...
# Modify.........: No:MOD-C30861 12/03/26 By Polly 調整列印條件判斷
...
#       l_time          LIKE type_file.chr8          #No.FUN-6A0073
  ...
  #LET g_pageno = 0
   ...
   FOREACH aglr800_curs1 INTO sr.*
     ...
     #IF sr.bdr=0 AND sr.bcr=0 AND sr.dr=0 AND sr.cr=0 THEN                 #MOD-C30861 mark
      IF sr.dr=0 AND sr.cr=0 AND sr.edr=0 AND sr.ecr=0 AND tm.e = 'N' THEN  #MOD-C30861 add
         CONTINUE FOREACH
      END IF
   ...
   END IF
   #            p1    ;   p2    ;    p3   ;    p4   ;  p5    ;  p6
   LET g_str = g_str,";",tm.yy,";",tm.bm,";",tm.em,";",tm.d,";",tm.f
   CALL cl_prt_cs3('aglr800','aglr800',l_sql,g_str)   #FUN-710080 modify
