...
#
# Pattern name...: aglg735.4gl
# Descriptions...: 兩期實際預算比較專案表列印
...
# Modify.........: No.TQC-6A0080 06/11/09 BY cheunl 報表格式修改
# Modify.........: No.FUN-6C0068 07/01/17 BY rainy 報表結構加檢查使用者及部門設限
# Modify.........: No.TQC-720032 07/03/01 By johnray 修正期別檢核方式
# Modify.........: No.FUN-740020 07/04/10 By Lynn 會計科目加帳套
# Modify.........: No.TQC-740093 07/04/18 By johnray 期別默認值與欄位期別欄位輸入判斷有衝突,導致報錯agl-020
# Modify.........: No.TQC-760105 07/06/14 By dxfwo   aglg735(項目兩期預算比較表) 帳別 tm.bookno 未 display or deafult!
# Modify.........: No.FUN-780059 07/08/23 By xiaofeizhu 報表改寫由Crystal Report產出
# Modify.........: No.FUN-810069 08/03/03 By ChenMoyang 取消預算編號的控管
...
# Modify.........: No.MOD-AA0083 10/10/14 By Dido 抓取預算不可限定條件 
...
#                budget LIKE afa_file.afa01,               #預算編號      #No.FUN-680098  VARCHAR(4)                 #No.FUN-830139
          ...
          g_tot1        ARRAY[100] OF LIKE type_file.num10,  #No.FUN-680098   integer
          g_tot2        ARRAY[100] OF LIKE type_file.num10,  #No.FUN-680098   integer 
          g_tot1_1      ARRAY[100] OF LIKE type_file.num10,  #No.FUN-680098   integer 
          g_tot2_1      ARRAY[100] OF LIKE type_file.num10,  #No.FUN-680098   integer 
          m_gem02       LIKE gem_file.gem02
   DEFINE g_aaa03       LIKE aaa_file.aaa03   
   DEFINE g_i           LIKE type_file.num5          #count/index for any purpose        #No.FUN-680098 smalint
...
TYPE sr1_t RECORD
    ...
    bal1 LIKE aef_file.aef05,
    bal2 LIKE aef_file.aef05,
    bal1_1 LIKE aef_file.aef05,
    bal2_1 LIKE aef_file.aef05,
    amt1 LIKE aef_file.aef05,
    amt2 LIKE aef_file.aef05,
...
MAIN
 ...
 #--str FUN-780059 add--#                                                                                                           
   ...
   LET g_sql = "maj20.maj_file.maj20,",                                                                                             
               ...
               "bal1.aef_file.aef05,",
               "bal2.aef_file.aef05,",        
               "bal1_1.aef_file.aef05,",                                                                                      
               "bal2_1.aef_file.aef05,",
               "amt1.aef_file.aef05,",
               "amt2.aef_file.aef05,",                                                                                            
               "per1.fid_file.fid03,",                                                                                              
               "per2.fid_file.fid03,",                                                                                              
   ...
   LET l_table = cl_prt_temptable('aglg735',g_sql) CLIPPED   # 產生Temp Table                                                       
...
#No.FUN-740020 ---end
   ...
   CALL cl_gre_drop_temptable(l_table)      #No.FUN-B90027
END MAIN
...
FUNCTION g735_tm()
   ...
   OPEN WINDOW g735_w AT p_row,p_col
     WITH FORM "agl/42f/aglg735"  ATTRIBUTE (STYLE = g_win_style CLIPPED) #No.FUN-580092 HCN
...
#     CALL cl_err('sel aaa:',SQLCA.sqlcode,0)   #No.FUN-660123
      CALL cl_err3("sel","g_aaa03",g_bookno,"",SQLCA.sqlcode,"","sel aaa:",0)   #No.FUN-660123
   END IF
...
#  LET tm.b = '00'         #No.TQC-760105
   LET tm.b = g_bookno     #No.TQC-760105
   LET tm.c = 'Y'
   LET tm.d = '1'
   LET tm.f = 0
   LET tm.h = 'N'
...
#FUN-AB0020--------------add--------------str--------
 ...
 #FUN-AB0020--------------add-------------end-----------
         ...
         BEFORE FIELD bm1
            IF tm.rtype = '1' THEN
#               LET tm.bm1 = 0     #No.TQC-740093
               LET tm.bm1 = 1      #No.TQC-740093
               DISPLAY '' TO bm1
            END IF
...
#              CALL cl_err(tm.p,'agl-109',0)   #No.FUN-660123
         ...
         ON ACTION CONTROLP
            IF INFIELD(a) THEN
              ...
              #LET g_qryparam.where = " mai00 = '",tm.b,"'"     #No.FUN-740020   #No.TQC-C50042
...
##             LET g_qryparam.arg1 = tm.b            #No.FUN-740020 #No.FUN-810069
...
#                       " '",tm.budget CLIPPED,"'",   #No.FUN-830139
            ...
            CALL cl_cmdat('aglg735',g_time,l_cmd)    # Execute cmd at later time
         END IF
...
#     DEFINE   l_time LIKE type_file.chr8              #No.FUN-6A0073
   ...
   DEFINE l_amt1          LIKE aef_file.aef05           #No.FUN-780059                                                                                  
   DEFINE l_amt2          LIKE aef_file.aef05           #No.FUN-780059 
   DEFINE amt1_1,amt2_1   LIKE aef_file.aef05
   DEFINE maj             RECORD LIKE maj_file.*
   DEFINE sr              RECORD
                             bal1,bal2,bal1_1,bal2_1      LIKE aef_file.aef05
                          END RECORD
   #--str FUN-780059 add--#                                                                                                         
   ...
   IF STATUS THEN
      ...
      EXIT PROGRAM
   END IF
   DECLARE g735_c CURSOR FOR g735_p
...
#  CALL cl_outnam('aglg735') RETURNING l_name         #No.FUN-780059--mark
#  START REPORT g735_rep TO l_name                    #No.FUN-780059--mark
...
#              AND afc01 = tm.budget              #No.FUN-830139
               ...
               AND afc03 = tm.yy1
               AND afc042 = tm.x           #----專案編號    #MOD-9C0100 afc04 modify afc042
              ...
              #AND afb041 = ''     #No.FUN-810069          #MOD-A80003 mark
              #AND afb041 = ' '    #No.FUN-810069          #MOD-A80003       #MOD-AA0083 mark
              #AND afb042 = ''     #No.FUN-810069          #MOD-9C0100 mark 
#FUN -AB0020-------add-----------str------
         ELSE
          #SELECT SUM(afc06) INTO amt1_1                                                  #CHI-B60055 mark
           SELECT SUM(COALESCE(afc06,0)+COALESCE(afc08,0)+COALESCE(afc09,0)) INTO amt1_1  #CHI-B60055
...
#           CALL cl_err3("sel","afc_file,afb_file",tm.b,tm.budget,STATUS,"","sel afc:",1)   #No.FUN-660123    #No.FUN-830139
#           CALL cl_err3("sel","afc_file,afb_file",tm.b,"",STATUS,"","sel afc:",1)          #No.FUN-660123    #No.FUN-830139 #FUN-AB0020 mark
            CALL cl_err3("sel","afc_file,afb_file",tm.b,tm.afc01,STATUS,"","sel afc:",1)    #FUN-AB0020 add   
            EXIT FOREACH 
         END IF
...
#           CALL cl_err('sel aef2',STATUS,1)    #No.FUN-660123
            CALL cl_err3("sel","aef_file,aag_file",tm.yy2,tm.b,STATUS,"","sel aef2",1)   #No.FUN-660123
            EXIT FOREACH
         END IF
...
#             AND afc01 = tm.budget              #No.FUN-830139
              AND afc02 BETWEEN maj.maj21 AND maj.maj22
              AND afc03 = tm.yy2
              AND afc042 = tm.x                    #MOD-9C0100 afc04 modify afc042                              
              AND afc05 BETWEEN tm.bm2 AND tm.em2
              AND afbacti = 'Y'   #TQC-630238
              AND afc041 = afb041 #No.FUN-810069                                                                                      
              AND afc042 = afb042 #No.FUN-810069 
             #AND afc041 = ''     #No.FUN-810069               #MOD-A80003 mark                                                                       
             #AND afc041 = ' '    #No.FUN-810069               #MOD-A80003      #MOD-AA0083 mark 
             #AND afc042 = ''     #No.FUN-810069   #MOD-9C0100 mark
#FUN-AB0020-------add-----------str------
        ELSE
          #SELECT SUM(afc06) INTO amt2_1                                                  #CHI-B60055 mark
           SELECT SUM(COALESCE(afc06,0)+COALESCE(afc08,0)+COALESCE(afc09,0)) INTO amt2_1  #CHI-B60055
...
#FUN-AB0020-------add-----------end------ 
         IF STATUS THEN
#           CALL cl_err('sel afc:',STATUS,1)   #No.FUN-660123
            CALL cl_err3("sel","afc_file,afb_file",tm.yy2,tm.x,STATUS,"","sel afc:",1)   #No.FUN-660123
            EXIT FOREACH 
         END IF
      ...
      IF maj.maj04 = 0 THEN                                                                                                         
         EXECUTE insert_prep USING                                                                                                  
            ...
            sr.bal1,sr.bal2,sr.bal1_1,sr.bal2_1,l_amt1,l_amt2,l_per1,l_per2,                                                                            
            '2'                                                                                                                     
      ELSE                                                                                                                          
         EXECUTE insert_prep USING                                                                                                  
            maj.maj20,maj.maj20e,maj.maj02,maj.maj03,                                                                               
...
#     OUTPUT TO REPORT g735_rep(maj.*, sr.*)                 #No.FUN-780059--mark
   END FOREACH
   #--str FUN-780059 add--#                                                                                                         
   ## **** 與 Crystal Reports 串聯段 - <<<< CALL cs3() >>>> CR11 **** ##                                                            
###GENGRE###   LET g_sql = "SELECT * FROM ",g_cr_db_str CLIPPED,l_table CLIPPED                                                                 
###GENGRE###   LET g_str = g_mai02,";",tm.a,";",tm.d,";",tm.p,";",tm.x,";",tm.title1,";",tm.title2,";",                                         
###GENGRE####              l_tit1,";",l_tit2,";",'',";",tm.e             #No.FUN-830139          #FUN-AB0020 mark                                                                     
###GENGRE####              l_tit1,";",l_tit2,";",tm.budget,";",tm.e                                                                                           
###GENGRE###               l_tit1,";",l_tit2,";",tm.afc01,";",tm.e     #FUN-AB0020 add                                                                                      
###GENGRE###   CALL cl_prt_cs3('aglg735','aglg735',g_sql,g_str)                                                                                 
    CALL aglg735_grdata()    ###GENGRE###
   #------------------------------ CR (4) ------------------------------#                                                           
   #--end FUN-780059 add--#
 
#  FINISH REPORT g735_rep                                    #No.FUN-780059--mark
...
#                         bal1,bal2,bal1_1,bal2_1      LIKE aef_file.aef05
#                      END RECORD
#  DEFINE l_amt1       LIKE aef_file.aef05
#  DEFINE l_amt2       LIKE aef_file.aef05
...
#        LET g_x[1] = g_mai02              #No.TQC-6A0080 ADD CLIPPED
...
#              COLUMN g_c[36],l_tit2 CLIPPED      #No.TQC-6A0080 
...
FUNCTION aglg735_grdata()
    ...
    WHILE TRUE
        ...
        LET handler = cl_gre_outnam("aglg735")
        IF handler IS NOT NULL THEN
            START REPORT aglg735_rep TO XML HANDLER handler
            LET l_sql = "SELECT * FROM ",g_cr_db_str CLIPPED,l_table CLIPPED
                        ," ORDER BY maj02,line"   #FUN-B90027 add
          
            DECLARE aglg735_datacur1 CURSOR FROM l_sql
            FOREACH aglg735_datacur1 INTO sr1.*
                OUTPUT TO REPORT aglg735_rep(sr1.*)
            END FOREACH
            FINISH REPORT aglg735_rep
        END IF
...
REPORT aglg735_rep(sr1)
    ...
    FORMAT
        ...
        ON EVERY ROW
            ...
            LET l_fmt = cl_gr_numfmt("aef_file","aef05",tm.e)
            PRINTX l_fmt
            #FUN-B90027----add----str---------
