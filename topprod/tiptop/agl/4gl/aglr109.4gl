...
# Modify.........: No.MOD-CC0038 12/12/06 By Polly 因IFRS兩套帳並行，故加回帳別條件
...
#No.FUN-760083 --BEGIN--
   ...
   LET l_table=cl_prt_temptable("aglr109",g_sql) CLIPPED
...
#  CALL s_dsmark(g_bookno)
   ...
   OPEN WINDOW aglr109_w AT p_row,p_col
     WITH FORM "agl/42f/aglr109"  ATTRIBUTE (STYLE = g_win_style CLIPPED) #No.FUN-580092 HCN
    ...
    #FUN-B20054--add--end
      IF g_bgjob = 'Y' THEN
         ...
         ELSE
            ...
            CALL cl_cmdat('aglr109',g_time,l_cmd)  # Execute cmd at later time
         END IF
  ...
  # WHERE aaf01 = g_bookno
   ...
   LET l_sql = "SELECT aag1.aag08, aag2.aag02, aag2.aag13,aag1.aag01, aag1.aag02,aag1.aag13,",   #FUN-6C0012
            ...
            #  " WHERE aba00 = '",g_bookno,"'", #若為空白使用預設帳別
               ...
               "   AND aba00 = abb00",                                      #No.FUN-740020 #MOD-CC0038 remark
               "   AND aba01 = abb01",
   ...
   PREPARE aglr109_prepare1 FROM l_sql
   IF STATUS THEN
      CALL cl_err('prepare:',STATUS,1)
      CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690114
      EXIT PROGRAM
   END IF
   DECLARE aglr109_curs1 CURSOR FOR aglr109_prepare1
#No.FUN-760083  --BEGIN--
 
  #CALL cl_outnam('aglr109') RETURNING l_name    
  #
  ##No.FUN-6C0012 --start--                                                     
  #IF tm.f = 'Y' THEN                                                           
  ...
  ##No.FUN-6C0012 --end--
  #
  #START REPORT aglr109_rep TO l_name
   
  #str MOD-870172 mark
  #IF tm.f='Y' THEN
  #    LET l_name='aglr109_1'
  #ELSE
  #    LET l_name='aglr109'
  #END IF
  #end MOD-870172 mark
...
#No.FUN-760083  --end--
   ...
   FOREACH aglr109_curs1 INTO sr.*
     ...
     #IF g_aza.aza26 = '2' AND tm.d='1' AND sr.aag24 != tm.e THEN #CHI-710005
      ...
      #OUTPUT TO REPORT aglr109_rep(sr.*)     #No.FUN-760083
...
#No.FUN-760083  --begin--
  ...
  #CALL cl_prt(l_name,g_prtway,g_copies,g_len)
   ...
   IF g_zz05='Y' THEN 
       ...
       RETURNING tm.wc
   END IF
   LET g_str=tm.wc,';',tm.b_date,';',tm.e_date,';',t_azi04,';',t_azi05,";",
             tm.f   #MOD-870172 add
   CALL cl_prt_cs3("aglr109","aglr109",g_sql,g_str)   #MOD-870172 mod
#No.FUN-760083  --END--
END FUNCTION
 
#No.FUN-760083 --begin--
{
REPORT aglr109_rep(sr)
