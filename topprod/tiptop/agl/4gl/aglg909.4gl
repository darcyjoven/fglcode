...
# Modify.........: No.FUN-C20080 12/03/05 By lujh
...
MAIN
   ...
   LET l_table = cl_prt_temptable('aglg909',g_sql) CLIPPED                                                                  
   ...
   IF cl_null(g_bgjob) OR g_bgjob = 'N'      # If background job sw is off
      THEN CALL aglg909_tm(0,0)            # Input print condition
      ELSE CALL aglg909()            # Read data and create out-file
   END IF
   CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690114
   CALL cl_gre_drop_temptable(l_table)   #FUN-B80161 add
END MAIN
 
FUNCTION aglg909_tm(p_row,p_col)
   ...
   END IF
   OPEN WINDOW aglg909_w AT p_row,p_col WITH FORM "agl/42f/aglg909"
...
# 
#      IF INT_FLAG THEN
#         LET INT_FLAG = 0 CLOSE WINDOW aglg909_w 
#         CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690114
#         EXIT PROGRAM
#      END IF
# 
...
#No.FUN-B20054--add-end--
      ...
      IF g_bgjob = 'Y' THEN
         ...
         ELSE
            ...
            CALL cl_cmdat('aglg909',g_time,l_cmd)      # Execute cmd at later time
         END IF
         CLOSE WINDOW aglg909_w
         CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690114
         CALL cl_gre_drop_temptable(l_table)   #FUN-B80161 add
         EXIT PROGRAM
      END IF
...
#         l_time    LIKE type_file.chr8           #No.FUN-6A0073
  ...
  #FUN-5C0015----------------------------------------------------------(E)
   PREPARE aglg909_pre1 FROM l_sql
   DECLARE aglg909_cs1 CURSOR FOR aglg909_pre1
  ...
  #str MOD-8C0083 mark
  #  CALL cl_outnam('aglg909') RETURNING l_name
  #  #FUN-5C0015-------------------------------------------------------(S)
  ...
  # #FUN-5C0015-------------------------------------------------------(E)
  #end MOD-8C0083 mark
#    START REPORT aglg909_rep TO l_name     #No.FUN-790008
   ...
   FOREACH aglg909_cs1 INTO sr.*
     ...
     #str MOD-8C0083 add
      ...
      ELSE
        ...
        #->FUN-5C0015--------------------------------------------------------(E)
#No.FUN-790008---Begin
#        OUTPUT TO REPORT aglg909_rep(sr.*)
...
###GENGRE###   LET l_sql = "SELECT * FROM ", g_cr_db_str CLIPPED, l_table CLIPPED                                              
   ...
   ELSE
      LET tm.wc=""
   END IF                                                                                                                          
###GENGRE###   LET g_str = tm.wc,";",tm.a,";",tm.b 
###GENGRE###   CALL cl_prt_cs3('aglg909','aglg909',l_sql,g_str)     
    CALL aglg909_grdata()    ###GENGRE###
#No.FUN-790008---End 
#    CALL cl_prt(l_name,g_prtway,g_copies,g_len)
END FUNCTION
{                                #No.FUN-790008
REPORT aglg909_rep(sr)
...
FUNCTION aglg909_grdata()
    ...
    WHILE TRUE
        ...
        LET handler = cl_gre_outnam("aglg909")
        IF handler IS NOT NULL THEN
            START REPORT aglg909_rep TO XML HANDLER handler
            LET l_sql = "SELECT * FROM ",g_cr_db_str CLIPPED,l_table CLIPPED
                        ," ORDER BY aag01"    #FUN-B80161 add
          
            DECLARE aglg909_datacur1 CURSOR FROM l_sql
            FOREACH aglg909_datacur1 INTO sr1.*
                OUTPUT TO REPORT aglg909_rep(sr1.*)
            END FOREACH
            FINISH REPORT aglg909_rep
        END IF
...
REPORT aglg909_rep(sr1)
    DEFINE sr1 sr1_t
    DEFINE l_lineno LIKE type_file.num5
    DEFINE l_aag    LIKE aag_file.aag02   #FUN-B80161 add
    DEFINE l_aag_str STRING               #FUN-B80161 add
    ...
    FORMAT
        ...
        ON EVERY ROW
            ...
            PRINTX l_lineno
            #FUN-B80161---add------str-----------
            IF tm.b = 'N' THEN LET l_aag = sr1.aag02 ELSE LET l_aag = sr1.aag13 END IF
            PRINTX l_aag                
           
            IF tm.b = 'N' THEN  
               LET l_aag_str = cl_gr_getmsg("gre-215",g_lang,'1')
            ELSE
               LET l_aag_str = cl_gr_getmsg("gre-215",g_lang,'1')
            END IF
            PRINTX l_aag_str
