...
MAIN
   ...
   LET l_table = cl_prt_temptable('aglr116',g_sql) CLIPPED   # 產生Temp Table
...
#  LET tm.bm = ARG_VAL(11)    #FUN-A90032
   ...
   IF cl_null(g_bgjob) OR g_bgjob = 'N'        # If background job sw is off
      THEN CALL r116_tm()                   # Input print condition
      ELSE CALL r116()                      # Read data and create out-file
   END IF
...
FUNCTION r116_tm()
   ...
   OPEN WINDOW r116_w AT p_row,p_col WITH FORM "agl/42f/aglr116" 
...
#                    tm.yy,tm.bm,tm.em,tm.dd,        #FUN-950048 #FUN-A90032 mark
         ...
         BEFORE INPUT
             CALL cl_qbe_init()
             CALL r116_set_entry()    #FUN-A90032
             CALL r116_set_no_entry() #FUN-A90032
...
#FUN-A90032 --End           
      ...
      ON ACTION help         
       ...
       END INPUT
       IF INT_FLAG THEN
          LET INT_FLAG = 0 CLOSE WINDOW r116_w 
          CALL cl_used(g_prog,g_time,2) RETURNING g_time
          EXIT PROGRAM
...
#                            " '",tm.bm CLIPPED,"'",    #FUN-A90032
            ...
            CALL cl_cmdat('aglr116',g_time,l_cmd)   
         END IF
         CLOSE WINDOW r116_w
         CALL cl_used(g_prog,g_time,2) RETURNING g_time 
         EXIT PROGRAM
...
FUNCTION r116()
   ...
   LET g_str = g_mai02,";",tm.a,";",tm.d,";",tm.yy,";",tm.bm,";",
               tm.em,";",tm.dd,";",tm.e
   CALL cl_prt_cs3('aglr116','aglr116',g_sql,g_str)
   #------------------------------ CR (4) ------------------------------#
 
END FUNCTION

#FUN-A90032 --Begin
FUNCTION r116_set_entry()                                                                                                           
   CALL cl_set_comp_entry("q1,em,h1",TRUE)
END FUNCTION                                                                                                                        
                                                                                                                                    
FUNCTION r116_set_no_entry()                                                                                                        
   IF tm.axa06 ="1" THEN
