...
MAIN
   ...
   OPEN WINDOW q000_w AT p_row,p_col WITH FORM "agl/42f/aglq000"
...
FUNCTION q000_cs()
   ...
   CONSTRUCT BY NAME tm.wc ON
      aej01,aej00,aej02,aej03,aej04,aej05,aej11
      BEFORE CONSTRUCT
         CALL cl_qbe_init()
      ...
      ON ACTION CONTROLP
         CASE
            ...
            WHEN INFIELD(aej04)
                 ...
                 LET g_qryparam.state = "c"
                 CALL cl_create_qry() RETURNING g_qryparam.multiret
                 DISPLAY g_qryparam.multiret TO aej04
   ...
   LET g_sql=
       "SELECT UNIQUE aej01,aej00,aej02,aej03,aej04,aej05,aej11",
       "  FROM aej_file ",
       " WHERE ",tm.wc CLIPPED,
       " ORDER BY aej01,aej00,aej02,aej03,aej04,aej05"
...
DEFINE   l_cmd        LIKE type_file.chr1000
   WHILE TRUE
      ...
      CASE g_action_choice
         ...
         WHEN "query1"
            IF cl_chk_act_auth() THEN
                LET l_cmd =  "aglq0001 ","'",g_aej1.aej01,"' ",
                                     "'",g_aej1.aej00,"' '",g_aej1.aej02,"' ",
                                     "'",g_aej1.aej03,"' '",g_aej1.aej04,"'"
               CALL cl_cmdrun(l_cmd)
            END IF
         WHEN "query2"
            IF cl_chk_act_auth() THEN
                LET l_cmd =  "aglq0002 ","'",g_aej1.aej01,"' ",
                                     "'",g_aej1.aej00,"' '",g_aej1.aej02,"' ",
                                     "'",g_aej1.aej03,"' '",g_aej1.aej04,"'"
               CALL cl_cmdrun(l_cmd)
            END IF
...
DEFINE
    ...
    CASE p_flag
       WHEN 'N' FETCH NEXT     q000_cs INTO g_aej1.aej01,g_aej1.aej00,
                                            g_aej1.aej02,g_aej1.aej03,
                                            g_aej1.aej04,g_aej1.aej05,
                                            g_aej1.aej11
       WHEN 'P' FETCH PREVIOUS q000_cs INTO g_aej1.aej01,g_aej1.aej00,
                                            g_aej1.aej02,g_aej1.aej03,
                                            g_aej1.aej04,g_aej1.aej05,
                                            g_aej1.aej11
       WHEN 'F' FETCH FIRST    q000_cs INTO g_aej1.aej01,g_aej1.aej00,
                                            g_aej1.aej02,g_aej1.aej03,
                                            g_aej1.aej04,g_aej1.aej05,
                                            g_aej1.aej11
       WHEN 'L' FETCH LAST     q000_cs INTO g_aej1.aej01,g_aej1.aej00,
                                            g_aej1.aej02,g_aej1.aej03,
                                            g_aej1.aej04,g_aej1.aej05,
                                            g_aej1.aej11
       WHEN '/'
           IF (NOT mi_no_ask) THEN
              ...
              END IF
           END IF
           FETCH ABSOLUTE g_jump q000_cs INTO g_aej1.aej01,g_aej1.aej00,
                                              g_aej1.aej02,g_aej1.aej03,
                                              g_aej1.aej04,g_aej1.aej05,
                                              g_aej1.aej11
           LET mi_no_ask = FALSE
    ...
    ELSE
       ...
       CALL cl_navigator_setting( g_curs_index, g_row_count )
    END IF
  # CALL s_get_bookno(g_aej1.aej09)  RETURNING g_flag,g_bookno1,g_bookno2
  # IF g_flag='1' THEN   #抓不到帳套
  #    CALL cl_err(g_aej1.aej08,'aoo-081',1)
  # END IF
    CALL q000_show()
END FUNCTION
...
FUNCTION q000_show()
   ...
   DISPLAY BY NAME g_aej1.aej00,g_aej1.aej01,g_aej1.aej02,
                   g_aej1.aej03,g_aej1.aej04,g_aej1.aej05,
                   g_aej1.aej11
   CALL s_aaz641_dbs(g_aej1.aej01,g_aej1.aej02) RETURNING g_dbs_axz03
   LET g_sql ="SELECT aag02 ",
              " FROM ",cl_get_target_table(g_dbs_axz03,'aag_file'), 
              " WHERE aag00 = '",g_aej1.aej00,"'",
              "   AND aag01 = '",g_aej1.aej04,"'",
              "   AND aagacti = 'Y'"
...
FUNCTION q000_b_fill()              #BODY FILL UP
   ...
   LET l_sql =
       #"SELECT aej06,aej07,aej08,aej09,aej10",
       "SELECT aej06,aej07,aej08,(aej07-aej08),aej09,aej10",   #FUN-AB0028
       "  FROM aej_file",
       " WHERE aej01 = '",g_aej1.aej01,"'",
       "   AND aej00 = '",g_aej1.aej00,"' AND aej02 = '",g_aej1.aej02,"'",
       "   AND aej03 = '",g_aej1.aej03,"' AND aej04 = '",g_aej1.aej04,"'",
       "   AND aej05 = '",g_aej1.aej05,"' AND aej11= '",g_aej1.aej11,"'"
   ...
   LET g_rec_b=0
   LET g_cnt = 1
   FOREACH q000_bcs INTO g_aej[g_cnt].*
      IF SQLCA.sqlcode != 0 AND SQLCA.sqlcode != 100 THEN
         CALL cl_err('',SQLCA.sqlcode,1)
      END IF
      IF cl_null(g_aej[g_cnt].amt) THEN LET g_aej[g_cnt].amt = 0  END IF  #FUN-AB0028
      LET l_total = l_total + g_aej[g_cnt].amt   #FUN-AB0028
      LET g_aej[g_cnt].amt = l_total             #FUN-AB0028
      LET g_cnt = g_cnt+1
   END FOREACH
