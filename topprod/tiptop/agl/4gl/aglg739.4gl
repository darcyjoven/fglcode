...
TYPE sr1_t RECORD
    ...
    tot1 LIKE aao_file.aao05,
    tot2 LIKE aao_file.aao05,
    tot3 LIKE aao_file.aao05,
    tot4 LIKE aao_file.aao05,
    tot5 LIKE aao_file.aao05,
    tot6 LIKE aao_file.aao05,
    tot7 LIKE aao_file.aao05,
    tot8 LIKE aao_file.aao05,
    tot9 LIKE aao_file.aao05,
    tot10 LIKE aao_file.aao05,
    tot11 LIKE aao_file.aao05,
    tot12 LIKE aao_file.aao05,
    tot13 LIKE aao_file.aao05,
    tot14 LIKE aao_file.aao05,
...
###GENGRE###   LET g_str = g_mai02,";",tm.a,";",tm.d,";",tm.p,";",tm.dept,";",
###GENGRE###               g_msg,";",g_azi04   
###GENGRE###   CALL cl_prt_cs3('aglr739','aglr739',g_sql,g_str)                                                                                 
    CALL aglg739_grdata()    ###GENGRE###
   #------------------------------ CR (4) ------------------------------#                                                           
   #--end FUN-780059 add--#
END FUNCTION
...
FUNCTION aglg739_grdata()
    ...
    WHILE TRUE
        ...
        LET handler = cl_gre_outnam("aglg739")
        IF handler IS NOT NULL THEN
            START REPORT aglg739_rep TO XML HANDLER handler
            LET l_sql = "SELECT * FROM ",g_cr_db_str CLIPPED,l_table CLIPPED
                        ," ORDER BY maj02,line"   #FUN-B90028 add
          
            DECLARE aglg739_datacur1 CURSOR FROM l_sql
            FOREACH aglg739_datacur1 INTO sr1.*
                OUTPUT TO REPORT aglg739_rep(sr1.*)
            END FOREACH
            FINISH REPORT aglg739_rep
        END IF
...
REPORT aglg739_rep(sr1)
    ...
    FORMAT
        ...
        ON EVERY ROW
            ...
            LET l_fmt = cl_gr_numfmt("aao_file","aao05",g_azi04)
            PRINTX l_fmt
