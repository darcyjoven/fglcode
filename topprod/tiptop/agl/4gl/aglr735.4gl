...
# Modify.........: No.TQC-760105 07/06/14 By dxfwo   aglr735(項目兩期預算比較表) 帳別 tm.bookno 未 display or deafult!
...
FUNCTION r735_tm()
   ...
   OPEN WINDOW r735_w AT p_row,p_col
     WITH FORM "agl/42f/aglr735"  ATTRIBUTE (STYLE = g_win_style CLIPPED) #No.FUN-580092 HCN
...
#                       " '",tm.budget CLIPPED,"'",   #No.FUN-830139
            ...
            CALL cl_cmdat('aglr735',g_time,l_cmd)    # Execute cmd at later time
         END IF
...
#     DEFINE   l_time LIKE type_file.chr8              #No.FUN-6A0073
   ...
   LET l_sql = "SELECT * FROM maj_file",
               ...
               "   AND ",g_msg CLIPPED,
               " ORDER BY maj02"
   PREPARE r735_p FROM l_sql
   IF STATUS THEN
      CALL cl_err('prepare:',STATUS,1)  
      CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690114
      EXIT PROGRAM
   END IF
   DECLARE r735_c CURSOR FOR r735_p
...
#  CALL cl_outnam('aglr735') RETURNING l_name         #No.FUN-780059--mark
#  START REPORT r735_rep TO l_name                    #No.FUN-780059--mark
...
#     OUTPUT TO REPORT r735_rep(maj.*, sr.*)                 #No.FUN-780059--mark
   END FOREACH
   #--str FUN-780059 add--#                                                                                                         
   ## **** 與 Crystal Reports 串聯段 - <<<< CALL cs3() >>>> CR11 **** ##                                                            
   LET g_sql = "SELECT * FROM ",g_cr_db_str CLIPPED,l_table CLIPPED                                                                 
   LET g_str = g_mai02,";",tm.a,";",tm.d,";",tm.p,";",tm.x,";",tm.title1,";",tm.title2,";",                                         
#              l_tit1,";",l_tit2,";",'',";",tm.e             #No.FUN-830139          #FUN-AB0020 mark                                                                     
#              l_tit1,";",l_tit2,";",tm.budget,";",tm.e                                                                                           
               l_tit1,";",l_tit2,";",tm.afc01,";",tm.e     #FUN-AB0020 add                                                                                      
   CALL cl_prt_cs3('aglr735','aglr735',g_sql,g_str)                                                                                 
   #------------------------------ CR (4) ------------------------------#                                                           
   #--end FUN-780059 add--#
 
#  FINISH REPORT r735_rep                                    #No.FUN-780059--mark
