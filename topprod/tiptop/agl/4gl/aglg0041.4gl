...
# Modify.........: NO.FUN-C40071 12/05/20 By yangtt CR轉換成GRW
...
MAIN
   ...
   LET l_table = cl_prt_temptable('aglg0041',g_sql) CLIPPED   # 產生temp table
   ...
   LET l_table1 = cl_prt_temptable('aglg00411',g_sql) CLIPPED   # 產生temp table
   ...
   CALL cl_gre_drop_temptable(l_table||"|"||l_table1)  #FUN-C40071  add
END MAIN

FUNCTION g0041_tm(p_row,p_col)
DEFINE p_row,p_col    LIKE type_file.num5
DEFINE l_cmd          LIKE type_file.chr1000

   LET p_row = 3 LET p_col = 22

   OPEN WINDOW g0041_w AT p_row,p_col WITH FORM "agl/42f/aglg0041"
 ...
 WHILE TRUE
   ...
   IF INT_FLAG THEN
      LET INT_FLAG = 0
      CLOSE WINDOW g0041_w
      CALL cl_used(g_prog,g_time,2) RETURNING g_time
      CALL cl_gre_drop_temptable(l_table||"|"||l_table1)  #FUN-C40071  add
      EXIT PROGRAM
   END IF
   IF g_bgjob = 'y' THEN
      SELECT zz08 INTO l_cmd FROM zz_file WHERE zz01='aglg0041'
      IF sqlca.sqlcode OR l_cmd IS NULL THEN
         CALL cl_err('aglg0041','9031',1)
      ELSE
         LET l_cmd = l_cmd CLIPPED,
                         ...
                         " '",g_template CLIPPED,"'",
                         " '",g_rpt_name CLIPPED,"'"
         CALL cl_cmdat('aglg0041',g_time,l_cmd)
      END IF
      CLOSE WINDOW g0041_w
      CALL cl_used(g_prog,g_time,2) RETURNING g_time
      CALL cl_gre_drop_temptable(l_table||"|"||l_table1)  #FUN-C40071  add
...
FUNCTION g0041()
   ...
   PREPARE g0041_prepare FROM l_sql
   IF sqlca.sqlcode != 0 THEN
      ...
      EXIT PROGRAM
   END IF
   DECLARE g0041_curs CURSOR FOR g0041_prepare
   ...
   LET l_sql = "select aya01,aya02,aya06 from aya_file ",
               " where aya07 = 'N' order by aya06" 
   PREPARE g0041_prepare1 FROM l_sql
   DECLARE g0041_curs1 CURSOR FOR g0041_prepare1
   #FUN-C40071----add----end-- 

   FOREACH g0041_curs INTO g_axm[g_no].*
      IF sqlca.sqlcode != 0 THEN
    ...
    #FUN-C40071----mark---end-- 
      ...
      LET l_i = 1
      FOREACH g0041_curs1 INTO l_aya01,l_aya02,l_aya06
         IF sqlca.sqlcode != 0 THEN
            CALL cl_err('foreach:',sqlca.sqlcode,1)
            EXIT FOREACH
         END IF
...
#--FUN-BB0065 end---
      ...
      CALL g0041_to_dat(g_axm[g_no].axm05,g_axm[g_no].axm12)
  ...
  #LET l_sql ="select aya02 from aya_file where aya07 = 'y' order by aya06"   #MOD-B90160 mark
   ...
   PREPARE g0041_pre_1 FROM l_sql
   DECLARE g0041_cur_1 CURSOR FOR g0041_pre_1

   LET l_i = 1
   FOREACH g0041_cur_1 INTO g_title[l_i]
      LET l_i = l_i + 1
   END FOREACH
...
###GENGRE###              l_unit,";",tm.e,";",t_azi04,";",t_azi05,";",l_axm02    #No.TQC-BB0246 modify:l_azi->t_azi

###GENGRE###   CALL cl_prt_cs3('aglg0041','aglg0041',l_sql,g_str)
    CALL aglg0041_grdata()    ###GENGRE###

END FUNCTION

FUNCTION g0041_to_dat(p_str,p_axm12)
...
FUNCTION aglg0041_grdata()
    ...
    WHILE TRUE
        ...
        LET handler = cl_gre_outnam("aglg0041")
        IF handler IS NOT NULL THEN
            START REPORT aglg0041_rep TO XML HANDLER handler
            LET l_sql = "SELECT * FROM ",g_cr_db_str CLIPPED,l_table CLIPPED
          
            DECLARE aglg0041_datacur1 CURSOR FROM l_sql
            FOREACH aglg0041_datacur1 INTO sr1.*
                OUTPUT TO REPORT aglg0041_rep(sr1.*)
            END FOREACH
            FINISH REPORT aglg0041_rep
        END IF
...
REPORT aglg0041_rep(sr1)
    ...
    FORMAT
        FIRST PAGE HEADER
            ...
            START REPORT aglg0041_subrep01
            DECLARE aglg0041_subrep01 CURSOR FROM l_sql
            FOREACH aglg0041_subrep01 INTO sr2.*
                OUTPUT TO REPORT aglg0041_subrep01 (sr2.*)
            END FOREACH
            FINISH REPORT aglg0041_subrep01
            #FUN-C40071--------add----end---
        ...
        ON EVERY ROW
            ...
            #FUN-C40071--------add----str---
            LET l_amt1_fmt = cl_gr_numfmt('type_file','num20_6',t_azi05)
            PRINTX l_amt1_fmt
            LET g_y_fmt = cl_gr_numfmt('type_file','num20_6',t_azi04)
            PRINTX g_y_fmt
...
REPORT aglg0041_subrep01(sr2)
    ...
    DEFINE l_display11 LIKE type_file.chr1
    DEFINE l_display12 LIKE type_file.chr1
    DEFINE l_display13 LIKE type_file.chr1
    DEFINE l_display14 LIKE type_file.chr1
    DEFINE l_display15 LIKE type_file.chr1
    DEFINE l_display16 LIKE type_file.chr1
    DEFINE l_display17 LIKE type_file.chr1
    DEFINE l_display18 LIKE type_file.chr1
    DEFINE l_display19 LIKE type_file.chr1
    DEFINE l_display20 LIKE type_file.chr1
    DEFINE l_display21 LIKE type_file.chr1
    DEFINE l_display22 LIKE type_file.chr1
    DEFINE l_display23 LIKE type_file.chr1
    DEFINE l_display24 LIKE type_file.chr1
    DEFINE l_display25 LIKE type_file.chr1
    DEFINE l_display26 LIKE type_file.chr1
    DEFINE l_display27 LIKE type_file.chr1
    DEFINE l_display28 LIKE type_file.chr1
    DEFINE l_display29 LIKE type_file.chr1
    DEFINE l_display30 LIKE type_file.chr1

    FORMAT
        ON EVERY ROW

           IF cl_null(sr2.title_2) THEN
              LET l_display2 = 'N'
           ELSE
              LET l_display2 = 'Y'
           END IF
