...
#NO.FUN-830094----START-----
   ...
   LET l_table = cl_prt_temptable('aglr702',g_sql) CLIPPED
...
FUNCTION aglr702_tm(p_row,p_col)
...
DEFINE li_chk_bookno    LIKE type_file.num5           #FUN-B20054 
   ...
   OPEN WINDOW aglr702_w AT p_row,p_col
     WITH FORM "agl/42f/aglr702"  ATTRIBUTE (STYLE = g_win_style CLIPPED) #No.FUN-580092 HCN
  ...
  #FUN-B20054--add--end
      ...
      IF g_bgjob = 'Y' THEN
         ...
         ELSE
            ...
            CALL cl_cmdat('aglr702',g_time,l_cmd)      # Execute cmd at later time
         END IF
...
#         l_time   LIKE type_file.chr8               #No.FUN-6A0073
   ...
   SELECT zz05 INTO g_zz05 FROM zz_file WHERE zz01 = 'aglr702'  #NO.FUN-830094
  ...
  #資料要先排序,再算餘額
   ...
   END FOR
  #end MOD-9B0158 add
   PREPARE aglr702_prepare1 FROM l_sql
   IF SQLCA.sqlcode != 0 THEN
      CALL cl_err('prepare:',SQLCA.sqlcode,1)
      CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690114
      EXIT PROGRAM
   END IF
   DECLARE aglr702_curs1 CURSOR FOR aglr702_prepare1
 
#  CALL cl_outnam('aglr702') RETURNING l_name         #NO.FUN-830094  
#  #No.FUN-6C0012 --start--                                                     
...
#  CALL cl_prt_pos_len()                                                        
#  #No.FUN-6C0012 --end--
#  START REPORT aglr702_rep TO l_name                 #NO.FUN-830094
#  LET g_pageno = 0                                   #NO.FUN-830094
   LET l_n = 0   #MOD-9B0158 add
   FOREACH aglr702_curs1 INTO sr.*
      IF SQLCA.sqlcode != 0 THEN
...
#     OUTPUT TO REPORT aglr702_rep(sr.*)              #NO.FUN-830094
#NO.FUN-830094----START-----
      IF sr.abb06 = '1' THEN
...
#  FINISH REPORT aglr702_rep                          #NO.FUN-830094
...
#NO.FUN-830094----START-----
   ...
   END IF
   LET g_str = tm.wc,";",tm.u[1,1],";",tm.a
   CALL cl_prt_cs3('aglr702','aglr702',g_sql,g_str) 
#NO.FUN-830094----END-----
END FUNCTION
 
#NO.FUN-830094----START-----
#REPORT aglr702_rep(sr)
