...
#No.FUN-780060--start--
   LET g_sql="maj31.maj_file.maj31,",     #FUN-B80158   Add
             ...
             "per2.fid_file.fid03,", 
             "line.type_file.num5"    
   LET l_table = cl_prt_temptable('aglg140',g_sql) CLIPPED
   IF l_table = -1 THEN 
...
FUNCTION g140_tm()
   ...
   OPEN WINDOW g140_w AT p_row,p_col
     WITH FORM "agl/42f/aglg140"  ATTRIBUTE (STYLE = g_win_style CLIPPED) #No.FUN-580092 HCN
...
#     INPUT BY NAME tm.rtype,tm.a,tm.b,tm.title1,tm.yy1,tm.bm1,tm.em1,tm.title2,
      INPUT BY NAME tm.rtype,tm.b,tm.a,tm.title1,tm.yy1,tm.bm1,tm.em1,tm.title2,   #No.FUN-740020
                    ...
                    tm.title4,tm.yy4,tm.bm4,tm.em4,tm.e,tm.f,tm.d,tm.acc_code,tm.c,tm.h,      #FUN-B80158   Add tm.acc_code
...
#              CALL cl_err(tm.p,'agl-109',0)   #No.FUN-660123
      ...
      IF g_bgjob = 'Y' THEN
         ...
         ELSE
            ...
            CALL cl_cmdat('aglg140',g_time,l_cmd)    # Execute cmd at later time
         END IF
...
#No.FUN-780060--end--
   ...
   IF STATUS THEN 
      ...
      EXIT PROGRAM
   END IF
   DECLARE g140_c CURSOR FOR g140_p
...
#   CALL cl_outnam('aglg140') RETURNING l_name       #No.FUN-780060    
#   START REPORT g140_rep TO l_name                  #No.FUN-780060 
 
#   LET g_pageno = 0                                 #No.FUN-780060 
 
   FOREACH g140_c INTO maj.*
      IF STATUS THEN
...
#No.FUN-780060--start--add
         ...
         END IF
#No.FUN-780060--end--
#     OUTPUT TO REPORT g140_rep(maj.*, sr.*)             #No.FUN-780060
...
#  FINISH REPORT g140_rep                                   #No.FUN-780060
...
###GENGRE###              tm.title2,";",tm.title3,";",tm.title4,";",l_tit1,";", 
###GENGRE###              l_tit2,";",l_tit3,";",l_tit4,";",tm.e,";",tm.acc_code   #No.FUN-B80158  add   FROM FUN-B90140   Add tm.acc_code
###GENGRE###   CALL cl_prt_cs3('aglg140','aglg140',g_sql,g_str)
    CALL aglg140_grdata()    ###GENGRE###
END FUNCTION
#No.FUN-780060--start--mark
{REPORT g140_rep(maj, sr)
...
FUNCTION aglg140_grdata()
    ...
    WHILE TRUE
        ...
        LET handler = cl_gre_outnam("aglg140")
        IF handler IS NOT NULL THEN
            START REPORT aglg140_rep TO XML HANDLER handler
            LET l_sql = "SELECT * FROM ",g_cr_db_str CLIPPED,l_table CLIPPED
                        ," ORDER BY maj02,line"                  #FUN-B80158   add
          
            DECLARE aglg140_datacur1 CURSOR FROM l_sql
            FOREACH aglg140_datacur1 INTO sr1.*
                OUTPUT TO REPORT aglg140_rep(sr1.*)
            END FOREACH
            FINISH REPORT aglg140_rep
        END IF
...
REPORT aglg140_rep(sr1)
    ...
    FORMAT
        ...
        ON EVERY ROW
            ...
            PRINTX l_lineno
            #FUN-B80158-----------add-----str---
            LET l_a = sr1.bal1 - sr1.bal2
            PRINTX l_a
            LET l_b = sr1.bal3 - sr1.bal4
            PRINTX l_b
            ...
            PRINTX l_bal4_fmt 
            LET l_a_fmt = cl_gr_numfmt("aah_file","aah04",tm.e)
            PRINTX l_a_fmt 
            LET l_b_fmt = cl_gr_numfmt("aah_file","aah04",tm.e)
            PRINTX l_b_fmt 
