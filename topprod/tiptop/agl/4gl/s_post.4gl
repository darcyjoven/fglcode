...
#
##□ s_post
##SYNTAX	   CALL s_post(p_bookno,p_bdate,p_edate,bno,p_eno)
...
FUNCTION s_post(p_bookno,p_bdate,p_edate,p_bno,p_eno,p_post,p_wc)
   ...
   DEFINE p_wc		LIKE type_file.chr1000              #No.FUN-680098  VARCHAR(600)
   ...
   IF g_bgjob = 'N'  THEN    #MOD-7C0040
      OPEN WINDOW post_g_w AT 19,18 WITH FORM "agl/42f/s_post"
            ATTRIBUTE (STYLE = g_win_style CLIPPED) #No.FUN-580092 HCN
      CALL cl_ui_locale("s_post")
   END IF   #MOD-7C0040
...
#NO.FUN-710023--BEGIN
      IF STATUS THEN
        IF g_bgerr THEN
          ...
          CALL s_errmsg('aba00,abapost,aba19,abaacti',g_showmsg,'fore aba:',STATUS,0)
        ELSE
...
#NO.FUN-710023--END         
      IF g_aba.abapost<>p_post THEN
        {CALL cl_err('sel aba:','aar-347',1)} CONTINUE FOREACH
      END IF
      #----------------------------------------------------------------------
...
#NO.FUN-710023--BEGIN                                                           
         IF g_bgerr THEN                                                        
            LET g_showmsg=g_aba.aba01,"/",g_aba.aba00                           
            CALL s_errmsg('aba01,aba00',g_showmsg,'aba01/03/04 is null','agl-027',0) CONTINUE FOREACH           
         ELSE                                                                   
            CALL cl_err('aba01/03/04 is null','agl-027',1)  CONTINUE FOREACH                                  
         END IF     
#NO.FUN-710023--END         
...
#NO.FUN-710023--BEGIN                                                           
         IF g_bgerr THEN                                                        
            LET g_showmsg=g_aba.aba01,"/",g_aba.aba00                           
            CALL s_errmsg('aba01,aba00',g_showmsg,'aba02<aaa07','agl-200',0) CONTINUE FOREACH           
         ELSE                                                                   
 ...
 #            CALL cl_err3("ins","aea_file",g_abb.abb00,l_aag08,STATUS,"","ins aea:",1) #NO.FUN-710023
           #NO.FUN-710023--BEGIN                                                           
              IF g_bgerr THEN                                                        
                ...
                CALL s_errmsg('aea00,aea02,aea03,aea04',g_showmsg,'ins aea:',STATUS,0)            
               ELSE                                                                   
...
FUNCTION s_post_aed()
   ...
   IF NOT cl_null(g_abb.abb11) THEN
      CALL aec_ins(g_abb.abb11,g_aag.aag151,'1',g_aag.aag15)
      IF g_success = 'N' THEN RETURN END IF
   ...
   END IF
   IF NOT cl_null(g_abb.abb12) THEN
      CALL aec_ins(g_abb.abb12,g_aag.aag161,'2',g_aag.aag16)
      IF g_success = 'N' THEN RETURN END IF
   ...
   END IF
   IF NOT cl_null(g_abb.abb13) THEN
      CALL aec_ins(g_abb.abb13,g_aag.aag171,'3',g_aag.aag17)
      IF g_success = 'N' THEN RETURN END IF
   ...
   END IF
   IF NOT cl_null(g_abb.abb14) THEN
      CALL aec_ins(g_abb.abb14,g_aag.aag181,'4',g_aag.aag18)
      IF g_success = 'N' THEN RETURN END IF
   ...
   IF NOT cl_null(g_abb.abb31) THEN
      CALL aec_ins(g_abb.abb31,g_aag.aag311,'5',g_aag.aag31)
      IF g_success = 'N' THEN RETURN END IF
   ...
   IF NOT cl_null(g_abb.abb32) THEN
      CALL aec_ins(g_abb.abb32,g_aag.aag321,'6',g_aag.aag32)
      IF g_success = 'N' THEN RETURN END IF
   ...
   IF NOT cl_null(g_abb.abb33) THEN
      CALL aec_ins(g_abb.abb33,g_aag.aag331,'7',g_aag.aag33)
      IF g_success = 'N' THEN RETURN END IF
   ...
   IF NOT cl_null(g_abb.abb34) THEN
      CALL aec_ins(g_abb.abb34,g_aag.aag341,'8',g_aag.aag34)
      IF g_success = 'N' THEN RETURN END IF
   ...
   IF NOT cl_null(g_abb.abb35) THEN
      CALL aec_ins(g_abb.abb35,g_aag.aag351,'9',g_aag.aag35)
      IF g_success = 'N' THEN RETURN END IF
      CALL aed_ins(g_abb.abb35,'9',g_aag.aag35)
      IF g_success = 'N' THEN RETURN END IF
      CALL ted_ins(g_abb.abb35,'9',g_aag.aag35)
      IF g_success = 'N' THEN RETURN END IF
   END IF
   IF NOT cl_null(g_abb.abb36) THEN
      CALL aec_ins(g_abb.abb36,g_aag.aag361,'10',g_aag.aag36)
      IF g_success = 'N' THEN RETURN END IF
      CALL aed_ins(g_abb.abb36,'10',g_aag.aag36)
      IF g_success = 'N' THEN RETURN END IF
      CALL ted_ins(g_abb.abb36,'10',g_aag.aag36)
      IF g_success = 'N' THEN RETURN END IF
   END IF
   IF NOT cl_null(g_abb.abb37) THEN
      CALL aec_ins(g_abb.abb37,g_aag.aag371,'99',g_aag.aag37)
      IF g_success = 'N' THEN RETURN END IF
...
FUNCTION aec_ins(p_key,p_sw,p_key2,p_tc) #FUN-5C0015 BY GILL 
   ...
   DEFINE  p_key   LIKE aeg_file.aeg05 	# 專案編號
    ...
    INSERT INTO aeg_file(aeg00,aeg01,aeg02,aeg03,aeg04,aeg05,aeglegal)  #No.MOD-470041 #FUN-980003 add aeglegal
        VALUES(g_abb.abb00,g_abb.abb03,g_aba.aba02,g_aba.aba01,
               g_abb.abb02,p_key,g_legal) #FUN-980003 add g_legal
        IF STATUS THEN
