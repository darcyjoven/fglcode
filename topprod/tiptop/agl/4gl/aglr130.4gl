...
#No.FUN-780060--start--
   LET g_sql="maj31.maj_file.maj31,",               #FUN-B90140   Add
         ...
         #    "per3.fid_file.fid03,",   #MOD-930106
             "line.type_file.num5"    
   LET l_table = cl_prt_temptable('aglr130',g_sql) CLIPPED
   IF l_table = -1 THEN EXIT PROGRAM END IF
   LET g_sql = "INSERT INTO ",g_cr_db_str CLIPPED,l_table CLIPPED, 
            #   " VALUES(?,?,?,?,?, ?,?,?,?,?,?)"         #MOD-930106
                " VALUES(?,?,?,?,?, ?,?,?,?)"               #MOD-930106  #FUN-B90140   Add ?
...
FUNCTION r130_tm()
   ...
   OPEN WINDOW r130_w AT p_row,p_col
     WITH FORM "agl/42f/aglr130"  ATTRIBUTE (STYLE = g_win_style CLIPPED) #No.FUN-580092 HCN
...
#              CALL cl_err(tm.p,'agl-109',0)   #No.FUN-660123
      ...
      IF g_bgjob = 'Y' THEN
         ...
         ELSE
            ...
            CALL cl_cmdat('aglr130',g_time,l_cmd)    # Execute cmd at later time
         END IF
...
#  CALL cl_outnam('aglr130') RETURNING l_name         #No.FUN-780060   
#  START REPORT r130_rep TO l_name                    #No.FUN-780060
...
#MOD-930106  --end 
      ...
      END IF
#No.FUN-780060--end--
#     OUTPUT TO REPORT r130_rep(maj.*, sr.*)               #No.FUN-780060
...
#  FINISH REPORT r130_rep                                   #No.FUN-780060
...
#No.FUN-780060--start--add 
   ...
   LET g_str= g_mai02,";",tm.d,";",tm.a,";",tm.p,";",tm.title1,";", 
              tm.title2,";",tm.title3,";",l_tit1,";",l_tit2,";", 
              l_tit3,";",tm.e,";",g_basetot1,";",g_basetot2,";",g_basetot3    #MOD-930106 add g_basetot1,g_basetot2,g_basetot3     
              ,";",tm.acc_code   #FUN-B90140   Add
   CALL cl_prt_cs3('aglr130','aglr130',g_sql,g_str)  
#No.FUN-780060--end--
END FUNCTION
 
#MOD-930106  --begin--
#REPORT r130_rep(maj, sr)
