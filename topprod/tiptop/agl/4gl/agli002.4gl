...
# Modify.........: No.FUN-C50059 12/12/20 By Belle 持股比率相關欄位改由agli0021處理
# Modify.........: No.FUN-D20049 13/03/20 By Lori agli0021改aglq0021
# Modify.........: No.FUN-D20046 13/03/21 By Lori 單頭單身各別新增現行年度,現行期別的欄位,由aglp000捲算後回寫
# Modify.........: No.TQC-D40006 13/04/02 By Lori 畫面上無任何資料時直接按 「子公司股本異動查詢」功能鍵時顯示-400訊息
...
DEFINE
    ...
    g_axb           DYNAMIC ARRAY OF RECORD    #程式變數(Program Variables)
        ...
        axb14       LIKE axb_file.axb14,   #Year             #FUN-D20046 add
        axb15       LIKE axb_file.axb15    #Month            #FUN-D20046 add
       #FUN-C50059--Mark--
...
DEFINE p_row,p_col   LIKE type_file.num5                  #No.FUN-680098     smallint
   ...
   LET g_sql = "axa01.axa_file.axa01,",
              ...
              ,",axb14.axb_file.axb14",     #FUN-D20046 add
               ",axb15.axb_file.axb15"       #FUN-D20046 add
              #FUN-C50059--Mark--
   ...
   LET g_sql = "INSERT INTO ",g_cr_db_str CLIPPED,l_table CLIPPED,      #TQC-A40116 mod       
               " VALUES(?,?,?,?,?, ?,?,?,?,?, ?) "                      #FUN-D20046 add
              #" VALUES(?,?,?,?,?, ?,?,?,?) "                           #FUN-C50059     #FUN-D20046 mark           
              #" VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?) "                #FUN-C50059 mark #No.FUN-7A0035 
   ...
   OPEN WINDOW i002_w AT p_row,p_col  #顯示畫面
     WITH FORM "agl/42f/agli002"  ATTRIBUTE (STYLE = g_win_style CLIPPED) #No.FUN-580092 HCN
...
#  CONSTRUCT BY NAME g_wc ON axa01,axa02,axa03,axa09,axauser,axagrup,axamodu,axadate    #FUN-950051 add axa09   #FUN-A90029 makr
   CONSTRUCT BY NAME g_wc ON axa01,axa02,axa03,axa04,axa10,axa11,axa09,axa05,axa06,     #FUN-A90029 add         #FUN-D20046 add axa10,axa11
  ...
  #FUN-C50059--mark
   CONSTRUCT g_wc2 ON axb04,axb05,axb14,axb15 FROM s_axb[1].axb04,s_axb[1].axb05             #FUN-C50059   #FUN-D20046 add axb14,axb15
                                                  ,s_axb[1].axb14,s_axb[1].axb15             #FUN-D20046 add
		BEFORE CONSTRUCT
		   CALL cl_qbe_display_condition(lc_qbe_sn)
      ON ACTION CONTROLP
         CASE
...
FUNCTION i002_menu()
DEFINE   l_cmd  LIKE type_file.chr1000     #FUN-C50059
   ...
   WHILE TRUE
      ...
      CASE g_action_choice
        ...
        #FUN-C50059--
         WHEN "transtock"     #股本異動
            IF cl_chk_act_auth() THEN
               IF NOT cl_null(g_axa.axa01) THEN                                                   #TQC-D40006 add
                 #LET l_cmd="agli0021 '",g_axa.axa01,"' '",g_axa.axa02,"' '",g_axa.axa03,"' '"    #FUN-D20049 mark
                  LET l_cmd="aglq0021 '",g_axa.axa01,"' '",g_axa.axa02,"' '",g_axa.axa03,"' '"    #FUN-D20049 add
                            ,g_axb[l_ac].axb04,"' '",g_axb[l_ac].axb05,"'"
                  CALL cl_cmdrun(l_cmd)
               #TQC-D40006 add begin--- 
               ELSE
                 CALL cl_err('','-400',0)
               END IF
               #TQC-D40006 add end-----
...
FUNCTION i002_a()
   ...
   WHILE TRUE
      ...
      LET g_axa.axa10 = NULL             #FUN-D20046 add
      LET g_axa.axa11 = NULL             #FUN-D20046 add
...
DEFINE 
   ...
   DISPLAY BY NAME g_axa.axa10,g_axa.axa11,g_axa.axauser,g_axa.axamodu,g_axa.axagrup,g_axa.axadate        #TQC-AB0296 modify   #FUN-D20046 add axa10,axa11
   CALL cl_set_head_visible("","YES")        #No.FUN-6B0029
...
#  INPUT BY NAME g_axa.axa01,g_axa.axa02,g_axa.axa03,g_axa.axa09 WITHOUT DEFAULTS   #FUN-950051 add axa09  #FUN-A90029 mark
   INPUT BY NAME g_axa.axa01,g_axa.axa02,g_axa.axa03,g_axa.axa04,g_axa.axa09,       #FUN-A90029 add
                 g_axa.axa05,g_axa.axa06 WITHOUT DEFAULTS                           #FUN-A90029 add
...
FUNCTION i002_show()
   ...
   DISPLAY BY NAME                              #顯示單頭值
      ...
      ,g_axa.axa10,g_axa.axa11                             #FUN-D20046 add
...
FUNCTION i002_r()
   ...
   IF cl_delh(0,0) THEN                   #確認一下
      ...
      INSERT INTO azo_file(azo01,azo02,azo03,azo04,azo05,azo06,azoplant,azolegal)
                   VALUES ('agli002',g_user,g_today,g_msg,g_axa.axa01,'delete',g_plant,g_legal)
      IF SQLCA.sqlcode THEN
         CALL cl_err3("ins","azo_file","agli002","",SQLCA.sqlcode,"","",1)
         ROLLBACK WORK
         RETURN FALSE
      END IF
      #FUN-D20046 add end-----
...
DEFINE
  ...
  #LET g_forupd_sql = "SELECT axb04,'',axb05,axb07,axb11,axb12,axb13,'',axb08 FROM axb_file ",  #FUN-C50509 mark #FUN-580063     #No.FUN-7A0035 
   LET g_forupd_sql = "SELECT axb04,'',axb05,axb14,axb15 FROM axb_file ",                       #FUN-C50059      #FUN-D20046 add axb14,axb15      
   ...
   INPUT ARRAY g_axb WITHOUT DEFAULTS FROM s_axb.*
      ...
      AFTER INSERT
         ...
         END IF
        #FUN-C50059--mark--
        #INSERT INTO axb_file(axb01,axb02,axb03,axb04,axb05,axb07,axb11,axb12,axb13,axb08)     #No.FUN-7A0035 
        ...
        #FUN-C50059--mark--
        #FUN-C50059--
         INSERT INTO axb_file(axb01,axb02,axb03,axb04,axb05)
                       VALUES(g_axa.axa01,g_axa.axa02,g_axa.axa03,g_axb[l_ac].axb04,g_axb[l_ac].axb05)
        #FUN-C50059--
...
#-----------------------------No.MOD-B70248-----------------------end
      ...
      ON ROW CHANGE
         ...
         ELSE
            UPDATE axb_file SET axb04=g_axb[l_ac].axb04,
                               ...
                               #axb13=g_axb[l_ac].axb13,   #FUN-7A0035 
   ...
   CLOSE i002_bcl
   COMMIT WORK
#  CALL i002_delall()   #CHI-740039 add #CHI-C30002 mark
   CALL i002_delHeader()     #CHI-C30002 add
 
END FUNCTION

#CHI-C30002 -------- add -------- begin
FUNCTION i002_delHeader()
   IF g_rec_b = 0 THEN
...
DEFINE
  ...
  #FUN-C50059--mark--
  #CONSTRUCT l_wc2 ON axb04,axb05,axb07,axb11,axb12,axb13,axb08   # 螢幕上取單身條件  #No.FUN-7A0035 
  #              FROM s_axb[1].axb04,s_axb[1].axb05,s_axb[1].axb07,
  #                   s_axb[1].axb11,s_axb[1].axb12,s_axb[1].axb13,s_axb[1].axb08     #No.FUN-7A0035 
  #FUN-C50059--mark--
   CONSTRUCT l_wc2 ON axb04,axb05,axb14,axb15 FROM s_axb[1].axb04,s_axb[1].axb05,s_axb[1].axb14,s_axb[1].axb15        #FUN-C50059      #FUN-D20046 add axb14,axb15
      ON IDLE g_idle_seconds
              BEFORE CONSTRUCT
                 CALL cl_qbe_init()
         CALL cl_on_idle()
...
DEFINE
  ...
  #LET g_sql = "SELECT axb04,'',axb05,axb07,axb11,axb12,axb13,'',axb08",  #FUN-C50059 mark  #FUN-580063     #No.FUN-7A0035 
   LET g_sql = "SELECT axb04,'',axb05,axb14,axb15",                       #FUN-C50059       #FUN-D20046 add axb14,axb15
               " FROM axb_file",
...
DEFINE l_i             LIKE type_file.num5,         #No.FUN-680098  smallint
       ...
       sr              RECORD
           ...
           axb14       LIKE axb_file.axb14,   #Year       #FUN-D20046
           axb15       LIKE axb_file.axb15    #Month      #FUN-D20046
          #FUN-C50059--mark--
          #axb07       LIKE axb_file.axb07,   #持股比率
          #axb11       LIKE axb_file.axb11,   #投資股數   #FUN-580063
          #axb12       LIKE axb_file.axb12,   #股本       #FUN-580063
...
DEFINE l_axz03,l_axz03b   LIKE axz_file.axz03  
   ...
   LET g_sql="SELECT axa01,axa02,axa03,",
             " axb04,axb05 ",                                  #FUN-C50059
             ",axb14,axb15 ",                                  #FUN-D20046 add
            #" axb04,axb05,axb07,axb11,axb12,axb13,axb08 ",    #FUN-C50059 mark #FUN-580063     #No.FUN-7A0035  
             " FROM axa_file,axb_file",               
   ...
   FOREACH i002_co INTO sr.*
     ...
     #FUN-C50059--mark
      EXECUTE insert_prep USING sr.axa01,sr.axa02,l_axz02,l_axz03,
                                ...
                                l_axz03b,sr.axb05                                #FUN-C50059
                               ,sr.axb14,sr.axb15                                #FUN-D20046 add
                               #l_axz03b,sr.axb05,sr.axb07,sr.axb11,sr.axb12,    #FUN-C50059 mark
                               #sr.axb13,l_aag02,sr.axb08                        #FUN-C50059 mark #No.FUN-7A0035    #No.MOD-7B0223
   END FOREACH
