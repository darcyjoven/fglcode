...
#
# Pattern name...: aglr021.4gl
# Descriptions...: 合併後多異動碼二期財務比較表
# Date & Author..: 11/03/29 By wangxin
# Modify.........: No:FUN-B30146 11/03/29 By wangxin
...
MAIN
   ...
   LET l_table = cl_prt_temptable('aglr021',g_sql) CLIPPED  # 產生Temp Table
   ...
   LET tm.q1 = ARG_VAL(18)
   LET tm.h1 = ARG_VAL(19)
   LET tm.e = ARG_VAL(20)
   LET tm.f = ARG_VAL(21)
   LET tm.d = ARG_VAL(22)
   LET tm.c = ARG_VAL(23)
   ...
   IF cl_null(g_bgjob) OR g_bgjob = 'N'  # If background job sw is off
      THEN CALL r021_tm()                # Input print condition
      ELSE CALL r021()                   # Read data and create out-file
   END IF
...
FUNCTION r021_tm()
   ...
   END IF
   OPEN WINDOW r021_w AT p_row,p_col
        WITH FORM "agl/42f/aglr021" 
...
#luttb
      ...
      AFTER FIELD b 
         ...
         PREPARE r021_cnt_p FROM g_sql
         DECLARE r021_cnt_c CURSOR FOR r021_cnt_p
         OPEN r021_cnt_c
         FETCH r021_cnt_c INTO l_cnt
...
################################################################################
      ...
      ON ACTION CONTROLP
         ...
         IF INFIELD(a) THEN
           ...
           #LET g_qryparam.where = " mai00 = '",tm.b,"'"   #No.TQC-C50042   Add
            LET g_qryparam.where = " mai00 = '",tm.b,"' AND mai03 NOT IN ('5','6')"  #No.TQC-C50042   Add
            CALL cl_create_qry() RETURNING tm.a
            DISPLAY BY NAME tm.a
            NEXT FIELD a
         END IF
         IF INFIELD(aaz641) THEN    #FUN-B50001   #luttb
#         IF INFIELD(aaw01) THEN    #luttb
            CALL cl_init_qry_var()
            LET g_qryparam.form = 'q_aaa'
            LET g_qryparam.default1 = tm.b
            CALL cl_create_qry() RETURNING tm.b 
            DISPLAY BY NAME tm.b
            NEXT FIELD aaz641       #FUN-B50001   #luttb
#            NEXT FIELD aaw01
         END IF
         IF INFIELD(p) THEN
            CALL cl_init_qry_var()
   ...
   END INPUT
   IF INT_FLAG THEN
      LET INT_FLAG = 0 CLOSE WINDOW r021_w 
      CALL cl_used(g_prog,g_time,2) RETURNING g_time 
      EXIT PROGRAM
   ...
   IF g_bgjob = 'Y' THEN
      ...
      ELSE
         LET l_cmd = l_cmd CLIPPED,        #(at time fglgo xxxx p1 p2 p3)
                         ...
                         " '",tm.p  CLIPPED,"'",
                         " '",tm.q  CLIPPED,"'"
         CALL cl_cmdat('aglr021',g_time,l_cmd)    # Execute cmd at later time
      END IF
      CLOSE WINDOW r021_w
      CALL cl_used(g_prog,g_time,2) RETURNING g_time 
      EXIT PROGRAM
...
FUNCTION r021()
   ...
   LET l_sql = "SELECT * FROM maj_file",
               ...
               "   AND ",g_msg CLIPPED,
               " ORDER BY maj02"
   PREPARE r021_p FROM l_sql
   IF STATUS THEN CALL cl_err('prepare:',STATUS,1) 
      CALL cl_used(g_prog,g_time,2) RETURNING g_time 
      EXIT PROGRAM 
   END IF
   DECLARE r021_c CURSOR FOR r021_p
   ...
   FOR g_i = 1 TO 100 LET g_tot1[g_i] = 0 END FOR
       FOREACH r021_c INTO maj.*
         ...
         EXECUTE insert_prep USING
            ...
            g_azi03,g_azi04,g_azi05,g_aeii05,tm.yy,tm.title1,'1'
         IF maj.maj04 > 0 THEN
   ...
   CALL cl_prt_cs3('aglr021','aglr021',l_sql,g_str)   
   LET tm.title1 = ''  
END FUNCTION

FUNCTION r021_set_entry() 
    CALL cl_set_comp_entry("em,q1,h1",TRUE)   
END FUNCTION

FUNCTION r021_set_no_entry()
