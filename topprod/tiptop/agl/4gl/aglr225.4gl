...
MAIN
   ...
   LET g_sql="maj20.maj_file.maj20,maj20e.maj_file.maj20e,",
             ...
             "line.type_file.num5"
   LET l_table = cl_prt_temptable('aglr225',g_sql) CLIPPED
...
FUNCTION r225_tm()
   ...
   OPEN WINDOW r225_w AT p_row,p_col
     WITH FORM "agl/42f/aglr225"  ATTRIBUTE (STYLE = g_win_style CLIPPED) #No.FUN-580092 HCN
...
#              CALL cl_err(tm.p,'agl-109',0)   #No.FUN-660123
      ...
      IF g_bgjob = 'Y' THEN
         ...
         ELSE
            ...
            CALL cl_cmdat('aglr225',g_time,l_cmd)    # Execute cmd at later time
         END IF
...
#     DEFINE   l_time LIKE type_file.chr8        #No.FUN-6A0073
   ...
   LET l_sql = "SELECT * FROM maj_file",
               ...
               "   AND ",g_msg CLIPPED,
               " ORDER BY maj02"
   PREPARE r225_p FROM l_sql
   IF STATUS THEN 
      CALL cl_err('prepare:',STATUS,1)   
      CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690114
      EXIT PROGRAM
   END IF
   DECLARE r225_c CURSOR FOR r225_p
...
#   CALL cl_outnam('aglr225') RETURNING l_name       #No.FUN-780061
#   START REPORT r225_rep TO l_name                  #No.FUN-780061
   FOREACH r225_c INTO maj.*
      IF STATUS THEN
...
#      OUTPUT TO REPORT r225_rep(maj.*, sr.*)    #No.FUN-780061
      #No.FUN-780061 --start--
      IF maj.maj07 = '2' THEN 
         LET sr.bal1 = sr.bal1 * -1
         LET sr.bal2 = sr.bal2 * -1
...
#   FINISH REPORT r225_rep                       #No.FUN-780061
#
#   CALL cl_prt(l_name,g_prtway,g_copies,g_len)  #No.FUN-780061
   ...
   LET g_str = g_mai02,";",tm.a,";",tm.p,";",tm.d,";",tm.x,";",
               tm.title1,";",tm.title2,";",l_tit1,";",l_tit2,";",tm.e,";",g_basetot1,";",g_basetot2  #CHI-A70046 add g_basetot1,g_basetot2
   LET l_sql = "SELECT * FROM ",g_cr_db_str CLIPPED,l_table CLIPPED
   CALL cl_prt_cs3('aglr225','aglr225',l_sql,g_str)
   #No.FUN-780061 --end--
 
END FUNCTION
#No.FUN-780061 --start-- mark
{REPORT r225_rep(maj, sr)
