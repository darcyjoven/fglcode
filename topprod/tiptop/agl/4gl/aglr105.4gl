...
# Modify.........: No.FUN-CC0093 12/01/09 By zhangweib 程序控管優化
...
MAIN
   ...
   LET l_table = cl_prt_temptable('aglr105',g_sql) CLIPPED   # 產生Temp Table
...
FUNCTION r105_tm()
   ...
   OPEN WINDOW r105_w AT p_row,p_col WITH FORM "agl/42f/aglr105" 
...
#      INPUT BY NAME tm.a,tm.b,tm.yy,tm.bm,tm.em,tm.dd,
       ...
       ON ACTION locale
         ...
         AFTER FIELD a
           #IF tm.a IS NULL THEN NEXT FIELD a END IF   #No.FUN-CC0093   Mark
...
#              CALL cl_err('sel mai:',STATUS,0) #No.FUN-660123
          ...
          AFTER FIELD b
          # IF tm.b IS NULL THEN       #No.FUN-CC0093   Mark
          #    NEXT FIELD b END IF     #No.FUN-CC0093   Mark
...
#              CALL cl_err('sel aaa:',STATUS,0)  #No.FUN-660123 
         ...
         AFTER FIELD c
           #IF tm.c IS NULL OR tm.c NOT MATCHES "[YN]" THEN NEXT FIELD c END IF      #No.FUN-CC0093   Mark
            IF tm.c NOT MATCHES "[YN]" THEN NEXT FIELD c END IF        #No.FUN-CC0093   Mark
 
         AFTER FIELD yy
# genero  script marked             IF cl_ku() THEN NEXT FIELD PREVIOUS END IF
           #IF tm.yy IS NULL OR tm.yy = 0 THEN     #No.FUN-CC0093   Mark 
            IF tm.yy = 0 THEN                      #No.FUN-CC0093   Mark
               NEXT FIELD yy
            END IF
...
#No.TQC-720032 -- end --
# genero  script marked             IF cl_ku() THEN NEXT FIELD PREVIOUS END IF
          # IF tm.bm IS NULL THEN NEXT FIELD bm END IF      #No.FUN-CC0093   Mark
#No.TQC-720032 -- begin --
...
#No.TQC-720032 -- begin --
         ...
         END IF
#No.TQC-720032 -- end --
           #IF tm.em IS NULL THEN NEXT FIELD em END IF      #No.FUN-CC0093   Mark
#No.TQC-720032 -- begin --
...
#No.TQC-720032 -- end --
         ...
         AFTER FIELD f
           #IF tm.f IS NULL OR tm.f < 0  THEN     #No.FUN-CC0093   Mark
            IF tm.f < 0  THEN           #No.FUN-CC0093   Mark
               LET tm.f = 0
         ...
         #FUN-8B0059--Begin--#   
         AFTER FIELD m
           #IF cl_null(tm.m) OR tm.m NOT MATCHES'[YN]' THEN NEXT FIELD m END IF   #No.FUN-CC0093   Mark
            IF tm.m NOT MATCHES'[YN]' THEN NEXT FIELD m END IF                    #No.FUN-CC0093   Mark
         #FUN-8B0059--Begin--#            
   
         AFTER FIELD o
           #IF tm.o IS NULL OR tm.o NOT MATCHES'[YN]' THEN NEXT FIELD o END IF    #No.FUN-CC0093   Mark
            IF tm.o NOT MATCHES'[YN]' THEN NEXT FIELD o END IF                   #No.FUN-CC0093   Mark
            IF tm.o = 'N' THEN 
               LET tm.p = g_aaa03 
               LET tm.q = 1
      ...
      ON ACTION help          #MOD-4C0121
       ...
       IF g_bgjob = 'Y' THEN
          ...
          ELSE
            ...
            CALL cl_cmdat('aglr105',g_time,l_cmd)    # Execute cmd at later time
         END IF
         CLOSE WINDOW r105_w
         CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690114
         EXIT PROGRAM
...
#-----END TQC-620081-----
   ...
   END FOR
  #CALL cl_outnam('aglr105') RETURNING l_name   #FUN-770044 mark
  #START REPORT r105_rep TO l_name              #FUN-770044 mark
   #-----MOD-850040---------
   LET l_maj02=''
...
#-----END MOD-850040-----
     ...
     #OUTPUT TO REPORT r105_rep(maj.*, sr.*)   #FUN-770044 mark
   END FOREACH
