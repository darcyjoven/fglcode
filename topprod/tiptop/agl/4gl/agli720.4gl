...
#
# battern name...: agli720.4gl
# Descriptions...: 分攤傳票維護作業
# Date & Author..: 92/04/17 BY MAY
# Modify.........: 95/12/20 By Melody      於 OUT 加入金額來源科目顯示
# Modify.........: By Melody    加入部門管理、單身 keyin 順序調整
# Modify.........: By Melody    aab_file->gem_file
#                  By Melody    q_aac 改為不區分帳別
#                  By Melody    四組異動碼加入欄位控制
# Modify.........: No.MOD-490236 04/09/15 By Nicola 1."自動產生順序","起始日期","截止日期" PER 應設定 NOT NULL,REQUIRED
#                                                   2."餘額來源"='2' 應可輸入 "預算編號" ,"餘額性質" 是 noentry ,"餘額來源"='1' "預算編號" 是 noentry
#                                                   3."簽核" 應是可輸入, 'Y'時需輸入 "簽核等級"
#                                                   4.單身維護時 於 "摘要"欄 無法執行 "建立傳票額外摘要" ,Ctrl-P 查詢常用摘要 有英文action "select"
#                                                   5.單頭的確定按下後不再跳出維護來源科目的窗
# uodify.........: No.MOD-490344 04/09/20 By Kitty Controlp 未加display
# Modify.........: No.MOD-470515 04/10/05 By Nicola 加入"相關文件"功能
# Modify.........: No.FUN-4B0010 04/11/02 By Nicola 加入"轉EXCEL"功能
# Modify.........: No.FUN-4C0048 04/12/08 By Nicola 權限控管修改
# Modify.........: No.MOD-4C0038 04/12/14 By Nicola 新增時，單身異動碼無法維護
# Modify.........: No.MOD-4C0097 04/12/15 By Smapmin _i()開窗不可為複選
...
# Modify.........: No.FUN-5C0015 06/01/03 BY GILL 新增異動碼5-10、關係人異動碼
...
# Modify.........: No.MOD-640024 06/04/13 By Smapmin 確認時,借方比率總數與貸方比率總數要為100
...
# Modify.........: No.CHI-680026 06/12/05 By Smapmin 不CHECK借貸方比率是否一致,也不CHECK借貨方比率是否為100,僅CHECK借方比率為100
# Modify.........: No.TQC-6B0105 07/03/07 By carrier 連續兩次查詢,第二次查不到資料,做修改等操作會將當前筆停在上次查詢到的資料上
# Modify.........: No.FUN-740033 07/04/11 By Carrier 會計科目加帳套-財務 -修改
# Modify.........: No.FUN-740104 07/04/23 By rainy 新增額外摘要action
...
# Modify.........: No.MOD-9C0261 09/12/23 By sabrina 借方比率合計>100% or 貸方比率合計>100%時應顯示錯誤訊息且不可存檔
# Modify.........: No.MOD-9C0396 09/12/24 By Sarah 單頭"簽核"未打勾時"簽核等級"不應顯示黃色,且不可卡"簽核等級"不可空白
...
# Modify.........: No.TQC-AA0127 10/10/25 By Carrier 将相关使用 g_depno 予已 mark
# Modify.........: No.MOD-AB0052 10/11/05 By Dido 檢核單身是否有借貸方 
# Modify.........: No.TQC-AC0403 10/12/31 By zhangweib CALLs_check_no 傳入參數有問題
# Modify.........: No.FUN-B10048 11/01/20 By zhangll AFTER FIELD 科目时开窗自动过滤
# Modify.........: No.MOD-B30296 11/03/14 By Dido 新增時單頭輸入不需檢核單身 
...
# Modify.........: No:MOD-C20222 12/02/29 By Polly 調整單身項次中間跳號而出現錯誤判斷
...
#   g_depno         LIKE type_file.chr20,                                        #No.FUN-680098  VARCHAR(20)  #No.TQC-AA0127
...
DEFINE
   ...
   LET l_table = cl_prt_temptable('agli720',g_sql) CLIPPED                      
   ...
   END IF                                    
   LET g_forupd_sql = "SELECT * FROM aha_file WHERE aha00 = ? AND aha01 = ? AND aha000 = ? FOR UPDATE"
   LET g_forupd_sql = cl_forupd_sql(g_forupd_sql)
   DECLARE i720_cl CURSOR FROM g_forupd_sql
 
   LET g_aha000 = '2' #性質固定比率
   LET g_wc2=' 1=1'
   ...
   #  #FUN-A30049--mod--str--
   #   LET l_sql = "aglform $AGL/42r/agli720.42f agli720.42f ",
   #               g_depno CLIPPED
#  #   LET l_sql = "aglform ",os.Path.join( os.Path.join(FGL_GETENV("AGL"),"42r"),"agli720.42f")," ","agli720.42f ",
#  #               g_depno CLIPPED
   #  #FUN-A30049--mod--end
   #   RUN l_sql
   #   OPEN WINDOW i720_w AT p_row,p_col
   #        WITH FORM "agli720"  ATTRIBUTE (STYLE = g_win_style CLIPPED) #No.FUN-580092 HCN
 
   # CALL cl_ui_init()
   #ELSE
   #No.TQC-AA0127  --End 
      OPEN WINDOW i720_w AT p_row,p_col
        WITH FORM "agl/42f/agli720"  ATTRIBUTE (STYLE = g_win_style CLIPPED) #No.FUN-580092 HCN
 
    CALL cl_ui_init()
 
   #END IF   #No.TQC-AA0127
 
   CALL i720_show_field()  #FUN-5C0015 BY GILL
 
   #LET l_str1 = g_depno CLIPPED,'*' CLIPPED  #No.TQC-AA0127
...
DEFINE  lc_qbe_sn       LIKE    gbm_file.gbm01    #No.FUN-580031  HCN
   ...
   INITIALIZE g_aha.* TO NULL    #No.FUN-750051
    CONSTRUCT BY NAME g_wc ON             # 螢幕上取單頭條件
        aha00,aha01,aha02,aha03,aha05,aha06,aha04,aha07,aha13,aha08,aha10, #No.FUN-740033 
        ahamksg,ahasign,
        ahauser,ahagrup,ahamodu,ahadate,ahaacti,
    ...
    ON ACTION CONTROLP
       CASE
          ...
          WHEN INFIELD(aha07) #單據性質
             ...
             DISPLAY g_qryparam.multiret TO aha07
    ...
    CONSTRUCT g_wc2 ON ahb02,ahb03,ahb05,ahb06,ahb07,#ahb15,      #No.FUN-830139
            ...
            FROM s_ahb[1].ahb02,s_ahb[1].ahb03,
                 ...
                 s_ahb[1].ahb37,             #No.FUN-830139 Move ahb35,ahb36
    ...
    ON ACTION CONTROLP
       CASE
          ...
          WHEN INFIELD(ahb11)  #異動碼一
             ...
             CALL cl_create_qry() RETURNING g_qryparam.multiret
             DISPLAY g_qryparam.multiret TO shb11
          WHEN INFIELD(ahb12)  #異動碼二
             CALL cl_init_qry_var()
             LET g_qryparam.state = "c"
             LET g_qryparam.form ="q_aee"
             LET g_qryparam.arg1 = g_ahb[1].ahb03
    ...
    #IF g_wc2 = " 1=1" AND (g_depno IS NULL OR g_depno=' ') THEN#若單身未輸入條件  #No.TQC-AA0127
    IF g_wc2 = " 1=1"  THEN                                     #若單身未輸入條件  #No.TQC-AA0127
     ...
     ELSE                    # 若單身有輸入條件
       LET g_sql = "SELECT DISTINCT aha01,aha00,aha000 ",
                   ...
                   " AND aha000 = '",g_aha000,"' ",
                   " AND ahb000 = '",g_aha000,"' ",
                   " AND aha000 = ahb000 ",        #No.FUN-740033
                   " AND aha00 = ahb00 ",
                   " AND ahb02 !=0 ",
    ...
    #END IF
    #No.TQC-AA0127  --End  
    LET g_sql = g_sql CLIPPED," ORDER BY aha01 "
 
    PREPARE i720_prepare FROM g_sql
    DECLARE i720_cs                         #SCROLL CURSOR
        SCROLL CURSOR WITH HOLD FOR i720_prepare
 
    #IF g_wc2 = " 1=1" AND (g_depno IS NULL OR g_depno = ' ') THEN#取合乎條件筆數    #No.TQC-AA0127
    IF g_wc2 = " 1=1"  THEN                                       #取合乎條件筆數    #No.TQC-AA0127
        LET g_sql="SELECT DISTINCT aha00,aha01 FROM aha_file WHERE ",g_wc CLIPPED,
                  " AND aha000 = '",g_aha000,"'"
    ELSE
    ...
    DROP TABLE x
    PREPARE i720_pre_x FROM g_sql_tmp
    EXECUTE i720_pre_x
...
DEFINE   l_str   LIKE ze_file.ze03    #No.FUN-680098  VARCHAR(17)
   ...
   WHILE TRUE
      ...
      IF INT_FLAG THEN                   #使用者不玩了
         ...
         EXIT WHILE
      END IF
      IF g_aha.aha01 IS NULL
      OR g_aha.aha00 IS NULL     #No.FUN-740033
      OR g_aha.aha02 IS NULL                 # KEY 不可空白
      OR g_aha.aha07 IS NULL
      OR g_aha.aha13 IS NULL THEN
       CONTINUE WHILE
      END IF
      ...
      SELECT aha00 INTO g_aha.aha00 FROM aha_file
       WHERE aha00 = g_aha.aha00 AND aha01 = g_aha.aha01  #No.FUN-740033
         AND aha000 = g_aha.aha000                        #No.FUN-740033
      LET g_aha01_t = g_aha.aha01        #保留舊值
      LET g_aha00_t = g_aha.aha00        #保留舊值  #No.FUN-740033
      LET l_priv1=g_priv1
      LET l_priv2=g_priv2
      LET l_priv3=g_priv3
      CALL i721(g_aha.aha00,g_aha000,g_aha.aha01)  #No.FUN-740033
...
FUNCTION i720_u()
   IF s_aglshut(0) THEN RETURN END IF
   IF g_aha.aha01 IS NULL OR g_aha.aha00 IS NULL THEN  #No.FUN-740033
      CALL cl_err('',-400,0)
      RETURN
   END IF
   ...
   LET g_aha00_t = g_aha.aha00  #No.FUN-740033
   LET g_aha_o.* = g_aha.*
   BEGIN WORK
 
   OPEN i720_cl USING g_aha.aha00,g_aha.aha01,g_aha.aha000
   IF STATUS THEN
      ...
      RETURN
   END IF
   FETCH i720_cl INTO g_aha.*            # 鎖住將被更改或取消的資料
   ...
   WHILE TRUE
      ...
      IF INT_FLAG THEN
         ...
         EXIT WHILE
      END IF
      IF g_aha.aha01 != g_aha01_t OR g_aha.aha00 != g_aha00_t THEN            # 更改單號  #No.FUN-740033
         UPDATE ahb_file SET ahb01 = g_aha.aha01,ahb00 = g_aha.aha00          #No.FUN-740033
          WHERE ahb01 = g_aha01_t AND ahb00 = g_aha00_t AND ahb000 = '3'      #No.FUN-740033
         IF SQLCA.sqlcode THEN
            CALL cl_err3("upd","ahb_file",g_aha01_t,g_aha00_t,SQLCA.sqlcode,"","ahb",1)  #No.FUN-660123  #No.FUN-740033
            CONTINUE WHILE
         END IF
      END IF
      ...
      IF SQLCA.sqlcode THEN
         CALL cl_err3("upd","aha_file",g_aha01_t,g_aha00_t,SQLCA.sqlcode,"","",1)  #No.FUN-660123  #No.FUN-740033
         CONTINUE WHILE
      END IF
      LET l_priv1=g_priv1
      LET l_priv2=g_priv2
...
DEFINE
    ...
    INPUT BY NAME g_aha.ahaoriu,g_aha.ahaorig,
        g_aha.aha00,  #No.FUN-740033
        g_aha.aha01,g_aha.aha02,g_aha.aha03,g_aha.aha05,g_aha.aha06,
        g_aha.aha04,g_aha.aha07,g_aha.aha13,g_aha.aha08,g_aha.aha10,#g_aha.aha09,  #No.FUN-830139 mark
      ...
      BEFORE INPUT
         ...
         CALL i720_set_required()      #MOD-9C0396 add
         CALL i720_set_no_required()   #MOD-9C0396 add
 
        AFTER FIELD aha00
            IF NOT cl_null(g_aha.aha00) THEN
               CALL i720_aha00('a',g_aha.aha00)
             ...
             IF p_cmd = 'a' OR p_cmd = 'u' AND 
               (g_aha.aha01 != g_aha01_t OR g_aha.aha00 != g_aha00_t) THEN
                 ...
                 IF g_cnt > 0 THEN   #資料重複
                    ...
                    NEXT FIELD aha00   #No.FUN-7400033
                 END IF
              END IF
           END IF
...
#             CALL s_check_no("agl",g_t1,"","","","","")   #No.FUN-A40041    #No.TQC-AC0403
        ...
        AFTER FIELD aha06  #有效截止日期
         ...
         BEFORE FIELD aha08    #No.MOD-490236
           CALL i720_set_entry(p_cmd)
           CALL i720_set_required()      #MOD-9C0396 add
        ...
        AFTER FIELD aha08  #餘額來源 1:實際科目餘額 2:固定預算
            IF NOT cl_null(g_aha.aha08) THEN
               ...
               LET l_direct2 = 'D'
            END IF
            CALL i720_set_no_entry(p_cmd)    #No.MOD-490236
            CALL i720_set_no_required()      #MOD-9C0396 add
         ...
         BEFORE FIELD ahamksg    #No.MOD-490236
           CALL i720_set_entry(p_cmd)
           CALL i720_set_required()   #MOD-9C0396 add
        ...
        ON CHANGE ahamksg                   #MOD-9C0396 add
           CALL i720_set_no_required()      #MOD-9C0396 add
        ...
        AFTER FIELD ahasign
            IF g_aha.ahamksg MATCHES '[Yy]' THEN
               IF g_aha.ahasign IS NULL OR g_aha.ahasign =' ' THEN
                  ...
                  NEXT FIELD ahamksg
               ELSE
                  SELECT * FROM aze_file
                   WHERE aze01 = g_aha.ahasign
                     AND azeacti IN ('y','Y')
                     AND aze09 = 7
                  IF SQLCA.sqlcode THEN
        ...
        BEFORE FIELD aha10 #若為固定預算的餘額來源則本欄位不需輸入，
                           #因為為預算的話則預算檔中就巳有 是否遞延或
                           #抓本期的預算額的欄位來做處理固本欄位是供
                           #抓供實際餘額用
            IF g_aha.aha08 = '2' THEN
               IF l_direct2 = 'D' THEN
                  NEXT FIELD ahamksg
               ELSE
                  NEXT FIELD aha09  #若為'2'則一定會走預算編號的欄位(aha09)
               END IF
            END IF
 
        ##???是否餘額來源為實際科目餘額時餘額性質一定要輸入
        AFTER FIELD aha10  #餘額性質 1:累計餘額 2:當期異動
            IF g_aha.aha10 IS NULL OR g_aha.aha10 = ' ' OR
               g_aha.aha10 NOT MATCHES '[12]' THEN
               NEXT FIELD aha10
            END IF
        ...
        AFTER INPUT  #判斷必要欄位之值是否有值,若無則反白顯示,並要求重新輸入
           ...
           LET g_aha.ahagrup = s_get_data_group("aha_file") #FUN-C10039
            ...
            END IF
            #若來源為'1'實際科目餘額則餘額性質一定要輸入
            IF g_aha.aha08 = '1' AND
              (g_aha.aha10 IS NULL OR g_aha.aha10 = ' ' OR
               g_aha.aha10 NOT MATCHES '[12]') THEN
               LET g_aha.aha10 = ' '
               DISPLAY BY NAME  g_aha.aha10
               CALL cl_err('','agl-129',0)
            END IF
            IF l_flag='Y' THEN
                CALL cl_err('','9033',0)
                NEXT FIELD aha00   #No.FUN-740033
            END IF
        ...
        ON ACTION CONTROLP
           CASE
              ...
              WHEN INFIELD(aha02) #類別
                 ...
                 CALL i720_aha02('d')
                 NEXT FIELD aha02
               WHEN INFIELD(aha07) #單據性質     #MOD-4C0097
                  CALL q_aac(FALSE,TRUE,g_aha.aha07,'1','0',' ','AGL')   #TQC-670008
   ...
   #-MOD-AB0052-add-
    ...
    SELECT COUNT(*) INTO l_cnt 
     ...
     WHERE ahd01 = g_aha.aha01
       ...
       AND ahd000 = '2'
   #IF l_cnt = 0 THEN                  #MOD-B30296 mark
    IF l_cnt = 0 AND p_cmd = 'u' THEN  #MOD-B30296
       SELECT COUNT(*) INTO l_cnt 
         FROM ahb_file              
...
DEFINE
    ...
    CASE p_flag
        WHEN 'N' FETCH NEXT     i720_cs INTO g_aha.aha01,g_aha.aha00,g_aha.aha000
        WHEN 'P' FETCH PREVIOUS i720_cs INTO g_aha.aha01,g_aha.aha00,g_aha.aha000
        WHEN 'F' FETCH FIRST    i720_cs INTO g_aha.aha01,g_aha.aha00,g_aha.aha000
        WHEN 'L' FETCH LAST     i720_cs INTO g_aha.aha01,g_aha.aha00,g_aha.aha000
        WHEN '/'
      ...
      ON ACTION controlg      #MOD-4C0121
         CALL cl_cmdask()     #MOD-4C0121
                ...
                END IF
            END IF
            FETCH ABSOLUTE g_jump i720_cs INTO g_aha.aha01,g_aha.aha00,g_aha.aha000
            LET mi_no_ask = FALSE
    END CASE
    ...
    IF SQLCA.sqlcode THEN
       CALL cl_err3("sel","aha_file",g_aha_t.aha01,g_aha_t.aha00,SQLCA.sqlcode,"","",1)  #No.FUN-660123
       INITIALIZE g_aha.* TO NULL
       RETURN
    ELSE
...
FUNCTION i720_show()
    ...
    DISPLAY BY NAME g_aha.ahaoriu,g_aha.ahaorig,                        # 顯示單頭值
        g_aha.aha00,  #No.FUN-740033
        g_aha.aha01,g_aha.aha02,g_aha.aha03,g_aha.aha06,
        g_aha.aha05,g_aha.aha07,g_aha.aha13,g_aha.aha11,g_aha.aha08,
        g_aha.aha10,g_aha.aha12,g_aha.aha04, #No.FUN-830139 delete g_aha.aha09
        g_aha.ahamksg,g_aha.ahasign,g_aha.ahauser,g_aha.ahagrup,
...
DEFINE l_str   LIKE type_file.chr1000,   #No.FUN-680098  VARCHAR(1000)
  ...
  LET l_str = ' '
  DECLARE i720_ahd_cs CURSOR FOR
          SELECT ahd03,ahd04 FROM ahd_file
            WHERE ahd00 = g_aha.aha00 AND  #No.FUN-740033
                  ahd01 = g_aha.aha01 AND
                  ahd000 = '2'
  FOREACH i720_ahd_cs INTO l_ahd03,l_ahd04
    IF SQLCA.sqlcode THEN EXIT FOREACH END IF
    IF NOT cl_null(l_ahd04) THEN
       LET l_ahd03=l_ahd03 CLIPPED,'(',l_ahd04 CLIPPED,')'
    END IF
    IF cl_null(l_str) THEN
       LET l_str = l_ahd03 CLIPPED
    ELSE
       LET l_str = l_str CLIPPED,' ',l_ahd03
    END IF
  END FOREACH
...
FUNCTION i720_r()
    ...
    IF STATUS THEN
       ...
       RETURN
    END IF
    FETCH i720_cl INTO g_aha.*
    IF SQLCA.sqlcode THEN CALL cl_err(g_aha.aha01,SQLCA.sqlcode,0)
       CLOSE i720_cl ROLLBACK WORK RETURN END IF
    CALL i720_show()
#   IF cl_delh1(0,0) THEN                   #確認一下   #No.FUN-9B0098 MARK 10/03/01
    IF cl_delh(0,0) THEN               #No.FUN-9B0098 MODIFY 10/03/01
        ...
        DELETE FROM ahc_file WHERE ahc00 = g_aha.aha00 AND   #額外摘要
                                   ...
                                   ahc000 = g_aha.aha000
        IF SQLCA.sqlcode      THEN
            CALL cl_err3("del","ahc_file",g_aha.aha01,g_aha.aha00,SQLCA.sqlcode,"","",1)  #No.FUN-660123
        END IF
        ...
        CALL g_ahb.clear()
        DROP TABLE x
        PREPARE i720_pre_x2 FROM g_sql_tmp
        EXECUTE i720_pre_x2
        OPEN i720_count
...
DEFINE
   ...
   l_aha11_t       LIKE aha_file.aha11,
   l_aha12_t       LIKE aha_file.aha12,
   l_ahd03         LIKE ahd_file.ahd03,   #CHI-680026
   l_chr           LIKE type_file.chr1,   #CHI-680026
...
DEFINE
   ...
   IF g_aha.ahaacti ='N' THEN    #檢查資料是否為無效
       ...
       RETURN
   END IF
   CALL s_get_doc_no(g_aha.aha07) RETURNING g_t1  #No.FUN-550028
   ...
   LET g_forupd_sql = "SELECT ahb02,ahb03,' ',ahb05,ahb06,ahb07,ahb08,ahb35,ahb36,", #No.FUN-830139 Delete ahb15
                      "       ahb11,ahb12,ahb13,ahb14,",
 
                       " ahb31,ahb32,ahb33,ahb34,ahb37,",#No.FUN-830139 ahb35,ahb36 移動到ahb08后
                      ...
                      "       ahbud11,ahbud12,ahbud13,ahbud14,ahbud15 ", 
                      "  FROM ahb_file",
                      "  WHERE ahb000 =? AND ahb01 =? AND ahb00 =? ",
   ...
   INPUT ARRAY g_ahb WITHOUT DEFAULTS FROM s_ahb.*
       ...
       BEFORE ROW
          ...
          IF g_rec_b>=l_ac THEN
             ...
             OPEN i720_bcl USING g_aha.aha000,g_aha.aha01,g_aha.aha00,g_ahb_t.ahb02
             IF STATUS THEN
                CALL cl_err("OPEN i720_bcl:", STATUS, 1)
                LET l_lock_sw = "Y"
             END IF
             FETCH i720_bcl INTO g_ahb[l_ac].*
             IF SQLCA.sqlcode THEN
                CALL cl_err(g_ahb_t.ahb02,SQLCA.sqlcode,1)
                LET l_lock_sw = "Y"
             END IF
             CALL cl_show_fld_cont()     #FUN-550037(smin)
             CALL i720_set_entry_b()
             CALL i720_set_no_entry_b()
             CALL i720_set_no_required_b()   #MOD-9C0396 mod
             CALL i720_set_required_b()      #MOD-9C0396 mod
          END IF
          IF l_ac <= l_n then                   #DISPLAY NEWEST
             CALL i720_ahb03(' ')           #for referenced field
          END IF
       ...
       AFTER INSERT
          ...
          INSERT INTO ahb_file(ahb00,ahb000,ahb01,ahb02,ahb03,
                               ...
                               ahb11,ahb12,ahb13,ahb14,#ahb15,  #No.FUN-830139
          ...
          VALUES(g_aha.aha00,g_aha.aha000,g_aha.aha01,
                 ...
                 g_ahb[l_ac].ahb06,g_ahb[l_ac].ahb07,
          ...
          IF SQLCA.sqlcode THEN
             CALL cl_err3("ins","ahb_file",g_aha.aha00,g_ahb[l_ac].ahb02,SQLCA.sqlcode,"","",1)  #No.FUN-660123
             CANCEL INSERT
          ELSE
             MESSAGE 'INSERT O.K'
             COMMIT WORK
          ...
          SELECT SUM(ahb07) INTO l_aha11 FROM ahb_file,aag_file
           WHERE ahb01 = g_aha.aha01
             AND ahb00 = g_aha.aha00
             AND ahb000= g_aha.aha000
             AND ahb06 = '1'
             AND ahb03 = aag01
             AND ahb00 = aag00   #No.FUN-740033
          ...
          IF l_aha11 IS NULL OR l_aha11 =' ' THEN LET l_aha11 = 0 END IF
          IF l_aha12 IS NULL OR l_aha12 =' ' THEN LET l_aha12 = 0 END IF
          ...
          IF NOT cl_null(g_ahb[l_ac].ahb03) THEN
             ...
             IF NOT cl_null(g_errno) THEN
               ...
               #LET g_ahb[l_ac].ahb03=g_ahb_t.ahb03
                ...
                LET g_qryparam.arg1 = g_aha.aha00  #No.FUN-740033
               ...
               #End Mod No.FUN-B10048
                ...
                NEXT FIELD ahb03
             END IF
             SELECT aag05,aag15,aag16,aag17,aag18,aag151,aag161,aag171,aag181,aag21,aag23,
 
                    aag31,aag32,aag33,aag34,aag35,aag36,aag37,
                    aag311,aag321,aag331,aag341,aag351,aag361,aag371
 
               INTO l_aag05,l_aag15,l_aag16,l_aag17,l_aag18,l_aag151,l_aag161,
       ...
       AFTER FIELD ahb05
          SELECT aag05 INTO l_aag05 FROM aag_file
            WHERE aag01 = g_ahb[l_ac].ahb03
              AND aag00 = g_aha.aha00  #No.FUN-740033
          IF l_aag05='Y' THEN
             IF cl_null(g_ahb[l_ac].ahb05) THEN NEXT FIELD ahb05 END IF
          END IF
          IF g_ahb[l_ac].ahb05 IS NOT NULL THEN
             ...
             END IF
          END IF
          IF l_aag05 = 'Y' THEN   #TQC-620028
             CALL s_chkdept(g_aaz.aaz72,g_ahb[l_ac].ahb03,g_ahb[l_ac].ahb05,g_aha.aha00)  #No.FUN-740033
                  RETURNING g_errno
             IF not cl_null(g_errno) THEN
                CALL cl_err('',g_errno,0)
                NEXT FIELD  ahb05
             ...
             IF g_ahb[l_ac].ahb06 = '1' THEN
                SELECT SUM(ahb07) INTO l_aha11 FROM ahb_file,aag_file
                 WHERE ahb01 = g_aha.aha01
                   ...
                   AND ahb00 = aag00  #No.FUN-740033
                   AND aag09 NOT IN ('N','n')
                  #AND ahb02 <> l_ac                       #MOD-C20222 mark
                   AND ahb02 <> g_ahb[l_ac].ahb02          #MOD-C20222 add
                IF SQLCA.sqlcode OR l_aha11 IS NULL THEN LET l_aha11 = 0 END IF
                LET l_aha11 = l_aha11 + g_ahb[l_ac].ahb07
                IF l_aha11 > 100 THEN 
                   CALL cl_err('','agl-019',1) 
                   NEXT FIELD ahb07
                END IF
             ELSE
                SELECT SUM(ahb07) INTO l_aha12 FROM ahb_file,aag_file
                 WHERE ahb01 = g_aha.aha01
                  ...
                  #AND ahb02 <> l_ac                       #MOD-C20222 mark
                   AND ahb02 <> g_ahb[l_ac].ahb02          #MOD-C20222 add
                IF SQLCA.sqlcode OR l_aha12 IS NULL THEN LET l_aha12 = 0 END IF
                LET l_aha12 = l_aha12 + g_ahb[l_ac].ahb07
                IF l_aha12 > 100 THEN
                   CALL cl_err('','agl-019',1) 
                   NEXT FIELD ahb07
                END IF
       ...
       BEFORE FIELD ahb11
         CALL i720_show_ahe02(l_aag15)
 
       AFTER FIELD ahb11
          CALL s_chk_aee(g_ahb[l_ac].ahb03,'1',g_ahb[l_ac].ahb11,g_aha.aha00)  #No.FUN-740033
          IF NOT cl_null(g_errno) THEN
       ...
       BEFORE FIELD ahb12
         CALL i720_show_ahe02(l_aag16)
 
       AFTER FIELD ahb12
           CALL s_chk_aee(g_ahb[l_ac].ahb03,'2',g_ahb[l_ac].ahb12,g_aha.aha00)  #No.FUN-740033
           IF NOT cl_null(g_errno) THEN
              CALL cl_err('',g_errno,1)
              NEXT FIELD ahb12
           END IF
       ...
       BEFORE FIELD ahb13
         CALL i720_show_ahe02(l_aag17)
 
       AFTER FIELD ahb13
           CALL s_chk_aee(g_ahb[l_ac].ahb03,'3',g_ahb[l_ac].ahb13,g_aha.aha00)  #No.FUN-740033
           IF NOT cl_null(g_errno) THEN
              CALL cl_err('',g_errno,1)
              NEXT FIELD ahb13
           END IF
       ...
       BEFORE FIELD ahb14
         CALL i720_show_ahe02(l_aag18)
 
       AFTER FIELD ahb14
           CALL s_chk_aee(g_ahb[l_ac].ahb03,'4',g_ahb[l_ac].ahb14,g_aha.aha00)  #No.FUN-740033
          IF NOT cl_null(g_errno) THEN
             CALL cl_err('',g_errno,1)
             NEXT FIELD ahb14
          END IF
        ...
        BEFORE FIELD ahb31
          CALL i720_show_ahe02(l_aag31)
 
        AFTER FIELD ahb31
           CALL s_chk_aee(g_ahb[l_ac].ahb03,'5',g_ahb[l_ac].ahb31,g_aha.aha00)  #No.FUN-740033
           IF NOT cl_null(g_errno) THEN
              CALL cl_err('',g_errno,1)
              NEXT FIELD ahb31
           END IF
        ...
        BEFORE FIELD ahb32
          CALL i720_show_ahe02(l_aag32)
 
        AFTER FIELD ahb32
           CALL s_chk_aee(g_ahb[l_ac].ahb03,'6',g_ahb[l_ac].ahb32,g_aha.aha00)  #No.FUN-740033
           IF NOT cl_null(g_errno) THEN
              CALL cl_err('',g_errno,1)
              NEXT FIELD ahb32
           END IF
        ...
        BEFORE FIELD ahb33
          CALL i720_show_ahe02(l_aag33)
 
        AFTER FIELD ahb33
           CALL s_chk_aee(g_ahb[l_ac].ahb03,'7',g_ahb[l_ac].ahb33,g_aha.aha00)  #No.FUN-740033
           IF NOT cl_null(g_errno) THEN
              CALL cl_err('',g_errno,1)
              NEXT FIELD ahb33
           END IF
        ...
        BEFORE FIELD ahb34
          CALL i720_show_ahe02(l_aag34)
 
        AFTER FIELD ahb34
           CALL s_chk_aee(g_ahb[l_ac].ahb03,'8',g_ahb[l_ac].ahb34,g_aha.aha00)  #No.FUN-740033
           IF NOT cl_null(g_errno) THEN
              CALL cl_err('',g_errno,1)
              NEXT FIELD ahb34
           END IF
        ...
        BEFORE FIELD ahb37
          CALL i720_show_ahe02(l_aag37)
 
        AFTER FIELD ahb37
           CALL s_chk_aee(g_ahb[l_ac].ahb03,'99',g_ahb[l_ac].ahb37,g_aha.aha00)  #No.FUN-740033
           IF NOT cl_null(g_errno) THEN
              CALL cl_err('',g_errno,1)
              NEXT FIELD ahb37
           END IF
       ...
       BEFORE DELETE                            #是否取消單身
          IF g_ahb_t.ahb02 > 0 AND g_ahb_t.ahb02 IS NOT NULL THEN
             ...
             #*****特別處理:將單身之借方比率及貸方比率加總後UPDATE到單頭的
             #借方比率、貸方比率*********
             #若為非貨幣性科目則不作累計值
             SELECT SUM(ahb07) INTO l_aha11 FROM ahb_file,aag_file
              WHERE ahb01 = g_aha.aha01
             ...
             UPDATE aha_file SET aha11 = l_aha11,
                                 aha12 = l_aha12
              WHERE aha00 = g_aha.aha00
                AND aha000= g_aha.aha000
                AND aha01 = g_aha.aha01
             LET g_aha.aha11 = l_aha11
             LET g_aha.aha12 = l_aha12
             DISPLAY BY NAME g_aha.aha11,g_aha.aha12
             NEXT FIELD ahb02
          ...
          ELSE
             UPDATE ahb_file SET ahb02 = g_ahb[l_ac].ahb02,
               ...
               WHERE ahb000 = g_aha.aha000
                 ...
                 AND ahb02 = g_ahb_t.ahb02
             IF SQLCA.sqlcode THEN
                 CALL cl_err3("upd","ahb_file",g_aha.aha00,g_aha.aha01,SQLCA.sqlcode,"","",1)  #No.FUN-660123
                 LET g_ahb[l_ac].* = g_ahb_t.*
             ELSE
                 MESSAGE 'UPDATE O.K'
                 COMMIT WORK
       ...
       AFTER ROW
        ...
        AFTER INPUT
             IF g_aha.aha11 > 0 AND g_aha.aha11 != 100 THEN
                CALL cl_err('','agl-019',1)
                NEXT FIELD ahb03
             END IF
             IF g_rec_b > 0 THEN
                ...
                SELECT COUNT(*) INTO l_cnt FROM ahd_file
                   WHERE ahd00 = g_aha.aha00 AND
                         ahd000 = g_aha.aha000 AND
                         ahd01 = g_aha.aha01
                IF l_cnt > 0 THEN
                   DECLARE ahd_c1 CURSOR FOR SELECT ahd03 FROM ahd_file
                      WHERE ahd00 = g_aha.aha00 AND
                            ahd000 = g_aha.aha000 AND
                            ahd01 = g_aha.aha01
                   FOREACH ahd_c1 INTO l_ahd03
                       LET l_chr = 'N'
                       FOR i=1 TO g_rec_b
                           IF l_ahd03 = g_ahb[i].ahb03 AND
                              g_aha.aha13 <> g_ahb[i].ahb06 THEN
                              LET l_chr = 'Y'
                           END IF
                       END FOR
                       IF l_chr = 'N' THEN
                          CALL cl_err('','agl-091',1)
                          NEXT FIELD ahb03
                       END IF
                   END FOREACH
                END IF
       ...
       ON ACTION CONTROLP
          CASE
             ...
             WHEN INFIELD(ahb11)    #查詢異動碼-1
                  CALL s_ahe_qry(g_ahb[l_ac].ahb03,'1','i',g_ahb[l_ac].ahb11,g_aha.aha00)  #No.FUN-740033
                     RETURNING g_ahb[l_ac].ahb11
                  DISPLAY g_ahb[l_ac].ahb11 TO ahb11
                  NEXT FIELD ahb11
 
             WHEN INFIELD(ahb12)    #查詢異動碼-2
                  CALL s_ahe_qry(g_ahb[l_ac].ahb03,'2','i',g_ahb[l_ac].ahb12,g_aha.aha00)  #No.FUN-740033
                     RETURNING g_ahb[l_ac].ahb12
                  DISPLAY g_ahb[l_ac].ahb12 TO ahb12
                  NEXT FIELD ahb12
 
             WHEN INFIELD(ahb13)    #查詢異動碼-3
                  CALL s_ahe_qry(g_ahb[l_ac].ahb03,'3','i',g_ahb[l_ac].ahb13,g_aha.aha00)  #No.FUN-740033
                     RETURNING g_ahb[l_ac].ahb13
                  DISPLAY g_ahb[l_ac].ahb13 TO ahb13
                  NEXT FIELD ahb13
 
             WHEN INFIELD(ahb14)    #查詢異動碼-4
                  CALL s_ahe_qry(g_ahb[l_ac].ahb03,'4','i',g_ahb[l_ac].ahb14,g_aha.aha00)  #No.FUN-740033
                     RETURNING g_ahb[l_ac].ahb14
                  DISPLAY g_ahb[l_ac].ahb14 TO ahb14
                  NEXT FIELD ahb14
 
             WHEN INFIELD(ahb31)    #查詢異動碼-5
                  CALL s_ahe_qry(g_ahb[l_ac].ahb03,'5','i',g_ahb[l_ac].ahb31,g_aha.aha00)  #No.FUN-740033
                     RETURNING g_ahb[l_ac].ahb31
                  DISPLAY g_ahb[l_ac].ahb31 TO ahb31
                  NEXT FIELD ahb31
 
             WHEN INFIELD(ahb32)    #查詢異動碼-6
                  CALL s_ahe_qry(g_ahb[l_ac].ahb03,'6','i',g_ahb[l_ac].ahb32,g_aha.aha00)  #No.FUN-740033
                     RETURNING g_ahb[l_ac].ahb32
                  DISPLAY g_ahb[l_ac].ahb32 TO ahb32
                  NEXT FIELD ahb32
 
             WHEN INFIELD(ahb33)    #查詢異動碼-7
                  CALL s_ahe_qry(g_ahb[l_ac].ahb03,'7','i',g_ahb[l_ac].ahb33,g_aha.aha00)  #No.FUN-740033
                     RETURNING g_ahb[l_ac].ahb33
                  DISPLAY g_ahb[l_ac].ahb33 TO ahb33
                  NEXT FIELD ahb33
 
             WHEN INFIELD(ahb34)    #查詢異動碼-8
                  CALL s_ahe_qry(g_ahb[l_ac].ahb03,'8','i',g_ahb[l_ac].ahb34,g_aha.aha00)  #No.FUN-740033
             ...
             WHEN INFIELD(ahb37)    #查詢關係人異動碼
                  CALL s_ahe_qry(g_ahb[l_ac].ahb03,'99','i',g_ahb[l_ac].ahb37,g_aha.aha00)  #No.FUN-740033
      ...
      ON ACTION addno
         SELECT COUNT(*) INTO l_cnt FROM ahb_file
          WHERE ahb000= g_aha.aha000
            ...
            AND ahb00 = g_aha.aha00
            AND ahb02 >= g_ahb[l_ac].ahb02
         DECLARE ahb_cl CURSOR FOR SELECT ahb02 FROM ahb_file
           WHERE ahb00 = g_aha.aha00 AND ahb01 = g_aha.aha01 AND
                 ahb000 = aha.aha000 AND ahb02 >= g_ahb[l_ac].ahb02
           ORDER BY  1 DESC
...
FUNCTION i720_delall()
    ...
    IF g_cnt = 0 THEN 			# 未輸入單身資料, 故取消單頭資料
       ...
       ERROR g_msg CLIPPED
       DELETE FROM aha_file WHERE aha00 = g_aha.aha00 AND aha01 = g_aha.aha01  #No.FUN-740033
                              AND aha000 = '2'
    END IF
END FUNCTION
 
#檢查科目名稱
FUNCTION  i720_ahb03(p_cmd)
DEFINE
    p_cmd           LIKE type_file.chr1,          #No.FUN-680098 VARCHAR(1)
    l_aag07         LIKE aag_file.aag07,
...
FUNCTION i720_ahb11(p_cmd,p_seq,p_key) 
...
DEFINE
    ...
    l_oldno0,l_newno0  LIKE aha_file.aha00   #No.FUN-740033
    ...
    CALL i720_set_no_entry('a')
    CALL i720_set_required()      #MOD-9C0396 add
    CALL i720_set_no_required()   #MOD-9C0396 add
    LET g_before_input_done = TRUE
    CALL cl_set_head_visible("","YES")    #No.FUN-6B0029 
 
    INPUT l_newno0,l_newno FROM aha00,aha01  #No.FUN-740033
        AFTER FIELD aha00
            IF l_newno0 IS NOT NULL THEN
               CALL i720_aha00('a',l_newno0)
               IF NOT cl_null(g_errno) THEN
        ...
        AFTER FIELD aha01
            ...
            END IF
            SELECT count(*) INTO g_cnt FROM aha_file
                WHERE aha01 = l_newno AND aha00 = l_newno0 AND  #No.FUN-740033
                      aha000 = '2'
            IF g_cnt > 0 THEN
    ...
    IF INT_FLAG THEN
        LET INT_FLAG = 0
        DISPLAY BY NAME g_aha.aha01,g_aha.aha00  #No.FUN-740033
        ROLLBACK WORK
        RETURN
    END IF
    LET l_aha.* = g_aha.*
    LET l_aha.aha01  =l_newno   #新的鍵值
    LET l_aha.aha00  =l_newno0  #新的鍵值  #No.FUN-740033
    ...
    DECLARE i720_cs3 CURSOR FOR
            SELECT * FROM ahb_file
                   WHERE ahb00 = g_aha.aha00 AND ahb01 = g_aha.aha01 AND  #No.FUN-740033
                         ahb000 = g_aha.aha000
    FOREACH i720_cs3 INTO l_ahb.*
    IF SQLCA.sqlcode THEN EXIT FOREACH END IF
    ...
    LET l_ahb.ahb00 = l_newno0  #No.FUN-740033
    LET l_ahb.ahblegal = g_legal  ##FUN-980003 add legal
    INSERT INTO ahb_file VALUES(l_ahb.*)
    IF SQLCA.sqlcode THEN
       CALL cl_err3("ins","ahb_file",l_newno,l_newno0,SQLCA.sqlcode,"","ahd:",1) # NO. FUN-660123  #No.FUN-740033
    END IF
    END FOREACH
    MESSAGE '(',g_cnt USING '##&',') ROW of (',l_newno,') O.K'
 
    #比率科目的維護檔(ahd_file)
    DECLARE i720_cs2  CURSOR FOR
            SELECT * FROM ahd_file
                   WHERE ahd00 = g_aha.aha00 AND ahd01 = g_aha.aha01 AND  #No.FUN-740033
                         ahd000 = g_aha.aha000
    FOREACH i720_cs2 INTO l_ahd.*
    IF SQLCA.sqlcode THEN EXIT FOREACH END IF
    LET l_ahd.ahd01 = l_newno
    LET l_ahd.ahd00 = l_newno0   #No.FUN-740033
    INSERT INTO ahd_file VALUES(l_ahd.*)
    IF SQLCA.sqlcode THEN
       CALL cl_err3("ins","ahd_file",l_ahd.ahd01,l_ahd.ahd02,SQLCA.sqlcode,"","ahd:",1)# NO.FUN-660123 
    END IF
    END FOREACH
 
    LET l_oldno = g_aha.aha01
    LET l_oldno0= g_aha.aha00  #No.FUN-740033
    ...
    #                     aha00 = l_oldno0 AND  #No.FUN-740033
    #                     aha000 = g_aha.aha000
    #CALL i720_show()
    #FUN-C30027---end
END FUNCTION
...
FUNCTION i720_set_entry(p_cmd)
  DEFINE p_cmd   LIKE type_file.chr1          #No.FUN-680098  VARCHAR(1)
    ...
    IF p_cmd = 'a' AND ( NOT g_before_input_done ) THEN
      CALL cl_set_comp_entry("aha01,aha00",TRUE)  #No.FUN-740033
    END IF
 
    IF INFIELD(aha08) THEN
...
FUNCTION i720_set_no_entry(p_cmd)
  DEFINE p_cmd   LIKE type_file.chr1          #No.FUN-680098  VARCHAR(1)
    ...
    IF p_cmd = 'u' AND g_chkey = 'N' AND ( NOT g_before_input_done ) THEN
       CALL cl_set_comp_entry("aha01,aha00",FALSE)  #No.FUN-740033
    END IF
 
    IF INFIELD(aha08) THEN
       IF g_aha.aha08 ="1" THEN
       ELSE
          CALL cl_set_comp_entry("aha10",FALSE)
       END IF
    END IF
 
    IF INFIELD(ahamksg) THEN
...
FUNCTION i720_set_required()
    CALL cl_set_comp_required("ahasign",TRUE)
END FUNCTION
...
FUNCTION i720_set_entry_b()
 
       CALL cl_set_comp_entry("ahb05,ahb11,ahb12,ahb13,ahb14",TRUE)   #No.MOD-4C0038
...
DEFINE
    ...
    sr              RECORD
        aha00       LIKE aha_file.aha00,   #原始編號
        ...
        aha11       LIKE aha_file.ahamksg, #借方比率
        aha12       LIKE aha_file.ahasign, #貸方比率
   ...
   END IF
    ...
    SELECT zz17,zz05 INTO g_len,g_zz05 FROM zz_file WHERE zz01 = 'agli720'
    LET g_sql="SELECT aha00,aha01,aha02,aha03,aha04,aha05,aha06,aha07,",  #No.FUN-740033
              "aha08,aha10,aha11,aha12,ahamksg,ahasign,",    #No.FUN-830139
              "ahb02,ahb03,ahb04,ahb05,ahb06,ahb07,ahb08,",
              "ahb11,ahb12,ahb13,ahb14,",
              ...
              " aha00 = aha00 AND aha000 = '2' AND ahb000 = '2' ",
              " AND ",g_wc2 CLIPPED,
              " ORDER BY aha00,aha01 "  #No.FUN-740033
    PREPARE i720_p1 FROM g_sql                # RUNTIME 編譯
    DECLARE i720_co CURSOR FOR i720_p1
 
    FOREACH i720_co INTO sr.*
        IF SQLCA.sqlcode THEN
           CALL cl_err('foreach:',SQLCA.sqlcode,1)
           EXIT FOREACH
        END IF
        LET l_str = ' '                                                         
        DECLARE i720_hd1_cs CURSOR FOR                                          
          SELECT ahd03,ahd04 FROM ahd_file                                      
            WHERE ahd00 = sr.aha00 AND  #No.FUN-740033                          
                  ahd01 = sr.aha01 AND                                          
                  ahd000 = '2'                                                  
        FOREACH i720_hd1_cs INTO l_ahd03,l_ahd04                                
          IF SQLCA.sqlcode THEN EXIT FOREACH END IF                             
          IF NOT cl_null(l_ahd04) THEN                                          
             LET l_ahd03=l_ahd03 CLIPPED,'(',l_ahd04 CLIPPED,')'                
          END IF                                                                
        ...
        LET l_str = ' '                                                         
        DECLARE i720_hd2_cs CURSOR FOR                                          
          SELECT ahd03,ahd04 FROM ahd_file                                      
            WHERE ahd00 = sr.aha00 AND  #No.FUN-740033                          
                  ahd01 = sr.aha01 AND                                          
                  ahd000 = '2'                                                  
        FOREACH i720_hd2_cs INTO l_ahd03,l_ahd04                                
          IF SQLCA.sqlcode THEN EXIT FOREACH END IF                             
          IF NOT cl_null(l_ahd04) THEN                                          
             LET l_ahd03=l_ahd03 CLIPPED,'(',l_ahd04 CLIPPED,')'                
          END IF                                                                
...
#FUN-B50105   ---end     Add
        ...
        EXECUTE insert_prep USING sr.aha00,sr.aha01,sr.aha02,sr.aha03,          
                                  sr.aha06,sr.aha05,sr.aha07,sr.aha11,          
                                  sr.aha08,sr.aha10,sr.aha12,          
                                  sr.aha04,sr.ahamksg,sr.ahasign,l_str,sr.ahaacti,
                                  sr.ahb02,sr.ahb03,sr.ahb04,sr.ahb05,          
                                  sr.ahb06,sr.ahb07,sr.ahb08,                   
                                  l_tc1,l_tc2,l_tc3,                            
    ...
    IF g_zz05 = 'Y' THEN                                                        
       CALL cl_wcchp(g_wc,'aha00,aha01,aha02,aha03,aha05,aha06,aha04,aha07,     
                      aha13,aha08,aha10,ahamksg,ahasign,                  
                      ahauser,ahagrup,ahamodu,ahadate,ahaacti,ahb02,ahb03,      
                      ahb05,ahb06,ahb07,ahb15,ahb08,ahb11,ahb12,ahb13,ahb14,    
                      ahb31,ahb32,ahb33,ahb34,ahb35,ahb36,ahb37,ahb04')         
            RETURNING g_str                                                     
    END IF                                                                      
    LET g_str = g_str,";",g_aaz.aaz88,";",g_chr,";",g_azi04,";",g_aaz.aaz125   #FUN-B50105 Add ,";",g_aaz.aaz125
    LET l_sql = "SELECT * FROM ", g_cr_db_str CLIPPED, l_table CLIPPED          
    CALL cl_prt_cs3('agli720','agli720',l_sql,g_str)                            
END FUNCTION
 
FUNCTION  i720_show_field()
#依參數決定異動碼的多寡
...
FUNCTION i720_set_no_required_b()   #MOD-9C0396 mod
   CALL cl_set_comp_required("ahb05,ahb08,ahb11,ahb12,ahb13,ahb14,  #No.MOD-930170 add ahb05,ahb08
                              ahb31,ahb32,ahb33,ahb34,ahb35,ahb36,ahb37",FALSE)
END FUNCTION
 
FUNCTION i720_set_required_b()   #MOD-9C0396 mod
DEFINE    l_aag05         LIKE aag_file.aag05,
          l_aag151        LIKE aag_file.aag151,
          l_aag161        LIKE aag_file.aag161,
          l_aag171        LIKE aag_file.aag171,
          ...
          l_aag361        LIKE aag_file.aag361,
          l_aag371        LIKE aag_file.aag371,
          l_aag21         LIKE aag_file.aag21,   #No.MOD-930170
          l_aag23         LIKE aag_file.aag23    #No.MOD-930170
...
FUNCTION i720_show_ahe02(p_code)
...
FUNCTION i720_aha00(p_cmd,p_aha00)
...
FUNCTION i720_aha07(p_cmd,p_aha07)
  DEFINE p_cmd     LIKE type_file.chr1
