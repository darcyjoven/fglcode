...
# Modify.........: No.TQC-840022 08/07/15 By lala  aglg002在打印時候只抓取前五個下層公司的資料，后面的子公司資料與前五個一樣
...
# Modify.........: No.MOD-A40165 10/04/28 By sabrina (1)AFTER INPUT後不需再CALL g002_get_aaz641
...
# Modify.........: No.FUN-B90027 11/08/04 By fengrui  程式撰寫規範修正
# Modify.........: No:FUN-B90070 11/09/13 By belle 列印出多個上層公司並以不同上層公司為分頁列印
# Modify.........: No:FUN-B90027 11/09/20 By Wangning 明細CR報表轉GR
# Modify.........: No:FUN-B90027 12/01/05 By qirl FUN-B80057追单
# Modify.........: No:FUN-B90027 12/01/13 By xuxz FUN-BA0006(FUN-BA0012(FUN-B50001))追單
# Modify.........: No.TQC-C50042 12/05/07 By zhangweib 修改開窗q_mai去除報表性質為5\6的資料
# Modify.........: No:FUN-C50007 12/05/11 by minpp GR程序优化
...
DEFINE g_aaz641      LIKE aaz_file.aaz641   #MOD-970037 add   #FUN-B50001 #FUN-B90027(FUN-B50001 rollback)
#DEFINE g_aaw01       LIKE aaw_file.aaw01 #FUN-B90027(FUN-B50001 rollback)
DEFINE g_axa05       LIKE axa_file.axa05    #FUN-A90032
#DEFINE g_aaw         RECORD LIKE aaw_file.* #FUN-B50001 #FUN-B90027(FUN-B50001 rollback)
DEFINE g_aaz         RECORD LIKE aaz_file.* #FUN-B90027(FUN-B50001 rollback)
...
TYPE sr1_t RECORD
    ...
    l_amount1 LIKE aah_file.aah04,
    l_amount2 LIKE aah_file.aah04,
    l_amount3 LIKE aah_file.aah04,
    l_amount4 LIKE aah_file.aah04,
    l_amount5 LIKE aah_file.aah04,
    l_amount6 LIKE aah_file.aah04,
    l_amount7 LIKE aah_file.aah04,
    l_amount8 LIKE aah_file.aah04,
    l_amount9 LIKE aah_file.aah04,
    l_amount10 LIKE aah_file.aah04,
    l_axa02 LIKE axa_file.axa02,
    l_class LIKE type_file.num5
END RECORD
###GENGRE###END
...
MAIN
   ...
   IF (NOT cl_setup("AGL")) THEN
      EXIT PROGRAM
   END IF
   #CALL cl_used(g_prog,g_time,1) RETURNING g_time #No.FUN-690114#FUN-B90027 mark
 
  # SELECT * INTO g_aaw.* FROM aaw_file WHERE aaw00 = '0'#FUN-B90027(FUN-B50001 rollback )
...
#No.FUN-870029 -- begin --
   ...
   LET l_table = cl_prt_temptable('aglg002',g_sql) CLIPPED
   IF l_table = -1 THEN
...
#No.FUN-870029 -- end --
  ...
  #DROP TABLE g002_file
#FUN-680098-BEGIN
CREATE TEMP TABLE g002_file(
...
#FUN-680098-END
   CALL cl_used(g_prog,g_time,1) RETURNING g_time #FUN-B90027 add
  ...
  #IF cl_null(tm.ver) THEN LET tm.ver = '00' END IF   #FUN-760044 add #寫死抓版?0的資料 #FUN-950048 mark
   ...
   IF cl_null(g_bgjob) OR g_bgjob = 'N' THEN   # If background job sw is off
      CALL g002_tm()                           # Input print condition
   ELSE
      CALL g002()
   END IF
   DROP TABLE temp_wc
...
FUNCTION g002_tm()
   ...
   OPEN WINDOW g002_w AT p_row,p_col WITH FORM "agl/42f/aglg002"
...
#                   tm.yy,tm.bm,tm.em,tm.f,tm.d,tm.c,tm.e,tm.more    #FUN-6C0012
       INPUT BY NAME tm.rtype,tm.axa01,tm.axa02,tm.axa03,tm.a,tm.b,
                    tm.yy,tm.em,tm.q1,tm.h1,tm.f,tm.d,tm.c,tm.e,tm.more
#FUN-A90032 --End
          	  WITHOUT DEFAULTS
         #No.FUN-580031 --start--
         BEFORE INPUT
...
#FUN-A90032 --End        
        ...
        #FUN-950048--end--add--
         ...
         AFTER FIELD a
            CALL g002_set_no_entry()   #FUN-A90032
           ...
           #LET g_sql = "SELECT mai02,mai03 FROM ",g_dbs_axz03,"mai_file",  #FUN-A50102
            LET g_sql = "SELECT mai02,mai03 FROM ",cl_get_target_table(g_plant_new,'mai_file'), #FUN-A50102
                       ...
                       #"   AND mai00 = '",tm.axa03,"'",     #MOD-A40008      #MOD-A70035 mark
                        "   AND mai00 = '",g_aaz641,"'",     #MOD-A40008      #MOD-A70035   #FUN-B50001 #FUN-B90027(FUN-B50001 rollback)
                        #"   AND mai00 = '",g_aaw01,"'",   #FUN-B90027(FUN-B50001 rollback)
                        "   AND maiacti IN ('Y','y')"
            CALL cl_replace_sqldb(g_sql) RETURNING g_sql   #FUN-A50102         
            CALL cl_parse_qry_sql(g_sql,g_plant_new) RETURNING g_sql   #FUN-A50102 
            PREPARE g002_pre FROM g_sql
            DECLARE g002_cur CURSOR FOR g002_pre
            OPEN g002_cur
            FETCH g002_cur INTO g_mai02,g_mai03
           #FUN-930076---mod---end---
            IF STATUS THEN 
...
#              CALL cl_err('sel axa:',STATUS,0)   #No.FUN-660123
           ...
           #FUN-A30122-------------------add start---------------------------- 
            ...
            CALL s_get_aaz641(g_plant_axz03) RETURNING g_aaz641       #FUN-B50001 #FUN-B90027(FUN-B50001 rollback)        
            #CALL s_get_aaz641(g_plant_axz03) RETURNING g_aaw01 #FUN-B90027(FUN-B50001 rollback)
            LET g_plant_new = g_plant_axz03 
            LET tm.b = g_aaz641    #FUN-B50001     #FUN-B90027(FUN-B50001 rollback)                                        
            #LET tm.b = g_aaw01 #FUN-B90027(FUN-B50001 rollback)
...
#            IF tm.bm > tm.em THEN CALL cl_err('','9011',0) NEXT FIELD bm END IF   #FUN-A90032 mark
         ...
         AFTER INPUT
           ...
           #CALL g002_get_aaz641()   #MOD-970037 add   #MOD-A40165 mark
           #--FUN-A90032 start--
...
#                 CALL FGL_DIALOG_SETBUFFER( tm.a )
                 ...
                 #LET g_qryparam.where = "mai00 = '",g_aaz641,"'"      #MOD-A40008     #MOD-A70035  #FUN-B50001 #FUN-B90027(FUN-B50001 rollback)  #No.TQC-C50042  Mark
                 #LET g_qryparam.arg1 = l_dbs              #FUN-930076 mod #MOD-B30067 mark
                 #LET g_qryparam.where = "mai00 = '",tm.axa03,"'"      #MOD-A40008     #MOD-A70035 mark 
                 #LET g_qryparam.where = "mai00 = '",g_aaw01,"'"    #FUN-B50001 #FUN-B90027(FUN-B50001 rollback)
...
#                 NEXT FIELD axa01
     ...
     END INPUT
     IF INT_FLAG THEN
        LET INT_FLAG = 0 CLOSE WINDOW g002_w 
        CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690114
        CALL cl_gre_drop_temptable(l_table)                     #FUN-B90027
        EXIT PROGRAM
     ...
     IF g_bgjob = 'Y' THEN
        ...
        ELSE
           ...
           CALL cl_cmdat('aglg002',g_time,l_cmd)    # Execute cmd at later time
        END IF
        CLOSE WINDOW g002_w
        CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690114
        CALL cl_gre_drop_temptable(l_table)                     #FUN-B90027
...
#   SELECT zz17,zz05 INTO g_len,g_zz05 FROM zz_file WHERE zz01 = 'aglg002'   #FUN-6C0012
#   IF g_len = 0 OR g_len IS NULL THEN LET g_len = 223 END IF                #FUN-6C0012
 #FUN-6C0012.....begin
   SELECT zz05 INTO g_zz05 FROM zz_file WHERE zz01 = 'aglg002'
   IF tm.e = 'Y' THEN
 ...
 #FUN-6C0012.....end
   ...
   CASE WHEN tm.rtype='1' LET g_msg=" SUBSTRING(maj23,1,1)='1'"   #no.FUN-750076 oracle不接受此種寫法
        WHEN tm.rtype='2' LET g_msg=" SUBSTRING(maj23,1,1)='2'"   #no.FUN-750076
 ...
 # LET l_sql = "SELECT * FROM maj_file",                  #No.FUN-920200 mark
  #LET l_sql = "SELECT * FROM ",g_dbs_axz03,"maj_file",   #No.FUN-920200 add  #FUN-A50102
   ...
   PREPARE g002_p FROM l_sql
   IF STATUS THEN CALL cl_err('prepare:',STATUS,1) 
      CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690114
      CALL cl_gre_drop_temptable(l_table)                     #FUN-B90027
      EXIT PROGRAM 
   END IF
   DECLARE g002_c CURSOR FOR g002_p
...
#MOD-830214-add-end
   ...
   END FOR
#  CALL cl_outnam('aglg002') RETURNING l_name   #FUN-B90027 mark
  ...
  #            "  ORDER BY 1,2,3,4 "
  #end FUN-580063
   CALL g002_create_temp_table()
   LET g_flag_1 = 'N'
   LET g_j = 1
   CALL g002_p(g_j)
   LET l_sql = "SELECT axa02,class FROM g002_tmp WHERE axa02 = axb04"
   PREPARE g002_axa_p_1 FROM l_sql 
   DECLARE g002_axa_c_1 CURSOR FOR g002_axa_p_1

   #FUN-C50007--ADD--STR
   LET l_sql = "SELECT axa01,axa02,axa03,axb04,axb05",
                  "  FROM g002_tmp",
                  " WHERE axa02 = ? "
      PREPARE g002_axa_p FROM l_sql
      IF STATUS THEN CALL cl_err('prepare:',STATUS,1)
         CALL cl_used(g_prog,g_time,2) RETURNING g_time 
         CALL cl_gre_drop_temptable(l_table)                     
         EXIT PROGRAM
      END IF
      DECLARE g002_axa_c CURSOR FOR g002_axa_p

   DECLARE tmp_curs CURSOR FOR
      SELECT * FROM g002_file ORDER BY maj02,no
   #FUN-C50007--ADD--END
   FOREACH g002_axa_c_1 INTO l_axa02,l_class
     #FUN-C50007---MARK--STR 
     #LET l_sql = "SELECT axa01,axa02,axa03,axb04,axb05",
     #            "  FROM g002_tmp",
     #            " WHERE axa02 = '",l_axa02,"'"
     ...
     #FUN-C50007--MARK--END
      LET g_no = 1
     #FOREACH g002_axa_c INTO g_dept[g_no].*              #FUN-C50007  MARK
      FOREACH g002_axa_c USING l_axa02 INTO g_dept[g_no].*  #FUN-C50007 ADD
          IF SQLCA.SQLCODE THEN
     ...
     #控制一次印十個族群---------------------------------
      ...
      FOR l_i = 5 TO l_cnt STEP 10  #CHI-A50047
         ...
         #No.FUN-870029 -- end --
         #No.FUN-890102 -- start --      
          #LET l_name1='g002_',l_i/5 USING '&&&','.out'
          #LET l_cmd2 = 'chmod 777 ',l_name1    #MOD-580055
          #RUN l_cmd2   #MOD-580055
          #START REPORT g002_rep TO l_name1
          #LET g_pageno = 0
         #No.FUN-890102 -- end --
          LET g_cn = 1  #No.TQC-5A0080
          DELETE FROM g002_file
          LET m_dept = ''
   ...
   ##                             ' ',g_dept[l_cn+g_group].azp02[1,14]
                ...
                #CALL g002_process(l_cn+g_group)           #FUN-B90070 mark #TQC-840022
                 CALL g002_process(l_cn+g_group,l_axa02)   #FUN-B90070
   ...
   ##                             ' ',g_dept[l_cn+g_group].azp02[1,14]
                ...
                #CALL g002_process(l_cn+g_group)           #FUN-B90070
                 CALL g002_process(l_cn+g_group,l_axa02)   #FUN-B90070
            ...
            #aglg002@1 = 調整或銷除(D)     aglg002@2 = 調整或銷除(C)
            #aglg002@3 = 會計師調整(D)     aglg002@4 = 會計師調整(C)
            #aglg002@5 = 合併後
            #-----------------------------------------------------
             #CASE g_cn MOD 5  #CHI-A50047 mark
             CASE g_no MOD 10 #CHI-A50047
               WHEN 1 LET sr2.l_dept2 = "aglg002@1"  LET sr2.l_dept3 = "aglg002@2"
                      LET sr2.l_dept4 = "aglg002@3"  LET sr2.l_dept5 = "aglg002@4"
                      LET sr2.l_dept6 = "aglg002@5"
               WHEN 2 LET sr2.l_dept3 = "aglg002@1"  LET sr2.l_dept4 = "aglg002@2"
                      LET sr2.l_dept5 = "aglg002@3"  LET sr2.l_dept6 = "aglg002@4"
                      LET sr2.l_dept7 = "aglg002@5"
               WHEN 3 LET sr2.l_dept4 = "aglg002@1"  LET sr2.l_dept5 = "aglg002@2"
                      LET sr2.l_dept6 = "aglg002@3"  LET sr2.l_dept7 = "aglg002@4"
                      LET sr2.l_dept8 = "aglg002@5"
               WHEN 4 LET sr2.l_dept5 = "aglg002@1"  LET sr2.l_dept6 = "aglg002@2"
                      LET sr2.l_dept7 = "aglg002@3"  LET sr2.l_dept8 = "aglg002@4"
                      LET sr2.l_dept9 = "aglg002@5"
              #CHI-A50047 mark --start--
              # WHEN 0 LET sr2.l_dept6 = "aglg002@1"  LET sr2.l_dept7 = "aglg002@2"
              #        LET sr2.l_dept8 = "aglg002@3"  LET sr2.l_dept9 = "aglg002@4"
              #        LET sr2.l_dept10= "aglg002@5"
              #CHI-A50047 mark --end--
               #CHI-A50047 add --start--
               WHEN 0 LET sr2.l_dept1 = "aglg002@1"  LET sr2.l_dept2 = "aglg002@2"
                      LET sr2.l_dept3 = "aglg002@3"  LET sr2.l_dept4 = "aglg002@4"
                      LET sr2.l_dept5 = "aglg002@5"
               WHEN 5 LET sr2.l_dept6 = "aglg002@1"  LET sr2.l_dept7 = "aglg002@2"
                      LET sr2.l_dept8 = "aglg002@3"  LET sr2.l_dept9 = "aglg002@4"
                      LET sr2.l_dept10 = "aglg002@5"
               OTHERWISE
                      LET sr2.l_dept1 = "aglg002@1"  LET sr2.l_dept2 = "aglg002@2"
                      LET sr2.l_dept3 = "aglg002@3"  LET sr2.l_dept4 = "aglg002@4"
                      LET sr2.l_dept5 = "aglg002@5"
               #CHI-A50047 add --end--
             END CASE
   ...
   #No.FUN-870029 -- END --
              ...
              IF cl_null(sr2.l_dept1) THEN LET sr2.l_dept1 = 'aglg002@0' END IF
              IF cl_null(sr2.l_dept2) THEN LET sr2.l_dept2 = 'aglg002@0' END IF
              IF cl_null(sr2.l_dept3) THEN LET sr2.l_dept3 = 'aglg002@0' END IF
              IF cl_null(sr2.l_dept4) THEN LET sr2.l_dept4 = 'aglg002@0' END IF
              IF cl_null(sr2.l_dept5) THEN LET sr2.l_dept5 = 'aglg002@0' END IF
              IF cl_null(sr2.l_dept6) THEN LET sr2.l_dept6 = 'aglg002@0' END IF
              IF cl_null(sr2.l_dept7) THEN LET sr2.l_dept7 = 'aglg002@0' END IF
              IF cl_null(sr2.l_dept8) THEN LET sr2.l_dept8 = 'aglg002@0' END IF
              IF cl_null(sr2.l_dept9) THEN LET sr2.l_dept9 = 'aglg002@0' END IF
              IF cl_null(sr2.l_dept10) THEN LET sr2.l_dept10 = 'aglg002@0' END IF
   ...
   #           END IF
   #          #end MOD-860204 add
   #           OUTPUT TO REPORT g002_rep(sr.maj02,sr.maj03,sr.maj04,sr.maj05,
   #                                     sr.maj07,sr.maj20,sr.maj20e,l_str)
            END IF
         END FOREACH
    
   #      FINISH REPORT g002_rep   #No.FUN-870029 
         CLOSE tmp_curs
   #No.FUN-870029 -- begin -- 
   #      ###結合報表
   #     IF l_i/5 = 1 THEN
   ...
   #No.FUN-870029 -- begin --
                  #p1      #p2             #p3         
###GENGRE###      LET g_str = " ;",    g_aaz.aaz77,";",g_mai02,";",
###GENGRE###                  #p4      #p5                    #p6
###GENGRE###                  tm.a,";",tm.yy USING '<<<<',";",tm.bm USING'&&',";",
###GENGRE###                  #p7                 #p8      #p9
###GENGRE###                  tm.em USING'&&',";",tm.d,";",tm.e      #,";",  #FUN-950048
                  #p10
                  #tm.ver   #FUN-950048 mark
###GENGRE###      LET g_sql = "SELECT * FROM ",g_cr_db_str CLIPPED,l_table CLIPPED
   END FOREACH #FUN-B90070 
###GENGRE###   CALL cl_prt_cs3('aglg002','aglg002',g_sql,g_str)
    CALL aglg002_grdata()    ###GENGRE###
#No.FUN-870029 -- end --
...
#FUNCTION g002_process(l_cn)         #FUN-B90070 mark
FUNCTION g002_process(l_cn,l_axa02)  #FUN-B90070
   ...
   DEFINE l_amt5,l_amt6        LIKE type_file.num20_6  #CHI-A70012 add 本期損益(aaw06)換匯分錄使用
   ...
   DEFINE l_axa02              LIKE axa_file.axa02     #FUN-B90070
    ...
    PREPARE g002_sum FROM l_sql
    DECLARE g002_sumc CURSOR FOR g002_sum
...
#No.MOD-860241 --end
         #-MOD-A40008-end- 
         #OPEN g002_sumc USING tm.b,maj.maj21,maj.maj22,tm.yy,tm.bm,g_mm     #MOD-A40008 mark
         #OPEN g002_sumc USING g_aaz641,maj.maj21,maj.maj22,tm.yy,tm.bm,g_mm #FUN-A90032 mark
          OPEN g002_sumc USING g_aaz641,maj.maj21,maj.maj22,tm.yy,g_mm       #FUN-A90032 remark  #FUN-B50001 #FUN-B90027(FUN-B50001 rollback)
          #OPEN g002_sumc USING g_aaw01,maj.maj21,maj.maj22,tm.yy,g_mm    #FUN-B90027(FUN-B50001 rollback)
          FETCH g002_sumc INTO amt1
          IF STATUS THEN CALL cl_err('fetch #1',STATUS,1) EXIT FOREACH END IF
          IF cl_null(amt1) THEN LET amt1 = 0 END IF
 
         #str FUN-770069 add 10/19
         #各子公司呈現(g_axz08)累換數(aaw04)、本期損益(aaw06),僅取換匯(axi09 = 'Y') #CHI-A70012 add

          #累積換算調整數(g_aaz.aaw04)要另外抓分錄(axj_file)裡的金額來show
          IF maj.maj21 = g_aaz.aaz87 OR maj.maj22 = g_aaz.aaz87 THEN   #FUN-B50001 #FUN-B90027(FUN-B50001 rollback)
          #IF maj.maj21 = g_aaw.aaw04 OR maj.maj22 = g_aaw.aaw04 THEN #FUN-B90027(FUN-B50001 rollback)
             #借方金額合計
...
#               AND axi04 BETWEEN tm.bm AND tm.em   #MOD-A40008 remark #FUN-A90032 mark
               ...
               #AND axi05=tm.axa01 AND axi06=tm.axa02 AND axi07=tm.axa03     #FUN-B90070 mark
                AND axi05=tm.axa01 AND axi06=l_axa02 AND axi07=tm.axa03      #FUN-B90070 mod
            #   AND axi00=tm.axa03   #FUN-760053   #MOD-970037 mark
                AND axi00=g_aaz641   #FUN-760053   #MOD-970037   #FUN-B50001 #FUN-B90027(FUN-B50001 rollback)
                #AND axi00=g_aaw01 #FUN-B90027(FUN-B50001 rollback)
                AND axi00=axj00      #FUN-760053
...
#               AND axi04 BETWEEN tm.bm AND tm.em   #MOD-A40008 remark #FUN-A90032 mark
         ...
         #ELSE     #MOD-970037 mark
          ...
          #各子公司呈現(g_axz08)累換數(aaw04)、本期損益(aaw06),取換匯(axi09 = 'Y')

          IF maj.maj21 = g_aaz.aaz114 OR maj.maj22 = g_aaz.aaz114 THEN   #FUN-B50001 #FUN-B90027(FUN-B50001 rollback)
          #IF maj.maj21 = g_aaw.aaw06 OR maj.maj22 = g_aaw.aaw06 THEN #FUN-B90027(FUN-B50001 rollback)
             #借方金額合計 
...
#               AND axi04 BETWEEN tm.bm AND tm.em   #FUN-A90032 mark
               ...
               #AND axi05=tm.axa01 AND axi06=tm.axa02 AND axi07=tm.axa03   #FUN-B90070
                ...
                AND axi00=g_aaz641    #FUN-B50001  #FUN-B90027(FUN-B50001 rollback)
                #AND axi00=g_aaw01 #FUN-B90027(FUN-B50001 rollback)
                AND axi00=axj00     
                AND axj05=g_axz08  
                AND axiconf ='Y' 
...
#               AND axi04 BETWEEN tm.bm AND tm.em   #MOD-A40008 remark #FUN-A90032 mark
                ...
                AND axi05 = tm.axa01
               #AND axi06 = tm.axa02  #FUN-B90070 mark
                AND axi06 = l_axa02   #FUN-B90070
                AND axi07 = tm.axa03
                AND axi08<>'3'       #MOD-850172 add   #調整與銷除
            #   AND axi00 = tm.axa03 #FUN-760053   #MOD-970037 mark
                AND axi00 = g_aaz641 #FUN-760053   #MOD-970037   #FUN-B50001 #FUN-B90027(FUN-B50001 rollback)
                #AND axi00 = g_aaw01 #FUN-B90027(FUN-B50001 rollback)
                AND axi00 = axj00    #FUN-760053
               #AND axi21 = tm.ver   #FUN-770069 add  #FUN-950048 mark
                AND axiconf ='Y' #FUN-A30011
                AND ((axj03 != g_aaz.aaz87) OR ((axj03 = g_aaz.aaz87) AND (axj05 IS NULL OR axj05 = ' ')))    #MOD-A40188  #FUN-B50001  #FUN-B90027(FUN-B50001 rollback)
                #AND ((axj03 != g_aaw.aaw04) OR ((axj03 = g_aaw.aaw04) AND (axj05 IS NULL OR axj05 = ' ')))    #FUN-B90027(FUN-B50001 rollback)
             IF STATUS OR l_count=0 THEN
                LET l_dc_amt=0
             ELSE
                #借方金額合計
...
#                  AND axi04 BETWEEN tm.bm AND tm.em   #MOD-A40008 remark #FUN-A90032 mark
               ...
               #   AND axi00=tm.axa03   #FUN-760053   #MOD-970037 mark
                   ...
                   AND axi08<>'3'       #MOD-850172 add   #調整與銷除
                  #AND axi21=tm.ver     #FUN-770069 add #FUN-950048 mark
                   AND ((axj03 != g_aaz.aaz87) OR ((axj03 = g_aaz.aaz87) AND (axj05 IS NULL OR axj05 = ' ')))    #MOD-A40188 add    #FUN-B50001 #FUN-B90027(FUN-B50001 rollback)
                   #AND ((axj03 != g_aaw.aaw04) OR ((axj03 = g_aaw.aaw04) AND (axj05 IS NULL OR axj05 = ' ')))  #FUN-B90027(FUN-B50001 rollback)
                   AND axiconf ='Y' #FUN-A30011
                IF cl_null(l_d_amt) THEN LET l_d_amt=0 END IF
                #貸方金額合計
...
#                  AND axi04 BETWEEN tm.bm AND tm.em   #MOD-A40008 remark #FUN-A90032 mark
        ...
        #CHI-A70012 add --start--
             ##-->沖銷分錄(D/C)
             #本期損益(g_aaz.aaw06)另抓分錄(axj_file)裡的金額來show,
...
#                   AND axi04 BETWEEN tm.bm AND tm.em   #FUN-A90032 mark
          ...
          #沖銷分錄呈現累換數(g_aaz.aaw04)要抓分錄(axj_file)裡axi09= 'N' 的金額來show
         #調整(D)或消除(C)累換數(aaw04)依借貸分別呈現 
           IF maj.maj21 = g_aaz.aaz87 OR maj.maj22 = g_aaz.aaz87 THEN   #FUN-B50001#FUN-B90027(FUN-B50001 rollback)
           #IF maj.maj21 = g_aaw.aaw04 OR maj.maj22 = g_aaw.aaw04 THEN#FUN-B90027(FUN-B50001 rollback)
              LET l_d_amt = 0  LET l_c_amt = 0
...
#                  AND axi04 BETWEEN tm.bm AND tm.em   #MOD-A40008 remark #FUN-A90032 mark
	  ...
	  IF maj.maj03 = '%' THEN
	     ...
	     SELECT bal1 INTO l_sun FROM g002_file WHERE no=l_cn
	            AND maj02=l_temp
	     LET l_temp = maj.maj22
	     SELECT bal1 INTO l_mon FROM g002_file WHERE no=l_cn
	            AND maj02=l_temp
...
#         CALL cl_err('ins g002_file',STATUS,1)   #No.FUN-660123
          CALL cl_err3("ins","g002_file",l_cn,maj.maj02,STATUS,"","ins g002_file",1)   #No.FUN-660123
          EXIT FOREACH 
       END IF
    END FOREACH
   #-MOD-A40008-add- 
...
#  PREPARE g002_pre_01 FROM g_sql
#  DECLARE g002_cur_01 CURSOR FOR g002_pre_01
#  OPEN g002_cur_01
#  FETCH g002_cur_01 INTO g_aaz641   #合併帳別
#
#END FUNCTION
#end MOD-970037 add
#MDO-A40165---mark---end---
...
#-----END MOD-6A0037-----
#FUN-B90070--Begin--
FUNCTION g002_create_temp_table()
   DROP TABLE g002_tmp
   CREATE TEMP TABLE g002_tmp(
   axa01  LIKE axa_file.axa01,
   axa02  LIKE axa_file.axa02,
   axa03  LIKE axa_file.axa03,
   axb04  LIKE axb_file.axb04,
   ...
   WHILE g_flag_1 = 'N'
     ...
     IF p_i = 1 THEN  #找第一階
        LET l_sql = " SELECT axa01,axa02,axa03,axa02,axa03",
                    ...
                    "  WHERE axa01='",tm.axa01,"'",
                    "    AND axa02='",tm.axa02,"' AND axa03='",tm.axa03,"' "
        PREPARE g002_p1 FROM l_sql
        IF STATUS THEN CALL cl_err('prepare:',STATUS,1) 
           CALL cl_used(g_prog,g_time,2) RETURNING g_time
           CALL cl_gre_drop_temptable(l_table)                     #FUN-B90027
           EXIT PROGRAM 
        END IF
        DECLARE g002_c1 CURSOR FOR g002_p1
        FOREACH g002_c1 INTO l_axa01,l_axa02,l_axa03,l_axb04,l_axb05
           INSERT INTO g002_tmp VALUES (l_axa01,l_axa02,l_axa03,l_axb04,l_axb05,1)
        END FOREACH
     ELSE
        LET l_j = g_j-1
        LET l_sql = "SELECT axb04 FROM g002_tmp",
                    " WHERE class = '",l_j,"'"
        PREPARE g002_p2 FROM l_sql
        IF STATUS THEN CALL cl_err('prepare:',STATUS,1) 
           CALL cl_used(g_prog,g_time,2) RETURNING g_time 
           CALL cl_gre_drop_temptable(l_table)                     #FUN-B90027
           EXIT PROGRAM 
        END IF
        DECLARE g002_c2 CURSOR FOR g002_p2
      ...
      #FUN-C50007--ADD--STR
       LET l_sql = " SELECT axa01,axa02,axa03,axa02,axa03",
              ...
              PREPARE g002_p4 FROM l_sql
              IF STATUS THEN CALL cl_err('prepare:',STATUS,1)
                 CALL cl_used(g_prog,g_time,2) RETURNING g_time
                 CALL cl_gre_drop_temptable(l_table)                     #FUN-B90027
                 EXIT PROGRAM
              END IF
              DECLARE g002_c4 CURSOR FOR g002_p4
           ...
           LET l_sql = " SELECT axa01,axa02,axa03,axb04,axb05",
                       ...
                       "    AND axa01='",tm.axa01,"'",
                       "    AND axa02= ? AND axa03='",tm.axa03,"' "
           PREPARE g002_p3 FROM l_sql
           IF STATUS THEN CALL cl_err('prepare:',STATUS,1)
              CALL cl_used(g_prog,g_time,2) RETURNING g_time
              CALL cl_gre_drop_temptable(l_table)                     #FUN-B90027
              EXIT PROGRAM
           END IF
           DECLARE g002_c3 CURSOR FOR g002_p3
      #FUN-C50007--ADD--END
  
        FOREACH g002_c2 INTO l_axb02
           LET l_axa01 = " "
           LET l_axa02 = " "
           LET l_axa03 = " "
           LET l_axb04 = " "
           ...
           IF l_j>1 THEN
             ...
             #OPEN g002_c4
             #FUN-C50007--MARK--END
              OPEN g002_c4 USING l_axb02         #FUN-C50007  ADD
              FETCH g002_c4 INTO l_axa01,l_axa02,l_axa03,l_axb04,l_axb05
              IF NOT cl_null(l_axa01) THEN
                 INSERT INTO g002_tmp VALUES (l_axa01,l_axa02,l_axa03,l_axb04,l_axb05,l_j)
              END IF
              CLOSE g002_c4
             #FOREACH g002_c4 INTO l_axa01,l_axa02,l_axa03,l_axb04,l_axb05
             #   INSERT INTO g002_tmp VALUES (l_axa01,l_axa02,l_axa03,l_axb04,l_axb05,l_j)
             #END FOREACH
           END IF
          #FUN-C50007---MARK--STR
          ...
          #END IF
          #DECLARE g002_c3 CURSOR FOR g002_p3
          # FOREACH g002_c3 INTO l_axa01,l_axa02,l_axa03,l_axb04,l_axb05
          #FUN-C50007---MARK--end
            FOREACH g002_c3 USING l_axb02 INTO l_axa01,l_axa02,l_axa03,l_axb04,l_axb05  #FUN-C50007 ADD
              INSERT INTO g002_tmp VALUES (l_axa01,l_axa02,l_axa03,l_axb04,l_axb05,g_j)
           END FOREACH
        END FOREACH
     END IF     
...
FUNCTION aglg002_grdata()
    ...
    WHILE TRUE
        ...
        LET handler = cl_gre_outnam("aglg002")
        IF handler IS NOT NULL THEN
            START REPORT aglg002_rep TO XML HANDLER handler
            LET l_sql = "SELECT * FROM ",g_cr_db_str CLIPPED,l_table CLIPPED
          
            DECLARE aglg002_datacur1 CURSOR FROM l_sql
            FOREACH aglg002_datacur1 INTO sr1.*
                OUTPUT TO REPORT aglg002_rep(sr1.*)
            END FOREACH
            FINISH REPORT aglg002_rep
        END IF
