...
DEFINE g_argv1          LIKE cdm_file.cdm00            #FUN-C90002
   OPTIONS                              
      INPUT NO WRAP                    
   DEFER INTERRUPT                    
   
   LET g_argv1=ARG_VAL(1)                      #FUN-C90002
  ...
  ##FUN-C90002---mark----str
  #LET g_forupd_sql = "SELECT * FROM cdm_file WHERE cdm01 = ? AND cdm02 = ? AND cdm03 = ? AND cdm04 = ? FOR UPDATE"
...
#    FROM  cdm_file WHERE cdm01 = g_cdm_h.cdm01 AND cdm02 = g_cdm_h.cdm02 AND cdm03 = g_cdm_h.cdm03 AND cdm04 = g_cdm_h.cdm04 
#  IF SQLCA.sqlcode THEN
...
#                     " FROM cdm_file",
#                     " WHERE cdm01=? AND cdm02=? AND cdm03 = ? AND cdm04 = ? AND cdm05 = ? AND cdm06 = ?  FOR UPDATE"
#  LET g_forupd_sql = cl_forupd_sql(g_forupd_sql)
...
#  LET g_success ='Y'
#  CALL p326_gl(g_cdm_h.cdm04,g_cdm_h.cdm02,g_cdm_h.cdm03,g_cdm_h.cdm01)
#  IF g_success ='N' THEN 
#     RETURN  
#  END IF 
#  MESSAGE " "
...
#EFINE l_flg    LIKE type_file.chr1
