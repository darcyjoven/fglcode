...
#               " ORDER BY cdl01,cdl02,cdl03,cdl04,cdl09 "
   LET l_sql = " SELECT ?,?,?,?, ima39,'', je ",
               "   FROM (SELECT ima39,SUM(je) je ",
               "           FROM (SELECT ima39,SUM(ta_ccc22a4)-SUM(ta_ccc42) je FROM cxcq901_file ",
               "                  WHERE ta_ccc02 = ? AND ta_ccc03 = ? AND ima39 IN(140201,140301,140302,1405,1407,140901,140902,140903,140904,160102,160103,160104,160105,160106) GROUP BY ima39 ",
               "                 UNION ALL ",
               "                 SELECT ima39,SUM(zrje)-SUM(zfje) je FROM cxcq906_file ",
               "                  WHERE ta_ccc02 = ? AND ta_ccc03 = ? AND ima39 IN(140201,140301,140302,1405,1407,140901,140902,140903,140904,160102,160103,160104,160105,160106) GROUP BY ima39 ",
               "                ) GROUP BY ima39 ",
               "          UNION ALL ",
               "         SELECT ima39,SUM(je) je ",
               "           FROM (SELECT '500101' ima39,SUM(ta_ccc217 * ta_cccud07)+SUM(TA_CCC81 * ta_cccud07) je FROM ta_ccp_file ",
               "                  WHERE ta_ccc02 = ? AND ta_ccc03 = ? AND INSTR(ta_ccc01, '.') > 0 ",
               "                  UNION ALL ",
               "                 SELECT '500101' ima39,SUM(ta_ccc217b+ta_ccc81b) je FROM cxcq905_file ", 
               "                  WHERE ta_ccc02 = ? AND ta_ccc03 = ?) GROUP BY ima39 ",
               "          UNION ALL ",
               "         SELECT '500102' ima39,SUM(ta_ccc217c+ta_ccc81c) je FROM cxcq905_file WHERE ta_ccc02 = ? AND ta_ccc03 = ? ",
               "         UNION ALL ",
               "        SELECT '500103' ima39,SUM(ta_ccc217d+ta_ccc81d) je FROM cxcq905_file WHERE ta_ccc02 = ? AND ta_ccc03 = ? ",
               "         UNION ALL ",
               "        SELECT '500104' ima39,SUM(ta_ccc217e+ta_ccc81e) je FROM cxcq905_file WHERE ta_ccc02 = ? AND ta_ccc03 = ?) "
...
#      LET l_npq.npq35 = ' '
   ...
   FOREACH p324_c5 USING  l_cdl.cdl01,l_cdl.cdl02,l_cdl.cdl03,l_cdl.cdl04,
   	                      l_cdl.cdl02,l_cdl.cdl03,l_cdl.cdl02,l_cdl.cdl03,l_cdl.cdl02,l_cdl.cdl03,l_cdl.cdl02,l_cdl.cdl03,l_cdl.cdl02,l_cdl.cdl03,l_cdl.cdl02,l_cdl.cdl03,l_cdl.cdl02,l_cdl.cdl03
