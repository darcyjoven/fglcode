...
# Modify.........: No:FUN-D40128 13/05/16 By wangrr 欄位"產品分類"增加開窗
...
GLOBALS "../../config/top.global"
   ...
   DEFINE tm  RECORD
              ...
              ima131  LIKE ima_file.ima131,         #No.FUN-680122CHAR(04)             #產品分類 
              a       LIKE type_file.chr1,          #No.FUN-680122CHAR(01)     #是否依產品分類第一碼作彙總
              ...
              dec     LIKE type_file.chr1,          #No.FUN-680122CHAR(01)      #金額單位(1)元(2)千(3)萬
	  ...
	  g_bookno             LIKE type_file.chr2,          #No.FUN-680122CHAR(2)
          ...
          g_ary DYNAMIC ARRAY OF RECORD          #被選擇之工廠
                plant      LIKE type_file.chr10,        #No.FUN-680122CHAR(08) #No.TQC-6A0079
                dbs_new    LIKE type_file.chr21         #No.FUN-680122CHAR(21)
                END RECORD ,
           g_tmp DYNAMIC ARRAY OF RECORD          #被選擇之工廠
                p          LIKE type_file.chr10,        #No.FUN-680122CHAR(08) #No.TQC-6A0079
...
MAIN
   ...
   LET g_sql = "item.ccg_file.ccg04,",
          ...
          #     "qty1.ima_file.ima26,",#FUN-A20044
             ...
             #  "qty2.ima_file.ima26,",#FUN-A20044
               ...
               "amt2.ima_file.ima32,",
               "ccz27.ccz_file.ccz27,", #FUN-D30060
               "ccz26.ccz_file.ccz26"   #FUN-D30060
 
   LET l_table = cl_prt_temptable('axcx859',g_sql) CLIPPED   # 產生Temp Table
   IF l_table = -1 THEN EXIT PROGRAM END IF                  # Temp Table產生
   LET g_sql = "INSERT INTO ",g_cr_db_str CLIPPED,l_table CLIPPED,
           #    " VALUES(?,?,?,?,?, ?,?) "    #No.FUN-7C0101
               " VALUES(?,?,?,?,?, ?,?,?,?,?) "   #No.FUN-7C0101 #FUN-D30060 add 2?
   ...
   IF cl_null(g_bgjob) OR g_bgjob = 'N' 
      THEN CALL x859_tm(0,0)        
      ELSE CALL x859()             
   END IF
   CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690125 BY dxfwo 
END MAIN
 
FUNCTION x859_tm(p_row,p_col)
DEFINE lc_qbe_sn      LIKE gbm_file.gbm01   #No.FUN-580031
   ...
   END IF
   OPEN WINDOW x859_w AT p_row,p_col WITH FORM "axc/42f/axcx859" 
         ATTRIBUTE (STYLE = g_win_style CLIPPED) #No.FUN-580092 HCN
    
   CALL cl_ui_init()
 
   CALL cl_opmsg('p')
   CALL x859_set_visible() RETURNING l_cnt    #FUN-A70084
...
WHILE TRUE
   ...
   IF INT_FLAG THEN LET INT_FLAG = 0 CLOSE WINDOW x859_w 
      CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690125 BY dxfwo 
      EXIT PROGRAM 
   END IF
         ...
         AFTER FIELD plant_1
             ...
             ELSE
                IF NOT cl_null(tm.plant_1) THEN
                   ...
                   IF NOT x859_chkplant(tm.plant_1) THEN
         ...
         AFTER FIELD plant_2
             ...
             ELSE
                IF NOT cl_null(tm.plant_2) THEN
                               # 檢查工廠並將新的資料庫放在g_dbs_new
                   IF NOT x859_chkplant(tm.plant_2) THEN
             ...
             IF NOT cl_null(tm.plant_2) THEN
                IF NOT x859_chklegal(m_legal[2],1) THEN
                   CALL cl_err(tm.plant_2,g_errno,0)
                   NEXT FIELD plant_2
                END IF
             END IF
         ...
         AFTER FIELD plant_3
             ...
             ELSE
                IF NOT cl_null(tm.plant_3) THEN
                               # 檢查工廠並將新的資料庫放在g_dbs_new
                   IF NOT x859_chkplant(tm.plant_3) THEN
             ...
             #FUN-A70084--add--str--檢查所錄入PLANT在同一法人下
             IF NOT cl_null(tm.plant_3) THEN
                IF NOT x859_chklegal(m_legal[3],2) THEN
                   CALL cl_err(tm.plant_3,g_errno,0)
                   NEXT FIELD plant_3
                END IF
             END IF
         ...
         AFTER FIELD plant_4
             ...
             ELSE
                IF NOT cl_null(tm.plant_4) THEN
                               # 檢查工廠並將新的資料庫放在g_dbs_new
                   IF NOT x859_chkplant(tm.plant_4) THEN
             ...
             #FUN-A70084--add--str--檢查所錄入PLANT在同一法人下
             IF NOT cl_null(tm.plant_4) THEN
                IF NOT x859_chklegal(m_legal[4],3) THEN
                   CALL cl_err(tm.plant_4,g_errno,0)
                   NEXT FIELD plant_4
                END IF
             END IF
         ...
         AFTER FIELD plant_5
             ...
             ELSE
                IF NOT cl_null(tm.plant_5) THEN
                               # 檢查工廠並將新的資料庫放在g_dbs_new
                   IF NOT x859_chkplant(tm.plant_5) THEN
             ...
             #FUN-A70084--add--str--檢查所錄入PLANT在同一法人下
             IF NOT cl_null(tm.plant_5) THEN
                IF NOT x859_chklegal(m_legal[5],4) THEN
                   CALL cl_err(tm.plant_5,g_errno,0)
                   NEXT FIELD plant_5
                END IF
             END IF
         ...
         AFTER FIELD plant_6
             ...
             ELSE
                IF NOT cl_null(tm.plant_6) THEN
                               # 檢查工廠並將新的資料庫放在g_dbs_new
                   IF NOT x859_chkplant(tm.plant_6) THEN
             ...
             #FUN-A70084--add--str--檢查所錄入PLANT在同一法人下
             IF NOT cl_null(tm.plant_6) THEN
                IF NOT x859_chklegal(m_legal[6],5) THEN
                   CALL cl_err(tm.plant_6,g_errno,0)
                   NEXT FIELD plant_6
                END IF
             END IF
         ...
         AFTER FIELD plant_7
             ...
             ELSE
                IF NOT cl_null(tm.plant_7) THEN
                               # 檢查工廠並將新的資料庫放在g_dbs_new
                   IF NOT x859_chkplant(tm.plant_7) THEN
             ...
             #FUN-A70084--add--str--檢查所錄入PLANT在同一法人下
             IF NOT cl_null(tm.plant_7) THEN
                IF NOT x859_chklegal(m_legal[7],6) THEN
                   CALL cl_err(tm.plant_7,g_errno,0)
                   NEXT FIELD plant_7
                END IF
             END IF
         ...
         AFTER FIELD plant_8
             ...
             ELSE
                IF NOT cl_null(tm.plant_8) THEN
                               # 檢查工廠並將新的資料庫放在g_dbs_new
                   IF NOT x859_chkplant(tm.plant_8) THEN
             ...
             #FUN-A70084--add--str--檢查所錄入PLANT在同一法人下
             IF NOT cl_null(tm.plant_8) THEN
                IF NOT x859_chklegal(m_legal[8],7) THEN
                   CALL cl_err(tm.plant_8,g_errno,0)
                   NEXT FIELD plant_8
                END IF
             END IF
   ...
   IF g_bgjob = 'Y' THEN
      ...
      ELSE
         LET l_cmd = l_cmd CLIPPED,        #(at time fglgo xxxx p1 p2 p3)
                         ...
                         " '",g_template  CLIPPED,"'",
                         " '",g_bookno  CLIPPED,"'"
         CALL cl_cmdat('axcx859',g_time,l_cmd)    # Execute cmd at later time
      END IF
...
FUNCTION x859()
   ...
   END IF
   PREPARE x859_prepare1 FROM l_sql
   IF SQLCA.sqlcode != 0 THEN 
      CALL cl_err('prepare1:',SQLCA.sqlcode,1) 
      CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690125 BY dxfwo 
      EXIT PROGRAM 
   END IF
   DECLARE x859_curs1 CURSOR FOR x859_prepare1
 
   LET g_pageno = 0
   LET l_flag=null
   LET l_item=null
   LET l_ccg04=null
   FOREACH x859_curs1 INTO l_cta.*
      ...
      EXECUTE insert_prep USING
             ...
             ,g_ccz.ccz27,g_ccz.ccz26  #FUN-D30060
   END FOREACH
...
###XtraGrid###   LET l_sql = "SELECT * FROM ",g_cr_db_str CLIPPED,l_table CLIPPED   #FUN-710080 modify
   ...
   ELSE
      LET g_str = " "
   END IF
###XtraGrid###   LET g_str = g_str,";",tm.a,";",tm.yy1_b,";",tm.mm1_b,";",
###XtraGrid###                         tm.mm1_e,";",tm.plant_1,";",
###XtraGrid###                         tm.plant_2,";",tm.plant_3,";",tm.plant_4,";",
###XtraGrid###                         tm.plant_5,";",tm.plant_6,";",tm.plant_7,";",
###XtraGrid###                         #tm.plant_8,";",g_ccz.ccz27,";",g_azi03,";",tm.type    #FUN-710080 modify   #No.FUN-7C0101 add tm.type #CHI-C30012
###XtraGrid###                         tm.plant_8,";",g_ccz.ccz27,";",g_ccz.ccz26,";",tm.type #CHI-C30012
   IF tm.type MATCHES '[12]' THEN
###XtraGrid###      CALL cl_prt_cs3('axcx859','axcx859_1',l_sql,g_str)
      LET g_xgrid.visible_column = cl_xg_column_visible(g_xgrid.visible_column,"ccg07","N")
   END IF
   IF tm.type MATCHES '[345]' THEN
###XtraGrid###      CALL cl_prt_cs3('axcx859','axcx859',l_sql,g_str)
      LET g_xgrid.visible_column = cl_xg_column_visible(g_xgrid.visible_column,"ccg07","Y")
   END IF
   LET g_xgrid.table = l_table    ###XtraGrid###
   #FUN-D30060--add--str--
   LET g_xgrid.footerinfo1=cl_getmsg('axm-751',g_lang),':',tm.yy1_b,'/',tm.mm1_b USING '<<','-',tm.mm1_e USING '<<'
   LET g_xgrid.footerinfo2='DATA FROM:',tm.plant_1,' ',tm.plant_2,' ',tm.plant_3,' ',
...
LET g_tname='x859_tmp'                          #No.TQC-980163 mod
...
#FUN-A10098---END
 	 ...
 	 CALL cl_replace_sqldb(tmp_sql) RETURNING tmp_sql        #FUN-920032
         #CALL cl_parse_qry_sql(tmp_sql,g_ary[g_idx].plant) RETURNING tmp_sql  #FUN-A10098  #TQC-BB0182 mark
          PREPARE x859_prepare2 FROM tmp_sql
          EXECUTE x859_prepare2
          IF SQLCA.sqlcode != 0 THEN 
...
#FUN-A10098---END
 	 ...
 	 CALL cl_replace_sqldb(tmp_sql) RETURNING tmp_sql        #FUN-920032
       #CALL cl_parse_qry_sql(tmp_sql,g_ary[g_idx].plant) RETURNING tmp_sql  #FUN-A10098  #TQC-BB0182 mark
        PREPARE x859_prepare10 FROM tmp_sql
        EXECUTE x859_prepare10
        IF SQLCA.sqlcode != 0 THEN 
            CALL cl_err('prepare2:',SQLCA.sqlcode,1) 
...
#FUN-A10098---END
 	 ...
 	 CALL cl_replace_sqldb(tmp_sql) RETURNING tmp_sql        #FUN-920032
         #CALL cl_parse_qry_sql(tmp_sql,g_ary[g_idx].plant) RETURNING tmp_sql  #FUN-A10098  #TQC-BB0182 mark
          PREPARE x859_prepare3 FROM tmp_sql
          EXECUTE x859_prepare3
          IF SQLCA.sqlcode != 0 THEN 
...
FUNCTION get_dpm()
  DEFINE l_wc     LIKE type_file.chr1000,       #No.FUN-680122CHAR(300)
    ...
    LET g_tname1='x859_tmp1'                            #No.TQC-980163 mod
...
#FUN-A10098---END
 	 ...
 	 CALL cl_replace_sqldb(tmp_sql) RETURNING tmp_sql        #FUN-920032
       #CALL cl_parse_qry_sql(tmp_sql,g_ary[g_idx].plant) RETURNING tmp_sql  #FUN-A10098  #TQC-BB0182 mark
        PREPARE x859_predpm FROM tmp_sql 
        EXECUTE x859_predpm
          IF SQLCA.sqlcode != 0 THEN 
...
#FUN-A10098---END
 	 ...
 	 CALL cl_replace_sqldb(tmp_sql) RETURNING tmp_sql        #FUN-920032
      #CALL cl_parse_qry_sql(tmp_sql,g_ary[g_idx].plant) RETURNING tmp_sql  #FUN-A10098  #TQC-BB0182 mark 
       PREPARE x859_pregsl FROM tmp_sql
       EXECUTE x859_pregsl
       IF SQLCA.sqlcode != 0 THEN 
...
#FUN-A10098---END
 	 ...
 	 CALL cl_replace_sqldb(tmp_sql) RETURNING tmp_sql        #FUN-920032
      #CALL cl_parse_qry_sql(tmp_sql,g_ary[g_idx].plant) RETURNING tmp_sql  #FUN-A10098   #TQC-BB0182 mark
       PREPARE x859_predae FROM tmp_sql
        EXECUTE x859_predae
          IF SQLCA.sqlcode != 0 THEN 
           # EXECUTE del_dpm
...
#FUN-A10098---END
 	 ...
 	 CALL cl_replace_sqldb(tmp_sql) RETURNING tmp_sql        #FUN-920032
      #CALL cl_parse_qry_sql(tmp_sql,g_ary[g_idx].plant) RETURNING tmp_sql  #FUN-A10098  #TQC-BB0182 mark
        PREPARE x859_predac FROM tmp_sql
        EXECUTE x859_predac
          IF SQLCA.sqlcode != 0 THEN 
    ...
    PREPARE x859_union FROM tmp_sql
      IF SQLCA.sqlcode != 0 THEN 
    ...
    DECLARE union_cur CURSOR FOR x859_union
...
#傳回值 - 字串起始位置
FUNCTION x859_getStartPos(l_sta,l_end,l_str)
...
FUNCTION x859_chkplant(l_plant)
 DEFINE l_plant     LIKE azp_file.azp01
...
FUNCTION x859_chklegal(l_legal,n)
