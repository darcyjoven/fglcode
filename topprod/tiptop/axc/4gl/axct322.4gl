...
# Modify.........: No.FUN-C80094 12/08/28 By minpp 将axct322改为销货成本分录（cdj00='1'）和发出商品转出分录(cdj00='3')共同调用的作业，通过cdj00区分
DATABASE ds
...
#DEFINE p_row,p_col      LIKE type_file.num5  
 DEFINE g_argv1          LIKE cdj_file.cdj00     #FUN-C80094
   OPTIONS                              
      INPUT NO WRAP                    
   DEFER INTERRUPT                    

   LET g_argv1=ARG_VAL(1)                      #FUN-C80094
...
#      RETURNING l_time
   ...
   CALL t322('1')                       #FUN-C80094
#FUN-C80094--MARK--STR
#  LET g_forupd_sql = "SELECT * FROM cdj_file WHERE cdj01 = ? AND cdj02 = ? AND cdj03 = ? AND cdj04 = ? FOR UPDATE"
...
#QBE 查詢資料
#FUNCTION t322_cs()
#EFINE   l_type      LIKE apa_file.apa00    
#EFINE   l_dbs       LIKE type_file.chr21  
#EFINE   lc_qbe_sn   LIKE gbm_file.gbm01  
#
#  CLEAR FORM                             #清除畫面
#  CALL g_cdj.clear()
...
#FUNCTION t322_menu()
#EFINE l_ccz12    LIKE ccz_file.ccz12
#EFINE l_npptype  LIKE npp_file.npptype
#
#  WHILE TRUE
#     CALL t322_bp("G")
...
#        END IF
#        FETCH ABSOLUTE g_jump t322_cs INTO g_cdj_h.cdj01
#        LET mi_no_ask = FALSE
#  END CASE
#
#  IF SQLCA.sqlcode THEN
...
#    FROM  cdj_file WHERE cdj01 = g_cdj_h.cdj01 AND cdj02 = g_cdj_h.cdj02 AND cdj03 = g_cdj_h.cdj03 AND cdj04 = g_cdj_h.cdj04 
#  IF SQLCA.sqlcode THEN
...
#  END IF
#  CALL t322_show()
# Prog. Version..: '5.30.06-13.03.12(0,0) THEN                   #確認一下
...
#                     " FROM cdj_file",
#                     " WHERE cdj01=? AND cdj02=? AND cdj03 = ? AND cdj04 = ? AND cdj05 = ? AND cdj06 = ? FOR UPDATE"
#  LET g_forupd_sql = cl_forupd_sql(g_forupd_sql)
...
#  LET g_success ='Y'
#  CALL p322_gl(g_cdj_h.cdj04,g_cdj_h.cdj02,g_cdj_h.cdj03,g_cdj_h.cdj01)  #FUN-BB0038
#  IF g_success ='N' THEN 
#     RETURN  
#  END IF 
#  MESSAGE " "
