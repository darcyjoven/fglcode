...
# Modify.........: No:FUN-D20040 13/02/20 By wujie 增加cde13，部门厂商的group，核算项1取cde13
...
DEFINE l_cde01     LIKE cde_file.cde01
DEFINE l_cde02     LIKE cde_file.cde02
DEFINE l_cde03     LIKE cde_file.cde03
DEFINE l_cde04     LIKE cde_file.cde04
DEFINE l_cde09     LIKE cde_file.cde09
DEFINE l_cde10     LIKE cde_file.cde10
DEFINE l_cde11     LIKE cde_file.cde11
...
DEFINE l_cde13     LIKE cde_file.cde13   #No.FUN-D20040
...
DEFINE l_bookno3   LIKE aza_file.aza81   #FUN-D60025
   ...
   LET l_sql = "SELECT DISTINCT cde01,cde02,cde03,cde04 ",
               "  FROM cde_file ",
               " WHERE ",l_wc CLIPPED 

   PREPARE p320_p3 FROM l_sql
   ...
   IF SQLCA.SQLCODE THEN
      ...
      RETURN
   END IF
   DECLARE p320_c3 CURSOR FOR p320_p3

   LET l_sql = "SELECT cde01,cde02,cde03,cde04,cde09,cde11,cde13,SUM(cde10) ",   #No.FUN-D20040 add cde13
               "  FROM cde_file,aag_file ",
               " WHERE cde01 =? ",
               "   AND cde02 =? ",
               "   AND cde03 =? ",
               "   AND cde04 =? ", 
               ...
               "   AND cde09 = aag01 ",
               "   AND aag05 ='Y' ",
               "   AND cde09 IS NOT NULL ",
               "GROUP BY cde01,cde02,cde03,cde04,cde09,cde11,cde13 ",            #No.FUN-D20040 add cde13
               " UNION ",
               "SELECT cde01,cde02,cde03,cde04,cde09,'',cde13,SUM(cde10) ",      #No.FUN-D20040 add cde13
               "  FROM cde_file,aag_file ",
               " WHERE cde01 =? ",
               "   AND cde02 =? ",
               "   AND cde03 =? ",
               ...
               "   AND aag05 ='N' ",
               "   AND cde09 IS NOT NULL ",
               "GROUP BY cde01,cde02,cde03,cde04,cde09,cde13 ",                  #No.FUN-D20040 add cde13
               " UNION ",
               "SELECT cde01,cde02,cde03,cde04,cde09,cde11,cde13,cde10 ",        #No.FUN-D20040 add cde13
               "  FROM cde_file ",
               " WHERE cde01 =? ",
               "   AND cde02 =? ",
               "   AND cde03 =? ",
               "   AND cde04 =? ",              
               "   AND cde09 IS NULL ",
               "ORDER BY cde01,cde02,cde03,cde04,cde09,cde13 "                    #No.FUN-D20040 add cde13

   PREPARE p320_p4 FROM l_sql
   IF SQLCA.SQLCODE THEN
      CALL cl_err('FILL PREPARE:',SQLCA.SQLCODE,1)
      LET g_success ='N'
      RETURN
   END IF
   DECLARE p320_c4 CURSOR FOR p320_p4
   ...
   PREPARE p320_p5 FROM l_sql
   IF SQLCA.SQLCODE THEN
      CALL cl_err('FILL PREPARE:',SQLCA.SQLCODE,1) 
      LET g_success ='N'
      RETURN
   END IF
   DECLARE p320_c5 CURSOR FOR p320_p5
   
   FOREACH p320_c3 INTO l_cde.cde01,l_cde.cde02,l_cde.cde03,l_cde.cde04  
      IF SQLCA.sqlcode THEN
      ...
      IF l_cde.cde01 = l_ccz12 THEN 
         LET l_npp.npptype =0
      ELSE
         LET l_npp.npptype =1
      END IF  
      LET l_date = MDY(l_cde.cde03,1,l_cde.cde02)
      LET l_npp.nppsys   = 'CA'
      LET l_npp.npp00    = 2  #工单发料
      LET l_npp.npp01    = 'A',l_cde.cde04 CLIPPED,l_cde.cde01 CLIPPED,'-',l_cde.cde02 USING '&&&&',l_cde.cde03 CLIPPED USING '&&','0001'
      LET l_npp.npp011   = 1
      LET l_npp.npp02    = s_last(l_date)
      LET l_npp.npp03    = NULL
      SELECT DISTINCT cdeplant,cdelegal INTO l_npp.npp06,l_npp.npplegal 
        FROM cde_file 
       WHERE cde01 = l_cde.cde01
         AND cde02 = l_cde.cde02
         AND cde03 = l_cde.cde03
         AND cde04 = l_cde.cde04
         
      LET l_npp.nppglno  = NULL
      LET l_npp.npp07 = l_cde.cde01
...
#FUN-D60025 ------------ end by yuhuabao 13/06/05
   ...
   #FUN-B40056 --end
      ...
      FOREACH p320_c4 USING  l_cde.cde01,l_cde.cde02,l_cde.cde03,l_cde.cde04,l_cde.cde01,l_cde.cde02,l_cde.cde03,l_cde.cde04,l_cde.cde01,l_cde.cde02,l_cde.cde03,l_cde.cde04 
                       INTO l_cde01,l_cde02,l_cde03,l_cde04,l_cde09,l_cde11,l_cde13,l_cde10       #No.FUN-D20040 add cde13                     
         ...
         LET l_npq.npq03 = l_cde09
         LET l_npq.npq04 = ''
         LET l_npq.npq05 = l_cde11 
         LET l_npq.npq06 = '1'
         LET l_npq.npq07f = l_cde10  
         LET l_npq.npq07  = l_cde10  
...
#        LET l_npq.npq24 = g_aza.aza17      #No.MOD-CA0116
      ...
      INITIALIZE l_npq.* TO NULL
      FOREACH p320_c5 USING  l_cde.cde01,l_cde.cde02,l_cde.cde03,l_cde.cde04,l_cde.cde01,l_cde.cde02,l_cde.cde03,l_cde.cde04,l_cde.cde01,l_cde.cde02,l_cde.cde03,l_cde.cde04
                       INTO l_cdf01,l_cdf02,l_cdf03,l_cdf04,l_cdf08,l_cdf10,l_cdf09                   
         IF STATUS THEN LET g_success = 'N' RETURN END IF
         INITIALIZE l_npq.* TO NULL
         LET l_npq.npqsys ='CA'
         LET l_npq.npq00  = 2
         ...
         LET l_npq.npq011 = 1
         LET l_npq.npq02 = l_npq02
         LET l_npq.npq03 = l_cdf08
         LET l_npq.npq04 = ''
         LET l_npq.npq05 = l_cdf10
         LET l_npq.npq06 = '2'
         LET l_npq.npq07f = l_cdf09  
         LET l_npq.npq07  = l_cdf09 
        #LET l_npq.npq07f = cl_digcut(l_npq.npq07f,2) 
        #LET l_npq.npq07  = cl_digcut(l_npq.npq07,2)
         LET l_npq.npq08 = NULL
         LET l_npq.npq11 = ' '
...
#No.MOD-CA0116 --end  
   ...
   IF NOT cl_null(l_npp.npp01) THEN
      LET l_cde.cde05 = l_npp.npp01
      UPDATE cde_file SET cde05 = l_cde.cde05 
       WHERE cde01 = l_cde.cde01
         AND cde02 = l_cde.cde02
         AND cde03 = l_cde.cde03
         AND cde04 = l_cde.cde04
...
#No.MOD-CA0116 --end  
   ...
   IF g_success ='Y' AND g_prog ='axct320' THEN CALL cl_err('','abm-019',0) END IF 
