...
FUNCTION q461_cs()
   ...
   CONSTRUCT tm.wc ON ima01,imk02 
                FROM s_ccc[1].ima01,s_ccc[1].imk02
...
DEFINE l_sql,l_sql1 STRING 
   ...
   LET l_sql = "select ima01,ima02,ima021,imk02,imd02,ima25,sum(qcsl),0,sum(qcje),sum(rksl),0,sum(rkje),sum(cksl),0,sum(ckje),sum(qmsl),0,sum(qmje) ",
"   from ima_file left join ",
" (select imk01,imk02,sum(imk09) qcsl,sum(imk09*ccc23) qcje,0 rksl,0 rkje,0 cksl,0 ckje,0 qmsl,0 qmje ",
"   from imk_file,ccc_file ",
"  where imk01 = ccc01 and imk05 = ccc02 and imk06 = ccc03 ",
"    and imk05 = ",tm.sy," and imk06 = ",tm.sm,
...
"   from imk_file,ccc_file ",
"  where imk01 = ccc01 and imk05 = ccc02 and imk06 = ccc03 ",
"    and imk05 = ",tm.ey," and imk06 = ",tm.em,
"    and imk02 not in (select jce02 from jce_file) ",
"  group by imk01,imk02 ",
" union all ",
" select tlf01,tlf902,",
...
" select ccb01,'axct002',0,0,0,sum(case when ccb22>0 then ccb22 else 0 end) ,0,sum(case when ccb22>0 then 0 else ccb22 end)*(-1) ,0,0 ",
"   from ccb_file ",
