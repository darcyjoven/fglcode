...
#{
# Program name...: aws_get_fifo4.4gl
...
FUNCTION aws_get_fifo4_process()
   ...
   LET l_sql=" select a.ibb01,a.ima02,a.imgb03,a.imgb05,a.sumimgb05,a.sfa05c",
    ...
    FOREACH occ_cur INTO l_fifo4.*
       LET l_node = aws_ttsrv_addMasterRecord(base.TypeInfo.create(l_fifo4), "Master")   #加入此筆單檔資料至 Response 中
