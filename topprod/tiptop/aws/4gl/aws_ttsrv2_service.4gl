...
#             LET l_op = com.WebOperation.CreateDOCStyle("aws_getDelivery", p_op_name, g_request, g_response)
    ...
    #一般出货查询 cws_get_axmt620
       ...
       #一般出货过账 cws_upd_asft670
        WHEN "cwsupdaxmt620"
             LET l_op = com.WebOperation.CreateDOCStyle("cwsupdaxmt620", p_op_name, g_request, g_response)
    ...
    #杂收单查询 	cws_get_aimt302
	  ...
	  #add by nihuan 20170508-----------end---------------
       ...
       WHEN "cjc_CreateERPGodownEntry"
            LET l_op = com.WebOperation.CreateDOCStyle("cjc_CreateERPGodownEntry", p_op_name, g_request, g_response)
       WHEN "cjc_CreateERPRequisition"
            LET l_op = com.WebOperation.CreateDOCStyle("cjc_CreateERPRequisition", p_op_name, g_request, g_response)
       WHEN "cjc_CreateERPMiscReceipt"
            LET l_op = com.WebOperation.CreateDOCStyle("cjc_CreateERPMiscReceipt", p_op_name, g_request, g_response)
       WHEN "cjc_CreateERPMiscIssue"
            LET l_op = com.WebOperation.CreateDOCStyle("cjc_CreateERPMiscIssue", p_op_name, g_request, g_response)
       WHEN "cjc_CreateERPWipCompletion"
            LET l_op = com.WebOperation.CreateDOCStyle("cjc_CreateERPWipCompletion", p_op_name, g_request, g_response)
       WHEN "cjc_CreateERPSales"
      ...
      {WHEN "cjc_CreateERPWorkReport"
       ...
       WHEN "cjc_CreateERPWHReturn"
            LET l_op = com.WebOperation.CreateDOCStyle("cjc_CreateERPWHReturn", p_op_name, g_request, g_response)
       WHEN "cjc_CreateERPSaleReturn"
            LET l_op = com.WebOperation.CreateDOCStyle("cjc_CreateERPSaleReturn", p_op_name, g_request, g_response)
       WHEN "cjc_CreateERPScrap"
            LET l_op = com.WebOperation.CreateDOCStyle("cjc_CreateERPScrap", p_op_name, g_request, g_response)
       WHEN "cjc_GetWorkTaskEntryNum"
            LET l_op = com.WebOperation.CreateDOCStyle("cjc_GetWorkTaskEntryNum", p_op_name, g_request, g_response)
       WHEN "cjc_GetWorkTaskBack"
            LET l_op = com.WebOperation.CreateDOCStyle("cjc_GetWorkTaskBack", p_op_name, g_request, g_response)
       WHEN "cjc_CreatePOrder"
            LET l_op = com.WebOperation.CreateDOCStyle("cjc_CreatePOrder", p_op_name, g_request, g_response)
       WHEN "cjc_Del_POrder"
...
FUNCTION cjc_CreateERPReceipts()
  ...
  CALL cjc_zm_createerpreceipts()
END FUNCTION
#生成入库单
FUNCTION cjc_CreateERPGodownEntry()
  LET g_service = "SCM_CreateERPGodownEntry"
  CALL cjc_zm_createerpgodownentry()
END FUNCTION

#生成调拨单
FUNCTION cjc_CreateERPRequisition()
  LET g_service = "SCM_CreateERPRequisition"
  CALL cjc_zm_createerprequisition()
END FUNCTION

#生成杂收单
FUNCTION cjc_CreateERPMiscReceipt()
  LET g_service = "SCM_CreateERPMiscReceipt"
  CALL cjc_zm_createerpmiscreceipt()
END FUNCTION
#生成杂发单
FUNCTION cjc_CreateERPMiscIssue()
  LET g_service = "SCM_CreateERPMiscIssue"
  CALL cjc_zm_createerpmiscissue()
END FUNCTION
#生成发料单
FUNCTION cjc_CreateERPIssue()
  LET g_service = "SCM_CreateERPIssue"
  CALL cjc_zm_createerpissue()
END FUNCTION
#生成工单入库
FUNCTION cjc_CreateERPWipCompletion()
  LET g_service = "SCM_CreateERPWipCompletion"
  CALL cjc_zm_createerpwipcompletion()
END FUNCTION
#生成出货单
FUNCTION cjc_CreateERPSales()
  LET g_service = "SCM_CreateERPSales"
  CALL cjc_zm_createerpsales()
END FUNCTION
#add by darcy 220321
...
#   #CALL cjc_zm_createerpworkreport()
# END FUNCTION
# #生成仓退单
# FUNCTION cjc_CreateERPWHReturn()
#   LET g_service = "SCM_CreateERPWHReturn"
#   CALL cjc_zm_createerpwhreturn()
# END FUNCTION
# #生成销退单
# FUNCTION cjc_CreateERPSaleReturn()
#   LET g_service = "SCM_CreateERPSaleReturn"
#   CALL cjc_zm_createerpsalereturn()
# END FUNCTION


# #获取工单完工量
# FUNCTION cjc_GetWorkTaskEntryNum()
#   LET g_service = "SCM_GetWorkTaskEntryNum"
#   CALL cjc_zm_getWorkTaskEntryNum()
# END FUNCTION

# #获取工单退料
# FUNCTION cjc_GetWorkTaskBack()
#   LET g_service = "SCM_GetWorkTaskBack"
