...
#{
# Program name...: aws_get_product_class_data.4gl
# Descriptions...: 提供取得 ERP 產品分類資料服務
...
#
#]
FUNCTION aws_get_product_class_data()
    ...
    IF g_status.code = "0" THEN
       CALL aws_get_product_class_data_process()
    END IF
...
#
#]
FUNCTION aws_get_product_class_data_process()
    ...
    LET l_sql = "SELECT * FROM oba_file WHERE ",
                 l_wc, 
                 " ORDER BY oba01"
 
    DECLARE oba_curs CURSOR FROM l_sql 
