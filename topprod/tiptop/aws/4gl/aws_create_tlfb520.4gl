...
# Date & Author..: 2016-04-29 16:10:10 shenran
...
FUNCTION aws_create_tlfb520()
 ...
 WHENEVER ERROR CONTINUE
    ...
    IF g_status.code = "0" THEN
       CALL aws_create_tlfb520_process()
    END IF
...
#
#]
FUNCTION aws_create_tlfb520_process()
   ...
   DEFINE l_rvb07      LIKE rvb_file.rvb07
    ...
    END IF
END FUNCTION
FUNCTION tlfb520_load()
   DEFINE l_n         LIKE type_file.num5
   DEFINE l_img09     LIKE img_file.img09

   LET g_success = "Y"
   BEGIN WORK
   CALL tlfb520_ins_tlfb()
   ...
   END IF
END FUNCTION
FUNCTION tlfb520_ins_tlfb()   #No.MOD-8A0112 add
