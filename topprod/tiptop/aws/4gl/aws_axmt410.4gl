...
#---------------------------------------------------------------------
    ...
    DEFINE l_oea00      LIKE oea_file.oea00,                       #No.FUN-680130 VARCHAR(50)
           ...
           l_oea08      LIKE oea_file.oea08                        #No.FUN-680130 VARCHAR(100)
...
#---------------------------------------------------------------------
 ...
 #MOD-480101
    LET l_sql =                                                  
		...
		" oea06, oea08, oea10, oea11, oea12, gen02, gem02, gec02, oea21,",
		" oea211, oea212, oea213, azi02, oea23, oab02, oah02, oag02, oea50,",
		" oea61, oea72, oak02, oeauser, ima021, ima15, oeb03, oeb04,",
		" oeb05, oeb06, oeb092, oeb12, oeb13, oeb14, oeb14t, oeb15,",
		" oeb19, oeb22, oeb24, oeb70, oeb71, oeb908, oea04, oea14,",
                " oea15",
                "  FROM oea_file, oeb_file, OUTER gen_file,",
                " OUTER gem_file, OUTER gec_file, OUTER azi_file,",
                " OUTER oab_file, OUTER oah_file, OUTER oag_file,",
                " OUTER oak_file, OUTER ima_file",
                " WHERE oea01 = oeb01 ",
...
#---------------------------------------------------------------------
           ...
           CASE
             WHEN sr.oea08='1' CALL cl_getmsg('aws-023',g_lang) RETURNING g_msg
             WHEN sr.oea08='2' CALL cl_getmsg('aws-024',g_lang) RETURNING g_msg
             WHEN sr.oea08='3' CALL cl_getmsg('aws-025',g_lang) RETURNING g_msg
           END CASE
             LET l_oea08 = g_msg
           ...
           LET g_strXMLInput = g_strXMLInput CLIPPED,
            "     <oea00>", sr.oea00 CLIPPED, ' ',l_oea00 CLIPPED, "</oea00>", ASCII 10,
               ...
               "     <oea08>", sr.oea08 CLIPPED, ' ',l_oea08 CLIPPED, "</oea08>", ASCII 10,
