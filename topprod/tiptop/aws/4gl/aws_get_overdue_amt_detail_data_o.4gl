...
#
#]
FUNCTION aws_getOverdueAmtDetailData_g()
    ...
    # 檢查登入資訊                                                             #
    #--------------------------------------------------------------------------#
    IF NOT aws_ttsrv_checkSignIn(g_getOverdueAmtDetailData_in.signIn) THEN    
    ...
    IF g_status.code = "0" THEN
       CALL aws_getOverdueAmtDetailData_get()
    END IF
    
    LET g_getOverdueAmtDetailData_out.status = aws_ttsrv_getStatus()
...
#
#]
FUNCTION aws_getOverdueAmtDetailData_get()
    DEFINE l_fld       RECORD 
...
#mandy--------str---
   ...
   #抓取逾期帳款排行明細資料
   #--------------------------------------------------------------------------#
    IF NOT cl_null(g_getOverdueAmtDetailData_in.oma03) THEN
        LET l_oma03 = g_getOverdueAmtDetailData_in.oma03 CLIPPED
    END IF
    IF NOT cl_null(g_getOverdueAmtDetailData_in.d1) THEN
        LET l_d[1]  = g_getOverdueAmtDetailData_in.d1
    END IF
    IF NOT cl_null(g_getOverdueAmtDetailData_in.d1) THEN
        LET l_d[2]  = g_getOverdueAmtDetailData_in.d2
    END IF
    IF NOT cl_null(g_getOverdueAmtDetailData_in.d1) THEN
        LET l_d[3]  = g_getOverdueAmtDetailData_in.d3
    END IF
    IF NOT cl_null(g_getOverdueAmtDetailData_in.d1) THEN
        LET l_d[4]  = g_getOverdueAmtDetailData_in.d4
    END IF
    IF NOT cl_null(g_getOverdueAmtDetailData_in.d1) THEN
        LET l_d[5]  = g_getOverdueAmtDetailData_in.d5
    END IF
    IF NOT cl_null(g_getOverdueAmtDetailData_in.d1) THEN
        LET l_d[6]  = g_getOverdueAmtDetailData_in.d6
    END IF
    IF NOT cl_null(g_getOverdueAmtDetailData_in.d1) THEN
        LET l_d[7]  = g_getOverdueAmtDetailData_in.d7
    END IF
    IF NOT cl_null(g_getOverdueAmtDetailData_in.d1) THEN
        LET l_d[8]  = g_getOverdueAmtDetailData_in.d8
    END IF
    IF NOT cl_null(g_getOverdueAmtDetailData_in.d1) THEN
        LET l_d[9]  = g_getOverdueAmtDetailData_in.d9
    END IF
    IF NOT cl_null(g_getOverdueAmtDetailData_in.d1) THEN
        LET l_d[10] = g_getOverdueAmtDetailData_in.d10
    END IF
    LET l_count = 0
    FOR l_i = 1 TO 10
...
#mandy--------end---
    ...
    # Response Xml 文件改成字串                                                #
    #--------------------------------------------------------------------------#
    LET g_getOverdueAmtDetailData_out.recd = aws_ttsrv_xmlToString(l_node)
END FUNCTION
