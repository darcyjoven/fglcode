...
#{
# Program name...: aws_get_basic_code_data.4gl
# Descriptions...: 提供取得 ERP 碼別代號資料服務
...
#
#]
FUNCTION aws_get_basic_code_data()
    ...
    IF g_status.code = "0" THEN
       CALL aws_get_basic_code_data_process()
    END IF
...
#
#]
FUNCTION aws_get_basic_code_data_process()
