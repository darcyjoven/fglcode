...
#No.FUN-7C0034--BEGIN--
   LET g_sql="sre03.sre_file.sre03,",                                                                                               
    ...
    LET l_table=cl_prt_temptable("asrr100",g_sql) CLIPPED                                                                           
         ...
         ELSE
            ...
            LET l_cmd = l_cmd CLIPPED,
                         ...
                         " '",g_rlang CLIPPED,"'", #No.FUN-7C0078
                            ...
                            " '",g_rep_clas CLIPPED,"'",           
                            " '",g_template CLIPPED,"'"            
            CALL cl_cmdat('asrr100',g_time,l_cmd)
         END IF
         CLOSE WINDOW r100_w
         CALL cl_used(g_prog,g_time,2) RETURNING g_time      # FUN-B80063--add--
         EXIT PROGRAM
...
#    CALL cl_outnam("asrr100") RETURNING l_name   #No.FUN-7C0034
#    START REPORT r100_rep TO l_name              #No.FUN-7C0034
     LET g_pageno = 0
...
#         OUTPUT TO REPORT r100_rep(sr.*)
           EXECUTE insert_prep USING sr.sre03,sr.eci06,sr.sre06,sr.sre04,sr.ima02,
                                     sr.ima021,sr.sra03,sr.sre07,sr.sre11
     END FOREACH
...
#    CALL cl_prt(l_name,g_prtway,g_copies,g_len)
     ...
     END IF                                                                                                                          
     LET g_str=tm.wc                                                                                                                 
     CALL cl_prt_cs3('asrr100','asrr100',g_sql,g_str)
#No.FUN-7C0034--END--
