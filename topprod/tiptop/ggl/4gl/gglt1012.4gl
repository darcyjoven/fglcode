...
#
# Pattern name...: gglt1012.4gl
# Descriptions...: 内部往来交易--手工录入
...
MAIN
   ...
   IF g_bgjob='N' OR cl_null(g_bgjob) THEN 
      OPEN WINDOW t0021_w AT p_row,p_col WITH FORM "ggl/42f/gglt1012"
            ATTRIBUTE (STYLE = g_win_style CLIPPED)
      
      CALL cl_ui_init()
   END IF
   CALL t001('2','1',g_argv1,g_argv2) 

   IF g_bgjob='N' OR cl_null(g_bgjob) THEN
      CLOSE WINDOW t0021_w                 #結束畫面
   END IF
