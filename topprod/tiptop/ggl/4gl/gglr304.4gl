...
# Modify.........: No:MOD-C90088 13/04/19 By apo 增加g_azi04、g_azi05傳遞參數至CR
# Modify.........: No:FUN-CA0098 13/05/09 By zhangweib 增加原幣金額列印,並調整報表列印格式
...
DEFINE tm  RECORD	       	     #Print condition RECORD
           ...
           b_user   LIKE aba_file.abauser,   #No.FUN-CA0098   Add
           e_user   LIKE aba_file.abauser,   #No.FUN-CA0098   Add
...
MAIN
   ...
   LET g_sql="aba01.aba_file.aba01,",                                                                                               
            ...
            #No.FUN-CA0098 ---end  --- Add
              #No.maoyy20170109 ---start--- Add
             "abb04_7.abb_file.abb04,",
             "l_aag_all_7.type_file.chr1000,",
             "abb07f_7.abb_file.abb07f,",
             "abb25_7.abb_file.abb25,",
             "l_abb07_l_7.abb_file.abb07,",
             "l_abb07_r_7.abb_file.abb07,",
             "azi04_7.azi_file.azi04,",
             "azi05_7.azi_file.azi05,",
             "azi07_7.azi_file.azi07,",
            #No.maoyy20170109 ---end  --- Add 
             #No.maoyy20170109 ---start--- Add
             "abb04_8.abb_file.abb04,",
             "l_aag_all_8.type_file.chr1000,",
             "abb07f_8.abb_file.abb07f,",
             "abb25_8.abb_file.abb25,",
             "l_abb07_l_8.abb_file.abb07,",
             "l_abb07_r_8.abb_file.abb07,",
             "azi04_8.azi_file.azi04,",
             "azi05_8.azi_file.azi05,",
             "azi07_8.azi_file.azi07,",
            #No.maoyy20170109 ---end  --- Add
            ...
            #NO.FUN-CA0098 ---start--- add
             ...
             "abb24_7.abb_file.abb24,",  #maoyy201701019
             "abb24_8.abb_file.abb24,",  #maoyy201701019
             "aac02.aac_file.aac02"
            #NO.FUN-CA0098 ---end  --- add
    LET l_table=cl_prt_temptable("gglr304",g_sql) CLIPPED                                                                           
    ...
    LET g_sql="INSERT INTO ",g_cr_db_str CLIPPED,l_table CLIPPED,                                                                   
              ...
              "        ?,?,?,?,?, ?,?,?,?,?, ?,?,?,?,?, ?,?,?,?,?,",   #maoyy20170109
              "        ?,?,?,?,?, ?,?,?,?,?, ?,?,?,?,?,?,?,?,?,?, ?,?,",   #No.FUN-CA0098   add
              "        ?,?,?,?,?, ?,?,?,?,?, ?,?,?,?,?  )         " #No.MOD-8C0030 add by liuxqa  #FUN-940041 Add 3 ?                                                                            
   ...
   LET tm.b_user  = ARG_VAL(17)  #No.FUN-CA0098   Add
   LET tm.e_user  = ARG_VAL(18)  #No.FUN-CA0098   Add
   ...
   IF cl_null(g_bgjob) OR g_bgjob = 'N'		# If background job sw is off
      THEN CALL gglr304_tm()	        	# Input print condition
      ELSE CALL gglr304()			# Read data and create out-file
   END IF
...
DEFINE lc_qbe_sn        LIKE gbm_file.gbm01   #No.FUN-580031
   ...
   END IF
   OPEN WINDOW gglr304_w AT p_row,p_col
        WITH FORM "ggl/42f/gglr304"
################################################################################
...
WHILE TRUE
  ...
  END CONSTRUCT
   ...
   IF INT_FLAG THEN
      LET INT_FLAG = 0 CLOSE WINDOW gglr304_w
      CALL  cl_used(g_prog,g_time,2) RETURNING g_time #No.MOD-B80009
      EXIT PROGRAM
   END IF
  #INPUT BY NAME tm.bookno,tm.t,tm.u,tm.w,tm.n,tm.h,tm.e,tm.m WITHOUT DEFAULTS  #FUN-6C0012   #No.FUN-740055 #No.MOD-860252 add tm.h   #No.FUN-CA0098   Mark
   INPUT BY NAME tm.bookno,tm.b_user,tm.e_user,tm.t,tm.u,tm.w,tm.h,tm.e,tm.m WITHOUT DEFAULTS  #No.FUN-CA0098 Add
         BEFORE INPUT
...
###############################################################################
   ...
   IF g_bgjob = 'Y' THEN
      ...
      ELSE
         ...
         CALL cl_cmdat('gglr304',g_time,l_cmd)	# Execute cmd at later time
      END IF
      CLOSE WINDOW gglr304_w
      CALL  cl_used(g_prog,g_time,2) RETURNING g_time #No.MOD-B80009
      EXIT PROGRAM
   END IF
   CALL cl_wait()
...
FUNCTION gglr304()
   DEFINE l_name	LIKE type_file.chr20,   #NO FUN-690009   VARCHAR(20)   # External(Disk) file name
          ...
          DEFINE  sr1           RECORD
                               ...
                               #No.FUN-CA0098 ---end  --- Add
                                #No.maoyy20170109 ---start--- Add
                                abb04_7     LIKE abb_file.abb04,
                                l_aag_all_7 LIKE type_file.chr1000,
                                abb07f_7    LIKE abb_file.abb07f,
                                abb25_7     LIKE abb_file.abb25,
                                l_abb07_l_7 LIKE abb_file.abb07,
                                l_abb07_r_7 LIKE abb_file.abb07,
                                azi04_7     LIKE azi_file.azi04,
                                azi05_7     LIKE azi_file.azi05,
                                azi07_7     LIKE azi_file.azi07,
                               #No.maoyy20170109 ---end  --- Add
                                #No.maoyy20170109 ---start--- Add
                                abb04_8     LIKE abb_file.abb04,
                                l_aag_all_8 LIKE type_file.chr1000,
                                abb07f_8    LIKE abb_file.abb07f,
                                abb25_8     LIKE abb_file.abb25,
                                l_abb07_l_8 LIKE abb_file.abb07,
                                l_abb07_r_8 LIKE abb_file.abb07,
                                azi04_8     LIKE azi_file.azi04,
                                azi05_8     LIKE azi_file.azi05,
                                azi07_8     LIKE azi_file.azi07,
                               #No.maoyy20170109 ---end  --- Add
  ...
  #NO.FUN-CA0098   ---start--- add
   ...
   DEFINE l_abb24_7   LIKE abb_file.abb24 #maoyy20170109
   DEFINE l_abb24_8   LIKE abb_file.abb24 #maoyy20170109
...
#    CALL  cl_used(g_prog,g_time,1) RETURNING g_time #No.MOD-580088  HCN 20050818  #No.FUN-6A0097  #No.MOD-B80009
     ...
     SELECT aaf03 INTO g_company FROM aaf_file WHERE aaf01 = tm.bookno   #NO.FUN-740055
    	 AND aaf02 = g_rlang
     SELECT zz17,zz05 INTO g_len,g_zz05 FROM zz_file WHERE zz01 = 'gglr304'
     #使用預設帳別之幣別
     ...
     SELECT zo02 INTO l_zo02 FROM zo_file WHERE zo01 = g_rlang   #NO.FUN-CA0098   Add
 
     LET tm.wc = tm.wc CLIPPED,cl_get_extra_cond('abauser', 'abagrup')
 
  LET l_sql = "SELECT aba01,aba02,aba10,aba19,aba21,abb02,abb04,abb06,",
                 "       abb24,abb25,abb07f,aag01,aag02,aag13,aag07,aag08,abb07,",  #FUN-6C0012
                 "       azi07,0,'','','','','',0,0,",     #No.A117
                 "       aba03,aba04,aba24,aba37,aba38,aba24",  #No.FUN-CA0098   add
                 ...
                 "    AND aac03 = '0'",
                 "    AND aag07 IN ('2','3')",
                # "    AND aba19 <> 'X' ",  #CHI-C80041   #临时开作废的也打印
                 "    AND azi_file.azi01 = abb_file.abb24 ",
                 "    AND aba00 = '",tm.bookno,"'",          #No.TQC-750041
                 "    AND ",tm.wc CLIPPED
    #No.FUN-CA0098 ---Mark--- Start
    #IF tm.n = 'Y' THEN
    #   LET l_sql = l_sql CLIPPED," AND aac13 = 'Y'"                    #No.FUN-CA0098 Mark
    #ELSE                                            #TQC-B60146   Add
    #   LET l_sql = l_sql CLIPPED," AND aac13 = 'N'" #TQC-B60146   Add  #No.FUN-CA0098 Mark
    #END IF
    #No.FUN-CA0098 ---Mark--- End
     ...
     END IF
     PREPARE gglr304_prepare1 FROM l_sql
     IF STATUS THEN 
        CALL cl_err('prepare:',STATUS,1)
        CALL  cl_used(g_prog,g_time,2) RETURNING g_time #No.MOD-B80009
        EXIT PROGRAM
     END IF
     DECLARE gglr304_curs1 CURSOR FOR gglr304_prepare1
     LET l_aba01 = NULL
     LET l_i = 0
     LET l_l_abb07_l = 0
     LET l_l_abb07_r = 0
     ...
     FOREACH gglr304_curs1 INTO sr.*,l_aba24    #No.FUN-CA0098   Add l_aba24
      #No.FUN-CA0098   ---start--- Add
      ...
      #NO.FUN-CA0098   ---start--- modify
       #LET sr.l_aag_all = sr.l_aag02_r CLIPPED,
       #                   '-(',sr.l_aag01_l CLIPPED,')',sr.l_aag02_l CLIPPED,
      #NO.FUN-CA0098   ---start--- modify
      # LET sr.l_aag_all = sr.l_aag02_r CLIPPED,         #mark by liyjf170302                         
      #                     '-(',sr.l_aag01_l CLIPPED,')',sr.l_aag02_l CLIPPED, #mark by liyjf170302
      LET sr.l_aag_all = '(',sr.l_aag01_l CLIPPED,')',sr.l_aag02_l CLIPPED,  #add by liyjf170302 
                          l_str CLIPPED                                         
       #No.FUN-A30016  --End    
        IF NOT cl_null(l_aba01) THEN
           ...
           IF l_aba01 <> sr.aba01 THEN
              #當前頁
              LET sr1.l_cur_p = l_i / 8   #No.FUN-CA0098  Mod 5 --> 6
              IF l_i MOD 8 <> 0 THEN      #No.FUN-CA0098  Mod 5 --> 6
             ...
             #No.FUN-CA0098 ---Add--- Start
              ...
              LET l_gen02_2 = ''
              LET l_gen02_3 = ''
              SELECT a.gen02,b.gen02,c.gen02 INTO l_gen02_1,l_gen02_2,l_gen02_3
                FROM aba_file
                     LEFT JOIN gen_file a ON a.gen01 = aba37
                     LEFT JOIN gen_file b ON b.gen01 = aba38
                     LEFT JOIN gen_file c ON c.gen01 = aba24
             ...
             #No.FUN-CA0098 ---Add--- End
              IF cl_null(sr1.l_aag_all_7) THEN LET l_abb24_7 = Null END IF #maoyy20170109
              IF cl_null(sr1.l_aag_all_8) THEN LET l_abb24_8 = Null END IF #maoyy20170109
              EXECUTE insert_prep USING sr1.*,l_n,       #No.MOD-8C0030 add by liuxqa
                                        "",l_img_blob,"N",   #FUN-940041 
                                        sr.aba03,sr.aba04,l_gen02_1,l_gen02_2,l_gen02_3,l_zo02,    #NO.FUN-CA0098 add
                                        l_abb24_1,l_abb24_2,l_abb24_3,l_abb24_4,l_abb24_5,l_abb24_6,l_abb24_7,l_abb24_8,l_aac02  #NO.FUN-CA0098 add  #maoyy20170109
              INITIALIZE sr1.* TO NULL 
           ...
           ELSE
              ...
              IF l_i MOD 8 = 0 THEN   #TQC-880017        #No.FUN-CA0098  Mod 5 --> 6
                 LET sr1.l_cur_p = l_i / 8               #No.FUN-CA0098  Mod 5 --> 6
             ...
             #No.FUN-CA0098 ---Add--- End
              ...
              IF cl_null(sr1.l_aag_all_8) THEN LET l_abb24_8 = Null END IF #maoyy20170109
                 EXECUTE insert_prep USING sr1.*,l_n,    #No.MOD-8C0030 add by liuxqa
                                           "",l_img_blob,"N",   #FUN-940041 
                                           sr.aba03,sr.aba04,l_gen02_1,l_gen02_2,l_gen02_3,l_zo02,   #NO.FUN-CA0098 add
                                           l_abb24_1,l_abb24_2,l_abb24_3,l_abb24_4,l_abb24_5,l_abb24_6,l_abb24_7,l_abb24_8,l_aac02  #NO.FUN-CA0098 add #maoyy
                 INITIALIZE sr1.* TO NULL
                 LET l_n = l_n + 1                       #No.MOD-8C0030 add by liuxqa
              END IF
           END IF
       ...
       SELECT COUNT(*) INTO sr1.l_tot_p FROM aba_file,abb_file
         WHERE aba00 = abb00
           AND aba01 = abb01
           AND aba01 = sr.aba01
       LET l_temp1 = sr1.l_tot_p/8           #No.FUN-CA0098  Mod 5 --> 6 #maoyy20170109 6--8
       IF sr1.l_tot_p MOD 8 <> 0 THEN        #No.FUN-CA0098  Mod 5 --> 6 #maoyy20170109 6--8
       ...
       SELECT azi04,azi05 INTO t_azi04,t_azi05 FROM azi_file      
        ...
        CASE l_i MOD 8          #No.FUN-CA0098  Mod 5 --> 6 #maoyy20170109 6--8
            WHEN 0 LET sr1.abb04_1 = sr.abb04
                   ...
                   LET l_abb24_1 = sr.abb24 #No.FUN-CA0098   Add
            WHEN 1 LET sr1.abb04_2 = sr.abb04
                   ...
                   LET l_abb24_2 = sr.abb24 #No.FUN-CA0098   Add
            WHEN 2 LET sr1.abb04_3 = sr.abb04
                   ...
                   LET l_abb24_3 = sr.abb24 #No.FUN-CA0098   Add
            WHEN 3 LET sr1.abb04_4 = sr.abb04
                   ...
                   LET l_abb24_4 = sr.abb24 #No.FUN-CA0098   Add
            WHEN 4 LET sr1.abb04_5 = sr.abb04
                   ...
                   LET l_abb24_5 = sr.abb24 #No.FUN-CA0098   Add
          #No.FUN-CA0098 ---start--- Add   20121026
          ...
          #No.FUN-CA0098 ---end  --- Add   20121026
          #No.maoyy20170109 ---start--- Add   20121026
            WHEN 6 LET sr1.abb04_7 = sr.abb04
                   LET sr1.l_aag_all_7 = sr.l_aag_all
                   LET sr1.abb07f_7 = sr.abb07f
                   LET sr1.abb25_7 = sr.abb25
                   LET sr1.l_abb07_l_7 = sr.l_abb07_l
                   LET sr1.l_abb07_r_7 = sr.l_abb07_r
                   LET sr1.azi04_7 = t_azi04
                   LET sr1.azi05_7 = t_azi05
                   LET sr1.azi07_7 = sr.azi07
                   LET l_abb24_7 = sr.abb24
          #No.maoyy20170109 ---end  --- Add   20121026 
          #No.maoyy20170109 ---start--- Add   20121026
            WHEN 7 LET sr1.abb04_8 = sr.abb04
                   LET sr1.l_aag_all_8 = sr.l_aag_all
                   LET sr1.abb07f_8 = sr.abb07f
                   LET sr1.abb25_8 = sr.abb25
                   LET sr1.l_abb07_l_8 = sr.l_abb07_l
                   LET sr1.l_abb07_r_8 = sr.l_abb07_r
                   LET sr1.azi04_8 = t_azi04
                   LET sr1.azi05_8 = t_azi05
                   LET sr1.azi07_8 = sr.azi07
                   LET l_abb24_8 = sr.abb24
          #No.maoyy20170109 ---end  --- Add   20121026
        END CASE
     ...
     IF l_i > 0 THEN
        #當前頁
        LET sr1.l_cur_p = l_i / 8   #No.FUN-CA0098  Mod 5 --> 6 #maoyy20170109 6--8
        IF l_i MOD 8 <> 0 THEN      #No.FUN-CA0098  Mod 5 --> 6 #maoyy20170109 6--8
           LET sr1.l_cur_p = sr1.l_cur_p + 1
        END IF
     ...
     IF g_zz05='Y' THEN                                                                                                              
        ...
        RETURNING tm.wc                                                                                                              
     END IF
    #LET g_str = tm.wc                                         #MOD-C90088 mark
     LET g_str = tm.wc,";",g_azi04,";",g_azi05                 #MOD-C90088 add
     ...
     FOREACH key_cs INTO l_key.*            
        ...
        LET l_ii = l_ii + 1
     END FOREACH
    #CALL cl_prt_cs3('gglr304',l_name,g_sql,g_str)      #No.FUN-CA0098   Mark   20121026
     CALL cl_prt_cs3('gglr304','gglr304',g_sql,g_str)   #No.FUN-CA0098   Add
...
FUNCTION r304_get_dimention(p_aba01,p_abb02)
   ...
   IF NOT cl_null(l_abb.abb05) THEN
     ...
     #LET l_str = '-',l_gem02                   #No.FUN-CA0098   Mark
      LET l_str = '/',l_abb.abb05 CLIPPED,'-',l_gem02   #No.FUN-CA0098   Add
   END IF

   LET l_flag = 'N'
   IF NOT cl_null(l_abb.abb11) THEN
      CALL r999_get_ahe02(l_abb.abb03,l_abb.abb11,'aag15','1') RETURNING l_aee04 #No.FUN-CA0098   Add
      IF cl_null(l_str) THEN
        #LET l_str = '-',l_abb.abb11            #No.FUN-CA0098   Mark
         LET l_str = '/',l_abb.abb11 CLIPPED ,'-',l_aee04 #No.FUN-CA0098   Add
      ELSE
        #LET l_str = l_str CLIPPED,'-',l_abb.abb11   #No.FUN-CA0098   Mark
         LET l_str = l_str CLIPPED,'/',l_abb.abb11 CLIPPED ,'-',l_aee04   #No.FUN-CA0098   Add
      END IF
      LET l_flag = 'Y'
   END IF
  
   IF NOT cl_null(l_abb.abb12) AND l_flag = 'N' THEN
      CALL r999_get_ahe02(l_abb.abb03,l_abb.abb12,'aag16','2') RETURNING l_aee04  #NO.FUN-CA0098 add
      IF cl_null(l_str) THEN
        #LET l_str = '-',l_abb.abb12                       #No.FUN-CA0098   Mark
         LET l_str = '/',l_abb.abb12 CLIPPED ,'-',l_aee04  #No.FUN-CA0098   Add
      ELSE
        #LET l_str = l_str CLIPPED,'-',l_abb.abb12         #No.FUN_CA0098   Mark
         LET l_str = l_str CLIPPED,'/',l_abb.abb12 CLIPPED ,'-',l_aee04   #No.FUN-CA0098   Add
      END IF
      LET l_flag = 'Y'
   END IF
   ...
   IF NOT cl_null(l_abb.abb13) AND l_flag = 'N' THEN
      CALL r999_get_ahe02(l_abb.abb03,l_abb.abb12,'aag16','2') RETURNING l_aee04  #NO.FUN-CA0098 add
      IF cl_null(l_str) THEN
        #LET l_str = '-',l_abb.abb13                       #No.FUN-CA0098   Mark
         LET l_str = '/',l_abb.abb13 CLIPPED ,'-',l_aee04  #No.FUN-CA0098   Add
      ELSE
        #LET l_str = l_str CLIPPED,'-',l_abb.abb13         #No.FUN_CA0098   Mark
         LET l_str = l_str CLIPPED,'/',l_abb.abb13 CLIPPED ,'-',l_aee04   #No.FUN-CA0098   Add
      END IF
      LET l_flag = 'Y'
   END IF
   ...
   IF NOT cl_null(l_abb.abb14) AND l_flag = 'N' THEN
      ...
      IF cl_null(l_str) THEN
        #LET l_str = '-',l_abb.abb14                       #No.FUN-CA0098   Mark
         LET l_str = '/',l_abb.abb14 CLIPPED ,'-',l_aee04  #No.FUN-CA0098   Add
      ELSE
        #LET l_str = l_str CLIPPED,'-',l_abb.abb14         #No.FUN-CA0098   Mark
         LET l_str = l_str CLIPPED,'/',l_abb.abb14 CLIPPED ,'-',l_aee04   #No.FUN-CA0098   Add
      END IF
      LET l_flag = 'Y'
   END IF
  
   IF NOT cl_null(l_abb.abb31) AND l_flag = 'N' THEN
      CALL r999_get_ahe02(l_abb.abb03,l_abb.abb31,'aag31','4') RETURNING l_aee04   #No.FUN-CA0098   Add
      IF cl_null(l_str) THEN
        #LET l_str = '-',l_abb.abb31                        #NO.FUN-CA0098   Mark
         LET l_str = '/',l_abb.abb31 CLIPPED ,'-',l_aee04   #No.FUN-CA0098   Add
      ELSE
         LET l_str = l_str CLIPPED,'-',l_abb.abb31          #No.FUN-CA0098   Mark
         LET l_str = l_str CLIPPED,'/',l_abb.abb31 CLIPPED ,'-',l_aee04   #No.FUN-CA0098   Add
      END IF
      LET l_flag = 'Y'
   END IF
  
   IF NOT cl_null(l_abb.abb32) AND l_flag = 'N' THEN
      CALL r999_get_ahe02(l_abb.abb03,l_abb.abb32,'aag32','6') RETURNING l_aee04   #No.FUN-CA0098   Add
      IF cl_null(l_str) THEN
        #LET l_str = '-',l_abb.abb32                        #No.FUN-CA0098  Mark
         LET l_str = '/',l_abb.abb32 CLIPPED ,'-',l_aee04   #No.FUN-CA0098  Add
      ELSE
         LET l_str = l_str CLIPPED,'-',l_abb.abb32          #No.FUN-CA0098  Mark
         LET l_str = l_str CLIPPED,'/',l_abb.abb32 CLIPPED ,'-',l_aee04 #No.FUN-CA0098  Add
      END IF
      LET l_flag = 'Y'
   END IF
   ...
   IF NOT cl_null(l_abb.abb33) AND l_flag = 'N' THEN
      ...
      IF cl_null(l_str) THEN
        #LET l_str = '-',l_abb.abb33                        #No.FUN-CA0098  Mark
         LET l_str = '/',l_abb.abb33 CLIPPED ,'-',l_aee04   #No.FUN-CA0098  Add
      ELSE
        #LET l_str = l_str CLIPPED,'-',l_abb.abb33                        #No.FUN-CA0098  Mark
         LET l_str = l_str CLIPPED,'/',l_abb.abb33 CLIPPED ,'-',l_aee04   #No.FUN-CA0098  Add
      END IF
      LET l_flag = 'Y'
   END IF
  
   IF NOT cl_null(l_abb.abb34) AND l_flag = 'N' THEN
      CALL r999_get_ahe02(l_abb.abb03,l_abb.abb34,'aag34','8') RETURNING l_aee04   #No.FUN-cA0098   Add
      IF cl_null(l_str) THEN
        #LET l_str = '-',l_abb.abb34                        #No.FUN-CA0098   Mark
         LET l_str = '/',l_abb.abb34 CLIPPED ,'-',l_aee04   #No.FUN-CA0098   Add
      ELSE
        #LET l_str = l_str CLIPPED,'-',l_abb.abb34                        #No.FUN-CA0098   Mark
         LET l_str = l_str CLIPPED,'/',l_abb.abb34 CLIPPED ,'-',l_aee04   #No.FUN-CA0098   Add
      END IF
      LET l_flag = 'Y'
   END IF
  
   IF NOT cl_null(l_abb.abb35) AND l_flag = 'N' THEN
      CALL r999_get_ahe02(l_abb.abb03,l_abb.abb35,'aag35','9') RETURNING l_aee04   #No.FUN-cA0098   Add
      IF cl_null(l_str) THEN
        #LET l_str = '-',l_abb.abb35                         #No.FUN-CA0098   Mark
         LET l_str = '/',l_abb.abb35 CLIPPED ,'-',l_aee04    #No.FUN-CA0098   Add
      ELSE
        #LET l_str = l_str CLIPPED,'-',l_abb.abb35           #No.FUN-CA0098   Mark
         LET l_str = l_str CLIPPED,'/',l_abb.abb35 CLIPPED ,'-',l_aee04 #No.FUN-CA0098   Add
      END IF
      LET l_flag = 'Y'
   END IF
  
   IF NOT cl_null(l_abb.abb36) AND l_flag = 'N' THEN
      CALL r999_get_ahe02(l_abb.abb03,l_abb.abb36,'aag36','10') RETURNING l_aee04    #No.FUN-CCCA0098   Add
      IF cl_null(l_str) THEN
        #LET l_str = '-',l_abb.abb36                         #No.FUN-CA0098   Mark
         LET l_str = '/',l_abb.abb36 CLIPPED ,'-',l_aee04    #No.FUN-CA0098   Add
      ELSE
        #LET l_str = l_str CLIPPED,'-',l_abb.abb36           #No.FUN-CA0098   Mark
         LET l_str = l_str CLIPPED,'/',l_abb.abb36 CLIPPED ,'-',l_aee04 #No.FUN-CA0098   Add
      END IF
      LET l_flag = 'Y'
   END IF
  
   IF NOT cl_null(l_abb.abb37) AND l_flag = 'N' THEN
      CALL r999_get_ahe02(l_abb.abb03,l_abb.abb37,'aag37','99') RETURNING l_aee04  #No.FUN-CA0098   Add
      IF cl_null(l_str) THEN
        #LET l_str = '-',l_abb.abb37                         #No.FUN-CA0098   Mark
         LET l_str = '/',l_abb.abb37 CLIPPED ,'-',l_aee04    #No.FUN-CA0098   Add
      ELSE
        #LET l_str = l_str CLIPPED,'-',l_abb.abb37           #No.FUN-CA0098   Mark
         LET l_str = l_str CLIPPED,'/',l_abb.abb37 CLIPPED ,'-',l_aee04 #No.FUN-CA0098   Add
      END IF
      LET l_flag = 'Y'
   END IF
