...
#
# Pattern name...: ggli934.4gl   #agli934.4gl
...
# Modify.........: No.TQC-C40201 12/04/20 By lujh 科目編號gio02開窗應抓giv_file資料
...
#       l_time    LIKE type_file.chr8              #No.FUN-6A0073
   ...
   CALL cl_used(g_prog,g_time,1) RETURNING g_time #No.FUN-690114
    ...
    OPEN WINDOW i934_w AT p_row,p_col      #顯示畫面
      WITH FORM "ggl/42f/ggli934"  ATTRIBUTE (STYLE = g_win_style CLIPPED) #No.FUN-580092 HCN
...
#            CALL q_gis(4,4,g_gio01,g_gio02) RETURNING l_gio01,g_gio02
             CALL cl_init_qry_var()
             LET g_qryparam.state = "c"
             #LET g_qryparam.form ="q_gin"  #MOD-9B0087 mod q_gis->q_gin   #TQC-C40201  mark
             LET g_qryparam.form ="q_giv"   #TQC-C40201  add
      ...
      AFTER ROW
         ...
         #LET l_ac_t = l_ac                 #FUN-D30032 Mark  
          IF INT_FLAG THEN
             CALL cl_err('',9001,0)
             LET INT_FLAG = 0
            #LET g_gio[l_ac].* = g_gio_t.*  #FUN-D30032 Mark
             #FUN-D30032--add--str--
             IF p_cmd = 'u' THEN
                LET g_gio[l_ac].* = g_gio_t.*  
             ELSE
...
FUNCTION i934_out()
     ...
     LET l_cmd = 'p_query "ggli934" "',g_wc CLIPPED,'"'                                                                             
