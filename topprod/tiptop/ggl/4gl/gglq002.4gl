...
# Modify.........: No.TQC-B70148 11/07/18 By guoch 將axb07 > 20去掉，由axb06為基準
# Modify.........: No:FUN-B80096 11/08/10 By Lujh 模組程序撰寫規範修正
# Modify.........: No.TQC-C50042 12/05/07 By zhangweib 修改開窗q_mai去除報表性質為5\6的資料
# Modify.........: No.MOD-C70187 12/07/17 By yinhy 報表結構開窗更改，默認帳套為aaw01
# Modify.........: No.FUN-D70059 13/07/10 By zhangweib 將程序合併成一個畫面
# Modify.........: NO.FUN-D70119 13/08/07 By chenying 會計年期會不按照自然年月設置，需要按照aooq011的設置來
...
#  CALL q002_out_1()
   ...
   OPEN WINDOW q002_w AT 5,10
        WITH FORM "ggl/42f/gglq002" ATTRIBUTE(STYLE = g_win_style)
...
FUNCTION gglq002_tm()
  ...
  #No.FUN-D70059 ---Add--- Mark   
#   LET p_row = 4 LET p_col = 12
#   OPEN WINDOW gglq002_w1 AT p_row,p_col
#        WITH FORM "ggl/42f/gglq002_1"
#        ATTRIBUTE (STYLE = g_win_style CLIPPED)
#
#   CALL cl_ui_locale("gglq002_1")
  #No.FUN-D70059 ---end--- Mark
...
#  #FUN-D70119--mark--str--
  ...
  #FUN-D70119--mark--end--   
   ...
   #No.MOD-C70187  --End
  #FUN-D70119--add--str--
   LET tm.yy= s_get_aznn(g_plant,tm.b,g_today,1)
   LET tm.bm= s_get_aznn(g_plant,tm.b,g_today,3)
   LET tm.em= s_get_aznn(g_plant,tm.b,g_today,3)
  #FUN-D70119--add--end--
   ...
   WHILE TRUE
      ...
      INPUT BY NAME tm.rtype,tm.a,tm.b,tm.ver,tm.axa01,tm.axa02,tm.axa03, 
                    tm.yy,tm.bm,tm.em,tm.f,tm.d,tm.c,tm.e   #,tm.more  #No.FUN-D70059   Add
          	  WITHOUT DEFAULTS
         ...
         AFTER FIELD a
           ...
           #No.TQC-C50042   ---end---     Add
                #No.MOD-C70187  --Begin
                IF (g_mai03 = '2' AND tm.rtype = '2') OR (g_mai03 = '3' AND tm.rtype = '1') THEN 
                  CALL cl_err('','agl-187',0)
                  NEXT FIELD a
                END IF   
                #No.MOD-C70187  --End
            END IF
         ...
         AFTER FIELD axa03
            #IF cl_null(tm.axa03) THEN NEXT FIELD axa03 END IF  #No.TQC-B70042
            IF NOT cl_null(tm.axa03) THEN                       #No.TQC-B70042
...
#No.FUN-D70059 ---Add--- end
      ...
      END INPUT
      IF INT_FLAG THEN
         #LET INT_FLAG = 0 CLOSE WINDOW q002_w   #No.FUN-D70059   Add
         CALL cl_used(g_prog,g_time,2) RETURNING g_time
         EXIT PROGRAM
      END IF
      ...
      IF g_bgjob = 'Y' THEN
         ...
         ELSE
            LET l_cmd = l_cmd CLIPPED,
                        ...
                        " '",g_template CLIPPED,"'",
                        " '",tm.ver CLIPPED,"'"     
            CALL cl_cmdat('gglq002',g_time,l_cmd)    # Execute cmd at later time
         END IF
         #CLOSE WINDOW gglq002_w1 #No.FUN-D70059   Add
...
#  END IF
   ...
   DELETE FROM gglq002_tmp2   #luttb
   DELETE FROM gglq002_tmp    #luttb

   LET g_sql = "INSERT INTO gglq002_tmp2",
               " VALUES(?,?,?,?,?, ?,?,?,?,?,",
               "        ?,?,?,?,?, ?,?,?,?,?,",
               #luttb 101223--add--str--
               "        ?,?,?,?,?, ?,?,?,?,?,",
  ...
  #將族群填入array------------------------------------------------------
   LET l_sql = " SELECT axa01,axa02,axa03,axa02,axa03",
               ...
               "    AND axa01='",tm.axa01,"'",
            #   "    AND axb07 > 20 ",   #TQC-B70148 mark
               "    AND axb06 = 'Y' ",      #No.TQC-B70049
               "  ORDER BY 1,2,3,4 "
   PREPARE q002_axa_p FROM l_sql
   IF STATUS THEN CALL cl_err('prepare:',STATUS,1) 
      CALL cl_used(g_prog,g_time,2) RETURNING g_time
      EXIT PROGRAM 
   END IF
   DECLARE q002_axa_c CURSOR FOR q002_axa_p
   LET g_no = 1
   FOREACH q002_axa_c INTO g_dept[g_no].*
       IF SQLCA.SQLCODE THEN
...
#luttb 101223--add--str--
                   ...
                   WHEN 21 LET sr2.l_dept41 = g_dept[l_cn+g_group].axb04
                   WHEN 22 LET sr2.l_dept42 = g_dept[l_cn+g_group].axb04
                   WHEN 23 LET sr2.l_dept43 = g_dept[l_cn+g_group].axb04
                   WHEN 24 LET sr2.l_dept44 = g_dept[l_cn+g_group].axb04
                   WHEN 25 LET sr2.l_dept45 = g_dept[l_cn+g_group].axb04
                   WHEN 26 LET sr2.l_dept46 = g_dept[l_cn+g_group].axb04
                   WHEN 27 LET sr2.l_dept47 = g_dept[l_cn+g_group].axb04
                   WHEN 28 LET sr2.l_dept48 = g_dept[l_cn+g_group].axb04
                   WHEN 29 LET sr2.l_dept49 = g_dept[l_cn+g_group].axb04
                   WHEN 30 LET sr2.l_dept50 = g_dept[l_cn+g_group].axb04
                   WHEN 31 LET sr2.l_dept51 = g_dept[l_cn+g_group].axb04
                   WHEN 32 LET sr2.l_dept52 = g_dept[l_cn+g_group].axb04
                   WHEN 33 LET sr2.l_dept53 = g_dept[l_cn+g_group].axb04
                   WHEN 34 LET sr2.l_dept54 = g_dept[l_cn+g_group].axb04
                   WHEN 35 LET sr2.l_dept55 = g_dept[l_cn+g_group].axb04
#luttb 101223--add--end
              END CASE
...
#luttb 101223--add--end
         ...
         #START 部門後面加上5個調整資料
         #gglq002@1 = 調整或銷除(D)     gglq002@2 = 調整或銷除(C)
         #gglq002@3 = 會計師調整(D)     gglq002@4 = 會計師調整(C)
         #gglq002@5 = 合併後
         #-----------------------------------------------------
          CASE g_cn MOD 50
            WHEN 1  LET sr2.l_dept2 = "gglq002@1"  LET sr2.l_dept3 = "gglq002@2"
                    LET sr2.l_dept4 = "gglq002@3"  LET sr2.l_dept5 = "gglq002@4"
                    LET sr2.l_dept6 = "gglq002@5"
            WHEN 2  LET sr2.l_dept3 = "gglq002@1"  LET sr2.l_dept4 = "gglq002@2"
                    LET sr2.l_dept5 = "gglq002@3"  LET sr2.l_dept6 = "gglq002@4"
                    LET sr2.l_dept7 = "gglq002@5"
            WHEN 3  LET sr2.l_dept4 = "gglq002@1"  LET sr2.l_dept5 = "gglq002@2"
                    LET sr2.l_dept6 = "gglq002@3"  LET sr2.l_dept7 = "gglq002@4"
                    LET sr2.l_dept8 = "gglq002@5"
            WHEN 4  LET sr2.l_dept5 = "gglq002@1"  LET sr2.l_dept6 = "gglq002@2"
                    LET sr2.l_dept7 = "gglq002@3"  LET sr2.l_dept8 = "gglq002@4"
                    LET sr2.l_dept9 = "gglq002@5"
#add--begin
            WHEN 5  LET sr2.l_dept6 = "gglq002@1"  LET sr2.l_dept7 = "gglq002@2"
                    LET sr2.l_dept8 = "gglq002@3"  LET sr2.l_dept9 = "gglq002@4"
                    LET sr2.l_dept10= "gglq002@5"
            WHEN 6  LET sr2.l_dept7 = "gglq002@1"  LET sr2.l_dept8 = "gglq002@2"
                    LET sr2.l_dept9 = "gglq002@3"  LET sr2.l_dept10= "gglq002@4"
                    LET sr2.l_dept11= "gglq002@5"
            WHEN 7  LET sr2.l_dept8 = "gglq002@1"  LET sr2.l_dept9 = "gglq002@2"
                    LET sr2.l_dept10= "gglq002@3"  LET sr2.l_dept11= "gglq002@4"
                    LET sr2.l_dept12= "gglq002@5"
            WHEN 8  LET sr2.l_dept9 = "gglq002@1"  LET sr2.l_dept10= "gglq002@2"
                    LET sr2.l_dept11= "gglq002@3"  LET sr2.l_dept12= "gglq002@4"
                    LET sr2.l_dept13= "gglq002@5"
            WHEN 9  LET sr2.l_dept10= "gglq002@1"  LET sr2.l_dept11= "gglq002@2"
                    LET sr2.l_dept12= "gglq002@3"  LET sr2.l_dept13= "gglq002@4"
                    LET sr2.l_dept14= "gglq002@5"
            WHEN 10 LET sr2.l_dept11= "gglq002@1"  LET sr2.l_dept12= "gglq002@2"
                    LET sr2.l_dept13= "gglq002@3"  LET sr2.l_dept14= "gglq002@4"
                    LET sr2.l_dept15= "gglq002@5"
            WHEN 11 LET sr2.l_dept12= "gglq002@1"  LET sr2.l_dept13= "gglq002@2"
                    LET sr2.l_dept14= "gglq002@3"  LET sr2.l_dept15= "gglq002@4"
                    LET sr2.l_dept16= "gglq002@5"
            WHEN 12 LET sr2.l_dept13= "gglq002@1"  LET sr2.l_dept14= "gglq002@2"
                    LET sr2.l_dept15= "gglq002@3"  LET sr2.l_dept16= "gglq002@4"
                    LET sr2.l_dept17= "gglq002@5"
            WHEN 13 LET sr2.l_dept14= "gglq002@1"  LET sr2.l_dept15= "gglq002@2"
                    LET sr2.l_dept16= "gglq002@3"  LET sr2.l_dept17= "gglq002@4"
                    LET sr2.l_dept18= "gglq002@5"
            WHEN 14 LET sr2.l_dept15= "gglq002@1"  LET sr2.l_dept16= "gglq002@2"
                    LET sr2.l_dept17= "gglq002@3"  LET sr2.l_dept18= "gglq002@4"
                    LET sr2.l_dept19= "gglq002@5"
            WHEN 15 LET sr2.l_dept16= "gglq002@1"  LET sr2.l_dept17= "gglq002@2"
                    LET sr2.l_dept18= "gglq002@3"  LET sr2.l_dept19= "gglq002@4"
                    LET sr2.l_dept20= "gglq002@5"
            WHEN 16 LET sr2.l_dept17= "gglq002@1"  LET sr2.l_dept18= "gglq002@2"
                    LET sr2.l_dept19= "gglq002@3"  LET sr2.l_dept20= "gglq002@4"
                    LET sr2.l_dept21= "gglq002@5"
            WHEN 17 LET sr2.l_dept18= "gglq002@1"  LET sr2.l_dept19= "gglq002@2"
                    LET sr2.l_dept20= "gglq002@3"  LET sr2.l_dept21= "gglq002@4"
                    LET sr2.l_dept22= "gglq002@5"
            WHEN 18 LET sr2.l_dept19= "gglq002@1"  LET sr2.l_dept20= "gglq002@2"
                    LET sr2.l_dept21= "gglq002@3"  LET sr2.l_dept22= "gglq002@4"
                    LET sr2.l_dept23= "gglq002@5"
            WHEN 19 LET sr2.l_dept20= "gglq002@1"  LET sr2.l_dept21= "gglq002@2"
                    LET sr2.l_dept22= "gglq002@3"  LET sr2.l_dept23= "gglq002@4"
                    LET sr2.l_dept24= "gglq002@5"
#add--end
#luttb 101223--add--str--
            WHEN 20 LET sr2.l_dept21= "gglq002@1"  LET sr2.l_dept22= "gglq002@2"
                    LET sr2.l_dept22= "gglq002@3"  LET sr2.l_dept24= "gglq002@4"
                    LET sr2.l_dept24= "gglq002@5"
            WHEN 21 LET sr2.l_dept22= "gglq002@1"  LET sr2.l_dept23= "gglq002@2"
                    LET sr2.l_dept24= "gglq002@3"  LET sr2.l_dept25= "gglq002@4"
                    LET sr2.l_dept26= "gglq002@5"
            WHEN 22 LET sr2.l_dept23= "gglq002@1"  LET sr2.l_dept24= "gglq002@2"
                    LET sr2.l_dept25= "gglq002@3"  LET sr2.l_dept26= "gglq002@4"
                    LET sr2.l_dept27= "gglq002@5"
            WHEN 23 LET sr2.l_dept24= "gglq002@1"  LET sr2.l_dept25= "gglq002@2"
                    LET sr2.l_dept26= "gglq002@3"  LET sr2.l_dept27= "gglq002@4"
                    LET sr2.l_dept28= "gglq002@5"
            WHEN 24 LET sr2.l_dept25= "gglq002@1"  LET sr2.l_dept26= "gglq002@2"
                    LET sr2.l_dept27= "gglq002@3"  LET sr2.l_dept28= "gglq002@4"
                    LET sr2.l_dept29= "gglq002@5"
            WHEN 25 LET sr2.l_dept26= "gglq002@1"  LET sr2.l_dept27= "gglq002@2"
                    LET sr2.l_dept28= "gglq002@3"  LET sr2.l_dept29= "gglq002@4"
                    LET sr2.l_dept30= "gglq002@5"
            WHEN 26 LET sr2.l_dept27= "gglq002@1"  LET sr2.l_dept28= "gglq002@2"
                    LET sr2.l_dept29= "gglq002@3"  LET sr2.l_dept30= "gglq002@4"
                    LET sr2.l_dept31= "gglq002@5"
            WHEN 27 LET sr2.l_dept28= "gglq002@1"  LET sr2.l_dept29= "gglq002@2"
                    LET sr2.l_dept30= "gglq002@3"  LET sr2.l_dept31= "gglq002@4"
                    LET sr2.l_dept32= "gglq002@5"
            WHEN 28 LET sr2.l_dept29= "gglq002@1"  LET sr2.l_dept30= "gglq002@2"
                    LET sr2.l_dept31= "gglq002@3"  LET sr2.l_dept32= "gglq002@4"
                    LET sr2.l_dept33= "gglq002@5"
            WHEN 29 LET sr2.l_dept30= "gglq002@1"  LET sr2.l_dept31= "gglq002@2"
                    LET sr2.l_dept32= "gglq002@3"  LET sr2.l_dept33= "gglq002@4"
                    LET sr2.l_dept34= "gglq002@5"
            WHEN 30 LET sr2.l_dept31= "gglq002@1"  LET sr2.l_dept32= "gglq002@2"
                    LET sr2.l_dept33= "gglq002@3"  LET sr2.l_dept34= "gglq002@4"
                    LET sr2.l_dept35= "gglq002@5"
            WHEN 31 LET sr2.l_dept32= "gglq002@1"  LET sr2.l_dept33= "gglq002@2"
                    LET sr2.l_dept34= "gglq002@3"  LET sr2.l_dept35= "gglq002@4"
                    LET sr2.l_dept36= "gglq002@5"
            WHEN 32 LET sr2.l_dept33= "gglq002@1"  LET sr2.l_dept34= "gglq002@2"
                    LET sr2.l_dept35= "gglq002@3"  LET sr2.l_dept36= "gglq002@4"
                    LET sr2.l_dept37= "gglq002@5"
            WHEN 33 LET sr2.l_dept34= "gglq002@1"  LET sr2.l_dept35= "gglq002@2"
                    LET sr2.l_dept36= "gglq002@3"  LET sr2.l_dept37= "gglq002@4"
                    LET sr2.l_dept38= "gglq002@5"
            WHEN 34 LET sr2.l_dept35= "gglq002@1"  LET sr2.l_dept36= "gglq002@2"
                    LET sr2.l_dept37= "gglq002@3"  LET sr2.l_dept38= "gglq002@4"
                    LET sr2.l_dept39= "gglq002@5"
            WHEN 35 LET sr2.l_dept36= "gglq002@1"  LET sr2.l_dept37= "gglq002@2"
                    LET sr2.l_dept38= "gglq002@3"  LET sr2.l_dept39= "gglq002@4"
                    LET sr2.l_dept40= "gglq002@5"
            WHEN 36 LET sr2.l_dept37= "gglq002@1"  LET sr2.l_dept38= "gglq002@2"
                    LET sr2.l_dept39= "gglq002@3"  LET sr2.l_dept40= "gglq002@4"
                    LET sr2.l_dept41= "gglq002@5"
            WHEN 37 LET sr2.l_dept38= "gglq002@1"  LET sr2.l_dept39= "gglq002@2"
                    LET sr2.l_dept40= "gglq002@3"  LET sr2.l_dept41= "gglq002@4"
                    LET sr2.l_dept42= "gglq002@5"
            WHEN 38 LET sr2.l_dept39= "gglq002@1"  LET sr2.l_dept40= "gglq002@2"
                    LET sr2.l_dept41= "gglq002@3"  LET sr2.l_dept42= "gglq002@4"
                    LET sr2.l_dept43= "gglq002@5"
            WHEN 39 LET sr2.l_dept40= "gglq002@1"  LET sr2.l_dept41= "gglq002@2"
                    LET sr2.l_dept42= "gglq002@3"  LET sr2.l_dept43= "gglq002@4"
                    LET sr2.l_dept44= "gglq002@5"
            WHEN 40 LET sr2.l_dept41= "gglq002@1"  LET sr2.l_dept42= "gglq002@2"
                    LET sr2.l_dept43= "gglq002@3"  LET sr2.l_dept44= "gglq002@4"
                    LET sr2.l_dept45= "gglq002@5"
            WHEN 41 LET sr2.l_dept42= "gglq002@1"  LET sr2.l_dept43= "gglq002@2"
                    LET sr2.l_dept44= "gglq002@3"  LET sr2.l_dept45= "gglq002@4"
                    LET sr2.l_dept46= "gglq002@5"
            WHEN 42 LET sr2.l_dept43= "gglq002@1"  LET sr2.l_dept44= "gglq002@2"
                    LET sr2.l_dept45= "gglq002@3"  LET sr2.l_dept46= "gglq002@4"
                    LET sr2.l_dept47= "gglq002@5"
            WHEN 43 LET sr2.l_dept44= "gglq002@1"  LET sr2.l_dept45= "gglq002@2"
                    LET sr2.l_dept46= "gglq002@3"  LET sr2.l_dept47= "gglq002@4"
                    LET sr2.l_dept48= "gglq002@5"
            WHEN 44 LET sr2.l_dept45= "gglq002@1"  LET sr2.l_dept46= "gglq002@2"
                    LET sr2.l_dept47= "gglq002@3"  LET sr2.l_dept48= "gglq002@4"
                    LET sr2.l_dept49= "gglq002@5"
            WHEN 45 LET sr2.l_dept46= "gglq002@1"  LET sr2.l_dept47= "gglq002@2"
                    LET sr2.l_dept48= "gglq002@3"  LET sr2.l_dept49= "gglq002@4"
                    LET sr2.l_dept50= "gglq002@5"
            WHEN 46 LET sr2.l_dept47= "gglq002@1"  LET sr2.l_dept48= "gglq002@2"
                    LET sr2.l_dept49= "gglq002@3"  LET sr2.l_dept50= "gglq002@4"
                    LET sr2.l_dept51= "gglq002@5"
            WHEN 47 LET sr2.l_dept48= "gglq002@1"  LET sr2.l_dept49= "gglq002@2"
                    LET sr2.l_dept50= "gglq002@3"  LET sr2.l_dept51= "gglq002@4"
                    LET sr2.l_dept52= "gglq002@5"
            WHEN 48 LET sr2.l_dept49= "gglq002@1"  LET sr2.l_dept50= "gglq002@2"
                    LET sr2.l_dept51= "gglq002@3"  LET sr2.l_dept52= "gglq002@4"
                    LET sr2.l_dept53= "gglq002@5"
            WHEN 49 LET sr2.l_dept50= "gglq002@1"  LET sr2.l_dept51= "gglq002@2"
                    LET sr2.l_dept52= "gglq002@3"  LET sr2.l_dept53= "gglq002@4"
                    LET sr2.l_dept54= "gglq002@5"
#luttb 101223--add--end
#luttb 101223--mod--str--
#            WHEN 0 LET sr2.l_dept21= "gglq002@1"  LET sr2.l_dept22= "gglq002@2"
#                   LET sr2.l_dept23= "gglq002@3"  LET sr2.l_dept24= "gglq002@4"
#                   LET sr2.l_dept25= "gglq002@5"
            WHEN 0 LET sr2.l_dept51= "gglq002@1"  LET sr2.l_dept52= "gglq002@2"
                   LET sr2.l_dept53= "gglq002@3"  LET sr2.l_dept54= "gglq002@4"
                   LET sr2.l_dept55= "gglq002@5"
#luttb 101223--mod--end
          END CASE
         #END 部門後面加上5個調整資料
       ...
       DECLARE tmp_curs CURSOR FOR
          SELECT * FROM gglq002_tmp ORDER BY maj02,no
...
#luttb 101223--add--end
           ...
           IF cl_null(sr2.l_dept1) THEN LET sr2.l_dept1 = 'gglq002@0' END IF
           IF cl_null(sr2.l_dept2) THEN LET sr2.l_dept2 = 'gglq002@0' END IF
           IF cl_null(sr2.l_dept3) THEN LET sr2.l_dept3 = 'gglq002@0' END IF
           IF cl_null(sr2.l_dept4) THEN LET sr2.l_dept4 = 'gglq002@0' END IF
           IF cl_null(sr2.l_dept5) THEN LET sr2.l_dept5 = 'gglq002@0' END IF
           IF cl_null(sr2.l_dept6) THEN LET sr2.l_dept6 = 'gglq002@0' END IF
           IF cl_null(sr2.l_dept7) THEN LET sr2.l_dept7 = 'gglq002@0' END IF
           IF cl_null(sr2.l_dept8) THEN LET sr2.l_dept8 = 'gglq002@0' END IF
           IF cl_null(sr2.l_dept9) THEN LET sr2.l_dept9 = 'gglq002@0' END IF
           IF cl_null(sr2.l_dept10) THEN LET sr2.l_dept10 = 'gglq002@0' END IF
           IF cl_null(sr2.l_dept11) THEN LET sr2.l_dept11 = 'gglq002@0' END IF
           IF cl_null(sr2.l_dept12) THEN LET sr2.l_dept12 = 'gglq002@0' END IF
           IF cl_null(sr2.l_dept13) THEN LET sr2.l_dept13 = 'gglq002@0' END IF
           IF cl_null(sr2.l_dept14) THEN LET sr2.l_dept14 = 'gglq002@0' END IF
           IF cl_null(sr2.l_dept15) THEN LET sr2.l_dept15 = 'gglq002@0' END IF
           IF cl_null(sr2.l_dept16) THEN LET sr2.l_dept16 = 'gglq002@0' END IF
           IF cl_null(sr2.l_dept17) THEN LET sr2.l_dept17 = 'gglq002@0' END IF
           IF cl_null(sr2.l_dept18) THEN LET sr2.l_dept18 = 'gglq002@0' END IF
           IF cl_null(sr2.l_dept19) THEN LET sr2.l_dept19 = 'gglq002@0' END IF
           IF cl_null(sr2.l_dept20) THEN LET sr2.l_dept20 = 'gglq002@0' END IF
           IF cl_null(sr2.l_dept21) THEN LET sr2.l_dept21 = 'gglq002@0' END IF
           IF cl_null(sr2.l_dept22) THEN LET sr2.l_dept22 = 'gglq002@0' END IF
           IF cl_null(sr2.l_dept23) THEN LET sr2.l_dept23 = 'gglq002@0' END IF
           IF cl_null(sr2.l_dept24) THEN LET sr2.l_dept24 = 'gglq002@0' END IF
           IF cl_null(sr2.l_dept25) THEN LET sr2.l_dept25 = 'gglq002@0' END IF
#luttb 101223--add--str--
           IF cl_null(sr2.l_dept26) THEN LET sr2.l_dept26 = 'gglq002@0' END IF
           IF cl_null(sr2.l_dept27) THEN LET sr2.l_dept27 = 'gglq002@0' END IF
           IF cl_null(sr2.l_dept28) THEN LET sr2.l_dept28 = 'gglq002@0' END IF
           IF cl_null(sr2.l_dept29) THEN LET sr2.l_dept29 = 'gglq002@0' END IF
           IF cl_null(sr2.l_dept30) THEN LET sr2.l_dept30 = 'gglq002@0' END IF
           IF cl_null(sr2.l_dept31) THEN LET sr2.l_dept31 = 'gglq002@0' END IF
           IF cl_null(sr2.l_dept32) THEN LET sr2.l_dept32 = 'gglq002@0' END IF
           IF cl_null(sr2.l_dept33) THEN LET sr2.l_dept33 = 'gglq002@0' END IF
           IF cl_null(sr2.l_dept34) THEN LET sr2.l_dept34 = 'gglq002@0' END IF
           IF cl_null(sr2.l_dept35) THEN LET sr2.l_dept35 = 'gglq002@0' END IF
           IF cl_null(sr2.l_dept36) THEN LET sr2.l_dept36 = 'gglq002@0' END IF
           IF cl_null(sr2.l_dept37) THEN LET sr2.l_dept37 = 'gglq002@0' END IF
           IF cl_null(sr2.l_dept38) THEN LET sr2.l_dept38 = 'gglq002@0' END IF
           IF cl_null(sr2.l_dept39) THEN LET sr2.l_dept39 = 'gglq002@0' END IF
           IF cl_null(sr2.l_dept40) THEN LET sr2.l_dept40 = 'gglq002@0' END IF
           IF cl_null(sr2.l_dept41) THEN LET sr2.l_dept41 = 'gglq002@0' END IF
           IF cl_null(sr2.l_dept42) THEN LET sr2.l_dept42 = 'gglq002@0' END IF
           IF cl_null(sr2.l_dept43) THEN LET sr2.l_dept43 = 'gglq002@0' END IF
           IF cl_null(sr2.l_dept44) THEN LET sr2.l_dept44 = 'gglq002@0' END IF
           IF cl_null(sr2.l_dept45) THEN LET sr2.l_dept45 = 'gglq002@0' END IF
           IF cl_null(sr2.l_dept46) THEN LET sr2.l_dept46 = 'gglq002@0' END IF
           IF cl_null(sr2.l_dept47) THEN LET sr2.l_dept47 = 'gglq002@0' END IF
           IF cl_null(sr2.l_dept48) THEN LET sr2.l_dept48 = 'gglq002@0' END IF
           IF cl_null(sr2.l_dept49) THEN LET sr2.l_dept49 = 'gglq002@0' END IF
           IF cl_null(sr2.l_dept50) THEN LET sr2.l_dept50 = 'gglq002@0' END IF
           IF cl_null(sr2.l_dept51) THEN LET sr2.l_dept51 = 'gglq002@0' END IF
           IF cl_null(sr2.l_dept52) THEN LET sr2.l_dept52 = 'gglq002@0' END IF
           IF cl_null(sr2.l_dept53) THEN LET sr2.l_dept53 = 'gglq002@0' END IF
           IF cl_null(sr2.l_dept54) THEN LET sr2.l_dept54 = 'gglq002@0' END IF
           IF cl_null(sr2.l_dept55) THEN LET sr2.l_dept55 = 'gglq002@0' END IF
#luttb 101223--add--end
...
#  CALL cl_prt_cs3('gglq002','gglq002',g_sql,g_str)
#寫入CR准備的臨時表--end
...
FUNCTION gglq002_cs()
     ...
     LET g_sql = "SELECT UNIQUE * FROM gglq002_tmp2 " 
     PREPARE gglq002_ps FROM g_sql
     DECLARE gglq002_curs SCROLL CURSOR WITH HOLD FOR gglq002_ps

     LET g_sql = "SELECT UNIQUE * FROM gglq002_tmp2 ",
                 "  INTO TEMP x "
     DROP TABLE x
     PREPARE gglq002_ps1 FROM g_sql
     EXECUTE gglq002_ps1

     LET g_sql = "SELECT COUNT(*) FROM x"
     PREPARE gglq002_ps2 FROM g_sql
     DECLARE gglq002_cnt CURSOR FOR gglq002_ps2

     OPEN gglq002_curs
     IF SQLCA.sqlcode THEN
        CALL cl_err('OPEN gglq002_curs',SQLCA.sqlcode,0)
        CALL cl_used(g_prog,g_time,2) RETURNING g_time           #FUN-B80096   ADD
        EXIT PROGRAM
     ELSE
        OPEN gglq002_cnt
        FETCH gglq002_cnt INTO g_row_count
        DISPLAY g_row_count TO FORMONLY.cnt
     END IF
     CALL gglq002_show()
END FUNCTION

FUNCTION gglq002_show()
...
FUNCTION gglq002_b_fill()
  ...
  DEFINE  l_dbs      LIKE azp_file.azp03
   LET g_sql = "SELECT *",
               " FROM gglq002_tmp2 ORDER BY maj02"  #No.TQC-B70042 
   PREPARE gglq002_pb FROM g_sql
   DECLARE abb_curs  CURSOR FOR gglq002_pb
...
FUNCTION q002_out_1()
   ...
   LET l_table = cl_prt_temptable('gglq002',g_sql) CLIPPED
   IF l_table = -1 THEN 
      CALL cl_used(g_prog,g_time,2) RETURNING g_time           #FUN-B80096   ADD
      EXIT PROGRAM
   END IF
...
FUNCTION gglq002_table()
#luttb 101225 gglq002_tmp2 add column sum21--sum50
     DROP TABLE gglq002_tmp;
     CREATE TEMP TABLE gglq002_tmp(
                    no       LIKE type_file.num5,
     ...
     DROP TABLE gglq002_tmp2;
     CREATE TEMP TABLE gglq002_tmp2(
   ...
   DEFINE l_count              LIKE type_file.num5
    ...
    FOREACH q002_c INTO maj.*
	  ...
	  IF maj.maj03 = '%' THEN
	     ...
	     SELECT bal1 INTO l_sun FROM gglq002_tmp WHERE no=l_cn
	            AND maj02=l_temp
	     LET l_temp = maj.maj22
	     SELECT bal1 INTO l_mon FROM gglq002_tmp WHERE no=l_cn
	            AND maj02=l_temp
       ...
       END IF
       INSERT INTO gglq002_tmp VALUES
       ...
       IF STATUS OR SQLCA.SQLERRD[3] = 0 THEN
          CALL cl_err3("ins","gglq002_tmp",l_cn,maj.maj02,STATUS,"","ins gglq002_tmp",1) 
          EXIT FOREACH 
       END IF
    END FOREACH
END FUNCTION
