...
#
# Pattern name...: gglt1101.4gl
# Descriptions...: 沖銷作業-未實現損益
...
MAIN
   ...
   IF g_bgjob='N' OR cl_null(g_bgjob) THEN
      OPEN WINDOW t0014_w AT p_row,p_col WITH FORM "ggl/42f/gglt1101"
            ATTRIBUTE (STYLE = g_win_style CLIPPED)
      
      CALL cl_ui_init()
   END IF
   CALL t001('2','2',g_argv1,g_argv2) 

   IF g_bgjob='N' OR cl_null(g_bgjob) THEN
      CLOSE WINDOW t0014_w                 #結束畫面
   END IF
