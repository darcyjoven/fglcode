...
MAIN
   ...
   OPEN WINDOW q001_w AT 5,10
        WITH FORM "ggl/42f/gglq023" ATTRIBUTE(STYLE = g_win_style)
...
FUNCTION gglq023_tm()
   ...
   OPEN WINDOW gglq023_w1 AT p_row,p_col
        WITH FORM "ggl/42f/gglq023_1"
        ATTRIBUTE (STYLE = g_win_style CLIPPED)

   CALL cl_ui_locale("gglq023_1")
      ...
      INPUT BY NAME tm.rtype,tm.a,tm.b,tm.ver,tm.asa01,tm.asa02,tm.asa03, 
         ...
         ON CHANGE rtype
           ...
           ELSE
              LET l_mai03 = '3'
           END IF
           SELECT mai01 INTO tm.a FROM mai_file WHERE mai00 = g_asz.asz01 AND mai03 = l_mai03
         ...
         AFTER FIELD asa03
            IF cl_null(tm.asa03) THEN NEXT FIELD asa03 END IF
      ...
      IF g_bgjob = 'Y' THEN
         ...
         ELSE
            LET l_cmd = l_cmd CLIPPED,
                        ...
                        " '",g_template CLIPPED,"'",
                        " '",tm.ver CLIPPED,"'"     
            CALL cl_cmdat('gglq023',g_time,l_cmd)    # Execute cmd at later time
         END IF
         CLOSE WINDOW gglq023_w1
         CALL cl_used(g_prog,g_time,2) RETURNING g_time  #No.FUN-C80020
         EXIT PROGRAM
      END IF
      CALL cl_wait()
      CALL gglq023()
...
FUNCTION gglq023()
   ...
   DELETE FROM gglq023_tmp2   #luttb
   DELETE FROM gglq023_tmp    #luttb

   LET g_sql = "INSERT INTO gglq023_tmp2",
               " VALUES(?,?,?,?,?, ?,?,?,?,?,",
               "        ?,?,?,?,?, ?,?,?,?,?,",
               "        ?,?,?,?,?, ?,?,?,?,?,",
               "        ?,?,?,?,?, ?,?,?,?,?,",
  ...
  #將族群填入array------------------------------------------------------
      LET l_sql = " SELECT asa01,asa02,asa03,asa02,asa03",
                  ...
                  "  WHERE asa01=asb01 AND asa02=asb02 AND asa03=asb03 ",
                  "    AND asa01='",tm.asa01,"'",
                 #"    AND asb07 > 20 ",     #FUN-B90026    
                  "    AND asb06 = 'Y'",     #FUN-B90026
                  "  ORDER BY 1,2,3,4 "
   END IF  #FUN-B90057
   PREPARE q001_asa_p FROM l_sql
   IF STATUS THEN CALL cl_err('prepare:',STATUS,1) 
      CALL cl_used(g_prog,g_time,2) RETURNING g_time
      EXIT PROGRAM 
   END IF
   DECLARE q001_asa_c CURSOR FOR q001_asa_p
   LET g_no = 1
   FOREACH q001_asa_c INTO g_dept[g_no].*
       IF SQLCA.SQLCODE THEN
  ...
  #---------------------------------------------------
   ...
   FOR l_i = 50 TO l_cnt STEP 50 
          ...
          FOR l_cn = 1 TO 50
             ...
             #START 新版部門要拆開,不一次把5個部門寫入一個字串裡
              CASE l_cn
                   ...
                   WHEN 56 LET sr2.l_dept52 = g_dept[l_cn+g_group].asb04
                   WHEN 57 LET sr2.l_dept53 = g_dept[l_cn+g_group].asb04
                   WHEN 58 LET sr2.l_dept54 = g_dept[l_cn+g_group].asb04
                   WHEN 59 LET sr2.l_dept55 = g_dept[l_cn+g_group].asb04
       ...
       ELSE
         ...
         #START 部門後面加上9個調整資料
         #gglq023@1 = 調整(D)     gglq023@2 = 調整(C)
         #gglq023@3 = 销除(D)     gglq023@4 = 销除(C)
         #gglq023@5 = 會計師調整(D)     gglq023@6 = 會計師調整(C)
         #gglq023@7 = SUM2(调整前合计)  gglq023@8 = SUM3(原始+调整+消除)
         #gglq023@9 = 合併後     
         #-----------------------------------------------------
          CASE g_cn MOD 50
            WHEN 1  LET sr2.l_dept2 = "gglq023@1"  LET sr2.l_dept3 = "gglq023@2"
                    LET sr2.l_dept4 = "gglq023@3"  LET sr2.l_dept5 = "gglq023@4"
                    LET sr2.l_dept6 = "gglq023@5"  LET sr2.l_dept7 = "gglq023@6"
                    LET sr2.l_dept8 = "gglq023@7"  LET sr2.l_dept9 = "gglq023@8"
                    LET sr2.l_dept10= "gglq023@9"
            WHEN 2  LET sr2.l_dept3 = "gglq023@1"  LET sr2.l_dept4 = "gglq023@2"
                    LET sr2.l_dept5 = "gglq023@3"  LET sr2.l_dept6 = "gglq023@4"
                    LET sr2.l_dept7 = "gglq023@5"  LET sr2.l_dept8 = "gglq023@6"
                    LET sr2.l_dept9 = "gglq023@7"  LET sr2.l_dept10= "gglq023@8"
                    LET sr2.l_dept11 = "gglq023@9"
            WHEN 3  LET sr2.l_dept4 = "gglq023@1"  LET sr2.l_dept5 = "gglq023@2"
                    LET sr2.l_dept6 = "gglq023@3"  LET sr2.l_dept7 = "gglq023@4"
                    LET sr2.l_dept8 = "gglq023@5"  LET sr2.l_dept9 = "gglq023@6"
                    LET sr2.l_dept10= "gglq023@7"  LET sr2.l_dept11= "gglq023@8"
                    LET sr2.l_dept12 = "gglq023@9"
            WHEN 4  LET sr2.l_dept5 = "gglq023@1"  LET sr2.l_dept6 = "gglq023@2"
                    LET sr2.l_dept7 = "gglq023@3"  LET sr2.l_dept8 = "gglq023@4"
                    LET sr2.l_dept9 = "gglq023@5"  LET sr2.l_dept10= "gglq023@6"
                    LET sr2.l_dept11= "gglq023@7"  LET sr2.l_dept12= "gglq023@8"
                    LET sr2.l_dept13 = "gglq023@9"
            WHEN 5  LET sr2.l_dept6 = "gglq023@1"  LET sr2.l_dept7 = "gglq023@2"
                    LET sr2.l_dept8 = "gglq023@3"  LET sr2.l_dept9 = "gglq023@4"
                    LET sr2.l_dept10= "gglq023@5"  LET sr2.l_dept11= "gglq023@6"
                    LET sr2.l_dept12= "gglq023@7"  LET sr2.l_dept13= "gglq023@8"
                    LET sr2.l_dept14 = "gglq023@9"
            WHEN 6  LET sr2.l_dept7 = "gglq023@1"  LET sr2.l_dept8 = "gglq023@2"
                    LET sr2.l_dept9 = "gglq023@3"  LET sr2.l_dept10= "gglq023@4"
                    LET sr2.l_dept11= "gglq023@5"  LET sr2.l_dept12= "gglq023@6"
                    LET sr2.l_dept13= "gglq023@7"  LET sr2.l_dept14= "gglq023@8"
                    LET sr2.l_dept15 = "gglq023@9"
            WHEN 7  LET sr2.l_dept8 = "gglq023@1"  LET sr2.l_dept9 = "gglq023@2"
                    LET sr2.l_dept10= "gglq023@3"  LET sr2.l_dept11= "gglq023@4"
                    LET sr2.l_dept12= "gglq023@5"  LET sr2.l_dept13= "gglq023@6"
                    LET sr2.l_dept14= "gglq023@7"  LET sr2.l_dept15= "gglq023@8"
                    LET sr2.l_dept16 = "gglq023@9"
            WHEN 8  LET sr2.l_dept9 = "gglq023@1"  LET sr2.l_dept10= "gglq023@2"
                    LET sr2.l_dept11= "gglq023@3"  LET sr2.l_dept12= "gglq023@4"
                    LET sr2.l_dept13= "gglq023@5"  LET sr2.l_dept14= "gglq023@6"
                    LET sr2.l_dept15= "gglq023@7"  LET sr2.l_dept16= "gglq023@8"
                    LET sr2.l_dept17 = "gglq023@9"
            WHEN 9  LET sr2.l_dept10= "gglq023@1"  LET sr2.l_dept11= "gglq023@2"
                    LET sr2.l_dept12= "gglq023@3"  LET sr2.l_dept13= "gglq023@4"
                    LET sr2.l_dept14= "gglq023@5"  LET sr2.l_dept15= "gglq023@6"
                    LET sr2.l_dept16= "gglq023@7"  LET sr2.l_dept17= "gglq023@8"
                    LET sr2.l_dept18 = "gglq023@9"
            WHEN 10 LET sr2.l_dept11= "gglq023@1"  LET sr2.l_dept12= "gglq023@2"
                    LET sr2.l_dept13= "gglq023@3"  LET sr2.l_dept14= "gglq023@4"
                    LET sr2.l_dept15= "gglq023@5"  LET sr2.l_dept16= "gglq023@6"
                    LET sr2.l_dept17= "gglq023@7"  LET sr2.l_dept18= "gglq023@8"
                    LET sr2.l_dept19 = "gglq023@9"
            WHEN 11 LET sr2.l_dept12= "gglq023@1"  LET sr2.l_dept13= "gglq023@2"
                    LET sr2.l_dept14= "gglq023@3"  LET sr2.l_dept15= "gglq023@4"
                    LET sr2.l_dept16= "gglq023@5"  LET sr2.l_dept17= "gglq023@6"
                    LET sr2.l_dept18= "gglq023@7"  LET sr2.l_dept19= "gglq023@8"
                    LET sr2.l_dept20 = "gglq023@9"
            WHEN 12 LET sr2.l_dept13= "gglq023@1"  LET sr2.l_dept14= "gglq023@2"
                    LET sr2.l_dept15= "gglq023@3"  LET sr2.l_dept16= "gglq023@4"
                    LET sr2.l_dept17= "gglq023@5"  LET sr2.l_dept18= "gglq023@6"
                    LET sr2.l_dept19= "gglq023@7"  LET sr2.l_dept20= "gglq023@8"
                    LET sr2.l_dept21 = "gglq023@9"
            WHEN 13 LET sr2.l_dept14= "gglq023@1"  LET sr2.l_dept15= "gglq023@2"
                    LET sr2.l_dept16= "gglq023@3"  LET sr2.l_dept17= "gglq023@4"
                    LET sr2.l_dept18= "gglq023@5"  LET sr2.l_dept19= "gglq023@6"
                    LET sr2.l_dept20= "gglq023@7"  LET sr2.l_dept21= "gglq023@8"
                    LET sr2.l_dept22 = "gglq023@9"
            WHEN 14 LET sr2.l_dept15= "gglq023@1"  LET sr2.l_dept16= "gglq023@2"
                    LET sr2.l_dept17= "gglq023@3"  LET sr2.l_dept18= "gglq023@4"
                    LET sr2.l_dept19= "gglq023@5"  LET sr2.l_dept20= "gglq023@6"
                    LET sr2.l_dept21= "gglq023@7"  LET sr2.l_dept22= "gglq023@8"
                    LET sr2.l_dept23 = "gglq023@9"
            WHEN 15 LET sr2.l_dept16= "gglq023@1"  LET sr2.l_dept17= "gglq023@2"
                    LET sr2.l_dept18= "gglq023@3"  LET sr2.l_dept19= "gglq023@4"
                    LET sr2.l_dept20= "gglq023@5"  LET sr2.l_dept21= "gglq023@6"
                    LET sr2.l_dept22= "gglq023@7"  LET sr2.l_dept23= "gglq023@8"
                    LET sr2.l_dept24 = "gglq023@9"
            WHEN 16 LET sr2.l_dept17= "gglq023@1"  LET sr2.l_dept18= "gglq023@2"
                    LET sr2.l_dept19= "gglq023@3"  LET sr2.l_dept20= "gglq023@4"
                    LET sr2.l_dept21= "gglq023@5"  LET sr2.l_dept22= "gglq023@6"
                    LET sr2.l_dept23= "gglq023@7"  LET sr2.l_dept24= "gglq023@8"
                    LET sr2.l_dept25 = "gglq023@9"
            WHEN 17 LET sr2.l_dept18= "gglq023@1"  LET sr2.l_dept19= "gglq023@2"
                    LET sr2.l_dept20= "gglq023@3"  LET sr2.l_dept21= "gglq023@4"
                    LET sr2.l_dept22= "gglq023@5"  LET sr2.l_dept23= "gglq023@6"
                    LET sr2.l_dept24= "gglq023@7"  LET sr2.l_dept25= "gglq023@8"
                    LET sr2.l_dept26 = "gglq023@9"
            WHEN 18 LET sr2.l_dept19= "gglq023@1"  LET sr2.l_dept20= "gglq023@2"
                    LET sr2.l_dept21= "gglq023@3"  LET sr2.l_dept22= "gglq023@4"
                    LET sr2.l_dept23= "gglq023@5"  LET sr2.l_dept24= "gglq023@6"
                    LET sr2.l_dept25= "gglq023@7"  LET sr2.l_dept26= "gglq023@8"
                    LET sr2.l_dept27 = "gglq023@9"
            WHEN 19 LET sr2.l_dept20= "gglq023@1"  LET sr2.l_dept21= "gglq023@2"
                    LET sr2.l_dept22= "gglq023@3"  LET sr2.l_dept23= "gglq023@4"
                    LET sr2.l_dept24= "gglq023@5"  LET sr2.l_dept25= "gglq023@6"
                    LET sr2.l_dept26= "gglq023@7"  LET sr2.l_dept27= "gglq023@8"
                    LET sr2.l_dept28 = "gglq023@9"
            WHEN 20 LET sr2.l_dept21= "gglq023@1"  LET sr2.l_dept22= "gglq023@2"
                    LET sr2.l_dept23= "gglq023@3"  LET sr2.l_dept24= "gglq023@4"
                    LET sr2.l_dept25= "gglq023@5"  LET sr2.l_dept26= "gglq023@6"
                    LET sr2.l_dept27= "gglq023@7"  LET sr2.l_dept28= "gglq023@8"
                    LET sr2.l_dept29 = "gglq023@9"
            WHEN 21 LET sr2.l_dept22= "gglq023@1"  LET sr2.l_dept23= "gglq023@2"
                    LET sr2.l_dept24= "gglq023@3"  LET sr2.l_dept25= "gglq023@4"
                    LET sr2.l_dept26= "gglq023@5"  LET sr2.l_dept27= "gglq023@6"
                    LET sr2.l_dept28= "gglq023@7"  LET sr2.l_dept29= "gglq023@8"
                    LET sr2.l_dept30= "gglq023@9"
            WHEN 22 LET sr2.l_dept23= "gglq023@1"  LET sr2.l_dept24= "gglq023@2"
                    LET sr2.l_dept25= "gglq023@3"  LET sr2.l_dept26= "gglq023@4"
                    LET sr2.l_dept27= "gglq023@5"  LET sr2.l_dept28= "gglq023@6"
                    LET sr2.l_dept29= "gglq023@7"  LET sr2.l_dept30= "gglq023@8"
                    LET sr2.l_dept31= "gglq023@9"
            WHEN 23 LET sr2.l_dept24= "gglq023@1"  LET sr2.l_dept25= "gglq023@2"
                    LET sr2.l_dept26= "gglq023@3"  LET sr2.l_dept27= "gglq023@4"
                    LET sr2.l_dept28= "gglq023@5"  LET sr2.l_dept29= "gglq023@6"
                    LET sr2.l_dept30= "gglq023@7"  LET sr2.l_dept31= "gglq023@8"
                    LET sr2.l_dept32= "gglq023@9"
            WHEN 24 LET sr2.l_dept25= "gglq023@1"  LET sr2.l_dept26= "gglq023@2"
                    LET sr2.l_dept27= "gglq023@3"  LET sr2.l_dept28= "gglq023@4"
                    LET sr2.l_dept29= "gglq023@5"  LET sr2.l_dept30= "gglq023@6"
                    LET sr2.l_dept31= "gglq023@7"  LET sr2.l_dept32= "gglq023@8"
                    LET sr2.l_dept33= "gglq023@9"
            WHEN 25 LET sr2.l_dept26= "gglq023@1"  LET sr2.l_dept27= "gglq023@2"
                    LET sr2.l_dept28= "gglq023@3"  LET sr2.l_dept29= "gglq023@4"
                    LET sr2.l_dept30= "gglq023@5"  LET sr2.l_dept31= "gglq023@6"
                    LET sr2.l_dept32= "gglq023@7"  LET sr2.l_dept33= "gglq023@8"
                    LET sr2.l_dept34= "gglq023@9"
            WHEN 26 LET sr2.l_dept27= "gglq023@1"  LET sr2.l_dept28= "gglq023@2"
                    LET sr2.l_dept29= "gglq023@3"  LET sr2.l_dept30= "gglq023@4"
                    LET sr2.l_dept31= "gglq023@5"  LET sr2.l_dept32= "gglq023@6"
                    LET sr2.l_dept33= "gglq023@7"  LET sr2.l_dept34= "gglq023@8"
                    LET sr2.l_dept35= "gglq023@9"
            WHEN 27 LET sr2.l_dept28= "gglq023@1"  LET sr2.l_dept29= "gglq023@2"
                    LET sr2.l_dept30= "gglq023@3"  LET sr2.l_dept31= "gglq023@4"
                    LET sr2.l_dept32= "gglq023@5"  LET sr2.l_dept33= "gglq023@6"
                    LET sr2.l_dept34= "gglq023@7"  LET sr2.l_dept35= "gglq023@8"
                    LET sr2.l_dept36= "gglq023@9"
            WHEN 28 LET sr2.l_dept29= "gglq023@1"  LET sr2.l_dept30= "gglq023@2"
                    LET sr2.l_dept31= "gglq023@3"  LET sr2.l_dept32= "gglq023@4"
                    LET sr2.l_dept33= "gglq023@5"  LET sr2.l_dept34= "gglq023@6"
                    LET sr2.l_dept35= "gglq023@7"  LET sr2.l_dept36= "gglq023@8"
                    LET sr2.l_dept37= "gglq023@9"
            WHEN 29 LET sr2.l_dept30= "gglq023@1"  LET sr2.l_dept31= "gglq023@2"
                    LET sr2.l_dept32= "gglq023@3"  LET sr2.l_dept33= "gglq023@4"
                    LET sr2.l_dept34= "gglq023@5"  LET sr2.l_dept35= "gglq023@6"
                    LET sr2.l_dept36= "gglq023@7"  LET sr2.l_dept37= "gglq023@8"
                    LET sr2.l_dept38= "gglq023@9"
            WHEN 30 LET sr2.l_dept31= "gglq023@1"  LET sr2.l_dept32= "gglq023@2"
                    LET sr2.l_dept33= "gglq023@3"  LET sr2.l_dept34= "gglq023@4"
                    LET sr2.l_dept35= "gglq023@5"  LET sr2.l_dept36= "gglq023@6"
                    LET sr2.l_dept37= "gglq023@7"  LET sr2.l_dept38= "gglq023@8"
                    LET sr2.l_dept39= "gglq023@9"
            WHEN 31 LET sr2.l_dept32= "gglq023@1"  LET sr2.l_dept33= "gglq023@2"
                    LET sr2.l_dept34= "gglq023@3"  LET sr2.l_dept35= "gglq023@4"
                    LET sr2.l_dept36= "gglq023@5"  LET sr2.l_dept37= "gglq023@6"
                    LET sr2.l_dept38= "gglq023@7"  LET sr2.l_dept39= "gglq023@8"
                    LET sr2.l_dept40= "gglq023@9"
            WHEN 32 LET sr2.l_dept33= "gglq023@1"  LET sr2.l_dept34= "gglq023@2"
                    LET sr2.l_dept35= "gglq023@3"  LET sr2.l_dept36= "gglq023@4"
                    LET sr2.l_dept37= "gglq023@5"  LET sr2.l_dept38= "gglq023@6"
                    LET sr2.l_dept39= "gglq023@7"  LET sr2.l_dept40= "gglq023@8"
                    LET sr2.l_dept41= "gglq023@9"
            WHEN 33 LET sr2.l_dept34= "gglq023@1"  LET sr2.l_dept35= "gglq023@2"
                    LET sr2.l_dept36= "gglq023@3"  LET sr2.l_dept37= "gglq023@4"
                    LET sr2.l_dept38= "gglq023@5"  LET sr2.l_dept39= "gglq023@6"
                    LET sr2.l_dept40= "gglq023@7"  LET sr2.l_dept41= "gglq023@8"
                    LET sr2.l_dept42= "gglq023@9"
            WHEN 34 LET sr2.l_dept35= "gglq023@1"  LET sr2.l_dept36= "gglq023@2"
                    LET sr2.l_dept37= "gglq023@3"  LET sr2.l_dept38= "gglq023@4"
                    LET sr2.l_dept39= "gglq023@5"  LET sr2.l_dept40= "gglq023@6"
                    LET sr2.l_dept41= "gglq023@7"  LET sr2.l_dept42= "gglq023@8"
                    LET sr2.l_dept43= "gglq023@9"
            WHEN 35 LET sr2.l_dept36= "gglq023@1"  LET sr2.l_dept37= "gglq023@2"
                    LET sr2.l_dept38= "gglq023@3"  LET sr2.l_dept39= "gglq023@4"
                    LET sr2.l_dept40= "gglq023@5"  LET sr2.l_dept41= "gglq023@6"
                    LET sr2.l_dept42= "gglq023@7"  LET sr2.l_dept43= "gglq023@8"
                    LET sr2.l_dept44= "gglq023@9"
            WHEN 36 LET sr2.l_dept37= "gglq023@1"  LET sr2.l_dept38= "gglq023@2"
                    LET sr2.l_dept39= "gglq023@3"  LET sr2.l_dept40= "gglq023@4"
                    LET sr2.l_dept41= "gglq023@5"  LET sr2.l_dept42= "gglq023@6"
                    LET sr2.l_dept43= "gglq023@7"  LET sr2.l_dept44= "gglq023@8"
                    LET sr2.l_dept45= "gglq023@9"
            WHEN 37 LET sr2.l_dept38= "gglq023@1"  LET sr2.l_dept39= "gglq023@2"
                    LET sr2.l_dept40= "gglq023@3"  LET sr2.l_dept41= "gglq023@4"
                    LET sr2.l_dept42= "gglq023@5"  LET sr2.l_dept43= "gglq023@6"
                    LET sr2.l_dept44= "gglq023@7"  LET sr2.l_dept45= "gglq023@8"
                    LET sr2.l_dept46= "gglq023@9"
            WHEN 38 LET sr2.l_dept39= "gglq023@1"  LET sr2.l_dept40= "gglq023@2"
                    LET sr2.l_dept41= "gglq023@3"  LET sr2.l_dept42= "gglq023@4"
                    LET sr2.l_dept43= "gglq023@5"  LET sr2.l_dept44= "gglq023@6"
                    LET sr2.l_dept45= "gglq023@7"  LET sr2.l_dept46= "gglq023@8"
                    LET sr2.l_dept47= "gglq023@9"
            WHEN 39 LET sr2.l_dept40= "gglq023@1"  LET sr2.l_dept41= "gglq023@2"
                    LET sr2.l_dept42= "gglq023@3"  LET sr2.l_dept43= "gglq023@4"
                    LET sr2.l_dept44= "gglq023@5"  LET sr2.l_dept45= "gglq023@6"
                    LET sr2.l_dept46= "gglq023@7"  LET sr2.l_dept47= "gglq023@8"
                    LET sr2.l_dept48= "gglq023@9"
            WHEN 40 LET sr2.l_dept41= "gglq023@1"  LET sr2.l_dept42= "gglq023@2"
                    LET sr2.l_dept43= "gglq023@3"  LET sr2.l_dept44= "gglq023@4"
                    LET sr2.l_dept45= "gglq023@5"  LET sr2.l_dept46= "gglq023@6"
                    LET sr2.l_dept47= "gglq023@7"  LET sr2.l_dept48= "gglq023@8"
                    LET sr2.l_dept49= "gglq023@9"
            WHEN 41 LET sr2.l_dept42= "gglq023@1"  LET sr2.l_dept43= "gglq023@2"
                    LET sr2.l_dept44= "gglq023@3"  LET sr2.l_dept45= "gglq023@4"
                    LET sr2.l_dept46= "gglq023@5"  LET sr2.l_dept47= "gglq023@6"
                    LET sr2.l_dept48= "gglq023@7"  LET sr2.l_dept49= "gglq023@8"
                    LET sr2.l_dept50= "gglq023@9"
            WHEN 42 LET sr2.l_dept43= "gglq023@1"  LET sr2.l_dept44= "gglq023@2"
                    LET sr2.l_dept45= "gglq023@3"  LET sr2.l_dept46= "gglq023@4"
                    LET sr2.l_dept47= "gglq023@5"  LET sr2.l_dept48= "gglq023@6"
                    LET sr2.l_dept49= "gglq023@7"  LET sr2.l_dept50= "gglq023@8"
                    LET sr2.l_dept51= "gglq023@9"
            WHEN 43 LET sr2.l_dept44= "gglq023@1"  LET sr2.l_dept45= "gglq023@2"
                    LET sr2.l_dept46= "gglq023@3"  LET sr2.l_dept47= "gglq023@4"
                    LET sr2.l_dept48= "gglq023@5"  LET sr2.l_dept49= "gglq023@6"
                    LET sr2.l_dept50= "gglq023@7"  LET sr2.l_dept51= "gglq023@8"
                    LET sr2.l_dept52= "gglq023@9"
            WHEN 44 LET sr2.l_dept45= "gglq023@1"  LET sr2.l_dept46= "gglq023@2"
                    LET sr2.l_dept47= "gglq023@3"  LET sr2.l_dept48= "gglq023@4"
                    LET sr2.l_dept49= "gglq023@5"  LET sr2.l_dept50= "gglq023@6"
                    LET sr2.l_dept51= "gglq023@7"  LET sr2.l_dept52= "gglq023@8"
                    LET sr2.l_dept53= "gglq023@9"
            WHEN 45 LET sr2.l_dept46= "gglq023@1"  LET sr2.l_dept47= "gglq023@2"
                    LET sr2.l_dept48= "gglq023@3"  LET sr2.l_dept49= "gglq023@4"
                    LET sr2.l_dept50= "gglq023@5"  LET sr2.l_dept51= "gglq023@6"
                    LET sr2.l_dept52= "gglq023@7"  LET sr2.l_dept53= "gglq023@8"
                    LET sr2.l_dept54= "gglq023@9"
            WHEN 46 LET sr2.l_dept47= "gglq023@1"  LET sr2.l_dept48= "gglq023@2"
                    LET sr2.l_dept49= "gglq023@3"  LET sr2.l_dept50= "gglq023@4"
                    LET sr2.l_dept51= "gglq023@5"  LET sr2.l_dept52= "gglq023@6"
                    LET sr2.l_dept53= "gglq023@7"  LET sr2.l_dept54= "gglq023@8"
                    LET sr2.l_dept55= "gglq023@9"
            WHEN 47 LET sr2.l_dept48= "gglq023@1"  LET sr2.l_dept49= "gglq023@2"
                    LET sr2.l_dept50= "gglq023@3"  LET sr2.l_dept51= "gglq023@4"
                    LET sr2.l_dept52= "gglq023@5"  LET sr2.l_dept53= "gglq023@6"
                    LET sr2.l_dept54= "gglq023@7"  LET sr2.l_dept55= "gglq023@8"
                    LET sr2.l_dept56= "gglq023@9"
            WHEN 48 LET sr2.l_dept49= "gglq023@1"  LET sr2.l_dept50= "gglq023@2"
                    LET sr2.l_dept51= "gglq023@3"  LET sr2.l_dept52= "gglq023@4"
                    LET sr2.l_dept53= "gglq023@5"  LET sr2.l_dept54= "gglq023@6"
                    LET sr2.l_dept55= "gglq023@7"  LET sr2.l_dept56= "gglq023@8"
                    LET sr2.l_dept57= "gglq023@9"
            WHEN 49 LET sr2.l_dept50= "gglq023@1"  LET sr2.l_dept51= "gglq023@2"
                    LET sr2.l_dept52= "gglq023@3"  LET sr2.l_dept53= "gglq023@4"
                    LET sr2.l_dept54= "gglq023@5"  LET sr2.l_dept55= "gglq023@6"
                    LET sr2.l_dept56= "gglq023@7"  LET sr2.l_dept57= "gglq023@8"
                    LET sr2.l_dept58= "gglq023@9"
            WHEN 0 LET sr2.l_dept51= "gglq023@1"  LET sr2.l_dept52= "gglq023@2"
                   LET sr2.l_dept53= "gglq023@3"  LET sr2.l_dept54= "gglq023@4"
                   LET sr2.l_dept55= "gglq023@5"  LET sr2.l_dept56= "gglq023@6"
                   LET sr2.l_dept57= "gglq023@7"  LET sr2.l_dept58= "gglq023@8"
                   LET sr2.l_dept59= "gglq023@9"
          END CASE
         #END 部門後面加上5個調整資料
       ...
       DECLARE tmp_curs CURSOR FOR
          SELECT * FROM gglq023_tmp ORDER BY maj02,no
...
#借貸方處理應該在處理合計階前就轉換好-------(E)
           ...
           IF cl_null(sr2.l_dept1) THEN LET sr2.l_dept1 = 'gglq023@0' END IF
           IF cl_null(sr2.l_dept2) THEN LET sr2.l_dept2 = 'gglq023@0' END IF
           IF cl_null(sr2.l_dept3) THEN LET sr2.l_dept3 = 'gglq023@0' END IF
           IF cl_null(sr2.l_dept4) THEN LET sr2.l_dept4 = 'gglq023@0' END IF
           IF cl_null(sr2.l_dept5) THEN LET sr2.l_dept5 = 'gglq023@0' END IF
           IF cl_null(sr2.l_dept6) THEN LET sr2.l_dept6 = 'gglq023@0' END IF
           IF cl_null(sr2.l_dept7) THEN LET sr2.l_dept7 = 'gglq023@0' END IF
           IF cl_null(sr2.l_dept8) THEN LET sr2.l_dept8 = 'gglq023@0' END IF
           IF cl_null(sr2.l_dept9) THEN LET sr2.l_dept9 = 'gglq023@0' END IF
           IF cl_null(sr2.l_dept10) THEN LET sr2.l_dept10 = 'gglq023@0' END IF
           IF cl_null(sr2.l_dept11) THEN LET sr2.l_dept11 = 'gglq023@0' END IF
           IF cl_null(sr2.l_dept12) THEN LET sr2.l_dept12 = 'gglq023@0' END IF
           IF cl_null(sr2.l_dept13) THEN LET sr2.l_dept13 = 'gglq023@0' END IF
           IF cl_null(sr2.l_dept14) THEN LET sr2.l_dept14 = 'gglq023@0' END IF
           IF cl_null(sr2.l_dept15) THEN LET sr2.l_dept15 = 'gglq023@0' END IF
           IF cl_null(sr2.l_dept16) THEN LET sr2.l_dept16 = 'gglq023@0' END IF
           IF cl_null(sr2.l_dept17) THEN LET sr2.l_dept17 = 'gglq023@0' END IF
           IF cl_null(sr2.l_dept18) THEN LET sr2.l_dept18 = 'gglq023@0' END IF
           IF cl_null(sr2.l_dept19) THEN LET sr2.l_dept19 = 'gglq023@0' END IF
           IF cl_null(sr2.l_dept20) THEN LET sr2.l_dept20 = 'gglq023@0' END IF
           IF cl_null(sr2.l_dept21) THEN LET sr2.l_dept21 = 'gglq023@0' END IF
           IF cl_null(sr2.l_dept22) THEN LET sr2.l_dept22 = 'gglq023@0' END IF
           IF cl_null(sr2.l_dept23) THEN LET sr2.l_dept23 = 'gglq023@0' END IF
           IF cl_null(sr2.l_dept24) THEN LET sr2.l_dept24 = 'gglq023@0' END IF
           IF cl_null(sr2.l_dept25) THEN LET sr2.l_dept25 = 'gglq023@0' END IF
           IF cl_null(sr2.l_dept26) THEN LET sr2.l_dept26 = 'gglq023@0' END IF
           IF cl_null(sr2.l_dept27) THEN LET sr2.l_dept27 = 'gglq023@0' END IF
           IF cl_null(sr2.l_dept28) THEN LET sr2.l_dept28 = 'gglq023@0' END IF
           IF cl_null(sr2.l_dept29) THEN LET sr2.l_dept29 = 'gglq023@0' END IF
           IF cl_null(sr2.l_dept30) THEN LET sr2.l_dept30 = 'gglq023@0' END IF
           IF cl_null(sr2.l_dept31) THEN LET sr2.l_dept31 = 'gglq023@0' END IF
           IF cl_null(sr2.l_dept32) THEN LET sr2.l_dept32 = 'gglq023@0' END IF
           IF cl_null(sr2.l_dept33) THEN LET sr2.l_dept33 = 'gglq023@0' END IF
           IF cl_null(sr2.l_dept34) THEN LET sr2.l_dept34 = 'gglq023@0' END IF
           IF cl_null(sr2.l_dept35) THEN LET sr2.l_dept35 = 'gglq023@0' END IF
           IF cl_null(sr2.l_dept36) THEN LET sr2.l_dept36 = 'gglq023@0' END IF
           IF cl_null(sr2.l_dept37) THEN LET sr2.l_dept37 = 'gglq023@0' END IF
           IF cl_null(sr2.l_dept38) THEN LET sr2.l_dept38 = 'gglq023@0' END IF
           IF cl_null(sr2.l_dept39) THEN LET sr2.l_dept39 = 'gglq023@0' END IF
           IF cl_null(sr2.l_dept40) THEN LET sr2.l_dept40 = 'gglq023@0' END IF
           IF cl_null(sr2.l_dept41) THEN LET sr2.l_dept41 = 'gglq023@0' END IF
           IF cl_null(sr2.l_dept42) THEN LET sr2.l_dept42 = 'gglq023@0' END IF
           IF cl_null(sr2.l_dept43) THEN LET sr2.l_dept43 = 'gglq023@0' END IF
           IF cl_null(sr2.l_dept44) THEN LET sr2.l_dept44 = 'gglq023@0' END IF
           IF cl_null(sr2.l_dept45) THEN LET sr2.l_dept45 = 'gglq023@0' END IF
           IF cl_null(sr2.l_dept46) THEN LET sr2.l_dept46 = 'gglq023@0' END IF
           IF cl_null(sr2.l_dept47) THEN LET sr2.l_dept47 = 'gglq023@0' END IF
           IF cl_null(sr2.l_dept48) THEN LET sr2.l_dept48 = 'gglq023@0' END IF
           IF cl_null(sr2.l_dept49) THEN LET sr2.l_dept49 = 'gglq023@0' END IF
           IF cl_null(sr2.l_dept50) THEN LET sr2.l_dept50 = 'gglq023@0' END IF
           IF cl_null(sr2.l_dept51) THEN LET sr2.l_dept51 = 'gglq023@0' END IF
           IF cl_null(sr2.l_dept52) THEN LET sr2.l_dept52 = 'gglq023@0' END IF
           IF cl_null(sr2.l_dept53) THEN LET sr2.l_dept53 = 'gglq023@0' END IF
           IF cl_null(sr2.l_dept54) THEN LET sr2.l_dept54 = 'gglq023@0' END IF
           IF cl_null(sr2.l_dept55) THEN LET sr2.l_dept55 = 'gglq023@0' END IF
           IF cl_null(sr2.l_dept56) THEN LET sr2.l_dept56 = 'gglq023@0' END IF
           IF cl_null(sr2.l_dept57) THEN LET sr2.l_dept57 = 'gglq023@0' END IF
           IF cl_null(sr2.l_dept58) THEN LET sr2.l_dept58 = 'gglq023@0' END IF
           IF cl_null(sr2.l_dept59) THEN LET sr2.l_dept59 = 'gglq023@0' END IF
...
FUNCTION gglq023_cs()
     ...
     LET g_sql = "SELECT UNIQUE * FROM gglq023_tmp2 " 
     PREPARE gglq023_ps FROM g_sql
     DECLARE gglq023_curs SCROLL CURSOR WITH HOLD FOR gglq023_ps

     LET g_sql = "SELECT UNIQUE * FROM gglq023_tmp2 ",
                 "  INTO TEMP x "
     DROP TABLE x
     PREPARE gglq023_ps1 FROM g_sql
     EXECUTE gglq023_ps1

     LET g_sql = "SELECT COUNT(*) FROM x"
     PREPARE gglq023_ps2 FROM g_sql
     DECLARE gglq023_cnt CURSOR FOR gglq023_ps2

     OPEN gglq023_curs
     IF SQLCA.sqlcode THEN
        CALL cl_err('OPEN gglq023_curs',SQLCA.sqlcode,0)
        CALL cl_used(g_prog,g_time,2) RETURNING g_time  #No.FUN-C80020
        EXIT PROGRAM
     ELSE
        OPEN gglq023_cnt
        FETCH gglq023_cnt INTO g_row_count
        DISPLAY g_row_count TO FORMONLY.cnt
     END IF
     CALL gglq023_show()
END FUNCTION

FUNCTION gglq023_show()
...
FUNCTION gglq023_b_fill()
  ...
  DEFINE  l_dbs      LIKE azp_file.azp03
   LET g_sql = "SELECT *",
               " FROM gglq023_tmp2" 
   PREPARE gglq023_pb FROM g_sql
   DECLARE abb_curs  CURSOR FOR gglq023_pb
...
FUNCTION gglq023_table()
     DROP TABLE gglq023_tmp;
     CREATE TEMP TABLE gglq023_tmp(
                    no       LIKE type_file.num5,
     ...
     DROP TABLE gglq023_tmp2;
     CREATE TEMP TABLE gglq023_tmp2(
                     aag01       LIKE maj_file.maj20,
...
FUNCTION q001_process(l_cn)
   ...
   DEFINE l_count              LIKE type_file.num5
    ...
    #----------- sql for sum(asm07-asm08)-----------------------------------
    LET l_sql = "SELECT SUM(asm07-asm08) FROM asm_file,aag_file",
                " WHERE asm00= ? AND asm04 BETWEEN ? AND ? ",
                "   AND asm05 = ? ",
                "   AND asm00 = '",tm.b,"'", 
                "   AND asm06 BETWEEN ? AND ? ",
                "   AND asm20 = ",tm.yy," AND asm21 = ",tm.em,     #No.FUN-C80020
                "   AND asm04 = aag01 AND aag07 IN ('2','3')",
                "   AND asm00 = aag00 ",
                "   AND asm01 ='",g_dept[l_cn].asa01,"' ",
                "   AND asm02 ='",g_dept[l_cn].asb04,"' ",
                "   AND asm03 ='",g_dept[l_cn].asb05,"' "
    ...
    IF STATUS THEN CALL cl_err('sum prepare',STATUS,1) 
       ...
       EXIT PROGRAM 
    END IF
    SELECT asg04 INTO l_asg04 FROM asg_file WHERE asg01 = g_dept[l_cn].asb04
    FOREACH q001_c INTO maj.*
          ...
          IF tm.rtype = '1' THEN
             SELECT COUNT(*) INTO l_count
              ...
              WHERE asj01 = ask01
                ...
                #No.TQC-C90057  --End  
                AND asj08 = '1'       #調整
                AND asj081<>'8'       #No.TQC-C90057
                AND asj00 = tm.b 
                AND asj00 = ask00
                AND asj21 = tm.ver
                AND asjconf = 'Y'     #No.TQC-CC0102
             ...
             ELSE
                #借方金額合計
                SELECT SUM(ask07) INTO l_d_amt_t FROM asj_file,ask_file
                 WHERE asj01=ask01 AND asj03=tm.yy
                   AND asj04 BETWEEN tm.em AND tm.em
                   AND ask03 BETWEEN maj.maj21 AND maj.maj22 AND ask06='1'
                   AND asj05=tm.asa01 #AND asj06=tm.asa02 AND asj07=tm.asa03   #No.TQC-C90057
                   AND asj00=tm.b 
                   AND asj00=ask00
                   AND asj08 = '1'       #調整
                   AND asj081<>'8'       #No.TQC-C90057
                ...
                #貸方金額合計
                SELECT SUM(ask07) INTO l_c_amt_t FROM asj_file,ask_file
                 WHERE asj01=ask01 AND asj03=tm.yy
                   AND asj04 BETWEEN tm.em AND tm.em
          ...
          FOR i = 1 TO 100
             ...
             #將調整或消除D/C、會計師調整D/C分開計算
              IF l_dc_amt_t>0 THEN
                 LET g_tot2_t[i]=g_tot2_t[i]+l_dc_amt_t     #调整D
              ELSE
                 LET g_tot3_t[i]=g_tot3_t[i]+l_dc_amt_t     #调整C
              END IF
              IF l_dc_amt>0 THEN
                 LET g_tot2[i]=g_tot2[i]+l_dc_amt     #消除D
              ELSE
                 LET g_tot3[i]=g_tot3[i]+l_dc_amt     #消除C
              END IF
              IF l_dc_amt1>0 THEN
	  ...
	  IF maj.maj03 = '%' THEN
	     ...
	     SELECT bal1 INTO l_sun FROM gglq023_tmp WHERE no=l_cn
	            AND maj02=l_temp
	     LET l_temp = maj.maj22
	     SELECT bal1 INTO l_mon FROM gglq023_tmp WHERE no=l_cn
	            AND maj02=l_temp
       ...
       END IF
       INSERT INTO gglq023_tmp VALUES
       ...
       IF STATUS OR SQLCA.SQLERRD[3] = 0 THEN
          CALL cl_err3("ins","gglq023_tmp",l_cn,maj.maj02,STATUS,"","ins gglq023_tmp",1) 
          EXIT FOREACH 
       END IF
    END FOREACH
END FUNCTION
