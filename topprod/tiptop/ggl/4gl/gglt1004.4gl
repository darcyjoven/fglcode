...
#
# Pattern name...: gglt1004.4gl
# Descriptions...: 調整作業-其他內部事項調整
...
DEFINE g_argv1  LIKE asj_file.asj00,  #帳套 
       g_argv2  LIKE asj_file.asj01   #单号
MAIN
   ...
   IF g_bgjob='N' OR cl_null(g_bgjob) THEN 
      OPEN WINDOW t0012_w AT p_row,p_col WITH FORM "ggl/42f/gglt1004"
            ATTRIBUTE (STYLE = g_win_style CLIPPED) 
      
      CALL cl_ui_init()
   END IF
   CALL t001('1','V',g_argv1,g_argv2) 

   IF g_bgjob='N' OR cl_null(g_bgjob) THEN
      CLOSE WINDOW t0012_w                 #結束畫面
   END IF
