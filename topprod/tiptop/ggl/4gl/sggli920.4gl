...
#
# PATTERN NAME...: sggli920.4gl   #sagli920.4gl
...
FUNCTION i920(p_gim00)      #FUN-BC0110
      ...
      CASE g_action_choice
         ...
         WHEN "output"
            IF cl_chk_act_auth() THEN
               ...
               LET l_cmd = 'p_query "ggli920" "',g_wc2 CLIPPED,'"'
   ...
   INPUT g_gim04,g_gim05,g_gim06 
      ...
      AFTER FIELD gim06
         IF NOT cl_null(g_gim06) THEN
            SELECT axa01 FROM axa_file WHERE axa01 = g_gim06
   ...
   INPUT l_gim04,l_gim05,l_gim06 WITHOUT DEFAULTS FROM gim04,gim05,gim06
      ...
      AFTER FIELD gim06
         IF NOT cl_null(l_gim06) THEN
            SELECT axa01 FROM axa_file WHERE axa01 = l_gim06
            IF sqlca.sqlcode = 100 THEN
               CALL cl_err('','agl-265',1)
               NEXT FIELD gim06
            END IF
