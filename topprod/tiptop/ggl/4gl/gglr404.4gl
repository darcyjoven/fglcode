...
# Modify.........: NO.MOD-B80025 11/08/02 By Polly 將l_sql、wc 改型態為STRING
...
DEFINE tm  RECORD	       	                 #Print condition RECORD
          #wc       LIKE type_f                  #Where Condiction  #NO.MOD-B80025 mark
           wc       STRING,                      #NO.MOD-B80025 add
...
#              "sign_show.type_file.chr1,sign_str.type_file.chr1000"    #是否顯示簽核資料(Y/N)  #TQC-C10039 #MOD-C20064 Mark TQC-C10039
   ...
   LET l_table = cl_prt_temptable('gglr404',g_sql) CLIPPED                      
...
#No.FUN-7C0066---End
   ...
   IF cl_null(g_bgjob) OR g_bgjob = 'N' THEN 	 #If background job sw is off
      CALL gglr404_tm()	        	         #Input print condition
   ELSE 
      CALL gglr404()			         #Read data and create out-file
   END IF
...
FUNCTION gglr404_tm()
   ...
   END IF
   OPEN WINDOW gglr404_w AT p_row,p_col
        WITH FORM "ggl/42f/gglr404"
      ...
      ELSE
         ...
         LET l_cmd = l_cmd CLIPPED,		 #(at time fglgo xxxx p1 p2 p3)
			 " '",g_bookno CLIPPED,"'",
                         ...
                         " '",g_template CLIPPED,"'",            
                         " '",tm.e CLIPPED,"'" 
         CALL cl_cmdat('gglr404',g_time,l_cmd)	 # Execute cmd at later time
      END IF
      CLOSE WINDOW gglr404_w
      CALL cl_used(g_prog,g_time,2) RETURNING g_time           #FUN-B80096   ADD
      EXIT PROGRAM
...
FUNCTION gglr404()
   DEFINE l_name	LIKE type_file.chr20,	     #External(Disk) file name
         #l_sql         LIKE type_file.chr1000,      #RDSQL STATEMENT   #NO.MOD-B80025 mark
          l_sql         STRING,                      #NO.MOD-B80025 add
...
#     LOCATE l_img_blob IN MEMORY    #TQC-C10039  #MOD-C20064 Mark TQC-C10039
     ...
     SELECT aaf03 INTO g_company FROM aaf_file 
      WHERE aaf01 = g_bookno
        AND aaf02 = g_rlang
     SELECT zz17,zz05 INTO g_len,g_zz05 FROM zz_file WHERE zz01 = 'gglr404'
     #使用預設帳別之幣別
     ...
     END IF    
     PREPARE gglr404_prepare1 FROM l_sql
     IF STATUS THEN
        CALL cl_err('prepare:',STATUS,1)
        CALL cl_used(g_prog,g_time,2) RETURNING g_time           #FUN-B80096   ADD
        EXIT PROGRAM
     END IF
     DECLARE gglr404_curs1 CURSOR FOR gglr404_prepare1
#No.FUN-7C0066---Begin
#     CALL cl_outnam('gglr404') RETURNING l_name
...
#     LET g_pageno = 0
#     START REPORT gglr404_rep TO l_name
#     CALL cl_prt_pos_len()
#No.FUN-7C0066---End
     FOREACH gglr404_curs1 INTO sr.*
       ...
       ELSE 
          ...
          END IF
       END IF
       CALL r404_get_level(sr.aba01,sr.abb02,sr.aag01,sr.aag02,sr.aag13)  #FUN-6C0012 
...
#       OUTPUT TO REPORT gglr404_rep(sr.*)
#No.FUN-7C0066---End
     END FOREACH
#No.FUN-7C0066---Begin
#     FINISH REPORT gglr404_rep
      IF g_zz05 = 'Y' THEN                                                      
         CALL cl_wcchp(tm.wc,'aba01,aba02,aba06,abauser')                         
              RETURNING tm.wc                                                   
      END IF                                                                    
      LET g_str=tm.wc ,";",tm.a,";",g_company,";",
                      g_azi02,";",g_azi04,";",g_azi05
...
#      LET g_cr_apr_key_f = "aba01"             #報表主鍵欄位名稱  #TQC-C10039  #MOD-C20064 Mark TQC-C10039
      CALL cl_prt_cs3('gglr404','gglr404',l_sql,g_str)
#     CALL cl_prt(l_name,g_prtway,g_copies,g_len)
#     CALL cl_used(g_prog,g_time,2) RETURNING g_time 
#No.FUN-7C0066---End
END FUNCTION
 
FUNCTION r404_get_level(p_aba01,p_abb02,p_aag01,p_aag02,p_aag13)  #FUN-6C0012
