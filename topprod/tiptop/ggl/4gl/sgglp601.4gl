...
# Modify.........: No.FUN-B60144 11/07/01 By lixiang copy from gglp601,移除asg01,asg06
...
DEFINE tm      RECORD
              ...
              # asg01  LIKE asg_file.asg01,   #公司編號   #FUN-780068 add   #No.FUN-B60144
                asg05  LIKE asg_file.asg05    #帳別       #FUN-780068 add  
              # asg06  LIKE asg_file.asg06    #幣別       #FUN-780068 add   #No.FUN-B60144
               END RECORD,
...
FUNCTION gglp601(p_argv1)                            #No.FUN-B60144
...
#No.FUN-B60144--end
  ...
  #LET tm.asg01    = ARG_VAL(3)                   #公司編號   #FUN-780068 add   #No.FUN-B60144
   LET tm.asg05    = ARG_VAL(4)                   #帳別       #FUN-780068 add
  #LET tm.asg06    = ARG_VAL(5)                   #幣別       #FUN-780068 add   #No.FUN-B60144
...
FUNCTION gglp601_tm(p_row,p_col)
   ...
   OPEN WINDOW gglp601_w AT p_row,p_col WITH FORM "ggl/42f/gglp601" 
   ...
   WHILE TRUE 
      ...
      # FROM aaa04,aaa05,asg01,asg05,asg06,g_bgjob                                    #FUN-780068 add asg01,asg05,asg06
       ...
       INPUT tm.aaa04,tm.aaa05,tm.asg05,g_bgjob WITHOUT DEFAULTS    #No.FUN-B60144
          FROM aaa04,aaa05,asg05,g_bgjob                            #No.FUN-B60144
      ...
      #No.FUN-B60144--add--
         AFTER FIELD asg05
            IF NOT cl_null(tm.asg05) THEN
               SELECT COUNT(*) INTO l_cnt FROM aaa_file WHERE aaa01=tm.asg05
               IF l_cnt=0 THEN
                  CALL cl_err('',100,0)
                  LET tm.asg05=NULL      
                  NEXT FIELD asg05
      ...
      IF g_bgjob = 'Y' THEN
         ...
         ELSE
            LET lc_cmd = lc_cmd CLIPPED,
                         ...
                         " '",tm.aaa04 CLIPPED,"'",
                         " '",tm.aaa05 CLIPPED,"'",
                     #   " '",tm.asg01 CLIPPED,"'",   #FUN-780068 add            #No.FUN-B60144--mark
                         " '",tm.asg05 CLIPPED,"'",   #FUN-780068 add
                     #   " '",tm.asg06 CLIPPED,"'",   #FUN-780068 add            #No.FUN-B60144--mark
                         " '",g_bgjob CLIPPED,"'"
...
DEFINE l_ats01 LIKE ats_file.ats01,   #分類代碼   #FUN-780068 add
       ...
       l_atr16 LIKE atr_file.atr16,   #合併否    #No.FUN-B60144
       l_atn01 LIKE atn_file.atn01,              #No.FUN-B60144
       l_atn02 LIKE atn_file.atn02               #No.FUN-B60144  
...
#No.FUN-B60144--end--
   ...
   #  AND atq14 = tm.asg01   #公司編號                 #No.FUN-B60144--mark
      AND atq15 = tm.asg05   #帳別 
   #  AND atq16 = tm.asg06   #幣別                 #No.FUN-B60144--mark
  ...
  #str FUN-780068 mod
   ...
   DECLARE atq_cs1 CURSOR FOR 
      ...
      #  AND atq14 = tm.asg01   #公司編號    #No.FUN-B60144
         AND atq15 = tm.asg05   #帳別
      #  AND atq16 = tm.asg06   #幣別        #No.FUN-B60144
       ORDER BY atq17           #分類
   ...
   FOREACH atq_cs1 INTO l_atq_o.*
      ...
      IF SQLCA.sqlcode THEN
       # LET g_showmsg=l_yy,"/",l_mm,"/",tm.asg01,"/",tm.asg05,"/",tm.asg06    #No.FUN-B60144
         LET g_showmsg=l_yy,"/",l_mm,"/",tm.asg05 
       # CALL s_errmsg('atq01,atq02,atq14,atq15,atq16',g_showmsg,'(atq_cs1#1:foreach)',SQLCA.sqlcode,1) #No.FUN-B60144
         CALL s_errmsg('atq01,atq02,atq15',g_showmsg,'(atq_cs1#1:foreach)',SQLCA.sqlcode,1) #No.FUN-B60144 
    ...
    # LET l_atq_n.atq14 = tm.asg01       #公司編號    #FUN-780068 add  #No.FUN-B60144
      LET l_atq_n.atq15 = tm.asg05       #帳別        #FUN-780068 add
    # LET l_atq_n.atq16 = tm.asg06       #幣別        #FUN-780068 add  #No.FUN-B60144
      LET l_atq_n.atq17 = l_atq_o.atq17  #分類代碼    #FUN-780068 add
      LET l_atq_n.atq18 = l_atq_o.atq18  #餘額        #FUN-780068 add
      LET l_atq_n.atq19 = l_atq_o.atq19               #No.FUN-B60144
   ...
   #   # AND atr11 = tm.asg01       #公司編號    #No.FUN-B60144
   #     AND atr12 = tm.asg05       #帳別
   #   # AND atr13 = tm.asg06       #幣別        #No.FUN-B60144
   #     AND atr14 = l_atq_n.atq17  #分類代碼
   #     AND atr16 = l_atr16                     #No.FUN-B60144
   #   GROUP BY ats01
    ...
    #No.FUN-B60144--add
      SELECT SUM(atr04) INTO l_atr04
       ...
       WHERE ats01 = atr14
         ...
         AND atr02 = l_mm
         AND atr12 = tm.asg05
         AND atr14 = l_atq_n.atq17
         AND atr15 = l_atq_n.atq19
         AND atr16 = l_atr16
       GROUP BY ats01
      IF cl_null(l_atr04) THEN LET l_atr04 = 0 END IF
      ...
      IF cl_null(l_atq_n.atq14) THEN
         LET l_atq_n.atq14 = ' '
      END IF
      IF cl_null(l_atq_n.atq16) THEN
         LET l_atq_n.atq16 = ' '
      END IF
      IF cl_null(l_atq_n.atq19) THEN
         LET l_atq_n.atq19 = ' '
      END IF

      LET l_atq_n.atq20 = l_atr16
    #No.FUN-B60144--end 
      ...
      IF STATUS THEN
         UPDATE atq_file SET atq18 = l_atq_n.atq18,
                      ...
                      #  AND atq14 = l_atq_n.atq14   #公司編號    #No.FUN-B60144
                         AND atq15 = l_atq_n.atq15   #帳別  
                      #  AND atq16 = l_atq_n.atq16   #幣別        #No.FUN-B60144
                         AND atq17 = l_atq_n.atq17   #分類代碼
                         AND atq20 = l_atr16                      #No.FUN-B60144 
       ...
       WHERE ats01 = atr14
         ...
         AND (atr14 NOT IN (SELECT atq17 FROM atq_file
                            WHERE atq01 = l_yy
                              ...
                              AND atq15 = tm.asg05
                              AND atq20 = l_atr16)
           OR atr15 NOT IN (SELECT atq19 FROM atq_file
                            WHERE atq01 = l_yy
                              AND atq02 = l_mm
                              AND atq15 = tm.asg05
                              AND atq20 = l_atr16))
       GROUP BY ats01,atr15

   FOREACH atr_cs1 INTO l_ats01,l_atn01,l_atr04
 #No.FUN-B60144--end
      #NO.FUN-710023--BEGIN                                                           
      IF g_success='N' THEN                                                    
         LET g_totsuccess='N'                                                   
      ...
      IF SQLCA.sqlcode THEN
       # LET g_showmsg=tm.aaa04,"/",tm.aaa05,"/",tm.asg01,"/",tm.asg05,"/",tm.asg06      #No.FUN-B60144
       # CALL s_errmsg('atr01,atr02,atr11,atr12,atr13',g_showmsg,'(atr_cs1#1:foreach)',SQLCA.sqlcode,1)   #No.FUN-B60144
         LET g_showmsg=tm.aaa04,"/",tm.aaa05,"/",tm.asg05    #No.FUN-B60144
         CALL s_errmsg('atr01,atr02,atr12',g_showmsg,'(atr_cs1#1:foreach)',SQLCA.sqlcode,1)   #No.FUN-B60144 
         LET g_success='N' RETURN                             
      END IF
    ...
    # LET l_atq_n.atq16 = tm.asg06       #幣別        #FUN-780068 add   #No.FUN-B60144
      ...
      LET l_atq_n.atq19 = l_atn01                     #No.FUN-B60144 
      LET l_atq_n.atquser = g_user
      LET l_atq_n.atqgrup = g_grup
      LET l_atq_n.atqdate = g_today
      LET l_atq_n.atqlegal = g_legal     #FUN-980003 add
