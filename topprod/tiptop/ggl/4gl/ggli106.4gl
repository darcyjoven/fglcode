...
MAIN
    ...
    OPEN WINDOW i106_w WITH FORM "ggl/42f/ggli106"
      ...
      CASE g_action_choice
         ...
         WHEN "output"
            IF cl_chk_act_auth() THEN
               ...
               LET l_cmd = 'p_query "ggli106" "',g_wc2 CLIPPED,'"'
        ...
        IF g_rec_b>=l_ac THEN
           ...
           ELSE
              ...
              IF sqlca.sqlcode THEN
                  ...
                  LET l_lock_sw = "y"
              END IF
              SELECT asg02 INTO g_aal[l_ac].asg02 FROM asg_file WHERE asg01 = g_aal[l_ac].aal01
           END IF
...
FUNCTION i106_chk()
   ...
   SELECT asg02,asg08 INTO g_aal[l_ac].asg02,g_aal[l_ac].aal03
     FROM asg_file
    WHERE asg01 = g_aal[l_ac].aal01
...
FUNCTION i106_b_fill(p_wc2)
   ...
   FOREACH aal_curs INTO g_aal[g_cnt].*   #單身 array 填充
      IF STATUS THEN
         ...
         EXIT FOREACH
      END IF
      SELECT asg02 INTO g_aal[g_cnt].asg02 FROM asg_file
       WHERE asg01 = g_aal[g_cnt].aal01
      LET g_cnt = g_cnt + 1
...
FUNCTION i106_v()
   OPEN WINDOW i106_1_w WITH FORM "ggl/42f/ggli106_1"
        ATTRIBUTE (STYLE = g_win_style CLIPPED)

      CALL cl_ui_locale("ggli106_1")
...
FUNCTION i106_v1()
   ...
   CONSTRUCT BY NAME g_wc2 ON asg01
