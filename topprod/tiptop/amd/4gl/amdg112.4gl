...
#                                                  2.l_yy變數放大為chr4
# Modify.........: No:FUN-B40097 11/06/20 By chenying 憑證類報表轉GR 
# Modify.........: No.FUN-B40097 11/08/18 By chenying 程式規範修改
# Modify.........: No:TQC-B90211 11/10/21 By Smapmin 人事table drop
# Modify.........: No:MOD-BC0008 11/12/21 By chenying GRW套表更新處理
# Modify.........: No:CHI-C30041 12/04/23 By Lori 申報部門增加開窗功能
...
###GENGRE###START
TYPE sr1_t RECORD
    ama021 LIKE type_file.chr1,
    ama022 LIKE type_file.chr1,
    ama023 LIKE type_file.chr1,
    ama024 LIKE type_file.chr1,
    ama025 LIKE type_file.chr1,
    ama026 LIKE type_file.chr1,
    ama027 LIKE type_file.chr1,
    ama028 LIKE type_file.chr1,
    ama07 LIKE ama_file.ama07,
    ama031 LIKE type_file.chr1,
    ama032 LIKE type_file.chr1,
    ama033 LIKE type_file.chr1,
    ama034 LIKE type_file.chr1,
    ama035 LIKE type_file.chr1,
    ama036 LIKE type_file.chr1,
    ama037 LIKE type_file.chr1,
    ama038 LIKE type_file.chr1,
    ama039 LIKE type_file.chr1,
    t1a LIKE type_file.chr1,
    t2a LIKE type_file.chr1,
    t3a LIKE type_file.chr8,
    t4a LIKE type_file.chr4,
    t5a LIKE type_file.chr2,
    t6a LIKE amd_file.amd17,
    t7a LIKE amd_file.amd06,
    t8a LIKE amd_file.amd04,
    t11a LIKE type_file.chr1,
    t12a LIKE type_file.chr1,
    t13a LIKE type_file.chr8,
    t14a LIKE type_file.chr4,
    t15a LIKE type_file.chr2,
    t16a LIKE amd_file.amd17,
    t17a LIKE amd_file.amd06,
    t18a LIKE amd_file.amd04,
    t1b LIKE type_file.chr1,
    t2b LIKE type_file.chr1,
    t3b LIKE type_file.chr8,
    t4b LIKE type_file.chr4,
    t5b LIKE type_file.chr2,
    t6b LIKE amd_file.amd17,
    t7b LIKE amd_file.amd06,
    t8b LIKE amd_file.amd04,
    t11b LIKE type_file.chr1,
    t12b LIKE type_file.chr1,
    t13b LIKE type_file.chr8,
    t14b LIKE type_file.chr4,
    t15b LIKE type_file.chr2,
    t16b LIKE amd_file.amd17,
    t17b LIKE amd_file.amd06,
    t18b LIKE amd_file.amd04,
    t1c LIKE type_file.chr1,
    t2c LIKE type_file.chr1,
    t3c LIKE type_file.chr8,
    t4c LIKE type_file.chr4,
    t5c LIKE type_file.chr2,
    t6c LIKE amd_file.amd17,
    t7c LIKE amd_file.amd06,
    t8c LIKE amd_file.amd04,
    t11c LIKE type_file.chr1,
    t12c LIKE type_file.chr1,
    t13c LIKE type_file.chr8,
    t14c LIKE type_file.chr4,
    t15c LIKE type_file.chr2,
    t16c LIKE amd_file.amd17,
    t17c LIKE amd_file.amd06,
    t18c LIKE amd_file.amd04,
    t1d LIKE type_file.chr1,
    t2d LIKE type_file.chr1,
    t3d LIKE type_file.chr8,
    t4d LIKE type_file.chr4,
    t5d LIKE type_file.chr2,
    t6d LIKE amd_file.amd17,
    t7d LIKE amd_file.amd06,
    t8d LIKE amd_file.amd04,
    t11d LIKE type_file.chr1,
    t12d LIKE type_file.chr1,
    t13d LIKE type_file.chr8,
    t14d LIKE type_file.chr4,
    t15d LIKE type_file.chr2,
    t16d LIKE amd_file.amd17,
    t17d LIKE amd_file.amd06,
    t18d LIKE amd_file.amd04,
    t1e LIKE type_file.chr1,
    t2e LIKE type_file.chr1,
    t3e LIKE type_file.chr8,
    t4e LIKE type_file.chr4,
    t5e LIKE type_file.chr2,
    t6e LIKE amd_file.amd17,
    t7e LIKE amd_file.amd06,
    t8e LIKE amd_file.amd04,
    t11e LIKE type_file.chr1,
    t12e LIKE type_file.chr1,
    t13e LIKE type_file.chr8,
    t14e LIKE type_file.chr4,
    t15e LIKE type_file.chr2,
    t16e LIKE amd_file.amd17,
    t17e LIKE amd_file.amd06,
    t18e LIKE amd_file.amd04,
    t1f LIKE type_file.chr1,
    t2f LIKE type_file.chr1,
    t3f LIKE type_file.chr8,
    t4f LIKE type_file.chr4,
    t5f LIKE type_file.chr2,
    t6f LIKE amd_file.amd17,
    t7f LIKE amd_file.amd06,
    t8f LIKE amd_file.amd04,
    t11f LIKE type_file.chr1,
    t12f LIKE type_file.chr1,
    t13f LIKE type_file.chr8,
    t14f LIKE type_file.chr4,
    t15f LIKE type_file.chr2,
    t16f LIKE amd_file.amd17,
    t17f LIKE amd_file.amd06,
    t18f LIKE amd_file.amd04,
    t1g LIKE type_file.chr1,
    t2g LIKE type_file.chr1,
    t3g LIKE type_file.chr8,
    t4g LIKE type_file.chr4,
    t5g LIKE type_file.chr2,
    t6g LIKE amd_file.amd17,
    t7g LIKE amd_file.amd06,
    t8g LIKE amd_file.amd04,
    t11g LIKE type_file.chr1,
    t12g LIKE type_file.chr1,
    t13g LIKE type_file.chr8,
    t14g LIKE type_file.chr4,
    t15g LIKE type_file.chr2,
    t16g LIKE amd_file.amd17,
    t17g LIKE amd_file.amd06,
    t18g LIKE amd_file.amd04,
    t1h LIKE type_file.chr1,
    t2h LIKE type_file.chr1,
    t3h LIKE type_file.chr8,
    t4h LIKE type_file.chr4,
    t5h LIKE type_file.chr2,
    t6h LIKE amd_file.amd17,
    t7h LIKE amd_file.amd06,
    t8h LIKE amd_file.amd04,
    t11h LIKE type_file.chr1,
    t12h LIKE type_file.chr1,
    t13h LIKE type_file.chr8,
    t14h LIKE type_file.chr4,
    t15h LIKE type_file.chr2,
    t16h LIKE amd_file.amd17,
    t17h LIKE amd_file.amd06,
    t18h LIKE amd_file.amd04,
    t1i LIKE type_file.chr1,
    t2i LIKE type_file.chr1,
    t3i LIKE type_file.chr8,
    t4i LIKE type_file.chr4,
    t5i LIKE type_file.chr2,
    t6i LIKE amd_file.amd17,
    t7i LIKE amd_file.amd06,
    t8i LIKE amd_file.amd04,
    t11i LIKE type_file.chr1,
    t12i LIKE type_file.chr1,
    t13i LIKE type_file.chr8,
    t14i LIKE type_file.chr4,
    t15i LIKE type_file.chr2,
    t16i LIKE amd_file.amd17,
    t17i LIKE amd_file.amd06,
    t18i LIKE amd_file.amd04,
    t1j LIKE type_file.chr1,
    t2j LIKE type_file.chr1,
    t3j LIKE type_file.chr8,
    t4j LIKE type_file.chr4,
    t5j LIKE type_file.chr2,
    t6j LIKE amd_file.amd17,
    t7j LIKE amd_file.amd06,
    t8j LIKE amd_file.amd04,
    t11j LIKE type_file.chr1,
    t12j LIKE type_file.chr1,
    t13j LIKE type_file.chr8,
    t14j LIKE type_file.chr4,
    t15j LIKE type_file.chr2,
    t16j LIKE amd_file.amd17,
    t17j LIKE amd_file.amd06,
    t18j LIKE amd_file.amd04,
    amd17_11 LIKE type_file.num10,
    amd17_1 LIKE type_file.num10,
    amd17_21 LIKE type_file.num10,
    amd17_2 LIKE type_file.num10,
    l_l LIKE type_file.num10,
    amd06 LIKE type_file.num10,
    l_i LIKE type_file.num10,
    amd06_2 LIKE amd_file.amd06,
    azi04 LIKE azi_file.azi04,
    l_p LIKE type_file.num10
END RECORD
###GENGRE###END
...
MAIN
   ...
   LET g_sql =   "ama021.type_file.chr1,ama022.type_file.chr1,",
                 ...
                 "azi04.azi_file.azi04,l_p.type_file.num10" 
                 
    LET l_table = cl_prt_temptable('amdg112',g_sql) CLIPPED   # 產生Temp Table
    IF l_table = -1 THEN 
...
FUNCTION g112_tm(p_row,p_col)
   ...
   OPEN WINDOW g112_w AT p_row,p_col
     WITH FORM "amd/42f/amdg112"  ATTRIBUTE (STYLE = g_win_style CLIPPED) #No.FUN-580092 HCN
   ...
   WHILE TRUE
      ...
      IF g_bgjob = 'Y' THEN
         ...
         ELSE
            ...
            CALL cl_cmdat('amdg112',g_time,l_cmd)
         END IF
...
#FUN-590323 End
   ...
   SELECT zz17,zz05 INTO g_len,g_zz05 FROM zz_file WHERE zz01 = 'amdg112'
 # IF g_len = 0 OR g_len IS NULL THEN LET g_len = 160 END IF #FUN-710084
   LET g_new = 'Y'   #FUN-5C0026
 
#  CALL cl_outnam('amdg112') RETURNING l_name #FUN-710084
#  START REPORT g112_rep TO l_name #FUN-710084
   ...
   IF l_cnt > 0 THEN
   #FUN-710084  --begin
   #  OUTPUT TO REPORT g112_rep() #FUN-710084
      CALL l_amd.clear() 
         ...
         PREPARE g112_prepare1 FROM l_sql
         IF SQLCA.sqlcode THEN
            CALL cl_err('prepare:',SQLCA.sqlcode,1)
         END IF
         DECLARE g112_curs1 CURSOR FOR g112_prepare1
         LET l_amd06_2 = 0
         FOREACH g112_curs1 INTO l_amd[l_i].*
...
###GENGRE###     LET l_sql = "SELECT * FROM ",g_cr_db_str CLIPPED,l_table CLIPPED
   ...
   # END IF
     LET l_yy = tm.yy-1911
     LET l_mm = tm.mm
###GENGRE###     LET g_str = l_yy,";",l_mm,";",YEAR(tm.date),";",MONTH(tm.date),";",DAY(tm.date)
   # CALL cl_prt_cs3('amdg112',l_sql,g_str)    #TQC-730113
###GENGRE###     CALL cl_prt_cs3('amdg112','amdg112',l_sql,g_str) 
    CALL amdg112_grdata()    ###GENGRE###
   ELSE
...
FUNCTION amdg112_grdata()
    ...
    WHILE TRUE
        ...
        LET handler = cl_gre_outnam("amdg112")
        IF handler IS NOT NULL THEN
            START REPORT amdg112_rep TO XML HANDLER handler
            LET l_sql = "SELECT * FROM ",g_cr_db_str CLIPPED,l_table CLIPPED
          
            DECLARE amdg112_datacur1 CURSOR FROM l_sql
            FOREACH amdg112_datacur1 INTO sr1.*
                OUTPUT TO REPORT amdg112_rep(sr1.*)
            END FOREACH
            FINISH REPORT amdg112_rep
        END IF
...
REPORT amdg112_rep(sr1)
    ...
    FORMAT
        FIRST PAGE HEADER
            ...
            PRINTX tm.*
            LET l_cnt = cl_gre_rowcnt(l_table)    #MOD-BC0008
            PRINTX l_cnt                          #MOD-BC0008
