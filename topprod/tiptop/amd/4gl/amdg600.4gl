# Prog. Version..: '5.30.06-13.04.17(00003)'     #
# Pattern name...: amdg600.4gl
...
# Modify.........: No.FUN-B40092 11/06/23 By xujing 憑證報表轉GRW 
# Modify.........: No.FUN-B40092 11/08/17 By xujing 程式規範修改
# Modify.........: No.MOD-BC0008 11/12/09 By yangtt GRW套表更新處理
...
TYPE sr1_t RECORD
    ...
    amd173_b LIKE amd_file.amd173,
    amd174_b LIKE amd_file.amd174,
    amd174_e LIKE amd_file.amd174,
    sum1_1 LIKE amd_file.amd08,
    tot23_1 LIKE type_file.num20_6,
    tot24_1 LIKE type_file.num20_6,
    tot26_1 LIKE type_file.num10,
    tot5_1 LIKE type_file.num20_6,
    ab_1 LIKE amd_file.amd08,
    bb_1 LIKE amd_file.amd08,
    tot12_1 LIKE type_file.num20_6,
    l75_1 LIKE amd_file.amd08,
    tot18_1 LIKE type_file.num20_6,
    sum1_2 LIKE amd_file.amd08,
    tot23_2 LIKE type_file.num20_6,
    tot24_2 LIKE type_file.num20_6,
    tot26_2 LIKE type_file.num10,
    tot5_2 LIKE type_file.num20_6,
    ab_2 LIKE amd_file.amd08,
    bb_2 LIKE amd_file.amd08,
    tot12_2 LIKE type_file.num20_6,
    l75_2 LIKE amd_file.amd08,
    tot18_2 LIKE type_file.num20_6,
    sum1_3 LIKE amd_file.amd08,
    tot23_3 LIKE type_file.num20_6,
    tot24_3 LIKE type_file.num20_6,
    tot26_3 LIKE type_file.num10,
    tot5_3 LIKE type_file.num20_6,
    ab_3 LIKE amd_file.amd08,
    bb_3 LIKE amd_file.amd08,
    tot12_3 LIKE type_file.num20_6,
    l75_3 LIKE amd_file.amd08,
    tot18_3 LIKE type_file.num20_6,
    sum1_4 LIKE amd_file.amd08,
    tot23_4 LIKE type_file.num20_6,
    tot24_4 LIKE type_file.num20_6,
    tot26_4 LIKE type_file.num10,
    tot5_4 LIKE type_file.num20_6,
    ab_4 LIKE amd_file.amd08,
    bb_4 LIKE amd_file.amd08,
    tot12_4 LIKE type_file.num20_6,
    l75_4 LIKE amd_file.amd08,
    tot18_4 LIKE type_file.num20_6,
    sum1_5 LIKE amd_file.amd08,
    tot23_5 LIKE type_file.num20_6,
    tot24_5 LIKE type_file.num20_6,
    tot26_5 LIKE type_file.num10,
    tot5_5 LIKE type_file.num20_6,
    ab_5 LIKE amd_file.amd08,
    bb_5 LIKE amd_file.amd08,
    tot12_5 LIKE type_file.num20_6,
    l75_5 LIKE amd_file.amd08,
    tot18_5 LIKE type_file.num20_6,
    sum1_6 LIKE amd_file.amd08,
    tot23_6 LIKE type_file.num20_6,
    tot24_6 LIKE type_file.num20_6,
    tot26_6 LIKE type_file.num10,
    tot5_6 LIKE type_file.num20_6,
    ab_6 LIKE amd_file.amd08,
    bb_6 LIKE amd_file.amd08,
    tot12_6 LIKE type_file.num20_6,
    l75_6 LIKE amd_file.amd08,
    tot18_6 LIKE type_file.num20_6,
    sum1_7 LIKE amd_file.amd08,
    tot23_7 LIKE type_file.num20_6,
    tot24_7 LIKE type_file.num20_6,
    tot26_7 LIKE type_file.num10,
    tot5_7 LIKE type_file.num20_6,
    ab_7 LIKE amd_file.amd08,
    bb_7 LIKE amd_file.amd08,
    tot12_7 LIKE type_file.num20_6,
    l75_7 LIKE amd_file.amd08,
    tot18_7 LIKE type_file.num20_6,
    sum1_8 LIKE amd_file.amd08,
    tot23_8 LIKE type_file.num20_6,
    tot24_8 LIKE type_file.num20_6,
    tot26_8 LIKE type_file.num10,
    tot5_8 LIKE type_file.num20_6,
    ab_8 LIKE amd_file.amd08,
    bb_8 LIKE amd_file.amd08,
    tot12_8 LIKE type_file.num20_6,
    l75_8 LIKE amd_file.amd08,
    tot18_8 LIKE type_file.num20_6,
    sum1_9 LIKE amd_file.amd08,
    tot23_9 LIKE type_file.num20_6,
    tot24_9 LIKE type_file.num20_6,
    tot26_9 LIKE type_file.num10,
    tot5_9 LIKE type_file.num20_6,
    ab_9 LIKE amd_file.amd08,
    bb_9 LIKE amd_file.amd08,
    tot12_9 LIKE type_file.num20_6,
    l75_9 LIKE amd_file.amd08,
    tot18_9 LIKE type_file.num20_6,
    sum1_10 LIKE amd_file.amd08,
    tot23_10 LIKE type_file.num20_6,
    tot24_10 LIKE type_file.num20_6,
    tot26_10 LIKE type_file.num10,
    tot5_10 LIKE type_file.num20_6,
    ab_10 LIKE amd_file.amd08,
    bb_10 LIKE amd_file.amd08,
    tot12_10 LIKE type_file.num20_6,
    l75_10 LIKE amd_file.amd08,
    tot18_10 LIKE type_file.num20_6,
    sum1_11 LIKE amd_file.amd08,
    tot23_11 LIKE type_file.num20_6,
    tot24_11 LIKE type_file.num20_6,
    tot26_11 LIKE type_file.num10,
    tot5_11 LIKE type_file.num20_6,
    ab_11 LIKE amd_file.amd08,
    bb_11 LIKE amd_file.amd08,
    tot12_11 LIKE type_file.num20_6,
    l75_11 LIKE amd_file.amd08,
    tot18_11 LIKE type_file.num20_6,
    sum1_12 LIKE amd_file.amd08,
    tot23_12 LIKE type_file.num20_6,
    tot24_12 LIKE type_file.num20_6,
    tot26_12 LIKE type_file.num10,
    tot5_12 LIKE type_file.num20_6,
    ab_12 LIKE amd_file.amd08,
    bb_12 LIKE amd_file.amd08,
    tot12_12 LIKE type_file.num20_6,
    l75_12 LIKE amd_file.amd08,
    tot18_12 LIKE type_file.num20_6,
...
MAIN
   ...
   LET g_sql = "ama02.ama_file.ama02,",
               ...
               "l75.amd_file.amd08,",
               "tot18.type_file.num20_6"

   LET l_table = cl_prt_temptable('amdg600',g_sql) CLIPPED
   IF l_table = -1 THEN
...
FUNCTION g600_tm(p_row,p_col)
   ...
   END IF
   OPEN WINDOW g600_w AT p_row,p_col
        WITH FORM "amd/42f/amdg600"
   ...
   WHILE TRUE
      ...
      IF INT_FLAG THEN
         LET INT_FLAG = 0 CLOSE WINDOW g600_w
         CALL cl_used(g_prog,g_time,2) RETURNING g_time
         CALL cl_gre_drop_temptable(l_table)
         EXIT PROGRAM
      END IF
      IF g_bgjob = 'Y' THEN
         ...
         ELSE
            LET l_cmd = l_cmd CLIPPED,
                            ...
                            " '",g_template CLIPPED,"'",
                            " '",g_rpt_name CLIPPED,"'"
            CALL cl_cmdat('amdg600',g_time,l_cmd)
         END IF
         CLOSE WINDOW g600_w
         CALL cl_used(g_prog,g_time,2) RETURNING g_time
         CALL cl_gre_drop_temptable(l_table)
...
DEFINE l_amd173_b                             LIKE amd_file.amd173
     ...
     FOR l_b = tm.amd174_b TO tm.amd174_e
        IF tm.t = '2' THEN
           IF l_b MOD 2 = 0 THEN
              DELETE FROM x
              CALL g600_data(l_b-1,l_b) RETURNING l_data[l_b].*
        ...
        ELSE
           DELETE FROM x
           CALL g600_data(l_b,l_b) RETURNING l_data[l_b].*
           LET l_tot.sum1 = l_tot.sum1 + l_data[l_b].sum1
           LET l_tot.tot23 = l_tot.tot23 + l_data[l_b].tot23
           LET l_tot.tot24 = l_tot.tot24 + l_data[l_b].tot24
           LET l_tot.tot26 = l_tot.tot26 + l_data[l_b].tot26
...
#    IF tm.t = "1" THEN 
        LET l_name = "amdg600"     #無格     
#    ELSE  
#       LET l_name = "amdg600_2"   #有格  
#    END IF

    #CALL cl_prt_cs1('amdg600',l_name,l_sql,g_str)       #TQC-AA0123 mark
###GENGRE###     CALL cl_prt_cs3('amdg600','amdg600',l_sql,g_str)    #TQC-AA0123
    CALL amdg600_grdata()    ###GENGRE###

END FUNCTION

FUNCTION g600_sum1()  # 計算發票數
...
FUNCTION g600_data(p_amd174_b,p_amd174_e)
...
DEFINE l_ame           RECORD  LIKE ame_file.*
   ...
   DECLARE g600_curs CURSOR FOR g600_prepare
  ...
  #媒體申報其他資料
   ...
   LET g_tot19 = 0
   LET g_abx =0   #保稅
   CALL g600_sum1()  #計算發票數
   FOREACH g600_curs INTO sr.*,l_amd25,l_amd35,l_amd36,l_amd37,
                          l_amd38,l_amd39
...
#  END IF
   ...
   PREPARE g600_pre_26  FROM l_sql26
   IF SQLCA.SQLCODE THEN CALL cl_err('prepare',STATUS,0) END IF
   DECLARE g600_curs_26 CURSOR FOR g600_pre_26

   LET g_tot7_26 = 0
   LET g_tot15_26  = 0
   LET g_tot19_26  = 0

   FOREACH g600_curs_26 INTO sr26.*,l_amd25_26,l_amd35_26,l_amd36_26,
...
FUNCTION amdg600_grdata()
    ...
    WHILE TRUE
        ...
        LET handler = cl_gre_outnam("amdg600")
        IF handler IS NOT NULL THEN
            START REPORT amdg600_rep TO XML HANDLER handler
            LET l_sql = "SELECT * FROM ",g_cr_db_str CLIPPED,l_table CLIPPED
          
            DECLARE amdg600_datacur1 CURSOR FROM l_sql
            FOREACH amdg600_datacur1 INTO sr1.*
                OUTPUT TO REPORT amdg600_rep(sr1.*)
            END FOREACH
            FINISH REPORT amdg600_rep
        END IF
...
REPORT amdg600_rep(sr1)
    DEFINE sr1 sr1_t
    DEFINE l_lineno LIKE type_file.num5
    #FUN-B40092------add------str
    DEFINE l_3       LIKE type_file.num20_6
    DEFINE l_3_1     LIKE type_file.num20_6
    DEFINE l_3_10    LIKE type_file.num20_6 
    DEFINE l_3_11    LIKE type_file.num20_6
    DEFINE l_3_12    LIKE type_file.num20_6
    DEFINE l_3_2     LIKE type_file.num20_6
    DEFINE l_3_3     LIKE type_file.num20_6
    DEFINE l_3_4     LIKE type_file.num20_6
    DEFINE l_3_5     LIKE type_file.num20_6
    DEFINE l_3_6     LIKE type_file.num20_6
    DEFINE l_3_7     LIKE type_file.num20_6
    DEFINE l_3_8     LIKE type_file.num20_6
    DEFINE l_3_9     LIKE type_file.num20_6
    DEFINE l_9          LIKE amd_file.amd08
    DEFINE l_9_1        LIKE amd_file.amd08
    DEFINE l_9_2        LIKE amd_file.amd08
    DEFINE l_9_3        LIKE amd_file.amd08
    DEFINE l_9_4        LIKE amd_file.amd08
    DEFINE l_9_5        LIKE amd_file.amd08
    DEFINE l_9_6        LIKE amd_file.amd08
    DEFINE l_9_7        LIKE amd_file.amd08
    DEFINE l_9_8        LIKE amd_file.amd08
    DEFINE l_9_9        LIKE amd_file.amd08
    DEFINE l_9_10       LIKE amd_file.amd08
    DEFINE l_9_11       LIKE amd_file.amd08
    DEFINE l_9_12       LIKE amd_file.amd08    
    DEFINE l_percent    LIKE type_file.num20_6
    DEFINE l_option     LIKE type_file.num20_6
    DEFINE l_option1    LIKE type_file.num20_6
    DEFINE l_option2    LIKE type_file.num20_6
    DEFINE l_result     LIKE type_file.num20_6
    DEFINE l_option3    LIKE type_file.num20_6
    DEFINE l_option4    LIKE type_file.num20_6
    #FUN-B40092------add------end
    DEFINE l_fmt1       STRING                 #MOD-BC0008 add
    DEFINE l_fmt2       STRING                 #MOD-BC0008 add
    ...
    FORMAT
        ...
        ON EVERY ROW
            #FUN-B40092------add------str
            LET l_3 = sr1.tot24 - sr1.tot26
            PRINTX l_3
            LET l_3_1 = sr1.tot24_1 - sr1.tot26_1
            PRINTX l_3_1
            LET l_3_10 = sr1.tot24_10 - sr1.tot26_10
            PRINTX l_3_10
            LET l_3_11 = sr1.tot24_11 - sr1.tot26_11
            PRINTX l_3_11
            LET l_3_12 = sr1.tot24_12 - sr1.tot26_12
            PRINTX l_3_12
            LET l_3_2 = sr1.tot24_2 - sr1.tot26_2
            PRINTX l_3_2
            LET l_3_3 = sr1.tot24_3 - sr1.tot26_3
            PRINTX l_3_3
            LET l_3_4 = sr1.tot24_4 - sr1.tot26_4
            PRINTX l_3_4
            LET l_3_5 = sr1.tot24_5 - sr1.tot26_5
            PRINTX l_3_5
            LET l_3_6 = sr1.tot24_6 - sr1.tot26_6
            PRINTX l_3_6
            LET l_3_7 = sr1.tot24_7 - sr1.tot26_7
            PRINTX l_3_7
            LET l_3_8 = sr1.tot24_8 - sr1.tot26_8
            PRINTX l_3_8
            LET l_3_9 = sr1.tot24_9 - sr1.tot26_9
            PRINTX l_3_9

            LET l_9 = sr1.ab + sr1.bb
            PRINTX l_9
            LET l_9_1 = sr1.ab_1 + sr1.bb_1
            PRINTX l_9_1
            LET l_9_2 = sr1.ab_2 + sr1.bb_2
            PRINTX l_9_2
            LET l_9_3 = sr1.ab_3 + sr1.bb_3
            PRINTX l_9_3
            LET l_9_4 = sr1.ab_4 + sr1.bb_4
            PRINTX l_9_4
            LET l_9_5 = sr1.ab_5 + sr1.bb_5
            PRINTX l_9_5
            LET l_9_6 = sr1.ab_6 + sr1.bb_6
            PRINTX l_9_6
            LET l_9_7 = sr1.ab_7 + sr1.bb_7
            PRINTX l_9_7
            LET l_9_8 = sr1.ab_8 + sr1.bb_8
            PRINTX l_9_8
            LET l_9_9 = sr1.ab_9 + sr1.bb_9
            PRINTX l_9_9
            LET l_9_10 = sr1.ab_10 + sr1.bb_10
            PRINTX l_9_10
            LET l_9_11 = sr1.ab_11 + sr1.bb_11
            PRINTX l_9_11
            LET l_9_12 = sr1.ab_12 + sr1.bb_12
            PRINTX l_9_12 

            LET l_option = l_3 + sr1.tot5
            LET l_option1 = sr1.sum1 + sr1.tot23 + l_3 + sr1.tot5
      #     LET l_option2 = l_option + l_option1                    #MOD-BC0008   mark
            IF l_option1 != 0 THEN
      #        LET l_percent = l_option2 * 100               #MOD-BC0008  mark
               LET l_percent = (l_option / l_option2)* 100   #MOD-BC0008  add
            ELSE                                             #MOD-BC0008  add
               LET l_percent = 0                             #MOD-BC0008  add
            END IF
            PRINTX l_percent
            
            LET l_option3 = sr1.tot12 - l_3
            LET l_option4 = 1 - l_percent / 100
       #    LET l_result =  l_option3 * l_option4 + sr1.l75 * l_percent / 100 - sr1.tot18           #MOD-BC0008  mark
            LET l_result =  sr1.tot12 - l_3 * (l_option4 + sr1.l75 * l_percent / 100 - sr1.tot18)   #MOD-BC0008 add
            PRINTX l_result
