...
MAIN
   ...
   LET l_table = cl_prt_temptable('afar114',g_sql) CLIPPED
   ...
   IF cl_null(g_bgjob) OR g_bgjob = 'N'	# If background job sw is off
      ...
      ELSE CALL afar114()		        # Read data and create out-file
   END IF
...
FUNCTION r114_tm(p_row,p_col)
   ...
   OPEN WINDOW r114_w AT p_row,p_col WITH FORM "afa/42f/afar114"
      ...
      IF g_bgjob = 'Y' THEN
         ...
         ELSE
            ...
            LET l_cmd = l_cmd CLIPPED,		#(at time fglgo xxxx p1 p2 p3)
                            ...
                            " '",g_template CLIPPED,"'",
                            " '",g_rpt_name CLIPPED,"'"
            CALL cl_cmdat('afar114',g_time,l_cmd)      # Execute cmd at later time
         END IF
         CLOSE WINDOW r114_w
         CALL cl_used(g_prog,g_time,2) RETURNING g_time
         EXIT PROGRAM
...
FUNCTION afar114()
  ...
  LET l_sql = "SELECT fbx01,fbx02,fbx03,fbx04,fbx05,",
     ...
     CALL cl_prt_cs3('afar114','afar114',l_sql,g_str)
END FUNCTION
#FUN-BC0035
