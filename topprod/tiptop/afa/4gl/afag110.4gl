...
#No.FUN-710083 --begin
   ...
   LET l_table = cl_prt_temptable('afag110',g_sql) CLIPPED
   IF l_table = -1 THEN
...
#No.FUN-710083 --end
   IF cl_null(g_bgjob) OR g_bgjob = 'N'	# If background job sw is off
      ...
      ELSE CALL afag110()		# Read data and create out-file
   END IF
...
DEFINE lc_qbe_sn      LIKE gbm_file.gbm01   #No.FUN-580031
   ...
   OPEN WINDOW g110_w AT p_row,p_col WITH FORM "afa/42f/afag110"
 ...
 END CONSTRUCT
      ...
      IF g_bgjob = 'Y' THEN
         ...
         ELSE
            ...
            CALL cl_cmdat('afag110',g_time,l_cmd)      # Execute cmd at later time
         END IF
         CLOSE WINDOW g110_w
         CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690113
         CALL cl_gre_drop_temptable(l_table)
...
#    CALL cl_outnam('afag110') RETURNING l_name
...
###GENGRE###     LET l_sql = "SELECT * FROM ",g_cr_db_str CLIPPED,l_table CLIPPED
     ...
     IF g_aza.aza26 = '2' THEN
      # CALL cl_prt_cs3('afag110',l_sql,g_str)   #TQC-730088
      # CALL cl_prt_cs3('afag110','afag110',l_sql,g_str)      #FUN-920036 mark
###GENGRE###        CALL cl_prt_cs3('afag110','afag110_1',l_sql,g_str)    #FUN-920036 add
        LET g_template = "afag110_1"
        CALL afag110_grdata()    ###GENGRE###
     ELSE
      # CALL cl_prt_cs3('afag110_2',l_sql,g_str) #TQC-730088
      # CALL cl_prt_cs3('afag110','afag110_2',l_sql,g_str)    #FUN-920036 mark
###GENGRE###        CALL cl_prt_cs3('afag110','afag110',l_sql,g_str)      #FUN-920036 add
        LET g_template = "afag110"
        CALL afag110_grdata()    ###GENGRE###
     END IF
#No.FUN-710083 --end
...
FUNCTION afag110_grdata()
    ...
    WHILE TRUE
        ...
        LET handler = cl_gre_outnam("afag110")
        IF handler IS NOT NULL THEN
            START REPORT afag110_rep TO XML HANDLER handler
            LET l_sql = "SELECT * FROM ",g_cr_db_str CLIPPED,l_table CLIPPED,
                        " ORDER BY fbf03,fbf031"          
            DECLARE afag110_datacur1 CURSOR FROM l_sql
            FOREACH afag110_datacur1 INTO sr1.*
                OUTPUT TO REPORT afag110_rep(sr1.*)
            END FOREACH
            FINISH REPORT afag110_rep
        END IF
