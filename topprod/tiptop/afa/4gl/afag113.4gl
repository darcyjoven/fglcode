...
# Modify.........: No:FUN-C10066 12/02/01 By Sakura 憑證CR轉GR
...
###GENGRE###START
TYPE sr1_t RECORD
    fbq01 LIKE fbq_file.fbq01,
    fbq02 LIKE fbq_file.fbq02,
    fbq03 LIKE fbq_file.fbq03,
    fbq04 LIKE fbq_file.fbq04,
    fbq05 LIKE fbq_file.fbq05,
    fbq06 LIKE fbq_file.fbq06,
...
MAIN
   ...
   LET l_table = cl_prt_temptable('afag113',g_sql) CLIPPED #FUN-C10066 afar-->afag
   IF l_table = -1 THEN
   ...
   IF cl_null(g_bgjob) OR g_bgjob = 'N'	# If background job sw is off
      THEN CALL g113_tm(0,0)		# Input print condition #FUN-C10066 r-->g
      ELSE CALL afag113()		# Read data and create out-file #FUN-C10066 afar-->afag
   END IF
   CALL cl_used(g_prog,g_time,2) RETURNING g_time 
END MAIN

FUNCTION g113_tm(p_row,p_col) #FUN-C10066 r-->g
DEFINE lc_qbe_sn      LIKE gbm_file.gbm01   
   ...
   OPEN WINDOW g113_w AT p_row,p_col WITH FORM "afa/42f/afag113" #FUN-C10066 afar-->afag,r-->g
 ...
 END CONSTRUCT
      ...
      IF INT_FLAG THEN
         LET INT_FLAG = 0 CLOSE WINDOW g113_w #FUN-C10066 r-->g
         CALL cl_used(g_prog,g_time,2) RETURNING g_time 
         EXIT PROGRAM
      ...
      IF g_bgjob = 'Y' THEN
         SELECT zz08 INTO l_cmd FROM zz_file	#get exec cmd (fglgo xxxx)
          WHERE zz01='afag113' #FUN-C10066 afar-->afag
         IF SQLCA.sqlcode OR l_cmd IS NULL THEN
            CALL cl_err('afag113','9031',1) #FUN-C10066 afar-->afag
         ELSE
            ...
            LET l_cmd = l_cmd CLIPPED,		#(at time fglgo xxxx p1 p2 p3)
                            ...
                            " '",g_template CLIPPED,"'",           
                            " '",g_rpt_name CLIPPED,"'"          
            CALL cl_cmdat('afag113',g_time,l_cmd)      # Execute cmd at later time #FUN-C10066 afar-->afag
         END IF
         CLOSE WINDOW g113_w #FUN-C10066 r-->g
         CALL cl_used(g_prog,g_time,2) RETURNING g_time 
         EXIT PROGRAM
      END IF
      CALL cl_wait()
      CALL afag113() #FUN-C10066 afar-->afag
      ERROR ""
   END WHILE
...
FUNCTION afag113() #FUN-C10066 afar-->afag
   DEFINE l_name	LIKE type_file.chr20, 		# External(Disk) file name      
     ...
     LET l_sql = "SELECT fbq01,fbq02,fbq03,fbq04,fbq05,fbq06,",
                 ...
                 "       '','' ",
                #"  FROM fbq_file,fbr_file, OUTER faj_file  ",  #FUN-C50008 mark--
                 "  FROM fbq_file,fbr_file LEFT OUTER JOIN faj_file ON (fbr03=faj02 AND fbr031=faj022) ",  #FUN-C50008 add
                 " WHERE fbq01 = fbr01 ",
                 "   AND fbqconf !='X' ",        
                #"   AND fbr03=faj02 ",    #FUN-C50008 mark--
                #"   AND fbr031=faj022 ",  #FUN-C50008 mark--
                 "   AND ",tm.wc CLIPPED
     ...
     PREPARE g113_prepare1 FROM l_sql #FUN-C10066 r-->g
     ...
     END IF
     DECLARE g113_cs1 CURSOR FOR g113_prepare1 #FUN-C10066 r-->g

     FOREACH g113_cs1 INTO sr.* #FUN-C10066 r-->g
       IF SQLCA.sqlcode != 0 THEN
     ...
     CALL cl_wcchp(tm.wc,'fbq01,fbq02,fbq03,fbq04,fbq05')
          RETURNING tm.wc
###GENGRE###     LET g_str = tm.wc,";",g_zz05,";",g_faa.faa31

###GENGRE###     LET l_sql = "SELECT * FROM ",g_cr_db_str CLIPPED,l_table CLIPPED

###GENGRE###     CALL cl_prt_cs3('afar113','afar113',l_sql,g_str)
    LET g_cr_table = l_table                    # No.FUN-C40020 add
    LET g_cr_apr_key_f = "fbq01"          # No.FUN-C40020 add
    CALL afag113_grdata()    ###GENGRE###

END FUNCTION
#FUN-B80081

###GENGRE###START
FUNCTION afag113_grdata()
    DEFINE l_sql    STRING
    ...
    WHILE TRUE
        ...
        LET handler = cl_gre_outnam("afag113")
        IF handler IS NOT NULL THEN
            START REPORT afag113_rep TO XML HANDLER handler
            LET l_sql = "SELECT * FROM ",g_cr_db_str CLIPPED,l_table CLIPPED
          
            DECLARE afag113_datacur1 CURSOR FROM l_sql
            FOREACH afag113_datacur1 INTO sr1.*
                OUTPUT TO REPORT afag113_rep(sr1.*)
            END FOREACH
            FINISH REPORT afag113_rep
        END IF
...
REPORT afag113_rep(sr1)
    DEFINE sr1 sr1_t
    DEFINE l_lineno LIKE type_file.num5
    #FUN-C10066----add----str--------------
    DEFINE l_fbq04_gen02 STRING
    DEFINE l_fbq05_gem02 STRING
    DEFINE l_fbq03 STRING
    DEFINE l_fbr04 STRING
    DEFINE l_fbr05 STRING
    DEFINE l_fbr06 STRING
    DEFINE l_fbr06_show STRING
    #FUN-C10066----add----end--------------    

    
    ORDER EXTERNAL BY sr1.fbq01
    ...
    FORMAT
        ...
        BEFORE GROUP OF sr1.fbq01
            LET l_lineno = 0
            
            #FUN-C10066----add----str--------------
            LET l_fbq04_gen02=sr1.fbq04,' ',sr1.gen02
            LET l_fbq05_gem02=sr1.fbq05,' ',sr1.gem02
            LET l_fbq03= cl_gr_getmsg("gre-258",g_lang,sr1.fbq03)
            PRINTX l_fbq04_gen02
            PRINTX l_fbq05_gem02
            PRINTX l_fbq03            
            #FUN-C10066----add----end--------------            
        ...
        ON EVERY ROW
            ...
            #FUN-C10066----add----str--------------
            LET l_fbr04= cl_gr_getmsg("gre-259",g_lang,sr1.fbr04)
            LET l_fbr05= cl_gr_getmsg("gre-259",g_lang,sr1.fbr05)
            LET l_fbr06= cl_gr_getmsg("gre-259",g_lang,sr1.fbr06)
