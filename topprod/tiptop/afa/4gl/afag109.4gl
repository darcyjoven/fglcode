...
#FUN-710083.....begin
   ...
   LET l_table = cl_prt_temptable('afag109',g_sql) CLIPPED
   IF l_table = -1 THEN 
...
#FUN-710083.....end   
   IF cl_null(g_bgjob) OR g_bgjob = 'N'	# If background job sw is off
      ...
      ELSE CALL afag109()		# Read data and create out-file
   END IF
...
DEFINE lc_qbe_sn      LIKE gbm_file.gbm01   #No.FUN-580031
   ...
   OPEN WINDOW g109_w AT p_row,p_col WITH FORM "afa/42f/afag109"
 ...
 END CONSTRUCT
      ...
      IF g_bgjob = 'Y' THEN
         ...
         ELSE
            ...
            CALL cl_cmdat('afag109',g_time,l_cmd)      # Execute cmd at later time
         END IF
         CLOSE WINDOW g109_w
         CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690113
         CALL cl_gre_drop_temptable(l_table)
...
#     CALL cl_outnam('afag109') RETURNING l_name
#No.FUN-580010 --start
           #FUN-5A0180-begin
...
###GENGRE###    LET g_str = tm.wc,";",yyyymm,";",g_zz05,";",tm.b     #FUN-920036 add
  ...
  # CALL cl_prt_cs3('afag109',l_sql,g_str)
###GENGRE###    LET l_sql = "SELECT * FROM ",g_cr_db_str CLIPPED,l_table CLIPPED
###GENGRE###    CALL cl_prt_cs3('afag109','afag109',l_sql,g_str)
    LET g_cr_table = l_table                    # No.FUN-C40020 add
    LET g_cr_apr_key_f = "fbg01"          # No.FUN-C40020 add
    CALL afag109_grdata()    ###GENGRE###
...
FUNCTION afag109_grdata()
    ...
    WHILE TRUE
        ...
        LET handler = cl_gre_outnam("afag109")
        IF handler IS NOT NULL THEN
            START REPORT afag109_rep TO XML HANDLER handler
            LET l_sql = "SELECT * FROM ",g_cr_db_str CLIPPED,l_table CLIPPED,
                        " ORDER BY fbg01,fbh03,fbh031"
            DECLARE afag109_datacur1 CURSOR FROM l_sql
            FOREACH afag109_datacur1 INTO sr1.*
                OUTPUT TO REPORT afag109_rep(sr1.*)
            END FOREACH
            FINISH REPORT afag109_rep
        END IF
