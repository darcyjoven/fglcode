...
#No.FUN-7B0138--start
   ...
   LET l_table = cl_prt_temptable ('afar221',g_sql) CLIPPED
...
#No.FUN-7B0138--end
   ...
   IF cl_null(g_bgjob) OR g_bgjob = 'N'        # If background job sw is off
      THEN CALL afar221_tm(0,0)        # Input print condition
      ELSE CALL afar221()            # Read data and create out-file
   END IF
   CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690113
END MAIN
 
FUNCTION afar221_tm(p_row,p_col)
DEFINE lc_qbe_sn      LIKE gbm_file.gbm01   #No.FUN-580031
   ...
   OPEN WINDOW afar221_w AT p_row,p_col WITH FORM "afa/42f/afar221"
 ...
 END CONSTRUCT
      ...
      IF INT_FLAG THEN
         LET INT_FLAG = 0 CLOSE WINDOW afar221_w 
         CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690113
         EXIT PROGRAM
      ...
      IF g_bgjob = 'Y' THEN
         ...
         ELSE
            ...
            CALL cl_cmdat('afar221',g_time,l_cmd)    # Execute cmd at later time
         END IF
         CLOSE WINDOW afar221_w
         CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690113
         EXIT PROGRAM
      END IF
      CALL cl_wait()
...
#       l_time          LIKE type_file.chr8        #No.FUN-6A0069
     ...
     SELECT zz05 INTO g_zz05 FROM zz_file WHERE zz01 = 'afar221' #No.FUN-7B0138
     ...
     PREPARE afar221_prepare1 FROM l_sql
     ...
     END IF
     DECLARE afar221_curs1 CURSOR FOR afar221_prepare1
 
#     CALL cl_outnam('afar221') RETURNING l_name     #No.FUN-7B0138
#     START REPORT afar221_rep TO l_name             #No.FUN-7B0138 
#     LET g_pageno = 0                               #No.FUN-7B0138 
     FOREACH afar221_curs1 INTO sr.*
       IF SQLCA.sqlcode != 0 THEN
...
#No.FUN-7B0138--START--    MARK
     ...
     #  OUTPUT TO REPORT afar221_rep(sr.*)
...
#No.FUN-7B0138--start--
     ...
     LET g_str = g_str,";",tm.s[1,1],";",tm.s[2,2],";",tm.s[3,3],";",
                 tm.t[1,1],";",tm.t[2,2],";",tm.t[3,3],";",g_azi04
     CALL cl_prt_cs3('afar221','afar221',g_sql,g_str)
#No.FUN-7B0138--end
#     FINISH REPORT afar221_rep               #No.FUN-7B0138
 
#     CALL cl_prt(l_name,g_prtway,g_copies,g_len)  #No.FUN-7B0138
END FUNCTION
 
#No.FUN-7B0138--MARK START--
# REPORT afar221_rep(sr)
