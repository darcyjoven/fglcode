...
#FUN-710083.....begin
   LET g_sql="fbg01.fbg_file.fbg01,",
     ...
     LET l_table = cl_prt_temptable('afag108',g_sql) CLIPPED
     IF l_table = -1 THEN 
...
#FUN-710083.....end 
   ...
   IF cl_null(g_bgjob) OR g_bgjob = 'N'	# If background job sw is off
      ...
      ELSE CALL afag108()		# Read data and create out-file
   END IF
...
DEFINE lc_qbe_sn      LIKE gbm_file.gbm01   #No.FUN-580031
   ...
   OPEN WINDOW g108_w AT p_row,p_col WITH FORM "afa/42f/afag108"
 ...
 END CONSTRUCT
      ...
      IF g_bgjob = 'Y' THEN
         ...
         ELSE
            ...
            CALL cl_cmdat('afag108',g_time,l_cmd)      # Execute cmd at later time
         END IF
         CLOSE WINDOW g108_w
         CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690113
         CALL cl_gre_drop_temptable(l_table)
...
#     CALL cl_outnam('afag108') RETURNING l_name
#No.FUN-580010 --start
...
###GENGRE###    LET g_str = tm.wc,";",yyyymm,";",g_zz05,";",tm.b   #FUN-920036 add
  ...
  # CALL cl_prt_cs3('afag108',l_sql,g_str)
###GENGRE###    LET l_sql = "SELECT * FROM ",g_cr_db_str CLIPPED,l_table CLIPPED
###GENGRE###    CALL cl_prt_cs3('afag108','afag108',l_sql,g_str)
    LET g_cr_table = l_table                    # No.FUN-C40020 add
    LET g_cr_apr_key_f = "fbg01"          # No.FUN-C40020 add

    CALL afag108_grdata()    ###GENGRE###
#FUN-710083.....end
...
FUNCTION afag108_grdata()
    ...
    WHILE TRUE
        ...
        LET handler = cl_gre_outnam("afag108")
        IF handler IS NOT NULL THEN
            START REPORT afag108_rep TO XML HANDLER handler
            LET l_sql = "SELECT * FROM ",g_cr_db_str CLIPPED,l_table CLIPPED,
                        " ORDER BY fbg01,fbh03,fbh031"  
            DECLARE afag108_datacur1 CURSOR FROM l_sql
            FOREACH afag108_datacur1 INTO sr1.*
                OUTPUT TO REPORT afag108_rep(sr1.*)
            END FOREACH
            FINISH REPORT afag108_rep
        END IF
