...
#    DEFINE l_time	LIKE type_file.chr8         #No.FUN-680070 VARCHAR(8) #NO.FUN-6A0069
   ...
   END IF
    ...
    IF g_bgjob='N' OR cl_null(g_bgjob) THEN
       ...
       OPEN WINDOW t109_w AT p_row,p_col WITH FORM "afa/42f/afat109"
    ...
    CALL t108('2',g_argv2,g_argv3)              #1.資產報廢 2.資產銷帳  No.FUN-630010 執行功能
    CLOSE WINDOW t109_w                 #結束畫面
