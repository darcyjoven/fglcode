...
#NO.TQC-810004--------------start----------------
   ...
   LET l_table = cl_prt_temptable('afag900',g_sql) CLIPPED
   IF  l_table = -1 THEN
...
#NO.TQC-810004--------------end----------------
   ...
   IF cl_null(g_bgjob) OR g_bgjob = 'N'    # If background job sw is off
      ...
      ELSE CALL afag900()        # Read data and create out-file
   END IF
...
DEFINE lc_qbe_sn      LIKE gbm_file.gbm01   #No.FUN-580031
   ...
   OPEN WINDOW g900_w AT p_row,p_col WITH FORM "afa/42f/afag900"
 ...
 END CONSTRUCT
      ...
      IF g_bgjob = 'Y' THEN
         ...
         ELSE
            ...
            CALL cl_cmdat('afag900',g_time,l_cmd)
         END IF
         CLOSE WINDOW g900_w
         CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690113
         CALL cl_gre_drop_temptable(l_table)
...
#       l_time          LIKE type_file.chr8        #No.FUN-6A0069
     ...
     SELECT zz17,zz05 INTO g_len,g_zz05 FROM zz_file WHERE zz01 = 'afag900'
...
#                 " WHERE fajconf='Y' "
     ...
     PREPARE g900_prepare FROM l_sql
     ...
     END IF
     DECLARE g900_cs CURSOR FOR g900_prepare
 
#     CALL cl_outnam('afag900') RETURNING l_name       #NO.TQC-810004
 
#     START REPORT g900_rep TO l_name                  #NO.TQC-810004
#     LET g_pageno=0                                   #NO.TQC-810004
 
     FOREACH g900_cs INTO sr.*
       IF SQLCA.sqlcode != 0 THEN
...
#       OUTPUT TO REPORT g900_rep(sr.*)                 #NO.TQC-810004
#NO.TQC-810004--------------------start--------------
     EXECUTE insert_prep USING
        sr.fce02,sr.faj06,sr.faj07,sr.faj08,sr.faj12,sr.faj11,sr.fce21,
        sr.fce20,sr.fce04,sr.faj29,sr.fcd01
#NO.TQC-810004--------------------end--------------
     END FOREACH
 
#     FINISH REPORT g900_rep                            #NO.TQC-810004
...
###GENGRE###    LET g_sql = "SELECT * FROM ",g_cr_db_str CLIPPED,l_table CLIPPED
    ...
    END IF
###GENGRE###    LET g_str = tm.wc,";",g_zo.zo02,";",g_zo.zo041,";",g_azi04,";",g_azi05
###GENGRE###    CALL cl_prt_cs3('afag900','afag900',g_sql,g_str)
    CALL afag900_grdata()    ###GENGRE###
#NO.TQC-810004--------------------end--------------
END FUNCTION
...
FUNCTION afag900_grdata()
    ...
    WHILE TRUE
        ...
        LET handler = cl_gre_outnam("afag900")
        IF handler IS NOT NULL THEN
            START REPORT afag900_rep TO XML HANDLER handler
            LET l_sql = "SELECT * FROM ",g_cr_db_str CLIPPED,l_table CLIPPED,
                        " ORDER BY fcd01,fce02"
          
            DECLARE afag900_datacur1 CURSOR FROM l_sql
            FOREACH afag900_datacur1 INTO sr1.*
                OUTPUT TO REPORT afag900_rep(sr1.*)
            END FOREACH
            FINISH REPORT afag900_rep
        END IF
...
REPORT afag900_rep(sr1)
    DEFINE sr1 sr1_t
    DEFINE l_lineno LIKE type_file.num5
    DEFINE l_p2     LIKE zo_file.zo02
    DEFINE l_p3     LIKE zo_file.zo041 
    DEFINE l_sum_fce04 LIKE fce_file.fce04
    DEFINE l_fce04_fmt STRING              #FUN-B40092
    DEFINE l_sum_fce04_fmt   STRING        #FUN-B40092
    ORDER EXTERNAL BY sr1.fcd01
    ...
    FORMAT
        ...
        ON EVERY ROW
            ...
            LET l_fce04_fmt = cl_gr_numfmt('fce_file','fce04',g_azi04)#FUN-B40092
            PRINTX l_fce04_fmt                                        #FUN-B40092

            PRINTX sr1.*

        AFTER GROUP OF sr1.fcd01
            LET l_sum_fce04 = GROUP SUM(sr1.fce04) 
            PRINTX l_sum_fce04

            LET l_sum_fce04_fmt = cl_gr_numfmt('fce_file','fce04',g_azi05) #FUN-B40092
            PRINTX l_sum_fce04_fmt                                         #FUN-B40092
