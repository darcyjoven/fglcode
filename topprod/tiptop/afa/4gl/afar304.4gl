...
MAIN
   ...
   LET g_sql="faj02.faj_file.faj02,faj022.faj_file.faj022,",
             ...
             "ze03.ze_file.ze03"
   LET l_table = cl_prt_temptable('afar304',g_sql) CLIPPED
...
FUNCTION afar304_tm()
   ...
   OPEN WINDOW r304_w AT p_row,p_col WITH FORM "afa/42f/afar304"
      ...
      IF g_bgjob = "Y" THEN
         ...
         ELSE
            LET lc_cmd = lc_cmd CLIPPED,
                         ...
                         " '",tm.yy CLIPPED,"'",
                         " '",tm.mm CLIPPED,"'"
            CALL cl_cmdat('afar304',g_time,lc_cmd CLIPPED)
         END IF
         CLOSE WINDOW r304_w
         CALL cl_used(g_prog,g_time,2) RETURNING g_time  #No.FUN-B80054--add--
         EXIT PROGRAM
...
#   CALL cl_outnam('afar304') RETURNING l_name          #No.FUN-7C0082
#   START REPORT afar304_rep TO l_name                  #No.FUN-7C0082
...
#         OUTPUT TO REPORT afar304_rep(g_faj.*,'afa-177')      #No.FUN-7C0082
         #No.FUN-7C0082 --start--
         LET l_ze01 = 'afa-177'
      ...
      SELECT COUNT(*) INTO g_cnt FROM fay_file,faz_file
        WHERE fay01=faz01 AND faz03=g_faj.faj02 AND faz031=g_faj.faj022
          ...
          AND fayconf<>'X'
      IF g_cnt > 0 THEN
#         OUTPUT TO REPORT afar304_rep(g_faj.*,'afa-180')      #No.FUN-7C0082
         #No.FUN-7C0082 --start--                                               
         LET l_ze01 = 'afa-180'                                                 
         CALL cl_getmsg(l_ze01,g_lang) RETURNING l_ze03                         
         EXECUTE insert_prep USING g_faj.faj02,g_faj.faj022,g_faj.faj105,       
      ...
      SELECT COUNT(*) INTO g_cnt FROM fba_file,fbb_file
        WHERE fba01=fbb01 AND fbb03=g_faj.faj02 AND fbb031=g_faj.faj022
          ...
          AND fbaconf<>'X' 
      IF g_cnt > 0 THEN
#         OUTPUT TO REPORT afar304_rep(g_faj.*,'afa-181')      #No.FUN-7C0082
         #No.FUN-7C0082 --start--                                               
         LET l_ze01 = 'afa-181'                                                 
         CALL cl_getmsg(l_ze01,g_lang) RETURNING l_ze03                         
         EXECUTE insert_prep USING g_faj.faj02,g_faj.faj022,g_faj.faj105,       
      ...
      SELECT COUNT(*) INTO g_cnt FROM fbc_file,fbd_file
        WHERE fbc01=fbd01 AND fbd03=g_faj.faj02 AND fbd031=g_faj.faj022
          ...
          AND fbcconf<>'X'
      IF g_cnt > 0 THEN
#         OUTPUT TO REPORT afar304_rep(g_faj.*,'afa-182')      #No.FUN-7C0082
         #No.FUN-7C0082 --start--                                               
         LET l_ze01 = 'afa-182'                                                 
         CALL cl_getmsg(l_ze01,g_lang) RETURNING l_ze03                         
         EXECUTE insert_prep USING g_faj.faj02,g_faj.faj022,g_faj.faj105,       
      ...
      IF g_cnt > 0 THEN
#         OUTPUT TO REPORT afar304_rep(g_faj.*,'afa-183')      #No.FUN-7C0082
         #No.FUN-7C0082 --start--                                               
         LET l_ze01 = 'afa-183'                                                 
         CALL cl_getmsg(l_ze01,g_lang) RETURNING l_ze03                         
         EXECUTE insert_prep USING g_faj.faj02,g_faj.faj022,g_faj.faj105,       
      ...
      IF g_faa.faa23 = 'N' THEN
         ...
         SELECT COUNT(*) INTO g_cnt FROM fbg_file,fbh_file
           WHERE fbg01=fbh01 AND fbh03=g_faj.faj02 AND fbh031=g_faj.faj022
             ...
             AND fbgconf<>'X'
         IF g_cnt > 0 THEN
#            OUTPUT TO REPORT afar304_rep(g_faj.*,'afa-184')   #No.FUN-7C0082
            #No.FUN-7C0082 --start--                                               
         LET l_ze01 = 'afa-184'                                                 
         CALL cl_getmsg(l_ze01,g_lang) RETURNING l_ze03                         
         EXECUTE insert_prep USING g_faj.faj02,g_faj.faj022,g_faj.faj105,       
         ...
         SELECT COUNT(*) INTO g_cnt FROM fbe_file,fbf_file
           WHERE fbe01=fbf01 AND fbf03=g_faj.faj02 AND fbf031=g_faj.faj022
             ...
             AND fbeconf<>'X'
         IF g_cnt > 0 THEN
#            OUTPUT TO REPORT afar304_rep(g_faj.*,'afa-185')   #No.FUN-7C0082
            #No.FUN-7C0082 --start--                                               
            LET l_ze01 = 'afa-185'                                                 
            CALL cl_getmsg(l_ze01,g_lang) RETURNING l_ze03                         
            EXECUTE insert_prep USING g_faj.faj02,g_faj.faj022,g_faj.faj105,       
...
#               OUTPUT TO REPORT afar304_rep(g_faj.*,'afa-317')  #No.FUN-7C0082
               #No.FUN-7C0082 --start--                                               
               LET l_ze01 = 'afa-317'                                                 
               CALL cl_getmsg(l_ze01,g_lang) RETURNING l_ze03                         
               EXECUTE insert_prep USING g_faj.faj02,g_faj.faj022,g_faj.faj105,       
...
#            OUTPUT TO REPORT afar304_rep(g_faj.*,'afa-361')     #No.FUN-7C0082
            #No.FUN-7C0082 --start--                                               
            LET l_ze01 = 'afa-361'                                                 
            CALL cl_getmsg(l_ze01,g_lang) RETURNING l_ze03                         
            EXECUTE insert_prep USING g_faj.faj02,g_faj.faj022,g_faj.faj105,       
         ...
         END IF
      END IF
#      OUTPUT TO REPORT afar304_rep(g_faj.*,'afa-155')           #No.FUN-7C0082
       #No.FUN-7C0082 --start--                                               
       LET l_ze01 = 'afa-155'                                                 
       CALL cl_getmsg(l_ze01,g_lang) RETURNING l_ze03                         
       EXECUTE insert_prep USING g_faj.faj02,g_faj.faj022,g_faj.faj105,       
       ...
       #No.FUN-7C0082 --end-- 
   END FOREACH
#   FINISH REPORT afar304_rep                                    #No.FUN-7C0082
#   CALL cl_prt(l_name,g_prtway,g_copies,g_len)                  #No.FUN-7C0082
   #No.FUN-7C0082 --start--
   LET g_str=''
   LET l_sql="SELECT * FROM ",g_cr_db_str CLIPPED,l_table CLIPPED
   CALL cl_prt_cs3('afar304','afar304',l_sql,g_str)
   #No.FUN-7C0082 --end--
