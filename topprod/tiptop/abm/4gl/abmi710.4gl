...
# Modify.........: No:MOD-B40163 11/05/10 By vampire AFTER FIELD bmz05段若g_bmz[l_ac].bmz05=NULL則要給一個空白字元
...
DEFINE
    ...
    g_bmy           DYNAMIC ARRAY OF RECORD    #程式變數(Prinram Variables)
            ...
            ta_bmy01 LIKE bmy_file.ta_bmy01,
    ...
    g_bmy_t         RECORD
			...
			bmy06    LIKE bmy_file.bmy06,
			bmy07    LIKE bmy_file.bmy07,
            ta_bmy01 LIKE bmy_file.ta_bmy01, #str---add by huanglf160816
            ta_bmy02 LIKE bmy_file.ta_bmy02, #str---add by huanglf160927
                        bmy34    LIKE bmy_file.bmy34,   #no.MOD-840426
			bmy22    LIKE bmy_file.bmy22
                    END RECORD,
   #CHI-C10032 str add-----
...
DEFINE l_sql          STRING   #add by zhangzs 201208
DEFINE l_bmz02        LIKE bmz_file.bmz02   #add by zhangzs 201208
DEFINE l_tc_bmc38     LIKE type_file.num5   #add by zhangzs 201208
DEFINE l_date         LIKE type_file.chr50    #add by zhangzs 201208
DEFINE l_date1        LIKE bmx_file.bmxdate
DEFINE l_bmb          RECORD LIKE bmb_file.*   #add by zhangzs 201208
       ...
       #@WHEN "確認"
         WHEN "confirm"
            IF cl_chk_act_auth() THEN
              ...
              DECLARE i710_tc_bmc CURSOR FOR SELECT bmz02 FROM bmz_file WHERE bmz01 = g_bmx.bmx01
              FOREACH i710_tc_bmc INTO l_bmz02
                 DECLARE i710_tc_bmc2 CURSOR FOR SELECT * FROM bmb_file WHERE bmb01 = l_bmz02 and bmb05 is null
                 FOREACH i710_tc_bmc2 INTO l_bmb.*
                   SELECT MAX(tc_bmc38) INTO l_tc_bmc38 FROM tc_bmc_file WHERE bmb01 = l_bmz02
                   IF l_tc_bmc38 IS NULL OR l_tc_bmc38 = '' THEN 
                    LET l_tc_bmc38 = 1
                   END IF 
				   select ecu02 into l_ecu02 from ecu_file where ecu01 = l_bmz02 AND ROWNUM=1 ORDER BY ecu02 DESC 
                   SELECT TO_CHAR(SYSDATE, 'YY-MM-DD,HH:MM:SS') INTO l_date FROM DUAL  #日期+时间
                   SELECT TO_CHAR(SYSDATE, 'YY-MM-DD') INTO l_date1 FROM DUAL
                   INSERT INTO tc_bmc_file VALUES (l_bmb.*,l_ecu02,l_date,g_bmx.bmx01)
              ...
              #add by zhangzs 201208 -------e-------
               ...
               IF g_success = "Y" THEN
                   CALL i710_y_upd()      #CALL 原確認的 update 段
                   IF g_success != 'Y' THEN  #add by zhangzs 201210
                      DELETE FROM tc_bmc_file WHERE tc_bmc38 = l_tc_bmc38+1 AND tc_bmc40 = g_bmx.bmx01  #add by zhangzs 201210
                   END IF    #add by zhangzs 201210
                   CALL i710_refresh() RETURNING g_bmx.*  #FUN-B80071
...
#FUN-A70125 --end--
            ...
            ELSE
               ...
               IF g_ima107='Y' AND g_bmy[l_ac].bmy03 MATCHES '[23456]' THEN #CHI-960004 add 5 #CHI-C20060
                  CALL i710_t()
               END IF
               COMMIT WORK
            END IF
...
#             END IF
            ...
            IF cl_null(l_bmy05) OR l_bmy05 != g_bmy[l_ac].bmy05 THEN    #No.MOD-550047
               ...
               IF g_bmy[l_ac].bmy03 = '1' OR   
                  ...
                  IF g_argv1='1' THEN   #CHI-CA0035 mod g_argv3->g_argv1
                     LET l_sql1=" SELECT bmb16,bmb06,bmb07,bmb30,bmb31,bmbud02,bmbud06 FROM bmb_file,bmz_file ",   #str---add by huanglf160817
                              #MOD-B70036---modify---start---      #bmbud06 add by huanglf160927
                              #" WHERE bmb01 = bmz02 AND bmb29 = bmz05 AND bmz01 = g_bmx.bmx01 ",
                              #" AND bmb03 = g_bmy[l_ac].bmy05 AND (bmb04 <=g_bmx.bmx07 OR bmb04 IS NULL) ",  
                              #" AND (bmb05 > g_bmx.bmx07 OR bmb05 IS NULL) "                                                        
                               " WHERE bmb01 = bmz02 AND bmb29 = bmz05 AND bmz01 = '",g_bmx.bmx01,"' ",                        
                              ...
                              #MOD-B70036---modify---end---
                  ELSE 
                     LET l_sql1=" SELECT brb16,brb06,brb07,brb30,brb31,'','' FROM brb_file,bmz_file ",    #str---add byhuanlf160817
                              #MOD-B70036---modify---start---  #add by huanglf160927
                              #" WHERE brb01 = bmz02 AND brb29 = bmz05 AND bmz01 = g_bmx.bmx01 ",
                              #" AND bmz011=brb011 AND brb012=bmz012 AND brb013=bmz013 ",
                              #" AND brb03 = g_bmy[l_ac].bmy05 AND (brb04 <=g_bmx.bmx07 OR brb04 IS NULL) ",
                              #" AND (brb05 > g_bmx.bmx07 OR brb05 IS NULL) "                 	  
...
#                     AND (bmb05 > g_bmx.bmx07 OR bmb05 IS NULL)
                 FOREACH get_def_cs INTO
                         ...
                         g_bmy[l_ac].ta_bmy01,
                         g_bmy[l_ac].ta_bmy02 #add by huanglf160927
                   EXIT FOREACH
                 END FOREACH
                 ...
                 DISPLAY g_bmy[l_ac].ta_bmy01 TO ta_bmy01
           ...
           #MOD-A80018---add---end---
            ...
            ELSE
               ...
               ELSE
                  MESSAGE 'UPDATE O.K'
                  LET l_bmx09 = '0'          #FUN-550040
                  IF g_ima107='Y' AND g_bmy[l_ac].bmy03 MATCHES '[23456]' #CHI-960004 add 5 #CHI-C20060
...
FUNCTION i710_b_move_back()
 DEFINE p_cmd   LIKE type_file.chr1      #No.FUN-680096 VARCHAR(1)
   ...
   LET b_bmy.ta_bmy01 = g_bmy[l_ac].ta_bmy01 #str---add by huanglf160816
...
DEFINE p_wc3   LIKE type_file.chr1000    #No.FUN-680096 VARCHAR(200)
    ...
    LET g_sql =
        "SELECT UNIQUE bmy02,bmy03,bmy19,bmy04,bmy05,'','',bmy27,'','',bmy16,bmy35,bmy30,bmy06,bmy07,ta_bmy01,ta_bmy02", #FUN-550014 add bmy30 add TQC-850020 #CHI-A60028 add bmy35
        "       bmy34,", 　#no.MOD-840426 add   #No:CHI-960045 add ,  #add by huanglf160927
        "       bmy22",   #bugno:6845
...
DEFINE l_ac      LIKE type_file.num5
     ...
     OPEN WINDOW i710_g_bmz1_w AT p_row,p_col WITH FORM "abm/42f/abmi710f"
      ATTRIBUTE (STYLE = g_win_style CLIPPED) 
     ...
     LET g_sql="SELECT cho,bmz02,'','',bmz04,bmz05,bmz011,bmz012,bmz013",
...
#    LET g_sql = "UPDATE ",g_cr_db_str CLIPPED,l_table CLIPPED,           #TQC-C60179       
    ...
    FOREACH i710_tmp_cur INTO l_bmz1[l_i].*
       IF SQLCA.sqlcode THEN
          ...
          EXIT FOREACH
       END IF
       SELECT ima02,ima021 INTO l_bmz1[l_i].ima02, l_bmz1[l_i].ima021
         FROM ima_file
...
#str----add by huanglf161019
   IF cl_null(g_bmb.bmb09) THEN 
      CALL cl_err('','cbm-001',1)
      LET g_success = 'N'
   END IF 
#str----end by huanglf161019 
  ...
  #LET g_bmb.bmb14 =0 #CHI-A60028 mark
   ...
   LET g_bmb.bmb17 ='N'
   LET g_bmb.bmb19 ='1'
   LET g_bmb.bmbud02 = b_bmy.ta_bmy01
   LET g_bmb.bmbud06 = b_bmy.ta_bmy02  #add by huanglf160927
...
#  LET g_bmb.bmb04 =g_bmx.bmx07  #No.TQC-A30040
   ...
   IF NOT cl_null(b_bmy.ta_bmy01) THEN LET g_bmb.bmbud02 =b_bmy.ta_bmy01 END IF #add by huanglf160927
   IF NOT cl_null(b_bmy.ta_bmy02) THEN LET g_bmb.bmbud06 =b_bmy.ta_bmy02 END IF #add by huanglf160927
