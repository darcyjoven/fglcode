...
MAIN
    ...
    CALL aws_efapp_flowaction("insert, modify, delete, reproduce, detail, query,locale, void, confirm, undo_confirm,easyflow_approval,master_item_detail,component_detail")  #NO.TQC-5C0004
    ...
    WHILE TRUE
       ...
       #CALL s_auto_assign_no("abm",g_bmx.bmx01,g_bmx.bmx07,"1","bmx_file","bmx01","","","")  #MOD-A40116 mark
        ...
        IF SQLCA.SQLCODE OR SQLCA.SQLERRD[3]=0 THEN
          #TQC-C20131--mark--begin
          #ROLLBACK WORK #No:7857
          #CALL cl_err3("ins","bmx_file",g_bmx.bmx01,g_bmx.bmx02,SQLCA.SQLCODE,"","",1) # TQC-660046
          #TQC-C20131--mark--end
          #TQC-C20131--add--begin
           CALL cl_err3("ins","bmx_file",g_bmx.bmx01,g_bmx.bmx02,SQLCA.SQLCODE,"","",1)
           ROLLBACK WORK
          #TQC-C20131--add--end
           CONTINUE WHILE
        ELSE
...
FUNCTION i710_out()
    ...
    MENU ""
       ...
       ON ACTION list_of_effective_wo
        ...
        # LET g_msg = "abmr730 '",g_today,"' '",g_user,"' '",g_lang,"' ", #FUN-C30085 mark
         LET g_msg = "abmg730 '",g_today,"' '",g_user,"' '",g_lang,"' ", #FUN-C30085 add
                     " 'Y' ' ' '1' ", 
                     " '",g_msg CLIPPED,"' "   #No.MOD-950055 add CLIPPED 
          CALL cl_cmdrun(g_msg)
...
FUNCTION i710_x()
   ...
   IF cl_void(0,0,g_bmx.bmx04) THEN
