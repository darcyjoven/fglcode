...
# Modify.........: No.TQC-D20021 13/02/19 By xuxz 修改tm.wc,l_sql為STRING類型，修改打印條件mps01顯示
...
DEFINE tm RECORD                           # Print condition RECORD
            #wc      LIKE type_file.chr1000,#NO.FUN-680101 VARCHAR(600) # Where condition#TQC-D20021 mark
             wc      STRING,#TQC-D20021 add
...
#No.FUN-750095 -- begin --
   ...
   LET l_table = cl_prt_temptable('amsr540',g_sql) CLIPPED
...
#No.FUN-750095 -- end --
   ...
   IF cl_null(g_bgjob) OR g_bgjob='N'        # If background job sw is off
      THEN CALL amsr540_tm(0,0)        # Input print condition
      ELSE CALL amsr540()            # Read data and create out-file
   END IF
   CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690116
END MAIN
 
FUNCTION amsr540_tm(p_row,p_col)
DEFINE lc_qbe_sn         LIKE gbm_file.gbm01   #No.FUN-580031
   ...
   OPEN WINDOW amsr540_w AT p_row,p_col
        WITH FORM "ams/42f/amsr540"  ATTRIBUTE (STYLE = g_win_style CLIPPED) #No.FUN-580092 HCN
...
LET tm.wc = tm.wc CLIPPED,cl_get_extra_cond(null, null) #FUN-980030
   ...
   IF INT_FLAG THEN
      LET INT_FLAG = 0 CLOSE WINDOW amsr540_w 
      CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690116
      EXIT PROGRAM
   ...
   IF g_bgjob = 'Y' THEN
      ...
      ELSE
         ...
         CALL cl_cmdat('amsr540',g_time,l_cmd)    # Execute cmd at later time
      END IF
      CLOSE WINDOW amsr540_w
      CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690116
      EXIT PROGRAM
   END IF
   CALL cl_wait()
...
#       l_time          LIKE type_file.chr8        #No.FUN-6A0081
         #l_sql     LIKE type_file.chr1000,#NO.FUN-680101 VARCHAR(1000)  # RDSQL STATEMENT#TQC-D20021 mark
          l_sql     STRING,  #TQC-D20021 add
...
#No.FUN-750095 -- end --
     ...
     LET l_sql = "SELECT mps01",
                 ...
                 "   AND mps_v='",tm.ver_no,"'",
                 " GROUP BY mps01"
     PREPARE amsr540_prepare1 FROM l_sql
     IF STATUS THEN CALL cl_err('prepare:',STATUS,1) 
        CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690116
        EXIT PROGRAM 
     END IF
     DECLARE amsr540_curs1 CURSOR FOR amsr540_prepare1
      ...
      PREPARE amsr540_premps  FROM l_sql
      IF STATUS THEN CALL cl_err('pre mps:',STATUS,1) 
         CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690116
         EXIT PROGRAM 
      END IF
      DECLARE amsr540_curmps CURSOR FOR amsr540_premps   
      ...
      PREPARE amsr540_prempt  FROM l_sql
      IF STATUS THEN CALL cl_err('pre mpt:',STATUS,1) 
         CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690116
         EXIT PROGRAM 
      END IF
      DECLARE r540_c2        CURSOR FOR amsr540_prempt   
      ...
      PREPARE amsr540_pretmp  FROM l_sql
      IF STATUS THEN CALL cl_err('pre tmp:',STATUS,1) 
         CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690116
         EXIT PROGRAM 
      END IF
      DECLARE r540_c3        CURSOR FOR amsr540_pretmp   
 
#No.FUN-750095 -- begin --
#     CALL cl_outnam('amsr540') RETURNING l_name
#     START REPORT amsr540_rep TO l_name
#     LET g_pageno = 0
#No.FUN-750095 -- end --
 
     FOREACH amsr540_curs1 INTO mps.mps01
      IF STATUS THEN CALL cl_err('foreach:',STATUS,1) EXIT FOREACH END IF
      LET l_max = 'Y' 
 
      FOREACH amsr540_curmps USING mps.mps01 INTO mps.* 
...
#No.FUN-750095 -- begin --
#          OUTPUT TO REPORT amsr540_rep(sr.*,mps.*, ima.*,mpt.*,l_lastbal)
...
#No.FUN-750095 -- end --
     ...
     END FOREACH
#     FINISH REPORT amsr540_rep   #No.FUN-750095
     DROP TABLE r540_tmp
#No.FUN-750095 -- begin --
#     CALL cl_prt(l_name,g_prtway,g_copies,g_len)
     SELECT zz05 INTO g_zz05 FROM zz_file WHERE zz01 = g_prog
     CALL cl_wcchp(tm.wc,'mps01,ima67,ima08,ima43')#TQC-D20021 add msp01,ima67,ima08,ima43
          RETURNING tm.wc
     LET g_str = tm.wc,";",g_zz05,";",tm.s[1,1],";",tm.s[2,2],";",tm.s[3,3],";",tm.t
     LET l_sql = "SELECT * FROM ",g_cr_db_str CLIPPED,l_table CLIPPED
     CALL cl_prt_cs3('amsr540','amsr540',l_sql,g_str)
#No.FUN-750095 -- end --
END FUNCTION
 
#No.FUN-750095 -- begin --
#REPORT amsr540_rep(sr,mps, ima,mpt,p_lastbal)
