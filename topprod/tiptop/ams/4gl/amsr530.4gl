...
#No.FUN-750101  --begin--
   ...
   LET l_table=cl_prt_temptable('amsr530',g_sql)  CLIPPED
...
#No.FUN-750101  --END--
   ...
   IF cl_null(g_bgjob) OR g_bgjob='N'        # If background job sw is off
      THEN CALL amsr530_tm(0,0)        # Input print condition
      ELSE CALL amsr530()            # Read data and create out-file
   END IF
   CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690116
END MAIN
 
FUNCTION amsr530_tm(p_row,p_col)
DEFINE lc_qbe_sn         LIKE gbm_file.gbm01   #No.FUN-580031
   ...
   OPEN WINDOW amsr530_w AT p_row,p_col
        WITH FORM "ams/42f/amsr530" 
################################################################################
...
LET tm.wc = tm.wc CLIPPED,cl_get_extra_cond(null, null) #FUN-980030
   ...
   IF INT_FLAG THEN
      LET INT_FLAG = 0 CLOSE WINDOW amsr530_w 
      CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690116
      EXIT PROGRAM
...
################################################################################
   ...
   IF g_bgjob = 'Y' THEN
      ...
      ELSE
         ...
         CALL cl_cmdat('amsr530',g_time,l_cmd)    # Execute cmd at later time
      END IF
      CLOSE WINDOW amsr530_w
      CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690116
      EXIT PROGRAM
   END IF
   CALL cl_wait()
...
#No.FUN-750101  --end--  
     ...
     LET l_sql = "SELECT *",
                 ...
                 "   AND mps_v='",tm.ver_no,"'"
     PREPARE amsr530_prepare1 FROM l_sql
     IF STATUS THEN CALL cl_err('prepare:',STATUS,1) 
        CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690116
        EXIT PROGRAM 
     END IF
     DECLARE amsr530_curs1 CURSOR FOR amsr530_prepare1
 
    # CALL cl_outnam('amsr530') RETURNING l_name #No.FUN-750101 
    # START REPORT amsr530_rep TO l_name         #No.FUN-750101
     LET g_pageno = 0
     FOREACH amsr530_curs1 INTO mps.*, ima.*
...
#No.FUN-750101  -- BEGIN--
      ...
      END IF      
#No.FUN-750101  --end--                
       #OUTPUT TO REPORT amsr530_rep(sr.*,mps.*, ima.*)   #No.FUN-750101
     END FOREACH
#No.FUN-750101  --begin--
     ...
     CALL cl_prt_cs3('amsr530','amsr530',l_sql,g_str) 
#No.FUN-750101   --end--
     #FINISH REPORT amsr530_rep   #No.FUN-750101
