...
# Modify.........: No:CHI-D40034 13/04/17 By chenying chr20欄位定義的長度不夠，導致報表打印出來欄位顯示不全
...
MAIN
   ...
   #No.FUN-780012 --start--
  #LET g_sql="chr20.type_file.chr20,tlf07.tlf_file.tlf07,",                    #CHI-D40034 
   LET g_sql="chr20.type_file.chr50,tlf07.tlf_file.tlf07,",                    #CHI-D40034  
             ...
             "tlf10.tlf_file.tlf10,tlf62.tlf_file.tlf62,",                      
             "tlf026.tlf_file.tlf026,tlf026_1.tlf_file.tlf026,",                
             "tlf026_2.tlf_file.tlf026,tlf026_3.tlf_file.tlf026,",
             "tlf13.tlf_file.tlf13,chr1.type_file.chr1"
   LET l_table = cl_prt_temptable('aimr230',g_sql) CLIPPED                      
  ...
  #LET g_code   = ARG_VAL(2)   #TQC-610072    	
   ...
   IF cl_null(g_bgjob) OR g_bgjob = 'N'		# If background job sw is off
      ...
      ELSE CALL r230()			            # Read data and create out-file
   END IF
...
################################################################################
   ...
   IF g_bgjob = 'Y' THEN
      ...
      ELSE
         ...
         CALL cl_cmdat('aimr230',g_time,l_cmd)	# Execute cmd at later time
      END IF
      CLOSE WINDOW r230_w
      CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690115 BY dxfwo 
      EXIT PROGRAM
...
#         l_time     LIKE type_file.chr8              #No.FUN-6A0074
          ...
          sr2        RECORD       
                     ...
                     #no       LIKE type_file.chr20,  #單據編號  #TQC-5B0142 add #No.FUN-690026 VARCHAR(20)  #CHI-D40034
                      no       LIKE type_file.chr50,  #單據編號  #TQC-5B0142 add #No.FUN-690026 VARCHAR(20)  #CHI-D40034
...
#       END CASE
#    END FOR
#     CALL cl_outnam('aimr230') RETURNING l_name
...
#      LET sr2.order3 = l_order[3]
     ...
     #MOD-650076-begin-mark
      ...
      #   OUTPUT TO REPORT r230_rep(sr2.*)    #先丟調撥出
      #   LET sr2.str ='調撥(一)→倉庫'
 #NO.MOD-530790--begin                                                           
...
#No.FUN-780012 --start--                                                        
    ...
    CALL cl_prt_cs3('aimr230','aimr230',l_sql,l_str)                            
#No.FUN-780012 --end-- 
END FUNCTION
#No.FUN-780012 --start-- mark
{REPORT r230_rep(sr2)
