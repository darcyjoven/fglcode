...
# Modify.........: No.FUN-D20064 13/02/20 By chenjing 修改全選報錯問題
...
MAIN
   ...
   LET l_table = cl_prt_temptable('aimg811',g_sql) CLIPPED   # 產生Temp Table
   IF l_table = -1 THEN 
   ...
   LET g_sql = "INSERT INTO ",g_cr_db_str CLIPPED,l_table CLIPPED,  #TQC-A50009 mod
               " VALUES(?)"  #FUN-860001  #MOD-A30152 remove ?
...
#TQC-AC0207 -----------mod end------------------------
   ...
   IF cl_null(g_bgjob) OR g_bgjob = 'N'	# If background job sw is off
      THEN CALL g811_tm(0,0)	    	# Input print condition
      ELSE CALL g811()		            # Read data and create out-file
   END IF
   CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690115 BY dxfwo 
   CALL cl_gre_drop_temptable(l_table)
END MAIN
 
FUNCTION g811_tm(p_row,p_col)
...
#  DEFINE l_pib03       LIKE pib_file.pib03      #CHI-960065  #TQC-AB0166 mark
   ...
   OPEN WINDOW g811_w AT p_row,p_col WITH FORM "aim/42f/aimg811"
...
WHILE TRUE
   ...
   IF INT_FLAG THEN
      LET INT_FLAG = 0 CLOSE WINDOW g811_w
...
#TQC-AC0207 -----------------mark end------------------------------------------------
   ...
   IF g_bgjob = 'Y' THEN
      ...
      ELSE
         ...
         CALL cl_cmdat('aimg811',g_time,l_cmd)      # Execute cmd at later time
      END IF
      CLOSE WINDOW g811_w
      CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690115 BY dxfwo 
      CALL cl_gre_drop_temptable(l_table)
...
#       l_time          LIKE type_file.chr8	    #No.FUN-6A0074
     ...
     SELECT zz17,zz05 INTO g_len,g_zz05 FROM zz_file WHERE zz01 = 'aimg811'
#No.FUN-710084 --begin
#    IF g_len = 0 OR g_len IS NULL THEN LET g_len = 80 END IF
#    FOR g_i = 1 TO g_len LET g_dash[g_i,g_i] = '=' END FOR
#    CALL cl_outnam('aimg811') RETURNING l_name
#No.FUN-710084 --end
...
#TQC-AC0207 -----------------mark end-----------------------------------
     ...
     PREPARE g811_prepare FROM l_sql
     IF SQLCA.sqlcode != 0 THEN
        CALL cl_err('prepare:',SQLCA.sqlcode,1) 
        CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690115 BY dxfwo 
        CALL cl_gre_drop_temptable(l_table)
     ...
     END IF
     DECLARE g811_curs CURSOR FOR g811_prepare
 
#    START REPORT g811_rep TO l_name     #No.FUN-710084
       FOREACH g811_curs INTO sr.pia01
        IF SQLCA.sqlcode THEN
           ...
           EXIT PROGRAM
        END IF
        EXECUTE g811_up USING sr.pia01
        EXECUTE insert_prep USING sr.pia01
 
#       OUTPUT TO REPORT g811_rep(sr.pia01)     #No.FUN-710084
      END FOREACH
   # LET g_str = tm.c,";",tm.d,";",tm.yearstr     #No.FUN-710084    #TQC-AC0207 mark
#     LET g_str = tm.wc,";",tm.c,";",tm.d,";",tm.yearstr             #TQC-AC0207   #FUN-B40087
   # CALL cl_prt_cs1('aimg811',l_sql,g_str)           #No.FUN-710084#TQC-730088
#     CALL cl_prt_cs1('aimg811','aimg811',l_sql,g_str) #No.FUN-710084    #FUN-B40087
#    FINISH REPORT g811_rep     #No.FUN-710084
 
#    CALL cl_prt(l_name,g_prtway,g_copies,g_len)     #No.FUN-710084

    CALL aimg811_grdata()      #FUN-B40087  add
END FUNCTION
...
FUNCTION aimg811_grdata()
    ...
    WHILE TRUE
        ...
        LET handler = cl_gre_outnam("aimg811")
        IF handler IS NOT NULL THEN
            START REPORT aimg811_rep TO XML HANDLER handler
            LET l_sql = "SELECT * FROM ",g_cr_db_str CLIPPED,l_table CLIPPED
          
            DECLARE aimg811_datacur1 CURSOR FROM l_sql
            FOREACH aimg811_datacur1 INTO sr1.*
                OUTPUT TO REPORT aimg811_rep(sr1.*)
            END FOREACH
            FINISH REPORT aimg811_rep
        END IF
