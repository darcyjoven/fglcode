# Prog. Version..: '5.30.06-13.04.17(00001)'     #
#
# Pattern name...: aimq200
...
# Modify.........: No.TQC-D30039 13/03/14 By xujing 處理aimq200單身動態顯示新規格
# Modify.........: No.TQC-D30056 13/03/21 By xujing 處理aimq200單身抓去欄位類型說明順序錯誤
# Modify.........: No.TQC-D30072 13/03/28 By xujing 調整aimq200匯總頁簽光標問題
# Modify.........: No.MOD-DB0074 13/11/12 By fengmy l_day非本月第一天,期初數量錯誤
# Modify.........: No.TQC-DB0022 13/11/14 By fengrui 反勾選[異動為0是否顯示],則不顯示無異動資料
...
MAIN
   ...
   LET l_bdate = NULL   
   LET l_edate = NULL  
   OPEN WINDOW aimq200_w AT p_row,p_col
         WITH FORM "aim/42f/aimq200" 
   ...
   CONSTRUCT tm.wc ON img02,img03,img04,img19,ima12,ima01,ima02,ima021,img09   
      ...
      BEFORE CONSTRUCT
         ...
         IF tm.price='Y' THEN 
            ...
            CALL cl_set_comp_visible('ts1,ts2,ts3,ts4,ts5,ts6,ts7,ts8,ts9,ts10',TRUE) #MOD-DB0074 add
            CALL cl_set_comp_visible('ts11,ts12,ts13,ts14,ts15,ts16,ts17,ts18,ts19,ts20',TRUE) #MOD-DB0074 add
            CALL cl_set_comp_visible('ts21,ts22,ts23,ts24,ts25,ts26,ts27,ts28,ts29,ts30',TRUE) #MOD-DB0074 add
            CALL cl_set_comp_visible('ts31,ts32,ts33,ts34,ts35,ts36,ts37,ts38,ts39,ts40',TRUE) #MOD-DB0074 add
            CALL cl_set_comp_visible('ts41,ts42,ts43,ts44,ts45,ts46,ts47,ts48,ts49,ts50',TRUE) #MOD-DB0074 add            
         ELSE
            CALL cl_set_comp_visible('p0,s0,s3',FALSE)
            CALL cl_set_comp_visible('ts1,ts2,ts3,ts4,ts5,ts6,ts7,ts8,ts9,ts10',FALSE) #MOD-DB0074 add
            CALL cl_set_comp_visible('ts11,ts12,ts13,ts14,ts15,ts16,ts17,ts18,ts19,ts20',FALSE) #MOD-DB0074 add
            CALL cl_set_comp_visible('ts21,ts22,ts23,ts24,ts25,ts26,ts27,ts28,ts29,ts30',FALSE) #MOD-DB0074 add
            CALL cl_set_comp_visible('ts31,ts32,ts33,ts34,ts35,ts36,ts37,ts38,ts39,ts40',FALSE) #MOD-DB0074 add
            CALL cl_set_comp_visible('ts41,ts42,ts43,ts44,ts45,ts46,ts47,ts48,ts49,ts50',FALSE) #MOD-DB0074 add  
         END IF
...
FUNCTION q200_bp(p_ud)
   ...
   DIALOG ATTRIBUTES(UNBUFFERED=TRUE)
      ...
      DISPLAY ARRAY g_img TO s_img.* ATTRIBUTE(COUNT=g_rec_b)
         ...
         BEFORE ROW
            CALL fgl_set_arr_curr(g_curs_index)             #TQC-D30072 add
            LET l_ac = ARR_CURR()
            CALL cl_show_fld_cont()
         BEFORE DISPLAY
            CALL cl_navigator_setting( g_curs_index, g_row_count )
#           CALL fgl_set_arr_curr(g_ac)                     #TQC-D30072 mark
            IF tm.price='Y' THEN 
               CALL cl_set_comp_visible('p0,s0,s3',TRUE)
               CALL cl_set_comp_visible('ts1,ts2,ts3,ts4,ts5,ts6,ts7,ts8,ts9,ts10',TRUE) #MOD-DB0074 add
               CALL cl_set_comp_visible('ts11,ts12,ts13,ts14,ts15,ts16,ts17,ts18,ts19,ts20',TRUE) #MOD-DB0074 add
...
#TQC-D10103---mark---end
     LET l_sql = " SELECT '",l_azp02,"',img02,imd02,img03,ime03,img04,img19,ima12,img01,ima02,ima021,img09, ",
#                "        NVL(stb04,0) p0,NVL(imk09,0) q0,NVL(stb04,0)*NVL(imk09,0) s0,",   #TQC-D30072 mark
               # "        NVL(stb04,0) p0,NVL(a.tlf_sum,0) q0,NVL(stb04,0)*NVL(a.tlf_sum,0) s0,",   #TQC-D30072 add  #MOD-DB0074 mark
                 "        NVL(stb04,0) p0,NVL(imk09,0)+NVL(a.tlf_sum,0) q0,NVL(stb04,0)*NVL(a.tlf_sum,0) s0,",  #MOD-DB0074 add
                 "        0 tq1, 0 ts1, 0 tq2, 0 ts2, 0 tq3, 0 ts3, 0 tq4, 0 ts4, 0 tq5, 0 ts5, 0 tq6, 0 ts6, 0 tq7, 0 ts7, 0 tq8, 0 ts8, 0 tq9, 0 ts9, 0 tq10,0 ts10,0 tq11,0 ts11,0 tq12,0 ts12,",
                 "        0 tq13,0 ts13,0 tq14,0 ts14,0 tq15,0 ts15,0 tq16,0 ts16,0 tq17,0 ts17,0 tq18,0 ts18,0 tq19,0 ts19,0 tq20,0 ts20,0 tq21,0 ts21,0 tq22,0 ts22,0 tq23,0 ts23,0 tq24,0 ts24,0 tq25,0 ts25,",
                 "        0 tq26,0 ts26,0 tq27,0 ts27,0 tq28,0 ts28,0 tq29,0 ts29,0 tq30,0 ts30,0 tq31,0 ts31,0 tq32,0 ts32,0 tq33,0 ts33,0 tq34,0 ts34,0 tq35,0 ts35,0 tq36,0 ts36,0 tq37,0 ts37,0 tq38,0 ts38,",
                 "        0 tq39,0 ts39,0 tq40,0 ts40,0 tq41,0 ts41,0 tq42,0 ts42,0 tq43,0 ts43,0 tq44,0 ts44,0 tq45,0 ts45,0 tq46,0 ts46,0 tq47,0 ts47,0 tq48,0 ts48,0 tq49,0 ts49,0 tq50,0 ts50,",
#                "        NVL(imk09,0)+NVL(b.tlf_sum,0)-NVL(c.tlf_sum,0) q3,(NVL(imk09,0)+NVL(b.tlf_sum,0)-NVL(c.tlf_sum,0))*NVL(stb04,0) s3,", #TQC-D30072 mark
                 "        NVL(a.tlf_sum,0)+NVL(b.tlf_sum,0)-NVL(c.tlf_sum,0) q3,(NVL(a.tlf_sum,0)+NVL(b.tlf_sum,0)-NVL(c.tlf_sum,0))*NVL(stb04,0) s3,", #TQC-D30072 add
                 "        nvl(trim(d.imz02),'') ima06_desc,nvl(trim(e.imz02),'') ima09_desc,nvl(trim(f.imz02),'') ima10_desc,nvl(trim(g.imz02),'') ima11_desc,nvl(trim(azf03),'') ima12_desc,nvl(trim(oba02),'') ima131_desc",
                 "   FROM ",l_dbs CLIPPED,"ima_file",
                 "        LEFT OUTER JOIN ",l_dbs CLIPPED,"imz_file d ON ima06=d.imz01",
                 "        LEFT OUTER JOIN ",l_dbs CLIPPED,"imz_file e ON ima09=e.imz01",
              ...
              #TQC-D30072---mark---end---
                ...
                #"                          WHERE tlf06 BETWEEN '",l_first,"' AND '",tm.bdate,"'",   #MOD-DB0074 mark
                 "                          WHERE tlf06 >='",l_first,"' AND tlf06<'",tm.bdate,"'",   #MOD-DB0074 add
     ...
     LET l_sql1 = " INSERT INTO aimq200_tmp ",
                  l_sql CLIPPED
     PREPARE q200_p FROM l_sql1
     EXECUTE q200_p
     IF tm.viewall='N'  THEN
        #TQC-DB0022--mark--str--
        #DELETE FROM aimq200_tmp WHERE q0 = 0 
        #                          AND q3 = 0
        #TQC-DB0022--mark--end--
        #TQC-DB0022--add--str--
        DELETE FROM aimq200_tmp 
         WHERE NOT EXISTS
              (SELECT * FROM aimq200_tmp,tlf_file 
                WHERE ima01 = tlf01 AND img02 = tlf902 
                  AND img03 = tlf903 AND img04 = tlf904
                  AND tlf06 BETWEEN tm.bdate AND tm.edate) 
        #TQC-DB0022--add--end--
     END IF
...
#    LET l_sql = "SELECT DISTINCT gge04,gge05,ggd02 FROM ",l_dbs CLIPPED,"gge_file",  #TQC-D30056 mark
     LET l_sql = "SELECT gge04,gge05,ggd02 FROM ",l_dbs CLIPPED,"gge_file",       #TQC-D30056 add
                 ...
                 " WHERE gge01='",tm.gge01 CLIPPED,"'",
                #" ORDER BY gge04,gge03"   #TQC-D30056 add  #MOD-DB0074 mark
                 " ORDER BY gge03,gge04"   #MOD-DB0074 
#TQC-D30039---add---end---
...
#TQC-D30039---add---end---
        IF l_gge04 = '1' THEN            #入库
           ...
           LET l_n  = l_i
#TQC-D10103 mark---str
#          LET l_sql = "MERGE INTO aimq200_tmp o",
...
#TQC-D10103 mark---end
#TQC-D10103---add---str---
#          LET l_sql = "UPDATE aimq200_tmp o SET o.tq",l_n," = NVL((SELECT SUM(tlf10) tlf10_sum FROM ",l_dbs CLIPPED,"tlf_file x",   #TQC-D20038 mark
           LET l_sql = "UPDATE aimq200_tmp o SET o.tq",l_n," = NVL((SELECT SUM(tlf10*tlf907*tlf60) tlf10_sum FROM ",l_dbs CLIPPED,"tlf_file x",   #TQC-D20038 add
#                      "                                        WHERE x.tlf14 = '",l_gge06 CLIPPED,"'",              #TQC-D30039 mark
           ...
           EXECUTE q200_p3
           LET l_sql = "UPDATE aimq200_tmp o SET o.ts",l_n," = o.p0 * NVL((SELECT SUM(tlf10*tlf907*tlf60) FROM ",l_dbs CLIPPED,"tlf_file x",
#                      "                                        WHERE x.tlf14 = '",l_gge06 CLIPPED,"'",              #TQC-D30039 mark
                       "                                        WHERE x.tlf14 IN ('",l_str CLIPPED,"')",             #TQC-D30039 add
                       "                                          AND x.tlf06 BETWEEN '",tm.bdate,"' AND '", tm.edate,"'",
                       "                                          AND o.ima01=x.tlf01 AND o.img02 = x.tlf902 ",
...
#          LET l_sql = "UPDATE aimq200_tmp o SET o.tq",l_n1," = NVL((SELECT SUM(tlf10) tlf10_sum FROM ",l_dbs CLIPPED,"tlf_file x",  #TQC-D20038 mark
           LET l_sql = "UPDATE aimq200_tmp o SET o.tq",l_n1," = NVL((SELECT -1*SUM(tlf10*tlf907*tlf60) tlf10_sum FROM ",l_dbs CLIPPED,"tlf_file x",  #TQC-D20038 add
#                      "                                        WHERE x.tlf14 = '",l_gge06 CLIPPED,"'",              #TQC-D30039 mark
                       "                                        WHERE x.tlf14 IN ('",l_str CLIPPED,"')",             #TQC-D30039 add
                       "                                          AND x.tlf06 BETWEEN '",tm.bdate,"' AND '", tm.edate,"'",
                       "                                          AND o.ima01=x.tlf01 AND o.img02 = x.tlf902 ",
           ...
           EXECUTE q200_p4
           LET l_sql = "UPDATE aimq200_tmp o SET o.ts",l_n1," = o.p0 * NVL((SELECT -1*SUM(tlf10*tlf907*tlf60) FROM ",l_dbs CLIPPED,"tlf_file x",
#                      "                                        WHERE x.tlf14 = '",l_gge06 CLIPPED,"'",              #TQC-D30039 mark
                       "                                        WHERE x.tlf14 IN ('",l_str CLIPPED,"')",             #TQC-D30039 add
                       "                                          AND x.tlf06 BETWEEN '",tm.bdate,"' AND '", tm.edate,"'",
                       "                                          AND o.ima01=x.tlf01 AND o.img02 = x.tlf902 ",
...
#TQC-D10103---add---end---
     ...
     IF tm.viewall='N'  THEN
        DELETE FROM aimq200_tmp
         WHERE tq1=0 AND tq2=0 AND tq3=0 AND tq4=0 AND tq5=0 
           AND tq6=0 AND tq7=0 AND tq8=0 AND tq9=0 AND tq10=0 
           AND tq11=0 AND tq12=0 AND tq13=0 AND tq14=0 AND tq15=0 
           AND tq16=0 AND tq17=0 AND tq18=0 AND tq19=0 AND tq20=0 
           AND tq21=0 AND tq22=0 AND tq23=0 AND tq24=0 AND tq25=0 
           AND tq26=0 AND tq27=0 AND tq28=0 AND tq29=0 AND tq30=0 
           AND tq31=0 AND tq32=0 AND tq33=0 AND tq34=0 AND tq35=0 
           AND tq36=0 AND tq37=0 AND tq38=0 AND tq39=0 AND tq40=0 
           AND tq41=0 AND tq42=0 AND tq43=0 AND tq44=0 AND tq45=0 
           AND tq46=0 AND tq47=0 AND tq48=0 AND tq49=0 AND tq50=0 
     END IF
     #TQC-DB0022--add--end--
 CALL q200_show()
END FUNCTION
...
FUNCTION q200_table()
DEFINE l_sql STRING
LET l_sql = "CREATE TEMP TABLE aimq200_tmp(",
            "   azp02   LIKE azp_file.azp02,",
            "   img02   LIKE img_file.img02,",
            "   imd02   LIKE imd_file.imd02,",
            "   img03   LIKE img_file.img03,",
...
FUNCTION q200_b_fill_1()
   ...
   LET g_sql = "SELECT * FROM aimq200_tmp "

   PREPARE aimq200_pb1 FROM g_sql
   DECLARE img_curs1  CURSOR FOR aimq200_pb1        #CURSOR
...
#        BEFORE ROW                                  #TQC-D30072 mark
#           LET l_ac1 = ARR_CURR()                   #TQC-D30072 mark
#           CALL cl_show_fld_cont()                  #TQC-D30072 mark
         BEFORE DISPLAY
            CALL cl_navigator_setting( g_curs_index, g_row_count )
            IF l_ac1 > 1 THEN                  #TQC-D30072 add    
               CALL fgl_set_arr_curr(l_ac1)    #TQC-D30072 add
            END IF                             #TQC-D30072 add
            IF tm.price='Y' THEN 
               CALL cl_set_comp_visible('p0_1,s0_1,s3_1',TRUE)
               CALL cl_set_comp_visible('ts1_1,ts2_1,ts3_1,ts4_1,ts5_1,ts6_1,ts7_1,ts8_1,ts9_1,ts10_1',TRUE) #MOD-DB0074 add
               CALL cl_set_comp_visible('ts11_1,ts12_1,ts13_1,ts14_1,ts15_1,ts16_1,ts17_1,ts18_1,ts19_1,ts20_1',TRUE) #MOD-DB0074 add
               CALL cl_set_comp_visible('ts21_1,ts22_1,ts23_1,ts24_1,ts25_1,ts26_1,ts27_1,ts28_1,ts29_1,ts30_1',TRUE) #MOD-DB0074 add
               CALL cl_set_comp_visible('ts31_1,ts32_1,ts33_1,ts34_1,ts35_1,ts36_1,ts37_1,ts38_1,ts39_1,ts40_1',TRUE) #MOD-DB0074 add
               CALL cl_set_comp_visible('ts41_1,ts42_1,ts43_1,ts44_1,ts45_1,ts46_1,ts47_1,ts48_1,ts49_1,ts50_1',TRUE) #MOD-DB0074 add
            ELSE
               CALL cl_set_comp_visible('p0_1,s0_1,s3_1',FALSE)
               CALL cl_set_comp_visible('ts1_1,ts2_1,ts3_1,ts4_1,ts5_1,ts6_1,ts7_1,ts8_1,ts9_1,ts10_1',FALSE) #MOD-DB0074 add
               CALL cl_set_comp_visible('ts11_1,ts12_1,ts13_1,ts14_1,ts15_1,ts16_1,ts17_1,ts18_1,ts19_1,ts20_1',FALSE) #MOD-DB0074 add
               CALL cl_set_comp_visible('ts21_1,ts22_1,ts23_1,ts24_1,ts25_1,ts26_1,ts27_1,ts28_1,ts29_1,ts30_1',FALSE) #MOD-DB0074 add
               CALL cl_set_comp_visible('ts31_1,ts32_1,ts33_1,ts34_1,ts35_1,ts36_1,ts37_1,ts38_1,ts39_1,ts40_1',FALSE) #MOD-DB0074 add
               CALL cl_set_comp_visible('ts41_1,ts42_1,ts43_1,ts44_1,ts45_1,ts46_1,ts47_1,ts48_1,ts49_1,ts50_1',FALSE) #MOD-DB0074 add
            END IF
            CALL cl_show_fld_cont()         
      END DISPLAY         
...
CASE tm.c
   WHEN "1"
      ...
      ELSE 
         LET l_tmp = ''
      END IF
      LET l_sql = "SELECT * FROM aimq200_tmp ",
   ...
   WHEN "9"
      ...
      LET l_sql = "SELECT * FROM aimq200_tmp",
                  ...
                  " ORDER BY ima131_desc"
END CASE 
PREPARE aimq200_pb_detail FROM l_sql
DECLARE img_curs_detail  CURSOR FOR aimq200_pb_detail        
CALL g_img.clear()
LET g_cnt = 1
LET g_rec_b = 0
