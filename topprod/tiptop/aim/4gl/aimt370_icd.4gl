...
#           FIELD ORDER FORM                   #整個畫面欄位輸入會依照p_per所設定的順序(忽略4gl寫的順序)#FUN-C20101---MARK----
    ...
    #No.FUN-830056  ...begin
    CASE WHEN g_argv1 = '1' LET g_cmd ='aimt301_icd'
         WHEN g_argv1 = '2' LET g_cmd ='aimt311_icd'
         WHEN g_argv1 = '3' LET g_cmd ='aimt302_icd'
         WHEN g_argv1 = '4' LET g_cmd ='aimt312_icd'
         WHEN g_argv1 = '5' LET g_cmd ='aimt303_icd'
         WHEN g_argv1 = '6' LET g_cmd ='aimt313_icd'
         OTHERWISE 
              PROMPT "This program must follow 1/2/3/4/5/6 parameter:"
                 FOR CHAR g_argv1 #EXIT PROGRAM
    END CASE
 
    CASE WHEN g_argv1 = '1' LET g_prog='aimt301_icd'
         WHEN g_argv1 = '2' LET g_prog='aimt311_icd'
         WHEN g_argv1 = '3' LET g_prog='aimt302_icd'
         WHEN g_argv1 = '4' LET g_prog='aimt312_icd'
         WHEN g_argv1 = '5' LET g_prog='aimt303_icd'
         WHEN g_argv1 = '6' LET g_prog='aimt313_icd'
    END CASE
    #No.FUN-830056  ...end
