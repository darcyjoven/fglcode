...
#FUN-C20101----add----BEGIN---
    CASE WHEN g_argv1 = '1' LET g_cmd ='aimt301_slk'
         WHEN g_argv1 = '3' LET g_cmd ='aimt302_slk'
         WHEN g_argv1 = '5' LET g_cmd ='aimt303_slk'
         OTHERWISE 
               PROMPT "This program must follow 1/3/5 parameter:"
                 FOR CHAR g_argv1 #EXIT PROGRAM
    END CASE
 
    CASE WHEN g_argv1 = '1' LET g_prog='aimt301_slk'
         WHEN g_argv1 = '3' LET g_prog='aimt302_slk'
         WHEN g_argv1 = '5' LET g_prog='aimt303_slk'
    END CASE
#FUN-C20101-----ADD---END--------
...
#FUN-C20101---ADD---BEGIN----
       OPEN WINDOW t370_w WITH FORM "aim/42f/aimt370_slk"
          ATTRIBUTE (STYLE = g_win_style CLIPPED)
       CALL cl_set_locale_frm_name("aimt370_slk")
#FUN-C20101---ADD----END-------      
       CALL cl_ui_init()
   END IF
