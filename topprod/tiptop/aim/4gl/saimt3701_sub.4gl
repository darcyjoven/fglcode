...
FUNCTION t370sub_s_upd(p_ina01,p_argv1,p_inTransaction)
  ...
  LET l_ina02 = g_ina02
   ...
   IF g_success = 'Y' THEN
      UPDATE ina_file SET 	inapost='Y'  WHERE ina01=p_ina01  
...
DEFINE p_ina06 LIKE ina_file.ina06
    ...
    #LET g_tlff.tlff06=l_ina.ina03      #發料日期
    SELECT ina03 INTO g_tlff.tlff06 FROM ina_file WHERE ina01=p_inb01
...
FUNCTION t370sub_tlf(p_ware,p_loca,p_lot,p_unit,p_qty,p_img10,p_uom,p_factor,
   ...
   #LET g_tlf.tlf06=l_ina.ina03          #發料日期
   SELECT ina03 INTO g_tlf.tlf06 FROM ina_file WHERE ina01=p_inb01
