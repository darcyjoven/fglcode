...
# Modify.........: No:CHI-B60076 11/06/29 By Vampire 加入 ima021 規格資料
# Modify.........: No:CHI-B50008 11/07/07 By Summer 要以aimi100料件基本檔的單位管制方式決定要印出來的是單一單位(pia_file)還是多單位(piaa_file)
# Modify.........: No.FUN-B70032 11/08/04 By jason 刻號/BIN-盤點
# Modify.........: No.MOD-BC0244 11/12/23 By ck2yuan 調整cl_prt_cs3的g_str參數
...
# Modify.........: No.MOD-C20122 12/02/14 By destiny l_sql长度不够
# Modify.........: No.MOD-C70012 12/07/02 By suncx 臨時表l_table和l_table1表名重複
...
DEFINE tm  RECORD	        		# Print condition RECORD
	   ...
	   code      LIKE type_file.chr1,  	# 是否列印條碼  #No.FUN-690026 VARCHAR(1)
          ...
          #e         LIKE type_file.chr1,       #No.FUN-570082  是否列印多單位標簽  #No.FUN-690026 CARCHAR(1) #CHI-B50008 mark
           f         LIKE type_file.chr1,       #No.FUN-860001
           d         LIKE type_file.chr1,       #No.FUN-B70032
...
DEFINE    l_table1    STRING   #FUN-B70032
...
MAIN
   ...
   LET g_sql =   "pia01.pia_file.pia01,pia02.pia_file.pia02,",
                 ...
                 "pias06.pias_file.pias06,pias07.pias_file.pias07,ima021.ima_file.ima021" #FUN-860001 #CHI-B60076 add ima021.ima_file.ima021
...
#No.TQC-C20047 ----- mark ----- end 
   LET l_table = cl_prt_temptable('aimr800',g_sql) CLIPPED   # 產生Temp Table
  ...
  #LET l_table1 = cl_prt_temptable('aimr800',g_sql) CLIPPED             #MOD-C70012 mark         
   LET l_table1 = cl_prt_temptable('aimr800_1',g_sql) CLIPPED           #MOD-C70012 aimr800 -> aimr800_1            
...
#  #No.FUN-570264 ---end---
   ...
   LET tm.a  = ARG_VAL(10)
  #LET tm.e  = ARG_VAL(11)   #TQC-610072 #CHI-B50008 mark
  #CHI-B50008 mod -1 --start--
   LET tm.yearstr = ARG_VAL(11)
   LET g_rep_user = ARG_VAL(12)
   LET g_rep_clas = ARG_VAL(13)
   LET g_template = ARG_VAL(14)
   LET g_rpt_name = ARG_VAL(15)  
  #CHI-B50008 mod -1 --end--
#TQC-AC0207 --------------mod end------------------------
...
FUNCTION r800_tm(p_row,p_col)
   ...
   OPEN WINDOW r800_w AT p_row,p_col WITH FORM "aim/42f/aimr800"
  ...
  #LET tm.bno='000001'                          #No.MOD-840153 mark
   ...
   LET tm.size = 'N'
   LET tm.a    = 'N'
  #LET tm.e    = 'N'   #No.FUN-570082 #CHI-B50008 mark
   LET tm.f    = 'N'   #No.FUN-860001
   LET tm.d    = 'N'   #No.FUN-B70032
   LET tm.more = 'N'
   LET g_pdate = g_today
   LET g_rlang = g_lang
   LET g_bgjob = 'N'
...
WHILE TRUE
   ...
   #            WITHOUT DEFAULTS
   #INPUT BY NAME tm.yearstr,tm.code,tm.size,tm.a,tm.e,tm.f,tm.more #CHI-B50008 mark
    INPUT BY NAME tm.yearstr,tm.code,tm.size,tm.a,tm.f,tm.d,tm.more #CHI-B50008 #FUN-B70032
       WITHOUT DEFAULTS
   #TQC-AC0207 --------------mod end----------------------------
      BEFORE INPUT
      ...
      ELSE
         LET l_cmd = l_cmd CLIPPED,		#(at time fglgo xxxx p1 p2 p3)
                       ...
                       # " '",tm.eno CLIPPED,"'",     #TQC-AC0207 mark
                         ...
                         " '",tm.size CLIPPED,"'",
                         " '",tm.a CLIPPED,"'",
                        #" '",tm.e CLIPPED,"'",  #No.FUN-570082 #CHI-B50008 mark
                         " '",tm.yearstr CLIPPED,"'" ,
                         " '",g_rep_user CLIPPED,"'",           #No.FUN-570264
                         " '",g_rep_clas CLIPPED,"'",           #No.FUN-570264
                         " '",g_template CLIPPED,"'",           #No.FUN-570264
                         " '",g_rpt_name CLIPPED,"'"            #No.FUN-7C0078
         CALL cl_cmdat('aimr800',g_time,l_cmd)
      END IF
      CLOSE WINDOW r800_w
      CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690115 BY dxfwo 
      EXIT PROGRAM
...
#         l_time    LIKE type_file.chr8     #No.FUN-6A0074
         #l_sql     LIKE type_file.chr1000, # RDSQL STATEMENT  #No.FUN-690026 VARCHAR(1000)  #MOD-C20122
          l_sql     STRING,                 #MOD-C20122
          l_za05    LIKE za_file.za05,      #No.FUN-690026 VARCHAR(40)
          l_stkbno  LIKE pia_file.pia01,
          l_stkeno  LIKE pia_file.pia01,
         #l_gfe03   LIKE gfe_file.gfe03,    #FUN-710084   #MOD-A30152 mark
          sr        RECORD
                    stat   LIKE type_file.chr1,    #No.FUN-570082  0.原來 1.多單位  #No.FUN-690026 VARCHAR(1) 2.批序號 3.刻號/BIN
                    ...
                    ima021 LIKE ima_file.ima021    #CHI-B60076 add
                    END RECORD
   DEFINE l_ima906  LIKE ima_file.ima906 #CHI-B50008 add
   DEFINE l_piad RECORD LIKE piad_file.* #FUN-B70032
#No.TQC-C20047 ----- mark ----- begin
...
#No.TQC-C20047 ----- mark -----end
   ...
   LET g_sql = "INSERT INTO ",g_cr_db_str CLIPPED,l_table CLIPPED,  #TQC-A50009 mod
               " VALUES(?,?,?,?,?, ?,?,?,?,?, ?,?,?,? )"  #FUN-860001  #MOD-A30152 remove ?    #CHI-B60076 add ?  #No.TQC-C10034 add 4? #No.TQC-C20047 del 4?
   PREPARE insert_prep FROM g_sql 
   ...
   CALL cl_del_data(l_table1)       #FUN-B70032
   SELECT zo02 INTO g_company FROM zo_file WHERE zo01 = g_rlang
   SELECT zz17,zz05 INTO g_len,g_zz05 FROM zz_file WHERE zz01 = 'aimr800'
 #FUN-710084  --begin
 # IF g_len = 0 OR g_len IS NULL THEN LET g_len = 80 END IF
 # FOR g_i = 1 TO g_len LET g_dash[g_i,g_i] = '=' END FOR
   LET l_sql = " SELECT 0,pia01,pia02,pia03,pia04,pia05,pia08,pia09,", #No.FUN-570082
               "        ima02,ima08,ima15,'','',ima021,ima906 ", #FUN-860001 #CHI-B50008 add ima906   #CHI-B60076 add ima021
...
#TQC-AC0207 --------------mark end--------------
   ...
   LET l_sql = " SELECT 1,piaa01,piaa02,piaa03,piaa04,piaa05,piaa08,piaa09,",
               "        ima02,ima08,ima15,'','' ,ima021,ima906 ", #CHI-B50008 add ima906 #CHI-B60076 add ima021
...
#TQC-AC0207 ---------------- mark end-------------------------
   ...
   IF SQLCA.sqlcode != 0 THEN
      ...
      EXIT PROGRAM
   END IF
   DECLARE r800_cs1 CURSOR FOR r800_prepare1
   LET l_sql = " UPDATE piaa_file ",
               " SET piaa15=piaa15+1,",
               "     piaa14='",g_today,"' " ,
               " WHERE piaa01=? AND piaa09=?"
   PREPARE r800_up1 FROM l_sql
   IF SQLCA.sqlcode != 0 THEN
      CALL cl_err('prepare:',SQLCA.sqlcode,1) 
      CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690115 BY dxfwo 
      EXIT PROGRAM
   ...
   LET l_sql = " SELECT 2,pias01,pias02,pias03,pias04,pias05,pias09,pias10,",
               "        ima02,ima08,ima15,pias06,pias07,ima021 ",   #CHI-B60076 add ima021
...
#TQC-AC0207 ------------mark end---------------------------------
   ...
   PREPARE r800_prepare3 FROM l_sql
   IF SQLCA.sqlcode != 0 THEN
      CALL cl_err('prepare3:',SQLCA.sqlcode,1) 
      CALL cl_used(g_prog,g_time,2) RETURNING g_time 
      EXIT PROGRAM
   END IF
   DECLARE r800_cs3 CURSOR FOR r800_prepare3   
   #FUN-B70032 --END-
 
 # CALL cl_outnam('aimr800') RETURNING l_name
   LET l_sql = " UPDATE pia_file ",
               " SET pia15=pia15+1,",
               "     pia14='",g_today,"' " ,
               " WHERE pia01=? "
   PREPARE r800_up FROM l_sql
   IF SQLCA.sqlcode != 0 THEN
      CALL cl_err('prepare:',SQLCA.sqlcode,1) 
      CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690115 BY dxfwo 
      EXIT PROGRAM
 ...
 # LET g_pageno = 0
   ...
   FOREACH r800_cs INTO sr.*,l_ima906 #CHI-B50008 add l_ima906
      IF SQLCA.sqlcode != 0 THEN
         CALL cl_err('foreach:',SQLCA.sqlcode,1) EXIT FOREACH
      END IF
     #SELECT gfe03 INTO l_gfe03 FROM gfe_file WHERE gfe01=sr.pia09   #MOD-A30152 mark
      IF l_ima906 MATCHES '[13]' THEN #CHI-B50008 add
         #更新列印次數及列印日期
         EXECUTE r800_up  USING sr.pia01
         EXECUTE insert_prep USING
          ...
          #sr.ima08,sr.ima15,sr.stat,l_gfe03,' ',' '    #FUN-860001  #MOD-A30152 mark
           sr.ima08,sr.ima15,sr.stat,' ',' ',sr.ima021  #FUN-860001  #MOD-A30152        #CHI-B60076 add sr.ima021
#          "",  l_img_blob,   "N",""      #No.TQC-C10034 add #No.TQC-C20047 mark
      END IF #CHI-B50008 add
 #    OUTPUT TO REPORT r800_rep(sr.*)
   END FOREACH
 
   #No.FUN-570082  --begin
  #IF g_sma.sma115='Y' AND tm.e='Y' THEN #CHI-B50008 mark
   IF g_sma.sma115='Y' THEN #CHI-B50008 
      FOREACH r800_cs1 INTO sr.*,l_ima906 #CHI-B50008 add l_ima906
         IF SQLCA.sqlcode != 0 THEN
            CALL cl_err('foreach:',SQLCA.sqlcode,1) EXIT FOREACH
         END IF
        #SELECT gfe03 INTO l_gfe03 FROM gfe_file WHERE gfe01=sr.pia09   #MOD-A30152 mark
         IF l_ima906 = '2' THEN #CHI-B50008 add
            #更新列印次數及列印日期
            EXECUTE r800_up1  USING sr.pia01,sr.pia09
            EXECUTE insert_prep USING
              sr.pia01,sr.pia02,sr.pia03,sr.pia04,
              sr.pia05,sr.pia08,sr.pia09,sr.ima02,
             #sr.ima08,sr.ima15,sr.stat,l_gfe03,' ',' '   #FUN-860001  #MOD-A30152 mark
        ...
        #SELECT gfe03 INTO l_gfe03 FROM gfe_file WHERE gfe01=sr.pia09   #MOD-A30152 mark
         EXECUTE insert_prep USING
          ...
          #sr.ima08,sr.ima15,sr.stat,l_gfe03,   #MOD-A30152 mark
           ...
           sr.pias06,sr.pias07,sr.ima021        #FUN-860001        #CHI-B60076 add sr.ima021
#          ,"",  l_img_blob,   "N",""      #No.TQC-C10034 add #No.TQC-C20047 mark
 #       OUTPUT TO REPORT r800_rep(sr.*)
      END FOREACH
   END IF
 ...
 # LET l_sql = "SELECT * FROM ",l_table CLIPPED  #TQC-730088
  ...
  #LET l_sql = "SELECT * FROM ",l_table CLIPPED
   LET l_sql = "SELECT * FROM ",g_cr_db_str CLIPPED,l_table CLIPPED, "|",
               "SELECT * FROM ",g_cr_db_str CLIPPED, l_table1 CLIPPED,"|"   #FUN-B70032
  #---------------------No.MOD-930047 end
   CALL cl_replace_str(tm.wc,"piad","pia") RETURNING tm.wc     #TQC-AC0207 #FUN-B70032 
   #LET g_str = tm.wc,";",tm.code,";",tm.size,";",tm.yearstr,";",tm.a,";",g_sma.sma888   #TQC-AC0207 add tm.wc #MOD-BC0244 mark
    LET g_str = tm.code,";",tm.size,";",tm.yearstr,";",tm.a,";",g_sma.sma888,";",tm.f    #MOD-BC0244 add
#No.TQC-C20047 ----- mark ----- begin
#  LET g_cr_table = l_table                 #主報表的temp table名稱        #No.TQC-C10034 add
#  LET g_cr_apr_key_f = "pia01"       #報表主鍵欄位名稱，用"|"隔開   #No.TQC-C10034 add
#No.TQC-C20047 ----- mark ----- end
 # CALL cl_prt_cs3('aimr800',l_sql,g_str)    #TQC-730088
   CALL cl_prt_cs3('aimr800','aimr800',l_sql,g_str) 
