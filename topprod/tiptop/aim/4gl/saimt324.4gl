...
# Modify.........: No:FUN-D50028 13/05/10 By fengmy 增加數量欄位小數取位
...
# Modify.........: No:2021112401 21/11/24 By jc 自动审核扣账调整
...
#FUN-D50028--add--start--
DEFINE g_imn09_t            LIKE imn_file.imn09
DEFINE g_imn20_t            LIKE imn_file.imn20
...
#FUN-BC0036 --END mark--
  ...
  #FUN-C30140---mod---end---
   ...
   LET g_bgjob=ARG_VAL(5)   #2021112401 add
   ...
   WHILE TRUE
      ...
      CASE g_action_choice
         ...
         WHEN "confirm"
            IF cl_chk_act_auth() THEN
                LET l_x3 = '96230'
               select db INTO l_x3 from xyb_s012 a,(select ima06 from ima_file where ima01 = g_imn[l_ac].imn03) b where a.fqm = b.ima06 and g_imn[l_ac].imn04 = d.ck and g_imn[l_ac].imn15 = d.ck2
               select count(*) INTO l_x2 from imn_file c,(select * from xyb_s012 a,(select ima06 from ima_file where ima01 = g_imn[l_ac].imn03) b where a.fqm = b.ima06) d where c.imn03 = g_imn[l_ac].imn03 and c.imn04 = d.ck and c.imn15 = d.ck2
              #CALL t324_y_chk()              #FUN-A60034 mark
              CALL t324sub_y_chk(g_imm.imm01)     #CALL 原確認的 check 段                 #FUN-A60034 add
               IF g_success = "Y" THEN
                IF (l_x3 <> '96230') THEN 
...
#FUN-AB0025 --------------------mark---------------------------------------
    ...
    FOREACH t324_g2_c INTO l_img.*
       ...
       LET b_imn.imn32 = s_digqty(b_imn.imn32,b_imn.imn30)  #FUN-D50028
       #Unit 2
...
#---------------------destination-------------------------
      ...
      #str MOD-A70117 add
       ...
       LET b_imn.imn42 = s_digqty(b_imn.imn42,b_imn.imn40)  #FUN-D50028
       LET b_imn.imn51 = 1
    ...
    INPUT ARRAY g_imn WITHOUT DEFAULTS FROM s_imn.*
        ...
        BEFORE ROW
            ...
            IF g_rec_b >= l_ac THEN
                ...
                #FUN-D50028--begin
                LET g_imn09_t = g_imn[l_ac].imn09
                LET g_imn20_t = g_imn[l_ac].imn20
...
#FUN-B90035 -------------------End---------------------
        ...
        AFTER FIELD imn33  #第二單位
           ...
           LET g_imn33_t=g_imn_t.imn33  #FUN-D50028
        ...
        AFTER FIELD imn35  #第二數量
           IF NOT cl_null(g_imn[l_ac].imn35) THEN
              #FUN-D50028--begin
              IF NOT cl_null(g_imn[l_ac].imn33) THEN
                 IF cl_null(g_imn33_t) OR cl_null(g_imn_t.imn35) OR g_imn33_t != g_imn[l_ac].imn33 OR g_imn_t.imn35 != g_imn[l_ac].imn35 THEN
       ...
       AFTER FIELD imn10  #調撥數量
           IF NOT cl_null(g_imn[l_ac].imn10) THEN
              ...
              IF NOT cl_null(g_imn[l_ac].imn09) THEN
                 IF cl_null(g_imn09_t) OR cl_null(g_imn_t.imn10) OR g_imn09_t != g_imn[l_ac].imn09 OR g_imn_t.imn10 != g_imn[l_ac].imn10 THEN
  ...
  #MOD-CA0009---mark---E
   ...
   IF g_sma.sma115 = 'Y' AND l_ima906 != '2' THEN
      ...
      IF l_ima906='3' THEN
         ...
         LET g_imn[l_ac].imn42=s_digqty(g_imn[l_ac].imn42, g_imn[l_ac].imn40)  #FUN-D50028
      END IF
     #MOD-CB0118 str add---
