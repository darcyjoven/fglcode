...
GLOBALS "../../axm/4gl/s_slk.global"   #FUN-C20101-----ADD---
...
#FUN-C20101----ADD---STR----
DEFINE g_inbslk      DYNAMIC ARRAY OF RECORD
                  inbslk03 LIKE inbslk_file.inbslk03,
                  inbslk04 LIKE inbslk_file.inbslk04,
                  ima02    LIKE ima_file.ima02,
                  inbslk05 LIKE inbslk_file.inbslk05,
                  inbslk06 LIKE inbslk_file.inbslk06,
                  inbslk07 LIKE inbslk_file.inbslk07,
                  inbslk08 LIKE inbslk_file.inbslk08,
                  inbslk08_fac LIKE inbslk_file.inbslk08_fac,
                  inbslk09 LIKE inbslk_file.inbslk09,
                  inbslk15 LIKE inbslk_file.inbslk15
                     END RECORD
DEFINE g_inbslk_t    RECORD
                  inbslk03 LIKE inbslk_file.inbslk03,
                  inbslk04 LIKE inbslk_file.inbslk04,
                  ima02    LIKE ima_file.ima02,
                  inbslk05 LIKE inbslk_file.inbslk05,
                  ...
                  inbslk15 LIKE inbslk_file.inbslk15
                     END RECORD
DEFINE g_inbslk_o RECORD LIKE inbslk_file.*
DEFINE g_inbslk2  RECORD LIKE inbslk_file.*
DEFINE b_inbslk   RECORD LIKE inbslk_file.*
DEFINE l_ac2      LIKE type_file.num10,
       l_ac3      LIKE type_file.num10,
       g_rec_b2   LIKE type_file.num10,
       g_rec_b3   LIKE type_file.num10,
       g_wc3       STRING
DEFINE g_inbslk04 LIKE inbslk_file.inbslk04
DEFINE g_inbslk08_t LIKE inbslk_file.inbslk08
...
#    CALL cl_set_act_visible("controlb",FALSE) #FUN-C60100--MARK--
    CALL cl_set_act_visible("controlb",FALSE) #FUN-C60100--ADD--
...
#FUN-C20101-----ADD-----END-------                
    ...
    END IF
#FUN-C20101-----ADD------STR----
    CALL cl_set_comp_visible("inbud01,inbud02,inbud03,inbud04,inbud05,inbud06,inbud07,inbud08,                              inbud09,inbud10,inbud11,inbud12,inbud13,inbud14,inbud15",FALSE)
#FUN-C20101----END-------
    CALL t370_menu()
END FUNCTION
...
#FUN-C20101-----ADD----STR-----
       DIALOG ATTRIBUTE(UNBUFFERED)  
          ...
          CONSTRUCT g_wc3 ON inbslk03,inbslk04,inbslk05,inbslk06,inbslk07,inbslk08,
                             inbslk08_fac,inbslk09,inbslk15
                FROM s_inbslk[1].inbslk03,s_inbslk[1].inbslk04,s_inbslk[1].inbslk05,
                     s_inbslk[1].inbslk06,s_inbslk[1].inbslk07,s_inbslk[1].inbslk08,
                     s_inbslk[1].inbslk08_fac,s_inbslk[1].inbslk09,s_inbslk[1].inbslk15
              BEFORE CONSTRUCT
                 CALL cl_qbe_init()
          END CONSTRUCT
...
#FUN-BC0104-----------add------------end------------------
                 ...
                 WHEN INFIELD(inb911) OR INFIELD(inb912) #查詢訂單單號、項次
                    ...
                    NEXT FIELD inb911
                  WHEN INFIELD(inbslk04)
                     CALL q_sel_ima( TRUE, "q_ima","","","","","","","",'')  RETURNING  g_qryparam.multiret
                     DISPLAY g_qryparam.multiret TO inbslk04
                     NEXT FIELD inbslk04

                  WHEN INFIELD(inbslk05)
                     CALL q_imd_1(TRUE,TRUE,"","","","","") RETURNING g_qryparam.multiret 
                     DISPLAY g_qryparam.multiret TO inbslk05
                     NEXT FIELD inbslk05
 
                  WHEN INFIELD(inblk08)
                     CALL cl_init_qry_var()
                     LET g_qryparam.form ="q_gfe"
                     LET g_qryparam.default1 = g_inbslk[1].inbslk08
                     LET g_qryparam.state = "c"
                     CALL cl_create_qry() RETURNING g_qryparam.multiret
                     DISPLAY g_qryparam.multiret TO inbslk08
                     NEXT FIELD inbslk08
                  WHEN INFIELD(inbslk15)
                    IF g_sma.sma79='Y' THEN
                       CALL cl_init_qry_var()
                       LET g_qryparam.form ="q_azf06"                      #MOD-C70176  q_azf->q_azf06
                       LET g_qryparam.default1 = g_inbslk[1].inbslk15,'A2'
                    ...
                    ELSE
                       ...
                       LET g_qryparam.default1 = g_inbslk[1].inbslk15,'2'
                       LET g_qryparam.arg1 = "4"
                       LET g_qryparam.state = "c"
                       CALL cl_create_qry() RETURNING g_qryparam.multiret
                    END IF
                    DISPLAY g_qryparam.multiret TO inbslk15
                    NEXT FIELD inbslk15   
               END CASE
...
#FUN-C20101----ADD---STR-------
       IF g_wc3<>" 1=1" AND (NOT cl_null(g_wc3))  THEN
          LET g_sql = " SELECT UNIQUE ina01 FROM ina_file,inbslk_file ",
                      "  WHERE ",g_wc CLIPPED," AND ",g_wc3 CLIPPED,
                      "    AND ina01=inbslk01",
                      "    AND inaplant IN ",g_auth,
                      "   ORDER BY ina01"
       END IF                
#FUN-C20101----ADD---END-------                   
    ELSE					# 若單身有輸入條件
       LET g_sql = "SELECT UNIQUE ina_file. ina01 ",
                   ...
                   " ORDER BY ina01"
      #FUN-B30187 --START--
       IF g_wc2.getindexof('inbi',1)>0 THEN
          LET g_sql = "SELECT UNIQUE ina_file.ina01 ",
                      " FROM ina_file, inb_file, inbi_file",
                      " WHERE ina01 = inb01",
                      " AND inb01 = inbi01",           
                      " AND inb03 = inbi03",           
                      " AND inaplant = inbplant",           
                      " AND inaplant IN ",g_auth,           
                      " AND ", g_wc CLIPPED, " AND ",g_wc2 CLIPPED,
                      " ORDER BY ina01"
       END IF 
...
#FUN-C20101-------ADD-----STR-----
       IF g_wc3<>" 1=1" AND (NOT cl_null(g_wc3)) THEN
          LET g_sql = "SELECT UNIQUE ina_file.ina01 ",
                      "  FROM ina_file,inb_file,inbi_file,inbslk_file ",
                      " WHERE ina01=inb01 AND inb01=inbi01 AND inb03=inbi03 ",
                      "   AND inbi01=inbslk01 AND inbslk03=inbislk02",
                      "   AND inaplant = inbplant",
                      "   AND inaplant = inbslkplant ",
                      "   AND inaplant IN ",g_auth,
...
#FUN-C20101----ADD---STR-------
       IF g_wc3<>" 1=1" AND (NOT cl_null(g_wc3))  THEN
          LET g_sql = " SELECT COUNT(DISTINCT ina01) FROM ina_file,inbslk_file ",
                      "  WHERE ",g_wc CLIPPED," AND ",g_wc3 CLIPPED,
                      "    AND ina01=inbslk01",
                      "    AND inaplant IN ",g_auth,
                      "   ORDER BY ina01"
...
#FUN-C20101----ADD---END-------                  
    ...
    ELSE
        ...
        #FUN-B30187 --START--
        IF g_wc2.getindexof('inbi',1)>0 THEN
           LET g_sql="SELECT COUNT(DISTINCT ina01) FROM ina_file,inb_file,inbi_file WHERE ",
                     "inb01=ina01 ",
                     " AND inb01 = inbi01",
                     " AND inb03 = inbi03",
                     " AND inaplant = inbplant",           
...
#FUN-C20101-------ADD-----STR-----
      IF g_wc3<>" 1=1" AND (NOT cl_null(g_wc3)) THEN
         LET g_sql = "SELECT COUNT(DISTINCT ina01) ",
                     "  FROM ina_file,inb_file,inbi_file,inbslk_file ",
                     " WHERE ina01=inb01 AND inb01=inbi01 AND inb03=inbi03 ",
                     "   AND inbi01=inbslk01 AND inbslk03=inbislk02",
                     "   AND inaplant = inbplant",
         ...
         WHEN "easyflow_approval"     #FUN-550047
            IF cl_chk_act_auth() THEN
              #FUN-C20025 add str---
               ...
               CALL t370_show()
#FUN-C20101-----ADD------STR-------
               CALL t370_bslk_fill(' 1=1',' 1=1')
               CALL t370_b_fill2(' 1=1','1=1')
...
DEFINE l_where    STRING               #FUN-CB0087
  ...
  END IF                        #FUN-8C0024
    ...
    #FUN-B30187 --START--
    LET g_forupd_sql = " SELECT * FROM inbi_file ",
                          "  WHERE inbi01 = ? ",
                          "    AND inbi03 = ? ",
                          "    FOR UPDATE "
    LET g_forupd_sql = cl_forupd_sql(g_forupd_sql)
    DECLARE t370_bcl_ind CURSOR FROM g_forupd_sql
    #FUN-B30187 --END--

#FUN-C20101----ADD-----STR-----
    LET g_forupd_sql = " SELECT * FROM inbslk_file ",
                       "  WHERE inbslk01 = ? ",
                       "    AND inbslk03 = ? ",
                       "    FOR UPDATE "
    LET g_forupd_sql = cl_forupd_sql(g_forupd_sql)
    DECLARE t370_bcl_slk CURSOR FROM g_forupd_sql    
#FUN-C20101----ADD-----END-----
#FUN-C20101----ADD-----STR------
   IF g_rec_b2=0 THEN CALL g_inbslk.clear() END IF
   DIALOG ATTRIBUTE(UNBUFFERED)
 
    INPUT ARRAY g_inbslk  FROM s_inbslk.*
        ...
        BEFORE INPUT
           ...
           END IF
           CALL cl_set_comp_entry("inbslk03",FALSE)
           CALL cl_set_comp_entry("inbslk09,inbslk08",TRUE)   #MOD-C30217--add inbslk08
           CALL cl_set_comp_required("inbslk08",TRUE)         #MOD-C30217--add
        ...
        BEFORE ROW
            ...
            LET g_chr4  = '0'
            LET g_chr3  = '0'
            CALL s_settext_slk(g_inbslk[l_ac2].inbslk04)
            CALL s_fillimx_slk(g_inbslk[l_ac2].inbslk04,g_ina.ina01,g_inbslk[l_ac2].inbslk03)
            ...
            IF g_rec_b2 >= l_ac2 THEN
               LET p_cmd='u'
               LET g_inbslk_t.* = g_inbslk[l_ac2].*  #BACKUP
                
               OPEN t370_bcl_slk USING g_ina.ina01,g_inbslk_t.inbslk03
               IF STATUS THEN
                  CALL cl_err("OPEN t370_bcl_slk:", STATUS, 1)
                  LET l_lock_sw = "Y"
               ELSE
                  FETCH t370_bcl_slk INTO b_inbslk.*
                  IF SQLCA.sqlcode THEN
                      CALL cl_err('lock inbslk',SQLCA.sqlcode,1)
                      LET l_lock_sw = "Y"
                  ELSE
                     SELECT inbslk_file.* INTO b_inbslk.*
                       FROM inbslk_file
                      WHERE inbslk01=g_ina.ina01
                        AND inbslk03=g_inbslk_t.inbslk03  
                     CALL t370_b_move_to()
                      
                  END IF
               END IF
               
               CALL t370_set_no_required_inb07()
               CALL t370_set_required_inb07(p_cmd)
               CALL t370_set_entry_inb07()
               CALL t370_set_no_entry_inb07()
               SELECT ima151,imaag INTO l_ima151,l_imaag FROM ima_file WHERE ima01=g_inbslk[l_ac2].inbslk04
               IF (l_ima151='Y' OR (l_ima151='N' AND l_imaag= '@HILD')  ) THEN
                  CALL cl_set_comp_entry("inbslk09",FALSE)
               ELSE
                  CALL cl_set_comp_entry("inbslk09",TRUE)
               END IF    
        ...
        BEFORE INSERT
            ...
            INITIALIZE arr_detail[l_ac2].* TO NULL   #No.TQC-650108
             IF l_ac2 = 1 THEN
                INITIALIZE g_inbslk[l_ac2].* TO NULL
             ELSE
                LET g_inbslk[l_ac2].* = g_inbslk[l_ac2-1].*
                SELECT MAX(inbslk03)+1 INTO g_inbslk[l_ac2].inbslk03 FROM inbslk_file
                 WHERE inbslk01 = g_ina.ina01
                IF g_inbslk[l_ac2].inbslk03 IS NULL THEN
                   LET g_inbslk[l_ac2].inbslk03 = g_inbslk[l_ac2-1].inbslk03+1
                END IF
                LET g_inbslk[l_ac2].inbslk04=''   #MOD-A50129
                LET g_inbslk[l_ac2].ima02=''   #MOD-A50129
                LET g_change='Y'
             END IF
             LET l_ins_flag = 'Y'
             INITIALIZE b_inbslk.* TO NULL
             INITIALIZE g_inbslk_o.* TO NULL
             INITIALIZE g_inbslk_t.* TO NULL
             LET b_inbslk.inbslk01 = g_ina.ina01
             IF l_ac2 != 1 THEN 
                SELECT inbslk08 INTO b_inbslk.inbslk08 FROM inbslk_file
                  WHERE inbslk01 = g_ina.ina01 AND inbslk03 = g_inbslk[l_ac2-1].inbslk03
             END IF
             LET g_inbslk[l_ac2].inbslk09 = 0
             LET g_inbslk[l_ac2].inbslk08_fac=1
             
             LET g_inbslk_t.* = g_inbslk[l_ac2].*         #新輸入資料
            NEXT FIELD inbslk03
        ...
        AFTER INSERT            
            ...
            IF NOT cl_null(g_inbslk[l_ac2].inbslk04) THEN
               SELECT ima159 INTO l_ima159 FROM ima_file
                WHERE ima01 = g_inbslk[l_ac2].inbslk04
               IF l_ima159 = '1' AND cl_null(g_inbslk[l_ac2].inbslk07) THEN
                  CALL cl_err(g_inbslk[l_ac2].inbslk04,'aim-034',1)
                  NEXT FIELD inbslk07
               END IF
            END IF
            ...
            LET b_inbslk.inbslklegal = g_legal
            LET b_inbslk.inbslkplant = g_plant
            INSERT INTO inbslk_file VALUES(b_inbslk.*)
            IF SQLCA.sqlcode THEN
               CALL cl_err3("ins","inbslk_file","","",SQLCA.sqlcode,"",
                   "ins inbslk",1)
               ROLLBACK WORK 
               CANCEL INSERT
               SELECT ima918,ima921 INTO g_ima918,g_ima921
               ...
               IF g_ima918 = "Y" OR g_ima921 = "Y" THEN
                  IF g_ina.ina00 = "1" OR g_ina.ina00 = "2"
                     ...
                     IF NOT s_lot_del(g_prog,g_ina.ina01,g_inbslk[l_ac2].inbslk03,0,g_inbslk[l_ac2].inbslk04,'DEL') THEN
                        CALL cl_err3("del","rvbs_file",g_ina.ina01,g_inbslk_t.inbslk03,
                                      SQLCA.sqlcode,"","",1)
                        ROLLBACK WORK  
                        CANCEL INSERT
                     END IF
            ...
            ELSE 
               ...
               SELECT COUNT(*) INTO l_count
                 FROM inb_file,inbi_file
                WHERE inb01=inbi01
                  AND inb02=inbi02
                  AND inb01=g_ina.ina01
                  AND inbislk02=g_inbslk[l_ac2].inbslk03 
                 IF cl_null(l_count) THEN LET l_count=0 END IF

                 IF l_count=0 AND l_ima151<>'Y' AND (l_ima151<>'N' OR l_imaag<>'@CHILD' OR cl_null(l_imaag)) THEN
                    LET g_inb_slk.inb01 = g_ina.ina01
                    SELECT MAX(inb03) INTO l_n FROM inb_file WHERE inb01 = g_ina.ina01
                    IF cl_null(l_n) THEN
                       LET l_n = 0
                    END IF 
                    LET g_inb_slk.inb03 = l_n + 1
                    LET g_inb_slk.inb04 = g_inbslk[l_ac2].inbslk04  
                    CALL t370_inbslk_move()
                    INSERT INTO inb_file VALUES(g_inb_slk.*)
                    IF SQLCA.sqlcode THEN
                       CALL cl_err3("ins","inb_file",g_ina.ina01,g_inbslk[l_ac2].inbslk03,SQLCA.sqlcode,"","",1)
                       ROLLBACK WORK
                       CANCEL INSERT  
                    ELSE
                          
                       
                       LET g_inbi_slk.inbi01 = g_ina.ina01
                       LET g_inbi_slk.inbi03 = g_inb_slk.inb03
                       LET g_inbi_slk.inbislk01 = g_inbslk[l_ac2].inbslk04
                       LET g_inbi_slk.inbislk02 = g_inbslk[l_ac2].inbslk03
                       LET g_inbi_slk.inbiplant = g_plant
                       LET g_inbi_slk.inbilegal = g_legal
                       INSERT INTO inbi_file VALUES(g_inbi_slk.*)  
                       IF SQLCA.sqlcode THEN
                          CALL cl_err3("ins","inbi_file",g_ina.ina01,g_inbslk[l_ac2].inbslk03,SQLCA.sqlcode,"","",1)
                          ROLLBACK WORK
                          CANCEL INSERT   
                       END IF
                    END IF
...
##更改非子母数量---------------
                    IF l_ima151<>'Y' AND g_inbslk[l_ac2].inbslk09 != g_inbslk_t.inbslk09 THEN
                       IF cl_null(g_inbslk[l_ac2].inbslk09) THEN LET g_inbslk[l_ac2].inbslk09=0 END IF
                       UPDATE inb_file SET inb09=g_inbslk[l_ac2].inbslk09,
                                           inb16=g_inbslk[l_ac2].inbslk09
                        WHERE inb01=g_ina.ina01 AND inb04= g_inbslk[l_ac2].inbslk04                  

                       
                       CALL t370_update_inbslk()   #回寫母料件單身防止金額和數量出錯
                    END IF  
#                    DISPLAY g_rec_b2 TO FORMONLY.cn2
        ...
        BEFORE FIELD inbslk03                            #default 序號
           IF g_inbslk[l_ac2].inbslk03 IS NULL OR g_inbslk[l_ac2].inbslk03 = 0 THEN
              SELECT max(inbslk03)+1 INTO g_inbslk[l_ac2].inbslk03
                FROM inbslk_file WHERE inbslk01 = g_ina.ina01
              IF g_inbslk[l_ac2].inbslk03 IS NULL THEN
                 LET g_inbslk[l_ac2].inbslk03 = 1
              END IF
           END IF            
 
        AFTER FIELD inbslk03                        #check 序號是否重複
           IF g_inbslk[l_ac2].inbslk03 IS NULL THEN
              LET g_inbslk[l_ac2].inbslk03 = g_inbslk_t.inbslk03
           END IF
           IF g_inbslk[l_ac2].inbslk03=0 THEN
              CALL cl_err('','apm-422',1)
              LET g_inbslk[l_ac2].inbslk03 = g_inbslk_t.inbslk03
              NEXT FIELD inbslk03
           END IF
           IF NOT cl_null(g_inbslk[l_ac2].inbslk03) THEN
              IF g_inbslk[l_ac2].inbslk03 != g_inbslk_t.inbslk03 OR
                 g_inbslk_t.inbslk03 IS NULL THEN
                 LET g_inbi_slk.inbislk02=g_inbslk[l_ac2].inbslk03          
                 SELECT count(*) INTO l_n FROM inbslk_file
                  WHERE inbslk01 = g_ina.ina01 AND
                        inbslk03 = g_inbslk[l_ac2].inbslk03                  
                 IF l_n > 0 THEN
                    CALL cl_err('',-239,0)
                    LET g_inbslk[l_ac2].inbslk03 = g_inbslk_t.inbslk03
                    NEXT FIELD inbslk03
                 END IF
              END IF
              LET b_inbslk.inbslk03 = g_inbslk[l_ac2].inbslk03
              LET g_inbslk_o.inbslk03 = g_inbslk[l_ac2].inbslk03
           END IF
            
           
        BEFORE FIELD inbslk04
           CALL t370_set_no_required()
           CALL t370_set_no_required_inb07()
           CALL t370_set_entry_inb07()
           
        AFTER FIELD inbslk04

            IF NOT cl_null(g_inbslk[l_ac2].inbslk04) THEN
               
               IF (g_inbslk[l_ac2].inbslk04!=g_inbslk_t.inbslk04 OR g_inbslk_t.inbslk04 IS NULL) THEN
                  IF NOT s_chk_item_no(g_inbslk[l_ac2].inbslk04,"") THEN
                     CALL cl_err('',g_errno,1)
                     LET g_inbslk[l_ac2].inbslk04= g_inbslk_t.inbslk04
                     NEXT FIELD inbslk04
                  END IF
                  
                  SELECT COUNT(*) INTO g_cnt FROM ima_file 
                   WHERE ima01=g_inbslk[l_ac2].inbslk04 AND imaacti='Y'
                  IF cl_null(g_cnt) OR g_cnt=0 THEN
                     CALL cl_err('','mfg3403',1)
                     NEXT FIELD inbslk04
                  END IF
                  INITIALIZE l_ima151,l_imaag TO NULL
                  SELECT ima151,imaag INTO l_ima151,l_imaag
                    FROM ima_file
                   WHERE ima01=g_inbslk[l_ac2].inbslk04 AND imaacti='Y'
                  IF l_ima151='N' AND l_imaag='@CHILD' THEN
                     CALL cl_err('','aim1147',1)
                     NEXT FIELD inbslk04
                  END IF
                  IF (l_ima151='Y' OR (l_ima151='N' AND l_imaag= '@HILD')  ) THEN
                  ...
                  SELECT COUNT(*) INTO g_cnt FROM inbslk_file
                   WHERE inbslk04=g_inbslk[l_ac2].inbslk04 AND inbslk01=g_ina.ina01
                     AND inbslk03<>g_inbslk[l_ac2].inbslk03
                  ...
                  CALL s_settext_slk(g_inbslk[l_ac2].inbslk04)
                  CALL s_fillimx_slk(g_inbslk[l_ac2].inbslk04,
                                     g_ina.ina01,g_inbslk[l_ac2].inbslk03)
                  LET g_rec_b3 = g_imx.getLength()
               END IF
               SELECT ima02 INTO g_inbslk[l_ac2].ima02 FROM ima_file
                WHERE ima01=g_inbslk[l_ac2].inbslk04
               DISPLAY g_inbslk[l_ac2].ima02 TO ima02    
            END IF

           IF cl_null(g_inbslk[l_ac2].inbslk04) THEN
              LET g_errno = 'aap-099'
        ...
        AFTER FIELD inbslk05
           CASE t370_chk_inbslk05()
              WHEN "inbslk05" NEXT FIELD inbslk05
              WHEN "inbslk06" NEXT FIELD inbslk06
           END CASE
 
 
        AFTER FIELD inbslk06
            CASE t370_chk_inbslk06()
               WHEN "inbslk05" NEXT FIELD inbslk05
               WHEN "inbslk06" NEXT FIELD inbslk06
               WHEN "inbslk07" NEXT FIELD inbslk07
            END CASE
            ...
            IF NOT cl_null(g_inbslk[l_ac2].inbslk04) THEN
               SELECT ima159 INTO l_ima159 FROM ima_file
                WHERE ima01 = g_inbslk[l_ac2].inbslk04
               IF l_ima159 = '2' THEN
                  CASE t370_chk_inbslk07(p_cmd)
                     WHEN "inbslk04" NEXT FIELD inbslk04
                     WHEN "inbslk06" NEXT FIELD inbslk06
                     WHEN "inbslk07" NEXT FIELD inbslk06
                  END CASE
               END IF
               SELECT img04 INTO g_inbslk[l_ac2].inbslk07
                FROM  img_file
                WHERE img02=g_inbslk[l_ac2].inbslk05
                 AND img03=g_inbslk[l_ac2].inbslk06
            END IF

 
 
        AFTER FIELD inbslk07
	       CASE t370_chk_inbslk07(p_cmd)
	          WHEN "inbslk04" NEXT FIELD inbslk04
	          WHEN "inbslk06" NEXT FIELD inbslk06
	       END CASE
        ...
        AFTER FIELD inbslk08
           IF NOT t370_chk_inbslk08() THEN
              NEXT FIELD CURRENT
           END IF

           IF NOT cl_null(g_inbslk[l_ac2].inbslk08) THEN 
              IF NOT cl_null(g_inbslk[l_ac2].inbslk09) THEN
                 IF cl_null(g_inbslk08_t) OR g_inbslk08_t != g_inbslk[l_ac2].inbslk08 OR
                    cl_null(g_inbslk_t.inbslk09) OR g_inbslk_t.inbslk09 != g_inbslk[l_ac2].inbslk09 THEN
                    LET g_inbslk[l_ac2].inbslk09 = s_digqty(g_inbslk[l_ac2].inbslk09,g_inbslk[l_ac2].inbslk08)
                    DISPLAY BY NAME g_inbslk[l_ac2].inbslk09
                 END IF
              END IF
           END IF
           LET g_inbslk08_t = g_inbslk[l_ac2].inbslk08
 
        AFTER FIELD inbslk08_fac
           IF NOT cl_null(g_inbslk[l_ac2].inbslk08_fac) THEN
              IF g_inbslk[l_ac2].inbslk08_fac=0 THEN
                 NEXT FIELD inbslk08_fac
              END IF
           END IF
        BEFORE FIELD inbslk09
           SELECT ima151,imaag INTO l_ima151,l_imaag FROM ima_file WHERE ima01 = g_inbslk[l_ac2].inbslk04
           IF l_ima151= 'Y' OR (l_ima151='N' AND l_imaag='@CHILD') THEN
              CALL cl_set_comp_entry("inbslk09",FALSE)
           ELSE
              CALL cl_set_comp_entry("inbslk09",TRUE)
           END IF
 
        AFTER FIELD inbslk09
#MOD-C30217---add------------------
           IF g_inbslk[l_ac2].inbslk09 < 0 THEN
              CALL cl_err('','art-040',0)
              LET g_inbslk[l_ac2].inbslk09=g_inbslk_t.inbslk09
              NEXT FIELD inbslk09     
           END IF
#MOD-C30217---end------------------ 
           IF NOT t370_chk_inbslk09() THEN
              NEXT FIELD inbslk09 
           END IF
           

        AFTER FIELD inbslk15
           IF NOT t370_chk_inbslk15() THEN
              NEXT FIELD CURRENT 
           END IF
 
 
        BEFORE DELETE
           IF g_inbslk_t.inbslk03 > 0 AND g_inbslk_t.inbslk03 IS NOT NULL THEN
              ...
              CASE
                 ...
                 WHEN g_ina.ina00 MATCHES '[34]'    #入庫 
                   LET l_act = "2"
               END CASE
             DELETE FROM inbslk_file
              WHERE inbslk01=g_ina.ina01
                AND inbslk03=g_inbslk_t.inbslk03
             IF SQLCA.sqlcode THEN
                CALL cl_err3("del","inbslk_file",g_ina.ina01,g_inbslk_t.inbslk03,SQLCA.sqlcode,"","",1)  
                ROLLBACK WORK
                CANCEL DELETE
             END IF
             DELETE FROM inb_file
              WHERE inb01=g_ina.ina01
                AND inb03 IN ( SELECT inbi03 FROM inbi_file WHERE inbi01=g_ina.ina01
                                  AND inbislk02=g_inbslk_t.inbslk03) 
             IF SQLCA.sqlcode THEN
                CALL cl_err3("del","inb_file",g_ina.ina01,'',SQLCA.sqlcode,"","",1)  
                ROLLBACK WORK
                CANCEL DELETE
             END IF
             DELETE FROM inbi_file
              WHERE inbi01=g_ina.ina01
                AND inbislk02=g_inbslk_t.inbslk03             
             IF SQLCA.sqlcode THEN
                CALL cl_err3("del","inbi_file",g_ina.ina01,'',SQLCA.sqlcode,"","",1)  
                ROLLBACK WORK
                CANCEL DELETE
             END IF 
...
#             DISPLAY g_rec_b2 TO FORMONLY.cn2
         ...
         ON ROW CHANGE
	        ...
	        IF l_lock_sw = 'Y' THEN
               CALL cl_err(g_inbslk[l_ac2].inbslk03,-263,1)
               LET g_inbslk[l_ac2].* = g_inbslk_t.*
            ELSE
               SELECT inbslk.* INTO b_inbslk.* FROM inbslk_file
                WHERE inbslk01=g_ina.ina01 AND inbslk03=g_inbslk_t.inbslk03
               LET b_inbslk.inbslk01=g_ina.ina01
               LET b_inbslk.inbslk03=g_inbslk[l_ac2].inbslk03
               LET b_inbslk.inbslk04=g_inbslk[l_ac2].inbslk04
               LET b_inbslk.inbslk05=g_inbslk[l_ac2].inbslk05
               LET b_inbslk.inbslk06=g_inbslk[l_ac2].inbslk06
               LET b_inbslk.inbslk07=g_inbslk[l_ac2].inbslk07
               LET b_inbslk.inbslk08=g_inbslk[l_ac2].inbslk08
               LET b_inbslk.inbslk08_fac=g_inbslk[l_ac2].inbslk08_fac
               LET b_inbslk.inbslk15=g_inbslk[l_ac2].inbslk15 
               LET b_inbslk.inbslk09=g_inbslk[l_ac2].inbslk09
               SELECT ima151 INTO l_ima151 FROM ima_file WHERE ima01 = g_inbslk[l_ac2].inbslk04
               IF l_ima151='Y' THEN 
                  SELECT SUM(inb09) INTO g_inbslk[l_ac2].inbslk09 FROM inb_file
                   WHERE inb01=g_ina.ina01
                     AND inb03 IN (SELECT inbi03 FROM inbi_file WHERE inbi01=g_ina.ina01
                                      AND inbislk02=g_inbslk_t.inbslk03)
               END IF                       
               IF cl_null(b_inbslk.inbslk08_fac) THEN LET b_inbslk.inbslk08_fac=0 END IF
               IF cl_null(b_inbslk.inbslk09) THEN LET b_inbslk.inbslk09=0 END IF
               UPDATE inbslk_file SET *=b_inbslk.*
                WHERE inbslk01=g_ina.ina01
                  AND inbslk03=g_inbslk_t.inbslk03
               IF SQLCA.sqlcode THEN
                  CALL cl_err3("upd","inbslk_file",g_ina.ina01,g_inbslk_t.inbslk03,SQLCA.sqlcode,"","upd inbslk",1) 
                  LET g_inbslk[l_ac2].* = g_inbslk_t.*
                  LET g_success='N'
               ELSE 
                  IF g_inbslk[l_ac2].inbslk04 != g_inbslk_t.inbslk04 THEN 
                     DELETE FROM inb_file WHERE inb01=g_ina.ina01
                                            AND inb03 IN (SELECT inb03 FROM inb_file,inbi_file
                                                           WHERE inb01=inbi01 AND inb03=inbi03
                                                             AND inbi01=g_ina.ina01
                                                             AND inbislk01=g_inbslk_t.inbslk04
                                                             AND inbislk02=g_inbslk_t.inbslk03 )
                     DELETE FROM inbi_file WHERE inbi01=g_ina.ina01 AND inbislk01=g_inbslk_t.inbslk04
                                             AND inbislk02=g_inbslk_t.inbslk03
                     SELECT ima151,imaag INTO l_ima151,l_imaag FROM ima_file WHERE ima01 = g_inbslk[l_ac2].inbslk04
                     IF l_ima151<>'Y' AND (l_ima151<>'N' OR l_imaag<>'@CHILD' OR cl_null(l_imaag)) THEN   #非子、母料件
                        LET g_inb_slk.inb01 = g_ina.ina01
                        SELECT MAX(inb03) INTO l_n FROM inb_file WHERE inb01 = g_ina.ina01
                        IF cl_null(l_n) THEN
                           LET l_n = 0
                     ...
                     END IF  
                  ELSE
                     SELECT ima151,imaag INTO l_ima151,l_imaag FROM ima_file WHERE ima01 = g_inbslk_t.inbslk04
                             
                     IF l_ima151<>'Y' AND (l_ima151<>'N' OR l_imaag<>'@CHILD' OR cl_null(l_imaag)) THEN #        #非子、母料件
                        
                        UPDATE inb_file SET inb05  = g_inbslk[l_ac2].inbslk05,
                                            inb06  = g_inbslk[l_ac2].inbslk06,
                                            inb07  = g_inbslk[l_ac2].inbslk07,
                                            inb08  = g_inbslk[l_ac2].inbslk08,
                                            inb08_fac  = g_inbslk[l_ac2].inbslk08_fac,
                                            inb09  = g_inbslk[l_ac2].inbslk09,
                                            inb15  = g_inbslk[l_ac2].inbslk15,
                                            inb16  = g_inbslk[l_ac2].inbslk09
                                      WHERE inb01 = g_ina.ina01
                                        AND inb03 IN (SELECT inb03 FROM inb_file,inbi_file
                                                           WHERE inb01=inbi01
                     ...
                     ELSE
                        ...
                        WHERE inb01=g_ina.ina01 AND inb03 IN (SELECT inb03 FROM inb_file,inbi_file
                                                               WHERE inb01=inbi01 AND inb03=inbi03
                                                                AND inbi01=g_ina.ina01
                                                                AND inbislk01=g_inbslk[l_ac2].inbslk04
                                                                AND inbislk02=g_inbslk[l_ac2].inbslk03 )
               ...
               ELSE
                  ...
                  LET l_ina08 = '0'
                  COMMIT WORK
                  SELECT SUM(inb09) INTO l_count FROM inb_file WHERE inb01=g_ina.ina01
            ...
            IF INT_FLAG THEN
               ...
               LET INT_FLAG = 0
                 ...
                 IF g_ima918 = "Y" OR g_ima921 = "Y" THEN
                    ...
                    END IF
                    IF g_ina.ina00 = "3" OR g_ina.ina00 = "4" THEN
                       IF NOT s_lot_del(g_prog,g_ina.ina01,g_inbslk[l_ac2].inbslk03,0,g_inbslk[l_ac].inbslk04,'DEL') THEN
                          CALL cl_err3("del","rvbs_file",g_ina.ina01,g_inbslk_t.inbslk03,
                                        SQLCA.sqlcode,"","",1)
                       END IF
                    END IF
               ...
               ELSE
                  INITIALIZE g_inbslk[l_ac2].* TO NULL
                  CALL g_inbslk.deleteElement(l_ac2)
               END IF
               LET l_ina08 = g_ina.ina08  #FUN-C30293
               CLOSE t370_cl
               CLOSE t370_bcl_slk
        ...
        ON ACTION CONTROLO                        #沿用所有欄位
           IF INFIELD(inbslk03) AND l_ac2 > 1 THEN
              LET l_inb03_o=g_inbslk[l_ac2].inbslk03 
              LET g_inbslk[l_ac2].* = g_inbslk[l_ac2-1].*
              LET g_inbslk[l_ac2].inbslk03=l_inb03_o 
              NEXT FIELD inbslk03
           END IF
        ON ACTION controlp
           CASE
                ...
                WHEN INFIELD(inbslk04)
                     ...
                     CALL q_sel_ima(FALSE, "q_ima01_slk", "", g_inbslk[l_ac2].inbslk04, "", "", "", "" ,"",'' )  RETURNING g_inbslk[l_ac2].inbslk04 
                     DISPLAY BY NAME g_inbslk[l_ac2].inbslk04
                     NEXT FIELD inbslk04
                WHEN INFIELD(inbslk05)
                     CALL q_imd_1(FALSE,TRUE,g_inbslk[l_ac2].inbslk05,"","","","imd11='Y'") RETURNING g_inbslk[l_ac2].inbslk05
                     DISPLAY BY NAME g_inbslk[l_ac2].inbslk05
                     NEXT FIELD inbslk05
                WHEN INFIELD(inbslk06)
                     CALL q_ime_1(FALSE,TRUE,g_inbslk[l_ac2].inbslk06,g_inbslk[l_ac2].inbslk05,"","","","","") RETURNING g_inbslk[l_ac2].inbslk06
                     DISPLAY BY NAME g_inbslk[l_ac2].inbslk06
                     NEXT FIELD inbslk06
                WHEN INFIELD(inbslk07)
                     CALL cl_init_qry_var() 
                     LET g_qryparam.form ="q_img04"
                     LET g_qryparam.default1 = g_inbslk[l_ac2].inbslk07
#                     LET g_qryparam.where = "img02='",g_inbslk[l_ac2].inbslk05,"' AND img03='"g_inbslk[l_ac2].inbslk06,"'"
                     CALL cl_create_qry() RETURNING g_inbslk[l_ac2].inbslk07
                     DISPLAY BY NAME g_inbslk[l_ac2].inbslk07
                     NEXT FIELD inbslk07    
 
                WHEN INFIELD(inbslk08) #單位
                     CALL cl_init_qry_var()
                     LET g_qryparam.form ="q_gfe"
                     LET g_qryparam.default1 = g_inbslk[l_ac2].inbslk08
                     CALL cl_create_qry() RETURNING g_inbslk[l_ac2].inbslk08
                     DISPLAY BY NAME g_inbslk[l_ac2].inbslk08
                     NEXT FIELD inbslk08
 
                
 
                WHEN INFIELD(inbslk15)  #理由
                     ...
                     IF g_sma.sma79 = 'Y' AND l_ima15 = 'Y' THEN                                                                    
                        CALL cl_init_qry_var()
                        LET g_qryparam.form ="q_azf06"                      #MOD-C70176  q_azf->q_azf06
                        LET g_qryparam.default1 = g_inbslk[l_ac2].inbslk15
                       #LET g_qryparam.arg1 = "A2"                          #MOD-C70176 mark
                        CALL cl_create_qry() RETURNING g_inbslk[l_ac2].inbslk15
                     ELSE
                        CALL cl_init_qry_var()
                        LET g_qryparam.form ="q_azf01a"
                        LET g_qryparam.default1 = g_inbslk[l_ac2].inbslk15
                        ...
                        CALL cl_create_qry() RETURNING g_inbslk[l_ac2].inbslk15
                     END IF
                      DISPLAY BY NAME g_inbslk[l_ac2].inbslk15
                     NEXT FIELD inbslk15
        ...
        ON ACTION q_imd    #查詢倉庫
           CALL cl_init_qry_var()
           LET g_qryparam.form ="q_imd"
           LET g_qryparam.default1 = g_inbslk[l_ac2].inbslk05
           LET g_qryparam.arg1     = 'SW'        #倉庫類別
           LET g_qryparam.where    = " imd20='",g_inb_slk.inbplant CLIPPED,"'"   #MOD-C30390
           CALL cl_create_qry() RETURNING g_inbslk[l_ac2].inbslk05
           NEXT FIELD inbslk05
        ...
        ON ACTION q_ime    #查詢倉庫儲位
           ...
           LET g_qryparam.arg1     = 'SW'        #倉庫類別
           LET g_qryparam.default1 = g_inbslk[l_ac2].inbslk05
           LET g_qryparam.default2 = g_inbslk[l_ac2].inbslk06
           CALL cl_create_qry() RETURNING g_inbslk[l_ac2].inbslk05,g_inbslk[l_ac2].inbslk06 #MOD-4A0063
           NEXT FIELD inbslk05
        ...
        INPUT ARRAY g_imx FROM s_imx.*
          ...
          BEFORE INPUT
              ...
              IF STATUS THEN
                 ...
                 RETURN
              END IF
              FETCH t370_cl INTO g_ina.*               # 對DB鎖定
              IF SQLCA.sqlcode THEN
                 CALL cl_err(g_ina.ina01,SQLCA.sqlcode,0)
                 CLOSE t370_cl
                 ROLLBACK WORK
              ...
              OPEN t370_bcl_slk USING g_ina.ina01,g_inbslk[l_ac2].inbslk03
              IF STATUS THEN
                 CALL cl_err("OPEN t370_bcl_slk:", STATUS, 1)
                 CLOSE t370_bcl_slk
                 ROLLBACK WORK
                 RETURN
              END IF
              FETCH t370_bcl_slk INTO b_inbslk.*               # 對DB鎖定
              IF SQLCA.sqlcode THEN
                 CALL cl_err(g_ina.ina01,SQLCA.sqlcode,0)
                 CLOSE t370_bcl_slk
                 ROLLBACK WORK
          ...
          BEFORE ROW
             ...
             IF g_rec_b3 >= l_ac3 THEN
                LET p_cmd3='u'
                LET g_imx_t.* = g_imx[l_ac3].*  #BACKUP
             END IF
          ...
          AFTER FIELD imx01
             IF NOT cl_null(g_imx[l_ac3].imx01) THEN
                IF p_cmd3='a' OR (g_imx[l_ac3].imx01 !=g_imx_t.imx01 AND g_imx_t.imx01 IS NOT NULL) THEN
                   IF NOT t370_check_imx(1,g_imx[l_ac3].imx01,g_imx_t.imx01) THEN
                      LET g_imx[l_ac3].imx01 = g_imx_t.imx01
                      NEXT FIELD imx01
                   END IF
                   CALL s_chk_prod_strategy(l_ac3,1,g_inbslk[l_ac2].inbslk04,g_imx[l_ac3].imx01) RETURNING l_error,l_ima01
                ...
                END IF
             END IF
             IF cl_null(g_imx[l_ac3].imx01) THEN
          ...
          AFTER FIELD imx02
             IF NOT cl_null(g_imx[l_ac3].imx02) THEN
                IF p_cmd3='a' OR (g_imx[l_ac3].imx02 !=g_imx_t.imx02 AND g_imx_t.imx02 IS NOT NULL) THEN
                   IF NOT t370_check_imx(2,g_imx[l_ac3].imx02,g_imx_t.imx02) THEN
                      LET g_imx[l_ac3].imx02 = g_imx_t.imx02
                      NEXT FIELD imx02
                   END IF
                   CALL s_chk_prod_strategy(l_ac3,2,g_inbslk[l_ac2].inbslk04,g_imx[l_ac3].imx02) RETURNING l_error,l_ima01
                   IF NOT cl_null(l_error) THEN   #檢查商品策略 
                      CALL cl_err(l_ima01,l_error,0)
                      LET g_imx[l_ac3].imx02 = g_imx_t.imx02
                      NEXT FIELD imx02
                ...
                END IF
             END IF
             IF cl_null(g_imx[l_ac3].imx02) THEN
          ...
          AFTER FIELD imx03
             IF NOT cl_null(g_imx[l_ac3].imx03) THEN
                IF p_cmd3='a' OR (g_imx[l_ac3].imx03 !=g_imx_t.imx03 AND g_imx_t.imx03 IS NOT NULL) THEN
                   IF NOT t370_check_imx(3,g_imx[l_ac3].imx03,g_imx_t.imx03) THEN
                      LET g_imx[l_ac3].imx03 = g_imx_t.imx03
                      NEXT FIELD imx03
                   END IF
                   CALL s_chk_prod_strategy(l_ac3,3,g_inbslk[l_ac2].inbslk04,g_imx[l_ac3].imx03) RETURNING l_error,l_ima01
                   IF NOT cl_null(l_error) THEN   #檢查商品策略 
                      CALL cl_err(l_ima01,l_error,0)
                      LET g_imx[l_ac3].imx03 = g_imx_t.imx03
                      NEXT FIELD imx03
                ...
                END IF
             END IF
             IF cl_null(g_imx[l_ac3].imx03) THEN
          ...
          AFTER FIELD imx04
             IF NOT cl_null(g_imx[l_ac3].imx04) THEN
                IF p_cmd3='a' OR (g_imx[l_ac3].imx04 !=g_imx_t.imx04 AND g_imx_t.imx04 IS NOT NULL) THEN
                    IF NOT t370_check_imx(4,g_imx[l_ac3].imx04,g_imx_t.imx04) THEN
                       LET g_imx[l_ac3].imx04 = g_imx_t.imx04
                       NEXT FIELD imx04
                    END IF
                   CALL s_chk_prod_strategy(l_ac3,4,g_inbslk[l_ac2].inbslk04,g_imx[l_ac3].imx04) RETURNING l_error,l_ima01
                   IF NOT cl_null(l_error) THEN   #檢查商品策略 
                      CALL cl_err(l_ima01,l_error,0)
                      LET g_imx[l_ac3].imx04 = g_imx_t.imx04
                      NEXT FIELD imx04
                ...
                END IF
             END IF
             IF cl_null(g_imx[l_ac3].imx04) THEN
          ...
          AFTER FIELD imx05
             IF NOT cl_null(g_imx[l_ac3].imx05) THEN
                IF p_cmd3='a' OR (g_imx[l_ac3].imx05 !=g_imx_t.imx05 AND g_imx_t.imx05 IS NOT NULL) THEN
                   IF NOT t370_check_imx(5,g_imx[l_ac3].imx05,g_imx_t.imx05) THEN
                      LET g_imx[l_ac3].imx05 = g_imx_t.imx05
                      NEXT FIELD imx05
                   END IF
                   CALL s_chk_prod_strategy(l_ac3,5,g_inbslk[l_ac2].inbslk04,g_imx[l_ac3].imx05) RETURNING l_error,l_ima01
                   IF NOT cl_null(l_error) THEN   #檢查商品策略 
                      CALL cl_err(l_ima01,l_error,0)
                      LET g_imx[l_ac3].imx05 = g_imx_t.imx05
                      NEXT FIELD imx05
                ...
                END IF
             END IF
             IF cl_null(g_imx[l_ac3].imx05) THEN
          ...
          AFTER FIELD imx06
             IF NOT cl_null(g_imx[l_ac3].imx06) THEN
                IF p_cmd3='a' OR (g_imx[l_ac3].imx06 !=g_imx_t.imx06 AND g_imx_t.imx06 IS NOT NULL) THEN
                   IF NOT t370_check_imx(6,g_imx[l_ac3].imx06,g_imx_t.imx06) THEN
                      LET g_imx[l_ac3].imx06 = g_imx_t.imx06
                      NEXT FIELD imx06
                   END IF
                   CALL s_chk_prod_strategy(l_ac3,6,g_inbslk[l_ac2].inbslk04,g_imx[l_ac3].imx06) RETURNING l_error,l_ima01
                   IF NOT cl_null(l_error) THEN   #檢查商品策略 
                      CALL cl_err(l_ima01,l_error,0)
                      LET g_imx[l_ac3].imx06 = g_imx_t.imx06
                      NEXT FIELD imx06
                ...
                END IF
             END IF
             IF cl_null(g_imx[l_ac3].imx06) THEN
          ...
          AFTER FIELD imx07
             IF NOT cl_null(g_imx[l_ac3].imx07) THEN
                IF p_cmd3='a' OR (g_imx[l_ac3].imx07 !=g_imx_t.imx07 AND g_imx_t.imx07 IS NOT NULL) THEN
                   IF NOT t370_check_imx(7,g_imx[l_ac3].imx07,g_imx_t.imx07) THEN
                      LET g_imx[l_ac3].imx07 = g_imx_t.imx07
                      NEXT FIELD imx07
                   END IF
                   CALL s_chk_prod_strategy(l_ac3,7,g_inbslk[l_ac2].inbslk04,g_imx[l_ac3].imx07) RETURNING l_error,l_ima01
                   IF NOT cl_null(l_error) THEN   #檢查商品策略 
                      CALL cl_err(l_ima01,l_error,0)
                      LET g_imx[l_ac3].imx07 = g_imx_t.imx07
                      NEXT FIELD imx07
                ...
                END IF
             END IF
             IF cl_null(g_imx[l_ac3].imx07) THEN
          ...
          AFTER FIELD imx08
             IF NOT cl_null(g_imx[l_ac3].imx08) THEN
                IF p_cmd3='a' OR (g_imx[l_ac3].imx08 !=g_imx_t.imx08 AND g_imx_t.imx08 IS NOT NULL) THEN
                   IF NOT t370_check_imx(8,g_imx[l_ac3].imx08,g_imx_t.imx08) THEN
                      LET g_imx[l_ac3].imx08 = g_imx_t.imx08
                      NEXT FIELD imx08
                   END IF
                   CALL s_chk_prod_strategy(l_ac3,8,g_inbslk[l_ac2].inbslk04,g_imx[l_ac3].imx08) RETURNING l_error,l_ima01
                   IF NOT cl_null(l_error) THEN   #檢查商品策略 
                      CALL cl_err(l_ima01,l_error,0)
                      LET g_imx[l_ac3].imx08 = g_imx_t.imx08
                      NEXT FIELD imx08
                ...
                END IF
             END IF
             IF cl_null(g_imx[l_ac3].imx08) THEN
          ...
          AFTER FIELD imx09
             IF NOT cl_null(g_imx[l_ac3].imx09) THEN
                IF p_cmd3='a' OR (g_imx[l_ac3].imx09 !=g_imx_t.imx09 AND g_imx_t.imx09 IS NOT NULL) THEN
                   IF NOT t370_check_imx(9,g_imx[l_ac3].imx09,g_imx_t.imx09) THEN
                      LET g_imx[l_ac3].imx09 = g_imx_t.imx09
                      NEXT FIELD imx09
                   END IF
                   CALL s_chk_prod_strategy(l_ac3,9,g_inbslk[l_ac2].inbslk04,g_imx[l_ac3].imx09) RETURNING l_error,l_ima01
                   IF NOT cl_null(l_error) THEN   #檢查商品策略 
                      CALL cl_err(l_ima01,l_error,0)
                      LET g_imx[l_ac3].imx09 = g_imx_t.imx09
                      NEXT FIELD imx09
                ...
                END IF
             END IF
             IF cl_null(g_imx[l_ac3].imx09) THEN
          ...
          AFTER FIELD imx10
             IF NOT cl_null(g_imx[l_ac3].imx10) THEN
                IF p_cmd3='a' OR (g_imx[l_ac3].imx10 !=g_imx_t.imx10 AND g_imx_t.imx10 IS NOT NULL) THEN
                   IF NOT t370_check_imx(10,g_imx[l_ac3].imx10,g_imx_t.imx10) THEN
                      LET g_imx[l_ac3].imx10 = g_imx_t.imx10
                      NEXT FIELD imx10
                   END IF
                   CALL s_chk_prod_strategy(l_ac3,10,g_inbslk[l_ac2].inbslk04,g_imx[l_ac3].imx10) RETURNING l_error,l_ima01
                   IF NOT cl_null(l_error) THEN   #檢查商品策略 
                      CALL cl_err(l_ima01,l_error,0)
                      LET g_imx[l_ac3].imx10 = g_imx_t.imx10
                      NEXT FIELD imx10
                ...
                END IF
             END IF
             IF cl_null(g_imx[l_ac3].imx10) THEN
          ...
          AFTER FIELD imx11
             IF NOT cl_null(g_imx[l_ac3].imx11) THEN
                IF p_cmd3='a' OR (g_imx[l_ac3].imx11 !=g_imx_t.imx11 AND g_imx_t.imx11 IS NOT NULL) THEN
                   IF NOT t370_check_imx(11,g_imx[l_ac3].imx11,g_imx_t.imx11) THEN
                      LET g_imx[l_ac3].imx11 = g_imx_t.imx11
                      NEXT FIELD imx11
                   END IF
                   CALL s_chk_prod_strategy(l_ac3,11,g_inbslk[l_ac2].inbslk04,g_imx[l_ac3].imx11) RETURNING l_error,l_ima01
                   IF NOT cl_null(l_error) THEN   #檢查商品策略
                      CALL cl_err(l_ima01,l_error,0)
                      LET g_imx[l_ac3].imx11 = g_imx_t.imx11
                      NEXT FIELD imx11
                ...
                END IF
             END IF
             IF cl_null(g_imx[l_ac3].imx11) THEN
                LET g_imx[l_ac3].imx11=0
             END IF

          AFTER FIELD imx12
             IF NOT cl_null(g_imx[l_ac3].imx12) THEN
                IF p_cmd3='a' OR (g_imx[l_ac3].imx12 !=g_imx_t.imx12 AND g_imx_t.imx12 IS NOT NULL) THEN
                   IF NOT t370_check_imx(12,g_imx[l_ac3].imx12,g_imx_t.imx12) THEN
                      LET g_imx[l_ac3].imx12 = g_imx_t.imx12
                      NEXT FIELD imx12
                   END IF
                   CALL s_chk_prod_strategy(l_ac3,12,g_inbslk[l_ac2].inbslk04,g_imx[l_ac3].imx12) RETURNING l_error,l_ima01
                   IF NOT cl_null(l_error) THEN   #檢查商品策略
                      CALL cl_err(l_ima01,l_error,0)
                      LET g_imx[l_ac3].imx12 = g_imx_t.imx12
                      NEXT FIELD imx12
                ...
                END IF
             END IF
             IF cl_null(g_imx[l_ac3].imx12) THEN
                LET g_imx[l_ac3].imx12=0
             END IF

          AFTER FIELD imx13
             IF NOT cl_null(g_imx[l_ac3].imx13) THEN
                IF p_cmd3='a' OR (g_imx[l_ac3].imx13 !=g_imx_t.imx13 AND g_imx_t.imx13 IS NOT NULL) THEN
                   IF NOT t370_check_imx(13,g_imx[l_ac3].imx13,g_imx_t.imx13) THEN
                      LET g_imx[l_ac3].imx13 = g_imx_t.imx13
                      NEXT FIELD imx13
                   END IF
                   CALL s_chk_prod_strategy(l_ac3,13,g_inbslk[l_ac2].inbslk04,g_imx[l_ac3].imx13) RETURNING l_error,l_ima01
                   IF NOT cl_null(l_error) THEN   #檢查商品策略
                      CALL cl_err(l_ima01,l_error,0)
                      LET g_imx[l_ac3].imx13 = g_imx_t.imx13
                      NEXT FIELD imx13
                ...
                END IF
             END IF
             IF cl_null(g_imx[l_ac3].imx13) THEN
                LET g_imx[l_ac3].imx13=0
             END IF

          AFTER FIELD imx14
             IF NOT cl_null(g_imx[l_ac3].imx14) THEN
                IF p_cmd3='a' OR (g_imx[l_ac3].imx14 !=g_imx_t.imx14 AND g_imx_t.imx14 IS NOT NULL) THEN
                   IF NOT t370_check_imx(14,g_imx[l_ac3].imx14,g_imx_t.imx14) THEN
                      LET g_imx[l_ac3].imx14 = g_imx_t.imx14
                      NEXT FIELD imx14
                   END IF
                   CALL s_chk_prod_strategy(l_ac3,14,g_inbslk[l_ac2].inbslk04,g_imx[l_ac3].imx14) RETURNING l_error,l_ima01
                   IF NOT cl_null(l_error) THEN   #檢查商品策略
                      CALL cl_err(l_ima01,l_error,0)
                      LET g_imx[l_ac3].imx14 = g_imx_t.imx14
                      NEXT FIELD imx14
                ...
                END IF
             END IF
             IF cl_null(g_imx[l_ac3].imx14) THEN
                LET g_imx[l_ac3].imx14=0
             END IF

          AFTER FIELD imx15
             IF NOT cl_null(g_imx[l_ac3].imx15) THEN
                IF p_cmd3='a' OR (g_imx[l_ac3].imx15 !=g_imx_t.imx15 AND g_imx_t.imx15 IS NOT NULL) THEN
                   IF NOT t370_check_imx(15,g_imx[l_ac3].imx15,g_imx_t.imx15) THEN
                      LET g_imx[l_ac3].imx15 = g_imx_t.imx15
                      NEXT FIELD imx15
                   END IF
                   CALL s_chk_prod_strategy(l_ac3,15,g_inbslk[l_ac2].inbslk04,g_imx[l_ac3].imx15) RETURNING l_error,l_ima01
                   IF NOT cl_null(l_error) THEN   #檢查商品策略
                      CALL cl_err(l_ima01,l_error,0)
                      LET g_imx[l_ac3].imx15 = g_imx_t.imx15
                      NEXT FIELD imx15
                ...
                END IF
             END IF
             IF cl_null(g_imx[l_ac3].imx15) THEN
                LET g_imx[l_ac3].imx15=0
             END IF


          BEFORE DELETE
            IF NOT cl_null(g_imx_t.color) THEN    
               IF NOT cl_delb(0,0) THEN
                  CANCEL DELETE
               END IF
               CALL s_ins_slk('r',l_ac3,g_inbslk[l_ac2].inbslk04,
                              g_ina.ina01,g_inbslk[l_ac2].inbslk03)
               LET g_rec_b3=g_rec_b3-1
               CALL t370_update_inbslk()
               IF g_success = 'Y' THEN
                  COMMIT WORK
               ELSE
                  ROLLBACK WORK
...
#MOD-C30217------add---begin-----------------
             ...
             END IF
#MOD-C30217------end-------------------------
             CALL t370_inbslk_slk_move()
             CALL s_ins_slk('a',l_ac3,g_inbslk[l_ac2].inbslk04,
                            g_ina.ina01,g_inbslk[l_ac2].inbslk03)
             LET g_rec_b3=g_rec_b3+1
             CALL t370_update_inbslk()
             IF g_success = 'Y' THEN
          ...
          ON ROW CHANGE
             CALL t370_inbslk_slk_move()
             CALL s_ins_slk('u',l_ac3,g_inbslk[l_ac2].inbslk04,
                            g_ina.ina01,g_inbslk[l_ac2].inbslk03)
             CALL t370_update_inbslk()
...
FUNCTION t302_img()
   ...
   DEFINE l_inb07 LIKE inb_file.inb07
   DEFINE l_sql2  STRING
   DEFINE l_count LIKE type_file.num5

   LET l_sql2 = "SELECT inb01,inb03,inb04,inb05,inb06,inb07 ",
                "  FROM inb_file ",
                " WHERE inb01= '",g_ina.ina01,"' "
   PREPARE t302_pre FROM l_sql2
   DECLARE t302_cs CURSOR FOR t302_pre
   FOREACH t302_cs INTO l_inb01,l_inb03,l_inb04,l_inb05,l_inb06,l_inb07
      SELECT COUNT(*) INTO l_count FROM img_file
       WHERE img01=l_inb04 AND img02=l_inb05 AND img03=l_inb06
         AND img04=l_inb07
      IF cl_null(l_count) THEN LET l_count=0 END IF    
      IF l_count=0 THEN
         CALL t302_add_img(l_inb04,l_inb05,l_inb06,l_inb07,g_ina.ina01,l_inb03,g_ina.ina02)
      END IF
   END FOREACH
END FUNCTION
FUNCTION t302_add_img(p_img01,p_img02,p_img03,p_img04,p_img05,p_img06,p_date)
...
#FUN-A90049 --------------end-------------------------------------
   ...
   END IF
END FUNCTION   
FUNCTION t370_check_imx(p_index,p_qty,p_qty_t)
...
FUNCTION t370_update_inbslk()
   ...
   SELECT SUM(inb09)
     INTO l_inb09
     FROM inb_file,inbi_file
   WHERE inb01=inbi01 AND inb03=inbi03 AND inbislk02=g_inbslk[l_ac2].inbslk03 AND inb01=g_ina.ina01


   UPDATE inbslk_file SET inbslk09=l_inb09
     WHERE inbslk01=g_ina.ina01 AND inbslk03=g_inbslk[l_ac2].inbslk03
   IF SQLCA.sqlcode OR SQLCA.sqlerrd[3] = 0 THEN
      CALL cl_err3("upd","inbslk_file","","",SQLCA.sqlcode,"","",1)
   END IF
   LET g_inbslk[l_ac2].inbslk09=l_inb09
   DISPLAY ARRAY g_inbslk TO s_inbslk.* ATTRIBUTE(COUNT=g_rec_b2,UNBUFFERED)
           BEFORE DISPLAY
           EXIT DISPLAY
   END DISPLAY
END FUNCTION
FUNCTION t370_inbslk_slk_move()

   INITIALIZE g_inb_slk.* TO NULL
   LET g_inb_slk.inb01=g_ina.ina01
   LET g_inb_slk.inb05=g_inbslk[l_ac2].inbslk05
   LET g_inb_slk.inb06=g_inbslk[l_ac2].inbslk06
   LET g_inb_slk.inb07=g_inbslk[l_ac2].inbslk07
   LET g_inb_slk.inb08=g_inbslk[l_ac2].inbslk08
   LET g_inb_slk.inb08_fac=g_inbslk[l_ac2].inbslk08_fac
   LET g_inb_slk.inb15=g_inbslk[l_ac2].inbslk15
   LET g_inb_slk.inb10='N'
   LET g_inb_slk.inb11=' '
   LET g_inb_slk.inb12=' '
#  LET g_inb_slk.inb13=0    #FUN-BC0062 mark
   IF cl_null(g_inb_slk.inb13) THEN LET g_inb_slk.inb13 = 0 END IF  #FUN-BC0062
   LET g_inb_slk.inb14=0
   LET g_inb_slk.inb902=g_inbslk[l_ac2].inbslk08
   LET g_inb_slk.inb903=g_inbslk[l_ac2].inbslk08_fac
   LET g_inb_slk.inb910=''
   LET g_inb_slk.inb930=s_costcenter(g_ina.ina04)
#   LET g_inb_slk.inb922=g_inbslk[l_ac2].inbslk08
#   LET g_inb_slk.inb923=g_inbslk[l_ac2].inbslk08_fac
   LET g_inb_slk.inbplant=g_ina.inaplant
   LET g_inb_slk.inblegal=g_ina.inalegal 
   LET g_inbi_slk.inbiplant=g_ina.inaplant
   LET g_inbi_slk.inbilegal=g_ina.inalegal

END FUNCTION


FUNCTION t370_inbslk_move()
   ...
   LET g_inb_slk.inb08_fac=g_inbslk[l_ac2].inbslk08_fac
   LET g_inb_slk.inb15=g_inbslk[l_ac2].inbslk15
   LET g_inb_slk.inb09=g_inbslk[l_ac2].inbslk09
   LET g_inb_slk.inb15=g_inbslk[l_ac2].inbslk15
   LET g_inb_slk.inb16=g_inbslk[l_ac2].inbslk09
   LET g_inb_slk.inb10='N'
   LET g_inb_slk.inb11=' '
   LET g_inb_slk.inb12=' '
   LET g_inb_slk.inb13=0
   LET g_inb_slk.inb14=0
   LET g_inb_slk.inb902=g_inbslk[l_ac2].inbslk08
   LET g_inb_slk.inb903=g_inbslk[l_ac2].inbslk08_fac
   LET g_inb_slk.inb910=''
   LET g_inb_slk.inb904=g_inbslk[l_ac2].inbslk09
   LET g_inb_slk.inb930=s_costcenter(g_ina.ina04)
#   LET g_inb_slk.inb922=g_inbslk[l_ac2].inbslk08
#   LET g_inb_slk.inb923=g_inbslk[l_ac2].inbslk08_fac
   LET g_inb_slk.inbplant=g_ina.inaplant
   ...
   LET g_inbi_slk.inbiplant=g_ina.inaplant
   LET g_inbi_slk.inbilegal=g_ina.inalegal
   INITIALIZE g_inb_slk.inb912,g_inb_slk.inb45,g_inb_slk.inb47,g_inb_slk.inb48 TO NULL
   
END FUNCTION 

FUNCTION t370_chk_inbslk05()
DEFINE  l_inaplant   LIKE ina_file.inaplant 
   ...
   IF NOT cl_null(g_inbslk[l_ac2].inbslk05) THEN
      SELECT COUNT(*) INTO l_cn FROM imd_file WHERE imd01=g_inbslk[l_ac2].inbslk05
      IF l_cn=0 THEN
         CALL cl_err("","aim1149",1)
         RETURN "inbslk05"
      END IF 
      IF g_azw.azw04 = '2' THEN
         ...
         IF l_ima154 = 'Y' AND g_inbslk[l_ac2].inbslk04[1,4] <> 'MISC' THEN
            ...
            CALL s_get_defstore(g_plant,g_inbslk[l_ac2].inbslk04) RETURNING l_rtz07,l_rtz08   #FUN-C90049 add
      
            IF l_rcj03 = '1' THEN 
               IF g_inbslk[l_ac2].inbslk05 <> l_rtz07 THEN
                  CALL cl_err('','aim1142',0)
                  LET g_inbslk[l_ac2].inbslk05 = g_inbslk_t.inbslk05
                  RETURN "inbslk05"
               END IF
            ELSE
               IF g_inbslk[l_ac2].inbslk05 <> l_rtz08 THEN
         ...
         END IF
      END IF 
       IF NOT s_chk_ware(g_inbslk[l_ac2].inbslk05) THEN
          RETURN "inb05"
       END IF    
      IF g_inbslk_t.inbslk07 IS NULL OR g_inbslk_t.inbslk07 <> g_inbslk[l_ac2].inbslk07 THEN
         LET g_change='Y'
      END IF
      SELECT imd02 INTO g_buf FROM imd_file
       WHERE imd01=g_inbslk[l_ac2].inbslk05 AND imd10=g_imd10
          AND imdacti = 'Y'
      IF STATUS THEN
         LET g_errno = 'mfg1100'                   #FUN-B10016 add
         CALL cl_err3("sel","imd_file",g_inbslk[l_ac2].inbslk05,g_imd10,"mfg1100","",
                      "imd",1)
         RETURN "inbslk05"
      END IF
      SELECT imd20 INTO l_inaplant FROM imd_file
       WHERE imd01=g_inbslk[l_ac2].inbslk05
      IF l_inaplant <> g_ina.inaplant THEN
         LET g_errno = 'art-426'
         CALL cl_err(g_inbslk[l_ac2].inbslk05,"art-426",1)
         RETURN "inbslk05"
      END IF   
      LET g_cnt = 0
...
FUNCTION t370_chk_inbslk06()
   DEFINE l_cn LIKE type_file.num5
   LET g_errno = ' '

   #BugNo:5626 控管是否為全型空白
   IF g_inbslk[l_ac2].inbslk06 ='　' THEN #全型空白
       LET g_inbslk[l_ac2].inbslk06 =' '
   END IF
   IF g_inbslk[l_ac2].inbslk06 IS NULL THEN LET g_inbslk[l_ac2].inbslk06 =' ' END IF
   IF g_inbslk_t.inbslk06 IS NULL OR g_inbslk_t.inbslk06 <> g_inbslk[l_ac2].inbslk06 THEN
      LET g_change='Y'
   END IF
   #------------------------------------ 檢查料號預設倉儲及單別預設倉儲
   IF NOT cl_null(g_inbslk[l_ac2].inbslk05) THEN   #FUN-D20060 add
      IF NOT s_chksmz(g_inbslk[l_ac2].inbslk04, g_ina.ina01,
                      g_inbslk[l_ac2].inbslk05, g_inbslk[l_ac2].inbslk06) THEN
         RETURN "inbslk05"
      END IF
   END IF #FUN-D20060 add
   SELECT COUNT(*) INTO l_cn FROM ime_file
    WHERE ime01=g_inbslk[l_ac2].inbslk05 AND ime02=g_inbslk[l_ac2].inbslk06
   IF l_cn=0 THEN
      CALL cl_err("","aim1150",1)
      RETURN "inbslk06"
   END IF
...
FUNCTION t370_chk_inbslk07(p_cmd)
   DEFINE p_cmd LIKE type_file.chr1
 
   #BugNo:5626 控管是否為全型空白
   IF g_inbslk[l_ac2].inbslk07 ='　' THEN #全型空白
       LET g_inbslk[l_ac2].inbslk07 =' '
   END IF
   IF g_inbslk[l_ac2].inbslk07 IS NULL THEN LET g_inbslk[l_ac2].inbslk07 =' ' END IF
   IF g_inbslk_t.inbslk07 IS NULL OR g_inbslk_t.inbslk07 <> g_inbslk[l_ac2].inbslk07 THEN
      LET g_change='Y'
   END IF
#   IF NOT cl_null(g_inbslk[l_ac2].inbslk04) AND NOT cl_null(g_inbslk[l_ac2].inbslk05) THEN
...
FUNCTION t370_chk_inbslk08()
   IF NOT cl_null(g_inbslk[l_ac2].inbslk08) THEN
      SELECT gfe02 INTO g_buf FROM gfe_file
       WHERE gfe01=g_inbslk[l_ac2].inbslk08
      IF STATUS THEN
         CALL cl_err3("sel","gfe_file",g_inbslk[l_ac2].inbslk08,"",STATUS,"",
                      "gfe:",1)
         LET g_errno = STATUS                          #FUN-B10016 add
         RETURN FALSE
      END IF
...
FUNCTION t370_chk_inbslk09()
DEFINE 
       l_sql      STRING                                        
DEFINE l_inbslk09   LIKE inbslk_file.inbslk09,                                           
       l_inbslk03   LIKE inbslk_file.inbslk03,                                           
       l_qcs01   LIKE qcs_file.qcs01,                                           
       l_qcs02   LIKE qcs_file.qcs02,                                           
       l_qcs091c LIKE qcs_file.qcs091                                           
DEFINE l_bno     LIKE rvbs_file.rvbs08
   ...
   SELECT SUM(qcs091) INTO l_qcs091c
    ...
    WHERE qcs01 = g_ina.ina01         
      AND qcs02 = g_inbslk[l_ac2].inbslk03    
   IF g_inbslk[l_ac2].inbslk09 < l_qcs091c THEN
...
FUNCTION t370_chk_inbslk15()
   ...
   LET g_buf=NULL
   IF NOT cl_null(g_inbslk[l_ac2].inbslk15) THEN
      SELECT ima15 INTO l_ima15 FROM ima_file                                                                                       
       WHERE ima01 = g_inbslk[l_ac2].inbslk04                                                                                              
         AND imaacti = 'Y'                                                                                                          
      IF STATUS THEN                                                                                                                
         CALL cl_err3("sel","ima_file",g_inbslk[l_ac2].inbslk04,"",STATUS,"",                                                              
                      "select ima15",1) 
         LET g_errno = STATUS                                                                                           
         RETURN FALSE                                                                                                               
      END IF                                                                                                                        
      IF g_sma.sma79='Y' AND l_ima15 = 'Y' THEN        #使用保稅系統且為保稅料件                                                     
         IF cl_null(g_inbslk[l_ac2].inbslk15) THEN RETURN FALSE END IF
         SELECT azf03 INTO g_buf FROM azf_file
          WHERE azf01=g_inbslk[l_ac2].inbslk15 AND (azf02='A' OR azf02='2')
          IF STATUS THEN
             CALL cl_err3("sel","azf_file",g_inbslk[l_ac2].inbslk15,"",STATUS,"",
                          "select azf",1)
             LET g_errno = STATUS
             RETURN FALSE
          END IF
      ELSE
          SELECT azf03 INTO g_buf FROM azf_file
          WHERE azf01=g_inbslk[l_ac2].inbslk15 AND azf02='2'
          IF STATUS THEN
             CALL cl_err3("sel","azf_file",g_inbslk[l_ac2].inbslk15,"",STATUS,"",
                          "select azf",1)
             LET g_errno = STATUS
   ...
   SELECT azfacti INTO l_acti FROM azf_file WHERE azf01 = g_inbslk[l_ac2].inbslk15
                                              AND (azf02='A' OR azf02='2')
   IF l_acti <> 'Y' THEN
...
DEFINE l_n   LIKE type_file.num5
  ...
  IF g_ina.inaconf = 'Y' AND g_ina.inapost = 'N' THEN 
     ...
     CALL cl_set_comp_entry("inb03,inb911,inb912,inb04,inb08,inb08_fac,                            inb16,inb925,inb926,inb927,inb922,inb923,inb924,                            inb905,inb906,inb902,inb903,inb15,                            inb41,inb42,inb43,inb11,inb12,inb901,inb10,inb930,                            inb44,inb45,inb46,inb47,inb48",TRUE) #上段會將mark部分也視為欄位  #FUN-C20047 add inb44-48
     # -------MOD-BB0341 end-----------
  END IF
END FUNCTION
...
DEFINE l_ima15         LIKE ima_file.ima15    #No.CHI-950013       
   ...
   LET g_sql =
       ...
       "       inb15,' ',inb13,inb14,inb41,inb42,inb43,inb11,inb12,inb901,inb10,inb930,'', ",   #FUN-BC0062 add inb13,inb14
       "       inbud01,inbud02,inbud03,inbud04,inbud05,",
       "       inbud06,inbud07,inbud08,inbud09,inbud10,",
       "       inbud11,inbud12,inbud13,inbud14,inbud15,",
       "       inbiicd028,inbiicd029",
       " FROM inb_file LEFT OUTER JOIN ima_file ON inb04 = ima01 ",
       " LEFT OUTER JOIN inbi_file ON (inb01 = inbi01 AND inb03 = inbi03)",
...
#FUN-C20101-------ADD----STR------
FUNCTION t370_bslk_fill(p_wc2,p_wc3)
...
DEFINE l_ima15         LIKE ima_file.ima15       
   ...
   IF p_wc3=" 1=1" THEN 
      LET g_sql =
       ...
       "       inb16,inb925,inb926,inb927,inb922,inb923,inb924,",  
       "       inb09,inb905,inb906,inb907,inb902,inb903,inb904,",
       "       inb15,' ',inb13,inb14,inb41,inb42,inb43,inb11,inb12,inb901,inb10,inb930,'', ",  #MOD-C30217 add inb13,inb14
       "       inbud01,inbud02,inbud03,inbud04,inbud05,",
       "       inbud06,inbud07,inbud08,inbud09,inbud10,",
       "       inbud11,inbud12,inbud13,inbud14,inbud15,",
       "       inbiicd028,inbiicd029",
   ...
   ELSE     
      LET g_sql =
       ...
       "       inb16,inb925,inb926,inb927,inb922,inb923,inb924,",  
       "       inb09,inb905,inb906,inb907,inb902,inb903,inb904,",
       "       inb15,' ',inb41,inb42,inb43,inb11,inb12,inb901,inb10,inb930,'', ",
       "       inbud01,inbud02,inbud03,inbud04,inbud05,",
       "       inbud06,inbud07,inbud08,inbud09,inbud10,",
       "       inbud11,inbud12,inbud13,inbud14,inbud15,",
       "       inbiicd028,inbiicd029",
       "  FROM inb_file,ima_file,inbi_file,inbslk_file",
       " WHERE inb01=inbi01 AND inb03=inbi03 AND inb04=ima01",
       "   AND inbslk01=inbi01 AND inbslk03=inbislk02 ",
       " AND inb01 ='",g_ina.ina01,"'",  #單頭
       " AND ",p_wc2 CLIPPED," AND ",p_wc3 CLIPPED,              #單身
       " ORDER BY inb03"
   END IF     
   PREPARE t370_pb_slk FROM g_sql
   DECLARE inb_curs_slk CURSOR FOR t370_pb_slk
   DISPLAY "p_sql=",g_sql
   CALL g_inb.clear()
   LET g_cnt = 1
   FOREACH inb_curs_slk INTO g_inb[g_cnt].*   #單身 ARRAY 填充
      IF STATUS THEN
         CALL cl_err('foreach:',STATUS,1)
         EXIT FOREACH
      END IF
      SELECT ima021 INTO g_inb[g_cnt].ima021 FROM ima_file WHERE ima01=g_inb[g_cnt].inb04
      SELECT qcl02 INTO g_inb[g_cnt].qcl02 FROM qcl_file WHERE qcl01 = g_inb[g_cnt].inb46   #FUN-BC0104
      SELECT ima15 INTO l_ima15 FROM ima_file                                                                                      
       WHERE ima01 = g_inb[g_cnt].inb04 
       
      IF cl_null(l_ima15) THEN LET l_ima15='N' END IF
      IF g_sma.sma79 = 'Y' AND l_ima15 = 'Y' THEN                                                                                   
        SELECT DISTINCT(azf03) INTO g_inb[g_cnt].azf03 FROM azf_file
          WHERE (azf02='A' OR azf02 = '2') AND azf01=g_inb[g_cnt].inb15
      ELSE
        SELECT DISTINCT(azf03) INTO g_inb[g_cnt].azf03 FROM azf_file
          WHERE azf02='2' AND azf01=g_inb[g_cnt].inb15
      END IF
   ...
   DISPLAY g_rec_b TO FORMONLY.cn2
    ...
    LET g_sql = " SELECT rvbs02,rvbs021,ima02,ima021,rvbs022,rvbs04,rvbs03,rvbs05,rvbs06,rvbs07,rvbs08",
                "   FROM rvbs_file LEFT JOIN ima_file ON rvbs021 = ima01",
                "  WHERE rvbs00 = '",g_prog,"' AND rvbs01 = '",g_ina.ina01,"'"
    PREPARE sel_rvbs_pre_slk FROM g_sql
    DECLARE rvbs_curs_slk CURSOR FOR sel_rvbs_pre_slk

    CALL g_rvbs.clear()

    LET g_cnt = 1
    FOREACH rvbs_curs_slk INTO g_rvbs[g_cnt].*   #單身 ARRAY 填充
        IF STATUS THEN CALL cl_err('foreach:',STATUS,1) EXIT FOREACH END IF
        LET g_cnt = g_cnt + 1
        IF g_cnt > g_max_rec THEN
           CALL cl_err( '', 9035, 0 )
...
FUNCTION t370_b_fill2(p_wc3,p_wc2)
   DEFINE p_wc3    STRING,
          p_wc2    STRING,
          l_cnt    LIKE type_file.num5,
          l_count  LIKE pml_file.pml20

   IF cl_null(p_wc3) THEN
      LET p_wc3 = " 1=1"
   END IF
   IF cl_null(p_wc2) OR p_wc2 = " 1=1" THEN
      LET g_sql="SELECT DISTINCT inbslk03,inbslk04,'',inbslk05,inbslk06,inbslk07,",
                "       inbslk08,inbslk08_fac,inbslk09,inbslk15",
                "  FROM inbslk_file WHERE inbslk01='",g_ina.ina01,"'",
                "   AND ",p_wc3 CLIPPED,
                " ORDER BY inbslk03 " CLIPPED          
   ELSE
      LET g_sql="SELECT DISTINCT inbslk03,inbslk04,'',inbslk05,inbslk06,inbslk07,",
                "       inbslk08,inbslk08_fac,inbslk09,inbslk15",
                "  FROM inbslk_file,inb_file,inbi_file WHERE inbslk01='",g_ina.ina01,"'",
                "   AND inbi01 = inb01 AND inb03 = inbi03 AND inbi01 = inbslk01 ",
                "   AND inbslk03 = inbislk02 AND ",p_wc2 CLIPPED,
                "   AND ",p_wc3 CLIPPED,
                " ORDER BY inbslk03 " CLIPPED
   END IF   
   PREPARE t420_pp2 FROM g_sql
   DECLARE t420_cs3 CURSOR FOR t420_pp2
 
   CALL g_inbslk.clear()
   LET l_cnt=1
   FOREACH t420_cs3 INTO g_inbslk[l_cnt].*
   
      IF SQLCA.sqlcode THEN
         CALL cl_err('prepare2:',SQLCA.sqlcode,1) EXIT FOREACH
      END IF 
      SELECT ima02 INTO g_inbslk[l_cnt].ima02 FROM ima_file
       WHERE ima01=g_inbslk[l_cnt].inbslk04      
      LET l_cnt=l_cnt+1
      ...
      END IF
   END FOREACH
   CALL g_inbslk.deleteElement(l_cnt)
...
#FUN-C20101----ADD---STR--------
      DISPLAY ARRAY g_inbslk TO s_inbslk.*
         BEFORE DISPLAY
            CALL cl_navigator_setting( g_curs_index, g_row_count )
            CALL g_imx.clear()
            CALL t370_bslk_fill(g_wc2,g_wc2)
            CALL t370_b_fill2(g_wc3,g_wc2)
            LET g_action_choice=""
         ...
         BEFORE ROW
            ...
            END FOR
            LET l_ac2 = DIALOG.getCurrentRow("s_inbslk")
            IF l_ac2 != 0 THEN
               CALL s_settext_slk(g_inbslk[l_ac2].inbslk04)
               CALL s_fillimx_slk(g_inbslk[l_ac2].inbslk04,
                                   g_ina.ina01,g_inbslk[l_ac2].inbslk03)
...
FUNCTION t370_chkkey()
   ...
   #FUN-B30187 --START--
   ELSE 
      UPDATE inbi_file SET inbi01=g_ina.ina01
       WHERE inbi01=g_ina_t.ina01
      IF SQLCA.SQLCODE OR SQLCA.SQLERRD[3]=0 THEN
         CALL cl_err3("upd","inbi_file",g_ina_t.ina01,"",SQLCA.sqlcode,"",
                      "upd inbi01",1)  
         LET g_ina.*=g_ina_t.*
         CALL t370_show()
         ROLLBACK WORK
...
#FUN-C20101----ADD----STR----
   IF p_cmd='u' OR INFIELD(inbslk04) THEN
      IF NOT cl_null(g_inbslk[l_ac2].inbslk04) THEN
         SELECT ima159 INTO l_ima159 FROM ima_file
          WHERE ima01 = g_inbslk[l_ac2].inbslk04
         IF l_ima159 = '1' THEN
            IF cl_null(g_inbslk[l_ac2].inbslk07) THEN LET g_inbslk[l_ac2].inbslk07=NULL END IF
            CALL cl_set_comp_required("inbslk07",TRUE)
         END IF
      END IF
   END IF
#FUN-C20101----ADD endif----------   
...
#FUN-C20101---ADD---STR--
     CALL cl_set_comp_required("inbslk07",FALSE)
#FUN-C20101---add endif---------     
END FUNCTION
#FUN-A40022--end--add-----
...
#FUN-C20101----ADD---STR----
   CALL cl_set_comp_entry("inbslk07",TRUE)
#FUN-C20101----ADD endif------   
END FUNCTION
   ...
   IF l_ac2 > 0 THEN
      IF NOT cl_null(g_inbslk[l_ac2].inbslk04) THEN
         SELECT ima159 INTO l_ima159 FROM ima_file
          WHERE ima01 = g_inbslk[l_ac2].inbslk04
         IF l_ima159 = '2' THEN
            CALL cl_set_comp_entry("inbslk07",FALSE)
         ELSE
            CALL cl_set_comp_entry("inbslk07",TRUE)
         END IF
      END IF
...
#FUN-C20101----ADD----STR----
   CALL t370_bslk_fill(g_wc2,g_wc3)
   CALL t370_b_fill2(g_wc3,g_wc2)
#FUN-C20101---ADD endif------------   
   CALL cl_show_fld_cont()                   #No.FUN-550037 hmf
END FUNCTION
...
FUNCTION t370_r()
	...
	DELETE FROM ina_file WHERE ina01 = g_ina.ina01 
        ...
        END FOREACH
#FUN-C20101-----ADD------BEGIN------
        DELETE FROM inbslk_file WHERE inbslk01=g_ina.ina01
        IF SQLCA.sqlcode THEN
           CALL cl_err3("del","inbslk_file",g_ina.ina01,"",STATUS,"","",1)
           ROLLBACK WORK
           RETURN
        ELSE
           DELETE FROM inb_file WHERE inb01=g_ina.ina01
           DELETE FROM inbi_file WHERE inbi01=g_ina.ina01
           IF SQLCA.sqlcode THEN
              ROLLBACK WORK
              RETURN
           END IF 
...
#FUN-C20101----ADD  ENDIF---------        
        ...
        #FUN-BC0104-add-end--
        #FUN-B30187 --START--
        IF NOT s_del_inbi(g_ina.ina01,'','') THEN
           #不作處理        
        END IF
        #FUN-B30187 --END--
        LET g_msg=TIME
      ...
      IF NOT cl_null(g_inb[l_ac].inb927) THEN
         ...
         IF p_cmd = 'a' OR (p_cmd='u' AND g_inb[l_ac].inb924=0)  THEN  #MOD-D30154
            IF g_ima906='3' THEN  
               ...
               #MOD-D30154---begin
               ELSE
                  CALL s_du_umfchk(g_inb[l_ac].inb04,'','','',g_inb[l_ac].inb925,g_inb[l_ac].inb922,g_ima906)
...
FUNCTION t370_b_upd()
   ...
   END IF
   #FUN-B30187 --START--
   UPDATE inbi_file SET * = b_inbi.*
    WHERE inbi01=g_ina.ina01 AND inbi03=g_inb_t.inb03 
   IF SQLCA.sqlcode THEN
      CALL cl_err3("upd","inbi_file",g_ina.ina01,g_inb_t.inb03,SQLCA.sqlcode,"",
                   "upd inbi",1) 
      LET g_inb[l_ac].* = g_inb_t.*
      RETURN FALSE
   END IF
...
#FUN-C20101----ADD---STR---
   LET g_inbslk[l_ac2].inbslk03 = b_inbslk.inbslk03
   LET g_inbslk[l_ac2].inbslk04 = b_inbslk.inbslk04
   LET g_inbslk[l_ac2].inbslk05 = b_inbslk.inbslk05
   LET g_inbslk[l_ac2].inbslk06 = b_inbslk.inbslk06
   LET g_inbslk[l_ac2].inbslk07 = b_inbslk.inbslk07
   LET g_inbslk[l_ac2].inbslk08 = b_inbslk.inbslk08
   LET g_inbslk[l_ac2].inbslk08_fac = b_inbslk.inbslk08_fac
   LET g_inbslk[l_ac2].inbslk09 = b_inbslk.inbslk09
   LET g_inbslk[l_ac2].inbslk15 = b_inbslk.inbslk15
#FUN-C20101----ADD endif------------
END FUNCTION
...
#FUN-C20101-----ADD----STR------
   IF g_inbslk[l_ac2].inbslk05 IS NULL THEN LET g_inbslk[l_ac2].inbslk05 =' ' END IF
   IF g_inbslk[l_ac2].inbslk06 IS NULL THEN LET g_inbslk[l_ac2].inbslk06 =' ' END IF
   IF g_inbslk[l_ac2].inbslk07 IS NULL THEN LET g_inbslk[l_ac2].inbslk07 =' ' END IF
#FUN-C20101-------ADD---END------   
END FUNCTION
...
DEFINE p_type   LIKE type_file.chr1  #CHI-D20010
   ...
   #IF cl_void(0,0,g_ina.inaconf) THEN #FUN-660079 post->conf  #CHI-D20010
...
#FUN-C20101-----ADD----STR-----
   CASE
    WHEN g_ina.ina00 MATCHES '[1256]'  #出庫
      ...
      LET b_rvbs.rvbs02 = g_inbslk[l_ac2].inbslk03
      LET b_rvbs.rvbs021 = g_inbslk[l_ac2].inbslk04
      LET b_rvbs.rvbs06 = g_inbslk[l_ac2].inbslk09 * g_inbslk[l_ac2].inbslk08_fac  #數量*庫存單位換算率
      LET b_rvbs.rvbs08 = g_inbslk[l_ac2].ima02
      LET b_rvbs.rvbs09 = -1
...
#FUN-C20101----add---str--------
      ...
      IF SQLCA.sqlcode THEN
         ...
         RETURN 
      END IF  
      UPDATE x SET inbslk01=l_newno
      INSERT INTO inbslk_file SELECT * FROM x
      IF SQLCA.sqlcode THEN 
         CALL cl_err3("ins","inbslk_file","","",SQLCA.sqlcode,"","",1)
         LET g_success = 'N'
         RETURN
      END IF 
      DROP TABLE y
      ...
      IF SQLCA.sqlcode THEN
         ...
         RETURN
      END IF
      UPDATE z SET inbi01=l_newno
      INSERT INTO inbi_file SELECT * FROM z
      IF SQLCA.sqlcode THEN
         CALL cl_err3("ins","inbi_file","","",SQLCA.sqlcode,"","",1)
         LET g_success = 'N'
         RETURN
...
#FUN-C20101-----ADD--STR----
         DELETE FROM inb_file WHERE inb01 = g_ina.ina01
         DELETE FROM inbslk_file WHERE inbslk01=g_ina.ina01  #CHI-C80041
#FUN-C20101-----ADD--END-----
         INITIALIZE g_ina.* TO NULL
...
FUNCTION t370_list_fill()
  ...
  DEFINE l_i             LIKE type_file.num10
    ...
    CALL g_ina_l.clear()
    LET l_i = 1
    FOREACH t370_fill_cs INTO l_ina01
       IF SQLCA.sqlcode THEN
