...
MAIN
  ...
  #No.FUN-C80102 ---start--- Add
   ...
   CALL cl_set_comp_visible("oma54t_1,oma56t_1,oma55_1,oma57_1,sum_1_1,sum_2_1",FALSE)
  ...
  #No.FUN-C80102 ---end  --- Add
   ...
   #TQC-C30324 add
   CALL cl_set_comp_visible("sum1,sum2,sum3,sum4,sum5,sum6,sum7,sum8,sum9,sum10",FALSE)
...
DEFINE l_azi04   LIKE azi_file.azi04        #yinhy130619
  ...
  #FUN-CB0146--add--end
   ...
   LET g_tot51 = cl_digcut(g_tot41,g_azi04) 
   #No.yinhy130619  --End
...
FUNCTION q191_get_tmp()
   ...
   IF g_ooz.ooz07 = 'Y' THEN
      LET l_sql="UPDATE axrq191_tmp1 o",
               ...
               "                 OR (oox01 = '",l_year,"'"," AND oox02 <= '",l_month,"'))"     #MOD-D50237

      PREPARE upd_pr5 FROM l_sql
      EXECUTE upd_pr5
   END IF
   UPDATE axrq191_tmp1 SET net=0 WHERE net IS NULL OR net=' '
   ...
   CASE
      WHEN g_aza.aza19 = '1'            #取每月匯率 
         ...
         IF tm.a='1' THEN            
            LET l_sql=l_sql," AND n.azj02= YEAR(o.oma02)||MONTH(o.oma02) )"
         ELSE
            LET l_sql=l_sql," AND n.azj02= YEAR(o.alz07)||MONTH(o.alz07) )"
         END IF
