...
FUNCTION t400_g_b()                       #先由應收票據或TT自動產生借方單身
   ...
   #CALL t400_g_b2()   #mark by guanyao160826   不需要弹框，默认为0
...
#str-------mark by guanyao160826  #不需要开窗，默认为TT，及sw2 = 'Y'
...
#No.FUN-AB0034 --begin
            ...
            END IF
            IF cl_null(g_net) THEN LET g_net =0 END IF
            #IF (tot8+g_oob[l_ac].oob10) > l_omc.omc13-g_net  THEN  #mark by dengs170306
           IF (tot8+g_oob[l_ac].oob10) > l_omc.omc13  THEN  #add by dengsy170306  
#No.FUN-AB0034 --end
               CALL cl_err('','axr-185',1)
               LET g_oob[l_ac].oob10 = l_omc.omc13 - tot8 #No.FUN-680022 --add
               DISPLAY g_oob[l_ac].oob10 TO oob10         #No.FUN-680022 --add  
...
## No.2695 modify 1998/10/31 若溢收款在後已被沖帳,則不可取消確認
  ...
  IF p_sw = '+' THEN
     ...
     LET l_oma.oma50 = 0
     LET l_oma.oma50t= 0
     LET l_oma.oma51 = 0  #zhouxm150928 add 
     LET l_oma.oma51f = 0 #zhouxm150928 add
     LET l_oma.oma52 = 0
     LET l_oma.oma53 = 0
