...
#     DEFINEl_time LIKE type_file.chr8            #No.FUN-6A0100
   ...
   END IF
    ...
    CALL cl_ui_init()
    #No.FUN-810017--BEGIN--
       CALL cl_set_comp_visible("sgaslk04,sgaslk03,sgaslk02",FALSE)                                                              
    #No.FUN-810017--END--          
...
DEFINE
    ...
    LET g_forupd_sql = "SELECT sga01,sga02,sga03,sga04,sga06,'','','',sga07,sga08,sga05,sgaacti FROM sga_file WHERE sga01=? FOR UPDATE" #FUN-810017
...
DEFINE
    ...
    LET g_sql =
        ...
        " '','','',sga07,sga08,sga05,sgaacti",                            #No.FUN-810017
        " FROM   sga_file " ,
        " WHERE  ", p_wc2 CLIPPED,
