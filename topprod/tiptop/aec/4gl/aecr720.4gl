...
MAIN
   ...
   LET l_table = cl_prt_temptable('aecr720',g_sql) CLIPPED
   IF l_table = -1 THEN
      CALL cl_used(g_prog,g_time,2) RETURNING g_time 
      EXIT PROGRAM END 
   IF
   ...
   IF cl_null(g_bgjob) OR g_bgjob = 'N'   # If background job sw is off
      ...
      ELSE CALL aecr720()                 # Read data and create out-file
   END IF
...
DEFINE lc_qbe_sn      LIKE gbm_file.gbm01
    ...
    OPEN WINDOW r720_w AT p_row,p_col WITH FORM "aec/42f/aecr720"
       ...
       END IF
        ...
        IF g_bgjob = 'Y' THEN
            ...
            ELSE
                ...
                CALL cl_cmdat('aecr720',g_time,l_cmd)
            END IF
...
FUNCTION aecr720()
  ...
  #TQC-C10034--add--end
   IF g_sma.sma541 = 'Y' THEN
      CALL cl_prt_cs3('aecr720','aecr720_1',l_sql,l_str)
   ELSE
      CALL cl_prt_cs3('aecr720','aecr720',l_sql,l_str)
   END IF 
