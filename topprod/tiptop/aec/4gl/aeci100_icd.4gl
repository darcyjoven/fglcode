...
#       ecb44           LIKE ecb_file.ecb44,      #FUN-A50081
        ...
        ecb49           LIKE ecb_file.ecb49,      #FUN-960056
...
#                     ecb21,ecb20,ecb39,ecb40,ecb41,ecb42,ecb43,ecb44,ecb45,   #FUN-A50081
                      ...
                      ecb46,ecb51,ecb14,ecb52,ecb53,ecb48,ecb49,ecb66        #FUN-960056 add ecb48,ecb49  #FUN-A80150 add ecb66
                                                                       #FUN-A50081 add ecb51,ecb14,ecb52,ecb53
...
#               s_ecb[1].ecb44,s_ecb[1].ecb45,s_ecb[1].ecb46,   #FUN-A50081
                ...
                s_ecb[1].ecb48,s_ecb[1].ecb49,s_ecb[1].ecb66                  #FUN-960056  #FUN-A80150 add ecb66
...
#FUN-A50081 --end--
              ...
              WHEN INFIELD(ecb49) #查詢廠商檔
                    ...
                    LET g_qryparam.state = 'c'
                    CALL cl_create_qry() RETURNING g_qryparam.multiret
                    DISPLAY g_qryparam.multiret TO ecb49
                    NEXT FIELD ecb49
           END CASE
...
#FUN-A50081 --end--
        ...
        WHEN " notconfirm"
         ...
         WHEN "mntn_desc"
            IF cl_chk_act_auth() THEN
               IF NOT cl_null(g_ecu.ecu01) AND NOT cl_null(g_ecu.ecu02)
                  AND NOT cl_null(g_ecu.ecu012)                      #FUN-A50081
                  AND l_ac>0 THEN   #No.MOD-920375 add
...
DEFINE  l_cnt_vnm    LIKE type_file.num5         #FUN-A40060 add
    ...
    LET g_forupd_sql =
        ...
        "       ecb21,ecb20,'','','','',ecb66,ecb39,ecb40,ecb41,",                        #No.FUN-810017   #FUN-A80150 add ecb66 #No.TQC-BC0166 add
#       "       ecb42,ecb43,ecb44,ecb45,ecb46,ecb48,ecb49",                      #No.FUN-810017 #FUN-960056  #FUN-A50081
        "       ecb42,ecb43,ecb45,ecb46,ecb51,ecb14,ecb52,ecb53,ecb48,ecb49",                      #FUN-A50081
        " FROM ecb_file ",
...
#                                g_ecb[l_ac].ecb44,g_ecb[l_ac].ecb45,  #FUN-A50081
                                 ...
                                 g_ecb[l_ac].ecb48,g_ecb[l_ac].ecb49,   #FUN-960056
...
#FUN-A50081 --end--
       ...
       AFTER FIELD ecb49
         IF NOT cl_null(g_ecb[l_ac].ecb49) THEN
            LET g_cnt = 0
            SELECT COUNT(*) INTO g_cnt FROM pmc_file
             WHERE pmcacti = 'Y'
               AND pmc01 =g_ecb[l_ac].ecb49
               AND pmc30 IN ('1','3')
            IF g_cnt = 0 THEN
...
#                                  ecb44=g_ecb[l_ac].ecb44,  #FUN-A50081
                    ...
                    #FUN-A50081 --end--
                                   ...
                                   ecb49=g_ecb[l_ac].ecb49,  #FUN-960056
                                   ecbacti='Y',
...
#FUN-A50081 --end--
              ...
              WHEN INFIELD(ecb49) #查詢廠商檔
                   CALL cl_init_qry_var()
                   LET g_qryparam.form = "q_pmc1"
                   LET g_qryparam.default1 = g_ecb[l_ac].ecb49
                   CALL cl_create_qry() RETURNING g_ecb[l_ac].ecb49
                   DISPLAY BY NAME g_ecb[l_ac].ecb49
                   NEXT FIELD ecb49
           END CASE
...
DEFINE l_n1            LIKE type_file.num10
   ...
   LET g_sql = "SELECT ecu012,ecu014 FROM ecu_file LEFT OUTER JOIN ecr_file",
               "    ON ecu012 = ecr01 ",
               " WHERE ecu015 IS NULL AND ecu012='",p_ecu012,"' ",
