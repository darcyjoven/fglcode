...
#-->資料權限的檢查
    ...
    CONSTRUCT g_wc2 ON sgy05,sgy04,
                       ...
                       sgy12,sgy20,
                       sgyislk03,sgyislk04,sgyislk05,sgyislk06,
                       sgy13,sgy14,sgy15,sgy16,sgy17,sgy18,sgy19,sgy21
                      ,sgyislk08,sgyislk09,sgyislk10
...
#       LET g_sql = "SELECT UNIQUE sgx_file.ROWI, sgx01,sgx02,sgx03 ",  #TQC-9A0123
       LET g_sql = "SELECT sgx01,sgx02,sgx03,sgx012 ",   #TQC-9A0123   #FUN-A60092 add sgx012
                  ...
                  # " ORDER BY 2"  #TQC-9A0123
                   " ORDER BY sgx01"  #TQC-9A0123
      #NO.FUN-810014   ----begin
       IF (g_wc2.getIndexOf('sgyi',1)>0)  THEN
#       LET g_sql = "SELECT UNIQUE sgx_file.ROWI, sgx01,sgx02,sgx03 ",   #TQC-9A0123
       LET g_sql = "SELECT sgx01,sgx02,sgx03,sgx012 ",   #TQC-9A0123  #FUN-A60092 add sgx012
                   "  FROM sgx_file, sgy_file,sgyi_file ",
                   " WHERE sgx01 = sgy01 AND sgx02 = sgy02",
                   "   AND sgx03=sgy03 ",
                   "   AND sgx012=sgy012 ",  #FUN-A60092 add
                   "   AND sgy01 = sgyi01 ",
                   "   AND sgy012=sgyi012 ",  #FUN-A60092 add
                   "   AND sgy02 = sgyi02 ",
                   "   AND sgy03 = sgyi03 ",
                   "   AND sgy05 = sgyi05 ",
                   "   AND ", g_wc CLIPPED, " AND ",g_wc2 CLIPPED,
    ...
    ELSE
     ...
     #NO.FUN-810014  ----begin
         IF (g_wc2.getIndexOf('sgyi',1)>0) THEN
         LET g_sql_tmp="SELECT UNIQUE sgx01,sgx02,sgx03,sgx012 FROM sgx_file,sgy_file ,sgyi_file", #FUN-A60092 add sgx012
                   " WHERE sgy01=sgx01 AND sgy02=sgx02",
                   "   AND sgy012=sgx012 ",   #FUN-A60092 add
                   "   AND sgy01= sgyi01 ",
                   "   AND sgy012=sgyi012 ",  #FUN-A60092 add
...
FUNCTION i721_r()
   ...
   # OPEN i721_cl USING g_sgx_rowi  #TQC-9A0123
    ...
    IF cl_delh(0,0) THEN                   #確認一下
       ...
       #NO.FUN-7B0018 08/02/16 add --begin
          LET l_flag = s_del_sgyi(g_sgx.sgx01,g_sgx.sgx02,g_sgx.sgx03,'','',g_sgx.sgx012) #FUN-A60092 add sgx012
#      #No.FUN-810014 --start --
#      IF NOT s_industry('std') THEN
#         DELETE FROM sgyi_file WHERE sgyi01 = g_sgx.sgx01 AND sgyi02 = g_sgx.sgx02  AND sgyi03 = g_sgx.sgx03
#         IF STATUS THEN 
#            CALL cl_err3("del","sgyi_file",g_sgx.sgx01,g_sgx.sgx02,STATUS,"","del sgu:",1)       
#            RETURN
#         END IF
#      END IF
#      #No.FUN-810014 --end ---
       #NO.FUN-7B0018 08/02/16 add --end
       INITIALIZE g_sgx.* TO NULL
       CALL g_sgy.clear()
       CLEAR FORM
       OPEN i721_count
...
DEFINE l_sgyi          RECORD LIKE sgyi_file.*        #NO.FUN-7B0018
...
#&endif
    ...
    #No.FUN-810014   -----begin
       LET g_forupd_sql = "SELECT * FROM sgyi_file ",
                          " WHERE sgyi01= ? AND sgyi02 = ? AND sgyi03= ? AND sgyi05 = ?  FOR UPDATE"
       LET g_forupd_sql = cl_forupd_sql(g_forupd_sql)
       DECLARE i721_bcl_slk CURSOR FROM g_forupd_sql      # LOCK CURSOR
    #No.FUN-810014  ------ end
           ...
           # OPEN i721_cl USING g_sgx_rowi  #TQC-9A0123
            ...
            IF g_rec_b >= l_ac THEN
                ...
                ELSE
                   ...
                   ELSE
                   #NO.FUN-810014   -----begin
                       OPEN i721_bcl_slk USING g_sgx.sgx01,g_sgx.sgx02,g_sgx.sgx03,g_sgy_t.sgy05
                                              ,g_sgx.sgx012  #FUN-A60092 add
                       IF SQLCA.sqlcode THEN
                          CALL cl_err('lock sgyi',SQLCA.sqlcode,1)
                          LET l_lock_sw = "Y"
                       ELSE
                          FETCH i721_bcl_slk INTO b_sgyi.*
                          LET g_sgy[l_ac].sgyislk01 = b_sgyi.sgyislk01
                          LET g_sgy[l_ac].sgyislk03 = b_sgyi.sgyislk03
                          LET g_sgy[l_ac].sgyislk04 = b_sgyi.sgyislk04
                          LET g_sgy[l_ac].sgyislk05 = b_sgyi.sgyislk05
                          LET g_sgy[l_ac].sgyislk06 = b_sgyi.sgyislk06
                          LET g_sgy[l_ac].sgyislk08 = b_sgyi.sgyislk08
                          LET g_sgy[l_ac].sgyislk09 = b_sgyi.sgyislk09
                          LET g_sgy[l_ac].sgyislk10 = b_sgyi.sgyislk10
                          IF SQLCA.sqlcode THEN
                             CALL cl_err('lock sgyi',SQLCA.sqlcode,1)
                             LET l_lock_sw = "Y"
                          END IF
...
#No.FUN-870124--END--          
        ...
        AFTER INSERT
            ...
            ELSE
                #NO.FUN-7B0018 08/01/31 add --begin
                   INITIALIZE l_sgyi.* TO NULL
                   LET l_sgyi.sgyi01 = g_sgx.sgx01
                   LET l_sgyi.sgyi02 = g_sgx.sgx02
                   LET l_sgyi.sgyi03 = g_sgx.sgx03
                   LET l_sgyi.sgyi05 = g_sgy[l_ac].sgy05
                   LET l_sgyi.sgyi012= g_sgx.sgx012   #FUN-A60092
                   LET l_sgyi.sgyislk01 = g_sgy[l_ac].sgyislk01
                   LET l_sgyi.sgyislk03 = g_sgy[l_ac].sgyislk03
                   LET l_sgyi.sgyislk04 = g_sgy[l_ac].sgyislk04
                   LET l_sgyi.sgyislk05 = g_sgy[l_ac].sgyislk05
                   LET l_sgyi.sgyislk06 = g_sgy[l_ac].sgyislk06
                   LET l_sgyi.sgyislk08 = g_sgy[l_ac].sgyislk08
                   LET l_sgyi.sgyislk09 = g_sgy[l_ac].sgyislk09
                   LET l_sgyi.sgyislk10 = g_sgy[l_ac].sgyislk10
                   IF NOT s_ins_sgyi(l_sgyi.*,'') THEN
                      CANCEL INSERT
                   END IF
       ...
       CALL cl_set_comp_entry("sgyislk06,sgy13,sgy14,sgy15,sgy16,sgy17,sgy18,                               sgy19,sgy21,sgyislk08,sgyislk09,sgyislk10",TRUE)
                  ...
                  IF l_n > 0 THEN 
                     SELECT COUNT(*) INTO l_n1 FROM sgd_file
                      ...
                      IF l_n1 = 0  THEN 
                         ...
                         LET g_sgy[l_ac].sgyislk03 = " "
                         LET g_sgy[l_ac].sgyislk04 = " "
                         LET g_sgy[l_ac].sgyislk05 = " "
                         #No.FUN-870124--BEGIN--
                      ...
                      SELECT 
                              ...
                              sgd11,sgd13
                              ,sgd14,sgdslk02,sgdslk03,
                              sgdslk04
                        INTO 
                              g_sgy[l_ac].sgyislk01,
                              g_sgy[l_ac].sgy06,
                              g_sgy[l_ac].sgy07,g_sgy[l_ac].sgy08,
                              g_sgy[l_ac].sgy09,g_sgy[l_ac].sgy10,
                              g_sgy[l_ac].sgy11,g_sgy[l_ac].sgy12,
                              g_sgy[l_ac].sgy20
                             ,g_sgy[l_ac].sgyislk03,
                              g_sgy[l_ac].sgyislk04,g_sgy[l_ac].sgyislk05
                        FROM sgd_file    
                       WHERE sgd00 = g_sgx.sgx01
                         AND sgd03 = g_sgx.sgx02
                         AND sgd05 = g_sgy[l_ac].sgy05
                    ...
                    END IF                                                         #No.FUN-870124
                       DISPLAY BY NAME g_sgy[l_ac].sgyislk01
                       ...
                       DISPLAY BY NAME g_sgy[l_ac].sgyislk03
                       DISPLAY BY NAME g_sgy[l_ac].sgyislk04
                       DISPLAY BY NAME g_sgy[l_ac].sgyislk05
                         #No.FUN-870124--BEGIN--
                       IF g_sgy_t.sgy05 IS NULL  THEN
                         LET g_sgy[l_ac].sgyislk08 = NULL
                         LET g_sgy[l_ac].sgyislk09 = NULL
                         LET g_sgy[l_ac].sgyislk10 = NULL
                       END IF
                         #No.FUN-870124--END--
                         #No.FUN-870124--BEGIN--
                       IF g_sgy_t.sgy05 IS NULL  THEN
...
#               END IF   #No.FUN-870124
       ...
       AFTER FIELD sgy04
         ...
         IF g_sgy[l_ac].sgy04 = '2' THEN
            CALL cl_set_comp_entry("sgyislk06,sgy13,sgy14,sgy15,                                   sgy16,sgy17,sgy18,sgy19,sgy21                                   sgyislk08,sgyislk09,sgyislk10",FALSE)
         END IF 
...
#       AFTER FIELD sgyislk01           #No.FUN-870124                                                                                            
        AFTER FIELD sgyislk06                                                                                                       
          IF NOT cl_null(g_sgy[l_ac].sgyislk06) THEN                                                                                
            IF g_sgy[l_ac].sgyislk01<0 THEN                                                                                         
               CALL cl_err('','aec-992',0)                                                                                          
               NEXT FIELD sgyislk06                                                                                                 
            END IF                                                                                                                  
          END IF
 
        AFTER FIELD sgyislk10                                                                                                       
          IF NOT cl_null(g_sgy[l_ac].sgyislk10) THEN                                                                                
            IF g_sgy[l_ac].sgyislk10<0 THEN                                                                                         
               CALL cl_err('','aec-992',0)                                                                                          
               NEXT FIELD sgyislk10                                                                                                 
            END IF                                                                                                                  
          END IF
 
        AFTER FIELD sgyislk09                                                                                                       
          IF NOT cl_null(g_sgy[l_ac].sgyislk09) THEN                                                                                
            IF g_sgy[l_ac].sgyislk09<0 THEN                                                                                         
               CALL cl_err('','aec-992',0)                                                                                          
               NEXT FIELD sgyislk09                                                                                                 
            END IF                                                                                                                  
          END IF
 
        AFTER FIELD sgyislk08                                                                                                       
          IF NOT cl_null(g_sgy[l_ac].sgyislk08) THEN                                                                                
            IF g_sgy[l_ac].sgyislk08<0 THEN                                                                                         
               CALL cl_err('','aec-992',0)                                                                                          
               NEXT FIELD sgyislk08                                                                                                 
            END IF                                                                                                                  
          END IF
...
#           IF g_sgy_t.sgy05 > 0 AND             #NO.FUN-870124
            IF g_sgy_t.sgy05 IS NOT NULL THEN
               ...
               DELETE FROM sgy_file
                ...
                END IF
                #NO.FUN-7B0018 08/02/16 add --begin
                   IF NOT s_del_sgyi(g_sgx.sgx01,g_sgx.sgx02,g_sgx.sgx03,g_sgy_t.sgy05,'',g_sgx.sgx012) THEN
                                                   #FUN-A60092 add g_sgx.sgx012
                      ROLLBACK WORK
                      CANCEL DELETE
                   END IF
                #NO.FUN-7B0018 08/02/16 add --end
            ...
            ELSE
                UPDATE sgy_file 
                   SET sgy05=g_sgy[l_ac].sgy05,
                       ...
                       sgyislk01=g_sgy[l_ac].sgyislk01,
                       ...
                       sgyislk03=g_sgy[l_ac].sgyislk03,
                       sgyislk04=g_sgy[l_ac].sgyislk04,
                       sgyislk05=g_sgy[l_ac].sgyislk05,
                       sgyislk06=g_sgy[l_ac].sgyislk06,
                      ...
                      ,sgyislk08=g_sgy[l_ac].sgyislk08,
                       sgyislk09=g_sgy[l_ac].sgyislk09,
                       sgyislk10=g_sgy[l_ac].sgyislk10
                 WHERE sgy01 = g_sgx.sgx01 
                   AND sgy02 = g_sgx.sgx02
                   AND sgy03 = g_sgx.sgx03
                   AND sgy05 = g_sgy_t.sgy05
                ...
                END IF
                #NO.FUN-810014    -----begin
                 UPDATE  sgyi_file  SET 
                           sgyi05 = g_sgy[l_ac].sgy05 ,      
                           sgyislk01 = g_sgy[l_ac].sgyislk01,   
                           sgyislk03 = g_sgy[l_ac].sgyislk03,
                           sgyislk04 = g_sgy[l_ac].sgyislk04,
                           sgyislk05 = g_sgy[l_ac].sgyislk05,
                           ...
                           sgyislk09 = g_sgy[l_ac].sgyislk09,
                           sgyislk10 = g_sgy[l_ac].sgyislk10
                     WHERE sgyi01  = g_sgx.sgx01
                       AND sgyi02  = g_sgx.sgx02
                       AND sgyi03  = g_sgx.sgx03
                       AND sgyi05  = g_sgy_t.sgy05
                       AND sgyi012 = g_sgx.sgx012    #FUN-A60092 add
                    IF SQLCA.sqlcode THEN
                        CALL cl_err(b_sgyi.sgyislk01,SQLCA.sqlcode,0)
                    ELSE
                        MESSAGE 'UPDATE O.K'      
                        COMMIT WORK
                    END IF
...
#    l_wc2           LIKE type_file.chr1000 
    ...
    CONSTRUCT g_wc2 ON sgy05,sgy04,
              ...
              FROM  s_sgy[1].sgy05,s_sgy[1].sgy04,
                    ...
                    s_sgy[1].sgyislk03,s_sgy[1].sgyislk04,
                    s_sgy[1].sgyislk05,s_sgy[1].sgyislk06,
...
#    p_wc2      LIKE type_file.chr1000,
    ...
    #NO.FUN-810014 ------BEGIN
    LET g_sql =
        "SELECT sgy05,sgy04,sgyislk01,sgy06,sgy07,sgy08,",
        "       sgy09,sgy10,sgy11,sgy12,sgy20,sgyislk03,",
        "       sgyislk04,sgyislk05,sgyislk06,sgy13,sgy14,sgy15,",
        "       sgy16,sgy17,sgy18,sgy19,sgy21,sgyislk08,",
        "       sgyislk09,sgyislk10 ",
#       "  FROM sgy_file,OUTER sgyi_file  ",   #TQC-9A0123
        "  FROM sgy_file LEFT OUTER JOIN sgyi_file ON sgy01=sgyi01 AND sgyi02=sgy02 AND sgy03=sgyi03 AND sgy05=sgyi05 ",   #TQC-9A0123
        " WHERE sgy01='",g_sgx.sgx01,"'",
#        "   AND sgy_file.sgy01= sgyi_file.sgyi01 ",    #TQC-9A0123
#        "   AND sgy_file.sgy02= sgyi_file.sgyi02 ",    #TQC-9A0123
#        "   AND sgy_file.sgy03= sgyi_file.sgyi03 ",    #TQC-9A0123
#        "   AND sgy_file.sgy05= sgyi_file.sgyi05 ",    #TQC-9A0123
     ...
     FOREACH sgy_cury INTO g_sgy[l_ac].*
       CASE g_sgy[l_ac].sgy04
         WHEN '1' 
          ...
          END IF 
          #No.FUN-A70131--end                           
          INSERT INTO sgd_file(sgd00,sgd01,sgd02,sgd03,sgd04,sgd05,sgdslk05,sgd06,sgd07,
                               sgd08,sgd09,sgd10,sgd11,sgd13,sgd14,
                               sgdslk02,sgdslk03,sgdslk04,
          ...
          VALUES(g_sgx.sgx01,l_ecm03_par,l_ecm11,g_sgx.sgx02,l_ecm06,g_sgy[l_ac].sgy05,
                 g_sgy[l_ac].sgyislk06,g_sgy[l_ac].sgy13,g_sgy[l_ac].sgy14,
                 g_sgy[l_ac].sgy15,g_sgy[l_ac].sgy16,g_sgy[l_ac].sgy17,
                 g_sgy[l_ac].sgy18,g_sgy[l_ac].sgy19,g_sgy[l_ac].sgy21,
                 g_sgy[l_ac].sgyislk08,g_sgy[l_ac].sgyislk09,
                 g_sgy[l_ac].sgyislk10,
                 g_plant,g_legal,g_sgx.sgx012) #FUN-980002   #FUN-A60092 add sgx012
          IF SQLCA.sqlcode  THEN            
         ...
         WHEN '3' 
               IF NOT cl_null(g_sgy[l_ac].sgyislk06) THEN
                  UPDATE sgd_file SET sgdslk05 = g_sgy[l_ac].sgyislk06
                   WHERE sgd00=g_sgx.sgx01 
                     AND sgd03=g_sgx.sgx02
                     AND sgd05=g_sgy[l_ac].sgy05
                     AND sgd012=g_sgx.sgx012     #FUN-A60092 
                  IF SQLCA.sqlcode  THEN            
                     CALL cl_err3("sql","sgd_file",g_sgx.sgx01,g_sgx.sgx02,SQLCA.sqlcode,"","sgdslk05",1)      
                     LET g_success = 'N'   
                     EXIT FOREACH          
                  END IF
               END IF
               ...
               END IF
               IF NOT cl_null(g_sgy[l_ac].sgyislk08) THEN
                  UPDATE sgd_file SET sgdslk02 = g_sgy[l_ac].sgyislk08
                   WHERE sgd00=g_sgx.sgx01 
                     AND sgd03=g_sgx.sgx02
                     AND sgd05=g_sgy[l_ac].sgy05 
                     AND sgd012=g_sgx.sgx012    #FUN-A60092                      
                  IF SQLCA.sqlcode  THEN            
                     CALL cl_err3("sql","sgd_file",g_sgx.sgx01,g_sgx.sgx02,SQLCA.sqlcode,"","sgdslk02",1)      
                     LET g_success = 'N'   
                     EXIT FOREACH          
                  END IF
               END IF
               IF NOT cl_null(g_sgy[l_ac].sgyislk09) THEN
                  UPDATE sgd_file SET sgdslk03 = g_sgy[l_ac].sgyislk09
                   WHERE sgd00=g_sgx.sgx01 
                     AND sgd03=g_sgx.sgx02
                     AND sgd05=g_sgy[l_ac].sgy05 
                     AND sgd012=g_sgx.sgx012    #FUN-A60092                      
                  IF SQLCA.sqlcode  THEN            
                     CALL cl_err3("sql","sgd_file",g_sgx.sgx01,g_sgx.sgx02,SQLCA.sqlcode,"","sgdslk03",1)      
                     LET g_success = 'N'   
                     EXIT FOREACH          
                  END IF
               END IF
               IF NOT cl_null(g_sgy[l_ac].sgyislk10) THEN
                  UPDATE sgd_file SET sgdslk04 = g_sgy[l_ac].sgyislk10
                   WHERE sgd00=g_sgx.sgx01 
                     AND sgd03=g_sgx.sgx02
                     AND sgd05=g_sgy[l_ac].sgy05 
                     AND sgd012=g_sgx.sgx012    #FUN-A60092                      
                  IF SQLCA.sqlcode  THEN            
                     CALL cl_err3("sql","sgd_file",g_sgx.sgx01,g_sgx.sgx02,SQLCA.sqlcode,"","sgdslk04",1)      
                     LET g_success = 'N'   
                     EXIT FOREACH          
                  END IF
               END IF
