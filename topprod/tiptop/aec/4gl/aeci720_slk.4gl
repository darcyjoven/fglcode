...
#               s_sgu[1].sgu21,s_sgu[1].sgu22,s_sgu[1].sgu23,       #FUN-B30019
                ...
                s_sgu[1].sguislk01,s_sgu[1].sguislk02,s_sgu[1].sguislk03,
                s_sgu[1].sguislk04,
...
#               s_sgu[1].sgu35,s_sgu[1].sgu36,s_sgu[1].sgu37,s_sgu[1].sgu38,s_sgu[1].sgu39,s_sgu[1].sgu40,   #FUN-B30019
               ...
               ,s_sgu[1].sguislk05,s_sgu[1].sguislk06,s_sgu[1].sguislk07,s_sgu[1].sguislk08
		BEFORE CONSTRUCT
...
#FUN-B50178 ---------------End------------------
   ...
   ELSE
      LET g_sql="SELECT sgt01,sgt02",                  #No.FUN-9A0071
       ...
       IF (g_wc2.getIndexOf('sgui',1)>0)  THEN
       LET g_sql="SELECT sgt01,sgt02",   #No.FUN-9A0071
                "  FROM sgt_file,sgu_file,sgui_file ",
                " WHERE sgt01=sgu01 AND sgt02=sgu02",
                "   AND sgu01 = sgui01 ",
                "   AND sgu02 = sgui02 ",
                "   AND sgu04 = sgui04 ",
   ...
   IF g_wc2=' 1=1' THEN                                                                                                            
    ...
    ELSE
       LET g_sql_tmp= "SELECT UNIQUE sgt01,sgt02 FROM sgt_file,sgu_file",
                 ...
                 "   INTO TEMP x"
       IF (g_wc2.getIndexOf('sgui',1)>0)  THEN
       LET g_sql_tmp="SELECT UNIQUE sgt01,sgt02",
                "  FROM sgt_file,sgu_file,sgui_file ",
                " WHERE sgt01=sgu01 AND sgt02=sgu02",
                "   AND sgu01 = sgui01 ",
                "   AND sgu02 = sgui02 ",
      ...
      CASE g_action_choice
        ...
        WHEN "output"
            ...
            IF cl_chk_act_auth() THEN
              ...
              #LET g_msg="aecr720 ", #FUN-C30085 mark
               LET g_msg="aecg720 ", #FUN-C30085 add
                         "'",g_today,"'",
                         " '",g_user,"'",
                         " '",g_lang,"'",
                         " 'Y' ",
...
FUNCTION i720_copy()
   ...
   DEFINE  l_sgui          RECORD LIKE sgui_file.*     #No.FUN-7B0018
  ...
  DROP TABLE z
   SELECT * FROM sgui_file         #單身複製
       WHERE sgui01=g_sgt.sgt01
         AND sgui02=g_sgt.sgt02
       INTO TEMP z
...
FUNCTION i720_r()
    ...
    IF cl_delh(15,21) THEN
        ...
        IF STATUS THEN 
           ...
           RETURN
        ELSE
           IF NOT s_del_sgui(g_sgt.sgt01,g_sgt.sgt02,'','') THEN
              RETURN
           END IF
        END IF
        INITIALIZE g_sgt.* TO NULL
...
DEFINE l_next_ecm012 LIKE ecm_file.ecm012  #CHI-C70022
    ...
    DECLARE i720_bcl CURSOR FROM g_forupd_sql      # LOCK CURSOR
       LET g_forupd_sql = "SELECT * FROM sgui_file ",
                          " WHERE sgui01= ? AND sgui02 = ? AND sgui04= ?  FOR UPDATE"
       LET g_forupd_sql = cl_forupd_sql(g_forupd_sql)
       DECLARE i720_bcl_slk CURSOR FROM g_forupd_sql      # LOCK CURSOR
    ...
    INPUT ARRAY g_sgu WITHOUT DEFAULTS FROM s_sgu.*
            ...
            IF g_rec_b >= l_ac THEN
                ...
                ELSE
                   ...
                   ELSE
                    ...
                    #FUN-B20078--end--add------
                       OPEN i720_bcl_slk USING g_sgt.sgt01,g_sgt.sgt02,g_sgu_t.sgu04
                       IF SQLCA.sqlcode THEN
                          CALL cl_err('lock sgui',SQLCA.sqlcode,1)
                          LET l_lock_sw = "Y"
                       ELSE
                          FETCH i720_bcl_slk INTO b_sgui.*
                          LET g_sgu[l_ac].sguislk01 = b_sgui.sguislk01
                          LET g_sgu[l_ac].sguislk02 = b_sgui.sguislk02
                          LET g_sgu[l_ac].sguislk03 = b_sgui.sguislk03
                          LET g_sgu[l_ac].sguislk04 = b_sgui.sguislk04
                          LET g_sgu[l_ac].sguislk05 = b_sgui.sguislk05
                          LET g_sgu[l_ac].sguislk06 = b_sgui.sguislk06
                          LET g_sgu[l_ac].sguislk07 = b_sgui.sguislk07
                          LET g_sgu[l_ac].sguislk08 = b_sgui.sguislk08
                          IF SQLCA.sqlcode THEN
                             CALL cl_err('lock sgui',SQLCA.sqlcode,1)
                             LET l_lock_sw = "Y"
                          END IF
        ...
        AFTER INSERT
            ...
            IF SQLCA.sqlcode THEN
               ...
               CANCEL INSERT
            ELSE
               INITIALIZE l_sgui.* TO NULL
               LET l_sgui.sgui01 = g_sgt.sgt01
               LET l_sgui.sgui02 = g_sgt.sgt02
               LET l_sgui.sgui04 = g_sgu[l_ac].sgu04
               LET l_sgui.sguislk01 = g_sgu[l_ac].sguislk01
               LET l_sgui.sguislk02 = g_sgu[l_ac].sguislk02
               LET l_sgui.sguislk03 = g_sgu[l_ac].sguislk03
               LET l_sgui.sguislk04 = g_sgu[l_ac].sguislk04
               LET l_sgui.sguislk05 = g_sgu[l_ac].sguislk05
               LET l_sgui.sguislk06 = g_sgu[l_ac].sguislk06
               LET l_sgui.sguislk07 = g_sgu[l_ac].sguislk07
               LET l_sgui.sguislk08 = g_sgu[l_ac].sguislk08
               IF NOT s_ins_sgui(l_sgui.*,'') THEN
                  CANCEL INSERT
               END IF
               MESSAGE 'INSERT O.K'
          ...
          AFTER FIELD sgu04
            CALL cl_set_comp_entry("sgu016,sgu24,sgu25,sgu26,sgu27,sgu29,sgu30,sgu31,sgu32,sgu33,                                     sgu34,sgu35,sgu36,sgu37,sgu39,sgu41,sgu42,                                         sgu48,sgu49,sgu50,sgu51,sgu52,sgu54,                                       sguislk05,sguislk06,sguislk07,sguislk08",TRUE) #FUN-B30019  #FUN-B50178 add sgu54  
...
#TQC-AC0093 --------------------------------------mark end---------------------------------------------     
       ...
       AFTER FIELD sgu03
        ...
        IF g_sgu[l_ac].sgu03 = '2' THEN
           CALL cl_set_comp_entry("sgu016,sgu24,sgu25,sgu26,sgu27,sgu29,sgu30,sgu31,sgu32,sgu33,                                   sgu34,sgu35,sgu36,sgu37,sgu39,sgu41,sgu42,                                         sgu48,sgu49,sgu50,sgu51,sgu52,sgu54,                                              sguislk05,sguislk06,sguislk07,sguislk08",FALSE)   #FUN-B30019  #FUN-B50178  add sgu54
         END IF
         IF g_sgu[l_ac].sgu03 = '1' OR g_sgu[l_ac].sgu03 = '3' THEN
            CALL cl_set_comp_entry("sgu016,sgu24,sgu25,sgu26,sgu27,sgu29,sgu30,sgu31,sgu32,sgu33,                                    sgu34,sgu35,sgu36,sgu37,sgu39,sgu41,sgu42,                                             sgu48,sgu49,sgu50,sgu51,sgu52,sgu54,                                    sguislk06,sguislk07,sguislk08",TRUE) #FUN-B30019  #FUN-B50178
        END IF
        CALL i720_set_no_required()  #FUN-B30019
       IF g_sgu[l_ac].sgu03 != g_sgu_t.sgu03 OR g_sgu_t.sgu03 IS NULL THEN
        ...
        #  LET g_sgu[l_ac].sgu40 = " "  #FUN-B30019
           ...
           LET g_sgu[l_ac].sguislk05 = " "
           LET g_sgu[l_ac].sguislk06 = " "
           LET g_sgu[l_ac].sguislk07 = " "
           LET g_sgu[l_ac].sguislk08 = " "
         END IF
         IF g_sma.sma541 = 'N' THEN LET g_sgu[l_ac].sgu012 = ' ' END IF  #MOD-C80002 add 
         IF NOT i720_check_sgu04() THEN NEXT FIELD sgu04 END IF          #MOD-C80002 add 
        END IF 
        ...
        AFTER FIELD sguislk08
            IF NOT cl_null(g_sgu[l_ac].sguislk08) THEN                                                                                  
               IF g_sgu[l_ac].sguislk08 < 0 THEN                                                                                        
                  CALL cl_err(g_sgu[l_ac].sguislk08,'aec-992',0)                                                                        
                  NEXT FIELD sguislk08                                                                                                  
               END IF                                                                                                               
            END IF
 
       AFTER FIELD sguislk07
             IF NOT cl_null(g_sgu[l_ac].sguislk07) THEN                                                                                  
                IF g_sgu[l_ac].sguislk07 < 0 THEN                                                                                        
                   CALL cl_err(g_sgu[l_ac].sguislk07,'aec-992',0)                                                                        
                   NEXT FIELD sguislk07                                                                                                  
                END IF                                                                                                               
             END IF
 
       AFTER FIELD sguislk06
            IF NOT cl_null(g_sgu[l_ac].sguislk06) THEN                                                                                  
               IF g_sgu[l_ac].sguislk06 < 0 THEN                                                                                        
                  CALL cl_err(g_sgu[l_ac].sguislk06,'aec-992',0)                                                                        
                  NEXT FIELD sguislk06                                                                                                  
               END IF                                                                                                               
            END IF
        ...
        BEFORE DELETE                            #是否取消單身
            IF g_sgu_t.sgu04 IS NOT NULL THEN
                ...
                IF SQLCA.sqlcode THEN
                   ...
                   CANCEL DELETE
                ELSE
                   IF NOT s_del_sgui(g_sgt.sgt01,g_sgt.sgt02,g_sgu_t.sgu04,'') THEN
                      ROLLBACK WORK
                      CANCEL DELETE
                   END IF
                END IF
...
#FUN-B30019 -----------------------------End-------------------------------
               ...
               ELSE
                  ...
                  COMMIT WORK
               END IF
                UPDATE  sgui_file  SET 
                          sgui04 = g_sgu[l_ac].sgu04 ,      
                          sguislk01 = g_sgu[l_ac].sguislk01,   
                          sguislk02 = g_sgu[l_ac].sguislk02,
                          sguislk03 = g_sgu[l_ac].sguislk03,
                          sguislk04 = g_sgu[l_ac].sguislk04,
                          sguislk05 = g_sgu[l_ac].sguislk05,
                          sguislk06 = g_sgu[l_ac].sguislk06,
                          sguislk07 = g_sgu[l_ac].sguislk07,
                          sguislk08 = g_sgu[l_ac].sguislk08
                    WHERE sgui01  = g_sgt.sgt01
                      AND sgui02  = g_sgt.sgt02
                      AND sgui04  = g_sgu_t.sgu04
                   IF SQLCA.sqlcode THEN
                       CALL cl_err(b_sgui.sguislk01,SQLCA.sqlcode,0)
                   ELSE
                       MESSAGE 'UPDATE O.K'      
                       COMMIT WORK
                   END IF
...
DEFINE
    ...
    CONSTRUCT g_wc2 ON sgu012,sgu014,sgu04,sgu03,sgu015,sgu05,sgu06,sgu07,sgu08,sgu10,sgu11,sgu12,sgu13,   #NO.FUN-A60080  add sgu012 #FUN-B10056
                    ...
                    #  sgu31,sgu32,sgu33,sgu34,sgu35,sgu36,sgu37,sgu38,sgu39,sgu40,sgu41,  #FUN-B30019
                       ...
                       sgu48,sgu49,sgu50,sgu51,sgu52,      #FUN-B30019
                       sgu41,sgu42
                       ,sguislk05,sguislk06,sguislk07,sguislk08
           ...
           #    s_sgu[1].sgu35,s_sgu[1].sgu36,s_sgu[1].sgu37,s_sgu[1].sgu38,s_sgu[1].sgu39,s_sgu[1].sgu40,   #FUN-B30019
                ...
                s_sgu[1].sgu41,s_sgu[1].sgu42
                ,s_sgu[1].sguislk05,s_sgu[1].sguislk06,s_sgu[1].sguislk07,
                s_sgu[1].sguislk08
              BEFORE CONSTRUCT
                 CALL cl_qbe_init()
...
DEFINE
    ...
    #   " sgu13,sgu14,sgu15,sgu16,sgu17,sgu18,sgu19,sgu20,sgu21,sgu22,sgu23,",    #FUN-B30019   
        ...
        " sgu47,sgu22,sgu23,",     #FUN-B30019
        " sguislk01,sguislk02,sguislk03,sguislk04,sgu016,sgu24,sgu25,sgu26,sgu27,",   #FUN-B10056 
    #   " sgu29,sgu30,sgu31,sgu32,sgu33,sgu34,sgu35,sgu36,sgu37,sgu38,sgu39,",    #FUN-B30019
    #   " sgu40,sgu41,sgu42,sguislk05,sguislk06,sguislk07,sguislk08",             #FUN-B30019
        " sgu29,sgu30,sgu31,sgu32,sgu33,sgu54,sgu34,sgu35,sgu36,sgu37,sgu39,",    #FUN-B30019  #FUN-B50178 add sgu54
        " sgu48,sgu49,sgu50,sgu51,sgu52,",                                        #FUN-B30019  
        " sgu41,sgu42,sguislk05,sguislk06,sguislk07,sguislk08",                   #FUN-B30019 
        " FROM sgu_file LEFT OUTER JOIN sgui_file ON sgui01 = sgu01 AND sgui02 = sgu02 AND sgui04 = sgu04 ",
        " WHERE sgu01 ='",g_sgt.sgt01,"'",
        "   AND sgu02 ='",g_sgt.sgt02,"'",
        "   AND ",p_wc2 CLIPPED,  #FUN-B20078
        " ORDER BY sgu04"
...
#資料刪除時須將良品轉入量移轉到下一站良品轉入量，所以需要抓下一製程號，為了正確的抓取到下一製程號,故將刪除放最後處理
       LET g_sql = 
             " SELECT sug012,sgu014,sgu04,sgu03,(case when (sgu03='3') then '2'",
             "       when (sgu03='1') then '1'",
             "       when (sgu03='2') then '3' end) as a,",
             "       sgu015,sgu05,sgu06,sgu07,sgu08,sgu10,sgu11,sgu12,sgu13, ",  #NO.FUN-A60080  add sgu012
       #     "       sgu14,sgu15,sgu16,sgu17,sgu18,sgu19,sgu20,sgu21,sgu22,sgu23,sguislk01, ",   #FUN-B30019      
             "       sgu14,sgu53,sgu15,sgu16,sgu17,sgu18,sgu20,sgu43,sgu44,sgu45,sgu46,sgu47,",  #FUN-B30019  #FUN-B50178 add sgu53 
             "       sgu22,sgu23,sguislk01, ",               #FUN-B30019
             "       sguislk02,sguislk03,sguislk04,sgu016,sgu24,sgu25,sgu26,sgu27,sgu29,sgu30, ",
       #     "       sgu31,sgu32,sgu33,sgu34,sgu35,sgu36,sgu37,sgu38,sgu39,sgu40,sgu41, ",       #FUN-B30019
             "       sgu31,sgu32,sgu33,sgu54,sgu34,sgu35,sgu36,sgu37,sgu39,sgu48,sgu49,sgu50, ", #FUN-B30019  #FUN-B50178 add sgu54
...
#FUN-B30019 -------------------------------------Begin----------------------------------
        ...
        IF (NOT cl_null(l_sgu.sgu48) OR NOT cl_null(l_sgu.sgu49) OR NOT cl_null(l_sgu.sgu50)
           ...
           CALL cralc_eck_rate(g_sgt.sgt01,l_sgu.sgu04,l_sgu.sgu012,l_sfb08,l_sgu.sgu50,l_sgu.sgu51,
                               l_sgu.sgu52,l_sgu.sgu48/l_sgu.sgu49,1)
                RETURNING g_ecm65
        END IF
       ...
       CASE l_sgu.sgu03
         WHEN '1' 
          ...
          VALUES(g_sgt.sgt01,l_sfb02,l_ecm03_par,l_sgu.sgu04,
                 ...
                 l_sgu.sgu41,l_sgu.sgu42,l_sgu.sguislk05,
                 l_sgu.sguislk06,l_sgu.sguislk07,l_sgu.sguislk08,
...
#FUN-B30019 ------------------------End---------------------------------
               ...
               END IF
               #FUN-B30019--end--add-------
               IF NOT cl_null(l_sgu.sguislk05) THEN
                  UPDATE ecm_file SET ecmslk01 = l_sgu.sguislk05
                   WHERE ecm01 = g_sgt.sgt01
                     AND ecm012= l_sgu.sgu012  
                     AND ecm03 = l_sgu.sgu04
                  IF SQLCA.sqlcode  THEN                                                                                                  
                  ...
                  END IF
               END IF
               IF NOT cl_null(l_sgu.sguislk06) THEN
                  UPDATE ecm_file SET ecmslk02 = l_sgu.sguislk06
                   WHERE ecm01 = g_sgt.sgt01
                     AND ecm012= l_sgu.sgu012  
                     AND ecm03 = l_sgu.sgu04
                  IF SQLCA.sqlcode  THEN                                                                                                  
                  ...
                  END IF
               END IF
               IF NOT cl_null(l_sgu.sguislk07) THEN
                  UPDATE ecm_file SET ecmslk03 = l_sgu.sguislk07
                   WHERE ecm01 = g_sgt.sgt01
                     AND ecm012= l_sgu.sgu012  
                     AND ecm03 = l_sgu.sgu04
                  IF SQLCA.sqlcode  THEN                                                                                                  
                  ...
                  END IF
               END IF
               IF NOT cl_null(l_sgu.sguislk08) THEN
                  UPDATE ecm_file SET ecmslk04 = l_sgu.sguislk08
                   WHERE ecm01 = g_sgt.sgt01
                     AND ecm012= l_sgu.sgu012  
                     AND ecm03 = l_sgu.sgu04
                  IF SQLCA.sqlcode  THEN                                                                                                  
