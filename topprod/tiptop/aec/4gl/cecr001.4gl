...
FUNCTION cecr001_tm(p_row,p_col)
 ...
 #--------------No.TQC-610089 end 
   ...
   DIALOG ATTRIBUTE (UNBUFFERED)
      ...
      CONSTRUCT BY NAME tm.wc ON ecu01        
         BEFORE CONSTRUCT
             CALL cl_qbe_init() 
         ON ACTION locale
...
FUNCTION cecr001()
  ...
  #公司全名zo02、公司地址zo041、公司電話zo05、公司傳真zo09
   ...
   LET l_sql = "SELECT ecu01,ecu11,'',trim(imaud07),trim(imaud10),ecb03,ecb06,ecb17,ecb40,trim(ecbud04),trim(ecbud05),trim(ecbud03),trim(ecbud02),ima02,''",
               "  FROM ecb_file,ecu_file LEFT JOIN ima_file ON ima01=ecu01 ",
               " WHERE ecu01 = ecb01",
               "   AND ",tm.wc CLIPPED,
               " ORDER BY ecu01,ecb03"
