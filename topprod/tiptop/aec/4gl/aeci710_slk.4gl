    ...
    #   CONSTRUCT BY NAME g_wc ON sfb01,sfb05,sfb06,ecm03,ecm012,ecm45,ecm06,      #NO.FUN-A60080  add ecm012  #FUN-B10056 mark
      ...
      ON ACTION controlg      #MOD-4C0121
       ...
       CONSTRUCT g_wc2 ON sgd05,sgd06,sgd07,sgd08,sgd10,sgd1l,sgd09,  #No.FUN-810014
                          sgdslk05,sgdslk04,sgdslk03,sgdslk02,    #No.FUN-810014
                 ...
                 FROM s_sgd[1].sgd05,s_sgd[1].sgd06,s_sgd[1].sgd07,
                      ...
                      s_sgd[1].sgdslk05,s_sgd[1].sgdslk04,s_sgd[1].sgdslk03, #No.FUN-810014
                      s_sgd[1].sgdslk02,
...
FUNCTION i710_show()
    ...
    DISPLAY BY NAME g_sfb.sfb01,g_sfb.sfb08,g_sfb.sfb05,g_sfb.sfb06,
                    ...
                    g_ecm.ecm60
                    ,g_ecm.ecmslk04,g_ecm.ecmslk03,g_ecm.ecmslk02    #No.FUN-810014
...
DEFINE
    ...
    LET g_sql = "SELECT sgd05,'','',sgd06,sgd07,sgd08,sgd10,sgd11,sgd09,",   #No.FUN-810014
                " sgdslk05,sgdslk04,sgdslk03,sgdslk02,sgd13,sgd14",  #No.FUN-810014
                " FROM sgd_file ",
                " WHERE sgd00 = '",g_sfb01,"'  ",
                "   AND sgd01 = '",g_sfb05,"'  ",
...
#No.FUN-840178--END--
    SELECT sga02,sga03,sga04,sga06,sga07,sga08                    #No.FUN-840178
           #No.FUN-830114--BEGIN                                                                                          
           ,sgaslk03,sgaslk04 #,sgaslk02*g_sgd[l_ac].sgd06        #No.FUN-840178                                                          
           #No.FUN-830114--END                                                                                            
      INTO g_sgd[l_ac].sga02,g_sgd[l_ac].sga03,g_sgd[l_ac].sgd07,
           g_sgd[l_ac].sgd10,g_sgd[l_ac].sgd13,g_sgd[l_ac].sgd14  #No.FUN-840178
           #No.FUN-830114--BEGIN                                                                                          
           ,g_sgd[l_ac].sgdslk03,g_sgd[l_ac].sgdslk04                                                                    
          # g_sgd[l_ac].sgdslk02                                  #No.FUN-840178                                                         
           #No.FUN-830114--END                                                                                            
      FROM  sga_file
...
DEFINE l_sgdslk02   LIKE sgd_file.sgdslk02              #No.FUN-840178
    LET g_action_choice = ""
...
#       "SELECT sgd05,'','',sgd06,sgd07,sgd08,sgd10,sgd11,sgd09 FROM sgd_file ",  #No.FUN-810014
        "SELECT sgd05,'','',sgd06,sgd07,sgd08,sgd10,sgd11,sgd09,sgdslk05,",      #No.FUN-810014
        " sgdslk04,sgdslk03,sgdslk02,sgd13,sgd14",                         #No.FUN-810014
...
#                     CALL  i710_sgd05()  #No.FUN-840178
        ...
        AFTER INSERT
            ...
            INSERT INTO sgd_file(sgd00,sgd01,sgd02,sgd03,sgd04,sgd05,
                                 ...
                                 sgdslk05,sgdslk04,sgdslk03,         #No.FUN-810014
                                 sgdslk02,sgd13,sgd14,             #No.FUN-810014
                          ...
                          VALUES(g_sfb.sfb01,g_sfb.sfb05,g_sfb.sfb06,
                                 ...
                                 g_sgd[l_ac].sgdslk05,g_sgd[l_ac].sgdslk04,  #No.FUN-810014
                                 g_sgd[l_ac].sgdslk03,g_sgd[l_ac].sgdslk02,  #No.FUN-810014
        ...
        AFTER FIELD sgd06
            IF NOT cl_null(g_sgd[l_ac].sgd06) THEN
             IF cl_null(g_sgd_t.sgd06) OR g_sgd[l_ac].sgd06 != g_sgd_t.sgd06 #No.FUN-840178 
               ...
               #No.FUN-840178--BEGIN--                                                                                              
               SELECT sgaslk02 INTO l_sgdslk02                                                                                      
                 FROM sga_file                                                                                                      
                WHERE sga01 = g_sgd[l_ac].sgd05                                                                                     
               LET g_sgd[l_ac].sgdslk02 = l_sgdslk02 * g_sgd[l_ac].sgd06                                                            
               DISPLAY BY NAME g_sgd[l_ac].sgdslk02                                                                                 
               #No.FUN-840178--END                                                                                                  
               #------MOD-5A0095 START----------
...
#No.FUN-810014--Begin
        AFTER FIELD sgdslk05                                                                                                       
          IF NOT cl_null(g_sgd[l_ac].sgdslk05) THEN                                                                                
            IF g_sgd[l_ac].sgdslk05<0 THEN                                                                                         
        ...
        AFTER FIELD sgdslk04                                                                                                       
          IF NOT cl_null(g_sgd[l_ac].sgdslk04) THEN                                                                                
            IF g_sgd[l_ac].sgdslk04<0 THEN                                                                                         
               CALL cl_err('','aec-992',0)                                                                                          
               NEXT FIELD sgdslk04                                                                                                 
            END IF                                                                                                                  
          END IF
        ...
        AFTER FIELD sgdslk03                                                                                                       
          IF NOT cl_null(g_sgd[l_ac].sgdslk03) THEN                                                                                
            IF g_sgd[l_ac].sgdslk03<0 THEN                                                                                         
               CALL cl_err('','aec-992',0)                                                                                          
               NEXT FIELD sgdslk03                                                                                                 
            END IF                                                                                                                  
          END IF
        ...
        AFTER FIELD sgdslk02                                                                                                       
          IF NOT cl_null(g_sgd[l_ac].sgdslk02) THEN                                                                                
            IF g_sgd[l_ac].sgdslk02<0 THEN                                                                                         
               CALL cl_err('','aec-992',0)                                                                                          
               NEXT FIELD sgdslk02                                                                                                 
            END IF                                                                                                                  
          END IF
        ...
        ON ROW CHANGE
            ...
            ELSE
               UPDATE sgd_file SET sgd05=g_sgd[l_ac].sgd05,
                                   ...
                                   sgdslk05=g_sgd[l_ac].sgdslk05,  #No.FUN-810014
                                   sgdslk04=g_sgd[l_ac].sgdslk04,  #No.FUN-810014
                                   sgdslk03=g_sgd[l_ac].sgdslk03,  #No.FUN-810014
                                   sgdslk02=g_sgd[l_ac].sgdslk02,  #No.FUN-810014
