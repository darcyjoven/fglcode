    ...
    IF cl_null(g_argv1) THEN
      ...
      ON ACTION controlg      #MOD-4C0121
       ...
       CONSTRUCT g_wc2 ON ecm03,ecm011,ecm012,
                          ...
                          ecmslk04,ecmslk03,ecmslk02,            #No.FUN-810014
                          ecmslk01,                              #No.TQC-BC0166 add
               ...
               FROM s_ecm[1].ecm03,s_ecm[1].ecm011,s_ecm[1].ecm012,
                    ...
                    s_ecm[1].ecmslk04,         #No.FUN-810014
                    s_ecm[1].ecmslk03,s_ecm[1].ecmslk02,     #No.FUN-810014
                    s_ecm[1].ecmslk01,                       #No.TQC-BC0166 add
                    s_ecm[1].ecm49,
      ...
      #FUN-A10044  ---END---
         ...
         WHEN "wo_cell_details"
            IF NOT cl_null(g_sfb.sfb01) AND NOT cl_null(g_sfb.sfb05) THEN
               LET g_cmd = "aeci710_slk '",g_sfb.sfb01,"' '",g_sfb.sfb05 clipped,"'"
               CALL cl_cmdrun(g_cmd)
            END IF
         WHEN "related_time"
            CALL i700_more('d')
...
DEFINE l_cnt1       LIKE type_file.num5     #FUN-B20078 add    
    ...
    LET g_forupd_sql =
       ...
       #"SELECT ecm03,ecm011,ecm012,ecm014,ecm015,'',ecm04,ecm45,ecm61,ecm06,'','',ecm14,ecm13,ecm16,ecm15,",   #FUN-B20078  #FUN-9A0048 mark
        ...
        "       ecmslk04,ecmslk03,ecmslk02,ecmslk01,",    #No.FUN-810014 #No.TQC-BC0166 add ecmslk01
 ...
 #FUN-B10056 -----------End-ADD-----------------------
           #FUN-B20070--begin--add----
            IF cl_null(g_ecm[l_ac].ecm65) OR g_ecm[l_ac].ecm65=0 THEN
               CALL cralc_eck_rate(g_sfb.sfb01,g_ecm[l_ac].ecm03,g_ecm[l_ac].ecm012,g_sfb.sfb08,g_ecm[l_ac].ecm12,g_ecm[l_ac].ecm34,
                                   g_ecm[l_ac].ecm64,g_ecm[l_ac].ecm62/g_ecm[l_ac].ecm63,1)
           ...
           #No.FUN-A60011  --Begin
            INSERT INTO ecm_file(ecm01,ecm03_par,ecm03,ecm04,ecm45,ecm61,ecm06,ecm14,ecm13,    # No.MOD-610024 add ecm03_par #FUN-870092 add ecm61
                                 ecm16,ecm15,
                                 ecmslk04,ecmslk03,ecmslk02,      #No.FUN-810014
                                 ecmslk01,                        #No.TQC-BC0166 add ecmslk01
                          ...
                          VALUES(g_sfb.sfb01,g_sfb.sfb05,g_ecm[l_ac].ecm03,   # No.MOD-610024 add sfb05
                                 ...
                                 g_ecm[l_ac].ecm15,
                                 g_ecm[l_ac].ecmslk04,                       #No.FUN-810014
                                 g_ecm[l_ac].ecmslk03,                       #No.FUN-810014
                                 g_ecm[l_ac].ecmslk02,                       #No.FUN-810014
                                 g_ecm[l_ac].ecmslk01,                       #No.TQC-BC0166 add
...
#FUN-BB0084 ----------------End-------------------
        ...
        AFTER FIELD ecm15
            IF g_ecm[l_ac].ecm15<0 THEN
               ...
               NEXT FIELD ecm15
            END IF
        AFTER FIELD ecmslk04
          IF NOT cl_null(g_ecm[l_ac].ecmslk04) THEN
            IF g_ecm[l_ac].ecmslk04<0 THEN
               CALL cl_err('','aec-992',0)
               NEXT FIELD ecmslk04
            END IF
          END IF

        AFTER FIELD ecmslk03
          IF NOT cl_null(g_ecm[l_ac].ecmslk03) THEN
            IF g_ecm[l_ac].ecmslk03<0 THEN
               CALL cl_err('','aec-992',0)
               NEXT FIELD ecmslk03
            END IF
          END IF

        AFTER FIELD ecmslk02
          IF NOT cl_null(g_ecm[l_ac].ecmslk02) THEN
            IF g_ecm[l_ac].ecmslk02<0 THEN
               CALL cl_err('','aec-992',0)
               NEXT FIELD ecmslk02
            END IF
          END IF
        ...
        ON ROW CHANGE
            ...
            #FUN-B20070--end--add-----
               ...
               UPDATE ecm_file SET ecm03=g_ecm[l_ac].ecm03,
                                   ...
                                   ecmslk04=g_ecm[l_ac].ecmslk04,      #No;FUN-810014
                                   ecmslk03=g_ecm[l_ac].ecmslk03,      #No.FUN-810014
                                   ecmslk02=g_ecm[l_ac].ecmslk02,      #No.FUN-810014
                                   ecmslk01=g_ecm[l_ac].ecmslk01,      #No.TQC-BC0166 add
...
DEFINE
 ...
 #      "SELECT ecm03,ecm011,ecm012,ecm014,ecm015,ecm04,ecm45,ecm61,ecm06,eca02,'',",   #FUN-B10056 add ecm014,ecm015   #FUN-B20078 mark
        "SELECT ecm03,ecm011,ecm012,ecm014,ecm015,'',ecm04,ecm45,ecm61,ecm06,eca02,'',",  #FUN-B20078 
       #"       ecm14,ecm13,ecm16,ecm15,ecmslk04,ecmslk03,",            #No:FUN-810014 #FUN-9A0048 mark
        "       '',ecm14,ecm13,'',ecm16,ecm15,ecmslk04,ecmslk03,",      #No:FUN-810014 #FUN-9A0048 add
        "       ecmslk02,ecmslk01,ecm49,ecm50,ecm51,ecm05,'',",                #No.FUN-810014 #TQC-8C0016 add '' #No.TQC-BC0166 add ecmslk01
