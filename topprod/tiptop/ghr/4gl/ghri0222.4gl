...
DEFINE p_row,p_col   LIKE type_file.num5         #No.FUN-680102 SMALLINT
   ...
   END IF
    ...
    OPEN WINDOW i0222_w AT p_row,p_col WITH FORM "ghr/42f/ghri022_a"  ATTRIBUTE (STYLE = g_win_style CLIPPED) #No.FUN-580092 HCN
    
    CALL cl_ui_init()
    CALL cl_set_comp_visible("hratid",FALSE)
    
    LET g_wc2 = '1=1' CALL i0222_b_fill(g_wc2,'')
    CALL i0222_menu()
    CLOSE WINDOW i0222_w                 #結束畫面
...
FUNCTION i0222_b_askkey()
   ...
   IF INT_FLAG THEN
      ...
      RETURN
   END IF
    CALL i0222_b_fill(g_wc2,'')
END FUNCTION
 
FUNCTION i0222_b_fill(p_wc2,p_start)              #BODY FILL UP
DEFINE
 ...
 IF cl_null(p_start) THEN 
    ...
    PREPARE i0222_pb FROM g_sql
    DECLARE hrat_curs CURSOR FOR i0222_pb
  ...
  # add by shenran end
    ...
    CALL g_hrat_t.deleteElement(g_cnt)
     # add by shenran start
      ...
      CALL i0222_set_data(0,g_turn)
     DISPLAY g_rec_b TO cnt1
     DISPLAY g_turn TO cnt1 
      ELSE 
        CALL i0222_set_data(p_start,g_turn)
        DISPLAY g_turn TO cnt1 
 END IF  
    LET g_cnt = 0
...
FUNCTION i0222_assign()
 ...
 DEFINE l_err    LIKE  type_file.chr1000
   ...
   OPEN WINDOW i0222_w1 WITH FORM "ghr/42f/ghri0221"
  ...
  # LET g_hrbf.hrbf10 = g_today
   ...
   WHILE TRUE
      ...
      INPUT BY NAME g_hrbf.hrbf03,g_hrbf.hrbf04,g_hrbf.hrbf05,
        ...
        AFTER FIELD hrbf04
           IF NOT cl_null(g_hrbf.hrbf04) THEN
           	  CALL i0222_hrbf04() RETURNING l_des
      ...
      IF INT_FLAG THEN
         LET INT_FLAG = 0 CLOSE WINDOW i0222_w1 
         RETURN
      END IF  
      EXIT WHILE  
   END WHILE
...
#      	 END IF 
   ...
   CLOSE WINDOW i0222_w1
   CALL i0222_b_fill(g_wc2,'')
END FUNCTION


FUNCTION i0222_hrbf04()
   ...
   RETURN l_hrbe02
END FUNCTION
FUNCTION i0222_set_data(l_cnt,l_turn)
...
FUNCTION i0222_tz()  #add by shenran NO.130707
   ...
   END INPUT
    ...
    CALL i0222_b_fill(g_wc2,l_cnt)
END FUNCTION
#add by zhuzw 20141110 start
FUNCTION i0222_relet()
		DEFINE l_jump2    LIKE type_file.num10
	  DEFINE l_turn   LIKE type_file.num10
	  DEFINE l_cnt      LIKE type_file.num10
