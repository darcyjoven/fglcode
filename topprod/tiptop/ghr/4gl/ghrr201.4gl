...
#
# Pattern name...: ghrr201.4gl
# Descriptions...: 员工学历统计表
...
MAIN
   ...
   LET g_sql ="tc_hrat01.tc_hrat_file.tc_hrat01,",
              ...
              "hrat22_1.type_file.num5,",
              "hrat22_2.type_file.num5,",
              "hrat22_3.type_file.num5,",
              "hrat22_4.type_file.num5,",              
              "hrat22_5.type_file.num5,",              
              "hrat22_6.type_file.num5,",                            
              "hrat22_hj.type_file.num5"                                          
              
   LET l_table = cl_prt_temptable('ghrr201',g_sql) CLIPPED
...
DEFINE p_row,p_col    LIKE type_file.num5,        #No.FUN-680121 SMALLINT
  ...
  OPEN WINDOW ghrr201_w AT p_row,p_col WITH FORM "ghr/42f/ghrr201"
...
FUNCTION ghrr201()
   DEFINE l_name    LIKE type_file.chr20,             #No.FUN-680121 VARCHAR(20)# External(Disk) file name
          ...
          sr        RECORD
                     ...
                     hrat22_1 LIKE type_file.num5,
                     hrat22_2 LIKE type_file.num5,
                     hrat22_3 LIKE type_file.num5,
                     hrat22_4 LIKE type_file.num5,              
                     hrat22_5 LIKE type_file.num5,              
                     hrat22_6 LIKE type_file.num5,                            
                     hrat22_hj LIKE type_file.num5  
                    END RECORD
...
--
   ...
   LET l_sql = "select tc_hrat01,tc_hrat02,hrat21,sum(c.n1),sum(c.n2),sum(c.n3),sum(c.n4),sum(c.n5),sum(c.n6),0 from ", 
               " (select tc_hrat01,tc_hrat02,hrat21,hrat22,",
               " case when hrat22='001' then count(*) else 0 end as n1,", 
               " case when hrat22='002' then count(*) else 0 end as n2,",                
               " case when hrat22='003' then count(*) else 0 end as n3,",
               " case when hrat22='004' or hrat22='011' then count(*) else 0 end as n4,",
               " case when hrat22='005' or hrat22='008' or hrat22='009' or hrat22='010' then count(*) else 0 end as n5,",
               " case when  hrat22='006' or hrat22='007' or hrat22='012' then count(*) else 0 end as n6,",
               " 0 ",
               " from tc_hrat_file,hrao_file where (hrat20<>'001' and hrat20<>'007') and hrat04=hrao01 and tc_hrat01=",tm.s_year," and ",tm.wc,
               " group by tc_hrat01,tc_hrat02,hrat21,hrat22) c ",
               " group by tc_hrat01,tc_hrat02,hrat21 ",
               " order by tc_hrat01,tc_hrat02,hrat21 "
      ...
      FOREACH r100_curs INTO sr.*
          ...
          LET sr.hrat22_hj=sr.hrat22_1+sr.hrat22_2+sr.hrat22_3+sr.hrat22_4+sr.hrat22_5+sr.hrat22_6  
            
          EXECUTE insert_prep USING sr.*
      END FOREACH

    LET l_rep_name="ghr/ghrr201.cpt&p2=",tm.s_year,"&p3=",tm.s_month  
