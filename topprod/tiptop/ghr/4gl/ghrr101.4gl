...
MAIN
   ...
   LET l_table = cl_prt_temptable('ghrr101',g_sql) CLIPPED
   ...
   IF cl_null(g_bgjob) OR g_bgjob = 'N' THEN        # If background job sw is off
      CALL ghrr101_tm(0,0)        # Input print condition
   ELSE
      CALL ghrr101()            # Read data and create out-file
   END IF
   CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690123
END MAIN
 
FUNCTION ghrr101_tm(p_row,p_col)
...
DEFINE p_row,p_col    LIKE type_file.num5,        #No.FUN-680121 SMALLINT
  ...
  OPEN WINDOW ghrr101_w AT p_row,p_col WITH FORM "ghr/42f/ghrr101"
  ...
  WHILE TRUE
    ...
    IF g_bgjob = 'Y' THEN
      ...
      CALL cl_cmdat('ghrr101',g_time,l_cmd)    # Execute cmd at later time
       END IF
       CLOSE WINDOW ghrr101_w
       CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690123
       EXIT PROGRAM
    END IF
...
FUNCTION ghrr101()
   ...
   LET l_sql = " select hrat01,hrat02,hrao02,hras04,hrat25,hrad03,sr01,sr02,sr04 as sr03,sr15 as sr04,sr03 as sr05,sr05+sr13 as sr06,sr06 as sr07,hrdxa08,sr07 as sr08,sr11 as sr09,sr09 as sr10,sr08 as sr11,sr14 as sr12,sr10 as sr13,hrdxa14,sr12 as sr14,sr18 as sr15,sr19 as sr16,sr20 as sr17,sr21 as sr18,sr17 as sr19,hrao01 as sr20",
                   ...
                   " where hrct_file.hrct03='30' and hrad03 not like '离职员工'",  
                   " AND ",tm.wc CLIPPED,""
                   
      PREPARE r100_p FROM l_sql 
      IF SQLCA.sqlcode != 0 THEN
         CALL cl_err('ghrr101_p:',SQLCA.sqlcode,1)
         CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690123
         EXIT PROGRAM
      END IF
    ...
    CALL cl_prt_cs3('ghrr101','ghrr101',l_sql,g_str)
