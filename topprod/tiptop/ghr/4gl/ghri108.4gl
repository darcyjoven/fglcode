...
#
# Pattern name...: ghri108.4gl
# Descriptions...: 币种维护
# Date & Author..: 2013-03-21  Jack 
...
DEFINE p_row,p_col   LIKE type_file.num5          #No.FUN-680102 SMALLINT
   ...
   END IF
    ...
    OPEN WINDOW i050_w AT p_row,p_col WITH FORM "ghr/42f/ghri108"  ATTRIBUTE (STYLE = g_win_style CLIPPED) #No.FUN-580092 HCN
