...
FUNCTION i009_b_askkey()
    ...
    CONSTRUCT g_wc2 ON hrax01,hrax02,hrax03,hrax04,hrax05,hrax11,hrax06,hrax07,
                       hrax09,hrax08,hrax14,hrax16,hrax17,hrax18,hrax19,hrax20                      
         FROM s_hrax[1].hrax01,s_hrax[1].hrax02,s_hrax[1].hrax03,                                  
              s_hrax[1].hrax04,s_hrax[1].hrax05,s_hrax[1].hrax11,s_hrax[1].hrax06,
              s_hrax[1].hrax07,s_hrax[1].hrax09,s_hrax[1].hrax08,
              s_hrax[1].hrax14,s_hrax[1].hrax16,
      ...
      ON ACTION CONTROLP
         CASE 
          ...
          WHEN INFIELD(hrax11)
               ...
               LET g_qryparam.state = "c"
               CALL cl_create_qry() RETURNING g_qryparam.multiret
               DISPLAY g_qryparam.multiret TO s_hrax[1].hrax11
               NEXT FIELD hrax11
           WHEN INFIELD(hrax04)
             CALL cl_init_qry_var()
...
FUNCTION i009_b_fill(p_wc2)              #BODY FILL UP
    ...
    FOREACH hrax_curs INTO g_hrax[g_cnt].*   
     ...
     SELECT hrad03 INTO g_hrax[g_cnt].hrax11 FROM hrad_file
      WHERE hrad02 = g_hrax[g_cnt].hrax11
     #证件类型
