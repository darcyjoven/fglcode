...
# Descriptions...: 加班计划批量维护作业
# Date & Author..: 16/09/26 By nihuan
...
MAIN
   ...
   DECLARE i053_cl CURSOR FROM g_forupd_sql                 #單頭Lock Cursor
      ...
      OPEN WINDOW i053_w WITH FORM "ghr/42f/ghri053_3"
  ...
  IF g_wc2 = " 1=1" THEN                  # 若單身未輸入條件
   ...
   ELSE                              # 若單身有輸入條件
      ...
      LET g_sql = "SELECT UNIQUE hrcm_file. hrcm02 ", # modify by cqz 140815 hrcm01->hrcm02
                  ...
                  "   AND ", g_wc CLIPPED, " ",g_wc2 CLIPPED,
                  " ORDER BY hrcm02"
...
FUNCTION i053_a()
   ...
   WHILE TRUE
      LET g_hrcma_1.hrcma04 =  g_today          
      LET g_hrcma_1.hrcma05 =  '00:00'         
      LET g_hrcma_1.hrcma06 =  g_today    
      LET g_hrcma_1.hrcma07 =  '00:00'    
      LET g_hrcm.hrcm01 =  '1000'     
      LET g_hrcma_1.hrcma12 = 'N'
...
DEFINE l_string,g_x   STRING    
          
   IF s_shut(0) THEN
      RETURN
   END IF
 
   DISPLAY BY NAME g_hrcm.hrcmuser,g_hrcm.hrcmmodu,g_hrcm.hrcmgrup,g_hrcm.hrcmdate,g_hrcm.hrcmacti,g_hrcm.hrcmconf,g_hrcm.hrcm01
  ...
  DISPLAY l_hrcm01_desc TO hrcm01_desc 
   ...
   INPUT BY NAME g_hrcm.hrcm01,g_hrcm.hrcm02,g_hrcm.hrcm03,
                 ...
                 g_hrcma_1.hrcma04,g_hrcma_1.hrcma05,g_hrcma_1.hrcma06,g_hrcma_1.hrcma07,g_hrcma_1.hrcma08,
                 g_hrcma_1.hrcma09,g_hrcma_1.hrcma12,g_hrcma_1.hrcma10
       WITHOUT DEFAULTS
...
#add by lijun130905-----end------
      ...
      AFTER FIELD hrcm02
         ...
         AFTER FIELD hrcma07
            IF NOT cl_null(g_hrcma_1.hrcma07) THEN
               LET g_h=''
               LET g_m=''
               LET g_h=g_hrcma_1.hrcma07[1,2]
               LET g_m=g_hrcma_1.hrcma07[4,5]
               LET g_x = g_hrcma_1.hrcma07
               IF cl_null(g_h) OR cl_null(g_m) OR g_h>23 OR g_m>59 THEN
                  CALL cl_err('时间录入错误','!',0)
                  NEXT FIELD hrcma07
               END IF
              IF g_hrcma_1.hrcma07[1] =' ' OR g_hrcma_1.hrcma07[2] =' '  OR 
               g_hrcma_1.hrcma07[4] =' ' OR g_hrcma_1.hrcma07[5] =' ' OR g_x.getLength() <>5 THEN
                   CALL cl_err('时间录入错误','!',0)
                  NEXT FIELD hrcma07
               END IF
              IF g_hrcma_1.hrcma06  = g_hrcma_1.hrcma04 AND g_hrcma_1.hrcma05 > g_hrcma_1.hrcma07 THEN
                  CALL cl_err('','ghr-120',0)
                  NEXT FIELD hrcma07
              END IF 
              IF NOT cl_null(g_hrcma_1.hrcma04) AND NOT cl_null(g_hrcma_1.hrcma05)
                 AND NOT cl_null(g_hrcma_1.hrcma06) THEN
                 LET l_hrcma04_05 = g_hrcma_1.hrcma04 CLIPPED,' ',g_hrcma_1.hrcma05 CLIPPED
                 LET l_hrcma06_07 = g_hrcma_1.hrcma06 CLIPPED,' ',g_hrcma_1.hrcma07 CLIPPED
                 LET l_hrcma08 = ''
                 SELECT TO_NUMBER(to_date(l_hrcma06_07,'YYYY/MM/DD HH24:MI') - to_date(l_hrcma04_05,'YYYY/MM/DD HH24:MI')) * 24 INTO l_hrcma08 from dual;   	
               	 ...
               	 IF l_hrcma08 > 0 THEN
               	     LET g_hrcma_1.hrcma08 = l_hrcma08
               	     DISPLAY g_hrcma_1.hrcma08 TO hrcma08
               	 ELSE
        ...
        AFTER FIELD hrcma05
            IF NOT cl_null(g_hrcma_1.hrcma05) THEN
               LET g_h=''
               LET g_m=''
               LET g_h=g_hrcma_1.hrcma05[1,2]
               LET g_m=g_hrcma_1.hrcma05[4,5]
               LET g_x = g_hrcma_1.hrcma05
               IF cl_null(g_h) OR cl_null(g_m) OR g_h>23 OR g_m>59 THEN
                  CALL cl_err('时间录入错误','!',0)
                  NEXT FIELD hrcma05
               END IF
              IF g_hrcma_1.hrcma05[1] =' ' OR g_hrcma_1.hrcma05[2] =' '  OR      
               g_hrcma_1.hrcma05[4] =' ' OR g_hrcma_1.hrcma05[5] =' ' OR g_x.getLength() <> 5  THEN 
                  CALL cl_err('时间录入错误','!',0)
                  NEXT FIELD hrcma05
               END IF
           END IF     
        ...
        AFTER FIELD hrcma09
             IF NOT cl_null(g_hrcma_1.hrcma09) THEN
#               SELECT COUNT(*) INTO l_count FROM hrbm_file 
#                WHERE hrbm07 ='Y' AND hrbm02  ='008' AND hrbm01=g_hrcm.hrcm01 AND hrbm03 = g_hrcma_1.hrcma09
#               IF cl_null(l_count) THEN LET l_count = 0  END IF
#               IF l_count <=0 THEN  
#                  CALL cl_err('','mfg1306',1)
#                  NEXT FIELD hrcma09 
#               END IF
               SELECT hrbm04,hrbm23 INTO g_hrcma_1.hrbm04,g_hrcma_1.hrcma12 FROM hrbm_file
                WHERE hrbm07 ='Y' AND hrbm02  ='008'  AND hrbm03 = g_hrcma_1.hrcma09
                DISPLAY g_hrcma_1.hrbm04 TO hrbm04
                DISPLAY g_hrcma_1.hrcma12 TO hrcma12
             END IF
      ...
      ON ACTION controlp
         CASE
           ...
           WHEN INFIELD(hrcma09)
                 ...
                 LET g_qryparam.form ="q_hrbm03"
                 LET g_qryparam.arg1 = '008'
                 LET g_qryparam.default1 = g_hrcma_1.hrcma09
                 CALL cl_create_qry() RETURNING g_hrcma_1.hrcma09
                 DISPLAY BY NAME  g_hrcma_1.hrcma09  
            OTHERWISE EXIT CASE
          END CASE
...
FUNCTION i053_fetch(p_flag)
   ...
   SELECT DISTINCT hrcma04,hrcma05,hrcma06,hrcma07,hrcma08,hrcma09,'',hrcma12 INTO g_hrcma_1.* FROM hrcma_file WHERE hrcma02=g_hrcm.hrcm02
...
FUNCTION i053_show()
  ...
  DISPLAY BY NAME g_hrcm.hrcm01,g_hrcm.hrcm02,g_hrcm.hrcm03,
                   ...
                   g_hrcma_1.hrcma04,g_hrcma_1.hrcma05,g_hrcma_1.hrcma06,g_hrcma_1.hrcma07,g_hrcma_1.hrcma08,
                   g_hrcma_1.hrcma09,g_hrcma_1.hrcma12
   SELECT hraa02 INTO l_hraa02 FROM hraa_file WHERE hraa01 = g_hrcm.hrcm01  AND hraaacti ='Y' 
   DISPLAY l_hraa02 TO hrcm01_desc
   SELECT hrbm04 INTO g_hrcma_1.hrbm04 FROM hrbm_file
   WHERE hrbm07 ='Y' AND hrbm02  ='008'  AND hrbm03 = g_hrcma_1.hrcma09
   DISPLAY BY NAME g_hrcma_1.hrbm04
...
DEFINE l_string   STRING       
   ...
   END IF 
    ...
    LET g_forupd_sql = "SELECT hrcma01,hrcma03,'','','','',hrcma14,hrcma15,hrcma16",
                       "  FROM hrcma_file",
...
#           CALL i053_set_no_entry_b(p_cmd) #No.FUN-610018
        ...
        AFTER INSERT
           ...
           SELECT COUNT(*) INTO l_n FROM hrcma_file WHERE hrcma02 =  g_hrcm.hrcm02 AND hrcma03 =l_hratid
           IF l_n = 0 THEN  
           ...
           INSERT INTO hrcma_file(hrcma01,hrcma02,hrcma03,hrcma04,hrcma05,hrcma06,
                                hrcma07,hrcma08,hrcma09,hrcma11,hrcma12,hrcma14,hrcma15,ta_hrcma01,hrcma10) 
           VALUES(g_hrcma[l_ac].hrcma01,g_hrcm.hrcm02,
                  l_hratid,g_hrcma_1.hrcma04,
                  g_hrcma_1.hrcma05,g_hrcma_1.hrcma06,
                  g_hrcma_1.hrcma07,g_hrcma_1.hrcma08,
                  g_hrcma_1.hrcma09,'N',
                  g_hrcma_1.hrcma12,'Y','N','N',g_hrcma_1.hrcma10)  #FUN-650191 add hrcma12 #FUN-980006 add g_plant,g_legal
        ...
        ON ROW CHANGE
           ...
           #add by nihuan 20160901   
              UPDATE hrcma_file SET hrcma03=l_hratid_tt,
                                  hrcma04=g_hrcma_1.hrcma04,
                                  hrcma05=g_hrcma_1.hrcma05,
                                  hrcma06=g_hrcma_1.hrcma06,
                                  hrcma07=g_hrcma_1.hrcma07,
                                  hrcma08=g_hrcma_1.hrcma08,
                                  hrcma09=g_hrcma_1.hrcma09, 
                                  hrcma12=g_hrcma_1.hrcma12,
                                  hrcma10 =g_hrcma_1.hrcma10 
               WHERE hrcma02=g_hrcm.hrcm02
                 AND hrcma01=g_hrcma_t.hrcma01
...
FUNCTION i053_pl()
    DEFINE l_wc2,l_sql           STRING    #TQC-630166   
    DEFINE l_hrcma_hrcma02   LIKE hrcma_file.hrcma02
    DEFINE l_a               LIKE type_file.num5
    DEFINE l_hratid          LIKE hrat_file.hratid
    DEFINE l_count           LIKE type_file.num5    
    
    CONSTRUCT l_wc2 ON hrcma03
        FROM  s_hrcma[1].hrcma03
    ...
    IF l_wc2 IS NULL THEN 
#     LET l_wc2='1=1'
       RETURN 
    END IF 
    LET l_wc2=cl_replace_str(l_wc2,"hrcma03","hrat01")
    LET g_sql = "SELECT distinct hrat01",
                "  FROM hrat_file",
                " WHERE hratconf ='Y'",
                "   AND ",l_wc2 CLIPPED,
                " ORDER BY 1"
    PREPARE i213_pb1_1 FROM g_sql
    DECLARE hrcma_curs1_1 CURSOR WITH HOLD FOR i213_pb1_1
 
#    CALL g_hrcma.clear()

     SELECT COUNT(*) INTO l_a FROM hrcma_file WHERE hrcma02=g_hrcm.hrcm02
     IF l_a=0 THEN 
        LET l_a = 1 
        ELSE LET l_a=l_a+1
     END IF 
     
      FOREACH hrcma_curs1_1 INTO g_hrcma[l_a].hrcma03
       IF STATUS THEN CALL cl_err('foreach:',STATUS,1) EXIT FOREACH END IF
       SELECT hratid INTO l_hratid FROM hrat_file WHERE hrat01 = g_hrcma[l_a].hrcma03
       CALL i053_hrat_fill(l_hratid) 
       RETURNING  g_hrcma[l_a].hrat02,g_hrcma[l_a].hrat04,g_hrcma[l_a].hrat20,g_hrcma[l_a].hrat25
       SELECT hrag07 INTO g_hrcma[l_a].hrat20 FROM hrag_file WHERE hrag01='313' AND hrag06=g_hrcma[l_a].hrat20 AND hragacti='Y'

       LET l_sql="SELECT COUNT(*)  FROM hrcma_file WHERE hrcma03 = '",l_hratid,"' AND (
       (hrcma04 = to_date('",g_hrcma_1.hrcma04,"','yy/mm/dd')    AND hrcma06 = to_date('",g_hrcma_1.hrcma06,"','yy/mm/dd') AND hrcma05 <= '",g_hrcma_1.hrcma05,"'  AND hrcma07 > '",g_hrcma_1.hrcma05,"')
       OR(hrcma04 = to_date('",g_hrcma_1.hrcma04,"','yy/mm/dd')  AND hrcma06 = to_date('",g_hrcma_1.hrcma06,"','yy/mm/dd') AND hrcma05 < '",g_hrcma_1.hrcma07,"'  AND hrcma07 >= '",g_hrcma_1.hrcma07,"') 
       OR(hrcma04 = to_date('",g_hrcma_1.hrcma04,"','yy/mm/dd')  AND hrcma06 = to_date('",g_hrcma_1.hrcma06,"','yy/mm/dd') AND hrcma05 <= '",g_hrcma_1.hrcma05,"'  AND hrcma07 >= '",g_hrcma_1.hrcma07,"')
       OR(hrcma04 = to_date('",g_hrcma_1.hrcma04,"','yy/mm/dd')  AND hrcma06 = to_date('",g_hrcma_1.hrcma06,"','yy/mm/dd') AND hrcma05 >= '",g_hrcma_1.hrcma05,"'  AND hrcma07 <= '",g_hrcma_1.hrcma07,"')   
        ) "
       PREPARE i053_pl FROM l_sql
       EXECUTE i053_pl INTO l_count 
        
       IF l_count > 0 THEN 
          CALL cl_err('','ghr-128',0)
          CONTINUE FOREACH 
       ELSE 
       CALL i053_auto_hrcma01() RETURNING g_hrcma[l_a].hrcma01
       INSERT INTO hrcma_file(hrcma01,hrcma02,hrcma03,hrcma04,hrcma05,hrcma06,
                            hrcma07,hrcma08,hrcma09,hrcma11,hrcma12,hrcma14,hrcma15,ta_hrcma01,hrcma10) 
       VALUES(g_hrcma[l_a].hrcma01,g_hrcm.hrcm02,
              l_hratid,g_hrcma_1.hrcma04,
              g_hrcma_1.hrcma05,g_hrcma_1.hrcma06,
              g_hrcma_1.hrcma07,g_hrcma_1.hrcma08,
              g_hrcma_1.hrcma09,'N',
              g_hrcma_1.hrcma12,'Y','N','N',g_hrcma_1.hrcma10)  #FUN-650191 add hrcma12 #FUN-980006 add g_plant,g_legal
       IF SQLCA.sqlcode THEN
          CALL cl_err3("ins","hrcma_file",g_hrcm.hrcm02,g_hrcma[l_a].hrcma03,SQLCA.sqlcode,"","",1)  #No.FUN-660129
          CONTINUE FOREACH 
       ELSE
          MESSAGE 'INSERT O.K'
          COMMIT WORK
       ...
       LET l_a=l_a+1
       IF l_a > g_max_rec THEN
          CALL cl_err( '', 9035, 0 )
          EXIT FOREACH
       END IF
    END FOREACH
    CALL g_hrcma.deleteElement(l_a)
END FUNCTION 
...
DEFINE  i        LIKE type_file.num5
   ...
   LET g_sql = " SELECT hrcma01,hrcma03,'','','','',hrcma14,hrcma15,hrcma16  FROM hrcma_file,hrat_file",
               " WHERE hratid=hrcma03 AND hrcma02 ='",g_hrcm.hrcm02,"' "   #單頭
 
   IF NOT cl_null(p_wc2) THEN
      LET g_sql=g_sql CLIPPED,"  ",p_wc2 CLIPPED
   END IF
