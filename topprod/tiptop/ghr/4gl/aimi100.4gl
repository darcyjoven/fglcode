...
# Modify.........: No:CHI-B70001 11/07/27 By Vampire 當料件做廢時，判斷是否為有效且未結案請購單，若有則不允許做無效
# Modify.........: No.FUN-B80032 11/08/08 By yangxf ima_file 更新揮寫rtepos
# Modify.........: No.FUN-B50096 11/08/11 By lixh1 所有入庫程式應該要加入可以依料號設置"批號(倉儲批的批)是否為必要輸入欄位"的選項
# Modify.........: No:MOD-B90017 11/09/02 By Vampire 當資料拋轉後，執行複製功能，需重新撈取資料
# Modify.........: No:CHI#B80043 11/09/02 By Vampire 需先判斷料建是否存在於rvbs_file 
...
#No.FUN-A50011  ------end------
                              ...
                              # ima905,ima24,ima911,ima022,ima251,ima07,ima70,ima37,ima51,ima52,   #FUN-610080 加ima911  #FUN-A20037 add ima022,ima251  #TQC-AC0185 mark
                                ima24,ima911,ima109,ima022,ima251,ima07,ima70,ima37,ima51,ima52,   #TQC-AC0185
                                ...
                                ima12,ima39,ima391,ima149,ima1491,ima15,ima146,ima16,ima905,ima09,  #FUN-680034 #FUN-960141      #TQC-AC0185 add ima905
                                ima10,ima11,
                                ima1001,ima1002,ima1012,ima1013,#No.FUN-640010
                                ima1015,ima1014,ima1016,#No.FUN-640010
...
#  LET g_d2=g_ima.ima262-g_ima.ima26      #FUN-A20044
   ...
   INPUT BY NAME g_ima.imaoriu,g_ima.imaorig,
      ...
      # g_ima.ima109,g_ima.ima903, g_ima.ima905,g_ima.ima24,g_ima.ima911,   #FUN-610080 加ima911    #TQC-AC0185 mark 
        ...
        g_ima.ima906,g_ima.ima907,g_ima.ima908,g_ima.ima159,  #FUN-540025  #FUN-B50096 add ima159
        ...
        g_ima.ima1015, g_ima.ima1014,g_ima.ima1016,   #No.FUN-640010
...
#                  g_ima.ima902 ,g_ima.ima37  ,g_ima.ima51  ,               #No.FUN-8C0131 
                   ...
                   g_ima.ima1013,g_ima.ima1015,g_ima.ima1014,
...
FUNCTION i100_set_no_entry(p_cmd)
   ...
   IF p_cmd = 'u' AND g_chkey = 'N' AND ( NOT g_before_input_done ) THEN
       CALL cl_set_comp_entry("ima01,ima940,ima941,ima151,imaag",FALSE) 
   END IF
...
FUNCTION i100_set_rel_ima06()
  DEFINE
    ...
    SELECT imz01,imz02,imz03 ,imz04,
           ...
           imz022,imz251,imz159                #FUN-B30092 add   #FUN-B50096 add imz159
      ...
      INTO g_ima.ima06,l_imz02,g_ima.ima03,g_ima.ima04,
           ...
           g_ima.ima156,g_ima.ima157,g_ima.ima158,               #FUN-A80150 add
           g_ima.ima022,g_ima.ima251,g_ima.ima159                #FUN-B30092 add    #FUN-B50096 add ima159
           FROM  imz_file
           WHERE imz01 = g_ima.ima06
