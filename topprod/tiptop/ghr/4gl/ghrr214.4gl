...
DEFINE g_hrat21    STRING
DEFINE g_hraoud02  STRING 
...
MAIN
   ...
   LET g_sql =               
      "col01.hrat_file.hrat01,",
      "col02.hrat_file.hrat02,",
      "col03.hrao_file.hrao02,",
      "col04.type_file.num5,",
      "col05.hrat_file.hrat25,",
      "col06.hrbh_file.hrbh04,",
      "col07.hrat_file.hrat25,",
      "col08.hrbh_file.hrbh04,",
      "col09.hrat_file.hrat25,",
      "col10.type_file.num15_3"
      
      
   LET l_table = cl_prt_temptable('ghrr214',g_sql) CLIPPED
   ...
   IF cl_null(g_bgjob) OR g_bgjob = 'N' THEN        # If background job sw is off
      CALL ghrr214_tm(0,0)        # Input print condition
   ELSE
      CALL ghrr214()            # Read data and create out-file
   END IF
   CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690123
END MAIN
 
FUNCTION ghrr214_tm(p_row,p_col)
...
DEFINE p_row,p_col    LIKE type_file.num5,        #No.FUN-680121 SMALLINT
  ...
  OPEN WINDOW ghrr214_w AT p_row,p_col WITH FORM "ghr/42f/ghrr214"
  ...
  LET g_copies = '1'
  WHILE TRUE
    CONSTRUCT BY NAME tm.wc ON hrat04,hrat21,hraoud02
       ...
       ON ACTION controlp
          CASE 
              ...
              WHEN INFIELD(hrat21)
                 ...
                 LET g_hrat21=g_qryparam.multiret
                 NEXT FIELD hrat21   
              ...
              WHEN INFIELD(hraoud02)
                 ...
                 LET g_hraoud02=g_qryparam.multiret
                 NEXT FIELD hraoud02   
  ...
  # DISPLAY BY NAME tm.l_year                 
    ...
    IF g_bgjob = 'Y' THEN
      ...
      CALL cl_cmdat('ghrr214',g_time,l_cmd)    # Execute cmd at later time
       END IF
       CLOSE WINDOW ghrr214_w
       CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690123
       EXIT PROGRAM
    END IF
...
FUNCTION ghrr214()
   DEFINE l_name    LIKE type_file.chr20,             #No.FUN-680121 VARCHAR(20)# External(Disk) file name
          ...
          l_rep_name STRING ,
          sr        RECORD
      col01 LIKE hrat_file.hrat01,
      col02 LIKE hrat_file.hrat02,
      col03 LIKE hrao_file.hrao02,
      col04 LIKE type_file.num5,
      col05 LIKE hrat_file.hrat25,
      col06 LIKE hrbh_file.hrbh04,
      col07 LIKE hrat_file.hrat25,
      col08 LIKE hrbh_file.hrbh04,
      col09 LIKE hrat_file.hrat25,
...
{   SELECT hrbl04,hrbl05 INTO tm.l_year,tm.l_month
   ...
   IF cl_null(tm.wc) THEN
    ...
    END IF  
  #如果是萧山或海宁基地并且直接员工，否则。
  IF (g_hraoud02.subString(1,3)='001' OR  g_hraoud02.subString(1,3)='002') AND g_hrat21.subString(1,3)='001' THEN 
     LET l_sql = " select hrat01,hrat02,hrao02,1,hrat25,'','','','',trunc((to_date('",tm.l_date,"','yyyy-mm-dd')-hrat25)/365,2) as siling  from hrat_file,hrao_file ",
       " where hrat04=hrao01 and ",tm.wc," and hrat19 in('006','1001','2001') order by hrat25"
   ELSE
     LET l_sql = "  "
   ...
   END IF 
      ...
      IF SQLCA.sqlcode != 0 THEN
         CALL cl_err('ghrr214_p:',SQLCA.sqlcode,1)
         CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690123
         EXIT PROGRAM
      END IF
    ...
    LET l_rep_name="ghr/ghrr214.cpt&p2=",tm.l_date #,"&p3=",tm.l_month     
