...
MAIN
   ...
   LET l_table = cl_prt_temptable('cghrr001',g_sql) CLIPPED
...
DEFINE p_row,p_col    LIKE type_file.num5,        #No.FUN-680121 SMALLINT
  ...
  OPEN WINDOW cghrr001_w AT p_row,p_col WITH FORM "ghr/42f/cghrr001"
...
FUNCTION cghrr001()
   ...
   LET l_sql = "  SELECT hrao02,hrat01,hrat02,hrat21,                                                                  ",                                  
    ...
    LET l_rep_name="ghr/cghr001.cpt&p1=",s_year,"&p2=",s_month    
