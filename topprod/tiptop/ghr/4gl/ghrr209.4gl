...
#
# Pattern name...: ghrr209.4gl
# Descriptions...: 
# Date & Author..: 15/01/21   by shenran
#xie150416
DATABASE ds
...
MAIN
   ...
   LET g_sql ="hrat01.hrat_file.hrat01,",
              ...
              "day1.type_file.num5,",
              "salary.hrde_file.hrdeud02"              
              

   LET l_table = cl_prt_temptable('ghrr209',g_sql) CLIPPED
   ...
   IF cl_null(g_bgjob) OR g_bgjob = 'N' THEN        # If background job sw is off
      CALL ghrr209_tm(0,0)        # Input print condition
   ELSE
      CALL ghrr209()            # Read data and create out-file
   END IF
   CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690123
END MAIN
 
FUNCTION ghrr209_tm(p_row,p_col)
...
DEFINE p_row,p_col    LIKE type_file.num5,        #No.FUN-680121 SMALLINT
  ...
  OPEN WINDOW ghrr209_w AT p_row,p_col WITH FORM "ghr/42f/ghrr209"
  ...
  WHILE TRUE
    ...
    IF g_bgjob = 'Y' THEN
      ...
      CALL cl_cmdat('ghrr209',g_time,l_cmd)    # Execute cmd at later time
       END IF
       CLOSE WINDOW ghrr209_w
       CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690123
       EXIT PROGRAM
    END IF
...
FUNCTION ghrr209()
   DEFINE l_name    LIKE type_file.chr20,             #No.FUN-680121 VARCHAR(20)# External(Disk) file name
          ...
          sr        RECORD
                     ...
                     day1   LIKE type_file.num5,
                     salary LIKE hrde_file.hrdeud02
                    END RECORD
  ...
  #xie150416
   LET l_sql = " select distinct hrat01,hrat02,hrao02,hras04,hrat25,hrat26,h,hrag07||hrdeud02  from (select hratid,hrat01,hrat02,hrao02,hras04,hrat25,hrat26,floor(hrat26-hrat25) h  from hrat_file,hrao_file,hras_file  ",
               " where hrat04=hrao01 and hrat05=hras01 ",
               " and (hrat20<>'001' and hrat20<>'007') and hrat25 <=to_date('",tm.l_day,"','YYYY/MM/DD') and hrat25 >=to_date('",tm.l_last_day,"','YYYY/MM/DD')) hh ",
               " left join hrdp_file on hratid=hrdp04 ", 
               " left join hrag_file on hrag06=hrdpud02 and hrag01='649'  ",      
               " left join hrde_file on hrde05=hrdpud03 and hrde03=hrdpud02 ",
               " order by hrat25 "

                   
      PREPARE r100_p FROM l_sql 
      IF SQLCA.sqlcode != 0 THEN
         CALL cl_err('ghrr209_p:',SQLCA.sqlcode,1)
      ...
      FOREACH r100_curs INTO sr.*
           ...
           LET sr.day1=sr.hrat26-sr.hrat25

           select hrdeud02 INTO sr.salary from hrdp_file,hrde_file where hrdpud02=hrde03 
            and hrdpud03=hrde05 and hrdpud02=hrde03 AND hrdp04=sr.hrat01 AND hrdpud13<=tm.l_day
            ORDER BY hrdpud13
                            
            EXECUTE insert_prep USING sr.*
      END FOREACH

    LET l_rep_name="ghr/ghrr209.cpt&p2=",tm.s_year,"&p3=",tm.s_month  
