...
#
# PATTERN NAME...: abat610
# DESCRIPTIONS...: 出貨配貨單維護作業
...
MAIN
   ...
   #OPEN WINDOW t610_w AT p_row,p_col WITH FORM "aba/42f/abat610"
   #      ATTRIBUTE (STYLE = g_win_style CLIPPED) 
   #CALL cl_ui_init()
   #DEV-CA0017--mark--end

    CALL sabat600('1',g_argv1)
   #CLOSE WINDOW t610_w                  #結束畫面 #DEV-CA0017--mark
