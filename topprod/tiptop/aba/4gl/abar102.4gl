...
#     DEFINE   l_time LIKE type_file.chr8     #No.FUN-6A0074
   ...
   END IF
    ...
    OPEN WINDOW abar102_w AT p_row,p_col
         WITH FORM "aba/42f/abar102"
...
FUNCTION q102_b_fill()              #BODY FILL UP
 ...
 #IF g_tc_ibb_m.chk1 = 'N' THEN 
   LET l_sql ="SELECT tc_ibb06,ima02,ima021,ima25,tc_ibb21,tc_ibb05,tc_ibb07,tc_ibb17,tc_ibb01,'Y' ",
                  "  FROM tc_ibb_file ",
...
DEFINE l_ima21 LIKE ima_file.ima21
...
#取条码档数据
    LET g_sql = "ima02.ima_file.ima02,    ",      #工单编号                                        #建立临时表的表结构  改程序的时候这里需要增加栏
  ...
  # LET l_str = l_str,"pm;gg;ph;qty;barcode_no\n"
    ...
    END FOR 
         ...
         CALL cl_prt_cs3('abar102','abar102',g_sql,g_str)
