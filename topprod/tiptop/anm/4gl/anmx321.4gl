...
# Modify.........: No.FUN-D40129 13/05/15 By yangtt 1、nma04，nma10欄位新增開窗
#                                                   2、報表下方顯示打印條件 
...
GLOBALS "../../config/top.global"
   ...
   DEFINE tm  RECORD
              wc      STRING,    #TQC-63016   #No.TQC-D40018
...
MAIN
   ...
   LET l_table = cl_prt_temptable('anmx321',g_sql) CLIPPED   # 產生Temp Table
   ...
   IF cl_null(g_bgjob) OR g_bgjob = 'N'
      THEN CALL x321_tm(0,0)
      ELSE CALL x321()
   END IF
   CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690117
END MAIN
 
FUNCTION x321_tm(p_row,p_col)
   DEFINE p_row,p_col  LIKE type_file.num5,       #No.FUN-680107 SMALLINT
          l_cmd        LIKE type_file.chr1000     #No.FUN-680107 VARCHAR(400)
 
   LET p_row = 4 LET p_col = 16
   OPEN WINDOW x321_w AT p_row,p_col
        WITH FORM "anm/42f/anmx321"
...
#No.FUN-A30106  --end  
 ...
 END CONSTRUCT
   ...
   IF INT_FLAG THEN
      LET INT_FLAG = 0 CLOSE WINDOW x321_w 
      CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690117
      EXIT PROGRAM
...
#     ON ACTION CONTROLP CALL x321_wc()      # Input detail Where Condition
    AFTER INPUT
   ...
   IF g_bgjob = 'Y' THEN
      ...
      ELSE
         ...
         CALL cl_cmdat('anmx321',g_time,l_cmd)
      END IF
      CLOSE WINDOW x321_w
      CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690117
      EXIT PROGRAM
...
#         l_time    LIKE type_file.chr8            #No.FUN-6A0082
     ...
     LET l_sql = "SELECT nma01,nma02,nma10,0,0,0,0 FROM nma_file",
                 " WHERE ", tm.wc CLIPPED
     PREPARE x321_prepare1 FROM l_sql
     ...
     END IF
     DECLARE x321_curs1 CURSOR FOR x321_prepare1
#    LET l_name = 'anmx321.out'
 
     LET g_pageno = 0
     FOREACH x321_curs1 INTO sr.*
       IF SQLCA.sqlcode != 0 THEN
...
###XtraGrid###        LET g_str = tm.wc
     END IF
###XtraGrid###     CALL cl_prt_cs3('anmx321','anmx321',l_sql,g_str)   #FUN-710080 modify
    LET g_xgrid.table = l_table    ###XtraGrid###
    LET g_xgrid.order_field = "nma01"
