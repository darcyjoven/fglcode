...
MAIN
   ...
   LET l_table = cl_prt_temptable('anmg150',g_sql) CLIPPED
   IF l_table = -1 THEN 
   ...
   IF cl_null(tm.wc) THEN
      CALL anmg150_tm(0,0)             # Input print condition
   ELSE 
      CALL anmg150()                   # Read data and create out-file
   END IF
   CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690117
   CALL cl_gre_drop_temptable(l_table)
END MAIN
 
FUNCTION anmg150_tm(p_row,p_col)
DEFINE lc_qbe_sn      LIKE gbm_file.gbm01           #No.FUN-580031
   ...
   OPEN WINDOW anmg150_w AT p_row,p_col
        WITH FORM "anm/42f/anmg150"
...
WHILE TRUE
 ...
 END CONSTRUCT
   ...
   IF INT_FLAG THEN
      LET INT_FLAG = 0 CLOSE WINDOW anmg150_w 
      CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690117
      CALL cl_gre_drop_temptable(l_table)
      EXIT PROGRAM
   ...
   IF g_bgjob = 'Y' THEN
      ...
      ELSE
         ...
         CALL cl_cmdat('anmg150',g_time,l_cmd)    # Execute cmd at later time
      END IF
      CLOSE WINDOW anmg150_w
      CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690117
      CALL cl_gre_drop_temptable(l_table)
      EXIT PROGRAM
   END IF
...
#No.FUN-580010  --begin
##    SELECT zz17,zz05 INTO g_len,g_zz05 FROM zz_file WHERE zz01 = 'anmg150'
...
#NO.CHI-6A0004--END
     ...
     PREPARE anmg150_prepare1 FROM l_sql
     IF STATUS THEN CALL cl_err('prepare:',STATUS,1) 
        CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690117
        CALL cl_gre_drop_temptable(l_table)
        EXIT PROGRAM 
     END IF
     DECLARE anmg150_curs1 CURSOR FOR anmg150_prepare1
 
#    CALL cl_outnam('anmg150') RETURNING l_name  #No.FUN-710085 mark
#    START REPORT anmg150_rep TO l_name          #No.FUN-710085 mark

     LET g_pageno = 0
#    FOREACH anmg150_curs1 INTO sr.*     #FUN-C50007  mark
     FOREACH anmg150_curs1 INTO sr.* ,t_azi04,t_azi05,t_azi07  #FUN-C50007
...
#      OUTPUT TO REPORT anmg150_rep(sr.*)  #No.FUN-710085 mark
     END FOREACH
 
#    FINISH REPORT anmg150_rep                    #No.FUN-710085 mark
...
FUNCTION anmg150_grdata()
    ...
    WHILE TRUE
        ...
        LET handler = cl_gre_outnam("anmg150")
        IF handler IS NOT NULL THEN
            START REPORT anmg150_rep TO XML HANDLER handler
            LET l_sql = "SELECT * FROM ",g_cr_db_str CLIPPED,l_table CLIPPED,
                        " ORDER BY npl01,npm02"
            DECLARE anmg150_datacur1 CURSOR FROM l_sql
            FOREACH anmg150_datacur1 INTO sr1.*
                OUTPUT TO REPORT anmg150_rep(sr1.*)
            END FOREACH
            FINISH REPORT anmg150_rep
        END IF
