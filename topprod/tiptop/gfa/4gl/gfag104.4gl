...
# Modify.........: No.FUN-D10098 13/02/01 By lujh 新增gfag104
...
#No.FUN-710083 --begin
   ...
   LET l_table = cl_prt_temptable('gfag104',g_sql) CLIPPED
   IF l_table = -1 THEN 
...
#No.FUN-710083 --end
   IF cl_null(g_bgjob) OR g_bgjob = 'N'	# If background job sw is off
      ...
      ELSE CALL gfag104()		# Read data and create out-file
   END IF
...
DEFINE p_row,p_col    LIKE type_file.num5,         #No.FUN-680070 SMALLINT
   ...
   OPEN WINDOW g104_w AT p_row,p_col WITH FORM "gfa/42f/gfag104"
   ...
   END INPUT
      ...
      IF g_bgjob = 'Y' THEN
         ...
         ELSE
            ...
            CALL cl_cmdat('gfag104',g_time,l_cmd)      # Execute cmd at later time
         END IF
         CLOSE WINDOW g104_w
         CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690113
         CALL cl_gre_drop_temptable(l_table)
...
#No.FUN-710083 --begin
#    CALL cl_outnam('gfag104') RETURNING l_name
...
###GENGRE###     LET g_str = g_str,";",tm.s[4,4],";",tm.t[1,1],";",tm.t[2,2],";",tm.t[3,3],";",tm.t[4,4]
   ...
   # CALL cl_prt_cs3('gfag104',l_sql,g_str)
###GENGRE###     LET l_sql = "SELECT * FROM ",g_cr_db_str CLIPPED,l_table CLIPPED
###GENGRE###     CALL cl_prt_cs3('gfag104','gfag104',l_sql,g_str)
    LET g_cr_table = l_table                    # No.FUN-C40020 add
    LET g_cr_apr_key_f = "fas01"          # No.FUN-C40020 add
    CALL gfag104_grdata()    ###GENGRE###
...
FUNCTION gfag104_grdata()
    ...
    WHILE TRUE
        ...
        LET handler = cl_gre_outnam("gfag104")
        IF handler IS NOT NULL THEN
            START REPORT gfag104_rep TO XML HANDLER handler
            LET l_sql = "SELECT * FROM ",g_cr_db_str CLIPPED,l_table CLIPPED, 
                        " ORDER BY order1,order2,order3,order4,fas01 "             #FUN-B50018 add 
            DECLARE gfag104_datacur1 CURSOR FROM l_sql
            FOREACH gfag104_datacur1 INTO sr1.*
                OUTPUT TO REPORT gfag104_rep(sr1.*)
            END FOREACH
            FINISH REPORT gfag104_rep
        END IF
