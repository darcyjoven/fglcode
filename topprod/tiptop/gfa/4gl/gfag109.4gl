...
# Modify.........: No.FUN-D10098 13/02/01 By lujh 新增gfag109
...
#FUN-710083.....begin
   ...
   LET l_table = cl_prt_temptable('gfag109',g_sql) CLIPPED
   IF l_table = -1 THEN 
...
#FUN-710083.....end   
   IF cl_null(g_bgjob) OR g_bgjob = 'N'	# If background job sw is off
      THEN CALL g109_tm(0,0)		# Input print condition
      ELSE CALL gfag109()		# Read data and create out-file
   END IF
   CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690113
   CALL cl_gre_drop_temptable(l_table)
END MAIN
 
FUNCTION g109_tm(p_row,p_col)
DEFINE lc_qbe_sn      LIKE gbm_file.gbm01   #No.FUN-580031
   ...
   OPEN WINDOW g109_w AT p_row,p_col WITH FORM "gfa/42f/gfag109"
 ...
 END CONSTRUCT
      ...
      IF INT_FLAG THEN
         LET INT_FLAG = 0 CLOSE WINDOW g109_w 
         CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690113
         CALL cl_gre_drop_temptable(l_table)
         EXIT PROGRAM
      ...
      IF g_bgjob = 'Y' THEN
         ...
         ELSE
            ...
            CALL cl_cmdat('gfag109',g_time,l_cmd)      # Execute cmd at later time
         END IF
         CLOSE WINDOW g109_w
         CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690113
         CALL cl_gre_drop_temptable(l_table)
...
#     START REPORT g109_rep TO l_name
#     LET g_pageno = 0
#FUN-710083.....end mark
    FOREACH g109_co INTO sr.*
...
#FUN-710083.....begin
        ...
        EXECUTE insert_prep USING sr.*,l_gen02,m_faj20,m_fbh05,l_gem02a,l_gen02a,g_azi04,g_azi05,"",  l_img_blob,"N",""  # No.FUN-C40020 add
#        OUTPUT TO REPORT g109_rep(sr.*,sr.tot_dep,yyyymm)
    END FOREACH
...
###GENGRE###    LET g_str = tm.wc,";",yyyymm,";",g_zz05,";",tm.b     #FUN-920036 add
  ...
  # CALL cl_prt_cs3('gfag109',l_sql,g_str)
###GENGRE###    LET l_sql = "SELECT * FROM ",g_cr_db_str CLIPPED,l_table CLIPPED
###GENGRE###    CALL cl_prt_cs3('gfag109','gfag109',l_sql,g_str)
    LET g_cr_table = l_table                    # No.FUN-C40020 add
    LET g_cr_apr_key_f = "fbg01"          # No.FUN-C40020 add
    CALL gfag109_grdata()    ###GENGRE###
 
#    FINISH REPORT g109_rep
 
#    CALL cl_prt(l_name,' ','1',g_len)
#FUN-710083.....end
END FUNCTION
#FUN-710083.....begin mark
#REPORT g109_rep(sr,p_faj32,p_yyyymm)
#    DEFINE
#        m_faj20         LIKE gem_file.gem02,
#        m_fbh05         LIKE fag_file.fag03,
...
FUNCTION gfag109_grdata()
    ...
    WHILE TRUE
        ...
        LET handler = cl_gre_outnam("gfag109")
        IF handler IS NOT NULL THEN
            START REPORT gfag109_rep TO XML HANDLER handler
            LET l_sql = "SELECT * FROM ",g_cr_db_str CLIPPED,l_table CLIPPED,
                        " ORDER BY fbg01,fbh03,fbh031"
            DECLARE gfag109_datacur1 CURSOR FROM l_sql
            FOREACH gfag109_datacur1 INTO sr1.*
                OUTPUT TO REPORT gfag109_rep(sr1.*)
            END FOREACH
            FINISH REPORT gfag109_rep
        END IF
