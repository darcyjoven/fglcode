...
#
# Library name...: cl_sure3
# Descriptions...: 詢問 "您所輸入的資料是否正確(Y/N)?"
# Input parameter: p_row,p_col
# RETURN code....: 1 FOR TRUE  : 是
#                  0 FOR FALSE : 否
# Usage .........: if cl_sure3(p_row,p_col)
...
FUNCTION cl_sure3(p_row,p_col)
   ...
   SELECT ze03 INTO ls_msg FROM ze_file WHERE ze01 = 'lib-013' AND ze02 = g_lang
