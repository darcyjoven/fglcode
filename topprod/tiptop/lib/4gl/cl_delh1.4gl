...
#
# Library name...: cl_delh1
# Descriptions...: 詢問 "是否確定取消此筆單頭及所有單身資料(Y/N):"
#                  (for 單檔建檔程式單頭刪除功能)
# Memo...........: 
# Input parameter: p_row,p_col
# Return code....: TRUE/FALSE
# Usage..........: IF cl_delh1(p_row,p_col)
...
FUNCTION cl_delh1(p_row,p_col)
   ...
   SELECT ze03 INTO ls_msg FROM ze_file WHERE ze01 = 'lib-007' AND ze02 = g_lang
   SELECT ze03 INTO lc_title FROM ze_file WHERE ze01 = 'lib-039' AND ze02 = g_lang
