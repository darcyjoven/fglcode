...
#                       RETURNING l_price    #MOD-B30234
                  ...
                  WHEN l_ohi04 = 'C2'
                     CALL s_fetch_price_C2(p_cust,p_item,p_booth,p_unit,p_date,p_plant,p_curr,p_term,p_type,p_no,p_line,l_price,p_count,l_ohi02,p_cmd) #FUN-BC0071
#                       RETURNING l_price    #MOD-B30234
     ...
     #FOREACH cur_scale_1 INTO l_tmp[l_cnt].* ,g_oeb[l_cnt].oeb917                    #FUN-D30076 Mark
      FOREACH cur_scale_1 INTO l_tmp[l_cnt].* ,g_oeb[l_cnt].oeb917,g_oeb[l_cnt].oeb47 #FUN-D30076 Add
         IF l_tmp[l_cnt].line <> p_line THEN 
            CALL s_fetch_price_new2(p_cust,l_tmp[l_cnt].item,l_tmp[l_cnt].booth,l_tmp[l_cnt].unit,p_date,p_type,p_plant,p_curr,p_term,p_payment,l_tmp[l_cnt].no,l_tmp[l_cnt].line,l_tmp[l_cnt].qty,p_no1,p_cmd,'2')
                 ...
                 WHEN '2'
                   ...
                   #TQC-C30329 add START
                    IF g_azw.azw04 = '2' AND NOT s_industry("slk") THEN  
                       ...
                       CALL s_ogb14t(l_tmp[l_cnt].item,l_rtz04,g_oga.oga213,g_oeb[l_cnt].oeb917,l_price_1[l_cnt],t_azi04)
         ...
         #          CALL cl_digcut(l_price_1[l_cnt],t_azi03) RETURNING l_price_1[l_cnt]   #MOD-B20087 MARK
                 ...
                 WHEN '3'
                    ...
                    IF g_azw.azw04 = '2' AND NOT cl_null(l_rtz04) AND g_oha.oha03 = l_rtz06 THEN
                        CALL s_t700_sub(p_item,l_rtz04,g_oha.oha213,g_oeb[l_cnt].oeb917,l_price_1[l_cnt],t_azi04)
...
DEFINE l_ima151   LIKE ima_file.ima151  #TQC-C30005 add
   ...
   IF s_industry("slk") AND g_azw.azw04='2'
     AND (g_prog='axmt410_slk' OR g_prog='axmt400_slk' OR g_prog='axmt420_slk' OR g_prog='axmt810_slk' OR
      ...
      SELECT ima151 INTO l_ima151 FROM ima_file WHERE ima01=p_item
      IF l_ima151='Y' THEN
         LET l_sql = "SELECT DISTINCT xmf07,xmf08 ",
...
FUNCTION s_fetch_price_C2(p_cust,p_item,p_booth,p_unit,p_date,p_plant,p_curr,p_term,p_type,p_no,p_line,p_price,p_count,p_team,p_cmd)   #FUN-BC0071 add p_booth
...
DEFINE p_no1        LIKE tqx_file.tqx01     #提案單號
   IF l_sx_1 <> l_sx THEN
   CALL s_fetch_price_new2(p_cust,p_item,p_booth,p_unit,p_date,p_type,p_plant,p_curr,p_term,p_payment,p_no,p_line,p_count,p_no1,p_cmd,'1')   #FUN-BC0071
...
#參數設定需要重新審核，以當前機構活動代碼為准;否則以拋轉資料為主
   ...
   CALL s_fetch_price_ins_temp_table(p_price,p_cust,p_booth,p_item,p_unit,p_date,p_type,p_plant,p_curr,p_term,p_payment,p_no,p_line,p_count,p_no1,p_cmd)  #FUN-BC0071 
   CASE p_type
       WHEN '1'
           LET l_sql = "DELETE FROM ",cl_get_target_table(g_plant_new,'rxc_file'), 
...
###-FUN-B30012 - ADD -  END  ---------------------------------------------
   ...
   FOR l_i = 1 TO 3
      CASE l_raa07[l_i,l_i]
         WHEN '1'             #一般促销
            CALL s_price1(p_cust,p_item,p_booth,p_unit,p_date,p_no,p_line,p_price,p_type,p_plant,p_term,p_curr,p_count,p_team)     #FUN-BC0071
         WHEN '2'
            CALL s_price2(p_cust,p_item,p_booth,p_unit,p_date,p_no,p_line,p_price,p_type,p_plant,p_term,p_curr,p_count,p_team)     #FUN-BC0071
         WHEN '3'
            CALL s_price3(p_cust,p_item,p_booth,p_unit,p_date,p_no,p_line,p_price,p_type,p_plant,p_term,p_curr,p_count,p_team)     #FUN-BC0071
      END CASE
   END FOR  
   LET l_sql = "SELECT no,line FROM s_price_c2 WHERE item ='",p_item,"' AND line = '",p_line,"' "
   CALL cl_replace_sqldb(l_sql) RETURNING l_sql              							
...
END FUNCTION
#FUN-AA0065   ---start --add
FUNCTION  s_price1(p_cust,p_item,p_booth,p_unit,p_date,p_no,p_line,p_price,p_type,p_plant,p_term,p_curr,p_count,p_team)   #FUN-BC0071 
DEFINE p_cust        LIKE occ_file.occ01
DEFINE p_team        LIKE ohi_file.ohi02
DEFINE p_item        LIKE ima_file.ima01
...
### -MOD-B20087- ADD -  END  ----------------------------------------
  ...
  #FUN-D40010 Mark&Add Begin ---
   ...
   FOREACH s_fetch_price_c2_curs3 INTO l_tmp.*               
     ...
     #IF NOT s_fetch_price_chk('1',l_rac.rac01,l_rac.rac02,l_rac.rac03,g_plant_new,l_tmp.item,l_tmp.booth,p_date,l_tmp.price) THEN   #FUN-BC0071   #FUN-C30154 add price
     #   CONTINUE FOREACH
     #END IF
     #FUN-D40010 Mark Begin ---
...
FUNCTION  s_price2(p_cust,p_item,p_booth,p_unit,p_date,p_no,p_line,p_price,p_type,p_plant,p_term,p_curr,p_count,p_team)   #FUN-BC0071
DEFINE p_cust       LIKE occ_file.occ01
DEFINE p_team       LIKE ohi_file.ohi02
DEFINE p_item       LIKE ima_file.ima01
DEFINE p_booth      LIKE oeb_file.oeb49               #FUN-BC0071
...
### -MOD-B20087- ADD -  END  -------------------------------------
       ...
       #FOREACH s_fetch_price_c2_curs1 INTO l_item,l_sum_qty2                 #FUN-D40010 Mark
        FOREACH s_fetch_price_c2_curs1 INTO l_item,l_line,l_price,l_sum_qty2  #FUN-D40010 Add
            IF SQLCA.sqlcode != 0 THEN
                CALL cl_err('foreach:',SQLCA.sqlcode,1)
                EXIT FOREACH
            END IF
...
#FUN-BC0071 -----------------------END
            ...
            FOREACH s_sel_raf_cs INTO l_raf03,l_raf04,l_raf05	
              #IF NOT s_fetch_price_chk('2',l_rae.rae01,l_rae.rae02,l_raf03,g_plant_new,l_item,'',p_date,'') THEN #FUN-BC0071  #FUN-C30154 add '' #FUN-D40010 Mark
               IF NOT s_fetch_price_chk('2',l_rae.rae01,l_rae.rae02,l_raf03,g_plant_new,l_item,'',p_date,l_price) THEN                            #FUN-D40010 Add
                   CONTINUE FOREACH	
               END IF	
#FUN-C20098 -----------------STA
...
FUNCTION  s_price3(p_cust,p_item,p_booth,p_unit,p_date,p_no,p_line,p_price,p_type,p_plant,p_term,p_curr,p_count,p_team)    #FUN-BC0071 
DEFINE p_cust       LIKE occ_file.occ01
DEFINE p_team       LIKE ohi_file.ohi02
DEFINE p_item       LIKE ima_file.ima01
DEFINE p_booth      LIKE oeb_file.oeb49                      #FUN-BC0071 
...
#算出剩余数量部分 达到多少金额
      ...
      #FUN-D40010 Add End -----
       ...
       FOREACH s_fetch_price_c2_curs4 INTO l_fg,l_line,l_booth,l_item,l_price,l_qty2,l_cx_no      #FUN-BC0071
           IF SQLCA.sqlcode != 0 THEN
              CALL cl_err('foreach:',SQLCA.sqlcode,1)
              EXIT FOREACH
           END IF 
           IF l_rah.rah11 = '2' THEN
             #IF NOT s_fetch_price_chk('3',l_rah.rah01,l_rah.rah02,'',g_plant_new,l_item,l_booth,p_date,'') THEN    #FUN-BC0071  #FUN-C30154 add '' #FUN-D40010 Mark
              IF NOT s_fetch_price_chk('3',l_rah.rah01,l_rah.rah02,'',g_plant_new,l_item,l_booth,p_date,l_price) THEN                               #FUN-D40010 Add
                  CONTINUE FOREACH
              END IF
#FUN-BC0071 -------------------STA
           ELSE
...
FUNCTION s_fetch_price_ins_temp_table(p_price,p_cust,p_booth,p_item,p_unit,p_date,p_type,p_plant,p_curr,p_term,p_payment,p_no,p_line,p_count,p_no1,p_cmd)   #FUN-BC0071 
DEFINE p_type       LIKE type_file.chr1
DEFINE l_sql        STRING
DEFINE p_cmd        LIKE type_file.chr1
DEFINE p_cust       LIKE occ_file.occ01
...
#TQC-C20501 -----------STA
      ...
      END IF
#TQC-C20501 -----------END
      CALL s_fetch_price_new2(p_cust,l_item,l_booth,l_unit,p_date,p_type,p_plant,p_curr,p_term,p_payment,l_no,l_line,l_qty,p_no1,p_cmd,'1')  #FUN-BC0071
      RETURNING  l_price,g_flg
      LET l_price = l_price
...
FUNCTION  s_fetch_price_chk(l_type,p_rac01,p_rac02,p_rac03,p_plant,p_item,p_booth,p_date,p_price)    #FUN-BC0071 add  #FUN-C30154 add price
...
#FUN-BC0071 ----------------END
              ...
              WHEN '3'           
                 ...
                 #END IF 
                  ...
                  LET l_oba01_str = get_oba01_by_oba13(l_rax05,l_oba01_tree)
...
FUNCTION s_dynamic(p_cust,p_item,p_booth,p_unit,p_date,p_curr,p_no,p_type,p_plant,p_rwf,p_team,p_price,p_term,p_line,p_count) #TQC-B60015 ADD  #FUN-BC0071
DEFINE p_team       LIKE ohi_file.ohi02
DEFINE p_cust       LIKE occ_file.occ01
DEFINE p_item       LIKE ima_file.ima01
DEFINE p_booth      LIKE oeb_file.oeb49               #FUN-BC0071
   ...
   IF p_rwf.rwf10 = '1' THEN   
     ...
     #CALL s_get_price(p_cust,p_item,p_unit,p_date,p_type,p_plant,p_curr,l_oea87,p_rwf.rwf12,p_rwf.rwf13,'1',p_team) RETURNING l_price #MOD-9C0173
      ...
      FOREACH cur_tmp5 INTO l_tmp.*
         CALL s_fetch_price_new1(p_cust,l_tmp.oeb04,p_booth,l_tmp.oeb05,p_date,p_type,p_plant,      #FUN-BC0071
...
FUNCTION s_fix(p_cust,p_item,p_booth,p_unit,p_type,p_curr,p_date,p_plant,p_no,p_count,p_rwf,p_team,p_price,p_term,p_line) #MOD-9C0173  #FUN-BC0071
DEFINE p_cust       LIKE occ_file.occ01
DEFINE p_team       LIKE ohi_file.ohi02
DEFINE p_item       LIKE ima_file.ima01
DEFINE p_booth      LIKE oeb_file.oeb49              #FUN-BC0071
  ...
  #FUN-9C0068   ---END
   ...
   IF p_rwf.rwf10 = '1' THEN  
	 ...
	 LET l_rxc.rxc07 = l_rtv13
         ...
         LET l_nouse_sum = l_oeb12 - l_use_sum    #不可以參加組合促銷的商品數量
         IF l_nouse_sum > 0 THEN 
            CALL s_fetch_price_new1(p_cust,l_oeb04,p_booth,l_oeb05,p_date,p_type,p_plant,       #FUN-BC0071
                             p_curr,g_term,g_payment,p_no,l_oeb03,l_nouse_sum,'','a')
               RETURNING l_price
         END IF
      END FOREACH
...
#FUN-AB0102 ---add---end--   
   ...
   RETURN l_xmc09
END FUNCTION
FUNCTION s_fetch_price_new1(p_cust,p_item,p_booth,p_unit,p_date,p_type,p_plant,p_curr,p_term,p_payment,p_no,p_line,p_count,p_no1,p_cmd)   #FUN-BC0071
DEFINE p_cust       LIKE tqo_file.tqo01,     #客戶編號
       p_item       LIKE tqn_file.tqn03,     #料件編號
...
#FUN-AA0065  ---end--mark
#FUN-AA0065 --add--begin
FUNCTION s_fetch_price_new2(p_cust,p_item,p_booth,p_unit,p_date,p_type,p_plant,p_curr,p_term,p_payment,p_no,p_line,p_count,p_no1,p_cmd,l_p1)   #FUN-BC0071
DEFINE p_cust       LIKE tqo_file.tqo01,     #客戶編號
       p_item       LIKE tqn_file.tqn03,     #料件編號
       p_booth      LIKE oeb_file.oeb49,     #攤位編號                    #FUN-BC0071
       p_unit       LIKE tqn_file.tqn04,     #單位
...
FUNCTION get_oba01_by_oba13(p_oba01,p_oba01_tree)
...
DEFINE l_sql          STRING
   ...
   FOR l_i = 1 TO l_oba_rec.getLength()
      ...
      END IF
      IF NOT cl_null(l_oba01) THEN
         LET p_oba01_tree = get_oba01_by_oba13(l_oba01, p_oba01_tree)
      END IF
   END FOR
   RETURN p_oba01_tree
END FUNCTION
#FUN-B80095 Add End -----
#FUN-C10053 add begin ---
FUNCTION s_t700_sub(p_no,p_rtz04,p_oha213,p_ohb917,p_ohb13,t_azi04)
...
#FUN-C10053 add end -----
#TQC-C30329 add START
FUNCTION s_ogb14t(p_no,p_rtz04,p_oea213,p_oeb917,p_oeb13,t_azi04)
   DEFINE p_no      LIKE rte_file.rte03    #产品编号
   DEFINE p_rtz04   LIKE rtz_file.rtz04    #商品策略
