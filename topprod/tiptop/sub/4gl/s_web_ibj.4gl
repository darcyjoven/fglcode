...
# Usage..........: CALL s_web_ibj(p_argv1,p_argv2,p_argv3,p_argv4,p_plant) RETURNING g_success
...
FUNCTION s_web_insibj(p_argv1,p_argv2,p_argv3,p_argv4,p_plant_new)
    ...
    IF cl_null(g_ibj.ibj16) THEN
       LET g_ibj.ibj16 = cl_web_used_ap_hostname() #AP Server
    END IF
    #DEV-D40014---add---str--
    ...
    IF STATUS OR SQLCA.SQLERRD[3]=0 THEN
       IF g_bgerr THEN
          CALL s_errmsg('ibj12',g_ibj.ibj12,'s_web_ibj:ins ibj',STATUS,1)
       ELSE
    ...
    IF cl_null(g_ibj.ibj07) THEN 
       ...
       ELSE 
          ...
          FOREACH ibj_seq_cs INTO l_seqno,l_qty  
             ...
             IF SQLCA.SQLCODE OR SQLCA.SQLERRD[3]=0 THEN
                IF g_bgerr THEN
                   CALL s_errmsg('ibj12',g_ibj.ibj12,'s_web_ibj:ins ibj',SQLCA.SQLCODE,1)
                ELSE
       ...
       IF SQLCA.SQLCODE THEN
          IF g_bgerr THEN
             CALL s_errmsg('ibj12',g_ibj.ibj12,'s_web_ibj:upd ibj',SQLCA.SQLCODE,1)
          ELSE
