...
FUNCTION s_web_tlfb(p_argv1,p_argv2,p_argv3,p_argv4,p_plant_new)
  ...
  #异动数量为负，则将数量调为正，异动类型取反
    ...
    IF cl_null(g_tlfb.tlfb16) THEN
       LET g_tlfb.tlfb16 ='PDA' # cl_web_used_ap_hostname() #AP Server
    END IF
   ...
   #No:DEV-CA0011--mark--end
    ...
    IF STATUS OR SQLCA.SQLERRD[3]=0 THEN
       IF g_bgerr THEN
          CALL s_errmsg('tlfb12',g_tlfb.tlfb12,'s_web_tlfb:ins tlfb',STATUS,1)
       ELSE
    ...
    IF cl_null(g_tlfb.tlfb08) THEN 
       ...
       IF l_count=1 THEN 
          ...
          IF SQLCA.SQLCODE OR SQLCA.SQLERRD[3]=0 THEN 
             IF g_bgerr THEN
                CALL s_errmsg('tlfb12',g_tlfb.tlfb12,'s_web_tlfb:upd tlfb',SQLCA.SQLCODE,1)
             ELSE
          ...
          ELSE 
             IF g_tlfb.tlfb11="abat151" OR g_tlfb.tlfb11="wmbt151" OR 
                ...
                IF l_ins_flag = 'Y' THEN 
                   ...
                   IF SQLCA.SQLCODE OR SQLCA.SQLERRD[3]=0 THEN
                      IF g_bgerr THEN
                         CALL s_errmsg('tlfb12',g_tlfb.tlfb12,'s_web_tlfb:ins tlfb',SQLCA.SQLCODE,1)
                      ELSE
       ...
       ELSE
          ...
          #IF SQLCA.SQLCODE OR SQLCA.SQLERRD[3]=0 THEN
          #   IF g_bgerr THEN
          #      CALL s_errmsg('tlfb12',g_tlfb.tlfb12,'s_web_tlfb:del tlfb',SQLCA.SQLCODE,1)
          #   ELSE
