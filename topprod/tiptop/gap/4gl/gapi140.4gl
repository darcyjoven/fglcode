...
DEFINE
   ...
   g_head_t      RECORD
                 ...
                 rvw06f_sum LIKE rvw_file.rvw06f,          #FUN-C80027---ADD---STR
                 sum3       LIKE rvw_file.rvw05f,        #原币含税金额合计
                 rvw05_sum  LIKE rvw_file.rvw05,         #未稅金額
                 rvw06_sum  LIKE rvw_file.rvw06,         #稅額
                 sum4       LIKE rvw_file.rvw05,         #本币含税金额合计
   ...
   g_rvw         DYNAMIC ARRAY OF RECORD                 #程式變數(Program Variables)
                 ...
                 rvv36      LIKE rvv_file.rvv36,         #str----add by huanglf160822
         ...
         WHEN "Carry_Account"
           #IF NOT cl_null(g_head_1.rvw01) THEN                                 #No.FUN-CB0053 Mark
            IF NOT cl_null(g_head_1.rvw01) AND cl_null(g_head_1.rvw18) THEN #No.FUN-CB0053 Add
               ...
               #END IF
               #CALL cl_cmdrun(g_cmd)
    ##########################mark by maoyy20160705 start
         {      IF l_rvw05f_s = 0 THEN
                  CALL cl_err("","alm-340",0)
               END IF}
    ##########################mark by maoyy20160705 end
            #   IF l_rvw05f_s > 0 THEN   #mark by maoyy20160705
                IF l_rvw05f_s > = 0 THEN #add by maoyy20160705
                 #LET g_cmd = "aapp110 '' '' '' '' '' '' '' '' '1' 'N' '",g_head_1.rvw01,"'"                     #No.FUN-CB0053   Mark
                 # LET g_cmd = "aapp110 '' '' '",g_head_1.rvw19,"' '' '' '' '' '' '1' 'N' '",g_head_1.rvw01,"'"   #No.FUN-CB0053   Add  #mark by guanyao160830
                 LET g_cmd = "aapp110 '' '' '",g_head_1.rvw02,"' '' '' '' '' '' '1' 'N' '",g_head_1.rvw01,"'" #add by guanyao160830
               ...
               IF l_rvw05f_s < 0 THEN
                 ...
                 # LET g_cmd = "aapp111 '' '3' '4' '' '",g_head_1.rvw19,"' '' '' '",g_user,"' '",g_clas,"' '' 'N' '",g_head_1.rvw01,"'" #No.FUN-CB0053 Add  #mark by guanyao160830
                 LET g_cmd = "aapp111 '' '3' '4' '' '",g_head_1.rvw02,"' '' '' '",g_user,"' '",g_clas,"' '' 'N' '",g_head_1.rvw01,"'" #No.FUN-CB0053 Add  #add by guanyao160830
                 #CALL cl_cmdrun(g_cmd)       #No.FUN-CB053   Mark
                  CALL cl_cmdrun_wait(g_cmd)  #No.FUN-CB0053  Add
                  SELECT rvw18 INTO g_head_1.rvw18 FROM rvw_file WHERE rvw01 = g_head_1.rvw01   #No.FUN-CB0053 Add
               END IF
...
#No.MOD-B50003 --end
   ...
   # 螢幕上取單身條件
   CONSTRUCT g_wc2 ON rvw99,rvw08,rvw09,ima01,ima02,rvv09,rvw10,rvw05f, rvw06f,sum1        #MOD-640405      #CHI-980038   #FUN-9B0130 add rvw99 FUN-C80027  ADD--sum1  #add ima01,ima02 by dengsy160527
		 FROM s_rvw[1].rvw99,s_rvw[1].rvw08,s_rvw[1].rvw09,s_rvw[1].ima01,s_rvw[1].ima02,s_rvw[1].rvv09,   #FUN-9B0130 add rvw99  #add s_rvw[1].ima01,s_rvw[1].ima02 by dengsy160527
   ...
   LET g_wc2=cl_replace_str(g_wc2,"ima02","rvv031")
...
DEFINE
   ...
   END IF
      ...
      #      '',SUM(rvw05f),SUM(rvw06f),'',SUM(rvw05f),SUM(rvw06f),''  #FUN-C80027 add 2'' #No.FUN-CB0048   Mark
             '',SUM(rvw05f),SUM(rvw06f),SUM(rvw05f),SUM(rvw06f),'',SUM(rvw05f),SUM(rvw06f),'','',rvw18        #No.FUN-CB0048   Add  #add '' by guanyao160830
        INTO g_head_1.*
...
DEFINE
   ...
   l_cnt,l_cnt1           LIKE type_file.num5,     #NO FUN-690009 SMALLINT
...
#                     AND apk28 = g_head_1.rvw07                  #CHI-B30082 add
      ...
      AFTER FIELD rvw05
         IF NOT cl_null(g_rvw[l_ac].rvw05) AND (g_rvw[l_ac].rvw05 <> g_rvw_t.rvw05 )  THEN
            ...
            END IF
            LET g_rvw[l_ac].rvw06  = g_rvw[l_ac].rvw05*g_head_1.rvw04/100  #mark by xujw200427
            #LET g_rvw[l_ac].rvw06  = g_rvw[l_ac].rvw06f*g_head_1.rvw12      #add by xujw200427
...
#MOD-B70073--mark--end           
      ...
      AFTER FIELD rvw17
         IF NOT cl_null(g_rvw[l_ac].rvw17) THEN
           ...
           #LET g_rvw[l_ac].rvw06f = g_rvw[l_ac].rvw17*g_rvw[l_ac].rvw10 * (g_head_1.rvw04/100)  #add by huanglf160921   mark by zhangsba190531
            LET g_rvw[l_ac].rvw06f = g_rvw[l_ac].rvw05f * g_head_1.rvw04 / 100              #原幣稅額 add by zhangsba190531
           # LET g_rvw[l_ac].rvw06  = g_rvw[l_ac].rvw05 * g_head_1.rvw04 / 100                #本幣稅額    rvw04:稅率
      ...
      IF g_sma.sma116 MATCHES '[13]' THEN
         IF NOT cl_null(l_rvv36) THEN              #FUN-940083--add
            LET g_sql = "SELECT rvu03,rvv31,rvv031,rvv87,",
                        ...
                        "       gec05,pmm42,rvb22,",
                        "       rvv39,rvv38t,rvv39t",           #MOD-9C0061 add rvv39t
      ...
      ELSE
         IF NOT cl_null(l_rvv36) THEN              #FUN-940083--add
            ...
            EXECUTE sel_rvu03_pre3 INTO g_rvw[l_ac].rvv09,g_rvw[l_ac].ima01,
                                        ...
                                        g_rvw03,g_gec05,g_rvw12,g_rvb22,g_rvw[l_ac].rvw05f
         ELSE
            IF NOT cl_null(l_rvv04) THEN
               LET g_sql = "SELECT rvu03,rvv31,rvv031,rvv17,",
                           "       gec04,rvv38,rva113,rva115,",
                           "       gec05,rva114,rvb22,rvv39",
                           #"  FROM ",li_dbs CLIPPED,"rvv_file,",li_dbs CLIPPED,"rvu_file,",
                           #          li_dbs CLIPPED,"rvb_file,",li_dbs CLIPPED,"rva_file,",
                           #          li_dbs CLIPPED,"gec_file",
                           "  FROM ",cl_get_target_table(g_plant_new,'rvv_file')," JOIN ", #FUN-A50102
                                     cl_get_target_table(g_plant_new,'rvu_file')," ON rvv01 = rvu01 LEFT JOIN ", #FUN-A50102
                                     cl_get_target_table(g_plant_new,'rvb_file')," ON rvb01 = rvv04 AND rvb02 = rvv05 LEFT JOIN ", #FUN-A50102
                                     cl_get_target_table(g_plant_new,'rva_file')," ON rvb01=rva01 LEFT JOIN ", #FUN-A50102
                                     cl_get_target_table(g_plant_new,'gec_file'),     #FUN-A50102
                           " ON gec01 = rva115 AND gec011= '1'  WHERE rvv01 = '",g_rvw[l_ac].rvw08,"' ",
                           "   AND rvu01 = '",g_rvw[l_ac].rvw08,"' ",
                           "   AND rvv02 = '",g_rvw[l_ac].rvw09,"' ",
                           "   AND rvuconf = 'Y' AND rvu00 = '1' ",
                           "   AND rvv89 <> 'Y'"
...
#  END IF                          #No.MOD-A70133  mark
  ...
  #所以rvu00='3'時,不做數量(rvw10)的管控
   ...
   IF l_rvu00 = '3' THEN
      ...
      IF l_cnt > 0 and g_rvw[l_ac].rvw10>=0  THEN
         LET g_errno = 'aap-348'
         RETURN
      END IF
   ...
   IF g_type = '2' AND g_rvw[l_ac].rvw05f > 0 THEN
      ...
      END IF
   END IF
  # LET g_rvw[l_ac].rvw05f = cl_digcut(g_rvw[l_ac].rvw05f,t_azi04)  #No.MOD-740008 #modfiy by huanglf160921
   IF g_flag = 'N' THEN                                            #MOD-A80052
   ...
   LET g_rvw[l_ac].rvw06  = cl_digcut(g_rvw[l_ac].rvw06,g_azi04)
   LET g_rvw[l_ac].sum1=g_rvw[l_ac].rvw05f
    + g_rvw[l_ac].rvw06f      #FUN-C80027 #mark by liy190430  #remark by lifang 190719
  ...
  #LET g_rvw[l_ac].rvw06=g_rvw[l_ac].sum1-g_rvw[l_ac].rvw05 mark by zhangsba190530
   #LET g_rvw[l_ac].rvw06=g_rvw[l_ac].sum2-g_rvw[l_ac].rvw05 #add by zhangsba190530  mark  单身税额统一
   #add by liy190430 e
...
DEFINE l_rvv36     LIKE rvv_file.rvv36
   ...
   #       "SELECT rvw99,rvw08,rvw09,'','','',rvw10,rvw17,rvw05f,rvw06f,'',rvw05,rvw06,''",      #FUN-C80027
   ...
   LET g_sql =
          "SELECT rvw99,'',rvw08,rvw09,rvv31,rvv031,'','',rvw10,rvw17,rvw05f,rvw06f,'',rvw05,rvw06,''",      #FUN-C80027
...
#     LET g_type ='2' #mark by maoyy20161118
     DISPLAY BY NAME g_type
...
DEFINE l_rvw RECORD LIKE rvw_file.*,
   ...
   FOREACH i140_sel_rvb INTO l_rvw.rvw17,l_rvw.rvw10,l_rvw.rvw05f,
    ...
    # LET l_rvw.rvw05f = cl_digcut(l_rvw.rvw05f,t_azi04)  #modify by huanglf160921
      IF g_flag = 'N' THEN                                               #MOD-A80052
...
FUNCTION i140_share()
   ...
   DEFINE t_rvw10          LIKE rvw_file.rvw10   #160628
   LET l_rvw08 = ''
   LET l_rvw09 = ''
   LET l_rvw05f = 0
