...
#
# Pattern name...: apsi331_2.4gl
# Descriptions...: APS 途程製程指定工模具替代維護作業
# Date & Author..: FUN-880102  08/10/01 By DUKE
...
DEFINE
    ...
    g_vnm06         LIKE vnm_file.vnm06,   #FUN-880102
    g_vnm06_t       LIKE vnm_file.vnm06,   #
    ...
    g_argv3         LIKE vnm_file.vnm02, 
    g_argv4         LIKE vnm_file.vnm03,
    g_argv5         LIKE vnm_file.vnm06,
    g_argv6         LIKE vnm_file.vnm012,  #FUN-B50101 add
...
#       l_time    LIKE type_file.chr8          #No.FUN-6A0060
   ...
   END IF
	...
	LET g_argv1=ARG_VAL(1)	#品號
        ...
        LET g_argv5=ARG_VAL(5)  #序號
        LET g_argv6=ARG_VAL(6)  #製程段號 #FUN-B50101 add
        #LET g_argv1='00000'
        #LET g_argv2='TEST'
        #LET g_argv3='2'
        #LET g_argv4='1002'
	...
	IF g_argv1=' ' THEN 
        ...
        ELSE 
           ...
           LET g_vnm03=g_argv4
           LET g_vnm06=g_argv5
           LET g_vnm012=g_argv6 #FUN-B50101 add
        END IF
        ...
        DISPLAY 'g_vnm06=',g_vnm06
 
 
 
    LET p_row = 2 LET p_col = 2
    OPEN WINDOW i3312_w AT p_row,p_col WITH FORM "aps/42f/apsi331_2"
...
FUNCTION i3312_cs()
    IF cl_null(g_argv1) THEN
        ...
        INITIALIZE g_vnm06 TO NULL
 
    	CONSTRUCT g_wc ON vnm00,vnm01,vnm02,vnm03,vnm012,vnm04    #螢幕上取條件 #FUN-B50101 add vnm012
        	FROM vnm00,vnm01,vnm02,vnm03,vnm012,s_vnm[1].vnm04              #FUN-B50101 add vnm012
      ...
      ELSE
	LET g_wc=" vnm00='",g_argv1,"' AND vnm01= '",g_argv2,"' AND vnm02= '",g_argv3,"' AND vnm03= '",g_argv4,"' AND vnm06= '",g_argv5,"' AND vnm012 = '",g_argv6,"'" #FUN-B50101 add vnm012
    END IF
 
    LET g_sql="SELECT DISTINCT vnm00,vnm01,vnm02,vnm03,vnm012,vnm06 FROM vnm_file ", #FUN-B50101 add vnm012
               " WHERE vnm05 = 1 AND ", g_wc CLIPPED,
               " ORDER BY vnm00,vnm01,vnm02,vnm03,vnm012,vnm06 "                     #FUN-B50101 add vnm012
    PREPARE i3312_prepare FROM g_sql      #預備一下
    IF STATUS THEN CALL cl_err('prep:',STATUS,1) END IF
    DECLARE i3312_bcs                  #宣告成可捲動的
        SCROLL CURSOR WITH HOLD FOR i3312_prepare
    LET g_sql="SELECT DISTINCT vnm00,vnm01,vnm02,vnm03,vnm012,vnm06 FROM vnm_file WHERE vnm05=1 AND ",g_wc CLIPPED #FUN-B50101 add vnm012
    PREPARE i3312_precount FROM g_sql
    DECLARE i3312_count CURSOR FOR i3312_precount
END FUNCTION
...
FUNCTION i3312_a()
    ...
    INITIALIZE g_vnm012 LIKE vnm_file.vnm012 #FUN-B50101 add vnm012
    INITIALIZE g_vnm06 LIKE vnm_file.vnm06
	...
	IF NOT cl_null(g_argv1) THEN 
           ...
           LET g_vnm03=g_argv4   
           LET g_vnm06=g_argv5
           LET g_vnm012=g_argv6 #FUN-B50101 add vnm012
	   DISPLAY g_vnm00 TO vnm00 
           DISPLAY g_vnm01 TO vnm01
           DISPLAY g_vnm02 TO vnm02
           DISPLAY g_vnm03 TO vnm03
           DISPLAY g_vnm012 TO vnm012 #FUN-B50101 add vnm012
           DISPLAY g_vnm06 TO vnm06
       END IF
    LET g_vnm00_t = NULL
    LET g_vnm01_t = NULL
    LET g_vnm02_t = NULL
    LET g_vnm03_t = NULL
    LET g_vnm012_t = NULL #FUN-B50101 add vnm012
    LET g_vnm06_t = NULL
...
FUNCTION i3312_u()
    ...
    IF g_vnm00 IS NULL OR g_vnm01 IS NULL 
       OR g_vnm02 IS NULL OR g_vnm03 IS NULL OR
          g_vnm012 IS NULL OR g_vnm06 IS NULL THEN #FUN-B50101 add vnm012
        CALL cl_err('',-400,0)
        RETURN
    END IF
    MESSAGE ""
    ...
    WHILE TRUE
        ...
        IF g_vnm00 != g_vnm00_t OR
           ...
           g_vnm012 != g_vnm012_t OR #FUN-B50101 add
           g_vnm06 != g_vnm06_t THEN
            UPDATE vnm_file SET vnm00 = g_vnm00,  #更新DB
		                vnm01 = g_vnm01,
                                vnm02 = g_vnm02,
                                vnm03 = g_vnm03,
                                vnm012 = g_vnm012, #FUN-B50101 add
                                vnm06 = g_vnm06
...
DEFINE
    ...
    LET g_ss='Y'
    CALL cl_set_head_visible("","YES")           #No.FUN-6B0033
    INPUT g_vnm00,g_vnm01,g_vnm02,g_vnm03,g_vnm012,g_vnm06 #FUN-B50101 add vnm012
        WITHOUT DEFAULTS
        FROM vnm00,vnm01,vnm02,vnm03,vnm012,vnm06          #FUN-B50101 add vnm012
	    ...
	    IF NOT cl_null(g_vnm01) THEN
                SELECT count(*) INTO g_cnt FROM vnm_file
                    WHERE vnm00 = g_vnm00
                      ...
                      AND vnm02 = g_vnm02
                      AND vnm03 = g_vnm03
                      AND vnm012 = g_vnm012  #FUN-B50101 add vnm012
                      AND vnm06 = g_vnm06
                      AND vnm05 = 1
...
FUNCTION i3312_q()
  DEFINE l_vnm00  LIKE vnm_file.vnm00,
    ...
    IF INT_FLAG THEN                       #使用者不玩了
        ...
        RETURN
    END IF
    OPEN i3312_bcs                    #從DB產生合乎條件TEMP(0-30秒)
    IF SQLCA.sqlcode THEN                         #有問題
        ...
        END IF
    ELSE
        FOREACH i3312_count INTO l_vnm00,l_vnm01,l_vnm02,l_vnm03,l_vnm012,l_vnm06 #FUN-B50101 add
            LET g_row_count = g_row_count + 1
        END FOREACH
        DISPLAY g_row_count TO FORMONLY.cnt
        CALL i3312_fetch('F')            #讀出TEMP第一筆並顯示
    END IF
END FUNCTION
 
#處理資料的讀取
FUNCTION i3312_fetch(p_flag)
DEFINE
    p_flag     LIKE type_file.chr1       #處理方式   #No.FUN-680096 VARCHAR(1)
 
    MESSAGE ""
    CASE p_flag
        WHEN 'N' FETCH NEXT     i3312_bcs INTO g_vnm00,g_vnm01,g_vnm02,g_vnm03,g_vnm012,g_vnm06 #FUN-B50101 add vnm012
        WHEN 'P' FETCH PREVIOUS i3312_bcs INTO g_vnm00,g_vnm01,g_vnm02,g_vnm03,g_vnm012,g_vnm06 #FUN-B50101 add vnm012
        WHEN 'F' FETCH FIRST    i3312_bcs INTO g_vnm00,g_vnm01,g_vnm02,g_vnm03,g_vnm012,g_vnm06 #FUN-B50101 add vnm012
        WHEN 'L' FETCH LAST     i3312_bcs INTO g_vnm00,g_vnm01,g_vnm02,g_vnm03,g_vnm012,g_vnm06 #FUN-B50101 add vnm012
        WHEN '/'
...
#                      CONTINUE PROMPT
      ...
      ON ACTION controlg      #MOD-4C0121
         CALL cl_cmdask()     #MOD-4C0121
            ...
            END IF
            LET mi_no_ask = FALSE
            FETCH ABSOLUTE g_jump i3312_bcs INTO g_vnm00,g_vnm01,g_vnm02,g_vnm03,g_vnm012,g_vnm06 #FUN-B50101 add vnm012
    END CASE
...
FUNCTION i3312_show()
    ...
    DISPLAY g_vnm03 TO vnm03   #單頭
    DISPLAY g_vnm012 TO vnm012 #單頭 #FUN-B50101 add
    DISPLAY g_vnm06 TO vnm06   #單頭
    CALL i3312_bf(g_wc)                 #單身
  ...
  DEFINE l_vnm00  LIKE vnm_file.vnm00,
    ...
    IF cl_delh(0,0) THEN                   #確認一下
        ...
        ELSE
            CLEAR FORM
            CALL g_vnm.clear()
            FOREACH i3312_count INTO l_vnm00,l_vnm01,l_vnm02,l_vnm03,l_vnm012,l_vnm06 #FUN-B50101 add vnm012
                LET g_row_count = g_row_count + 1
            END FOREACH
            DISPLAY g_row_count TO FORMONLY.cnt
            OPEN i3312_bcs
...
DEFINE
    ...
    DECLARE i3312_bcl CURSOR FROM g_forupd_sql      # LOCK CURSOR
    ...
    LET l_ac_t = 0
        ...
        BEFORE ROW
	        ...
	        BEGIN WORK
                ...
                OPEN i3312_bcl USING g_vnm00,g_vnm01,g_vnm02,g_vnm03,g_vnm012,g_vnm06,g_vnm_t.vnm04 #FUN-B50101 add vnm012
                IF STATUS THEN
                    CALL cl_err("OPEN i3312_bcl:", STATUS, 1)
                    LET l_lock_sw = "Y"
                ELSE
                    FETCH i3312_bcl INTO g_vnm[l_ac].*
                    IF SQLCA.sqlcode THEN
        ...
        AFTER INSERT
            ...
            VALUES(g_vnm00,g_vnm01,g_vnm02,g_vnm03,g_vnm012,    #FUN-B50101 add vnm012
                   g_vnm[l_ac].vnm04,1,
                   g_vnm06,g_plant,g_legal)                     #FUN-B50101 add vnmplant,vnmlegal
        ...
        BEFORE DELETE                            #是否取消單身
            IF   g_vnm_t.vnm04 IS NOT NULL THEN
        ...
        ON ROW CHANGE
            ...
            END IF
            IF l_lock_sw = 'Y' THEN
               CALL cl_err(g_vnm[l_ac].vnm04,-263,1)
               LET g_vnm[l_ac].* = g_vnm_t.*
            ELSE
               LET l_seq=0
               SELECT COUNT(*) INTO l_seq FROM vnm_file
               ...
               IF l_seq = 0 THEN
                  ...
                  IF SQLCA.sqlcode THEN
                     CALL cl_err3("ins","vnm_file",g_vnm00,g_vnm[l_ac].vnm04,SQLCA.sqlcode,"","",1)
                     ROLLBACK WORK
                  ELSE
                     MESSAGE 'INSERT O.K'
                     COMMIT WORK
        ...
        #    IF INFIELD(vnm04) AND l_ac > 1 THEN
...
FUNCTION i3312_bf(p_wc)              #BODY FILL UP
...
DEFINE i	LIKE type_file.num5      #No.FUN-680096 SMALLINT
    ...
    LET g_sql =
       ...
       "   AND ",p_wc CLIPPED ,
       " ORDER BY 1"
    PREPARE i3312_prepare2 FROM g_sql      #預備一下
    DECLARE vnm_cs CURSOR FOR i3312_prepare2
    CALL g_vnm.clear()
    LET g_cnt = 1
    LET g_rec_b=0
