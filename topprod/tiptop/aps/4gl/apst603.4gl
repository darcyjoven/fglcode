...
#
# Pattern name...: apst603.4gl
# Descriptions...: 啟動APS CP手調器(無法變更資料)
# Date & Author..: 08/04/28 By Kevin #FUN-840179
# Modify.........: No.MOD-870105 08/07/09 By kevin 修改select的方式
# Modify.........: No.TQC-920012 09/02/06 By Duke 修正當前端有參數傳入時，判斷若儲存版本參數空白則取該aps版本之最大儲存版本反之則直接取參數之儲存版本
...
MAIN
   ...
   CALL  cl_used(g_prog,g_time,1) RETURNING g_time
    ...
    OPEN WINDOW apst603_w AT p_row,p_col WITH FORM "aps/42f/apst601"
