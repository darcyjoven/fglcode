...
DEFINE lc_qbe_sn      LIKE gbm_file.gbm01   #No.FUN-580031
   ...
   OPEN WINDOW r411_w AT p_row,p_col WITH FORM "apm/42f/apmr411"
...
END CONSTRUCT
   ...
   IF g_bgjob = 'Y' THEN
      ...
      ELSE
         ...
         CALL cl_cmdat('apmr411',g_time,l_cmd)	# Execute cmd at later time
      END IF
      CLOSE WINDOW r411_w
      CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690119
      EXIT PROGRAM
...
#No.FUN-7C0054---End
   ...
   # LET l_sql = " SELECT pml01,pml04,ima02,pml41,pml07,pml33,pml20,pml21 ",
     ...
     PREPARE r411_p1 FROM l_sql
     IF SQLCA.sqlcode != 0 THEN
        CALL cl_err('prepare:',SQLCA.sqlcode,1)
        CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690119
        EXIT PROGRAM
     END IF
     DECLARE r411_c1 CURSOR FOR r411_p1
     IF SQLCA.sqlcode != 0 THEN
        CALL cl_err('declare:',SQLCA.sqlcode,1)
        CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690119
        EXIT PROGRAM
     END IF
#     CALL cl_outnam('apmr411') RETURNING l_name    #No.FUN-7C0054
#No.FUN-580004 --start--
...
#No.FUN-580004 --end
#     START REPORT r411_rep TO l_name               #No.FUN-7C0054
 
#    LET g_pageno = 0                               #No.FUN-7C0054
     IF g_sma115 = "Y" THEN                         #No.FUN-7C0054
        LET l_name = 'apmr411'                      #No.FUN-7C0054
     ELSE                                           #No.FUN-7C0054
        LET l_name = 'apmr411_1'                    #No.FUN-7C0054
     END IF                                         #No.FUN-7C0054
     FOREACH r411_c1 INTO sr.*
...
#     FINISH REPORT r411_rep
     ...
     CALL cl_prt_cs3('apmr411',l_name,l_sql,g_str)
