...
DEFINE g_wc3          STRING
DEFINE  g_ponslk      DYNAMIC ARRAY OF RECORD
                ponslk02   LIKE ponslk_file.ponslk02,
                ponslk04   LIKE ponslk_file.ponslk04,
                ponslk041  LIKE ponslk_file.ponslk041,
                ponslk07   LIKE ponslk_file.ponslk07,
                ponslk19   LIKE ponslk_file.ponslk19,
                ponslk20   LIKE ponslk_file.ponslk20,
                ponslk21   LIKE ponslk_file.ponslk21,
                ponslk31   LIKE ponslk_file.ponslk31,
                ponslk31t  LIKE ponslk_file.ponslk31t,
                ponslk06   LIKE ponslk_file.ponslk06
                END RECORD,
        g_ponslk_t    RECORD
                ...
                ponslk06   LIKE ponslk_file.ponslk06
                END RECORD,
       g_ponslk_o     RECORD LIKE ponslk_file.*,
       g_ponslk2      RECORD LIKE ponslk_file.*,     
...
#FUN-C30057--add--begin--
   IF g_azw.azw04 = '2' THEN    
      OPEN WINDOW t580_w AT p_row,p_col WITH FORM "apm/42f/apmt580_slk"
        ATTRIBUTE (STYLE = g_win_style CLIPPED)
   ELSE                                                  
      OPEN WINDOW t580_w AT p_row,p_col WITH FORM "apm/42f/apmt580"     
        ATTRIBUTE (STYLE = g_win_style CLIPPED)                  
   END IF                                                
...
#FUN-C30057--add--begin--
      DIALOG ATTRIBUTES(UNBUFFERED)
         ...
         BEFORE CONSTRUCT
            CALL cl_qbe_init()
      END CONSTRUCT      
      CONSTRUCT g_wc3 ON ponslk02,ponslk04,ponslk041,ponslk07,ponslk19,ponslk20,ponslk21,
                         ponslk31,ponslk31t,ponslk06
           FROM s_ponslk[1].ponslk02,s_ponslk[1].ponslk04,s_ponslk[1].ponslk041,
                s_ponslk[1].ponslk07,s_ponslk[1].ponslk19,s_ponslk[1].ponslk20,s_ponslk[1].ponslk21,
                s_ponslk[1].ponslk31,s_ponslk[1].ponslk31t,s_ponslk[1].ponslk06
...
#FUN-C30057--add--begin--
          IF g_azw.azw04 = '2' THEN
             IF g_wc3 !=' 1=1' AND (NOT cl_null(g_wc3)) THEN
                LET g_sql="SELECT UNIQUE pom01 FROM pom_file,ponslk_file ",
                          " WHERE pom01=ponslk01 AND ",g_wc CLIPPED," AND ",g_wc3 CLIPPED,
                          " ORDER BY pom01"
             END IF
          ELSE
             LET g_sql="SELECT UNIQUE pom01 FROM pom_file ",
                       " WHERE ",g_wc CLIPPED, " ORDER BY pom01"
          END IF
...
#FUN-C30057--add--end---
       ELSE
          LET g_sql="SELECT pom_file.pom01 FROM pom_file,pon_file ",
                    ...
                    "   AND pom01 = pon01",
                    " ORDER BY pom01"
         IF g_wc2.getindexof('poni',1) > 0  THEN                   
         LET g_sql="SELECT pom_file.pom01 FROM pom_file,pon_file,poni_file ",
                          " WHERE ",g_wc CLIPPED," AND ",g_wc2 CLIPPED,
                          "   AND poni01 = pon01 ",
                          "   AND poni02 = pon02 ",
                          "   AND pom01 = pon01",
...
#FUN-C30057--add--begin--
          IF g_azw.azw04 = '2' THEN   
             IF g_wc3 !=' 1=1' AND (NOT cl_null(g_wc3)) THEN
                LET g_sql="SELECT UNIQUE pom01 FROM pom_file,pon_file,poni_file,ponslk_file ",
                          " WHERE pon01=ponslk01 AND pon01 = poni01 AND pon02 = poni02 ",
                          "   AND poni01 = ponslk01 AND ponislk02 = ponslk02 ",
                          "   AND ",g_wc CLIPPED," AND ",g_wc3 CLIPPED," AND ",g_wc2 CLIPPED,
                          " ORDER BY pom01"
             END IF
          ELSE
             LET g_sql="SELECT UNIQUE pom01 FROM pom_file,pon_file ",
                       " WHERE pom01=pon01 AND ",g_wc CLIPPED," AND ",g_wc2 CLIPPED,
                       " ORDER BY pom01"
             IF g_wc2.getindexof('poni',1) > 0  THEN
                LET g_sql="SELECT UNIQUE pom01 FROM pom_file,pon_file,poni_file ",
                          " WHERE pom01=pon01 AND ",g_wc CLIPPED," AND ",g_wc2 CLIPPED,
                          "   AND poni01 = pon01 ",
                          "   AND poni02 = pon02 ",
                          " ORDER BY pom01"
...
#FUN-C30057--add--end---                    
 ...
 #FUN-C30057--add--begin--
         IF g_azw.azw04 = '2' THEN   
            IF g_wc3 !=' 1=1' AND (NOT cl_null(g_wc3)) THEN
               LET g_sql= "SELECT COUNT(DISTINCT pom01) FROM pom_file,ponslk_file",
                          " WHERE pom01=ponslk01 AND pom02 != 'SUB' AND ",g_wc CLIPPED," AND ",g_wc3 CLIPPED   
            END IF              
         ELSE
            LET g_sql= "SELECT COUNT(*) FROM pom_file WHERE pom02 != 'SUB' AND ",g_wc CLIPPED
         END IF 
 ...
 #FUN-C30057--add--end--
      ELSE
          ...
          IF g_wc2.getindexof('poni',1) > 0  THEN
             LET g_sql= "SELECT COUNT(DISTINCT pom01) FROM pom_file,pon_file,poni_file",
                        " WHERE pom01 = pon01",
                        "   AND poni01 = pon01 ",
                        "   AND poni02 = pon02 ",
                        "  AND pom02 != 'SUB' AND ",g_wc CLIPPED," AND ",
 ...
 #FUN-C30057--add--begin--
          IF g_azw.azw04 = '2' THEN    
             IF g_wc3 !=' 1=1' AND (NOT cl_null(g_wc3)) THEN
                LET g_sql= "SELECT COUNT(DISTINCT pom01) FROM pom_file,pon_file,poni_file,ponslk_file",
                           " WHERE pom01=ponslk01 AND pon01 = poni01 AND pon02 = poni02 ",
                           "  AND poni01 = ponslk01 AND ponislk02 = ponslk02 AND pom02 != 'SUB' AND ",
                           "  AND ",g_wc CLIPPED," AND ",g_wc2 CLIPPED," AND ",g_wc3 CLIPPED
             END IF
          ELSE
             LET g_sql= "SELECT COUNT(DISTINCT pom01) FROM pom_file,pon_file",
                        " WHERE pom01=pon01 AND pom02 != 'SUB' AND ",g_wc CLIPPED," AND ",g_wc2 CLIPPED
             IF g_wc2.getindexof('poni',1) > 0  THEN
                LET g_sql= "SELECT COUNT(DISTINCT pom01) FROM pom_file,pon_file,poni_file",
                           " WHERE pom01=pon01 AND pom02 != 'SUB' AND ",g_wc CLIPPED," AND ",g_wc2 CLIPPED,
                           "   AND poni01 = pon01 ",
        ...
        AFTER INPUT
           ...
           IF g_pom.pom09 != g_pom_t.pom09 OR g_pom.pom22 != g_pom_t.pom22 OR g_pom.pom04 != g_pom_t.pom04 OR g_pom.pom21 != g_pom_t.pom21 OR g_pom.pom43 != g_pom_t.pom43
              ...
              IF g_cnt > 0 THEN
               ...
               #FUN-C30057--add--begin---
                    IF g_azw.azw04='2' THEN
                       DECLARE upd_ponslk_cs CURSOR FOR
                         SELECT ponslk01,ponslk02 FROM ponslk_file WHERE ponslk01=g_pom.pom01
                       FOREACH upd_ponslk_cs INTO l_ponslk01,l_ponslk02
                          SELECT MAX(pon31),MAX(pon31t)
                             INTO l_ponslk31,l_ponslk31t
                             FROM pon_file,poni_file
                            WHERE pon01=poni01 AND pon02=poni02
                              AND poni01=l_ponslk01 AND ponislk02=l_ponslk02
                          IF cl_null(l_ponslk31) THEN LET l_ponslk31=0 END IF
                          IF cl_null(l_ponslk31t) THEN LET l_ponslk31t=0 END IF
                          UPDATE ponslk_file SET ponslk31 = l_ponslk31,
                                                 ponslk31t= l_ponslk31t
                              WHERE ponslk01=l_ponslk01 AND ponslk02=l_ponslk02
                          IF STATUS OR SQLCA.SQLERRD[3]=0 THEN
                             CALL cl_err3("upd","ponslk_file",l_ponslk01,l_ponslk02,STATUS,"","upd pon:",1)
                             EXIT FOREACH
                          END IF
                       END FOREACH
                    END IF
                    CALL t580_b_fill2(' 1=1',' 1=1')
               #FUN-C30057--add--end----
...
#FUN-C30057--add--begin--
      ...
      END IF   
      IF g_azw.azw04 = '2' THEN    
         LET l_sql="SELECT DISTINCT pon02,ponislk01,pon04,pon041,ima021,pon07,pon19,pon20,pon83,pon84,pon85,",  
                     "       pon80,pon81,pon82,pon86,pon87,pon21,0,pon31,",
                     "       pon31t,pon06,  ",      
                     "       ponud01,ponud02,ponud03,ponud04,ponud05,",
                     "       ponud06,ponud07,ponud08,ponud09,ponud10,",
                     "       ponud11,ponud12,ponud13,ponud14,ponud15 ",
                     " FROM pon_file, OUTER poni_file,OUTER ima_file,OUTER ponslk_file ",
                     " WHERE pon01= '",g_pom.pom01,"' AND ",g_wc2 CLIPPED, " AND ",g_wc3 CLIPPED,
                     "   AND pon_file.pon01 = poni_file.poni01",
                     "   AND pon_file.pon02 = poni_file.poni02",
                     "   AND poni_file.poni01 = ponslk_file.ponslk01",
                     "   AND poni_file.ponislk02 = ponslk_file.ponslk02",
      ...
      ELSE
         LET l_sql="SELECT DISTINCT pon02,ponislk01,pon04,pon041,ima021,pon07,pon19,pon20,pon83,pon84,pon85,",  
                     ...
                     "       ponud06,ponud07,ponud08,ponud09,ponud10,",
                     "       ponud11,ponud12,ponud13,ponud14,ponud15 ",
                     " FROM pon_file,OUTER poni_file, OUTER ima_file ",
...
#FUN-C30057-------begin-----------
FUNCTION t580_b_fill2(p_wc3,p_wc2)
   DEFINE p_wc3    STRING,
          p_wc2    STRING,
          l_cnt    LIKE type_file.num5,
          l_count  LIKE pon_file.pon20

   IF cl_null(p_wc3) THEN
      LET p_wc3 = " 1=1"
   END IF
   IF cl_null(p_wc2) OR p_wc2 = " 1=1" THEN
      LET g_sql="SELECT DISTINCT ponslk02,ponslk04,ponslk041,ponslk07,ponslk19,ponslk20,ponslk21,",
                "       ponslk31,ponslk31t,ponslk06 ",
                "  FROM ponslk_file WHERE ponslk01='",g_pom.pom01,"'","   AND ",p_wc3 CLIPPED,
                " ORDER BY ponslk02 " CLIPPED          
   ELSE
      LET g_sql="SELECT DISTINCT ponslk02,ponslk04,ponslk041,ponslk07,ponslk19,ponslk20,ponslk21,",
                "       ponslk31,ponslk31t,ponslk06 ",
                "  FROM ponslk_file,pon_file,poni_file WHERE ponslk01='",g_pom.pom01,"'",
                "   AND poni01 = pon01 AND pon02 = poni02 AND poni01 = ponslk01 ",
                "   AND ponislk02 = ponslk02 AND ",p_wc2 CLIPPED,
                "   AND ",p_wc3 CLIPPED,
                " ORDER BY ponslk02 " CLIPPED
   END IF   
   PREPARE t580_pp2 FROM g_sql
   DECLARE t580_cs3 CURSOR FOR t580_pp2
 
   CALL g_ponslk.clear()
   LET l_cnt=1
   FOREACH t580_cs3 INTO g_ponslk[l_cnt].*
      IF SQLCA.sqlcode THEN
         CALL cl_err('prepare2:',SQLCA.sqlcode,1) EXIT FOREACH
      END IF          
      LET l_cnt=l_cnt+1
      ...
      END IF
   END FOREACH
   CALL g_ponslk.deleteElement(l_cnt)
   LET g_rec_b2=l_cnt - 1
   DISPLAY g_rec_b2 TO FORMONLY.cn2
   SELECT SUM(pon20) INTO l_count FROM pon_file WHERE pon01=g_pom.pom01
   DISPLAY l_count TO FORMONLY.qty
END FUNCTION

FUNCTION t580_check_color()
...
FUNCTION t580_check_imx(p_index,p_qty,p_qty_t)
   DEFINE p_index     LIKE type_file.num5,
          p_qty       LIKE pml_file.pml20,
          p_qty_t     LIKE pml_file.pml20

    LET g_errno = ''
    IF cl_null(g_ponslk[l_ac2].ponslk04)  THEN
       RETURN FALSE
    END IF
    IF p_qty < 0 THEN
...
FUNCTION t580_update_ponslk()
   DEFINE l_sum_pon20      LIKE pon_file.pon20
   
   SELECT SUM(pon20)
   INTO l_sum_pon20
   FROM pon_file
    WHERE pon01 = g_pom.pom01 
      AND pon02 IN (SELECT pon02 FROM pon_file,poni_file
                     WHERE pon01=poni01 AND pon02=poni02
                       AND poni01=g_pom.pom01 
                       AND ponislk03=g_ponslk[l_ac2].ponslk04
                       AND ponislk02=g_ponslk[l_ac2].ponslk02)
     AND ponplant=g_pom.pomplant
   IF SQLCA.sqlcode OR cl_null(l_sum_pon20) THEN 
      LET l_sum_pon20 = 0 
   END IF
   UPDATE ponslk_file SET ponslk20 = l_sum_pon20
    WHERE ponslk02 = g_ponslk[l_ac2].ponslk02 AND ponslkplant=g_pom.pomplant
      AND ponslk01 = g_pom.pom01
   IF STATUS OR SQLCA.sqlerrd[3] = 0 THEN
      CALL cl_err3("upd","ponslk_file",g_pom.pom01,g_ponslk[l_ac2].ponslk02,STATUS,"","x_upd ponslk",1)
      LET g_success = 'N'
   END IF
   LET g_ponslk[l_ac2].ponslk20 = l_sum_pon20
END FUNCTION

FUNCTION t580_ponslk_move()
   LET g_pon_slk.pon06 = g_ponslk[l_ac2].ponslk06
   LET g_pon_slk.pon07 = g_ponslk[l_ac2].ponslk07
   LET g_pon_slk.pon11 = 'N'
   CALL s_overate(g_ponslk[l_ac2].ponslk04) RETURNING g_pon_slk.pon13
   LET g_pon_slk.pon19= g_ponslk[l_ac2].ponslk19
   LET g_pon_slk.pon20 = g_ponslk[l_ac2].ponslk20
   LET g_pon_slk.pon21 = 0
   LET g_pon_slk.pon23 = 'Y'
   LET g_pon_slk.pon31 = g_ponslk[l_ac2].ponslk31
   LET g_pon_slk.pon31t= g_ponslk[l_ac2].ponslk31t
   SELECT afb02 INTO g_pon_slk.pon40
                  FROM afb_file
                 WHERE afb00 = g_bookno1
                   AND afb03 = YEAR(g_pom.pom04)
                   AND afb04 = g_pon_slk.pon121
                   AND afb041= g_pon_slk.pon67 
   LET g_pon_slk.pon42 = 0
   LET g_pon_slk.pon50 = 0
   LET g_pon_slk.pon51 = 0
   LET g_pon_slk.pon53 = 0
   LET g_pon_slk.pon55 = 0
   LET g_pon_slk.pon56 = ' '
   LET g_pon_slk.pon57 = 0
   LET g_pon_slk.pon58 = 0
   LET g_pon_slk.pon59 = ' '
   LET g_pon_slk.pon60 = ' '
   LET  g_pon_slk.pon61=g_ponslk[l_ac2].ponslk04           #被替代料號
   LET  g_pon_slk.pon62=1                     #替代率
   LET g_pon_slk.pon80 = g_ponslk[l_ac2].ponslk07
   CALL s_du_umfchk(g_ponslk[l_ac2].ponslk04,'','','',
                               g_ponslk[l_ac2].ponslk07,g_pon_slk.pon80,'1')
                   RETURNING g_errno,g_pon_slk.pon81

   LET g_pon_slk.ponplant  = g_plant
   LET g_pon_slk.ponlegal  = g_legal

   LET g_poni_slk.poniplant= g_plant
   LET g_poni_slk.ponilegal= g_legal 
END FUNCTION

FUNCTION t580_price_check_slk(p_ponslk31,p_ponslk31t)
   DEFINE p_ponslk31    LIKE   ponslk_file.ponslk31
   DEFINE p_ponslk31t   LIKE   ponslk_file.ponslk31t
   ...
   IF g_ponslk[l_ac2].ponslk04[1,4] = 'MISC' THEN
      IF g_gec07 = 'Y' THEN   #含税
         CALL cl_set_comp_entry("ponslk31",FALSE)
         CALL cl_set_comp_entry("ponslk31t",TRUE)
      ELSE
         CALL cl_set_comp_entry("ponslk31",TRUE)
         CALL cl_set_comp_entry("ponslk31t",FALSE)
      END IF
      RETURN
   END IF
   #FUN-BC0088 ----- add end -----
   ...
   IF g_gec07 = 'Y' THEN   #含稅
      IF p_ponslk31t = 0 OR cl_null(p_ponslk31t) THEN
         #未取到含稅單價
      ...
      END IF
   ELSE                    #不含稅
      IF p_ponslk31 = 0 OR cl_null(p_ponslk31) THEN
         #未取到稅前單價
         IF l_pnz04 = 'Y' THEN   #未取到單價可人工輸入
            CALL cl_set_comp_entry("ponslk31",TRUE)
            CALL cl_set_comp_entry("ponslk31t",FALSE)
...
FUNCTION t580_ponslk04()  #料件編號
    DEFINE l_ima02 LIKE ima_file.ima02,
           l_imaacti LIKE ima_file.imaacti 

  LET g_errno = " "
  SELECT ima02,ima49,ima491,imaacti
         INTO l_ima02,g_ima49,g_ima491,l_imaacti
    FROM ima_file  WHERE ima01 = g_ponslk[l_ac2].ponslk04
  ...
  CASE WHEN SQLCA.SQLCODE = 100  LET g_errno = 'mfg0002'
       ...
       OTHERWISE                 LET g_errno = SQLCA.SQLCODE USING '-------'
  END CASE
  LET g_ponslk[l_ac2].ponslk041= l_ima02
  LET g_ponslk2.ponslk041      = l_ima02
  DISPLAY g_ponslk[l_ac2].ponslk041 TO ponslk041
  IF cl_null(g_ima49) THEN LET g_ima49 = 0 END IF
  IF cl_null(g_ima491) THEN LET g_ima491 = 0 END IF
END FUNCTION

FUNCTION t580_ponslk20_check(p_cmd)
DEFINE p_cmd     LIKE type_file.chr1

   IF NOT cl_null(g_ponslk[l_ac2].ponslk07) AND NOT cl_null(g_ponslk[l_ac2].ponslk20) THEN
      IF cl_null(g_ponslk_t.ponslk07) OR cl_null(g_ponslk_t.ponslk20) 
         OR g_ponslk_t.ponslk07 != g_ponslk[l_ac2].ponslk07 OR g_ponslk_t.ponslk20 !=g_ponslk[l_ac2].ponslk20 THEN
         LET g_ponslk[l_ac2].ponslk20 = s_digqty(g_ponslk[l_ac2].ponslk20,g_ponslk[l_ac2].ponslk07)
         DISPLAY BY NAME g_ponslk[l_ac2].ponslk20
      END IF
   END IF

   IF NOT cl_null(g_ponslk[l_ac2].ponslk20) THEN
       IF g_ponslk[l_ac2].ponslk20 <= 0 THEN
           CALL cl_err(g_ponslk[l_ac2].ponslk20,'mfg3331',0)
           LET g_ponslk[l_ac2].ponslk20 = g_ponslk_o.ponslk20
           DISPLAY g_ponslk[l_ac2].ponslk20 TO ponslk20
           RETURN FALSE
       END IF
       IF (g_ponslk_t.ponslk20 IS NULL OR g_ponslk[l_ac2].ponslk20 != g_ponslk_t.ponslk20 )
                AND (g_no != 'MISC') THEN
         #CALL s_sizechk(g_ponslk[l_ac2].ponslk04,g_ponslk[l_ac2].ponslk20,g_lang) #CHI-C10037 mark
          CALL s_sizechk(g_ponslk[l_ac2].ponslk04,g_ponslk[l_ac2].ponslk20,g_lang,g_ponslk[l_ac2].ponslk07)  #CHI-C10037 add
                  RETURNING g_ponslk[l_ac2].ponslk20
          DISPLAY g_ponslk[l_ac2].ponslk20 TO ponslk20

       END IF
   END IF
   LET g_ponslk2.ponslk20 = g_ponslk[l_ac2].ponslk20
   LET g_ponslk_o.ponslk20 = g_ponslk[l_ac2].ponslk20
   DISPLAY BY NAME g_ponslk[l_ac2].ponslk20

   IF cl_null(g_ponslk[l_ac2].ponslk31) OR g_ponslk[l_ac2].ponslk31 = 0 THEN
      CALL s_defprice_new(g_ponslk[l_ac2].ponslk04,g_pom.pom09,g_pom.pom22,g_pom.pom04,g_ponslk[l_ac2].ponslk20,'',
                          g_pom.pom21,g_pom.pom43,'1',g_ponslk[l_ac2].ponslk07,'',g_pom.pom41,g_pom.pom20,g_plant)
         RETURNING g_ponslk[l_ac2].ponslk31,g_ponslk[l_ac2].ponslk31t,
                   g_pmn73,g_pmn74   
      CALL t580_price_check_slk(g_ponslk[l_ac2].ponslk31,g_ponslk[l_ac2].ponslk31t)
      IF g_ponslk[l_ac2].ponslk31=0 THEN
         LET g_ponslk[l_ac2].ponslk31=g_ponslk2.ponslk31
         LET g_ponslk[l_ac2].ponslk31t=g_ponslk2.ponslk31t
      END IF
      LET g_ponslk[l_ac2].ponslk31 = cl_digcut(g_ponslk[l_ac2].ponslk31,t_azi03)
      LET g_ponslk[l_ac2].ponslk31t = cl_digcut(g_ponslk[l_ac2].ponslk31t,t_azi03)
      DISPLAY g_ponslk[l_ac2].ponslk31 TO ponslk31
      DISPLAY g_ponslk[l_ac2].ponslk31t TO ponslk31t
   END IF
   IF g_ponslk[l_ac2].ponslk20 <> g_ponslk_t.ponslk20 THEN
      CALL s_defprice_new(g_ponslk[l_ac2].ponslk04,g_pom.pom09,g_pom.pom22,g_pom.pom04,g_ponslk[l_ac2].ponslk20,'',
                          g_pom.pom21,g_pom.pom43,'1',g_ponslk[l_ac2].ponslk07,'',g_pom.pom41,g_pom.pom20,g_plant)
             RETURNING g_ponslk[l_ac2].ponslk31,g_ponslk[l_ac2].ponslk31t,
                       g_pmn73,g_pmn74   
...
FUNCTION t580_bp2(p_ud)
   ...
   DIALOG ATTRIBUTES(UNBUFFERED)
      ...
      DISPLAY ARRAY g_ponslk TO s_ponslk.*
         BEFORE DISPLAY
            CALL cl_navigator_setting( g_curs_index, g_row_count )
            CALL g_imx.clear()
            CALL t580_b_fill(g_wc2,g_wc3)
            CALL t580_b_fill2(g_wc3,g_wc2)
            LET g_action_choice=""
         ...
         BEFORE ROW
            ...
            END FOR
            LET l_ac2 = DIALOG.getCurrentRow("s_ponslk")
            IF l_ac2 != 0 THEN
               CALL s_settext_slk(g_ponslk[l_ac2].ponslk04)
               CALL s_fillimx_slk(g_ponslk[l_ac2].ponslk04,
                                   g_pom.pom01,g_ponslk[l_ac2].ponslk02)
...
FUNCTION t580_u()
	...
	END IF
        ...
        IF g_pom.pom01 != g_pom_t.pom01 THEN
           ...
           END IF
              UPDATE poni_file SET poni01=g_pom.pom01 WHERE poni01=g_pom_t.pom01
   ...
   END IF                     
    ...
    IF cl_delh(20,16) THEN
        ...
        FOREACH t580_r_c INTO l_pon.*
           ...
           ELSE
              IF NOT s_del_poni(l_pon.pon01,l_pon.pon02,'') THEN              
                 ROLLBACK WORK
                 RETURN
              END IF                                                       
           END IF
...
#FUN-C30057--add--begin-- 
       IF g_azw.azw04 = '2' THEN    
          DELETE FROM ponslk_file WHERE ponslk01=g_pom.pom01
          DELETE FROM ponislk_file WHERE ponislk01=g_pom.pom01
       END IF      
#FUN-C30057--add--end--
...
FUNCTION t580_copy()
  ...
  DEFINE li_result   LIKE type_file.num5       #No.FUN-540027  #No.FUN-680136 SMALLINT
  DEFINE l_poni      RECORD LIKE poni_file.*   #NO.FUN-7B0018
     IF s_shut(0) THEN RETURN END IF
     #TQC-C10020 mark---------------
     #IF g_pom.pom01 IS NULL THEN
     #   CALL cl_err('',-420,0)
...
#FUN-C30057--add--begin--
    IF g_azw.azw04 = '2' THEN    
       DROP TABLE y
       SELECT * FROM ponslk_file         #單身複製
           WHERE ponslk01=g_pom.pom01
           INTO TEMP y
       IF SQLCA.sqlcode THEN
           CALL cl_err3("sel","ponslk_file",g_pom.pom01,"",SQLCA.sqlcode,"","",1)  
           RETURN
       END IF
       UPDATE y
           SET ponslk01=l_newno,   
               ponslk21= 0  
       INSERT INTO ponslk_file
           SELECT * FROM y
       IF SQLCA.sqlcode THEN
           CALL cl_err3("ins","ponslk_file",g_pom.pom01,"",SQLCA.sqlcode,"","",1)  
           RETURN
       END IF
    END IF     
#FUN-C30057--add--end-- 
    ...
    IF SQLCA.sqlcode THEN
       ...
       RETURN
    ELSE
       INITIALIZE l_poni.* TO NULL
       DECLARE t580_cp_poni CURSOR FOR #FUN-C30057--add---- 
   #    SELECT * INTO l_poni.*         #FUN-C30057--mark---- 
        SELECT *                      #FUN-C30057--add----
          FROM poni_file
         WHERE poni01 = g_pom.pom01
        FOREACH t580_cp_poni INTO l_poni.* #FUN-C30057--add---- 
       LET l_poni.poni01 = l_newno
       IF NOT s_ins_poni(l_poni.*,'') THEN
          ROLLBACK WORK
          RETURN
       END IF
         END FOREACH                     #FUN-C30057--add---- 
       COMMIT WORK #No:7857
    END IF
...
#FUN-C30057---add--begin--
      ...
      IF g_azw.azw04 = '2' THEN    
          ...
          "  FOR UPDATE "
          LET g_forupd_sql = cl_forupd_sql(g_forupd_sql)
          DECLARE t580_bcl_slk CURSOR FROM g_forupd_sql
      ELSE  
          LET g_forupd_sql =
          " SELECT * ",
          "    FROM pon_file ",
...
#FUN-C30057--add--str--
    ...
    IF g_azw.azw04 = '2' THEN
       DIALOG ATTRIBUTES(UNBUFFERED) 
          INPUT ARRAY g_ponslk FROM s_ponslk.*
        ...
        BEFORE ROW
            ...
            LET l_n  = ARR_COUNT()
            SELECT ima151 INTO l_ima151 FROM ima_file WHERE ima01= g_ponslk[l_ac2].ponslk04 
            CALL s_settext_slk(g_ponslk[l_ac2].ponslk04)
            CALL s_fillimx_slk(g_ponslk[l_ac2].ponslk04,
                                g_pom.pom01,g_ponslk[l_ac2].ponslk02)
            LET g_rec_b3 = g_imx.getLength()
            IF l_ima151 <> 'Y' THEN
               CALL cl_set_comp_entry("ponslk20",TRUE)
            ELSE
               CALL cl_set_comp_entry("ponslk20",FALSE)
            END IF
            BEGIN WORK
            ...
            IF g_rec_b2 >= l_ac2 THEN
                LET p_cmd='u'
                LET g_ponslk_t.* = g_ponslk[l_ac2].*  #BACKUP
                LET g_ponslk_t.ponslk07 = g_ponslk[l_ac2].ponslk07  
                LET g_ponslk_o.ponslk07=g_ponslk_t.ponslk07
                OPEN t580_bcl_slk USING g_pom.pom01 ,g_ponslk_t.ponslk02
                IF STATUS THEN
                    CALL cl_err("OPEN t580_bcl_slk:", STATUS, 1)
                    LET l_lock_sw = "Y"
                ELSE
                    FETCH t580_bcl_slk INTO g_ponslk2.* 
                    IF SQLCA.sqlcode THEN
                        CALL cl_err(g_ponslk_t.ponslk02,SQLCA.sqlcode,1)
                        LET l_lock_sw = "Y"
                       CALL t580_b_move_to()
                       LET g_ponslk_o.*=g_ponslk2.*
                    END IF
                END IF
                IF g_sma.sma115 = 'Y' THEN
                   IF NOT cl_null(g_ponslk[l_ac2].ponslk04) THEN
                      SELECT ima44 INTO g_ima44
                        FROM ima_file WHERE ima01=g_ponslk[l_ac2].ponslk04
 
                      CALL s_chk_va_setting(g_ponslk[l_ac2].ponslk04)
                           RETURNING g_flag,g_ima906,g_ima907
 
                      CALL s_chk_va_setting1(g_ponslk[l_ac2].ponslk04)
        ...
        AFTER INSERT
            IF INT_FLAG THEN
               ...
               CANCEL INSERT
            END IF
            CALL t580_b_move_back() 
            IF NOT cl_null(g_ponslk[l_ac2].ponslk04) THEN
               SELECT ima151 INTO l_ima151 FROM ima_file WHERE ima01 = g_ponslk[l_ac2].ponslk04 
                  IF l_ima151 = 'N' THEN        #非子、母料件
                     LET g_pon_slk.pon01 = g_pom.pom01
                     SELECT MAX(pon02) INTO l_n FROM pon_file WHERE pon01 = g_pom.pom01
                        IF cl_null(l_n) THEN
                           LET l_n = 0
                        END IF 
                        LET g_pon_slk.pon02 = l_n + 1
                        LET g_pon_slk.pon04 = g_ponslk[l_ac2].ponslk04
                        LET g_pon_slk.pon06 = g_ponslk[l_ac2].ponslk06
                        LET g_pon_slk.pon19 = g_ponslk[l_ac2].ponslk19
                        LET g_pon_slk.pon041= g_ponslk[l_ac2].ponslk041
                        CALL t580_ponslk_move()
                        INSERT INTO pon_file VALUES(g_pon_slk.*)
                        IF SQLCA.sqlcode THEN
                           CALL cl_err3("ins","pon_file",g_pom.pom01,g_ponslk[l_ac2].ponslk02,SQLCA.sqlcode,"","",1)
                        ELSE
                           LET g_poni_slk.poni01 = g_pom.pom01
                           LET g_poni_slk.poni02 = g_pon_slk.pon02
                           LET g_poni_slk.ponislk03 = g_ponslk[l_ac2].ponslk04
                           LET g_poni_slk.ponislk02 = g_ponslk[l_ac2].ponslk02
                           LET g_poni_slk.poniplant = g_plant
                           LET g_poni_slk.ponilegal = g_legal
                           INSERT INTO poni_file VALUES(g_poni_slk.*)
                           IF SQLCA.sqlcode THEN
                           CALL cl_err3("ins","poni_file",g_pom.pom01,g_ponslk[l_ac2].ponslk02,SQLCA.sqlcode,"","",1)
                           END IF
                      END IF
                    END IF 
                  END IF  
            IF g_sma.sma115 = 'Y' THEN
               ...
               END IF
            END IF  
            LET g_ponslk2.ponslk06 = g_ponslk[l_ac2].ponslk06   
            LET g_ponslk2.ponslk19 = g_ponslk[l_ac2].ponslk19
            LET g_ponslk2.ponslk21 = g_ponslk[l_ac2].ponslk21
            LET g_ponslk2.ponslk31 = g_ponslk[l_ac2].ponslk31
            LET g_ponslk2.ponslk31t= g_ponslk[l_ac2].ponslk31t  
            IF g_ponslk2.ponslk20 <> g_ponslk[l_ac2].ponslk20 THEN
                LET g_ponslk[l_ac2].ponslk20 = g_ponslk2.ponslk20
            END IF
            LET g_ponslk2.ponslkplant = g_plant  
            LET g_ponslk2.ponslklegal = g_legal  
            INSERT INTO ponslk_file VALUES(g_ponslk2.*)
            IF SQLCA.sqlcode THEN
               CALL cl_err3("ins","ponslk_file",g_ponslk2.ponslk01,g_ponslk2.ponslk02,SQLCA.sqlcode,"","",1)  
               LET g_success = 'N'
               CANCEL INSERT
            ELSE
               MESSAGE 'INSERT O.K'
        ...
        BEFORE INSERT
            LET l_n = ARR_COUNT()
            LET p_cmd='a'
            INITIALIZE g_ponslk[l_ac2].* TO NULL      
            INITIALIZE g_ponslk_o.* TO NULL
            INITIALIZE g_ponslk_t.* TO NULL
            INITIALIZE g_ponslk2.* TO NULL
            LET g_ponslk[l_ac2].ponslk19 = g_today
            LET g_ponslk[l_ac2].ponslk20 = 0
            LET g_ponslk[l_ac2].ponslk21 = 0
            LET g_ponslk[l_ac2].ponslk31 = 0
            LET g_ponslk[l_ac2].ponslk31t= 0      
            LET g_ponslk2.ponslk01      = g_pom.pom01
            LET g_ponslk2.ponslk20      = 0          #訂購量
            LET g_ponslk2.ponslk31      = 0          #單價
            LET g_ponslk2.ponslk31t     = 0          #含稅單價  
            LET g_ponslk_t.*         = g_ponslk[l_ac2].*      #新輸入資料
            LET g_ponslk_t.ponslk07         = NULL               
            CALL cl_show_fld_cont()     
            NEXT FIELD ponslk02
 
        BEFORE FIELD ponslk02                        #default 序號
            IF cl_null(g_ponslk[l_ac2].ponslk02) OR
               g_ponslk[l_ac2].ponslk02 = 0 THEN
               SELECT max(ponslk02)+1 INTO g_ponslk[l_ac2].ponslk02
                   FROM ponslk_file
                   WHERE ponslk01 = g_pom.pom01
               IF cl_null(g_ponslk[l_ac2].ponslk02) THEN
                  LET g_ponslk[l_ac2].ponslk02 = 1
               END IF
            END IF
 
        AFTER FIELD ponslk02                        #check 序號是否重複
            IF cl_null(g_ponslk[l_ac2].ponslk02) THEN
               LET g_ponslk[l_ac2].ponslk02 = g_ponslk_t.ponslk02
            END IF
            IF NOT cl_null(g_ponslk[l_ac2].ponslk02) THEN
                IF g_ponslk[l_ac2].ponslk02 != g_ponslk_t.ponslk02 OR
                   g_ponslk_t.ponslk02 IS NULL THEN
                    SELECT count(*) INTO l_n FROM ponslk_file
                        WHERE ponslk01 = g_pom.pom01 AND
                              ponslk02 = g_ponslk[l_ac2].ponslk02
                    IF l_n > 0 THEN
                        CALL cl_err('',-239,0)
                        LET g_ponslk[l_ac2].ponslk02 = g_ponslk_t.ponslk02
                        NEXT FIELD ponslk02
                ...
                END IF
            END IF
            LET g_ponslk2.ponslk02 = g_ponslk[l_ac2].ponslk02
            LET g_ponslk_o.ponslk02 = g_ponslk[l_ac2].ponslk02

        AFTER FIELD ponslk04  	# check 料件編號
            IF NOT cl_null(g_ponslk[l_ac2].ponslk04) THEN
               IF NOT s_chk_item_no(g_ponslk[l_ac2].ponslk04,"") THEN
                  CALL cl_err('',g_errno,1)
                  LET g_ponslk[l_ac2].ponslk04= g_ponslk_t.ponslk04
                  NEXT FIELD ponslk04
               END IF
               SELECT ima151,imaag INTO l_ima151,l_imaag FROM ima_file
                 WHERE ima01=g_ponslk[l_ac2].ponslk04 AND imaacti='Y'
                 IF l_ima151='N' AND l_imaag='@CHILD' THEN
                   CALL cl_err('','axm1104',0)
                   NEXT FIELD ponslk04
                END IF

               LET l_misc=g_ponslk[l_ac2].ponslk04[1,4]
               IF g_ponslk[l_ac2].ponslk04[1,4]='MISC' THEN  #NO:6808
                   ...
                   END IF
               END IF
               LET g_ponslk2.ponslk04 = g_ponslk[l_ac2].ponslk04
               LET g_no = g_ponslk2.ponslk04[1,4]
               IF (g_ponslk[l_ac2].ponslk04 != g_ponslk_t.ponslk04 OR g_ponslk_t.ponslk04 IS NULL) 
                  OR cl_null(g_ponslk[l_ac2].ponslk041) THEN 
                  CALL t580_ponslk04()
                  IF NOT cl_null(g_errno) THEN
               ...
               IF g_sma.sma115 = 'Y' THEN
                   ...
                   END IF
                END IF       
                 SELECT ima02,ima44 INTO g_ponslk[l_ac2].ponslk041,g_ponslk[l_ac2].ponslk07
                  FROM ima_file WHERE ima01=g_ponslk[l_ac2].ponslk04
                SELECT ima151 INTO l_ima151 FROM ima_file WHERE ima01 = g_ponslk[l_ac2].ponslk04
                IF l_ima151 = 'Y' THEN
                   CALL cl_set_comp_entry("ponslk20",FALSE)
               ...
               END IF
            END IF
            IF (g_ponslk_t.ponslk04 IS NULL OR g_ponslk[l_ac2].ponslk04 != g_ponslk_t.ponslk04) AND NOT cl_null(g_ponslk[l_ac2].ponslk04)      
                AND (g_no != 'MISC') THEN
               #採購料件/供應商控制
                SELECT ima915 INTO l_ima915 FROM ima_file WHERE ima01=g_ponslk[l_ac2].ponslk04
                IF l_ima915='2' OR l_ima915='3' THEN 
                   CALL t580_pmh(g_ponslk[l_ac2].ponslk04)
                   IF NOT cl_null(g_errno) THEN
                      CALL cl_err(g_ponslk[l_ac2].ponslk04,g_errno,0)
                      LET g_ponslk[l_ac2].ponslk04 = g_ponslk_o.ponslk04
                      NEXT FIELD ponslk04
                   END IF
                END IF
                #料件主檔檢查/預設值的讀取
                IF g_ponslk[l_ac2].ponslk04<>g_ponslk_t.ponslk04 OR
                   cl_null(g_ponslk_t.ponslk04) THEN
                ...
                #單價預設值的設定
#FUN-C60091------ADD----STR-----
                CALL s_defprice_new(g_ponslk[l_ac2].ponslk04,g_pom.pom09,g_pom.pom22,
                                   g_pom.pom04,g_ponslk[l_ac2].ponslk20,'',g_pom.pom21,g_pom.pom43,
                                   '1',g_ponslk[l_ac2].ponslk07,'',g_pom.pom41,g_pom.pom20,g_plant)
                        RETURNING g_ponslk[l_ac2].ponslk31,g_ponslk[l_ac2].ponslk31t,
                                  g_pmn73,g_pmn74
#FUN-C60091------ADD----END-----
            END IF
            CALL t580_price_check_slk(g_ponslk[l_ac2].ponslk31,g_ponslk[l_ac2].ponslk31t)
            IF cl_null(g_ponslk[l_ac2].ponslk31)  THEN LET g_ponslk[l_ac2].ponslk31 = 0 END IF
            IF cl_null(g_ponslk[l_ac2].ponslk31t) THEN LET g_ponslk[l_ac2].ponslk31t= 0 END IF
            ...
            END IF
            LET g_ponslk2.ponslk04 = g_ponslk[l_ac2].ponslk04
            LET g_ponslk_o.ponslk04 = g_ponslk[l_ac2].ponslk04
            CALL s_settext_slk(g_ponslk[l_ac2].ponslk04)
            CALL s_fillimx_slk(g_ponslk[l_ac2].ponslk04,
                               g_pom.pom01,g_ponslk[l_ac2].ponslk02)
            LET g_rec_b3 = g_imx.getLength()   
 
        AFTER FIELD ponslk041
            LET g_ponslk2.ponslk041 = g_ponslk[l_ac2].ponslk041
 
        AFTER FIELD ponslk07    #採購單位
            IF NOT cl_null(g_ponslk[l_ac2].ponslk07) THEN
                IF g_no = 'MISC' THEN
                   CALL t580_unit(g_ponslk[l_ac2].ponslk07)
                   IF NOT cl_null(g_errno) THEN
                      CALL cl_err(g_ponslk[l_ac2].ponslk07,g_errno,0)
                      LET g_ponslk[l_ac2].ponslk07 = g_ponslk_t.ponslk07
                      DISPLAY g_ponslk[l_ac2].ponslk07 TO ponslk07
                      NEXT FIELD ponslk07
                   END IF
                END IF
                IF g_ponslk[l_ac2].ponslk07 <> g_ponslk_o.ponslk07 THEN
                   CALL s_defprice_new(g_ponslk[l_ac2].ponslk04,g_pom.pom09,g_pom.pom22,
                                   g_pom.pom04,g_ponslk[l_ac2].ponslk20,'',g_pom.pom21,g_pom.pom43,
                                   '1',g_ponslk[l_ac2].ponslk07,'',g_pom.pom41,g_pom.pom20,g_plant)
                        RETURNING g_ponslk[l_ac2].ponslk31,g_ponslk[l_ac2].ponslk31t,
                ...
                END IF
            END IF
            IF NOT t580_ponslk20_check(p_cmd) THEN
               LET g_ponslk[l_ac2].ponslk07 = g_ponslk_t.ponslk07
               NEXT FIELD ponslk20
            END IF
            LET g_ponslk2.ponslk07  = g_ponslk[l_ac2].ponslk07
            LET g_ponslk_o.ponslk07 = g_ponslk[l_ac2].ponslk07
            LET g_ponslk_t.ponslk07 = g_ponslk[l_ac2].ponslk07
           
        AFTER FIELD ponslk19
            IF NOT cl_null(g_ponslk[l_ac2].ponslk19) THEN
               IF g_ponslk[l_ac2].ponslk19 < g_pom.pom04 THEN
                  CALL cl_err('','apm-816',1)
                  NEXT FIELD ponslk19
               END IF
            END IF  
         
        AFTER FIELD ponslk20
            IF NOT t580_ponslk20_check(p_cmd) THEN 
               NEXT FIELD ponslk20                 
            END IF 

        AFTER FIELD ponslk31   #單價
            IF NOT cl_null(g_ponslk[l_ac2].ponslk31) THEN
                IF g_ponslk[l_ac2].ponslk31 < 0 THEN
                   CALL cl_err(g_ponslk[l_ac2].ponslk31,'mfg1322',1)
                   LET g_ponslk[l_ac2].ponslk31 = g_ponslk_o.ponslk31
                   DISPLAY g_ponslk[l_ac2].ponslk31 TO ponslk31
                   NEXT FIELD ponslk31
                END IF
                #----- check採購單價超過最近採購單價% 
                IF g_sma.sma84 != 99.99 AND g_ponslk[l_ac2].ponslk04<>'MISC' THEN
                   SELECT ima53 INTO l_ima53 FROM ima_file
                    WHERE ima01=g_ponslk[l_ac2].ponslk04
                   IF l_ima53 != 0 THEN  
                      IF g_ponslk[l_ac2].ponslk31*g_pom.pom42 > l_ima53*(1+g_sma.sma84/100) 
                      THEN
                         IF g_sma.sma109 = 'R' THEN 
                             CALL cl_err(g_ponslk[l_ac2].ponslk04,'apm-240',0)
                             NEXT FIELD ponslk31
                         ELSE
                             CALL cl_err(g_ponslk[l_ac2].ponslk04,'apm-240',0)
                         END IF
                   ...
                   END IF
                END IF
                CALL cl_digcut(g_ponslk[l_ac2].ponslk31,t_azi03)  
                     RETURNING g_ponslk[l_ac2].ponslk31
                DISPLAY g_ponslk[l_ac2].ponslk31  TO ponslk31
               
                LET g_ponslk[l_ac2].ponslk31t =
                    g_ponslk[l_ac2].ponslk31 * ( 1 + g_pom.pom43/100)
                LET g_ponslk[l_ac2].ponslk31t = cl_digcut(g_ponslk[l_ac2].ponslk31t,t_azi03)   

                LET g_ponslk_o.ponslk31 = g_ponslk[l_ac2].ponslk31
                LET g_ponslk2.ponslk31 = g_ponslk[l_ac2].ponslk31
                LET g_ponslk_o.ponslk31t = g_ponslk[l_ac2].ponslk31t
                LET g_ponslk2.ponslk31t = g_ponslk[l_ac2].ponslk31t
                DISPLAY g_ponslk[l_ac2].ponslk31  TO ponslk31
                DISPLAY g_ponslk[l_ac2].ponslk31t TO ponslk31t
            END IF
 
        AFTER FIELD ponslk31t     #含稅單價
             IF NOT cl_null(g_ponslk[l_ac2].ponslk31t) THEN
                IF g_ponslk[l_ac2].ponslk31t < 0 THEN
                   CALL cl_err(g_ponslk[l_ac2].ponslk31t,'mfg1322',1)
                   LET g_ponslk[l_ac2].ponslk31t = g_ponslk_o.ponslk31t
                   NEXT FIELD ponslk31t
                END IF
                LET g_ponslk[l_ac2].ponslk31t = cl_digcut(g_ponslk[l_ac2].ponslk31t,t_azi03) 
                LET g_ponslk[l_ac2].ponslk31 =
                    g_ponslk[l_ac2].ponslk31t / ( 1 + g_pom.pom43 / 100)
                LET g_ponslk[l_ac2].ponslk31 = cl_digcut(g_ponslk[l_ac2].ponslk31,t_azi03)
        ...
        BEFORE DELETE                            #是否取消單身
            IF g_ponslk_t.ponslk02 > 0 AND
                    g_ponslk_t.ponslk02 IS NOT NULL THEN
                ...
                IF l_lock_sw = "Y" THEN
                   ...
                   CANCEL DELETE
                END IF
                DELETE FROM ponslk_file
                    WHERE ponslk01 = g_pom.pom01 AND
                          ponslk02 = g_ponslk_t.ponslk02
                IF SQLCA.sqlcode THEN
                    CALL cl_err3("del","ponslk_file",g_pom.pom01,g_ponslk_t.ponslk02,SQLCA.sqlcode,"","",1)  
                    ROLLBACK WORK
                    CANCEL DELETE
                ELSE
                  LET g_rec_b2=g_rec_b2-1
                   DELETE FROM pon_file WHERE pon01=g_pom.pom01 
                                          AND pon02 IN (SELECT pon02 FROM pon_file,poni_file
                                                         WHERE pon01=poni01
                                                           AND pon02=poni02 
                                                           AND poni01=g_pom.pom01
                                                           AND ponislk03=g_ponslk_t.ponslk04
                                                           AND ponislk02=g_ponslk_t.ponslk02)
                   DELETE FROM poni_file WHERE poni01=g_pom.pom01
                                           AND ponislk03=g_ponslk_t.ponslk04
                                           AND ponislk02=g_ponslk_t.ponslk02                                    
                END IF
        ...
        ON ROW CHANGE
            IF INT_FLAG THEN
               CALL cl_err('',9001,0)
               LET INT_FLAG = 0
               LET g_ponslk[l_ac2].* = g_ponslk_t.*
               CLOSE t580_bcl_slk
               ROLLBACK WORK
            END IF
            IF l_lock_sw = 'Y' THEN
                CALL cl_err(g_ponslk[l_ac2].ponslk02,-263,1)
                LET g_ponslk[l_ac2].* = g_ponslk_t.*
            ELSE
                IF g_sma.sma115 = 'Y' THEN
                   IF NOT cl_null(g_ponslk[l_ac2].ponslk04) THEN
                 ...
                 SELECT azi03,azi04 INTO t_azi03,t_azi04 FROM azi_file    
                  WHERE azi01 = g_pom.pom22  AND aziacti= 'Y'  #原幣         
                 IF g_ponslk[l_ac2].ponslk20 < 0  THEN
                     CALL cl_err(g_ponslk[l_ac2].ponslk20,'mfg0013',1)
                     LET g_ponslk[l_ac2].ponslk20 = g_ponslk_o.ponslk20
                     IF g_sma.sma115 != 'Y' THEN
                        NEXT FIELD ponslk20
                     END IF
                 ...
                 UPDATE ponslk_file SET ponslk_file.* = g_ponslk2.*   # 更新DB
                  WHERE ponslk01=g_pom.pom01 AND ponslk02=g_ponslk_t.ponslk02
                 IF SQLCA.sqlcode OR SQLCA.sqlerrd[3] = 0 THEN
                    CALL cl_err3("upd","ponslk_file",g_pom.pom01,g_ponslk_t.ponslk02,SQLCA.sqlcode,"","",1)  
                    LET g_ponslk[l_ac2].* = g_ponslk_t.*
                 ELSE
                    IF g_ponslk[l_ac2].ponslk04 != g_ponslk_t.ponslk04 THEN 
                       DELETE FROM pon_file WHERE pon01=g_pom.pom01
                                              AND pon02 IN (SELECT pon02 FROM pon_file,poni_file
                                                             WHERE pon01=poni01
                                                               AND pon02=poni02
                       ...
                       END IF   
                    ELSE
                       SELECT ima151 INTO l_ima151 FROM ima_file WHERE ima01 = g_ponslk_t.ponslk04
                       IF l_ima151 = 'N' THEN        #非子、母料件
                          UPDATE pon_file SET pon07  = g_ponslk[l_ac2].ponslk07,
                                              pon19  = g_ponslk[l_ac2].ponslk19,
                                              pon20  = g_ponslk[l_ac2].ponslk20,
                                              pon31  = g_ponslk[l_ac2].ponslk31,
                                              pon31t = g_ponslk[l_ac2].ponslk31t,
                                              pon06  = g_ponslk[l_ac2].ponslk06,
                                              pon82  = g_ponslk[l_ac2].ponslk20,
                                              pon87  = g_ponslk[l_ac2].ponslk20,
                                              pon88  = ROUND(g_ponslk[l_ac2].ponslk31 * g_ponslk[l_ac2].ponslk20,t_azi04),
                                              pon88t = ROUND(g_ponslk[l_ac2].ponslk31t * g_ponslk[l_ac2].ponslk20,t_azi04)
                                        WHERE pon01 = g_pom.pom01
                                          AND pon02 IN (SELECT pon02 FROM pon_file,poni_file
                                                              WHERE pon01=poni01
                                                                AND pon02=poni02
                       ...
                       ELSE
                          UPDATE pon_file SET pon07  = g_ponslk[l_ac2].ponslk07,
                                              ...
                                              pon31t = g_ponslk[l_ac2].ponslk31t,
                                              pon06  = g_ponslk[l_ac2].ponslk06,
                                              pon88  = ROUND(g_ponslk[l_ac2].ponslk31 * pon20,t_azi04),
                                              pon88t = ROUND(g_ponslk[l_ac2].ponslk31t * pon20,t_azi04)
                                        WHERE pon01=g_pom.pom01
                                           AND pon02 IN (SELECT pon02 FROM pon_file,poni_file
                                                           WHERE pon01=poni01
                                                             AND pon02=poni02
                ...
                CALL t580_update()    
                COMMIT WORK
                CALL t580_b_fill(' 1=1',' 1=1')    # 新增參數用於服飾行業母單身和子單身的切換
                CALL t580_b_fill2(' 1=1',' 1=1') 
                ELSE
                   ROLLBACK WORK
                END IF
       ...
       #   #LET g_qryparam.default1 = g_pom.pom09
       #    CALL cl_create_qry() RETURNING g_ponslk[l_ac2].ponslk04
       #    DISPLAY g_ponslk[l_ac2].ponslk04 TO ponslk04
       #    NEXT FIELD ponslk04
        ...
        ON ACTION special_desc
             LET g_cmd = "apmt402 2 '",g_pom.pom01,"' ",g_ponslk[l_ac2].ponslk02
             CALL cl_cmdrun_wait(g_cmd)  
 
 
        ON ACTION CONTROLP
            CASE
               WHEN INFIELD(ponslk04) #料件編號
                  CALL q_sel_ima(FALSE, "q_ima01_slk","",g_ponslk[l_ac2].ponslk04,"","","","","",'' ) 
                  RETURNING g_ponslk[l_ac2].ponslk04
                  DISPLAY g_ponslk[l_ac2].ponslk04 TO ponslk04
                  NEXT FIELD ponslk04

               WHEN INFIELD(ponslk07) #採購單位
                  CALL cl_init_qry_var()
                  LET g_qryparam.form = "q_gfe"
                  LET g_qryparam.default1 = g_ponslk[l_ac2].ponslk07
                  CALL cl_create_qry() RETURNING g_ponslk[l_ac2].ponslk07
                  DISPLAY g_ponslk[l_ac2].ponslk07 TO ponslk07
                  NEXT FIELD ponslk07
               OTHERWISE EXIT CASE
            END CASE
        ...
        ON ACTION CONTROLO                        #沿用所有欄位
            IF INFIELD(ponslk02) AND l_ac2 > 1 THEN
                LET g_ponslk[l_ac2].* = g_ponslk[l_ac2-1].*
                NEXT FIELD ponslk02
            END IF
       ...
       INPUT ARRAY g_imx FROM s_imx.*
          ...
          AFTER FIELD imx01
             IF NOT cl_null(g_imx[l_ac3].imx01) THEN
                IF p_cmd3='a' OR (g_imx[l_ac3].imx01 !=g_imx_t.imx01 AND g_imx_t.imx01 IS NOT NULL) THEN
                   IF NOT t580_check_imx(1,g_imx[l_ac3].imx01,g_imx_t.imx01) THEN
                       LET g_imx[l_ac3].imx01 = g_imx_t.imx01 
                       NEXT FIELD imx01
                    END IF
                    CALL s_chk_prod_strategy(l_ac3,1,g_ponslk[l_ac2].ponslk04,g_imx[l_ac3].imx01) RETURNING l_error,l_ima01
          ...
          IF NOT cl_null(g_imx[l_ac3].imx02) THEN
                 IF p_cmd3='a' OR (g_imx[l_ac3].imx02 !=g_imx_t.imx02 AND g_imx_t.imx02 IS NOT NULL) THEN
                    IF NOT t580_check_imx(2,g_imx[l_ac3].imx02,g_imx_t.imx02) THEN
                       LET g_imx[l_ac3].imx02 = g_imx_t.imx02
                       NEXT FIELD imx02
                    END IF
                    CALL s_chk_prod_strategy(l_ac3,2,g_ponslk[l_ac2].ponslk04,g_imx[l_ac3].imx02) RETURNING l_error,l_ima01
                    IF NOT cl_null(l_error) THEN   #檢查商品策略
                       CALL cl_err(l_ima01,l_error,0)
                       LET g_imx[l_ac3].imx02 = g_imx_t.imx02
                       NEXT FIELD imx02
           ...
           AFTER FIELD imx03
              IF NOT cl_null(g_imx[l_ac3].imx03) THEN
                 IF p_cmd3='a' OR (g_imx[l_ac3].imx03 !=g_imx_t.imx03 AND g_imx_t.imx03 IS NOT NULL) THEN
                    IF NOT t580_check_imx(3,g_imx[l_ac3].imx03,g_imx_t.imx03) THEN
                       LET g_imx[l_ac3].imx03 = g_imx_t.imx03
                       NEXT FIELD imx03
                    END IF
                    CALL s_chk_prod_strategy(l_ac3,3,g_ponslk[l_ac2].ponslk04,g_imx[l_ac3].imx03) RETURNING l_error,l_ima01
                    IF NOT cl_null(l_error) THEN   #檢查商品策略
                       CALL cl_err(l_ima01,l_error,0)
                       LET g_imx[l_ac3].imx03 = g_imx_t.imx03
                       NEXT FIELD imx03
           ...
           AFTER FIELD imx04
              IF NOT cl_null(g_imx[l_ac3].imx04) THEN
                 IF p_cmd3='a' OR (g_imx[l_ac3].imx04 !=g_imx_t.imx04 AND g_imx_t.imx04 IS NOT NULL) THEN
                     IF NOT t580_check_imx(4,g_imx[l_ac3].imx04,g_imx_t.imx04) THEN
                        LET g_imx[l_ac3].imx04 = g_imx_t.imx04
                        NEXT FIELD imx04
                     END IF
                    CALL s_chk_prod_strategy(l_ac3,4,g_ponslk[l_ac2].ponslk04,g_imx[l_ac3].imx04) RETURNING l_error,l_ima01
                    IF NOT cl_null(l_error) THEN   #檢查商品策略
                       CALL cl_err(l_ima01,l_error,0)
                       LET g_imx[l_ac3].imx04 = g_imx_t.imx04
                       NEXT FIELD imx04
           ...
           AFTER FIELD imx05
              IF NOT cl_null(g_imx[l_ac3].imx05) THEN
                 IF p_cmd3='a' OR (g_imx[l_ac3].imx05 !=g_imx_t.imx05 AND g_imx_t.imx05 IS NOT NULL) THEN
                    IF NOT t580_check_imx(5,g_imx[l_ac3].imx05,g_imx_t.imx05) THEN
                       LET g_imx[l_ac3].imx05 = g_imx_t.imx05
                       NEXT FIELD imx05
                    END IF
                    CALL s_chk_prod_strategy(l_ac3,5,g_ponslk[l_ac2].ponslk04,g_imx[l_ac3].imx05) RETURNING l_error,l_ima01
                    IF NOT cl_null(l_error) THEN   #檢查商品策略
                       CALL cl_err(l_ima01,l_error,0)
                       LET g_imx[l_ac3].imx05 = g_imx_t.imx05
                       NEXT FIELD imx05
           ...
           AFTER FIELD imx06
              IF NOT cl_null(g_imx[l_ac3].imx06) THEN
                 IF p_cmd3='a' OR (g_imx[l_ac3].imx06 !=g_imx_t.imx06 AND g_imx_t.imx06 IS NOT NULL) THEN
                    IF NOT t580_check_imx(6,g_imx[l_ac3].imx06,g_imx_t.imx06) THEN
                       LET g_imx[l_ac3].imx06 = g_imx_t.imx06
                       NEXT FIELD imx06
                    END IF
                    CALL s_chk_prod_strategy(l_ac3,6,g_ponslk[l_ac2].ponslk04,g_imx[l_ac3].imx06) RETURNING l_error,l_ima01
                    IF NOT cl_null(l_error) THEN   #檢查商品策略
                       CALL cl_err(l_ima01,l_error,0)
                       LET g_imx[l_ac3].imx06 = g_imx_t.imx06
                       NEXT FIELD imx06
           ...
           AFTER FIELD imx07
              IF NOT cl_null(g_imx[l_ac3].imx07) THEN
                 IF p_cmd3='a' OR (g_imx[l_ac3].imx07 !=g_imx_t.imx07 AND g_imx_t.imx07 IS NOT NULL) THEN
                    IF NOT t580_check_imx(7,g_imx[l_ac3].imx07,g_imx_t.imx07) THEN
                       LET g_imx[l_ac3].imx07 = g_imx_t.imx07
                       NEXT FIELD imx07
                    END IF
                    CALL s_chk_prod_strategy(l_ac3,7,g_ponslk[l_ac2].ponslk04,g_imx[l_ac3].imx07) RETURNING l_error,l_ima01
                    IF NOT cl_null(l_error) THEN   #檢查商品策略
                       CALL cl_err(l_ima01,l_error,0)
                       LET g_imx[l_ac3].imx07 = g_imx_t.imx07
                       NEXT FIELD imx07
           ...
           AFTER FIELD imx08
              IF NOT cl_null(g_imx[l_ac3].imx08) THEN
                 IF p_cmd3='a' OR (g_imx[l_ac3].imx08 !=g_imx_t.imx08 AND g_imx_t.imx08 IS NOT NULL) THEN
                    IF NOT t580_check_imx(8,g_imx[l_ac3].imx08,g_imx_t.imx08) THEN
                       LET g_imx[l_ac3].imx08 = g_imx_t.imx08
                       NEXT FIELD imx08
                    END IF
                    CALL s_chk_prod_strategy(l_ac3,8,g_ponslk[l_ac2].ponslk04,g_imx[l_ac3].imx08) RETURNING l_error,l_ima01
                    IF NOT cl_null(l_error) THEN   #檢查商品策略
                       CALL cl_err(l_ima01,l_error,0)
                       LET g_imx[l_ac3].imx08 = g_imx_t.imx08
                       NEXT FIELD imx08
           ...
           AFTER FIELD imx09
              IF NOT cl_null(g_imx[l_ac3].imx09) THEN
                 IF p_cmd3='a' OR (g_imx[l_ac3].imx09 !=g_imx_t.imx09 AND g_imx_t.imx09 IS NOT NULL) THEN
                    IF NOT t580_check_imx(9,g_imx[l_ac3].imx09,g_imx_t.imx09) THEN
                       LET g_imx[l_ac3].imx09 = g_imx_t.imx09
                       NEXT FIELD imx09
                    END IF
                    CALL s_chk_prod_strategy(l_ac3,9,g_ponslk[l_ac2].ponslk04,g_imx[l_ac3].imx09) RETURNING l_error,l_ima01
                    IF NOT cl_null(l_error) THEN   #檢查商品策略
                       CALL cl_err(l_ima01,l_error,0)
                       LET g_imx[l_ac3].imx09 = g_imx_t.imx09
                       NEXT FIELD imx09
           ...
           AFTER FIELD imx10
              IF NOT cl_null(g_imx[l_ac3].imx10) THEN
                 IF p_cmd3='a' OR (g_imx[l_ac3].imx10 !=g_imx_t.imx10 AND g_imx_t.imx10 IS NOT NULL) THEN
                    IF NOT t580_check_imx(10,g_imx[l_ac3].imx10,g_imx_t.imx10) THEN
                       LET g_imx[l_ac3].imx10 = g_imx_t.imx10
                       NEXT FIELD imx10
                    END IF
                    CALL s_chk_prod_strategy(l_ac3,10,g_ponslk[l_ac2].ponslk04,g_imx[l_ac3].imx10) RETURNING l_error,l_ima01
                    IF NOT cl_null(l_error) THEN   #檢查商品策略
                       CALL cl_err(l_ima01,l_error,0)
                       LET g_imx[l_ac3].imx10 = g_imx_t.imx10
                       NEXT FIELD imx10
           ...
           AFTER FIELD imx11
              IF NOT cl_null(g_imx[l_ac3].imx11) THEN
                 IF p_cmd3='a' OR (g_imx[l_ac3].imx11 !=g_imx_t.imx11 AND g_imx_t.imx11 IS NOT NULL) THEN
                    IF NOT t580_check_imx(11,g_imx[l_ac3].imx11,g_imx_t.imx11) THEN
                       LET g_imx[l_ac3].imx11 = g_imx_t.imx11
                       NEXT FIELD imx11
                    END IF
                    CALL s_chk_prod_strategy(l_ac3,11,g_ponslk[l_ac2].ponslk04,g_imx[l_ac3].imx11) RETURNING l_error,l_ima01
                    IF NOT cl_null(l_error) THEN   #檢查商品策略
                       CALL cl_err(l_ima01,l_error,0)
                       LET g_imx[l_ac3].imx11 = g_imx_t.imx11
                       NEXT FIELD imx11
           ...
           AFTER FIELD imx12
              IF NOT cl_null(g_imx[l_ac3].imx12) THEN
                 IF p_cmd3='a' OR (g_imx[l_ac3].imx12 !=g_imx_t.imx12 AND g_imx_t.imx12 IS NOT NULL) THEN
                    IF NOT t580_check_imx(12,g_imx[l_ac3].imx12,g_imx_t.imx12) THEN
                       LET g_imx[l_ac3].imx12 = g_imx_t.imx12
                       NEXT FIELD imx12
                    END IF
                    CALL s_chk_prod_strategy(l_ac3,12,g_ponslk[l_ac2].ponslk04,g_imx[l_ac3].imx12) RETURNING l_error,l_ima01
                    IF NOT cl_null(l_error) THEN   #檢查商品策略
                       CALL cl_err(l_ima01,l_error,0)
                       LET g_imx[l_ac3].imx12 = g_imx_t.imx12
                       NEXT FIELD imx12
           ...
           AFTER FIELD imx13
              IF NOT cl_null(g_imx[l_ac3].imx13) THEN
                 IF p_cmd3='a' OR (g_imx[l_ac3].imx13 !=g_imx_t.imx13 AND g_imx_t.imx13 IS NOT NULL) THEN
                    IF NOT t580_check_imx(13,g_imx[l_ac3].imx13,g_imx_t.imx13) THEN
                       LET g_imx[l_ac3].imx13 = g_imx_t.imx13
                       NEXT FIELD imx13
                    END IF
                    CALL s_chk_prod_strategy(l_ac3,13,g_ponslk[l_ac2].ponslk04,g_imx[l_ac3].imx13) RETURNING l_error,l_ima01
                    IF NOT cl_null(l_error) THEN   #檢查商品策略
                       CALL cl_err(l_ima01,l_error,0)
                       LET g_imx[l_ac3].imx13 = g_imx_t.imx13
                       NEXT FIELD imx13
           ...
           AFTER FIELD imx14
              IF NOT cl_null(g_imx[l_ac3].imx14) THEN
                 IF p_cmd3='a' OR (g_imx[l_ac3].imx14 !=g_imx_t.imx14 AND g_imx_t.imx14 IS NOT NULL) THEN
                    IF NOT t580_check_imx(14,g_imx[l_ac3].imx14,g_imx_t.imx14) THEN
                       LET g_imx[l_ac3].imx14 = g_imx_t.imx14
                       NEXT FIELD imx14
                    END IF
                    CALL s_chk_prod_strategy(l_ac3,14,g_ponslk[l_ac2].ponslk04,g_imx[l_ac3].imx14) RETURNING l_error,l_ima01
                    IF NOT cl_null(l_error) THEN   #檢查商品策略
                       CALL cl_err(l_ima01,l_error,0)
                       LET g_imx[l_ac3].imx14 = g_imx_t.imx14
                       NEXT FIELD imx14
           ...
           AFTER FIELD imx15
              IF NOT cl_null(g_imx[l_ac3].imx15) THEN
                 IF p_cmd3='a' OR (g_imx[l_ac3].imx15 !=g_imx_t.imx15 AND g_imx_t.imx15 IS NOT NULL) THEN
                    IF NOT t580_check_imx(15,g_imx[l_ac3].imx15,g_imx_t.imx15) THEN
                       LET g_imx[l_ac3].imx15 = g_imx_t.imx15
                       NEXT FIELD imx15
                    END IF
                    CALL s_chk_prod_strategy(l_ac3,15,g_ponslk[l_ac2].ponslk04,g_imx[l_ac3].imx15) RETURNING l_error,l_ima01
                    IF NOT cl_null(l_error) THEN   #檢查商品策略
                       CALL cl_err(l_ima01,l_error,0)
                       LET g_imx[l_ac3].imx15 = g_imx_t.imx15
                       NEXT FIELD imx15
          ...
          BEFORE DELETE 
            IF NOT cl_delb(0,0) THEN
               CANCEL DELETE
            END IF
            CALL s_ins_slk('r',l_ac3,g_ponslk[l_ac2].ponslk04,
                           g_pom.pom01,g_ponslk[l_ac2].ponslk02)  
            LET g_rec_b3=g_rec_b3-1           
            CALL t580_update()
            CALL t580_update_ponslk()
            IF g_success = 'Y' THEN
                COMMIT WORK
            ELSE
                ROLLBACK WORK
          ...
          AFTER INSERT 
             CALL t580_ponslk_move()
             CALL s_ins_slk('a',l_ac3,g_ponslk[l_ac2].ponslk04,
                           g_pom.pom01,g_ponslk[l_ac2].ponslk02)
             LET g_rec_b3=g_rec_b3+1
             CALL t580_update()
             CALL t580_update_ponslk()
          ...
          ON ROW CHANGE 
             CALL t580_ponslk_move()
             CALL s_ins_slk('u',l_ac3,g_ponslk[l_ac2].ponslk04,
                           g_pom.pom01,g_ponslk[l_ac2].ponslk02)          
             CALL t580_update()
             CALL t580_update_ponslk()
             IF g_success = 'Y' THEN
...
#               LET li_a = TRUE     #FUN-C60100--MARK-----
    ...
    #TQC-D40025--add--str--
         IF g_b_flag = '1' THEN
            IF p_cmd = 'a' THEN 
               CALL g_ponslk.deleteElement(l_ac2)
               IF g_rec_b2 != 0 THEN
                  LET g_action_choice = "detail"
                  LET l_ac2 = l_ac2_t
               END IF
   ...
   ELSE
     INPUT ARRAY g_pon WITHOUT DEFAULTS FROM s_pon.*
            ...
            IF g_rec_b >= l_ac THEN
                ...
                ELSE
                    ...
                    IF SQLCA.sqlcode THEN
                        ...
                        LET l_lock_sw = "Y"
                    ELSE
                       OPEN t580_bcl_ind USING g_pom.pom01 ,g_pon_t.pon02
                       IF SQLCA.sqlcode THEN
                          CALL cl_err('lock poni',SQLCA.sqlcode,1)
                          LET l_lock_sw = "Y"
                       ELSE
                          FETCH t580_bcl_ind INTO g_poni.*
                          IF SQLCA.sqlcode THEN
                             CALL cl_err('lock poni',SQLCA.sqlcode,1)
                             LET l_lock_sw = "Y"
                          END IF
        ...
        AFTER INSERT
            ...
            LET g_pon2.pon19 = g_pon[l_ac].pon19   #NO:7066
            ...
            IF SQLCA.sqlcode THEN
               ...
               CANCEL INSERT
            ELSE
               LET g_poni.poni01 = g_pon2.pon01
               LET g_poni.poni02 = g_pon2.pon02
               LET g_poni.ponislk01 = g_poni.ponislk01    #No.FUN-810017
               IF NOT s_ins_poni(g_poni.*,'') THEN
                  LET g_success = 'N'
                  CANCEL INSERT
               END IF
              #移到行業別包起來的部分的下面
        ...
        AFTER FIELD ponislk01
           IF NOT cl_null(g_pon[l_ac].ponislk01) THEN
              SELECT COUNT(*) INTO l_n1
                FROM skd_file
               WHERE skd01 = g_pon[l_ac].ponislk01
                 AND skd04 = 'Y'
              IF l_n1 = 0 THEN
           ...
           END IF
            IF g_pon_t.pon02 > 0 AND
                ...
                IF SQLCA.sqlcode THEN
                    ...
                    CANCEL DELETE
                ELSE
                   IF NOT s_del_poni(g_pom.pom01,g_pon_t.pon02,'') THEN              
                      ROLLBACK WORK
                      CANCEL DELETE
                   END IF                                                       
                    LET g_rec_b=g_rec_b-1
 ...
 #              EXIT INPUT    #FUN-C30057--mark---
            ...
            ELSE
                ...
                IF SQLCA.sqlcode THEN
                    ...
                    LET g_success = 'N'
                ELSE
                    UPDATE poni_file SET poni_file.*=g_poni.*
                     WHERE poni01=g_pom.pom01
                       AND poni02=g_pon_t.pon02
                    IF SQLCA.sqlcode THEN
                       CALL cl_err3("upd","poni_file",g_pom.pom01,'',SQLCA.sqlcode,"","upd pomi",1)  
                    END IF
                    MESSAGE 'UPDATE O.K'
                    CALL  t580_update()
...
#FUN-C70098---add--begin--------
   DEFINE l_ponslk02   LIKE ponslk_file.ponslk02
   DEFINE l_ponslk04   LIKE ponslk_file.ponslk04
   DEFINE l_ponslk20   LIKE ponslk_file.ponslk20  
#FUN-C70098---add---end---------
...
#---BUGNO:7379---無單身資料不可確認
   ...
   #FUN-C70098----add----begin--------------
   IF g_azw.azw04 = '2' THEN
       DECLARE ponslk04_curs CURSOR FOR
          SELECT ponslk02,ponslk04,ponslk20 FROM ponslk_file WHERE ponslk01 = g_pom.pom01 
       CALL s_showmsg_init()
       FOREACH ponslk04_curs INTO l_ponslk02,l_ponslk04,l_ponslk20
           IF cl_null(l_ponslk20) OR l_ponslk20 = 0 THEN
              CALL s_errmsg('', g_pom.pom01 ,l_ponslk04 ,'mfg1214',1)
              LET g_success = 'N'
           END IF
       END FOREACH
       CALL s_showmsg()
...
FUNCTION t580_pon(p_pml01,p_pml02,p_n)      #產生單身資料
  ...
  #---取出請購單身資料
   SELECT * INTO l_pml.* FROM pml_file
    WHERE pml01=p_pml01 AND pml02=p_pml02
     SELECT * INTO l_pmli.* FROM pmli_file
      WHERE pmli01=p_pml01 AND pmli02=p_pml02
  ...
  #---產生採購單身資料
   ...
   IF g_success = 'Y' THEN
      ...
      ELSE    #No.FUN-830132
         INITIALIZE l_poni.* TO NULL
         LET l_poni.poni01 = l_pon.pon01
         LET l_poni.poni02 = l_pon.pon02
         LET l_poni.ponislk01=l_pmli.pmlislk01  #No.FUN-810017
         IF NOT s_ins_poni(g_poni.*,'') THEN
            LET g_success='N'
            RETURN
         END IF
...
#FUN-C30057--add--begin
   IF g_azw.azw04 = '2' THEN    
      LET g_pom.pom01               = g_ponslk2.ponslk01
      LET g_ponslk[l_ac2].ponslk02  = g_ponslk2.ponslk02
      LET g_ponslk[l_ac2].ponslk04  = g_ponslk2.ponslk04
      LET g_ponslk[l_ac2].ponslk041 = g_ponslk2.ponslk041
      LET g_ponslk[l_ac2].ponslk06  = g_ponslk2.ponslk06
      LET g_ponslk[l_ac2].ponslk07  = g_ponslk2.ponslk07
      LET g_ponslk[l_ac2].ponslk19  = g_ponslk2.ponslk19
      LET g_ponslk[l_ac2].ponslk20  = g_ponslk2.ponslk20
      LET g_ponslk[l_ac2].ponslk21  = g_ponslk2.ponslk21
      LET g_ponslk[l_ac2].ponslk31  = g_ponslk2.ponslk31
      LET g_ponslk[l_ac2].ponslk31t  = g_ponslk2.ponslk31t
   ELSE
      ...
      LET g_pon[l_ac].pon31t = g_pon2.pon31t
      LET g_pon[l_ac].pon06  = g_pon2.pon06
      LET g_pon[l_ac].ponislk01 = g_poni.ponislk01 
...
#FUN-C30057--add--begin--
   ...
   ELSE
      ...
      LET g_pon2.pon31t = g_pon[l_ac].pon31t
      LET g_pon2.pon06  = g_pon[l_ac].pon06
      LET g_poni.ponislk01 = g_pon[l_ac].ponislk01
