...
#No.FUN-750110--------begin--------     
   ...
   LET l_table = cl_prt_temptable('apmr505',g_sql) CLIPPED
...
DEFINE lc_qbe_sn      LIKE gbm_file.gbm01   #No.FUN-580031
   ...
   OPEN WINDOW r505_w AT p_row,p_col
     WITH FORM "apm/42f/apmr505" ATTRIBUTE (STYLE = g_win_style CLIPPED) #No.FUN-580092 HCN
   ...
   WHILE TRUE
      ...
      IF g_bgjob = 'Y' THEN
         ...
         ELSE
            ...
            CALL cl_cmdat('apmr505',g_time,l_cmd)
         END IF
...
#              " AND pmn20 > pmn50-pmn55 ",        #No.FUN-9A0068 mark
   ...
   DECLARE r505_c1 CURSOR FOR r505_p1
 
#  CALL cl_outnam('apmr505') RETURNING l_name     #No.FUN-750110
#  START REPORT r505_rep TO l_name                #No.FUN-750110  
...
#No.FUN-750110--------begin-------- 
         ...
         END FOR
             ...
             LET l_pmn50_n[9] = 0 
#No.FUN-750110--------end--------  
   FOREACH r505_c1 INTO sr.*,l_pmn34,l_pmn35,l_pmn36,l_pmn37
      IF SQLCA.sqlcode != 0 THEN
...
#No.FUN-750110--------begin-------- 
         ...
         END CASE
         EXECUTE insert_prep USING sr.pmn04,sr.pmn041,l_ima021,l_pmn50_n[1],
                                   l_pmn50_n[2],l_pmn50_n[3],l_pmn50_n[4],l_pmn50_n[5],
                                   l_pmn50_n[6],l_pmn50_n[7],l_pmn50_n[8],l_pmn50_n[9]      
#No.FUN-750110--------end--------  
#     OUTPUT TO REPORT r505_rep(sr.*)     #No.FUN-750110
   END FOREACH
#  FINISH REPORT r505_rep   #No.FUN-750110
#  CALL cl_prt(l_name,g_prtway,g_copies,g_len)   #No.FUN-750110
#No.FUN-750110--------begin--------  
     SELECT zz05 INTO g_zz05 FROM zz_file WHERE zz01 = g_prog                                                                  
     CALL cl_wcchp(tm.wc,'pmn04')                                                                                       
      RETURNING tm.wc                                                                                                           
     LET g_str = tm.wc,";",l_tit[1],";",l_tit[2],";",l_tit[3],";",l_tit[4],";",l_tit[5],";",
                 l_tit[6],";",l_tit[7],";",l_tit[8],";",l_tit[9]                                                                                                                       
     LET l_sql = "SELECT * FROM ", g_cr_db_str CLIPPED, l_table CLIPPED                                                             
     CALL cl_prt_cs3('apmr505','apmr505',l_sql,g_str)                  
#No.FUN-750110--------end--------  
