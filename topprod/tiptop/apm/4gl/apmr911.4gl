...
MAIN
   ...
   LET l_table = cl_prt_temptable('apmr911',g_sql) CLIPPED
   IF l_table = -1 THEN EXIT PROGRAM END IF
   LET g_sql= "pnd01.pnd_file.pnd01,",
              "pnd02.pnd_file.pnd02,",
              "pnd03.pnd_file.pnd03,",
              "pnd04.pnd_file.pnd04"
   LET l_table1 = cl_prt_temptable('apmr9111',g_sql) CLIPPED
   ...
   LET g_sql= "pmq01.pmq_file.pmq01,",
              ...
              "pnb03.pnb_file.pnb03"  
   LET l_table2 = cl_prt_temptable('apmr9112',g_sql) CLIPPED
   IF l_table2 = -1 THEN EXIT PROGRAM END IF        
   #No.FUN-A80005--end
              
   #No.FUN-710091--end  
   IF cl_null(g_bgjob) OR g_bgjob = 'N'	# If background job sw is off
      THEN CALL r911_tm(0,0)		# Input print condition
      ELSE CALL apmr911()		# Read data and create out-file
   END IF
   CALL cl_used(g_prog,g_time,2) RETURNING g_time
END MAIN
 
FUNCTION r911_tm(p_row,p_col)
DEFINE lc_qbe_sn      LIKE gbm_file.gbm01   
   ...
   OPEN WINDOW r911_w AT p_row,p_col WITH FORM "apm/42f/apmr911"
...
END CONSTRUCT
   ...
   IF INT_FLAG THEN
      LET INT_FLAG = 0 CLOSE WINDOW r911_w 
      CALL cl_used(g_prog,g_time,2) RETURNING g_time 
      EXIT PROGRAM
   ...
   IF g_bgjob = 'Y' THEN
      ...
      ELSE
         ...
         LET l_cmd = l_cmd CLIPPED,		#(at time fglgo xxxx p1 p2 p3)
                         ...
                         " '",g_rep_clas CLIPPED,"'",         
                         " '",g_template CLIPPED,"'"         
         CALL cl_cmdat('apmr911',g_time,l_cmd)      # Execute cmd at later time
      END IF
      CLOSE WINDOW r911_w
      CALL cl_used(g_prog,g_time,2) RETURNING g_time 
      EXIT PROGRAM
...
FUNCTION apmr911()
   DEFINE l_name	LIKE type_file.chr20, 	# External(Disk) file name       #No.FUN-680136 VARCHAR(20)
     ...
     SELECT zz17,zz05 INTO g_len,g_zz05 FROM zz_file WHERE zz01 = 'apmr911'
    ...
    #LET l_sql = " SELECT pnd03,pnd04 FROM pnd_file ",   #No.FUN-710091 
     LET l_sql = " SELECT pnd01,pnd02,pnd03,pnd04 FROM pnd_file ",    #No.FUN-710091
                 ...
                 "  ORDER BY pnd03 "
     PREPARE r911_pr2 FROM l_sql
     DECLARE r911_cs2 CURSOR FOR r911_pr2
     ...
     END IF
     DECLARE r911_cs1 CURSOR FOR r911_pr1
     ...
     LET g_sql = "INSERT INTO ",g_cr_db_str CLIPPED,l_table CLIPPED,  #TQC-780049
                 ...
                 "        ?,?,?,?,?, ?,?,?,?,?, ?,?,?,?,?, ",
                 "        ?,?,?,?,?, ?,?,?,?,?, ?,?,?,?,?, ",
                 "        ?,?,?,?,?, ?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?) "   #FUN-7B0142 拿掉一個? #No.FUN-A80005加一个?  #FUN-B30062 最後加了6個  ##TQC-C10039 add 4?
...
#    CALL cl_outnam('apmr911') RETURNING l_name
...
#    CALL cl_prt_pos_len()
#No.FUN-580004-end
#    START REPORT r911_rep TO l_name
#    LET g_pageno = 0
 
 
     FOREACH r911_cs1 INTO sr.*
      ...
      #FUN-7B0142---mark---end---
       ...
       FOREACH r911_cs2 USING sr.pna01,sr.pna02 INTO sr1.*
...
#      OUTPUT TO REPORT r911_rep(sr.*)
     END FOREACH
 
#    FINISH REPORT r911_rep
     ...
     LET l_str = l_str,";",tm.d,";",tm.e,";",l_zo12,";",tm.b CLIPPED,g_aza.aza08   #FUN-740057 add  #FUN-A80005 add tm.b CLIPPED  #FUN-B30062 add aza08
  ...
  #TQC-730088 #  "  FROM ",l_table CLIPPED,",",l_table1 CLIPPED,
     ...
     LET l_sql = "SELECT A.*,B.*",                                              
                 "  FROM ",g_cr_db_str CLIPPED,l_table CLIPPED," A LEFT OUTER JOIN ",           
                           g_cr_db_str CLIPPED,l_table1 CLIPPED," B ON A.pna01=B.pnd01 AND A.pna02=B.pnd02 ",           
                 " ORDER BY pna01,pna02,pnb03","|",
                 " SELECT * FROM ",g_cr_db_str CLIPPED,l_table2 CLIPPED      #No.FUN-A80005 add                              
     #No.FUN-840083---End           
     LET g_rlang = g_rlang_2                      
     IF g_bgjob='Y' AND g_prtway = 'J' THEN
   #   CALL r911_jmail(l_name)
     ELSE
#      CALL cl_prt(l_name,g_prtway,g_copies,g_len)
  #  CALL cl_prt_cs3('apmr911',l_sql,l_str)    #TQC-730088
     LET g_cr_table = l_table                 #主報表的temp table名稱  #TQC-C10039
     LET g_cr_apr_key_f = "pna01|pna02"       #報表主鍵欄位名稱  #TQC-C10039
     CALL cl_prt_cs3('apmr911','apmr911',l_sql,l_str) 
     END IF
     #No.FUN-710091  --end 
END FUNCTION
...
#   LET l_pnd04=' '
#   SKIP 1 LINE
#   FOREACH r911_cs2 USING sr.pna01,sr.pna02
