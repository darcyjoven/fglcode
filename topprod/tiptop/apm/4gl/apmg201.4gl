...
# Modify.........: No.FUN-C10036 12/02/02 By yangtt  GR修改
...
TYPE sr1_t RECORD
    ...
    pmc091 LIKE aaf_file.aaf03,
    pmc092 LIKE aaf_file.aaf03,
    pmc093 LIKE aaf_file.aaf03,
    pmc094 LIKE aaf_file.aaf03,
    pmc095 LIKE aaf_file.aaf03
END RECORD
#FUN-B40087----------add-------end
...
MAIN
   ...
   LET l_table = cl_prt_temptable('apmg201',g_sql) CLIPPED   # 產生Temp Table
   IF l_table = -1 THEN 
...
#-------------No.TQC-610085 end
   IF cl_null(g_bgjob) OR g_bgjob = 'N'	# If background job sw is off
      THEN CALL apmg201_tm(0,0)		# Input print condition
      ELSE CALL apmg201()		# Read data and create out-file
   END IF
   CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690119
   CALL cl_gre_drop_temptable(l_table)
END MAIN
 
FUNCTION apmg201_tm(p_row,p_col)
   ...
   OPEN WINDOW apmg201_w AT p_row,p_col WITH FORM "apm/42f/apmg201"
...
END CONSTRUCT
   ...
   IF INT_FLAG THEN
      LET INT_FLAG = 0 CLOSE WINDOW apmg201_w 
      CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690119
      CALL cl_gre_drop_temptable(l_table)
      EXIT PROGRAM
   ...
   IF g_bgjob = 'Y' THEN
      ...
      ELSE
         ...
         CALL cl_cmdat('apmg201',g_time,l_cmd)      # Execute cmd at later time
      END IF
      CLOSE WINDOW apmg201_w
      CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690119
      CALL cl_gre_drop_temptable(l_table)
      EXIT PROGRAM
   END IF
...
FUNCTION apmg201()
   DEFINE l_name	LIKE type_file.chr20,       # External(Disk) file name       #No.FUN-680136 VARCHAR(20)
     ...
     CALL cl_del_data(l_table)  #FUN-B40087 
     SELECT zo02 INTO g_company FROM zo_file WHERE zo01 = g_rlang
     SELECT zz17,zz05 INTO g_len,g_zz05 FROM zz_file WHERE zz01 = 'apmg201'
     ...
     LET l_sql = "SELECT  ",
                 ...
                 "   pmc01, pmc904,",   #FUN-550091  #CHI-A40059 add pmc904
                 "   pmd02, pmc081, pmc082, pmc52,  pmc53,",
                 "   pmc091, pmc092,",
...
#FUN-B40087---------mark------end-----
      CASE
        WHEN tm.c='1'
         #   CALL cl_prt_cs1('apmg201_1',l_sql,g_str)  #TQC-730088
#            CALL cl_prt_cs1('apmg201','apmg201_1',l_sql,g_str)   #FUN-B40087 mark
             LET g_template = 'apmg201_1'                         #FUN-B40087 add
#            CALL apmg201_grdata()                                #FUN-B40087 add    #FUN-C10036 mark
        WHEN tm.c='2'
         #   CALL cl_prt_cs1('apmg201_2',l_sql,g_str)  #TQC-730088
#            CALL cl_prt_cs1('apmg201','apmg201_2',l_sql,g_str)   #FUN-B40087 mark
             LET g_template = 'apmg201_2'                         #FUN-B40087 add
#            CALL apmg201_grdata()                                #FUN-B40087 add    #FUN-C10036 mark
        WHEN tm.c='3'
         #   CALL cl_prt_cs1('apmg201_3',l_sql,g_str)  #TQC-730088
#            CALL cl_prt_cs1('apmg201','apmg201_3',l_sql,g_str)   #FUN-B40087 mark
             LET g_template = 'apmg201_3'                         #FUN-B40087 add
#            CALL apmg201_grdata()                                #FUN-B40087 add   #FUN-C10036 mark
      END CASE
#No.FUN-710091  --end  
#No.FUN-710091  --begin
     ...
     LET i     = 0
     LET j     = 0
     PREPARE apmg201_prepare1 FROM l_sql
     ...
     END IF
      DECLARE apmg201_curs1 CURSOR FOR apmg201_prepare1
      #LET l_name = 'apmg201.out'
     #CALL cl_outnam('apmg201') RETURNING l_name  #No.FUN-710091
     #START REPORT apmg201_rep TO l_name  #No.FUN-710091 
      LET g_cnt = 0
      FOREACH apmg201_curs1 INTO sr.*
        IF SQLCA.sqlcode != 0 THEN
           CALL cl_err('foreach:',SQLCA.sqlcode,1) EXIT FOREACH
        END IF
        LET g_cnt = g_cnt + 1
      # OUTPUT TO REPORT apmg201_rep(sr.*)  #No.FUN-710091 
      EXECUTE insert_prep USING sr.*
      END FOREACH
 
#     FINISH REPORT apmg201_rep
#     CALL cl_prt(l_name,g_prtway,g_copies,g_len)
      CALL apmg201_grdata()      #FUN-B40087  add
 END FUNCTION
#
#REPORT apmg201_rep(sr)
#   DEFINE
...
FUNCTION apmg201_grdata()
    ...
    WHILE TRUE
        ...
        LET handler = cl_gre_outnam("apmg201")
        IF handler IS NOT NULL THEN
            START REPORT apmg201_rep TO XML HANDLER handler
            LET l_sql = "SELECT * FROM ",g_cr_db_str CLIPPED,l_table CLIPPED,
                        " ORDER BY pmc01"

            DECLARE apmg201_datacur1 CURSOR FROM l_sql
            FOREACH apmg201_datacur1 INTO sr1.*
                OUTPUT TO REPORT apmg201_rep(sr1.*)
            END FOREACH
            FINISH REPORT apmg201_rep
        END IF
...
REPORT apmg201_rep(sr1)
    DEFINE sr1 sr1_t
    DEFINE l_lineno LIKE type_file.num5
    DEFINE l_string  STRING

    ORDER EXTERNAL BY sr1.pmc01
    ...
    FORMAT
        ...
        ON EVERY ROW
            ...
            IF tm.d = '1' OR tm.d = '2' OR tm.d = '3' THEN
               LET l_string = cl_gr_getmsg("gre-090",g_lang,tm.d)
            ELSE
               LET l_string = cl_gr_getmsg("gre-090",g_lang,'4')
            END IF
            PRINTX l_string
