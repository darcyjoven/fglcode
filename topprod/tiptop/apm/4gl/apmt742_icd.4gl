...
#
# Pattern name...: apmt742.4gl
# Descriptions...: 代採買三角貿易倉退資料維護作業
...
MAIN
   ...
   IF FGL_GETENV("FGLGUI") <> "0" THEN  #FUN-840012
      OPTIONS
          INPUT NO WRAP,
          FIELD ORDER FORM                   #整個畫面欄位輸入會依照p_per所設定的順序(忽略4gl寫的順序)  #CHI-740014
   END IF
   DEFER INTERRUPT
  ...
  #IF g_argv1 = '0' THEN LET g_argv1=' ' END IF          #FUN-A60009 mark
  #IF cl_null(g_argv1) THEN LET g_argv1 = '3' END IF     #FUN-A60009 mark
   LET g_argv3 = 'TAP'                #參數-3(採購性質)      
   #No.FUN-630010 ---end---
 
   LET g_prog='apmt742_icd'
   ...
   CALL cl_used(g_prog,g_time,2)       #計算使用時間 (進入時間) #No.MOD-580088  HCN 20050818
   RETURNING g_time
END MAIN
#FUN-810038
