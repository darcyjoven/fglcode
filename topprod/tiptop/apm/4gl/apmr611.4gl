...
# Modify.........: No.MOD-530173 05/03/21 By Mandy apmr611畫面上已拿掉tm.y 所以INPUT 段也要拿掉
...
#No.FUN-580004-end
  ...
  DEFINE tm  RECORD				# Print condition RECORD
                #wc   VARCHAR(500),		# Where condition        #TQC-630166 mark
                 ...
                 u    	LIKE type_file.chr3,    #No.FUN-680136 VARCHAR(3)   # print gkf_file detail(Y/N)
...
#NO.FUN-830001---------------START-------------
   ...
   LET l_table = cl_prt_temptable('apmr611',g_sql) CLIPPED
...
#--------------No.TQC-610085 end
   IF cl_null(g_bgjob) OR g_bgjob = 'N'	# If background job sw is off
      ...
      ELSE CALL apmr611()		# Read data and create out-file
   END IF
...
FUNCTION r611_tm(p_row,p_col)
   ...
   OPEN WINDOW r611_w AT p_row,p_col WITH FORM "apm/42f/apmr611"
...
#UI
   ...
   IF g_bgjob = 'Y' THEN
      ...
      ELSE
         ...
         CALL cl_cmdat('apmr611',g_time,l_cmd)      # Execute cmd at later time
      END IF
      CLOSE WINDOW r611_w
      CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690119
      EXIT PROGRAM
...
#NO.FUN-830001----------------start---------------
     ...
     SELECT zz05 INTO g_zz05 FROM zz_file WHERE zz01='apmr611'
#NO.FUN-830001----------------end---------------
...
#     LET l_name = 'apmr611.out'                           #NO.FUN-830001
#     CALL cl_outnam('apmr611') RETURNING l_name           #NO.FUN-830001
#No.FUN-580004-begin
     IF g_sma115 = "Y"  THEN  #是否顯示單位注解
#            LET g_zaa[52].zaa06 = "N"                     #NO.FUN-830001
            LET l_name = 'apmr611_1'                       #NO.FUN-830001
     ELSE
#            LET g_zaa[52].zaa06 = "Y"                     #NO.FUN-830001
            LET l_name = 'apmr611'                         #NO.FUN-830001
     END IF
     CALL cl_prt_pos_len()
#No.FUN-580004-end
 
#     START REPORT r611_rep TO l_name                      #NO.FUN-830001
...
#       OUTPUT TO REPORT r611_rep(sr.*)
      ...
      EXECUTE insert_prep USING
         ...
         sr.rvv82,sr.rvv83,sr.rvv85,l_azf03,l_ima021,l_s
#NO.FUN-830001------------end------------
     END FOREACH
 
#     FINISH REPORT r611_rep                               #NO.FUN-830001
...
#NO.FUN-830001------------start------------
     ...
     CALL cl_prt_cs3('apmr611',l_name,g_sql,g_str)
#NO.FUN-830001------------end------------
END FUNCTION
