...
# Pattern name...: sapmt111.4gl
# Descriptions...: 採購收貨其他資料
...
FUNCTION t111(p_rva01)
    ...
    OPEN WINDOW t111_w WITH FORM "apm/42f/apmt111"
       ATTRIBUTE (STYLE = g_win_style CLIPPED) #No.FUN-580092 HCN
    CALL cl_ui_locale("apmt111")
...
FUNCTION t111_i(p_cmd)
    ...
    INPUT BY NAME g_rva.rva07,g_rva.rva08,g_rva.rva03 WITHOUT DEFAULTS 
...
FUNCTION t111_show()
    LET g_rva_t.* = g_rva.*
    DISPLAY BY NAME g_rva.rva07,g_rva.rva08,g_rva.rva03
