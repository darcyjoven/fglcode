...
# Modify.........: No.MOD-D10037 13/01/28 By Elise sr 的欄位需與 PREPARE r400_prepare1 的 SQL 對應
...
#No.FUN-7C0054---Begin                                                          
   ...
   LET l_table = cl_prt_temptable('apmr400',g_sql) CLIPPED                      
...
#---------------No.TQC-610085 end
   IF cl_null(g_bgjob) OR g_bgjob = 'N'	# If background job sw is off
      ...
      ELSE CALL apmr400()		# Read data and create out-file
   END IF
   CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690119
END MAIN
...
DEFINE lc_qbe_sn      LIKE gbm_file.gbm01   #No.FUN-580031
   ...
   OPEN WINDOW r400_w AT p_row,p_col WITH FORM "apm/42f/apmr400"
...
#UI
   ...
   IF g_bgjob = 'Y' THEN
      ...
      ELSE
         ...
         CALL cl_cmdat('apmr400',g_time,l_cmd)      # Execute cmd at later time
      END IF
      CLOSE WINDOW r400_w
      CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690119
      EXIT PROGRAM
...
#No.FUN-580004 --start--
                                  ...
                                  pml85 LIKE pml_file.pml85   #MOD-D10037 remove ,
                                 #pml86 LIKE pml_file.pml86,  #MOD-D10037 mark
                                 #pml87 LIKE pml_file.pml87   #MOD-D10037 mark
                        END RECORD
...
#No.FUN-7C0054---Begin
#     LET l_name = 'apmr400.out'
#     CALL cl_outnam('apmr400') RETURNING l_name
...
#     FINISH REPORT r400_rep
   ...
   CALL cl_prt_cs3('apmr400',l_name,l_sql,g_str)
