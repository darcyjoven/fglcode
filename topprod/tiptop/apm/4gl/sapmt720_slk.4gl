...
# Modify.........: No.MOD-8A0068 08/10/08 By alexstar 修正單身收貨項次欄位按開窗時查不到資料的問題
# Modify.........: No.MOD-8A0070 08/10/08 By alexstar 修正當要做入庫時,開窗查詢收貨單卻查不到的狀況
...
# Modify.........: No:TQC-D40092 13/07/17 By yangtt 录入的方式维护apmt720的资料时，如果rvb39=Y,需做QC检查
...
GLOBALS "../../axm/4gl/s_slk.global"    #FUN-B90104 add
...
DEFINE  l_ac5         LIKE type_file.num5,
        ...
        g_wc5         STRING,
        p_cmd5        LIKE type_file.chr1,
        p_cmd6        LIKE type_file.chr1
DEFINE  li_a          LIKE type_file.chr10
DEFINE  g_rvvslk      DYNAMIC ARRAY OF RECORD
                          rvvslk02   LIKE rvvslk_file.rvvslk02,
                          rvvslk05   LIKE rvvslk_file.rvvslk05,
                          rvvslk31   LIKE rvvslk_file.rvvslk31,
                          rvvslk031  LIKE rvvslk_file.rvvslk031,
                          rvvslk17   LIKE rvvslk_file.rvvslk17,
                          rvvslk32   LIKE rvvslk_file.rvvslk32,
                          rvvslk33   LIKE rvvslk_file.rvvslk33,
                          rvvslk34   LIKE rvvslk_file.rvvslk34,
                          rvvslk35   LIKE rvvslk_file.rvvslk35,
                          rvvslk36   LIKE rvvslk_file.rvvslk36,
                          rvvslk37   LIKE rvvslk_file.rvvslk37,
                          rvvslk38   LIKE rvvslk_file.rvvslk38,
                          rvvslk39   LIKE rvvslk_file.rvvslk39,
                          rvvslk38t  LIKE rvvslk_file.rvvslk38t,
                          rvvslk39t  LIKE rvvslk_file.rvvslk39t,
                          rvvslk930  LIKE rvvslk_file.rvvslk930,
                          rvvslk10   LIKE rvvslk_file.rvvslk10,
                          rvvslk11   LIKE rvvslk_file.rvvslk11
                      END RECORD
DEFINE  g_rvvslk_t    RECORD
                          rvvslk02   LIKE rvvslk_file.rvvslk02,
                          rvvslk05   LIKE rvvslk_file.rvvslk05,
                          rvvslk31   LIKE rvvslk_file.rvvslk31,
                          rvvslk031  LIKE rvvslk_file.rvvslk031,
      ...
      IF g_bgjob='N' OR cl_null(g_bgjob) THEN               #FUN-A50001 add
        CASE
          WHEN (g_argv1='1' AND g_argv3 !='SUB' AND g_argv3 !='TAP')
               ...
               OPEN WINDOW t720_w WITH FORM "apm/42f/apmt720_slk"   #FUN-B90104----add
          ...
          WHEN g_argv1='3' AND g_argv3 !='SUB' AND g_argv3 !='TAP'
               OPEN WINDOW t720_w WITH FORM "apm/42f/apmt722_slk"  #FUN-B90104----add
                ATTRIBUTE (STYLE = g_win_style CLIPPED)            #FUN-B90104----add
...
#FUN-B90104 add----begin-------
         IF g_azw.azw04 = '2' THEN
            CALL cl_set_comp_visible("rvvslk930",TRUE)
            CALL cl_set_comp_visible("rvvslk10,rvvslk11",FALSE)
         ELSE
            CALL cl_set_comp_visible("rvvslk930",FALSE)
            CALL cl_set_comp_visible("rvvslk10,rvvslk11",TRUE)
         END IF
         LET li_a=TRUE                          
...
DEFINE l_where   STRING                 #FUN-CB0087
  ...
  #FUN-A60009 add end -------- 
   ...
   ELSE
    CLEAR FORM                             #清除畫面
    CALL g_rvv.clear()
    CALL g_rvvslk.clear()  #FUN-B90104
    CASE
       WHEN g_rvu.rvu00='1'
            CALL cl_getmsg('apm-243',g_lang) RETURNING g_buf
       WHEN g_rvu.rvu00='2'
...
#FUN-B90104 add---begin---------------------
        CONSTRUCT g_wc5 ON rvvslk02,rvvslk05,rvvslk31,rvvslk031,rvvslk32,rvvslk33,rvvslk35,
                           rvvslk36,rvvslk37,rvvslk38,rvvslk39,rvvslk38t,rvvslk39t,rvvslk930,rvvslk10,rvvslk11
                     FROM s_rvvslk[1].rvvslk02,s_rvvslk[1].rvvslk05,s_rvvslk[1].rvvslk31,s_rvvslk[1].rvvslk031,s_rvvslk[1].rvvslk32,
                          s_rvvslk[1].rvvslk33,s_rvvslk[1].rvvslk35,s_rvvslk[1].rvvslk36,s_rvvslk[1].rvvslk37,s_rvvslk[1].rvvslk38,
                          s_rvvslk[1].rvvslk39,s_rvvslk[1].rvvslk38t,s_rvvslk[1].rvvslk39t,s_rvvslk[1].rvvslk930,s_rvvslk[1].rvvslk10,
                          s_rvvslk[1].rvvslk11
          ...
          ON ACTION CONTROLP
             CASE
                 WHEN INFIELD(rvvslk31)      #料號
                      CALL q_sel_ima(TRUE, "q_ima","","","","","","","",'')
                        RETURNING  g_qryparam.multiret
                      DISPLAY g_qryparam.multiret TO rvvslk31
                      NEXT FIELD rvvslk31
                 WHEN INFIELD(rvvslk05) #查詢驗收單項次
                      IF g_rvu.rvu00='3' THEN #-- 倉退
                         CALL q_rvb7(TRUE,TRUE,g_rvu.rvu02,g_rvvslk[1].rvvslk05,g_rvu.rvu01)  
                         RETURNING g_qryparam.multiret                                       
                      ELSE
                          CALL cl_init_qry_var()
                          ...
                          CALL cl_create_qry() RETURNING g_qryparam.multiret
                      END IF
                      DISPLAY g_qryparam.multiret TO rvvslk05        
                      NEXT FIELD rvvslk05
                 WHEN INFIELD(rvvslk35) #查詢單位
                      CALL cl_init_qry_var()
                      LET g_qryparam.form = "q_gfe"
                      LET g_qryparam.state = 'c'
                      CALL cl_create_qry() RETURNING g_qryparam.multiret
                      DISPLAY g_qryparam.multiret TO rvvslk35
                      NEXT FIELD rvvslk35
                WHEN INFIELD(rvvslk32)  #倉庫  
                     CALL q_imd_1(TRUE,TRUE,"","","","","") RETURNING g_qryparam.multiret
                     DISPLAY g_qryparam.multiret TO rvvslk32
                     NEXT FIELD rvvslk32
                WHEN INFIELD(rvvslk33)
                     CALL q_ime_1(TRUE,TRUE,"","","",g_plant,"","","") RETURNING g_qryparam.multiret
                     DISPLAY g_qryparam.multiret TO rvvslk33
                     NEXT FIELD rvvslk33
                WHEN INFIELD(rvvslk930)
                     CALL cl_init_qry_var()
                     LET g_qryparam.form  = "q_gem4"
                     LET g_qryparam.state = "c"   #多選
                     CALL cl_create_qry() RETURNING g_qryparam.multiret
                     DISPLAY g_qryparam.multiret TO rvvslk930
                     NEXT FIELD rvvslk930
...
#FUN-B90104 add----------begin-------------
    IF cl_null(g_wc5) THEN
       LET g_wc5 = " 1=1"
    END IF
    IF g_wc5 = " 1=1" THEN                      # 若單身未輸入條件
       LET g_sql = "SELECT rvu01,rvu00 FROM rvu_file",
                   " WHERE ", g_wc CLIPPED
    ELSE                                       # 若單身有輸入條件
       IF g_prog[1,7] = 'apmt720' OR g_prog[1,7] = 'aict042' THEN   #MOD-D30083 add aict042
          LET g_sql = "SELECT UNIQUE rvu01,rvu00 ",
                      "  FROM rvu_file,rvvslk_file",
                      "   LEFT OUTER JOIN ",
                      "   pmn_file LEFT OUTER JOIN pmm_file ON pmn01=pmm01 ",
                      "    ON pmn01=rvvslk36 AND pmn02=rvvslk37 ",
                      " WHERE rvu01 = rvvslk01 ",
                      "   AND ", g_wc CLIPPED, " AND ",g_wc5 CLIPPED
       ELSE
          LET g_sql = "SELECT UNIQUE rvu01,rvu00 ",
                      "  FROM rvu_file,rvvslk_file",
                      " WHERE rvu01 = rvvslk01 ",
...
#FUN-B90104 add----------end-------------
  ...
  END IF
    ...
    DECLARE t720_fill_cs CURSOR FOR t720_prepare    #FUN-CB0014 add
#FUN-B90104 add----------begin-------------
    IF g_wc5 = " 1=1" THEN                     # 取合乎條件筆數
    ...
    ELSE
       IF g_prog = 'apmt720' OR g_prog = 'aict042' THEN  #MOD-D30083 add aict042
          LET g_sql="SELECT COUNT(DISTINCT rvu01) ",
                    "   FROM rvu_file,rvvslk_file,OUTER (pmn_file,OUTER pmm_file) ", 
                    " WHERE rvvslk01=rvu01 ",
                    "   AND pmm_file.pmm01 = pmn_file.pmn01 ",  
                    "   AND rvvslk36 = pmn_file.pmn01 ",          
                    "   AND rvvslk37 = pmn_file.pmn02 ",         
                    "   AND ",g_wc CLIPPED," AND ",g_wc5 CLIPPED
       ELSE
          LET g_sql="SELECT COUNT(DISTINCT rvu01) FROM rvu_file,rvvslk_file ",
                    " WHERE rvvslk01=rvu01 ",
                    "   AND ",g_wc CLIPPED," AND ",g_wc5 CLIPPED
       END IF
    END IF
         ...
         WHEN "confirm"
            IF cl_chk_act_auth() THEN
              ...
              #FUN-A60009 add str --------------------
               ...
               IF g_success = "Y" THEN
                  #CALL t720sub_y_upd(g_rvu.rvu01,g_argv1,g_argv2,g_argv3,g_chr,FALSE,'Y')    #MOD-C80049 mark
                  CALL t720sub_y_upd(g_rvu.rvu01,g_argv1,g_argv2,g_argv3,g_chr,FALSE,'Y','N') #MOD-C80049 add
               END IF
              #FUN-A60009 add end ---------------------
               CALL t720_refresh() RETURNING g_rvu.*  #FUN-A10130
               CALL t720_show()   #FUN-A10130
                  ...
                  CASE
                     ...
                     WHEN g_rvu.rvu00='3' #倉退
                        ...
                        ELSE
                           ...
                           IF t720sub_chkpoz011(g_rvu.rvu01) THEN  #MOD-920279   #CHI-B40011
                              LET g_msg="apmp840 '",g_rvu.rvu01,"'"
                              CALL cl_cmdrun_wait(g_msg CLIPPED)
                           END IF
                        END IF
               ...
               ELSE
                  ...
                  ELSE
                    ...
                    ELSE
                       ...
                       CALL t720_b_fill_slk(' 1=1') #FUN-B90104----add
...
#FUN-A60035 ---MARK END
        ...
        #DEV-D30045--add--begin
         WHEN "barcode_gen"     #條碼產生
             IF cl_chk_act_auth() THEN
                CALL t720sub_barcode_gen(g_rvu.rvu01,'Y')
             END IF
...
DEFINE li_result         LIKE type_file.num5    #No.FUN-550060  #No.FUN-680136 SMALLINT
DEFINE l_gem02           LIKE gem_file.gem02    #MOD-640260
 ...
 #........如單身已有資料則不可修正驗收單號
        ...
        AFTER FIELD rvu02         #驗收單號
           ...
           IF g_rvu.rvu00 ='3' AND NOT cl_null(g_rvu.rvu02) THEN     #FUN-9A0068
              ...
              CALL cl_set_comp_required('rvu111,rvu112,rvu113,rvu115',FALSE)
              #MOD-B30544 add end--------------------------
           ELSE
              #MOD-B30544 add begin------------------------
         ...
         AFTER FIELD rvu04       #廠商編號
           IF NOT cl_null(g_rvu.rvu04) THEN
               IF NOT cl_null(g_rvu.rvu04) OR g_rvu.rvu04 != g_rvu_t.rvu04 THEN
                  ...
                  SELECT pmc03,pmcacti INTO g_rvu.rvu05,l_pmcacti FROM pmc_file   #MOD-C60054 add
...
#               IF g_rvu.rvu116 MATCHES "[123]" AND g_rvu.rvu10 = 'N' THEN #No.FUN-A40054   #No.MOD-AC0403
                IF g_rvu.rvu116 MATCHES "[123]" AND g_rvu.rvu10 = 'N' THEN                    #No.MOD-AC0403 #TQC-B70073 add 2
                   CALL cl_err('','apm-436',0)
                   NEXT FIELD rvu10
                END IF
               #No.FUN-A40054 -BEGIN-----
...
#MOD-AC0414 --------------------Begin------------------------
          IF NOT cl_null(g_rvu.rvu12) AND g_rvu.rvu12 >= 0 THEN
           ...
           #no.A010本幣取位
             ...
             DISPLAY BY NAME g_rvu.rvu14
          ELSE
             CALL cl_err(g_rvu.rvu12,'apm-798',0)
          END IF
#MOD-AC0414 --------------------End--------------------------
          LET l_flag='N'
...
DEFINE l_gem02     LIKE  gem_file.gem02   #NO.FUN-960130
  ...
  CALL t720_b_fill_slk(g_wc5) #FUN-B90104----add
    ...
    IF cl_delh(20,16) THEN
      ...
      #FUN-BC0104---add---str---
       ELSE 
          ...
          END FOR
      #FUN-BC0104---add---end---
      #ELSE #FUN-BC0104 mark
         #IF NOT s_del_rvvi(g_rvu.rvu01,'','') THEN      #No.FUN-A50054
          IF NOT s_del_rvvi(g_rvu.rvu01,'',g_plant) THEN #No.FUN-A50054
             ROLLBACK WORK
             RETURN 
          END IF
       END IF
       DELETE FROM rvvslk_file WHERE rvvslk01 = g_rvu.rvu01  #FUN-B90104  add
...
DEFINE
   ...
   #l_ima25         LIKE ima_file.ima25,     #FUN-A10130
    ...
    l_tmp           LIKE type_file.chr5,    #No.FUN-680136 VARCHAR(05)           #No.FUN-550060
...
DEFINE b_rvvslk RECORD LIKE rvvslk_file.*        #FUN-B90104--add-
DEFINE l_rvv    RECORD LIKE rvv_file.*           #FUN-B90104--add-
DEFINE l_rvvi   RECORD LIKE rvvi_file.*          #FUN-B90104--add-
DEFINE l_ima151        LIKE ima_file.ima151      #FUN-B90104--add-
DEFINE l_imaag         LIKE ima_file.imaag       #FUN-B90104--add-
...
DEFINE l_rvv17_tol  LIKE rvv_file.rvv17   #FUN-D20022 add
   ...
   #FUN-A60009 add end ---
    ...
    LET g_forupd_sql = " SELECT * FROM rvvi_file WHERE rvvi01= ?  AND rvvi02= ? ",
     " FOR UPDATE "
    LET g_forupd_sql = cl_forupd_sql(g_forupd_sql)
    DECLARE t720_bcl_ind CURSOR FROM g_forupd_sql      # LOCK CURSOR

#FUN-B90104--add--str--
   LET g_forupd_sql = "SELECT * FROM rvvslk_file ",
                      " WHERE rvvslk01= ? AND rvvslk02= ?  FOR UPDATE"
   LET g_forupd_sql = cl_forupd_sql(g_forupd_sql)
   DECLARE t720_bcl_slk CURSOR FROM g_forupd_sql
#FUN-B90104--add--end--
...
#FUN-B90104--add--begin-------------------
    DIALOG ATTRIBUTES(UNBUFFERED)
       INPUT ARRAY g_rvvslk FROM s_rvvslk.*
         ATTRIBUTE(COUNT=g_rec_b5,MAXCOUNT=g_max_rec,WITHOUT DEFAULTS=TRUE,
        ...
        BEFORE INPUT
            ...
            END IF
            CALL cl_set_comp_entry("rvvslk930,rvvslk10,rvvslk11",FALSE)
            IF NOT cl_null(g_rvu.rvu02) THEN
               CALL cl_set_comp_entry("rvvslk31,rvvslk17",FALSE)
               CALL cl_set_comp_entry("rvvslk05",TRUE)
               CALL cl_set_comp_required("rvvslk05",TRUE)
            ELSE
               CALL cl_set_comp_entry("rvvslk31,rvvslk17",TRUE)
               CALL cl_set_comp_required("rvvslk05",FALSE)
               CALL cl_set_comp_entry("rvvslk05",FALSE)
            END IF
            CALL t720_getazi_slk('')
...
#            END IF
            ...
            IF g_rec_b5 >= l_ac5 THEN
               LET p_cmd5='u'
               LET g_rvvslk_t.* = g_rvvslk[l_ac5].*  #BACKUP
               ...
               OPEN t720_bcl_slk USING g_rvu.rvu01,g_rvvslk_t.rvvslk02
               IF STATUS THEN
                  CALL cl_err("OPEN t720_bcl_slk:", STATUS, 1)
                  LET l_lock_sw = "Y"
               ELSE
                  FETCH t720_bcl_slk INTO b_rvvslk.*
                  IF SQLCA.sqlcode THEN
                     CALL cl_err('lock rvvslk',SQLCA.sqlcode,1)
                     LET l_lock_sw = "Y"
                  END IF
               END IF
            END IF
#TQC-C20500-----add-----------------------
            SELECT ima151 INTO l_ima151 FROM ima_file WHERE ima01=g_rvvslk[l_ac5].rvvslk31
            IF l_ima151 = 'Y' THEN
               CALL cl_set_comp_entry("rvvslk17",FALSE)
            ELSE
                CALL cl_set_comp_entry("rvvslk17",TRUE)
            END IF
#TQC-C20500-----end-----------------------      
            CALL s_settext_slk(g_rvvslk[l_ac5].rvvslk31)
            CALL s_fillimx_slk(g_rvvslk[l_ac5].rvvslk31,
                                g_rvu.rvu01,g_rvvslk[l_ac5].rvvslk02)
            LET g_rec_b6 = g_imx.getLength()

        BEFORE INSERT
            LET p_cmd5='a'
            INITIALIZE g_rvvslk[l_ac5].* TO NULL
            LET g_rvvslk[l_ac5].rvvslk17=0
            LET g_rvvslk[l_ac5].rvvslk38=0
            LET g_rvvslk[l_ac5].rvvslk38t=0
            LET g_rvvslk[l_ac5].rvvslk39t=0
            LET g_rvvslk[l_ac5].rvvslk39=0
        ...
        AFTER INSERT
           ...
           LET b_rvvslk.rvvslk03=g_rvu.rvu00                  #異動類別
           LET b_rvvslk.rvvslk01=g_rvu.rvu01                  #入庫單號
           LET b_rvvslk.rvvslk04=g_rvu.rvu02
           LET b_rvvslk.rvvslk02=g_rvvslk[l_ac5].rvvslk02
           LET b_rvvslk.rvvslk05=g_rvvslk[l_ac5].rvvslk05
           LET b_rvvslk.rvvslk17=g_rvvslk[l_ac5].rvvslk17
           LET b_rvvslk.rvvslk31=g_rvvslk[l_ac5].rvvslk31
           LET b_rvvslk.rvvslk031=g_rvvslk[l_ac5].rvvslk031
           LET b_rvvslk.rvvslk32=g_rvvslk[l_ac5].rvvslk32
           LET b_rvvslk.rvvslk33=g_rvvslk[l_ac5].rvvslk33
           LET b_rvvslk.rvvslk34=g_rvvslk[l_ac5].rvvslk34
           LET b_rvvslk.rvvslk35=g_rvvslk[l_ac5].rvvslk35
           LET b_rvvslk.rvvslk35_fac=1
           LET b_rvvslk.rvvslk36=g_rvvslk[l_ac5].rvvslk36
           LET b_rvvslk.rvvslk37=g_rvvslk[l_ac5].rvvslk37
           LET b_rvvslk.rvvslk38=g_rvvslk[l_ac5].rvvslk38
           LET b_rvvslk.rvvslk39=g_rvvslk[l_ac5].rvvslk39
           LET b_rvvslk.rvvslk38t=g_rvvslk[l_ac5].rvvslk38t
           LET b_rvvslk.rvvslk39t=g_rvvslk[l_ac5].rvvslk39t
           LET b_rvvslk.rvvslk930=g_rvvslk[l_ac5].rvvslk930
           LET b_rvvslk.rvvslk10=g_rvvslk[l_ac5].rvvslk10
           LET b_rvvslk.rvvslk11=g_rvvslk[l_ac5].rvvslk11
           LET b_rvvslk.rvvslkplant = g_rvu.rvuplant  
           LET b_rvvslk.rvvslklegal = g_rvu.rvulegal  
           IF cl_null(b_rvvslk.rvvslk17)  THEN LET b_rvvslk.rvvslk17=0 END IF
           IF cl_null(b_rvvslk.rvvslk38)  THEN LET b_rvvslk.rvvslk38=0 END IF
           IF cl_null(b_rvvslk.rvvslk38t) THEN LET b_rvvslk.rvvslk38t=0 END IF
           IF cl_null(b_rvvslk.rvvslk39)  THEN LET b_rvvslk.rvvslk39=0 END IF
           IF cl_null(b_rvvslk.rvvslk39t) THEN LET b_rvvslk.rvvslk39t=0 END IF
           IF b_rvvslk.rvvslk10 IS NULL THEN LET b_rvvslk.rvvslk10 = '4' END IF   
           INSERT INTO rvvslk_file VALUES(b_rvvslk.*)
           IF SQLCA.sqlcode THEN
              CALL cl_err3("ins","rvvslk_file",b_rvvslk.rvvslk01,b_rvvslk.rvvslk02,SQLCA.sqlcode,"","ins rvvslk",1) 
              ROLLBACK WORK 
              CANCEL INSERT
           ELSE
              IF cl_null(g_rvvslk[l_ac5].rvvslk05) THEN   #TQC-C20512 add 
                 SELECT ima151,imaag
                   INTO l_ima151,l_imaag
                   FROM ima_file WHERE ima01=g_rvvslk[l_ac5].rvvslk31

                #IF l_ima151<>'Y' AND (l_ima151<>'N' AND l_imaag<>'@CHILD' ) THEN   #非多屬性料件更新料件編號  #FUN-C20006
                 IF l_ima151<>'Y' AND (l_ima151<>'N' OR l_imaag<>'@CHILD' OR cl_null(l_imaag)) THEN     #FUN-C20006
                    INITIALIZE l_rvv.* TO NULL
                    LET l_rvv.rvv01=g_rvu.rvu01
                    SELECT MAX(rvv02)+1 INTO l_rvv.rvv02 FROM rvv_file
                     WHERE rvv01=g_rvu.rvu01
                    IF cl_null(l_rvv.rvv02) THEN
                       LET l_rvv.rvv02=1
                    END IF
                    LET l_rvv.rvv03=g_rvu.rvu00
                    LET l_rvv.rvv04=g_rvu.rvu02
                    LET l_rvv.rvv05=b_rvvslk.rvvslk05
                    LET l_rvv.rvv06=g_rvu.rvu04
                    LET l_rvv.rvv09=g_rvu.rvu03
                    LET l_rvv.rvv17=b_rvvslk.rvvslk17
                    LET l_rvv.rvv31=b_rvvslk.rvvslk31
                    LET l_rvv.rvv031=b_rvvslk.rvvslk031
                    LET l_rvv.rvv32=b_rvvslk.rvvslk32
                    LET l_rvv.rvv33=b_rvvslk.rvvslk33
                    LET l_rvv.rvv34=b_rvvslk.rvvslk34
                    LET l_rvv.rvv35=b_rvvslk.rvvslk35
                    LET l_rvv.rvv35_fac=b_rvvslk.rvvslk35_fac
                    LET l_rvv.rvv36=b_rvvslk.rvvslk36
                    LET l_rvv.rvv37=b_rvvslk.rvvslk37
                    LET l_rvv.rvv38=b_rvvslk.rvvslk38
                    LET l_rvv.rvv38t=b_rvvslk.rvvslk38t
                    LET l_rvv.rvv39=b_rvvslk.rvvslk39
                    LET l_rvv.rvv39t=b_rvvslk.rvvslk39t
                    LET l_rvv.rvv930=b_rvvslk.rvvslk930
                    LET l_rvv.rvv10=b_rvvslk.rvvslk10
                    LET l_rvv.rvv11=b_rvvslk.rvvslk11
                    LET l_rvv.rvv24='N' 
                    LET l_rvv.rvv25='N'       #樣品
                    LET l_rvv.rvv89='N' 
                    LET l_rvv.rvv87=b_rvvslk.rvvslk17
                    LET l_rvv.rvv86=b_rvvslk.rvvslk35
                    LET l_rvv.rvvplant=b_rvvslk.rvvslkplant
                    LET l_rvv.rvvlegal=b_rvvslk.rvvslklegal

                    INSERT INTO rvv_file VALUES(l_rvv.*)
                    IF SQLCA.sqlcode THEN
                       CALL cl_err3("ins","rvv_file",g_rvu.rvu01,"",SQLCA.sqlcode,"","ins rvv",1)
                       ROLLBACK WORK
                       CANCEL INSERT
                    END IF
                    ...
                    LET l_rvvi.rvvislk01 = g_rvvslk[l_ac5].rvvslk31
                    LET l_rvvi.rvvislk02 = g_rvvslk[l_ac5].rvvslk02
                    LET l_rvvi.rvvilegal = l_rvv.rvvlegal
                    LET l_rvvi.rvviplant = l_rvv.rvvplant

                    INSERT INTO rvvi_file VALUES (l_rvvi.*)
                    IF SQLCA.sqlcode THEN
                       CALL cl_err3("ins",'',g_rvu.rvu01,"",SQLCA.sqlcode,"","ins rvvi",1)
                       ROLLBACK WORK
                       CANCEL INSERT
                    END IF
                 #TQC-C20512--add--begin--
                 ELSE
                    IF l_ima151<>'Y' AND (l_ima151<>'N' OR l_imaag<>'@CHILD' OR cl_null(l_imaag)) THEN
                       UPDATE rvv_file SET rvv17=g_rvvslk[l_ac5].rvvslk17,
                                           rvv39=g_rvvslk[l_ac5].rvvslk39,
                                           rvv39t=g_rvvslk[l_ac5].rvvslk39t,
                                           rvv32=g_rvvslk[l_ac5].rvvslk32,
                                           rvv33=g_rvvslk[l_ac5].rvvslk33,
                                           rvv34=g_rvvslk[l_ac5].rvvslk34,
                                           rvv930=g_rvvslk[l_ac5].rvvslk930,
                                           rvv10=g_rvvslk[l_ac5].rvvslk10,
                                           rvv11=g_rvvslk[l_ac5].rvvslk11
                        WHERE rvv01=g_rvu.rvu01
                          AND rvv02 IN (SELECT rvv02 FROM rvv_file,rvvi_file
                                         WHERE rvvi01=rvv01
                                           AND rvvi02=rvv02
                                           AND rvvislk02=g_rvvslk[l_ac5].rvvslk02)
                    ELSE   
                       UPDATE rvv_file SET rvv32=g_rvvslk[l_ac5].rvvslk32,
                                           rvv33=g_rvvslk[l_ac5].rvvslk33,
                                           rvv34=g_rvvslk[l_ac5].rvvslk34,
                                           rvv930=g_rvvslk[l_ac5].rvvslk930,
                                           rvv10=g_rvvslk[l_ac5].rvvslk10,
                    ...
                    END IF
                    IF SQLCA.sqlcode THEN
                       CALL cl_err3("upd","rvv_file",g_rvu.rvu01,'',SQLCA.sqlcode,"","upd rvv",1)
                       ROLLBACK WORK 
                    END IF
                 END IF   
                 #TQC-C20512--add--end--
        ...
        BEFORE FIELD rvvslk02                            #default 序號
           IF g_rvvslk[l_ac5].rvvslk02 IS NULL OR g_rvvslk[l_ac5].rvvslk02 = 0 THEN
               SELECT max(rvvslk02)+1 INTO g_rvvslk[l_ac5].rvvslk02
                  FROM rvvslk_file WHERE rvvslk01 = g_rvu.rvu01
               IF g_rvvslk[l_ac5].rvvslk02 IS NULL THEN
                   LET g_rvvslk[l_ac5].rvvslk02 = 1
               END IF
           END IF

        AFTER FIELD rvvslk05             #驗收項次
           IF NOT cl_null(g_rvu.rvu02) AND NOT cl_null(g_rvvslk[l_ac5].rvvslk05) 
             AND g_rvvslk[l_ac5].rvvslk05 !=g_rvvslk_t.rvvslk05 THEN
              CALL t720_getazi_slk(g_rvvslk[l_ac5].rvvslk36)
              CALL t720_rvvslk05(p_cmd5)
              IF NOT cl_null(g_errno) THEN
                #MOD-C30590 -- add -- begin
                 IF (g_rvvslk[l_ac5].rvvslk31 = 'MISC') AND (g_errno = 'apm-259') THEN     
                    CALL t720_b_insrvv(p_cmd5)
                 ELSE
                #MOD-C30590 -- add -- end
                    CALL cl_err(g_rvvslk[l_ac5].rvvslk05,g_errno,0)
 
                    IF g_errno <> 'apm-259' THEN 
                       NEXT FIELD rvvslk05
                    ELSE                       
                       NEXT FIELD rvvslk32         
                    END IF         
...
#TQC-C20500-----end-----------------------
       ...
       #TQC-C20512--add--begin-- 
        AFTER FIELD rvvslk17              #異動數量
           IF NOT cl_null(g_rvvslk[l_ac5].rvvslk17) AND NOT cl_null(g_rvvslk[l_ac5].rvvslk35) THEN
              IF cl_null(g_rvvslk_t.rvvslk17) OR cl_null(g_rvvslk_t.rvvslk35) 
                 OR g_rvvslk_t.rvvslk17 != g_rvvslk[l_ac5].rvvslk17 OR g_rvvslk_t.rvvslk35 != g_rvvslk[l_ac5].rvvslk35 THEN
                 LET g_rvvslk[l_ac5].rvvslk17=s_digqty(g_rvvslk[l_ac5].rvvslk17,g_rvvslk[l_ac5].rvvslk35)
                 DISPLAY BY NAME g_rvvslk[l_ac5].rvvslk17
              END IF
           END IF
           IF NOT t720_rvvslk17(p_cmd5) THEN
              NEXT FIELD rvvslk17
           END IF 
       #TQC-C20512--add--end--
 
        AFTER FIELD rvvslk31
          IF NOT cl_null(g_rvvslk[l_ac5].rvvslk31) THEN
             IF p_cmd5='a' OR (p_cmd5='u' AND g_rvvslk_t.rvvslk31 <> g_rvvslk[l_ac5].rvvslk31) THEN
                IF NOT s_chk_item_no(g_rvvslk[l_ac5].rvvslk31,"") THEN
                   CALL cl_err('',g_errno,1)
                   LET g_rvvslk[l_ac5].rvvslk31= g_rvvslk_t.rvvslk31
                   NEXT FIELD rvvslk31
                END IF
                SELECT COUNT(*) INTO g_cnt FROM ima_file
                 WHERE ima01=g_rvvslk[l_ac5].rvvslk31 AND imaacti='Y'
                IF cl_null(g_cnt) OR g_cnt=0 THEN
                   CALL cl_err('','mfg3403',1)
                   NEXT FIELD rvvslk31
                END IF
                SELECT ima151,imaag INTO l_ima151,l_imaag
                  FROM ima_file
                 WHERE ima01=g_rvvslk[l_ac5].rvvslk31 AND imaacti='Y'
               #IF l_ima151='N' AND l_imaag='' THEN    #FUN-C20006
                IF l_ima151='N' AND l_imaag='@CHILD' THEN  #FUN-C20006
                   CALL cl_err('','axm1104',1)
                   NEXT FIELD rvvslk31
                END IF
                SELECT COUNT(*) INTO g_cnt FROM rvvslk_file
                 WHERE rvvslk31=g_rvvslk[l_ac5].rvvslk31 AND rvvslk01=g_rvu.rvu01
                IF NOT cl_null(g_cnt) AND g_cnt>0 THEN
                   CALL cl_err('','aim1100',1)
                   NEXT FIELD rvvslk31
                END IF
                IF g_rvvslk[l_ac5].rvvslk31[1,4] != 'MISC' THEN
                   SELECT ima02,ima44
                     INTO g_rvvslk[l_ac5].rvvslk031,g_ima44
                     FROM ima_file WHERE ima01=g_rvvslk[l_ac5].rvvslk31 AND imaacti='Y'
                   IF STATUS THEN
                      CALL cl_err3("sel","ima_file",g_rvvslk[l_ac5].rvvslk31,"",STATUS,"","sel ima",1)
                      NEXT FIELD rvvslk31
                   END IF
                END IF
                IF cl_null(g_rvvslk[l_ac5].rvvslk35) OR (g_rvvslk[l_ac5].rvvslk31 !=g_rvvslk_t.rvvslk31) THEN
                   LET g_rvvslk[l_ac5].rvvslk35=g_ima44
                END IF
                CALL t720_getslk_price()
                DISPLAY BY NAME g_rvvslk[l_ac5].rvvslk35
                DISPLAY BY NAME g_rvvslk[l_ac5].rvvslk031
#TQC-C20500-----add-----------------------
                SELECT ima151 INTO l_ima151 FROM ima_file WHERE ima01=g_rvvslk[l_ac5].rvvslk31
                IF l_ima151 = 'Y' THEN
                   CALL cl_set_comp_entry("rvvslk17",FALSE)
...
#TQC-C20500-----end-----------------------
        ...
        AFTER FIELD rvvslk32              #倉庫
           IF g_rvvslk[l_ac5].rvvslk32 IS NULL THEN
               LET g_rvvslk[l_ac5].rvvslk32=' '
           END IF
           IF NOT cl_null(g_rvvslk[l_ac5].rvvslk32) THEN
               IF NOT s_chk_ware(g_rvvslk[l_ac5].rvvslk32) THEN
                  NEXT FIELD rvvslk32
               END IF
               IF cl_null(g_errno) AND g_azw.azw04='2' THEN 
                  IF (g_rvu.rvu21 = '3' OR (g_rvu.rvu21 = '2' AND g_sma.sma146 = '2'))THEN 
                     LET g_cnt = 0
                     SELECT count(*) INTO g_cnt FROM imd_file
                      WHERE imd01 = g_rvvslk[l_ac5].rvvslk32
                        AND imd01 IN (SELECT jce02 FROM jce_file)
                     IF g_cnt = 0 THEN
                        IF g_rvu.rvu21 = '3' THEN    
                           CALL cl_err('','apm-147',0)
                        ELSE                        
                           CALL cl_err('','apm-153',0) 
                        END IF                         
                        NEXT FIELD rvvslk32
                     END IF
                  END IF                              
                  ...
                  END IF
               END IF
               CALL t720_check_rvvslk32()
               IF NOT cl_null(g_errno) THEN
                  CALL cl_err('',g_errno,0)
                  NEXT FIELD rvvslk32
               END IF
               IF g_rvvslk[l_ac5].rvvslk31[1,4] != 'MISC' AND g_rvu.rvu00!='2' THEN  #料號
                  #------>check-1  檢查該料是否可收至該倉
                  IF NOT s_imfchk1(g_rvvslk[l_ac5].rvvslk31,g_rvvslk[l_ac5].rvvslk32) THEN
                     CALL cl_err('s_imfchk1:','mfg9036',0) NEXT FIELD rvvslk32
                  END IF
                  #------>check-2  檢查倉庫須存在否
                  CALL s_stkchk(g_rvvslk[l_ac5].rvvslk32,'A') RETURNING l_code
                  IF NOT l_code THEN
                     CALL cl_err('s_stkchk:','mfg1100',0) NEXT FIELD rvvslk32
                  END IF
                  #------>check-3  檢查是否為可用倉
                  CALL s_swyn(g_rvvslk[l_ac5].rvvslk32) RETURNING sn1,sn2
                  IF sn1=1 AND g_rvvslk[l_ac5].rvvslk32 != g_rvvslk_t.rvvslk32 THEN
                     LET g_rvvslk_t.rvvslk32=g_rvvslk[l_ac5].rvvslk32
                     CALL cl_err(g_rvvslk[l_ac5].rvvslk32,'mfg6080',0)
                     NEXT FIELD rvvslk32
                  ELSE
                     IF sn2=2 AND g_rvvslk[l_ac5].rvvslk32 != g_rvvslk_t.rvvslk32 THEN
                        CALL cl_err(g_rvvslk[l_ac5].rvvslk32,'mfg6085',0)
                        LET g_rvvslk_t.rvvslk32=g_rvvslk[l_ac5].rvvslk32
                        NEXT FIELD rvvslk32
                     END IF
                  END IF
        ...
        AFTER FIELD rvvslk33              #儲位
           # 控管是否為全型空白
           IF g_rvvslk[l_ac5].rvvslk33 = '　' OR cl_null(g_rvvslk[l_ac5].rvvslk33) THEN #全型空白 
              LET g_rvvslk[l_ac5].rvvslk33 = ' '
           END IF
           IF NOT cl_null(g_rvvslk[l_ac5].rvvslk33) THEN
               CALL t720_check_rvvslk32()
               IF NOT cl_null(g_errno) THEN
                  CALL cl_err('',g_errno,0)
                  NEXT FIELD rvvslk32
               END IF
           END IF
          #IF g_rvvslk[l_ac5].rvvslk31[1,4] != 'MISC' AND g_rvu.rvu00!='2' THEN   #CHI-CC0014
           IF NOT cl_null(g_rvvslk[l_ac5].rvvslk32) AND g_rvvslk[l_ac5].rvvslk31[1,4] != 'MISC' AND g_rvu.rvu00!='2' THEN #CHI-CC0014
           #------------------------------------ 檢查料號預設倉儲及單別預設倉儲
              IF NOT s_chksmz(g_rvvslk[l_ac5].rvvslk31, g_rvu.rvu01,
                              g_rvvslk[l_ac5].rvvslk32, g_rvvslk[l_ac5].rvvslk33) THEN
                  NEXT FIELD rvvslk32
              END IF
              #------>check-1  檢查該料是否可收至該倉/儲位
              IF NOT s_imfchk(g_rvvslk[l_ac5].rvvslk31,g_rvvslk[l_ac5].rvvslk32,
                              g_rvvslk[l_ac5].rvvslk33) THEN
                 CALL cl_err(g_rvvslk[l_ac5].rvvslk33,'mfg6095',0) NEXT FIELD rvvslk33
              END IF
              #------>check-2  檢查該倉庫/儲位是否存在
              IF g_rvvslk[l_ac5].rvvslk33 IS NOT NULL THEN
                 CALL s_hqty(g_rvvslk[l_ac5].rvvslk31,g_rvvslk[l_ac5].rvvslk32,
                             g_rvvslk[l_ac5].rvvslk33)
                      RETURNING g_cnt,g_imf04,g_imf05
                 IF g_imf04 IS NULL THEN LET g_imf04=0 END IF
                 CALL s_lwyn(g_rvvslk[l_ac5].rvvslk32,g_rvvslk[l_ac5].rvvslk33)
                 ...
                 END IF  
              END IF
              IF g_rvvslk[l_ac5].rvvslk33 IS NULL THEN LET g_rvvslk[l_ac5].rvvslk33=' ' END IF
           END IF
        ...
        BEFORE DELETE                            #是否取消單身
           IF p_cmd5='a' THEN
              LET g_success='N'
           END IF
           IF g_rvvslk_t.rvvslk02 > 0 AND NOT cl_null(g_rvvslk_t.rvvslk02) THEN
              ...
              IF l_lock_sw = "Y" THEN
                 ...
                 CANCEL DELETE
              END IF
                 DELETE FROM rvvslk_file
                  WHERE rvvslk01 = g_rvu.rvu01
                    AND rvvslk02 = g_rvvslk_t.rvvslk02
                 IF SQLCA.sqlcode THEN
                    CALL cl_err3("del","rvvslk_file",g_rvu.rvu01,g_rvvslk_t.rvvslk02,SQLCA.sqlcode,"","",1)  
                    ROLLBACK WORK
                    CANCEL DELETE
                 END IF
#TQC-C20500-----modify--------------begin------------------
#                DELETE FROM rvv_file
#                 WHERE rvv01 = g_rvu.rvu01 AND rvv02 IN (SELECT rvvislk02 FROM rvvi_file
#                                                          WHERE rvvi01=g_rvu.rvu01 AND rvvislk02=g_rvvslk_t.rvvslk02)
                 DELETE FROM rvv_file
                  WHERE rvv01 = g_rvu.rvu01 AND rvv02 IN (SELECT rvvi02 FROM rvvi_file,rvv_file
                                                           WHERE rvvi01=g_rvu.rvu01 
                                                             AND rvvi01=rvv01   
                                                             AND rvvi02=rvv02
                                                             AND rvvislk02=g_rvvslk_t.rvvslk02)
#TQC-C20500-----end------------------------------------------
                 IF SQLCA.sqlcode THEN
                    CALL cl_err3("del","rvv_file",g_rvu.rvu01,'',SQLCA.sqlcode,"","",1)
                     ROLLBACK WORK
                     CANCEL DELETE
                 END IF
                 DELETE FROM rvvi_file
                  WHERE rvvi01 = g_rvu.rvu01 AND rvvislk02=g_rvvslk_t.rvvslk02
                 IF SQLCA.sqlcode THEN
                    CALL cl_err3("del","rvvi_file",g_rvu.rvu01,'',SQLCA.sqlcode,"","",1)
                     ROLLBACK WORK
                     CANCEL DELETE
                 END IF
        ...
        ON ROW CHANGE
            ...
            END IF
            IF l_lock_sw = 'Y' THEN
                CALL cl_err(g_rvvslk[l_ac5].rvvslk02,-263,1)
                LET g_rvvslk[l_ac5].* = g_rvvslk_t.*
            ELSE
                IF cl_null(g_rvvslk[l_ac5].rvvslk33) THEN
                   LET g_rvvslk[l_ac5].rvvslk33=' '
                END IF
                IF cl_null(g_rvvslk[l_ac5].rvvslk34) THEN
                   LET g_rvvslk[l_ac5].rvvslk34=' '
                END IF
             #TQC-C30005--add--begin----
                LET b_rvvslk.rvvslk32=g_rvvslk[l_ac5].rvvslk32
                LET b_rvvslk.rvvslk33=g_rvvslk[l_ac5].rvvslk33
                LET b_rvvslk.rvvslk34=g_rvvslk[l_ac5].rvvslk34
                IF g_rvvslk[l_ac5].rvvslk17 <>g_rvvslk_t.rvvslk17 THEN 
                   LET g_rvvslk[l_ac5].rvvslk39 = g_rvvslk[l_ac5].rvvslk38*g_rvvslk[l_ac5].rvvslk17
                   LET g_rvvslk[l_ac5].rvvslk39t = g_rvvslk[l_ac5].rvvslk38t*g_rvvslk[l_ac5].rvvslk17
                   CALL cl_digcut(g_rvvslk[l_ac5].rvvslk39,t_azi04) RETURNING g_rvvslk[l_ac5].rvvslk39
                   CALL cl_digcut(g_rvvslk[l_ac5].rvvslk39t,t_azi04) RETURNING g_rvvslk[l_ac5].rvvslk39t
                   LET b_rvvslk.rvvslk17 = g_rvvslk[l_ac5].rvvslk17
                   LET b_rvvslk.rvvslk39 = g_rvvslk[l_ac5].rvvslk39
                   LET b_rvvslk.rvvslk39t= g_rvvslk[l_ac5].rvvslk39t
                END IF
              #TQC-C30005--add--end---
                IF cl_null(b_rvvslk.rvvslk17) THEN LET b_rvvslk.rvvslk17=0 END IF
                IF cl_null(b_rvvslk.rvvslk39) THEN LET b_rvvslk.rvvslk39=0 END IF
                IF cl_null(b_rvvslk.rvvslk39t) THEN LET b_rvvslk.rvvslk39t=g_rvvslk[l_ac5].rvvslk39t END IF
                IF cl_null(b_rvvslk.rvvslk38) THEN LET b_rvvslk.rvvslk38=0 END IF
                IF cl_null(b_rvvslk.rvvslk38t) THEN LET b_rvvslk.rvvslk38t=g_rvvslk[l_ac5].rvvslk38t END IF
#                CALL t720sub_rvv39(b_rvvslk.rvvslk36,b_rvvslk.rvvslk39,b_rvvslk.rvvslk39t,g_rvu.rvu04,g_rvu.rvu02) 
#                     RETURNING b_rvvslk.rvvslk39,b_rvvslk.rvvslk39t

#款號單身修改款號編號
                IF g_rvvslk[l_ac5].rvvslk31 <>g_rvvslk_t.rvvslk31 THEN
                   DELETE FROM rvv_file
                    WHERE rvv01=g_rvu.rvu01
                      AND rvv02 IN (SELECT rvv02 FROM rvv_file,rvvi_file
                                     WHERE rvvi01=rvv01
                ...
                END IF
#款號單身修改倉、儲、批
                SELECT ima151 INTO l_ima151 FROM ima_file WHERE ima01 = g_rvvslk[l_ac5].rvvslk31 #TQC-C30005 add
                IF l_ima151 = 'Y' THEN                                                           #TQC-C30005 add
                   IF (g_rvvslk[l_ac5].rvvslk32 <>g_rvvslk_t.rvvslk32 OR g_rvvslk[l_ac5].rvvslk32 <>g_rvvslk_t.rvvslk32
                     OR g_rvvslk[l_ac5].rvvslk32 <>g_rvvslk_t.rvvslk32) AND g_rvvslk[l_ac5].rvvslk31=g_rvvslk_t.rvvslk31 THEN
                      UPDATE rvv_file SET rvv32=g_rvvslk[l_ac5].rvvslk32,
                                          rvv33=g_rvvslk[l_ac5].rvvslk33,
                                          rvv34=g_rvvslk[l_ac5].rvvslk34
                       WHERE rvv01=g_rvu.rvu01
           ...
           #TQC-C30005--add--end-- 
                IF SQLCA.sqlcode THEN
                   ...
                   LET g_success='N'
                END IF
               #END IF  #TQC-C30005 mark

                UPDATE rvvslk_file SET * = b_rvvslk.*
                 WHERE rvvslk01=g_rvu.rvu01
                   AND rvvslk02=g_rvvslk_t.rvvslk02
                IF SQLCA.sqlcode OR SQLCA.sqlerrd[3] = 0 THEN
                   CALL cl_err3("upd","rvvslk_file",g_rvu.rvu01,g_rvvslk_t.rvvslk02,SQLCA.sqlcode,"","upd rvvslk",1) 
                   LET g_rvvslk[l_ac5].* = g_rvvslk_t.*
                   LET g_success='N'
                ELSE
        ...
        AFTER ROW
            ...
            IF INT_FLAG THEN
               ...
               IF p_cmd = 'u' THEN
                  LET g_rvvslk[l_ac5].* = g_rvvslk_t.*
               ELSE                                  
                  CALL g_rvvslk.deleteElement(l_ac5)    
               END IF
               CLOSE t720_cl
               CLOSE t720_bcl_slk
               ROLLBACK WORK
       ...
       INPUT ARRAY g_imx FROM s_imx.*
             ATTRIBUTE(COUNT=g_rec_b6,MAXCOUNT=g_max_rec,WITHOUT DEFAULTS=TRUE,
          ...
          BEFORE INPUT
              ...
              IF STATUS THEN
                 ...
                 RETURN
              END IF
              FETCH t720_cl INTO g_rvu.*               # 對DB鎖定
              IF SQLCA.sqlcode THEN
                 CALL cl_err(g_rvu.rvu01,SQLCA.sqlcode,0)
                 CLOSE t720_cl
                 ROLLBACK WORK
                 RETURN
              END IF

              OPEN t720_bcl_slk USING g_rvu.rvu01,g_rvvslk[l_ac5].rvvslk02
              IF STATUS THEN
                 CALL cl_err("OPEN t720_bcl_slk:", STATUS, 1)
                 CLOSE t720_bcl_slk
                 ROLLBACK WORK
                 RETURN
              END IF
              FETCH t720_bcl_slk INTO b_rvvslk.*               # 對DB鎖定
              IF SQLCA.sqlcode THEN
                 CALL cl_err(g_rvu.rvu01,SQLCA.sqlcode,0)
                 CLOSE t720_bcl_slk
                 ROLLBACK WORK
          ...
          BEFORE ROW
             ...
             IF g_rec_b6 >= l_ac6 THEN
                LET p_cmd6='u'
                LET g_imx_t.* = g_imx[l_ac6].*  #BACKUP
                IF NOT cl_null(g_rvu.rvu02) AND NOT cl_null(g_rvvslk[l_ac5].rvvslk05) THEN
          ...
          AFTER FIELD color
             IF NOT cl_null(g_imx[l_ac6].color) THEN
                IF NOT t720_check_color() THEN
                   LET g_imx[l_ac6].color=g_imx_t.color
                   NEXT FIELD color
                END IF
             #TQC-C20348--add--begin--
                IF p_cmd6 ='a' OR (g_imx[l_ac6].color !=g_imx_t.color AND g_imx_t.color IS NOT NULL) THEN
#MOD-C30217------add---------begin-----------
                   IF NOT t720_chk_color_detail(l_ac6,g_rvvslk[l_ac6].rvvslk31) THEN
                      LET g_imx[l_ac6].color = g_imx_t.color
                      NEXT FIELD color
                   END IF
#MOD-C30217----end---------------------------
                   IF NOT s_chk_color_strategy(l_ac6,g_rvvslk[l_ac5].rvvslk31) THEN
                      LET g_imx[l_ac6].color = g_imx_t.color
                      NEXT FIELD color
                   END IF
                END IF
              #TQC-C20348--add--end--
                IF g_imx[l_ac6].color !=g_imx_t.color AND g_imx_t.color IS NOT NULL THEN
                   CALL s_updcolor_slk(l_ac6,g_rvvslk[l_ac5].rvvslk31,
                                    g_rvu.rvu01,g_rvvslk[l_ac5].rvvslk02)
                END IF
             END IF
          ...
          AFTER FIELD imx01
             IF NOT cl_null(g_imx[l_ac6].imx01) THEN
                IF p_cmd6='a' OR (g_imx[l_ac6].imx01 !=g_imx_t.imx01 AND g_imx_t.imx01 IS NOT NULL) THEN
                   IF NOT t720_check_imx(1,g_imx[l_ac6].imx01,g_imx_t.imx01) THEN
                      LET g_imx[l_ac6].imx01 = g_imx_t.imx01
                      NEXT FIELD imx01
                   END IF
                 #TQC-C20348--add--begin--
                    CALL s_chk_prod_strategy(l_ac6,1,g_rvvslk[l_ac5].rvvslk31,g_imx[l_ac6].imx01) RETURNING l_error,l_ima01
                ...
                END IF
             END IF
             IF cl_null(g_imx[l_ac6].imx01) THEN
                LET g_imx[l_ac6].imx01=0
             END IF

          AFTER FIELD imx02
             IF NOT cl_null(g_imx[l_ac6].imx02) THEN
                IF p_cmd6='a' OR (g_imx[l_ac6].imx02 !=g_imx_t.imx02 AND g_imx_t.imx02 IS NOT NULL) THEN
                   IF NOT t720_check_imx(2,g_imx[l_ac6].imx02,g_imx_t.imx02) THEN
                      LET g_imx[l_ac6].imx02 = g_imx_t.imx02
                      NEXT FIELD imx02
                   END IF
                 #TQC-C20348--add--begin--
                    CALL s_chk_prod_strategy(l_ac6,2,g_rvvslk[l_ac5].rvvslk31,g_imx[l_ac6].imx02) RETURNING l_error,l_ima01
                    IF NOT cl_null(l_error) THEN   #檢查商品策略
                       CALL cl_err(l_ima01,l_error,0)
                       LET g_imx[l_ac6].imx02 = g_imx_t.imx02
                       NEXT FIELD imx02
                ...
                END IF
             END IF
             IF cl_null(g_imx[l_ac6].imx02) THEN
                LET g_imx[l_ac6].imx02=0
             END IF

          AFTER FIELD imx03
             IF NOT cl_null(g_imx[l_ac6].imx03) THEN
                IF p_cmd6='a' OR (g_imx[l_ac6].imx03 !=g_imx_t.imx03 AND g_imx_t.imx03 IS NOT NULL) THEN
                   IF NOT t720_check_imx(3,g_imx[l_ac6].imx03,g_imx_t.imx03) THEN
                      LET g_imx[l_ac6].imx03 = g_imx_t.imx03
                      NEXT FIELD imx03
                   END IF
                 #TQC-C20348--add--begin--
                    CALL s_chk_prod_strategy(l_ac6,3,g_rvvslk[l_ac5].rvvslk31,g_imx[l_ac6].imx03) RETURNING l_error,l_ima01
                    IF NOT cl_null(l_error) THEN   #檢查商品策略
                       CALL cl_err(l_ima01,l_error,0)
                       LET g_imx[l_ac6].imx03 = g_imx_t.imx03
                       NEXT FIELD imx03
                ...
                END IF
             END IF
             IF cl_null(g_imx[l_ac6].imx03) THEN
                LET g_imx[l_ac6].imx03=0
             END IF

          AFTER FIELD imx04
             IF NOT cl_null(g_imx[l_ac6].imx04) THEN
                IF p_cmd6='a' OR (g_imx[l_ac6].imx04 !=g_imx_t.imx04 AND g_imx_t.imx04 IS NOT NULL) THEN
                    IF NOT t720_check_imx(4,g_imx[l_ac6].imx04,g_imx_t.imx04) THEN
                       LET g_imx[l_ac6].imx04 = g_imx_t.imx04
                       NEXT FIELD imx04
                    END IF
                 #TQC-C20348--add--begin--
                    CALL s_chk_prod_strategy(l_ac6,4,g_rvvslk[l_ac5].rvvslk31,g_imx[l_ac6].imx04) RETURNING l_error,l_ima01
                    IF NOT cl_null(l_error) THEN   #檢查商品策略
                       CALL cl_err(l_ima01,l_error,0)
                       LET g_imx[l_ac6].imx04 = g_imx_t.imx04
                       NEXT FIELD imx04
                ...
                END IF
             END IF
             IF cl_null(g_imx[l_ac6].imx04) THEN
                LET g_imx[l_ac6].imx04=0
             END IF

          AFTER FIELD imx05
             IF NOT cl_null(g_imx[l_ac6].imx05) THEN
                IF p_cmd6='a' OR (g_imx[l_ac6].imx05 !=g_imx_t.imx05 AND g_imx_t.imx05 IS NOT NULL) THEN
                   IF NOT t720_check_imx(5,g_imx[l_ac6].imx05,g_imx_t.imx05) THEN
                      LET g_imx[l_ac6].imx05 = g_imx_t.imx05
                      NEXT FIELD imx05
                   END IF
                 #TQC-C20348--add--begin--
                    CALL s_chk_prod_strategy(l_ac6,5,g_rvvslk[l_ac5].rvvslk31,g_imx[l_ac6].imx05) RETURNING l_error,l_ima01
                    IF NOT cl_null(l_error) THEN   #檢查商品策略
                       CALL cl_err(l_ima01,l_error,0)
                       LET g_imx[l_ac6].imx05 = g_imx_t.imx05
                       NEXT FIELD imx05
                ...
                END IF
             END IF
             IF cl_null(g_imx[l_ac6].imx05) THEN
                LET g_imx[l_ac6].imx05=0
             END IF


          AFTER FIELD imx06
             IF NOT cl_null(g_imx[l_ac6].imx06) THEN
                IF p_cmd6='a' OR (g_imx[l_ac6].imx06 !=g_imx_t.imx06 AND g_imx_t.imx06 IS NOT NULL) THEN
                   IF NOT t720_check_imx(6,g_imx[l_ac6].imx06,g_imx_t.imx06) THEN
                      LET g_imx[l_ac6].imx06 = g_imx_t.imx06
                      NEXT FIELD imx06
                   END IF
                 #TQC-C20348--add--begin--
                    CALL s_chk_prod_strategy(l_ac6,6,g_rvvslk[l_ac5].rvvslk31,g_imx[l_ac6].imx06) RETURNING l_error,l_ima01
                    IF NOT cl_null(l_error) THEN   #檢查商品策略
                       CALL cl_err(l_ima01,l_error,0)
                       LET g_imx[l_ac6].imx06 = g_imx_t.imx06
                       NEXT FIELD imx06
                ...
                END IF
             END IF
             IF cl_null(g_imx[l_ac6].imx06) THEN
                LET g_imx[l_ac6].imx06=0
             END IF

          AFTER FIELD imx07
             IF NOT cl_null(g_imx[l_ac6].imx07) THEN
                IF p_cmd6='a' OR (g_imx[l_ac6].imx07 !=g_imx_t.imx07 AND g_imx_t.imx07 IS NOT NULL) THEN
                   IF NOT t720_check_imx(7,g_imx[l_ac6].imx07,g_imx_t.imx07) THEN
                      LET g_imx[l_ac6].imx07 = g_imx_t.imx07
                      NEXT FIELD imx07
                   END IF
                 #TQC-C20348--add--begin--
                    CALL s_chk_prod_strategy(l_ac6,7,g_rvvslk[l_ac5].rvvslk31,g_imx[l_ac6].imx07) RETURNING l_error,l_ima01
                    IF NOT cl_null(l_error) THEN   #檢查商品策略
                       CALL cl_err(l_ima01,l_error,0)
                       LET g_imx[l_ac6].imx07 = g_imx_t.imx07
                       NEXT FIELD imx07
                ...
                END IF
             END IF
             IF cl_null(g_imx[l_ac6].imx07) THEN
                LET g_imx[l_ac6].imx07=0
             END IF

          AFTER FIELD imx08
             IF NOT cl_null(g_imx[l_ac6].imx08) THEN
                IF p_cmd6='a' OR (g_imx[l_ac6].imx08 !=g_imx_t.imx08 AND g_imx_t.imx08 IS NOT NULL) THEN
                   IF NOT t720_check_imx(8,g_imx[l_ac6].imx08,g_imx_t.imx08) THEN
                      LET g_imx[l_ac6].imx08 = g_imx_t.imx08
                      NEXT FIELD imx08
                   END IF
                 #TQC-C20348--add--begin--
                    CALL s_chk_prod_strategy(l_ac6,8,g_rvvslk[l_ac5].rvvslk31,g_imx[l_ac6].imx08) RETURNING l_error,l_ima01
                    IF NOT cl_null(l_error) THEN   #檢查商品策略
                       CALL cl_err(l_ima01,l_error,0)
                       LET g_imx[l_ac6].imx08 = g_imx_t.imx08
                       NEXT FIELD imx08
                ...
                END IF
             END IF
             IF cl_null(g_imx[l_ac6].imx08) THEN
                LET g_imx[l_ac6].imx08=0
             END IF

          AFTER FIELD imx09
             IF NOT cl_null(g_imx[l_ac6].imx09) THEN
                IF p_cmd6='a' OR (g_imx[l_ac6].imx09 !=g_imx_t.imx09 AND g_imx_t.imx09 IS NOT NULL) THEN
                   IF NOT t720_check_imx(9,g_imx[l_ac6].imx09,g_imx_t.imx09) THEN
                      LET g_imx[l_ac6].imx09 = g_imx_t.imx09
                      NEXT FIELD imx09
                   END IF
                 #TQC-C20348--add--begin--
                    CALL s_chk_prod_strategy(l_ac6,9,g_rvvslk[l_ac5].rvvslk31,g_imx[l_ac6].imx09) RETURNING l_error,l_ima01
                    IF NOT cl_null(l_error) THEN   #檢查商品策略
                       CALL cl_err(l_ima01,l_error,0)
                       LET g_imx[l_ac6].imx09 = g_imx_t.imx09
                       NEXT FIELD imx09
                ...
                END IF
             END IF
             IF cl_null(g_imx[l_ac6].imx09) THEN
                LET g_imx[l_ac6].imx09=0
             END IF

          AFTER FIELD imx10
             IF NOT cl_null(g_imx[l_ac6].imx10) THEN
                IF p_cmd6='a' OR (g_imx[l_ac6].imx10 !=g_imx_t.imx10 AND g_imx_t.imx10 IS NOT NULL) THEN
                   IF NOT t720_check_imx(10,g_imx[l_ac6].imx10,g_imx_t.imx10) THEN
                      LET g_imx[l_ac6].imx10 = g_imx_t.imx10
                      NEXT FIELD imx10
                   END IF
                 #TQC-C20348--add--begin--
                    CALL s_chk_prod_strategy(l_ac6,10,g_rvvslk[l_ac5].rvvslk31,g_imx[l_ac6].imx10) RETURNING l_error,l_ima01
                    IF NOT cl_null(l_error) THEN   #檢查商品策略
                       CALL cl_err(l_ima01,l_error,0)
                       LET g_imx[l_ac6].imx10 = g_imx_t.imx10
                       NEXT FIELD imx10
                ...
                END IF
             END IF
             IF cl_null(g_imx[l_ac6].imx10) THEN
                LET g_imx[l_ac6].imx10=0
             END IF


          AFTER FIELD imx11
             IF NOT cl_null(g_imx[l_ac6].imx11) THEN
                IF p_cmd6='a' OR (g_imx[l_ac6].imx11 !=g_imx_t.imx11 AND g_imx_t.imx11 IS NOT NULL) THEN
                   IF NOT t720_check_imx(11,g_imx[l_ac6].imx11,g_imx_t.imx11) THEN
                      LET g_imx[l_ac6].imx11 = g_imx_t.imx11
                      NEXT FIELD imx11
                   END IF
                 #TQC-C20348--add--begin--
                    CALL s_chk_prod_strategy(l_ac6,11,g_rvvslk[l_ac5].rvvslk31,g_imx[l_ac6].imx11) RETURNING l_error,l_ima01
                    IF NOT cl_null(l_error) THEN   #檢查商品策略
                       CALL cl_err(l_ima01,l_error,0)
                       LET g_imx[l_ac6].imx11 = g_imx_t.imx11
                       NEXT FIELD imx11
                ...
                END IF
             END IF
             IF cl_null(g_imx[l_ac6].imx11) THEN
                LET g_imx[l_ac6].imx11=0
             END IF

          AFTER FIELD imx12
             IF NOT cl_null(g_imx[l_ac6].imx12) THEN
                IF p_cmd6='a' OR (g_imx[l_ac6].imx12 !=g_imx_t.imx12 AND g_imx_t.imx12 IS NOT NULL) THEN
                   IF NOT t720_check_imx(12,g_imx[l_ac6].imx12,g_imx_t.imx12) THEN
                      LET g_imx[l_ac6].imx12 = g_imx_t.imx12
                      NEXT FIELD imx12
                   END IF
                 #TQC-C20348--add--begin--
                    CALL s_chk_prod_strategy(l_ac6,12,g_rvvslk[l_ac5].rvvslk31,g_imx[l_ac6].imx12) RETURNING l_error,l_ima01
                    IF NOT cl_null(l_error) THEN   #檢查商品策略
                       CALL cl_err(l_ima01,l_error,0)
                       LET g_imx[l_ac6].imx12 = g_imx_t.imx12
                       NEXT FIELD imx12
                ...
                END IF
             END IF
             IF cl_null(g_imx[l_ac6].imx12) THEN
                LET g_imx[l_ac6].imx12=0
             END IF

          AFTER FIELD imx13
             IF NOT cl_null(g_imx[l_ac6].imx13) THEN
                IF p_cmd6='a' OR (g_imx[l_ac6].imx13 !=g_imx_t.imx13 AND g_imx_t.imx13 IS NOT NULL) THEN
                   IF NOT t720_check_imx(13,g_imx[l_ac6].imx13,g_imx_t.imx13) THEN
                      LET g_imx[l_ac6].imx13 = g_imx_t.imx13
                      NEXT FIELD imx13
                   END IF
                 #TQC-C20348--add--begin--
                    CALL s_chk_prod_strategy(l_ac6,13,g_rvvslk[l_ac5].rvvslk31,g_imx[l_ac6].imx13) RETURNING l_error,l_ima01
                    IF NOT cl_null(l_error) THEN   #檢查商品策略
                       CALL cl_err(l_ima01,l_error,0)
                       LET g_imx[l_ac6].imx13 = g_imx_t.imx13
                       NEXT FIELD imx13
                ...
                END IF
             END IF
             IF cl_null(g_imx[l_ac6].imx13) THEN
                LET g_imx[l_ac6].imx13=0
             END IF

          AFTER FIELD imx14
             IF NOT cl_null(g_imx[l_ac6].imx14) THEN
                IF p_cmd6='a' OR (g_imx[l_ac6].imx14 !=g_imx_t.imx14 AND g_imx_t.imx14 IS NOT NULL) THEN
                   IF NOT t720_check_imx(14,g_imx[l_ac6].imx14,g_imx_t.imx14) THEN
                      LET g_imx[l_ac6].imx14 = g_imx_t.imx14
                      NEXT FIELD imx14
                   END IF
                 #TQC-C20348--add--begin--
                    CALL s_chk_prod_strategy(l_ac6,14,g_rvvslk[l_ac5].rvvslk31,g_imx[l_ac6].imx14) RETURNING l_error,l_ima01
                    IF NOT cl_null(l_error) THEN   #檢查商品策略
                       CALL cl_err(l_ima01,l_error,0)
                       LET g_imx[l_ac6].imx14 = g_imx_t.imx14
                       NEXT FIELD imx14
                ...
                END IF
             END IF
             IF cl_null(g_imx[l_ac6].imx14) THEN
                LET g_imx[l_ac6].imx14=0
             END IF

          AFTER FIELD imx15
             IF NOT cl_null(g_imx[l_ac6].imx15) THEN
                IF p_cmd6='a' OR (g_imx[l_ac6].imx15 !=g_imx_t.imx15 AND g_imx_t.imx15 IS NOT NULL) THEN
                   IF NOT t720_check_imx(15,g_imx[l_ac6].imx15,g_imx_t.imx15) THEN
                      LET g_imx[l_ac6].imx15 = g_imx_t.imx15
                      NEXT FIELD imx15
                   END IF
                 #TQC-C20348--add--begin--
                    CALL s_chk_prod_strategy(l_ac6,15,g_rvvslk[l_ac5].rvvslk31,g_imx[l_ac6].imx15) RETURNING l_error,l_ima01
                    IF NOT cl_null(l_error) THEN   #檢查商品策略
                       CALL cl_err(l_ima01,l_error,0)
                       LET g_imx[l_ac6].imx15 = g_imx_t.imx15
                       NEXT FIELD imx15
                ...
                END IF
             END IF
             IF cl_null(g_imx[l_ac6].imx15) THEN
                LET g_imx[l_ac6].imx15=0
             END IF
          ...
          BEFORE DELETE
            IF NOT cl_null(g_imx_t.color) THEN    #TQC-C20348 add
               IF NOT cl_delb(0,0) THEN
                  CANCEL DELETE
               END IF
               CALL s_ins_slk('r',l_ac6,g_rvvslk[l_ac5].rvvslk31,
                              g_rvu.rvu01,g_rvvslk[l_ac5].rvvslk02)
          ...
          AFTER INSERT
#MOD-C30217------add---begin-----------------
             IF (g_imx[l_ac6].imx01 IS NULL OR g_imx[l_ac6].imx01 = 0) AND
                (g_imx[l_ac6].imx02 IS NULL OR g_imx[l_ac6].imx02 = 0) AND
                (g_imx[l_ac6].imx03 IS NULL OR g_imx[l_ac6].imx03 = 0) AND
                (g_imx[l_ac6].imx04 IS NULL OR g_imx[l_ac6].imx04 = 0) AND
                (g_imx[l_ac6].imx05 IS NULL OR g_imx[l_ac6].imx05 = 0) AND
                (g_imx[l_ac6].imx06 IS NULL OR g_imx[l_ac6].imx06 = 0) AND
                (g_imx[l_ac6].imx07 IS NULL OR g_imx[l_ac6].imx07 = 0) AND
                (g_imx[l_ac6].imx08 IS NULL OR g_imx[l_ac6].imx08 = 0) AND
                (g_imx[l_ac6].imx09 IS NULL OR g_imx[l_ac6].imx09 = 0) AND
                (g_imx[l_ac6].imx10 IS NULL OR g_imx[l_ac6].imx10 = 0) AND
                (g_imx[l_ac6].imx11 IS NULL OR g_imx[l_ac6].imx11 = 0) AND
                (g_imx[l_ac6].imx12 IS NULL OR g_imx[l_ac6].imx12 = 0) AND
                (g_imx[l_ac6].imx13 IS NULL OR g_imx[l_ac6].imx13 = 0) AND
                (g_imx[l_ac6].imx14 IS NULL OR g_imx[l_ac6].imx14 = 0) AND
                (g_imx[l_ac6].imx15 IS NULL OR g_imx[l_ac6].imx15 = 0)
             THEN
                 CANCEL INSERT
             END IF
#MOD-C30217------end-------------------------
             CALL t720_rvvslk_slk_move()
             CALL s_ins_slk('a',l_ac6,g_rvvslk[l_ac5].rvvslk31,
                            g_rvu.rvu01,g_rvvslk[l_ac5].rvvslk02)
             LET g_rec_b6=g_rec_b6+1

          ON ROW CHANGE
             CALL t720_rvvslk_slk_move()
             CALL s_ins_slk('u',l_ac6,g_rvvslk[l_ac5].rvvslk31,
                            g_rvu.rvu01,g_rvvslk[l_ac5].rvvslk02)

          AFTER INPUT
             CALL t720_update_rvvslk()
             IF g_success = 'Y' THEN
                COMMIT WORK
             ELSE
                ROLLBACK WORK
...
#                 LET li_a = TRUE     #FUN-C60100---MARK---
        ...
        ON ACTION controlp
           CASE
             WHEN INFIELD(rvvslk05) #查詢驗收單項次
               IF g_rvu.rvu00='3' THEN #-- 倉退
                  CALL q_rvbslk7(FALSE,TRUE,g_rvu.rvu02,g_rvvslk[l_ac5].rvvslk05,g_rvu.rvu01) #TQC-C20512 add
                  RETURNING g_rvvslk[l_ac5].rvvslk05   
                # CALL q_rvb7(FALSE,TRUE,                                                #TQC-C20512 mark
                #              g_rvu.rvu02,g_rvvslk[l_ac5].rvvslk05,g_rvu.rvu01)         #TQC-C20512 mark 
                #  RETURNING g_rvvslk[l_ac5].rvvslk05                                    #TQC-C20512 mark
               ELSE
                 IF g_rvu.rvu00='1' THEN  
                   CALL cl_init_qry_var()
                   LET g_qryparam.form = "q_rvvslk05"                    #TQC-C20512 add
                 # LET g_qryparam.form = "q_rvb"                         #TQC-C20512 mark
                   LET g_qryparam.default1 = g_rvvslk[l_ac5].rvvslk05
                   LET g_qryparam.arg1 = g_rvu.rvu02
                   CALL cl_create_qry() RETURNING g_rvvslk[l_ac5].rvvslk05
                 END IF
               END IF
               DISPLAY BY NAME g_rvvslk[l_ac5].rvvslk05       
...
#               END IF
             ...
             WHEN INFIELD(rvvslk31)
                CALL q_sel_ima(FALSE, "q_ima01_slk","",g_rvvslk[l_ac5].rvvslk31,"","","","","",'' )    #TQC-C20348--modify
                         RETURNING g_rvvslk[l_ac5].rvvslk31
                DISPLAY BY NAME g_rvvslk[l_ac5].rvvslk31       
                NEXT FIELD rvvslk31
             WHEN INFIELD(rvvslk32) OR INFIELD(rvvslk33) OR INFIELD(rvvslk34)
               CALL q_img4(FALSE,TRUE, 
                           g_rvvslk[l_ac5].rvvslk31,g_rvvslk[l_ac5].rvvslk32,
                           g_rvvslk[l_ac5].rvvslk33,g_rvvslk[l_ac5].rvvslk34,'A')
               RETURNING  g_rvvslk[l_ac5].rvvslk32,g_rvvslk[l_ac5].rvvslk33,g_rvvslk[l_ac5].rvvslk34
               DISPLAY g_rvvslk[l_ac5].rvvslk32 TO rvvslk32
               DISPLAY g_rvvslk[l_ac5].rvvslk33 TO rvvslk33
               DISPLAY g_rvvslk[l_ac5].rvvslk34 TO rvvslk34

               IF INFIELD(rvvslk32) THEN NEXT FIELD rvvslk32 END IF
               IF INFIELD(rvvslk33) THEN NEXT FIELD rvvslk33 END IF
               IF INFIELD(rvvslk34) THEN NEXT FIELD rvvslk34 END IF
             WHEN INFIELD(rvvslk930)
               CALL cl_init_qry_var()
               LET g_qryparam.form ="q_gem4"
               CALL cl_create_qry() RETURNING g_rvvslk[l_ac5].rvvslk930
               DISPLAY BY NAME g_rvvslk[l_ac5].rvvslk930
               NEXT FIELD rvvslk930
             WHEN INFIELD(rvvslk35) #查詢單位
               CALL cl_init_qry_var()
               LET g_qryparam.form = "q_gfe"
               LET g_qryparam.default1 = g_rvvslk[l_ac5].rvvslk35
               CALL cl_create_qry() RETURNING g_rvvslk[l_ac5].rvvslk35
               DISPLAY BY NAME g_rvvslk[l_ac5].rvvslk35     
               NEXT FIELD rvvslk35
...
#FUN-A60035 ---MARK END
    ...
    IF g_prog = 'apmt720' OR g_prog = 'aict042' THEN  #MOD-D30083 add aict042
          ...
          "       rvv18,rvv36,rvv37,rvv919,'','','',rvv25, rvv89,rvv17, rvv32,rvv33,rvv34,'','','','','',", #FUN-740046 rvv37 #FUN-9A0068  #FUN-A80150 add rvv919
...
#TQC-A60046 --End
          ...
          " ORDER BY rvv02 "
          LET g_sql = "SELECT rvv02,rvv05,rvv45,rvv46,qcl02,rvv47,rvv31,'','','','','','','','','','','','','','','','','','','','','',rvv031,ima021,rvviicd03,'',rvviicd04,'',rvv35,rvv35_fac,",    #FUN-BC0104 add 
          " rvv10,rvv11,rvv12,rvv13,",  #NO.FUN-960130
          "       rvv18,rvv36,rvv37,rvv919,'','','',rvv25, rvv89, rvv17, rvv32,rvv33,rvv34,rvviicd05,rvviicd01,'',rvviicd02,rvviicd06,",    #FUN-9A0068 add rvv89  #FUN-A80150 add rvv919
          "       rvv83,rvv84,rvv85,rvv80, rvv81, rvv82,rvv86,rvv87,",
          "       rvv38,rvv38t,rvv39,rvv39t,rvv26,azf03, rvv41,'','','','',",  #FUN-B40083  add pmn123 mse02
          "       rvv930,'', ",
          "       rvvud01,rvvud02,rvvud03,rvvud04,rvvud05,",
          "       rvvud06,rvvud07,rvvud08,rvvud09,rvvud10,",
          "       rvvud11,rvvud12,rvvud13,rvvud14,rvvud15 ",
#MOD-D30166-------
#         "  FROM rvv_file, OUTER azf_file, OUTER ima_file ,OUTER rvvi_file ",
#         "       ,OUTER (pmn_file,OUTER pmm_file) ",    #No.FUN-940083
#         "       ,OUTER qcl_file ",                #FUN-BC0104
#         " WHERE rvv01 ='",g_rvu.rvu01,"'",     #單頭
#         "   AND pmm_file.mm01 = pmn_file.pmn01 ",               
#         "   AND rvv36 = pmn_file.pmn01 AND rvv37 = pmn_file.pmn02 ",
#         "   AND rvv26=azf_file.azf01 AND azf_file.azf02='2' ",
#         "   AND rvv31=ima_file.ima01 ",
#         "   AND rvv01 = rvvi_file.rvvi01 ",
#         "   AND rvv02 = rvvi_file.rvvi02 ",
#         "   AND rvv46 = qcl01 ",            #FUN-BC0104
          "  FROM rvv_file LEFT OUTER JOIN azf_file ON rvv26=azf01 AND azf02='2' ",
          "                LEFT OUTER JOIN ima_file ON rvv31=ima01 ",
          "                LEFT OUTER JOIN rvvi_file ON rvv01 = rvvi01 AND rvv02 = rvvi02 ",
          "                LEFT OUTER JOIN ",
          "                              pmn_file LEFT OUTER JOIN pmm_file  ON pmm01 = pmn01 ", 
          "                ON rvv36 = pmn01 AND rvv37 = pmn02 ",
          "                LEFT OUTER JOIN qcl_file ON rvv46 = qcl01 ", 
          " WHERE rvv01 ='",g_rvu.rvu01,"'",     #單頭
#MOD-D30166-------
          "   AND ",p_wc2 CLIPPED,               #單身
          " ORDER BY rvv02 "
    ELSE
          ...
          " rvv10,rvv11,rvv12,rvv13,",  #NO.FUN-960130
          "       rvv18,rvv36,rvv37,rvv919,'','','',rvv25, rvv89, rvv17, rvv32,rvv33,rvv34,'','','','','',",   #FUN-740046 rvv37後#FUN-9A00688  #FUN-A80150 add rvv919
          "       rvv83,rvv84,rvv85,rvv80, rvv81, rvv82,rvv86,rvv87,",
          "       rvv38,rvv38t,rvv39,rvv39t,rvv26,azf03, rvv41,'','','','',", #no.A050  FUN-610018  #FUN-B40083  add pmn123 mse02
          "       rvv930,'', ",  #FUN-670051
          "       rvvud01,rvvud02,rvvud03,rvvud04,rvvud05,",
          ...
          "   AND ",p_wc2 CLIPPED,               #單身
          " ORDER BY rvv02 "
          LET g_sql = "SELECT rvv02,rvv05,rvv45,rvv46,qcl02,rvv47,rvv31,'','','','','','','','','','','','','','','','','','','','','',rvv031,ima021,rvviicd03,'',rvviicd04,'',rvv35,rvv35_fac,",  #FUN-810038       #FUN-BC0104add
          " rvv10,rvv11,rvv12,rvv13,",  #NO.FUN-960130
          "       rvv18,rvv36,rvv37,rvv919,'','','',rvv25, rvv89, rvv17, rvv32,rvv33,rvv34,rvviicd05,rvviicd01,'',rvviicd02,rvviicd06,",  #FUN-810038 #FUN-9A0068  #FUN-A80150 add rvv919
          "       rvv83,rvv84,rvv85,rvv80, rvv81, rvv82,rvv86,rvv87,",
          "       rvv38,rvv38t,rvv39,rvv39t,rvv26,azf03, rvv41,'','','','',",  #FUN-B40083  add pmn123 mse02
          "       rvv930,'', ",
          "       rvvud01,rvvud02,rvvud03,rvvud04,rvvud05,",
          "       rvvud06,rvvud07,rvvud08,rvvud09,rvvud10,",
          "       rvvud11,rvvud12,rvvud13,rvvud14,rvvud15 ",
          "  FROM rvv_file, OUTER azf_file, OUTER ima_file ,OUTER rvvi_file ,OUTER qcl_file ", #FUN-BC0104 qcl_file
          " WHERE rvv01 ='",g_rvu.rvu01,"'",     #單頭
          "   AND rvv26=azf_file.azf01 AND azf_file.azf02='2' ",
          "   AND rvv31=ima_file.ima01 ",
          "   AND rvv01 = rvvi_file.rvvi01 ",
...
#FUN-B90104----add----begin-------------------------
FUNCTION t720_b_fill_slk(p_wc5)              #BODY FILL UP
 DEFINE p_wc5          STRING
    ...
    IF g_prog = 'apmt720_slk' THEN
       LET g_sql = " SELECT rvvslk02,rvvslk05,rvvslk31,rvvslk031,rvvslk17,rvvslk32,rvvslk33,rvvslk34,rvvslk35,",
                   "        rvvslk36,rvvslk37,rvvslk38,rvvslk39,rvvslk38t,rvvslk39t,rvvslk930,rvvslk10,rvvslk11 ",
                   "   FROM rvvslk_file LEFT OUTER JOIN pmnslk_file LEFT OUTER JOIN pmm_file ON pmnslk01=pmm01 ",
                   "                ON rvvslk36=pmnslk01 AND rvvslk37=pmnslk02 ",
                   "  WHERE rvvslk01 ='",g_rvu.rvu01,"'",     #單頭
                   "    AND ",p_wc5 CLIPPED,                  #單身
                   "  ORDER BY rvvslk02"
    ELSE
       LET g_sql = " SELECT rvvslk02,rvvslk05,rvvslk31,rvvslk031,rvvslk17,rvvslk32,rvvslk33,rvvslk34,rvvslk35,",
                   "        rvvslk36,rvvslk37,rvvslk38,rvvslk39,rvvslk38t,rvvslk39t,rvvslk930,rvvslk10,rvvslk11 ",
    ...
    PREPARE t720_pb_slk FROM g_sql
    DECLARE rvvslk_curs CURSOR FOR t720_pb_slk

    CALL g_rvvslk.clear()

    LET g_cnt = 1
    FOREACH rvvslk_curs INTO g_rvvslk[g_cnt].*   #單身 ARRAY 填充
        IF STATUS THEN CALL cl_err('foreach:',STATUS,1) EXIT FOREACH END IF
        LET g_cnt = g_cnt + 1
        IF g_cnt > g_max_rec THEN
           CALL cl_err( '', 9035, 0 )
        ...
        END IF
    END FOREACH
    CALL g_rvvslk.deleteElement(g_cnt)
...
FUNCTION t720_getslk_price()
  DEFINE l_rvvslk17     LIKE rvvslk_file.rvvslk17

   IF g_rvu.rvu00 != '3' OR NOT cl_null(g_rvu.rvu02) THEN RETURN END IF
   IF cl_null(g_rvvslk[l_ac5].rvvslk31) OR cl_null(g_rvvslk[l_ac5].rvvslk35) THEN
      RETURN
   END IF
   IF cl_null(g_rvvslk[l_ac5].rvvslk17) AND p_cmd5='a' THEN
      LET l_rvvslk17=1
   ELSE
      LET l_rvvslk17=g_rvvslk[l_ac5].rvvslk17
   END IF
   CALL s_defprice_new(g_rvvslk[l_ac5].rvvslk31,g_rvu.rvu04,g_rvu.rvu113,g_rvu.rvu03,
                   l_rvvslk17,'',g_rvu.rvu115,g_rvu.rvu12,'',
                   g_rvvslk[l_ac5].rvvslk35,'',g_rvu.rvu112,g_rvu.rvu111,g_rvu.rvuplant)
      RETURNING g_rvvslk[l_ac5].rvvslk38,g_rvvslk[l_ac5].rvvslk38t,
                g_rvvslk[l_ac5].rvvslk10,g_rvvslk[l_ac5].rvvslk11   
   CALL t720_getazi_slk('')
   CALL cl_digcut(g_rvvslk[l_ac5].rvvslk38,t_azi03) RETURNING g_rvvslk[l_ac5].rvvslk38
   CALL cl_digcut(g_rvvslk[l_ac5].rvvslk38t,t_azi03) RETURNING g_rvvslk[l_ac5].rvvslk38t
   LET g_rvvslk[l_ac5].rvvslk39 = g_rvvslk[l_ac5].rvvslk38*g_rvvslk[l_ac5].rvvslk17
   LET g_rvvslk[l_ac5].rvvslk39t = g_rvvslk[l_ac5].rvvslk38t*g_rvvslk[l_ac5].rvvslk17
   CALL cl_digcut(g_rvvslk[l_ac5].rvvslk39,t_azi04) RETURNING g_rvvslk[l_ac5].rvvslk39
   CALL cl_digcut(g_rvvslk[l_ac5].rvvslk39t,t_azi04) RETURNING g_rvvslk[l_ac5].rvvslk39t
   IF cl_null(g_rvvslk[l_ac5].rvvslk10) THEN
      LET g_rvvslk[l_ac5].rvvslk10 = '4'
   END IF 
   DISPLAY BY NAME g_rvvslk[l_ac5].rvvslk38,g_rvvslk[l_ac5].rvvslk38t,g_rvvslk[l_ac5].rvvslk39,
                   g_rvvslk[l_ac5].rvvslk39t,g_rvvslk[l_ac5].rvvslk10,g_rvvslk[l_ac5].rvvslk11
END FUNCTION

FUNCTION t720_check_rvvslk32()
DEFINE l_ime12            LIKE ime_file.ime12

   LET g_errno = ' '
   IF cl_null(g_rvvslk[l_ac5].rvvslk32) OR cl_null(g_rvvslk[l_ac5].rvvslk33) THEN
      RETURN
   END IF

   SELECT ime12 INTO l_ime12 FROM ime_file WHERE ime01 = g_rvvslk[l_ac5].rvvslk32
                                             AND ime02 = g_rvvslk[l_ac5].rvvslk33
   IF SQLCA.SQLCODE THEN
...
FUNCTION t720_update_rvvslk()
   DEFINE l_rva00   LIKE rva_file.rva00
   DEFINE l_rva113  LIKE rva_file.rva113

   SELECT SUM(rvv17) INTO g_rvvslk[l_ac5].rvvslk17 FROM rvv_file,rvvi_file
    WHERE rvv01=g_rvu.rvu01 AND rvv01=rvvi01 AND rvv02=rvvi02
      AND rvvislk02=g_rvvslk[l_ac5].rvvslk02
   ...
   IF cl_null(g_rvu.rvu02) THEN
      LET l_rva00 = '2'
   END IF
   LET g_rvvslk[l_ac5].rvvslk39=g_rvvslk[l_ac5].rvvslk17*g_rvvslk[l_ac5].rvvslk38  
   LET g_rvvslk[l_ac5].rvvslk39t=g_rvvslk[l_ac5].rvvslk17*g_rvvslk[l_ac5].rvvslk38t 

   CALL t720_getazi_slk(g_rvvslk[l_ac5].rvvslk36)
   CALL cl_digcut(g_rvvslk[l_ac5].rvvslk39,t_azi04)     
                     RETURNING g_rvvslk[l_ac5].rvvslk39
   CALL cl_digcut(g_rvvslk[l_ac5].rvvslk39t,t_azi04)    
                     RETURNING g_rvvslk[l_ac5].rvvslk39t  

   #CALL t720sub_rvv39(g_rvvslk[l_ac5].rvvslk36,g_rvvslk[l_ac5].rvvslk39,g_rvvslk[l_ac5].rvvslk39t,g_rvu.rvu04,g_rvu.rvu02) #MOD-BC0262 mark 
   CALL t720sub_rvv39(g_rvvslk[l_ac5].rvvslk36,g_rvvslk[l_ac5].rvvslk39,g_rvvslk[l_ac5].rvvslk39t,g_rvu.rvu04,g_rvu.rvu01)  #MOD-BC0262 add
     RETURNING g_rvvslk[l_ac5].rvvslk39,g_rvvslk[l_ac5].rvvslk39t

   UPDATE rvvslk_file SET rvvslk17=g_rvvslk[l_ac5].rvvslk17,
                          rvvslk39=g_rvvslk[l_ac5].rvvslk39,
                          rvvslk39t=g_rvvslk[l_ac5].rvvslk39t
    WHERE rvvslk01=g_rvu.rvu01 AND rvvslk02=g_rvvslk[l_ac5].rvvslk02
   IF SQLCA.sqlcode OR SQLCA.sqlerrd[3]=0 THEN
      CALL cl_err3("upd","rvvslk_file",g_rvvslk[l_ac5].rvvslk02,"",SQLCA.sqlcode,"","Update rvvslk",1)  
      LET g_success = 'N'
      RETURN
   END IF
...
FUNCTION t720_rvvslk_slk_move()

   LET g_rvv_slk.rvv03=g_rvu.rvu00
   IF NOT cl_null(g_rvu.rvu02) THEN
      LET g_rvv_slk.rvv04=g_rvu.rvu02
      LET g_rvv_slk.rvv05=g_rvvslk[l_ac5].rvvslk05
   END IF
   LET g_rvv_slk.rvv06=g_rvu.rvu04
   LET g_rvv_slk.rvv09=g_rvu.rvu03
   LET g_rvv_slk.rvv24='N'
   LET g_rvv_slk.rvv25='N'       #樣品
   LET g_rvv_slk.rvv89='N'
   LET g_rvv_slk.rvv31=g_rvvslk[l_ac5].rvvslk31
   LET g_rvv_slk.rvv031=g_rvvslk[l_ac5].rvvslk031
   LET g_rvv_slk.rvv32=g_rvvslk[l_ac5].rvvslk32
   LET g_rvv_slk.rvv33=g_rvvslk[l_ac5].rvvslk33
   LET g_rvv_slk.rvv34=g_rvvslk[l_ac5].rvvslk34
   LET g_rvv_slk.rvv35=g_rvvslk[l_ac5].rvvslk35
   LET g_rvv_slk.rvv35_fac=1
   LET g_rvv_slk.rvv36=g_rvvslk[l_ac5].rvvslk36
   LET g_rvv_slk.rvv37=g_rvvslk[l_ac5].rvvslk37
   LET g_rvv_slk.rvv38=g_rvvslk[l_ac5].rvvslk38
   LET g_rvv_slk.rvv38t=g_rvvslk[l_ac5].rvvslk38t
   LET g_rvv_slk.rvv86=g_rvvslk[l_ac5].rvvslk35
   LET g_rvv_slk.rvv930=g_rvvslk[l_ac5].rvvslk930
   LET g_rvv_slk.rvv10=g_rvvslk[l_ac5].rvvslk10
   LET g_rvv_slk.rvv11=g_rvvslk[l_ac5].rvvslk11
   LET g_rvv_slk.rvvplant=g_plant
   LET g_rvv_slk.rvvlegal=g_legal

END FUNCTION

FUNCTION t720_g_bslk()   #自動產生款號單身
  DEFINE l_rvvslk  RECORD  LIKE rvvslk_file.*
  DEFINE l_rvv02           LIKE rvv_file.rvv02
  DEFINE l_rvv04           LIKE rvv_file.rvv04


   DECLARE t720_g_rvvslk CURSOR FOR SELECT rvbslk01,rvbslk02,rvbslk05,rvbslk36,rvbslk37,rvbslk38,
                                           rvbslk90,1,rvbslk04,rvbslk03,rvbslk930,rvbslk42,
                                           rvbslk43,rvbslk10,rvbslk10t
                                      FROM rvbslk_file
                                     WHERE rvbslk01=g_rvu.rvu02

   FOREACH t720_g_rvvslk INTO l_rvvslk.rvvslk04,l_rvvslk.rvvslk05,l_rvvslk.rvvslk31,
      ...
      LET l_rvvslk.rvvslk01=g_rvu.rvu01
      SELECT MAX(rvvslk02)+1 INTO l_rvvslk.rvvslk02 FROM rvvslk_file WHERE rvvslk01=g_rvu.rvu01
      ...
      LET l_rvvslk.rvvslk03=g_rvu.rvu00
...
#         AND rvv05 IN (SELECT rvb02 FROM rvb_file,rvbi_file
#                        WHERE rvb01=rvbi01
#                          AND rvb02=rvbi02
...
#                          AND rvbislk02=l_rvvslk.rvvslk05)
      ...
      IF cl_null(l_rvvslk.rvvslk17) THEN
         CONTINUE FOREACH
      END IF
      CALL t720_getazi_slk(l_rvvslk.rvvslk36)

      CALL cl_digcut(l_rvvslk.rvvslk39,t_azi04) RETURNING l_rvvslk.rvvslk39
      CALL cl_digcut(l_rvvslk.rvvslk39t,t_azi04) RETURNING l_rvvslk.rvvslk39t
      LET l_rvvslk.rvvslkplant=g_rvu.rvuplant
      LET l_rvvslk.rvvslklegal=g_rvu.rvulegal
      INSERT INTO rvvslk_file VALUES(l_rvvslk.*)
      IF STATUS THEN
         CALL cl_err3("ins","rvvslk_file","","",SQLCA.sqlcode,"","ins rvvslk",1)
         EXIT FOREACH
      ELSE
#         UPDATE rvvi_file SET rvvislk01=l_rvvslk.rvvslk31,
#                              rvvislk02=l_rvvslk.rvvslk02
#           WHERE rvvi01=g_rvu.rvu01
#             AND rvvi02 IN (SELECT rvv02 FROM rvv_file,imx_file
#                             WHERE rvv01=g_rvu.rvu01
#                               AND rvv31=imx000
#                               AND rvv04=l_rvvslk.rvvslk04
#                               AND imx00=l_rvvslk.rvvslk31
#                               AND rvv05 IN 
#                                  (SELECT rvb02 FROM rvb_file,rvbi_file
#                                               WHERE rvb01=rvbi01
#                                                 AND rvb02=rvbi02
#                                                 AND rvb01=l_rvvslk.rvvslk04
#                                                 AND rvbislk02=l_rvvslk.rvvslk05))
...
#根據rvv_file的資料，產生rvvslk_file的資料
#服飾行業，一筆rva中款號不能重複，若款號重複，請修改下列代碼
#   DECLARE t720_g_rvvslk CURSOR FOR SELECT MIN(rvv02),SUM(rvv17),SUM(rvv39),SUM(rvv39t)
#                                      FROM rvv_file,rvvi_file,imx_file
#                                     WHERE rvv01=rvvi01
#                                       AND rvv02=rvvi02
#                                       AND rvv31=imx000
#                                       AND rvv01 = g_rvu.rvu01
#                                      GROUP BY rvv04,imx00
#   FOREACH t720_g_rvvslk INTO l_rvv02,l_rvvslk.rvvslk17,l_rvvslk.rvvslk39,l_rvvslk.rvvslk39t
#      LET l_rvvslk.rvvslk01=g_rvu.rvu01
#      SELECT MAX(rvvslk02)+1 INTO l_rvvslk.rvvslk02 FROM rvvslk_file WHERE rvvslk01=g_rvu.rvu01
#      IF cl_null(l_rvvslk.rvvslk02) THEN
#         LET l_rvvslk.rvvslk02=1
#      END IF
#      SELECT imx00 INTO l_rvvslk.rvvslk31 FROM imx_file,rvv_file
#        WHERE imx000=rvv31 AND rvv01=g_rvu.rvu01 AND rvv02=l_rvv02
#      SELECT ima02 INTO l_rvvslk.rvvslk031 FROM ima_file WHERE ima01=l_rvvslk.rvvslk31
#
#      SELECT rvv03,rvv04,rvv32,rvv33,rvv34,rvv35,rvv35_fac,rvv38,rvv38t,
#             rvv930,rvv10,rvv11,rvvplant,rvvlegal
#        INTO l_rvvslk.rvvslk03,l_rvvslk.rvvslk04,l_rvvslk.rvvslk32,l_rvvslk.rvvslk33,l_rvvslk.rvvslk34,
#             l_rvvslk.rvvslk35,l_rvvslk.rvvslk35_fac,l_rvvslk.rvvslk38,l_rvvslk.rvvslk38t,l_rvvslk.rvvslk930,
#             l_rvvslk.rvvslk10,l_rvvslk.rvvslk11,l_rvvslk.rvvslkplant,l_rvvslk.rvvslklegal
#        FROM rvv_file
#       WHERE rvv01=g_rvu.rvu01 AND rvv02=l_rvv02
#      SELECT rvbslk02,rvbslk04,rvbslk03 INTO l_rvvslk.rvvslk05,l_rvvslk.rvvslk36,l_rvvslk.rvvslk37 FROM rvbslk_file
#        WHERE rvbslk01=l_rvvslk.rvvslk04 AND rvbslk05=l_rvvslk.rvvslk31
#
#      INSERT INTO rvvslk_file VALUES(l_rvvslk.*)
#      IF STATUS THEN
#         CALL cl_err3("ins","rvvslk_file","","",SQLCA.sqlcode,"","ins rvvslk",1)
#         EXIT FOREACH
#      ELSE
#         SELECT rvv04 INTO l_rvv04 FROM rvv_file WHERE rvv01=g_rvu.rvu01 AND rvv02=l_rvv02
#         UPDATE rvvi_file SET rvvislk01=l_rvvslk.rvvslk31,
#                              rvvislk02=l_rvvslk.rvvslk02
#           WHERE rvvi01=g_rvu.rvu01
#             AND rvvi02 IN (SELECT rvv02 FROM rvv_file,imx_file
...
#                               AND imx00=l_rvvslk.rvvslk31)
#         IF STATUS THEN
#            CALL cl_err3("upd","rvv_file","","",SQLCA.sqlcode,"","",1)
#            EXIT FOREACH
#         END IF
#      END IF
#
...
FUNCTION t720_check_color()
  DEFINE i          LIKE type_file.num5
  DEFINE l_flag     LIKE type_file.chr1

    FOR i=1 TO g_imx.getLength()
      IF g_imx[i].color=g_imx[l_ac6].color AND i<>l_ac6 THEN
         LET l_flag='N'
         EXIT FOR
      END IF
    END FOR
...
#MOD-C30217---add---begin-------------------
FUNCTION t720_chk_color_detail(p_ac,p_item)
...
DEFINE l_qty   LIKE type_file.num5
  ...
  IF cl_null(g_rvu.rvu02) AND cl_null(g_rvvslk[l_ac5].rvvslk05) THEN
     RETURN TRUE
  END IF
  IF (g_imx[l_ac6].imx01 IS NULL OR g_imx[l_ac6].imx01 = 0) AND (g_imx[l_ac6].imx02 IS NULL OR g_imx[l_ac6].imx02 = 0) AND
     (g_imx[l_ac6].imx03 IS NULL OR g_imx[l_ac6].imx03 = 0) AND (g_imx[l_ac6].imx04 IS NULL OR g_imx[l_ac6].imx04 = 0) AND
     (g_imx[l_ac6].imx05 IS NULL OR g_imx[l_ac6].imx05 = 0) AND (g_imx[l_ac6].imx06 IS NULL OR g_imx[l_ac6].imx06 = 0) AND
     (g_imx[l_ac6].imx07 IS NULL OR g_imx[l_ac6].imx07 = 0) AND (g_imx[l_ac6].imx08 IS NULL OR g_imx[l_ac6].imx08 = 0) AND
     (g_imx[l_ac6].imx09 IS NULL OR g_imx[l_ac6].imx09 = 0) AND (g_imx[l_ac6].imx10 IS NULL OR g_imx[l_ac6].imx10 = 0) AND
     (g_imx[l_ac6].imx11 IS NULL OR g_imx[l_ac6].imx11 = 0) AND (g_imx[l_ac6].imx12 IS NULL OR g_imx[l_ac6].imx12 = 0) AND
     (g_imx[l_ac6].imx13 IS NULL OR g_imx[l_ac6].imx13 = 0) AND (g_imx[l_ac6].imx14 IS NULL OR g_imx[l_ac6].imx14 = 0) AND
     (g_imx[l_ac6].imx15 IS NULL OR g_imx[l_ac6].imx15 = 0)  THEN
      RETURN TRUE
  END IF

  LET l_n=0
  SELECT COUNT(*) INTO l_n FROM rvb_file,rvbi_file,imx_file
   WHERE rvb01=g_rvu.rvu02
     AND rvb01=rvbi01
     AND rvb02=rvbi02
     AND rvbislk02=g_rvvslk[l_ac5].rvvslk05
     AND imx000=rvb05
     AND imx00=p_item
     AND imx01=g_imx[p_ac].color

  IF l_n=0 OR cl_null(l_n) THEN
     CALL cl_err('','mfg-994',0)
     RETURN FALSE
  END IF

  FOR i=1 TO 15
      IF i=1 THEN LET l_qty=g_imx[l_ac6].imx01 END IF
      IF i=2 THEN LET l_qty=g_imx[l_ac6].imx02 END IF
      IF i=3 THEN LET l_qty=g_imx[l_ac6].imx03 END IF
      IF i=4 THEN LET l_qty=g_imx[l_ac6].imx04 END IF
      IF i=5 THEN LET l_qty=g_imx[l_ac6].imx05 END IF
      IF i=6 THEN LET l_qty=g_imx[l_ac6].imx06 END IF
      IF i=7 THEN LET l_qty=g_imx[l_ac6].imx07 END IF
      IF i=8 THEN LET l_qty=g_imx[l_ac6].imx08 END IF
      IF i=9 THEN LET l_qty=g_imx[l_ac6].imx09 END IF
      IF i=10 THEN LET l_qty=g_imx[l_ac6].imx10 END IF
      IF i=11 THEN LET l_qty=g_imx[l_ac6].imx11 END IF
      IF i=12 THEN LET l_qty=g_imx[l_ac6].imx12 END IF
      IF i=13 THEN LET l_qty=g_imx[l_ac6].imx13 END IF
      IF i=14 THEN LET l_qty=g_imx[l_ac6].imx14 END IF
      IF i=15 THEN LET l_qty=g_imx[l_ac6].imx15 END IF
      IF l_qty >0 THEN
         IF NOT t720_check_imx(i,l_qty,g_imx_t.imx01) THEN
            RETURN FALSE
         END IF
      END IF
  END FOR
...
FUNCTION t720_check_imx(p_index,p_qty,p_qty_t)
  DEFINE p_index           LIKE type_file.num5,
         ...
         l_rvb33           LIKE rvb_file.rvb33,
         l_rvb39           LIKE rvb_file.rvb39,
         l_rvv17_1_other   LIKE rvv_file.rvv17,
         l_rvv17_return    LIKE rvv_file.rvv17,
         l_rvb33_tol       LIKE rvb_file.rvb33,
         l_rvv17_3         LIKE rvv_file.rvv17,
         l_rvv17_3_other   LIKE rvv_file.rvv17
  DEFINE l_ps              LIKE sma_file.sma46
  DEFINE l_n               LIKE type_file.num5    #MOD-C30217--add


   IF cl_null(g_rvvslk[l_ac5].rvvslk31)  THEN
      RETURN FALSE
   END IF
...
#TQC-C30194---add------------------
    ...
    END IF
#TQC-C30194---end------------------
   IF cl_null(p_qty_t) THEN
      LET p_qty_t=0
   END IF

   SELECT sma46 INTO l_ps FROM sma_file
   IF cl_null(l_ps) THEN LET l_ps = ' ' END IF
   LET l_ima01 = g_rvvslk[l_ac5].rvvslk31,l_ps,              #子料件編號
                 g_imx[l_ac6].color,l_ps,
                 g_imxtext[l_ac6].detail[p_index].size
#MOD-C30217-----add----------------
   IF NOT cl_null(g_rvu.rvu02) AND NOT cl_null(g_rvvslk[l_ac5].rvvslk05) THEN
      LET l_n=0
      SELECT COUNT(*) INTO l_n FROM rvb_file,rvbi_file,imx_file
       WHERE rvb01=g_rvu.rvu02
         ...
         AND imx000=rvb05
         AND imx000=l_ima01
         AND imx00=g_rvvslk[l_ac5].rvvslk31
         AND imx01=g_imx[l_ac6].color
   ...
   END IF
#MOD-C30217------end---------------
#   SELECT imx000 INTO l_ima01 FROM imx_file
#     WHERE imx00=g_rvvslk[l_ac5].rvvslk31
#       AND imx01=g_imx[l_ac6].color
#       AND imx02=g_imxtext[l_ac6].detail[p_index].size

   SELECT rvv02,rvv05 INTO l_rvv02,l_rvv05 FROM rvv_file,rvvi_file
    WHERE rvv01=rvvi01
      AND rvv02=rvvi02
      AND rvvislk02=g_rvvslk[l_ac5].rvvslk02
      AND rvv31=l_ima01
   ...
   IF g_rvu.rvu00='1' THEN
      SELECT rvb33,rvb39 INTO l_rvb33,l_rvb39 FROM rvb_file
       WHERE rvb01=g_rvu.rvu02 AND rvb02=l_rvv05
      IF l_rvb39 = 'Y' THEN
         IF cl_null(l_rvb33) THEN LET l_rvb33 = 0 END IF
         IF (p_qty > l_rvb33) THEN
            IF g_qcz.qcz05 = 'N' THEN                  
               CALL cl_err(l_ima01,'apm-282',1)
               RETURN FALSE
            END IF
         END IF
      END IF
      ...
      IF p_qty > g_inqty THEN  #異動數量不可大於可入庫量
          CALL cl_err(g_inqty,'mfg3252',1)
          RETURN FALSE
      END IF

      #本張單據,其他屬於此收貨項次的入庫數量
        SELECT SUM(rvv17) INTO l_rvv17_1_other FROM rvv_file,rvu_file
         WHERE rvv04=g_rvu.rvu02 AND rvv05=l_rvv05
           AND rvv03='1'
           AND rvv01 =g_rvu.rvu01
           AND rvv01=rvu01
           AND rvv02 !=l_rvv02
       ...
       END IF
       LET l_rvv17_1_other = l_rvv17_1_other+ p_qty
       #總允收數量
       SELECT SUM(rvb33) INTO l_rvb33_tol FROM rvb_file
         ...
         IF g_qcz.qcz05='Y' THEN
           ...
           IF g_rvv[l_ac].rvv32=g_qcz.qcz051 AND
              ...
              LET l_rvv17_return=l_rvv17_return +p_qty
           END IF
         END IF
       IF cl_null(l_rvv17_return) THEN LET l_rvv17_return = 0 END IF 
        IF l_rvv17_1_other > (l_rvb33_tol+l_rvv17_return) THEN 
          CALL cl_err(l_ima01,'apm-306',1)
          RETURN FALSE
       END IF
   END IF
   ...
   IF g_rvu.rvu00='3' THEN
      IF NOT cl_null(g_rvu.rvu02) THEN
         ...
         #異動數量不可大於入庫量-倉退量
         IF p_qty > (g_inqty-l_rvv17_3-l_rvv17_3_other ) THEN
            CALL cl_err(l_ima01,'apm-254',1)
            RETURN FALSE
         END IF
      END IF
   END IF
...
#TQC-C20512--add--begin--
FUNCTION t720_rvvslk17(p_cmd5)
DEFINE
    p_cmd5          LIKE type_file.chr1,                #處理狀態
    l_qcs091        LIKE qcs_file.qcs091,
    l_qcs22         LIKE qcs_file.qcs22,
...
DEFINE 
    l_rvvslk17_in      LIKE rvvslk_file.rvvslk17,
    l_rvvslk17_3       LIKE rvvslk_file.rvvslk17,
    l_rvvslk17_2       LIKE rvvslk_file.rvvslk17,   
    l_rvvslk17_3_other LIKE rvvslk_file.rvvslk17,   
    l_rvvslk17_1_other LIKE rvvslk_file.rvvslk17,   
    l_rvvslk17_2_other LIKE rvvslk_file.rvvslk17,   
    l_rvvslk17_return  LIKE rvvslk_file.rvvslk17,
    l_rvbslk07         LIKE rvbslk_file.rvbslk07,
    l_rvbslk30         LIKE rvbslk_file.rvbslk30,
    l_rvb39            LIKE rvb_file.rvb39   
      
  
     IF g_rvvslk[l_ac5].rvvslk17 < 0 THEN
        CALL cl_err('','afa-043',0)
        RETURN FALSE
     END IF
     #倉退單身可輸入數量為0
     IF (g_rvu.rvu00 != '3') AND (g_rvvslk[l_ac5].rvvslk17 = 0) THEN  
        CALL cl_err('','afa-978',1)
        LET g_rvvslk[l_ac5].rvvslk17 = g_rvvslk_t.rvvslk17
        RETURN FALSE
     END IF
 
     IF g_rvvslk_t.rvvslk17 IS NULL AND g_rvvslk[l_ac5].rvvslk17 IS NOT NULL OR
        g_rvvslk_t.rvvslk17 IS NOT NULL AND g_rvvslk[l_ac5].rvvslk17 IS NULL OR
        g_rvvslk_t.rvvslk17 <> g_rvvslk[l_ac5].rvvslk17 THEN
        LET l_rvbslk07 = 0
        SELECT rvbslk07 INTO l_rvbslk07 FROM rvbslk_file
         WHERE rvbslk01=g_rvu.rvu02 
           AND rvbslk02=g_rvvslk[l_ac5].rvvslk05
        IF l_rvbslk07 <> g_rvvslk[l_ac5].rvvslk17  AND p_cmd5 <> 'a' THEN
           LET g_change='Y'
        END IF  
     END IF
     IF g_rvu.rvu00='1' THEN 
        SELECT rvbslk07 INTO g_inqty FROM rvbslk_file,rva_file 
         WHERE rvbslk01=g_rvu.rvu02 AND rvbslk02=g_rvvslk[l_ac5].rvvslk05
           AND rvbslk01 = rva01
           AND rvaconf !='X' #作廢資料要剔除 
        IF cl_null(g_inqty) THEN LET g_inqty=0 END IF           
        IF g_rvvslk[l_ac5].rvvslk17 > g_inqty THEN  #異動數量不可大於可入庫量
            CALL cl_err(g_inqty,'mfg3252',1) 
            RETURN FALSE 
        END IF
     END IF
    ...
    #IF g_rvu.rvu00='1' THEN
    #  #本張單據,其他屬於此收貨項次的入庫數量
    #   SELECT SUM(rvvslk17) INTO l_rvvslk17_1_other FROM rvvslk_file,rvu_file
    #    WHERE rvvslk04=g_rvu.rvu02 AND rvvslk05=g_rvvslk[l_ac5].rvvslk05
    #      AND rvvslk03='1'
    #      AND rvvslk01 =g_rvu.rvu01
    #      AND rvvslk01=rvu01
    #      AND rvvslk02 !=g_rvvslk[l_ac5].rvvslk02
    #      AND rvuconf !='X'
    #   IF cl_null(l_rvvslk17_1_other) THEN
    #      LET l_rvvslk17_1_other=0
    #   END IF
    #   LET l_rvvslk17_1_other = l_rvvslk17_1_other+ g_rvvslk[l_ac5].rvvslk17
    #   #總允收數量
    #   SELECT SUM(rvb33) INTO l_rvb33_tol FROM rvb_file,rvbi_file,rvbslk_file
    #      WHERE rvb01=g_rvu.rvu02 AND rvb01=rvbslk01 AND rvb01=rvbi01 AND rvbi01=rvbslk01
    #        AND rvb02 = rvbi02 AND rvbslk02=rvbislk02 AND rvbslk02=g_rvvslk[l_ac2].rvvslk05
    #        AND rvb39 = 'Y'
    #   IF g_qcz.qcz05='Y' THEN
    #      SELECT SUM(rvvslk17) INTO l_rvvslk17_return FROM rvvslk_file,rvu_file
    #       WHERE rvvslk04=g_rvu.rvu02 AND rvvslk05=g_rvvslk[l_ac5].rvvslk05
    #         AND rvvslk03='1'
    #         AND rvvslk01 =g_rvu.rvu01
    #         AND rvvslk01=rvu01
    #         AND rvvslk02 !=g_rvvslk[l_ac5].rvvslk02
    #         AND rvuconf !='X'
    #         AND rvvslk32 = g_qcz.qcz051
    #         AND rvvslk33 = g_qcz.qcz052
    #      IF cl_null(l_rvvslk17_return) THEN
    #         LET l_rvvslk17_return=0
    #      END IF
    #      #加上當筆屬於不合格品入庫部份
    #      IF g_rvvslk[l_ac5].rvvslk32=g_qcz.qcz051 AND
    #         g_rvvslk[l_ac5].rvvslk33=g_qcz.qcz052  THEN
    #         LET l_rvvslk17_return=l_rvvslk17_return + g_rvvslk[l_ac5].rvvslk17
    #      END IF
    #   END IF
    #   IF cl_null(l_rvvslk17_return) THEN LET l_rvvslk17_return = 0 END IF 
    #   IF l_rvvslk17_1_other > (l_rvb33_tol+l_rvvslk17_return) THEN 
    #      CALL cl_err(g_rvvslk[l_ac5].rvvslk31,'apm-306',0)
    #      RETURN FALSE
    #   END IF
    #END IF
     #退貨不可大於庫存量
     IF g_rvu.rvu00='3' THEN
        IF NOT cl_null(g_rvvslk[l_ac5].rvvslk05) THEN
           SELECT SUM(rvvslk17) INTO l_rvvslk17_3 FROM rvvslk_file,rvu_file
            WHERE rvvslk04=g_rvu.rvu02 AND rvvslk05=g_rvvslk[l_ac5].rvvslk05
              AND rvvslk03='3' AND rvvslk01 !=g_rvu.rvu01 AND rvvslk01=rvu01
              AND rvuconf !='X'
           IF cl_null(l_rvvslk17_3) THEN LET l_rvvslk17_3=0 END IF
           #本張單據,其他屬於此收貨項次的數量
           SELECT SUM(rvvslk17) INTO l_rvvslk17_3_other FROM rvvslk_file,rvu_file
            WHERE rvvslk04=g_rvu.rvu02 AND rvvslk05=g_rvvslk[l_ac5].rvvslk05
              AND rvvslk03='3'
              AND rvvslk01 =g_rvu.rvu01
              AND rvvslk01=rvu01
              AND rvvslk02 !=g_rvvslk[l_ac5].rvvslk02
              AND rvuconf !='X'
           IF cl_null(l_rvvslk17_3_other) THEN
              LET l_rvvslk17_3_other=0
           END IF
           SELECT rvbslk30 INTO g_inqty FROM rvbslk_file,rva_file
            WHERE rvbslk01=g_rvu.rvu02 AND rvbslk02=g_rvvslk[l_ac5].rvvslk05
              AND rvbslk01=rva01
              AND rvaconf !='X' #作廢資料要剔除 
           IF cl_null(g_inqty) THEN LET g_inqty=0 END IF
           #異動數量不可大於入庫量-倉退量
           IF g_rvvslk[l_ac5].rvvslk17 > (g_inqty-l_rvvslk17_3-l_rvvslk17_3_other ) THEN
              CALL cl_err(g_rvvslk[l_ac5].rvvslk31,'apm-254',1)
              RETURN FALSE
           END IF
        END IF
     END IF
     ...
     IF g_rvu.rvu00='2' THEN
        IF NOT cl_null(g_rvvslk[l_ac5].rvvslk05) THEN
           SELECT SUM(rvvslk17) INTO l_rvvslk17_2 FROM rvvslk_file,rvu_file
            WHERE rvvslk04=g_rvu.rvu02 AND rvvslk05=g_rvvslk[l_ac5].rvvslk05
              AND rvvslk03='2'
              AND rvvslk01 !=g_rvu.rvu01
              AND rvvslk01=rvu01
              AND rvuconf !='X'
          IF cl_null(l_rvvslk17_2) THEN LET l_rvvslk17_2=0 END IF
          #本張單據,其他屬於此收貨項次的數量
          SELECT SUM(rvvslk17) INTO l_rvvslk17_2_other FROM rvvslk_file,rvu_file
           WHERE rvvslk04=g_rvu.rvu02 AND rvvslk05=g_rvvslk[l_ac5].rvvslk05
             AND rvvslk03='2'
             AND rvvslk01 =g_rvu.rvu01
             AND rvvslk01=rvu01
             AND rvvslk02 !=g_rvvslk[l_ac5].rvvslk02
             AND rvuconf !='X'
           IF cl_null(l_rvvslk17_2_other) THEN
              LET l_rvvslk17_2_other=0
           END IF
          #修改可驗退數量控管
          #1.若走IQC   可驗退量=SUM(IQC送驗量) - SUM(IQC合格量) - 已驗退量
          #2.若不走IQC 可驗退量=實收數量 - 已入庫量 - 已驗退量
 
           SELECT rvbslk07,rvbslk30,rvb39 INTO g_inqty,
              l_rvbslk30,l_rvb39  FROM rvbslk_file,rva_file,rvbi_file
           WHERE rvbslk01=g_rvu.rvu02 AND rvbslk02=g_rvvslk[l_ac5].rvvslk05
             AND rvbslk01=rva01 AND rvbslk01=rvbi01 AND rvbslk02=rvbislk02
             AND rvaconf !='X' #作廢資料要剔除
 
           SELECT SUM(rvvslk17) INTO l_rvvslk17_in FROM rvu_file,rvvslk_file
              WHERE rvvslk04 = g_rvu.rvu02
                AND rvvslk05 = g_rvvslk[l_ac5].rvvslk05
                AND rvvslk01 = rvu01
                AND rvu00 = '1'
                AND rvuconf != 'X'
           IF cl_null(l_rvvslk17_in) THEN LET l_rvvslk17_in = 0 END IF

           IF cl_null(g_inqty) THEN LET g_inqty=0 END IF
           IF cl_null(l_rvbslk30) THEN LET l_rvbslk30=0 END IF
 
           IF g_sma.sma886[8,8] = 'N'  OR l_rvb39='N' THEN   
             #若勾選允收數與IQC勾稽 , 驗退量以qcs_file為主
             #若不勾選允收數與IQC勾稽 , 驗退量以rvbslk_file為主
 
              #不走IQC
               IF g_rvvslk[l_ac5].rvvslk17 > (g_inqty-l_rvvslk17_2-l_rvvslk17_2_other-l_rvvslk17_in) THEN   #MOD-B90019
                   CALL cl_err(g_rvvslk[l_ac5].rvvslk31,'apm-730',1)
                 RETURN FALSE
               END IF
            ELSE
              #走IQC
               SELECT SUM(qcs091),SUM(qcs22) INTO l_qcs091,l_qcs22
                  ...
                  AND qcs02 = g_rvvslk[l_ac5].rvvslk05
                  AND qcs14 = 'Y'               #確認否
 
               IF cl_null(l_qcs091) THEN LET l_qcs091 = 0 END IF
               IF cl_null(l_qcs22)  THEN LET l_qcs22 = 0 END IF
 
               IF g_rvvslk[l_ac5].rvvslk17 > (l_qcs22-l_rvvslk17_2-l_rvvslk17_2_other-l_qcs091) THEN
                   CALL cl_err(g_rvvslk[l_ac5].rvvslk31,'apm-730',1)
                 RETURN FALSE
               END IF
           END IF
        END IF
     END IF
     IF g_rvvslk[l_ac5].rvvslk17>0 OR g_rvu.rvu00 ='1' THEN 
        LET g_rvvslk[l_ac5].rvvslk39=g_rvvslk[l_ac5].rvvslk17*g_rvvslk[l_ac5].rvvslk38   
        LET g_rvvslk[l_ac5].rvvslk39t=g_rvvslk[l_ac5].rvvslk17*g_rvvslk[l_ac5].rvvslk38t  
       #MOD-C40047 str mark----
       #LET t_azi04=''
       ...
       #      FROM pmm_file,azi_file
       #     WHERE pmm22=azi01
       #       AND pmm01 = g_rvvslk[l_ac5].rvvslk36 AND pmm18 <> 'X'
       #END IF
       #IF g_rva00 = '2' THEN
       #   SELECT rva113 INTO l_rva113 FROM rva_file 
       #       WHERE rva01 = g_rvu.rvu02
       ...
       #MOD-C40047 end mark----
        ...
        CALL t720sub_rvv39(g_rvvslk[l_ac5].rvvslk36,g_rvvslk[l_ac5].rvvslk39,g_rvvslk[l_ac5].rvvslk39t,g_rvu.rvu04,g_rvu.rvu01)  #MOD-BC0262 add
             RETURNING g_rvvslk[l_ac5].rvvslk39,g_rvvslk[l_ac5].rvvslk39t
        DISPLAY BY NAME g_rvvslk[l_ac5].rvvslk39
        DISPLAY BY NAME g_rvvslk[l_ac5].rvvslk39t
     ELSE
        IF g_rvu.rvu00 ='3' THEN
           LET g_rvvslk[l_ac5].rvvslk39=g_rvvslk[l_ac5].rvvslk38
           LET g_rvvslk[l_ac5].rvvslk39t=g_rvvslk[l_ac5].rvvslk38t  
          #MOD-C40047 str mark----
          #LET t_azi04=''
          #IF g_rva00 = '1' AND g_rvu.rvu00 = '3' THEN
          #   SELECT azi04 INTO t_azi04 FROM azi_file
     ...
     SELECT ima918,ima921,ima930 INTO g_ima918,g_ima921,g_ima930 #DEV-D30059 add ima930 
       FROM ima_file
      WHERE ima01 = g_rvvslk[l_ac5].rvvslk31
        AND imaacti = "Y"
     ...
     IF g_ima918 = "Y" OR g_ima921 = "Y" THEN
        SELECT img09 INTO g_img09 FROM img_file
        WHERE img01=g_rvvslk[l_ac5].rvvslk31 AND img02=g_rvvslk[l_ac5].rvvslk32
          AND img03=g_rvvslk[l_ac5].rvvslk33 AND img04=g_rvvslk[l_ac5].rvvslk34
        IF (NOT cl_null(g_rvu.rvu02)) OR (cl_null(g_rvu.rvu02)
            AND g_prog='apmt722_slk' AND p_cmd5='u') THEN  
           IF g_sma.sma90 = 'Y' THEN  
              SELECT COUNT(*) INTO l_n FROM rvbs_file
               WHERE rvbs00 = g_prog
                 AND rvbs01 = g_rvu.rvu01
                 AND rvbs02 = g_rvvslk[l_ac5].rvvslk02
              IF l_n = 0 THEN
                 CALL t720sub_ins_rvbs(g_prog,g_rvu.rvu01,g_rvvslk[l_ac5].rvvslk02,
                                    g_rvu.rvu02,g_rvvslk[l_ac5].rvvslk05,g_rvvslk[l_ac5].rvvslk31,
                                    g_rvvslk[l_ac5].rvvslk32,g_rvvslk[l_ac5].rvvslk33,g_rvvslk[l_ac5].rvvslk34,g_rvu.rvu02) #FUN-A10130
              END IF
              CALL s_wo_record(g_rvv[l_ac].rvv18,'Y')   #MOD-CC0047 add
              IF g_ima930 = 'N' THEN                                        #DEV-D30059
                 IF g_rvu.rvu00='1' THEN
                    CALL s_mod_lot(g_prog,g_rvu.rvu01,g_rvvslk[l_ac5].rvvslk02,0,
                                   g_rvvslk[l_ac5].rvvslk31,g_rvvslk[l_ac5].rvvslk32,g_rvvslk[l_ac5].rvvslk33,
                                   g_rvvslk[l_ac5].rvvslk34,g_rvvslk[l_ac5].rvvslk35,g_img09,
                                   1,g_rvvslk[l_ac5].rvvslk17,'','SEL',1)
                            RETURNING l_r,g_qty
                 ELSE
                    CALL s_mod_lot(g_prog,g_rvu.rvu01,g_rvvslk[l_ac5].rvvslk02,0,
                                   g_rvvslk[l_ac5].rvvslk31,g_rvvslk[l_ac5].rvvslk32,g_rvvslk[l_ac5].rvvslk33,
                                   g_rvvslk[l_ac5].rvvslk34,g_rvvslk[l_ac5].rvvslk35,g_img09,
                                   1,g_rvvslk[l_ac5].rvvslk17,'','SEL',-1) #CHI-9A0022 add ''
                            RETURNING l_r,g_qty
                 END IF
              END IF                                                        #DEV-D30059
              IF l_r = "Y" THEN
                 LET g_rvvslk[l_ac5].rvvslk17 = g_qty
              END IF
           ELSE
              LET l_bno = ''
              SELECT pmn122 INTO l_bno
                FROM pmn_file
               WHERE pmn01 = g_rvvslk[l_ac5].rvvslk36
                 AND pmn02 = g_rvvslk[l_ac5].rvvslk37
              CALL s_wo_record(g_rvv[l_ac].rvv18,'Y')   #MOD-CC0047 add
              IF g_ima930 = 'N' THEN                                        #DEV-D30059
                 IF g_rvu.rvu00='1' THEN
                    CALL s_mod_lot(g_prog,g_rvu.rvu01,g_rvvslk[l_ac5].rvvslk02,0,
                                   g_rvvslk[l_ac5].rvvslk31,g_rvvslk[l_ac5].rvvslk32,g_rvvslk[l_ac5].rvvslk33,
                                   g_rvvslk[l_ac5].rvvslk34,g_rvvslk[l_ac5].rvvslk35,g_img09,
                                   1,g_rvvslk[l_ac5].rvvslk17,l_bno,'MOD',1) #CHI-9A0022 add l_bno
                            RETURNING l_r,g_qty
                 ELSE
                    CALL s_mod_lot(g_prog,g_rvu.rvu01,g_rvvslk[l_ac5].rvvslk02,0,
                                   g_rvvslk[l_ac5].rvvslk31,g_rvvslk[l_ac5].rvvslk32,g_rvvslk[l_ac5].rvvslk33,
        ...
        END IF    
     END IF
     IF NOT cl_null(g_rvvslk[l_ac5].rvvslk17) THEN
        IF g_rvu.rvu00 = '3' AND g_rvu.rvu116 MATCHES '[12]' THEN
           IF g_rvvslk[l_ac5].rvvslk17 <= 0 THEN
              CALL cl_err(g_rvvslk[l_ac5].rvvslk17,'axm-948',0)
              RETURN FALSE
           END IF
        END IF
     END IF
...
FUNCTION t720_get_price()
   ...
   CALL s_defprice_new(g_rvv[l_ac].rvv31,g_rvu.rvu04,g_rvu.rvu113,g_rvu.rvu03,
                   ...
                   g_rvv[l_ac].rvv86,'',g_rvu.rvu112,g_rvu.rvu111,g_rvu.rvuplant)
...
FUNCTION t720_bp(p_ud)
   ...
   DEFINE   l_i        LIKE type_file.num5    #FUN-B90104---Add
   DEFINE   l_index    LIKE type_file.num5    #FUN-B90104---Add
...
#FUN-B90104---Add---End--
      DISPLAY ARRAY g_rvvslk TO s_rvvslk.*
         BEFORE DISPLAY
            CALL cl_navigator_setting( g_curs_index, g_row_count )
            CALL g_imx.clear()
            LET g_action_choice=""
         ...
         BEFORE ROW
            ...
            END FOR
            LET l_ac5 = DIALOG.getCurrentRow("s_rvvslk")
            IF l_ac5 != 0 THEN
               CALL s_settext_slk(g_rvvslk[l_ac5].rvvslk31)
               CALL s_fillimx_slk(g_rvvslk[l_ac5].rvvslk31,
                                   g_rvu.rvu01,g_rvvslk[l_ac5].rvvslk02)
      ...
      DISPLAY ARRAY g_imx TO s_imx.*
         ...
         BEFORE ROW
            LET l_ac6 = DIALOG.getCurrentRow("s_imx")
...
#FUN-B90104-----add---begin------------------
FUNCTION t720_rvvslk05(p_cmd)     # 驗收單項次
  DEFINE p_cmd           LIKE type_file.chr1
  DEFINE l_ima35         LIKE ima_file.ima35        #倉庫
  DEFINE l_ima36         LIKE ima_file.ima36        #儲位
  DEFINE l_rvb45         LIKE rvb_file.rvb45 
  DEFINE l_rtz07         LIKE rtz_file.rtz07 
  DEFINE l_rva113        LIKE rva_file.rva113   
  DEFINE l_rvbslk07      LIKE rvbslk_file.rvbslk07
  DEFINE l_rvbslk29      LIKE rvbslk_file.rvbslk29
  DEFINE l_rvbslk30      LIKE rvbslk_file.rvbslk30
  DEFINE l_rvbslk36      LIKE rvbslk_file.rvbslk36
  DEFINE l_rvbslk37      LIKE rvbslk_file.rvbslk37
  DEFINE l_rvbslk38      LIKE rvbslk_file.rvbslk38
 
  LET g_errno = " "
  SELECT rva00 INTO g_rva00 FROM rva_file WHERE rva01 = g_rvu.rvu02 
  IF g_rvvslk[l_ac5].rvvslk05 != g_rvvslk_t.rvvslk05 OR cl_null(g_rvvslk_t.rvvslk05) THEN
 
       CASE
        WHEN g_rvu.rvu00='1' OR g_rvu.rvu00='3' #入庫
          SELECT rvbslk03,rvbslk04,rvbslk05,
                 rvbslk30,rvbslk29,rvbslk07,
                 rvbslk36,rvbslk37,rvbslk38,
                 rvbslk10,rvbslk10t,
                 rvbslk930,rvbslk42,rvbslk43,rvbslk90
            INTO g_rvvslk[l_ac5].rvvslk37,g_rvvslk[l_ac5].rvvslk36,g_rvvslk[l_ac5].rvvslk31,
                 l_rvbslk30,l_rvbslk29,l_rvbslk07,
                 l_rvbslk36,l_rvbslk37,l_rvbslk38,                                           #FUN-C20006 add
                #g_rvvslk[l_ac5].rvvslk32,g_rvvslk[l_ac5].rvvslk33,g_rvvslk[l_ac5].rvvslk34, #FUN-C20006 mark
                 g_rvvslk[l_ac5].rvvslk38,g_rvvslk[l_ac5].rvvslk38t,
                 g_rvvslk[l_ac5].rvvslk930,g_rvvslk[l_ac5].rvvslk10,g_rvvslk[l_ac5].rvvslk11,
                 g_rvvslk[l_ac5].rvvslk35
            FROM rvbslk_file
           WHERE rvbslk01=g_rvu.rvu02 AND rvbslk02=g_rvvslk[l_ac5].rvvslk05 #驗收單號,項次
          IF SQLCA.sqlcode THEN LET g_errno='mfg3070' RETURN END IF
 
          IF cl_null(l_rvbslk29) THEN LET l_rvbslk29=0 END IF
          IF cl_null(l_rvbslk30) THEN LET l_rvbslk30=0 END IF
          LET g_inqty=l_rvbslk07-l_rvbslk30-l_rvbslk29
          IF g_inqty <= 0 AND g_rvu.rvu00='1' THEN
             LET g_errno='mfg3173' RETURN
          END IF
          IF l_rvbslk30 <= 0 AND g_rvu.rvu00='3' THEN
   ...
   END IF
   IF g_rvvslk[l_ac5].rvvslk31[1,4] != 'MISC' THEN   #料件編號
     SELECT ima02    #品名規格
       INTO g_rvvslk[l_ac5].rvvslk031
       FROM ima_file
      WHERE ima01 = g_rvvslk[l_ac5].rvvslk31
      IF p_cmd='a' OR g_rvvslk_t.rvvslk31!=g_rvvslk[l_ac5].rvvslk31 THEN
          IF NOT cl_null(l_rvbslk36) THEN 
              LET g_rvvslk[l_ac5].rvvslk32=l_rvbslk36
              LET g_rvvslk[l_ac5].rvvslk33=l_rvbslk37
              LET g_rvvslk[l_ac5].rvvslk34=l_rvbslk38
          ELSE
              LET l_ima35 = NULL
              LET l_ima36 = NULL
              SELECT ima35,ima36    #品名,倉庫,儲位
                INTO l_ima35,l_ima36
                FROM ima_file
               WHERE ima01 = g_rvvslk[l_ac5].rvvslk31
              IF SQLCA.sqlcode THEN LET g_rvvslk[l_ac5].rvvslk031 = ' ' END IF
              IF cl_null(l_ima35) THEN LET l_ima35=' ' END IF 
              IF cl_null(l_ima36) THEN LET l_ima36=' ' END IF
              LET g_rvvslk[l_ac5].rvvslk32=l_ima35
              LET g_rvvslk[l_ac5].rvvslk33=l_ima36
              LET g_rvvslk[l_ac5].rvvslk34=' '
              IF g_azw.azw04 = '2' THEN  
                 #FUN-C90049 mark begi---
                 #SELECT rtz07 INTO l_rtz07 FROM rtz_file 
                 # WHERE rtz01 = g_rvu.rvuplant  
                 #FUN-C90049 mark end-----
                 CALL s_get_coststore(g_rvu.rvuplant,g_rvvslk[l_ac5].rvvslk31) RETURNING l_rtz07     #FUN-C90049 add
                 IF g_rvu.rvu21 = '3' OR (g_rvu.rvu27 = '2' AND g_sma.sma146 = '2') THEN 
                    #FUN-C90049 mark begin----
                    #SELECT rtz08 INTO l_rtz07 FROM rtz_file
                    # WHERE rtz01 = g_rvu.rvuplant
                    #FUN-C90049 mark end-----
                    CALL s_get_noncoststore(g_rvu.rvuplant,g_rvvslk[l_ac5].rvvslk31) RETURNING l_rtz07     #FUN-C90049 add
                 END IF
                 LET g_rvvslk[l_ac5].rvvslk32 = l_rtz07
              END IF
          END IF
      END IF
   END IF
...
FUNCTION t720_b_insrvv(p_cmd)     #自動產生rvv資料
  DEFINE l_ima35         LIKE ima_file.ima35        #倉庫
  DEFINE l_ima36         LIKE ima_file.ima36        #儲位
  ...
  DEFINE l_rvvi  RECORD  LIKE rvvi_file.*
   ...
   DELETE FROM rvv_file
     WHERE rvv01 = g_rvu.rvu01 AND rvv02 IN (SELECT rvvislk02 FROM rvvi_file
                                              WHERE rvvi01=g_rvu.rvu01 AND rvvislk02=g_rvvslk[l_ac5].rvvslk02)
   IF SQLCA.sqlcode THEN
      CALL cl_err3("del","rvv_file",g_rvu.rvu01,'',SQLCA.sqlcode,"","",1)
      LET g_success='N'
      RETURN
   ...
   CASE
      ...
      # DECLARE t720_b_insrvv CURSOR FOR
      #      SELECT rvb02,rvb03,rvb04,rvb05,rvb919,rvb31,rvb34,rvb35,rvb89,rvb30,
      #             rvb10,rvb33,rvb36,rvb37,rvb38,rvb39,rvb40,rvb25,rvb86,rvb87,
      #             rvb10t,rvb930,rvb42,rvb43,rvb44,rvb45,rvb90,rvb90_fac
      #   FROM rvb_file,rvbi_file
      #  WHERE rvb01=g_rvu.rvu02    #驗收單號
      #    AND rvb01=rvbi01
      #    AND rvb02=rvbi02
      #    AND rvbi02=g_rvvslk[l_ac5].rvvslk05
      #TQC-C20117--mark--end---

      #TQC-C20117--add--begin--
        DECLARE t720_b_insrvv CURSOR FOR
             SELECT rvb01,rvb02,rvb03,rvb04,rvb05,rvb919,rvb31,rvb34,rvb35,rvb89,rvb30,  #TQC-C20512 add rvb01
                    rvb10,rvb33,rvb36,rvb37,rvb38,rvb39,rvb40,rvb25,rvb86,rvb87,
                    rvb10t,rvb930,rvb42,rvb43,rvb44,rvb45,rvb90,rvb90_fac
          FROM rvb_file,rvbi_file,rvbslk_file
         WHERE rvb01=g_rvu.rvu02    #驗收單號
           AND rvb01=rvbi01
           AND rvb02=rvbi02      
           AND rvbslk01=rvbi01
      ...
      #TQC-C20117--add--end--
        ...
        FOREACH t720_b_insrvv INTO l_rvv.rvv04,        #TQC-C20512 add l_rvv.rvv04
               l_rvv.rvv05,l_rvv.rvv37,l_rvv.rvv36,
               l_rvv.rvv31,l_rvv.rvv919,g_inqty,l_rvv.rvv18,
               l_rvv.rvv25,l_rvv.rvv89,l_rvb30,l_rvv.rvv38,l_rvb33,
               l_rvb36,l_rvb37,l_rvb38,l_rvb39,l_rvb40,l_rvv.rvv41,
               l_rvv.rvv86,l_rvv.rvv87,l_rvv.rvv38t,l_rvv.rvv930,
               l_rvv.rvv10,l_rvv.rvv11,l_rvv.rvv12,l_rvv.rvv13,
               l_rvv.rvv35,l_rvv.rvv35_fac
           ...
           IF g_rvu.rvu00='1' THEN
              IF g_sma.sma886[6]='Y' AND l_rvb39='Y' AND l_rvb40 IS NULL THEN
                 CALL cl_err('','apm-264',1)
                 CONTINUE FOREACH
              END IF
              IF l_rvb39 = 'Y' THEN      #-->檢驗  
                 LET l_rvv.rvv17 = l_rvb33
              ELSE
                 LET l_rvv.rvv17 = g_inqty
              END IF
           ELSE
              IF g_rvu.rvu00='3' THEN
                 IF NOT cl_null(g_rvu.rvu02) THEN
                    SELECT SUM(rvv17) INTO l_rvv17_3 FROM rvv_file,rvu_file
                     WHERE rvv04=g_rvu.rvu02 AND rvv05=l_rvv.rvv05
                       AND rvv03='3' AND rvv01 !=g_rvu.rvu01 AND rvv01=rvu01
                       AND rvuconf !='X'
                    IF cl_null(l_rvv17_3) THEN LET l_rvv17_3=0 END IF
                    SELECT rvb30 INTO g_inqty FROM rvb_file,rva_file
                     WHERE rvb01=g_rvu.rvu02 AND rvb02=l_rvv.rvv05
                       AND rvb01=rva01
                       AND rvaconf !='X' #作廢資料要剔除 
                    IF cl_null(g_inqty) THEN LET g_inqty=0 END IF
                    #異動數量=入庫量-倉退量
                    LET l_rvv.rvv17=g_inqty-l_rvv17_3
                 END IF
              END IF
          ...
          IF l_rvv.rvv31[1,4] != 'MISC' THEN   #料件編號
             IF NOT cl_null(l_rvb36) THEN
                 LET l_rvv.rvv32=l_rvb36
                 LET l_rvv.rvv33=l_rvb37
                 LET l_rvv.rvv34=l_rvb38
             ELSE
                 LET l_ima35 = NULL
                 LET l_ima36 = NULL
                 SELECT ima02,ima35,ima36    #品名,倉庫,儲位
                   INTO l_rvv.rvv031,l_ima35,l_ima36
                   FROM ima_file
                  WHERE ima01 = l_rvv.rvv31
                 IF SQLCA.sqlcode THEN LET l_rvv.rvv031 = ' ' END IF
                 IF cl_null(l_ima35) THEN LET l_ima35=' ' END IF 
                 IF cl_null(l_ima36) THEN LET l_ima36=' ' END IF 
                 ...
                 IF g_azw.azw04 = '2' THEN  
                    ...
                    # WHERE rtz01 = g_rvu.rvuplant 
                    #FUN-C90049 mark end------
                    CALL s_get_coststore(g_rvu.rvuplant,l_rvv.rvv31) RETURNING l_rtz07     #FUN-C90049 add 
                    IF g_rvu.rvu21 = '3' OR (g_rvu.rvu27 = '2' AND g_sma.sma146 = '2') THEN 
                       #FUN-C90049 mark begin---
                       #SELECT rtz08 INTO l_rtz07 FROM rtz_file
                       # WHERE rtz01 = g_rvu.rvuplant
                       #FUN-C90049 mark end------
                       CALL s_get_noncoststore(g_rvu.rvuplant,l_rvv.rvv31) RETURNING l_rtz07     #FUN-C90049 add  
                    END IF
          ...
          IF l_rvv.rvv87>=0 THEN  
             IF l_rvv.rvv87 > 0 THEN 
                CALL t720sub_rvv38(l_rvv.rvv36,l_rvv.rvv38,l_rvv.rvv38t,g_rvu.rvu04,g_rvu.rvu01)  #TQC-C30225 add
                    RETURNING l_rvv.rvv38,l_rvv.rvv38t
                LET l_rvv.rvv39=l_rvv.rvv87*l_rvv.rvv38 
                LET l_rvv.rvv39t=l_rvv.rvv87*l_rvv.rvv38t 
             ELSE
                CALL t720_pmm43(l_rvv.rvv36) RETURNING l_pmm43
             ...
             END IF
                  ...
                  #MOD-C40047 end mark----
                   ...
                   #CALL t720sub_rvv39(l_rvv.rvv36,l_rvv.rvv39,l_rvv.rvv39t,g_rvu.rvu04,g_rvu.rvu02) #MOD-BC0262 mark 
                   CALL t720sub_rvv39(l_rvv.rvv36,l_rvv.rvv39,l_rvv.rvv39t,g_rvu.rvu04,g_rvu.rvu01)  #MOD-BC0262 add
                        RETURNING l_rvv.rvv39,l_rvv.rvv39t
          END IF
          LET l_rvv.rvv38t=l_rvv.rvv38t    
...
#                 CALL t720sub_ins_rvbs(g_prog,g_rvu.rvu01,g_rvv[l_ac].rvv02,
#                                    g_rvu.rvu02,g_rvv[l_ac].rvv05,g_rvv[l_ac].rvv31,
#                                    g_rvv[l_ac].rvv31,g_rvv[l_ac].rvv33,g_rvv[l_ac].rvv34,g_rvu.rvu02) 
#              END IF
#           END IF


           IF l_rvv.rvv10 IS NULL THEN LET l_rvv.rvv10 = '4' END IF  
           IF l_rvv.rvv35_fac IS NULL THEN LET l_rvv.rvv35_fac =1  END IF  
           LET l_rvv.rvv01=g_rvu.rvu01
           LET l_rvv.rvv09=g_rvu.rvu03   #TQC-C20512 add
           SELECT MAX(rvv02)+1 INTO l_rvv.rvv02 FROM rvv_file WHERE rvv01=g_rvu.rvu01
           IF cl_null(l_rvv.rvv02) THEN
              LET l_rvv.rvv02=1
           END IF
           LET l_rvv.rvvplant=g_rvu.rvuplant
           LET l_rvv.rvvlegal=g_rvu.rvulegal
           INSERT INTO rvv_file VALUES(l_rvv.*)
           IF SQLCA.sqlcode THEN
              CALL cl_err3("ins","rvv_file",l_rvv.rvv01,l_rvv.rvv02,SQLCA.sqlcode,"","",1)
              LET g_success='N'
              EXIT FOREACH
           ELSE
              LET l_rvvi.rvvi01 = l_rvv.rvv01
    ...
    END CASE
#把rvv的資料，統計到rvvslk的變量中
    SELECT SUM(rvv17),SUM(rvv39),SUM(rvv39t)
      INTO g_rvvslk[l_ac5].rvvslk17,g_rvvslk[l_ac5].rvvslk39,g_rvvslk[l_ac5].rvvslk39t
      FROM rvv_file,rvvi_file
     WHERE rvv01=rvvi01
       AND rvv02=rvvi02
       AND rvv01=g_rvu.rvu01
  ...
  IF l_cnt > 0 THEN CALL cl_err('','apm-901',0) RETURN END IF
   ...
   IF g_rvu.rvu08='SUB' THEN
      ...
      FOREACH t720_s2_chk INTO l_rvv.*
         SELECT pmn41,pmn43,pmn18,pmn32          #No.MOD-5C0165
           INTO l_pmn41,l_pmn43,l_pmn18,l_pmn32  #No.MOD-5C0165
           FROM pmn_file
...
#------- UPDATE -------
   ...
   IF g_success = 'Y' THEN
      ...
      UPDATE rvu_file SET rvuconf='N',rvu99='',rvu20='N',
...
#FUN-B90104----add---begin----
          SELECT rvbislk02 INTO l_rvbslk02 FROM rvbi_file
           WHERE rvbi01=g_rvu.rvu02 AND rvbi02=b_rvv.rvv05
          ...
          IF SQLCA.sqlcode THEN
             CALL cl_err3("upd","rvbslk_file",g_rvu.rvu02,l_rvbslk02,SQLCA.sqlcode,"","退 upd rvbslk29,rvbslk30:",1)  
             LET g_success = 'N'
          END IF
#FUN-B90104----add---begin----
...
FUNCTION t720_out()
   DEFINE l_cmd        LIKE type_file.chr1000, #No.FUN-680136 VARCHAR(200)
      ...
      #IF g_rvu.rvu00='2' THEN LET l_program='apmr632' END IF #FUn-C30085 mark
      IF g_rvu.rvu00='2' THEN LET l_program='apmg632' END IF #FUn-C30085 add
      #IF g_rvu.rvu00='3' THEN LET l_program='apmr631' END IF #FUn-C30085 mark
      IF g_rvu.rvu00='3' THEN LET l_program='apmg631' END IF #FUn-C30085 add
...
#FUN-AB0066 --end--
    ...
    #當不使用多單位時，單位一的換算率也不default值
      ...
      IF cl_null(b_rvv.rvv32) THEN LET b_rvv.rvv32=' ' END IF
   ...
   #FUN-BB0001 add END
      ...
      IF SQLCA.sqlcode THEN
         ...
         CONTINUE FOREACH
      ELSE
         LET b_rvvi.rvvi01 = b_rvv.rvv01
         LET b_rvvi.rvvi02 = b_rvv.rvv02
        #IF NOT s_ins_rvvi(b_rvvi.*,'') THEN       #No.FUN-A50054
         IF NOT s_ins_rvvi(b_rvvi.*,g_plant) THEN  #No.FUN-A50054
            ROLLBACK WORK
            CONTINUE FOREACH
         END IF
      END IF
...
DEFINE   p_cmd     LIKE type_file.chr1    #No.FUN-680136 VARCHAR(1)
   IF (NOT g_before_input_done) THEN
      ...
      IF cl_null(g_rvu.rvu02) THEN
         CALL cl_set_comp_entry("rvu111,rvu112,rvu113,rvu115",TRUE)  #MOD-B30544
      END IF
   END IF
   ...
   IF INFIELD(rvu02) OR (NOT g_before_input_done) THEN
       IF NOT cl_null(g_rvu.rvu02) THEN
         #CALL cl_set_comp_entry("rvu04,rvu08",FALSE)
          CALL cl_set_comp_entry("rvu04,rvu08,rvu111,rvu112,rvu113,rvu115",FALSE)  #MOD-B30544
       END IF
       IF NOT cl_null(g_rvu.rvu04) THEN
...
FUNCTION t720_set_required(p_cmd)
  ...
  IF p_cmd = 'u' OR INFIELD(rvv31) THEN
     #IF g_rvv[l_ac].rvv31[1,4] != 'MISC' AND g_rvu.rvu00 !='2' THEN   #MOD-A40166
     IF g_rvv[l_ac].rvv31[1,4] != 'MISC' AND g_rvu.rvu00 ='1' THEN   #MOD-A40166
...
FUNCTION t720_exp_oga(p_oea01)
 ...
 #MOD-D30033---add---E
  ...
  LET l_oga.ogaslk02=l_oea.oeaslk02  #FUN-B90104 add
  ...
  ELSE
     ...
     IF g_success = 'Y' THEN
        CALL t720_exp_ogbslk(l_oga.oga01,p_oea01) #FUN-B90104 add
     END IF
  END IF
...
#FUN-B90104 add----begin-----------
#根據ogb_file的資料，產生ogbslk_file的資料
#服飾行業的訂單，一筆訂單中款號不能重複，若款號重複，請修改下列代碼
FUNCTION t720_exp_ogbslk(p_oga01,p_oea01)
  DEFINE p_oga01           LIKE oga_file.oga01
  DEFINE p_oea01           LIKE oea_file.oea01
  DEFINE l_ogbslk  RECORD  LIKE ogbslk_file.*
  DEFINE l_ogb03           LIKE ogb_file.ogb03

   DECLARE t600_g_ogbslk CURSOR FOR SELECT MIN(ogb03),SUM(ogb12),SUM(ogb14),SUM(ogb14t),SUM(ogb16),
                                           SUM(ogb18),SUM(ogb60),SUM(ogb63),SUM(ogb64),SUM(ogb1013)
                                      FROM ogb_file,ogbi_file,imx_file
                                     WHERE ogb01=ogbi01
                                       AND ogb03=ogbi03
                                       AND ogb04=imx000
                                       AND ogb01 =p_oga01
                                      GROUP BY ogb31,imx00

   FOREACH t600_g_ogbslk INTO l_ogb03,l_ogbslk.ogbslk12,l_ogbslk.ogbslk14,l_ogbslk.ogbslk14t,l_ogbslk.ogbslk16,
                              l_ogbslk.ogbslk18,l_ogbslk.ogbslk60,l_ogbslk.ogbslk63,l_ogbslk.ogbslk64,l_ogbslk.ogbslk1013

      LET l_ogbslk.ogbslk01=p_oga01
      SELECT MAX(ogbslk03)+1 INTO l_ogbslk.ogbslk03 FROM ogbslk_file WHERE ogbslk01=p_oga01
      IF cl_null(l_ogbslk.ogbslk03) THEN
         LET l_ogbslk.ogbslk03=1
      END IF
      SELECT imx00 INTO l_ogbslk.ogbslk04 FROM imx_file,ogb_file
        WHERE imx000=ogb04 AND ogb01=p_oga01 AND ogb03=l_ogb03
      SELECT ima02 INTO l_ogbslk.ogbslk06 FROM ima_file WHERE ima01=l_ogbslk.ogbslk04
      SELECT imc02 INTO l_ogbslk.ogbslk07 FROM imc_file WHERE imc01=l_ogbslk.ogbslk04
      SELECT obk03 INTO l_ogbslk.ogbslk11 FROM obk_file WHERE obk01=l_ogbslk.ogbslk04 AND obk02=g_oga.oga03

      SELECT ogb05,ogb05_fac,ogb09,ogb091,ogb092,
             ogb13,ogb15,ogb15_fac,ogb31,ogb1006,
             ogbplant,ogblegal
        INTO l_ogbslk.ogbslk05,l_ogbslk.ogbslk05_fac,l_ogbslk.ogbslk09,l_ogbslk.ogbslk091,l_ogbslk.ogbslk092,
             l_ogbslk.ogbslk13,l_ogbslk.ogbslk15,l_ogbslk.ogbslk15_fac,l_ogbslk.ogbslk31,l_ogbslk.ogbslk1006,
             l_ogbslk.ogbslkplant,l_ogbslk.ogbslklegal
        FROM ogb_file
       WHERE ogb01=p_oga01 AND ogb03=l_ogb03
      SELECT oebslk03,oebslk131 INTO l_ogbslk.ogbslk32,l_ogbslk.ogbslk131 FROM oebslk_file
        WHERE oebslk01=l_ogbslk.ogbslk31 AND oebslk04=l_ogbslk.ogbslk04

      INSERT INTO ogbslk_file VALUES(l_ogbslk.*)
      IF STATUS THEN
         CALL cl_err3("ins","ogbslk_file","","",SQLCA.sqlcode,"","ins ogbslk",1)
         LET g_success = 'N'
         EXIT FOREACH
      ELSE
         UPDATE ogbi_file SET ogbislk01=l_ogbslk.ogbslk04,
                              ogbislk02=l_ogbslk.ogbslk03
           WHERE ogbi01=p_oga01
             AND ogbi03 IN (SELECT ogb03 FROM ogb_file,imx_file
                             WHERE ogb01=p_oga01
                               AND ogb04=imx000
                               AND imx00=l_ogbslk.ogbslk04)
         IF STATUS THEN
            CALL cl_err3("upd","ogb_file","","",SQLCA.sqlcode,"","",1)
            LET g_success = 'N'
            EXIT FOREACH
         END IF
      END IF
...
FUNCTION t720_getazi_slk(p_rvv36)
DEFINE l_rva113          LIKE rva_file.rva113   
DEFINE p_rvv36           LIKE rvv_file.rvv36

   LET t_azi03=''
   LET t_azi04=''
   IF (g_rva00 = '1' AND g_rvu.rvu00 = '3') OR cl_null(g_rva00) THEN
   ...
   IF g_rva00 = '1' AND g_rvu.rvu00 <> '3' THEN
      SELECT azi03,azi04 INTO t_azi03,t_azi04
        FROM pmm_file,azi_file
       WHERE pmm22=azi01
         AND pmm01 = p_rvv36 AND pmm18 <> 'X'
   END IF
   IF g_rva00 = '2' THEN
      SELECT rva113 INTO l_rva113 FROM rva_file WHERE rva01 = g_rvu.rvu02
      SELECT azi03,azi04 INTO t_azi03,t_azi04 FROM azi_file
          WHERE azi01 = l_rva113
   END IF
