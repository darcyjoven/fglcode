...
# Modify.........: No.MOD-D30133 13/03/13 By Elise 增加zz05的判斷
...
#No.FUN-750093 --start--
   ...
   LET l_table = cl_prt_temptable('apmr001',g_sql) CLIPPED
...
#----------No.TQC-690108 end
   ...
   IF cl_null(g_bgjob) OR g_bgjob = 'N'     # If background job sw is off
      THEN CALL apmr001_tm(0,0)             # Input print condition
      ELSE CALL apmr001()                   # Read data and create out-file
   END IF
   CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690119
END MAIN
 
FUNCTION apmr001_tm(p_row,p_col)
DEFINE lc_qbe_sn       LIKE gbm_file.gbm01        #No.FUN-580031
   ...
   OPEN WINDOW apmr001_w AT p_row,p_col WITH FORM "apm/42f/apmr001"
  ...
  #--------No.TQC-690108 end
   ...
   IF g_bgjob = 'Y' THEN
      ...
      ELSE
         ...
         CALL cl_cmdat('apmr001',g_time,l_cmd)    # Execute cmd at later time
      END IF
   ...
   DEFINE l_name    LIKE type_file.chr20,         # External(Disk) file name        #No.FUN-680136 VARCHAR(20)
     ...
     LET l_sql=" SELECT pmm01,pmm04,pmn02,pmn04,pmn041,pmn33,pmn20,pmn50,pmn55,", #FUN-990062 add pmn041  #No.FUN-9C0153 add pmn33
              ...
              #" FROM pmm_file,pmn_file",
               ...
               "   AND ",tm.wc CLIPPED
     PREPARE apmr001_p1 FROM l_sql
     IF STATUS THEN CALL cl_err('prepare1:',STATUS,1) 
        CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690119
        EXIT PROGRAM 
     END IF
     DECLARE apmr001_c1 CURSOR FOR apmr001_p1
 
#     CALL cl_outnam('apmr001') RETURNING l_name       #No.FUN-750093
#     START REPORT apmr001_rep TO l_name
#     LET g_pageno = 0
#     LET l_cnt=0
#     LET l_i=0                                        #No.FUN-750093
     LET g_success='Y'
     BEGIN WORK
     FOREACH apmr001_c1 INTO sr.*
       ...
       END IF
           ...
           IF tm.upd='N' THEN
#              OUTPUT TO REPORT apmr001_rep(sr.*)       #No.FUN-750093
#No.FUN-750093 --add--
...
#No.FUN-750093 --add--                                                          
           ...
           END IF
     END FOREACH
#     FINISH REPORT apmr001_rep                         #No.FUN-750093 
     IF g_success = 'Y' THEN
        COMMIT WORK
       #IF tm.b='Y' THEN CALL cl_cmmsg(0) END IF     #No.TQC-690108 mark
     ELSE
        ROLLBACK WORK 
       #IF tm.b='Y' THEN CALL cl_rbmsg(0) END IF     #No.TQC-690108 mark
     END IF
#     CALL cl_prt(l_name,g_prtway,g_copies,g_len)    #No.FUN-750093
#No.FUN-750093 --start--
     SELECT zz05 INTO g_zz05 FROM zz_file WHERE zz01 = g_prog
     IF g_zz05 = 'Y' THEN  #MOD-D30133 add
    ...
    #MOD-D30133---add---E
     ...
     CALL cl_prt_cs3('apmr001','apmr001',l_sql,g_str)
#No.FUN-750093 --end--
END FUNCTION

#No.FUN-750093 --start-- --mark--
{REPORT apmr001_rep(sr)
