...
FUNCTION t420(p_argv1,p_argv2,p_argv3,p_argv4) #No.FUN-630010
   ...
   CREATE TEMP TABLE apm_p470(
       ...
       sfa01    LIKE sfa_file.sfa01,    #add by sx210426
...
#FUN-B90101--add--end--            
      LET g_sql="SELECT pml02,pml24,pml25,'',pml47,pml04,'','','','','','','','','','','','','','','','','','','','','', ",  #NO.FUN-670007 ADD pml24/pml25 #No.FUN-870007-add-pml47
                ...
                "       pml83,pml84,pml85,pml80,pml81,pml82,pml86,pml87,",
                "       pml21,pml35,pml34,pml33,pmlud02,pml919,pml55,pml41,", #mod by jixf 160804 add 'pmlud02'  #FUN-570106   #No.TQC-640132 #No.FUN-870007-add-pml55  #FUN-A80150 add pml919
                "       pml190,pml191,pml192,",     #No.FUN-630040
                "       pml92,pml93,",  #FUN-9A0065 add pml92,pml93
                "       pml12,pml121,pml122,",
...
#FUN-A60035 ---MARK END
                ...
                LET g_pml[l_ac].pml20=0    #add by jixf 160808
             END IF
             LET l_ins_flag = 'Y'
