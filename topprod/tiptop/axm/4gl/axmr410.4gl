...
DEFINE tm         RECORD
               #      wc      VARCHAR(500),            # QBE 條件
                     ...
                     u       LIKE type_file.chr3,        # No.FUN-680137 VARCHAR(03)             # 合計 (INPUT 條件)
...
#------------No.TQC-610089 modify
  #LET tm.more  = ARG_VAL(14)
   ...
   LET tm.x     = ARG_VAL(13)
   LET tm.v     = ARG_VAL(14)
   LET tm.oea00 = ARG_VAL(15)
   #MOD-CC0246 -- add end --     #參數順序搬移
   #No.FUN-570264 --start--
   LET g_rep_user = ARG_VAL(16)                   #MOD-CC0246 modify ARG_VAL(15) -> ARG_VAL(16)
   LET g_rep_clas = ARG_VAL(17)                   #MOD-CC0246 modify ARG_VAL(16) -> ARG_VAL(17)
   LET g_template = ARG_VAL(18)                   #MOD-CC0246 modify ARG_VAL(17) -> ARG_VAL(18)
   LET g_rpt_name = ARG_VAL(19)  #No.FUN-7C0078   #MOD-CC0246 modify ARG_VAL(18) -> ARG_VAL(19)
   #No.FUN-570264 ---end---
#------------No.TQC-610089 end
...
#   LET tm.c    = 'N'       #No.FUN-7B0154
   ...
   WHILE TRUE
      ...
      INPUT BY NAME tm2.s1,tm2.s2,tm2.s3,tm2.t1,tm2.t2,tm2.t3,
                    tm2.u1,tm2.u2,tm2.u3,tm.a,tm.b,tm.more,tm.oea00,tm.x,tm.v  #No.MOD-7B0154  #FUN-850142 Add tm.x  #TQC-940009 add tm.v   #No.FUN-960004 add tm.oea00
