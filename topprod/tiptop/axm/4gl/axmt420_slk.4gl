...
MAIN      #No.FUN-740016
   ...
   LET g_prog = 'axmt420_slk'               #No.FUN-7C0017
   IF (NOT cl_user()) THEN
      EXIT PROGRAM
   END IF
   ...
   IF g_bgjob='N' OR cl_null(g_bgjob) THEN
      ...
      OPEN WINDOW t420_w AT p_row,p_col WITH FORM "axm/42f/axmt410_slk"   #FUN-B90101 add
        ATTRIBUTE (STYLE = g_win_style CLIPPED)                           #FUN-B90101 add 
      CALL cl_ui_init()
