...
# Modify.........: No:TQC-C40197 12/04/25 By qiaozy  给apmt110_slk的採購項次rvb03重新賦值 
# Modify.........: No:FUN-C50097 12/06/13 By SunLM  對非空字段進行判斷ogb50,51,52             
# Modify.........: No:FUN-C70098 12/07/24 By xjll   bug修改,採購收貨帶不出品名 
# Modify.........: No:FUN-CC0057 12/12/17 By xumeimei INSERT INTO rup_file時rup22給撥入營運中心
...
FUNCTION s_imx_ins_slk(p_i,p_index,p_qty,p_cmd,p_ima01)
   ...
   DEFINE l_rvbslk03    LIKE rvbslk_file.rvbslk03  #TQC-C40197--ADD----
...
#                                                                          類型為：RECORD LIKE oeb_file.*,RECORD LIKE oebi_file.*
         ...
         CASE g_prog
            ...
            WHEN 'apmt110_slk'
                 ...
                 END IF
#TQC-C40197------ADD----STR-----
                 LET l_rvbslk03=g_rvb_slk.rvb03
                 
                 SELECT pmn02 INTO g_rvb_slk.rvb03 FROM pmni_file,pmn_file 
                  WHERE pmni01=pmn01 AND pmni02=pmn02
                    AND pmni01=g_rvb_slk.rvb04
                    AND pmnislk02=p_ima01
                    AND pmnislk03=l_rvbslk03
                    AND pmn04 = l_ima01
#TQC-C40197------ADD-----END-----                 
                 SELECT pmm21,pmm43 INTO l_pmm21,l_pmm43 FROM pmm_file,rvbslk_file
                   WHERE pmm01=rvbslk04 AND rvbslk03=g_keyvalue2 AND rvbslk01=g_keyvalue1
            ...
            WHEN 'artt256'
                 ...
                 SELECT ruo05 INTO g_rup_slk.rup22 FROM ruo_file   #FUN-CC0057 add
                  WHERE ruo01 = g_keyvalue1                        #FUN-CC0057 add
                    AND ruoplant = g_plant                         #FUN-CC0057 add
            ...
            WHEN 'apmt720_slk'
                 ...
                 SELECT ima02 INTO g_rvv_slk.rvv031 FROM ima_file WHERE ima01 = l_ima01  #FUN-C70098    
