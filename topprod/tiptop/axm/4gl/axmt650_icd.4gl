...
#FUN-A60035 ---MARK END
   ...
   SELECT * INTO g_ica.* FROM ica_file WHERE ica00 = '0'   #FUN-B80178
...
#                  DISPLAY BY NAME g_oga.oga04   #No.MOD-490371         #MOD-B80301 mark
    ...
    CONSTRUCT g_wc2 ON ogb03, ogb04, ogb06, ogb092,ogb1001,ogb17,        #CHI-6B0027 mod  #No.FUN-660073
                       ...
                       ,ogbiicd02,ogbiicd03,ogbiicd04,ogbiicd028,ogbiicd029   #FUN-B80178
            ...
            FROM s_ogb[1].ogb03, s_ogb[1].ogb04, s_ogb[1].ogb06,
                 ...
                 ,s_ogb[1].ogbiicd02,s_ogb[1].ogbiicd03,s_ogb[1].ogbiicd04,s_ogb[1].ogbiicd028,s_ogb[1].ogbiicd029   #FUN-B80178   
...
#No.FUN-AA0062  --End
   ...
   #IF INT_FLAG THEN LET INT_FLAG=0 RETURN END IF       #No.TQC-D40060   Mark
    ...
    IF g_wc2 = " 1=1" THEN			# 若單身未輸入條件
     ...
     ELSE					# 若單身有輸入條件
       LET g_sql = "SELECT UNIQUE oga_file. oga01 ",
                   ...
                   " ORDER BY 1"
        #FUN-B8178 --START--
        IF g_wc2.getindexof('ogbi',1) > 0 THEN
           LET g_sql = "SELECT UNIQUE oga_file.oga01 " , 
                       "  FROM oga_file, ogb_file,ogbi_file",
                       " WHERE oga01 = ogb01",
                       "  AND ogb01 = ogbi01 ",
                       "  AND ogb03 = ogbi03 ",
                       "  AND ", g_wc CLIPPED, " AND ",g_wc2 CLIPPED,
    ...
    ELSE
       ...
       #FUN-B8178 --START--
       IF g_wc2.getindexof('ogbi',1) > 0 THEN
          LET g_sql="SELECT COUNT(DISTINCT oga01) FROM oga_file,ogb_file,ogbi_file WHERE ",
                    "ogb01=oga01 AND ogb01 = ogbi01 AND ogb03 = ogbi03 AND ",g_wc CLIPPED," AND ",g_wc2 CLIPPED
       END IF
       #FUN-B8178 --END--
    END IF
...
DEFINE l_wc     LIKE type_file.chr1000       #No.TQC-610089 add  #No.FUN-680137 VARCHAR(200)
   DEFINE l_ogb    RECORD LIKE ogb_file.*    #FUN-B80178
...
#FUN-BB0167 add end------------------------------
        ...
        WHEN "qry_lot"
           ...
           WHEN "aic_s_icdout"
              IF cl_chk_act_auth() THEN             
                 IF g_oga.oga55 matches '[Ss]' THEN         #送簽中不可更改刻號/BIN資料
                    CALL cl_err('','apm-030',0)
                 ELSE
                    IF (NOT cl_null(g_oga.oga01)) AND (g_oga.ogaconf = 'N') AND
                       (NOT cl_null(l_ac)) AND (l_ac <> 0) AND (cl_null(g_oga.oga70)) THEN                       
                       #FUN-BA0019 --START--
                       IF g_ogb[l_ac].ogb17 = 'Y' THEN
                          CALL cl_err('','axm-434',0) 
                          CONTINUE WHILE 
                       END IF
                       #FUN-BA0019 --END--
                       ...
                       IF s_icdbin(g_ogb[l_ac].ogb04) THEN  
                          CALL s_icdout(l_ogb.ogb04,l_ogb.ogb09,l_ogb.ogb091,
                                        l_ogb.ogb092,l_ogb.ogb05,l_ogb.ogb12,
                                        g_oga.oga01,l_ogb.ogb03,g_oga.oga02,
                                        'N','','','','')
                          RETURNING g_dies,l_r,l_qty   #FUN-C30302
                          #FUN-C30302---begin
                          IF l_r = 'Y' THEN
                              LET l_qty = s_digqty(l_qty,l_ogb.ogb05) 
                              LET g_ogb[l_ac].ogb12 = l_qty
                              LET g_ogb[l_ac].ogb912 = l_qty
                              LET g_ogb[l_ac].ogb917 = l_qty

                              IF g_oga.oga213 = 'N' THEN
                                 LET g_ogb[l_ac].ogb14 = cl_digcut(g_ogb[l_ac].ogb917 * l_ogb.ogb13, t_azi04)
                                 LET g_ogb[l_ac].ogb14t = cl_digcut(g_ogb[l_ac].ogb14 * (1 + g_oga.oga211 / 100), t_azi04)
                              ELSE
                                 LET g_ogb[l_ac].ogb14t = cl_digcut(g_ogb[l_ac].ogb917 * l_ogb.ogb13, t_azi04)
                                 LET g_ogb[l_ac].ogb14 = cl_digcut(g_ogb[l_ac].ogb14t / (1 + g_oga.oga211 / 100), t_azi04)
                              END IF
                              
                              UPDATE ogb_file SET ogb12  = g_ogb[l_ac].ogb12,
                                                  ogb16  = g_ogb[l_ac].ogb12*l_ogb.ogb15_fac,   #FUN-C50114 add
                                                  ogb912 = g_ogb[l_ac].ogb912,
                                                  ogb917 = g_ogb[l_ac].ogb917,
                              ...
                              END IF
                              DISPLAY BY NAME g_ogb[l_ac].ogb12, g_ogb[l_ac].ogb912,
                                              g_ogb[l_ac].ogb14, g_ogb[l_ac].ogb14t
                          END IF 
                          #FUN-C30302---end
                          CALL t650_upd_dies()
                          CALL t650_bu()   #FUN-C50114 add
                       ELSE
                          CALL cl_err(g_ogb[l_ac].ogb04,'aic-316',1)
                       END IF
                    END IF
                 END IF                                    
              END IF
            ...
            WHEN "aic_s_icdqry"
              IF cl_chk_act_auth() THEN
                IF NOT cl_null(g_oga.oga01) THEN
                   CALL s_icdqry(2,g_oga.oga01,'',g_oga.ogapost,'')
                END IF
             END IF
           #FUN-B80178 --END--    
...
FUNCTION t650_chkkey()
           ...
           END IF
           #FUN-B80178 --START--
           UPDATE ogbi_file SET ogbi01=g_oga.oga01 WHERE ogbi01=g_oga_t.oga01
           IF STATUS OR SQLCA.SQLCODE THEN
              CALL cl_err3("upd","ogbi_file",g_oga_t.oga01,"",SQLCA.SQLCODE,"","upd ogbi01",1)
              LET g_oga.*=g_oga_t.* CALL t650_show() ROLLBACK WORK RETURN
           END IF
           #FUN-B80178 --END--
...
#FUN-BB0167 add end ------------------------------
    ...
    IF cl_delh(20,16) THEN
      ...
      IF g_cnt > 0 THEN         
         IF NOT s_icdinout_del(-1,g_oga.oga01,'','') THEN
            CLOSE t650_cl
            ROLLBACK WORK
            RETURN
         END IF
      ...
      #FUN-BA0019 --END--
        ...
        #IF NOT s_industry('std') THEN   #FUN-B80178 mark
           LET l_flag = s_del_ogbi(g_oga.oga01,'','')   #FUN-A50054 mark #FUN-A60035 ---REMARK
           
        #END IF   #FUN-B80178 mark
#FUN-A60035 ---MARK BEGIN
#       #FUN-A50054---Begin add
#       IF s_industry('slk') THEN
...
#FUN-A60035 ---MARK END        
        ...
        #IF NOT s_industry('std') THEN   #FUN-B80178 mark
           LET l_flag = s_del_ogdi(g_oga.oga01,'','','')
        #END IF   #FUN-B80178 mark
...
#FUN-A60035 ---MARK END
    ...
    #IF NOT s_industry("std") THEN   #FUN-B80178 mark
       LET g_forupd_sql = "SELECT * FROM ogbi_file ",
                          " WHERE ogbi01= ? AND ogbi03= ?  FOR UPDATE"
       LET g_forupd_sql = cl_forupd_sql(g_forupd_sql)     #MOD-B70278
       DECLARE t650_bcl_ind CURSOR FROM g_forupd_sql      # LOCK CURSOR
     #END IF   #FUN-B80178 mark
               ...
               #FUN-A60035 ---MARK END 
                   ...
                   ELSE
                      ...
                      ELSE
                         ...
                         OPEN t650_bcl_ind USING g_oga.oga01,g_ogb_t.ogb03
                         IF STATUS THEN
                            CALL cl_err("OPEN t650_bcl_ind:", STATUS, 1)
                            LET l_lock_sw = "Y"
                         ELSE
                            FETCH t650_bcl_ind INTO b_ogbi.*
                            IF SQLCA.sqlcode THEN
                         ...
                         END IF   #FUN-B80178     
                      END IF
                      CALL t650_set_no_required_1()   #FUN-B80178
                      CALL t650_set_required_1(p_cmd) #FUN-B80178
                   END IF
...
#              END IF  #FUN-A50054 add   
        ...
        AFTER FIELD ogb03                        #check 序號是否重複
            IF NOT cl_null(g_ogb[l_ac].ogb03) THEN
               ...
               END IF
               #FUN-B80178 --START-- 
               IF p_cmd = 'u' AND NOT cl_null(g_ogb[l_ac].ogb03) THEN
                  IF g_ogb_t.ogb03 <> g_ogb[l_ac].ogb03 THEN
                     CALL t650_ind_icd_chk_icdout()
                     IF NOT cl_null(g_errno) THEN
                        CALL cl_err(g_ogb[l_ac].ogb03,g_errno,0)
                        LET g_ogb[l_ac].ogb03 = g_ogb_t.ogb03
...
#FUN-AA0059 ---------------------end-------------------------------
             ...
             #FUN-A60035 ---MARK END 
              ...
              END IF
              #FUN-B80178 --START--
              IF NOT cl_null(g_ogb[l_ac].ogb04)
                 AND (g_ogb[l_ac].ogb04!=g_ogb_t.ogb04
                 OR g_ogb_t.ogb04 IS NULL ) THEN
                 SELECT imaicd12 INTO l_imaicd12 FROM imaicd_file
                  WHERE imaicd00 = g_ogb[l_ac].ogb04
                 LET g_ogb[l_ac].ogbiicd02 = l_imaicd12
                 DISPLAY BY NAME g_ogb[l_ac].ogbiicd02
              END IF
              IF p_cmd = 'u' AND NOT cl_null(g_ogb[l_ac].ogb04) THEN
                 IF g_ogb_t.ogb04 <> g_ogb[l_ac].ogb04 THEN
                    CALL t650_ind_icd_chk_icdout()
                    IF NOT cl_null(g_errno) THEN
                       CALL cl_err(g_ogb[l_ac].ogb04,g_errno,0)
                       LET g_ogb[l_ac].ogb04 = g_ogb_t.ogb04
                 ...
                 END IF
              END IF
              IF NOT s_icdout_holdlot(g_ogb[l_ac].ogb04,g_ogb[l_ac].ogb09,
                                      g_ogb[l_ac].ogb091,g_ogb[l_ac].ogb092) THEN
                 NEXT FIELD ogb04 
              END IF
              #FUN-B80178 --END--
        ...
        AFTER FIELD ogb092
           ...
           #FUN-B80178 --START-- 
           IF p_cmd = 'u' THEN
              IF cl_null(g_ogb_t.ogb092) THEN LET g_ogb_t.ogb092 = ' ' END IF
              IF g_ogb_t.ogb092 <> g_ogb[l_ac].ogb092 THEN
                 CALL t650_ind_icd_chk_icdout()
                 IF NOT cl_null(g_errno) THEN
                    CALL cl_err(g_ogb[l_ac].ogb092,g_errno,0)
                    LET g_ogb[l_ac].ogb092 = g_ogb_t.ogb092
           ...
           END IF
           #-----END MOD-A50013-----
           CALL t650_def_ogbiicd029() #FUN-B80178
        ...
        AFTER FIELD ogb05
           ...
           IF p_cmd = 'u' AND g_sma.sma115 = 'N' AND
              NOT cl_null(g_ogb[l_ac].ogb05) THEN
              IF g_ogb_t.ogb05 <> g_ogb[l_ac].ogb05 THEN
                 CALL t650_ind_icd_chk_icdout()
                 IF NOT cl_null(g_errno) THEN
                    CALL cl_err(g_ogb[l_ac].ogb05,g_errno,0)
                    LET g_ogb[l_ac].ogb05 = g_ogb_t.ogb05
        ...
        AFTER FIELD ogb17
            IF NOT cl_null(g_ogb[l_ac].ogb17) THEN
               ...
               ELSE
                   ...
                   IF NOT t650_del_idb('','','','',g_oga.oga01,g_ogb[l_ac].ogb03) THEN 
 ...
 #TQC-B60225 ------------------END
          ...
          #IF g_ogb[l_ac].ogb091 IS NOT NULL AND NOT cl_null(g_ogb[l_ac].ogb09) THEN
           ...
           #CHI-CC0014 ------------end
           #FUN-B80178 --START--
           IF p_cmd = 'u' AND NOT cl_null(g_ogb[l_ac].ogb09) THEN
               IF g_ogb_t.ogb09 <> g_ogb[l_ac].ogb09 THEN
                  CALL t650_ind_icd_chk_icdout()
                  IF NOT cl_null(g_errno) THEN
       ...
       AFTER FIELD ogb091
        ...
        IF g_ogb[l_ac].ogb091 IS NOT NULL AND NOT cl_null(g_ogb[l_ac].ogb09) THEN     #MOD-AB0033
         ...
         #FUN-B80178 --START--
         IF p_cmd = 'u' THEN
            IF cl_null(g_ogb_t.ogb091) THEN LET g_ogb_t.ogb091 = ' ' END IF
            IF g_ogb_t.ogb091 <> g_ogb[l_ac].ogb091 THEN
               CALL t650_ind_icd_chk_icdout()
               IF NOT cl_null(g_errno) THEN
                  CALL cl_err(g_ogb[l_ac].ogb091,g_errno,0)
                  LET g_ogb[l_ac].ogb091 = g_ogb_t.ogb091
        ...
        AFTER FIELD ogb908
            ...
            END IF
        #FUN-B80178 --START--
        AFTER FIELD ogbiicd02
           IF NOT cl_null(g_ogb[l_ac].ogbiicd02) THEN
              IF g_ogb[l_ac].ogbiicd02 < 0 THEN
                 CALL cl_err('','aic-005',0)
                 NEXT FIELD ogbiicd02
              END IF
           END IF
        #FUN-B80178 --START--   

       #str FUN-C50114 add
        AFTER FIELD ogbiicd07    #End User
           IF NOT cl_null(g_ogb[l_ac].ogbiicd07) THEN
              LET g_cnt = 0
              SELECT COUNT(*) INTO g_cnt FROM icd_file
               WHERE icd02='R' and icdacti='Y' and icd01=g_ogb[l_ac].ogbiicd07
              IF g_cnt = 0 THEN
...
#                END IF     #FUN-A60035 ---add    #FUN-A60035 ---MARK
	       ...
	       #FUN-810045 begin
              ...
              #FUN-A60035 ---MARK END
                  ...
                  ELSE
                     #IF NOT s_industry('std') THEN   #FUN-B80178 mark
#                       IF NOT s_del_ogbi(g_oga.oga01,g_ogb_t.ogb03,'') THEN
                        IF NOT s_del_ogbi(g_oga.oga01,g_ogb_t.ogb03,g_oga.ogaplant) THEN #FUN-A50054
                           ROLLBACK WORK
                           CANCEL DELETE
                        END IF
                     #END IF   #FUN-B80178 mark
               ...
               #str FUN-C50114 add
                LET g_cnt = 0
                SELECT COUNT(*) INTO g_cnt FROM idb_file
                 WHERE idb07 = g_oga.oga01 AND idb08 = g_ogb_t.ogb03
                IF g_cnt > 0 THEN         
                   IF NOT s_icdinout_del(-1,g_oga.oga01,g_ogb_t.ogb03,'') THEN
                      ROLLBACK WORK
                      CANCEL DELETE
                   END IF
                END IF
        ...
        ON ROW CHANGE
            ...
            IF cl_null(g_ogb[l_ac].ogb092) THEN
               LET g_ogb[l_ac].ogb092 = ' '
            END IF
            IF g_ogb_t.ogb03 <> g_ogb[l_ac].ogb03 OR
               g_ogb_t.ogb04 <> g_ogb[l_ac].ogb04 OR
               g_ogb_t.ogb09 <> g_ogb[l_ac].ogb09 OR
               g_ogb_t.ogb091 <> g_ogb[l_ac].ogb091 OR
               g_ogb_t.ogb092 <> g_ogb[l_ac].ogb092 OR
               g_ogb_t.ogb05 <> g_ogb[l_ac].ogb05 THEN
               CALL t650_ind_icd_chk_icdout()
               IF NOT cl_null(g_errno) THEN
            ...
            ELSE
               ...
               #將單位一的資料給單位二
               CALL t650_ind_icd_set_value()   #FUN-B80178
...
#FUN-A60035 ---MARK END
               ...
               ELSE
               #FUN-B80178 --START--
                  UPDATE ogbi_file SET * = b_ogbi.*
                   WHERE ogbi01=g_oga.oga01 AND ogbi03=g_ogb_t.ogb03
                  IF SQLCA.sqlcode THEN
                     CALL cl_err3("upd","ogbi_file",g_oga.oga01,g_ogb_t.ogb03,SQLCA.sqlcode,"","upd ogbi",1)  #No.FUN-660167
                     LET g_ogb[l_ac].* = g_ogb_t.*                  
                     LET g_success = 'N' 
                  END IF                   
               END IF 
...
FUNCTION t650_b_move_to()
   ...
   #FUN-B80178 --START--
   LET g_ogb[l_ac].ogbiicd02 = b_ogbi.ogbiicd02
   LET g_ogb[l_ac].ogbiicd03 = b_ogbi.ogbiicd03
   LET g_ogb[l_ac].ogbiicd04 = b_ogbi.ogbiicd04
   LET g_ogb[l_ac].ogbiicd028 = b_ogbi.ogbiicd028
   LET g_ogb[l_ac].ogbiicd029 = b_ogbi.ogbiicd029
   LET g_ogb[l_ac].ogbiicd07 = b_ogbi.ogbiicd07  #FUN-C30289
   #FUN-B80178 --END--
END FUNCTION
...
FUNCTION t650_b_move_back()
   ...
   #FUN-B80178 --START--
   LET b_ogbi.ogbi01 = g_oga.oga01         
   LET b_ogbi.ogbi03 = g_ogb[l_ac].ogb03   
   LET b_ogbi.ogbiicd02 = g_ogb[l_ac].ogbiicd02 
   LET b_ogbi.ogbiicd03 = g_ogb[l_ac].ogbiicd03 
   LET b_ogbi.ogbiicd04 = g_ogb[l_ac].ogbiicd04 
   LET b_ogbi.ogbiicd028 = g_ogb[l_ac].ogbiicd028 
   LET b_ogbi.ogbiicd029 = g_ogb[l_ac].ogbiicd029 
   LET b_ogbi.ogbiicd07 = g_ogb[l_ac].ogbiicd07 #FUN-C30289
   #FUN-B80178 --END--
END FUNCTION
...
FUNCTION t650_b_ogg()			# 庫存異動明細(ogg_file)輸入
  ...
  DEFINE l_r              LIKE type_file.chr1        #FUN-C30302
  DEFINE l_qty            LIKE type_file.num15_3     #FUN-C30302
  DEFINE l_imaicd04       LIKE imaicd_file.imaicd04  #FUN-C50114 add
  DEFINE l_ima25          LIKE ima_file.ima25        #FUN-C50114 add
  DEFINE l_flag1          LIKE type_file.chr1   #FUN-C80107 add 121024
   ...
   INPUT ARRAY l_ogg WITHOUT DEFAULTS FROM s_ogg.*
     ...
     #FUN-BA0019 --START--   
     BEFORE DELETE 
        SELECT COUNT(*) INTO l_cnt FROM idb_file WHERE idb01 = g_ogb[l_ac].ogb04
          AND idb02 = l_ogg[i].ogg09 AND idb03 = l_ogg[i].ogg091
          AND idb04 = l_ogg[i].ogg092 AND idb07 = g_oga.oga01
          AND idb08 = g_ogb[l_ac].ogb03
        IF l_cnt > 0 THEN   
           IF NOT cl_confirm('aic-112') THEN
              CANCEL DELETE
           ELSE              
              IF NOT t650_del_idb(g_ogb[l_ac].ogb04,l_ogg[i].ogg09,l_ogg[i].ogg091,
                                  l_ogg[i].ogg092,g_oga.oga01,g_ogb[l_ac].ogb03) THEN               
                 CANCEL DELETE                            
              END IF
           END IF
        END IF     
  ...
  #FUN-910088--mark--end--
     ...
     AFTER INPUT
      ...
      ON ACTION aic_s_icdout
         IF l_ogg[i].ogg12 <> 0 THEN
            IF s_icdbin(g_ogb[l_ac].ogb04) THEN  
               CALL s_icdout_ogb17_on()
               CALL s_icdout(g_ogb[l_ac].ogb04,l_ogg[i].ogg09,l_ogg[i].ogg091,
                             l_ogg[i].ogg092,l_ogg[i].ogg10,l_ogg[i].ogg12,
                             g_oga.oga01,g_ogb[l_ac].ogb03,g_oga.oga02,
                             'N','','','','')
                    RETURNING g_dies,l_r,l_qty   #FUN-C30302
               #FUN-C30302---begin
               IF l_r = 'Y' THEN
                 #str FUN-C50114 add
                 #當出貨的料號為CP,
                 #將l_qty寫回ogg20='1'的ogg12與ogg16;將g_dies寫回ogg20='2'的ogg12與ogg16
                 #當沒有ogg20='2'的資料時自動新增
                  LET l_imaicd04 = NULL
                  LET l_ima25 = NULL
                  SELECT imaicd04,ima25 INTO l_imaicd04,l_ima25
                    FROM ima_file,imaicd_file
                   WHERE ima01 = imaicd00 AND ima01 = g_ogb[l_ac].ogb04
                  IF l_imaicd04 = '2' THEN   #CP
                     LET l_cnt = 0
                     IF l_ogg[i].ogg20 = '1' THEN   #1:出貨單位
                        LET l_qty = s_digqty(l_qty,l_ogg[i].ogg10) 
                        LET l_ogg[i].ogg12 = l_qty
                        LET l_ogg[i].ogg16 = l_qty
                        DISPLAY BY NAME l_ogg[i].ogg12, l_ogg[i].ogg16

                        #找出參考單位的那一筆將g_dies更新過去
                        FOR k = 1 TO l_ogg.getLength()
                           IF l_ogg[k].ogg20 = '2' AND
                              l_ogg[k].ogg09 = l_ogg[i].ogg09  AND
                              l_ogg[k].ogg091= l_ogg[i].ogg091 AND
                              l_ogg[k].ogg092= l_ogg[i].ogg092 THEN
                              LET l_ogg[k].ogg12 = g_dies
                              LET l_ogg[k].ogg16 = g_dies
                              DISPLAY BY NAME l_ogg[k].ogg12, l_ogg[k].ogg16
                           END IF
                        END FOR
                     ELSE
                        LET l_qty = s_digqty(l_qty,l_ima25) 
                        LET l_ogg[i].ogg12 = g_dies
                        LET l_ogg[i].ogg16 = g_dies
                        DISPLAY BY NAME l_ogg[i].ogg12, l_ogg[i].ogg16

                        #找出出貨單位的那一筆將l_qty更新過去
                        FOR k = 1 TO l_ogg.getLength()
                           IF l_ogg[k].ogg20 = '1' AND
                              l_ogg[k].ogg09 = l_ogg[i].ogg09  AND
                              l_ogg[k].ogg091= l_ogg[i].ogg091 AND
                              l_ogg[k].ogg092= l_ogg[i].ogg092 THEN
                              LET l_ogg[k].ogg12 = l_qty
                              LET l_ogg[k].ogg16 = l_qty
                              DISPLAY BY NAME l_ogg[k].ogg12, l_ogg[k].ogg16
                           END IF
                        END FOR
                     END IF
 ...
 #No.FUN-AA0062  --End                                                                                                              
   ...
   FOR i = 1 TO l_ogg.getLength()
       IF l_ogg[i].ogg12 IS NULL OR l_ogg[i].ogg12=0 THEN 
          ...
          IF NOT t650_del_idb(g_ogb[l_ac].ogb04,l_ogg[i].ogg09,l_ogg[i].ogg091,
                                  l_ogg[i].ogg092,g_oga.oga01,g_ogb[l_ac].ogb03) THEN
             CALL s_errmsg('','',"DEL idb_file",SQLCA.sqlcode,1)                                  
             LET g_success = 'N'
             EXIT FOR
          END IF              
          #FUN-BA0019 --END--
    ...
    #FUN-BA0019 --START--
    IF g_success = 'Y' THEN     
       CALL t650_upd_qty()   #FUN-C50114 add
       CALL t650_upd_dies()   
    END IF
    #FUN-BA0019 --END--   
...
#FUN-A60035 ---MARK END
    ...
    LET g_sql =
        ...
        "       ogbud11,ogbud12,ogbud13,ogbud14,ogbud15",
        #FUN-B80178 --START--
        "       ,ogbiicd02,ogbiicd03,ogbiicd04,ogbiicd028,ogbiicd029,ogbiicd07",   #FUN-C30289
        "  FROM ogb_file LEFT OUTER JOIN ogbi_file ON ogb01 = ogbi01 and ogb03 = ogbi03 ",
...
#FUN-B80178 --START--
FUNCTION t650_def_ogbiicd029()
DEFINE l_idc10    LIKE idc_file.idc10,
       l_idc11    LIKE idc_file.idc11
DEFINE l_flag     LIKE type_file.num10

   CALL s_icdfun_def_slot(g_ogb[l_ac].ogb04,g_ogb[l_ac].ogb09,g_ogb[l_ac].ogb091,
                          g_ogb[l_ac].ogb092) RETURNING l_flag,l_idc10,l_idc11   
   IF l_flag = 1 THEN 
      LET g_ogb[l_ac].ogbiicd029 = l_idc10
      LET g_ogb[l_ac].ogbiicd028 = l_idc11      
      DISPLAY BY NAME g_ogb[l_ac].ogbiicd029,g_ogb[l_ac].ogbiicd028
   END IF 
END FUNCTION

#當料號為wafer段時,imaicd04 = 1,用dice數量加總給原單據的第二單位數量.
#當料號為wafer段時,imaicd04 = 2,用pass bin = 'Y' 數量加總給原單據的第二單位數量.
FUNCTION t650_upd_dies()
   DEFINE l_ima906    LIKE ima_file.ima906,
          l_imaicd04  LIKE imaicd_file.imaicd04  
   DEFINE l_ida15 LIKE ida_file.ida15,            
          l_ida16 LIKE ida_file.ida16             
   ...
   IF g_sma.sma115 = 'Y' THEN
      ...
      IF NOT cl_null(l_ima906) AND l_ima906 MATCHES '[13]' THEN
         IF l_imaicd04 MATCHES '[012]' THEN
            LET g_ogb[l_ac].ogb915 = g_dies             #數量
            LET g_ogb[l_ac].ogb914 = g_ogb[l_ac].ogb912/g_ogb[l_ac].ogb915            
            UPDATE ogb_file set ogb915 = g_ogb[l_ac].ogb915,
                                ogb914 = g_ogb[l_ac].ogb914
               WHERE ogb01=g_oga.oga01 AND ogb03=g_ogb[l_ac].ogb03
            IF SQLCA.sqlcode OR SQLCA.sqlerrd[3] = 0 THEN
               LET g_ogb[l_ac].ogb915 = b_ogb.ogb915
               LET g_ogb[l_ac].ogb914 = b_ogb.ogb914
            ...
            ELSE
               ...
               LET b_ogb.ogb914 = g_ogb[l_ac].ogb914               
            END IF
            DISPLAY BY NAME g_ogb[l_ac].ogb915, g_ogb[l_ac].ogb914
         END IF
      END IF
   END IF
   ...
   IF s_icdbin(g_ogb[l_ac].ogb04) THEN
      ...
      DECLARE t600_upd_dia_c CURSOR FROM g_sql            
      OPEN t600_upd_dia_c                                       
      FETCH t600_upd_dia_c INTO g_ogb[l_ac].ogbiicd029   #FUN-BC0109 del ,g_ogb[l_ac].ogbiicd028
      
      #串接Date Code值
       CALL s_icdfun_datecode('1',g_oga.oga01,g_ogb[l_ac].ogb03) 
                                RETURNING g_ogb[l_ac].ogbiicd028   #FUN-BC0109
                                
      UPDATE ogbi_file set ogbiicd029 = g_ogb[l_ac].ogbiicd029,
       ogbiicd028 = g_ogb[l_ac].ogbiicd028
       WHERE ogbi01=g_oga.oga01 AND ogbi03=g_ogb[l_ac].ogb03 
      IF SQLCA.sqlcode OR SQLCA.sqlerrd[3] = 0 THEN
         LET g_ogb[l_ac].ogbiicd029 = b_ogbi.ogbiicd029
         LET g_ogb[l_ac].ogbiicd028 = b_ogbi.ogbiicd028
         LET g_success  = 'N'
...
FUNCTION t650_set_required_1(p_cmd)
   ...
   IF p_cmd='u' OR INFIELD(ogb04) THEN
      IF NOT cl_null(g_ogb[l_ac].ogb04) THEN
         ...
         IF l_imaicd13 = 'Y' THEN
            CALL cl_set_comp_required("ogb092",TRUE)
         END IF
      END IF
   END IF
END FUNCTION

FUNCTION t650_set_no_required_1()
     CALL cl_set_comp_required("ogb092",FALSE)
END FUNCTION

#   料號為參考單位,單一單位,且狀態為其它段生產料號(imaicd04=3,4)時,
#   將單位一的資料給單位二
FUNCTION t650_ind_icd_set_value()
   DEFINE l_ima906    LIKE ima_file.ima906,
          l_imaicd04  LIKE imaicd_file.imaicd04
   IF g_sma.sma115 = 'Y' THEN
      LET l_ima906 = NULL
     ...
     #若料號為單一單位, 如IC料號, 出入庫不回寫單位二級單位二數量
      IF NOT cl_null(l_ima906) AND l_ima906 MATCHES '[3]' THEN
         IF l_imaicd04 MATCHES '[34]' THEN
            LET g_ogb[l_ac].ogb913 = g_ogb[l_ac].ogb910 #單位
            LET g_ogb[l_ac].ogb915 = g_ogb[l_ac].ogb912 #數量
            LET g_ogb[l_ac].ogb914 = g_ogb[l_ac].ogb912/g_ogb[l_ac].ogb915

            LET b_ogb.ogb913= g_ogb[l_ac].ogb913    #單位二
            LET b_ogb.ogb915= g_ogb[l_ac].ogb915    #單位二數量
            LET b_ogb.ogb914= g_ogb[l_ac].ogb914    #單位二換算率(與銷售單位)
            DISPLAY BY NAME g_ogb[l_ac].ogb913,
                            g_ogb[l_ac].ogb915,
                            g_ogb[l_ac].ogb914
...
FUNCTION t650_ind_icd_chk_icdout()
   LET g_cnt = 0
   LET g_errno = ''

   SELECT COUNT(*) INTO g_cnt FROM idb_file
    WHERE idb07 = g_oga.oga01
      AND idb08 = g_ogb_t.ogb03
   IF g_cnt > 0 THEN
      LET g_errno = 'aic-113'
   ELSE
...
#str FUN-C50114 add
FUNCTION t650_upd_qty()
   DEFINE l_ogg12_1        LIKE ogg_file.ogg12
   DEFINE l_ogg12_2        LIKE ogg_file.ogg12
   DEFINE l_imaicd04       LIKE imaicd_file.imaicd04
   DEFINE l_ogb            RECORD LIKE ogb_file.*

   #刻號/BIN數量回寫多倉儲批數量後,會與主維護畫面的數量不一樣,
   #程式詢問axm-170後應該將ogg_file數量加總回寫到ogb_file

   SELECT * INTO l_ogb.* FROM ogb_file
    WHERE ogb01=g_oga.oga01 AND ogb03=g_ogb[l_ac].ogb03

   LET l_imaicd04 = NULL
   SELECT imaicd04 INTO l_imaicd04 FROM ima_file,imaicd_file
    WHERE ima01 = imaicd00 AND ima01 = g_ogb[l_ac].ogb04

   LET l_ogg12_1 = 0         #出貨數量
   LET l_ogg12_2 = 0         #參考數量
   SELECT SUM(ogg12) INTO l_ogg12_1 FROM ogg_file
    WHERE ogg01=g_oga.oga01 AND ogg03=g_ogb[l_ac].ogb03 AND ogg20='1'
   SELECT SUM(ogg12) INTO l_ogg12_2 FROM ogg_file
    WHERE ogg01=g_oga.oga01 AND ogg03=g_ogb[l_ac].ogb03 AND ogg20='2'
      
   LET l_ogb.ogb12 = l_ogg12_1
   LET l_ogb.ogb16 = l_ogg12_1*l_ogb.ogb15_fac
   LET l_ogb.ogb912 = l_ogg12_1
   IF l_imaicd04 = '2' THEN    #CP還要回寫參考數量
      LET l_ogb.ogb915 = l_ogg12_2
   ELSE
      LET l_ogb.ogb915 = NULL
   END IF
   LET l_ogb.ogb917 = l_ogg12_1
   IF g_oga.oga213 = 'N' THEN
      LET l_ogb.ogb14  = cl_digcut(l_ogb.ogb917 * l_ogb.ogb13, t_azi04)
      LET l_ogb.ogb14t = cl_digcut(l_ogb.ogb14 * (1 + g_oga.oga211 / 100), t_azi04)
   ELSE
      LET l_ogb.ogb14t = cl_digcut(l_ogb.ogb917 * l_ogb.ogb13, t_azi04)
      LET l_ogb.ogb14  = cl_digcut(l_ogb.ogb14t / (1 + g_oga.oga211 / 100), t_azi04)
   END IF

   UPDATE ogb_file SET ogb12  = l_ogb.ogb12,
                       ogb16  = l_ogb.ogb16,
                       ogb912 = l_ogb.ogb912,
                       ogb915 = l_ogb.ogb915,
                       ogb917 = l_ogb.ogb917,
                       ...
                       ogb14t = l_ogb.ogb14t
    WHERE ogb01=g_oga.oga01 AND ogb03=g_ogb[l_ac].ogb03
   LET g_ogb[l_ac].ogb12 = l_ogb.ogb12
   LET g_ogb[l_ac].ogb912= l_ogb.ogb912
   LET g_ogb[l_ac].ogb915= l_ogb.ogb915
   LET g_ogb[l_ac].ogb917= l_ogb.ogb917
   LET g_ogb[l_ac].ogb14 = l_ogb.ogb14
   LET g_ogb[l_ac].ogb14t= l_ogb.ogb14t
   DISPLAY BY NAME g_ogb[l_ac].ogb12 ,g_ogb[l_ac].ogb912,g_ogb[l_ac].ogb915,
                   g_ogb[l_ac].ogb917,g_ogb[l_ac].ogb14 ,g_ogb[l_ac].ogb14t
   CALL t650_bu()
...
#FUN-BA0019 --START--
FUNCTION t650_del_idb(p_idb01,p_idb02,p_idb03,p_idb04,p_idb07,p_idb08)
...
DEFINE l_type       LIKE type_file.chr1  #0:料倉儲批 1:單一項次 

IF cl_null(p_idb01) AND cl_null(p_idb02) AND cl_null(p_idb03) AND cl_null(p_idb04) THEN
   LET l_type = '1'
ELSE
   LET l_type = '0'    
END IF  
   ...
   CASE l_type
      WHEN '0'
         LET g_sql = "SELECT * FROM idb_file ",
                     " WHERE idb01 = '", p_idb01 ,"'",
                     "   AND idb02 = '", p_idb02 ,"'",
                     "   AND idb03 = '", p_idb03 ,"'",
                     "   AND idb04 = '", p_idb04 ,"'",
   ...
   PREPARE t600_idb_p1 FROM g_sql
   DECLARE t600_idb_c1 CURSOR FOR t600_idb_p1

   FOREACH t600_idb_c1 INTO l_idb.*
      IF cl_null(l_idb.idb11) OR l_idb.idb11 = 0 THEN
         CONTINUE FOREACH  
      END IF   
      #回寫已備置量  
   ...
   CASE l_type
      WHEN '0'
         DELETE FROM idb_file WHERE idb01 = p_idb01 AND idb02 = p_idb02
                             AND idb03 = p_idb03 AND idb04 = p_idb04
                             AND idb07 = p_idb07 AND idb08 = p_idb08
      WHEN '1'
         DELETE FROM idb_file WHERE idb07 = p_idb07 AND idb08 = p_idb08
   END CASE
   
   IF SQLCA.sqlcode THEN
      CALL s_errmsg('','',"DEL idb:",SQLCA.sqlcode,1)      
      RETURN FALSE 
   END IF          
   RETURN TRUE 
END FUNCTION 
   ...
   FOREACH t600_ins_ogb_c1 INTO l_ogb.*
     ...
     END IF
       ...
       ELSE
          ...
          IF NOT s_ins_ogbi(l_ogbi.*,l_ogb.ogbplant) THEN   
             LET g_success = 'N'
          END IF
       END IF
       LET g_ima918 = ''   
             ...
             IF g_ima918 = "Y" OR g_ima921 = "Y" THEN
                ...
                FOREACH t600_g_rvbs_4 INTO l_rvbs.*
                   IF STATUS THEN
                      CALL cl_err('rvbs',STATUS,1)
                   END IF
                   LET l_rvbs.rvbs00 = 'axmt628_icd'   #FUN-B40066
                   LET l_rvbs.rvbs01 = l_oga.oga01
                   LET l_rvbs.rvbs022 = i
