...
# Modify.........: No.FUN-D40020 13/01/30 By chenjing 追單TQC-D10011
...
MAIN
   ...
   LET g_sql = "ohe03.ohe_file.ohe03,",
               ...
               "pis1.type_file.chr1000,",   #FUN-CB0001      
               "l_num1.type_file.num5"      #FUN-CB0001
 
   LET l_table = cl_prt_temptable('axmx761',g_sql) CLIPPED   # 產生Temp Table
   ...
   IF cl_null(g_bgjob) OR g_bgjob = 'N'
      THEN CALL x761_tm(0,0)	
      ELSE CALL x761()		
   END IF
   CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690126
END MAIN
 
FUNCTION x761_tm(p_row,p_col)
DEFINE lc_qbe_sn      LIKE gbm_file.gbm01   #No.FUN-580031
   ...
   OPEN WINDOW x761_w AT p_row,p_col WITH FORM "axm/42f/axmx761"
...
WHILE TRUE
   ...
   IF g_bgjob = 'Y' THEN
      ...
      ELSE
         ...
         CALL cl_cmdat('axmx761',g_time,l_cmd)	# Execute cmd at later time
      END IF
      CLOSE WINDOW x761_w
      CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690126
      EXIT PROGRAM
...
#       l_time          LIKE type_file.chr8         #No.FUN-6A0094
   ...
   DEFINE l_pis      LIKE type_file.chr100   #FUN-CB0001
   ...
   PREPARE x761_p1 FROM l_sql
   IF SQLCA.sqlcode != 0 THEN
      CALL cl_err('prepare:x761_p1',SQLCA.sqlcode,1)
      CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690126
      EXIT PROGRAM
   END IF
   DECLARE x761_c1 CURSOR FOR x761_p1
   ...
   LET l_sql = " SELECT UNIQUE ohe03 ,'',COUNT(ohe03)",
               ...
               "    AND ohe01 = ohc01",
               "    AND ohc02 BETWEEN '",tm.bdate,"' AND '",tm.edate,"'",
               "    AND ohcconf != 'X' ",    #FUN-D40020
               "  GROUP BY ohe03 "
 
   PREPARE x761_p2 FROM l_sql
   IF SQLCA.sqlcode != 0 THEN
      CALL cl_err('prepare:x761_p2',SQLCA.sqlcode,1)
      CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690126
      EXIT PROGRAM
   END IF
   DECLARE x761_c2 CURSOR FOR x761_p2
 
   LET g_pageno = 0
   OPEN x761_c1
   FETCH x761_c1 INTO g_total
   IF SQLCA.sqlcode THEN
       CALL cl_err('fetch:x761_c1',SQLCA.sqlcode,1) RETURN
   END IF
 
   FOREACH x761_c2 INTO sr.*
      IF SQLCA.sqlcode THEN
      ...
      LET l_pis = sr.pis USING '####'  #FUN-CB0001
      LET l_pis = l_pis,'%'  #FUN-CB0001
      EXECUTE insert_prep USING 
              sr.ohe03,sr.ock02,sr.count,sr.pis,g_total,l_pis,l_num1   #FUN-CB0001 add l_pis,l_num1
      #------------------------------ CR (3) ------------------------------#
      #end FUN-720004 add
   END FOREACH
...
###XtraGrid###   CALL cl_prt_cs3('axmx761','axmx761',l_sql,g_str)   #FUN-710080 modify
    ...
    IF g_zz05 = 'Y' THEN
      ...
      LET g_str = tm.wc
   END IF
    LET g_xgrid.order_field = "ohe03"  #FUN-CB0001 add
    LET g_xgrid.footerinfo1 = cl_getmsg('axm-751',g_lang),':',tm.bdate,'-',tm.edate   #FUN-CB0001 add
