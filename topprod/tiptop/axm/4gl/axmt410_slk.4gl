...
#     DEFINE    l_time LIKE type_file.chr8	    #No.FUN-6A0094
   ...
   LET g_prog='axmt410_slk'     #No.FUN-810016                                                                                      
   IF (NOT cl_user()) THEN
      EXIT PROGRAM
   END IF
...
#FUN-B90101--Add--Str---
      IF g_azw.azw04 = '2' THEN  #FUN-C20006 
         OPEN WINDOW t410_w AT p_row,p_col WITH FORM "axm/42f/axmt410_slk"
            ATTRIBUTE (STYLE = g_win_style CLIPPED)
      ELSE                                                                 #FUN-C20006
         OPEN WINDOW t410_w AT p_row,p_col WITH FORM "axm/42f/axmt410"     #FUN-C20006
            ATTRIBUTE (STYLE = g_win_style CLIPPED) #No.FUN-580092 HCN     #FUN-C20006
      END IF                                                               #FUN-C20006
#FUN-B90101--Add
