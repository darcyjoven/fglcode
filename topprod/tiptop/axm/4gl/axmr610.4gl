...
DEFINE lc_qbe_sn      LIKE gbm_file.gbm01   #No.FUN-580031
   ...
   OPEN WINDOW axmr610_w AT p_row,p_col WITH FORM "axm/42f/axmr610"
 ...
 #--------------No.TQC-610089 end
   ...
   CALL cl_opmsg('p')
WHILE TRUE
   CONSTRUCT BY NAME tm.wc ON oga01,oga011,oga02,oga03,oga04,oga14,oga15
...
#No.FUN-7C0007---Begin
         ...
         SELECT ima021 INTO l_ima021 FROM ima_file WHERE ima01=sr.ogb04 
            ...
            EXECUTE insert_prep USING   
                 sr.oga01,sr.oma10,sr.oga02,sr.oga03,sr.oga032,sr.oga04,sr.oga14,sr.oga15,   #MOD-870137  oga011-->oma10
                 sr.ogb03,sr.ogb04,sr.ogb05,sr.ogb06,sr.ogb12,sr.ogb17,sr.ogb31,sr.ogb32,l_occ02,
                 l_gen02,l_gem02,l_ima021,l_str2
...
#     FINISH REPORT axmr610_rep
      IF g_zz05 = 'Y' THEN                                                      
              CALL cl_wcchp(tm.wc,'oga01,oga011,oga02,oga03,oga04,oga14,oga15')                         
              RETURNING tm.wc                                                   
      END IF                                                                    
