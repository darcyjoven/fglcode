...
MAIN
   ...
   CALL cl_used(g_prog,g_time,1) RETURNING g_time 
    ...
    LET l_table = cl_prt_temptable('artr303',g_sql) CLIPPED   # 產生Temp Table                                                      
   ...
   IF cl_null(g_bgjob) OR g_bgjob = 'N'    # If background job sw is off
      THEN CALL artr303_tm(0,0)            # Input print condition
      ELSE CALL artr303()                  # Read data and create out-file
   END IF
   CALL cl_used(g_prog,g_time,2) RETURNING g_time 
END MAIN 

FUNCTION artr303_tm(p_row,p_col)
   ...
   OPEN WINDOW artr303_w AT p_row,p_col WITH FORM "art/42f/artr303"
   ...
   CALL r303_set_entry()       #TQC-BB0034
   CALL r303_setS() RETURNING tm2.s1,tm2.s2,tm2.s3  #TQC-BB0034
...
WHILE TRUE
   ...
   END IF 
   IF INT_FLAG THEN
      LET INT_FLAG = 0 CLOSE WINDOW artr303_w 
      CALL cl_used(g_prog,g_time,2) RETURNING g_time 
      EXIT PROGRAM
   END IF         
   ...
   IF g_bgjob = 'Y' THEN
      ...
      ELSE
         ...
         LET l_cmd = l_cmd CLIPPED,  #(at time fglgo xxxx p1 p2 p3)
                         ...
                         " '",g_template CLIPPED,"'",           
                         " '",g_rpt_name CLIPPED,"'"            
         CALL cl_cmdat('artr303',g_time,l_cmd)      # Execute cmd at later time
      END IF
      CLOSE WINDOW artr303_w
      CALL cl_used(g_prog,g_time,2) RETURNING g_time 
      EXIT PROGRAM
   END IF
   CALL cl_wait()
...
FUNCTION artr303()
   ...
   FOREACH sel_azp01_cs INTO l_plant,l_azp02                                 ##--最外围的FOREACH--
     ...
     END IF
     DECLARE artr303_curs1 CURSOR FOR artr303_p1
  ...
  END FOREACH     
   ...
   CASE
      WHEN tm.t='1'
         CALL cl_prt_cs3('artr303','artr303',l_sql,g_str)  
      WHEN tm.t='2'
         CALL cl_prt_cs3('artr303','artr303_1',l_sql,g_str)
      WHEN tm.t='3'
         CALL cl_prt_cs3('artr303','artr303_2',l_sql,g_str)         
   END CASE
END FUNCTION 
