...
MAIN
   ...
   LET g_sql  = "ruw01.ruw_file.ruw01,",
                ...
                "rux09.rux_file.rux09,"
   LET l_table = cl_prt_temptable('artr210',g_sql) CLIPPED
...
DEFINE p_row,p_col    LIKE type_file.num5,
   ...
   OPEN WINDOW r210_w AT p_row,p_col WITH FORM "art/42f/artr210"
...
FUNCTION artr210()
   ...
   IF g_zz05 = 'Y' THEN
      CALL cl_wcchp(tm.wc,'ruw02,ruw01,ruw04,ruw05,ruw06') 
           RETURNING tm.wc 
      LET g_str =tm.wc  #FUN-BC0026 add
   END IF
  #LET g_str = tm.wc  #FUN-BC0026 mark
   IF tm.store = 'Y' THEN
      CALL cl_prt_cs3('artr210','artr210_1',l_sql,g_str)
   ELSE
      CALL cl_prt_cs3('artr210','artr210_2',l_sql,g_str)
   END IF
END FUNCTION
#FUN-B30207
