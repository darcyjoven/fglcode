...
MAIN
   ...
   LET l_table = cl_prt_temptable('artr142',g_sql) CLIPPED
...
DEFINE p_row,p_col    LIKE type_file.num5,
   ...
   OPEN WINDOW r142_w AT p_row,p_col WITH FORM "art/42f/artr142"
...
FUNCTION artr142()
   ...
   DEFINE sr1         RECORD
     ...
     LET g_posdb_link=r142_dblinks(l_posdb_link)
     ...
     PREPARE r142_prepare1 FROM l_sql
     IF SQLCA.sqlcode != 0 THEN
        CALL cl_err('prepare:',SQLCA.sqlcode,1) 
        CALL cl_used(g_prog,g_time,2) RETURNING g_time
        EXIT PROGRAM
     END IF
     DECLARE r142_cs1 CURSOR FOR r142_prepare1
     FOREACH r142_cs1 INTO sr1.*
...
#FUN-C80043 mark end ----
   ...
   IF g_zz05 = 'Y' THEN
     #CALL cl_wcchp(tm.wc,'oga01,tc_ogb004,tc_ogb008')  #FUN-BC0026 mark
      ...
      LET g_str = tm.wc
   END IF
   LET g_str = g_str,";",tm.saleyear,";",tm.salemonth
   CALL cl_prt_cs3('artr142','artr142',l_sql,g_str)
END FUNCTION

FUNCTION r142_dblinks(l_db_links)
