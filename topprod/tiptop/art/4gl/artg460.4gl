...
MAIN
   ...
   LET l_table = cl_prt_temptable('artg460',g_sql) CLIPPED
   IF  l_table = -1 THEN
   ...
   IF cl_null(g_bgjob) OR g_bgjob = 'N'        # If background job sw is off
      THEN CALL artg460_tm(0,0)        # Input print condition
      ELSE CALL artg460()            # Read data and create out-file
   END IF
   CALL cl_used(g_prog,g_time,2) RETURNING g_time 
   CALL cl_gre_drop_temptable(l_table)     #FUN-BA0062
END MAIN

FUNCTION artg460_tm(p_row,p_col)
   ...
   OPEN WINDOW artg460_w AT p_row,p_col WITH FORM "art/42f/artg460" 
   ...
   WHILE TRUE 
      ...
      IF INT_FLAG THEN
         LET INT_FLAG = 0 CLOSE WINDOW artg460_w 
         CALL cl_used(g_prog,g_time,2) RETURNING g_time 
         CALL cl_gre_drop_temptable(l_table)     #FUN-BA0062
         EXIT PROGRAM
      END IF
      ...
      IF g_bgjob = 'Y' THEN
         ...
         ELSE
            ...
            LET l_cmd = l_cmd CLIPPED,        #(at time fglgo xxxx p1 p2 p3)
                       ...
                       " '",g_template CLIPPED,"'",           
                       " '",g_rpt_name CLIPPED,"'"            
            CALL cl_cmdat('artg460',g_time,l_cmd)    # Execute cmd at later time
         END IF
         CLOSE WINDOW artg460_w
         CALL cl_used(g_prog,g_time,2) RETURNING g_time 
         CALL cl_gre_drop_temptable(l_table)     #FUN-BA0062
         EXIT PROGRAM
      END IF
...
#                  "UNION SELECT lpk01,lpk04,oha87,ohaplant,'',oha02, ",        #TQC-B70204 mark
       ...
       PREPARE artg460_prepare1 FROM l_sql
       IF SQLCA.sqlcode != 0 THEN
          ...
          EXIT PROGRAM
       END IF
       DECLARE artg460_curs1 CURSOR FOR artg460_prepare1
       
       FOREACH artg460_curs1 INTO sr.*
         IF SQLCA.sqlcode != 0 THEN
...
###GENGRE###    CALL cl_prt_cs3('artg460','artg460',l_sql,g_str) 
    CALL artg460_grdata()    ###GENGRE###
END FUNCTION
#FUN-A60075

###GENGRE###START
FUNCTION artg460_grdata()
    DEFINE l_sql    STRING
    ...
    WHILE TRUE
        ...
        LET handler = cl_gre_outnam("artg460")
        IF handler IS NOT NULL THEN
            START REPORT artg460_rep TO XML HANDLER handler
            LET l_sql = "SELECT * FROM ",g_cr_db_str CLIPPED,l_table CLIPPED,
                        " ORDER BY lpk01,oga87"
          
            DECLARE artg460_datacur1 CURSOR FROM l_sql
            FOREACH artg460_datacur1 INTO sr1.*
                OUTPUT TO REPORT artg460_rep(sr1.*)
            END FOREACH
            FINISH REPORT artg460_rep
        END IF
...
REPORT artg460_rep(sr1)
    DEFINE sr1 sr1_t
    DEFINE l_lineno LIKE type_file.num5
    DEFINE l_price  LIKE type_file.num5      #FUN-BA0062
    DEFINE l_amt    LIKE type_file.num5      #FUN-BA0062
    ...
    FORMAT
        ...
        ON EVERY ROW
            ...
            PRINTX l_lineno
            #FUN-BA0062----add----str--------
            LET l_price = sr1.ogb13 * sr1.oga24
            PRINTX l_price

            LET l_amt = sr1.ogb14t * sr1.oga24
            PRINTX l_amt
            #FUN-BA0062----add----end--------
