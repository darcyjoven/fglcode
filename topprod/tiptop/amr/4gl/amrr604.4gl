...
MAIN
   ...
   IF cl_null(g_bgjob) OR g_bgjob='N'  # If background job sw is off
      THEN CALL amrr604_tm(0,0)        # Input print condition
      ELSE CALL amrr604()              # Read data and create out-file
   END IF
   CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690116
END MAIN
 
FUNCTION amrr604_tm(p_row,p_col)
DEFINE lc_qbe_sn       LIKE gbm_file.gbm01     #No.FUN-580031
   ...
   OPEN WINDOW amrr604_w AT p_row,p_col
        WITH FORM "amr/42f/amrr604" 
...
LET tm.wc = tm.wc CLIPPED,cl_get_extra_cond('msuuser', 'msugrup') #FUN-980030
    ...
    IF INT_FLAG THEN
       LET INT_FLAG = 0 CLOSE WINDOW amrr604_w 
       CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690116
       EXIT PROGRAM
   ...
   IF g_bgjob = 'Y' THEN
      ...
      ELSE
         ...
         LET l_cmd = l_cmd CLIPPED,        #(at time fglgo xxxx p1 p2 p3)
                         ...
                         " '",g_rep_clas CLIPPED,"'",  
                         " '",g_template CLIPPED,"'"  
         CALL cl_cmdat('amrr604',g_time,l_cmd)    # Execute cmd at later time
      END IF
      CLOSE WINDOW amrr604_w
      CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690116
      EXIT PROGRAM
   END IF
   CALL cl_wait()
...
#                " msv032,msv16",                                                #No.FUN-850155
                 " msv032,msv16,ima02,ima25,pmc03",                              #No.FUN-850155  
...
#No.FUN-830158--begin--
     ...
     CALL cl_prt_cs1('amrr604','amrr604',l_sql,g_str) 
#    PREPARE amrr604_prepare1 FROM l_sql
#    IF STATUS THEN CALL cl_err('prepare:',STATUS,1) 
#       CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690116
#       EXIT PROGRAM 
#    END IF
#    DECLARE amrr604_curs1 CURSOR FOR amrr604_prepare1
#    LET l_name = 'amrr604.out' 
#    CALL cl_outnam('amrr604') RETURNING l_name
#    START REPORT amrr604_rep TO l_name
#    LET g_pageno = 0
#    FOREACH amrr604_curs1 INTO sr_mrp.*
...
#      OUTPUT TO REPORT amrr604_rep(sr.*,sr_mrp.*)
#    END FOREACH
 
#    FINISH REPORT amrr604_rep
 
#    CALL cl_prt(l_name,g_prtway,g_copies,g_len)
#No.FUN-830158--end--
END FUNCTION
#No.FUN-830158--begin--
#REPORT amrr604_rep(sr,sr_mrp)
