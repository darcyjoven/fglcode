...
#No.FUN-730009 --begin
   ...
   LET l_table = cl_prt_temptable('aqcg340',g_sql) CLIPPED
   IF l_table = -1 THEN 
      CALL cl_used(g_prog,g_time,2) RETURNING g_time     #FUN-B40087
      CALL cl_gre_drop_temptable(l_table||"|"||l_table1||"|"||l_table2||"|"||l_table3||"|"||l_table4||"|"||l_table5||"|"||l_table6||"|"||l_table7||"|"||l_table8)         #FUN-B40087 
      EXIT PROGRAM 
   END IF
   ...
   LET l_table1 = cl_prt_temptable('aqcg3401',g_sql) CLIPPED
   IF l_table1 = -1 THEN 
      CALL cl_used(g_prog,g_time,2) RETURNING g_time     #FUN-B40087
      CALL cl_gre_drop_temptable(l_table||"|"||l_table1||"|"||l_table2||"|"||l_table3||"|"||l_table4||"|"||l_table5||"|"||l_table6||"|"||l_table7||"|"||l_table8)         #FUN-B40087 
      EXIT PROGRAM 
   ...
   LET l_table2 = cl_prt_temptable('aqcg3402',g_sql) CLIPPED
   IF l_table2 = -1 THEN 
      CALL cl_used(g_prog,g_time,2) RETURNING g_time     #FUN-B40087
      CALL cl_gre_drop_temptable(l_table||"|"||l_table1||"|"||l_table2||"|"||l_table3||"|"||l_table4||"|"||l_table5||"|"||l_table6||"|"||l_table7||"|"||l_table8)         #FUN-B40087 
      EXIT PROGRAM 
   ...
   LET l_table3 = cl_prt_temptable('aqcg3403',g_sql) CLIPPED
   IF l_table3 = -1 THEN 
      CALL cl_used(g_prog,g_time,2) RETURNING g_time     #FUN-B40087
      CALL cl_gre_drop_temptable(l_table||"|"||l_table1||"|"||l_table2||"|"||l_table3||"|"||l_table4||"|"||l_table5||"|"||l_table6||"|"||l_table7||"|"||l_table8)         #FUN-B40087 
      EXIT PROGRAM 
   ...
   LET l_table4 = cl_prt_temptable('aqcg3404',g_sql) CLIPPED
   IF l_table4 = -1 THEN 
      CALL cl_used(g_prog,g_time,2) RETURNING g_time     #FUN-B40087
      CALL cl_gre_drop_temptable(l_table||"|"||l_table1||"|"||l_table2||"|"||l_table3||"|"||l_table4||"|"||l_table5||"|"||l_table6||"|"||l_table7||"|"||l_table8)         #FUN-B40087 
      EXIT PROGRAM 
   ...
   LET l_table5 = cl_prt_temptable('aqcg3405',g_sql) CLIPPED
   IF l_table5 = -1 THEN 
      CALL cl_used(g_prog,g_time,2) RETURNING g_time     #FUN-B40087
      CALL cl_gre_drop_temptable(l_table||"|"||l_table1||"|"||l_table2||"|"||l_table3||"|"||l_table4||"|"||l_table5||"|"||l_table6||"|"||l_table7||"|"||l_table8)         #FUN-B40087 
      EXIT PROGRAM 
   ...
   LET l_table6 = cl_prt_temptable('aqcg3406',g_sql) CLIPPED
   IF l_table6 = -1 THEN 
      CALL cl_used(g_prog,g_time,2) RETURNING g_time     #FUN-B40087
      CALL cl_gre_drop_temptable(l_table||"|"||l_table1||"|"||l_table2||"|"||l_table3||"|"||l_table4||"|"||l_table5||"|"||l_table6||"|"||l_table7||"|"||l_table8)         #FUN-B40087 
      EXIT PROGRAM 
   ...
   LET l_table7 = cl_prt_temptable('aqcg3407',g_sql) CLIPPED
   IF l_table7 = -1 THEN 
      CALL cl_used(g_prog,g_time,2) RETURNING g_time     #FUN-B40087
      CALL cl_gre_drop_temptable(l_table||"|"||l_table1||"|"||l_table2||"|"||l_table3||"|"||l_table4||"|"||l_table5||"|"||l_table6||"|"||l_table7||"|"||l_table8)         #FUN-B40087 
      EXIT PROGRAM 
   ...
   LET l_table8 = cl_prt_temptable('aqcg3408',g_sql) CLIPPED
   IF l_table8 = -1 THEN 
      CALL cl_used(g_prog,g_time,2) RETURNING g_time     #FUN-B40087
      CALL cl_gre_drop_temptable(l_table||"|"||l_table1||"|"||l_table2||"|"||l_table3||"|"||l_table4||"|"||l_table5||"|"||l_table6||"|"||l_table7||"|"||l_table8)         #FUN-B40087 
      EXIT PROGRAM 
...
DEFINE lc_qbe_sn      LIKE gbm_file.gbm01   #No.FUN-580031
   ...
   END IF
   OPEN WINDOW g340_w AT p_row,p_col
        WITH FORM "aqc/42f/aqcg340"
...
END CONSTRUCT
   ...
   IF g_bgjob = 'Y' THEN
      ...
      ELSE
         ...
         CALL cl_cmdat('aqcg340',g_time,l_cmd)
      END IF
      CLOSE WINDOW g340_w
      CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690121
      CALL cl_gre_drop_temptable(l_table||"|"||l_table1||"|"||l_table2||"|"||l_table3||"|"||l_table4||"|"||l_table5||"|"||l_table6||"|"||l_table7||"|"||l_table8)
...
#bugno:6010 --> SQL:qcf14 = 'Y' 移除
    ...
    # LET l_sql = "SELECT * FROM qcf_file,OUTER qcg_file ", #TQC-590013 add OUTER
      LET l_sql = "SELECT qcf00,qcf01 ,qcf02 ,qcf021,qcf03 ,qcf04 ,qcf041,qcf05,  ",
                 ...
                 #" FROM  qcf_file,OUTER qcg_file ",   #FUN-C50008 mark--
                  " FROM  qcf_file LEFT OUTER JOIN qcg_file ON qcf01=qcg01 ",   #FUN-C50008 add LEFT OUTER
    #MOD-890053-end-modify
                 #" WHERE qcf_file.qcf01=qcg_file.qcg01 AND qcf18='1' ", #FUN-C50008 mark--
                  " WHERE qcf18='1' ",    #FUN-C50008 add 
               # " WHERE qcf_file.qcf01=qcg_file.qcg01 AND qcf14 = 'Y' AND qcf18='1' ",
                 "   AND ", tm.wc CLIPPED
 
 
     PREPARE g340_prepare1 FROM l_sql
     IF SQLCA.sqlcode != 0 THEN
        ...
        EXIT PROGRAM
     END IF
     DECLARE g340_curs1 CURSOR FOR g340_prepare1
...
#FUN-C50008--add--str
     ...
     DECLARE qde_cur CURSOR FOR 
        SELECT * FROM qde_file WHERE qde01 = ?  AND qde02 =?

     DECLARE s_memo1_c CURSOR FOR
        SELECT * FROM oao_file
         WHERE oao01 =?  AND oao05 IN ('1','2')
           AND oao03=0  ORDER BY oao03
#FUN-C50008--add--end
#No.FUN-730009 --begin
#    CALL cl_outnam('aqcg340') RETURNING l_name
#    START REPORT g340_rep TO l_name
#    LET g_pageno = 0
#No.FUN-730009 --end
     FOREACH g340_curs1 INTO sr.*
         IF SQLCA.sqlcode != 0 THEN
...
#No.FUN-730009 --begin
         ...
         EXECUTE insert_prep USING sr.*,l_gen02,l_ima02,l_ima021,l_ima109,l_azf03_1,l_azf03_2,
                                   l_sfb22,l_sfb221,l_sfb82,l_occ02,l_gem02,l_oea01,l_oea04,l_oea44,"",  l_img_blob,"N",""  # No.FUN-C40020 add
        ...
        #FUN-C50008--mark--end
         FOREACH qao_cur2 USING sr.qcf01,sr.qcg03 INTO l_qao01,l_qao02,l_qao021,l_qao03,l_qao05,l_qao06   #FUN-C50008 add
            IF SQLCA.SQLCODE THEN LET l_qao06=' ' END IF
        ...
        #FUN-C50008--mark--end
         FOREACH qao_cur3 USING sr.qcf01,sr.qcg03 INTO l_qao01,l_qao02,l_qao021,l_qao03,l_qao05,l_qao06  #FUN-C50008 add
            IF SQLCA.SQLCODE THEN LET l_qao06=' ' END IF
        ...
        #FUN-C50008--mark--end
          FOREACH qcu_cur USING sr.qcg01,sr.qcg03 INTO l_qcu.*  #FUN-C50008 add
             LET l_qce03 = NULL
        ...
        #FUN-C50008--mark--end
         FOREACH qde_cur USING sr.qcf01,sr.qcf02 INTO l_qde.*   #FUN-C50008 add
        ...
        #FUN-C50008--mark--end
            FOREACH s_memo1_c USING l_sfb22 INTO l_oao.*  #FUN-C50008 add
                IF SQLCA.SQLCODE THEN
                   EXIT FOREACH
                ELSE
...
#No.FUN-730009 --end
     ...
     #列印整張備註
      LET l_sql = "SELECT qcf01 FROM qcf_file ",
                 " WHERE ",tm.wc CLIPPED,
                 "   ORDER BY qcf01"
      PREPARE g340_prepare2 FROM l_sql
      IF SQLCA.sqlcode != 0 THEN
         ...
         EXIT PROGRAM
      END IF
      DECLARE g340_cs2 CURSOR FOR g340_prepare2

 #FUN-C50008--add--str
      DECLARE qao_cur4 CURSOR FOR 
         SELECT qao01,qao02,qao021,qao03,qao05,qao06 FROM qao_file
          WHERE qao01=? AND qao02=0 AND qao021=0 AND qao03=0 AND qao05='2'

      DECLARE qao_cur1 CURSOR FOR 
         SELECT qao01,qao02,qao021,qao03,qao05,qao06 FROM qao_file
          WHERE qao01=? AND qao02=0 AND qao021=0 AND qao03=0 AND qao05='1'
 #FUN-C50008--add--end

      FOREACH g340_cs2 INTO sr.qcf01   #MOD-890053 modify
      IF SQLCA.sqlcode != 0 THEN
...
#         FOREACH qao_cur4 INTO l_qao01,l_qao02,l_qao021,l_qao03,l_qao05,l_qao06
#FUN-C50008--mark--end
         FOREACH qao_cur4 USING sr.qcf01 INTO l_qao01,l_qao02,l_qao021,l_qao03,l_qao05,l_qao06  #FUN-C50008 add
            IF SQLCA.SQLCODE THEN LET l_qao06=' ' END IF
            EXECUTE insert_prep4 USING l_qao01,l_qao02,l_qao021,l_qao03,l_qao05,l_qao06
         END FOREACH
#FUN-C50008--mark--str 
...
#         FOREACH qao_cur1 INTO l_qao01,l_qao02,l_qao021,l_qao03,l_qao05,l_qao06
#FUN-C50008--mark--end
         FOREACH qao_cur1 USING sr.qcf01 INTO l_qao01,l_qao02,l_qao021,l_qao03,l_qao05,l_qao06  #FUN-C50008 add
            IF SQLCA.SQLCODE THEN LET l_qao06=' ' END IF
            EXECUTE insert_prep1 USING l_qao01,l_qao02,l_qao021,l_qao03,l_qao05,l_qao06
         END FOREACH
...
#No.FUN-730009 --begin
     ...
     CALL cl_wcchp(tm.wc,'qcf01,qcf021,qcf02,qcf13')
          RETURNING tm.wc
###GENGRE###     LET g_str = tm.wc,";",g_zz05,";",tm.b,";",tm.c,";",g_sma.sma115    #No.CHI-830021 add
...
###GENGRE###                 "SELECT * FROM ",g_cr_db_str CLIPPED,l_table7 CLIPPED,"|",
###GENGRE###                 "SELECT * FROM ",g_cr_db_str CLIPPED,l_table8 CLIPPED
  #-------------------No.MOD-820094 end
   # CALL cl_prt_cs3('aqcg340',l_sql,g_str)  #TQC-730113
###GENGRE###     CALL cl_prt_cs3('aqcg340','aqcg340',l_sql,g_str)
    LET g_cr_table = l_table                    # No.FUN-C40020 add
    LET g_cr_apr_key_f = "qcf01"                    # No.FUN-C40020 add
    CALL aqcg340_grdata()    ###GENGRE###
#    FINISH REPORT g340_rep
...
FUNCTION aqcg340_grdata()
    ...
    WHILE TRUE
        ...
        LET handler = cl_gre_outnam("aqcg340")
        IF handler IS NOT NULL THEN
            START REPORT aqcg340_rep TO XML HANDLER handler
            LET l_sql = "SELECT * FROM ",g_cr_db_str CLIPPED,l_table CLIPPED," ORDER BY qcf01,qcg03"
          
            DECLARE aqcg340_datacur1 CURSOR FROM l_sql
            FOREACH aqcg340_datacur1 INTO sr1.*
                OUTPUT TO REPORT aqcg340_rep(sr1.*)
            END FOREACH
            FINISH REPORT aqcg340_rep
        END IF
...
REPORT aqcg340_rep(sr1)
    ...
    FORMAT
        ...
        BEFORE GROUP OF sr1.qcf01
            ...
            IF sr1.qcf21 = 'N' OR sr1.qcf21 = 'T' OR sr1.qcf21 = 'R' THEN
                LET l_qcf21_desc = cl_gr_getmsg("gre-109",g_lang,sr1.qcf21)
            ELSE
                LET l_qcf21_desc = NULL
            END IF
            PRINTX l_qcf21_desc

            LET l_qcf19_qcf20 = sr1.qcf19,'-',sr1.qcf20
            #FUN-C20053-add--str
            IF cl_null(sr1.qcf19) or cl_null(sr1.qcf20) THEN
               LET l_qcf19_qcf20 = ' '
            END IF
            #FUN-C20053--add--end
            PRINTX l_qcf19_qcf20
            LET l_qcf09 = cl_gr_getmsg("gre-028",g_lang,sr1.qcf09)
            PRINTX l_qcf09
           
            LET l_sql = "SELECT * FROM ",g_cr_db_str CLIPPED,l_table1 CLIPPED,
                        " WHERE qao01_1 = '",sr1.qcf01 CLIPPED,"'",
                        " AND qao02_1 = 0 AND qao021_1 = 0 AND qao05_1 = '1'"
            START REPORT aqcg340_subrep01
            DECLARE aqcg340_repcur1 CURSOR FROM l_sql
            FOREACH aqcg340_repcur1 INTO sr2.*
                OUTPUT TO REPORT aqcg340_subrep01(sr2.*)
            END FOREACH
            FINISH REPORT aqcg340_subrep01
            #FUN-B40087  ADD --------END -----
            LET l_lineno = 0
        ...
        ON EVERY ROW
            ...
            PRINTX l_lineno
            #FUN-B40087  ADD --------STR -----
            SELECT sfb22 INTO l_sfb22 FROM sfb_file WHERE sfb01=sr1.qcf02
            IF sr1.qcg05 = "1" THEN
               LET l_qcg05 = "CR"
            ...
            END IF          
            PRINTX l_qcg05
            LET l_qcg08_desc = cl_gr_getmsg("gre-028",g_lang,sr1.qcg08)
            PRINTX l_qcg08_desc
            LET l_azf03_2 = sr1.azf03_2[1,35]
            PRINTX l_azf03_2
              
            LET l_sql = "SELECT * FROM ",g_cr_db_str CLIPPED,l_table2 CLIPPED,
                        " WHERE qao01_2 = '",sr1.qcf01 CLIPPED,"'",
                   #    " AND qao03_2 = ",sr1.qcg03 CLIPPED,
                        " AND qao03_2 = '",sr1.qcg03 CLIPPED,"'",  #FUN-C40020 
                        " AND qao02_2 = 0 AND qao021_2 = 0 AND qao05_2 = '1'"
            START REPORT aqcg340_subrep02
            DECLARE aqcg340_repcur2 CURSOR FROM l_sql
            FOREACH aqcg340_repcur2 INTO sr3.*
                OUTPUT TO REPORT aqcg340_subrep02(sr3.*)
            END FOREACH
            FINISH REPORT aqcg340_subrep02

            LET l_sql = "SELECT * FROM ",g_cr_db_str CLIPPED,l_table5 CLIPPED,
                        " WHERE qcu01 = '",sr1.qcg01 CLIPPED,"'",
                      # " AND qcu03 = ",sr1.qcg03 CLIPPED
                        " AND qcu03 = '",sr1.qcg03 CLIPPED,"'"    #FUN-C40020
            START REPORT aqcg340_subrep05
            DECLARE aqcg340_repcur5 CURSOR FROM l_sql
            FOREACH aqcg340_repcur5 INTO sr6.*
                OUTPUT TO REPORT aqcg340_subrep05(sr6.*)
            END FOREACH
            FINISH REPORT aqcg340_subrep05

            LET l_sql = "SELECT * FROM ",g_cr_db_str CLIPPED,l_table3 CLIPPED,
                        " WHERE qao01_3 = '",sr1.qcf01 CLIPPED,"'",
                     #  " AND qao03_3 = ",sr1.qcg03 CLIPPED,
                        " AND qao03_3 = '",sr1.qcg03 CLIPPED,"'",  #FUN-C40020
                        " AND qao02_3 = 0 AND qao021_3 = 0 AND qao05_3 = '2'"
            START REPORT aqcg340_subrep03
            DECLARE aqcg340_repcur3 CURSOR FROM l_sql
            FOREACH aqcg340_repcur3 INTO sr4.*
                OUTPUT TO REPORT aqcg340_subrep03(sr4.*)
            END FOREACH
            FINISH REPORT aqcg340_subrep03
            #FUN-B40087  ADD --------END -----
        ...
        AFTER GROUP OF sr1.qcf01
            #FUN-B40087  ADD --------STR -----
            SELECT oea04,oea44 INTO l_oea04,l_oea44 FROM oea_file WHERE oea01=l_sfb22

            LET l_sql = "SELECT * FROM ",g_cr_db_str CLIPPED,l_table7 CLIPPED,
                        " WHERE qde01 = '",sr1.qcf01 CLIPPED,"'",
                        " AND qde02 = '",sr1.qcf02 CLIPPED,"'"
            START REPORT aqcg340_subrep07
            DECLARE aqcg340_repcur7 CURSOR FROM l_sql
            FOREACH aqcg340_repcur7 INTO sr8.*
                OUTPUT TO REPORT aqcg340_subrep07(sr8.*)
            END FOREACH
            FINISH REPORT aqcg340_subrep07

            LET l_sql = "SELECT * FROM ",g_cr_db_str CLIPPED,l_table8 CLIPPED,
                        " WHERE oao01 = '",l_sfb22 CLIPPED,"'",
                        " AND oao03 = 0",
                        " AND oao05 IN ('1','2')"
            START REPORT aqcg340_subrep08
            DECLARE aqcg340_repcur8 CURSOR FROM l_sql
            FOREACH aqcg340_repcur8 INTO sr9.*
                OUTPUT TO REPORT aqcg340_subrep08(sr9.*)
            END FOREACH
            FINISH REPORT aqcg340_subrep08

            LET l_sql = "SELECT * FROM ",g_cr_db_str CLIPPED,l_table6 CLIPPED,
                        " WHERE ocf01 = '",l_oea04 CLIPPED,"'",
                        " AND ocf02 = '",l_oea44 CLIPPED,"'"
            START REPORT aqcg340_subrep06
            DECLARE aqcg340_repcur6 CURSOR FROM l_sql
            FOREACH aqcg340_repcur6 INTO sr7.*
                OUTPUT TO REPORT aqcg340_subrep06(sr7.*)
            END FOREACH
            FINISH REPORT aqcg340_subrep06           

            LET l_sql = "SELECT * FROM ",g_cr_db_str CLIPPED,l_table4 CLIPPED,
                        " WHERE qao01_4 = '",sr1.qcf01 CLIPPED,"'",
                        " AND qao03_4 = 0",
                        " AND qao02_4 = 0 AND qao021_4 = 0 AND qao05_4 = '2'"
            START REPORT aqcg340_subrep04
            DECLARE aqcg340_repcur4 CURSOR FROM l_sql
            FOREACH aqcg340_repcur4 INTO sr5.*
                OUTPUT TO REPORT aqcg340_subrep04(sr5.*)
            END FOREACH
            FINISH REPORT aqcg340_subrep04
            #FUN-B40087  ADD --------END -----
...
REPORT aqcg340_subrep06(sr7)
    DEFINE sr1 sr1_t
    DEFINE sr7 sr7_t
    DEFINE l_ocf01_occ02  STRING
    DEFINE l_occ02        LIKE occ_file.occ02

    ORDER EXTERNAL BY sr7.ocf01

    FORMAT
        ON EVERY ROW
            LET l_occ02 = sr1.occ02
            LET l_ocf01_occ02 = sr7.ocf01,' ',l_occ02
            PRINTX l_ocf01_occ02
            PRINTX g_lang
            PRINTX sr7.*
END REPORT

REPORT aqcg340_subrep07(sr8)
    DEFINE sr1            sr1_t
    DEFINE sr8            sr8_t
    DEFINE l_qde09        STRING
    DEFINE l_qde10        STRING
    DEFINE l_qde11        STRING
    DEFINE l_qde09_10_11  STRING   
    DEFINE l_ima02        LIKE ima_file.ima02

    ORDER EXTERNAL BY sr8.qde03

    FORMAT
        ON EVERY ROW
            LET l_ima02 = sr1.ima02
            PRINTX l_ima02
            IF cl_null(sr8.qde09) THEN 
               LET l_qde09 = "(/"
            ELSE
               LET l_qde09 = "(",sr8.qde09,"/"
            END IF
            PRINTX l_qde09
            IF cl_null(sr8.qde10) THEN
               LET l_qde10 = "/"
            ELSE
               LET l_qde10 = sr8.qde09,"/"
            END IF
            PRINTX l_qde10
            IF cl_null(sr8.qde11) THEN
               LET l_qde11 = "0"
            ELSE
               LET l_qde11 = sr8.qde09,")"
            END IF
            PRINTX l_qde11
            LET l_qde09_10_11 = l_qde09,l_qde10,l_qde11
            PRINTX l_qde09_10_11
            PRINTX sr8.*
END REPORT

REPORT aqcg340_subrep08(sr9)
    DEFINE sr9 sr9_t

    ORDER EXTERNAL BY sr9.oao03
