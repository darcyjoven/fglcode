...
#No.FUN-A20051 ---BEGIN
   ...
   LET l_table = cl_prt_temptable('aqcr600',g_sql)
   IF l_table = -1 THEN EXIT PROGRAM END IF
   LET g_sql="INSERT INTO ",g_cr_db_str CLIPPED,l_table CLIPPED,
             " VALUES(?,?,?,?,?, ?,?,?,?,?, ?,?,?,?,?, ?,?,?,?,?, ?,?)"   #MOD-A40001 add 3?
...
################################################################################
   ...
   IF g_bgjob = 'Y' THEN
      ...
      ELSE
         ...
         CALL cl_cmdat('aqcr600',g_time,l_cmd)
      END IF
      CLOSE WINDOW r600_w
      CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690121
      EXIT PROGRAM
...
#                    qdc    RECORD LIKE qdc_file.*
   ...
   SELECT zz05 INTO g_zz05 FROM zz_file WHERE zz01='aqcr600'
#FUN-A20051 ---END 
 
   SELECT zo02 INTO g_company FROM zo_file WHERE zo01 = g_rlang
   SELECT zz17,zz05 INTO g_len,g_zz05 FROM zz_file WHERE zz01 = 'aqcr600'
...
#FUN-A20051 ---END
   ...
   IF SQLCA.sqlcode != 0 THEN
      ...
      EXIT PROGRAM
   END IF
   DECLARE r600_curs1 CURSOR FOR r600_prepare1
#FUN-A20051 ---BEGIN
#  CALL cl_outnam('aqcr600') RETURNING l_name
#  IF tm.ch='1' THEN
#     START REPORT r600_rep1 TO l_name
#  ELSE
#     START REPORT r600_rep2 TO l_name
#  END IF
#  LET g_pageno = 0
#FUN-A20051 ---END

   FOREACH r600_curs1 INTO sr.*
      IF SQLCA.sqlcode != 0 THEN
...
#FUN-A20051 ---BEGIN
      ...
      EXECUTE insert_prep USING
         ...
         sr.qdc07, sr.qdc08
#     IF tm.ch='1' THEN
#        OUTPUT TO REPORT r600_rep1(sr.*)
#     ELSE
#        OUTPUT TO REPORT r600_rep2(sr.*)
#     END IF
#FUN-A20051 ---END
   END FOREACH
...
#  LET g_str = tm.wc,';',tm.bdate,';',tm.edate,';',tm.ans
   LET g_str = tm.wc
   IF tm.ch='1' THEN
      CALL cl_prt_cs3('aqcr600','aqcr600',g_sql,g_str)
   ELSE
      CALL cl_prt_cs3('aqcr600','aqcr600_1',g_sql,g_str)
   END IF
#FUN-A20051 ---END

#FUN-A20051 ---BEGIN 
#     IF tm.ch='1' THEN
#        FINISH REPORT r600_rep1
#     ELSE
#        FINISH REPORT r600_rep2
#     END IF
# 
#     IF tm.ch='1' THEN
