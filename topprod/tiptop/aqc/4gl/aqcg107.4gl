...
TYPE sr1_t RECORD
    ...
    sma115 LIKE sma_file.sma115,   #FUN-C60048 add
    sma541 LIKE sma_file.sma541,   #FUN-C60048 add
...
MAIN
   ...
   LET g_sql =   "qcf00.qcf_file.qcf00,",
                 ...
                 "sma115.sma_file.sma115,",   #FUN-C60048 add
                 "sma541.sma_file.sma541,",   #FUN-C60048 add
   ...
   LET l_table = cl_prt_temptable('aqcg107',g_sql) CLIPPED
...
WHILE TRUE
   ...
   IF g_bgjob = 'Y' THEN
      ...
      ELSE
         ...
         CALL cl_cmdat('aqcg107',g_time,l_cmd)
      END IF
      CLOSE WINDOW r107_w
      CALL cl_used(g_prog,g_time,2) RETURNING g_time 
      CALL cl_gre_drop_temptable(l_table) #FUN-C60048 add
...
#                   "   ORDER BY qco04"                 #TQC-C20295 mark
     ...
     FOREACH r107_curs1 INTO sr.*
         ...
         EXECUTE insert_prep USING sr.*,l_gen02,l_ima02,l_ima021,l_ima109,l_azf03_1,
                                   ...
                                   g_sma.sma115,g_sma.sma541, #FUN-C60048 add
                                   "", l_img_blob, "N",""
    END FOREACH
    ...
    SELECT zz05 INTO g_zz05 FROM zz_file WHERE zz01 = g_prog
     CALL cl_wcchp(tm.wc,'qco01,qco06')
          RETURNING tm.wc
###GENGRE###    LET g_str = tm.wc,";",g_zz05,";",tm.type,";",tm.a,";",g_sma.sma115,";",g_sma.sma541,";"
###GENGRE###    LET l_sql = "SELECT * FROM ",g_cr_db_str CLIPPED,l_table CLIPPED
    LET g_cr_table = l_table                 #主報表的temp table名稱  
    LET g_cr_apr_key_f = "qcf01"       #報表主鍵欄位名稱  
###GENGRE###    CALL cl_prt_cs3('aqcg107','aqcg107',l_sql,g_str)
    CALL aqcg107_grdata()    ###GENGRE###
...
FUNCTION aqcg107_grdata()
    ...
    WHILE TRUE
        ...
        LET handler = cl_gre_outnam("aqcg107")
        IF handler IS NOT NULL THEN
            START REPORT aqcg107_rep TO XML HANDLER handler
            LET l_sql = "SELECT * FROM ",g_cr_db_str CLIPPED,l_table CLIPPED
                        ," ORDER BY qcf01,qco04 " #FUN-C60048 add
            DECLARE aqcg107_datacur1 CURSOR FROM l_sql
            FOREACH aqcg107_datacur1 INTO sr1.*
                OUTPUT TO REPORT aqcg107_rep(sr1.*)
            END FOREACH
            FINISH REPORT aqcg107_rep
        END IF
...
REPORT aqcg107_rep(sr1)
    DEFINE sr1 sr1_t
    DEFINE l_lineno LIKE type_file.num5
    #FUN-C60048 sta
    DEFINE l_gem02_str     STRING 
    ...
    #FUN-C60048 end
    ORDER EXTERNAL BY sr1.qcf01,sr1.qco04
    ...
    FORMAT
        ...
        ON EVERY ROW
            ...
            PRINTX l_lineno
            #FUN-C60048 sta
            LET l_gem02_str = cl_gr_getmsg("gre-284",g_lang,tm.type) 
            LET l_str1 = cl_gr_getmsg("gre-285",g_lang,tm.type) 
            LET l_str2 = cl_gr_getmsg("gre-286",g_lang,tm.type) 
            PRINTX l_gem02_str 
            PRINTX l_str1
            PRINTX l_str2
