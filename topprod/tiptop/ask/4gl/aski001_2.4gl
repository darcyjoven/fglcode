...
FUNCTION i001_2(p_skd01)
   DEFINE p_skd01    LIKE skd_file.skd01
  
    OPEN WINDOW i001_2_w WITH FORM "ask/42f/aski001_2"
          ATTRIBUTE (STYLE = g_win_style CLIPPED) 
       
    CALL cl_ui_locale("aski001_2")
    LET g_skd01=p_skd01
        
    CALL i001_2_menu()
    CLOSE WINDOW i001_2_w                  #結束畫面
 
END FUNCTION
 
FUNCTION i001_2_menu()
...
DEFINE
    ...
    DECLARE i001_2_bcl CURSOR FROM g_forupd_sql      # Lske CURSOR
...
#           LET g_ske[l_ac].ske05 = '0'
            ...
            IF g_rec_b >= l_ac THEN
               ...
               CALL i001_2_set_entry_b(p_cmd)                                                                                         
               CALL i001_2_set_no_entry_b(p_cmd)                                                                                      
               LET g_before_input_done = TRUE                                                                                       
 
#              BEGIN WORK      #MOD-AB0173
 
               OPEN i001_2_bcl USING g_skd01,g_ske02,g_ske_t.ske03
               IF STATUS THEN
                  CALL cl_err("OPEN i001_2_bcl:", STATUS, 1)
                  LET l_lske_sw = "Y"
               ELSE  
                  FETCH i001_2_bcl INTO g_ske[l_ac].* 
...
FUNCTION i001_2_b_fill()              #BODY FILL UP
DEFINE
    p_wc2            STRING  
    ...
    LET g_sql =
        ...
        "   AND ske02='2'",
        " ORDER BY 1"
    PREPARE i001_2_pb FROM g_sql
    DECLARE ske_curs CURSOR FOR i001_2_pb
...
FUNCTION i001_2_set_entry_b(p_cmd)                                                                                                    
...
FUNCTION i001_2_set_no_entry_b(p_cmd)                                                                                                 
