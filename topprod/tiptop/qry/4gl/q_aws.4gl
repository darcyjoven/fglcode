...
#
# Program name  : q_aws.4gl
# Program ver.  : 7.0
# Description   : 使用者執行 "不准" 功能時取得關卡資訊選擇
# Date & Author : 2005/08/11 by Echo
# Memo          : 
# Modify        :
...
FUNCTION q_aws(p_back)
   ...
   OPEN WINDOW w_qry WITH FORM "qry/42f/q_aws" ATTRIBUTE(STYLE="dialog")
 
 
   CALL cl_ui_locale("q_aws")
...
FUNCTION aws_qry_sel()
   ...
   WHILE TRUE
      ...
      CALL aws_qry_set_display_data(li_start_index, li_end_index)
      ...
      MESSAGE li_count CLIPPED || " : " || ma_qry.getLength() || "  " || li_page CLIPPED || " : " || li_curr_page
         ...
         CALL aws_qry_display_array(ls_hide_act, li_start_index, li_end_index) RETURNING li_continue,li_reconstruct,li_start_index
...
# Modify        :
##################################################
FUNCTION aws_qry_set_display_data(pi_start_index, pi_end_index)
...
# Modify   	:
##################################################
FUNCTION aws_qry_input_array(ps_hide_act, pi_start_index, pi_end_index)
   ...
   INPUT ARRAY ma_qry_tmp WITHOUT DEFAULTS FROM s_back.* ATTRIBUTE(INSERT ROW=FALSE, DELETE ROW=FALSE,APPEND ROW=FALSE)
      ...
      ON ACTION reconstruct
         ...
         EXIT INPUT
      ON ACTION accept
         CALL aws_qry_accept(pi_start_index+ARR_CURR()-1)
...
# Modify   	:
##################################################
FUNCTION aws_qry_display_array(ps_hide_act, pi_start_index, pi_end_index)
   DEFINE   ps_hide_act      STRING,
            pi_start_index   LIKE type_file.num10, 	#No.FUN-680131 INTEGER
            pi_end_index     LIKE type_file.num10 	#No.FUN-680131 INTEGER
   DEFINE   li_continue      LIKE type_file.num5,  	#No.FUN-680131 SMALLINT
...
# Modify   	:
##################################################
FUNCTION aws_qry_accept(pi_sel_index)
