...
FUNCTION q_short_qty(pi_multi_sel,pi_need_cons,ps_default1,ps_default2,ps_where,ps_type)
   ...
   ELSE
      RETURN ms_ret1,ms_ret2,ms_ret3,ms_ret4,ms_ret5,ms_ret6,ms_ret7  #回傳值(也許有多個).  #FUN-A60028 add ms_ret6,ms_ret7
   END IF
END FUNCTION
