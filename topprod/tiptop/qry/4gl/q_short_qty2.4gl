...
FUNCTION q_short_qty2(pi_multi_sel,pi_need_cons,ps_default1,ps_default2,ps_where,ps_type)
...
# Modify        :
##################################################
FUNCTION short_qty_qry_prep_result_set2()
...
# Modify        :
##################################################
FUNCTION short_qty_qry_set_display_data2(pi_start_index, pi_end_index)
...
# Modify   	:
##################################################
FUNCTION short_qty_qry_input_array2(ps_hide_act, pi_start_index, pi_end_index)
...
# Modify   	:
##################################################
FUNCTION short_qty_qry_reset_multi_sel2(pi_start_index, pi_end_index)
   DEFINE   pi_start_index   LIKE type_file.num10, 	#No.FUN-680131 INTEGER
            pi_end_index     LIKE type_file.num10 	#No.FUN-680131 INTEGER
   DEFINE   li_i             LIKE type_file.num10, 	#No.FUN-680131 INTEGER
            li_j             LIKE type_file.num10 	#No.FUN-680131 INTEGER
...
# Modify   	:
##################################################
FUNCTION short_qty_qry_display_array2(ps_hide_act, pi_start_index, pi_end_index)
   DEFINE   ps_hide_act      STRING,
            pi_start_index   LIKE type_file.num10, 	#No.FUN-680131 INTEGER
            pi_end_index     LIKE type_file.num10 	#No.FUN-680131 INTEGER
   DEFINE   li_continue      LIKE type_file.num5,  	#No.FUN-680131 SMALLINT
...
# Modify        :
##################################################
FUNCTION short_qty_qry_refresh2()
   DEFINE   li_i   LIKE type_file.num10 	#No.FUN-680131 INTEGER
...
# Modify   	:
##################################################
FUNCTION short_qty_qry_accept2(pi_sel_index)
