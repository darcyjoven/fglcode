   ...
   WHILE TRUE
      ...
      IF (li_reconstruct) THEN
         ...
         IF (mi_need_cons) THEN
            CONSTRUCT BY NAME ms_cons_where ON oea01,oea02,oeb03,oeb04,oeb06,ima021,oeb091,oeb12,  #TQC-C60093 add oeb06,ima021
...
FUNCTION oeb_qry_prep_result_set_oeb10()
   ...
   IF cl_null(ms_oga16) THEN   #MOD-8C0110
     #LET ls_sql = "SELECT 'N',oea01,oea02,oeb03,oeb04,oeb091,(oeb12-oeb24+oeb25),oeb24,oeb15",              #TQC-780032 mark #MOD-780285 modify -oeb24  #MOD-7B0195 +oeb25
      ...
      END IF
      #End:FUN-980030
      LET ls_sql = "SELECT 'N',oea01,oea02,oeb03,oeb04,oeb06,ima021,oeb091,oeb12,oeb24,oeb25,(oeb12-oeb24+oeb25),oeb15",  #TQC-780032 mod  #MOD-780285 modify -oeb24  #MOD-7B0195 +oeb25   #TQC-C60093 add oeb06,ima021
...
#FUN-C50097 ------------add start----------------
               ...
               IF cl_null(mr_ogb.ogb54) THEN
                 LET  mr_ogb.ogb54 = '0'
               END IF
   # str-----------------出货单带订单备注  add by ly 170907
               IF cl_null(mr_ogb.ogbud01) THEN
                  LET mr_ogb.ogbud01=mr_oeb.oebud01
               END IF
   #str  ---------add end-----------------ly 170907      
