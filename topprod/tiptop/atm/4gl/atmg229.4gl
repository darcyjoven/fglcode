...
# Modify.........: No:FUN-B40097 11/05/26 By chenying 憑證類CR報表轉成GR
# Modify.........: No:FUN-B80061 11/08/05 By Lujh 模組程序撰寫規範修正
# Modify.........: No:FUN-C10036 12/01/16 By yangtt 程序撰寫規範修正
# Modify.........: No:FUN-C20052 12/02/13 By chenying GR調整
# Modify.........: No.FUN-C40036 12/04/11 By xujing   GR報表列印TIPTOP與EasyFlow簽核圖片
# Modify.........: No.FUN-C50007 12/05/15 By minpp GR程序优化
DATABASE ds
...
TYPE sr3_t RECORD
    tqr01 LIKE tqr_file.tqr01,
    tqr02 LIKE tqr_file.tqr02,
    tqr03 LIKE tqr_file.tqr03,
    tqr04 LIKE tqr_file.tqr04,
    tqr05 LIKE tqr_file.tqr05,
    azi04 LIKE azi_file.azi04,
    azi07 LIKE azi_file.azi07,
    tqr_n LIKE type_file.num10
END RECORD

TYPE sr4_t RECORD
    tqs01 LIKE tqs_file.tqs01,
    ...
    tqa022 LIKE tqa_file.tqa02,
    azi07 LIKE azi_file.azi07,
    tqs_n LIKE type_file.num10
END RECORD

TYPE sr5_t RECORD
    tqt01 LIKE tqt_file.tqt01,
    tqt02 LIKE tqt_file.tqt02,
    tqa023 LIKE tqa_file.tqa02,
    tqt_n LIKE type_file.num10
END RECORD

TYPE sr6_t RECORD
    tqu01 LIKE tqu_file.tqu01,   #FUN-B40097 add
    tqu14 LIKE tqu_file.tqu14,
    tqu02 LIKE tqu_file.tqu02,
    tqu03 LIKE tqu_file.tqu03,
    tqu04 LIKE tqu_file.tqu04,
    tqu05 LIKE tqu_file.tqu05,
    tqu07 LIKE tqu_file.tqu07,
    tqu06 LIKE tqu_file.tqu06,
    tqu08 LIKE tqu_file.tqu08,
    tqu09 LIKE tqu_file.tqu09,
    tqu11 LIKE tqu_file.tqu11,
    tqu12 LIKE tqu_file.tqu12,
    tqu_n LIKE type_file.num10
END RECORD
###GENGRE###END
...
MAIN
   ...
   IF (NOT cl_setup("ATM")) THEN
      EXIT PROGRAM
   END IF
#  CALL cl_used(g_prog,g_time,1) RETURNING g_time #No.FUN-690124    #FUN-C10036 mark
#No.TQC-810004---Begin                                                                                                              
   ...
   LET l_table = cl_prt_temptable('atmg229',g_sql) CLIPPED                                                                          
   IF l_table = -1 THEN 
#     CALL cl_used(g_prog,g_time,2) RETURNING g_time     #FUN-B40097        #FUN-C10036 mark                                                 
#     CALL cl_gre_drop_temptable(l_table||"|"||l_table1||"|"||l_table2||"|"||l_table3||"|"||l_table4||"|"||l_table5)         #FUN-B40097    #FUN-C10036 mark
      EXIT PROGRAM 
   END IF
   ...
   LET l_table1 = cl_prt_temptable('atmg2291',g_sql) CLIPPED                                                                        
   IF l_table1 = -1 THEN 
#     CALL cl_used(g_prog,g_time,2) RETURNING g_time     #FUN-B40097        #FUN-C10036 mark                                                 
#     CALL cl_gre_drop_temptable(l_table||"|"||l_table1||"|"||l_table2||"|"||l_table3||"|"||l_table4||"|"||l_table5)         #FUN-B40097    #FUN-C10036 mark
      EXIT PROGRAM 
   ...
   LET l_table2 = cl_prt_temptable('atmg2292',g_sql) CLIPPED                                                                        
   IF l_table2 = -1 THEN 
#     CALL cl_used(g_prog,g_time,2) RETURNING g_time     #FUN-B40097         #FUN-C10036 mark                                                
#     CALL cl_gre_drop_temptable(l_table||"|"||l_table1||"|"||l_table2||"|"||l_table3||"|"||l_table4||"|"||l_table5)         #FUN-B40097   #FUN-C10036 mark
      EXIT PROGRAM 
   ...
   LET l_table3 = cl_prt_temptable('atmg2293',g_sql) CLIPPED                                                                        
   IF l_table3 = -1 THEN 
#     CALL cl_used(g_prog,g_time,2) RETURNING g_time     #FUN-B40097     #FUN-C10036 mark                                                    
#     CALL cl_gre_drop_temptable(l_table||"|"||l_table1||"|"||l_table2||"|"||l_table3||"|"||l_table4||"|"||l_table5)         #FUN-B40097     #FUN-C10036 mark
      EXIT PROGRAM 
   ...
   LET l_table4 = cl_prt_temptable('atmg2294',g_sql) CLIPPED                                                                        
   IF l_table4 = -1 THEN 
#     CALL cl_used(g_prog,g_time,2) RETURNING g_time     #FUN-B40097     #FUN-C10036 mark                                                    
#     CALL cl_gre_drop_temptable(l_table||"|"||l_table1||"|"||l_table2||"|"||l_table3||"|"||l_table4||"|"||l_table5)         #FUN-B40097  #FUN-C10036 mark
      EXIT PROGRAM 
...
#No.TQC-810004---End                     
   #CHI-AB0028 add --start--
   LET g_sql = "tqu01.tqu_file.tqu01,",  #FUN-B40097 add
               "tqu14.tqu_file.tqu14,",                                                                                             
   ...
   LET l_table5 = cl_prt_temptable('atmg2295',g_sql) CLIPPED                                                                        
   IF l_table5 = -1 THEN 
   #  CALL cl_used(g_prog,g_time,2) RETURNING g_time     #FUN-B40097                      #FUN-C10036 mark                                   
   #  CALL cl_gre_drop_temptable(l_table||"|"||l_table1||"|"||l_table2||"|"||l_table3||"|"||l_table4||"|"||l_table5)         #FUN-B40097  #FUN-C10036 mark
      EXIT PROGRAM 
  ...
  #     CALL atmg229()                   # Read data and create out-file
  #END IF
  #CHI-AB0028 mark --end--
  #CHI-AB0028 add --start--
   IF cl_null(g_bgjob) OR g_bgjob = 'N' THEN
        CALL atmg229_tm(0,0)             # Input print condition
   ELSE
        CALL atmg229()                   # Read data and create out-file
   END IF
  #CHI-AB0028 add --end--
...
FUNCTION atmg229_tm(p_row,p_col)
DEFINE lc_qbe_sn      LIKE gbm_file.gbm01   
   ...
   OPEN WINDOW atmg229_w AT p_row,p_col WITH FORM "atm/42f/atmg229"
       ATTRIBUTE (STYLE = g_win_style CLIPPED)
 
   CALL cl_ui_init()
   CALL cl_opmsg('p')
   LET g_bgjob = 'N'   #FUN-C50007
...
WHILE TRUE
  ...
  END CONSTRUCT
   ...
   IF INT_FLAG THEN
      LET INT_FLAG = 0 CLOSE WINDOW atmg229_w 
      CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690124
      CALL cl_gre_drop_temptable(l_table||"|"||l_table1||"|"||l_table2||"|"||l_table3||"|"||l_table4||"|"||l_table5)
      EXIT PROGRAM
   ...
   LET tm.more = 'N'
   #CHI-AB0028 add --end--
   LET g_pdate = g_today   #FUN-C20052 add
   ...
   IF g_bgjob = 'Y' THEN
      ...
      ELSE
         ...
         CALL cl_cmdat('atmg229',g_time,l_cmd)    
      END IF
      CLOSE WINDOW atmg229_w
      CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690124
      CALL cl_gre_drop_temptable(l_table||"|"||l_table1||"|"||l_table2||"|"||l_table3||"|"||l_table4||"|"||l_table5)
      EXIT PROGRAM
   END IF
...
#No.TQC-810004---Begin                                                                                                              
   ...
   IF STATUS THEN                                                                                                                   
      ...
      CALL cl_gre_drop_temptable(l_table||"|"||l_table1||"|"||l_table2||"|"||l_table3||"|"||l_table4||"|"||l_table5)         #FUN-B40097
      EXIT PROGRAM                                                                             
   END IF                                                                                                                           
...
SELECT zz05 INTO g_zz05 FROM zz_file WHERE zz01 = g_prog      #No.TQC-810004
     ...
     #End:FUN-980030
      ...
      LET l_sql="SELECT tqp01,tqp02,tqp03,tqp05,tqp06,tqp22,",  
          #    "       tqp07,tqp21,tqp12,tqp13",     #FUN-C50007 mark
          #    "  FROM tqp_file ",                   #FUN-C50007 mark
               "       tqp07,tqp21,tqp12,tqp13,tqa02,gec02 ",                        #FUN-C50007
               " FROM tqp_file LEFT OUTER JOIN tqa_file  ON tqp03=tqa01 AND tqa03='13'", #FUN-C50007
               " LEFT OUTER JOIN gec_file ON gec01=tqp22 AND gec011='2'",                     #FUN-C50007 
               " WHERE ",tm.wc CLIPPED,
               " ORDER BY tqp01 "
     PREPARE atmg229_prepare1 FROM l_sql
     IF STATUS THEN CALL cl_err('prepare:',STATUS,1) 
        CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690124
        CALL cl_gre_drop_temptable(l_table||"|"||l_table1||"|"||l_table2||"|"||l_table3||"|"||l_table4||"|"||l_table5)
        EXIT PROGRAM 
     END IF
     DECLARE atmg229_curs1 CURSOR FOR atmg229_prepare1
...
#     ELSE
#        CALL cl_outnam('atmg229') RETURNING l_name
#     END IF
 
#     START REPORT atmg229_rep TO l_name
...
#No.TQC-810004---End 
     ...
     LET l_sql = "SELECT tqs_file.* ,oaj02 ",
                              " FROM tqs_file LEFT OUTER JOIN oaj_file ON tqs03=oaj01",
                              " WHERE tqs01 = ? "
                  PREPARE tqs_p1 FROM l_sql
                  IF SQLCA.SQLCODE THEN CALL cl_err('tqs_p1',SQLCA.SQLCODE,1) END IF
                  DECLARE tqs_c1  CURSOR FOR tqs_p1
     
     LET l_sql = "SELECT tqt_file.* ,tqa02 ",
                              " FROM tqt_file LEFT OUTER JOIN tqa_file ON tqa01=tqt02  and  tqa03='3' ",
                              " WHERE tqt01 = ? "
     ...
     #FUN-C50007--ADD--END
     #FOREACH atmg229_curs1 INTO sr.*                 #FUN-C50007  mark
      FOREACH atmg229_curs1 INTO sr.*,l_tqa02,l_gec02 #FUN-C50007  end
...
#No.TQC-810004---Begin             
    ...
    #FUN-C50007--mod--end            
            OPEN tqq_c1  USING sr.tqp01    #FUN-C50007 add
            FOREACH tqq_c1 INTO l_tqq.*    #FUN-C50007 add                                                          
 	 ...
 	 CALL cl_parse_qry_sql(l_sql, l_tqq.tqq06) RETURNING l_sql  #FUN-A50102
            ...
            IF tm.a = 'Y' THEN                                                                                                      
                 ...
                 #OPEN tqr_c1           
                 #FUN-C50007--MARK--END                         
                  OPEN tqr_c1 USING sr.tqp01   #FUN-C50007   add                                                                   
     ...
     IF tm.b = 'Y' THEN                                                                                                      
                 ...
                 #OPEN tqs_c1          
                 #FUN-C50007--mark--end
                  OPEN tqs_c1 USING sr.tqp01                 #FUN-C50007   add                                                                            
                  FOREACH tqs_c1 INTO l_tqs.*,l_tqa022       #FUN-C50007   add-l_tqa022                                                                                
                     SELECT COUNT(*) INTO l_tqs_n FROM tqs_file WHERE tqs01 = sr.tqp01                                              
                 #   SELECT oaj02 INTO l_tqa022 FROM oaj_file WHERE oaj01=l_tqs.tqs03   #FUN-C50007  MARK                                            
          ...
          IF tm.c = 'Y' THEN                                                                                                        
              ...
              # OPEN tqt_c1          
              #FUN-C50007--MARK--END                
                OPEN tqt_c1 USING sr.tqp01   #FUN-C50007  ADD                                                                             
                FOREACH tqt_c1 INTO l_tqt.*,l_tqa023        #FUN-C50007   add--l_tqa023                                                                                  
                  SELECT COUNT(*) INTO l_tqt_n FROM tqt_file WHERE tqt01 = sr.tqp01                                                 
               #  SELECT tqa02 INTO l_tqa023 FROM tqa_file WHERE tqa01=l_tqt.tqt02 and tqa03='3'  #FUN-C50007 mark                                  
          ...
          END IF                                                                                                                    
            ...
            IF tm.d = 'Y' THEN              
               ...
               #OPEN tqu_c1          
               #FUN-C50007--MARK--END
                OPEN tqu_c1 USING sr.tqp01     #FUN-C50007 add                                                                                               
                FOREACH tqu_c1 INTO l_tqu.*                                                                                         
                   SELECT COUNT(*) INTO l_tqu_n FROM tqu_file WHERE tqu01 = sr.tqp01                                                 
                   EXECUTE insert_prep5 USING  l_tqu.tqu01,           #FUN-B40097 add
                                               l_tqu.tqu14,l_tqu.tqu02,l_tqu.tqu03,                                               
        ...
        EXECUTE insert_prep USING sr.tqp01,sr.tqp02,sr.tqp03,sr.tqp05,sr.tqp06,                                                     
                                  ...
                                  l_tqa02,l_tqa021,l_gec02      
                                  ,"",l_img_blob,"N",""                        #FUN-C40036 add                                                                    
#       OUTPUT TO REPORT atmg229_rep(sr.*)                                                                                          
#No.TQC-810004---End      
     END FOREACH
#No.TQC-810004---Begin                                                                                                              
#     FINISH REPORT atmg229_rep                                                                                                     
      IF g_zz05 = 'Y' THEN                                                                                                          
         CALL cl_wcchp(tm.wc,'tqp01,tqp06,tqp07')                                                                                   
              RETURNING tm.wc                                                                                                       
      ELSE         #FUN-C40036 add
         CALL cl_wcchp(tm.wc,'tqp01') RETURNING tm.wc     #FUN-C40036 add
      END IF                                                                                                                        
###GENGRE###      LET g_str=tm.wc ,";",tm.a,";",tm.b,";",tm.c,";",tm.d  #CHI-AB0028 add tm.d                                                                                   
...
###GENGRE###               "SELECT * FROM ", g_cr_db_str CLIPPED, l_table4 CLIPPED, "|", #CHI-AB0028 add ,"|",                                                              
###GENGRE###               "SELECT * FROM ", g_cr_db_str CLIPPED, l_table5 CLIPPED       #CHI-AB0028 add                                                       
###GENGRE###   CALL cl_prt_cs3('atmg229','atmg229',l_sql,g_str)      
 
    LET g_cr_table = l_table                   #主報表的temp table名稱         #FUN-C40036 add
    LET g_cr_apr_key_f = "tqp01"       #報表主鍵欄位名稱，用"|"隔開  #FUN-C40036 add                                                                           
    CALL atmg229_grdata()    ###GENGRE###
#     CALL cl_prt(l_name,g_prtway,g_copies,g_len)                                                                                   
#No.TQC-810004---End  
END FUNCTION
#No.TQC-810004---Begin 
#REPORT atmg229_rep(sr)
#   DEFINE l_tqa02  LIKE tqa_file.tqa02
#   DEFINE l_tqa021 LIKE tqa_file.tqa02
#   DEFINE l_gec02  LIKE gec_file.gec02
#   DEFINE l_azp02  LIKE azp_file.azp02
...
FUNCTION atmg229_grdata()
    ...
    WHILE TRUE
        ...
        LET handler = cl_gre_outnam("atmg229")
        IF handler IS NOT NULL THEN
            START REPORT atmg229_rep TO XML HANDLER handler
            LET l_sql = "SELECT * FROM ",g_cr_db_str CLIPPED,l_table CLIPPED,
                        " ORDER BY tqp01"    #FUN-C20052 add
           
            DECLARE atmg229_datacur1 CURSOR FROM l_sql
            FOREACH atmg229_datacur1 INTO sr1.*
                OUTPUT TO REPORT atmg229_rep(sr1.*)
            END FOREACH
            FINISH REPORT atmg229_rep
        END IF
...
REPORT atmg229_rep(sr1)
    ...
    DEFINE l_sql         STRING  #FUN-B40097
    
    ORDER EXTERNAL BY sr1.tqp01
    ...
    FORMAT
        ...
        ON EVERY ROW
            ...
            LET l_sql = "SELECT * FROM ",g_cr_db_str CLIPPED,l_table1 CLIPPED,
                        " WHERE tqq01 = '",sr1.tqp01 CLIPPED,"'",
                        " ORDER BY tqq02"  #FUN-C20052
            START REPORT atmg229_subrep01
            DECLARE atmg229_repcur1 CURSOR FROM l_sql
            FOREACH atmg229_repcur1 INTO sr2.*
                 OUTPUT TO REPORT atmg229_subrep01(sr2.*)
            END FOREACH
            FINISH REPORT atmg229_subrep01            

            LET l_sql = "SELECT * FROM ",g_cr_db_str CLIPPED,l_table2 CLIPPED,
                        " WHERE tqr01 = '",sr1.tqp01 CLIPPED,"'"      
            START REPORT atmg229_subrep02
            DECLARE atmg229_repcur2 CURSOR FROM l_sql
            FOREACH atmg229_repcur2 INTO sr3.*
                OUTPUT TO REPORT atmg229_subrep02(sr3.*)
            END FOREACH
            FINISH REPORT atmg229_subrep02  

            LET l_sql = "SELECT * FROM ",g_cr_db_str CLIPPED,l_table3 CLIPPED,
                        " WHERE tqs01 = '",sr1.tqp01 CLIPPED,"'",
                        " ORDER BY tqs02"    #FUN0-C20052
            START REPORT atmg229_subrep03
            DECLARE atmg229_repcur3 CURSOR FROM l_sql
            FOREACH atmg229_repcur3 INTO sr4.*
                OUTPUT TO REPORT atmg229_subrep03(sr4.*)
            END FOREACH
            FINISH REPORT atmg229_subrep03


            LET l_sql = "SELECT * FROM ",g_cr_db_str CLIPPED,l_table5 CLIPPED,
                        " WHERE tqu01 = '",sr1.tqp01 CLIPPED,"'",
                        " ORDER BY tqu14"   #FUN-C20052
            START REPORT atmg229_subrep05
            DECLARE atmg229_repcur5 CURSOR FROM l_sql
            FOREACH atmg229_repcur5 INTO sr6.*
                OUTPUT TO REPORT atmg229_subrep05(sr6.*)
            END FOREACH
            FINISH REPORT atmg229_subrep05

            LET l_sql = "SELECT * FROM ",g_cr_db_str CLIPPED,l_table4 CLIPPED,
                        " WHERE tqt01 = '",sr1.tqp01 CLIPPED,"'"
            START REPORT atmg229_subrep04
            DECLARE atmg229_repcur4 CURSOR FROM l_sql
            FOREACH atmg229_repcur4 INTO sr5.*
                OUTPUT TO REPORT atmg229_subrep04(sr5.*)
            END FOREACH
            FINISH REPORT atmg229_subrep04
            #FUN-B40097---add---end-------------------------------
...
REPORT atmg229_subrep02(sr3)
    DEFINE sr3 sr3_t
    DEFINE l_tqr02       STRING
    DEFINE l_tqr03_fmt   STRING  
    DEFINE l_tqr04_fmt   STRING  
    DEFINE l_tqr05_fmt   STRING  

    FORMAT
        ON EVERY ROW
           LET l_tqr03_fmt = cl_gr_numfmt('tqr_file','tqr03',sr3.azi04)
           PRINTX l_tqr03_fmt
           LET l_tqr04_fmt = cl_gr_numfmt('tqr_file','tqr04',sr3.azi04)
           PRINTX l_tqr04_fmt
           LET l_tqr05_fmt = cl_gr_numfmt('tqr_file','tqr05',sr3.azi07)
           PRINTX l_tqr05_fmt
           LET l_tqr02 = cl_gr_getmsg("gre-060",g_lang,sr3.tqr02)
           PRINTX l_tqr02
           PRINTX sr3.*
END REPORT

REPORT atmg229_subrep03(sr4)
    DEFINE sr4 sr4_t
    DEFINE sr3 sr3_t
    DEFINE l_tqs04       STRING
    DEFINE l_tqs08_fmt   STRING

    FORMAT
        ON EVERY ROW
           LET l_tqs08_fmt = cl_gr_numfmt('tqs_file','tqs08',sr4.azi07)
           PRINTX l_tqs08_fmt
           LET l_tqs04 = cl_gr_getmsg("gre-061",g_lang,sr4.tqs04)
           PRINTX l_tqs04 
           PRINTX sr4.*
END REPORT

REPORT atmg229_subrep04(sr5)
    DEFINE sr5 sr5_t
...
REPORT atmg229_subrep05(sr6)
    DEFINE sr6 sr6_t
    DEFINE l_tqu02   STRING
    DEFINE l_tqu05   STRING
    DEFINE l_tqu07   STRING

    FORMAT
        ON EVERY ROW
           LET l_tqu02 = cl_gr_getmsg("gre-062",g_lang,sr6.tqu02)
           LET l_tqu05 = cl_gr_getmsg("gre-060",g_lang,sr6.tqu05)
           LET l_tqu07 = cl_gr_getmsg("gre-063",g_lang,sr6.tqu07) 
           PRINTX l_tqu02
           PRINTX l_tqu05
           PRINTX l_tqu07
