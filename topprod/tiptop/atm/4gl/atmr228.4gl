...
END GLOBALS
 ...
 DEFINE tm  RECORD                         # Print condition RECORD
            ...
            a       LIKE type_file.chr1,             # Prog. Version..: '5.30.06-13.03.12(01)            # 是否打印產品價格明細
...
#No.FUN-850152 --Begin
   ...
   LET l_table1=cl_prt_temptable('atmr228',g_sql1)
   ...
   LET l_table2=cl_prt_temptable('atmr228_sub',g_sql2)
...
#No.FUN-850152 --End
   ...
   IF cl_null(tm.wc) THEN
        CALL atmr228_tm(0,0)             # Input print condition
   ELSE LET tm.wc="tqo01= '",tm.wc CLIPPED,"'"
        CALL atmr228()                   # Read data and create out-file
   END IF
   CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690124
END MAIN
 
FUNCTION atmr228_tm(p_row,p_col)
DEFINE lc_qbe_sn      LIKE gbm_file.gbm01   
   ...
   OPEN WINDOW atmr228_w AT p_row,p_col WITH FORM "atm/42f/atmr228"
...
WHILE TRUE
  ...
  END CONSTRUCT
   ...
   IF INT_FLAG THEN
      LET INT_FLAG = 0 CLOSE WINDOW atmr228_w 
      CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690124
      EXIT PROGRAM
   ...
   IF g_bgjob = 'Y' THEN
      ...
      ELSE
         ...
         LET l_cmd = l_cmd CLIPPED,        
                         ...
                         " '",g_rep_clas CLIPPED,"'",
                         " '",g_template CLIPPED,"'"
         CALL cl_cmdat('atmr228',g_time,l_cmd)    
      END IF
      CLOSE WINDOW atmr228_w
      CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690124
      EXIT PROGRAM
   END IF
   CALL cl_wait()
...
#No.FUN-850152 --Begin
     ...
     SELECT zz05 INTO g_zz05 FROM zz_file WHERE zz01='atmr228'
#No.FUN-850152 --End
     ...
     PREPARE atmr228_prepare1 FROM l_sql
     IF STATUS THEN CALL cl_err('prepare:',STATUS,1) 
        CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690124
        EXIT PROGRAM 
     END IF
     DECLARE atmr228_curs1 CURSOR FOR atmr228_prepare1
...
#    ELSE
#       CALL cl_outnam('atmr228') RETURNING l_name
#    END IF
#    IF tm.a='Y' THEN
...
#    START REPORT atmr228_rep TO l_name
 
#    LET g_pageno = 0
#No.FUN-850152 --End
     FOREACH atmr228_curs1 INTO sr.*
...
#       OUTPUT TO REPORT atmr228_rep(sr.*)
#No.FUN-850152 --End
     END FOREACH
 
#No.FUN-850152 --Begin
#    FINISH REPORT atmr228_rep
...
#    CALL cl_prt(l_name,g_prtway,g_copies,g_len)
     ...
     IF tm.a='Y' THEN
         ...
         CALL cl_prt_cs3('atmr228','atmr228',g_sql,g_str)
     ELSE
         LET g_sql=" SELECT * FROM ",g_cr_db_str CLIPPED,l_table1 CLIPPED
         CALL cl_prt_cs3('atmr228','atmr228_1',g_sql,g_str)
     END IF
#No.FUN-850152 --End
END FUNCTION
 
#No.FUN-850152 --Begin
#REPORT atmr228_rep(sr)
