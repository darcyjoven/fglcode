...
MAIN
   ...
   LET l_table = cl_prt_temptable('atmr260',g_sql)
   ...
   LET l_table1 = cl_prt_temptable('atmr260_1',g_sql)                              
   ...
   IF cl_null(tm.wc) THEN
        CALL atmr260_tm(0,0)             # Input print condition
   ELSE LET tm.wc="tsc01= '",tm.wc CLIPPED,"'"
        CALL atmr260()                   # Read data and create out-file
   END IF
   CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690124
END MAIN
 
FUNCTION atmr260_tm(p_row,p_col)
...
DEFINE p_row,p_col  LIKE type_file.num5,         #No.FUN-680120 SMALLINT
  ...
  OPEN WINDOW atmr260_w AT p_row,p_col WITH FORM "atm/42f/atmr260"
...
#              LET g_qryparam.form ="q_tqe01"
    ...
    IF INT_FLAG THEN
       LET INT_FLAG = 0 CLOSE WINDOW atmr260_w 
       CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690124
       EXIT PROGRAM
   ...
   IF g_bgjob = 'Y' THEN
      ...
      ELSE
         ...
         LET l_cmd = l_cmd CLIPPED,
                     ...
                     " '",g_rep_clas CLIPPED,"'",
                     " '",g_template CLIPPED,"'"  
         CALL cl_cmdat('atmr260',g_time,l_cmd)    
      END IF
      CLOSE WINDOW atmr260_w
      CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690124
      EXIT PROGRAM
   END IF
   CALL cl_wait()
...
#NO.FUN-860007----END-------  
     ...
     PREPARE atmr260_prepare1 FROM l_sql
     IF STATUS THEN CALL cl_err('prepare:',STATUS,1) 
        CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690124
        EXIT PROGRAM 
     END IF
     DECLARE atmr260_curs1 CURSOR FOR atmr260_prepare1
     ...
     #ELSE
     #   CALL cl_outnam('atmr260') RETURNING l_name
     #END IF
 
     #START REPORT atmr260_rep TO l_name     
 
     #LET g_pageno = 0                       
     #NO.FUN-860007------end------
     FOREACH atmr260_curs1 INTO sr.*
      ...
      LET l_sql1=" SELECT tsd02,tsd03,tsd12,tsd13,tsd14,tsd04,tsd05, ",
                      ...
                      " ORDER BY tsd02 "
      PREPARE atmr260_prepare2 FROM l_sql1
      IF STATUS THEN CALL cl_err('prepare2:',STATUS,1) 
         CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690124
         EXIT PROGRAM 
      END IF
      DECLARE atmr260_curs2 CURSOR FOR atmr260_prepare2
      IF STATUS THEN CALL cl_err('declare:',STATUS,1) RETURN END IF
      FOREACH atmr260_curs2 INTO sr1.*
         IF STATUS THEN CALL cl_err('foreach:',STATUS,1) EXIT FOREACH END IF           
         SELECT ima906 INTO l_ima906
             FROM ima_file           
        ...
        END FOREACH
      #OUTPUT TO REPORT atmr260_rep(sr.*)
       #NO.FUN-860007------end------
     END FOREACH
     #NO.FUN-860007------begin-----
     ...
     ELSE
        LET l_name = 'atmr260'
     END IF
     CALL cl_prt_cs3(l_name,l_name,g_sql,g_str)
     #FINISH REPORT atmr260_rep
 
     #CALL cl_prt(l_name,g_prtway,g_copies,g_len)
     #NO.FUN-860007------end------
END FUNCTION
#NO.FUN-860007------begin----- 
#REPORT atmr260_rep(sr)
#DEFINE l_tsc01     LIKE tsc_file.tsc01,
#      l_tsc03     LIKE tsc_file.tsc03,
#      l_gem02     LIKE gem_file.gem02,
#      l_gen02     LIKE gen_file.gen02,
