...
# Modify.........: No:TQC-CC0126 12/12/26 By qirl 報表狀態碼的添加
...
#NO.FUN-860008--start--
   LET g_sql = "tqx01.tqx_file.tqx01,",
               ...
               "tqx07.tqx_file.tqx07,",   #--TQC-CC0126--add--
   ...
   LET l_table =cl_prt_temptable('atmr246',g_sql) CLIPPED
...
DEFINE lc_qbe_sn      LIKE gbm_file.gbm01   
   ...
   WHILE TRUE
      ...
      INPUT BY NAME tm2.s1,tm2.s2,tm2.s3,tm2.u1,tm2.u2,tm2.u3,
      ...
      IF g_bgjob = 'Y' THEN
         ...
         ELSE
            ...
            LET l_cmd = l_cmd CLIPPED,
                        ...
                        " '",g_rep_clas CLIPPED,"'",           
                        " '",g_template CLIPPED,"'"            
            CALL cl_cmdat('atmr246',g_time,l_cmd)
         END IF
...
DEFINE sr        RECORD order1  LIKE ima_file.ima01,   #No.FUN-680120 VARCHAR(40)         
                        ...
                        tqx07   LIKE tqx_file.tqx07,     #--TQC-CC0126--add
...
#NO.FUN-860008---start---
   ...
   DEFINE  l_ima021    LIKE ima_file.ima021
    ...
    SELECT zz05 INTO g_zz05 FROM zz_file WHERE zz01 = 'atmr246'
#NO.FUN-860008---end----
   #抓取公司名稱
...
#NO.CHI-6A0004 --END
   ...
   LET l_sql = "SELECT '','','',                                ",
               "      tqx01,tqx02,tqx05,tqx07,tqx09,",          #--TQC-CC0126--add
...
#NO.FUN-860008---END---MARK-----
   PREPARE r246_prepare1 FROM l_sql
   IF SQLCA.sqlcode != 0 THEN
      CALL cl_err('prepare:',SQLCA.sqlcode,1)
      CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690124
      EXIT PROGRAM
   END IF
   DECLARE r246_curs1 CURSOR FOR r246_prepare1
 
#   CALL cl_outnam('atmr246') RETURNING l_name              #NO.FUN-860008
 
   CALL cl_prt_pos_len()
 
#   START REPORT r246_rep TO l_name                         #NO.FUN-860008
#   LET g_pageno = 0                                        #NO.FUN-860008
   FOREACH r246_curs1 INTO sr.*
      IF SQLCA.sqlcode != 0 THEN
...
#      LET sr.order3 = l_order[3]
#NO.FUN-860008---end---mark--
#      OUTPUT TO REPORT r246_rep(sr.*)                      #NO.FUN-860008
#NO.FUN-860008---START--
      SELECT azi03,azi04,azi05
      ...
      EXECUTE insert_prep USING
        sr.tqx01,sr.tqx02,sr.tqx05,sr.tqx07,sr.tqx09,sr.tsa02,sr.tqy03,sr.tqy38,sr.tqy37,   #--TQC-CC0126--add
...
#   FINISH REPORT r246_rep                                  #NO.FUN-860008
#NO.FUN-860008--start--
     ...
     CALL cl_prt_cs3('atmr246','atmr246',g_sql,g_str) 
#NO.FUN-860008---end---
