...
# Modify.........: No.TQC-D10052 13/01/10 By xuxz 列印條件加入adk17 顯示中文
...
#No.FUN-860012---start---
   ...
   LET l_table = cl_prt_temptable('atmr170',g_sql) CLIPPED
...
DEFINE p_row,p_col    LIKE type_file.num5,          #No.FUN-680120 SMALLINT
   ...
   OPEN WINDOW r100_w AT p_row,p_col
        WITH FORM "atm//42f/atmr170"       ATTRIBUTE (STYLE = g_win_style CLIPPED)
...
#     CALL cl_outnam('atmr170') RETURNING l_name
...
#            OUTPUT TO REPORT r205_rep(sr1.*,sr2.*)
     ...
     EXECUTE insert_prep USING
        ...
        sr2.adl06,sr2.adl07,sr2.adl08
     END FOREACH
     END IF
     END FOREACH
     LET g_sql="SELECT * FROM ",g_cr_db_str CLIPPED,l_table CLIPPED
     CALL cl_wcchp(tm.wc,'adk01,adk02,adk13,adk08,adk17')  #TQC-D10052 add adk17
             RETURNING tm.wc
     LET g_str=tm.wc
     CALL cl_prt_cs3('atmr170','atmr170',g_sql,g_str)
