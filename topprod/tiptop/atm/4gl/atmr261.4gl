...
#NO.FUN-850163  --Begin--
   ...
   LET l_table = cl_prt_temptable('atmr261',gg_sql) CLIPPED
  ...
  LET l_table1 = cl_prt_temptable('atmr2611',gg_sql) CLIPPED
...
#NO.FUN-850163  ---End---   
   ...
   IF cl_null(tm.wc) THEN
        CALL atmr261_tm(0,0)             # Input print condition
   ELSE LET tm.wc="tse01= '",tm.wc CLIPPED,"'"
        CALL atmr261()                   # Read data and create out-file
   END IF
   CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690124
END MAIN
 
FUNCTION atmr261_tm(p_row,p_col)
...
DEFINE p_row,p_col  LIKE type_file.num5,         #No.FUN-680120 SMALLINT
  ...
  OPEN WINDOW atmr261_w AT p_row,p_col WITH FORM "atm/42f/atmr261"
...
#              LET g_qryparam.form ="q_tqe01"
    ...
    IF INT_FLAG THEN
       LET INT_FLAG = 0 CLOSE WINDOW atmr261_w 
       CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690124
       EXIT PROGRAM
   ...
   IF g_bgjob = 'Y' THEN
      ...
      ELSE
         ...
         LET l_cmd = l_cmd CLIPPED,
                     ...
                     " '",g_rep_clas CLIPPED,"'",
                     " '",g_template CLIPPED,"'"  
         CALL cl_cmdat('atmr261',g_time,l_cmd)    
      END IF
      CLOSE WINDOW atmr261_w
      CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690124
      EXIT PROGRAM
   END IF
   CALL cl_wait()
...
DEFINE l_tse01     LIKE tse_file.tse01,
     ...
     SELECT zz05 INTO g_zz05 FROM zz_file WHERE zz01 = 'atmr261'                          
#NO.FUN-850163  --End---
     ...
     PREPARE atmr261_prepare1 FROM l_sql
     IF STATUS THEN CALL cl_err('prepare:',STATUS,1) 
        CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690124
        EXIT PROGRAM 
     END IF
     DECLARE atmr261_curs1 CURSOR FOR atmr261_prepare1
...
#NO.FUN-850163  --Begin--     
    ...
    # ELSE
    #    CALL cl_outnam('atmr261') RETURNING l_name
    # END IF
 
    # START REPORT atmr261_rep TO l_name
    
#NO.FUN-850163  --End--
 
     LET g_pageno = 0
     FOREACH atmr261_curs1 INTO sr.*
       IF STATUS THEN CALL cl_err('foreach:',STATUS,1) EXIT FOREACH END IF 
       #是否使用多單位
       SELECT sma115 INTO g_sma115 FROM sma_file 
 
#NO.FUN-850163  --Begin--
#       OUTPUT TO REPORT atmr261_rep(sr.*)
       LET l_memo = g_memo 
       LET l_gem02=''                                                                                                         
       LET l_azf03=''
       LET l_gen02=''
      ...
      IF g_sma115 = "Y" THEN 
       ...
       ###########r261_sub###############begin
        LET l_sql1= " SELECT tsf01,tsf02,tsf03,tsf12,tsf13,tsf14,tsf04,tsf05, ",
                    ...
                    " ORDER BY tsf02 "
        PREPARE atmr261_prepare2 FROM l_sql1
        IF STATUS THEN
           CALL cl_err('prepare2:',STATUS,1) 
           CALL cl_used(g_prog,g_time,2) RETURNING g_time 
           EXIT PROGRAM 
        END IF
        DECLARE atmr261_curs2 CURSOR FOR atmr261_prepare2
        IF STATUS THEN 
           CALL cl_err('declare:',STATUS,1) 
           RETURN
        END IF
        FOREACH atmr261_curs2 INTO sr1.*
              IF STATUS THEN
...
#NO.FUN-850163  --Begin--
    ...
    CALL cl_prt_cs3('atmr261','atmr261',gg_sql,g_str)
#NO.FUN-850163  --End--
END FUNCTION
 
#NO.FUN-850163  --Begin--
#REPORT atmr261_rep(sr)
#DEFINE l_tse01     LIKE tse_file.tse01,
#       l_tse03     LIKE tse_file.tse03,
#       l_gem02     LIKE gem_file.gem02,
#       l_gen02     LIKE gen_file.gen02,
