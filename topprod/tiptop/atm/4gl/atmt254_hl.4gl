      ...
      CASE g_action_choice
         ...
         WHEN "exporttoexcel"
            IF cl_chk_act_auth() THEN
               ...
               (ui.Interface.getRootNode(),base.TypeInfo.create(g_tsl),'','')
            END IF
...
#No.FUN-870007-start-
    IF g_azw.azw04='2' THEN
       SELECT azp02 INTO l_azp02 FROM azp_file WHERE azp01 = g_tsk.tsk24
...
#     CALL t254_check_body_lot_qty()
  ...
  #FUN-A30063 ADD----------------------------------
   ...
   DISPLAY l_gen02 TO tskconu.desc    
...
#No.FUn-870007--end--
   ...
   CALL t254_u()
   CALL t254_b()
   SELECT tsk_file.* INTO g_tsk.* FROM tsk_file WHERE tsk01 = l_oldno
   CALL t254_show()
...
FUNCTION t254_pmm_ins()
   ...
   LET g_pmm.pmmplant= p_plant_new   #所屬工廠   #要算需求的工厂 
...
FUNCTION t254_oga_ins(p_pmm01)
   ...
   DEFINE l_poy             RECORD LIKE poy_file.*
    ...
    LET g_sql = " INSERT INTO ",cl_get_target_table(l_last_poy04,'oga_file'),"(",  #FUN-A50102
                ...
                "ogaorig, oga71,oga57)", #FUN-AC0055 add
                "  VALUES(?,?,?,?,?, ?,?,?,?,?,",
                "         ?,?,?,?,?, ?,?,?,?,?,",
                "         ?,?,?,?,?, ?,?,?,?,?,",
                "         ?,?,?,?,?, ?,?,?,?,?,",
...
#FUN-AB0061 -----------add end----------------  
      ...
      LET g_sql = " INSERT INTO ",cl_get_target_table(p_plant_new,'ogb_file'),"(", #FUN-A50102
                  ...
                  "ogb44,  ogb45,  ogb46,    ogb47,ogb37,ogb50,ogb51,ogb52,ogb53,ogb54,ogb55)",   #FUN-AB0061 add ogb37 #FUN-C50097 addogb50,51,52
                  "   VALUES(?,?,?,?,?, ?,?,?,?,?,",
                  "          ?,?,?,?,?, ?,?,?,?,?,",
                  "          ?,?,?,?,?, ?,?,?,?,?,",
                  "          ?,?,?,?,?, ?,?,?,?,?,",
                  ...
                  "          ?,?,?,?,?, ?,?,?,?,?,",
                  "          ?,?,?,?,?, ?,?,?,?,?,",
                  "          ?,?,?,?,?, ?,?,?,?,?, ?,?,?, ?,?,?)    "   #FUN-AB0061 add ogb37 #FUN-C50097 addogb50,51,52
      CALL cl_replace_sqldb(g_sql) RETURNING g_sql    #FUN-920032
