...
DEFINE g_argv1  LIKE ala_file.ala01       #No.TQC-630070
...
#     DEFINE   l_time LIKE type_file.chr8              #No.FUN-6A0055
   ...
   LET g_argv1 = ARG_VAL(1)               #No.TQC-630070
   ...
   OPEN WINDOW t710_w AT p_row,p_col
     WITH FORM "aap/42f/aapt710"  ATTRIBUTE (STYLE = g_win_style CLIPPED) #No.FUN-580092 HCN
    
    CALL cl_ui_init()
 
 
   CALL t710('1',g_argv1,g_argv2)      # 1.開狀申請   #No.FUN-4A0081 #No.TQC-630070
   CLOSE WINDOW t710_w
