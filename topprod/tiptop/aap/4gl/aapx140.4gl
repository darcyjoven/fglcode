...
# Modify.........: No:FUN-D40056 13/04/15 By yangtt CR轉XGrid
# Modify.........: No:FUN-D40129 13/05/14 By yangtt rvb22欄位新增開窗;【單號】【採購單號】開窗增加料件規格欄位顯示
...
GLOBALS "../../config/top.global"
   ...
   DEFINE tm  RECORD                # Print condition RECORD
               ...
               # azp01 LIKE azp_file.azp01,#  #NO.FUN-A10098  mark
                ...
                #u     LIKE type_file.chr3,   #No.FUN-690028  VARCHAR(3),        # Total sw  #FUN-D40056 mark
...
#FUN-BB0173 add START
   ...
   LET tm.s  = ARG_VAL(12)
   LET tm.t  = ARG_VAL(13)
  #LET tm.u  = ARG_VAL(14) #FUN-D40056 mark
  #FUN-D40056---mark--str--
  #LET g_rep_user = ARG_VAL(15)
  #LET g_rep_clas = ARG_VAL(16)
  #LET g_template = ARG_VAL(17)
...
#FUN-BB0173 add END
   ...
   LET g_sql = " rvv01.rvv_file.rvv01,",
               ...
               " rvv01_rvv02.type_file.chr100,",   #FUN-D40056
               " l_rvu08.type_file.chr100,",   #FUN-D40056
               " rvb04_rvb03.type_file.chr100,",   #FUN-D40056
               " l_rvv03_name.type_file.chr100,",   #FUN-D40056
               " rvv87_rvv23.rvv_file.rvv23,",   #FUN-D40056
               " amount.rvv_file.rvv38,",   #FUN-D40056
               " l_n1.type_file.num5,",   #FUN-D40056
               " l_n2.type_file.num5"   #FUN-D40056
   LET l_table = cl_prt_temptable('aapx140',g_sql) CLIPPED   # 產生Temp Table                                                      
...
FUNCTION aapx140_tm(p_row,p_col)
   DEFINE p_row,p_col  LIKE type_file.num5,    #No.FUN-690028  SMALLINT,
          l_cmd        LIKE type_file.chr1000  #No.FUN-690028  VARCHAR(400)
   DEFINE li_result    LIKE type_file.num5     #No.FUN-940102 
   
   OPEN WINDOW aapx140_w WITH FORM "aap/42f/aapx140"
      ATTRIBUTE (STYLE = g_win_style CLIPPED) #No.FUN-580092 HCN
   CALL cl_ui_init()
 
   CALL cl_opmsg('p')
   CALL x140_set_entry()              #FUN-BB0173 add
   INITIALIZE tm.* TO NULL            # Default condition
   LET tm.s    = '123'
  #LET tm.u    = 'Y  '  #FUN-D40056 mark
   LET tm.v    = '3'
   LET tm.a    = 'N'
   LET tm.b    = 'Y'    #No:8032
   LET tm.more = 'N'
   ...
   LET tm2.t2   = tm.t[2,2]
   LET tm2.t3   = tm.t[3,3]
  #LET tm2.u1   = tm.u[1,1]  #FUN-D40056 mark
  #LET tm2.u2   = tm.u[2,2]  #FUN-D40056 mark
  #LET tm2.u3   = tm.u[3,3]  #FUN-D40056 mark
  ...
  #IF cl_null(tm2.u1) THEN LET tm2.u1 = "N" END IF  #FUN-D40056 mark
  #IF cl_null(tm2.u2) THEN LET tm2.u2 = "N" END IF  #FUN-D40056 mark
  #IF cl_null(tm2.u3) THEN LET tm2.u3 = "N" END IF  #FUN-D40056 mark
   ...
   WHILE TRUE
      ...
      ON ACTION CONTROLP
        CASE
            WHEN INFIELD(rvv01)
             ...
             #LET g_qryparam.form = "q_rvv01"     #FUN-D40129 mark
              LET g_qryparam.form = "q_rvv01_1"   #FUN-D40129 add
            ...
            WHEN INFIELD(rvb04)
              CALL cl_init_qry_var()
              LET g_qryparam.state= "c"
             #LET g_qryparam.form = "q_rvb04"     #FUN-D40129 mark
              LET g_qryparam.form = "q_rvb04_1"   #FUN-D40129 add
              CALL cl_create_qry() RETURNING g_qryparam.multiret
     ...
     #INPUT BY NAME tm.a,tm.b,tm.v,tm2.s1,tm2.s2,tm2.s3,             #NO.FUN-A10098  #FUN-BB0173 mark
      INPUT BY NAME tm.azp01,tm.a,tm.b,tm.v,tm2.s1,tm2.s2,tm2.s3,    #FUN-BB0173 add
                    # tm2.t1,tm2.t2,tm2.t3,tm2.u1,tm2.u2,tm2.u3,tm.more  #FUN-D40056 mark
                      tm2.t1,tm2.t2,tm2.t3,tm.more   #FUN-D40056 add
                      WITHOUT DEFAULTS
     ...
     #FUN-BB0173 add END
         ...
         AFTER INPUT
           ...
           #LET tm.u = tm2.u1,tm2.u2,tm2.u3  #FUN-D40056 mark
            ...
            LET l_cmd = l_cmd CLIPPED,        #(at time fglgo xxxx p1 p2 p3)
                      ...
                      # " '",tm.azp01 CLIPPED,"'",   #NO.FUN-A10098  mark
                       ...
                       " '",tm.v CLIPPED,"'",   #TQC-610053
                        " '",tm.s CLIPPED,"'",
                        " '",tm.t CLIPPED,"'",
                       #" '",tm.u CLIPPED,"'",  #FUN-D40056 mark
                         " '",g_rep_user CLIPPED,"'",           #No.FUN-570264
                         " '",g_rep_clas CLIPPED,"'",           #No.FUN-570264
                         " '",g_template CLIPPED,"'",           #No.FUN-570264
                         " '",g_rpt_name CLIPPED,"'"            #No.FUN-7C0078
            CALL cl_cmdat('aapx140',g_time,l_cmd)    # Execute cmd at later time
         END IF
...
FUNCTION aapx140()
   DEFINE l_name    LIKE type_file.chr20,   #No.FUN-690028  VARCHAR(20),        # External(Disk) file name
     ...
     DEFINE l_rvv01_rvv02  LIKE type_file.chr100   #FUN-D40056
     DEFINE l_rvu08        LIKE type_file.chr100   #FUN-D40056
     DEFINE l_rvb04_rvb03  LIKE type_file.chr100   #FUN-D40056
     DEFINE l_rvv03_name   LIKE type_file.chr100   #FUN-D40056
     DEFINE l_rvv87_rvv23  LIKE rvv_file.rvv23      #FUN-D40056
     DEFINE l_amount       LIKE rvv_file.rvv38      #FUN-D40056
     DEFINE l_n1           LIKE type_file.num5     #FUN-D40056
     DEFINE l_n2           LIKE type_file.num5     #FUN-D40056
   ...
   #FUN-A60056--add--end
      ...
      PREPARE aapx140_prepare1 FROM l_sql
      IF STATUS != 0 THEN
         CALL cl_err('prepare:',STATUS,1)
         CALL cl_used(g_prog,g_time,2) RETURNING g_time  #FUN-B80105    ADD
         EXIT PROGRAM
      END IF
      DECLARE aapx140_curs1 CURSOR FOR aapx140_prepare1
 
 
      LET g_pageno = 0
      FOREACH aapx140_curs1 INTO sr.*
         IF STATUS != 0 THEN
     ...
     #FUN-BB0002 add END
        ...
        #FUN-A60056--mod--end
         ...
         #FUN-D40056---add---str--
         LET l_rvv01_rvv02 = sr.rvv01,'-',sr.rvv02 USING '--,---'
         CASE sr.rvu08 
            WHEN "REG" LET l_rvu08 = cl_getmsg('asm-119',g_lang)
            WHEN "EXP" LET l_rvu08 = cl_getmsg('asm-120',g_lang)
            WHEN "CAP" LET l_rvu08 = cl_getmsg('asm-121',g_lang)
            WHEN "SUB" LET l_rvu08 = sr.rvu08,':',cl_getmsg('aec-214',g_lang)
            WHEN "TAP" LET l_rvu08 = cl_getmsg('asm-124',g_lang)
          OTHERWISE LET l_rvu08 = " "
         END CASE
         LET l_rvb04_rvb03 = sr.rvb04,'-',sr.rvb03 USING '--,---'
         CASE sr.rvv03 
            WHEN '1' LET l_rvv03_name = cl_getmsg('apm-243',g_lang)
            WHEN '2' LET l_rvv03_name = cl_getmsg('apm-244',g_lang)
            WHEN '3' LET l_rvv03_name = cl_getmsg('apm-245',g_lang)
          OTHERWISE LET l_rvv03_name = "XXXX"
         END CASE
         LET l_rvv87_rvv23 = sr.rvv87 - l_rvv23 - sr.rvv88
         IF sr.rvv03 = '3' THEN  
            IF sr.rvv87 = 0 THEN
               IF tm.v = '2' THEN    
                  LET l_amount = 0
               ELSE
                  LET l_amount = sr.rvv39 * -1
               END IF
            ELSE 
               LET l_amount = sr.rvv39 * -1
            END IF
         ELSE
             LET l_amount = sr.rvv39
         END IF
         LET l_n1 = 2
         LET l_n2 = 3
         #FUN-D40056---add---end--
         ...
         EXECUTE insert_prep USING
                   ...
                   ,l_rvv01_rvv02,l_rvu08,l_rvb04_rvb03,l_rvv03_name,l_rvv87_rvv23,l_amount,l_n1,l_n2   #FUN-D40056
      END FOREACH
...
###XtraGrid###    LET l_sql = "SELECT * FROM ",g_cr_db_str CLIPPED,l_table CLIPPED                                                               
    LET g_str = ''
     ...
     IF g_zz05 = 'Y' THEN                                                                                                           
       ...
       LET g_str = tm.wc                                                                                                           
     END IF                                                                                                                         
###XtraGrid###     LET g_str = g_str,";",tm.s[1,1],";",tm.s[2,2],";",tm.s[3,3],";",tm.t,";",tm.u,";",tm.v    #MOD-7B0083
###XtraGrid###     CALL cl_prt_cs3('aapx140','aapx140',l_sql,g_str)                                                                                 
    LET g_xgrid.table = l_table    ###XtraGrid###
    #FUN-D40056--add---str---
    LET g_xgrid.order_field = cl_get_order_field(tm.s,"rvv06,rvv09,rvv01_rvv02,rvb22,rvv03,pmm22")
    LET g_xgrid.grup_field = cl_get_order_field(tm.s,"rvv06,rvv09,rvv01_rvv02,rvb22,rvv03,pmm22")
    IF cl_null(g_xgrid.grup_field) THEN
       LET g_xgrid.grup_field = 'pmm22'
    ELSE
       LET g_xgrid.grup_field = g_xgrid.grup_field,',pmm22'
    END IF     
    LET g_xgrid.skippage_field = cl_get_skip_field(tm.s,tm.t,"rvv06,rvv09,rvv01_rvv02,rvb22,rvv03,pmm22")
