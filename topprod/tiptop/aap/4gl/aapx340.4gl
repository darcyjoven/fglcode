...
# Modify.........: No.FUN-D40020 12/12/24 By zhangweib CR報表轉XtraGrid報表
...
#No.FUN-A10098 ---end
              ...
              #" pma02.pma_file.pma02,",     #No.FUN-D40020   Mark
               ...
               " apa121.apa_file.apa64,",    #No.FUN-D40020   Add
               " apa13.apa_file.apa13,",
               " apa41.apa_file.apa41,",
              #" apa11.apa_file.apa11,",     #No.FUN-D40020   Mark
               " apa11.type_file.chr100,",     #No.FUN-D40020   Add
               " azi04.azi_file.azi04,",
               " azi05.azi_file.azi05, ",                                                 
               " g_azi04.azi_file.azi04"   #FUN-D40129
   LET l_table = cl_prt_temptable('aapx340',g_sql) CLIPPED                      
   IF l_table = -1 THEN
...
#               " VALUES(?,?,?,?,?, ?,?,?,?,?, ",                       #No.FUN-A10098 ---mark
               ...
               "        ?,?,?,?,?, ?,?,?,?,?,?,?) " #FUN-970070 add?   #FUN-D40129 add 1?
...
#No.FUN-A10098 --mark end
      ...
      INPUT BY NAME tm.sw_21,tm.sw_23,tm.sw_22,tm.z,tm.h,tm2.s1,tm2.s2,tm2.s3,   #FUN-640097   #FUN-830108
                  # tm2.t1,tm2.t2,tm2.t3,tm2.u1,tm2.u2,tm2.u3,  #FUN-D30070 mark
                    tm2.t1,tm2.t2,tm2.t3,   #FUN-D30070 add
...
#No.FUN-A10098 --mark end
            ...
            CALL cl_cmdat('aapx340',g_time,l_cmd)    # Execute cmd at later time
         END IF
...
FUNCTION x340()
   DEFINE l_name    LIKE type_file.chr20,         # External(Disk) file name  #No.FUN-690028 VARCHAR(20)
          ...
          sr        RECORD order1 LIKE apa_file.apa01,      # No.FUN-690028 VARCHAR(30),           # FUN-560011
                    ...
                    END RECORD
   DEFINE l_apa11     LIKE type_file.chr100           #No.FUN-D40020   Add
...
#No.FUN-A10098 ----mark end
     ...
     #MOD-A30074---modify---end---
      ...
      PREPARE x340_prepare1 FROM l_sql
      IF SQLCA.sqlcode != 0 THEN
         CALL cl_err('prepare:',SQLCA.sqlcode,1)
         CALL cl_used(g_prog,g_time,2) RETURNING g_time 
         EXIT PROGRAM
      END IF
      DECLARE x340_curs1 CURSOR FOR x340_prepare1
 
      LET g_pageno = 0
 
      FOREACH x340_curs1 INTO sr.*
         IF SQLCA.sqlcode != 0 THEN
...
#         EXECUTE insert_prep USING sr.plant,sr.apa06,sr.apa07,sr.apa21,       #No.FUN-A10098 ----mark
         EXECUTE insert_prep USING sr.apa06,sr.apa07,sr.apa21,                 #No.FUN-A10098 ----add
                                  #sr.gen02,sr.pma02,sr.apa24,sr.apa01,sr.apa36,sr.apa44,  #FUN-970070 add apa44   #No.FUN-D40020   Mark
                                   sr.gen02,sr.apa24,sr.apa01,sr.apa36,sr.apa44,  #FUN-970070 add apa44            #No.FUN-D40020   Add
                                   sr.apa00,sr.apa02,sr.apa12,sr.pay,           #No.CHI-7B0051
                                  #sr.pay1,sr.apa64,sr.mark,sr.apa41,sr.apa11,  #No.CHI-7B0051   #No.FUN-D40020   Mark
                                   sr.pay1,sr.apa64,sr.apa12,sr.mark,sr.apa41,l_apa11,           #No.FUN-D40020   Add
                                   sr.azi04,sr.azi05   
                                   ,g_azi04   #FUN-D40129
...
###XtraGrid###               tm.u[2,2],";",tm.u[3,3],";",g_azi04,";",g_azi05
###XtraGrid###   LET l_sql = "SELECT * FROM ",g_cr_db_str CLIPPED,l_table CLIPPED           
###XtraGrid###   CALL cl_prt_cs3('aapx340','aapx340',l_sql,g_str)    
    LET g_xgrid.table = l_table    ###XtraGrid###
   #No.FUN-D40020 ---start--- Add
    LET g_xgrid.order_field = cl_get_order_field(tm.s,"apa06,apa21,apa11,apa24,apa12,apa64,apa02,apa01,apa13,apa00,apa36,apa44")
   #LET g_xgrid.grup_field = cl_get_sum_field(tm.s,tm.u,"apa06,apa21,apa11,apa24,apa12,apa64,apa02,apa01,apa13,apa00,apa36,apa44")   #FUN-D30070 mark
    LET g_xgrid.grup_field = cl_get_order_field(tm.s,"apa06,apa21,apa11,apa24,apa12,apa64,apa02,apa01,apa13,apa00,apa36,apa44")   #FUN-D30070 
   #LET g_xgrid.grup_sum_field = cl_get_sum_field(tm.s,tm.u,"apa06,apa21,apa11,apa24,apa12,apa64,apa02,apa01,apa13,apa00,apa36,apa44") #FUN-D30070 mark
    LET g_xgrid.skippage_field = cl_get_skip_field(tm.s,tm.t,"apa06,apa21,apa11,apa24,apa12,apa64,apa02,apa01,apa13,apa00,apa36,apa44")
   #No.FUN-D40020 ---end  --- Add
...
FUNCTION x340_create_tmp()    #no.5197
   CREATE TEMP TABLE x340_tmp(
