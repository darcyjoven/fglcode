...
DEFINE p_row,p_col    LIKE type_file.num5,         #No.FUN-680108 SMALLINT
   ...
   OPEN WINDOW r209_w AT p_row,p_col
        WITH FORM "axd/42f/axdr209"  ATTRIBUTE (STYLE = g_win_style CLIPPED) #No:FUN-580092 HCN
 ...
 END CONSTRUCT                                                                  
   ...
   IF g_bgjob = 'Y' THEN
      ...
      ELSE
         ...
         CALL cl_cmdat('axdr209',g_time,l_cmd)   
      END IF
      CLOSE WINDOW r209_w
      EXIT PROGRAM
   END IF
...
#       l_time          LIKE type_file.chr8        #No.FUN-6A0091
     ...
     END CASE 
     LET l_sql = "SELECT adk01,adk02,adk03,adk04,adk05,adk06,adk07,",
                 "       adk08,adk09,adk13,adk15,adk17,gen02,gem02,",
                 "       adl02,adl03,adl04,adl05,adl06,adl07,adl08,",
                 "       adl09,adl10,adg09,adg10,adg11 ",
     ...
     IF SQLCA.sqlcode != 0 THEN
        ...
        EXIT PROGRAM 
     END IF
     DECLARE r209_curs1 CURSOR FOR r209_prepare1

     CALL cl_outnam('axdr209') RETURNING l_name
     START REPORT r209_rep TO l_name
     LET g_pageno = 0

     FOREACH r209_curs1 INTO sr.*
       IF SQLCA.sqlcode != 0 THEN 
...
# BEFORE GROUP OF sr.adk01
   ON EVERY ROW
      ...
      PRINT COLUMN  g_c[31],sr.adk01 CLIPPED,  #TQC-6A0095
            ...
            COLUMN  g_c[36],sr.adk09 CLIPPED;  #TQC-6A0095
      SELECT gen02 INTO l_gen02a FROM gen_file 
       WHERE gen01 = sr.adk09
      PRINT COLUMN g_c[37],l_gen02a CLIPPED,  #TQC-6A0095
            COLUMN g_c[38],sr.adk04 CLIPPED,  #TQC-6A0095
            COLUMN g_c[39],sr.adk05 USING '##:##',   #TQC-6A0095
            COLUMN g_c[40],sr.adk06 CLIPPED,  #TQC-6A0095
            COLUMN g_c[41],sr.adk07 USING '##:##',   #TQC-6A0095
            COLUMN g_c[42],sr.adk03 CLIPPED,  #TQC-6A0095
            COLUMN g_c[43],sr.adk15 CLIPPED,  #TQC-6A0095
            COLUMN g_c[44],sr.adk17 CLIPPED,  #TQC-6A0095
            COLUMN g_c[45],l_desc CLIPPED,  #TQC-6A0095
            COLUMN g_c[46],sr.adl02 USING '###&',#FUN-590118
            COLUMN g_c[47],sr.adl03 CLIPPED,  #TQC-6A0095
            COLUMN g_c[48],sr.adl04 USING '#########&',#FUN-590118
            COLUMN g_c[49],sr.adg09 CLIPPED,  #TQC-6A0095
            COLUMN g_c[50],sr.adg10 CLIPPED,  #TQC-6A0095
            COLUMN g_c[51],sr.adg11 CLIPPED, #TQC-6A0095
            COLUMN g_c[52],sr.adl05 USING '-----------&.&&',
            COLUMN g_c[53],sr.adl06 USING '----&.&&',
            COLUMN g_c[54],sr.adl07 CLIPPED,  #TQC-6A0095
            COLUMN g_c[55],sr.adl08 USING '##:##',    #TQC-6A0095
            COLUMN g_c[56],sr.adl09 CLIPPED,   #TQC-6A0095
            COLUMN g_c[57],sr.adl10 USING '##:##'    #TQC-6A0095
