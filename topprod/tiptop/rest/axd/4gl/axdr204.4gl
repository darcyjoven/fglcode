...
# Pattern name...: axdr204.4gl
# Descriptions...: 集團調撥撥入單列印
...
# Modify.........: No:TQC-6A0095 06/11/13 By xumin 項次、參考項次問題更改
DATABASE ds
...
DEFINE l_cmd          LIKE type_file.chr1000       #No.FUN-680108 VARCHAR(1000)
   ...
   OPEN WINDOW r204_w AT p_row,p_col
        WITH FORM "axd/42f/axdr204"  ATTRIBUTE (STYLE = g_win_style CLIPPED) #No:FUN-580092 HCN
 ...
 END CONSTRUCT
   ...
   IF g_bgjob = 'Y' THEN
      ...
      ELSE
         ...
         CALL cl_cmdat('axdr204',g_time,l_cmd)
      END IF
      CLOSE WINDOW r204_w
      EXIT PROGRAM
   END IF
...
DEFINE sr        RECORD
     ...
     CASE
        ...
        WHEN tm.b = '3' LET tm.wc = tm.wc CLIPPED," AND adh07 = 'R'"
        WHEN tm.b = '4' LET tm.wc = tm.wc CLIPPED," AND adh07 = 'W'"
     END CASE
     ...
     CALL cl_outnam('axdr204') RETURNING l_name
...
DEFINE sr           RECORD
 ...
 #MOD-4B0067  --begin
      ...
      PRINT g_x[31],g_x[32],g_x[33],g_x[34],g_x[35],g_x[36],
            ...
            g_x[43],g_x[44],g_x[45],g_x[46],g_x[47],g_x[48],g_x[49]
      PRINT g_dash1
...
#     SKIP TO TOP OF PAGE
   ...
   ON EVERY ROW
      PRINT COLUMN  g_c[31],sr.adh.adh01 CLIPPED,  #TQC-6A0095  
            ...
            COLUMN  g_c[35],sr.adh.adh04 CLIPPED,  #TQC-6A0095
            COLUMN  g_c[36],sr.gem02 CLIPPED,  #TQC-6A0095
            COLUMN  g_c[37],sr.adh.adh00 CLIPPED,  #TQC-6A0095
            COLUMN  g_c[38],l_desc CLIPPED;   #TQC-6A0095
#      PRINT COLUMN   g_c[39],sr.adi.adi02 USING "###&", #FUN-590118
      PRINT COLUMN   g_c[39],cl_numfor(sr.adi.adi02,4,0),  #TQC-6A0095
            COLUMN   g_c[40],sr.adi.adi03 CLIPPED,  #TQC-6A0095
            COLUMN   g_c[41],sr.adi.adi05 CLIPPED,  #TQC-6A0095
             COLUMN   g_c[42],sr.ima02 CLIPPED,  #MOD-4A0238  #TQC-6A0095
             COLUMN   g_c[43],sr.ima021 CLIPPED;  #MOD-4A0238  #TQC-6A0095
#      PRINT COLUMN   g_c[44],sr.adi.adi04 USING "<<<<",  
      PRINT COLUMN   g_c[44],cl_numfor(sr.adi.adi04,8,0),  #TQC-6A0095
            COLUMN   g_c[45],sr.adi.adi06 CLIPPED,    #TQC-6A0095
            COLUMN   g_c[46],sr.adi.adi07 CLIPPED,    #TQC-6A0095
            COLUMN   g_c[47],sr.adi.adi08 CLIPPED,    #TQC-6A0095
            COLUMN   g_c[48],sr.adi.adi09 CLIPPED,    #TQC-6A0095
            COLUMN   g_c[49],sr.adi.adi10 USING "----------&.&&&"
      PRINT
 #MOD-4B0067  --end
