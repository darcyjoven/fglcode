...
#                                                  2.新增action"相關文件"
# Modify.........: No.MOD-730077 07/03/20 By pengu asft730有報數量不會回寫sfb12
   ...
   INPUT BY NAME g_shb.shb01,g_shb.shb04,g_shb.shb16,g_shb.shb05,g_shb.shb012, #FUN-A60095
        ...
        AFTER FIELD shb16  
            IF NOT cl_null(g_shb.shb16) THEN
               ...
               #add by liy210910 s
               SELECT sfb04 INTO l_sfb04 FROM sfb_file where sfb01 = l_shm012
               IF l_sfb04 ='8' THEN
                  call cl_err('工单已结案','!',1)
                  NEXT FIELD CURRENT
               END IF 
...
DEFINE g_shb10      LIKE shb_file.shb10
DEFINE g_shb01      LIKE shb_file.shb01
DEFINE g_shb05      LIKE shb_file.shb05
...
#atmt260单头
  BEGIN WORK 
      ...
      IF (NOT li_result) THEN
         CALL cl_err('组合单号产生失败','!',1)
      END IF
        LET g_tsc.tscud02 = g_shb01        #移转单号
        LET g_tsc.tsc02=g_today            #組合日期
        LET g_tsc.tsc21=g_today            #MOD-AA0167
        #LET g_tsc.tsc03=g_shb10            #料号
        ...
        SELECT ima35,ima36 INTO g_tsc.tsc12,g_tsc.tsc13 FROM ima_file WHERE ima01 = g_shb10  #仓库，库位
        LET g_tsc.tsc16 = g_user      #人员
        SELECT gen03 INTO g_tsc.tsc15 FROM gen_file WHERE gen01 = g_tsc.tsc16  #部门
        #LET g_tsc.tsc19 = g_shb05  #工单号
        SELECT ima25 INTO g_tsc.tsc04 FROM ima_file WHERE ima01 = g_shb10  #单位
...
{        IF l_status = 'Y' THEN 
        ...
        LET l_count = 0
        FOREACH oea_cur2 INTO l_bmb03
            LET g_tsd.tsd01 = g_tsc.tsc01
            LET l_count = l_count + 1
            LET g_tsd.tsd02 = l_count   #项次
            LET g_tsd.tsd03 = l_bmb03   #料号
            SELECT ima63 INTO g_tsd.tsd04 FROM ima_file WHERE ima01 = l_bmb03  #单位
            LET g_tsd.tsd05 = 0              #body default
            LET g_tsd.tsd08 = 0              #body default
            LET g_tsd.tsd11 = 0              #body default
            LET g_tsd.tsdplant = g_plant
            LET g_tsd.tsdlegal = g_legal
            SELECT ima35,ima36 INTO g_tsd.tsd12,g_tsd.tsd13 FROM ima_file WHERE ima01=g_tsd.tsd03
