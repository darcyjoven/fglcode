...
#MOD-B90008 --end--
  ...
  #        l_imaqty LIKE ima_file.ima262,
    ...
    DEFINE l_img18  LIKE img_file.img18
      ...
      LET g_forupd_sql = "SELECT img10,img16,img23,img24,img09,img21,img18 FROM img_file",
             "  WHERE img01= ? AND img02= ? AND img03= ? AND img04= ?  ", #tianry add img18
             " FOR UPDATE "
      LET g_forupd_sql = cl_forupd_sql(g_forupd_sql)
      ...
      IF STATUS THEN 
          ...
          INSERT INTO IMG_FILE
             VALUES(l_sfs.sfs04,p_ware,p_loca,p_lot,l_sfs.sfs01,l_sfs.sfs02,'','',l_sfs.sfs06,0,0,'',p_date,p_date,p_date,p_date,p_date,p_date,'',1,1,'W','Y','Y'
             ,'N','',0,0,0,0,0,0,1,'','',p_date,'','FOREWIN','FOREWIN')
  ...
  FUNCTION i501sub_tlf(p_ware,p_loca,p_lot,p_unit,p_qty,p_img10,p_uom,p_factor,
     ...
     LET g_tlf.tlf06=l_sfp.sfp02      #發料日期
...
#FUN-A60095 mark(E)
  ...
  #  CALL s_getima(l_sfs.sfs04) RETURNING l_ima262,l_ima25,l_ima55,l_ima86  #NO.FUN-A20044
     ...
     LET g_tlff.tlff06=l_sfp.sfp02      #發料日期
