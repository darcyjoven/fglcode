...
#                                         --> per add 選項列印
# Modify.........: No.MOD-4A0203 04/10/14 By Smapmin 將ima02全部印出來
...
# Modify.........: No.FUN-670104 08/10/06 By jan 改g102_p2,s_momo1_c,g102_memo1_c  CURSOR
...
# Modify.........: No.FUN-C10036 12/01/12 By yangtt   FUN-B50095、TQC-BA0010追單
# Modify.........: No.FUN-C10036 12/01/16 By xuxz 程序規範修改
# Modify.........: No.FUN-C40019 12/04/11 By yangtt GR報表列印TIPTOP與EasyFlow簽核圖片
# Modify.........: No.FUN-CA0107 12/10/19 By janet 子報表無法正常跳頁，新增判斷子報表頁尾變數、修改主、子報表架構
# Modify.........: No.FUN-CB0051 12/11/23 By chenying 將原子報表頁尾變數刪除,并添加臨時表的cl_del
# Modify.........: No.TQC-D70060 13/07/23 By yangtt 1."生產料件"、"部門/廠商"欄位增加開窗功能
#                                                   2.sfb82欄位維護為"部門/廠商"
#                                                   3.新增"幫助"按鈕   
#                                                   4.無法Ctrl+g    
#                                                   5.單頭[製造部門]錯位
...
DEFINE l_table1    STRING          #FUN-B50018 add
DEFINE l_table2    STRING          #FUN-B50018 add
DEFINE l_table3    STRING          #FUN-B50018 add
DEFINE l_table4    STRING          #FUN-B50018 add
DEFINE l_table5    STRING          #FUN-B50018 add                                                      
DEFINE l_str       STRING   
#No.FUN-710082--end  
...
#FUN-B50018--------add---------str------------
TYPE sr2_t RECORD
      l_order1   LIKE type_file.chr1000,
      ...
      sfa16    LIKE sfa_file.sfa16,           #FUN-C10036 add
...
MAIN
 ...
 # LET g_argv2 = ARG_VAL(11) #NO:6882
   ...
   LET l_table = cl_prt_temptable('asfg102',g_sql) CLIPPED
   IF l_table = -1 THEN 
      #CALL cl_used(g_prog,g_time,2) RETURNING g_time   #FUN-B50018  add #FUN-BB0047 mark
      #CALL cl_gre_drop_temptable(l_table||"|"||l_table1||"|"||l_table2||"|"||l_table3||"|"||l_table4||"|"||l_table5)    #FUN-B50018  add#FUN-C10036 mark
      EXIT PROGRAM 
   END IF
#  LET g_sql = "INSERT INTO ",g_cr_db_str CLIPPED,l_table CLIPPED,
#              " VALUES(?,?,?,?,?, ?,?,?,?,?, ?,?,?,?,?, ?,?,?,?,?,",
#              "        ?,?,?,?,?, ?,?,?,?,?, ",
#              "        ?,?,?  ) "   #No.TQC-A60097    #FUN-A60027 add 3?  #MOD-A60129 add ? 
...
LET l_table1 = cl_prt_temptable('asfg1021',g_sql) CLIPPED
IF l_table1 = -1 THEN 
   #CALL cl_used(g_prog,g_time,2) RETURNING g_time   #FUN-B50018  add #FUN-BB0047 mark
   #CALL cl_gre_drop_temptable(l_table||"|"||l_table1||"|"||l_table2||"|"||l_table3||"|"||l_table4||"|"||l_table5)   #FUN-B50018  add#FUN-C10036 mark
   EXIT PROGRAM
...
LET g_sql = "sfb01_2.sfb_file.sfb01,",
            "eca04d.eca_file.eca04,",
            "ecb012.ecb_file.ecb012,",
            "ecb03.ecb_file.ecb03,",
            "ecb06.ecb_file.ecb06,",
            "ecb08.ecb_file.ecb08,",
            "srtdt.type_file.dat,",
            "duedt.type_file.dat,",
            "esrtdt.type_file.dat,",
            "lsrtdt.type_file.dat,",
            "eduedt.type_file.dat,",
            "lduedt.type_file.dat"
LET l_table2 = cl_prt_temptable('asfg1022',g_sql) CLIPPED
IF l_table2 = -1 THEN 
   #CALL cl_used(g_prog,g_time,2) RETURNING g_time   #FUN-B50018  add #FUN-BB0047 mark
   #CALL cl_gre_drop_temptable(l_table||"|"||l_table1||"|"||l_table2||"|"||l_table3||"|"||l_table4||"|"||l_table5)   #FUN-B50018  add#FUN-C10036 mark
   EXIT PROGRAM 
...
LET g_sql = "sfb01_3.sfb_file.sfb01,",
            "ocf01.ocf_file.ocf01,",
...
LET l_table3 = cl_prt_temptable('asfg1023',g_sql) CLIPPED
IF l_table3 = -1 THEN 
   #CALL cl_used(g_prog,g_time,2) RETURNING g_time   #FUN-B50018  add #FUN-BB0047 mark
   #CALL cl_gre_drop_temptable(l_table||"|"||l_table1||"|"||l_table2||"|"||l_table3||"|"||l_table4||"|"||l_table5)   #FUN-B50018  add#FUN-C10036 mark
   EXIT PROGRAM 
...
LET g_sql = "sfb01_4.sfb_file.sfb01,",
            "sfw02.sfw_file.sfw02,",
            "sfw03.sfw_file.sfw03"
LET l_table4 = cl_prt_temptable('asfg1024',g_sql) CLIPPED
IF l_table4 = -1 THEN
   #CALL cl_used(g_prog,g_time,2) RETURNING g_time   #FUN-B50018  add #FUN-BB0047 mark
   #CALL cl_gre_drop_temptable(l_table||"|"||l_table1||"|"||l_table2||"|"||l_table3||"|"||l_table4||"|"||l_table5)   #FUN-B50018  add#FUN-C10036 mark
   EXIT PROGRAM 
...
LET g_sql = "sfb01_5.sfb_file.sfb01,",
            "oao03.oao_file.oao03,",
            "oao05.oao_file.oao05,",
            "oao06.oao_file.oao06"
LET l_table5 = cl_prt_temptable('asfg1025',g_sql) CLIPPED
IF l_table5 = -1 THEN 
   #CALL cl_used(g_prog,g_time,2) RETURNING g_time   #FUN-B50018  add #FUN-BB0047 mark
   #CALL cl_gre_drop_temptable(l_table||"|"||l_table1||"|"||l_table2||"|"||l_table3||"|"||l_table4||"|"||l_table5)   #FUN-B50018  add#FUN-C10036 mark
   EXIT PROGRAM 
...
#FUN-B50018-------mod-------str----------- 
 ...
 ##DROP TABLE g102_tmp1
 ##CREATE TEMP TABLE g102_tmp1(
 ##   sfb01_1  LIKE sfb_file.sfb01,
 ##   sfa03    LIKE sfa_file.sfa03,
 ##   sfa05    LIKE sfa_file.sfa05,
 ##   sfa06    LIKE sfa_file.sfa06,
 ...
 ##DROP TABLE g102_tmp2
 ##CREATE TEMP TABLE g102_tmp2(
 ##   sfb01_2  LIKE sfb_file.sfb01,
 ##   eca04d   LIKE eca_file.eca04,
 ...
 ##DROP TABLE g102_tmp3
 ##CREATE TEMP TABLE g102_tmp3(
 ##   sfb01_3  LIKE sfb_file.sfb01,
 ##   ocf01    LIKE ocf_file.ocf01,
 ##   ocf02    LIKE ocf_file.ocf02,
 ##   ocf101   LIKE ocf_file.ocf101,
 ...
 ##DROP TABLE g102_tmp4
 ##CREATE TEMP TABLE g102_tmp4(
 ##   sfb01_4  LIKE sfb_file.sfb01,
 ##   sfw02    LIKE sfw_file.sfw02,
 ##   sfw03    LIKE sfw_file.sfw03)
 
 ##DROP TABLE g102_tmp5
 ##CREATE TEMP TABLE g102_tmp5(
 ##   sfb01_5  LIKE sfb_file.sfb01,
 ##   oao03    LIKE oao_file.oao03,
 ##   oao05    LIKE oao_file.oao05,
 ##   oao06    LIKE oao_file.oao06)
...
#FUN-B50018----------mod--------end------------ 
   ...
   IF cl_null(g_bgjob) OR g_bgjob = 'N' THEN        # If background job sw is off
      CALL asfg102_tm(0,0)        # Input print condition
   ELSE
      CALL asfg102()            # Read data and create out-file
   END IF
   CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690123
   CALL cl_gre_drop_temptable(l_table||"|"||l_table1||"|"||l_table2||"|"||l_table3||"|"||l_table4||"|"||l_table5)
END MAIN
 
FUNCTION asfg102_tm(p_row,p_col)
...
DEFINE p_row,p_col    LIKE type_file.num5,        #No.FUN-680121 SMALLINT
  ...
  OPEN WINDOW asfg102_w AT p_row,p_col WITH FORM "asf/42f/asfg102"
  ...
  WHILE TRUE
    ...
    IF tm.wc=" 1=1 " THEN
       ...
       CONTINUE WHILE
    END IF
    DISPLAY BY NAME tm.a,tm.b,tm.c,tm.d,tm.e,tm.f,tm.more                  #FUN-750047 add tm.f
    INPUT BY NAME tm.a,tm.b,tm.c,tm.d,tm.e,tm.f,tm.more WITHOUT DEFAULTS   #FUN-750047 add tm.f
       #No.FUN-580031 --start--
       BEFORE INPUT
    ...
    IF g_bgjob = 'Y' THEN
       ...
       ELSE
          ...
          CALL cl_cmdat('asfg102',g_time,l_cmd)    # Execute cmd at later time
       END IF
       CLOSE WINDOW asfg102_w
      # CALL cl_gre_drop_temptable(l_table||"|"||l_table1||"|"||l_table2||"|"||l_table3||"|"||l_table4||"|"||l_table5)     #FUN-B80086    MARK
       CALL cl_used(g_prog,g_time,2) RETURNING g_time         
       CALL cl_gre_drop_temptable(l_table||"|"||l_table1||"|"||l_table2||"|"||l_table3||"|"||l_table4||"|"||l_table5)      #FUN-B80086    ADD
       EXIT PROGRAM
    END IF
...
DEFINE    sr1       RECORD
                     ...
                     sfa16    LIKE sfa_file.sfa16,    #標準QPA      #FUN-C10036 add
...
#FUN-CB0051--add--end--
   #------------------------------ CR (2) ------------------------------#
#FUN-B50018--------mod-------str------------
 ##DELETE FROM g102_tmp
 ##DELETE FROM g102_tmp1
 ##DELETE FROM g102_tmp2
 ##DELETE FROM g102_tmp3
 ##DELETE FROM g102_tmp4
 ##DELETE FROM g102_tmp5
 
 ##LET g_sql = "INSERT INTO g102_tmp ",
 ##            " VALUES(?,?,?,?,?, ?,?,?,?,?,",
 ##            "        ?,?,?,?,?, ?,?,?,?,?,",
 ##            "        ?,?,?,?,?, ?,?,?,?,?,",
 ##            "        ?,?,?)"
 ...
 ##LET g_sql = "INSERT INTO g102_tmp1 VALUES(?,?,?,?,?, ?,?,?,?,?, ?,?,?,?,?, ?,?,?)"   #FUN-A60027 add 2?  #MOD-A60129 add ?
 ##PREPARE insert_prep1 FROM g_sql
 ##IF STATUS THEN
 ##   CALL cl_err('insert_prep1:',status,1) EXIT PROGRAM
 ##END IF
 
 ##LET g_sql = "INSERT INTO g102_tmp2 VALUES(?,?,?,?,?, ?,?,?,?,?, ?,?)"      #FUN-A60027 add ?
 ##PREPARE insert_prep2 FROM g_sql
 ##IF STATUS THEN
 ##   CALL cl_err('insert_prep2:',status,1) EXIT PROGRAM
 ##END IF
 
 ##LET g_sql = "INSERT INTO g102_tmp3 ",
 ##            " VALUES(?,?,?,?,?, ?,?,?,?,?,",
 ##            "        ?,?,?,?,?, ?,?,?,?,?,",
 ##            "        ?,?,?,?,?, ?,?,?)"
...
#FUN-B50018-------add-------str--------
   ...
   CALL cl_used(g_prog,g_time,2) RETURNING g_time
   CALL cl_gre_drop_temptable(l_table||"|"||l_table1||"|"||l_table2||"|"||l_table3||"|"||l_table4||"|"||l_table5)   #FUN-B50018  add
   EXIT PROGRAM
   END IF
...
#FUN-B50018-------add-------end--------
   ...
   #No.FUN-670066---Begin
   #  SELECT zz17,zz05 INTO g_len,g_zz05 FROM zz_file WHERE zz01 = 'asfg102'
...
#No.CHI-6A0004--------End--------------
   ...
   IF SQLCA.sqlcode != 0 THEN
     ...
     # CALL cl_gre_drop_temptable(l_table||"|"||l_table1||"|"||l_table2||"|"||l_table3||"|"||l_table4||"|"||l_table5)    #FUN-B80086   MARK
      ...
      EXIT PROGRAM
   END IF
   DECLARE asfg102_curs1 CURSOR FOR asfg102_p1
 
   LET l_sql = " SELECT * FROM ocf_file ",      #NO:6882
               " WHERE  ocf01=? AND ocf02=? "
   PREPARE asfg102_p2 FROM l_sql                  # RUNTIME 編譯
   DECLARE asfg102_curs2 CURSOR FOR asfg102_p2    # CURSOR
 
#No.FUN-670104--BEGIN--
   IF tm.a = 'Y' THEN        #備料資料
      LET l_sql = " SELECT ' ',sfa03,sfa05,sfa06,sfa062,sfa063,'',sfa08,", #FUN-940008 sfa07-->'' #FUN-B50018 add ' '
                  " sfa09,sfa11,sfa12,sfa16,sfa25,sfa26,sfa27,sfa29,sfa012,sfa013",    #FUN-A60027 add sfa012,sfa013  #MOD-A60129 add sfa27    #FUN-C10036 add sfa16
                  " FROM sfa_file",
                  " WHERE sfa01 = ? ",
                  " ORDER BY sfa27 "
      PREPARE g102_p2 FROM l_sql
      IF STATUS THEN CALL cl_err('p2:',STATUS,1) 
        # CALL cl_gre_drop_temptable(l_table||"|"||l_table1||"|"||l_table2||"|"||l_table3||"|"||l_table4||"|"||l_table5)    #FUN-B80086   MARK
         ...
         EXIT PROGRAM 
      END IF
      DECLARE g102_c2 CURSOR FOR g102_p2
#FUN-A60027 --------------mark------------      
#      #FUN-940008---Begin add
#      FOREACH g102_c2 INTO l_sfa.*
    ...
    END IF     
      IF tm.c ='Y' THEN
         LET l_sql = " SELECT oao03,oao05,oao06,oao04 FROM oao_file",
                     ...
                     " ORDER BY oao03 "
        PREPARE g102_memo1_1 FROM l_sql
        DECLARE s_memo1_c CURSOR FOR g102_memo1_1
      END IF
      IF tm.e ='Y' THEN
         LET l_sql = " SELECT sfw02,sfw03 FROM sfw_file ",
                     "  WHERE sfw01 = ? ",
                     "  ORDER BY sfw02 "
        PREPARE g102_memo1_2 FROM l_sql
        DECLARE g102_memo1_c CURSOR FOR g102_memo1_2
      END IF
#No.FUN-670104--END--
   #No.FUN-710082--begin
   #CALL cl_outnam('asfg102') RETURNING l_name
   #START REPORT asfg102_rep TO l_name
   #LET g_pageno = 0
...
#No.FUN-670104--END--
         LET l_cnt = 0
         FOREACH g102_c2 USING sr.sfb.sfb01 INTO sr1.*  #No.FUN-670104
...
#FUN-B50018------add-------------str-----------
     LET sr1.l_order1 = sr1.sfa03,sr1.sfa08,sr1.sfa12,sr1.sfa27
#FUN-B50018------add-------------end-----------
            ...
            EXECUTE insert_prep1 USING
               sr1.l_order1,                                              #FUN-B50018 add 
               sr.sfb.sfb01,sr1.sfa03 ,sr1.sfa05,sr1.sfa06,sr1.sfa062,
               sr1.sfa063  ,sr1.sfa07 ,sr1.sfa08,sr1.sfa09,sr1.sfa11,
               sr1.sfa12   ,sr1.sfa16 ,sr1.sfa25 ,sr1.sfa26,sr1.sfa27,sr1.sfa29,   #MOD-A60129 add sr1.sfa27    #FUN-C10036 add sr1.sfa16
               sr1.sfa012  ,sr1.sfa013,l_ima02   #FUN-A60027 add sfa012,sfa013 
...
#No.FUN-670104--END--
      ...
      IF tm.d ='Y' THEN
         ...
         IF SQLCA.SQLCODE THEN
            ...
            LET l_oea44=NULL
         END IF
         OPEN asfg102_curs2 USING l_oea04,l_oea44
         FETCH asfg102_curs2 INTO sr3.*
         IF SQLCA.SQLCODE=0 AND NOT cl_null(l_oea04) THEN
            SELECT occ02 INTO l_occ02 FROM occ_file WHERE occ01=sr3.ocf.ocf01
 #MOD-530401
            LET g_ctn_no1=''
            LET g_ctn_no2=''
            LET sr3.ocf.ocf101=g102_ocf_c(sr3.ocf.ocf101)
            LET sr3.ocf.ocf102=g102_ocf_c(sr3.ocf.ocf102)
            LET sr3.ocf.ocf103=g102_ocf_c(sr3.ocf.ocf103)
            LET sr3.ocf.ocf104=g102_ocf_c(sr3.ocf.ocf104)
            LET sr3.ocf.ocf105=g102_ocf_c(sr3.ocf.ocf105)
            LET sr3.ocf.ocf106=g102_ocf_c(sr3.ocf.ocf106)
            LET sr3.ocf.ocf107=g102_ocf_c(sr3.ocf.ocf107)
            LET sr3.ocf.ocf108=g102_ocf_c(sr3.ocf.ocf108)
            LET sr3.ocf.ocf109=g102_ocf_c(sr3.ocf.ocf109)
            LET sr3.ocf.ocf110=g102_ocf_c(sr3.ocf.ocf110)
            LET sr3.ocf.ocf111=g102_ocf_c(sr3.ocf.ocf111)
            LET sr3.ocf.ocf112=g102_ocf_c(sr3.ocf.ocf112)
            LET sr3.ocf.ocf201=g102_ocf_c(sr3.ocf.ocf201)
            LET sr3.ocf.ocf202=g102_ocf_c(sr3.ocf.ocf202)
            LET sr3.ocf.ocf203=g102_ocf_c(sr3.ocf.ocf203)
            LET sr3.ocf.ocf204=g102_ocf_c(sr3.ocf.ocf204)
            LET sr3.ocf.ocf205=g102_ocf_c(sr3.ocf.ocf205)
            LET sr3.ocf.ocf206=g102_ocf_c(sr3.ocf.ocf206)
            LET sr3.ocf.ocf207=g102_ocf_c(sr3.ocf.ocf207)
            LET sr3.ocf.ocf208=g102_ocf_c(sr3.ocf.ocf208)
            LET sr3.ocf.ocf209=g102_ocf_c(sr3.ocf.ocf209)
            LET sr3.ocf.ocf210=g102_ocf_c(sr3.ocf.ocf210)
            LET sr3.ocf.ocf211=g102_ocf_c(sr3.ocf.ocf211)
            LET sr3.ocf.ocf212=g102_ocf_c(sr3.ocf.ocf212)
            #str TQC-740275 add 
            EXECUTE insert_prep3 USING
               sr.sfb.sfb01,sr3.ocf.ocf01,sr3.ocf.ocf02, 
               sr3.ocf.ocf101,sr3.ocf.ocf102,sr3.ocf.ocf103,
               sr3.ocf.ocf104,sr3.ocf.ocf105,sr3.ocf.ocf106,
               sr3.ocf.ocf107,sr3.ocf.ocf108,sr3.ocf.ocf109,
               sr3.ocf.ocf110,sr3.ocf.ocf111,sr3.ocf.ocf112,
               sr3.ocf.ocf201,sr3.ocf.ocf202,sr3.ocf.ocf203,
               sr3.ocf.ocf204,sr3.ocf.ocf205,sr3.ocf.ocf206,
               sr3.ocf.ocf207,sr3.ocf.ocf208,sr3.ocf.ocf209,
               sr3.ocf.ocf210,sr3.ocf.ocf211,sr3.ocf.ocf212,
               l_occ02
...
#No.FUN-670104--BEGIN--
      IF tm.e ='Y' THEN
#         DECLARE g102_memo1_c CURSOR FOR
#            SELECT sfw02,sfw03 FROM sfw_file
#             WHERE sfw01 = sr.sfb.sfb01
#             ORDER BY sfw02
#No.FUN-670104--END--
         FOREACH g102_memo1_c USING sr.sfb.sfb01 INTO l_sfw02,l_sfw03 #No.FUN-670104
            IF SQLCA.sqlcode THEN
...
#      OUTPUT TO REPORT asfg102_rep(sr.*)
   END FOREACH
...
#FUN-C40019----mark---str--
{
   ...
   LET l_sql=
      ...
      "       B.sfa09,B.sfa11,B.sfa12,B.sfa16,B.sfa25,B.sfa26,B.sfa27,B.sfa29,B.sfa012,B.sfa013,B.ima02_1,",   #FUN-A60027 add sfa012,sfa013  #MOD-A60129 add B.sfa27    #FUN-C10036 add B.sfa16
      ...
      "  FROM g102_tmp A LEFT OUTER JOIN g102_tmp1 B ON ",
#      "  FROM g102_tmp A  ",
      "  A.sfb01 = B.sfb01_1 LEFT OUTER JOIN g102_tmp2 C ",
#      "  LEFT OUTER JOIN g102_tmp2 C ", 
      " ON A.sfb01 = C.sfb01_2 LEFT OUTER JOIN g102_tmp3 D ",
      " ON A.sfb01 = D.sfb01_3 LEFT OUTER JOIN g102_tmp4 E ",
      " ON A.sfb01 = E.sfb01_4 LEFT OUTER JOIN g102_tmp5 F ",
      " ON A.sfb01 = F.sfb01_5 "
 
   PREPARE asfg102_prepare0 FROM l_sql
   IF SQLCA.sqlcode != 0 THEN
      CALL cl_err('prepare0:',SQLCA.sqlcode,1)
   END IF
   DECLARE asfg102_curs0 CURSOR FOR asfg102_prepare0
 
   FOREACH asfg102_curs0 INTO cr.*
     #--------------No:TQC-A60097 add                                           
     ...
     #   cr.sfw03  ,cr.oao03  ,cr.oao05 ,cr.oao06 ,l_sfb02doc   #No:MOD-960330 add l_sfb02doc
     #FUN-C40019---mark---end---
   END FOREACH
   #end TQC-740275 add
}
...
###GENGRE###               tm.a,";",tm.b,";",tm.c,";",tm.d,";",tm.e,";",tm.f   #FUN-750047 add tm.f   
###GENGRE###               ,";",g_sma.sma1421           #FUN-A80150 add 
  #CALL cl_prt_cs3('asfg102','asfg102',l_sql,l_str)    #FUN-A60027
  LET g_cr_table = l_table                   #主報表的temp table名稱          #FUN-C40019 add
  LET g_cr_apr_key_f = "sfb01"               #報表主鍵欄位名稱，用"|"隔開     #FUN-C40019 add
  #No.FUN-A60027 ------------------------start----------------------
  IF g_sma.sma541 = 'Y' THEN
###GENGRE###     CALL cl_prt_cs3('asfg102','asfg102_1',l_sql,l_str)  
   #LET g_template = 'asfg102_1'  #TQC-D70059 
    LET g_template = 'asfg102'    #TQC-D70059 
    CALL asfg102_grdata()    ###GENGRE###
  ELSE
###GENGRE###     CALL cl_prt_cs3('asfg102','asfg102',l_sql,l_str)
   #LET g_template = 'asfg102'    #TQC-D70059
    LET g_template = 'asfg102_1'  #TQC-D70059 
    CALL asfg102_grdata()    ###GENGRE###
  END IF 
  #No.FUN-A60027 -------------------------end-----------------------  
  #FINISH REPORT asfg102_rep
...
#           #            "  OR bmd08 ='ALL')",
#           #            " ORDER BY sfa03"
#           #PREPARE g102_p3 FROM l_sql
#           #IF STATUS THEN CALL cl_err('p3:',STATUS,1) EXIT PROGRAM END IF
#           #DECLARE g102_c3 CURSOR FOR g102_p3
#           #FOREACH g102_c3 INTO sr1.*
#           #    IF STATUS THEN
...
#        LET l_y='Y'
#        FOREACH g102_memo1_c INTO l_sfw02,l_sfw03
#          IF SQLCA.sqlcode THEN
#             CALL cl_err('',SQLCA.sqlcode,0)  
#             EXIT FOREACH
#          END IF
...
FUNCTION asfg102_grdata()
    ...
    WHILE TRUE
        ...
        LET handler = cl_gre_outnam("asfg102")
        IF handler IS NOT NULL THEN
            START REPORT asfg102_rep TO XML HANDLER handler
            LET l_sql = "SELECT * FROM ",g_cr_db_str CLIPPED,l_table CLIPPED,
                        " ORDER BY sfb01"
            DECLARE asfg102_datacur1 CURSOR FROM l_sql
            FOREACH asfg102_datacur1 INTO sr1.*
                OUTPUT TO REPORT asfg102_rep(sr1.*)
            END FOREACH
            FINISH REPORT asfg102_rep
        END IF
...
REPORT asfg102_rep(sr1)
    ...
    DEFINE l_sfb02doc              STRING
    DEFINE l_sfb02desc_sfb04desc   STRING
    DEFINE l_sfb05_ima08           STRING
    DEFINE l_sfb08                 STRING
    DEFINE l_sfb08_ima55           STRING
    DEFINE l_sfb221                STRING
    DEFINE l_sfb22_sfb221          STRING
    DEFINE l_sfb251                STRING
    DEFINE l_sfb251_1              STRING
    DEFINE l_sfb251_2              STRING
    DEFINE l_sfb28_desc            STRING
    DEFINE l_sfb39_desc            STRING
    DEFINE l_sfb42                 STRING
    DEFINE l_sfb42_1               STRING
    ...
    #FUN-B50018--------add-------end----------
    #FUN-CA0107 add ----------------------s
    DEFINE l_subrep02_cnt          INTEGER
    DEFINE l_subrep03_cnt          INTEGER
    DEFINE l_subrep04_cnt          INTEGER
    DEFINE l_subrep05_cnt          INTEGER
    DEFINE l_subfot02_show        LIKE type_file.chr1 
    DEFINE l_subfot03_show        LIKE type_file.chr1 
    DEFINE l_subfot04_show        LIKE type_file.chr1 
    DEFINE l_subfot05_show        LIKE type_file.chr1 
    #FUN-CA0107 add ----------------------e
    ...
    FORMAT
        ...
        LET l_sql = "SELECT * FROM ",g_cr_db_str CLIPPED,l_table4 CLIPPED,
                        " WHERE sfb01_4 = '",sr1.sfb01 CLIPPED,"'"
            START REPORT asfg102_subrep01
            DECLARE asfg102_repcur1 CURSOR FROM l_sql
            FOREACH asfg102_repcur1 INTO sr5.*
                OUTPUT TO REPORT asfg102_subrep01(sr5.*)
            END FOREACH
            FINISH REPORT asfg102_subrep01



        IF cl_null(sr1.sfb22) OR sr1.sfb22 = ' ' THEN
           LET l_display = 'N'
        ELSE 
           LET l_display = 'Y'
        END IF
        ...
        IF cl_null(sr1.sfb07) OR sr1.sfb07 = ' ' THEN
           LET l_display1 = 'N'
        ELSE
           LET l_display1 = 'Y'
        END IF
        ...
        ON EVERY ROW
            ...
            #FUN-B50018--------add-------str----------
            IF cl_null(sr1.sfb82) THEN  LET l_display3 = 'N' ELSE LET l_display3 = 'Y' END IF
            PRINTX l_display3

            IF cl_null(sr1.sfb06) THEN  LET l_display4 = 'N' ELSE LET l_display4 = 'Y' END IF
            PRINTX l_display4

            IF cl_null(sr1.sfb22) OR sr1.sfb22=''  THEN LET l_display5 = 'N' ELSE LET l_display5 = 'Y'  END IF
            PRINTX l_display5



            LET l_sfb01 = ' '
            IF NOT cl_null(sr1.sfb01) THEN
               LET l_sfb01 = sr1.sfb01[1,3]
            END IF

            IF l_sfb01 = '510' THEN
                LET l_ISO = 'FT-74-01-19'
            ELSE
                IF l_sfb01 = '511' OR l_sfb01 = '512' OR l_sfb01 = '513' OR l_sfb01 = '514' OR l_sfb01 = '515' THEN
                   LET l_ISO = 'FT-72-05-06G'
                ELSE
                    IF l_sfb01 = '51B' THEN
                       LET l_ISO = 'FT-72-05-26'
                    ELSE 
                       IF l_sfb01 = 'Y10' THEN
                          LET l_ISO = 'FT-72-05-16A'
                       ELSE
                           IF l_sfb01 = 'Z10' THEN
                              LET l_ISO = 'FT-72-05-17A'
                           ELSE
                              LET l_ISO = 'FT-72-05-11D'
                           END IF
                       END IF
                    END IF
                 END IF
            ...
            IF NOT cl_null(sr1.sfb02) THEN
               LET l_sfb02doc = s_wotype(sr1.sfb02)
            ELSE
               LET l_sfb02doc = NULL
            END IF

            LET l_sfb02desc_sfb04desc = l_sfb02doc,'/',l_sfb04_desc,' '
            PRINTX l_sfb02desc_sfb04desc

            LET l_sfb05_ima08  = sr1.sfb05,' ',sr1.ima08
            PRINTX l_sfb05_ima08

            LET l_sfb08 = ' '
            IF NOT cl_null(sr1.sfb08) THEN
               LET l_sfb08 = sr1.sfb08 USING '###,##&.&&&'
            END IF
            LET l_sfb08_ima55 = l_sfb08,' ',sr1.ima55
            PRINTX l_sfb08_ima55

            LET l_sfb221 = sr1.sfb221 USING '--,---,--&' 
            LET l_sfb22_sfb221 = sr1.sfb22,'/',l_sfb221
            PRINTX l_sfb22_sfb221

            LET l_sfb251_1 = sr1.sfb251 USING  "yyyy/MM/dd" 
            LET l_sfb251_2 = cl_gr_getmsg("gre-088",g_lang,'0')
            IF NOT cl_null(sr1.sfb251) THEN
                IF sr1.sfb04 = '1' THEN
                   LET l_sfb251 = l_sfb251_1,' ',l_sfb251_2
                ELSE
                   LET l_sfb251 = l_sfb251_1
                END IF       
            END IF       
            PRINTX l_sfb251
                      
           
            IF sr1.sfb28 = '1' OR sr1.sfb28 = '2' OR sr1.sfb28 = '3' THEN
               LET l_sfb28_desc = cl_gr_getmsg("gre-097",g_lang,sr1.sfb28)
               LET l_sfb28_desc = sr1.sfb28,' ',l_sfb28_desc
            ELSE
               LET l_sfb28_desc = cl_gr_getmsg("gre-097",g_lang,'0')
            END IF
            PRINTX l_sfb28_desc

            IF NOT cl_null(sr1.sfb39) THEN
               LET l_sfb39_desc = cl_gr_getmsg("gre-098",g_lang,sr1.sfb39)
               LET l_sfb39_desc = sr1.sfb39,' ',l_sfb39_desc
            END IF
            PRINTX l_sfb39_desc

            LET l_sfb42_1 = sr1.sfb42 USING '--,---,--&'
            IF cl_null(l_sfb42_1) THEN
               LET l_sfb42 = '0'
            ELSE
               LET l_sfb42 = l_sfb42_1
            END IF
            PRINTX l_sfb42
            #FUN-B50018--------add-------end---------
        ...
        AFTER GROUP OF sr1.sfb01
            #FUN-B50018--------add-------str----------
            #FUN-CA0107 add -(s)
            LET l_subfot02_show="N"
            LET l_sql = " SELECT COUNT(*) FROM ",g_cr_db_str CLIPPED,l_table1 CLIPPED,
                        " WHERE sfb01_1 = '",sr1.sfb01 CLIPPED,"'"
            DECLARE asfg102_repcnt02 CURSOR FROM l_sql
            FOREACH asfg102_repcnt02 INTO l_subrep02_cnt 
            END FOREACH 
            DISPLAY "l_subrep02_cnt:",l_subrep02_cnt
            IF l_subrep02_cnt = 0 THEN LET l_subfot02_show="Y" END IF 
            PRINTX l_subfot02_show
            #FUN-CA0107 add -(e)
            LET l_sql = "SELECT * FROM ",g_cr_db_str CLIPPED,l_table1 CLIPPED,
                        " WHERE sfb01_1 = '",sr1.sfb01 CLIPPED,"'"
                #       " ORDER BY l_order1"
            START REPORT asfg102_subrep02
            DECLARE asfg102_repcur2 CURSOR FROM l_sql
            FOREACH asfg102_repcur2 INTO sr2.*
                OUTPUT TO REPORT asfg102_subrep02(sr2.*)
            END FOREACH
            FINISH REPORT asfg102_subrep02



            #FUN-CA0107 add -(s)
            LET l_subfot03_show="N"
            LET l_sql = " SELECT COUNT(*) FROM ",g_cr_db_str CLIPPED,l_table2 CLIPPED,
                        " WHERE sfb01_2 = '",sr1.sfb01 CLIPPED,"'"
            DECLARE asfg102_repcnt03 CURSOR FROM l_sql
            FOREACH asfg102_repcnt03 INTO l_subrep03_cnt 
            END FOREACH                         
            IF l_subrep03_cnt=0 THEN LET l_subfot03_show="Y" END IF 
            PRINTX l_subfot03_show
            #FUN-CA0107 add -(e)            
            LET l_sql = "SELECT * FROM ",g_cr_db_str CLIPPED,l_table2 CLIPPED,
                        " WHERE sfb01_2 = '",sr1.sfb01 CLIPPED,"'"
            START REPORT asfg102_subrep03
            DECLARE asfg102_repcur3 CURSOR FROM l_sql
            FOREACH asfg102_repcur3 INTO sr3.*
                OUTPUT TO REPORT asfg102_subrep03(sr3.*)
            END FOREACH
            FINISH REPORT asfg102_subrep03


            #FUN-CA0107 add -(s)
            LET l_subfot04_show="N"
            LET l_sql = " SELECT COUNT(*) FROM ",g_cr_db_str CLIPPED,l_table5 CLIPPED,
                        " WHERE sfb01_5 = '",sr1.sfb01 CLIPPED,"'",
                        "   AND oao03 = 1"
            DECLARE asfg102_repcnt04 CURSOR FROM l_sql
            FOREACH asfg102_repcnt04 INTO l_subrep04_cnt 
            END FOREACH                         
            IF l_subrep04_cnt=0 THEN LET l_subfot04_show="Y" END IF 
            DISPLAY "l_subrep04_cnt:",l_subrep04_cnt
            DISPLAY "l_subfot04_show:",l_subfot04_show
            PRINTX l_subfot04_show
            #FUN-CA0107 add -(e)             
            LET l_sql = "SELECT * FROM ",g_cr_db_str CLIPPED,l_table5 CLIPPED,
                        #" WHERE oao01 = '",sr1.sfb01 CLIPPED,"'",  #FUN-CA0107 mark
                        " WHERE sfb01_5 = '",sr1.sfb01 CLIPPED,"'", #FUN-CA0107 add
                        "   AND oao03 = 1"
            START REPORT asfg102_subrep04
            DECLARE asfg102_repcur4 CURSOR FROM l_sql
            FOREACH asfg102_repcur4 INTO sr6.*
                OUTPUT TO REPORT asfg102_subrep04(sr6.*)
            END FOREACH
            FINISH REPORT asfg102_subrep04

            #FUN-CA0107 add -(s)
            LET l_subfot05_show="N"
            LET l_sql = " SELECT COUNT(*) FROM ",g_cr_db_str CLIPPED,l_table3 CLIPPED,
                        " WHERE sfb01_3 = '",sr1.sfb01 CLIPPED,"'"
            DECLARE asfg102_repcnt05 CURSOR FROM l_sql
            FOREACH asfg102_repcnt05 INTO l_subrep05_cnt 
            END FOREACH                         
            IF l_subrep05_cnt=0 THEN LET l_subfot05_show="Y" END IF 
            PRINTX l_subfot05_show
            #FUN-CA0107 add -(e) 
            LET l_sql = "SELECT * FROM ",g_cr_db_str CLIPPED,l_table3 CLIPPED,
                        " WHERE sfb01_3 = '",sr1.sfb01 CLIPPED,"'"
            START REPORT asfg102_subrep05
            DECLARE asfg102_repcur5 CURSOR FROM l_sql
            FOREACH asfg102_repcur5 INTO sr4.*
                OUTPUT TO REPORT asfg102_subrep05(sr4.*)
            END FOREACH
            FINISH REPORT asfg102_subrep05
        #FUN-B50018--------add-------end---------
...
REPORT asfg102_subrep02(sr2)
    DEFINE sr2 sr2_t
#   DEFINE l_display    STRING    #FUN-CB0051
    DEFINE l_sfa11_name STRING

    ORDER EXTERNAL BY sr2.sfb01_1,sr2.l_order1

    FORMAT
        BEFORE GROUP OF sr2.sfb01_1   
#          PRINTX l_display       #FUN-CB0051
           PRINTX g_sma.sma541
        ...
        ON EVERY ROW
            LET l_sfa11_name = cl_gr_getmsg("gre-253",g_lang,sr2.sfa11)      #FUN-C10036 add
            PRINTX l_sfa11_name                                       #FUN-C10036 add 

#FUN-CB0051--mark--str--
#           IF cl_null(sr2.sfa03) OR sr2.sfa03 != 5 AND sr2.sfa05 = 0 THEN
#              LET l_display = "N"
#           ELSE
#              LET l_display = "Y"
#           END IF
...
#FUN-CB0051--mark--end--
        ...
        AFTER GROUP OF sr2.l_order1
#           IF cl_null(sr2.sfa03) THEN LET l_display = 'Y' ELSE LET l_display = 'N' END IF   #FUN-CB0051
#           PRINTX l_display   #FUN-CB0051
...
REPORT asfg102_subrep03(sr3)
    DEFINE sr3 sr3_t
#   DEFINE l_display6  LIKE type_file.chr1   #FUN-CB0051


    ORDER EXTERNAL BY sr3.ecb03

    FORMAT

        BEFORE GROUP OF sr3.ecb03 

        ON EVERY ROW
            PRINTX sr3.*
            

         AFTER GROUP OF sr3.ecb03
 
#           IF cl_null(sr3.ecb03) THEN LET l_display6 = 'Y' ELSE LET l_display6 = 'N' END IF   #FUN-CB0051
#           PRINTX l_display6  #FUN-CB0051



END REPORT

REPORT asfg102_subrep04(sr6)
    DEFINE sr6 sr6_t
#   DEFINE l_display2   LIKE type_file.chr1   #FUN-CB0051

    ORDER EXTERNAL BY sr6.oao06

    FORMAT
        BEFORE GROUP OF sr6.oao06   
            PRINTX sr6.oao06

        ON EVERY ROW
            PRINTX sr6.*

        AFTER GROUP OF sr6.oao06
#           IF cl_null(sr6.oao06) THEN LET l_display2 = 'Y' ELSE LET l_display2 = 'N' END IF #FUN-CB0051
#           PRINTX l_display2   #FUN-CB0051

END REPORT


REPORT asfg102_subrep05(sr4)
    DEFINE sr4 sr4_t
    DEFINE l_ocf01_occ02  STRING
    DEFINE l_lineno       LIKE type_file.num5
#   DEFINE l_display3     LIKE type_file.chr1   #FUN-CB0051 

    ORDER EXTERNAL BY sr4.ocf01

    FORMAT
        BEFORE GROUP OF sr4.ocf01
            LET l_lineno = 0
        ...
        AFTER GROUP OF sr4.ocf01
#           IF cl_null(sr4.ocf01) THEN LET l_display3 = 'Y' ELSE LET l_display3 = 'N' END IF   #FUN-CB0051
#           PRINTX l_display3      #FUN-CB0051                  
