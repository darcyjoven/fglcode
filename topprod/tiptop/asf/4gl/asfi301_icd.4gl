...
# Modify.........: No.TQC-D40114 13/07/17 By yangtt CHI-B80044報錯訊息邏輯有誤,和GP5.25邏輯不一致,修改報錯訊息邏輯,與之和GP5.25一致
# Modify.........: No.MOD-D90130 13/09/25 By suncx 新增條件儲存按鈕
...
#str TQC-C60025 add
DEFINE g_rec_b0  LIKE type_file.num5     #料號單身筆數
DEFINE g_rec_b1  LIKE type_file.num5     #倉儲批單身筆數
DEFINE g_rec_b2  LIKE type_file.num5     #刻號/BIN/Datecode單身筆數
DEFINE l_ac0     LIKE type_file.num5     #目前處理的ARRAY CNT
DEFINE l_ac1     LIKE type_file.num5     #目前處理的ARRAY CNT
DEFINE l_ac2     LIKE type_file.num5     #目前處理的ARRAY CNT
DEFINE g_idc08_a LIKE idc_file.idc08     #挑選數量統計
DEFINE g_idc12_a LIKE idc_file.idc12     #挑選數量統計
DEFINE g_idc08_b LIKE idc_file.idc08     #挑選數量統計
DEFINE g_idc12_b LIKE idc_file.idc12     #挑選數量統計
DEFINE g_sfa03   DYNAMIC ARRAY OF RECORD
         cho0    LIKE type_file.chr1,
         sfa03   LIKE sfa_file.sfa03,
         ima02   LIKE ima_file.ima02,
         ima021  LIKE ima_file.ima021
                 END RECORD
DEFINE g_sfa03_t RECORD
         cho0    LIKE type_file.chr1,
         sfa03   LIKE sfa_file.sfa03,
         ima02   LIKE ima_file.ima02,
         ima021  LIKE ima_file.ima021
                 END RECORD
DEFINE g_idc1    DYNAMIC ARRAY OF RECORD
         cho1    LIKE type_file.chr1,
         idc02   LIKE idc_file.idc02,
         idc03   LIKE idc_file.idc03,
         idc04   LIKE idc_file.idc04,
         idc07_1 LIKE idc_file.idc07,
         idc08_1 LIKE idc_file.idc08,
         idc08_a LIKE idc_file.idc08,
         idc12_1 LIKE idc_file.idc12,
         idc12_a LIKE idc_file.idc12,
         idc21_1 LIKE idc_file.idc21
                 END RECORD
DEFINE g_idc1_t  RECORD
         cho1    LIKE type_file.chr1,
         idc02   LIKE idc_file.idc02,
         idc03   LIKE idc_file.idc03,
         idc04   LIKE idc_file.idc04,
         ...
         idc21_1 LIKE idc_file.idc21
                 END RECORD
DEFINE g_idc2    DYNAMIC ARRAY OF RECORD
         cho2    LIKE type_file.chr1,
         idc05   LIKE idc_file.idc05,
         idc06   LIKE idc_file.idc06,
         idc11   LIKE idc_file.idc11,
         idc07_2 LIKE idc_file.idc07,
         idc08_2 LIKE idc_file.idc08,
         idc08_b LIKE idc_file.idc08,
         idc12_2 LIKE idc_file.idc12,
         idc12_b LIKE idc_file.idc12,
         idc21_2 LIKE idc_file.idc21
                 END RECORD
DEFINE g_idc2_t  RECORD
         cho2    LIKE type_file.chr1,
         idc05   LIKE idc_file.idc05,
         idc06   LIKE idc_file.idc06,
         idc11   LIKE idc_file.idc11,
...
#                             sub_p_o, s_n, run_card, gen_m_iss, aps_related_data, aps_route_subc_data")         
   CALL aws_efapp_flowaction("insert, modify, delete, detail, query, locale, void, undo_void, confirm, undo_confirm, easyflow_approval,gen_allotment,delete_allotment,sub,gen_allotment,delete_allotment,sub,gen_routing, mold_wtdw, mold_return, m_iss, mat_shift, sub_p_o, s_n, run_card, gen_m_iss, aps_related_data, aps_route_subc_data, upd_product_qty, s_icdout, aic_s_icdqry,wo_change") #FUN-C30017 add wo_change  #CHI-D20010 add undo_void
#FUN-A50032 mod end ----
...
DEFINE  lc_qbe_sn       LIKE    gbm_file.gbm01    #No.FUN-580031  HCN
   ...
   ELSE
      ...
      CONSTRUCT BY NAME g_wc ON sfb01,sfb101,sfb44,sfb81,sfb02,sfb39,sfb87,sfb04,    #FUN-8C0081 add sfb44
                                ...
                                sfb05,
                               #sfbiicd09,sfbiicd14,sfbiicd04,sfbiicd05,sfbiicd06,  #TQC-C60025 mark
                                sfbiicd09,sfbiicd14,sfbiicd06,                      #TQC-C60025
...
#FUN-A50032 mod str ----
                       ...
                       #                          mold_wtdw, mold_return, m_iss, mat_shift,  #MOD-A50141 mod #wo_change_mat_shift->mat_shift
                       #                          sub_p_o, s_n, run_card, gen_m_iss, aps_related_data, aps_route_subc_data")      
                        CALL aws_efapp_flowaction("insert, modify, delete, detail, query, locale, void, undo_void, confirm, undo_confirm, easyflow_approval,gen_allotment,delete_allotment,sub,gen_allotment,delete_allotment,sub,gen_routing, mold_wtdw, mold_return, m_iss, mat_shift, sub_p_o, s_n, run_card, gen_m_iss, aps_related_data, aps_route_subc_data, upd_product_qty, s_icdout, aic_s_icdqry,wo_change,barcode_gen") #FUN-C30017 add wo_change   #CHI-D20010 add undo_void #FUN-D30030 add barcode_gen
#FUN-A50032 mod end ----
...
#FUN-A50032 mod end ----
         ...
         WHEN "confirm"
            IF cl_chk_act_auth() THEN  
               ...
               FROM imaicd_file WHERE imaicd00= g_sfb.sfb05   #MOD-D30027
               IF NOT cl_null(l_imaicd04) AND l_imaicd04 <> '9' THEN   #MOD-D30027        
                  CALL i301_sfp_gen() RETURNING l_sfp01   #產生發料單
                  IF NOT cl_null(l_sfp01) THEN
                     IF NOT i301_idb_cp(l_sfp01) THEN
                        LET g_success='N'
                        ROLLBACK WORK
                     END IF 
                  ELSE 
               ...
               END IF   #MOD-D30027                
               #FUN-C30274 --END--
               IF i301_icd_chk_icd(g_sfb.sfb01) AND g_success='Y' THEN   #FUN-C30274 add AND g_success='Y'            
...
#FUN-A80054--end--add---------------------------------------------------------------------------
                     ...
                     END IF  #FUN-A80054
                     IF g_success='Y' THEN
                  #      CALL i301_icd_stock_post(g_sfb.sfb01) #CHI-C90045 
                        CALL i301sub_refresh(g_sfb.sfb01) RETURNING g_sfb.*
      ...
      WHEN "aic_s_icdqry"
       IF cl_chk_act_auth() THEN
        ...
        IF g_sfb.sfb87 <> 'X' THEN
          ...
          #FUN-C30274 --END mark--
          END IF         
          CALL s_icdqry(-1,g_sfb.sfb01,1,'N','')   #FUN-C30274
        END IF
 
    #@WHEN 刻號/BIN號出庫明細
      WHEN "s_icdout" 
        IF cl_chk_act_auth() AND l_ac > 0 THEN   #FUN-C30274 add l_ac > 0 
          ...
          #FUN-A50032---add--end-----
             #FUN-C30274 --START--
             IF g_sfa[l_ac].sfaiicd06 = 'Y' THEN
                CALL cl_err('','aic-222',0)
             ELSE 
             #FUN-C30274 --END--
                IF g_sfb.sfb87 = 'N' THEN
                   ...
                   #FUN-C30274 --START mark--
                   CALL i301_icdout(l_ac)   #FUN-C30274
                END IF
             END IF  #FUN-C30274  
    ...
    #str TQC-C50140 add
    #@WHEN 多倉儲批備料明細
      WHEN "mntn_allotment_for_multi_wh" 
        IF cl_chk_act_auth() AND l_ac > 0 THEN
           IF g_sfa[l_ac].sfaiicd06 = 'Y' THEN
              CALL i301_mntn_allotment_for_multi_wh(g_sfb.sfb01,g_sfa[l_ac].sfa03,
                                                    g_sfa[l_ac].sfa08,g_sfa[l_ac].sfa12,
                                                    g_sfa[l_ac].sfa27,g_sfa[l_ac].sfa012,
                                                    g_sfa[l_ac].sfa013)
           END IF      
        END IF      
    #end TQC-C50140 add
...
FUNCTION i301_sfp_gen()
    ...
    IF g_success = 'Y' THEN
       #COMMIT WORK   #FUN-C30274 mark
    ELSE
       CALL cl_err('','abm-020',1)
       #ROLLBACK WORK   #FUN-C30274 mark
    END IF
    RETURN l_no 
...
#刻號/BIN號出庫明細 
#FUNCTION i301_icdout(p_sfp,l_i)  #FUN-C30274 mark
FUNCTION i301_icdout(l_i)            #FUN-C30274 
...
DEFINE l_ecdicd01    LIKE ecd_file.ecdicd01      #FUN-C30274
DEFINE l_sfa         RECORD LIKE sfa_file.*      #FUN-C30274 
DEFINE l_sfaiicd03   LIKE sfai_file.sfaiicd03    #FUN-C30274
DEFINE l_dies_sum    LIKE sfs_file.sfs05         #FUN-C30274
DEFINE l_sfb08       LIKE sfb_file.sfb08         #FUN-C30274
DEFINE l_r           LIKE type_file.chr1         #FUN-C30302
DEFINE l_qty         LIKE type_file.num15_3      #FUN-C30302
DEFINE l_idb11       LIKE idb_file.idb11         #TQC-C50189 add
DEFINE l_idb11_sum   LIKE idb_file.idb11         #TQC-C60025 add
DEFINE l_imaicd04    LIKE imaicd_file.imaicd04   #FUN-C30302 add
DEFINE l_imaicd04_h  LIKE imaicd_file.imaicd04   #TQC-C60025 add
DEFINE l_flag        LIKE type_file.chr1         #TQC-C60025 add
DEFINE l_imaicd08    LIKE imaicd_file.imaicd08   #MOD-D30095
         
  #IF NOT cl_null(p_sfp.sfp01) AND NOT cl_null(l_ac) AND l_ac <> 0 THEN   #FUN-C30274 mark
   IF NOT cl_null(g_sfb.sfb01) THEN   #FUN-C30274
     #str TQC-C60017 add
      IF NOT s_icdbin(g_sfa[l_i].sfa03) THEN
         CALL cl_err(g_sfa[l_i].sfa03,'sub-175',1)
         RETURN
      END IF
     #end TQC-C60017 add
     #FUN-C30274 --START mark--
     ...
     # END IF
      #FUN-C30274 --END mark--
      #FUN-C30274  --START--
      CALL s_icdout(g_sfa[l_i].sfa03, g_sfa[l_i].sfa30, 
                    g_sfa[l_i].sfa31, g_sfa[l_i].sfaiicd03,
                    g_sfa[l_i].sfa12, g_sfa[l_i].sfa05,
                    g_sfb.sfb01, 1,
                    p_sfp.sfp02,'N','','','','') 
            RETURNING l_dies,l_r,l_qty   #FUN-C30302
      #FUN-C30302---begin
      IF l_r = 'Y' THEN
         LET l_qty = s_digqty(l_qty,g_sfa[l_i].sfa12) 
         LET g_sfa[l_i].sfa05 = l_qty
         UPDATE sfa_file SET sfa05 = l_qty 
          WHERE sfa01 = g_sfb.sfb01
            AND sfa03 = g_sfa[l_i].sfa03
            AND sfa08 = g_sfa[l_i].sfa08
            AND sfa12 = g_sfa[l_i].sfa12
            AND sfa27 = g_sfa[l_i].sfa27
            AND sfa012= g_sfa[l_i].sfa012
            AND sfa013= g_sfa[l_i].sfa013
        #str TQC-C60025 add
         UPDATE sfaa_file SET sfaa05 = l_qty 
          WHERE sfaa01 = g_sfb.sfb01
            AND sfaa03 = g_sfa[l_i].sfa03
            AND sfaa08 = g_sfa[l_i].sfa08
            AND sfaa12 = g_sfa[l_i].sfa12
            AND sfaa27 = g_sfa[l_i].sfa27
            AND sfaa012= g_sfa[l_i].sfa012
            AND sfaa013= g_sfa[l_i].sfa013
        #end TQC-C60025 add
      END IF 

      SELECT imaicd04 INTO l_imaicd04 FROM imaicd_file
       WHERE imaicd00 = g_sfa[l_i].sfa03
      IF l_imaicd04 = '2' THEN   #CP時要回寫參考數量
         IF l_r != 'N' OR l_r IS NULL THEN
            LET g_sfa[l_i].sfaiicd01 = l_dies
            UPDATE sfai_file SET sfaiicd01 = l_dies 
             WHERE sfai01 = g_sfb.sfb01
               AND sfai03 = g_sfa[l_i].sfa03
               AND sfai08 = g_sfa[l_i].sfa08
               AND sfai12 = g_sfa[l_i].sfa12
               AND sfai27 = g_sfa[l_i].sfa27
               AND sfai012= g_sfa[l_i].sfa012
               AND sfai013= g_sfa[l_i].sfa013

            UPDATE sfaa_file SET sfaa051 = l_dies 
             WHERE sfaa01 = g_sfb.sfb01
               AND sfaa03 = g_sfa[l_i].sfa03
               AND sfaa08 = g_sfa[l_i].sfa08
               AND sfaa12 = g_sfa[l_i].sfa12
            ...
            IF l_ecdicd01 = '6' THEN   #Turnkey
               UPDATE sfb_file SET sfb08=l_dies WHERE sfb01=g_sfb.sfb01
              #UPDATE sfbi_file SET sfbiicd04=0,sfbiicd06=l_dies WHERE sfbi01=g_sfb.sfb01  #TQC-C60025 mark
               UPDATE sfbi_file SET sfbiicd06=l_dies WHERE sfbi01=g_sfb.sfb01              #TQC-C60025
               UPDATE sfa_file SET sfa161=sfa05/l_dies 
                WHERE sfa01 = g_sfb.sfb01
                  AND sfa03 = g_sfa[l_i].sfa03
                  AND sfa08 = g_sfa[l_i].sfa08
                  AND sfa12 = g_sfa[l_i].sfa12
                  ...
                  AND sfa012= g_sfa[l_i].sfa012
                  AND sfa013= g_sfa[l_i].sfa013
               SELECT sfb_file.* INTO g_sfb.* FROM sfb_file WHERE sfb01=g_sfb.sfb01
               SELECT sfbi_file.* INTO g_sfbi.* FROM sfbi_file WHERE sfbi01=g_sfb.sfb01
               CALL i301_show() 
            END IF
         END IF
      END IF
     ...
     #str TQC-C60025 add
      #Wafer -> CP -> DS -> AS -> FT
      #發Wafer來生產CP,發料單位為PCS,生產單位為PCS(不需要回寫,因為輸入的人很清楚要生產幾片)
      #發Wafer或CP來生產 DS、AS、FT時,發料單位為PCS,生產單位為EA,單位不同所以要將DIES數回寫到工單單頭的生產數量
      #發DS來生產AS、FT時,發料單位為EA,生產單位為EA,將發料數量回寫工單單頭的生產數量
      SELECT imaicd04 INTO l_imaicd04_h FROM imaicd_file
       WHERE imaicd00 = g_sfb.sfb05
      LET l_flag = '0'
      #發Wafer或CP生產DS/AS/FT
      IF (l_imaicd04='1' OR l_imaicd04='2') AND (l_imaicd04_h='3' OR l_imaicd04_h='4') THEN
         LET l_flag = '1'
      END IF
      #發DS生產AS/FT或發AS生產FT
      IF l_imaicd04='3' AND (l_imaicd04_h='3' OR l_imaicd04_h='4') THEN
         LET l_flag = '2'
      END IF
      IF l_flag = '1' OR l_flag = '2' THEN
         IF cl_confirm("aic-221") THEN   
            DECLARE i301_sfa_dies CURSOR FOR
             SELECT sfa_file.*,sfaiicd03 FROM sfa_file,sfai_file
              WHERE sfa01 = g_sfb.sfb01 
                AND sfa01 = sfai01 AND sfa03 = sfai03
                AND sfa08 = sfai08 AND sfa12 = sfai12
            INITIALIZE l_sfa.* TO NULL
            LET l_sfaiicd03 = ''
            LET l_dies_sum = 0
            LET l_idb11_sum = 0
            FOREACH i301_sfa_dies INTO l_sfa.*,l_sfaiicd03
               IF STATUS THEN
                  CALL cl_err('FOREACH:',STATUS,0) EXIT FOREACH
               END IF
               LET l_dies = 0   LET l_idb11 = 0
               #MOD-D30095---begin
               SELECT imaicd08 INTO l_imaicd08 FROM imaicd_file
                WHERE imaicd00 = l_sfa.sfa03
               IF l_imaicd08 = 'Y' THEN 
               #MOD-D30095---end
               #抓SUM(idb16)來回寫參考數量
                  SELECT SUM(idb16),SUM(idb11) INTO l_dies,l_idb11 FROM idb_file
                    WHERE idb01 = l_sfa.sfa03 AND idb02 = l_sfa.sfa30
                      AND idb03 = l_sfa.sfa31 AND idb04 = l_sfaiicd03
                      AND idb07 = g_sfb.sfb01 AND idb08 = 1 
                      AND idb16 IS NOT NULL   AND (idb20 = 'Y'  
                      OR  idb06 = 'BIN00')  #MOD-D30095 wafer要做刻號bin管理時BIN為BIN00且不考慮pass bin
               #MOD-D30095---begin
               ELSE
                  SELECT SUM(idb16),SUM(idb11) INTO l_dies,l_idb11 FROM idb_file
                    WHERE idb01 = l_sfa.sfa03 AND idb02 = l_sfa.sfa30
               ...
               END IF 
               #MOD-D30095---end
               IF cl_null(l_idb11) THEN LET l_idb11=0 END IF   
               LET l_idb11_sum = l_idb11_sum + l_idb11
               IF cl_null(l_dies) THEN LET l_dies=0 END IF   
               LET l_dies_sum = l_dies_sum + l_dies
               IF l_flag = '1' THEN
                  UPDATE sfai_file SET sfaiicd01 = l_dies
                  ...
                  IF l_imaicd04='1' THEN
                     UPDATE sfaa_file SET sfaa051 = 0
                      WHERE sfaa01 = l_sfa.sfa01 AND sfaa03 = l_sfa.sfa03
                        AND sfaa08 = l_sfa.sfa08 AND sfaa12 = l_sfa.sfa12
                        AND sfaa27 = l_sfa.sfa27 AND sfaa012= l_sfa.sfa012
                        AND sfaa013= l_sfa.sfa013
                  ELSE
                     UPDATE sfaa_file SET sfaa051 = l_dies
                      WHERE sfaa01 = l_sfa.sfa01 AND sfaa03 = l_sfa.sfa03
                        AND sfaa08 = l_sfa.sfa08 AND sfaa12 = l_sfa.sfa12
                  ...
                  END IF
               ELSE
                  UPDATE sfai_file SET sfaiicd01 = l_idb11
                   WHERE sfai01 = l_sfa.sfa01 AND sfai03 = l_sfa.sfa03
                     AND sfai08 = l_sfa.sfa08 AND sfai12 = l_sfa.sfa12
                     AND sfai27 = l_sfa.sfa27 AND sfai012= l_sfa.sfa012
                     AND sfai013= l_sfa.sfa013
                  UPDATE sfaa_file SET sfaa051 = l_idb11
                   WHERE sfaa01 = l_sfa.sfa01 AND sfaa03 = l_sfa.sfa03
                     AND sfaa08 = l_sfa.sfa08 AND sfaa12 = l_sfa.sfa12
                     AND sfaa27 = l_sfa.sfa27 AND sfaa012= l_sfa.sfa012
                     AND sfaa013= l_sfa.sfa013
               END IF
            END FOREACH
            IF cl_null(l_dies_sum) THEN LET l_dies_sum=0 END IF   
            IF cl_null(l_idb11_sum) THEN LET l_idb11_sum=0 END IF   
            IF l_flag = '1' THEN
               UPDATE sfb_file SET sfb08=l_dies_sum WHERE sfb01=g_sfb.sfb01
               UPDATE sfbi_file SET sfbiicd06=l_idb11_sum WHERE sfbi01=g_sfb.sfb01
               UPDATE sfa_file SET sfa161=l_sfa.sfa05/l_dies_sum
                WHERE sfa01 = l_sfa.sfa01 AND sfa03 = l_sfa.sfa03
                  AND sfa08 = l_sfa.sfa08 AND sfa12 = l_sfa.sfa12
                  AND sfa27 = l_sfa.sfa27 AND sfa012= l_sfa.sfa012
                  AND sfa013= l_sfa.sfa013
            ELSE
               UPDATE sfb_file SET sfb08=l_idb11_sum WHERE sfb01=g_sfb.sfb01
               UPDATE sfbi_file SET sfbiicd06=l_idb11_sum WHERE sfbi01=g_sfb.sfb01
               UPDATE sfa_file SET sfa161=l_sfa.sfa05/l_idb11_sum
                WHERE sfa01 = l_sfa.sfa01 AND sfa03 = l_sfa.sfa03
                  AND sfa08 = l_sfa.sfa08 AND sfa12 = l_sfa.sfa12
                  AND sfa27 = l_sfa.sfa27 AND sfa012= l_sfa.sfa012
                  AND sfa013= l_sfa.sfa013
     ...
     #str TQC-C60025 mark
     ##作業群組是3.DS或4.AS時一併回寫發料單身的應發參考數量sfaiicd01
     # SELECT ecdicd01 INTO l_ecdicd01 FROM ecd_file
     #  WHERE ecd01 = g_sfbi.sfbiicd09
     ##IF l_ecdicd01 MATCHES '[34]' THEN   #TQC-C50140 mark
     # IF l_ecdicd01 MATCHES '[345]' THEN  #TQC-C50140
     #    IF cl_confirm("aic-221") THEN   
     #       DECLARE i301_sfa_dies CURSOR FOR
     #        SELECT sfa_file.*,sfaiicd03 FROM sfa_file,sfai_file
     #         WHERE sfa01 = g_sfb.sfb01
     ...
     #          #   AND idb07 IN (SELECT sfs01 FROM sfs_file    
     #          #                  WHERE sfs03 = g_sfb.sfb01    
     #          #                    AND sfs04 = l_sfa.sfa03    
     #          #                    AND sfs10 = l_sfa.sfa08    
     #          #                    AND sfs06 = l_sfa.sfa12    
     #          #                    AND sfs27 = l_sfa.sfa27)   
     #          #   AND idb16 IS NOT NULL
     #          #   AND idb20 = 'Y'
     #          #FUN-C30274 --END mark--  
     #         #當為3.CP時,才抓SUM(idb16)來回寫參考數量
     #         IF l_ecdicd01 = '3' THEN  #TQC-C50189 add
     #            #FUN-C30274 --START--
     #            SELECT SUM(idb16),SUM(idb11) INTO l_dies,l_idb11 FROM idb_file  #TQC-C50189 add l_idb11
     #              WHERE idb01 = l_sfa.sfa03
     #                AND idb02 = l_sfa.sfa30
     #                AND idb03 = l_sfa.sfa31
     #                AND idb04 = l_sfaiicd03
     ...
     #         #str TQC-C50189 add
     #          ELSE
     #            SELECT SUM(idb11) INTO l_idb11 FROM idb_file
     #              WHERE idb01 = l_sfa.sfa03
     #                AND idb02 = l_sfa.sfa30
     #                AND idb03 = l_sfa.sfa31
     #                AND idb04 = l_sfaiicd03
     ...
     #       LET l_sfb08 = 0
     #       SELECT sfb08 INTO l_sfb08 FROM sfb_file WHERE sfb01 = g_sfb.sfb01
     #       IF cl_null(l_sfb08) THEN LET l_sfb08 = 0 END IF
     #       LET l_sfb08 = l_dies_sum                  
     #       UPDATE sfb_file SET sfb08 = l_sfb08 WHERE sfb01 = g_sfb.sfb01
     #      #UPDATE sfbi_file SET sfbiicd04 = 0,sfbiicd06=l_idb11 WHERE sfbi01=g_sfb.sfb01  #TQC-C50189 add l_idb11  #TQC-C60025 mark
     #       UPDATE sfbi_file SET sfbiicd06=l_idb11 WHERE sfbi01=g_sfb.sfb01  #TQC-C50189 add l_idb11                #TQC-C60025
     #       UPDATE sfa_file SET sfa161 = l_sfa.sfa05 / l_sfb08 
...
#str TQC-C60025 add
FUNCTION i301_icd_upd_sfb08()
   DEFINE l_imaicd04    LIKE imaicd_file.imaicd04
   DEFINE l_imaicd04_h  LIKE imaicd_file.imaicd04
   DEFINE l_imaicd14    LIKE imaicd_file.imaicd14

   #當料號不做刻號/BIN管理或Datecode管理時,就不會進FUNCTION i301_icdout()回寫工單生產數量,所以要另外處理
   IF NOT s_icdbin(g_sfa[l_ac].sfa03) THEN
      LET l_imaicd14=0
      LET l_imaicd04=''   LET l_imaicd04_h=''
      SELECT imaicd04,imaicd14 INTO l_imaicd04,l_imaicd14 FROM imaicd_file WHERE imaicd00=g_sfa[l_ac].sfa03
      SELECT imaicd04 INTO l_imaicd04_h FROM imaicd_file WHERE imaicd00=g_sfb.sfb05
      IF cl_null(l_imaicd14) OR l_imaicd14=0 THEN LET l_imaicd14=1 END IF
      IF (l_imaicd04='1' AND l_imaicd04_h='2' AND g_sfb.sfb08!=g_sfa[l_ac].sfa05) OR
         (l_imaicd04='1' AND (l_imaicd04_h='3' OR l_imaicd04_h='4') AND g_sfb.sfb08!=g_sfa[l_ac].sfa05*l_imaicd14) OR
         (l_imaicd04='2' AND (l_imaicd04_h='3' OR l_imaicd04_h='4') AND g_sfb.sfb08!=g_sfa[l_ac].sfaiicd01) OR
         (l_imaicd04='3' AND (l_imaicd04_h='3' OR l_imaicd04_h='4') AND g_sfb.sfb08!=g_sfa[l_ac].sfa05) THEN
         IF cl_confirm("aic-221") THEN
            IF l_imaicd04='1' AND l_imaicd04_h='2' THEN
               UPDATE sfb_file SET sfb08=g_sfa[l_ac].sfa05 WHERE sfb01=g_sfb.sfb01
               UPDATE sfbi_file SET sfbiicd06=g_sfa[l_ac].sfa05*l_imaicd14 WHERE sfbi01=g_sfb.sfb01
               UPDATE sfa_file SET sfa161=1
                WHERE sfa01 = g_sfb.sfb01       AND sfa03 = g_sfa[l_ac].sfa03
                  AND sfa08 = g_sfa[l_ac].sfa08 AND sfa12 = g_sfa[l_ac].sfa12
                  AND sfa27 = g_sfa[l_ac].sfa27 AND sfa012= g_sfa[l_ac].sfa012
                  AND sfa013= g_sfa[l_ac].sfa013 
            END IF
            IF l_imaicd04='1' AND (l_imaicd04_h='3' OR l_imaicd04_h='4') THEN
               UPDATE sfb_file SET sfb08=g_sfa[l_ac].sfa05*l_imaicd14 WHERE sfb01=g_sfb.sfb01
               UPDATE sfbi_file SET sfbiicd06=g_sfa[l_ac].sfa05 WHERE sfbi01=g_sfb.sfb01
               UPDATE sfa_file SET sfa161=1/l_imaicd14
                WHERE sfa01 = g_sfb.sfb01       AND sfa03 = g_sfa[l_ac].sfa03
                  AND sfa08 = g_sfa[l_ac].sfa08 AND sfa12 = g_sfa[l_ac].sfa12
                  AND sfa27 = g_sfa[l_ac].sfa27 AND sfa012= g_sfa[l_ac].sfa012
                  AND sfa013= g_sfa[l_ac].sfa013 
            END IF
            IF l_imaicd04='2' AND (l_imaicd04_h='3' OR l_imaicd04_h='4') THEN
               UPDATE sfb_file SET sfb08=g_sfa[l_ac].sfaiicd01 WHERE sfb01=g_sfb.sfb01
               UPDATE sfbi_file SET sfbiicd06=g_sfa[l_ac].sfa05 WHERE sfbi01=g_sfb.sfb01
               UPDATE sfa_file SET sfa161=g_sfa[l_ac].sfa05/g_sfa[l_ac].sfaiicd01
                WHERE sfa01 = g_sfb.sfb01       AND sfa03 = g_sfa[l_ac].sfa03
                  AND sfa08 = g_sfa[l_ac].sfa08 AND sfa12 = g_sfa[l_ac].sfa12
                  AND sfa27 = g_sfa[l_ac].sfa27 AND sfa012= g_sfa[l_ac].sfa012
                  AND sfa013= g_sfa[l_ac].sfa013 
...
FUNCTION i301_chkkey()
   ...
   #FUN-C30274 --START--
    UPDATE sfaa_file SET sfaa01=g_sfb.sfb01
       WHERE sfaa01=g_sfb_t.sfb01
     IF STATUS THEN
        CALL cl_err3("upd","sfaa_file",g_sfb_t.sfb01,"",STATUS,"","upd sfaa01",1)
        CALL i301_show()
        ROLLBACK WORK
        RETURN
     END IF
...
#  DEFINE l_woqty         LIKE ima_file.ima26            #No.FUN-680121 DEC(15,3)
   ...
   DEFINE l_smy72           LIKE smy_file.smy72,     #MOD-CC0152 add
    ...
    INPUT BY NAME g_sfb.sfboriu,g_sfb.sfborig,g_sfb.sfb01,g_sfb.sfb101,g_sfb.sfb44,g_sfb.sfb81,g_sfb.sfb02,g_sfb.sfb39,   #FUN-8C0081 add sfb44
                  ...
                  g_sfb.sfb05,
                 #g_sfbi.sfbiicd09,g_sfbi.sfbiicd14,g_sfbi.sfbiicd04,g_sfbi.sfbiicd05,  #FUN-810038  #TQC-C60025 mark
                  g_sfbi.sfbiicd09,g_sfbi.sfbiicd14,  #FUN-810038                                    #TQC-C60025
...
#--TQC-D10024--star---
           ...
           IF NOT cl_null(g_sfb.sfb221) THEN
             ...
             #str MOD-A40133 add
              ...
              SELECT oeb04,oeb12,oeb22,oeb05,ima55,((100+ima562)/100),oeb41,oeb42,oeb43,oeb1001  #MOD-D10066
...
# No:2422  modify 1998/09/08 ---------(check 最小生產數量) ---
           ...
           ##若生產數量<>空白,若預計完工數(sfbiicd04) 不為零,  #TQC-C60025 mark
           ##則提醒user並自動將預計完工數(sfbiicd04) = 0       #TQC-C60025 mark
           #CALL i301_ind_icd_set_sfbiicd04()                  #TQC-C60025 mark
...
#FUN-A50066--end--mark--------------------
      ...
      #      END IF
      #     #str TQC-C50140 add
      #      IF cl_null(g_sfbi_o.sfbiicd04) OR
      #         g_sfbi_o.sfbiicd04 <> g_sfbi.sfbiicd04 THEN
      #         LET g_sfb.sfb08 = g_sfbi.sfbiicd04
      #         CALL i300_time('1')
      #         DISPLAY BY NAME g_sfb.sfb15
      #         LET g_sfb.sfb08 = ''
      #      END IF
...
FUNCTION i301_set_no_required()
  ...
  #CALL cl_set_comp_required("sfbiicd01,sfbiicd02,sfbiicd03,sfbiicd04,sfb08,sfbiicd15,sfbiicd17",FALSE)  #FUN-A10138  #TQC-C60025 mark
   CALL cl_set_comp_required("sfbiicd01,sfbiicd02,sfbiicd03,sfb08,sfbiicd15,sfbiicd17",FALSE)  #FUN-A10138            #TQC-C60025
...
FUNCTION i301_set_entry(p_cmd)
 DEFINE p_cmd   LIKE type_file.chr1    #No.FUN-680121 VARCHAR(1)
    ...
    IF ( NOT g_before_input_done ) THEN   #No:8125  #No:8573
      ...
      #CALL cl_set_comp_entry("sfbiicd04,sfb86,sfbiicd16,sfb08,sfbiicd17",TRUE)  #TQC-C60025 mark
       CALL cl_set_comp_entry("sfb86,sfb89,sfbiicd16,sfb08,sfbiicd17",TRUE)            #TQC-C60025 #FUN-C30114 sfb89
    END IF
  ...
  #CALL cl_set_comp_entry("sfbiicd04,sfb86,sfbiicd05,sfbiicd10,sfbiicd15,sfbiicd16,sfbiicd17",TRUE)  #TQC-C60025 mark
   CALL cl_set_comp_entry("sfb86,sfb89,sfbiicd10,sfbiicd15,sfbiicd16,sfbiicd17",TRUE)                      #TQC-C60025  #FUN-C30114 sfb89
...
FUNCTION i301_set_no_entry(p_cmd)
  ...
  DEFINE l_t1       LIKE smy_file.smyslip #CHI-910055 
   ...
   #FUN-810038................begin  #有備料不能改
      #CALL cl_set_comp_entry("sfbiicd04,sfb86,sfbiicd05,sfbiicd10,sfbiicd15,sfbiicd16,sfbiicd17",FALSE)  #TQC-C60025 mark
       CALL cl_set_comp_entry("sfb86,sfb89,sfbiicd10,sfbiicd15,sfbiicd16,sfbiicd17",FALSE)                      #TQC-C60025 mark #FUN-C30114 sfb89
   ...
   IF NOT cl_null(g_sfbi.sfbiicd09) THEN
      ...
      END IF
   ELSE
     #CALL cl_set_comp_entry("sfbiicd04,sfbiicd05,sfbiicd10",FALSE)  #TQC-C60025 mark
      CALL cl_set_comp_entry("sfbiicd10",FALSE)                      #TQC-C60025
   END IF
    IF INFIELD(sfb02) OR ( NOT g_before_input_done ) THEN
       IF g_sfb.sfb02 NOT MATCHES '[78]' THEN
...
FUNCTION i301_show()
   DEFINE l_smydesc LIKE smy_file.smydesc  #MOD-4C0010
    ...
    DISPLAY BY NAME
        g_sfbi.sfbiicd01, g_sfbi.sfbiicd02, g_sfbi.sfbiicd03,
       #g_sfbi.sfbiicd04, g_sfbi.sfbiicd05,                    #TQC-C60025 mark
        g_sfbi.sfbiicd06, g_sfbi.sfbiicd07,                    #FUN-A10138
...
FUNCTION i301_b(p_in)
   ...
   DEFINE l_errmsg        STRING                    #TQC-C50140 add
   DEFINE l_ecdicd01      LIKE ecd_file.ecdicd01    #TQC-C50140 add
   DEFINE l_imaicd04      LIKE imaicd_file.imaicd04 #TQC-C50140 add
   DEFINE l_imaicd04_h    LIKE imaicd_file.imaicd04 #TQC-C60025 add
   DEFINE l_imaicd14      LIKE imaicd_file.imaicd14 #TQC-C60025 add
   DEFINE l_sfb08         LIKE sfb_file.sfb08       #TQC-C50140 add
   DEFINE l_sfbiicd06     LIKE sfbi_file.sfbiicd06  #TQC-C50140 add
   DEFINE l_ima928        LIKE ima_file.ima928      #FUN-C30047
    ...
    INPUT ARRAY g_sfa WITHOUT DEFAULTS FROM s_sfa.*
        ...
        BEFORE INSERT
            ...
            ELSE
               ...
               LET g_sfa[l_ac].sfaiicd06 = 'N'   #FUN-C30274
               LET b_sfai.sfaiicd04 = g_sfa[l_ac].sfaiicd04
               LET b_sfai.sfaiicd05 = g_sfa[l_ac].sfaiicd05
               LET b_sfai.sfaiicd06 = g_sfa[l_ac].sfaiicd06   #FUN-C30274
...
#TQC-A50141 --end
            ...
            ELSE
               ...
               #FUN-C30274 --START--
               IF g_sfa[l_ac].sfaiicd06 = 'N' THEN
                  LET l_sfaa.sfaa01   =b_sfa.sfa01
                  LET l_sfaa.sfaa03   =b_sfa.sfa03
                  LET l_sfaa.sfaa08   =b_sfa.sfa08
                  LET l_sfaa.sfaa12   =b_sfa.sfa12
                  LET l_sfaa.sfaa27   =b_sfa.sfa27
                  LET l_sfaa.sfaa30   =b_sfa.sfa30
                  LET l_sfaa.sfaa31   =b_sfa.sfa31
                  LET l_sfaa.sfaa32   =b_sfai.sfaiicd03
                  LET l_sfaa.sfaa05   =b_sfa.sfa05
                  LET l_sfaa.sfaa051  =b_sfai.sfaiicd01
                  LET l_sfaa.sfaaplant=b_sfa.sfaplant
                  LET l_sfaa.sfaalegal=b_sfa.sfalegal
                  LET l_sfaa.sfaa012  =b_sfa.sfa012
                  LET l_sfaa.sfaa013  =b_sfa.sfa013
                  IF cl_null(l_sfaa.sfaa051) THEN LET l_sfaa.sfaa051=0 END IF   #TQC-C60025 add
                  INSERT INTO sfaa_file VALUES(l_sfaa.*)
                  IF SQLCA.sqlcode THEN
                     CALL cl_err3("ins","sfaa_file",l_sfaa.sfaa01,l_sfaa.sfaa03,SQLCA.sqlcode,"","ins sfaa",1)  
                     CANCEL INSERT
                  END IF    
               END IF  
               #FUN-C30274 --END
               #當料號不做刻號/BIN管理或Datecode管理時,直接將發料數量回寫工單單頭生產數量
               CALL i301_icd_upd_sfb08()   #TQC-C60025 add
               CALL i301_bu()
               IF g_success = 'Y' THEN
...
#FUN-AA0059 ---------------------end-------------------------------
            ...
            END IF
           #str TQC-C60025 add
            IF g_sfa[l_ac].sfa27 IS NULL OR g_sfa[l_ac].sfa27 != g_sfa_t.sfa27 THEN
               SELECT imaicd04 INTO l_imaicd04_h FROM imaicd_file
                WHERE imaicd00=g_sfb.sfb05
               SELECT imaicd04,imaicd14 INTO l_imaicd04,l_imaicd14 FROM imaicd_file
                WHERE imaicd00=g_sfa[l_ac].sfa27
               IF cl_null(l_imaicd14) OR l_imaicd14=0 THEN LET l_imaicd14=1 END IF
               IF (l_imaicd04='1' OR l_imaicd04='2') AND (l_imaicd04_h='3' OR l_imaicd04_h='4') THEN
                  LET g_sfa[l_ac].sfa05 = g_sfb.sfb08 / l_imaicd14
                  IF l_imaicd04='1' THEN LET g_sfa[l_ac].sfaiicd01='' END IF
                  DISPLAY BY NAME g_sfa[l_ac].sfa05,g_sfa[l_ac].sfaiicd01
               END IF 
               IF l_imaicd04='3' AND (l_imaicd04_h='3' OR l_imaicd04_h='4') THEN
                  LET g_sfa[l_ac].sfa05 = g_sfb.sfb08
                  LET g_sfa[l_ac].sfaiicd01=''
                  DISPLAY BY NAME g_sfa[l_ac].sfa05,g_sfa[l_ac].sfaiicd01
               END IF 
            END IF
           #end TQC-C60025 add
            CALL i301_set_no_required_b('a') #TQC-C60025 add
...
#FUN-AA0059 ---------------------end-------------------------------
   ...
   #TQC-D50126 -------End--------
    ...
    AFTER FIELD sfaiicd03  #存在img就好
       IF NOT cl_null(g_sfa[l_ac].sfaiicd03) THEN
          ...
          IF SQLCA.sqlcode = 100 THEN
            ...
            #NEXT FIELD sfaiicd03       #MOD-CB0019 mark
         #MOD-CB0019---S
          ELSE
             IF NOT s_icdout_holdlot(g_sfa[l_ac].sfa03,g_sfa[l_ac].sfa30,
                                     g_sfa[l_ac].sfa31,g_sfa[l_ac].sfaiicd03) THEN
       ...
       ELSE
          ...
          #FUN-C30274 --START--
          IF g_sfa[l_ac].sfaiicd06 = 'N' AND cl_null(g_sfa[l_ac].sfa30) AND 
             cl_null(g_sfa[l_ac].sfa31) AND cl_null(g_sfa[l_ac].sfaiicd03) THEN
             NEXT FIELD sfa30 
          END IF  
          #FUN-C30274 --END--
       END IF
    ...
    #FUN-C30274 --START--   
    AFTER FIELD sfaiicd06
       CALL i301_set_no_required_b('a')
       CALL i301_set_required_b('a')
       IF g_sfa[l_ac].sfaiicd06 <> g_sfa_t.sfaiicd06 THEN 
          IF g_sfa[l_ac].sfaiicd06 = 'Y' THEN         
            #str TQC-C60025 add
             IF g_sfa_t.sfa03 != g_sfa[l_ac].sfa03 THEN
                DELETE FROM sfaa_file
                 WHERE sfaa01 = g_sfb.sfb01   AND sfaa03 = g_sfa_t.sfa03
                   AND sfaa08 = g_sfa_t.sfa08 AND sfaa12 = g_sfa_t.sfa12
                   AND sfaa27 = g_sfa_t.sfa27 AND sfaa012= g_sfa_t.sfa012 
                   AND sfaa013= g_sfa_t.sfa013 
                IF SQLCA.sqlcode THEN
                   CALL cl_err3("del","sfaa_file",g_sfb.sfb01,g_sfa_t.sfa03,SQLCA.sqlcode,"","del sfaa:",1) 
                   LET g_sfa[l_ac].* = g_sfa_t.*
                   LET g_success = 'N'
                ELSE
                   IF s_icdbin(g_sfa_t.sfa03) THEN
                      LET l_cnt=0
                      SELECT COUNT(*) INTO l_cnt FROM idb_file WHERE idb07=g_sfb.sfb01
                      IF cl_null(l_cnt) THEN LET l_cnt=0 END IF
                      IF l_cnt > 0 THEN
                         IF NOT s_icdinout_del(-1,g_sfb.sfb01,1,'') THEN
                            LET g_sfa[l_ac].* = g_sfa_t.*
                            LET g_success = 'N'
                         END IF
                      END IF
             ...
             END IF
            #end TQC-C60025 add
            #LET g_sfa_t.* = g_sfa[l_ac].*         #BACKUP   #TQC-C50189 add
             CALL i301_mntn_allotment_for_multi_wh(g_sfb.sfb01,
                                                   g_sfa[l_ac].sfa03,
                                                   g_sfa[l_ac].sfa08,
                                                   g_sfa[l_ac].sfa12,
                                                   g_sfa[l_ac].sfa27,
             ...
             LET l_sfaa05 = 0 
             LET l_sfaa051 = 0 
             SELECT SUM(sfaa05),SUM(sfaa051) INTO l_sfaa05,l_sfaa051 FROM sfaa_file
              WHERE sfaa01 = g_sfb.sfb01 AND sfaa03 = g_sfa[l_ac].sfa03
              AND sfaa08 = g_sfa[l_ac].sfa08 AND sfaa12 = g_sfa[l_ac].sfa12
              AND sfaa27 = g_sfa[l_ac].sfa27 AND sfaa012 = g_sfa[l_ac].sfa012
              AND sfaa013 = g_sfa[l_ac].sfa013 
            #IF l_sfaa05 <> g_sfa[l_ac].sfa05 THEN                                         #TQC-C50140 mark
             IF l_sfaa05 <> g_sfa[l_ac].sfa05 OR l_sfaa051 <> g_sfa[l_ac].sfaiicd01 THEN   #TQC-C50140
               #CALL cl_err_msg("","aic-223",l_sfaa05 CLIPPED|| "|" || g_sfa[l_ac].sfa05 CLIPPED,1)  #TQC-C50140 mark
               #str TQC-C50140 add
                IF l_sfaa05 <> g_sfa[l_ac].sfa05 THEN
                   LET l_errmsg=cl_getmsg("aic-223",g_lang)
                   LET l_errmsg=cl_replace_err_msg(l_errmsg, l_sfaa05 CLIPPED|| "|" || g_sfa[l_ac].sfa05 CLIPPED)
                END IF
                IF l_sfaa051 <> g_sfa[l_ac].sfaiicd01 THEN
                   LET l_errmsg=cl_getmsg("aic-223",g_lang)
                   LET l_errmsg=cl_replace_err_msg(l_errmsg, l_sfaa051 CLIPPED|| "|" || g_sfa[l_ac].sfaiicd01 CLIPPED)
                END IF
                #加總數量(%1)與單身應發數量(%2)不符,是否依多倉儲批數量回寫備料應發數量?
                IF cl_confirm(l_errmsg) THEN
                   #更新應發數量
                   UPDATE sfa_file SET sfa05 = l_sfaa05
                    WHERE sfa01 = g_sfb.sfb01       AND sfa03 = g_sfa[l_ac].sfa03
                      AND sfa08 = g_sfa[l_ac].sfa08 AND sfa12 = g_sfa[l_ac].sfa12
                      AND sfa27 = g_sfa[l_ac].sfa27 AND sfa012= g_sfa[l_ac].sfa012
                      AND sfa013= g_sfa[l_ac].sfa013 
                   #更新應發參考數量
                   UPDATE sfai_file SET sfaiicd01 = l_sfaa051
                    WHERE sfaa01 = g_sfb.sfb01       AND sfaa03 = g_sfa[l_ac].sfa03
                      AND sfaa08 = g_sfa[l_ac].sfa08 AND sfaa12 = g_sfa[l_ac].sfa12
                      AND sfaa27 = g_sfa[l_ac].sfa27 AND sfaa012= g_sfa[l_ac].sfa012
                      AND sfaa013= g_sfa[l_ac].sfa013 
                   LET g_sfa[l_ac].sfa05 = l_sfaa05
                   LET g_sfa[l_ac].sfaiicd01 = l_sfaa051
                   DISPLAY BY NAME g_sfa[l_ac].sfa05,g_sfa[l_ac].sfaiicd01,g_sfa[l_ac].sfaiicd06
                   ...
                   IF cl_confirm("aic-221") THEN
                      ...
                      SELECT SUM(sfaa05),SUM(sfaa051) INTO l_sfaa05,l_sfaa051 FROM sfaa_file
                       WHERE sfaa01 = g_sfb.sfb01
                      IF cl_null(l_sfaa05)  THEN LET l_sfaa05 = 0 END IF
                      IF cl_null(l_sfaa051) THEN LET l_sfaa051= 0 END IF
                     ...
                     #      SELECT imaicd04 INTO l_imaicd04 FROM imaicd_file
                     #       WHERE imaicd00 = g_sfb.sfb05
                     #      IF cl_null(l_imaicd04) OR l_imaicd04 = 0 THEN
                     #         LET l_imaicd04 = 1
                     #      END IF
                     #      LET l_sfb08 = l_sfaa05
                     #      LET l_sfbiicd06 = l_sfaa05 * l_imaicd04
                     #   WHEN '3'    #DS
                     #      LET l_sfb08 = l_sfaa051
                     #      LET l_sfbiicd06 = l_sfaa05
                     #   OTHERWISE   #其他
                     #      LET l_sfb08= l_sfaa05
                     #      LET l_sfbiicd06 = l_sfaa05
                     #END CASE
                     ...
                     #str TQC-C60025 add
                      ...
                      SELECT imaicd04 INTO l_imaicd04_h
                        FROM imaicd_file WHERE imaicd00=g_sfb.sfb05
                      IF cl_null(l_imaicd14) OR l_imaicd14=0 THEN LET l_imaicd14=1 END IF
                      IF l_imaicd04='1' AND l_imaicd04_h='2' THEN
                         LET l_sfb08 = l_sfaa05
                         LET l_sfbiicd06 = l_sfaa05*l_imaicd14
                      END IF
                      IF l_imaicd04='1' AND (l_imaicd04_h='3' OR l_imaicd04_h='4') THEN
                         LET l_sfb08 = l_sfaa05*l_imaicd14
                         LET l_sfbiicd06 = l_sfaa05
                      END IF
                      IF l_imaicd04='2' AND (l_imaicd04_h='3' OR l_imaicd04_h='4') THEN
                         LET l_sfb08 = l_sfaa051
                     ...
                     #end TQC-C60025 add
                      UPDATE sfb_file SET sfb08 = l_sfb08 WHERE sfb01 = g_sfb.sfb01
                     #UPDATE sfbi_file SET sfbiicd04=0,sfbiicd05=0,sfbiicd06=l_sfbiicd06  #TQC-C60025 mark
                      UPDATE sfbi_file SET sfbiicd06=l_sfbiicd06                          #TQC-C60025
                       WHERE sfbi01 = g_sfb.sfb01
                      UPDATE sfa_file SET sfa161 = l_sfaa05 / l_sfb08 
                       WHERE sfa01 = g_sfb.sfb01       AND sfa03 = g_sfa[l_ac].sfa03
                         AND sfa08 = g_sfa[l_ac].sfa08 AND sfa12 = g_sfa[l_ac].sfa12
                         AND sfa27 = g_sfa[l_ac].sfa27 AND sfa012= g_sfa[l_ac].sfa012
                         AND sfa013= g_sfa[l_ac].sfa013 
                      LET g_sfa[l_ac].sfa161 = l_sfaa05 / l_sfb08
                      DISPLAY BY NAME g_sfa[l_ac].sfa161
                      SELECT sfb_file.* INTO g_sfb.* FROM sfb_file WHERE sfb01=g_sfb.sfb01
                      SELECT sfbi_file.* INTO g_sfbi.* FROM sfbi_file WHERE sfbi01=g_sfb.sfb01
                      LET g_sfb_t.* = g_sfb.*                #保存單頭舊值
                      ...
                      DISPLAY BY NAME
                         ...
                         ,g_sfb.sfbud01,g_sfb.sfbud02,g_sfb.sfbud03,g_sfb.sfbud04,
                          ...
                          g_sfb.sfbud09,g_sfb.sfbud10,g_sfb.sfbud11,g_sfb.sfbud12,
                          g_sfb.sfbud13,g_sfb.sfbud14,g_sfb.sfbud15 
                     #LET g_sfa_t.* = g_sfa[l_ac].*         #BACKUP   #TQC-C60025 mark
                   END IF
                END IF
               #end TQC-C50140 add
             END IF
             IF s_icdbin(g_sfa[l_ac].sfa03) THEN
                LET g_sfa[l_ac].sfaiicd01 = l_sfaa051
                DISPLAY BY NAME g_sfa[l_ac].sfaiicd01
             END IF
          ELSE
             DELETE FROM sfaa_file
              WHERE sfaa01 = g_sfb.sfb01   AND sfaa03 = g_sfa_t.sfa03
      ...
      #str TQC-C60025 add
       ELSE
          IF g_sfa[l_ac].sfaiicd06 = 'Y' THEN         
             LET l_sfaa05=0     LET l_sfaa051=0  
             SELECT SUM(sfaa05),SUM(sfaa051) INTO l_sfaa05,l_sfaa051 FROM sfaa_file
              WHERE sfaa01 = g_sfb.sfb01
             IF cl_null(l_sfaa05)  THEN LET l_sfaa05 = 0 END IF
             IF cl_null(l_sfaa051) THEN LET l_sfaa051= 0 END IF
             IF g_sfa[l_ac].sfa05 != l_sfaa05 OR g_sfa[l_ac].sfaiicd01 != l_sfaa051 THEN
                CALL i301_mntn_allotment_for_multi_wh(g_sfb.sfb01,
                                                      g_sfa[l_ac].sfa03,
                                                      g_sfa[l_ac].sfa08,
                                                      g_sfa[l_ac].sfa12,
    ...
    AFTER FIELD sfa05
      IF g_sfa[l_ac].sfa11 != 'X'  THEN   #CHI-980013
        ...
        #   AND g_sfb.sfb02 NOT MATCHES '[58]' THEN                        #MOD-A40012 mark 
           ...
           #str TQC-C60025 add
           #計算應發參考數量
            LET l_imaicd04=''   LET l_imaicd14=0
            SELECT imaicd04,imaicd14 INTO l_imaicd04,l_imaicd14
              FROM imaicd_file WHERE imaicd00=g_sfa[l_ac].sfa03
            IF cl_null(l_imaicd14) THEN LET l_imaicd14=1 END IF
            IF l_imaicd04='1' OR l_imaicd04='2' THEN
  ...
  #    LET g_sfa_o.sfa161 = g_sfa_t.sfa161   #MOD-C90069 add   #MOD-CB0005 mark
       ...
       #str TQC-C50189 add
        BEFORE FIELD sfa161
          IF g_sfa[l_ac].sfa161 = 0 AND g_sfa[l_ac].sfa16 != 0 THEN
             LET g_sfa[l_ac].sfa161 = g_sfa[l_ac].sfa16
             DISPLAY BY NAME g_sfa[l_ac].sfa161
          END IF
       #end TQC-C50189 add
    ...
    BEFORE DELETE                            #是否取消單身
        ...
        END IF
       #str TQC-C60019 add
        #ICD行業別時,工單備料單身刪除應做刻號/BIN資料的刪除
        IF NOT i301sub_del_idb(g_sfb.sfb01,g_sfa_t.sfa03,g_sfa_t.sfa08,g_sfa_t.sfa12,g_sfa_t.sfa27,g_sfa_t.sfa012,g_sfa_t.sfa013,'2') THEN
           ROLLBACK WORK
           CANCEL DELETE
        END IF
       #end TQC-C60019 add
        ...
        DELETE FROM sfaa_file
         WHERE sfaa01 = g_sfb.sfb01 AND sfaa03 = g_sfa_t.sfa03
           AND sfaa08 = g_sfa_t.sfa08 AND sfaa12 = g_sfa_t.sfa12
           AND sfaa27 = g_sfa_t.sfa27 
           AND sfaa012 = g_sfa_t.sfa012  
           AND sfaa013 = g_sfa_t.sfa013 
        IF SQLCA.sqlcode THEN
           CALL cl_err3("del","sfaa_file",g_sfb.sfb01,g_sfa_t.sfa03,SQLCA.sqlcode,"","del sfaa:",1) 
           ROLLBACK WORK
        ...
        END IF
       #str TQC-C60019 mark
       #IF NOT s_icdinout_del_2(-1,g_sfb.sfb01,1,'',g_sfa_t.sfa03,g_sfa_t.sfa30,g_sfa_t.sfa31,g_sfa_t.sfaiicd03) THEN
       #   ROLLBACK WORK
       #   CANCEL DELETE
       #END IF    
       #end TQC-C60019 mark
...
#TQC-B90003 --mark--end--
           ...
           IF SQLCA.sqlcode THEN
              ...
              LET g_sfa[l_ac].* = g_sfa_t.*
           ELSE
              LET b_sfai.sfai01 = b_sfa.sfa01   #TQC-C60025 add
              LET b_sfai.sfai03 = b_sfa.sfa03   #TQC-C60025 add
              LET b_sfai.sfai08 = b_sfa.sfa08   #TQC-C60025 add
              LET b_sfai.sfai12 = b_sfa.sfa12   #TQC-C60025 add
              LET b_sfai.sfai27 = b_sfa.sfa27   #TQC-C60025 add
              LET b_sfai.sfai012= b_sfa.sfa012  #TQC-C60025 add
              LET b_sfai.sfai013= b_sfa.sfa013  #TQC-C60025 add
           ...
           IF SQLCA.sqlcode  OR SQLCA.SQLERRD[3] = 0 THEN
              CALL cl_err3("upd","sfai_file",g_sfa_t.sfa03,"",SQLCA.sqlcode,"","upd sfai",1)   #No.FUN-660128
              LET g_sfa[l_ac].* = g_sfa_t.*
              LET g_success = 'N'
           END IF
           #FUN-C30274 --START--
           IF g_success = 'Y' THEN
              IF cl_null(g_sfa_t.sfa30) THEN LET g_sfa_t.sfa30=' ' END IF
              IF cl_null(g_sfa_t.sfa31) THEN LET g_sfa_t.sfa31=' ' END IF
              IF cl_null(g_sfa_t.sfaiicd03) THEN LET g_sfa_t.sfaiicd03=' ' END IF
              IF cl_null(g_sfa[l_ac].sfa30) THEN LET g_sfa[l_ac].sfa30=' ' END IF
              IF cl_null(g_sfa[l_ac].sfa31) THEN LET g_sfa[l_ac].sfa31=' ' END IF
              IF cl_null(g_sfa[l_ac].sfaiicd03) THEN LET g_sfa[l_ac].sfaiicd03=' ' END IF
              
              IF NOT (g_sfa[l_ac].sfa03 = g_sfa_t.sfa03 AND  
                      g_sfa[l_ac].sfa08 = g_sfa_t.sfa08 AND
                      g_sfa[l_ac].sfa12 = g_sfa_t.sfa12 AND 
                      g_sfa[l_ac].sfa27 = g_sfa_t.sfa27 AND
                      g_sfa[l_ac].sfa012= g_sfa_t.sfa012 AND
                      g_sfa[l_ac].sfa013= g_sfa_t.sfa013 AND
                      g_sfa[l_ac].sfa05 = g_sfa_t.sfa05 AND
                      g_sfa[l_ac].sfa30 = g_sfa_t.sfa30 AND
                      g_sfa[l_ac].sfa31 = g_sfa_t.sfa31 AND                 
                      g_sfa[l_ac].sfaiicd03 = g_sfa_t.sfaiicd03 ) THEN 
                 ...
                 IF g_sfa[l_ac].sfaiicd06 = 'N' THEN
                    ...
                    END IF  
                 ELSE
                    IF g_sfa_t.sfa03 != g_sfa[l_ac].sfa03 THEN   #TQC-C60025 add
                       DELETE FROM sfaa_file
                        WHERE sfaa01 = g_sfb.sfb01   AND sfaa03 = g_sfa_t.sfa03
                          AND sfaa08 = g_sfa_t.sfa08 AND sfaa12 = g_sfa_t.sfa12
                          AND sfaa27 = g_sfa_t.sfa27 AND sfaa012= g_sfa_t.sfa012 
                       ...
                       ELSE
                          IF s_icdbin(g_sfa_t.sfa03) THEN
                            #str TQC-C60025 add
                             ...
                             IF l_cnt > 0 THEN
                            #end TQC-C60025 add
                               #IF NOT s_icdinout_del(-1,g_sfb.sfb01,1,'') THEN                           #TQC-C60025 mark
                                IF NOT s_icdinout_del_2(-1,g_sfb.sfb01,1,'',g_sfa_t.sfa03,g_sfa_t.sfa30,
                                                        g_sfa_t.sfa31,g_sfa_t.sfaiicd03) THEN             #TQC-C60025 
                                   LET g_sfa[l_ac].* = g_sfa_t.*
                                   LET g_success = 'N'
                                END IF
...
#        END IF     #TQC-B50022           #TQC-B90003 mark 
    ...
    ON ACTION CONTROLO                        #沿用所有欄位
       ...
       END IF
    #FUN-C30274 --START--
    ON ACTION mntn_allotment_for_multi_wh
       IF g_sfa[l_ac].sfaiicd06 = 'Y' THEN
          CALL i301_mntn_allotment_for_multi_wh(g_sfb.sfb01,
                                                g_sfa[l_ac].sfa03,
                                                g_sfa[l_ac].sfa08,
      ...
      WHEN INFIELD(sfa36) 
        ...
        WHEN INFIELD(sfaiicd03)
           ...
           IF s_industry("icd") THEN  #TQC-C60028
              CALL q_idc(FALSE,FALSE,g_sfa[l_ac].sfa03,g_sfa[l_ac].sfa30,g_sfa[l_ac].sfa31,g_sfa[l_ac].sfaiicd03)
              RETURNING g_sfa[l_ac].sfa30,g_sfa[l_ac].sfa31,g_sfa[l_ac].sfaiicd03
           ELSE
           #FUN-C30300---end
...
DEFINE l_flag         LIKE type_file.num5   #MOD-AC0336
      ...
      LET g_sql =
          ...
          "sfaiicd05,'',sfa063,sfa064,sfaiicd06,sfa30,sfa31,sfa36,'',sfaiicd03, ", #FUN-940008 sfa07-->'' #FUN-950088 add sfa36,'' #FUN-C30274 add sfaiicd06
          "sfaud01,sfaud02,sfaud03,sfaud04,sfaud05,",
          "sfaud06,sfaud07,sfaud08,sfaud09,sfaud10,",
          "sfaud11,sfaud12,sfaud13,sfaud14,sfaud15,", 
          "ima021,sfa29 ",
...
#@    ON ACTION 多倉儲批備料明細
      ON ACTION mntn_allotment_for_multi_wh
         LET g_action_choice="mntn_allotment_for_multi_wh"
         EXIT DISPLAY
     #end TQC-C50140 add
   ...
   ###折和量累加
         ...
         #TQC-D70019  ---end--
           ...
           #IF old_qty - l_sic_tot < l_tot + new[i].new_rate / new[i].new_qty  THEN #MOD-D60069 add  #TQC-D70019
            IF old_qty - l_sic_tot < l_tot THEN #TQC-D70019 add
...
#FUN-A50066--end--mark-------------------
  ...
  #str TQC-C60025 add
   #ICD行業別時,工單備料單身刪除應做刻號/BIN資料的刪除
   IF NOT i301sub_del_idb(g_sfb.sfb01,'','','','','','','1') THEN
      CALL cl_err3("del","idb_file",g_sfb.sfb01,"",SQLCA.sqlcode,"","del idb:",1)
      RETURN
   END IF
  #end TQC-C60025 add
  ...
  #str TQC-C60025 add
   DELETE FROM sfaa_file WHERE sfaa01=g_sfb.sfb01
   IF STATUS THEN
      CALL cl_err3("del","sfaa_file",g_sfb.sfb01,"",STATUS,"","del sfaa:",1)
      RETURN 
   END IF
  #end TQC-C60025 add
   ...
   CASE
      ...
      OTHERWISE                 #一般工單展單階
          ...
          END IF
        #str TQC-C60025 mark
        ##IF NOT cl_null(g_sfb.sfb08) THEN   #TQC-C60025 mark
        ...
        #end TQC-C60025 mark
        #str TQC-C60025 add
        #開啟料/倉/儲/批/刻號/BIN勾選畫面(asfi3017),依勾選的條件產生備料單身
          #MOD-D30027---begin
          SELECT imaicd04 INTO l_imaicd04 
            FROM imaicd_file WHERE imaicd00= g_sfb.sfb05
          IF NOT cl_null(l_imaicd04) AND l_imaicd04 <> '9' THEN 
          #MOD-D30027---end
             CALL i301_icd_gen_allotment(g_sfb.sfb01)
             SELECT sfb_file.* INTO g_sfb.* FROM sfb_file WHERE sfb01=g_sfb.sfb01
             SELECT sfbi_file.* INTO g_sfbi.* FROM sfbi_file WHERE sfbi01=g_sfb.sfb01
             CALL i301_show()
             CALL i301_lock_cursor()
          #MOD-D30027---begin   
          ELSE 
             CALL s_cralc(g_sfb.sfb01,g_sfb.sfb02,g_sfb.sfb05,l_btflg,
...
#TQC-BA0162--begin
       ...
       #str TQC-C60019 add
        #ICD行業別時,工單備料單身刪除應做刻號/BIN資料的刪除
        IF NOT i301sub_del_idb(l_sfb01,'','','','','','','1') THEN
           CALL cl_err3("del","idb_file",l_sfb01,"",SQLCA.sqlcode,"","del idb_sub",1)
           LET g_success = 'N'
        END IF
       #end TQC-C60019 add
#TQC-C50011 -----------------Begin-------------
        DELETE FROM sfaa_file WHERE sfaa01 = l_sfb01
        IF SQLCA.sqlcode THEN
           CALL cl_err3("del","sfaa_file",l_sfb01,"",SQLCA.sqlcode,"","del sfaa_sub",1)
           LET g_success = 'N'
        END IF
#TQC-C50011 -----------------End---------------
#TQC-BA0162--end
   ...
   #str TQC-C60019 add
    #ICD行業別時,工單備料單身刪除應做刻號/BIN資料的刪除
    IF NOT i301sub_del_idb(g_sfb.sfb01,'','','','','','','1') THEN
       CALL cl_err3("del","idb_file",g_sfb.sfb01,"",SQLCA.sqlcode,"","del idb_sub",1)
       LET g_success = 'N'
    END IF
   #end TQC-C60019 add
#TQC-C50011 -------------Begin----------------
...
FUNCTION i301_ind_icd_set_sfbiicd11()
   ...
   IF l_ecdicd01 MATCHES '[46]' THEN
      ...
      #END IF   #FUN-BC0103  #FUN-C30274 mark
      #FUN-C30274 --START--
      IF SQLCA.sqlcode THEN LET g_sfbi.sfbiicd11 = NULL END IF
      IF cl_null(g_sfbi.sfbiicd11) THEN
         SELECT imaicd20 INTO g_sfbi.sfbiicd11 FROM imaicd_file 
...
FUNCTION i301_ind_icd_set_sfbiicd12()
   ...
   IF l_ecdicd01 MATCHES '[46]' THEN
      ...
      #FUN-C30274 --END--   
   END IF
    #DISPLAY BY NAME  g_sfa[1].sfa03   #MOD-D30090
    DISPLAY BY NAME  g_sfbi.sfbiicd12  #MOD-D30090
END FUNCTION
...
FUNCTION i301_ind_icd_set_sfbiicd18()
   ...
   END IF
    ...
    #DISPLAY BY NAME  g_sfa[1].sfa03  #MOD-D30090
    DISPLAY BY NAME  g_sfbi.sfbiicd18 #MOD-D30090
END FUNCTION
...
FUNCTION i301_ind_icd_update_sfbiicd()
  ...
  IF l_ecdicd01 = '3' OR l_ecdicd01 = '4' THEN
     ...
     IF SQLCA.sqlcode THEN
        ...
        RETURN 0
     ELSE
       #UPDATE sfbi_file SET sfbiicd05 = l_sfa05,   #TQC-C60025 mark
        UPDATE sfbi_file SET sfbiicd06 = l_sfa05    #TQC-C60025 mod
        WHERE sfbi01 = g_sfb.sfb01
        IF SQLCA.sqlcode OR SQLCA.sqlerrd[3] = 0 THEN
           CALL cl_err('update sfb_file:',SQLCA.sqlcode,0)
           RETURN 0
        ELSE
          #LET g_sfbi.sfbiicd05 = l_sfa05     #TQC-C60025 mark
           LET g_sfbi.sfbiicd06 = l_sfa05
          #DISPLAY BY NAME g_sfbi.sfbiicd05   #TQC-C60025 mark
           DISPLAY BY NAME g_sfbi.sfbiicd06
           RETURN 1
        END IF
     END IF
...
FUNCTION i301_ind_icd_update_sfaiicd()
  ...
  #  LET l_icb05    = NULL    #FUN-B50106
    ...
    #END IF
    #end TQC-C60025 mark
     IF cl_null(l_sfa.sfa161) THEN LET l_sfa.sfa161=l_sfa.sfa16 END IF   #TQC-C60025 add
     ...
     ELSE
        ...
        IF cl_null(l_sfai.sfaiicd06) THEN   #FUN-C30274
           LET l_sfai.sfaiicd06='N'         #FUN-C30274
        END IF                              #FUN-C30274 
        ...
        #FUN-C30274 --START--
        ELSE
           CALL cralc_upd_sfaa(l_sfa.*,l_sfa.sfa01,l_sfa.sfa03,l_sfa.sfa08,l_sfa.sfa12,
...
FUNCTION i301_set_no_required_b(p_cmd)
  ...
  END IF
  #FUN-C30274 --START--
  IF l_ac > 0 THEN                       #TQC-C60025 add
 #IF INFIELD(sfaiicd06) THEN             #TQC-C60025 mark
  IF g_sfa[l_ac].sfaiicd06 = 'Y' THEN    #TQC-C60025
     CALL cl_set_comp_required("sfa30,sfa31,sfaiicd03",FALSE)
  END IF    
  END IF                                 #TQC-C60024 add
  #FUN-C30274 --END-- 
END FUNCTION
...
FUNCTION i301_ind_icd_gen_ecm_file()
  ...
  FOREACH c_put INTO l_ecb.*
    ...
    LET l_ecm.ecm62      =  l_ecb.ecb46   #FUN-C50122
    LET l_ecm.ecm63      =  l_ecb.ecb51   #FUN-C50122
...
FUNCTION i301_ind_icd_chk_price() 
    DEFINE l_flag      LIKE type_file.num5,
           ...
           l_pnz08     LIKE pnz_file.pnz08    #FUN-C50108
...
FUNCTION i301_ui_default()
   ...
   END IF
   CALL cl_set_comp_visible("sfaiicd06",TRUE)  #FUN-C30274
   #FUN-A80102(S)
...
FUNCTION i301_ind_icd_chk_icdqty(l_sfp,l_sfs)
   ...
   IF s_icdbin(l_sfs.sfs04) THEN   #FUN-BA0051
      ...
      #FUN-C30274 --END mark--  
      #FUN-C30274 --START--   
     #CALL s_icdchk(l_type,  l_sfs.sfs04, '','', '',       #MOD-C90033 mark
      CALL s_icdchk(l_type,  l_sfs.sfs04, l_sfs.sfs07,     #MOD-C90033
                             l_sfs.sfs08, l_sfs.sfs09,     #MOD-C90033 
                             l_sfs.sfs05, l_sfp.sfp01,
                            #1, l_sfp.sfp02,'')            #TQC-C60025 mark
                             l_sfs.sfs02, l_sfp.sfp02,'')  #TQC-C60025
           RETURNING l_flag
      #FUN-C30274 --END--     
   END IF
   RETURN l_flag
...
END WHILE
   ...
   IF STATUS OR SQLCA.SQLCODE THEN
    ...
    #SELECT sfbi_file.* INTO g_sfbi.* FROM sfbi_file WHERE sfbi01=old_no  #FUN-C80046
    CALL i301_show()   
...
#FUN-C30274 --START--
FUNCTION i301_idb_cp(l_sfp01)
DEFINE l_sfp01  LIKE sfp_file.sfp01
DEFINE l_idb    RECORD LIKE idb_file.*
DEFINE l_sql    STRING 
DEFINE l_sfs02  LIKE sfs_file.sfs02
               
   DECLARE i301_idb_cs CURSOR FOR        
   SELECT * FROM idb_file
    WHERE idb07 = g_sfb.sfb01 AND idb08 = 1
   
   FOREACH i301_idb_cs INTO l_idb.*
      LET l_idb.idb07 =  l_sfp01
      ...
      SELECT sfs02 INTO l_sfs02 FROM sfs_file 
       WHERE sfs04 = l_idb.idb01 AND sfs07 = l_idb.idb02
       AND sfs08 = l_idb.idb03 AND sfs09 = l_idb.idb04
       AND sfs03 = g_sfb.sfb01 
      LET l_idb.idb08 = l_sfs02
      IF cl_null(l_idb.idb08) OR l_idb.idb08 = 0 THEN 
         LET l_idb.idb08 = 1
      END IF    
      INSERT INTO idb_file VALUES(l_idb.*)
      IF SQLCA.sqlcode THEN
         CALL cl_err3("ins","idb_file",l_sfp01,'1',SQLCA.sqlcode,"","ins idb",1)         
         RETURN FALSE
      END IF    
   END FOREACH   
   RETURN TRUE 
...
#多倉儲批備料明細
FUNCTION i301_mntn_allotment_for_multi_wh(p_sfaa01,p_sfaa03,p_sfaa08,
                                          p_sfaa12,p_sfaa27,p_sfaa012,p_sfaa013)
#DEFINE p_sfaa01  LIKE sfaa_file.sfaa01     #MOD-D30045 mark
#DEFINE p_sfaa03  LIKE sfaa_file.sfaa01     #MOD-D30045 mark 
#DEFINE p_sfaa08  LIKE sfaa_file.sfaa01     #MOD-D30045 mark
#DEFINE p_sfaa12  LIKE sfaa_file.sfaa01     #MOD-D30045 mark
#DEFINE p_sfaa27  LIKE sfaa_file.sfaa01     #MOD-D30045 mark
#DEFINE p_sfaa012 LIKE sfaa_file.sfaa01     #MOD-D30045 mark
#DEFINE p_sfaa013 LIKE sfaa_file.sfaa01     #MOD-D30045 mark

DEFINE p_sfaa01  LIKE sfaa_file.sfaa01      #MOD-D30045 add
DEFINE p_sfaa03  LIKE sfaa_file.sfaa03      #MOD-D30045 add
DEFINE p_sfaa08  LIKE sfaa_file.sfaa08      #MOD-D30045 add
DEFINE p_sfaa12  LIKE sfaa_file.sfaa12      #MOD-D30045 add
DEFINE p_sfaa27  LIKE sfaa_file.sfaa27      #MOD-D30045 add
DEFINE p_sfaa012 LIKE sfaa_file.sfaa012     #MOD-D30045 add
DEFINE p_sfaa013 LIKE sfaa_file.sfaa013     #MOD-D30045 add                                         
DEFINE l_sfaa    DYNAMIC ARRAY OF RECORD
       ...
       sfaa051   LIKE sfaa_file.sfaa051       
                 END RECORD
DEFINE l_sfaa_t  RECORD 
       sfaa30    LIKE sfaa_file.sfaa30,
       sfaa31    LIKE sfaa_file.sfaa31,
       sfaa32    LIKE sfaa_file.sfaa32,
       sfaa05    LIKE sfaa_file.sfaa05,
...
DEFINE p_cmd            LIKE type_file.chr1
DEFINE l_sql            STRING
DEFINE l_dies           LIKE idd_file.idd18
DEFINE l_forupd_sql     STRING
DEFINE l_lock_sw        LIKE type_file.chr1
DEFINE l_code           LIKE type_file.num5
DEFINE l_r              LIKE type_file.chr1       #FUN-C30302
DEFINE l_qty            LIKE type_file.num15_3    #FUN-C30302
DEFINE l_sfaa05         LIKE sfaa_file.sfaa05     #TQC-C50140 add
DEFINE l_sfaa051        LIKE sfaa_file.sfaa051    #TQC-C50140 add
DEFINE l_imaicd14       LIKE imaicd_file.imaicd14 #TQC-C50140 add
DEFINE l_ecdicd01       LIKE ecd_file.ecdicd01    #TQC-C50140 add
DEFINE l_cnt            LIKE type_file.num5       #TQC-C50189 add
DEFINE l_imaicd04       LIKE imaicd_file.imaicd04 #TQC-C60025 add

   OPEN WINDOW i3016_w AT 04,02 WITH FORM "asf/42f/asfi3016"
         ATTRIBUTE (STYLE = g_win_style CLIPPED)
   CALL cl_ui_locale("asfi3016") 

   LET l_sql = "SELECT sfaa30,sfaa31,sfaa32,sfaa05,sfaa051",
               "  FROM sfaa_file",
               " WHERE sfaa01 ='",p_sfaa01,"' AND sfaa03 ='",p_sfaa03,"'",
               "   AND sfaa27 ='",p_sfaa27,"' AND sfaa012='",p_sfaa012,"'",
               "   AND sfaa013 =",p_sfaa013 
   DECLARE i3016_sfaa_c CURSOR FROM l_sql
     
   CALL l_sfaa.clear()
   
   LET i = 1
   FOREACH i3016_sfaa_c INTO l_sfaa[i].*
      IF STATUS THEN
         CALL cl_err('foreach sfaa',STATUS,0)
         EXIT FOREACH
      END IF
      LET i = i + 1
   END FOREACH
   CALL l_sfaa.deleteElement(i)
   LET l_i=i-1   

   DISPLAY p_sfaa01  TO sfaa01
   DISPLAY p_sfaa03  TO sfaa03
   DISPLAY p_sfaa08  TO sfaa08
   DISPLAY p_sfaa12  TO sfaa12
   DISPLAY p_sfaa27  TO sfaa27
   DISPLAY p_sfaa012 TO sfaa012
   DISPLAY p_sfaa013 TO sfaa013

  #str TQC-C50140 add
   IF g_action_choice = "mntn_allotment_for_multi_wh" THEN
      CALL cl_set_act_visible("accept,cancel", FALSE)
      DISPLAY ARRAY l_sfaa TO s_sfaa.* ATTRIBUTE(COUNT=l_i)
         ON ACTION aic_s_icdqry
            CALL s_icdqry(-1,g_sfb.sfb01,1,'N','')
   ...
   LET l_forupd_sql= "SELECT sfaa30,sfaa31,sfaa32,sfaa05,sfaa051 FROM sfaa_file ",
                     " WHERE sfaa01 = '", p_sfaa01, "' AND sfaa03 = '", p_sfaa03, "' ",
                     "   AND sfaa08 = '", p_sfaa08, "' AND sfaa12 = '", p_sfaa12, "' ",
                     "   AND sfaa27 = '", p_sfaa27, "' AND sfaa012 = '", p_sfaa012, "' ",
                     "   AND sfaa013 = ", p_sfaa013, 
                     "   AND sfaa30 = ? AND sfaa31 = ? AND sfaa32 = ?",
                     "   FOR UPDATE  "                     
   LET l_forupd_sql = cl_forupd_sql(l_forupd_sql)
   DECLARE i301_sfaa_bcl CURSOR FROM l_forupd_sql      # LOCK CURSOR

   INPUT ARRAY l_sfaa WITHOUT DEFAULTS FROM s_sfaa.*
         ATTRIBUTE(COUNT=l_i,MAXCOUNT=g_max_rec,UNBUFFERED,
                   INSERT ROW=l_allow_insert,DELETE ROW=l_allow_delete,APPEND ROW=l_allow_insert)
      BEFORE INPUT 
         CALL cl_set_comp_required("sfaa31,sfaa32,sfaa051",FALSE)
         CALL cl_set_comp_entry("sfaa051",FALSE)
      ...
      BEFORE ROW
         ...
         IF l_i >= i THEN            
            LET p_cmd='u'           
            LET l_sfaa_t.* = l_sfaa[i].*
            
            OPEN i301_sfaa_bcl USING l_sfaa[i].sfaa30,
                                     l_sfaa[i].sfaa31,
                                     l_sfaa[i].sfaa32
            IF SQLCA.sqlcode THEN
               CALL cl_err("OPEN i301_sfaa_bcl:", STATUS, 1)
               LET l_lock_sw = 'Y'
            ELSE
               FETCH i301_sfaa_bcl INTO l_sfaa[i].*
               IF SQLCA.sqlcode THEN
                  CALL cl_err('FETCH i301_sfaa_bcl:',SQLCA.sqlcode,1)
                  LET l_lock_sw = "Y"               
               END IF
            END IF
      ...
      BEFORE INSERT
         LET p_cmd='a'
         INITIALIZE l_sfaa[i].* TO NULL      
        #str TQC-C50140 add
        #LET l_sfaa[i].sfaa05 =  0          
        #LET l_sfaa[i].sfaa051 =  0     
         LET l_sfaa05 = 0 
         LET l_sfaa051 = 0 
         SELECT SUM(sfaa05),SUM(sfaa051) INTO l_sfaa05,l_sfaa051 FROM sfaa_file
          WHERE sfaa01 = p_sfaa01 AND sfaa03 = p_sfaa03 
         ...
         IF cl_null(l_sfaa05)  THEN LET l_sfaa05 = 0 END IF
         IF cl_null(l_sfaa051) THEN LET l_sfaa051= 0 END IF
         LET l_sfaa[i].sfaa05 = g_sfa[l_ac].sfa05 - l_sfaa05
         LET l_sfaa[i].sfaa051= g_sfa[l_ac].sfaiicd01- l_sfaa051
        #end TQC-C50140 add
         LET l_sfaa_t.* = l_sfaa[i].*
         CALL cl_show_fld_cont()         
         NEXT FIELD sfaa30   
      ...
      AFTER INSERT          
         IF INT_FLAG THEN
            ...
            CANCEL INSERT
         END IF
         IF cl_null(l_sfaa[i].sfaa31) THEN LET l_sfaa[i].sfaa31 = ' ' END IF
         IF cl_null(l_sfaa[i].sfaa32) THEN LET l_sfaa[i].sfaa32 = ' ' END IF  
          
        #str TQC-C50189 add
         LET l_cnt = 0
         SELECT COUNT(*) INTO l_cnt FROM sfaa_file
          WHERE sfaa01 = p_sfaa01
            AND sfaa03 = p_sfaa03
            AND sfaa08 = p_sfaa08
            AND sfaa12 = p_sfaa12
            AND sfaa27 = p_sfaa27
            AND sfaa012= p_sfaa012
            AND sfaa013= p_sfaa013
            AND sfaa30 = l_sfaa[i].sfaa30
            AND sfaa31 = l_sfaa[i].sfaa31
            AND sfaa32 = l_sfaa[i].sfaa32
         IF cl_null(l_cnt) THEN LET l_cnt = 0 END IF
         IF l_cnt = 0 THEN
        #end TQC-C50189 add
            INSERT INTO sfaa_file(sfaa01,sfaa03,sfaa08,sfaa12,sfaa27,sfaa012,sfaa013,
                                  sfaa30,sfaa31,sfaa32,sfaa05,sfaa051,sfaaplant,sfaalegal)
            VALUES(p_sfaa01,p_sfaa03,p_sfaa08,p_sfaa12,p_sfaa27,p_sfaa012,p_sfaa013,
                   l_sfaa[i].sfaa30,l_sfaa[i].sfaa31,l_sfaa[i].sfaa32,l_sfaa[i].sfaa05,l_sfaa[i].sfaa051,
                   g_plant,g_legal)  
            IF SQLCA.sqlcode THEN
               CALL cl_err3("ins","sfaa_file",'','',SQLCA.sqlcode,"","",1)  
               CANCEL INSERT
            ELSE
               MESSAGE 'INSERT O.K'
               COMMIT WORK
        ...
        #str TQC-C50189 add
         ELSE
            UPDATE sfaa_file SET sfaa30  =l_sfaa[i].sfaa30,
                                 sfaa31  =l_sfaa[i].sfaa31,
                                 sfaa32  =l_sfaa[i].sfaa32,
                                 sfaa05  =l_sfaa[i].sfaa05,
                                 sfaa051 =l_sfaa[i].sfaa051
             WHERE sfaa01 = p_sfaa01
               AND sfaa03 = p_sfaa03
               AND sfaa08 = p_sfaa08
               AND sfaa12 = p_sfaa12
      ...
      BEFORE DELETE     
         IF NOT cl_null(l_sfaa_t.sfaa30) THEN
            IF NOT cl_delb(0,0) THEN
               CANCEL DELETE
            END IF
            IF l_lock_sw = "Y" THEN
            ...
            DELETE FROM sfaa_file
             WHERE sfaa01 = p_sfaa01
               ...
               AND sfaa012 = p_sfaa012
               AND sfaa013 = p_sfaa013
               AND sfaa30 = l_sfaa_t.sfaa30
               AND sfaa31 = l_sfaa_t.sfaa31
               AND sfaa32 = l_sfaa_t.sfaa32
            IF SQLCA.sqlcode THEN
               CALL cl_err3("del","sfaa_file",'','',SQLCA.sqlcode,"","",1)  
               ROLLBACK WORK
               CANCEL DELETE
            ELSE
               IF NOT s_icdinout_del_2(-1,g_sfb.sfb01,1,'',g_sfa_t.sfa03,g_sfa_t.sfa30,g_sfa_t.sfa31,g_sfa_t.sfaiicd03) THEN
      ...
      ON ROW CHANGE
         IF INT_FLAG THEN
            CALL cl_err('',9001,0)
            LET INT_FLAG = 0
            LET l_sfaa[i].* = l_sfaa_t.*
            CLOSE i301_sfaa_bcl
            ROLLBACK WORK
            EXIT INPUT
         END IF
         IF l_lock_sw = 'Y' THEN
            CALL cl_err(l_sfaa[i].sfaa30,-263,1)
            LET l_sfaa[i].* = l_sfaa_t.*
         ELSE 
           #str TQC-C50140 mod
            #倉儲批有改變時,就要把刻號/BIN資料刪除
            IF NOT (l_sfaa[i].sfaa30 = l_sfaa_t.sfaa30 AND
                    l_sfaa[i].sfaa31 = l_sfaa_t.sfaa31 AND
                    l_sfaa[i].sfaa32 = l_sfaa_t.sfaa32) THEN
           #end TQC-C50140 mod
               IF NOT s_icdinout_del_2(-1,p_sfaa01,1,'',p_sfaa03,l_sfaa_t.sfaa30,l_sfaa_t.sfaa31,l_sfaa_t.sfaa32) THEN                  
                  CALL cl_err('del idb_file',SQLCA.sqlcode,1)
                  LET l_sfaa[i].* = l_sfaa_t.*
              #ELSE   #TQC-C50140 mark
               END IF #TQC-C50140 add
            END IF #TQC-C50140 add
               IF cl_null(l_sfaa[i].sfaa31) THEN LET l_sfaa[i].sfaa31 = ' ' END IF
               IF cl_null(l_sfaa[i].sfaa32) THEN LET l_sfaa[i].sfaa32 = ' ' END IF 
               UPDATE sfaa_file SET sfaa30  =l_sfaa[i].sfaa30,
                ...
                WHERE sfaa01 = p_sfaa01
                  ...
                  AND sfaa32 = l_sfaa_t.sfaa32
               IF SQLCA.sqlcode OR SQLCA.sqlerrd[3] = 0 THEN
                  CALL cl_err3("upd","sfaa_file",'','',SQLCA.sqlcode,"","",1)  
                  LET l_sfaa[i].* = l_sfaa_t.*
               ELSE
                  MESSAGE 'UPDATE O.K'
                  COMMIT WORK
               END IF
           #END IF    #TQC-C50140 mark
         END IF  
      ...
      ON ACTION aic_s_icdout
         ...
         IF cl_null(l_sfaa[i].sfaa32) THEN LET l_sfaa[i].sfaa32 = ' ' END IF      
         IF p_cmd = 'u' THEN
            IF l_sfaa[i].sfaa30 <> l_sfaa_t.sfaa30 OR l_sfaa[i].sfaa31 <> l_sfaa_t.sfaa31 OR
               l_sfaa[i].sfaa32 <> l_sfaa_t.sfaa32 THEN
               IF NOT s_icdinout_del_2(-1,p_sfaa01,1,'',p_sfaa03,l_sfaa_t.sfaa30,l_sfaa_t.sfaa31,l_sfaa_t.sfaa32) THEN
                  LET l_sfaa[i].* = l_sfaa_t.*               
                  CALL cl_err('del idb_file',SQLCA.sqlcode,1)
               ...
               ELSE 
                  UPDATE sfaa_file SET sfaa30  =l_sfaa[i].sfaa30,
                                       ...
                                       sfaa05  =l_sfaa[i].sfaa05,
                                       sfaa051 =l_sfaa[i].sfaa051
                   WHERE sfaa01 = p_sfaa01          #TQC-C50189 add  
                     AND sfaa03 = p_sfaa03          #TQC-C50189 add  
                     AND sfaa08 = p_sfaa08          #TQC-C50189 add  
                     AND sfaa12 = p_sfaa12          #TQC-C50189 add  
                     AND sfaa27 = p_sfaa27          #TQC-C50189 add  
                     AND sfaa012= p_sfaa012         #TQC-C50189 add 
                     AND sfaa013= p_sfaa013         #TQC-C50189 add 
                     AND sfaa30 = l_sfaa_t.sfaa30   #TQC-C50189 add
                     AND sfaa31 = l_sfaa_t.sfaa31   #TQC-C50189 add
                     AND sfaa32 = l_sfaa_t.sfaa32   #TQC-C50189 add
                  IF SQLCA.sqlcode THEN                     
                     LET g_success = 'N'               
                     CALL cl_err('upd sfaa_file',SQLCA.sqlcode,1)                     
                  END IF                      
               END IF                         
            END IF 
         ELSE 
           ...
           #str TQC-C50189 add
            ...
            IF cl_null(l_cnt) THEN LET l_cnt = 0 END IF
           #str TQC-C60025 add
            IF cl_null(l_sfaa[i].sfaa051) OR l_sfaa[i].sfaa05!=l_sfaa_t.sfaa05 THEN
               CALL s_icdfun_imaicd14(p_sfaa03) RETURNING l_imaicd14
               IF cl_null(l_imaicd14) THEN LET l_imaicd14=1 END IF
               SELECT imaicd04 INTO l_imaicd04 FROM imaicd_file WHERE imaicd00=p_sfaa03
               IF l_imaicd04 MATCHES '[12]' THEN
                  LET l_sfaa[i].sfaa051 = l_sfaa[i].sfaa05 * l_imaicd14
               ELSE
                  LET l_sfaa[i].sfaa051 = l_sfaa[i].sfaa05
               END IF 
               DISPLAY BY NAME l_sfaa[i].sfaa05,l_sfaa[i].sfaa051
            END IF
           #end TQC-C60025 add
            IF l_cnt = 0 THEN
           #end TQC-C50189 add
         ...
         END IF 
         IF g_success = 'Y' THEN            
            CALL s_icdout_ogb17_on()
            CALL s_icdout(p_sfaa03,l_sfaa[i].sfaa30,l_sfaa[i].sfaa31,
                          l_sfaa[i].sfaa32,p_sfaa12,l_sfaa[i].sfaa05,
                          p_sfaa01,1,g_sfb.sfb81,
                         'N','','','','')
                 RETURNING l_dies,l_r,l_qty   #FUN-C30302
            #FUN-C30302---begin
            IF l_r = 'Y' THEN
               LET l_qty = s_digqty(l_qty,p_sfaa12) 
               LET l_sfaa[i].sfaa05 = l_qty
            END IF 
            #FUN-C30302---end
            CALL s_icdout_ogb17_off()                  
           #str TQC-C50140 mod
           #LET l_sfaa[i].sfaa051 = l_dies
            IF l_dies = 0 THEN
               CALL s_icdfun_imaicd14(p_sfaa03) RETURNING l_imaicd14
               IF cl_null(l_imaicd14) THEN LET l_imaicd14=1 END IF   #TQC-C60025 mod
              #str TQC-C60025 mark
              #SELECT ecdicd01 INTO l_ecdicd01 FROM ecd_file
              # WHERE ecd01 = g_sfbi.sfbiicd09
              #IF l_ecdicd01 MATCHES '[234]' THEN
              #end TQC-C60025 mark
              #str TQC-C60025 add
               SELECT imaicd04 INTO l_imaicd04 FROM imaicd_file WHERE imaicd00=p_sfaa03
               IF l_imaicd04 MATCHES '[12]' THEN
           ...
           #end TQC-C50140 mod
            LET l_sfaa_t.* = l_sfaa[i].*
            DISPLAY BY NAME l_sfaa[i].sfaa051
         ELSE 
            LET l_sfaa[i].* = l_sfaa_t.*   
         END IF    
      ...
      ON ACTION controlp
         CASE
           WHEN INFIELD(sfaa30)
             CALL q_imd_1(FALSE,TRUE,l_sfaa[i].sfaa30,"",g_plant,"","")  
                  RETURNING l_sfaa[i].sfaa30
             DISPLAY BY NAME l_sfaa[i].sfaa30
             NEXT FIELD sfaa30 
            
           WHEN INFIELD(sfaa31)
             CALL q_ime_1(FALSE,TRUE,l_sfaa[i].sfaa31,l_sfaa[i].sfaa30,"",g_plant,"","","")
                  RETURNING l_sfaa[i].sfaa31          
             DISPLAY BY NAME l_sfaa[i].sfaa30
             NEXT FIELD sfaa31
           ...
           WHEN INFIELD(sfaa32)
             ...
             LET g_ima906 = NULL
             SELECT ima906 INTO g_ima906 FROM ima_file
              WHERE ima01 = p_sfaa03
             #IF s_industry("icd") AND g_ima906='3' THEN  #TQC-C60028
             IF s_industry("icd") THEN  #TQC-C60028
                CALL q_idc(FALSE,FALSE,p_sfaa03,l_sfaa[i].sfaa30,l_sfaa[i].sfaa31,l_sfaa[i].sfaa32)
                RETURNING l_sfaa[i].sfaa30,l_sfaa[i].sfaa31,l_sfaa[i].sfaa32
             ELSE
             #FUN-C30300---end
                CALL q_img4(FALSE,FALSE,p_sfaa03,l_sfaa[i].sfaa30,
                            l_sfaa[i].sfaa31,l_sfaa[i].sfaa32,'A')
                     RETURNING l_sfaa[i].sfaa30,l_sfaa[i].sfaa31,
                               l_sfaa[i].sfaa32
             END IF #FUN-C30300
             IF cl_null(l_sfaa[i].sfaa30) THEN
                LET l_sfaa[i].sfaa30 = ' '
             END IF      
             IF NOT s_chk_ware(l_sfaa[i].sfaa30) THEN  
                LET l_sfaa[i].sfaa30 = ' '
             END IF            
             IF cl_null(l_sfaa[i].sfaa31) THEN
                LET l_sfaa[i].sfaa31 = ' '
             END IF
             IF cl_null(l_sfaa[i].sfaa32) THEN
                LET l_sfaa[i].sfaa32 = ' '
             END IF 
             DISPLAY BY NAME l_sfaa[i].sfaa30
             DISPLAY BY NAME l_sfaa[i].sfaa31
             DISPLAY BY NAME l_sfaa[i].sfaa32 
         END CASE 

      AFTER FIELD sfaa30
         IF NOT cl_null(l_sfaa[i].sfaa30) THEN
            SELECT * FROM imd_file
             WHERE imd01=l_sfaa[i].sfaa30
               AND imdacti = 'Y' 
            IF STATUS THEN
              CALL cl_err3("sel","imd_file",l_sfaa[i].sfaa30,"","mfg1100","","imd:",1)   #No.FUN-660128
              NEXT FIELD sfaa30
            END IF
    #------>check-1
            IF NOT s_imfchk1(p_sfaa03,l_sfaa[i].sfaa30)
              THEN CALL cl_err(l_sfaa[i].sfaa30,'mfg9036',0)
              NEXT FIELD sfaa30
            END IF
    #------>check-2
            CALL s_stkchk(l_sfaa[i].sfaa30,'A') RETURNING l_code
            IF NOT l_code THEN
               CALL cl_err(l_sfaa[i].sfaa30,'mfg1100',0)
               NEXT FIELD sfaa30
            END IF
            IF NOT s_chk_ware(l_sfaa[i].sfaa30) THEN  #检查仓库是否属于当前门店
               NEXT FIELD sfaa30
            END IF
         ELSE
            LET l_sfaa[i].sfaa30=' '  
         ...
         IF NOT s_icdout_holdlot(p_sfaa03,l_sfaa[i].sfaa30,
                                 l_sfaa[i].sfaa31,l_sfaa[i].sfaa32) THEN
            NEXT FIELD sfaa30
         END IF  
         
      AFTER FIELD sfaa31
         IF NOT cl_null(l_sfaa[i].sfaa31) THEN
            IF NOT s_imfchk(p_sfaa03,l_sfaa[i].sfaa30,l_sfaa[i].sfaa31)
               THEN CALL cl_err(l_sfaa[i].sfaa31,'mfg6095',0)
               NEXT FIELD sfaa31
            END IF
         ELSE
            LET l_sfaa[i].sfaa31=' '  
      ...
      AFTER FIELD sfaa32
         IF NOT cl_null(l_sfaa[i].sfaa32) THEN
            SELECT * FROM img_file
             WHERE img01 = p_sfaa03
               AND img02 = l_sfaa[i].sfaa30
               AND img03 = l_sfaa[i].sfaa31
               AND img04 = l_sfaa[i].sfaa32
            IF SQLCA.sqlcode = 100 THEN
               CALL cl_err('','apm-259',1)
               NEXT FIELD sfaa32
            END IF
     ...
     #str TQC-C50140 add
      AFTER FIELD sfaa05
         IF cl_null(l_sfaa[i].sfaa05) OR l_sfaa[i].sfaa05 < 0 THEN 
            NEXT FIELD sfaa05
         END IF
         IF cl_null(l_sfaa[i].sfaa051) OR l_sfaa[i].sfaa05!=l_sfaa_t.sfaa05 THEN   #TQC-C60025 add
            CALL s_icdfun_imaicd14(p_sfaa03) RETURNING l_imaicd14
            IF cl_null(l_imaicd14) THEN LET l_imaicd14=0 END IF
           #str TQC-C60025 mark
           #SELECT ecdicd01 INTO l_ecdicd01 FROM ecd_file
...
#str TQC-C60025 add
FUNCTION i301_icd_gen_allotment(p_sfb01)
   DEFINE p_sfb01      LIKE sfb_file.sfb01
   DEFINE l_sfb        RECORD LIKE sfb_file.*
   ...
   DEFINE i,l_i        LIKE type_file.num5
   DEFINE l_idc08_t    LIKE idc_file.idc08  #TQC-C60185
   DEFINE l_idc12_t    LIKE idc_file.idc12  #TQC-C60185
   DEFINE l_idb16      LIKE idb_file.idb16  #TQC-C60185
   DEFINE l_idc08      LIKE idc_file.idc08  #TQC-C60185
   DEFINE l_idc12      LIKE idc_file.idc12  #TQC-C60185
   DEFINE l_idc21      LIKE idc_file.idc21  #TQC-C60185

   OPEN WINDOW i3017_w AT 04,02 WITH FORM "asf/42f/asfi3017"
         ATTRIBUTE (STYLE = g_win_style CLIPPED)
   CALL cl_ui_locale("asfi3017") 

   SELECT * INTO l_sfb.* FROM sfb_file WHERE sfb01=p_sfb01
   SELECT * INTO l_sfbi.* FROM sfbi_file WHERE sfbi01=p_sfb01
   SELECT ima02,ima021,ima55 INTO l_ima02,l_ima021,l_ima55 FROM ima_file WHERE ima01=l_sfb.sfb05 

   DISPLAY l_sfb.sfb05,l_sfb.sfb08 TO sfb05,sfb08
   DISPLAY l_sfbi.sfbiicd06,l_sfbi.sfbiicd09 TO sfbiicd06,sfbiicd09
   DISPLAY l_ima02,l_ima021,l_ima55 TO ima02_a,ima021_a,ima55

   #1.建立Temptable
   CALL i301_icd_cretmp()

   #定義更新Temptable的SQL
   LET g_sql = "UPDATE ",g_cr_db_str CLIPPED,l_table CLIPPED,
               "   SET cho0 = ? WHERE sfa03 = ?"
   PREPARE i301_icd_upd_cho0 FROM g_sql
   LET g_sql = "UPDATE ",g_cr_db_str CLIPPED,l_table1 CLIPPED,
               "   SET cho1 = ?,idc08_a = ? ,idc12_a = ? ",
               " WHERE idc01 = ? AND idc02 = ? AND idc03 = ? AND idc04 = ?"
   PREPARE i301_icd_upd_cho1 FROM g_sql
   LET g_sql = "UPDATE ",g_cr_db_str CLIPPED,l_table2 CLIPPED,
               "   SET cho2 = ?,idc08_b = ?,idc12_b = ?",
               " WHERE idc01 = ? AND idc02 = ? AND idc03 = ? AND idc04 = ?",
               "   AND idc05 = ? AND idc06 = ?"
   PREPARE i301_icd_upd_cho2 FROM g_sql

   #2.準備可選取的上階料號
   CALL i301_icd_get_icm01(g_sfb.sfb05)
   LET g_sql = "SELECT * FROM ",g_cr_db_str CLIPPED,l_table CLIPPED," ORDER BY sfa03"
   DECLARE i301_icd_sfa03_c CURSOR FROM g_sql
   CALL g_sfa03.clear()
   LET i = 1
   FOREACH i301_icd_sfa03_c INTO g_sfa03[i].*
      IF STATUS THEN
         CALL cl_err('foreach sfa03',STATUS,0)
         EXIT FOREACH
      END IF
      LET i = i + 1
   END FOREACH
   CALL g_sfa03.deleteElement(i)
   LET l_i = i - 1   
   DISPLAY l_i TO cnt

   #3.準備可選取的倉儲批與刻號/BIN
   CALL i301_icd_get_idc()
   LET g_sql = "SELECT cho1,idc02,idc03,idc04,idc07,idc08,idc08_a,idc12,idc12_a,idc21 ",
               "  FROM ",g_cr_db_str CLIPPED,l_table1 CLIPPED,
               " ORDER BY idc01,idc02,idc03,idc04"
   DECLARE i301_icd_idc1_c CURSOR FROM g_sql
   CALL g_idc1.clear()
   LET i = 1
   FOREACH i301_icd_idc1_c INTO g_idc1[i].*
      IF STATUS THEN
         CALL cl_err('foreach idc1',STATUS,0)
         EXIT FOREACH
      END IF
      LET i = i + 1
   END FOREACH
   CALL g_idc1.deleteElement(i)
   LET l_i = i - 1   
   DISPLAY l_i TO cn2
   LET g_sql = "SELECT cho2,idc05,idc06,idc11,idc07,idc08,idc08_b,idc12,idc12_b,idc21 ",
               "  FROM ",g_cr_db_str CLIPPED,l_table2 CLIPPED,
               " ORDER BY idc01,idc02,idc03,idc04,idc05,idc06,idc11"
   DECLARE i301_icd_idc2_c CURSOR FROM g_sql
   CALL g_idc2.clear()
   LET i = 1
   FOREACH i301_icd_idc2_c INTO g_idc2[i].*
      IF STATUS THEN
         CALL cl_err('foreach idc2',STATUS,0)
         EXIT FOREACH
      END IF
      LET i = i + 1
   END FOREACH
   CALL g_idc2.deleteElement(i)
   LET l_i = i - 1   
   DISPLAY l_i TO cn4

   LET l_ac0=1   LET l_ac1=1   LET l_ac2=1
   DIALOG ATTRIBUTES(UNBUFFERED)
   
      INPUT ARRAY g_sfa03 FROM s_sfa.*
         ...
         BEFORE ROW
            LET l_ac0 = ARR_CURR()
            LET g_sfa03_t.* = g_sfa03[l_ac0].*
            #顯示倉儲批單身資料
            CALL i301_refresh_idc1(g_sfa03[l_ac0].sfa03)
            #顯示刻號/BIN單身資料
            IF cl_null(g_idc1[l_ac1].idc04) THEN LET g_idc1[l_ac1].idc04=' ' END IF  #MOD-C90137 add
            CALL i301_refresh_idc2(g_sfa03[l_ac0].sfa03,g_idc1[l_ac1].idc02,
                                   g_idc1[l_ac1].idc03,g_idc1[l_ac1].idc04)
            CALL cl_set_comp_entry("sfa03",FALSE)
            NEXT FIELD cho0
         ...
         ON CHANGE cho0
            ...
            CALL i301_refresh_idc2(g_sfa03[l_ac0].sfa03,g_idc1[l_ac1].idc02,
                                   g_idc1[l_ac1].idc03,g_idc1[l_ac1].idc04)
            EXECUTE i301_icd_upd_cho0 USING g_sfa03[l_ac0].cho0,g_sfa03[l_ac0].sfa03
            IF SQLCA.sqlerrd[3]=0 THEN
               CALL cl_err('upd cho0_temp','9050',1)
            END IF
 
         ON ACTION all
            FOR l_i = 1 TO g_sfa03.getLength()
                LET g_sfa03[l_i].cho0 = 'Y'
                DISPLAY BY NAME g_sfa03[l_i].cho0
                EXECUTE i301_icd_upd_cho0 USING g_sfa03[l_i].cho0,g_sfa03[l_i].sfa03
                IF SQLCA.sqlerrd[3]=0 THEN
                   CALL cl_err('upd cho0_temp','9050',1)
                END IF
            END FOR
      ...
      INPUT ARRAY g_idc1 FROM s_idc1.*
         ...
         BEFORE ROW
            LET l_ac1 = ARR_CURR()
            LET g_idc1_t.* = g_idc1[l_ac1].*
            #顯示刻號/BIN單身資料
            IF cl_null(g_idc1[l_ac1].idc04) THEN LET g_idc1[l_ac1].idc04=' ' END IF  #MOD-C90137 add
            CALL i301_refresh_idc2(g_sfa03[l_ac0].sfa03,g_idc1[l_ac1].idc02,
                                   g_idc1[l_ac1].idc03,g_idc1[l_ac1].idc04)
            CALL cl_set_comp_entry("idc08_a,idc12_a",FALSE)
            IF g_sfa03[l_ac0].cho0='Y' THEN
               CALL i301_icd_get_imaicd(g_sfa03[l_ac0].sfa03) RETURNING l_imaicd04,l_imaicd08,l_imaicd09
               IF l_imaicd08='N' AND l_imaicd09='N' THEN   #不做刻號/BIN/Datecode管理,才需維護數量
                  IF l_imaicd04='2' THEN   #CP才要維護參考數量
                     CALL cl_set_comp_entry("idc08_a,idc12_a",TRUE)
                  ELSE
         ...
         ON CHANGE cho1
            ...
            CALL i301_refresh_idc2(g_sfa03[l_ac0].sfa03,g_idc1[l_ac1].idc02,
                                   g_idc1[l_ac1].idc03,g_idc1[l_ac1].idc04)
            IF g_idc1[l_ac1].cho1='N' THEN
               EXECUTE i301_icd_upd_cho1 USING
                  g_idc1[l_ac1].cho1,'0','0',
                  g_sfa03[l_ac0].sfa03,g_idc1[l_ac1].idc02,g_idc1[l_ac1].idc03,g_idc1[l_ac1].idc04
               IF SQLCA.sqlerrd[3]=0 THEN
                  CALL cl_err('upd cho1_temp','9050',1)
               END IF
            ELSE
               CALL i301_icd_get_imaicd(g_sfa03[l_ac0].sfa03) RETURNING l_imaicd04,l_imaicd08,l_imaicd09
               IF l_imaicd08='N' AND l_imaicd09='N' THEN   #要做刻號/BIN/Datecode管理,不需維護數量
                  IF l_imaicd04='2' THEN   #CP才要維護參考數量
                     LET g_idc1[l_ac1].idc08_a = g_idc1[l_ac1].idc08_1-g_idc1[l_ac1].idc21_1
                     IF g_idc1[l_ac1].idc08_a = 1 THEN
                        LET g_idc1[l_ac1].idc12_a = g_idc1[l_ac1].idc12_1
                     ELSE
                        LET g_idc1[l_ac1].idc12_a = 0
                     END IF
                  ELSE
                     LET g_idc1[l_ac1].idc08_a = g_idc1[l_ac1].idc08_1-g_idc1[l_ac1].idc21_1
                  END IF
                  CALL i301_icd_idc1_tot()
               END IF
               EXECUTE i301_icd_upd_cho1 USING
                  g_idc1[l_ac1].cho1,g_idc1[l_ac1].idc08_a,g_idc1[l_ac1].idc12_a,
                  g_sfa03[l_ac0].sfa03,g_idc1[l_ac1].idc02,g_idc1[l_ac1].idc03,g_idc1[l_ac1].idc04
               IF SQLCA.sqlerrd[3]=0 THEN
                  CALL cl_err('upd cho1_temp','9050',1)
               END IF
         ...
         ON CHANGE idc08_a
            IF NOT cl_null(g_idc1[l_ac1].idc08_a) THEN
               IF g_idc1[l_ac1].idc08_a < 0 THEN
                  CALL cl_err(g_idc1[l_ac1].idc08_a,'aap-022',0)
                  LET g_idc1[l_ac1].idc08_a = g_idc1_t.idc08_a
                  NEXT FIELD idc08_a
               END IF
               #須小於庫存量
               IF g_idc1[l_ac1].idc08_a > (g_idc1[l_ac1].idc08_1-g_idc1[l_ac1].idc21_1) THEN
                  CALL cl_err(g_idc1[l_ac1].idc08_a,'axm-280',0)
                  LET g_idc1[l_ac1].idc08_a = g_idc1_t.idc08_a
                  NEXT FIELD idc08_a
               END IF
               CALL i301_icd_idc1_tot()
         ...
         ON CHANGE idc12_a
            IF NOT cl_null(g_idc1[l_ac1].idc12_a) THEN
               IF g_idc1[l_ac1].idc12_a < 0 THEN
                  CALL cl_err(g_idc1[l_ac1].idc12_a,'aap-022',0)
                  LET g_idc1[l_ac1].idc12_a = g_idc1_t.idc12_a
                  NEXT FIELD idc12_a
               END IF
               CALL i301_icd_idc1_tot()
               EXECUTE i301_icd_upd_cho1 USING
         ...
         ON ACTION all
            FOR l_i = 1 TO g_idc1.getLength()
                LET g_idc1[l_i].cho1 = 'Y'
                CALL i301_icd_get_imaicd(g_sfa03[l_ac0].sfa03) RETURNING l_imaicd04,l_imaicd08,l_imaicd09
                IF l_imaicd08='N' AND l_imaicd09='N' THEN   #要做刻號/BIN/Datecode管理,不需維護數量
                   IF l_imaicd04='2' THEN   #CP才要維護參考數量
                      LET g_idc1[l_i].idc08_a = g_idc1[l_i].idc08_1-g_idc1[l_i].idc21_1
                      IF g_idc1[l_i].idc08_a = 1 THEN
                         LET g_idc1[l_i].idc12_a = g_idc1[l_i].idc12_1
                      ELSE
                         LET g_idc1[l_i].idc12_a = 0
                      END IF
                   ELSE
                      LET g_idc1[l_i].idc08_a = g_idc1[l_i].idc08_1-g_idc1[l_i].idc21_1
                   END IF
                END IF
                DISPLAY BY NAME g_idc1[l_i].cho1,g_idc1[l_i].idc08_a,g_idc1[l_i].idc12_a
                EXECUTE i301_icd_upd_cho1 USING
                   g_idc1[l_i].cho1,g_idc1[l_i].idc08_a,g_idc1[l_i].idc12_a,
                   g_sfa03[l_ac0].sfa03,g_idc1[l_i].idc02,g_idc1[l_i].idc03,g_idc1[l_i].idc04
                IF SQLCA.sqlerrd[3]=0 THEN
                   CALL cl_err('upd cho1_temp','9050',1)
                END IF
            END FOR
         ...
         ON ACTION no_all
            FOR l_i = 1 TO g_idc1.getLength()
                LET g_idc1[l_i].cho1 = 'N'
                LET g_idc1[l_i].idc08_a = 0
                LET g_idc1[l_i].idc12_a = 0
                DISPLAY BY NAME g_idc1[l_i].cho1,g_idc1[l_i].idc08_a,g_idc1[l_i].idc12_a
                EXECUTE i301_icd_upd_cho1 USING
                   g_idc1[l_i].cho1,g_idc1[l_i].idc08_a,g_idc1[l_i].idc12_a,
      ...
      INPUT ARRAY g_idc2 FROM s_idc2.*
         ...
         BEFORE ROW
            LET l_ac2 = ARR_CURR()
            LET g_idc2_t.* = g_idc2[l_ac2].*
            LET l_idc08_t = 0  #TQC-C60185
            LET l_idc12_t = 0  #TQC-C60185
            CALL cl_set_comp_entry("idc08_b,idc12_b",FALSE)
            IF g_sfa03[l_ac0].cho0='Y' THEN
               IF g_idc1[l_ac1].cho1='Y' THEN
                  CALL i301_icd_get_imaicd(g_sfa03[l_ac0].sfa03) RETURNING l_imaicd04,l_imaicd08,l_imaicd09
                  IF l_imaicd08='Y' OR l_imaicd09='Y' THEN   #要做刻號/BIN/Datecode管理,才需維護數量
                     IF l_imaicd04='2' THEN   #CP才要維護參考數量
                        CALL cl_set_comp_entry("idc08_b,idc12_b",TRUE)
                     ELSE
                        CALL cl_set_comp_entry("idc08_b",TRUE)
                     END IF
                  ELSE
                     CALL g_idc2.clear()
                     NEXT FIELD cho1
         ...
         ON CHANGE cho2
            IF g_idc2[l_ac2].cho2='N' THEN
               IF g_rec_b2 > 0 THEN  #MOD-D30050
                  EXECUTE i301_icd_upd_cho2 USING
                     g_idc2[l_ac2].cho2,'0','0',
                     g_sfa03[l_ac0].sfa03,g_idc1[l_ac1].idc02,g_idc1[l_ac1].idc03,g_idc1[l_ac1].idc04,
                     g_idc2[l_ac2].idc05,g_idc2[l_ac2].idc06
                  IF SQLCA.sqlerrd[3]=0 THEN
                     CALL cl_err('upd cho2_temp','9050',1)
                  END IF
               END IF   #MOD-D30050
            ELSE
               CALL i301_icd_get_imaicd(g_sfa03[l_ac0].sfa03) RETURNING l_imaicd04,l_imaicd08,l_imaicd09
               IF l_imaicd08='Y' OR l_imaicd09='Y' THEN   #要做刻號/BIN/Datecode管理,才需維護數量
                  IF l_imaicd04='2' THEN   #CP才要維護參考數量
                     LET g_idc2[l_ac2].idc08_b = g_idc2[l_ac2].idc08_2-g_idc2[l_ac2].idc21_2
                     IF g_idc2[l_ac2].idc08_b = 1 THEN
                        LET g_idc2[l_ac2].idc12_b = g_idc2[l_ac2].idc12_2
                     ELSE
                        #LET g_idc2[l_ac2].idc12_b = 0 TQC-C60185
                        #TQC-C60185---begin
                        SELECT idc08,idc12,idc21 INTO l_idc08,l_idc12,l_idc21
                          FROM idc_file
                         WHERE idc01 = g_sfa03[l_ac0].sfa03
                           AND idc02 = g_idc1[l_ac1].idc02
                           AND idc03 = g_idc1[l_ac1].idc03
                           AND idc04 = g_idc1[l_ac1].idc04
                           AND idc05 = g_idc2[l_ac2].idc05
                           AND idc06 = g_idc2[l_ac2].idc06

                        IF l_idc21 > 0 THEN 
                           CALL i301_get_idb16(g_sfa03[l_ac0].sfa03,g_idc1[l_ac1].idc02,g_idc1[l_ac1].idc03,g_idc1[l_ac1].idc04,
                                              g_idc2[l_ac2].idc05,g_idc2[l_ac2].idc06) 
                                RETURNING l_idb16 
                           LET g_idc2[l_ac2].idc12_b = (l_idc12 - l_idb16) * (g_idc2[l_ac2].idc08_b/(l_idc08-l_idc21))
                           LET g_idc2[l_ac2].idc12_b = cl_digcut(g_idc2[l_ac2].idc12_b,0)
                        ELSE 
                           LET g_idc2[l_ac2].idc12_b = l_idc12 * (g_idc2[l_ac2].idc08_b/l_idc08)
                           LET g_idc2[l_ac2].idc12_b = cl_digcut(g_idc2[l_ac2].idc12_b,0)
                        END IF 
                        DISPLAY BY NAME g_idc2[l_ac2].idc12_b
                     #TQC-C60185---end
                     END IF
                  ELSE
                     LET g_idc2[l_ac2].idc08_b = g_idc2[l_ac2].idc08_2-g_idc2[l_ac2].idc21_2
                  END IF
                  CALL i301_icd_idc2_tot()
               END IF
               IF g_rec_b2 > 0 THEN  #MOD-D30050
                  EXECUTE i301_icd_upd_cho2 USING
                     g_idc2[l_ac2].cho2,g_idc2[l_ac2].idc08_b,g_idc2[l_ac2].idc12_b,
                     g_sfa03[l_ac0].sfa03,g_idc1[l_ac1].idc02,g_idc1[l_ac1].idc03,g_idc1[l_ac1].idc04,
                     g_idc2[l_ac2].idc05,g_idc2[l_ac2].idc06
                  IF SQLCA.sqlerrd[3]=0 THEN
                     CALL cl_err('upd cho2_temp','9050',1)
         ...
         ON CHANGE idc08_b
            IF NOT cl_null(g_idc2[l_ac2].idc08_b) THEN
               IF g_idc2[l_ac2].idc08_b < 0 THEN
                  CALL cl_err(g_idc2[l_ac2].idc08_b,'aap-022',0)
                  LET g_idc2[l_ac2].idc08_b = g_idc2_t.idc08_b
                  NEXT FIELD idc08_b
               END IF
               #須小於庫存量
               IF g_idc2[l_ac2].idc08_b > (g_idc2[l_ac2].idc08_2-g_idc2[l_ac2].idc21_2) THEN
                  CALL cl_err(g_idc2[l_ac2].idc08_b,'axm-280',0)
                  LET g_idc2[l_ac2].idc08_b = g_idc2_t.idc08_b
                  NEXT FIELD idc08_b
               END IF
               #TQC-C60185---begin
               IF l_idc08_t = 0 AND g_idc2[l_ac2].idc08_b <> g_idc2_t.idc08_b THEN
                  SELECT idc08,idc12,idc21 INTO l_idc08,l_idc12,l_idc21
                    FROM idc_file
                   WHERE idc01 = g_sfa03[l_ac0].sfa03
                     AND idc02 = g_idc1[l_ac1].idc02
                  ...
                  ELSE 
                     ...
                     LET g_idc2[l_ac2].idc12_b = cl_digcut(g_idc2[l_ac2].idc12_b,0)
                  END IF 
                  LET l_idc12_t = g_idc2[l_ac2].idc12_b
                  DISPLAY BY NAME g_idc2[l_ac2].idc12_b
               END IF 
               LET l_idc08_t = g_idc2[l_ac2].idc08_b
               #TQC-C60185---end
               CALL i301_icd_idc2_tot()
               IF g_rec_b2 > 0 THEN  #MOD-D30050
                  EXECUTE i301_icd_upd_cho2 USING
         ...
         ON CHANGE idc12_b
            IF NOT cl_null(g_idc2[l_ac2].idc12_b) THEN
               IF g_idc2[l_ac2].idc12_b < 0 THEN
                  CALL cl_err(g_idc2[l_ac2].idc12_b,'aap-022',0)
                  LET g_idc2[l_ac2].idc12_b = g_idc2_t.idc12_b
                  NEXT FIELD idc12_b
               END IF
               #TQC-C60185---begin
               IF l_idc12_t = 0 AND g_idc2[l_ac2].idc12_b <> g_idc2_t.idc12_b THEN
                  SELECT idc08,idc12,idc21 INTO l_idc08,l_idc12,l_idc21
                    FROM idc_file
                   WHERE idc01 = g_sfa03[l_ac0].sfa03
                     AND idc02 = g_idc1[l_ac1].idc02
                  ...
                  IF l_idc21 > 0 THEN 
                     CALL i301_get_idb16(g_sfa03[l_ac0].sfa03,g_idc1[l_ac1].idc02,g_idc1[l_ac1].idc03,g_idc1[l_ac1].idc04,
                                        g_idc2[l_ac2].idc05,g_idc2[l_ac2].idc06) 
                          RETURNING l_idb16 
                     LET g_idc2[l_ac2].idc08_b = (l_idc08-l_idc21) * (g_idc2[l_ac2].idc12_b/(l_idc12 - l_idb16))
                  ELSE 
                     LET g_idc2[l_ac2].idc08_b = l_idc08 * (g_idc2[l_ac2].idc12_b/l_idc12)
                  END IF 
                  LET l_idc08_t = g_idc2[l_ac2].idc08_b
                  DISPLAY BY NAME g_idc2[l_ac2].idc08_b
               END IF 
               LET l_idc12_t = g_idc2[l_ac2].idc12_b
               #TQC-C60185---end
               CALL i301_icd_idc2_tot()
         ...
         ON ACTION all
            FOR l_i = 1 TO g_idc2.getLength()
                LET g_idc2[l_i].cho2 = 'Y'
                CALL i301_icd_get_imaicd(g_sfa03[l_ac0].sfa03) RETURNING l_imaicd04,l_imaicd08,l_imaicd09
                IF l_imaicd08='Y' OR l_imaicd09='Y' THEN   #要做刻號/BIN/Datecode管理,才需維護數量
                   IF l_imaicd04='2' THEN   #CP才要維護參考數量
                      LET g_idc2[l_i].idc08_b = g_idc2[l_i].idc08_2-g_idc2[l_i].idc21_2
                      IF g_idc2[l_i].idc08_b = 1 THEN
                         LET g_idc2[l_i].idc12_b = g_idc2[l_i].idc12_2
                      ELSE
                         LET g_idc2[l_i].idc12_b = 0
                      END IF
                   ELSE
                      LET g_idc2[l_i].idc08_b = g_idc2[l_i].idc08_2-g_idc2[l_i].idc21_2
                   END IF
                END IF
                DISPLAY BY NAME g_idc2[l_i].cho2,g_idc2[l_i].idc08_b,g_idc2[l_i].idc12_b
                EXECUTE i301_icd_upd_cho2 USING
                   g_idc2[l_i].cho2,g_idc2[l_i].idc08_b,g_idc2[l_i].idc12_b,
                   g_sfa03[l_ac0].sfa03,g_idc1[l_ac1].idc02,g_idc1[l_ac1].idc03,g_idc1[l_ac1].idc04,
                   g_idc2[l_i].idc05,g_idc2[l_i].idc06
                IF SQLCA.sqlerrd[3]=0 THEN
                   CALL cl_err('upd cho2_temp','9050',1)
                END IF
            END FOR
         ...
         ON ACTION no_all
            FOR l_i = 1 TO g_idc2.getLength()
                LET g_idc2[l_i].cho2 = 'N'
                LET g_idc2[l_i].idc08_b = 0
                LET g_idc2[l_i].idc12_b = 0
                DISPLAY BY NAME g_idc2[l_i].cho2,g_idc2[l_i].idc08_b,g_idc2[l_i].idc12_b
                EXECUTE i301_icd_upd_cho2 USING
                   g_idc2[l_i].cho2,g_idc2[l_i].idc08_b,g_idc2[l_i].idc12_b,
      ...
      ON ACTION execute   #依照挑選的料/倉/儲/批/刻號/BIN資料產生備料
         #TQC-C60185---begin
         CALL i301_icd_idc2_tot()
         IF g_rec_b2 > 0 THEN  #MOD-D30050
            EXECUTE i301_icd_upd_cho2 USING
         ...
         IF cl_confirm('abx-080') THEN
            CALL i301_icd_execute()
            CALL i301_icd_execute1()
            EXIT DIALOG
         END IF
   ...
   END DIALOG
   CLOSE WINDOW i3017_w

END FUNCTION
#TQC-C60185---begin
FUNCTION i301_get_idb16(p_idb01,p_idb02,p_idb03,p_idb04,p_idb05,p_idb06)
   DEFINE p_idb01      LIKE idb_file.idb01  
   DEFINE p_idb02      LIKE idb_file.idb02
   DEFINE p_idb03      LIKE idb_file.idb03
   DEFINE p_idb04      LIKE idb_file.idb04
   DEFINE p_idb05      LIKE idb_file.idb05
   DEFINE p_idb06      LIKE idb_file.idb06 
   DEFINE l_idb07      LIKE idb_file.idb07  
   DEFINE l_idb16      LIKE idb_file.idb16 
   DEFINE l_idb16_r    LIKE idb_file.idb16  
   DEFINE l_cnt        LIKE type_file.num5  
   DEFINE l_flag       LIKE type_file.chr1 
   DEFINE l_sql        STRING  
   
   LET l_sql = "SELECT idb07,idb16 ",
               " FROM  idb_file",
               " WHERE idb01 = '",p_idb01,"'",
               "   AND idb02 = '",p_idb02,"'",
               "   AND idb03 = '",p_idb03,"'",
               ...
               "   AND idb05 = '",p_idb05,"'",
               "   AND idb06 = '",p_idb06,"'"
   PREPARE i301_pb1 FROM l_sql
   DECLARE i301_bcs1 CURSOR FOR i301_pb1
   LET l_idb16_r = 0
   FOREACH i301_bcs1 INTO l_idb07,l_idb16
      IF SQLCA.sqlcode THEN
      ...
      SELECT 'Y' INTO l_flag FROM oga_file
       WHERE oga09 = '1' AND oga01 = l_idb07
         AND ogaconf <> 'X' 
      IF l_flag = 'Y' THEN 
         SELECT COUNT(*) INTO l_cnt FROM idb_file,oga_file
          WHERE idb07 = oga01 AND oga011 = l_idb07 AND oga09 = '2'
            AND ogaconf <> 'X'  
            AND idb01 = p_idb01
            AND idb02 = p_idb02
            AND idb03 = p_idb03
            ...
            AND idb06 = p_idb06
         IF l_cnt = 0 THEN
            SELECT COUNT(*) INTO l_cnt FROM idd_file,oga_file
             WHERE idd10 = oga01 AND oga011 = l_idb07 AND oga09 = '2'
               AND ogaconf <> 'X'  
               AND idd01 = p_idb01
               AND idd02 = p_idb02
               AND idd03 = p_idb03
      ...
      ELSE 
         ...
         SELECT 'Y' INTO l_flag FROM sfb_file
          WHERE sfb01 = l_idb07
            AND sfb87 <> 'X'  
         IF l_flag = 'Y' THEN 
            SELECT COUNT(*) INTO l_cnt FROM idd_file,sfe_file
             WHERE idd10 = sfe02 AND sfe01 = l_idb07
               ...
               AND idd06 = p_idb06
            IF l_cnt = 0 THEN
               SELECT COUNT(*) INTO l_cnt FROM idb_file,sfs_file,sfp_file #TQC-C60016
      ...
      END IF 
      IF l_cnt = 0 THEN
         LET l_idb16_r = l_idb16_r + l_idb16
      END IF   
   END FOREACH 
   RETURN l_idb16_r
END FUNCTION
#TQC-C60185---end
FUNCTION i301_refresh_idc1(p_idc01)
   DEFINE p_idc01      LIKE idc_file.idc01

   LET g_sql="SELECT cho1,idc02,idc03,idc04,idc07,idc08,0,idc12,0,idc21",
             "  FROM ",g_cr_db_str,l_table1 CLIPPED,
             " WHERE idc01='",p_idc01 CLIPPED,"'",
             " ORDER BY idc02,idc03,idc04"
   PREPARE i301_idc1_p FROM g_sql
   DECLARE i301_idc1_cs CURSOR FOR i301_idc1_p
 
   CALL g_idc1.clear()
   LET g_cnt = 1

   #單身 ARRAY 填充
   FOREACH i301_idc1_cs INTO g_idc1[g_cnt].*
      IF STATUS THEN
      ...
      END IF
   END FOREACH
   CALL g_idc1.deleteElement(g_cnt)
   MESSAGE ""
   CALL ui.Interface.refresh()
   ...
   CALL cl_set_act_visible("accept,cancel", FALSE)
   DISPLAY ARRAY g_idc1 TO s_idc1.* ATTRIBUTE(COUNT=g_rec_b1)
      BEFORE DISPLAY
	 EXIT DISPLAY
   END DISPLAY
...
FUNCTION i301_refresh_idc2(p_idc01,p_idc02,p_idc03,p_idc04)
   DEFINE p_idc01      LIKE idc_file.idc01
   DEFINE p_idc02      LIKE idc_file.idc02
   DEFINE p_idc03      LIKE idc_file.idc03
   DEFINE p_idc04      LIKE idc_file.idc04

   LET g_sql="SELECT cho2,idc05,idc06,idc11,idc07,idc08,0,idc12,0,idc21",
	     "  FROM ",g_cr_db_str,l_table2 CLIPPED,
	     " WHERE idc01='",p_idc01 CLIPPED,"'",
             "   AND idc02='",p_idc02 CLIPPED,"'",
             "   AND idc03='",p_idc03,"'",
             "   AND idc04='",p_idc04 CLIPPED,"'",
             " ORDER BY idc05,idc06,idc11"
   PREPARE i301_idc2_p FROM g_sql
   DECLARE i301_idc2_cs CURSOR FOR i301_idc2_p
 
   CALL g_idc2.clear()
   LET g_cnt = 1

   #單身 ARRAY 填充
   FOREACH i301_idc2_cs INTO g_idc2[g_cnt].*
      IF STATUS THEN
	 CALL cl_err("foreach:",STATUS,1)
	 EXIT FOREACH
      END IF
	 ...
	 EXIT FOREACH
      END IF
   END FOREACH
   CALL g_idc2.deleteElement(g_cnt)
   MESSAGE ""
   CALL ui.Interface.refresh()
   LET g_rec_b2 = g_cnt -1
   DISPLAY g_rec_b2 TO cn4

   CALL cl_set_act_visible("accept,cancel", FALSE)
   DISPLAY ARRAY g_idc2 TO s_idc2.* ATTRIBUTE(COUNT=g_rec_b2)
      BEFORE DISPLAY
	 EXIT DISPLAY
   END DISPLAY
...
FUNCTION i301_icd_cretmp()

   #記錄上階料號
   LET g_sql = "cho0.type_file.chr1,",
	       "sfa03.sfa_file.sfa03,",
	       "ima02.ima_file.ima02,",
	       "ima021.ima_file.ima021"
   LET l_table = cl_prt_temptable('asfi301_cho0',g_sql) CLIPPED
   IF l_table = -1 THEN
      CALL cl_err('Create_cho0_tmp_fail','',0)                                                                                          
      RETURN
   END IF
   DISPLAY "l_table=",l_table

   #記錄倉儲批
   LET g_sql = "cho1.type_file.chr1,",
	       ...
	       "idc08_a.idc_file.idc08,",
	       "idc12.idc_file.idc12,",
	       "idc12_a.idc_file.idc12,",
	       "idc21.idc_file.idc21"
   LET l_table1 = cl_prt_temptable('asfi301_cho1',g_sql) CLIPPED
   IF l_table1 = -1 THEN
      CALL cl_err('Create_cho1_tmp_fail','',0)                                                                                          
      RETURN
   END IF
   DISPLAY "l_table1=",l_table1

   #記錄刻號/BIN
   LET g_sql = "cho2.type_file.chr1,",
	       "idc01.idc_file.idc01,",
	       "idc02.idc_file.idc02,",
	       "idc03.idc_file.idc03,",
	       "idc04.idc_file.idc04,",
	       ...
	       "idc11.idc_file.idc11,",
	       "idc07.idc_file.idc07,",
	       "idc08.idc_file.idc08,",
	       "idc08_b.idc_file.idc08,",
	       "idc12.idc_file.idc12,",
	       "idc12_b.idc_file.idc12,",
	       "idc21.idc_file.idc21"
   LET l_table2 = cl_prt_temptable('asfi301_cho2',g_sql) CLIPPED
   IF l_table2 = -1 THEN
      CALL cl_err('Create_cho2_tmp_fail','',0)                                                                                          
      RETURN
   END IF
...
FUNCTION i301_icd_get_icm01(p_icm02)
   ...
   LET g_sql = "INSERT INTO ",g_cr_db_str,l_table CLIPPED," (cho0,sfa03,ima02,ima021) ",
	       "VALUES (?,?,?,?)"
   ...
   #由下階料號往上抓取所有上階料
   #例:FT的上階料包含Wafer、CP、DS、AS
   #LET g_sql="SELECT 'N',a.icm01,ima02,ima021", #MOD-D30198
   LET g_sql="SELECT DISTINCT 'N',a.icm01,ima02,ima021",  #MOD-D30198
	     #"  FROM (SELECT icm01 FROM icm_file",  #CHI-D40002
         "  FROM (SELECT icm01,icmacti FROM icm_file",  #CHI-D40002
         
	     "         START WITH icm02='",p_icm02 CLIPPED,"'",
	     "       CONNECT BY icm02=prior icm01) a,ima_file",
	     " WHERE a.icm01=ima01",
         "   AND a.icmacti <> 'N' "  #CHI-D40002
   DECLARE icm01_c CURSOR FROM g_sql
   FOREACH icm01_c INTO sr.*
      EXECUTE insert_prep USING sr.*
      IF SQLCA.sqlcode OR SQLCA.sqlerrd[3] = 0 THEN
	 CALL cl_err('insert cho0_tmp fail:',SQLCA.sqlcode,1)
	 RETURN
      END IF
   END FOREACH
...
FUNCTION i301_icd_get_idc()
   ...
   LET g_sql = "INSERT INTO ",g_cr_db_str,l_table1 CLIPPED,
	       " (cho1,idc01,idc02,idc03,idc04,idc07,idc08,idc08_a,idc12,idc12_a,idc21) ",
	       "VALUES (?,?,?,?,?, ?,?,?,?,?, ?)"
   ...
   LET g_sql = "INSERT INTO ",g_cr_db_str,l_table2 CLIPPED,
	       " (cho2,idc01,idc02,idc03,idc04,idc05,idc06,idc11,idc07,idc08,idc08_b,idc12,idc12_b,idc21) ",
	       "VALUES (?,?,?,?,?, ?,?,?,?,?, ?,?,?,?)"
   ...
   #抓取上階料的倉儲批
   LET g_sql="SELECT 'N',idc01,idc02,idc03,idc04,idc07,SUM(idc08),0,SUM(idc12),0,SUM(idc21)",
	     "  FROM idc_file",
	     " WHERE EXISTS (SELECT * FROM ",g_cr_db_str,l_table CLIPPED," WHERE sfa03=idc01)",
	     "   AND idc08-idc21>0",   #有庫存可挑的
	     "   AND idc17 != 'Y'",    #庫存狀態沒有被HOLD才可挑
             " GROUP BY idc01,idc02,idc03,idc04,idc07"
   DECLARE idc1_c CURSOR FROM g_sql
   FOREACH idc1_c INTO sr1.*
      EXECUTE insert_prep1 USING sr1.*
      IF SQLCA.sqlcode OR SQLCA.sqlerrd[3] = 0 THEN
	 CALL cl_err('insert cho1_tmp fail:',SQLCA.sqlcode,1)
	 RETURN
      END IF
   END FOREACH

   #抓取上階料的刻號/BIN/Datecode
   LET g_sql="SELECT 'N',idc01,idc02,idc03,idc04,idc05,idc06,idc11,idc07,idc08,0,idc12,0,idc21",
	     "  FROM idc_file,imaicd_file",
	     " WHERE idc01=imaicd00 AND (imaicd08='Y' OR imaicd09='Y')",
             "   AND EXISTS (SELECT * FROM ",g_cr_db_str,l_table CLIPPED," WHERE sfa03=idc01)",
	     "   AND idc08-idc21>0",   #有庫存可挑的
	     "   AND idc17 != 'Y'"     #庫存狀態沒有被HOLD才可挑
   DECLARE idc2_c CURSOR FROM g_sql
   FOREACH idc2_c INTO sr2.*
...
#倉儲批庫存明細資料選取數量總計
FUNCTION i301_icd_idc1_tot()
   DEFINE l_i     LIKE type_file.num5

   LET g_idc08_a = 0
   LET g_idc12_a = 0
   FOR l_i = 1 TO g_rec_b1
      IF g_idc1[l_i].cho1 = "Y" THEN
         IF NOT cl_null(g_idc1[l_i].idc08_a) THEN
            LET g_idc08_a = g_idc08_a + g_idc1[l_i].idc08_a
         END IF
         IF NOT cl_null(g_idc1[l_i].idc12_a) THEN
            LET g_idc12_a = g_idc12_a + g_idc1[l_i].idc12_a
         END IF
      END IF
   END FOR
   DISPLAY g_idc08_a TO FORMONLY.idc08_a_t
   DISPLAY g_idc12_a TO FORMONLY.idc12_a_t

END FUNCTION

#刻號BIN庫存明細資料選取數量總計
FUNCTION i301_icd_idc2_tot()
   DEFINE l_i     LIKE type_file.num5

   LET g_idc08_b = 0
   LET g_idc12_b = 0
   FOR l_i = 1 TO g_rec_b2
      IF g_idc2[l_i].cho2 = "Y" THEN
         IF NOT cl_null(g_idc2[l_i].idc08_b) THEN
            LET g_idc08_b = g_idc08_b + g_idc2[l_i].idc08_b
         END IF
         IF NOT cl_null(g_idc2[l_i].idc12_b) THEN
            LET g_idc12_b = g_idc12_b + g_idc2[l_i].idc12_b
         END IF
      END IF
   END FOR
   LET g_idc1[l_ac1].idc08_a = g_idc08_b
   LET g_idc1[l_ac1].idc12_a = g_idc12_b
   EXECUTE i301_icd_upd_cho1 USING
      g_idc1[l_ac1].cho1,g_idc1[l_ac1].idc08_a,g_idc1[l_ac1].idc12_a,
      g_sfa03[l_ac0].sfa03,g_idc1[l_ac1].idc02,g_idc1[l_ac1].idc03,g_idc1[l_ac1].idc04
   IF SQLCA.sqlerrd[3]=0 THEN
      CALL cl_err('upd cho1_temp','9050',1)
   END IF
   DISPLAY g_idc08_b TO FORMONLY.idc08_b_t
   DISPLAY g_idc12_b TO FORMONLY.idc12_b_t

   CALL i301_icd_idc1_tot()

END FUNCTION

FUNCTION i301_icd_get_imaicd(p_imaicd00)
   DEFINE p_imaicd00       LIKE imaicd_file.imaicd00
   DEFINE l_imaicd04       LIKE imaicd_file.imaicd04
   DEFINE l_imaicd08       LIKE imaicd_file.imaicd08
   DEFINE l_imaicd09       LIKE imaicd_file.imaicd09
 
   SELECT imaicd04,imaicd08,imaicd09
     INTO l_imaicd04,l_imaicd08,l_imaicd09 
     FROM imaicd_file
    WHERE imaicd00=p_imaicd00

   RETURN l_imaicd04,l_imaicd08,l_imaicd09
END FUNCTION

FUNCTION i301_icd_execute()
DEFINE l_sfa      RECORD LIKE sfa_file.*
...
DEFINE sr2        RECORD
   ...
   LET g_sql = "SELECT COUNT(*) FROM ",g_cr_db_str,l_table1 CLIPPED,
               " WHERE cho1='Y' AND idc08_a>0 AND idc01=?"
   PREPARE i301_idc1_cnt_p FROM g_sql
   DECLARE i301_idc1_cnt_c CURSOR FOR i301_idc1_cnt_p

   #產生sfa_file與sfaa_file
   LET g_sql="SELECT * FROM ",g_cr_db_str,l_table CLIPPED,
             " WHERE cho0='Y' ORDER BY sfa03"
   DECLARE i301_icd_sfa03_c1 CURSOR FROM g_sql
   FOREACH i301_icd_sfa03_c1 INTO sr0.*

      LET g_sql="SELECT * FROM ",g_cr_db_str,l_table1 CLIPPED,
                " WHERE cho1='Y' AND idc08_a>0",
                "   AND idc01='",sr0.sfa03 CLIPPED,"'",
                " ORDER BY idc01,idc02,idc03,idc04"
      DECLARE i301_icd_idc1_c1 CURSOR FROM g_sql
      LET l_m = 1
      FOREACH i301_icd_idc1_c1 INTO sr1.*
         IF l_m = 1 THEN   #料件的第一筆倉儲批,要寫入sfa_file,第二筆以後只寫sfaa_file
            INITIALIZE l_sfa.* TO NULL
            LET l_sfa.sfa01 =g_sfb.sfb01
            LET l_sfa.sfa02 =g_sfb.sfb02
            LET l_sfa.sfa03 =sr1.idc01
            LET l_sfa.sfa04 =sr1.idc08_a
            LET l_sfa.sfa05 =sr1.idc08_a
            LET l_sfa.sfa06 =0
            LET l_sfa.sfa061=0
            LET l_sfa.sfa062=0
            LET l_sfa.sfa063=0
            ...
            LET l_sfa.sfa09 =0
            LET l_sfa.sfa11 ='N'
            LET l_sfa.sfa12 =sr1.idc07_1
            LET l_sfa.sfa13 =1
            LET l_sfa.sfa14 =sr1.idc07_1
            LET l_sfa.sfa15 =1
            LET l_sfa.sfa16 =''
            SELECT bmb06/bmb07 INTO l_sfa.sfa16 FROM bmb_file WHERE bmb01=g_sfb.sfb05 AND bmb03=sr1.idc01
            IF cl_null(l_sfa.sfa16) THEN LET l_sfa.sfa16=1 END IF
            LET l_sfa.sfa25 =0
            LET l_sfa.sfa26 ='0'
            LET l_sfa.sfa27 =sr1.idc01
            LET l_sfa.sfa28 =1
            LET l_sfa.sfa29 =g_sfb.sfb05
            LET l_n = 0
            OPEN i301_idc1_cnt_c USING sr0.sfa03
            FETCH i301_idc1_cnt_c INTO l_n
            IF l_n = 1 THEN
               LET l_sfa.sfa30 =sr1.idc02
               LET l_sfa.sfa31 =sr1.idc03
            ELSE
               LET l_sfa.sfa30 =''
               LET l_sfa.sfa31 =''
            END IF
            ...
            INSERT INTO sfa_file VALUES(l_sfa.*)
            IF SQLCA.SQLCODE THEN
               CALL cl_err3("ins","sfa_file","","",STATUS,"","",1)
               LET g_success='N'
               EXIT FOREACH
            ELSE
               LET l_m = l_m + 1
               ...
               LET l_sfai.sfai012= l_sfa.sfa012
               LET l_sfai.sfai013= l_sfa.sfa013
               LET l_sfai.sfaiicd01=sr1.idc12_a
               SELECT ima907 INTO l_sfai.sfaiicd02 FROM ima_file WHERE ima01=sr1.idc01
               LET l_sfai.sfaiicd04=0
               LET l_sfai.sfaiicd05=0
               IF l_n = 1 THEN
                  LET l_sfai.sfaiicd03=sr1.idc04
                  LET l_sfai.sfaiicd06 = 'N'
               ELSE
                  LET l_sfai.sfaiicd03=''
                  LET l_sfai.sfaiicd06 = 'Y'
               END IF
               IF s_ins_sfai(l_sfai.*,'') THEN
                  LET l_sfaa.sfaa01   =g_sfb.sfb01
                  LET l_sfaa.sfaa03   =sr1.idc01
                  LET l_sfaa.sfaa08   =' '
                  LET l_sfaa.sfaa12   =sr1.idc07_1
                  LET l_sfaa.sfaa27   =sr1.idc01
                  LET l_sfaa.sfaa30   =sr1.idc02
                  LET l_sfaa.sfaa31   =sr1.idc03
                  LET l_sfaa.sfaa32   =sr1.idc04
                  LET l_sfaa.sfaa05   =sr1.idc08_a
                  LET l_sfaa.sfaa051  =sr1.idc12_a
                  LET l_sfaa.sfaaplant=g_plant
                  LET l_sfaa.sfaalegal=g_legal
                  LET l_sfaa.sfaa012  =' '
                  LET l_sfaa.sfaa013  =0
                  INSERT INTO sfaa_file VALUES(l_sfaa.*)
                  IF SQLCA.sqlcode THEN
               ...
               END IF
            END IF
         ELSE   #料件的第二筆以後只寫sfaa_file
            UPDATE sfa_file SET sfa05=sfa05+sr1.idc08_a
             WHERE sfa01 = l_sfa.sfa01 AND sfa03 = l_sfa.sfa03
               AND sfa08 = l_sfa.sfa08 AND sfa12 = l_sfa.sfa12
               AND sfa27 = l_sfa.sfa27 AND sfa012= l_sfa.sfa012
               AND sfa013= l_sfa.sfa013
            UPDATE sfai_file SET sfaiicd01=sfaiicd01+sr1.idc12_a
             WHERE sfai01 = l_sfa.sfa01 AND sfai03 = l_sfa.sfa03
               AND sfai08 = l_sfa.sfa08 AND sfai12 = l_sfa.sfa12
               AND sfai27 = l_sfa.sfa27 AND sfai012= l_sfa.sfa012
               AND sfai013= l_sfa.sfa013
      ...
      CALL i301_icd_get_imaicd(sr0.sfa03) RETURNING l_imaicd04,l_imaicd08,l_imaicd09
      IF l_imaicd08='Y' OR l_imaicd09='Y' THEN   #要做刻號/BIN/Datecode管理,才需維護數量
         #產生idb_file
         LET g_cnt = 0
         LET g_sql="SELECT a.*,b.idc09,b.idc10,b.idc12,b.idc13,b.idc14,b.idc15,b.idc16,b.idc19,b.idc20",
                   "  FROM ",g_cr_db_str,l_table2 CLIPPED," a,idc_file b",
                   " WHERE a.idc01=b.idc01 AND a.idc02=b.idc02 AND a.idc03=b.idc03 AND a.idc04=b.idc04",
                   "   AND a.idc05=b.idc05 AND a.idc06=b.idc06",
                   "   AND a.cho2='Y' AND a.idc08_b>0 AND a.idc01='",sr0.sfa03 CLIPPED,"'",
                   " ORDER BY a.idc01,a.idc02,a.idc03,a.idc04,a.idc05,a.idc06,a.idc11"
         DECLARE i301_icd_idc2_c1 CURSOR FROM g_sql
         FOREACH i301_icd_idc2_c1 INTO sr2.*
            INITIALIZE l_idb.* TO NULL
            LET l_idb.idb01 = sr2.idc01
            LET l_idb.idb02 = sr2.idc02
            LET l_idb.idb03 = sr2.idc03
            LET l_idb.idb04 = sr2.idc04
            LET l_idb.idb05 = sr2.idc05
            LET l_idb.idb06 = sr2.idc06
            LET l_idb.idb07 = g_sfb.sfb01
            LET l_idb.idb08 = 1
            LET l_idb.idb09 = g_sfb.sfb81
            LET l_idb.idb10 = sr2.idc08_2
            LET l_idb.idb11 = sr2.idc08_b
            LET l_idb.idb12 = sr2.idc07_2
            LET l_idb.idb10 = s_digqty(l_idb.idb10,l_idb.idb12)
            LET l_idb.idb11 = s_digqty(l_idb.idb11,l_idb.idb12)
            LET l_idb.idb13 = sr2.idc09
            LET l_idb.idb14 = sr2.idc10
            LET l_idb.idb15 = sr2.idc11
            #LET l_idb.idb16 = sr2.idc12 * (sr2.idc08_b/sr2.idc08_2)  #TQC-C60185
            LET l_idb.idb16 = sr2.idc12_b   #TQC-C60185
            LET l_idb.idb16 = cl_digcut(l_idb.idb16,0)
            LET l_idb.idb17 = sr2.idc13
            LET l_idb.idb18 = sr2.idc14
            LET l_idb.idb19 = sr2.idc15
            LET l_idb.idb20 = sr2.idc16
            LET l_idb.idb21 = sr2.idc19
            LET l_idb.idb25 = sr2.idc20
            LET l_idb.idbplant = g_plant
            LET l_idb.idblegal = g_legal
            IF l_idb.idb16 IS NULL THEN LET l_idb.idb16=0 END IF
            INSERT INTO idb_file VALUES(l_idb.*)
            IF cl_sql_dup_value(SQLCA.sqlcode) THEN
               UPDATE idb_file SET idb11 = idb11 + l_idb.idb11,
                                   idb16 = idb16 + l_idb.idb16
                WHERE idb01 = sr2.idc01   AND idb02 = sr2.idc02
                  AND idb03 = sr2.idc03   AND idb04 = sr2.idc04
                  AND idb05 = sr2.idc05   AND idb06 = sr2.idc06
                  AND idb07 = g_sfb.sfb01 AND idb08 = 1
               IF SQLCA.sqlcode OR SQLCA.sqlerrd[3] = 0  THEN
            ...
            ELSE
               ...
               END IF
            END IF
            #將刻號BIN庫存明細資料的庫存量指定給出庫資料後,同步更新庫存明細的已置備量(idc21),
            #避免在未過帳前數量同時被2筆以上的出庫指定走
            UPDATE idc_file
               SET idc21 = idc21 + l_idb.idb11
             WHERE idc01 = sr2.idc01 AND idc02 = sr2.idc02
               AND idc03 = sr2.idc03 AND idc04 = sr2.idc04
               AND idc05 = sr2.idc05 AND idc06 = sr2.idc06
            IF SQLCA.sqlcode OR SQLCA.sqlerrd[3] = 0  THEN
...
FUNCTION i301_icd_execute1()
   ...
   DEFINE l_flag        LIKE type_file.chr1
   DEFINE l_sfaa        RECORD LIKE sfaa_file.*
   DEFINE l_dies        LIKE idb_file.idb16
   DEFINE l_dies_sum    LIKE idb_file.idb16
   DEFINE l_idb11       LIKE idb_file.idb11
   DEFINE l_idb11_sum   LIKE idb_file.idb11
   ...
   IF l_cnt = 1 THEN
      ...
      #發Wafer或CP來生產 DS、AS、FT時,發料單位為PCS,生產單位為EA,單位不同所以要將DIES數回寫到工單單頭的生產數量
      #發DS來生產AS、FT時,發料單位為EA,生產單位為EA,將發料數量回寫工單單頭的生產數量
      SELECT imaicd04,imaicd14,imaicd08,ima906 INTO l_imaicd04,l_imaicd14,l_imaicd08,l_ima906 
        FROM imaicd_file,ima_file
       WHERE imaicd00 = ima01
         AND imaicd00 = (SELECT sfa03 FROM sfa_file WHERE sfa01=g_sfb.sfb01)
      IF cl_null(l_imaicd14) OR l_imaicd14=0 THEN LET l_imaicd14=1 END IF
      SELECT imaicd04 INTO l_imaicd04_h FROM imaicd_file
       WHERE imaicd00 = g_sfb.sfb05
      LET l_flag = '0'
      ...
      END IF
      #TQC-C60185---end
      IF l_flag = '1' OR l_flag = '2' OR l_flag = '3' THEN #TQC-C60185
         IF cl_confirm("aic-221") THEN
            DECLARE i301_sfaa_dies_1 CURSOR FOR
               SELECT * FROM sfaa_file WHERE sfaa01 = g_sfb.sfb01
            INITIALIZE l_sfaa.* TO NULL
            LET l_dies_sum = 0
            LET l_idb11_sum = 0
            FOREACH i301_sfaa_dies_1 INTO l_sfaa.*
               IF STATUS THEN
                  CALL cl_err('FOREACH:',STATUS,0) EXIT FOREACH
               END IF
               LET l_dies = 0   LET l_idb11 = 0
               ...
               SELECT SUM(idb16),SUM(idb11) INTO l_dies,l_idb11 FROM idb_file
                 WHERE idb01 = l_sfaa.sfaa03 AND idb02 = l_sfaa.sfaa30
                   ...
                   AND idb07 = g_sfb.sfb01 AND idb08 = 1
                   AND idb16 IS NOT NULL
               #不做刻號/BIN管理,idb_file會抓不到數量,改用sfaa05->idb11,sfaa051->dies
               IF l_imaicd08='N' THEN
                  LET l_idb11=l_sfaa.sfaa05
                  LET l_dies =l_sfaa.sfaa051
               END IF
               IF cl_null(l_idb11) THEN LET l_idb11=0 END IF
               LET l_idb11_sum = l_idb11_sum + l_idb11
               IF cl_null(l_dies) THEN LET l_dies=0 END IF
            ...
            IF cl_null(l_idb11_sum) THEN LET l_idb11_sum=0 END IF
            IF l_flag = '1' THEN
               IF l_ima906='1' THEN   #單一單位,idc_file裡不會有參考數量,要用片數*Gross Die來算出參考數量
                  LET l_dies_sum=l_idb11_sum*l_imaicd14
               END IF
               UPDATE sfb_file SET sfb08=l_dies_sum,sfb23='Y' WHERE sfb01=g_sfb.sfb01
               UPDATE sfbi_file SET sfbiicd06=l_idb11_sum WHERE sfbi01=g_sfb.sfb01
               UPDATE sfa_file SET sfa161=sfa05/l_dies_sum WHERE sfa01=g_sfb.sfb01
            #ELSE                #TQC-C60185
            END IF               #TQC-C60185
            IF l_flag = '2' THEN #TQC-C60185
               UPDATE sfb_file SET sfb08=l_idb11_sum,sfb23='Y' WHERE sfb01=g_sfb.sfb01
               UPDATE sfbi_file SET sfbiicd06=l_idb11_sum WHERE sfbi01=g_sfb.sfb01
               UPDATE sfa_file SET sfa161=sfa05/l_idb11_sum WHERE sfa01=g_sfb.sfb01
            END IF
            #TQC-C60185---begin
            IF l_flag = '3' THEN
               LET l_dies_sum=l_idb11_sum*l_imaicd14
               UPDATE sfb_file SET sfb08=l_idb11_sum,sfb23='Y' WHERE sfb01=g_sfb.sfb01
               UPDATE sfbi_file SET sfbiicd06=l_dies_sum WHERE sfbi01=g_sfb.sfb01
               UPDATE sfa_file SET sfa161=sfa05/l_idb11_sum WHERE sfa01=g_sfb.sfb01
            END IF
            #TQC-C60185---end
         END IF
