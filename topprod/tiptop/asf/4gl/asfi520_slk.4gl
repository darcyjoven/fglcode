...
#   DEFINE p_argv2 VARCHAR(1)
    ...
    #No.FUN-810016---Begin
    CASE WHEN p_argv2='6' LET g_prog='asfi526'
         WHEN p_argv2='7' LET g_prog='asfi527_slk'
         WHEN p_argv2='8' LET g_prog='asfi528_slk'
         WHEN p_argv2='9' LET g_prog='asfi529_slk'
         OTHERWISE        LET g_prog='asfi520_slk'
