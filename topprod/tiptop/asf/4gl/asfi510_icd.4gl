...
#   DEFINE p_argv2 VARCHAR(1)
   ...
   LET p_argv4=ARG_VAL(3)                  #No.FUN-660166
    ...
    #FUN-810038................begin
    CASE WHEN p_argv2='1' LET g_prog='asfi511_icd'
         WHEN p_argv2='2' LET g_prog='asfi512_icd'
         WHEN p_argv2='3' LET g_prog='asfi513_icd'
         WHEN p_argv2='4' LET g_prog='asfi514_icd'
         WHEN p_argv2='D' LET g_prog='asfi519_icd'   #FUN-C70014 add
         OTHERWISE        LET g_prog='asfi510_icd'
