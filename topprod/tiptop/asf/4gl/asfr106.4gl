...
#              "sfa06.sfa_file.sfa06,",
   ...
   LET l_table = cl_prt_temptable('asfr106',g_sql) CLIPPED
   ...
   WHILE TRUE
     ...
     IF g_bgjob = 'Y' THEN
        ...
        ELSE
           ...
           CALL cl_cmdat('asfr106',g_time,l_cmd)
        END IF
        CLOSE WINDOW r106_w
        CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690123
        EXIT PROGRAM
...
#    CALL cl_outnam('asfr106') RETURNING l_name
#    START REPORT r106_rep TO l_name
...
#         OUTPUT TO REPORT r106_rep(sr.*)                          #mark
    ...
    #CALL cl_prt_cs3('asfr106','asfr106',l_sql,g_str)     #FUN-A60027
    #FUN-A60027 -----------------start-------------------
    IF g_sma.sma541 = 'Y' THEN
      CALL cl_prt_cs3('asfr106','asfr106_1',l_sql,g_str)
    ELSE
      CALL cl_prt_cs3('asfr106','asfr106',l_sql,g_str)
    END IF 
    #FUN-A60027 ----------------end---------------------- 
 
#    FINISH REPORT r106_rep
