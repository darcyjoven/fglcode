...
# Modify.........: No.FUN-810016 08/03/04 By hongmei asfi510.4gl->asfi510.src.4gl
...
#   CASE WHEN p_argv2='1' LET g_prog='asfi511'
    CASE WHEN p_argv2='1' LET g_prog='asfi511_slk'     #No.FUN-870117
         WHEN p_argv2='2' LET g_prog='asfi512_slk'
         WHEN p_argv2='3' LET g_prog='asfi513_slk'
         WHEN p_argv2='4' LET g_prog='asfi514_slk'
         WHEN p_argv2='D' LET g_prog='asfi519_slk'   #FUN-C70014 add
#        OTHERWISE        LET g_prog='asfi510'
         OTHERWISE        LET g_prog='asfi510_slk'     #No.FUN-870117
                          LET p_argv4=p_argv3    #No.FUN-660166 因為asfi510進來沒有第一參數
   ...
   CALL i501('1', p_argv2,p_argv3,p_argv4)          #No.FUN-660166
