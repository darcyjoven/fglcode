...
# Modify.........: No.MOD-530635 05/03/31 By pengu 將原本cl_outnam()所傳參數g_prog，改成asfr623
...
# Modify.........: No.MOD-CC0112 12/12/26 By Elise 執行asfr624時，程式名稱應顯示asfr624
...
#             wc      VARCHAR(800),       # Where condition  #TQC-630166
              ...
              u       LIKE type_file.chr3,            #No.FUN-680121 VARCHAR(03)
              more    LIKE type_file.chr1             #No.FUN-680121 VARCHAR(01)# Input more condition(Y/N)
              END RECORD,
          ...
          g_prog_o       LIKE type_file.chr10    #MOD-CC0112 add
...
MAIN
   ...
   LET g_prog_o = g_sfu00   #MOD-CC0112 add
...
#NO.FUN-850139--START---
   ...
   LET l_table = cl_prt_temptable('asfr623',g_sql) CLIPPED
...
#NO.FUN-850139--end----
   ...
   IF cl_null(g_bgjob) OR g_bgjob = 'N'   # If background job sw is off
      THEN CALL r623_tm(0,0)        # Input print condition
      ELSE CALL r623()              # Read data and create out-file
   END IF
   CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690123
END MAIN
 
FUNCTION r623_tm(p_row,p_col)
DEFINE lc_qbe_sn      LIKE gbm_file.gbm01   #No.FUN-580031
   ...
   OPEN WINDOW r623_w AT p_row,p_col WITH FORM "asf/42f/asfr623"
   ATTRIBUTE (STYLE = g_win_style CLIPPED)
 
   # 2004/06/02 共用程式時呼叫
   CALL cl_set_locale_frm_name("asfr623")
   CALL cl_ui_init()
...
END CONSTRUCT
   ...
   IF INT_FLAG THEN
      LET INT_FLAG = 0 CLOSE WINDOW r623_w 
      CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690123
      EXIT PROGRAM
   ...
   IF g_bgjob = 'Y' THEN
      ...
      #WHERE zz01='asfr623' #MOD-4B0092     #No.MOD-7B0053 mark
         WHERE zz01=g_prog    #MOD-4B0092   #No.MOD-7B0053 add
      IF SQLCA.sqlcode OR l_cmd IS NULL THEN
         CALL cl_err('asfr623','9031',1)
      ELSE
         ...
         CALL cl_cmdat('asfr623',g_time,l_cmd)    # Execute cmd at later time
      END IF
      CLOSE WINDOW r623_w
      CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690123
      EXIT PROGRAM
...
#NO.FUN-850139----start---
   ...
   DEFINE l_gem02       LIKE gem_file.gem02
    ...
    SELECT zz05 INTO g_zz05 FROM zz_file WHERE zz01 = 'asfr623'
#NO.FUN-850139----end----   
    ...
    LET l_sql = "SELECT '','','',",
     ...
     PREPARE r623_prepare1 FROM l_sql
     IF SQLCA.sqlcode != 0 THEN
        CALL cl_err('prepare:',SQLCA.sqlcode,1)
        CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690123
        EXIT PROGRAM
     END IF
     DECLARE r623_curs1 CURSOR FOR r623_prepare1
      #-----No.MOD-530635-------------------------------------
      #----FUN-550012
       ...
       LET g_prog = 'asfr623'
      #----FUN-550012
#        CALL cl_outnam('asfr623') RETURNING l_name #MOD-4B0092  #NO.FUN-850139
...
#     START REPORT r623_rep TO l_name                       #NO.FUN-850139
#     LET g_pageno = 0                                      #NO.FUN-850139
     FOREACH r623_curs1 INTO sr.*
          IF SQLCA.sqlcode != 0 THEN
...
#NO.FUN-850139---START---
      ...
      EXECUTE insert_prep USING
        ...
        sr.sfv33,sr.sfv35,sr.sfv30,sr.sfv32,sr.sfv13,sr.sfv12,sr.sfv05,
        sr.sfv06,sr.sfv07,l_gem02,l_str,l_str2
#NO.FUN-850139---END---
     END FOREACH
 
#     FINISH REPORT r623_rep                                #NO.FUN-850139
...
#NO.FUN-850139----start----
     ...
     LET g_str = tm.wc,";",tm.t[1,1],";",tm.t[2,2],";",tm.t[3,3],";",
                 ...
                 tm.s[2,2],";",tm.s[3,3],";",g_sma115,";",g_prog_o   #MOD-CC0112 add g_prog_o
     CALL cl_prt_cs3('asfr623','asfr623',g_sql,g_str) 
#NO.FUN-850139--end---
