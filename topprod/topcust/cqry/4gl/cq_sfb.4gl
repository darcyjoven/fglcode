...
FUNCTION cq_sfb(pi_multi_sel,pi_need_cons,p_where,ps_default1,ps_default2,p_qcf01,p_qcf04)
...
FUNCTION cq_sfb_qry_prep_result_set()
   ...
   FOREACH lcurs_qry INTO lr_qry.*
      ...
      END IF
      LET l_cnt = 0
      SELECT COUNT (*) INTO l_cnt FROM sfa_file WHERE sfa01 = lr_qry.sfb01 AND sfa08 = g_where AND sfa11 = 'E'
