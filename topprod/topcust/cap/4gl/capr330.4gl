...
#       l_time          LIKE type_file.chr8        #No.FUN-6A0094
   ...
   DEFINE l_sum          LIKE apf_file.apf08f  #add by dengsy170607
...
LET l_sql="select apf01,apf05,'',apf02,apf03,'','','','',apf06,'',apf08f,'','','','',''",
    ...
    LET l_sql1 = "SELECT  to_char(wmsys.wm_concat(apc12))   FROM  apg_file,apc_file WHERE  apg01 = '",sr.apf01,"' AND  apc01 = apg04"
         PREPARE r330_1 FROM l_sql1
         EXECUTE r330_1 INTO sr.apc12
       #str-----add by guanyao160912
       #SELECT  apc04  INTO sr.apc04 FROM  apg_file,apc_file WHERE  apg01 = sr.apf01 AND  apc01 = apg04
       SELECT apa02 INTO sr.apc04 FROM apg_file,apa_file WHERE apa01 = apg04 AND apg01 = sr.apf01 ORDER BY apg02 
     
       #end-----add by guanyao160912
      # SELECT pma02 INTO sr.pma02 FROM pmc_file,pma_file WHERE pmc01 = sr.apf03 AND pmc17 = pma01 #mark by liyjf161109
       SELECT apa11 INTO sr.pma02 FROM apg_file,apa_file WHERE apa01 = apg04 AND apg01 = sr.apf01 ORDER BY apg02  #add by liyjf161109
       #str----- add by dengsy170607
       LET l_sum=0
       SELECT nvl(sum(aph05f),0) INTO l_sum FROM aph_file
       WHERE aph01=sr.apf01 AND aph03='6'
       LET sr.apf08f=sr.apf08f-l_sum
       #end----- add by dengsy170607
