...
#      LET g_detail_sum.cch92d = g_detail_sum.cch92d + g_detail[g_cnt].cch92d
      ...
      LET m_cnt = m_cnt + 1
 END FOREACH
    #LET g_detail_sum.sfb05 = '合计:'        #No:181231 mark
    #LET g_detail[m_cnt].* = g_detail_sum.*  #No:181231 mark
    #CALL g_detail.deleteElement(m_cnt)    #TQC-6B0162 add
    LET g_rec_b = m_cnt - 1
    DISPLAY g_rec_b TO FORMONLY.cn2
    #No:181231 add begin-----
     LET l_sql = " SELECT SUM(cch12d),SUM(cch22d), ",
                " SUM(ccg31),SUM(cch32d),SUM(cch92d) ",
                " FROM cxcq908_file WHERE ",tm.wc,
                " AND cch02='",g_yy,"' AND cch03='",g_mm,"'"
    PREPARE q907_pb1 FROM l_sql
    EXECUTE q907_pb1 INTO g_detail_sum.cch12d,g_detail_sum.cch22d,g_detail_sum.ccg31,g_detail_sum.cch32d,g_detail_sum.cch92d

    DISPLAY g_detail_sum.cch12d TO FORMONLY.cch12d_sum 
    DISPLAY g_detail_sum.cch22d TO FORMONLY.cch22d_sum 
    DISPLAY g_detail_sum.ccg31 TO FORMONLY.ccg31_sum 
    DISPLAY g_detail_sum.cch32d TO FORMONLY.cch32d_sum 
    DISPLAY g_detail_sum.cch92d TO FORMONLY.cch92d_sum 
    #No:181231 add end-------
END FUNCTION
