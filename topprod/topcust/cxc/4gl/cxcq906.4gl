...
#                 wc2    LIKE type_file.chr1000		# Body Where condition  #No.FUN-690026 VARCHAR(500)         #TQC-CC0058 mark
    ...
    g_detail    DYNAMIC ARRAY OF     RECORD
                  ...
                  ta_ccc11     LIKE ccc_file.ccc11,
                  ta_ccc12     LIKE ccc_file.ccc12,
                  ta_ccc12a    LIKE ccc_file.ccc12,
                  ta_ccc12b    LIKE ccc_file.ccc12,
                  ta_ccc12c    LIKE ccc_file.ccc12,
                  ta_ccc12d    LIKE ccc_file.ccc12,
                  bqrsl        LIKE ccc_file.ccc12,
                  bqrje        LIKE ccc_file.ccc12,
                  bqrcl        LIKE ccc_file.ccc12,
                  bqrrg        LIKE ccc_file.ccc12,
                  bqrzf        LIKE ccc_file.ccc12,
                  bqrjg        LIKE ccc_file.ccc12,
                  scly         LIKE ccc_file.ccc12,
                  sclyh        LIKE ccc_file.ccc12,
                  sclyc        LIKE ccc_file.ccc12,
                  sclyr        LIKE ccc_file.ccc12,
                  sclyz        LIKE ccc_file.ccc12,
                  sclyj        LIKE ccc_file.ccc12,
                  jcsl         LIKE ccc_file.ccc12,
                  jcje         LIKE ccc_file.ccc12,
                  bqccl        LIKE ccc_file.ccc12,
                  bqcrg        LIKE ccc_file.ccc12,
                  bqczf        LIKE ccc_file.ccc12,
                  bqcjg        LIKE ccc_file.ccc12,
                  ta_ccc27     LIKE ccc_file.ccc12,
                  fgrje        LIKE ccc_file.ccc12,
                  fgrc         LIKE ccc_file.ccc12,
                  fgrr         LIKE ccc_file.ccc12,
                  fgrz         LIKE ccc_file.ccc12,
                  fgrj         LIKE ccc_file.ccc12,
                  ta_ccc25     LIKE ccc_file.ccc12,
                  fglje        LIKE ccc_file.ccc12,
                  fglc         LIKE ccc_file.ccc12,
                  fglr         LIKE ccc_file.ccc12,
                  fglz         LIKE ccc_file.ccc12,
                  fglj         LIKE ccc_file.ccc12,
                  ta_ccc214    LIKE ccc_file.ccc12,
                  zrje         LIKE ccc_file.ccc12,
                  zrc          LIKE ccc_file.ccc12,
                  zrr          LIKE ccc_file.ccc12,
                  zrz          LIKE ccc_file.ccc12,
                  zrj          LIKE ccc_file.ccc12,
                  ta_ccc41     LIKE ccc_file.ccc12,
                  fje          LIKE ccc_file.ccc12,
                  zfc          LIKE ccc_file.ccc12,
                  zfr          LIKE ccc_file.ccc12,
                  zfz          LIKE ccc_file.ccc12,
                  zfj          LIKE ccc_file.ccc12,
                  ta_ccc61     LIKE ccc_file.ccc12,
                  hje          LIKE ccc_file.ccc12,
                  xhc          LIKE ccc_file.ccc12,
                  xhr          LIKE ccc_file.ccc12,
                  xhz          LIKE ccc_file.ccc12,
                  xhj          LIKE ccc_file.ccc12,
                  sltz         LIKE ccc_file.ccc12,
                  cltz         LIKE ccc_file.ccc12,
                  rgtz         LIKE ccc_file.ccc12,
                  zftz         LIKE ccc_file.ccc12,
                  jgtz         LIKE ccc_file.ccc12,
                  tzhz         LIKE ccc_file.ccc12
                  END RECORD,
     g_detail_sum  RECORD
                  ta_ccc01     LIKE ima_file.ima01,
                  ta_ccc02     LIKE ccc_file.ccc02,
