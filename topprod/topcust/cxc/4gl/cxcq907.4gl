...
#                 wc2    LIKE type_file.chr1000		# Body Where condition  #No.FUN-690026 VARCHAR(500)         #TQC-CC0058 mark
    ...
    g_detail    DYNAMIC ARRAY OF     RECORD
                  ...
                  ta_cct04       LIKE ccc_file.ccc12,
                  ta_cct05       LIKE ima_file.ima01,
                  ta_cct06       LIKE ccc_file.ccc12,
                  ta_cct07       LIKE ccc_file.ccc12,
                  ta_cct08       LIKE ccc_file.ccc12,
                  ta_cct09       LIKE ccc_file.ccc12,
                  ta_cct10       LIKE ccc_file.ccc12,
                  ta_cct11       LIKE ccc_file.ccc12,
                  ta_cct12       LIKE ccc_file.ccc12,
                  ta_cct13       LIKE ccc_file.ccc12,
                  ta_cct14       LIKE ccc_file.ccc12,
                  ta_cct15       LIKE ccc_file.ccc12,
                  ta_cct16       LIKE ccc_file.ccc12,
                  ta_cct17       LIKE ccc_file.ccc12,
                  ta_cct18       LIKE ccc_file.ccc12,
                  ta_cct19       LIKE ccc_file.ccc12,
                  ta_cct20       LIKE ccc_file.ccc12,
                  ta_cct21       LIKE ccc_file.ccc12
                  END RECORD,
    g_detail_sum  RECORD
                  ta_cct01       LIKE ima_file.ima01,
                  ta_cct02       LIKE ccc_file.ccc02,
