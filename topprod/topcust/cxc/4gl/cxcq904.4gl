...
#                 wc2    LIKE type_file.chr1000		# Body Where condition  #No.FUN-690026 VARCHAR(500)         #TQC-CC0058 mark
    ...
    g_detail    DYNAMIC ARRAY OF     RECORD
                   ...
                   ta_ccq04  LIKE ccc_file.ccc11, 
                   ta_ccq05  LIKE ima_file.ima01, 
                   ima02_1   LIKE ima_file.ima02, 
                   ima021_1  LIKE ima_file.ima021,
                   ima39_1   LIKE ima_file.ima39,
                   ta_ccq11  LIKE ccc_file.ccc11, 
                   ta_ccq18  LIKE ccc_file.ccc11, 
                   sjhyje    LIKE ccc_file.ccc12,   
                   ta_ccq12a LIKE ccc_file.ccc12, 
                   ta_ccq12b LIKE ccc_file.ccc12, 
                   ta_ccq12c LIKE ccc_file.ccc12, 
                   ta_ccq12d LIKE ccc_file.ccc12, 
                   txje      LIKE ccc_file.ccc12,    
                   ta_ccq22a LIKE ccc_file.ccc12, 
                   ta_ccq22b LIKE ccc_file.ccc12, 
                   ta_ccq22c LIKE ccc_file.ccc12, 
                   ta_ccq22d LIKE ccc_file.ccc12, 
                   ta_ccq20  LIKE ccc_file.ccc12, 
                   ta_ccq21  LIKE ccc_file.ccc12, 
                   ta_ccq21a LIKE ccc_file.ccc12, 
                   ta_ccq21b LIKE ccc_file.ccc12, 
                   ta_ccq21c LIKE ccc_file.ccc12, 
                   ta_ccq21d LIKE ccc_file.ccc12
                  END RECORD,
    g_detail_sum   RECORD
                   ta_ccq01  LIKE ima_file.ima01,
                   ima02     LIKE ima_file.ima02,    
    ...
    FOREACH q904_bcs INTO g_detail[g_cnt].* 
      ...
      IF g_cnt > g_max_rec THEN
         CALL cl_err( '', 9035, 0 )
	      EXIT FOREACH
      END IF 
      LET g_detail_sum.ta_ccq02  = g_detail_sum.ta_ccq02  + g_detail[g_cnt].ta_ccq02 
      LET g_detail_sum.ta_ccq03  = g_detail_sum.ta_ccq03  + g_detail[g_cnt].ta_ccq03 
