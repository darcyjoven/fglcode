...
DEFINE l_ccc09     LIKE ima_file.ima39
DEFINE l_ccc10     LIKE ccc_file.ccc21
...
#   LET l_wc = cl_replace_str(l_wc,"ccg03","ccc03")
  ...
  # LET l_sql = "SELECT DISTINCT ta_ccc01,ta_ccc02,ta_ccc03 ",
   ...
   IF SQLCA.SQLCODE THEN
      ...
      RETURN
   END IF
   DECLARE p906_c3 CURSOR FOR p906_p3

   LET l_sql = "SELECT '返工入库' ,'' ,'2','500101',SUM(fgrc),'2' ",   
               "  FROM cxcq906_file ",
              # " WHERE ta_ccc01 =? ",
               "   WHERE ta_ccc02 =? ",
               "   AND ta_ccc03 =? ", 
              ...
              # "GROUP BY ima39 ",            #No.FUN-D20040 add ccc13
               " UNION ",
               "SELECT '返工入库','','2','500102',SUM(fgrr),'2' ",   
               "  FROM cxcq906_file ",
               # " WHERE ta_ccc01 =? ",
               "   WHERE ta_ccc02 =? ",
               "   AND ta_ccc03 =? ", 
             ...
             #  "GROUP BY ima39 ",                 #No.FUN-D20040 add ccc13
               " UNION ",
               "SELECT '返工入库','','2','500103',SUM(fgrz),'2' ",   
               "  FROM cxcq906_file ",
              # " WHERE ta_ccc01 =? ",
               "   WHERE ta_ccc02 =? ",
               "   AND ta_ccc03 =? ", 
              ...
              # "GROUP BY ima39 ",
               " UNION ",
               "SELECT '返工入库','','2','500104',SUM(fgrj),'2' ",   
               "  FROM cxcq906_file ",
             #  " WHERE ta_ccc01 =? ",
               "   WHERE ta_ccc02 =? ",
               "   AND ta_ccc03 =? ", 
            ...
            #   "GROUP BY ima39 ",                  #No.FUN-D20040 add ccc13 
               " UNION ",
               "SELECT '返工入库','','2',ima39,-1*SUM(fgrje),'2' ",   
               "  FROM cxcq906_file ",
             #  " WHERE ta_ccc01 =? ",
               "   WHERE ta_ccc02 =? ",
               "   AND ta_ccc03 =? ", 
               ...
               "GROUP BY ima39 ",                 #No.FUN-D20040 add ccc13
               " UNION ",
               "SELECT '返工领料','','2',ima39,SUM(fglje),'2' ",   
               "  FROM cxcq906_file ",
            #  " WHERE ta_ccc01 =? ",
               "   WHERE ta_ccc02 =? ",
               "   AND ta_ccc03 =? ", 
               ...
               "GROUP BY ima39 ", 
               " UNION ",
               "SELECT '返工领料','','1','500101',SUM(fglc),'1' ",   
               "  FROM cxcq906_file ",
             #  " WHERE ta_ccc01 =? ",
               "   WHERE ta_ccc02 =? ",
               "   AND ta_ccc03 =? ", 
             ...
             #  "GROUP BY ima39 ",            #No.FUN-D20040 add ccc13
               " UNION ",
               "SELECT '返工领料','' ,'1','500102',SUM(fglr),'1' ",   
               "  FROM cxcq906_file ",
              # " WHERE ta_ccc01 =? ",
               "   WHERE ta_ccc02 =? ",
               "   AND ta_ccc03 =? ", 
             ...
             #  "GROUP BY ima39 ",                 #No.FUN-D20040 add ccc13
               " UNION ",
               "SELECT '返工领料','','1','500103',SUM(fglz),'1' ",   
               "  FROM cxcq906_file ",
              # " WHERE ta_ccc01 =? ",
               "   WHERE ta_ccc02 =? ",
               "   AND ta_ccc03 =? ", 
             ...
             #  "GROUP BY ima39 ",
                " UNION ",
               "SELECT '返工领料','','1','500104',SUM(fglj),'1' ",   
               "  FROM cxcq906_file ",
             #  " WHERE ta_ccc01 =? ",
               "   WHERE ta_ccc02 =? ",
               "   AND ta_ccc03 =? ", 
   ...
   PREPARE p906_p4 FROM l_sql
   IF SQLCA.SQLCODE THEN
      CALL cl_err('FILL PREPARE:',SQLCA.SQLCODE,1)
      LET g_success ='N'
      RETURN
   END IF
   DECLARE p906_c4 CURSOR FOR p906_p4
   ...
   PREPARE p906_p5 FROM l_sql
   IF SQLCA.SQLCODE THEN
      CALL cl_err('FILL PREPARE:',SQLCA.SQLCODE,1) 
      LET g_success ='N'
      RETURN
   END IF
   DECLARE p906_c5 CURSOR FOR p906_p5
   #11911good
   FOREACH p906_c3 INTO l_ccc.ccc01,l_ccc.ccc02,l_ccc.ccc03
      IF SQLCA.sqlcode THEN
     ...
     # LET l_npp.npp01    = 'A',l_ccc.ccc01 CLIPPED,l_ccc.ccc01 CLIPPED,'-',l_ccc.ccc02 USING '&&&&',l_ccc.ccc03 CLIPPED USING '&&','0001'
      LET l_npp.npp01    = 'A','600','-',l_ccc.ccc02 USING '&&&&',l_ccc.ccc03 CLIPPED USING '&&','0906'
...
#FUN-D60025 ------------ end by yuhuabao 13/06/05
   ...
   #   FOREACH p906_c4 USING  l_ccc.ccc01,l_ccc.ccc02,l_ccc.ccc03,l_ccc.ccc01,l_ccc.ccc02,l_ccc.ccc03,l_ccc.ccc01,l_ccc.ccc02,l_ccc.ccc03,l_ccc.ccc01,l_ccc.ccc02,l_ccc.ccc03,l_ccc.ccc01,l_ccc.ccc02,l_ccc.ccc03,l_ccc.ccc01,l_ccc.ccc02,l_ccc.ccc03,l_ccc.ccc01,l_ccc.ccc02,l_ccc.ccc03,l_ccc.ccc01,l_ccc.ccc02,l_ccc.ccc03,l_ccc.ccc01,l_ccc.ccc02,l_ccc.ccc03,l_ccc.ccc01,l_ccc.ccc02,l_ccc.ccc03,l_ccc.ccc01,l_ccc.ccc02,l_ccc.ccc03,l_ccc.ccc01,l_ccc.ccc02,l_ccc.ccc03 
       FOREACH p906_c4 USING  l_ccc.ccc02,l_ccc.ccc03,l_ccc.ccc02,l_ccc.ccc03,l_ccc.ccc02,l_ccc.ccc03,l_ccc.ccc02,l_ccc.ccc03,l_ccc.ccc02,l_ccc.ccc03,l_ccc.ccc02,l_ccc.ccc03,l_ccc.ccc02,l_ccc.ccc03,l_ccc.ccc02,l_ccc.ccc03,l_ccc.ccc02,l_ccc.ccc03,l_ccc.ccc02,l_ccc.ccc03,l_ccc.ccc02,l_ccc.ccc03,l_ccc.ccc02,l_ccc.ccc03        
