...
DEFINE l_aag43     LIKE aag_file.aag43
...
#    IF l_occ37 = 'N' THEN RETURN ' ',' ' END IF #150706wudj mark
    SELECT aag37,aag43,aag151 INTO l_aag37,l_aag43,l_aag151 FROM aag_file WHERE aag00 = p_bookno AND aag01 = p_npq.npq03
    IF cl_null(l_aag37) and l_occ37 = 'Y' THEN CALL cl_err(p_npq.npq03,'axc-920','0') RETURN ' ',' ' END IF #150706wudj add l_occ37 = 'Y' 
    LET p_npq.npq37 = p_npq.npq21
    IF l_aag43 ='Y' AND l_aag151 IS NOT NULL THEN 
    	 LET p_npq.npq11 = p_npq.npq21
    ELSE 
        LET p_npq.npq11=' '   #150706wudj
    END IF 
IF l_occ37 = 'N'  THEN  LET p_npq.npq37=' '  END IF #150706wudj
