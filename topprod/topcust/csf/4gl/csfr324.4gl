...
MAIN
   ...
   LET  l_table = cl_prt_temptable('csfr324',g_sql) CLIPPED
...
FUNCTION csfr324_tm(p_row,p_col)
...
DEFINE p_row,p_col    LIKE type_file.num5,        
   ...
   OPEN WINDOW csfr324_w AT p_row,p_col WITH FORM "csf/42f/csfr324"
...
WHILE TRUE
  ...
  END CONSTRUCT
   ...
   IF INT_FLAG THEN
      LET INT_FLAG = 0 CLOSE WINDOW csfr324_w 
  ...
  #UI
   ...
   IF g_bgjob = 'Y' THEN
      ...
      ELSE
         ...
         CALL cl_cmdat('csfr324',g_time,l_cmd)    # Execute cmd at later time
      END IF
      CLOSE WINDOW csfr324_w
      CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690126
      EXIT PROGRAM
   END IF
   CALL cl_wait()
...
#       l_time          LIKE type_file.chr8        #No.FUN-6A0094
   ...
   LOCATE l_img_blob IN MEMORY             
     ...
     SELECT zz05 INTO g_zz05 FROM zz_file WHERE zz01='csfr324' 
     
     
     LET tm.wc = tm.wc CLIPPED 
     
LET l_sql="select tc_sna04,'',tc_sna01,tc_sna02,tc_snb05,'',tc_snb20,tc_snb04,ima02,tc_snb07,tc_snb08,tc_snb09,'',tc_snauser,tc_snaoriu,''",
     ...
     PREPARE csfr324_prepare1 FROM l_sql
     IF STATUS THEN CALL cl_err('prepare:',STATUS,1) 
        CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690126
        EXIT PROGRAM 
     END IF
     DECLARE csfr324_curs1 CURSOR FOR csfr324_prepare1
 
     FOREACH csfr324_curs1 INTO sr.*
     ...
     CALL cl_prt_cs3('csfr324','csfr324',g_sql,g_str)
