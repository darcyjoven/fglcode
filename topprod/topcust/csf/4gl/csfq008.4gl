...
DEFINE	  l_sl          LIKE type_file.num5          #No.FUN-680137 SMALLINT
   ...
   END IF
    ...
    OPEN WINDOW q008_w AT p_row,p_col
        WITH FORM "csf/42f/csfq008"
...
FUNCTION q008_b_fill()              #BODY FILL UP
  ...
  LET l_sql3 = l_sql2," UNION ",
   ...
   PREPARE q008_pb FROM l_sql
   DECLARE q008_bcs CURSOR WITH HOLD FOR q008_pb
    CALL g_sfb.clear()
    LET g_cnt = 1
    FOREACH q008_bcs INTO g_sfb[g_cnt].*
  ...
  #  INSERT INTO csfq008_tmp VALUES (g_sfb[g_cnt].*)
    LET g_cnt = g_cnt + 1
...
FUNCTION q008_temp_table()
     DROP TABLE csfq008_tmp;
	 CREATE TEMP TABLE csfq008_tmp(
            sfb01   LIKE sfb_file.sfb01,
            sfb05   LIKE sfb_file.sfb05,
            ima02   LIKE ima_file.ima02,
            ima021  LIKE ima_file.ima021,
