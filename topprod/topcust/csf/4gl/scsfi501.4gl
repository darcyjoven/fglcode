...
FUNCTION i501_1(p_argv1, p_argv2, p_argv3, p_argv4)
...
#End Mark No:TQC-AC0125
        ...
        BEFORE INPUT
            ...
            CALL cl_set_comp_entry("sfpud02",TRUE)  #add by jixf 160809
...
#FUN-B20095 ---------------------End----------------------------
      ...
      AFTER INPUT
         ...
         IF NOT cl_null(g_sfp.sfpud02) THEN 
             FOR l_n = 1 TO g_sfq.getLength()
                SELECT shm08 INTO l_shm08_sum FROM shm_file 
                   WHERE ta_shm05=g_sfp.sfpud02 AND shm012=g_sfq[l_n].sfq02
                SELECT SUM(sfq03) INTO l_sfq03_sum FROM sfq_file,sfp_file 
                  WHERE sfq01=sfp01 AND sfq02=g_sfq[l_n].sfq02 AND
                        sfpud02=g_sfp.sfpud02 AND sfq01<>g_sfp.sfp01 AND sfpconf<>'X'
...
LET l_factor = 1
    ...
    LET l_sql=l_sql CLIPPED," ORDER BY img22 DESC,img37 ASC "		#發料順序   #add by jixf 160808 按呆滞日期升序,先取W仓，再取S仓
