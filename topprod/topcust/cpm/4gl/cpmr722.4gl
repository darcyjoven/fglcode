...
MAIN
   ...
   LET  l_table = cl_prt_temptable('cpmr722',g_sql) CLIPPED
...
FUNCTION cpmr722_tm(p_row,p_col)
...
DEFINE p_row,p_col    LIKE type_file.num5,        
   ...
   OPEN WINDOW cpmr722_w AT p_row,p_col WITH FORM "cpm/42f/cpmr721"
...
WHILE TRUE
  ...
  END CONSTRUCT
   ...
   IF INT_FLAG THEN
      LET INT_FLAG = 0 CLOSE WINDOW cpmr722_w 
  ...
  #UI
   ...
   IF g_bgjob = 'Y' THEN
      ...
      ELSE
         ...
         CALL cl_cmdat('cpmr722',g_time,l_cmd)    # Execute cmd at later time
      END IF
      CLOSE WINDOW cpmr722_w
      CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690126
      EXIT PROGRAM
   END IF
   CALL cl_wait()
...
#       l_time          LIKE type_file.chr8        #No.FUN-6A0094
   ...
   LOCATE l_img_blob IN MEMORY             
     ...
     SELECT zz05 INTO g_zz05 FROM zz_file WHERE zz01='cpmr722' 
...
LET l_sql="select rvu04,rvu05,rvu03,rvu01,rvv02,rvv31,rvv031,ima021,rvv34,rvv17,rvv35,rvv32,'',rvv36",
           ...
           " where ",tm.wc ,
           "   AND rvu01=rvv01 "
     PREPARE cpmr722_prepare1 FROM l_sql
     IF STATUS THEN CALL cl_err('prepare:',STATUS,1) 
        CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690126
        EXIT PROGRAM 
     END IF
     DECLARE cpmr722_curs1 CURSOR FOR cpmr722_prepare1
 
     FOREACH cpmr722_curs1 INTO sr.*
     ...
     CALL cl_prt_cs3('cpmr722','cpmr722',g_sql,g_str)
