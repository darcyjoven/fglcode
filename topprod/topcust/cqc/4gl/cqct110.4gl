...
#
# Pattern name...: cqct110.4gl
# Descriptions...: IQC 品質記錄維護作業
# Note...........: 原cqct110已改為scqct110
# Date & Author..: 06/02/09 By kim
# Modify.........: No.TQC-630027 06/03/06 視窗標題為FQC倉庫品質管理記錄,而非IQC cqct110品質管理記錄
...
#No.FUN-830131  --BEGIN  
#------------No.TQC-630027 add
#    CASE WHEN p_argv1='1' LET g_prog='cqct110'
...
#No.FUN-830131  --end
   ...
   IF g_bgjob='N' OR cl_null(g_bgjob) THEN
      ...
      OPEN WINDOW t110_w AT p_row,p_col WITH FORM "cqc/42f/cqct110"
      ATTRIBUTE (STYLE = g_win_style CLIPPED)
      #END FUN-680011
       
      CALL cl_set_locale_frm_name("cqct110")
      CALL cl_ui_init()
   END IF
   #FUN-680011
