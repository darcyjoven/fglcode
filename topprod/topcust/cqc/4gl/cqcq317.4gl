...
DEFINE
    ...
    g_qct DYNAMIC ARRAY OF RECORD
            ...
            qcsud031         LIKE  type_file.num15_3,
            qcsud032         LIKE  type_file.num15_3,
            qcsud03          LIKE  type_file.chr12,
            qcs0221          LIKE  type_file.num15_3,
            qcs0222          LIKE  type_file.num15_3,
            qcs022           LIKE  type_file.chr12
        END RECORD,
...
FUNCTION q317_b_fill()              #BODY FILL UP
   DEFINE l_sql     STRING       #No.FUN-680104 VARCHAR(1100)
   ...
   LET l_sql = "
      SELECT qcs03,pmc03,pmc081,SUM(合格),SUM(不合格),  
