...
#GLOBALS "../../config/top.global"#mark by guanyao160513
GLOBALS "../../../tiptop/config/top.global" #add by guanyao160513

#若 ina00 MATCHES "[1256]" THEN p_flag=+1 ELSE p_flag=-1.(即：入庫p_flag=+1 出庫 p_flag=-1) 
FUNCTION p379sub_p2(p_ina01,p_flag,p_bgjob)
DEFINE p_ina01     LIKE ina_file.ina01
DEFINE p_flag      LIKE type_file.num5
DEFINE p_bgjob     LIKE type_file.chr1  #add by guanyao160513

   WHENEVER ERROR CONTINUE                #忽略一切錯誤 
   LET g_success='Y'
   LET g_totsuccess = 'Y'  
   LET g_bgjob = p_bgjob                 #add by guanyao160513
