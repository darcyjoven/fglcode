...
DEFINE g_tc_deb17   LIKE tc_deb_file.tc_deb17,
       g_tc_deb18   LIKE tc_deb_File.tc_deb18
...
MAIN
   ...
   LET g_forupd_sql = "SELECT tc_dea01,tc_dea02,tc_dea03,tc_dea04,tc_dea05,tc_dea06,tc_dea07,tc_dea08,tc_dea09, ",
                      "       tc_dea10,tc_dea11,tc_dea14,tc_dea15,tc_dea16,tc_dea17,tc_dea18,tc_dea19,tc_dea20 ",
                      "  FROM tc_dea_file WHERE tc_dea01 = ? FOR UPDATE"                                                           
   LET g_forupd_sql = cl_forupd_sql(g_forupd_sql)
   DECLARE t001_cl CURSOR FROM g_forupd_sql

   LET g_forupd_sql = " SELECT tc_deb02,tc_deb04,tc_deb05,tc_deb06,tc_deb07,tc_deb08,",
                      " tc_deb09,tc_deb10,tc_deb11,tc_deb12,tc_deb13,tc_deb14,tc_deb15,tc_deb16 ",
                      " FROM pmn_file WHERE pmn01 = ? AND pmn02 = ? FOR UPDATE "
    LET g_forupd_sql = cl_forupd_sql(g_forupd_sql)
...
#將資料顯示在畫面上
FUNCTION t001_show()
   SELECT tc_dea01,tc_dea02,tc_dea03,tc_dea04,tc_dea05,tc_dea06,tc_dea07,tc_dea08,tc_dea09,tc_dea10,
          tc_dea11,tc_dea14,tc_dea15,tc_dea16,tc_dea17,tc_dea18,tc_dea19,tc_dea20
     INTO g_tc_dea.* FROM tc_dea_file 
    WHERE tc_dea01 = g_tc_deb01
   LET g_tc_dea_t.* = g_tc_dea.*                #保存單頭舊值
   DISPLAY BY NAME g_tc_dea.*   
...
FUNCTION t001_i(p_cmd)
   ...
   DIALOG ATTRIBUTES(UNBUFFERED,FIELD ORDER FORM)
      ...
      INPUT BY NAME g_tc_dea.tc_dea01,g_tc_dea.tc_dea02,g_tc_dea.tc_dea03,g_tc_dea.tc_dea04,g_tc_dea.tc_dea05,
         ...
         ELSE 
            BEGIN WORK
            OPEN t001_cl USING g_tc_dea.tc_dea01
            IF STATUS THEN
            ...
            FETCH t001_cl INTO g_tc_dea.* 
            IF SQLCA.sqlcode THEN
               CALL cl_err(g_tc_dea.tc_dea01,SQLCA.sqlcode,1)  
               ROLLBACK WORK
               RETURN
            END IF
         ...
         ON ACTION controlp INFIELD tc_dea06
            ...
            CALL cl_create_qry() RETURNING g_tc_dea.tc_dea06
            DISPLAY g_tc_dea.tc_dea06 TO tc_dea06
            NEXT FIELD tc_dea06
         
         AFTER INPUT
         #TODO 检查错误信息
         #TODO 根据actionchoice 确认update还是insert
            IF t001_input('u') THEN
            END IF
      ...
      INPUT ARRAY g_tc_deb FROM s_tc_deb.* 
         ...
         #NOTE 游标大于当前行数，判断为修改，修改前先重新显示一遍
            IF g_rec_b >= l_ac THEN
               LET p_cmd = 'u'
               LET g_tc_deb_t.* = g_tc_deb[l_ac].*
         #NOTE 检查单身事务
               OPEN t001_bcl USING g_tc_dea.tc_dea01,g_tc_deb_t.tc_deb02
               IF STATUS THEN
                  CALL cl_err("OPEN t001_bcl:", STATUS, 1)
               ELSE
                  FETCH t001_bcl INTO g_tc_deb2.*
                  IF SQLCA.sqlcode THEN
                     CALL cl_err(g_tc_deb_t.tc_deb02,SQLCA.sqlcode,1)
                  ELSE
                     LET g_tc_deb[l_ac].* = g_tc_deb2.*
                  END IF
               END IF
            END IF 
         ...
         #NOTE 设置entry
            ...
            CALL t001_set_no_entry_b(p_cmd)
         #NOTE 清空值
            INITIALIZE g_tc_deb[l_ac].* TO NULL
            INITIALIZE g_tc_deb_t.* TO NULL
            INITIALIZE g_tc_deb_o.* TO NULL
            INITIALIZE g_tc_deb2.* TO NULL
         #NOTE 设置默认值 
            LET g_tc_deb[l_ac].tc_deb04 ='N'
            LET g_tc_deb[l_ac].tc_deb05 ='N'
            LET c = CURRENT YEAR TO SECOND 
            LET g_tc_deb[l_ac].tc_deb11 = c
            LET g_tc_deb[l_ac].tc_deb12 = "/u1/topprod/tiptop/doc/pic/pdf_logo_flymn2.jpg"
            LET g_tc_deb[l_ac].tc_deb15 = g_user
            LET g_tc_deb[l_ac].tc_deb16 = TODAY
            LET g_tc_deb17 = g_user
            LET g_tc_deb17 = TODAY
         ...
         AFTER INSERT
            IF INT_FLAG THEN 
               ...
               CANCEL INSERT
            END IF
            LET g_tc_deb2.* = g_tc_deb[l_ac].*

         #TODO 基本检查
         #TODO 资料未重复，插入新增资料
            
            INSERT INTO tc_deb_file(tc_deb02,tc_deb04,tc_deb05,tc_deb06,tc_deb07,tc_deb08,
                                    tc_deb09,tc_deb10,tc_deb11,tc_deb12,tc_deb13,tc_deb14,tc_deb15,tc_deb16,tc_deb17,tc_deb18) 
            VALUES(g_tc_deb[l_ac].tc_deb02,g_tc_deb[l_ac].tc_deb04,g_tc_deb[l_ac].tc_deb05,
                   g_tc_deb[l_ac].tc_deb06,g_tc_deb[l_ac].tc_deb07,g_tc_deb[l_ac].tc_deb08,
                   g_tc_deb[l_ac].tc_deb09,g_tc_deb[l_ac].tc_deb10,g_tc_deb[l_ac].tc_deb11,
                   g_tc_deb[l_ac].tc_deb12,g_tc_deb[l_ac].tc_deb13,g_tc_deb[l_ac].tc_deb14,
                   g_tc_deb[l_ac].tc_deb15,g_tc_deb[l_ac].tc_deb16,g_tc_deb17,g_tc_deb18)
            IF SQLCA.sqlcode THEN
               CALL cl_err("ins tc_deb_file",SQLCA.sqlcode,1) 
               LET g_success = 'N'
               ROLLBACK WORK
               CANCEL INSERT
            END IF
         ...
         #TODO 修改模式时，弹窗确认
         #NOTE 删除单身
            DELETE FROM tc_deb_file 
             WHERE tc_deb01 = g_tc_dea.tc_dea01 
               AND tc_deb02 = g_tc_deb[l_ac].tc_deb02
               AND tc_deb03 = g_tc_dea.tc_dea03
         ...
         #TODO UPDATE 单身
            UPDATE tc_deb_file 
               SET tc_deb02 = g_tc_deb[l_ac].tc_deb02,
                   tc_deb04 = g_tc_deb[l_ac].tc_deb04,
                   tc_deb05 = g_tc_deb[l_ac].tc_deb05,
                   tc_deb06 = g_tc_deb[l_ac].tc_deb06,
                   tc_deb07 = g_tc_deb[l_ac].tc_deb07,
                   tc_deb08 = g_tc_deb[l_ac].tc_deb08,
                   tc_deb09 = g_tc_deb[l_ac].tc_deb09,
                   tc_deb10 = g_tc_deb[l_ac].tc_deb10,
                   tc_deb11 = g_tc_deb[l_ac].tc_deb11,
                   tc_deb12 = g_tc_deb[l_ac].tc_deb12,
                   tc_deb13 = g_tc_deb[l_ac].tc_deb13,
                   tc_deb14 = g_tc_deb[l_ac].tc_deb14,
                   tc_deb15 = g_tc_deb[l_ac].tc_deb15,
                   tc_deb16 = g_tc_deb[l_ac].tc_deb16
             WHERE tc_deb01 = g_tc_dea.tc_dea01 AND tc_deb02 = g_tc_deb[l_ac].tc_deb02 AND tc_deb03 = g_tc_dea.tc_dea03 
            IF SQLCA.sqlcode THEN
         ...
         AFTER ROW
            DISPLAY "AFTER ROW=",g_tc_deb.getLength()," l_ac=",l_ac
            LET l_ac = ARR_CURR()
            IF INT_FLAG THEN
               CALL cl_err('',9001,1)
               LET INT_FLAG = FALSE
            #NOTE   
               IF p_cmd = 'u' THEN
                  LET g_tc_deb[l_ac].* = g_tc_deb_t.*
               ELSE 
                  CALL g_tc_deb.deleteElement(l_ac)
                  IF g_rec_b != 0 THEN
                     LET g_action_choice = "detail"
                     LET l_ac = l_ac_t
                  END IF
               END IF
               DISPLAY 'leave =',g_tc_deb.getLength()," l_ac=",l_ac
               CLOSE t001_bcl
               ROLLBACK WORK
               EXIT DIALOG
            END IF
...
DEFINE  p_wc2  STRING      
   ...
   LET g_sql = " SELECT tc_deb02,tc_deb04,tc_deb05,tc_deb06,tc_deb07,tc_deb08,tc_deb09,",
               " tc_deb10,tc_deb11,tc_deb12,tc_deb13,tc_deb14,tc_deb15,tc_deb16 ",
               " FROM tc_deb_file",
   ...
   LET g_sql = " SELECT tc_dec02,tc_dec04,tc_dec05,tc_dec06,tc_dec07,tc_dec08,tc_dec09,tc_dec10,",
               " tc_dec11,tc_dec12,tc_dec13,tc_dec14,tc_dec15,tc_dec16,tc_dec17,tc_dec18 ",
               " FROM tc_dec_file",
...
FUNCTION t001_set_no_entry(p_cmd)
  DEFINE p_cmd   LIKE type_file.chr1       
   ...
   CALL cl_set_comp_entry("tc_dea03",FALSE) 
   IF p_cmd = 'u' AND ( NOT g_before_input_done ) AND g_chkey='N' THEN
     CALL cl_set_comp_entry("tc_dea01",FALSE) 
   END IF
END FUNCTION
...
END FUNCTION 
FUNCTION t001_set_comp()
   CALL cl_set_combo_items("tc_dea07","1,2,3,4","一,二,三,四")
   CALL cl_set_combo_items("tc_deb07","1,2","香蕉,苹果")
...
END FUNCTION
# 检查单头资料
FUNCTION t001_input(p_cmd)
   DEFINE p_cmd      LIKE type_file.chr1,
          li_result  LIKE type_file.chr1,
          l_cnt      LIKE type_file.num5
   #NOTE 检查必要栏位
   IF cl_null(g_tc_dea.tc_dea01) THEN
      CALL cl_err("请录入单别!","!",1)
      RETURN FALSE
   END IF 
   IF cl_null(g_tc_dea.tc_dea02) THEN
      CALL cl_err("请录入日期!","!",1)
      RETURN FALSE
   ELSE
      IF MONTH(g_tc_dea.tc_dea02) <> MONTH(TODAY) THEN 
         CALL cl_err("不可跨月!","!",1)
         RETURN FALSE
      END IF
   END IF 
   IF cl_null(g_tc_dea.tc_dea06) THEN
      CALL cl_err("请录入buttonedit!","!",1)
      RETURN FALSE
   ELSE 
      SELECT count(1) INTO l_cnt FROM ima_file 
       WHERE ima01 = g_tc_dea.tc_dea06 AND imaacti = 'Y'
      IF cl_null(l_cnt) OR l_cnt = 0 THEN 
         CALL cl_err("料件编号错误!","!",1)
         RETURN FALSE
      END IF
   END IF 

   IF cl_null(g_tc_dea.tc_dea08) THEN
      CALL cl_err("请录入banana/apple!","!",1)
      RETURN FALSE
   END IF 
   #NOTE 修改日期和人员
   LET g_tc_dea.tc_dea17 = TODAY
   LET g_tc_dea.tc_dea18 = g_user
   LET g_tc_dea.tc_dea15 = TODAY
   LET g_tc_dea.tc_dea16 = g_user
 
   
   IF p_cmd='a' AND g_before_input_done = FALSE THEN
      
      IF g_tc_dea.tc_dea01 <> 'PRB' THEN 
         CALL cl_err("请录入PRB！","!",1)
         RETURN FALSE
      END IF
      BEGIN WORK
      CALL s_auto_assign_no("apm",g_tc_dea.tc_dea01,g_tc_dea.tc_dea02,'2',"tc_dea_file","tc_dea01","","","") #TQC-9B0191
            RETURNING li_result,g_tc_dea.tc_dea01
      IF (NOT li_result) THEN
         CALL cl_err("编码失败!","!",1) 
         RETURN FALSE
      ...
      INSERT INTO tc_dea_file (tc_dea01,tc_dea02,tc_dea03,tc_dea04,tc_dea05,
                               tc_dea06,tc_dea07,tc_dea08,tc_dea09,tc_dea10,
                               tc_dea11,tc_dea14,tc_dea15,
                               tc_dea16,tc_dea17,tc_dea18,tc_dea19,tc_dea20) 
      VALUES(g_tc_dea.tc_dea01,g_tc_dea.tc_dea02,g_tc_dea.tc_dea03,g_tc_dea.tc_dea04,g_tc_dea.tc_dea05,
             g_tc_dea.tc_dea06,g_tc_dea.tc_dea07,g_tc_dea.tc_dea08,g_tc_dea.tc_dea09,g_tc_dea.tc_dea10,
             g_tc_dea.tc_dea11,g_tc_dea.tc_dea14,g_tc_dea.tc_dea15,
             g_tc_dea.tc_dea16,g_tc_dea.tc_dea17,g_tc_dea.tc_dea18,g_tc_dea.tc_dea19,g_tc_dea.tc_dea20)
      IF SQLCA.sqlcode THEN
         CALL cl_err("insert into tc_dea_file:",SQLCA.sqlcode,1) 
         ROLLBACK WORK
         RETURN FALSE
      ELSE 
         COMMIT WORK
   ...
   IF g_before_input_done ='Y' OR p_cmd='u' THEN
      UPDATE tc_dea_file 
         SET tc_dea02 = g_tc_dea.tc_dea02,
             tc_dea03 = g_tc_dea.tc_dea03,
             tc_dea04 = g_tc_dea.tc_dea04,
             tc_dea05 = g_tc_dea.tc_dea05,
             tc_dea06 = g_tc_dea.tc_dea06,
             tc_dea07 = g_tc_dea.tc_dea07,
             tc_dea08 = g_tc_dea.tc_dea08,
             tc_dea09 = g_tc_dea.tc_dea09,
             tc_dea10 = g_tc_dea.tc_dea10,
             tc_dea11 = g_tc_dea.tc_dea11,
             tc_dea14 = g_tc_dea.tc_dea14,
             tc_dea15 = g_tc_dea.tc_dea15,
             tc_dea16 = g_tc_dea.tc_dea16,
             tc_dea17 = g_tc_dea.tc_dea17,
             tc_dea18 = g_tc_dea.tc_dea18,
             tc_dea19 = g_tc_dea.tc_dea19,
             tc_dea20 = g_tc_dea.tc_dea20
       WHERE tc_dea01 = g_tc_dea.tc_dea01

      IF SQLCA.sqlcode THEN
         CALL cl_err("update tc_dea_file:",SQLCA.sqlcode,1) 
         ROLLBACK WORK
         RETURN FALSE
      ELSE 
         COMMIT WORK
