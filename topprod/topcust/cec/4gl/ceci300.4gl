...
# Modify.........: No.FUN-7A0072 08/10/07 By jamie 1.新增樣板,順序與欄位與維護程式(ceci300)一致。
...
#                                                  (3)ceci300單身變更時,需同步update ecbdate
...
# Modify.........: No:MOD-A40053 10/04/12 By Sarah i300_cs()段計算資料筆數有問題
...
# Modify.........: No.TQC-AC0231 10/11/17 By vealxu ceci300的複製功能，不走"平行工藝"時，不應該出現"製程段"
# Modify.........: No.TQC-AC0245 10/12/18 By lixh1  增加ceci300新增時的列印功能
...
# Modify.........: No:TQC-940179 09/04/29 By Duke ceci300 作業編號異動時，刪除原作業編號之維護檔 vmn_file,vms_file, vnm_file 資料
...
# Modify.........: No:MOD-C20166 12/03/06 By ck2yuan 將i300_chk_ecu51改到AFTER ROW檢查,除了ecb51為null,其他錯誤都next field到ecb46
...
# Modify.........: No.MOD-C30386 12/03/10 By bart 若行業別為ICD, 維護產品製程資料(ceci300)時,不要控卡單位轉換率。
...
# Modify.........: No.FUN-D10063 13/01/17 By Nina UPDATE ecu_inplan 的任何一個欄位時,多加ecudate=g_today
...
# Modify.........: No.MOD-D40052 13/04/09 By suncx 函數i300_chk_ecu51()中IF l_fac != l_fac2 THEN應該改為IF l_fac <= l_fac2 THEN
...
# Modify.........: No.170807     17/08/07 By ly   ecu02检查末尾不为字母O
...
DEFINE
    ...
    g_ecu      RECORD LIKE ecu_inplan.*,    #FUN-A50100 移至aecp110.global
    g_ecu_t    RECORD LIKE ecu_inplan.*,
    g_ecu_o    RECORD LIKE ecu_inplan.*,
    g_ecu01_t  LIKE ecu_inplan.ecu01,
    g_ecb03_t  LIKE ecb_inplan.ecb03,
    l_ecu19    LIKE ecb_inplan.ecb19,
    l_ecu18    LIKE ecb_inplan.ecb18,
    l_ecu21    LIKE ecb_inplan.ecb21,
    l_ecu20    LIKE ecb_inplan.ecb20,
    l_ecu38    LIKE ecb_inplan.ecb38,
    l_ecb03    LIKE ecb_inplan.ecb03,
    l_ecb08    LIKE ecb_inplan.ecb08,
    g_ecu02_t  LIKE ecu_inplan.ecu02,
    g_ecu012_t LIKE ecu_inplan.ecu012,       #FUN-A50081
    l_eci01    LIKE eci_file.eci01,
    b_ecb      RECORD LIKE ecb_inplan.*,
    g_ima      RECORD LIKE ima_file.*,
    g_wc,g_wc2,g_sql   string,                     #No.FUN-580092 HCN
    m_ecb      RECORD  LIKE ecb_inplan.*,
    g_ecb           DYNAMIC ARRAY OF RECORD    #程式變數(Program Variables)
        ecb03           LIKE ecb_inplan.ecb03,      #製程序號
        ecb06           LIKE ecb_inplan.ecb06,      #作業編號
        ecb17           LIKE ecb_inplan.ecb17,      #說明
        ecb08           LIKE ecb_inplan.ecb08,      #工作站編號
        eca02           LIKE eca_file.eca02,      #說明
        vmn081          LIKE vmn_file.vmn081,     #資源群組編號(工作站) #TQC-8C0016 add
        ecb07           LIKE ecb_inplan.ecb07,      #機械編號
        vmn08           LIKE vmn_file.vmn08,      #資源群組編號(機器)    #TQC-8C0016 add
        ecb38           LIKE ecb_inplan.ecb38,      #單位人力
        ecb04           LIKE ecb_inplan.ecb04,      #完工比率
        ecb19           LIKE ecb_inplan.ecb19,      #標準人工生產時間
        ecb18           LIKE ecb_inplan.ecb18,      #標準人工設置時間
        ecb21           LIKE ecb_inplan.ecb21,      #標準機械生產時間
        ecb20           LIKE ecb_inplan.ecb20,      #標準機械設置時間
        ecbslk05        LIKE ecb_inplan.ecbslk05,   #現實工價          #No.FUN-810017
        ecbslk04        LIKE ecb_inplan.ecbslk04,   #標准工價          #No.FUN-810017
        ecbslk02        LIKE ecb_inplan.ecbslk02,   #現實工時          #No.FUN-810017
        ecbslk01        LIKE ecb_inplan.ecbslk01,   #裁片管理否        #NO.TQC-BC0166 add
        ecb66           LIKE ecb_inplan.ecb66,      #報工點            #FUN-A80150 add
        ecb39           LIKE ecb_inplan.ecb39,      #委外否
        ecb25           LIKE ecb_inplan.ecb25,      #CHI-C70033
        ecb40           LIKE ecb_inplan.ecb40,      #PQC否
        ecbud02         LIKE ecb_inplan.ecbud02,    #add by guanyao160627
        ecbud03         LIKE ecb_inplan.ecbud03,    #add by guanyao160627
        ecbud04         LIKE ecb_inplan.ecbud04,    #add by guanyao160627
        ecb41           LIKE ecb_inplan.ecb41,      #check in 否
        ecb42           LIKE ecb_inplan.ecb42,      #check in hold
        ecb43           LIKE ecb_inplan.ecb43,      #check out hold
#       ecb44           LIKE ecb_inplan.ecb44,      #FUN-A50081
        ecb45           LIKE ecb_inplan.ecb45,
        ecb46           LIKE ecb_inplan.ecb46,
        ecb51           LIKE ecb_inplan.ecb51,      #FUN-A50081
        ecb14           LIKE ecb_inplan.ecb14,      #FUN-A50081
        ecb52           LIKE ecb_inplan.ecb52,      #FUN-A50081
        ecb53           LIKE ecb_inplan.ecb53,      #FUN-A50081
        ecb48           LIKE ecb_inplan.ecb48,      #FUN-960056
        #ecb49           LIKE ecb_inplan.ecb49,     #FUN-960056 #CHI-C70033
        ecbud01         LIKE ecb_inplan.ecbud01,
        #ecbud02         LIKE ecb_inplan.ecbud02,  #mark by guanyao160627
        #ecbud03         LIKE ecb_inplan.ecbud03,  #mark by guanyao160627
        #ecbud04         LIKE ecb_inplan.ecbud04,  #mark by guanyao160627
        ecbud05         LIKE ecb_inplan.ecbud05,
        ecbud06         LIKE ecb_inplan.ecbud06,
        ecbud07         LIKE ecb_inplan.ecbud07,
        ecbud08         LIKE ecb_inplan.ecbud08,
        ecbud09         LIKE ecb_inplan.ecbud09,
        ecbud10         LIKE ecb_inplan.ecbud10,
        ecbud11         LIKE ecb_inplan.ecbud11,
        ecbud12         LIKE ecb_inplan.ecbud12,
        ecbud13         LIKE ecb_inplan.ecbud13,
        ecbud14         LIKE ecb_inplan.ecbud14,
        ecbud15         LIKE ecb_inplan.ecbud15,
        ecbud16         LIKE ecb_inplan.ecbud16,
        ecbud17         LIKE ecb_inplan.ecbud17
                    END RECORD,
...
DEFINE g_ecb45_t            LIKE ecb_inplan.ecb45     #FUN-BB0083
#FUN-B90117--END--
...
MAIN
   ...
   OPEN WINDOW i300_w AT p_row,p_col WITH FORM "cec/42f/ceci300"
...
#FUN-B90117--begin--
   ...
   CALL i300_tree_fill_1(g_ecu.ecu01,g_ecu.ecu02,g_ecu.ecu012)      #填充树结构
#FUN-B90117--END--
...
#  LET g_forupd_sql = "SELECT * FROM ecu_inplan WHERE ecu01 = ? AND ecu02 =? FOR UPDATE"  #FUN-A50081
   LET g_forupd_sql = "SELECT * FROM ecu_inplan WHERE ecu01 = ? AND ecu02 =? and ecu012 = ? FOR UPDATE"  #FUN-A50081
...
#                     ecb21,ecb20,ecb39,ecb40,ecb41,ecb42,ecb43,ecb44,ecb45,   #FUN-A50081
                      ...
                      ecb46,ecb51,ecb14,ecb52,ecb53,ecb48,ecb25,ecb66 #CHI-C70033
                     ,ecbud01,ecbud02,ecbud03,ecbud04,ecbud05,
                      ecbud06,ecbud07,ecbud08,ecbud09,ecbud10,
                      ecbud11,ecbud12,ecbud13,ecbud14,ecbud15,ecbud16,ecbud17
...
#               s_ecb[1].ecb44,s_ecb[1].ecb45,s_ecb[1].ecb46,   #FUN-A50081
                ...
                s_ecb[1].ecb48,s_ecb[1].ecb25,s_ecb[1].ecb66  #CHI-C70033
               ,s_ecb[1].ecbud01,s_ecb[1].ecbud02,s_ecb[1].ecbud03,
                ...
                s_ecb[1].ecbud16,s_ecb[1].ecbud17
...
#FUN-A50081 --end--
   ...
   IF g_wc2=' 1=1' THEN
      LET g_sql="SELECT ecu01,ecu02,ecu012 FROM ecu_inplan ",             #FUN-A50081 add ecu012
  ...
  #str MOD-A40053 add
   DROP TABLE x
   PREPARE i300_precount_x FROM g_sql
   EXECUTE i300_precount_x
   IF SQLCA.sqlcode THEN
      CALL cl_err('i300_precount_x',SQLCA.sqlcode,1)
      RETURN
   END IF
...
DEFINE l_ecb06  LIKE ecb_inplan.ecb06
...
#FUN-B90117--Begin--
               IF NOT cl_null(g_ecu.ecu01) THEN
                  CALL i300_tree_fill_1(g_ecu.ecu01,g_ecu.ecu02,g_ecu.ecu012)
               END IF
#FUN-B90117--END--
            END IF
         ...
         WHEN "reproduce"
            IF cl_chk_act_auth() THEN
               CALL i300_copy()                 #No.TQC-920031 add
#FUN-B90117--Begin--
               IF NOT cl_null(g_ecu.ecu01) THEN
                  CALL i300_tree_fill_1(g_ecu.ecu01,g_ecu.ecu02,g_ecu.ecu012)
               END IF
...
#FUN-A50081 --end--
         ...
         WHEN "aps_related_data_aps_ecb"
            IF cl_chk_act_auth() THEN
                CALL i300_aps_ecb('Y') #TQC-8C0016 mod
            END IF
...
#str----add by huanglf161027
     ...
     #tianry add 161212
      ...
      SELECT ecb06,COUNT(ecb06)  FROM ecb_inplan  WHERE ecb01 = g_ecu.ecu01  AND ecb02 = g_ecu.ecu02
           GROUP BY ecb06
                ...
                ----更新报工否
{
               ...
               UPDATE ecb_inplan 
                 SET ecb17=(select ecd02 from ecd_file where ecb06=ecd01)
                 WHERE ecb01=g_ecu.ecu01 and ecb02=g_ecu.ecu02 



               UPDATE ecb_inplan 
                 SET ecb08=(select ecd07 from ecd_file where ecb06=ecd01)
                 WHERE ecb01=g_ecu.ecu01 and ecb02=g_ecu.ecu02 
                ...
                IF SQLCA.sqlcode THEN
                    CALL cl_err3("upd","ecu_inplan",g_ecu.ecu01,g_ecu.ecu02,SQLCA.sqlcode,"","ecuud02",1)
                    ROLLBACK WORK
                ELSE
                    COMMIT WORK
                    CALL i300_e_work()  #add by wangxt170209
                    LET g_ecu.ecuud02="Y"
...
INSERT INTO ECU_FILE SELECT * FROM ECU_INPLAN WHERE ecu01=g_ecu.ecu01 and  ecu02=g_ecu.ecu02
INSERT INTO ECB_FILE SELECT * FROM ECB_INPLAN WHERE ecb01=g_ecu.ecu01 and  ecb02=g_ecu.ecu02

UPDATE ECB_FILE 
SET ecbud06='Y' 
 WHERE ecb01=g_ecu.ecu01 AND  ecb02=g_ecu.ecu02 AND ecbud06<>'Y' AND  ecbud04 IS NOT NULL

 
UPDATE ECU_FILE SET ecu10='N'  ,ecuud02='N' WHERE ecu01=g_ecu.ecu01 and ecu02=g_ecu.ecu02
...
#FUN-A50081 --begin--
#FUNCTION i300_chkbom()
#DEFINE l_count       LIKE type_file.num5
#DEFINE l_cnt         LIKE type_file.num5
#DEFINE l_sql         STRING
#DEFINE l_ecu         RECORD LIKE ecu_inplan.*
#
#  LET l_count = 0
#
#  LET g_success = 'Y'
#
#  LET l_sql = "SELECT * FROM ecu_inplan WHERE ecu01 = '",g_ecu.ecu01,"'",
#              " AND ecu02 = '",g_ecu.ecu02,"'"
#  PREPARE i300_chkbom_pb FROM l_sql
#  DECLARE chkbom_curs CURSOR FOR i300_chkbom_pb
#
####no1.
#  FOREACH chkbom_curs INTO l_ecu.*
#     LET l_cnt = 0
#     SELECT COUNT(*) INTO l_cnt FROM ecu_inplan
...
FUNCTION  i300upecb03()
DEFINE l_count       LIKE type_file.num5
DEFINE l_count1       LIKE type_file.num5

SELECT count(*)  INTO l_count FROM ecu_inplan WHERE ecu01=g_ecu.ecu01 AND ecu02=g_ecu.ecu02 AND ( ecu10='Y'  OR ecuud02='Y' )
...
ELSE
  ...
  update ecb_inplan 
  SET ecb03=(select aa  from ( select  rownum*10 aa , ecb03  bb from ecb_inplan   where ecb01=g_ecu.ecu01 AND ecb02=g_ecu.ecu02  order by ecb03 ) where ecb01=g_ecu.ecu01 AND ecb02=g_ecu.ecu02 AND  ecb03=bb )
  where ecb01=g_ecu.ecu01  AND ecb02=g_ecu.ecu02
...
#add by zyq 170910 --start--
FUNCTION i300_stopuse()
    DEFINE l_ecu06 LIKE ecu_inplan.ecu06
    IF g_ecu.ecu06 IS NULL OR g_ecu.ecu06 = 'N' THEN 
        LET l_ecu06 = 'Y'
        BEGIN WORK
          UPDATE ecu_inplan
              SET ecu06=l_ecu06,ecudate = g_today     #FUN-D10063 add ecudate = g_today
              WHERE ecu01=g_ecu.ecu01
              AND ecu02=g_ecu.ecu02
              #AND ecu012 = g_ecu.ecu012   #FUN-A50081
          IF SQLCA.sqlcode THEN
            CALL cl_err3("upd","ecu_inplan",g_ecu.ecu01,g_ecu.ecu02,SQLCA.sqlcode,"","ecu06",1)
            ROLLBACK WORK 
          ELSE 
            COMMIT WORK
          END IF 
          SELECT ecu06 INTO g_ecu.ecu06 FROM ecu_inplan 
              WHERE ecu01=g_ecu.ecu01
              AND ecu02=g_ecu.ecu02
          DISPLAY g_ecu.ecu06 TO FORMONLY.ecu06 
...
FUNCTION i300_a()
    ...
    CLEAR FORM                                   # 清螢幕欄位內容
    CALL g_ecb.clear()
    INITIALIZE g_ecu.* LIKE ecu_inplan.*
    LET g_ecu01_t = NULL
    ...
    LET g_ecu.ecuud02 = 'N'
    LET g_ecu.ecu06 = 'N'                        #add by zyq 170911
    ...
    WHILE TRUE
        ...
        INSERT INTO ecu_inplan VALUES(g_ecu.*)     # DISK WRITE
        IF SQLCA.sqlcode THEN
           CALL cl_err3("ins","ecu_inplan",g_ecu.ecu01,g_ecu.ecu02,SQLCA.sqlcode,"","",1) #FUN-660091
           CONTINUE WHILE
        ELSE
           LET g_ecu_t.* = g_ecu.*               # 保存上筆資料
           SELECT ecu01,ecu02,ecu12 INTO g_ecu.ecu01,g_ecu.ecu02,g_ecu.ecu012 FROM ecu_inplan  #FUN-A50081 add ecu012
...
FUNCTION i300_i(p_cmd)
    ...
    DISPLAY g_ecu.ecuud02 TO FORMONLY.ecuud02 #modify by huanglf160928
    DISPLAY g_ecu.ecu06 TO FORMONLY.ecu06   #add by zyq 170911
...
#str----add by guanyao160627
   ...
   #    WITHOUT DEFAULTS
    INPUT  g_ecu.ecu01, g_ecu.ecu02, g_ecu.ecu03,g_ecu.ecu11,
        g_ecu.ecu012,g_ecu.ecu014,g_ecu.ecu015,  #FUN-A50081 add
        g_ecu.ecuuser,g_ecu.ecugrup,g_ecu.ecumodu,g_ecu.ecudate,g_ecu.ecuacti,
        g_ecu.ecuud01,g_ecu.ecuud02,g_ecu.ecuud03,g_ecu.ecuud04,
        g_ecu.ecuud05,g_ecu.ecuud06,g_ecu.ecuud07,g_ecu.ecuud08,
...
#                   SELECT count(*) INTO g_cnt FROM ecu_inplan
#                    WHERE ecu01 = g_ecu.ecu01 AND ecu02 = g_ecu.ecu02
              ...
              #  IF (g_ecu.ecu012 != g_ecu012_t) OR (g_ecu_t.ecu02 IS NULL) THEN        #MOD-B30520
                 IF (g_ecu.ecu012 != g_ecu012_t) OR (g_ecu012_t IS NULL) THEN           #MOD-B30520
                    ...
                    IF l_cnt1 < = 0 THEN
                       ...
                       NEXT FIELD ecu012
                    END IF
                    CALL i300_ecu014(g_ecu.ecu012) RETURNING g_ecu.ecu014
                 END IF
...
#FUN-B20078 ----------------------End--------------------------
             ...
             #  CALL cl_err('','aec-043',0)             #FUN-B20078
                ...
                NEXT FIELD CURRENT
             END IF
             CALL i300_ecu014(g_ecu.ecu015) RETURNING g_ecr02   #FUN-B20078
...
#FUN-A50081 --end--
        ...
        AFTER INPUT  #判斷必要欄位之值是否有值,若無則反白顯示,並要求重新輸入
           LET g_ecu.ecuuser = s_get_data_owner("ecu_inplan") #FUN-C10039
           LET g_ecu.ecugrup = s_get_data_group("ecu_inplan") #FUN-C10039
...
END FUNCTION
#FUN-B20078 ------------------------------Begin-------------------------------
FUNCTION i300_ecu014(p_ecr01)
DEFINE   p_ecr01     LIKE ecr_file.ecr01
DEFINE   l_ecr02     LIKE ecr_file.ecr02
   DECLARE i300_ecu014_curs CURSOR FOR
    SELECT DISTINCT ecu014 INTO l_ecr02 FROM ecu_inplan
     WHERE ecu01 = g_ecu.ecu01
       AND ecu012 = p_ecr01
   FOREACH i300_ecu014_curs INTO l_ecr02
...
FUNCTION i300_copy()
    DEFINE new_no,old_no   LIKE ecu_inplan.ecu01,
           oecu02,necu02   LIKE ecu_inplan.ecu02,
           oecu012,necu012 LIKE ecu_inplan.ecu012,        #FUN-A50081 add
           ...
           l_cnt           LIKE ecu_inplan.ecu02,         #No.FUN-680073 DECIMAL(4,0)
           l_dir           LIKE type_file.chr1,         #No.FUN-680073 VARCHAR(1)
           l_sql           LIKE type_file.chr1000,       #No.FUN-680073 VARCHAR(400)
           l_ecu014        LIKE ecu_inplan.ecu014         #TQC-B60169


   IF s_shut(0) THEN RETURN END IF
   OPEN WINDOW i300_c_w AT 06,15 WITH FORM "aec/42f/ceci300_c"
         ATTRIBUTE (STYLE = g_win_style CLIPPED) #No.FUN-580092 HCN

   CALL cl_ui_locale("ceci300_c")
  ...
  #TQC-AC0207 --------add end-------------
   ...
   CALL i300_set_entry('a')          #FUN-580024
...
#FUN-AA0059 --End--
   ...
   OPEN i300_cl USING g_ecu.ecu01,g_ecu.ecu02,g_ecu.ecu012   #FUN-A50081 add ecu012
   IF STATUS THEN
      ...
      RETURN
   END IF
   FETCH i300_cl INTO g_ecu.*               # 對DB鎖定
   IF SQLCA.sqlcode THEN
       CALL cl_err('lock ecu:',SQLCA.sqlcode,0)
       CLOSE i300_cl ROLLBACK WORK RETURN
   END IF
   DROP TABLE ecu_tmp
   SELECT * FROM ecu_inplan WHERE ecu01 = old_no
                            AND ecu02 = oecu02
                            AND ecu012 = oecu012         #FUN-A50081 add
     INTO TEMP ecu_tmp
   UPDATE ecu_tmp
   ...
   INSERT INTO ecu_inplan SELECT * FROM ecu_tmp
   IF STATUS THEN
   CALL cl_err3("ins","ecu_inplan",new_no,necu02,STATUS,"","ins ecu",1) #FUN-660091
   RETURN END IF
   DROP TABLE ecb_tmp
   LET l_sql = " SELECT * FROM ecb_inplan ",
               " WHERE ecb01= '",old_no,"' ",
               "   AND ecb02='",oecu02,"'"
   ...
   INSERT INTO ecb_inplan SELECT * FROM ecb_tmp
   IF STATUS THEN
   CALL cl_err3("ins","ecb_inplan",new_no,necu02,STATUS,"","ins ecb",1) #FUN-660091
   RETURN END IF
...
FUNCTION i300_newno(p_newno)  #料件編號
...
FUNCTION i300_fetch(p_flecu)
    DEFINE
        p_flecu         LIKE type_file.chr1,         #No.FUN-680073 VARCHAR(1)
        l_abso          LIKE type_file.chr1          #No.FUN-680073 VARCHAR(1)

    CASE p_flecu
        WHEN 'N' FETCH NEXT     i300_cs INTO g_ecu.ecu01,g_ecu.ecu02,g_ecu.ecu012     #FUN-A50081 add ecu012
        WHEN 'P' FETCH PREVIOUS i300_cs INTO g_ecu.ecu01,g_ecu.ecu02,g_ecu.ecu012     #FUN-A50081 add ecu012
        WHEN 'F' FETCH FIRST    i300_cs INTO g_ecu.ecu01,g_ecu.ecu02,g_ecu.ecu012     #FUN-A50081 add ecu012
        WHEN 'L' FETCH LAST     i300_cs INTO g_ecu.ecu01,g_ecu.ecu02,g_ecu.ecu012     #FUN-A50081 add ecu012
        WHEN '/'
      ...
      ON ACTION controlg      #MOD-4C0121
         CALL cl_cmdask()     #MOD-4C0121
               ...
               END IF
            END IF
            FETCH ABSOLUTE g_jump i300_cs INTO g_ecu.ecu01,g_ecu.ecu02,g_ecu.ecu012     #FUN-A50081 add ecu012
            LET mi_no_ask = FALSE
    END CASE
    ...
    SELECT * INTO g_ecu.* FROM ecu_inplan       # 重讀DB,因TEMP有不被更新特性
       WHERE ecu01 = g_ecu.ecu01
         AND ecu02 = g_ecu.ecu02
         AND ecu012 = g_ecu.ecu012        #FUN-A50081
    IF SQLCA.sqlcode THEN
        CALL cl_err3("sel","ecu_inplan",g_ecu.ecu01,g_ecu.ecu02,SQLCA.sqlcode,"","",1) #FUN-660091
    ELSE
...
DEFINE l_imaud06  LIKE ima_file.imaud06
    ...
    SELECT ima02,ima021,imaud06 INTO l_ima02,l_ima021,l_imaud06
     FROM ima_file
     WHERE ima01 = g_ecu.ecu01
     ...
     #str----add by guanyao160627
    SELECT imaud07,imaud10 INTO g_imaud07,g_imaud10 FROM ima_file WHERE ima01 = g_ecu.ecu01
...
#FUN-B90117--end
    ...
    CALL i300_tree_fill_1(g_ecu.ecu01,g_ecu.ecu02,g_ecu.ecu012)       #FUN-B90117

    CALL i300_show_pic()                      #No.FUN-810017
...
FUNCTION i300_u()
    ...
    #add by zyq 170911 --start--
    IF g_ecu.ecu06 = 'Y' THEN
       CALL cl_err('','170911',0)
       RETURN
    END IF
    #add by zyq 170911 --end--
    ...
    WHILE TRUE
        ...
        END IF 
        #end----add by guanyao160627
        UPDATE ecu_inplan SET ecu_inplan.* = g_ecu.*    # 更新DB
            WHERE ecu01 = g_ecu01_t AND ecu02 = g_ecu02_t             # COLAUTH?
              AND ecu012 = g_ecu012_t     #FUN-A50081
        IF SQLCA.sqlcode THEN
            CALL cl_err3("upd","ecu_inplan",g_ecu01_t,g_ecu02_t,SQLCA.sqlcode,"","",1) #FUN-660091
            CONTINUE WHILE
        END IF
        EXIT WHILE
    END WHILE
...
FUNCTION i300_r()
    ...
    OPEN i300_cl USING g_ecu.ecu01,g_ecu.ecu02,g_ecu.ecu012   #FUN-A50081
    IF STATUS THEN
       CALL cl_err("OPEN i300_cl:", STATUS, 1)
       CLOSE i300_cl
       ROLLBACK WORK
    ...
    IF cl_delh(15,21) THEN
        ...
        DELETE FROM ecu_inplan WHERE ecu01 = g_ecu.ecu01 AND ecu02 = g_ecu.ecu02
   #FUN-A50081 --begin--
                               AND ecu012 = g_ecu.ecu012
    ...
    #FUN-A50081  --end--
        IF STATUS THEN
        CALL cl_err3("del","ecu_inplan",g_ecu.ecu01,g_ecu.ecu02,STATUS,"","del ecu:",1) #FUN-660091
        RETURN END IF

        DELETE FROM ecb_inplan WHERE ecb01 = g_ecu.ecu01 AND ecb02 = g_ecu.ecu02
                               AND ecb012 = g_ecu.ecu012       #FUN-A50081
        IF STATUS THEN
        CALL cl_err3("del","ecb_inplan",g_ecu.ecu01,g_ecu.ecu02,STATUS,"","del ecb:",1) #FUN-660091
        RETURN END IF
...
#       IF cl_confirm('aap-222') THEN  #CHI-C30107 mark
            ...
            UPDATE ima_file SET ima571 = g_ecu.ecu01,
                                ima94  = g_ecu.ecu02
                          WHERE ima01 = g_ecu.ecu01  and ima08='M'
            IF SQLCA.sqlcode THEN
               CALL cl_err3("upd","ima_file",g_ecu.ecu01,g_ecu.ecu02,SQLCA.sqlcode,"","ima571",1)
               ROLLBACK WORK
               RETURN 
            ...
            WHERE ecu01=g_ecu.ecu01
              AND ecu02=g_ecu.ecu02
               AND ecu012 = g_ecu.ecu012   #FUN-A50081
        IF SQLCA.sqlcode THEN
            CALL cl_err3("upd","ecu_inplan",g_ecu.ecu01,g_ecu.ecu02,SQLCA.sqlcode,"","ecu10",1)
            ROLLBACK WORK
        ELSE
            COMMIT WORK
            LET g_ecu.ecu10="Y"
...
FUNCTION i300_show_pic()
      CALL cl_set_field_pic1(g_ecu.ecuud02,"","","","",g_ecu.ecuacti,"","")   #modify by huanglf160928
END FUNCTION
...
DEFINE  l_ecb06      LIKE ecb_inplan.ecb06         #TQC-940179 ADD
DEFINE  l_ecb03      LIKE ecb_inplan.ecb03         #TQC-940179 ADD
DEFINE  l_ecu01      LIKE ecu_inplan.ecu01         #TQC-940179 ADD
DEFINE  l_ecu02      LIKE ecu_inplan.ecu02         #TQC-940179 ADD
...
DEFINE  l_ima55      LIKE ima_file.ima55         #MOD-D20118
    ...
    IF g_ecu.ecu06 = 'Y' THEN RETURN END IF #ADD BY ZYQ 170911
    CALL cl_opmsg('b')

    LET g_forupd_sql =
        "SELECT ecb03,ecb06,ecb17,ecb08,' ','',ecb07,'',ecb38,ecb04,ecb19,ecb18,",
        "       ecb21,ecb20,'','','','',ecb66,ecb39,ecb25,ecb40,ecbud02,ecbud03,ecbud04,ecb41,",                        #No.FUN-810017   #FUN-A80150 add ecb66 #No.TQC-BC0166 add #CHI-C70033 acb25
#       "       ecb42,ecb43,ecb44,ecb45,ecb46,ecb48,ecb49",                      #No.FUN-810017 #FUN-960056  #FUN-A50081
    ...
    INPUT ARRAY g_ecb WITHOUT DEFAULTS FROM s_ecb.*
        ...
        BEFORE ROW
            ...
            OPEN i300_cl USING g_ecu.ecu01,g_ecu.ecu02,g_ecu.ecu012   #FUN-A50081 add ecu012
            IF STATUS THEN
               CALL cl_err("OPEN i300_cl_b:", STATUS, 1)
               CLOSE i300_cl
               ROLLBACK WORK
               RETURN
            ELSE
            ...
            IF g_rec_b >= l_ac THEN
                ...
                OPEN i300_bcl USING g_ecu.ecu01,g_ecu.ecu02,g_ecb_t.ecb03,g_ecu.ecu012  #FUN-A50081 add ecu012
                IF STATUS THEN
                   CALL cl_err("OPEN i300_bcl:", STATUS, 1)
                   LET l_lock_sw = "Y"
                ELSE
                   FETCH i300_bcl INTO g_ecb[l_ac].*
                   IF SQLCA.sqlcode THEN
...
#FUN-A50081 --end--
        ...
        AFTER INSERT
           ...
           #END IF
           #FUN-9A0047---mark---end---
            INSERT INTO ecb_inplan(ecb01,ecb02,ecb03,ecb06,ecb17,
...
#                                ecb44,ecb45,ecb46,  #FUN-A50081
                                 ...
                                 ecbud13,ecbud14,ecbud15,ecbud16,ecbud17,ecb012)   #FUN-A50081 add ecb012
...
#                                g_ecb[l_ac].ecb44,g_ecb[l_ac].ecb45,  #FUN-A50081
                                 ...
                                 g_ecb[l_ac].ecbud13,
                                 g_ecb[l_ac].ecbud14,
                                 g_ecb[l_ac].ecbud15, g_ecb[l_ac].ecbud16, g_ecb[l_ac].ecbud17,
                                 g_ecu.ecu012)           #FUN-A50081 add ecu012

            IF SQLCA.sqlcode THEN
               CALL cl_err3("ins","ecb_inplan",g_ecu.ecu01,g_ecu.ecu02,STATUS,"","ins ecb:",1) #FUN-660091
               CANCEL INSERT
            ELSE
               MESSAGE 'INSERT O.K'
          ...
          BEFORE FIELD ecb03
            IF cl_null(g_ecb[l_ac].ecb03) OR g_ecb[l_ac].ecb03 = 0 THEN
               SELECT max(ecb03) INTO g_ecb[l_ac].ecb03 FROM ecb_inplan   #FUN-960063
          ...
          AFTER FIELD ecb03
            IF NOT cl_null(g_ecb[l_ac].ecb03) THEN
               IF g_ecb[l_ac].ecb03 != g_ecb_t.ecb03
                  ...
                  SELECT count(*) INTO l_n FROM ecb_inplan
                   WHERE ecb01 = g_ecu.ecu01
                     AND ecb02 = g_ecu.ecu02
       ...
       #FUN-A80150---add---end---
        ...
        AFTER FIELD ecb42
            IF NOT cl_null(g_ecb[l_ac].ecb42) THEN
               CALL i300_sgg(g_ecb[l_ac].ecb42)
               IF NOT cl_null(g_errno) THEN
                  CALL cl_err('',g_errno,0)
        ...
        AFTER FIELD ecb43
            IF NOT cl_null(g_ecb[l_ac].ecb43) THEN
               CALL i300_sgg(g_ecb[l_ac].ecb43)
               IF NOT cl_null(g_errno) THEN
                  CALL cl_err('',g_errno,0)
...
#str-----------mark by guanyao160524
               ...
               IF l_ac = 1 THEN 
                  CALL i300_umfchk(g_ecu.ecu01,l_ima55,g_ecb[l_ac].ecb45)
                     RETURNING l_cnt,l_fac,g_ecb[l_ac].ecb46,g_ecb[l_ac].ecb51
               ELSE 
                  CALL i300_umfchk(g_ecu.ecu01,g_ecb[l_ac-1].ecb45,g_ecb[l_ac].ecb45)
                     RETURNING l_cnt,l_fac,g_ecb[l_ac].ecb46,g_ecb[l_ac].ecb51
               END IF 
...
#FUN-A50081 --end--
       ...
       AFTER FIELD ecb25  #CHI-C70033
        ...
        AFTER FIELD ecbud04
        #str---add by huanglf170313
           IF NOT cl_null(g_ecb[l_ac].ecbud04) THEN
                CALL i300_ecbud04(g_ecb[l_ac].ecbud04)
                IF g_success = 'N' THEN
        ...
        BEFORE DELETE                            #是否取消單身
            IF g_ecb_t.ecb03 IS NOT NULL THEN
                ...
                DELETE FROM ecb_inplan
                 WHERE ecb01 = g_ecu.ecu01 AND ecb02 = g_ecu.ecu02
                   AND ecb03 = g_ecb_t.ecb03
                   AND ecb012 = g_ecu.ecu012    #FUN-A50081
                IF SQLCA.sqlcode THEN
                   CALL cl_err3("del","ecb_inplan",g_ecu.ecu01,g_ecu.ecu02,SQLCA.sqlcode,"","",1) #FUN-660091
                   ROLLBACK WORK
                   CANCEL DELETE
                ELSE
        ...
        ON ROW CHANGE
           ...
           #FUN-9A0047 mark---end----
            IF l_lock_sw = 'Y' THEN
               ...
               LET g_ecb[l_ac].* = g_ecb_t.*
            ELSE
               UPDATE ecb_inplan SET ecb03=g_ecb[l_ac].ecb03,
...
#                                  ecb44=g_ecb[l_ac].ecb44,  #FUN-A50081
                    ...
                    #FUN-A50081 --end--
                                   ...
                                   ecbud16 = g_ecb[l_ac].ecbud16,
                                   ecbud17 = g_ecb[l_ac].ecbud17
                ...
                WHERE ecb01=g_ecu.ecu01
                  ...
                  AND ecb012 = g_ecu.ecu012   #FUN-A50081
               IF SQLCA.sqlcode THEN
                  CALL cl_err3("upd","ecb_inplan",g_ecu.ecu01,g_ecu.ecu02,SQLCA.sqlcode,"","",1) #FUN-660091
                  LET g_ecb[l_ac].* = g_ecb_t.*
                  ROLLBACK WORK
               ELSE
                  IF NOT cl_null(g_sma.sma901) AND g_sma.sma901 = 'Y' THEN
        ...
        AFTER INPUT
        IF NOT cl_null(g_sma.sma901) AND g_sma.sma901 = 'Y' THEN
            CALL i300_chk_aps() RETURNING l_sw_aps
            IF l_sw_aps THEN
                CONTINUE INPUT
            END IF
        END IF
...
#FUN-A50081 --end--
    ...
    UPDATE ecu_inplan SET ecumodu=g_user,
                        ecudate=TODAY
     WHERE ecu01=g_ecu.ecu01 AND ecu02=g_ecu.ecu02
       AND ecu012 = g_ecu.ecu012  #FUN-A50081 add
...
FUNCTION i300_delHeader()
   IF g_rec_b = 0 THEN
      IF cl_confirm("9042") THEN
         DELETE FROM ecu_inplan WHERE ecu01=g_ecu.ecu01
                                AND ecu02=g_ecu.ecu02
                                AND ecu012 = g_ecu.ecu012
         INITIALIZE g_ecu.* TO NULL
         CLEAR FORM
...
FUNCTION i300_b_total(p_cmd)
  DEFINE  p_cmd    LIKE type_file.chr1           #No.FUN-680073 VARCHAR(01)
    SELECT MIN(ecb03),MAX(ecb03) INTO g_ecu.ecu04,g_ecu.ecu05 FROM ecb_inplan
     WHERE ecb01=g_ecu.ecu01 AND ecb02=g_ecu.ecu02
      AND ecb012 = g_ecu.ecu012   #FUN-A50081
    ...
    IF p_cmd ='u' THEN
       UPDATE ecu_inplan SET ecu04=g_ecu.ecu04,
                           ecu05=g_ecu.ecu05,
...
IF cl_null(g_wc2) THEN LET g_wc2=' 1=1' END IF  #No.FUN-810017
    LET g_sql =
        "SELECT ecb03,ecb06,ecb17,ecb08,' ',' ',ecb07,' ',ecb38,ecb04,ecb19,ecb18,",
        " ecb21,ecb20,'','','','',ecb66,ecb39,ecb25,ecb40,ecbud02,ecbud03,ecbud04,ecb41,",      #No.FUN-810017    #FUN-A80150 add ecb66 #No.TQC-BC0166 add '' #CHI-C70033 ecb25
#       " ecb42,ecb43,ecb44,ecb45,ecb46,ecb48,ecb49,",   #No.FUN-810017   #MOD-A40053 add ecb48,ecb49 #FUN-A50081
        #" ecb42,ecb43,ecb45,ecb46,ecb51,ecb14,ecb52,ecb53,ecb48,ecb49,",         #FUN-A50081 #CHI-C70033
        " ecb42,ecb43,ecb45,ecb46,ecb51,ecb14,ecb52,ecb53,ecb48,",  #CHI-C70033
       # " ecbud01,ecbud02,ecbud03,ecbud04,ecbud05,",  #mark by guanyao160627
        " ecbud01,ecbud05,",    #add by guanyao160627
        " ecbud06,ecbud07,ecbud08,ecbud09,ecbud10,",
        " ecbud11,ecbud12,ecbud13,ecbud14,ecbud15,ecbud16,ecbud17",
        " FROM ecb_inplan",
        " WHERE ecb01 ='",g_ecu.ecu01,"'",
    ...
    DECLARE ecb_curs CURSOR FOR i300_pb
...
#填充树
FUNCTION i300_tree_fill_1(p_ecu01,p_ecu02,p_ecu012)
DEFINE p_level      LIKE type_file.num5,
       l_child      INTEGER
DEFINE p_ecu01        LIKE ecu_inplan.ecu01
DEFINE p_ecu02        LIKE ecu_inplan.ecu02
DEFINE p_ecu012       LIKE ecu_inplan.ecu012

   INITIALIZE g_tree TO NULL
    LET p_level = 0
    LET g_idx = 0

   CALL i300_tree_fill_2(NULL,p_level,p_ecu01,p_ecu02,p_ecu012)
END FUNCTION

#填充树的父亲节点
FUNCTION i300_tree_fill_2(p_pid,p_level,p_ima01,p_ecu02,p_ecu012)
DEFINE p_level           LIKE type_file.num5,
       p_pid             STRING,
       l_child           INTEGER
...
DEFINE l_ecu          DYNAMIC ARRAY OF RECORD
            ecu012      LIKE ecu_inplan.ecu012,
            ecu014      LIKE ecu_inplan.ecu014
            END RECORD
DEFINE l_cnt           LIKE type_file.num5
DEFINE l_ecb03         LIKE ecb_inplan.ecb03
DEFINE l_ecb06         LIKE ecb_inplan.ecb06
DEFINE l_ecb17         LIKE ecb_inplan.ecb17
DEFINE l_n             LIKE type_file.num10
DEFINE l_n1            LIKE type_file.num10

   LET g_sql = "SELECT ecu012,ecu014 FROM ecu_inplan LEFT OUTER JOIN ecr_file",
               "    ON ecu012 = ecr01 ",
   ...
   PREPARE i300_tree_pre1 FROM g_sql
   DECLARE i300_tree_cs1 CURSOR FOR i300_tree_pre1
   LET l_loop = 1
   LET l_cnt = 1
   LET p_level = p_level + 1
   CALL l_ecu.clear()

   FOREACH i300_tree_cs1 INTO l_ecu[l_cnt].*
      IF SQLCA.sqlcode THEN
          CALL cl_err('FOREACH:',SQLCA.sqlcode,1)
          EXIT FOREACH
      END IF
   ...
   IF l_cnt >0 THEN
      FOR l_loop=1 TO l_cnt
          ...
          ###填充单身的内容到树结构###
          LET g_sql = "SELECT ecb03,ecb06,ecb17 FROM ecb_inplan WHERE ecb01='",p_ima01,"' ",
                      " AND ecb02='",p_ecu02,"' ",
          ...
          SELECT COUNT(*) INTO l_child FROM ecu_inplan
          ...
          IF l_child > 0  THEN
             ...
             LET g_idx=l_n1
             CALL i300_tree_fill(l_ecu[l_loop].ecu012,g_tree[g_idx].desc,p_level,g_idx,p_ecu02)
          ELSE
             IF l_n1>g_idx THEN
                LET g_tree[g_idx].has_children = TRUE
             END IF
...
#填充子节点
FUNCTION i300_tree_fill(p_pid,p_tex,p_level,p_idx,p_ecu02)
...
DEFINE l_n1            LIKE type_file.num10
   ...
   PREPARE i300_tree_pre2 FROM g_sql
   DECLARE i300_tree_cs2 CURSOR FOR i300_tree_pre2

   LET l_cnt = 1
   CALL l_ecu.clear()
   FOREACH i300_tree_cs2 INTO l_ecu[l_cnt].*
      IF SQLCA.sqlcode THEN
          CALL cl_err('FOREACH:',SQLCA.sqlcode,1)
          EXIT FOREACH
      END IF
   ...
   LET l_cnt = l_cnt - 1
      IF l_cnt >0 THEN
         FOR l_i=1 TO l_cnt
            ...
            LET g_tree[g_idx].chk = 'N'
          ###填充单身的内容到树结构###
          LET g_sql = "SELECT ecb03,ecb06,ecb17 FROM ecb_inplan WHERE ecb01='",p_tex,"' ",
                      " AND ecb02='",p_ecu02,"' ",
          ...
          ###填充单身的内容到树结构###
            ...
            IF l_child > 0 THEN
               LET g_tree[g_idx].has_children = TRUE
               LET g_idx=l_n1
              #CALL i300_tree_fill(g_tree[g_idx].id,g_tree[g_idx].desc,p_level,g_idx,p_ecu02)  #MOD-D50279
               CALL i300_tree_fill(g_tree[g_idx].pid,g_tree[g_idx].desc,p_level,g_idx,p_ecu02) #MOD-D50279
            ELSE
               IF l_n1>g_idx THEN
                  LET g_tree[g_idx].has_children = TRUE
               END IF
      ...
      DISPLAY ARRAY g_tree TO tree.*
         ...
         BEFORE ROW
           ...
           IF g_tree[g_curr_idx].chk='N' THEN
              ...
              SELECT * INTO g_ecu.* FROM ecu_inplan
               WHERE ecu01=g_ecu.ecu01
                 AND ecu02=g_ecu.ecu02
                 AND ecu012=g_ecu.ecu012
              CALL i300_show()
...
#str----end by huanglf161011
        ...
        #str----add by ly170809
        ON ACTION  upecb03
           LET g_action_choice="upecb03"
           EXIT DIALOG
        #end----add by ly170809
        #add by zyq 1709010 --start--
        ON ACTION stopuse
...
FUNCTION i300_ecb06(p_cmd)
DEFINE p_cmd        LIKE type_file.chr1,         #No.TQC-6A0065
    l_ecdacti       LIKE ecd_file.ecdacti
DEFINE l_cnt        SMALLINT

    LET g_errno = ' '   #tianry add 170105
       SELECT ecd01,ecd02,ecd07,ta_ecd02,ecdacti,ta_ecd05 INTO  #add ta_ecd02 by guanyao160704
              g_ecb[l_ac].ecb06,g_ecb[l_ac].ecb17,g_ecb[l_ac].ecb08,g_ecb[l_ac].ecb39,l_ecdacti,g_ecb[l_ac].ecbud06 #add ecb39 by guanyao160704
         FROM ecd_file
       ...
       CASE WHEN SQLCA.SQLCODE = 100  LET g_errno = 'aec-015'
                                      ...
                                      #-----No.MOD-530167 END--------
                                      LET g_ecb[l_ac].ecb39 = 'N' #add by guanyao160704
            WHEN l_ecdacti='N' LET g_errno = '9028'
            OTHERWISE          LET g_errno = SQLCA.SQLCODE USING '-------'
       END CASE

       SELECT COUNT(*) INTO l_cnt FROM ecb_inplan WHERE ecb01=g_ecu.ecu01 AND ecb02=g_ecu.ecu02
          AND ecb06=g_ecb[l_ac].ecb06 AND ecb03 <> g_ecb[l_ac].ecb03
       IF l_cnt > 0 THEN
          LET g_errno = 'csf-033'
       END IF
       DISPLAY BY NAME g_ecb[l_ac].ecb06
       ...
       DISPLAY BY NAME g_ecb[l_ac].ecb08
       DISPLAY BY NAME g_ecb[l_ac].ecb39   #add by guanyao160704

END FUNCTION

FUNCTION i300_ecb08(p_cmd)
DEFINE p_cmd          LIKE type_file.chr1,         #No.FUN-680073 VARCHAR(01)
...
FUNCTION i300_ecu01(p_cmd)  #料件編號
    DEFINE l_ima02   LIKE ima_file.ima02,
           l_ima021  LIKE ima_file.ima021,
           l_imaacti LIKE ima_file.imaacti,
           p_cmd     LIKE type_file.chr1         #No.FUN-680073 VARCHAR(1)
...
FUNCTION i300_aps_ecb(p_cmd) #TQC-8C0016 加入參數p_cmd
...
#TQC-AC0245 ---------------------------End-----------------------------------------
       ...
       #str----mark by guanyao160811
        ...
        #            ' "" "',g_lang,'" "Y" "" "" ',
        #            '"',g_wc CLIPPED,'"',' "N" "Y" "Y" "Y" "" "" "" "ceci300" "Y"' CLIPPED
        #CALL cl_cmdrun(l_cmd)
        --LET l_cmd = 'cecr002',
                              --" '",g_today CLIPPED,"' ''",
...
#FUN-9A0047---add----str----
FUNCTION i300_chk_aps()
 DEFINE l_aps_err LIKE type_file.chr1
 DEFINE l_vmn08   LIKE vmn_file.vmn08
 DEFINE l_ecb     RECORD LIKE ecb_inplan.*

  CALL s_showmsg_init()
  DECLARE i300_chk_aps CURSOR FOR
     SELECT *
       FROM ecb_inplan
      WHERE ecb01 = g_ecu.ecu01
        AND ecb02 = g_ecu.ecu02
  ...
  LET l_aps_err = 'N'
  FOREACH i300_chk_aps INTO l_ecb.*
    IF SQLCA.SQLCODE THEN
...
#FUN-9A0047---add----end----
#FUN-B90141 --START--            
FUNCTION i300_chk_ecu51()
DEFINE l_flag   LIKE type_file.chr1
DEFINE l_fac    LIKE type_file.num26_10
DEFINE l_fac2   LIKE type_file.num26_10
DEFINE l_ima55  LIKE ima_file.ima55
DEFINE l_ecb51  LIKE ecb_inplan.ecb51  #add by guanyao160524
DEFINE l_ecb46  LIKE ecb_inplan.ecb46  #add by guanyao160524
...
#str-----mark by guanyao160524   
   ...
   #END IF  
   IF l_ac = 1 THEN 
      CALL i300_umfchk(g_ecu.ecu01,g_ecb[l_ac].ecb45,l_ima55)
                            RETURNING l_flag,l_fac,l_ecb46,l_ecb51
   ELSE 
      CALL i300_umfchk(g_ecu.ecu01,g_ecb[l_ac].ecb45,g_ecb[l_ac-1].ecb45)
                            RETURNING l_flag,l_fac,l_ecb46,l_ecb51
   END IF
#end-----mark by guanyao160524   
...
DEFINE l_chr LIKE type_file.chr1
    ...
    OPEN i300_cl USING g_ecu.ecu01,g_ecu.ecu02,g_ecu.ecu012 
    IF STATUS THEN
       CALL cl_err("OPEN i300_cl:", STATUS, 1)
       CLOSE i300_cl
       ROLLBACK WORK
...
FUNCTION i300_umfchk(p_item,p_1,p_2)
...
DEFINE l_ecu01,l_ecu01_o LIKE ecu_inplan.ecu01   
DEFINE l_ecu02,l_ecu02_o LIKE ecu_inplan.ecu02 
   ...
   CREATE TEMP TABLE ecu_tmp (
         p_ecu01    LIKE ecu_inplan.ecu01,
         p_ecu02    LIKE ecu_inplan.ecu02,
         p_ecb03    LIKE ecb_inplan.ecb03)
      ...
      IF iRes <> -1 THEN
         ...
         FOR i=2 TO l_iRow
            ...
            IF NOT cl_null(l_ecu01) THEN 
               ...
               LET l_z = 1
               INSERT INTO ecu_tmp VALUES(l_ecu01,l_ecu02,l_z)
         ...
         FOR i=2 TO iRow                           
            ...
            IF cl_null(l_ecu.ecu01) OR cl_null(l_ecu.ecu02) THEN 
              CONTINUE FOR  
            ELSE 
               SELECT COUNT(*) INTO l_x FROM ecu_inplan WHERE ecu01 = l_ecu.ecu01 AND ecu02 = l_ecu.ecu02
               IF l_x > 0 THEN 
                  LET g_success= 'N'                               
            ...
            INSERT INTO ecu_inplan VALUES (l_ecu.*)
            IF SQLCA.sqlcode THEN   			#置入資料庫不成功
               LET g_success='N'
               CALL s_errmsg("ins ecu_inplan",l_ecu.ecu01||';'||l_ecu.ecu02,'',SQLCA.sqlcode,1)
            END IF
            #end----栏位取值--写ecu表
            ...
            FOR j=i TO l_y
               ...
               CALL ui.interface.frontCall('WinCOM','GetProperty',[xlApp,'ActiveSheet.Cells('||j||',8).Value'],[l_ecb.ecb38])
               CALL ui.interface.frontCall('WinCOM','GetProperty',[xlApp,'ActiveSheet.Cells('||j||',9).Value'],[l_ecb.ecb07])
               CALL ui.interface.frontCall('WinCOM','GetProperty',[xlApp,'ActiveSheet.Cells('||j||',10).Value'],[l_ecb.ecb04])
               CALL ui.interface.frontCall('WinCOM','GetProperty',[xlApp,'ActiveSheet.Cells('||j||',11).Value'],[l_ecb.ecb19])
               CALL ui.interface.frontCall('WinCOM','GetProperty',[xlApp,'ActiveSheet.Cells('||j||',12).Value'],[l_ecb.ecb18])
               CALL ui.interface.frontCall('WinCOM','GetProperty',[xlApp,'ActiveSheet.Cells('||j||',13).Value'],[l_ecb.ecb21])
               CALL ui.interface.frontCall('WinCOM','GetProperty',[xlApp,'ActiveSheet.Cells('||j||',14).Value'],[l_ecb.ecb20])
               CALL ui.interface.frontCall('WinCOM','GetProperty',[xlApp,'ActiveSheet.Cells('||j||',15).Value'],[l_ecb.ecb39])
               CALL ui.interface.frontCall('WinCOM','GetProperty',[xlApp,'ActiveSheet.Cells('||j||',16).Value'],[l_ecb.ecb25])
               CALL ui.interface.frontCall('WinCOM','GetProperty',[xlApp,'ActiveSheet.Cells('||j||',17).Value'],[l_ecb.ecb40])
               CALL ui.interface.frontCall('WinCOM','GetProperty',[xlApp,'ActiveSheet.Cells('||j||',18).Value'],[l_ecb.ecb41])
               CALL ui.interface.frontCall('WinCOM','GetProperty',[xlApp,'ActiveSheet.Cells('||j||',19).Value'],[l_ecb.ecb42])
               CALL ui.interface.frontCall('WinCOM','GetProperty',[xlApp,'ActiveSheet.Cells('||j||',20).Value'],[l_ecb.ecb43])
               CALL ui.interface.frontCall('WinCOM','GetProperty',[xlApp,'ActiveSheet.Cells('||j||',21).Value'],[l_ecb.ecb45])
               CALL ui.interface.frontCall('WinCOM','GetProperty',[xlApp,'ActiveSheet.Cells('||j||',22).Value'],[l_ecb.ecb46])
               CALL ui.interface.frontCall('WinCOM','GetProperty',[xlApp,'ActiveSheet.Cells('||j||',23).Value'],[l_ecb.ecb51])
               ...
               LET l_ecb.ecb012 = ' '     
               INSERT INTO ecb_inplan VALUES (l_ecb.*)
               IF SQLCA.sqlcode THEN   			#置入資料庫不成功
                  LET g_success='N'
                  CALL s_errmsg("ins ecb_inplan",l_ecb.ecb01||';'||l_ecb.ecb02||';'||l_ecb.ecb03,'',SQLCA.sqlcode,1)
               END IF
            END FOR 
         END FOR 
         CALL ui.interface.frontCall('WinCOM','CallMethod',[xlApp,'Quit'],[iRes])
...
DEFINE l_bmb09     LIKE bmb_file.bmb09
    ...
    END IF
    LET l_x = 0
    SELECT COUNT(*) INTO l_x FROM ecb_inplan WHERE ecb01 =g_ecu.ecu01 AND ecbud04 IS NOT NULL 
    IF l_x >0 THEN 
       LET l_sql = "SELECT ecb06,ecbud04 FROM ecb_inplan",
                   " WHERE ecb01 ='",g_ecu.ecu01,"' ",
...
#str---add by huanglf170313
FUNCTION i300_ecbud04(g_ecbud04)
DEFINE l_sql,l_sql1      STRING 
DEFINE l_ecb06     LIKE ecb_inplan.ecb06
DEFINE l_ecbud04   LIKE ecb_inplan.ecbud04
DEFINE l_ecbud04_1 LIKE ecb_inplan.ecbud04
DEFINE l_ecbud04_2 LIKE ecb_inplan.ecbud04
DEFINE lst_token base.StringTokenizer
...
DEFINE l_bmb09     LIKE bmb_file.bmb09
DEFINE l_num       LIKE type_file.num5
DEFINE g_ecbud04   LIKE ecb_inplan.ecbud04   
    IF g_ecu.ecu01 IS NULL THEN 
       CALL cl_err('',-400,0) 
       RETURN 
    END IF 

    CALL ceci300_temp_table()
    LET g_success = 'Y'

    
       LET l_sql = "SELECT ecbud04 FROM ecb_inplan",
                   " WHERE ecb01 ='",g_ecu.ecu01,"' ",
                   "   AND ecb02 = '",g_ecu.ecu02,"' ",
                   "   AND ecbud04 is not null",
                   " ORDER BY ecb03"
       ...
       FOREACH bmb_e_curs1 INTO l_ecbud04   
          ...
          WHILE lst_token.hasMoreTokens()
             ...
             SELECT COUNT(*) INTO l_num FROM ceci300_tmp WHERE ecbud04 = l_ecbud04_1
             IF l_num =0 OR cl_null(l_num) THEN
                 INSERT INTO ceci300_tmp VALUES(l_ecbud04_1)
             ELSE 
                 LET g_success = 'N'
             END IF 
          END WHILE
      ...
      IF NOT cl_null(g_ecbud04) THEN
          LET lst_token1 = base.StringTokenizer.create(g_ecbud04, "|")
          WHILE lst_token1.hasMoreTokens()
             LET l_ecbud04_2 = lst_token1.nextToken()
             SELECT COUNT(*) INTO l_num FROM ceci300_tmp WHERE ecbud04 = l_ecbud04_2
             IF l_num = 0 OR cl_null(l_num) THEN
                 INSERT INTO ceci300_tmp VALUES(l_ecbud04_2)
             ELSE 
                 LET g_success = 'N'
             END IF 
          END WHILE
...
FUNCTION ceci300_temp_table()
DEFINE l_sql    STRING 
  DROP TABLE ceci300_tmp
  CREATE TEMP TABLE ceci300_tmp(    
        ecbud04   LIKE ecb_inplan.ecbud04)     
END FUNCTION
