...
# DEFINE      l_time    LIKE type_file.chr8            #No.FUN-6A0068
   ...
   LET g_argv2=ARG_VAL(2)   #執行功能   #FUN-7C0050
    ...
    OPEN WINDOW t001_w33 AT 2,2 WITH FORM "cec/42f/cecq012"
   ...
   #--
    ...
    DROP TABLE cect001_tmp_try #add by guanyao160930
...
DEFINE
   #p_wc1           VARCHAR(200) #TQC-630166     
    ...
    LET g_sql=" SELECT sgm03,sgm04,ecd02,sgm01,sgm02,sfb05,   '','',l_sum1,l_sum2,l_sum3,l_sum6,l_sum4,l_sum5,l_sum7,l_sum10 
                FROM cect001_tmp_try  WHERE l_sum7!=0"
...
DEFINE
   #p_wc2           VARCHAR(200) #TQC-630166 
    ...
    LET g_sql = "SELECT sgm02,sgm04,sfb05,ima02,ima021,ecbud09,sum(l_sum7) FROM cect001_tmp_try ",
...
DEFINE  l_imaud10    LIKE ima_file.imaud10,
    ...
    LET g_sql = "SELECT DISTINCT sfb05,ima02,ima021,ecbud09  FROM cect001_tmp_try  "
               
    PREPARE t001_pb3 FROM g_sql
    DECLARE tc_imd_curs3 CURSOR FOR t001_pb3
  
    #SELECT  l_sum7 INTO l_sum7 FROM cect001_tmp_try WHERE ROWNUM=1 AND sgm03=270
    CALL g_tc_imb_2.clear()
    LET l_ac = 1   
    ...
    FOREACH tc_imd_curs3 INTO g_tc_imb_2[l_ac].sfb05_2,g_tc_imb_2[l_ac].ima02_2,g_tc_imb_2[l_ac].ima021d,g_tc_imb_2[l_ac].ecbud09,l_aaa
       ...
       FOR i=1 TO 50
         IF i=1 THEN
            SELECT SUM(NVL(l_sum7,0)) INTO g_tc_imb_2[l_ac].d1 FROM cect001_tmp_try,cect_try
         ...
         END IF     
         IF i=2 THEN
            SELECT SUM(NVL(l_sum7,0)) INTO g_tc_imb_2[l_ac].d2 FROM cect001_tmp_try,cect_try
            WHERE nu=i AND ecd07=sgm06 AND sfb05=g_tc_imb_2[l_ac].sfb05_2 AND ecbud09=g_tc_imb_2[l_ac].ecbud09
            IF NOT cl_null(l_imaud10) THEN
         ...
         END IF
         IF i=3 THEN
            SELECT SUM(NVL(l_sum7,0)) INTO g_tc_imb_2[l_ac].d3 FROM cect001_tmp_try,cect_try
            WHERE nu=i AND ecd07=sgm06 AND sfb05=g_tc_imb_2[l_ac].sfb05_2 AND ecbud09=g_tc_imb_2[l_ac].ecbud09
            IF NOT cl_null(l_imaud10) THEN
         ...
         END IF
         IF i=4 THEN
            SELECT SUM(NVL(l_sum7,0)) INTO g_tc_imb_2[l_ac].d4 FROM cect001_tmp_try,cect_try
            WHERE nu=i AND ecd07=sgm06 AND sfb05=g_tc_imb_2[l_ac].sfb05_2 AND ecbud09=g_tc_imb_2[l_ac].ecbud09
            IF NOT cl_null(l_imaud10) THEN
         ...
         END IF
         IF i=5 THEN
            SELECT SUM(NVL(l_sum7,0)) INTO g_tc_imb_2[l_ac].d5 FROM cect001_tmp_try,cect_try
            WHERE nu=i AND ecd07=sgm06 AND sfb05=g_tc_imb_2[l_ac].sfb05_2 AND ecbud09=g_tc_imb_2[l_ac].ecbud09
            IF NOT cl_null(l_imaud10) THEN
         ...
         END IF
         IF i=6 THEN
            SELECT SUM(NVL(l_sum7,0)) INTO g_tc_imb_2[l_ac].d6 FROM cect001_tmp_try,cect_try
            WHERE nu=i AND ecd07=sgm06 AND sfb05=g_tc_imb_2[l_ac].sfb05_2 AND ecbud09=g_tc_imb_2[l_ac].ecbud09
            IF NOT cl_null(l_imaud10) THEN
         ...
         END IF
         IF i=7 THEN
            SELECT SUM(NVL(l_sum7,0)) INTO g_tc_imb_2[l_ac].d7 FROM cect001_tmp_try,cect_try
            WHERE nu=i AND ecd07=sgm06 AND sfb05=g_tc_imb_2[l_ac].sfb05_2 AND ecbud09=g_tc_imb_2[l_ac].ecbud09
            IF NOT cl_null(l_imaud10) THEN
         ...
         END IF
         IF i=8 THEN
            SELECT SUM(NVL(l_sum7,0)) INTO g_tc_imb_2[l_ac].d8 FROM cect001_tmp_try,cect_try
            WHERE nu=i AND ecd07=sgm06 AND sfb05=g_tc_imb_2[l_ac].sfb05_2 AND ecbud09=g_tc_imb_2[l_ac].ecbud09
            IF NOT cl_null(l_imaud10) THEN
         ...
         END IF
         IF i=9 THEN
            SELECT SUM(NVL(l_sum7,0)) INTO g_tc_imb_2[l_ac].d9 FROM cect001_tmp_try,cect_try
            WHERE nu=i AND ecd07=sgm06 AND sfb05=g_tc_imb_2[l_ac].sfb05_2 AND ecbud09=g_tc_imb_2[l_ac].ecbud09
            IF NOT cl_null(l_imaud10) THEN
         ...
         END IF
         IF i=10 THEN
            SELECT SUM(NVL(l_sum7,0)) INTO g_tc_imb_2[l_ac].d10 FROM cect001_tmp_try,cect_try
            WHERE nu=i AND ecd07=sgm06 AND sfb05=g_tc_imb_2[l_ac].sfb05_2 AND ecbud09=g_tc_imb_2[l_ac].ecbud09
            IF NOT cl_null(l_imaud10) THEN
         ...
         END IF
         IF i=11 THEN
            SELECT SUM(NVL(l_sum7,0)) INTO g_tc_imb_2[l_ac].d11 FROM cect001_tmp_try,cect_try
            WHERE nu=i AND ecd07=sgm06 AND sfb05=g_tc_imb_2[l_ac].sfb05_2 AND ecbud09=g_tc_imb_2[l_ac].ecbud09
            IF NOT cl_null(l_imaud10) THEN
         ...
         END IF
         IF i=12 THEN
            SELECT SUM(NVL(l_sum7,0)) INTO g_tc_imb_2[l_ac].d12 FROM cect001_tmp_try,cect_try
            WHERE nu=i AND ecd07=sgm06 AND sfb05=g_tc_imb_2[l_ac].sfb05_2 AND ecbud09=g_tc_imb_2[l_ac].ecbud09
            IF NOT cl_null(l_imaud10) THEN
         ...
         END IF
         IF i=13 THEN
            SELECT SUM(NVL(l_sum7,0)) INTO g_tc_imb_2[l_ac].d13 FROM cect001_tmp_try,cect_try
            WHERE nu=i AND ecd07=sgm06 AND sfb05=g_tc_imb_2[l_ac].sfb05_2 AND ecbud09=g_tc_imb_2[l_ac].ecbud09
            IF NOT cl_null(l_imaud10) THEN
         ...
         END IF
         IF i=14 THEN
            SELECT SUM(NVL(l_sum7,0)) INTO g_tc_imb_2[l_ac].d14 FROM cect001_tmp_try,cect_try
            WHERE nu=i AND ecd07=sgm06 AND sfb05=g_tc_imb_2[l_ac].sfb05_2 AND ecbud09=g_tc_imb_2[l_ac].ecbud09
            IF NOT cl_null(l_imaud10) THEN
         ...
         END IF
         IF i=15 THEN
            SELECT SUM(NVL(l_sum7,0)) INTO g_tc_imb_2[l_ac].d15 FROM cect001_tmp_try,cect_try
            WHERE nu=i AND ecd07=sgm06 AND sfb05=g_tc_imb_2[l_ac].sfb05_2 AND ecbud09=g_tc_imb_2[l_ac].ecbud09
            IF NOT cl_null(l_imaud10) THEN
         ...
         END IF
         IF i=16 THEN
            SELECT SUM(NVL(l_sum7,0)) INTO g_tc_imb_2[l_ac].d16 FROM cect001_tmp_try,cect_try
            WHERE nu=i AND ecd07=sgm06 AND sfb05=g_tc_imb_2[l_ac].sfb05_2 AND ecbud09=g_tc_imb_2[l_ac].ecbud09
            IF NOT cl_null(l_imaud10) THEN
         ...
         END IF
         IF i=17 THEN
            SELECT SUM(NVL(l_sum7,0)) INTO g_tc_imb_2[l_ac].d17 FROM cect001_tmp_try,cect_try
            WHERE nu=i AND ecd07=sgm06 AND sfb05=g_tc_imb_2[l_ac].sfb05_2 AND ecbud09=g_tc_imb_2[l_ac].ecbud09
            IF NOT cl_null(l_imaud10) THEN
         ...
         END IF
         IF i=18 THEN
            SELECT SUM(NVL(l_sum7,0)) INTO g_tc_imb_2[l_ac].d18 FROM cect001_tmp_try,cect_try
            WHERE nu=i AND ecd07=sgm06 AND sfb05=g_tc_imb_2[l_ac].sfb05_2 AND ecbud09=g_tc_imb_2[l_ac].ecbud09
            IF NOT cl_null(l_imaud10) THEN
         ...
         END IF
         IF i=19 THEN
            SELECT SUM(NVL(l_sum7,0)) INTO g_tc_imb_2[l_ac].d19 FROM cect001_tmp_try,cect_try
            WHERE nu=i AND ecd07=sgm06 AND sfb05=g_tc_imb_2[l_ac].sfb05_2 AND ecbud09=g_tc_imb_2[l_ac].ecbud09
            IF NOT cl_null(l_imaud10) THEN
         ...
         END IF
         IF i=20 THEN
            SELECT SUM(NVL(l_sum7,0)) INTO g_tc_imb_2[l_ac].d20 FROM cect001_tmp_try,cect_try
            WHERE nu=i AND ecd07=sgm06 AND sfb05=g_tc_imb_2[l_ac].sfb05_2 AND ecbud09=g_tc_imb_2[l_ac].ecbud09
            IF NOT cl_null(l_imaud10) THEN
         ...
         END IF
         IF i=21 THEN
            SELECT SUM(NVL(l_sum7,0)) INTO g_tc_imb_2[l_ac].d21 FROM cect001_tmp_try,cect_try
            WHERE nu=i AND ecd07=sgm06 AND sfb05=g_tc_imb_2[l_ac].sfb05_2 AND ecbud09=g_tc_imb_2[l_ac].ecbud09
            IF NOT cl_null(l_imaud10) THEN
         ...
         END IF
         IF i=22 THEN
            SELECT SUM(NVL(l_sum7,0)) INTO g_tc_imb_2[l_ac].d22 FROM cect001_tmp_try,cect_try
            WHERE nu=i AND ecd07=sgm06 AND sfb05=g_tc_imb_2[l_ac].sfb05_2 AND ecbud09=g_tc_imb_2[l_ac].ecbud09
            IF NOT cl_null(l_imaud10) THEN
         ...
         END IF
         IF i=23 THEN
            SELECT SUM(NVL(l_sum7,0)) INTO g_tc_imb_2[l_ac].d23 FROM cect001_tmp_try,cect_try
            WHERE nu=i AND ecd07=sgm06 AND sfb05=g_tc_imb_2[l_ac].sfb05_2 AND ecbud09=g_tc_imb_2[l_ac].ecbud09
            IF NOT cl_null(l_imaud10) THEN
         ...
         END IF
         IF i=24 THEN
            SELECT SUM(NVL(l_sum7,0)) INTO g_tc_imb_2[l_ac].d24 FROM cect001_tmp_try,cect_try
            WHERE nu=i AND ecd07=sgm06 AND sfb05=g_tc_imb_2[l_ac].sfb05_2 AND ecbud09=g_tc_imb_2[l_ac].ecbud09
            IF NOT cl_null(l_imaud10) THEN
         ...
         END IF
         IF i=25 THEN
            SELECT SUM(NVL(l_sum7,0)) INTO g_tc_imb_2[l_ac].d25 FROM cect001_tmp_try,cect_try
            WHERE nu=i AND ecd07=sgm06 AND sfb05=g_tc_imb_2[l_ac].sfb05_2 AND ecbud09=g_tc_imb_2[l_ac].ecbud09
            IF NOT cl_null(l_imaud10) THEN
         ...
         END IF
         IF i=26 THEN
            SELECT SUM(NVL(l_sum7,0)) INTO g_tc_imb_2[l_ac].d26 FROM cect001_tmp_try,cect_try
            WHERE nu=i AND ecd07=sgm06 AND sfb05=g_tc_imb_2[l_ac].sfb05_2 AND ecbud09=g_tc_imb_2[l_ac].ecbud09
            IF NOT cl_null(l_imaud10) THEN
         ...
         END IF
         IF i=27 THEN
            SELECT SUM(NVL(l_sum7,0)) INTO g_tc_imb_2[l_ac].d27 FROM cect001_tmp_try,cect_try
            WHERE nu=i AND ecd07=sgm06 AND sfb05=g_tc_imb_2[l_ac].sfb05_2 AND ecbud09=g_tc_imb_2[l_ac].ecbud09
            IF NOT cl_null(l_imaud10) THEN
         ...
         END IF
         IF i=28 THEN
            SELECT SUM(NVL(l_sum7,0)) INTO g_tc_imb_2[l_ac].d28 FROM cect001_tmp_try,cect_try
            WHERE nu=i AND ecd07=sgm06 AND sfb05=g_tc_imb_2[l_ac].sfb05_2 AND ecbud09=g_tc_imb_2[l_ac].ecbud09
            IF NOT cl_null(l_imaud10) THEN
         ...
         END IF
         IF i=29 THEN
            SELECT SUM(NVL(l_sum7,0)) INTO g_tc_imb_2[l_ac].d29 FROM cect001_tmp_try,cect_try
            WHERE nu=i AND ecd07=sgm06 AND sfb05=g_tc_imb_2[l_ac].sfb05_2 AND ecbud09=g_tc_imb_2[l_ac].ecbud09
            IF NOT cl_null(l_imaud10) THEN
         ...
         END IF
         IF i=30 THEN
            SELECT SUM(NVL(l_sum7,0)) INTO g_tc_imb_2[l_ac].d30 FROM cect001_tmp_try,cect_try
            WHERE nu=i AND ecd07=sgm06 AND sfb05=g_tc_imb_2[l_ac].sfb05_2 AND ecbud09=g_tc_imb_2[l_ac].ecbud09
            IF NOT cl_null(l_imaud10) THEN
         ...
         END IF
         IF i=31 THEN
            SELECT SUM(NVL(l_sum7,0)) INTO g_tc_imb_2[l_ac].d31 FROM cect001_tmp_try,cect_try
            WHERE nu=i AND ecd07=sgm06 AND sfb05=g_tc_imb_2[l_ac].sfb05_2 AND ecbud09=g_tc_imb_2[l_ac].ecbud09
            IF g_tc_imb_2[l_ac].d31=0 THEN LET g_tc_imb_2[l_ac].d31='' END IF
         END IF
         IF i=32 THEN
            SELECT SUM(NVL(l_sum7,0)) INTO g_tc_imb_2[l_ac].d32 FROM cect001_tmp_try,cect_try
            WHERE nu=i AND ecd07=sgm06 AND sfb05=g_tc_imb_2[l_ac].sfb05_2 AND ecbud09=g_tc_imb_2[l_ac].ecbud09
            IF g_tc_imb_2[l_ac].d32=0 THEN LET g_tc_imb_2[l_ac].d32='' END IF
         END IF
         IF i=33 THEN
            SELECT SUM(NVL(l_sum7,0)) INTO g_tc_imb_2[l_ac].d33 FROM cect001_tmp_try,cect_try
            WHERE nu=i AND ecd07=sgm06 AND sfb05=g_tc_imb_2[l_ac].sfb05_2 AND ecbud09=g_tc_imb_2[l_ac].ecbud09
            IF g_tc_imb_2[l_ac].d33=0 THEN LET g_tc_imb_2[l_ac].d33='' END IF
         END IF
         IF i=34 THEN
            SELECT SUM(NVL(l_sum7,0)) INTO g_tc_imb_2[l_ac].d34 FROM cect001_tmp_try,cect_try
            WHERE nu=i AND ecd07=sgm06 AND sfb05=g_tc_imb_2[l_ac].sfb05_2 AND ecbud09=g_tc_imb_2[l_ac].ecbud09
            IF g_tc_imb_2[l_ac].d34=0 THEN LET g_tc_imb_2[l_ac].d34='' END IF
         END IF
         IF i=35 THEN
            SELECT SUM(NVL(l_sum7,0)) INTO g_tc_imb_2[l_ac].d35 FROM cect001_tmp_try,cect_try
            WHERE nu=i AND ecd07=sgm06 AND sfb05=g_tc_imb_2[l_ac].sfb05_2 AND ecbud09=g_tc_imb_2[l_ac].ecbud09
            IF g_tc_imb_2[l_ac].d35=0 THEN LET g_tc_imb_2[l_ac].d35='' END IF
         END IF
         IF i=36 THEN
            SELECT SUM(NVL(l_sum7,0)) INTO g_tc_imb_2[l_ac].d36 FROM cect001_tmp_try,cect_try
            WHERE nu=i AND ecd07=sgm06 AND sfb05=g_tc_imb_2[l_ac].sfb05_2 AND ecbud09=g_tc_imb_2[l_ac].ecbud09
            IF g_tc_imb_2[l_ac].d36=0 THEN LET g_tc_imb_2[l_ac].d36='' END IF
         END IF
         IF i=37 THEN
            SELECT SUM(NVL(l_sum7,0)) INTO g_tc_imb_2[l_ac].d37 FROM cect001_tmp_try,cect_try
            WHERE nu=i AND ecd07=sgm06 AND sfb05=g_tc_imb_2[l_ac].sfb05_2 AND ecbud09=g_tc_imb_2[l_ac].ecbud09
            IF g_tc_imb_2[l_ac].d37=0 THEN LET g_tc_imb_2[l_ac].d37='' END IF
         END IF
         IF i=38 THEN
            SELECT SUM(NVL(l_sum7,0)) INTO g_tc_imb_2[l_ac].d38 FROM cect001_tmp_try,cect_try
            WHERE nu=i AND ecd07=sgm06 AND sfb05=g_tc_imb_2[l_ac].sfb05_2 AND ecbud09=g_tc_imb_2[l_ac].ecbud09
            IF g_tc_imb_2[l_ac].d38=0 THEN LET g_tc_imb_2[l_ac].d38='' END IF
         END IF
         IF i=39 THEN
            SELECT SUM(NVL(l_sum7,0)) INTO g_tc_imb_2[l_ac].d39 FROM cect001_tmp_try,cect_try
            WHERE nu=i AND ecd07=sgm06 AND sfb05=g_tc_imb_2[l_ac].sfb05_2 AND ecbud09=g_tc_imb_2[l_ac].ecbud09
            IF g_tc_imb_2[l_ac].d39=0 THEN LET g_tc_imb_2[l_ac].d39='' END IF
         END IF
         IF i=40 THEN
            SELECT SUM(NVL(l_sum7,0)) INTO g_tc_imb_2[l_ac].d40 FROM cect001_tmp_try,cect_try
            WHERE nu=i AND ecd07=sgm06 AND sfb05=g_tc_imb_2[l_ac].sfb05_2 AND ecbud09=g_tc_imb_2[l_ac].ecbud09
            IF g_tc_imb_2[l_ac].d40=0 THEN LET g_tc_imb_2[l_ac].d40='' END IF
         END IF
         IF i=41 THEN
            SELECT SUM(NVL(l_sum7,0)) INTO g_tc_imb_2[l_ac].d41 FROM cect001_tmp_try,cect_try
            WHERE nu=i AND ecd07=sgm06 AND sfb05=g_tc_imb_2[l_ac].sfb05_2 AND ecbud09=g_tc_imb_2[l_ac].ecbud09
            IF g_tc_imb_2[l_ac].d41=0 THEN LET g_tc_imb_2[l_ac].d41='' END IF
         END IF
         IF i=42 THEN
            SELECT SUM(NVL(l_sum7,0)) INTO g_tc_imb_2[l_ac].d42 FROM cect001_tmp_try,cect_try
            WHERE nu=i AND ecd07=sgm06 AND sfb05=g_tc_imb_2[l_ac].sfb05_2 AND ecbud09=g_tc_imb_2[l_ac].ecbud09
            IF g_tc_imb_2[l_ac].d42=0 THEN LET g_tc_imb_2[l_ac].d42='' END IF
         END IF
         IF i=43 THEN
            SELECT SUM(NVL(l_sum7,0)) INTO g_tc_imb_2[l_ac].d43 FROM cect001_tmp_try,cect_try
            WHERE nu=i AND ecd07=sgm06 AND sfb05=g_tc_imb_2[l_ac].sfb05_2 AND ecbud09=g_tc_imb_2[l_ac].ecbud09
            IF g_tc_imb_2[l_ac].d43=0 THEN LET g_tc_imb_2[l_ac].d43='' END IF
         END IF
         IF i=44 THEN
            SELECT SUM(NVL(l_sum7,0)) INTO g_tc_imb_2[l_ac].d44 FROM cect001_tmp_try,cect_try
            WHERE nu=i AND ecd07=sgm06 AND sfb05=g_tc_imb_2[l_ac].sfb05_2 AND ecbud09=g_tc_imb_2[l_ac].ecbud09
            IF g_tc_imb_2[l_ac].d44=0 THEN LET g_tc_imb_2[l_ac].d44='' END IF
         END IF
         IF i=45 THEN
            SELECT SUM(NVL(l_sum7,0)) INTO g_tc_imb_2[l_ac].d45 FROM cect001_tmp_try,cect_try
            WHERE nu=i AND ecd07=sgm06 AND sfb05=g_tc_imb_2[l_ac].sfb05_2 AND ecbud09=g_tc_imb_2[l_ac].ecbud09
            IF g_tc_imb_2[l_ac].d45=0 THEN LET g_tc_imb_2[l_ac].d45='' END IF
         END IF
         IF i=46 THEN
            SELECT SUM(NVL(l_sum7,0)) INTO g_tc_imb_2[l_ac].d46 FROM cect001_tmp_try,cect_try
            WHERE nu=i AND ecd07=sgm06 AND sfb05=g_tc_imb_2[l_ac].sfb05_2 AND ecbud09=g_tc_imb_2[l_ac].ecbud09
            IF g_tc_imb_2[l_ac].d46=0 THEN LET g_tc_imb_2[l_ac].d46='' END IF
         END IF
         IF i=47 THEN
            SELECT SUM(NVL(l_sum7,0)) INTO g_tc_imb_2[l_ac].d47 FROM cect001_tmp_try,cect_try
            WHERE nu=i AND ecd07=sgm06 AND sfb05=g_tc_imb_2[l_ac].sfb05_2 AND ecbud09=g_tc_imb_2[l_ac].ecbud09
            IF g_tc_imb_2[l_ac].d47=0 THEN LET g_tc_imb_2[l_ac].d47='' END IF
         END IF
         IF i=48 THEN
            SELECT SUM(NVL(l_sum7,0)) INTO g_tc_imb_2[l_ac].d48 FROM cect001_tmp_try,cect_try
            WHERE nu=i AND ecd07=sgm06 AND sfb05=g_tc_imb_2[l_ac].sfb05_2 AND ecbud09=g_tc_imb_2[l_ac].ecbud09
            IF g_tc_imb_2[l_ac].d48=0 THEN LET g_tc_imb_2[l_ac].d48='' END IF
         END IF
         IF i=49 THEN
            SELECT SUM(NVL(l_sum7,0)) INTO g_tc_imb_2[l_ac].d49 FROM cect001_tmp_try,cect_try
            WHERE nu=i AND ecd07=sgm06 AND sfb05=g_tc_imb_2[l_ac].sfb05_2 AND ecbud09=g_tc_imb_2[l_ac].ecbud09
            IF g_tc_imb_2[l_ac].d49=0 THEN LET g_tc_imb_2[l_ac].d49='' END IF
         END IF
         IF i=50 THEN
            SELECT SUM(NVL(l_sum7,0)) INTO g_tc_imb_2[l_ac].d50 FROM cect001_tmp_try,cect_try
            WHERE nu=i AND ecd07=sgm06 AND sfb05=g_tc_imb_2[l_ac].sfb05_2 AND ecbud09=g_tc_imb_2[l_ac].ecbud09
...
DEFINE
   #p_wc3           VARCHAR(200) #TQC-630166
    ...
    LET g_sql = "SELECT sfb05,ima02,ima021,ecbud09,sgm06,sum(l_sum7) FROM cect001_tmp_try  ",
...
DEFINE l_tc_sfcud07   LIKE tc_sfc_file.tc_sfcud07
    ...
    DROP TABLE cect001_tmp_try
    CREATE TEMP TABLE cect001_tmp_try
   ...
   IF g_tc_ima.tc_imaud03 = '2' THEN
      LET l_sql = l_sql CLIPPED," AND instr(sgm03_par, '-') >0"
   END IF  
   LET l_sql1 = " INSERT INTO cect001_tmp_try ",l_sql CLIPPED
   PREPARE t001_ins FROM l_sql1
   EXECUTE t001_ins
   
   SELECT COUNT(*) INTO AA FROM cect001_tmp_try 

   LET l_sql = " MERGE INTO cect001_tmp_try o ",
   ...
   DELETE FROM cect001_tmp_try WHERE l_sum7 <= 0
   UPDATE cect001_tmp_try SET l_sum7 = l_sum7 - l_sum4  #add by huanglf170112
   UPDATE cect001_tmp_try SET l_sum10 = l_sum7/l_sum10
    DELETE FROM cect001_tmp_try WHERE l_sum7 <= 0
