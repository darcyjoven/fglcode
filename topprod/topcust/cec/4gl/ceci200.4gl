...
GLOBALS "../../../tiptop/config/top.global"
   ...
   DEFINE g_sfb,g_sfb_excel   DYNAMIC ARRAY OF RECORD  
       ...
       tc_shc17          LIKE tc_shc_file.tc_shc17,  #str----add by huanglf160808
       tc_shcud09        LIKE tc_shc_file.tc_shcud09,#str----end by huanglf160808
       ...
       imaud10_1         LIKE ima_file.imaud10    #str----add by huanglf160810
                         END RECORD
   DEFINE g_sfb_attr     DYNAMIC ARRAY OF RECORD
       ...
       gen02             STRING,
       tc_shc12          STRING,
       tc_shc17          STRING,  #str----add by huanglf160808
       tc_shcud09        STRING,  #str----end by huanglf160808
       tc_shc13          STRING,
       ecg02             STRING,
       tc_shc14          STRING,
       tc_shc15          STRING,
    ...
    DEFINE g_sfb_1          DYNAMIC ARRAY OF RECORD  
        ...
        imaud10     LIKE ima_file.imaud10 #str---add by huanglf160810
                         END RECORD
...
#str----add by huanglf160810
   DEFINE g_shm_1          DYNAMIC ARRAY OF RECORD  
        ...
        shm06       LIKE shm_file.shm06, #使用工艺编号
        shm08       LIKE shm_file.shm08, 
        shm09       LIKE shm_file.shm09, 
        sgm03       LIKE sfb_file.sfb09,
        sgm06       LIKE sgm_file.sgm06,   
        m06_name_1  LIKE pmc_file.pmc03,   
        sgm04       LIKE sgm_file.sgm04,
        sgm45       LIKE sgm_file.sgm45,   #作業名稱
        sgm65       LIKE sgm_file.sgm65,   #标准产出量 #No.FUN-A60011
        wipqty_1    LIKE ecm_file.ecm315,  #
        ecm301_1    LIKE ecm_file.ecm301,  #
        ecm302_1    LIKE ecm_file.ecm302,  #
        ecm303_1    LIKE ecm_file.ecm303,
        ecm311_1    LIKE ecm_file.ecm311,  #
        ecm312_1    LIKE ecm_file.ecm312,  #
        ecm316_1    LIKE ecm_file.ecm316,
        ecm313_1    LIKE ecm_file.ecm313,  #
        ecm314_1    LIKE ecm_file.ecm314,  #
        shb30_1     LIKE shb_file.shb30,   #     #FUN-A80150 add
        ecm66_1     LIKE ecm_file.ecm66,   #     #FUN-A80150 add
        ecm315_1    LIKE ecm_file.ecm315,  #
        ecm321_1    LIKE ecm_file.ecm321,  #
        ecm322_1    LIKE ecm_file.ecm322,  #
        ecm291_1    LIKE ecm_file.ecm291,  #
        ecm292_1    LIKE ecm_file.ecm292,
        ecm58_1     LIKE ecm_file.ecm58,
        ecm54_1     LIKE ecm_file.ecm54,    #check-in 否
        ecm52_1     LIKE ecm_file.ecm52,
        ecm53_1     LIKE ecm_file.ecm53,
        ecm55_1     LIKE ecm_file.ecm55,
        ecm56_1     LIKE ecm_file.ecm56,
        imaud10_2   LIKE ima_file.imaud10 
                         END RECORD
  DEFINE g_shm_1_attr       DYNAMIC ARRAY OF RECORD  
        shm01       STRING,
        shm012      STRING,
        sgm03_par   STRING, 
        ima02_2     STRING, 
        ...
        sgm04       STRING,
        sgm45       STRING,   #作業名稱
        sgm65       STRING,   #标准产出量 #No.FUN-A60011
        wipqty_1    STRING,  # 
        ecm301_1    STRING,  
        ecm302_1    STRING,  
        ecm303_1    STRING,
...
MAIN
   ...
   OPEN WINDOW i005_w AT 5,10
        WITH FORM "cec/42f/ceci005" ATTRIBUTE(STYLE = g_win_style)  
   ...
   CALL i005_q()   
   CALL i005_menu()
   DROP TABLE ceci005_tmp;
   DROP TABLE ceci005_tmp_sum;
   DROP TABLE ceci005_tmp_sum_1;
   CLOSE WINDOW i005_w
               ...
               CASE g_action_flag 
                  ...
                  WHEN 'page2'
                   ...
                   WHEN 'page3'
                     ...
                     CALL cl_export_to_excel(page,base.TypeInfo.create(g_shm_1),'','')
               END CASE
            END IF
            LET g_action_choice = " "
...
FUNCTION i005_b_fill()
#str----add by huanglf160810
   LET g_sql = " SELECT tc_shc01,tc_shc02,tc_shc03,tc_shc04,tc_shc05,ima02_1,ima021_1,",
               "        tc_shc06,tc_shc07,tc_shc08,ecd02,tc_shc09,eca02,tc_shc10,tc_shc11,gen02,tc_shc12,tc_shc17,tc_shcud09,tc_shc13,",
               "        ecg02,tc_shc14,tc_shc15,tc_shc16,tc_shb121,tc_shb122,imaud10_1",
               "   FROM ceci005_tmp ",
               "  ORDER BY tc_shc01,tc_shc02 "   
#str----add by huanglf160808

   PREPARE ceci005_pb FROM g_sql
   DECLARE sfb_curs  CURSOR FOR ceci005_pb        #CURSOR
...
FUNCTION i005_bp2()
   ...
   DIALOG ATTRIBUTES(UNBUFFERED)
      ...
      ON ACTION refresh_detail
         CALL i005()
         #CALL i005_b_fill()  #FUN-D10105 mark
         CALL cl_set_comp_visible("page2", FALSE)
         CALL ui.interface.refresh()
         CALL cl_set_comp_visible("page2", TRUE)
         LET g_action_choice = 'page1' 
...
FUNCTION i005_bp3()
   ...
   CALL i005_b_fill_3()
   DIALOG ATTRIBUTES(UNBUFFERED)
      DISPLAY ARRAY g_shm_1 TO s_shm.* ATTRIBUTE(COUNT=g_rec_b3)
         BEFORE DISPLAY 
            CALL DIALOG.setArrayAttributes("s_shm",g_sfb_1_attr)    #参数：屏幕变量,属性数组
            CALL ui.Interface.refresh()
         BEFORE ROW
            LET l_ac = ARR_CURR()
            CALL cl_show_fld_cont()
...
FUNCTION i005_cs()
   ...
   #FUN-D10105--add--str--
   CALL cl_set_comp_visible("page2", FALSE)
   CALL cl_set_comp_visible("page3", FALSE) #str----add by huanglf160810
   CALL ui.interface.refresh()
   CALL cl_set_comp_visible("page2", TRUE)
   CALL cl_set_comp_visible("page3", TRUE)
   #FUN-D10105--add--end--
   ...
   DIALOG ATTRIBUTE(UNBUFFERED)    
         ...
         CONSTRUCT tm.wc2 ON tc_shc02,tc_shc03,tc_shc04,tc_shc05,tc_shc06,tc_shc07,tc_shc08,tc_shc09,tc_shc10, tc_shc11,tc_shc12,tc_shc17,tc_shcud09,tc_shc13,
                        ...
                        FROM s_tc_shc[1].tc_shc02,s_tc_shc[1].tc_shc03,s_tc_shc[1].tc_shc04,s_tc_shc[1].tc_shc05,s_tc_shc[1].tc_shc06,
                             ...
                             s_tc_shc[1].tc_shc12, s_tc_shc[1].tc_shc17, s_tc_shc[1].tc_shcud09,
                             s_tc_shc[1].tc_shc13,s_tc_shc[1].tc_shc14,s_tc_shc[1].tc_shc15,s_tc_shc[1].tc_shc16
...
FUNCTION i005_show() 
      ...
      CALL cl_set_comp_visible("page3", TRUE)
      LET g_action_flag = "page1"  
      CALL i005_b_fill()    #FUN-D10105 add
      --LET g_action_choice = "page2"
      --CALL cl_set_comp_visible("page1", FALSE)
      --CALL ui.interface.refresh()
      --CALL cl_set_comp_visible("page1", TRUE)
      --LET g_action_flag = "page2"  #FUN-D10105 add 
      --CALL i005_b_fill_2()  #FUN-D10105 add 
   CALL cl_show_fld_cont()                   
END FUNCTION

FUNCTION i005_filter_askkey()
DEFINE l_wc   STRING
   CLEAR FORM
         CONSTRUCT l_wc ON  tc_shc02,tc_shc03,tc_shc04,tc_shc05,tc_shc06,tc_shc07,tc_shc08,tc_shc09,tc_shc10, tc_shc11,tc_shc12,tc_shc.shc17,tc_shcud09,tc_shc13,
                             tc_shc14,tc_shc15,tc_shc16
...
FUNCTION i005_table()
   #DROP TABLE ceci005_tmp;  #FUN-D10105 mark
   CREATE TEMP TABLE ceci005_tmp(
       tc_shc01          LIKE tc_shc_file.tc_shc01,
       tc_shc02          LIKE tc_shc_file.tc_shc02,
       tc_shc03          LIKE tc_shc_file.tc_shc03,
       tc_shc04          LIKE tc_shc_file.tc_shc04,
       ...
       gen02             LIKE gen_file.gen02,
       tc_shc12          LIKE tc_shc_file.tc_shc12,
       tc_shc17          LIKE tc_shc_file.tc_shc17,
       tc_shcud09        LIKE tc_shc_file.tc_shcud09,
       tc_shc13          LIKE tc_shc_file.tc_shc13,
       ecg02             LIKE ecg_file.ecg02,
       tc_shc14          LIKE tc_shc_file.tc_shc14,
       tc_shc15          LIKE tc_shc_file.tc_shc15,
    ...
    CREATE TEMP TABLE ceci005_tmp_sum(
        sfb01       LIKE sfb_file.sfb01,   
        sfb05       LIKE sfb_file.sfb05, 
        ima02       LIKE ima_file.ima02, 
        ima021      LIKE ima_file.ima021, 
  ...
  CREATE TEMP TABLE ceci005_tmp_sum_1(
        shm01       LIKE shm_file.shm01,
        shm012      LIKE shm_file.shm012,
        sgm03_par   LIKE sgm_file.sgm03_par, 
        ima02_2     LIKE ima_file.ima02, 
...
FUNCTION i005()
 DEFINE   l_name      LIKE type_file.chr20,           
   ...
   DELETE FROM ceci005_tmp
   #str-----add by huanlf160810
   LET l_sql =  "SELECT CASE tc_shc01 WHEN '1' THEN 1 ELSE 4 END tc_shc01,tc_shc02,tc_shc03,tc_shc04,tc_shc05,", #str----add by huanglf160808
                "       ima02,ima021,tc_shc06,tc_shc07,tc_shc08,ecd02,tc_shc09,eca02,tc_shc10,tc_shc11,gen02,tc_shc12,tc_shc17,tc_shcud09,tc_shc13,",
                "       ecg02,tc_shc14,tc_shc15,tc_shc16,0 tc_shb121,0 tc_shb122,imaud10",
                ...
                "        ima02,ima021,tc_shb06,tc_shb07,tc_shb08,ecd02,tc_shb09,eca02,tc_shb10,tc_shb11,gen02,tc_shb12,tc_shb17,tc_shbud09,tc_shb13,",
                "        ecg02,tc_shb14,tc_shb15,tc_shb16,tc_shb121,tc_shb122,imaud10",
   ...
   LET l_sql = " INSERT INTO ceci005_tmp ",
               "   SELECT x.tc_shc01,x.tc_shc02,x.tc_shc03,x.tc_shc04,x.tc_shc05,",
               "          x.ima02,x.ima021,x.tc_shc06,x.tc_shc07,x.tc_shc08,x.ecd02,x.tc_shc09,x.eca02,x.tc_shc10,x.tc_shc11,x.gen02,x.tc_shc12,x.tc_shc17,x.tc_shcud09,x.tc_shc13,",
               "          x.ecg02,x.tc_shc14,x.tc_shc15,x.tc_shc16,x.tc_shb121,x.tc_shb122,x.imaud10,",
               "          ROW_NUMBER() OVER (PARTITION BY tc_shc01,tc_shc02 ORDER BY tc_shc01,tc_shc02) ",
               "     FROM (",l_sql CLIPPED,") x "
   PREPARE i005_ins FROM l_sql
   EXECUTE i005_ins
...
FUNCTION i005_get_sum()
   DEFINE l_wc     STRING
   DEFINE l_sql    STRING
   DEFINE l_sql1   STRING 
   

   DELETE FROM ceci005_tmp_sum
...
#str----add by huanlf160810
   LET l_sql1 = "SELECT distinct sfb01,sfb05,ima02,ima021,sfb06,sfb08,sfb081,sfb09,ecm03,ecm012,'',ecm06,eca_file.eca02,ecm04,ecm45,ecm65,0,0,0,",
                ...
                "       NVL(ecm52,'N'),NVL(ecm53,'N'),ecm55,ecm56,imaud10 ",
                "  FROM ecm_file LEFT JOIN eca_file ON eca01 = ecm06,",
                "       sfb_file LEFT JOIN ima_file ON ima01 = sfb05,ceci005_tmp",
                " WHERE ecm01 = sfb01",    
                "   AND ecm04 = tc_shc08",
                "   AND ecm01 = tc_shc04",       
                " ORDER BY sfb01,ecm012,ecm03 " 
    LET l_sql = "INSERT INTO ceci005_tmp_sum ",l_sql1 CLIPPED
    
    PREPARE i005_ins_sum FROM l_sql
    EXECUTE i005_ins_sum

    #良品转入量
    LET l_sql = " MERGE INTO ceci005_tmp_sum o ",
    ...
    PREPARE i005_sum3 FROM l_sql
    EXECUTE i005_sum3
    
    #当站返工
    LET l_sql = " MERGE INTO ceci005_tmp_sum o ",
               "      USING (SELECT SUM(tc_shb122) ecm312,tc_shb04,tc_shb08 FROM tc_shb_file ",
               "              WHERE tc_shb01 = '2'", 
               "               GROUP BY tc_shb04,tc_shb08) n ",
               "         ON (o.sfb01 = n.tc_shb04 AND o.ecm04 = n.tc_shb08) ",
               " WHEN MATCHED ",
    ...
    PREPARE i005_sum4 FROM l_sql
    EXECUTE i005_sum4

    LET l_sql = "update ceci005_tmp_sum set wipqty =NVL(ecm301-ecm311-ecm313,0) "
    PREPARE i005_sum5 FROM l_sql
    EXECUTE i005_sum5

    LET l_sql = "SELECT * FROM ceci005_tmp_sum ORDER BY sfb01,ecm012,ecm03"

              
   PREPARE i005_pb FROM l_sql
   DECLARE i005_curs1 CURSOR FOR i005_pb
   FOREACH i005_curs1 INTO g_sfb_1[g_cnt].*
      IF SQLCA.sqlcode THEN
         CALL cl_err('foreach:',SQLCA.sqlcode,1)
         EXIT FOREACH
      END IF
...
#str---add by huanlf160810
FUNCTION i005_get_sum_1()
   DEFINE l_wc     STRING
   DEFINE l_sql    STRING
   DEFINE l_sql1   STRING 
   

   DELETE FROM ceci005_tmp_sum_1
   #CALL g_sfb_1_attr.clear()
#str----add by huanlf160810
   LET l_sql1 = "SELECT distinct shm01,shm012,sgm03_par,ima02,ima021,shm06,shm08,shm09,sgm03,sgm06,eca_file.eca02,sgm04,sgm45,sgm65,0,0,0,",
                "       0,0,0,0,0,0,'N','N',0,",
                "       0,0,0,0,ecm58,NVL(ecm54,'N'),",
                "       NVL(ecm52,'N'),NVL(ecm53,'N'),ecm55,ecm56,imaud10 ",
                "  FROM ecm_file LEFT JOIN eca_file ON eca01 = ecm06,",
                "       sgm_file LEFT JOIN ima_file ON ima01 = sgm03_par,ceci005_tmp,shm_file",
                " WHERE ecm01 = shm012",    
                "   AND ecm04 = tc_shc08",
                "   AND ecm01 = tc_shc04", 
                "   AND sgm01 = shm01",
                ...
                "   AND sgm01 = tc_shc03",
                "   AND sgm03 = tc_shc06",
                " ORDER BY shm01,shm012,sgm03 " 
    LET l_sql = "INSERT INTO ceci005_tmp_sum_1 ",l_sql1 CLIPPED

    
    
    PREPARE i005_ins_sum_1 FROM l_sql
    EXECUTE i005_ins_sum_1

    #良品转入量
    LET l_sql = " MERGE INTO ceci005_tmp_sum_1 o ",
               "      USING (SELECT SUM(tc_shc12) ecm301,tc_shc03,tc_shc04,tc_shc08 FROM tc_shc_file ",
               "               WHERE  tc_shc01 = '1'",
               "               GROUP BY tc_shc03,tc_shc04,tc_shc08) n ",
               "         ON (o.shm01=n.tc_shc03 AND o.shm012 = n.tc_shc04 AND o.sgm04 = n.tc_shc08) ",
               " WHEN MATCHED ",
               " THEN ",
               "    UPDATE ",
               "       SET o.ecm301_1 = NVL(n.ecm301,0) "
    PREPARE i005_sum1_1 FROM l_sql
    EXECUTE i005_sum1_1

    #良品转出
    LET l_sql = " MERGE INTO ceci005_tmp_sum_1 o ",
               "      USING (SELECT SUM(tc_shc12) ecm311,tc_shc03,tc_shc04,tc_shc08 FROM tc_shc_file  ",
               "              WHERE tc_shc01 = '2'",
               "               GROUP BY tc_shc03,tc_shc04,tc_shc08) n ",
               "         ON (o.shm01=n.tc_shc03 AND o.shm012 = n.tc_shc04 AND o.sgm04 = n.tc_shc08) ",
               " WHEN MATCHED ",
               " THEN ",
               "    UPDATE ",
               "       SET o.ecm311_1 = NVL(n.ecm311,0) "
    PREPARE i005_sum2_1 FROM l_sql
    EXECUTE i005_sum2_1

    #当站报废
    LET l_sql = " MERGE INTO ceci005_tmp_sum_1 o ",
               "      USING (SELECT SUM(tc_shb121) ecm313,tc_shb03,tc_shb04,tc_shb08 FROM tc_shb_file ",
               "              WHERE tc_shb01 = '2'", 
               "               GROUP BY tc_shb03,tc_shb04,tc_shb08) n ",
               "         ON (o.shm01=n.tc_shb03 AND o.shm012 = n.tc_shb04 AND o.sgm04 = n.tc_shb08) ",
               " WHEN MATCHED ",
               " THEN ",
               "    UPDATE ",
               "       SET o.ecm313_1 = NVL(n.ecm313,0) "
    PREPARE i005_sum3_1 FROM l_sql
    EXECUTE i005_sum3_1
    
    #当站返工
    LET l_sql = " MERGE INTO ceci005_tmp_sum_1 o ",
               "      USING (SELECT SUM(tc_shb122) ecm312,tc_shb03,tc_shb04,tc_shb08 FROM tc_shb_file ",
               "              WHERE tc_shb01 = '2'", 
               "               GROUP BY tc_shb03,tc_shb04,tc_shb08) n ",
               "         ON (o.shm01=n.tc_shb03 AND o.shm012 = n.tc_shb04 AND o.sgm04 = n.tc_shb08) ",
               " WHEN MATCHED ",
               " THEN ",
               "    UPDATE ",
               "       SET o.ecm312_1 = NVL(n.ecm312,0) "
    PREPARE i005_sum4_1 FROM l_sql
    EXECUTE i005_sum4_1

    LET l_sql = "update ceci005_tmp_sum_1 set wipqty_1 =NVL(ecm301_1-ecm311_1-ecm313_1,0) "
    PREPARE i005_sum5_1 FROM l_sql
    EXECUTE i005_sum5_1

    LET l_sql = "SELECT * FROM ceci005_tmp_sum_1 ORDER BY shm01,shm012,sgm03"

              
   PREPARE i005_pb_1 FROM l_sql
   DECLARE i005_curs1_1 CURSOR FOR i005_pb_1
   FOREACH i005_curs1_1 INTO g_shm_1[g_cnt].*
      IF SQLCA.sqlcode THEN
         CALL cl_err('foreach:',SQLCA.sqlcode,1)
         EXIT FOREACH
      END IF
      IF g_shm_1[g_cnt].wipqty_1>0 THEN 
         CALL i005_color_2()
      END IF 
      LET g_cnt = g_cnt + 1
      IF g_cnt > 5000 THEN
      ...
      END IF
   END FOREACH
   DISPLAY ARRAY g_shm_1 TO s_shm.* ATTRIBUTE(COUNT=g_cnt)
      BEFORE DISPLAY
         EXIT DISPLAY
   END DISPLAY
 
   CALL g_shm_1.deleteElement(g_cnt)
...
FUNCTION i005_detail_fill(p_ac)
   ...
   PREPARE ceci005_pb_detail FROM l_sql
   DECLARE sfb_curs_detail  CURSOR FOR ceci005_pb_detail        #CURSOR
   CALL g_sfb.clear()
   CALL g_sfb_attr.clear()
   LET g_cnt = 1
   LET g_rec_b = 0
...
FUNCTION i005_detail_fill_1(p_ac)
   DEFINE p_ac         LIKE type_file.num5,
          l_sfb24      LIKE sfb_file.sfb24,
          l_type       LIKE type_file.chr1,   
          l_sql        STRING, 
   ...
   LET l_sql = " SELECT tc_shc01,tc_shc02,tc_shc03,tc_shc04,tc_shc05,ima02_1,ima021_1,",
               ...
               "        ecg02,tc_shc14,tc_shc15,tc_shc16,tc_shb121,tc_shb122,imaud10_1",
               "   FROM ceci005_tmp ",
               "  WHERE tc_shc04 = '",g_shm_1[p_ac].shm012,"'",
               "    AND tc_shc08 = '",g_shm_1[p_ac].sgm04,"'",
               "  ORDER BY tc_shc01,tc_shc02 "  


   PREPARE ceci005_pb_detail_1 FROM l_sql
   DECLARE sfb_curs_detail_1  CURSOR FOR ceci005_pb_detail_1        #CURSOR
   CALL g_sfb.clear()
   CALL g_sfb_attr.clear()
   LET g_cnt = 1
   LET g_rec_b = 0
   
   FOREACH sfb_curs_detail_1 INTO g_sfb_excel[g_cnt].*
      IF SQLCA.sqlcode THEN
         CALL cl_err('foreach:',SQLCA.sqlcode,1)
         EXIT FOREACH
      END IF
...
FUNCTION i005_color()
         ...
         LET g_sfb_attr[g_cnt].imaud10_1 = "red"
END FUNCTION

FUNCTION i005_color_1()
         ...
         LET g_sfb_1_attr[g_cnt].imaud10 = "red"
END FUNCTION 
#str----add by huanglf160810
FUNCTION i005_color_2()
          LET g_shm_1_attr[g_cnt].shm01 = "red"
         LET g_shm_1_attr[g_cnt].shm012 = "red"
         LET g_shm_1_attr[g_cnt].sgm03_par = "red"
         LET g_shm_1_attr[g_cnt].ima02_2 = "red"
         LET g_shm_1_attr[g_cnt].ima021_2 = "red"
         LET g_shm_1_attr[g_cnt].shm06 = "red"
         LET g_shm_1_attr[g_cnt].shm08 = "red"
         LET g_shm_1_attr[g_cnt].shm09 = "red"
         LET g_shm_1_attr[g_cnt].sgm03 = "red"
         LET g_shm_1_attr[g_cnt].sgm06 = "red"   #FUN-D10105
         LET g_shm_1_attr[g_cnt].m06_name_1 = "red"   #FUN-D10105
         LET g_shm_1_attr[g_cnt].sgm04 = "red"
         LET g_shm_1_attr[g_cnt].sgm45 = "red"
         LET g_shm_1_attr[g_cnt].sgm65 = "red"
         LET g_shm_1_attr[g_cnt].wipqty_1 = "red"
         LET g_shm_1_attr[g_cnt].ecm301_1 = "red"
         LET g_shm_1_attr[g_cnt].ecm302_1 = "red"
         LET g_shm_1_attr[g_cnt].ecm303_1 = "red"
         LET g_shm_1_attr[g_cnt].ecm311_1 = "red"   #FUN-D10105
         LET g_shm_1_attr[g_cnt].ecm312_1 = "red"   #FUN-D10105
         LET g_shm_1_attr[g_cnt].ecm316_1 = "red"
         LET g_shm_1_attr[g_cnt].ecm313_1 = "red"
         LET g_shm_1_attr[g_cnt].ecm314_1 = "red"
         LET g_shm_1_attr[g_cnt].shb30_1 = "red"
         LET g_shm_1_attr[g_cnt].ecm66_1 = "red"
         LET g_shm_1_attr[g_cnt].ecm315_1 = "red"         
         LET g_shm_1_attr[g_cnt].ecm321_1 = "red"
         LET g_shm_1_attr[g_cnt].ecm322_1 = "red"   #FUN-D10105         
         LET g_shm_1_attr[g_cnt].ecm291_1 = "red"   #FUN-D10105         
         LET g_shm_1_attr[g_cnt].ecm292_1 = "red"
         LET g_shm_1_attr[g_cnt].ecm58_1 = "red"
         LET g_shm_1_attr[g_cnt].ecm54_1 = "red"
         LET g_shm_1_attr[g_cnt].ecm52_1 = "red"
         LET g_shm_1_attr[g_cnt].ecm53_1 = "red"
         LET g_shm_1_attr[g_cnt].ecm55_1 = "red"
         LET g_shm_1_attr[g_cnt].ecm56_1 = "red"
         LET g_shm_1_attr[g_cnt].imaud10_2 = "red"
#str----end by huanglf160810
END FUNCTION
