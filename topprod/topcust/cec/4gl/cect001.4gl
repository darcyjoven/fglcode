...
DEFINE
   #p_wc3           VARCHAR(200) #TQC-630166
    ...
    LET g_sql = "SELECT tc_imd02,tc_imd03,ima02,ima021,tc_imd04 ",
                ...
                " AND tc_imd04>0   AND ",p_wc3 CLIPPED,
                " ORDER BY 1"
...
--DEFINE l_sql       STRING 
   ...
   #end----add by guanyao160923
--
   --LET l_sql = " INSERT INTO cect001_tmp ",
...
--
   ...
   --EXECUTE t001_pre2 
--
   --DELETE FROM cect001_tmp WHERE tc_shc12r = tc_shc12c OR tc_shc12r IS NULL 
   --
--END FUNCTION 
...
DEFINE l_sql1 STRING 
   ...
   LET l_sql = " MERGE INTO cect001_tmp o ",
               ...
               "           o.l_sum7 =l_sum7-NVL(n.tc_shc12,0)-l_sum4"
   PREPARE t001_pre2 FROM l_sql
   EXECUTE t001_pre2
           ...
           LET l_sql = " MERGE INTO cect001_tmp o ",
               ...
               "                 AND tc_shb01 ='2'",
               "               GROUP BY tc_shb03, tc_shb06) n ",
               "         ON (o.sgm01 = n.tc_shc03 AND o.sgm03_2 = n.tc_shc06) ",
               " WHEN MATCHED ",
               " THEN ",
               "    UPDATE ",
               "       SET o.l_sum12 = NVL(n.tc_shc12,0), ",
               "           o.l_sum11 =NVL(n.tc_shc12,0)-l_sum3-l_sum4"
   PREPARE t001_pre21 FROM l_sql
   EXECUTE t001_pre21                         
#  末工序WIP转化 取消 ly 180528
   ...
   LET l_sql = " MERGE INTO cect001_tmp o ",
               ...
               " THEN ",
               "    UPDATE ",
               "       SET o.l_sum12 = NVL(n.sfv09,0), ",
               "           o.l_sum11 =l_sum11-NVL(n.sfv09,0)"
   PREPARE t001_pre31 FROM l_sql
   EXECUTE t001_pre31
...
DEFINE l_tc_imb11  LIKE tc_imb_file.tc_imb11  #add by guanyao161010
   ...
   --LET l_sql =" SELECT * FROM cect001_tmp "
   ...
   LET l_sql = "SELECT l_tc_ima01,rownum,sgm04,sgm01,sgm02,l_sum1,l_sum2,l_sum3,l_sum6,wipqty,l_sum4,",
               "       l_sum5,l_sum10 FROM cect001_tmp"
