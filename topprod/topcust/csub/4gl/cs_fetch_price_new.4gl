...
#                  p_item     產品編號 
#                  p_booth    攤位編號           #FUN-BC0071 add                                                                                        
#                  p_unit     單位                                                                                                     
#                  p_date     日期                                                                                                     
#                  p_type     類型:1.訂單 2.出貨單 3.銷退單             
#                                  4.artt262使用   5.订货明细axmi404  6.報價單  #FUN-B90104 add 5.axmi404  #FUN-B60067 ADD  #TQC-CA0039 add 6.報價單
#                                  7.换增取价   #FUN-CA0152 add
#                  p_plant    機構別
#                  p_curr     幣別 
#                  p_term     價格條件
#                  p_payment  收款條件                                                                                       
...
#                  p_no       單據編號  
#                  p_no1      提案單號
#                  p_cmd      用戶動作 a:新增 u:修改 d:刪除 e:結束錄入 b:订单变更 
#                  p_count    數量                                                                                                  
...
# Modify.........: No:FUN-AA0065 10/10/15 By shenyang 修改s_fetch_price_new中的 cs_fetch_price_C2,添加返回基礎價格         
# Modify.........: No:FUN-AA0065 10/11/03 By shenyang 修改insert依次對應
# Modify.........: No:FUN-AB0083 10/11/19 By suncx 價格代碼取消抓取rzz_file
# Modify.........: No:FUN-AB0102 10/11/25 By shenyang  s_fetch_price_new 中的cs_fetch_price_C4() 在INSERT INTO rxc_file之前先DELETE
...
# Modify.........: No:TQC-B60055 11/06/11 By Summer 修正TQC-B60015,FUNCTION cs_fetch_price_A2需回傳兩個值
# Modify.........: No:FUN-B80095 11/08/25 By baogc 滿量促銷改善
# Modify.........: No:FUN-BC0071 11/12/21 By huangtao 增加促銷時段調整取價邏輯
# Modify.........: No:FUN-B90104 12/01/16 By huangrh 增加axmi404訂貨會明細的取價
# Modify.........: No:FUN-C10053 12/01/30 By yangxf 要去抓取產品策略所設定該產品對應的稅別資料來計算 ohb14(未稅金額) 及 ohb14t(含稅金額) 欄位的值.
# Modify.........: No:FUN-BC0079 12/02/06 By yangxf s_discount_amt1()中添加p_date参数
# Modify.........: No:TQC-C20171 12/02/15 By yangxf 解决於畫面單身輸入提案編號後按 enter 出現 error(-217)
# Modify.........: No:FUN-C20098 12/02/17 By huangtao 调整C2取价时有关摊位的问题
# Modify.........: No:TQC-C20379 12/02/22 By huangtao 調整促銷bug
# Modify.........: No:TQC-C20501 12/02/28 By huangtao 調整促銷bug
# Modify.........: No:TQC-C30005 12/03/01 By huangrh  服飾行業的取价策略中配置子料件資料，修改sql以便取到資料
# Modify.........: No:TQC-C30025 12/03/01 By pauline 取價時會員等級促銷錯誤 
# Modify.........: No:FUN-C30154 12/03/14 By pauline 一般促銷增加價格區間 
# Modify.........: No.FUN-C30151 12/03/20 By pauline artt304滿額促銷,當促銷為折扣時且條件為滿量,增加折扣基數
# Modify.........: No.TQC-C30329 12/03/30 By pauline 出貨單在取得單價的含稅與未稅價時,應從arti120內抓取稅率計算
# Modify.........: No:TQC-C40187 12/04/20 By fanbj l_raa07默認給值 '213'
# Modify.........: No:TQC-C50084 12/05/10 By zhuhao 若類型:1.訂單 2.出貨單 3.銷退單，則抓取當前單號對應的匯率
# Modify.........: No.CHI-C40023 12/05/17 By pauline 當數量傳入為null時應直接return 不繼續作業
# Modify.........: No.TQC-C60130 12/09/14 By zhuhao 促銷時p_booth IS NULL 應給空格
# Modify.........: No.TQC-CA0039 12/10/15 By dongsz 增加取價時報價單類型
# Modify.........: No.FUN-CA0152 12/11/13 By xumeimei p_type增加一个类型为7换增取价
# Modify.........: No.MOD-CC0222 12/12/26 By SunLM 修正促銷計算問題
# Modify.........: No:FUN-CC0146 12/12/28 By shiwuying 修正組合促銷達成倍數的Bug
# Modify.........: No:FUN-D30076 13/03/22 By baogc 取價sub回寫分攤折價邏輯調整
# Modify.........: No:FUN-D40011 13/04/02 By dongsz 促銷取價添加尾差處理（2.組合促銷 3.滿額/量促銷）
# Modify.........: No:FUN-D40010 13/04/03 By baogc 促銷取價效能優化
# Modify.........: No:MOD-D70144 13/07/22 By yuhuabao 13/07/22 #判断如果取价方式不涉及到C2类的话，直接更新当前行即可，不>
# Modify.........: No:160712     16/07/12 By yuhuabao 16/07/12 #A6价格判断变成根据 1、价格调价；2、币种；3、税种
...
#FUNCTION s_fetch_price_new(p_cust,p_item,p_booth,p_unit,p_date,p_type,p_plant,p_curr,p_term,p_payment,p_no,p_line,p_count,p_no1,p_cmd)    #FUN-BC0071 add p_booth
FUNCTION cs_fetch_price_new(p_cust,p_item,p_booth,p_unit,p_date,p_type,p_plant,p_curr,p_term,p_payment,p_no,p_line,p_count,p_no1,p_cmd,p_tax)    #FUN-BC0071 add p_booth  #add p_tax by guanyao160712
DEFINE p_cust       LIKE tqo_file.tqo01,     #客戶編號
       p_item       LIKE tqn_file.tqn03,     #料件編號
       p_booth      LIKE oeb_file.oeb49,     #攤位編號                      #FUN-BC0071 add
       ...
       p_tax        LIKE gec_file.gec01,     #税种 #add by guanyao160712   
...
DEFINE l_tmp        DYNAMIC ARRAY OF RECORD
                        ...
                        booth LIKE oeb_file.oeb49,       #FUN-BC0071 
...
DEFINE g_oeb       DYNAMIC ARRAY OF RECORD
                        oeb917  LIKE oeb_file.oeb917, #FUN-D30076 Add ,
                        oeb47   LIKE oeb_file.oeb47   #FUN-D30076 Add
                     END  RECORD
...
#FUN-C10053 add end   ---
   ...
   IF cl_null(p_count) THEN RETURN 0,0 END IF   #CHI-C40023 add 
      ...
      FOREACH cur_ohi03 INTO l_ohi03
         ...
         IF l_oah05 = 'N' THEN
            IF l_oah06 = 'N' THEN    #同組同類型價格不互斥
               ...
               CASE
                  WHEN l_ohi04 = 'A1'
                     CALL cs_fetch_price_A1(p_cust,p_item,p_unit,p_date,p_type,p_plant,p_curr)
                        RETURNING l_price
                  WHEN l_ohi04 = 'A2'
                     #CALL cs_fetch_price_A2(p_item,p_unit,p_plant)
                 #   CALL cs_fetch_price_A2(p_item,p_unit,p_plant,p_curr)  #MOD-B30225  #TQC-B40014 MARK
                 #   CALL cs_fetch_price_A2(p_no,p_type,p_item,p_unit,p_plant,p_curr)   #TQC-B40014 ADD #TQC-B60015 MARK
                     CALL cs_fetch_price_A2(p_no,p_type,p_item,p_unit,p_plant,p_curr,p_line,p_count)   #TQC-B60015 ADD
                        RETURNING l_price,l_a2_price  #TQC-B60015 ADD l_a2_price
                 #MOD-9C0173   ---start
                  WHEN l_ohi04 = 'A3' 
                     CALL cs_fetch_price_A3(p_item,p_no,p_plant,p_type)
                        RETURNING l_price
                  WHEN l_ohi04 = 'A4' 
                     CALL cs_fetch_price_A4(p_type,p_unit,p_plant,p_line,p_no,p_item,p_cust,p_term,p_curr)   #MOD-AB0237
                        RETURNING l_price
                  WHEN l_ohi04 = 'A5'
                     CALL cs_fetch_price_A5(p_item,p_cust,p_curr,p_plant)
                        RETURNING l_price
                  WHEN l_ohi04 = 'A6' 
                     #CALL s_fetch_price_A6(p_term,p_curr,p_item,p_unit,p_date,p_plant)         #mark by guanyao160712
                     CALL cs_fetch_price_A6(p_term,p_curr,p_item,p_unit,p_date,p_plant,p_tax)   #add by guanyao160712
                        RETURNING l_price    
                 #MOD-9C0173   ---end
                  WHEN l_ohi04 = 'B1'
                     CALL cs_fetch_price_B1(p_item,p_unit,p_date,p_plant,p_curr,p_term,p_count,l_price,p_no,p_line,p_type)
                        RETURNING l_rate
                  WHEN l_ohi04 = 'B2'
                     CALL cs_fetch_price_B2(p_cust,p_item,p_plant,l_price,p_no,p_line,p_count,p_type)
                        RETURNING l_rate1,l_rate2
                  WHEN l_ohi04 = 'C1'
                     CALL cs_fetch_price_C1(p_cust,p_item,p_unit,p_date,p_curr,p_no,p_line,l_price,p_plant,p_no1,p_type,p_count)
#                       RETURNING l_price    #MOD-B30234
                        RETURNING l_c1_price #MOD-B30234
                  WHEN l_ohi04 = 'C2'
                     CALL cs_fetch_price_C2(p_cust,p_item,p_booth,p_unit,p_date,p_plant,p_curr,p_term,p_type,p_no,p_line,l_price,p_count,l_ohi02,p_cmd) #FUN-BC0071
#                       RETURNING l_price    #MOD-B30234
                        RETURNING l_c2_price #MOD-B30234
                  WHEN l_ohi04 = 'C3' 
                     CALL cs_fetch_price_C3(p_cust,p_item,p_unit,p_date,p_plant,p_curr,p_term,p_payment,p_no,p_line,l_price,p_count,p_type) #FUN-9C0083 add p_type
#                       RETURNING l_price    #MOD-B30234
                        RETURNING l_c3_price #MOD-B30234
                  WHEN l_ohi04 = 'C4'
                     CALL cs_fetch_price_C4(p_cust,p_item,p_unit,p_date,p_plant,p_curr,p_term,p_payment,p_count,p_no,p_line,l_price,p_type)
#                       RETURNING l_price    #MOD-B30234
...
###TQC-B60015 - ADD -  END  ------------------------------------
         #FUN-CA0152---------------add----------str
         IF p_type = '7' THEN
            IF l_a1_price = 0 THEN
               EXIT FOREACH
            ELSE
               RETURN l_a1_price,l_a1_price
            END IF
         END IF
         #FUN-CA0152---------------add----------end
...
#  IF l_n1 >0 AND g_azw.azw04 = '2' THEN                        #MOD-B30045 MARK
   IF (l_n1 > 0 OR g_rxc_str = 'Y') AND g_azw.azw04 = '2' THEN  #MOD-B30045 ADD
      ...
      CASE p_type
        WHEN '1'
          #LET l_sql = "SELECT no,line,booth,item,unit,oeb37,qty,qty2,oeb917 FROM s_price_c2,   ",     #FUN-BC0071 #FUN-D30076 Mark
           LET l_sql = "SELECT no,line,booth,item,unit,oeb37,qty,qty2,oeb917,oeb47 FROM s_price_c2,   ",           #FUN-D30076 Add
                       cl_get_target_table(g_plant_new,'oeb_file'),
                       "   WHERE oeb01 = '",p_no,"' ",
                       "   AND oeb01 = no AND line = oeb03 "
        WHEN '2'
          #LET l_sql = "SELECT no,line,booth,item,unit,ogb37,qty,qty2,ogb917 FROM s_price_c2,   ",    #FUN-BC0071  #FUN-D30076 Mark
           LET l_sql = "SELECT no,line,booth,item,unit,ogb37,qty,qty2,ogb917,ogb47 FROM s_price_c2,   ",           #FUN-D30076 Add
                       cl_get_target_table(g_plant_new,'ogb_file'),
                       "   WHERE ogb01 = '",p_no,"' ",
                       "   AND ogb01 = no AND line = ogb03 "
        WHEN '3'
          #LET l_sql = "SELECT no,line,booth,item,unit,ohb37,qty,qty2,ohb917 FROM s_price_c2,   ",    #FUN-BC0071  #FUN-D30076 Mark
           LET l_sql = "SELECT no,line,booth,item,unit,ohb37,qty,qty2,ohb917,ohb67 FROM s_price_c2,   ",           #FUN-D30076 Add
     ...
     #FOREACH cur_scale_1 INTO l_tmp[l_cnt].* ,g_oeb[l_cnt].oeb917                    #FUN-D30076 Mark
      FOREACH cur_scale_1 INTO l_tmp[l_cnt].* ,g_oeb[l_cnt].oeb917,g_oeb[l_cnt].oeb47 #FUN-D30076 Add
         IF l_tmp[l_cnt].line <> p_line THEN 
            #CALL cs_fetch_price_new2(p_cust,l_tmp[l_cnt].item,l_tmp[l_cnt].booth,l_tmp[l_cnt].unit,p_date,p_type,p_plant,p_curr,p_term,p_payment,l_tmp[l_cnt].no,l_tmp[l_cnt].line,l_tmp[l_cnt].qty,p_no1,p_cmd,'2')#mark by guanyao160712
            CALL cs_fetch_price_new2(p_cust,l_tmp[l_cnt].item,l_tmp[l_cnt].booth,l_tmp[l_cnt].unit,p_date,p_type,p_plant,p_curr,p_term,p_payment,l_tmp[l_cnt].no,l_tmp[l_cnt].line,l_tmp[l_cnt].qty,p_no1,p_cmd,'2')
...
###-MOD-B30045- ADD -  END  ---------------------------------
    ...
    #    IF l_tmp[l_cnt].qty > l_tmp[l_cnt].qty2 THEN                         #MOD-B30045 MARK
        #IF (l_tmp[l_cnt].qty > l_tmp[l_cnt].qty2) OR (g_rxc_str = 'Y') THEN  #MOD-B30045 ADD                            #FUN-D30076 Mark
         IF (l_tmp[l_cnt].qty > l_tmp[l_cnt].qty2) OR (g_rxc_str = 'Y') OR (l_rxc06_1[l_cnt] <> g_oeb[l_cnt].oeb47) THEN #FUN-D30076 Add
              CASE p_type
                 WHEN '1'
       ...
       #            CALL cl_digcut(l_rxc06_1[l_cnt],t_azi03) RETURNING l_rxc06_1[l_cnt]    #FUN-B30012 MARK
        ...
        #              CALL cl_digcut(l_price_1[l_cnt],t_azi04) RETURNING l_price_1[l_cnt]  #FUN-B30012 MARK
                 ...
                 WHEN '2'
                   ...
                   #TQC-C30329 add START
                    IF g_azw.azw04 = '2' AND NOT s_industry("slk") THEN  
                       SELECT rtz04,rtz06 INTO l_rtz04,l_rtz06
                         FROM rtz_file
                        WHERE rtz01 = g_oga.ogaplant
                       CALL cs_ogb14t(l_tmp[l_cnt].item,l_rtz04,g_oga.oga213,g_oeb[l_cnt].oeb917,l_price_1[l_cnt],t_azi04)
                            RETURNING d_ogb[l_cnt].ogb14,d_ogb[l_cnt].ogb14t
                    ELSE
                   #TQC-C30329 add END
         ...
         #          CALL cl_digcut(l_price_1[l_cnt],t_azi03) RETURNING l_price_1[l_cnt]   #MOD-B20087 MARK
                 ...
                 WHEN '3'
                    ...
                    IF g_azw.azw04 = '2' AND NOT cl_null(l_rtz04) AND g_oha.oha03 = l_rtz06 THEN
                        CALL cs_t700_sub(p_item,l_rtz04,g_oha.oha213,g_oeb[l_cnt].oeb917,l_price_1[l_cnt],t_azi04)
                        RETURNING d_ohb[l_cnt].ohb14,d_ohb[l_cnt].ohb14t
                    ELSE 
                    #FUN-C10053 add end -----  
   ...
   IF p_cmd = 'e' OR p_cmd = 'd' OR p_cmd = 'u' THEN 
      IF p_type = '1' THEN
         ...
         LET l_sql = "SELECT oeb03 FROM ",cl_get_target_table(g_plant_new,'oeb_file'), #FUN-A50102
                     " WHERE oeb01 = '",p_no,"'"
#add by yuhuabao 130722 MOD-D70144
         IF l_n1=0 THEN
            LET l_sql = l_sql CLIPPED, " AND oeb03='",p_line,"'"
         END IF
#add by yuhuabao 130722 MOD-D70144
      END IF 
      IF p_type = '2' THEN
...
#add by yuhuabao 130722 MOD-D70144
         IF l_n1=0 THEN
            LET l_sql = l_sql CLIPPED, " AND  ogb03='",p_line,"'"
         END IF
#add by yuhuabao 130722 MOD-D70144
      END IF 
      IF p_type = '3' THEN
...
#add by yuhuabao 130722 MOD-D70144
         IF l_n1=0 THEN
            LET l_sql = l_sql CLIPPED, " AND  ohb03='",p_line,"'"
         END IF
#add by yuhuabao 130722 MOD-D70144
      END IF
      CALL cl_replace_sqldb(l_sql) RETURNING l_sql              #FUN-A50102							
...
END FUNCTION
FUNCTION cs_fetch_price_A1(p_cust,p_item,p_unit,p_date,p_type,p_plant,p_curr)
...
DEFINE l_ima151     LIKE ima_file.ima151 #TQC-C30005
  ...
  #TQC-C30005 add--begin----
   IF s_industry("slk") AND g_azw.azw04='2' 
     AND (g_prog='axmt410_slk' OR g_prog='axmt400_slk' OR g_prog='axmt420_slk' OR g_prog='axmt810_slk' OR  
          g_prog='axmt610_slk' OR g_prog='axmt620_slk' OR g_prog='axmt628_slk' OR g_prog='axmt629_slk' OR
          g_prog='axmt640_slk' OR g_prog='axmt700_slk' OR g_prog='axmi404') THEN
      LET l_ima151=NULL
      SELECT ima151 INTO l_ima151 FROM ima_file WHERE ima01=p_item
      IF l_ima151='Y' THEN
         LET l_sql="SELECT tqo03,tqn01,tqn05",
                   "  FROM ",cl_get_target_table(g_plant_new,'tqn_file'),",",
                             cl_get_target_table(g_plant_new,'tqo_file'),",",
                             cl_get_target_table(g_plant_new,'tqm_file'),",",
                             cl_get_target_table(g_plant_new,'imx_file'),
                   "  WHERE tqo01 = '",p_cust CLIPPED,"'",
                   "    AND tqo02 = tqn01",
                   "    AND tqm01 = tqn01",
                   "    AND tqn03 = imx000",
                   "    AND imx00 = '",p_item CLIPPED,"'",
   ...
   RETURN l_price
END FUNCTION
#FUNCTION cs_fetch_price_A2(p_item,p_unit,p_plant)
#FUNCTION cs_fetch_price_A2(p_item,p_unit,p_plant,p_curr)  #MOD-B30225   #TQC-B40014 MARK
#FUNCTION cs_fetch_price_A2(p_no,p_type,p_item,p_unit,p_plant,p_curr)     #TQC-B40014 ADD #TQC-B60015
FUNCTION cs_fetch_price_A2(p_no,p_type,p_item,p_unit,p_plant,p_curr,p_line,p_count)     #TQC-B60015 ADD
...
DEFINE l_exrate1    LIKE oea_file.oea24    #TQC-C50084 add
  #FUN-9C0068   ---start
  #SELECT azp03 INTO l_dbs FROM azp_file WHERE azp01 = p_plant
   LET g_plant_new = p_plant
   CALL s_gettrandbs()
...
#MOD-B30225--add--str--
   IF g_aza.aza17 <> p_curr THEN
     #LET l_exrate = s_curr3(p_curr,g_today,g_sma.sma904)   #TQC-C50084 mark
     #TQC-C50084 -- add -- begin
      IF p_type MATCHES '[123]' THEN
         LET l_exrate1 = 0
         CASE p_type
            WHEN '1'
               SELECT oea24 INTO l_exrate1 FROM oea_file
                WHERE oea01 = p_no
            WHEN '2'
               SELECT oga24 INTO l_exrate1 FROM oga_file
                WHERE oga01 = p_no
            WHEN '3'
               SELECT oha24 INTO l_exrate1 FROM oha_file
                WHERE oha01 = p_no
         END CASE
         LET l_exrate = l_exrate1
      ELSE
...
###-TQC-B40014- ADD - BEGIN ---------------------------------------------
   ...
   IF p_type <> '4' AND p_type <>'5' THEN   #FUN-B60067 ADD #TQC-C30005 add  <>'5'
      CALL cs_find_member(p_no,p_type,p_plant) RETURNING l_oea87
  ...
  #TQC-C30005 add--begin----
   IF s_industry("slk") AND g_azw.azw04='2'
     AND (g_prog='axmt410_slk' OR g_prog='axmt400_slk' OR g_prog='axmt420_slk' OR g_prog='axmt810_slk' OR
      ...
      SELECT ima151 INTO l_ima151 FROM ima_file WHERE ima01=p_item
      IF l_ima151='Y' THEN
         SELECT DISTINCT rtg05,rtg06,rtg08 INTO l_rtg05,l_rtg06,l_rtg08 FROM rtg_file,imx_file
          WHERE rtg01 = l_rtz05
            AND rtg03 = imx000
            AND imx00 = p_item
            AND rtg04 = p_unit
      ELSE
         SELECT rtg05,rtg06,rtg08 INTO l_rtg05,l_rtg06,l_rtg08 FROM rtg_file
...
#MOD-9C0173   ---start
FUNCTION cs_fetch_price_A3(p_item,p_no,p_plant,p_type)
DEFINE p_plant  LIKE azp_file.azp01 
...
DEFINE l_dbs    LIKE azp_file.azp03
DEFINE l_sql    STRING
DEFINE l_oea21  LIKE oea_file.oea21  #FUN-B90104---add
DEFINE l_oea23  LIKE oea_file.oea23  #FUN-B90104---add
...
#FUN-B90104---add----begin--
   IF p_type = '5' THEN  #訂貨明細取價--取客戶默認幣種、稅種
      SELECT occ42,occ41 INTO  l_oea23,l_oea21
         FROM occ_file WHERE occ01=g_cust
       CALL s_curr3(l_oea23,g_today,g_oaz.oaz52)  RETURNING l_oea24

       SELECT gec07  INTO l_oea213
          FROM gec_file  WHERE gec01 = l_oea21
   END IF
#FUN-B90104---add----end---
#TQC-CA0039 add str---
   IF p_type = '6' THEN
      SELECT oqt09,oqt24 INTO l_oea23,l_oea21
         FROM oqt_file WHERE oqt01=g_cust
      CALL s_curr3(l_oea23,g_today,g_oaz.oaz52)  RETURNING l_oea24
      SELECT gec07 INTO l_oea213
         FROM gec_file  WHERE gec01 = l_oea21
   END IF
...
FUNCTION cs_fetch_price_A4(p_type,p_unit,p_plant,p_line,p_no,p_item,p_cust,p_term,p_curr)
DEFINE l_price  LIKE oeb_file.oeb13
...
FUNCTION cs_fetch_price_A5(p_item,p_cust,p_curr,p_plant)
DEFINE p_plant     LIKE azp_file.azp01
DEFINE p_item      LIKE oeb_file.oeb04
DEFINE p_cust      LIKE oea_file.oea03
DEFINE p_curr      LIKE oea_file.oea23
...
DEFINE l_ima151    LIKE ima_file.ima151 #TQC-C30005 add
   ...
   IF s_industry("slk") AND g_azw.azw04='2'
     AND (g_prog='axmt410_slk' OR g_prog='axmt400_slk' OR g_prog='axmt420_slk' OR g_prog='axmt810_slk' OR
      ...
      SELECT ima151 INTO l_ima151 FROM ima_file WHERE ima01=p_item
      IF l_ima151='Y' THEN
         LET l_sql = "SELECT DISTINCT obk08 FROM ",cl_get_target_table(g_plant_new,'obk_file'),",",
                                                   cl_get_target_table(g_plant_new,'imx_file'),
                     " WHERE obk02 = '",p_cust,"'  ",
                     "   AND obk05 = '",p_curr,"' ",
                     "   AND obk01 = imx000",
                     "   AND imx00 ='",p_item,"'"
      ELSE
         LET l_sql = "SELECT obk08 FROM ",cl_get_target_table(g_plant_new,'obk_file'),
...
#FUNCTION s_fetch_price_A6(p_term,p_curr,p_item,p_unit,p_date,p_plant)   #mark by guanyao160712
FUNCTION cs_fetch_price_A6(p_term,p_curr,p_item,p_unit,p_date,p_plant,p_tax) #add by guanyao160712
DEFINE p_plant    LIKE azp_file.azp01
DEFINE p_term     LIKE oea_file.oea31
DEFINE p_curr     LIKE oea_file.oea23
DEFINE p_item     LIKE oeb_file.oeb04
...
DEFINE l_dbs      LIKE azp_file.azp03
DEFINE l_ima151   LIKE ima_file.ima151  #TQC-C30005 add
DEFINE p_tax      LIKE gec_file.gec01   #add by guanyao160712
   ...
   IF s_industry("slk") AND g_azw.azw04='2'
     AND (g_prog='axmt410_slk' OR g_prog='axmt400_slk' OR g_prog='axmt420_slk' OR g_prog='axmt810_slk' OR
      ...
      SELECT ima151 INTO l_ima151 FROM ima_file WHERE ima01=p_item
      IF l_ima151='Y' THEN
         LET l_sql = "SELECT DISTINCT CASE gec07 WHEN 'N' THEN xmf07 ELSE ta_xmf03 END CASE,xmf08 ",
                     "  FROM ",cl_get_target_table(g_plant_new,'xme_file'),",",
                               cl_get_target_table(g_plant_new,'gec_file'),",", #add by guanyao160715
                               cl_get_target_table(g_plant_new,'xmf_file'),",",
                               cl_get_target_table(g_plant_new,'imx_file'),
                     " WHERE xme01 = xmf01 AND xme02 = xmf02 ",
                     "   AND ta_xme01 =ta_xmf02",  #add by guanyao160712
                     "   AND imx00 = xmf03 ",
                     "   AND imx000 = '",p_item,"' ",
                     "   AND xmf01 = '",p_term,"' ",
                     "   AND xmf02 = '",p_curr,"' ",
                     "   AND xmf04 = '",p_unit,"' ",
                     "   AND xmf05 <= '",p_date,"' ",
                     "   AND ta_xmf02 =  '",p_tax,"' ",   #add by guanyao160712
                     "   AND ta_xmf02 = gec01",   #add by guanyao160715
                     "   AND xme00 = '1' ",
                     " ORDER BY xmf05 DESC,xmf07,xmf08 "
      ELSE
         LET l_sql = "SELECT CASE gec07 WHEN 'N' THEN xmf07 ELSE ta_xmf03 END CASE,xmf08 ",
                     "  FROM ",cl_get_target_table(g_plant_new,'xme_file'),",",
                               cl_get_target_table(g_plant_new,'gec_file'),",", #add by guanyao160715 
                               cl_get_target_table(g_plant_new,'xmf_file'),    
                     " WHERE xme01 = xmf01 AND xme02 = xmf02 ",
...
FUNCTION cs_fetch_price_B1(p_item,p_unit,p_date,p_plant,p_curr,p_term,p_count,p_price,p_no,p_line,p_type)
...
FUNCTION cs_fetch_price_B2(p_cust,p_item,p_plant,p_price,p_no,p_line,p_count,p_type)
DEFINE p_cust       LIKE tqo_file.tqo01,
       p_no         LIKE oeb_file.oeb01,  
       p_line       LIKE oeb_file.oeb03,  
       p_item       LIKE tqn_file.tqn03, 
...
FUNCTION cs_fetch_price_C1(p_cust,p_item,p_unit,p_date,p_curr,p_no,p_line,p_price,p_plant,p_no1,p_type,p_count)
  ...
  #FUN-9C0068   ---END
   ...
   ELSE                   #提案單中有符合條件的資料
      LET l_sql = "SELECT UNIQUE tqz09,tqx14,tqx16,tqz08 ",
                  ...
                  "    AND tqx09='",p_curr,"'",
                  "    AND tqxacti='Y' ",
#                 "    AND ",p_cust," IN ",         #TQC-C20171 MARK
                  "    AND tqy03 = '",p_cust,"'",   #TQC-C20171 add 
                  "    AND tqy03 IN ",              #TQC-C20171 add
                  "(SELECT tqy03 ",
...
FUNCTION cs_fetch_price_C2(p_cust,p_item,p_booth,p_unit,p_date,p_plant,p_curr,p_term,p_type,p_no,p_line,p_price,p_count,p_team,p_cmd)   #FUN-BC0071 add p_booth
#FUN-AA0065   ---start  -add
DEFINE p_item       LIKE tqn_file.tqn03 
DEFINE p_cust       LIKE occ_file.occ01   
DEFINE p_cmd        LIKE type_file.chr1
DEFINE p_booth      LIKE oeb_file.oeb49                       #FUN-BC0071 add
DEFINE p_unit       LIKE ima_file.ima25
DEFINE p_date       LIKE type_file.dat
...
DEFINE p_no1        LIKE tqx_file.tqx01     #提案單號
   IF l_sx_1 <> l_sx THEN
   CALL cs_fetch_price_new2(p_cust,p_item,p_booth,p_unit,p_date,p_type,p_plant,p_curr,p_term,p_payment,p_no,p_line,p_count,p_no1,p_cmd,'1')   #FUN-BC0071
...
#抓取最近的档期活动设置的顺序,当前默认为'213'（组合促销->一般促销->满额促销），预留这段逻辑 
   ...
   #IF cl_null(l_raa07) THEN LET l_raa07 = '213' END IF   #TQC-C40187 mark
   LET l_raa07 = '213'                                    #TQC-C40187 add
#參數設定需要重新審核，以當前機構活動代碼為准;否則以拋轉資料為主
   SELECT rtz11 INTO l_rtz11 FROM rtz_file WHERE rtz01=p_plant
   CALL cs_find_member(p_no,p_type,p_plant) RETURNING l_oea87   
   CALL cs_fetch_price_create_temp_table()
   CALL cs_fetch_price_ins_temp_table(p_price,p_cust,p_booth,p_item,p_unit,p_date,p_type,p_plant,p_curr,p_term,p_payment,p_no,p_line,p_count,p_no1,p_cmd)  #FUN-BC0071 
   CASE p_type
       WHEN '1'
           LET l_sql = "DELETE FROM ",cl_get_target_table(g_plant_new,'rxc_file'), 
...
###-FUN-B30012 - ADD -  END  ---------------------------------------------
   ...
   FOR l_i = 1 TO 3
      CASE l_raa07[l_i,l_i]
         WHEN '1'             #一般促销
            CALL cs_price1(p_cust,p_item,p_booth,p_unit,p_date,p_no,p_line,p_price,p_type,p_plant,p_term,p_curr,p_count,p_team)     #FUN-BC0071
         WHEN '2'
            CALL cs_price2(p_cust,p_item,p_booth,p_unit,p_date,p_no,p_line,p_price,p_type,p_plant,p_term,p_curr,p_count,p_team)     #FUN-BC0071
         WHEN '3'
            CALL cs_price3(p_cust,p_item,p_booth,p_unit,p_date,p_no,p_line,p_price,p_type,p_plant,p_term,p_curr,p_count,p_team)     #FUN-BC0071
      END CASE
   END FOR  
   LET l_sql = "SELECT no,line FROM s_price_c2 WHERE item ='",p_item,"' AND line = '",p_line,"' "
   CALL cl_replace_sqldb(l_sql) RETURNING l_sql              							
...
#   LET l_time = TIME
#   #No.FUN-A10106 --begin
#   CALL cs_base_price(p_cust,p_item,p_unit,p_date,p_type,p_plant,p_curr,p_team,p_term,p_line,p_no) #MOD-9C0173 
...
#            CALL cs_price1(p_cust,p_item,p_unit,p_date,p_no,p_line,p_price,p_type,p_plant,p_term,p_curr,'1',p_count,p_team) 
#               RETURNING l_success,l_price 
#         WHEN l_rwa07[l_i] = '2'    #品類特價促銷
#            CALL cs_price1(p_cust,p_item,p_unit,p_date,p_no,p_line,p_price,p_type,p_plant,p_term,p_curr,'2',p_count,p_team) 
#               RETURNING l_success,l_price 
#         WHEN l_rwa07[l_i] = '3' 
#            CALL cs_price3(p_cust,p_item,p_unit,p_date,p_no,p_line,p_price,p_type,p_plant,p_term,p_curr,p_count,p_team) 
...
END FUNCTION
#FUN-AA0065   ---start --add
FUNCTION  cs_price1(p_cust,p_item,p_booth,p_unit,p_date,p_no,p_line,p_price,p_type,p_plant,p_term,p_curr,p_count,p_team)   #FUN-BC0071 
DEFINE p_cust        LIKE occ_file.occ01
DEFINE p_team        LIKE ohi_file.ohi02
DEFINE p_item        LIKE ima_file.ima01
DEFINE p_booth       LIKE oeb_file.oeb49                    #FUN-BC0071 
DEFINE p_unit        LIKE ima_file.ima25
DEFINE p_date        LIKE type_file.dat
DEFINE p_term        LIKE oah_file.oah01
DEFINE p_curr        LIKE azi_file.azi01
...
#FUN-BC0071 ------------STA
DEFINE l_rac_t       RECORD LIKE rac_file.*
DEFINE l_raq06       LIKE raq_file.raq06
DEFINE l_raq07       LIKE raq_file.raq07
DEFINE l_rak10       LIKE rak_file.rak10
DEFINE l_rak11       LIKE rak_file.rak11
DEFINE l_rap05       LIKE rap_file.rap05
#FUN-BC0071 ------------END
DEFINE l_rad04       LIKE rad_file.rad04 #FUN-D40010 Add
   ...
   LET l_time = TIME
   LET l_sql1 = "SELECT DISTINCT rac_file.*,raq06,raq07,rak10,rak11 ",          #FUN-BC0071 add rak10 rak11
                "  FROM ",cl_get_target_table(g_plant_new,'rab_file'),",",
                          ...
                          cl_get_target_table(g_plant_new,'rak_file'),",",      #FUN-BC0071 add  #FUN-D40010 Add ",",
                          cl_get_target_table(g_plant_new,'rad_file'),          #FUN-D40010 Add
           ...
           #      " AND (raq08  IS NULL OR raq08 = ' ' OR raq08 = '",p_booth CLIPPED,"')",
                 " AND rak01 = rac01 AND rak02 = rac02 AND rak03 = '1' ",
                 " AND rak04 = rac03 AND rakplant=racplant AND rakacti = 'Y'",
                 " AND (rak06 <= '",p_date,"' AND rak07 >= '",p_date,"')",
                 " AND (rak08 <= '",l_time,"' AND rak09 >= '",l_time,"')",
           #FUN-BC0071 ----------------END 
                "   AND rabacti = 'Y' AND rabconf = 'Y' ",
                "   AND racacti = 'Y' AND raqacti = 'Y' ",        #FUN-B10024
               #FUN-D40010 Add Begin ---
                "   AND rad01 = rac01 ",
                "   AND rad02 = rac02 ",
                "   AND rad03 = rac03 ",
                "   AND radacti = 'Y' ",
                "   AND radplant = racplant ",
                "   AND (   (rad04 = '01' AND rad05 IN (SELECT item    FROM s_price_c2 WHERE qty2 > 0))",
                "        OR (rad04 = '02' AND rad05 IN (SELECT ima131  FROM ",cl_get_target_table(g_plant_new,'ima_file'),",s_price_c2 WHERE ima01 = item AND qty2 > 0) )",
                "        OR (rad04 = '03' AND rad05 IN (SELECT ima1004 FROM ",cl_get_target_table(g_plant_new,'ima_file'),",s_price_c2 WHERE ima01 = item AND qty2 > 0) ) ",
                "        OR (rad04 = '04' AND rad05 IN (SELECT ima1005 FROM ",cl_get_target_table(g_plant_new,'ima_file'),",s_price_c2 WHERE ima01 = item AND qty2 > 0) ) ",
                "        OR (rad04 = '05' AND rad05 IN (SELECT ima1006 FROM ",cl_get_target_table(g_plant_new,'ima_file'),",s_price_c2 WHERE ima01 = item AND qty2 > 0) ) ",
                "        OR (rad04 = '06' AND rad05 IN (SELECT ima1007 FROM ",cl_get_target_table(g_plant_new,'ima_file'),",s_price_c2 WHERE ima01 = item AND qty2 > 0) ) ",
                "        OR (rad04 = '07' AND rad05 IN (SELECT ima1008 FROM ",cl_get_target_table(g_plant_new,'ima_file'),",s_price_c2 WHERE ima01 = item AND qty2 > 0) ) ",
                "        OR (rad04 = '08' AND rad05 IN (SELECT ima1009 FROM ",cl_get_target_table(g_plant_new,'ima_file'),",s_price_c2 WHERE ima01 = item AND qty2 > 0) ) ",
                "        OR (rad04 = '09' AND rad05 IN (SELECT tqa01   FROM ",cl_get_target_table(g_plant_new,'tqa_file'),",s_price_c2 WHERE tqa03 = '27' AND qty2 > 0 AND tqa05 <= price AND tqa06 >= price) ) ) ",
               #FUN-D40010 Add End -----
                " ORDER BY raq06 DESC,raq07 DESC,rac02,rac03 " #By shi    FUN-BC0071 add rac02
           #    " ORDER BY rac03 "
   ...
   FOREACH s_sel_rac_cs INTO l_rac.*,l_raq06,l_raq07,l_rak10,l_rak11       #FUN-BC0071 add l_raq06,l_raq07,l_rak10,l_rak11
#FUN-BC0071 -----------------STA
      IF NOT cl_null(l_rak10) THEN
          IF l_rak10 <> DAY(p_date)  THEN CONTINUE FOREACH  END IF
      END IF     
      IF NOT cl_null(l_rak11) THEN
        IF  (l_rak11+7) MOD 7  <>  WEEKDAY(p_date) THEN CONTINUE FOREACH END IF
      END IF 
      IF l_rac_t.rac02 = l_rac.rac02 AND l_rac_t.rac03 = l_rac.rac03 THEN
         CONTINUE FOREACH 
      ELSE
         LET l_rac_t.* = l_rac.*
      END IF
...
#   IF l_rac.rac08 = 'Y' THEN                     
    IF l_rac.rac08 <> '0' THEN   
       CASE l_rac.rac08   #會員促銷方式
         WHEN  "1"     #會員等級  
#FUN-BC0071 -----------------------END    
...
#FUN-BC0071 -----------------------STA
         WHEN "2"      #會員類型
            LET l_sql = "SELECT lpk13 ",
                        "  FROM ",cl_get_target_table(g_plant_new,'lpk_file'),",", 
                                  cl_get_target_table(g_plant_new,'lpj_file'),
                        " WHERE lpk01=lpj01 AND lpj03 = '",l_oea87,"' "
         WHEN "3"      #會員卡種
            LET l_sql = "SELECT lpj02 ",
                        "  FROM ",cl_get_target_table(g_plant_new,'lpj_file'),
                        " WHERE lpj03 = '",l_oea87,"' "
       END CASE
...
#     EXECUTE pre_del_lpk01 INTO l_lpk10              #FUN-BC0071 mark
      EXECUTE pre_del_lpk01 INTO l_rap05              #FUN-BC0071 add
...
#                 " AND rapplant='",l_rac.racplant,"' AND rap05='",l_lpk10,"' AND rapacti='Y' AND rap03='1' "  #FUN-BC0071 mark
                  " AND rapplant='",l_rac.racplant,"' AND rap05='",l_rap05,"' AND rapacti='Y' AND rap03='1' ", #FUN-BC0071 add
                #," AND rap04 = '",l_rac.rac04,"'"                                                             #FUN-BC0071 add  #TQC-C30025 mark
                  " AND rap04 = '",l_rac.rac03,"'"  #TQC-C30025 add
      CALL cl_replace_sqldb(l_sql) RETURNING l_sql              							
      CALL cl_parse_qry_sql(l_sql,g_plant_new) RETURNING l_sql              
...
### -MOD-B20087- ADD -  END  ----------------------------------------
  ...
  #FUN-D40010 Add Begin ---
   LET g_sql = "SELECT DISTINCT rad04 FROM ",cl_get_target_table(g_plant_new,'rad_file'),
               " WHERE rad01 = '",l_rac.rac01,"' ",
               "   AND rad02 = '",l_rac.rac02,"' AND rad03 = '",l_rac.rac03,"' ",
               "   AND radacti = 'Y' AND radplant = '",l_rac.racplant,"' ",
               " ORDER BY rad04 "
   PREPARE sel_rad04_pre FROM g_sql
   DECLARE sel_rad04_cs CURSOR FOR sel_rad04_pre
  #FUN-D40010 Add End -----

  #FUN-D40010 Mark&Add Begin ---
  #LET g_sql = "SELECT * FROM s_price_c2 WHERE qty2 > 0  "
   LET g_sql = "SELECT * FROM s_price_c2,",cl_get_target_table(g_plant_new,'ima_file'),
               " WHERE ima01 = item AND qty2 > 0  "
   INITIALIZE l_rad04 TO NULL
   FOREACH sel_rad04_cs INTO l_rad04
      CASE l_rad04
         WHEN '01'
            LET g_sql = g_sql CLIPPED,
               "   AND ima01   IN (SELECT rad05 FROM ",cl_get_target_table(g_plant_new,'rad_file')," WHERE rad04 = '01' AND rad01 = '",l_rac.rac01,"' AND rad02 = '",l_rac.rac02,"' AND rad03 = '",l_rac.rac03,"' AND radacti = 'Y' AND radplant = '",l_rac.racplant,"') "
         WHEN '02'
            LET g_sql = g_sql CLIPPED,
               "   AND ima131  IN (SELECT rad05 FROM ",cl_get_target_table(g_plant_new,'rad_file')," WHERE rad04 = '02' AND rad01 = '",l_rac.rac01,"' AND rad02 = '",l_rac.rac02,"' AND rad03 = '",l_rac.rac03,"' AND radacti = 'Y' AND radplant = '",l_rac.racplant,"') "
         WHEN '03'
            LET g_sql = g_sql CLIPPED,
               "   AND ima1004 IN (SELECT rad05 FROM ",cl_get_target_table(g_plant_new,'rad_file')," WHERE rad04 = '03' AND rad01 = '",l_rac.rac01,"' AND rad02 = '",l_rac.rac02,"' AND rad03 = '",l_rac.rac03,"' AND radacti = 'Y' AND radplant = '",l_rac.racplant,"') "
         WHEN '04'
            LET g_sql = g_sql CLIPPED,
               "   AND ima1005 IN (SELECT rad05 FROM ",cl_get_target_table(g_plant_new,'rad_file')," WHERE rad04 = '04' AND rad01 = '",l_rac.rac01,"' AND rad02 = '",l_rac.rac02,"' AND rad03 = '",l_rac.rac03,"' AND radacti = 'Y' AND radplant = '",l_rac.racplant,"') "
         WHEN '05'
            LET g_sql = g_sql CLIPPED,
               "   AND ima1006 IN (SELECT rad05 FROM ",cl_get_target_table(g_plant_new,'rad_file')," WHERE rad04 = '05' AND rad01 = '",l_rac.rac01,"' AND rad02 = '",l_rac.rac02,"' AND rad03 = '",l_rac.rac03,"' AND radacti = 'Y' AND radplant = '",l_rac.racplant,"') "
         WHEN '06'
            LET g_sql = g_sql CLIPPED,
               "   AND ima1007 IN (SELECT rad05 FROM ",cl_get_target_table(g_plant_new,'rad_file')," WHERE rad04 = '06' AND rad01 = '",l_rac.rac01,"' AND rad02 = '",l_rac.rac02,"' AND rad03 = '",l_rac.rac03,"' AND radacti = 'Y' AND radplant = '",l_rac.racplant,"') "
         WHEN '07'
            LET g_sql = g_sql CLIPPED,
               "   AND ima1008 IN (SELECT rad05 FROM ",cl_get_target_table(g_plant_new,'rad_file')," WHERE rad04 = '07' AND rad01 = '",l_rac.rac01,"' AND rad02 = '",l_rac.rac02,"' AND rad03 = '",l_rac.rac03,"' AND radacti = 'Y' AND radplant = '",l_rac.racplant,"') "
         WHEN '08'
            LET g_sql = g_sql CLIPPED,
               "   AND ima1009 IN (SELECT rad05 FROM ",cl_get_target_table(g_plant_new,'rad_file')," WHERE rad04 = '08' AND rad01 = '",l_rac.rac01,"' AND rad02 = '",l_rac.rac02,"' AND rad03 = '",l_rac.rac03,"' AND radacti = 'Y' AND radplant = '",l_rac.racplant,"') "
         WHEN '09'
            LET g_sql = g_sql CLIPPED,
               "   AND EXISTS (SELECT 1 FROM ",cl_get_target_table(g_plant_new,'tqa_file'),
               "                WHERE tqa01 IN (SELECT rad05 FROM ",cl_get_target_table(g_plant_new,'rad_file')," WHERE rad04 = '09' AND rad01 = '",l_rac.rac01,"' AND rad02 = '",l_rac.rac02,"' AND rad03 = '",l_rac.rac03,"' AND radacti = 'Y' AND radplant = '",l_rac.racplant,"') ",
               "                  AND tqa03 = '27' ",
               "                  AND tqa05 <= price ",
               "                  AND tqa06 >= price) "
      END CASE
  ...
  #FUN-D40010 Mark&Add Begin ---
   ...
   PREPARE cs_fetch_price_C2_prepare3 FROM g_sql                                                
   DECLARE cs_fetch_price_C2_curs3 CURSOR FOR cs_fetch_price_C2_prepare3   
   FOREACH cs_fetch_price_C2_curs3 INTO l_tmp.*               
     ...
     #FUN-D40010 Mark Begin ---
     #料号检查已在抓值Sql过滤，故此处Mark
     #IF NOT cs_fetch_price_chk('1',l_rac.rac01,l_rac.rac02,l_rac.rac03,g_plant_new,l_tmp.item,l_tmp.booth,p_date,l_tmp.price) THEN   #FUN-BC0071   #FUN-C30154 add price
     #   CONTINUE FOREACH
     #END IF
     #FUN-D40010 Mark Begin ---
      ...
      CASE l_rac.rac04	
       ...
       IF l_rab.rab07 = 'Y'  THEN	
          ...
          LET l_sql = "INSERT INTO s_price_c2_1 ",
                  "(no,line,booth,item,type,cx_no,price,qty,qty1,qty2,flg1,flg2 )",    #FUN-BC0071 
                  "VALUES(?,?,?,?,?,?, ?,?,?,?,?,?)"                                   #FUN-BC0071
                  PREPARE pre_ins_no3 FROM l_sql
                  EXECUTE pre_ins_no3 USING l_tmp.no,l_tmp.line,l_tmp.booth,l_tmp.item,'1',l_rab.rab02,l_price,l_tmp.qty2,                              
...
###-添加新的會員卡折扣邏輯###
      ELSE
         IF l_rab.rab10 = 'Y' AND l_rab.rab07 = 'N' AND l_oea87 IS NOT NULL THEN
            ...
            IF l_lph36 = 'Y' THEN
               CALL s_discount_amt1(l_oea87,p_item,p_date) RETURNING  l_lpj11   #FUN-BC0079 add p_date
...
FUNCTION  cs_price2(p_cust,p_item,p_booth,p_unit,p_date,p_no,p_line,p_price,p_type,p_plant,p_term,p_curr,p_count,p_team)   #FUN-BC0071
DEFINE p_cust       LIKE occ_file.occ01
DEFINE p_team       LIKE ohi_file.ohi02
DEFINE p_item       LIKE ima_file.ima01
DEFINE p_booth      LIKE oeb_file.oeb49               #FUN-BC0071
...
DEFINE l_tmp        DYNAMIC ARRAY OF RECORD
                     ...
                     END  RECORD 
#FUN-CC0146 Begin---
DEFINE l_tmp_n      DYNAMIC ARRAY OF RECORD
                        raf03 LIKE raf_file.raf03,
                        zu    LIKE type_file.num5
                    END RECORD
DEFINE l_use         LIKE type_file.chr1
DEFINE l_i           LIKE type_file.num5
...
DEFINE l_rae_t       RECORD LIKE rae_file.*
DEFINE l_raq06       LIKE raq_file.raq06
DEFINE l_raq07       LIKE raq_file.raq07
DEFINE l_rak10       LIKE rak_file.rak10
DEFINE l_rak11       LIKE rak_file.rak11
DEFINE l_rap05       LIKE rap_file.rap05
DEFINE l_booth       LIKE oeb_file.oeb49
#FUN-BC0071 ------------END
DEFINE l_str         STRING              #FUN-D40010 Add
DEFINE l_rag04       LIKE rag_file.rag04 #FUN-D40010 Add
DEFINE l_line        LIKE oeb_file.oeb03 #FUN-D40010 Add
...
#更新本次消耗数量为0
    ...
    END IF
    LET l_time = TIME
    LET l_sql1 = "SELECT DISTINCT rae_file.*,raq06,raq07,rak10,rak11 ",      #FUN-BC0071 add
                 "  FROM ",cl_get_target_table(g_plant_new,'rae_file'),",",
                           cl_get_target_table(g_plant_new,'raf_file'),",",
                           cl_get_target_table(g_plant_new,'raq_file'),",",
                           cl_get_target_table(g_plant_new,'rak_file'),",",    #FUN-BC0071 add #FUN-D40010 Add ",",
                           cl_get_target_table(g_plant_new,'rag_file'),        #FUN-D40010 Add
          ...
          #      " AND (raq08  IS NULL OR raq08 = ' ' OR raq08 = '",p_booth CLIPPED,"')",
                 " AND rak01 = raf01 AND rak02 = raf02 AND rak03 = '2' ",
                 " AND (rak04 IS NULL OR rak04 =0) AND rakplant=rafplant AND rakacti = 'Y'",
                 " AND (rak06 <= '",p_date,"' AND rak07 >= '",p_date,"')",
                 " AND (rak08 <= '",l_time,"' AND rak09 >= '",l_time,"')",
          #FUN-BC0071 -----------------END 
                ...
                #FUN-D40010 Add Begin ---
                 ...
                 "   AND rag02 = rae02 ",
                 "   AND ragacti = 'Y' ",
                 "   AND ragplant = raeplant ",
                 "   AND (   (rag04 = '01' AND rag05 IN (SELECT item    FROM s_price_c2 WHERE qty2 > 0) )",
                 "        OR (rag04 = '02' AND rag05 IN (SELECT ima131  FROM ",cl_get_target_table(g_plant_new,'ima_file'),",s_price_c2 WHERE item = ima01 AND qty2 > 0) )",
                 "        OR (rag04 = '03' AND rag05 IN (SELECT ima1004 FROM ",cl_get_target_table(g_plant_new,'ima_file'),",s_price_c2 WHERE item = ima01 AND qty2 > 0) ) ",
                 "        OR (rag04 = '04' AND rag05 IN (SELECT ima1005 FROM ",cl_get_target_table(g_plant_new,'ima_file'),",s_price_c2 WHERE item = ima01 AND qty2 > 0) ) ",
                 "        OR (rag04 = '05' AND rag05 IN (SELECT ima1006 FROM ",cl_get_target_table(g_plant_new,'ima_file'),",s_price_c2 WHERE item = ima01 AND qty2 > 0) ) ",
                 "        OR (rag04 = '06' AND rag05 IN (SELECT ima1007 FROM ",cl_get_target_table(g_plant_new,'ima_file'),",s_price_c2 WHERE item = ima01 AND qty2 > 0) ) ",
                 "        OR (rag04 = '07' AND rag05 IN (SELECT ima1008 FROM ",cl_get_target_table(g_plant_new,'ima_file'),",s_price_c2 WHERE item = ima01 AND qty2 > 0) ) ",
                 "        OR (rag04 = '08' AND rag05 IN (SELECT ima1009 FROM ",cl_get_target_table(g_plant_new,'ima_file'),",s_price_c2 WHERE item = ima01 AND qty2 > 0) ) ",
                 "        OR (rag04 = '09' AND rag05 IN (SELECT tqa01   FROM ",cl_get_target_table(g_plant_new,'tqa_file'),",s_price_c2 WHERE tqa03 = '27' AND qty2 > 0 AND tqa05 <= price AND tqa06 >= price) ) ) ",
                #FUN-D40010 Add End -----
    ...
    FOREACH s_sel_rae_cs INTO l_rae.*,l_raq06,l_raq07,l_rak10,l_rak11      #FUN-BC0071 add 
#FUN-BC0071 -----------------STA
       IF NOT cl_null(l_rak10) THEN
          IF l_rak10 <> DAY(p_date)  THEN CONTINUE FOREACH  END IF
       END IF     
       IF NOT cl_null(l_rak11) THEN
          IF  (l_rak11+7) MOD 7  <>  WEEKDAY(p_date) THEN CONTINUE FOREACH END IF
       END IF 
       IF l_rae_t.rae02 = l_rae.rae02  THEN
          CONTINUE FOREACH 
       ELSE
          LET l_rae_t.* = l_rae.*
       END IF
...
#       IF l_rae.rae12 = 'Y' THEN                     
        IF l_rae.rae12 <>'0' THEN    
           CASE l_rae.rae12   #會員促銷方式
              WHEN  "1"     #會員等級  
#FUN-BC0071 -----------------------END                           
                LET l_sql = "SELECT lpk10 ",
                            "  FROM ",cl_get_target_table(g_plant_new,'lpk_file'),",",
...
#           EXECUTE pre_del_lpk02 INTO l_lpk10                #FUN-BC0071 mark
            EXECUTE pre_del_lpk02 INTO l_rap05                #FUN-BC0071 add
            LET l_sql = "SELECT rap06,rap07,rap08 ",
                        "  FROM ",cl_get_target_table(g_plant_new,'rap_file'),
                        " WHERE rap01='",l_rae.rae01,"' AND rap02='",l_rae.rae02,"'  ",
#                       " AND rapplant='",l_rae.raeplant,"' AND rap05='",l_lpk10,"' AND rapacti='Y' AND rap03='2' "     #FUN-BC0071 mark
                        " AND rapplant='",l_rae.raeplant,"' AND rap05='",l_rap05,"' AND rapacti='Y' AND rap03='2' "     #FUN-BC0071 add 
...
### -MOD-B20087- ADD -  END  -------------------------------------
        ...
        LET l_raf03 =''
        LET l_sum_qty2 = 0
        CALL l_tmp_n.clear() ##FUN-CC0146
        UPDATE s_price_c2 SET raf03 = ''  

       #FUN-D40010 Add Begin ---
        INITIALIZE l_str   TO NULL
        INITIALIZE l_rag04 TO NULL
        LET g_sql = "SELECT DISTINCT rag04 FROM ",cl_get_target_table(g_plant_new,'rag_file'),
                    " WHERE rag01 = '",l_rae.rae01,"' ",
                    "   AND rag02 = '",l_rae.rae02,"' ",
                    "   AND ragacti = 'Y' AND ragplant = '",l_rae.raeplant,"' ",
                    " ORDER BY rag04 "
        PREPARE sel_rag04_pre FROM g_sql
        DECLARE sel_rag04_cs CURSOR FOR sel_rag04_pre
        FOREACH sel_rag04_cs INTO l_rag04
           IF NOT cl_null(l_str) THEN LET l_str = l_str CLIPPED," OR " END IF
           CASE l_rag04
              WHEN '01'
                 LET l_str = l_str CLIPPED,
                    "   ima01   IN (SELECT rag05 FROM ",cl_get_target_table(g_plant_new,'rag_file')," WHERE rag04 = '01' AND rag01 = '",l_rae.rae01,"' AND rag02 = '",l_rae.rae02,"' AND ragacti = 'Y' AND ragplant = '",l_rae.raeplant,"') "
              WHEN '02'
                 LET l_str = l_str CLIPPED,
                    "   ima131  IN (SELECT rag05 FROM ",cl_get_target_table(g_plant_new,'rag_file')," WHERE rag04 = '02' AND rag01 = '",l_rae.rae01,"' AND rag02 = '",l_rae.rae02,"' AND ragacti = 'Y' AND ragplant = '",l_rae.raeplant,"') "
              WHEN '03'
                 LET l_str = l_str CLIPPED,
                    "   ima1004 IN (SELECT rag05 FROM ",cl_get_target_table(g_plant_new,'rag_file')," WHERE rag04 = '03' AND rag01 = '",l_rae.rae01,"' AND rag02 = '",l_rae.rae02,"' AND ragacti = 'Y' AND ragplant = '",l_rae.raeplant,"') "
              WHEN '04'
                 LET l_str = l_str CLIPPED,
                    "   ima1005 IN (SELECT rag05 FROM ",cl_get_target_table(g_plant_new,'rag_file')," WHERE rag04 = '04' AND rag01 = '",l_rae.rae01,"' AND rag02 = '",l_rae.rae02,"' AND ragacti = 'Y' AND ragplant = '",l_rae.raeplant,"') "
              WHEN '05'
                 LET l_str = l_str CLIPPED,
                    "   ima1006 IN (SELECT rag05 FROM ",cl_get_target_table(g_plant_new,'rag_file')," WHERE rag04 = '05' AND rag01 = '",l_rae.rae01,"' AND rag02 = '",l_rae.rae02,"' AND ragacti = 'Y' AND ragplant = '",l_rae.raeplant,"') "
              WHEN '06'
                 LET l_str = l_str CLIPPED,
                    "   ima1007 IN (SELECT rag05 FROM ",cl_get_target_table(g_plant_new,'rag_file')," WHERE rag04 = '06' AND rag01 = '",l_rae.rae01,"' AND rag02 = '",l_rae.rae02,"' AND ragacti = 'Y' AND ragplant = '",l_rae.raeplant,"') "
              WHEN '07'
                 LET l_str = l_str CLIPPED,
                    "   ima1008 IN (SELECT rag05 FROM ",cl_get_target_table(g_plant_new,'rag_file')," WHERE rag04 = '07' AND rag01 = '",l_rae.rae01,"' AND rag02 = '",l_rae.rae02,"' AND ragacti = 'Y' AND ragplant = '",l_rae.raeplant,"') "
              WHEN '08'
                 LET l_str = l_str CLIPPED,
                    "   ima1009 IN (SELECT rag05 FROM ",cl_get_target_table(g_plant_new,'rag_file')," WHERE rag04 = '08' AND rag01 = '",l_rae.rae01,"' AND rag02 = '",l_rae.rae02,"' AND ragacti = 'Y' AND ragplant = '",l_rae.raeplant,"') "
              WHEN '09'
                 LET l_str = l_str CLIPPED,
                    "   EXISTS (SELECT 1 FROM ",cl_get_target_table(g_plant_new,'tqa_file'),
                    "            WHERE tqa01 IN (SELECT rag05 FROM ",cl_get_target_table(g_plant_new,'rag_file')," WHERE rag04 = '09' AND rag01 = '",l_rae.rae01,"' AND rag02 = '",l_rae.rae02,"' AND ragacti = 'Y' AND ragplant = '",l_rae.raeplant,"') ",
                    "              AND tqa03 = '27' ",
                    "              AND tqa05 <= price ",
                    "              AND tqa06 >= price) "
           END CASE
       ...
       #            " WHERE qty2 > 0 ",	
       #            " GROUP BY item "	
        LET g_sql = "SELECT item,line,price,qty2 FROM s_price_c2,",cl_get_target_table(g_plant_new,'ima_file')," ",	
                    " WHERE item = ima01 AND qty2 > 0 "
        IF NOT cl_null(l_str) THEN LET g_sql = g_sql CLIPPED," AND (",l_str CLIPPED,") " END IF
        LET g_sql = g_sql CLIPPED," ORDER BY item "
       #FUN-D40010 Mark&Add End -----
        PREPARE cs_fetch_price_C2_prepare1 FROM g_sql                                                
        DECLARE cs_fetch_price_C2_curs1 CURSOR FOR cs_fetch_price_C2_prepare1  

       #FOREACH cs_fetch_price_C2_curs1 INTO l_item,l_sum_qty2                 #FUN-D40010 Mark
        FOREACH cs_fetch_price_C2_curs1 INTO l_item,l_line,l_price,l_sum_qty2  #FUN-D40010 Add
            IF SQLCA.sqlcode != 0 THEN
                CALL cl_err('foreach:',SQLCA.sqlcode,1)
                EXIT FOREACH
            END IF
#FUN-BC0071 ------------------STA
            LET l_sql = "SELECT SUM(qty2) ",    
                        "  FROM  s_price_c2,",
                                 cl_get_target_table(g_plant_new,'rae_file'),",",
                                 cl_get_target_table(g_plant_new,'raq_file'),
                        " WHERE rae01 = raq01 AND rae02 = raq02 ",
                        "   AND rae01 = '",l_rae.rae01,"' AND rae02 = '",l_rae.rae02,"'",
                        "   AND raeplant=raqplant",
                        "   AND raq03 = '2' AND raq04 = '",p_plant,"'",
                        "   AND raq05 = 'Y'",                                         
                        "   AND raeacti = 'Y' AND raeconf = 'Y' ",
                        "   AND raqacti = 'Y' ",
                        "   AND (raq08 = ' ' OR raq08 IS NULL OR raq08 = booth) ",
                        "   AND line = '",l_line,"' ", #FUN-D40010 Add
                        "   AND item = '",l_item,"'" 
             CALL cl_replace_sqldb(l_sql) RETURNING l_sql            							
             CALL cl_parse_qry_sql(l_sql,g_plant_new) RETURNING l_sql          
             PREPARE s_sel_qty2_pre FROM l_sql
             EXECUTE s_sel_qty2_pre INTO l_sum_qty2 
             IF cl_null(l_sum_qty2) OR  l_sum_qty2 = 0 THEN
                CONTINUE FOREACH
             END IF        
#FUN-BC0071 -----------------------END
            ...
            FOREACH s_sel_raf_cs INTO l_raf03,l_raf04,l_raf05	
              #IF NOT cs_fetch_price_chk('2',l_rae.rae01,l_rae.rae02,l_raf03,g_plant_new,l_item,'',p_date,'') THEN #FUN-BC0071  #FUN-C30154 add '' #FUN-D40010 Mark
               IF NOT cs_fetch_price_chk('2',l_rae.rae01,l_rae.rae02,l_raf03,g_plant_new,l_item,'',p_date,l_price) THEN                            #FUN-D40010 Add
                   CONTINUE FOREACH	
               END IF	
#FUN-C20098 -----------------STA
#              UPDATE s_price_c2 SET raf03 = l_raf03 WHERE item = l_item 
               LET l_sql = " UPDATE s_price_c2 SET raf03 = '",l_raf03,"'",
                           "  WHERE item = '",l_item,"'",
                           "    AND line = '",l_line,"'", #FUN-D40010 Add
                           "    AND booth in (",
                           "   SELECT booth FROM  s_price_c2,",
                                                  cl_get_target_table(g_plant_new,'rae_file'),",",
                                                  cl_get_target_table(g_plant_new,'raf_file'),",",
                                                  cl_get_target_table(g_plant_new,'raq_file'),
                           "   WHERE rae01 = raf01 AND rae02 = raf02",
                           "     AND rae01 = raq01 AND rae02 = raq02",
                           "     AND raf01 = '",l_rae.rae01,"' AND raf02 = '",l_rae.rae02,"'",
                           "     AND raeplant=rafplant AND raeplant=raqplant",
                           "     AND raq03 = '2' AND raq04 = '",p_plant,"'",
                           "     AND raq05 = 'Y'",
                           "     AND raeacti = 'Y' AND raeconf = 'Y' ",
                           "     AND raqacti = 'Y' ",
                           "     AND (raq08 = ' ' OR raq08  IS NULL OR ",
                           "          raq08 = booth) ",
                           "     AND item = '",l_item,"')"
                CALL cl_replace_sqldb(l_sql) RETURNING l_sql
                CALL cl_parse_qry_sql(l_sql,g_plant_new) RETURNING l_sql
                PREPARE s_upd_c2_pre FROM l_sql
                EXECUTE s_upd_c2_pre
...
#FUN-C20098 -----------------END             
               IF l_raf04 = '1' THEN  #必选	
                 ...
                 #FUN-CC0146 Begin---
                 #不能用l_zu1_t来判断，可能满足组合促销某一组有多个项次的料号
                 #可以在临时表s_price_c2中增加一个栏位，记录这个组满足多少次该组合促销，然后取最小的倍数
                 #这里处理方法：加一个数组，记录每个组达成的促销的倍数，然后取数组中最小的值，表示达成多少次组合促销
                 #IF cl_null(l_zu1_t) OR l_zu1_t = 0  THEN LET l_zu1_t = l_zu1 END IF
	         #IF l_zu1 >= l_zu1_t THEN #MOD-CC0222 mark
                 #   LET l_zu1 = l_zu1_t #MOD-CC0222 mark
                 #END IF     #MOD-CC0222 mark
                  LET l_use = 'N'
                  LET l_i1 = 0
                  FOR l_i = 1 TO l_tmp_n.getLength()
                      IF l_tmp_n[l_i].raf03 = l_raf03 THEN
                         IF l_tmp_n[l_i].zu < l_zu1 THEN
                            LET l_tmp_n[l_i].zu = l_zu1
                         END IF
                         LET l_use = 'Y'
                      END IF
                      LET l_i1 = l_i1+1
                  END FOR
                  IF l_use = 'N' THEN
                     LET l_tmp_n[l_i1+1].raf03 = l_raf03
                     LET l_tmp_n[l_i1+1].zu = l_zu1
                  END IF
                 #FUN-CC0146 End-----
	       ELSE
       ...
       #取数组中的最小值
        LET l_zu1 = 0
        FOR l_i = 1 TO l_tmp_n.getLength()
            IF l_i = 1 THEN LET l_zu1_t = l_tmp_n[l_i].zu END IF
            IF l_tmp_n[l_i].zu <= l_zu1_t THEN
               LET l_zu1 = l_tmp_n[l_i].zu
            END IF
        END FOR
       #FUN-CC0146 End-----
        ...
        PREPARE cs_fetch_price_C2_prepare2 FROM g_sql                                                
        DECLARE cs_fetch_price_C2_curs2 CURSOR FOR cs_fetch_price_C2_prepare2   
        FOREACH cs_fetch_price_C2_curs2 INTO l_tmp1.*
            IF SQLCA.sqlcode != 0 THEN
                CALL cl_err('foreach:',SQLCA.sqlcode,1)
                EXIT FOREACH
            END IF 
    ...
    #           WHERE raf03= l_zu
            ...
            IF l_raf04 = '1' THEN  
               LET   l_zuzo = l_raf05 * l_zu        #該組滿足用到的個數
                 #SELECT SUM(qty1) INTO l_qty1 FROM s_price_c2  WHERE item = l_tmp1.item  AND raf03 IS NOT NULL  #FUN-CC0146
                  SELECT SUM(qty1) INTO l_qty1 FROM s_price_c2  WHERE raf03 = l_tmp1.raf03 AND raf03 IS NOT NULL #FUN-CC0146
          ...
          #     SELECT SUM(qty1) INTO l_qty1 FROM s_price_c2  WHERE item = l_tmp1.item  AND raf03 IS NOT NULL
                SELECT SUM(qty1) INTO l_qty1 FROM s_price_c2
                 WHERE raf03 IS NOT NULL AND raf03 = l_tmp1.raf03
          #FUN-C20098  ----------------END                                                      
                  IF l_qty1 >= l_zuzo THEN
                     CONTINUE FOREACH
                  END IF
        ...
        PREPARE cs_fetch_price_C2_prepare6 FROM g_sql                                                
        DECLARE cs_fetch_price_C2_curs6 CURSOR FOR cs_fetch_price_C2_prepare6 
        FOREACH cs_fetch_price_C2_curs6 INTO l_tmp[l_cnt].*   #by 每筆單身算本次消耗數量
           CASE l_rae.rae10	
               WHEN '1'
                  SELECT SUM(qty1*price) INTO l_sum3 FROM s_price_c2 
                  WHERE qty1 > 0 AND item =l_tmp[l_cnt].item AND line =l_tmp[l_cnt].line
                  SELECT count(*)  INTO g_cnt FROM s_price_c2 WHERE qty1 > 0      #FUN-D40011 add
                  IF l_cnt <> g_cnt THEN                                          #FUN-D40011 add
                     LET l_rxc06 = (l_sum1 - l_price1*l_zu)*l_sum3/l_sum1
                     LET l_price = l_price1*l_zu*l_sum3/l_sum1/l_tmp[l_cnt].qty1
                 #FUN-D40011--add--str---
                  ELSE
                     LET l_rxc06 = (l_sum1 - l_price1*l_zu) - l_sum2
                     LET l_price = l_price1*l_zu*l_sum3/l_sum1/l_tmp[l_cnt].qty1
                  END IF
                 #FUN-D40011--add--end---
	       WHEN '2'
	       ...
	       WHEN '3'
	             ...
	             LET l_rxc06 = (l_price3*l_zu)*(l_tmp[l_cnt].price*l_tmp[l_cnt].qty1)/l_sum1
                    ...
                    #LET l_sum2 = l_sum2 + l_rxc06                                #FUN-D40011 mark
                  ELSE
           ...
           IF l_rae.rae23 = 'Y' OR (l_rae.rae26 = 'Y' AND l_oea87 IS NOT NULL) THEN
               ...
               LET l_sql = "INSERT INTO s_price_c2_1 ",
                  ...
                  EXECUTE pre_ins_no2 USING l_tmp[l_cnt].no,l_tmp[l_cnt].line,l_tmp[l_cnt].booth,l_tmp[l_cnt].item,'2',l_rae.rae02,l_price,l_tmp[l_cnt].qty1,           #FUN-BC0071                     
...
###-MOD-B20087- MARK -  END  ------------------------------------------------------------
           ...
           CALL cl_digcut(l_rxc06,t_azi04) RETURNING l_rxc06
           LET l_rxc.rxc06 = l_rxc06
           LET l_sum2      = l_sum2 + l_rxc06                    #FUN-D40011 add
           LET l_rxc.rxc07 = l_rtv13
           LET l_rxc.rxc08 = ''
           LET l_rxc.rxc09 = 0
           LET l_rxc.rxc10 = 0
...
FUNCTION  cs_price3(p_cust,p_item,p_booth,p_unit,p_date,p_no,p_line,p_price,p_type,p_plant,p_term,p_curr,p_count,p_team)    #FUN-BC0071 
DEFINE p_cust       LIKE occ_file.occ01
DEFINE p_team       LIKE ohi_file.ohi02
DEFINE p_item       LIKE ima_file.ima01
DEFINE p_booth      LIKE oeb_file.oeb49                      #FUN-BC0071 
...
DEFINE l_line        LIKE oeb_file.oeb03 
#DEFINE l_sub         LIKE type_file.num5   #FUN-B80095 MARK
DEFINE l_sub         LIKE rxc_file.rxc06    #FUN-B80095 ADD
DEFINE l_rap06       LIKE rap_file.rap06
DEFINE l_rap07       LIKE rap_file.rap07
DEFINE l_rap08       LIKE rap_file.rap08
...
#DEFINE l_amt         LIKE type_file.num5      #TQC-C20501 
DEFINE l_amt         LIKE rxc_file.rxc06       #TQC-C20501
...
DEFINE l_lph36       LIKE lph_file.lph36
### -MOD-B20087- ADD -  END  --------------------------------
DEFINE l_qty_n       LIKE type_file.num5     #FUN-B80095 ADD  #計數變量
DEFINE l_cnt3        LIKE type_file.num5     #FUN-B80095 ADD  #計數變量
#FUN-BC0071 ------------STA

DEFINE l_rah_t       RECORD LIKE rah_file.*
DEFINE l_raq06       LIKE raq_file.raq06
DEFINE l_raq07       LIKE raq_file.raq07
DEFINE l_rak10       LIKE rak_file.rak10
DEFINE l_rak11       LIKE rak_file.rak11
DEFINE l_rap05       LIKE rap_file.rap05
DEFINE l_zhe         LIKE rai_file.rai06
DEFINE l_tonum       LIKE type_file.num5
DEFINE l_booth       LIKE oeb_file.oeb49
DEFINE l_sum         LIKE type_file.num5  #FUN-C30151 add
#FUN-BC0071 ------------END
#FUN-D40011--add--str---
DEFINE l_cnt_temp    LIKE type_file.num5     #記錄臨時表中滿足條件的筆數
DEFINE l_cnt_foreach LIKE type_file.num5     #記錄FOREACH的筆數
DEFINE l_sum2        LIKE type_file.num20_6  #記錄折價合計
#FUN-D40011--add--end---
DEFINE l_str         STRING              #FUN-D40010 Add
DEFINE l_raj04       LIKE raj_file.raj04 #FUN-D40010 Add
...
#剩余数量>0，才可以走下面的逻辑
    ...
    LET l_time = TIME
    LET l_sql1 = "SELECT DISTINCT rah_file.*,raq06,raq07,rak10,rak11 ",
                 "  FROM ",cl_get_target_table(g_plant_new,'rah_file'),",",
                           cl_get_target_table(g_plant_new,'rai_file'),",",
                           cl_get_target_table(g_plant_new,'raq_file'),",",
                           cl_get_target_table(g_plant_new,'rak_file'),",",            #FUN-BC0071 add #FUN-D40010 Add ",",
                           cl_get_target_table(g_plant_new,'raj_file'),                #FUN-D40010 Add
          ...
          #      #"    OR (rah04 = '",p_date,"' AND rah06 <= '",l_time,"')",      #FUN-B80095 MARK
          #      "    OR ((rah04 = '",p_date,"' AND rah06 <= '",l_time,"')",     #FUN-B80095 ADD
          #      #"    OR (rah05 = '",p_date,"' AND rah07 >= '",l_time,"'))",     #FUN-B80095 MARK
          #      "   AND (rah05 = '",p_date,"' AND rah07 >= '",l_time,"')))",    #FUN-B80095 ADD
          #       " AND (raq08  IS NULL OR raq08 = ' ' OR raq08 = '",p_booth CLIPPED,"')",
                 " AND rak01 = rai01 AND rak02 = rai02 AND rak03 = '3' ",
                 " AND (rak04 IS NULL OR rak04 = 0) AND rakplant=raiplant AND rakacti = 'Y'",
                 " AND (rak06 <= '",p_date,"' AND rak07 >= '",p_date,"')",
                 " AND (rak08 <= '",l_time,"' AND rak09 >= '",l_time,"')",
          #FUN-BC0071 ------------------END 
                ...
                #FUN-D40010 Add Begin ---
                 ...
                 "   AND raj02 = rah02 ",
                 "   AND rajacti = 'Y' ",
                 "   AND rajplant = rahplant ",
                 "   AND (   (raj04 = '01' AND raj05 IN (SELECT item    FROM s_price_c2   WHERE qty2 > 0 UNION ALL ",
                 "                                       SELECT item    FROM s_price_c2_1 WHERE qty2 > 0 AND flg2 = 'Y') )",
                 "        OR (raj04 = '02' AND raj05 IN (SELECT ima131  FROM ",cl_get_target_table(g_plant_new,'ima_file'),",s_price_c2   WHERE item = ima01 AND qty2 > 0 UNION ALL ",
                 "                                       SELECT ima131  FROM ",cl_get_target_table(g_plant_new,'ima_file'),",s_price_c2_1 WHERE item = ima01 AND qty2 > 0 AND flg2 = 'Y') )",
                 "        OR (raj04 = '03' AND raj05 IN (SELECT ima1004 FROM ",cl_get_target_table(g_plant_new,'ima_file'),",s_price_c2   WHERE item = ima01 AND qty2 > 0 UNION ALL ",
                 "                                       SELECT ima1004 FROM ",cl_get_target_table(g_plant_new,'ima_file'),",s_price_c2_1 WHERE item = ima01 AND qty2 > 0 AND flg2 = 'Y') )",
                 "        OR (raj04 = '04' AND raj05 IN (SELECT ima1005 FROM ",cl_get_target_table(g_plant_new,'ima_file'),",s_price_c2   WHERE item = ima01 AND qty2 > 0 UNION ALL ",
                 "                                       SELECT ima1005 FROM ",cl_get_target_table(g_plant_new,'ima_file'),",s_price_c2_1 WHERE item = ima01 AND qty2 > 0 AND flg2 = 'Y') )",
                 "        OR (raj04 = '05' AND raj05 IN (SELECT ima1006 FROM ",cl_get_target_table(g_plant_new,'ima_file'),",s_price_c2   WHERE item = ima01 AND qty2 > 0 UNION ALL ",
                 "                                       SELECT ima1006 FROM ",cl_get_target_table(g_plant_new,'ima_file'),",s_price_c2_1 WHERE item = ima01 AND qty2 > 0 AND flg2 = 'Y') )",
                 "        OR (raj04 = '06' AND raj05 IN (SELECT ima1007 FROM ",cl_get_target_table(g_plant_new,'ima_file'),",s_price_c2   WHERE item = ima01 AND qty2 > 0 UNION ALL ",
                 "                                       SELECT ima1007 FROM ",cl_get_target_table(g_plant_new,'ima_file'),",s_price_c2_1 WHERE item = ima01 AND qty2 > 0 AND flg2 = 'Y') )",
                 "        OR (raj04 = '07' AND raj05 IN (SELECT ima1008 FROM ",cl_get_target_table(g_plant_new,'ima_file'),",s_price_c2   WHERE item = ima01 AND qty2 > 0 UNION ALL ",
                 "                                       SELECT ima1008 FROM ",cl_get_target_table(g_plant_new,'ima_file'),",s_price_c2_1 WHERE item = ima01 AND qty2 > 0 AND flg2 = 'Y') )",
                 "        OR (raj04 = '08' AND raj05 IN (SELECT ima1009 FROM ",cl_get_target_table(g_plant_new,'ima_file'),",s_price_c2   WHERE item = ima01 AND qty2 > 0 UNION ALL ",
                 "                                       SELECT ima1009 FROM ",cl_get_target_table(g_plant_new,'ima_file'),",s_price_c2_1 WHERE item = ima01 AND qty2 > 0 AND flg2 = 'Y') )",
                 "        OR (raj04 = '09' AND raj05 IN (SELECT tqa01   FROM ",cl_get_target_table(g_plant_new,'tqa_file'),",s_price_c2   WHERE tqa03 = '27' AND qty2 > 0 AND tqa05 <= price AND tqa06 >= price UNION ALL ",
                 "                                       SELECT tqa01   FROM ",cl_get_target_table(g_plant_new,'tqa_file'),",s_price_c2_1 WHERE tqa03 = '27' AND qty2 > 0 AND tqa05 <= price AND tqa06 >= price AND flg2 = 'Y') ) ) ",
                #FUN-D40010 Add End -----
                 " ORDER BY raq06 DESC,raq07 DESC "   #By shi
         #       " ORDER BY rah02 DESC "
    ...
    FOREACH s_sel_rah_cs INTO l_rah.*,l_raq06,l_raq07,l_rak10,l_rak11        #FUN-BC0071  add  
...
#FUN-BC0071 -----------------STA
      ...
      IF NOT cl_null(l_rak11) THEN
        IF  (l_rak11+7) MOD 7  <>  WEEKDAY(p_date) THEN CONTINUE FOREACH END IF
      END IF 
      IF l_rah_t.rah02 = l_rah.rah02  THEN
         CONTINUE FOREACH 
      ELSE
         LET l_rah_t.* = l_rah.*
      END IF
...
#算出剩余数量部分 达到多少金额
      ...
      #FUN-D40010 Add Begin ---
       INITIALIZE l_str   TO NULL
       INITIALIZE l_raj04 TO NULL
       LET g_sql = "SELECT DISTINCT raj04 FROM ",cl_get_target_table(g_plant_new,'raj_file'),
                   " WHERE raj01 = '",l_rah.rah01,"' ",
                   "   AND raj02 = '",l_rah.rah02,"' ",
                   "   AND rajacti = 'Y' AND rajplant = '",l_rah.rahplant,"' ",
                   " ORDER BY raj04 "
       PREPARE sel_raj04_pre FROM g_sql
       DECLARE sel_raj04_cs CURSOR FOR sel_raj04_pre
       FOREACH sel_raj04_cs INTO l_raj04
          IF NOT cl_null(l_str) THEN LET l_str = l_str CLIPPED," OR " END IF
          CASE l_raj04
             WHEN '01'
                LET l_str = l_str CLIPPED,
                   "   ima01   IN (SELECT raj05 FROM ",cl_get_target_table(g_plant_new,'raj_file')," WHERE raj04 = '01' AND raj01 = '",l_rah.rah01,"' AND raj02 = '",l_rah.rah02,"' AND rajacti = 'Y' AND rajplant = '",l_rah.rahplant,"') "
             WHEN '02'
                LET l_str = l_str CLIPPED,
                   "   ima131  IN (SELECT raj05 FROM ",cl_get_target_table(g_plant_new,'raj_file')," WHERE raj04 = '02' AND raj01 = '",l_rah.rah01,"' AND raj02 = '",l_rah.rah02,"' AND rajacti = 'Y' AND rajplant = '",l_rah.rahplant,"') "
             WHEN '03'
                LET l_str = l_str CLIPPED,
                   "   ima1004 IN (SELECT raj05 FROM ",cl_get_target_table(g_plant_new,'raj_file')," WHERE raj04 = '03' AND raj01 = '",l_rah.rah01,"' AND raj02 = '",l_rah.rah02,"' AND rajacti = 'Y' AND rajplant = '",l_rah.rahplant,"') "
             WHEN '04'
                LET l_str = l_str CLIPPED,
                   "   ima1005 IN (SELECT raj05 FROM ",cl_get_target_table(g_plant_new,'raj_file')," WHERE raj04 = '04' AND raj01 = '",l_rah.rah01,"' AND raj02 = '",l_rah.rah02,"' AND rajacti = 'Y' AND rajplant = '",l_rah.rahplant,"') "
             WHEN '05'
                LET l_str = l_str CLIPPED,
                   "   ima1006 IN (SELECT raj05 FROM ",cl_get_target_table(g_plant_new,'raj_file')," WHERE raj04 = '05' AND raj01 = '",l_rah.rah01,"' AND raj02 = '",l_rah.rah02,"' AND rajacti = 'Y' AND rajplant = '",l_rah.rahplant,"') "
             WHEN '06'
                LET l_str = l_str CLIPPED,
                   "   ima1007 IN (SELECT raj05 FROM ",cl_get_target_table(g_plant_new,'raj_file')," WHERE raj04 = '06' AND raj01 = '",l_rah.rah01,"' AND raj02 = '",l_rah.rah02,"' AND rajacti = 'Y' AND rajplant = '",l_rah.rahplant,"') "
             WHEN '07'
                LET l_str = l_str CLIPPED,
                   "   ima1008 IN (SELECT raj05 FROM ",cl_get_target_table(g_plant_new,'raj_file')," WHERE raj04 = '07' AND raj01 = '",l_rah.rah01,"' AND raj02 = '",l_rah.rah02,"' AND rajacti = 'Y' AND rajplant = '",l_rah.rahplant,"') "
             WHEN '08'
                LET l_str = l_str CLIPPED,
                   "   ima1009 IN (SELECT raj05 FROM ",cl_get_target_table(g_plant_new,'raj_file')," WHERE raj04 = '08' AND raj01 = '",l_rah.rah01,"' AND raj02 = '",l_rah.rah02,"' AND rajacti = 'Y' AND rajplant = '",l_rah.rahplant,"') "
             WHEN '09'
                LET l_str = l_str CLIPPED,
                   "   EXISTS (SELECT 1 FROM ",cl_get_target_table(g_plant_new,'tqa_file'),
                   "            WHERE tqa01 IN (SELECT raj05 FROM ",cl_get_target_table(g_plant_new,'raj_file')," WHERE raj04 = '09' AND raj01 = '",l_rah.rah01,"' AND raj02 = '",l_rah.rah02,"' AND rajacti = 'Y' AND rajplant = '",l_rah.rahplant,"') ",
                   "              AND tqa03 = '27' ",
                   "              AND tqa05 <= price ",
                   "              AND tqa06 >= price) "
          END CASE
      ...
      #FUN-D40010 Add End -----
       ...
       LET l_amt = 0 
       IF cl_null(l_str) THEN #FUN-D40010 Add
          LET l_sql = "SELECT '1',line,booth,item,price,qty2,'' ",            #FUN-BC0071
                      "  FROM s_price_c2",
                      " WHERE qty2 > 0",
                      " UNION ",
                      "SELECT '2',line,booth,item,price,qty2,cx_no ",          #FUN-BC0071
                      "  FROM s_price_c2_1",
                      " WHERE qty2 > 0 AND flg2 = 'Y' "
      #FUN-D40010 Add Begin ---
       ELSE
          LET l_sql = "SELECT '1',line,booth,item,price,qty2,'' ",
                      "  FROM s_price_c2,",cl_get_target_table(g_plant_new,'ima_file')," ",
                      " WHERE item = ima01 AND qty2 > 0 ",
                      "   AND (",l_str CLIPPED,") ",
                      " UNION ",
                      "SELECT '2',line,booth,item,price,qty2,cx_no ",
                      "  FROM s_price_c2_1,",cl_get_target_table(g_plant_new,'ima_file')," ",
                      " WHERE item = ima01 AND qty2 > 0 AND flg2 = 'Y' ",
                      "   AND (",l_str CLIPPED,") "
       END IF
      #FUN-D40010 Add End -----
       PREPARE cs_fetch_price_C2_prepare4 FROM l_sql                                                
       DECLARE cs_fetch_price_C2_curs4 CURSOR FOR cs_fetch_price_C2_prepare4   
       FOREACH cs_fetch_price_C2_curs4 INTO l_fg,l_line,l_booth,l_item,l_price,l_qty2,l_cx_no      #FUN-BC0071
           IF SQLCA.sqlcode != 0 THEN
              CALL cl_err('foreach:',SQLCA.sqlcode,1)
              EXIT FOREACH
           END IF 
           IF l_rah.rah11 = '2' THEN
             #IF NOT cs_fetch_price_chk('3',l_rah.rah01,l_rah.rah02,'',g_plant_new,l_item,l_booth,p_date,'') THEN    #FUN-BC0071  #FUN-C30154 add '' #FUN-D40010 Mark
              IF NOT cs_fetch_price_chk('3',l_rah.rah01,l_rah.rah02,'',g_plant_new,l_item,l_booth,p_date,l_price) THEN                               #FUN-D40010 Add
                  CONTINUE FOREACH
              END IF
#FUN-BC0071 -------------------STA
           ELSE
               LET l_sql = "SELECT COUNT(*) ",
                     "  FROM ",cl_get_target_table(g_plant_new,'rah_file'),",",
                               cl_get_target_table(g_plant_new,'rai_file'),",",
                               cl_get_target_table(g_plant_new,'raq_file'),",",
                               cl_get_target_table(g_plant_new,'rak_file'),            
                     " WHERE rah01 = rai01 AND rah02 = rai02",
                     "   AND rah01 = raq01 AND rah02 = raq02",
                     "   AND rai02 = '",l_rah.rah02,"'",
                     "   AND rahplant=raiplant AND rahplant=raqplant",
                     "   AND raq03 = '3' AND raq04 = '",g_plant_new,"'",
                     "   AND raq05 = 'Y'",                                         
                     "   AND (raq08  IS NULL OR raq08 = ' ' OR raq08 = '",l_booth CLIPPED,"')",
                     "   AND rak01 = rai01 AND rak02 = rai02 AND rak03 = '3' ",
                     "   AND (rak04 IS NULL OR rak04 = 0) AND rakplant=raiplant AND rakacti = 'Y'",
                     "   AND (rak06 <= '",p_date,"' AND rak07 >= '",p_date,"')",
                     "   AND (rak08 <= '",l_time,"' AND rak09 >= '",l_time,"')",
                 ...
                 CALL cl_replace_sqldb(l_sql) RETURNING l_sql             							
                 CALL cl_parse_qry_sql(l_sql,g_plant_new) RETURNING l_sql  
                 PREPARE s_sel_count_pre2 FROM l_sql   
                 EXECUTE s_sel_count_pre2 INTO l_n
                 IF l_n = 0  THEN
                    CONTINUE FOREACH
                 END IF
#FUN-BC0071 -------------------END
...
###-MOD-B30045- ADD -  END  --------------------------------------------------
       ...
       LET l_cnt = 1
 #     LET  i = 1
       LET l_zhe = 0                 #FUN-BC0071  add
       IF l_rah.rah12 = 'Y' THEN  #分段計算
          LET l_sql = "SELECT * ",
                      "  FROM ",cl_get_target_table(g_plant_new,'rai_file'),
                      " WHERE rai01 = '",l_rah.rah01,"' AND rai02 = '",l_rah.rah02,"'",
                      "   AND raiplant = '",g_plant_new,"'",
...
#             IF l_rai[l_cnt].rai07 = 'Y' THEN	
              IF l_rai[l_cnt].rai07 <> '0' THEN   
                 CASE l_rai[l_cnt].rai07   #會員促銷方式
                   WHEN  "1"     #會員等級  
#FUN-BC0071 -----------------------END  
#按照会员等级设置	
                      LET l_sql = "SELECT lpk10 ",
...
#                EXECUTE pre_del_lpk10 INTO l_lpk10        #FUN-BC0071  mark
                 EXECUTE pre_del_lpk10 INTO l_rap05        #FUN-BC0071  add
                 LET l_sql = "SELECT rap06,rap07,rap08 ",
                             "  FROM ",cl_get_target_table(g_plant_new,'rap_file'),
                             " WHERE rap01='",l_rah.rah01,"' AND rap02='",l_rah.rah02,"'  ",
#                            " AND rapplant='",l_rah.rahplant,"' AND rap05='",l_lpk10,"' AND rapacti='Y' AND rap03='3' "     #FUN-BC0071  mark
                             " AND rapplant='",l_rah.rahplant,"' AND rap05='",l_rap05,"' AND rapacti='Y' AND rap03='3' ",    #FUN-BC0071  add  
                             " AND rap04 = '",l_rai[l_cnt].rai03,"'"  #FUN-C30151 add
...
#                      LET l_price31[l_cnt] = l_rap08
                       IF cl_null(l_rai[l_cnt].rai10) OR l_rai[l_cnt].rai10 = 0 THEN
                          LET l_rai[l_cnt].rai10 = l_amt
                       END IF
                       LET l_tonum = l_amt/l_rai[l_cnt].rai10
                       LET l_price31[l_cnt] = l_tonum*l_rap08

                    WHEN '4'                                          
                       LET l_price31[l_cnt] = 0  
                       IF cl_null(l_rai[l_cnt].rai10) OR l_rai[l_cnt].rai10 = 0 THEN
                          LET l_rai[l_cnt].rai10 = l_amt
                       END IF
                       LET l_tonum = l_amt/l_rai[l_cnt].rai10
                       LET l_zhe = l_zhe+ l_tonum*l_rap08                  
#FUN-BC0071 ----------------END
                 END CASE
              ELSE	
                 IF l_oea87 IS NOT NULL  THEN  #是否為會員
### -MOD-B20087- ADD - BEGIN ----------------------------------------
                    INITIALIZE l_lpj02,l_lph04 TO NULL
                    SELECT lpj02 INTO l_lpj02 FROM lpj_file WHERE lpj03 = l_oea87
                    SELECT lph04 INTO l_lph04 FROM lph_file WHERE lph01 = l_lpj02
                    IF l_lph04 = 'Y' THEN   #會員促銷方式  不分類
### -MOD-B20087- ADD -  END  ----------------------------------------
                       CASE l_rah.rah10
                          WHEN '2'   
...
#                            LET l_price31[l_cnt] = l_rai[l_cnt].rai09
                             ...
                             END IF
                             LET l_tonum = l_amt/l_rai[l_cnt].rai10
                             LET l_price31[l_cnt] = l_tonum*l_rai[l_cnt].rai09
                          ...
                          WHEN '4'                                          
                             ...
                             END IF
                             LET l_tonum = l_amt/l_rai[l_cnt].rai10
                             LET l_zhe = l_zhe+ l_tonum*l_rai[l_cnt].rai09                      
#FUN-BC0071 ---------------END                             
                       END CASE
### -MOD-B20087- ADD - BEGIN ----------------------------------------
                    ELSE
...
#                            LET l_price31[l_cnt] = l_rai[l_cnt].rai06
                             ...
                             END IF
                             LET l_tonum = l_amt/l_rai[l_cnt].rai10
                             LET l_price31[l_cnt] = l_tonum*l_rai[l_cnt].rai06
                          ...
                          WHEN '4'                                         
                             ...
                             END IF
                             LET l_tonum = l_amt/l_rai[l_cnt].rai10
                             LET l_zhe = l_zhe+ l_tonum*l_rai[l_cnt].rai06                     
#FUN-BC0071 ----------------END
                       END CASE
                    END IF
### -MOD-B20087- ADD -  END  ----------------------------------------
...
#FUN-BC0071 -----------------------STA           
#           IF l_rai[l_cnt].rai07 = 'Y' THEN	
           #IF l_rai[l_cnt].rai07 <> '0' THEN   #FUN-C30151 mark
            IF l_rai1.rai07 <> '0' THEN   #FUN-C30151 add 
              #CASE l_rai[l_cnt].rai07   #會員促銷方式  #FUN-C30151 mark
               CASE l_rai1.rai07         #會員促銷方式  #FUN-C30151 add
                  WHEN  "1"     #會員等級  
#FUN-BC0071 -----------------------END  
         #按照会员等级设置	
                     LET l_sql = "SELECT lpk10 ",
...
#            EXECUTE pre_del_lpk03 INTO l_lpk10             #FUN-BC0071 mark
             EXECUTE pre_del_lpk03 INTO l_rap05             #FUN-BC0071  
             LET l_sql = "SELECT rap06,rap07,rap08 ",
                         "  FROM ",cl_get_target_table(g_plant_new,'rap_file'),
                         " WHERE rap01='",l_rah.rah01,"' AND rap02='",l_rah.rah02,"'  ",
#                        " AND rapplant='",l_rah.rahplant,"' AND rap05='",l_lpk10,"' AND rapacti='Y' AND rap03='3' "        #FUN-BC0071 mark
                         " AND rapplant='",l_rah.rahplant,"' AND rap05='",l_rap05,"' AND rapacti='Y' AND rap03='3' ",       #FUN-BC0071
                         " AND rap04 = '",l_rai1.rai03,"'"  #FUN-C30151 add
             CALL cl_replace_sqldb(l_sql) RETURNING l_sql              							
             CALL cl_parse_qry_sql(l_sql,g_plant_new) RETURNING l_sql              
             ...
             CASE l_rah.rah10
                WHEN '2'   
                   ...
                   #FUN-C30151 add START
                    IF cl_null(l_rai1.rai10) OR l_rai1.rai10 =0  THEN
                       LET l_rai1.rai10 = l_amt
                    END IF
                    LET l_tonum = l_amt/l_rai1.rai10
                   #FUN-C30151 add END
                WHEN '3' 
#FUN-BC0071  -----------------STA
#                   LET l_price3 = l_rap08
...
#FUN-BC0071  -----------------END
             END CASE
          ELSE	
             IF  l_oea87 IS NOT NULL  THEN   #會員促銷方式  不分類
### -MOD-B20087- ADD - BEGIN ----------------------------------------
                INITIALIZE l_lpj02,l_lph04 TO NULL
                SELECT lpj02 INTO l_lpj02 FROM lpj_file WHERE lpj03 = l_oea87
                SELECT lph04 INTO l_lph04 FROM lph_file WHERE lph01 = l_lpj02
...
#                        LET l_price3 = l_rai1.rai09
                         ...
                         END IF
                         LET l_tonum = l_amt/l_rai1.rai10
                         LET l_price3 = l_tonum*l_rai1.rai09
                      ...
                      WHEN '4'                                   
                         ...
                         END IF
                         LET l_tonum = l_amt/l_rai1.rai10
                         LET l_zhe = l_zhe + l_tonum*l_rai1.rai09     
#FUN-BC0071  -----------------END
                   END CASE
### -MOD-B20087- ADD - BEGIN ----------------------------------------
                ELSE
...
#                        LET l_price3 = l_rai1.rai06
                         ...
                         END IF
                         LET l_tonum = l_amt/l_rai1.rai10
                         LET l_price3 = l_tonum*l_rai1.rai06
                      ...
                      WHEN '4'                                   
                         ...
                         END IF
                         LET l_tonum = l_amt/l_rai1.rai10 
                         LET l_zhe = l_zhe + l_tonum*l_rai1.rai06                      
#FUN-BC0071  -----------------END                         
                   END CASE
                END IF
### -MOD-B20087- ADD -  END  ----------------------------------------
             ELSE
                CASE l_rah.rah10  #非會員折價
                   WHEN '2'   
                      LET l_price2 = l_rai1.rai05
                     #FUN-C30151 add START
                      IF cl_null(l_rai1.rai10) OR l_rai1.rai10 =0  THEN
...
#FUN-BC0071  -----------------END                       
       ...
       END IF 
#FUN-BC0071-----------------------STA
#促銷方式為4：收款折讓時，金額不作折讓，匯總折讓額，并寫入一筆0項次的rxc_file資料
       IF l_rah.rah10 = '4' THEN
          IF p_type = '1' THEN LET l_rxc.rxc00 = '01' END IF
          IF p_type = '2' THEN LET l_rxc.rxc00 = '02' END IF
          IF p_type = '3' THEN LET l_rxc.rxc00 = '03' END IF
          LET l_rxc.rxc01 = p_no
          ...
          IF p_type = '3' THEN
             ...
             SELECT azi03,azi04 INTO t_azi03,t_azi04 FROM azi_file
              WHERE azi01=g_oha.oha23
          END IF
          CALL cl_digcut(l_zhe,t_azi04) RETURNING l_zhe
          LET l_rxc.rxc06 = l_zhe   
          LET l_rxc.rxc08 = ''
          LET l_rxc.rxc09 = 0
          LET l_rxc.rxc10 = 0
          LET l_rxc.rxc11 = g_member   #是否會員
          ...
          LET l_sql = "INSERT INTO ",cl_get_target_table(g_plant_new,'rxc_file'),"(",   
                      "rxc00,rxc01,rxc02,rxc03,rxc04,rxc05,rxc06,",
                      "rxc08,rxc09,rxc10,rxclegal,rxcplant,rxc11,",
                      "rxc15) ",
                      "VALUES(?,?,?,?,?, ?,?,?,?,?, ?,?,?,?)"
          CALL cl_replace_sqldb(l_sql) RETURNING l_sql              							
          CALL cl_parse_qry_sql(l_sql,g_plant_new) RETURNING l_sql  
          PREPARE pre_ins_rxc_zhe FROM l_sql
          EXECUTE pre_ins_rxc_zhe USING l_rxc.rxc00,l_rxc.rxc01,l_rxc.rxc02,l_rxc.rxc03,l_rxc.rxc04, 
                               l_rxc.rxc05,l_rxc.rxc06,l_rxc.rxc08,
                               l_rxc.rxc09,l_rxc.rxc10,l_rxc.rxclegal,l_rxc.rxcplant,
                               l_rxc.rxc11,l_rxc.rxc15
          IF SQLCA.SQLCODE THEN 
             CALL cl_err('ins rxc',SQLCA.SQLCODE,1)
          END IF 
          UPDATE s_price_c2   SET qty2 = qty2 -qty1
          UPDATE s_price_c2_1 SET qty2 = qty2 -qty1
       ELSE
...
#FUN-BC0071 ----------------------END
      #FUN-D40011--add--str---
       ...
       LET l_cnt_temp = 0
       LET l_cnt_foreach = 1
       SELECT COUNT(*)+l_cnt_temp INTO l_cnt_temp FROM s_price_c2 WHERE qty2 > 0 AND qty1 > 0
       SELECT COUNT(*)+l_cnt_temp INTO l_cnt_temp FROM s_price_c2_1 WHERE qty2 > 0 AND qty1 > 0
      #FUN-D40011--add--end---
       LET l_sub = 0
       LET l_qty_n = 1         #計數變量賦初值1 #FUN-B80095 ADD
       LET l_sql = "SELECT '1',line,item,price,qty1,qty2,'N','','' ",
                   ...
                   "  FROM s_price_c2_1 ",
                   " WHERE qty2 > 0 AND qty1 > 0 "
       PREPARE cs_fetch_price_C2_prepare5 FROM l_sql                                                
       DECLARE cs_fetch_price_C2_curs5 CURSOR FOR cs_fetch_price_C2_prepare5   
       FOREACH cs_fetch_price_C2_curs5 INTO l_fg,l_line,l_item,l_price,l_qty1,l_qty2,l_flg1,l_type,l_cx_no
          SELECT SUM(qty1) INTO l_sum FROM s_price_c2  #FUN-C30151 add 
          IF SQLCA.sqlcode != 0 THEN
             CALL cl_err('foreach:',SQLCA.sqlcode,1)
             EXIT FOREACH
          END IF      
          IF l_rah.rah12 = 'Y' THEN  #分段計算
             CASE l_rah.rah10 
                WHEN '2'
                   CASE l_rah.rah25        #FUN-B80095 ADD
                      WHEN '1'   #滿額促銷 #FUN-B80095 ADD
                         LET l_sub = 0
                  ...
                  #FUN-B80095 Add Begin ---
                  #備註:滿量促銷的折扣在分段處理時，按照項次對應商品的順序取折扣
                      WHEN '2'   #滿量促銷
                         LET l_rxc06 = 0
                         FOR l_cnt = l_qty_n TO l_qty_n + l_qty1 - 1  
                            FOR l_cnt3 = 1 TO l_n 
                               IF l_cnt = l_rai[l_cnt3].rai04 THEN
                                 #LET l_rxc06 = l_price * (1-l_price21[l_cnt3]/100) + l_rxc06  #FUN-C30151 mark
                                 #FUN-C30151 add START
                                  IF cl_null(l_rai[l_cnt3].rai10) OR l_rai[l_cnt3].rai10 =0  THEN
                                     LET l_rai[l_cnt3].rai10 =  l_rai[l_cnt3].rai04
                                  END IF
                                  IF NOT cl_null(l_rai[l_cnt3+1].rai04) THEN 
                                     LET l_tonum = (l_rai[l_cnt3+1].rai04 - l_rai[l_cnt3].rai04)/l_rai[l_cnt3].rai10
                                  ELSE
                                     LET l_tonum = (l_sum - l_rai[l_cnt3].rai04)/l_rai[l_cnt3].rai10
                                  END IF
                                  LET l_rxc06 = l_price * (1-l_price21[l_cnt3]/100) * l_tonum * l_rai[l_cnt3].rai10 + l_rxc06 
                                 #FUN-C30151 add END
                               END IF
                            END FOR
                            #所有在最大折扣數量以後的商品折扣都按照最大折扣計算
                           #FUN-C30151 mark START
                           #IF l_cnt > l_rai04  THEN    
                           #   LET l_rxc06 = l_price * (1-l_price21[l_n]/100) + l_rxc06   
                           #END IF
                           #FUN-C30151 mark END
                         END FOR  
                         LET l_qty_n = l_qty_n + l_qty1
                   END CASE
                  #FUN-B80095 Add End -----
                WHEN '3'
                   CASE l_rah.rah25        #FUN-B80095 ADD
                      WHEN '1'   #滿額促銷 #FUN-B80095 ADD
                         ...
                         END FOR
                         IF l_cnt_temp <> l_cnt_foreach THEN           #FUN-D40011 add
                            LET l_rxc06 = l_sub*l_price*l_qty1/l_amt
                         ELSE                                          #FUN-D40011 add
                            LET l_rxc06 = l_sub - l_sum2               #FUN-D40011 add
                         END IF                                        #FUN-D40011 add
                  #FUN-B80095 Add Begin ---
                      WHEN '2'   #滿量促銷
                         LET l_sub = 0
                         FOR l_cnt = 1 TO l_n
                            LET l_sub = l_price31[l_cnt]+l_sub
                         END FOR
                         #所有在最大折讓數量以後的商品折讓都按照最大折讓額計算
                         FOR l_cnt = l_rai04 + 1 TO l_amt
                            LET l_sub = l_price31[l_n] + l_sub
                         END FOR
                         IF l_cnt_temp <> l_cnt_foreach THEN           #FUN-D40011 add
                            LET l_rxc06 = l_sub*l_qty1/l_amt
                         ELSE                                          #FUN-D40011 add
                            LET l_rxc06 = l_sub - l_sum2               #FUN-D40011 add
                         END IF                                        #FUN-D40011 add
                   END CASE
          ...
          ELSE
             CASE l_rah.rah10 
                WHEN '2'
                #備註：在促銷方式為折扣且不分段計算時，滿額促銷與滿量促銷分攤折價的計算邏輯相同
                  #LET  l_rxc06 = (1-l_price2/100)*l_price*l_qty1
                  #FUN-C30151 add START
                   IF l_rah.rah25 = '1' THEN 
                      LET l_rai1.rai10 = l_amt
                      LET l_tonum = l_amt/l_rai1.rai10
                   END IF    
                  #FUN-C30151 add END
                   LET  l_rxc06 = (1-l_price2/100)*l_tonum* l_rai1.rai10*l_price*l_qty1/l_amt  #FUN-C30151 add
                WHEN '3'
                   CASE l_rah.rah25 #條件規則 #FUN-B80095 ADD
                      WHEN '1'      #滿額促銷 #FUN-B80095 ADD
                         IF l_cnt_temp <> l_cnt_foreach THEN           #FUN-D40011 add 
                            LET l_rxc06 = l_price3*l_price*l_qty1/l_amt
                         ELSE                                          #FUN-D40011 add
                            LET l_rxc06 = l_price3 - l_sum2            #FUN-D40011 add
                         END IF                                        #FUN-D40011 add
                  #FUN-B80095 Add Begin ---
                      WHEN '2'      #滿量促銷
                         IF l_cnt_temp <> l_cnt_foreach THEN           #FUN-D40011 add
                            LET  l_rxc06 = l_price3*l_qty1/l_amt
                         ELSE                                          #FUN-D40011 add
                            LET l_rxc06 = l_price3 - l_sum2            #FUN-D40011 add
                         END IF                                        #FUN-D40011 add
                   END CASE
             ...
             END CASE
          END IF 
          LET l_cnt_foreach = l_cnt_foreach + 1    #FOREACH 笔数加1    #FUN-D40011 add
###-MOD-B20087- MARK - BEGIN -----------------------------------------------------------
###-MARK掉原來會員卡折扣部份-###
#           CASE l_fg
#              WHEN '1'
            ...
            CASE l_fg
               ...
               WHEN '2'
                  IF (l_type = '' OR l_flg1 = 'Y') AND l_rah.rah18 = 'Y' AND l_oea87 IS NOT NULL THEN
                     ...
                     SELECT lph36 INTO l_lph36 FROM lph_file WHERE lph01 = l_lpj02
                     IF l_lph36 = 'Y' THEN
                        CALL s_discount_amt1(l_oea87,p_item,p_date) RETURNING  l_lpj11        #FUN-BC0079  add
                        LET l_rxc06 = (l_price*l_qty1 - l_rxc06)*(1 - l_lpj11/100)
                        CALL cl_digcut(l_rxc06,t_azi04) RETURNING l_rxc06
                        LET l_sql = "SELECT count(*) FROM ",cl_get_target_table(g_plant_new,'rxc_file'),
                                    "   WHERE rxc01 = '",p_no,"' ",
...
####-FUN-B30012--ADD-----END-------------------------------------------------
     ...
     IF NOT cl_null(l_oea87)  THEN
      ...
      #    LET l_lpj11 = 100
      # END IF
        CALL s_discount_amt1(l_oea87,p_item,p_date) RETURNING  l_lpj11      #MOD-B20078   #FUN-BC0079 add p_date
        LET l_sql ="SELECT no,line,cx_no,item,price,qty,qty2,flg1,type ",
                   "  FROM s_price_c2_1",
                   " WHERE qty2 > 0 "
        PREPARE cs_fetch_price_C2_prepare7 FROM l_sql                                                
        DECLARE cs_fetch_price_C2_curs7 CURSOR FOR cs_fetch_price_C2_prepare7   
        FOREACH cs_fetch_price_C2_curs7 INTO l_no,l_line,l_cx_no,l_item,l_price,l_qty,l_qty2,l_flg1,l_type
...
FUNCTION cs_fetch_price_ins_temp_table(p_price,p_cust,p_booth,p_item,p_unit,p_date,p_type,p_plant,p_curr,p_term,p_payment,p_no,p_line,p_count,p_no1,p_cmd)   #FUN-BC0071 
DEFINE p_type       LIKE type_file.chr1
DEFINE l_sql        STRING
DEFINE p_cmd        LIKE type_file.chr1
DEFINE p_cust       LIKE occ_file.occ01
...
DEFINE l_booth      LIKE oeb_file.oeb49     #FUN-BC0071
 
   CASE p_type
      WHEN '1'
#       LET l_sql = "SELECT oeb01,oeb03,oeb04,oeb05,oeb37,oeb12,'','','' ",
        LET l_sql = "SELECT oeb01,oeb03,oeb49,oeb04,oeb05,oeb12,'','','' ",   #MOD-B30045 MOD  #FUN-BC0071 add oeb49
                     "  FROM ",cl_get_target_table(g_plant_new,'oeb_file'),
                     " WHERE oeb01 = '",p_no,"'  " 
      WHEN '2'
#        LET l_sql = "SELECT ogb01,ogb03,ogb04,ogb05,ogb37,ogb12,'','','' ",
         LET l_sql = "SELECT ogb01,ogb03,ogb48,ogb04,ogb05,ogb12,'','','' ",  #MOD-B30045 MOD  #FUN-BC0071 add ogb48
                     "  FROM ",cl_get_target_table(g_plant_new,'ogb_file'),
                     " WHERE ogb01 = '",p_no,"' " 
      WHEN '3'
#        LET l_sql = "SELECT ohb01,ohb03,ohb04,ohb05,ohb37,ohb12,'','','' ",
#        LET l_sql = "SELECT ohb01,ohb03,ohb69,ohb04,ohb05,ohb37,ohb12,'','','' ",  #MOD-B30045 MOD  #FUN-BC0071 add ohb69
         LET l_sql = "SELECT ohb01,ohb03,ohb69,ohb04,ohb05,ohb12,'','','' ",         #TQC-C20501 
...
#  FOREACH pre_cus_s_price_c2 INTO l_no,l_line,l_item,l_unit,l_price,l_qty,l_qty1,l_qty2,l_raf03 
   FOREACH pre_cus_s_price_c2 INTO l_no,l_line,l_booth,l_item,l_unit,l_qty,l_qty1,l_qty2,l_raf03   #FUN-BC0071
     #FUN-B10014 Begin---
     ...
     #FUN-B10014 End-----
      ...
      END IF
#TQC-C20501 -----------STA
      IF l_booth IS NULL THEN
         LET l_booth = ' '
      END IF
      IF p_booth IS NULL THEN
         LET p_booth = ' '
      END IF
#TQC-C20501 -----------END
      CALL cs_fetch_price_new2(p_cust,l_item,l_booth,l_unit,p_date,p_type,p_plant,p_curr,p_term,p_payment,l_no,l_line,l_qty,p_no1,p_cmd,'1')  #FUN-BC0071
      RETURNING  l_price,g_flg
      LET l_price = l_price
      LET l_sql = "INSERT INTO s_price_c2 ",
                  "(no,line,booth,item,unit,price,qty,qty1,qty2,raf03)",    #FUN-BC0071 add booth
                  "VALUES(?,?,?,?,?, ?,?,?,?,?)"                            #FUN-BC0071 add booth                  
      PREPARE pre_ins_no FROM l_sql
      EXECUTE pre_ins_no USING l_no,l_line,l_booth,l_item,l_unit,l_price,l_qty,l_qty1,l_qty,l_raf03   #FUN-BC0071 add booth
   END FOREACH
  #TQC-C60130 -- add -- begin
   IF p_booth IS NULL THEN
      LET p_booth = ' '
   END IF
  #TQC-C60130 -- add -- end
   IF p_cmd = 'a' THEN
     #把新增状态下的这笔资料也要INSERT 到临时表
      ...
      EXECUTE pre_ins_no1 USING p_no,p_line,p_booth,p_item,p_unit,p_price,p_count,'',p_count,''   #FUN-BC0071 add booth 
   END IF
   
END FUNCTION

FUNCTION  cs_fetch_price_chk(l_type,p_rac01,p_rac02,p_rac03,p_plant,p_item,p_booth,p_date,p_price)    #FUN-BC0071 add  #FUN-C30154 add price
...
DEFINE p_booth         LIKE oeb_file.oeb49   #攤位編號
DEFINE p_date          LIKE type_file.dat    #日期
DEFINE p_price         LIKE rtg_file.rtg05   #基礎單價  #FUN-C30154 add   傳入基礎單價來判判斷是否落於價格區間
...
DEFINE l_rax04_t       LIKE rad_file.rad04    #FUN-BC0071
DEFINE l_ima131        LIKE ima_file.ima131
...
DEFINE l_oba01         LIKE oba_file.oba01    #FUN-B80095 ADD
DEFINE l_oba01_tree    STRING                 #FUN-B80095 ADD
DEFINE l_oba01_str     STRING                 #FUN-B80095 ADD
#FUN-BC0071 -----------------STA
DEFINE l_time          LIKE type_file.chr8
DEFINE l_n             LIKE type_file.num5
    ...
    CASE l_type
      ...
      WHEN '3'
         LET l_sql = "SELECT COUNT(*) ",
                     ...
                     "   AND rah01 = raq01 AND rah02 = raq02",
                     "   AND rai02 = '",p_rac02,"'",
                   # "   AND rai03 = '",p_rac03,"'",                #FUN-C20098 mark
                     "   AND rahplant=raiplant AND rahplant=raqplant",
                     "   AND raq03 = '3' AND raq04 = '",p_plant,"'",
                     "   AND raq05 = 'Y'",                                         
                     "   AND (raq08  IS NULL OR raq08 = ' ' OR raq08 = '",p_booth CLIPPED,"')",
    ...
    CALL cl_replace_sqldb(l_sql) RETURNING l_sql             							
    CALL cl_parse_qry_sql(l_sql,g_plant_new) RETURNING l_sql  
    PREPARE s_sel_count_pre1 FROM l_sql   
    EXECUTE s_sel_count_pre1 INTO l_n
    IF l_n = 0 AND l_type <> '2' THEN
       RETURN FALSE
    END IF
...
#FUN-BC0071 -----------------END
   LET i = 0      #FUN-B10024 	
   CASE l_type	
      WHEN '1'	 #同組同類型OR，同組不同類型AND     #FUN-BC0071 add
         LET l_sql = "SELECT rad03,rad04,rad05,rad06 ",	
                     ...
                     "   AND rad03='",p_rac03,"'",	
                     "   AND radacti = 'Y'"	,
                     " ORDER BY rad03,rad04 "           #FUN-BC0071 add
...
#FUN-BC0071 --------------STA
      IF l_type = '1' THEN
         IF cl_null(l_rax04_t) THEN LET l_rax04_t = l_rax04 END IF
         IF l_rax04<>l_rax04_t AND l_flag = 'N' THEN EXIT  FOREACH END IF
         IF l_rax04=l_rax04_t  AND l_flag = 'Y' THEN CONTINUE FOREACH END IF
         IF l_rax04<>l_rax04_t THEN LET l_rax04_t = l_rax04 END IF
      END IF
#FUN-BC0071 --------------END
      CASE l_rax04	
         WHEN '01'	
...
#FUN-BC0071 ----------------END
              ...
              WHEN '3'           
                 ...
                 #END IF 
                  ...
                  LET l_oba01_tree = "'",l_rax05 CLIPPED,"'"
                  LET l_oba01_str = cget_oba01_by_oba13(l_rax05,l_oba01_tree)
                  LET l_oba01_str = "(",l_oba01_str,")"

                  LET l_sql = "SELECT oba01 FROM ",cl_get_target_table(g_plant_new,'oba_file'),
                              " WHERE oba01 IN ",l_oba01_str,
                              "   AND oba01 = '",l_ima131,"' "
                  CALL cl_replace_sqldb(l_sql) RETURNING l_sql
                  CALL cl_parse_qry_sql(l_sql,g_plant_new) RETURNING l_sql
                  PREPARE sel_oba01_pre FROM l_sql
                  EXECUTE sel_oba01_pre INTO l_oba01
                  IF SQLCA.sqlcode THEN
                     LET  l_flag = 'N'
                     CONTINUE FOREACH
                  ELSE
...
#FUN-BC0071 ----------------END
           ...
           END CASE 
         WHEN '09'	
          #FUN-C30154 mark START
          #不使用ima33來決定是否落於價格區間  應使用各自的基礎價來判斷是否落於價格區間內
          ...
          #FUN-C30154 mark END
           LET l_ima33 = p_price   #FUN-C30154 add
...
#FUN-AA0065   ---end  --add 
#查找會員卡號
FUNCTION cs_find_member(p_no,p_type,p_plant)
DEFINE p_no         LIKE oea_file.oea01
DEFINE p_type       LIKE type_file.chr1
DEFINE p_plant      LIKE azp_file.azp01
DEFINE l_dbs        LIKE azp_file.azp03
...
#從商品特價促銷單中取價格
#FUNCTION cs_price1(p_cust,p_item,p_unit,p_date,p_no,p_line,p_price,p_type,p_plant,p_term,p_curr,p_flag,p_count,p_team)
#DEFINE p_cust       LIKE occ_file.occ01
#DEFINE p_team       LIKE ohi_file.ohi02
#DEFINE p_item       LIKE ima_file.ima01
#DEFINE p_unit       LIKE ima_file.ima25
...
#         LET l_price = l_rwc13
#      ELSE                    #品類促銷
#         #CALL cs_base_price(p_cust,p_item,p_unit,p_date,p_type,p_plant,p_curr,p_team) 
#         #   RETURNING l_price
...
#            LET l_price = l_rwc15 
#         ELSE                    #品類促銷
#           #CALL cs_base_price(p_cust,p_item,p_unit,p_date,p_type,p_plant,p_curr,p_team) #MOD-9C0173
#            CALL cs_base_price(p_cust,p_item,p_unit,p_date,p_type,p_plant,p_curr,p_team,p_term,p_line,p_no) #MOD-9C0173 
#               RETURNING l_price
...
#根據價格條件取A類基礎價格 
#FUNCTION cs_base_price(p_cust,p_item,p_unit,p_date,p_type,p_plant,p_curr,p_team) #MOD-9C0173
#FUNCTION cs_base_price(p_cust,p_item,p_unit,p_date,p_type,p_plant,p_curr,p_team,p_term,p_line,p_no) #MOD-9C0173 #TQC-B60015 MARK
FUNCTION cs_base_price(p_cust,p_item,p_unit,p_date,p_type,p_plant,p_curr,p_team,p_term,p_line,p_no,p_count) #MOD-9C0173 #TQC-B60015 ADD
DEFINE p_cust       LIKE occ_file.occ01
DEFINE p_item       LIKE ima_file.ima01
DEFINE p_unit       LIKE ima_file.ima25
DEFINE p_date       LIKE type_file.dat
        ...
        #MOD-9C0173   ---start
         ...
         WHEN l_ohi04 = 'A5'
            CALL cs_fetch_price_A5(p_item,p_cust,p_curr,p_plant)
               RETURNING l_price
         WHEN l_ohi04 = 'A6'
            CALL cs_fetch_price_A6(p_term,p_curr,p_item,p_unit,p_date,p_plant,'')
               RETURNING l_price
        #MOD-9C0173   ---end
      END CASE
      IF l_price > 0 THEN EXIT FOREACH END IF
...
#        #CALL cs_dynamic(p_cust,p_item,p_unit,p_date,p_curr,p_no,p_type,p_plant,l_rwf.*,p_team,p_price) RETURNING l_success #MOD-9C0173
#         CALL cs_dynamic(p_cust,p_item,p_unit,p_date,p_curr,p_no,p_type,p_plant,l_rwf.*,p_team,p_price,p_term,p_line) RETURNING l_success #MOD-9C0173
#      ELSE                     #固定組合
#        #CALL cs_fix(p_cust,p_item,p_unit,p_type,p_curr,p_date,p_plant,p_no,p_count,l_rwf.*,p_team,p_price) RETURNING l_success #MOD-9C0173
#         CALL cs_fix(p_cust,p_item,p_unit,p_type,p_curr,p_date,p_plant,p_no,p_count,l_rwf.*,p_team,p_price,p_term,p_line) RETURNING l_success #MOD-9C0173
#      END IF 
#   END FOREACH
#   RETURN l_success
#END FUNCTION
#FUN-AA0065  ---end--mark
#變動組合
#FUNCTION cs_dynamic(p_cust,p_item,p_unit,p_date,p_curr,p_no,p_type,p_plant,p_rwf,p_team,p_price) #MOD-9C0173
#FUNCTION cs_dynamic(p_cust,p_item,p_unit,p_date,p_curr,p_no,p_type,p_plant,p_rwf,p_team,p_price,p_term,p_line) #MOD-9C0173 #TQC-B60015 MARK
FUNCTION cs_dynamic(p_cust,p_item,p_booth,p_unit,p_date,p_curr,p_no,p_type,p_plant,p_rwf,p_team,p_price,p_term,p_line,p_count) #TQC-B60015 ADD  #FUN-BC0071
DEFINE p_team       LIKE ohi_file.ohi02
DEFINE p_cust       LIKE occ_file.occ01
DEFINE p_item       LIKE ima_file.ima01
DEFINE p_booth      LIKE oeb_file.oeb49               #FUN-BC0071
  ...
  #FUN-9C0068   ---END
   ...
   IF p_rwf.rwf10 = '1' THEN   
      ...
      FOREACH cur_tmp8 INTO l_tmp.*
         #CALL cs_base_price(p_cust,l_tmp.oeb04,l_tmp.oeb05,p_date,p_type,p_plant,p_curr,p_team) #MOD-9C0173
         #CALL cs_base_price(p_cust,l_tmp.oeb04,l_tmp.oeb05,p_date,p_type,p_plant,p_curr,p_team,p_term,p_line,p_no) #MOD-9C0173 #TQC-B60015 MARK
          CALL cs_base_price(p_cust,l_tmp.oeb04,l_tmp.oeb05,p_date,p_type,p_plant,p_curr,p_team,p_term,p_line,p_no,p_count) #TQC-B60015 ADD 
      ...
      SELECT SUM(oeb12) INTO l_sum FROM oeb_tmp
      IF l_sum IS NULL THEN LET l_sum = 0 END IF
     #CALL cs_get_price(p_cust,p_item,p_unit,p_date,p_type,p_plant,p_curr,l_oea87,p_rwf.rwf12,p_rwf.rwf13,'1',p_team) RETURNING l_price #MOD-9C0173
      CALL cs_get_price(p_cust,p_item,p_unit,p_date,p_type,p_plant,p_curr,l_oea87,p_rwf.rwf12,p_rwf.rwf13,'1',p_team,p_term,p_line,p_no) RETURNING l_price #MOD-9C0173 
      ...
      FOREACH cur_tmp5 INTO l_tmp.*
         CALL cs_fetch_price_new1(p_cust,l_tmp.oeb04,p_booth,l_tmp.oeb05,p_date,p_type,p_plant,      #FUN-BC0071
   ...
   RETURN 'Y'
END FUNCTION
#FUNCTION cs_get_price(p_cust,p_item,p_unit,p_date,p_type,p_plant,p_curr,p_member,p_price1,p_price2,p_flag,p_team) #MOD-9C0173
FUNCTION cs_get_price(p_cust,p_item,p_unit,p_date,p_type,p_plant,p_curr,p_member,p_price1,p_price2,p_flag,p_team,p_term,p_line,p_no) #MOD-9C0173
DEFINE p_team       LIKE ohi_file.ohi02
DEFINE p_cust       LIKE occ_file.occ01
DEFINE p_item       LIKE ima_file.ima01
DEFINE p_unit       LIKE ima_file.ima25
   ...
   ELSE                          #是會員的情況
      ...
      IF l_lph04 = 'Y' THEN   #會員價
         ...
         IF p_flag = '2' THEN    #折扣情況
           #CALL cs_base_price(p_cust,p_item,p_unit,p_date,p_type,p_plant,p_curr,p_team) #MOD-9C0173
           #CALL cs_base_price(p_cust,p_item,p_unit,p_date,p_type,p_plant,p_curr,p_team,p_term,p_line,p_no) #MOD-9C0173 #TQC-B60015 MARK 
            CALL cs_base_price(p_cust,p_item,p_unit,p_date,p_type,p_plant,p_curr,p_team,p_term,p_line,p_no,p_count) #TQC-B60015 ADD
               RETURNING l_price
            LET l_price = (l_price*l_lph08)/100
         END IF
      END IF
...
END FUNCTION
#固定組合
#FUNCTION cs_fix(p_cust,p_item,p_unit,p_type,p_curr,p_date,p_plant,p_no,p_count,p_rwf,p_team,p_price) #MOD-9C0173
FUNCTION cs_fix(p_cust,p_item,p_booth,p_unit,p_type,p_curr,p_date,p_plant,p_no,p_count,p_rwf,p_team,p_price,p_term,p_line) #MOD-9C0173  #FUN-BC0071
DEFINE p_cust       LIKE occ_file.occ01
DEFINE p_team       LIKE ohi_file.ohi02
DEFINE p_item       LIKE ima_file.ima01
DEFINE p_booth      LIKE oeb_file.oeb49              #FUN-BC0071
...
DEFINE l_rtv02      LIKE rtv_file.rtv02
  ...
  #FUN-9C0068   ---END
   ...
   IF p_rwf.rwf10 = '1' THEN  
     #CALL cs_get_price(p_cust,p_item,p_unit,p_date,p_type,p_plant,p_curr,l_oea87,p_rwf.rwf12,p_rwf.rwf13,'1',p_team) RETURNING l_price #MOD-9C0173
      ...
      FOREACH cur_ohb1 INTO l_oeb03,l_oeb04,l_oeb05,l_oeb12
         ...
         IF l_use_sum > 0 THEN
           #CALL cs_base_price(p_cust,l_oeb04,l_oeb05,p_date,p_type,p_plant,p_curr,p_team) #MOD-9C0173
           #CALL cs_base_price(p_cust,l_oeb04,l_oeb05,p_date,p_type,p_plant,p_curr,p_team,p_term,p_line,p_no) #MOD-9C0173 #TQC-B60015 MARK 
            CALL cs_base_price(p_cust,l_oeb04,l_oeb05,p_date,p_type,p_plant,p_curr,p_team,p_term,p_line,p_no,p_count) #TQC-B60015 ADD
               RETURNING l_base_price
            LET l_total_money = l_total_money + l_base_price*l_use_sum   #參加組合促銷商品的金額
         END IF
         #IF l_nouse_sum > 0 THEN 
         #   CALL cs_fetch_price_new1(p_cust,l_oeb04,l_oeb05,p_date,p_type,p_plant,
	 ...
	 LET l_rxc.rxc07 = l_rtv13
         ...
         LET l_nouse_sum = l_oeb12 - l_use_sum    #不可以參加組合促銷的商品數量
         IF l_nouse_sum > 0 THEN 
            CALL cs_fetch_price_new1(p_cust,l_oeb04,p_booth,l_oeb05,p_date,p_type,p_plant,       #FUN-BC0071
                             p_curr,g_term,g_payment,p_no,l_oeb03,l_nouse_sum,'','a')
               RETURNING l_price
         END IF
      END FOREACH
   END IF
   IF p_rwf.rwf10 = '2' THEN  
     #CALL cs_get_price(p_cust,p_item,p_unit,p_date,p_type,p_plant,p_curr,l_oea87,p_rwf.rwf14,p_rwf.rwf15,'2',p_team) RETURNING l_price #MOD-9C0173
      CALL cs_get_price(p_cust,p_item,p_unit,p_date,p_type,p_plant,p_curr,l_oea87,p_rwf.rwf14,p_rwf.rwf15,'2',p_team,p_term,p_line,p_no) RETURNING l_price #MOD-9C0173
...
FUNCTION cs_fetch_price_C3(p_cust,p_item,p_unit,p_date,p_plant,p_curr,p_term,p_payment,p_no,p_line,p_price,p_count,p_type) #FUN-9C0083 add p_type
DEFINE p_cust       LIKE tqo_file.tqo01,     #客戶編號
       p_item       LIKE tqn_file.tqn03,     #料件編號
       p_unit       LIKE tqn_file.tqn04,     #單位
       p_date       LIKE type_file.dat,      #日期
...
DEFINE l_oea87      LIKE oea_file.oea87
  ...
  #FUN-9C0068   ---END
   ...
   RETURN l_price
END FUNCTION
FUNCTION cs_fetch_price_C4(p_cust,p_item,p_unit,p_date,p_plant,p_curr,p_term,p_payment,p_count,p_no,p_line,p_price,p_type)
DEFINE p_cust       LIKE tqo_file.tqo01,     #客戶編號
       p_item       LIKE tqn_file.tqn03,     #料件編號
       p_unit       LIKE tqn_file.tqn04,     #單位
       p_date       LIKE type_file.dat,      #日期
...
#FUN-AB0102 ---add---end--   
   ...
   RETURN l_xmc09
END FUNCTION
FUNCTION cs_fetch_price_new1(p_cust,p_item,p_booth,p_unit,p_date,p_type,p_plant,p_curr,p_term,p_payment,p_no,p_line,p_count,p_no1,p_cmd)   #FUN-BC0071
DEFINE p_cust       LIKE tqo_file.tqo01,     #客戶編號
       p_item       LIKE tqn_file.tqn03,     #料件編號
       p_booth      LIKE oeb_file.oeb49,     #攤位編號                      #FUN-BC0071
       p_unit       LIKE tqn_file.tqn04,     #單位
       p_date       LIKE type_file.dat,      #日期
       p_type       LIKE type_file.chr1,     #單據類型
       p_cmd        LIKE type_file.chr1,     #用戶動作
...
##No.FUN-A10106 --begin
##從價格區間促銷單取出商品價格
#FUNCTION cs_price3(p_cust,p_item,p_unit,p_date,p_no,p_line,p_price,p_type,p_plant,p_term,p_curr,p_count,p_team)
#DEFINE p_cust       LIKE occ_file.occ01
#DEFINE p_team       LIKE ohi_file.ohi02
#DEFINE p_item       LIKE ima_file.ima01
#DEFINE p_unit       LIKE ima_file.ima25
...
#FUN-AA0065  ---end--mark
#FUN-AA0065 --add--begin
FUNCTION cs_fetch_price_new2(p_cust,p_item,p_booth,p_unit,p_date,p_type,p_plant,p_curr,p_term,p_payment,p_no,p_line,p_count,p_no1,p_cmd,l_p1)   #FUN-BC0071
DEFINE p_cust       LIKE tqo_file.tqo01,     #客戶編號
       p_item       LIKE tqn_file.tqn03,     #料件編號
       p_booth      LIKE oeb_file.oeb49,     #攤位編號                    #FUN-BC0071
       p_unit       LIKE tqn_file.tqn04,     #單位
...
#FUN-B80095 Add Begin ---
#獲取產品分類樹 - 當前分類以及下級所有分類
FUNCTION cget_oba01_by_oba13(p_oba01,p_oba01_tree)
DEFINE p_oba01        LIKE oba_file.oba01
DEFINE p_oba01_tree   STRING
DEFINE l_i            LIKE type_file.num5
DEFINE l_oba_rec      DYNAMIC ARRAY OF RECORD
            oba01     LIKE oba_file.oba01
                      END RECORD
DEFINE l_key_word     STRING
...
DEFINE l_sql          STRING
   ...
   DECLARE sel_oba_cs CURSOR FOR sel_oba_pre

   LET l_i = 1
   FOREACH sel_oba_cs INTO l_oba_rec[l_i].oba01
      IF STATUS THEN
   ...
   CALL l_oba_rec.deleteElement(l_i)

   FOR l_i = 1 TO l_oba_rec.getLength()
      LET l_oba01 = l_oba_rec[l_i].oba01 CLIPPED
      LET l_key_word = "'",l_oba01,"'"
      IF cl_null(p_oba01_tree) THEN
         LET p_oba01_tree = "'",l_oba01,"'"
      ELSE
         IF p_oba01_tree.getIndexOf(l_key_word,1) > 0 THEN
            LET l_err_msg = "The oba01 '",l_oba01,"' belongs to a ring structure architecture, please check for errors!"
            CALL cl_err(l_err_msg, "!", 1)
            RETURN
         ELSE
            IF NOT cl_null(l_oba01) THEN
               LET p_oba01_tree = p_oba01_tree,",'",l_oba01,"'"
            END IF
         END IF
      END IF
      IF NOT cl_null(l_oba01) THEN
         LET p_oba01_tree = cget_oba01_by_oba13(l_oba01, p_oba01_tree)
      END IF
   END FOR
   RETURN p_oba01_tree
END FUNCTION
#FUN-B80095 Add End -----
#FUN-C10053 add begin ---
FUNCTION cs_t700_sub(p_no,p_rtz04,p_oha213,p_ohb917,p_ohb13,t_azi04)
   ...
   ELSE
      ...
      CALL cl_digcut(l_ohb14,t_azi04) RETURNING l_ohb14
      LET l_ohb14t = l_ohb14 * (1 + l_sum_gec04/100)
      CALL cl_digcut(l_ohb14t,t_azi04) RETURNING l_ohb14t
   END IF
...
#FUN-C10053 add end -----
#TQC-C30329 add START
FUNCTION cs_ogb14t(p_no,p_rtz04,p_oea213,p_oeb917,p_oeb13,t_azi04)
   DEFINE p_no      LIKE rte_file.rte03    #产品编号
   DEFINE p_rtz04   LIKE rtz_file.rtz04    #商品策略
   ...
   IF NOT cl_null(p_rtz04) THEN
      LET l_sql = "SELECT rvy04,gec04,gec07,rvy06",
                  ...
                  "   AND rte03 = '",p_no,"'",
                  "   AND rte07 = 'Y'",
                  "   AND gec011 = '2'"  #TQC-C30321 add 銷項
      PREPARE sel_rvy_p1 FROM l_sql
      DECLARE sel_rvy_c1 CURSOR FOR sel_rvy_p1
      LET l_oeb14_1 = p_oeb917 * p_oeb13             #计算售价
      LET l_sum_gec04 = 0
      LET l_sum_rvy06 = 0
      FOREACH sel_rvy_c1 INTO l_rvy04,l_gec04,l_gec07,l_rvy06
        #TQC-C30321 add START
