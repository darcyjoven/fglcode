...
FUNCTION cs_minp(p_wono,p_check,p_percent,p_opseq,p_process,p_sequence,p_date)  #FUN-C70037 add 'p_date'
...
FUNCTION cs_minp_routing(p_wono1,p_check1,p_percent1,p_operation,p_process,p_sequence)  
  ...
  #IF g_sma.sma541 = 'Y' AND l_sfb93 ='Y'  #TQC-AC0084
   ...
   FOREACH s_minp_c1 INTO l_sfa.*
    ...
    # IF l_sfa.sfa26 MATCHES '[34]' THEN    #FUN-A20037
      ...
      LET l_sfa.sfa06 = l_sfa.sfa06 + 0.01 #因小数点尾差，默认允许发料量有1%的误差 add by donghy
      LET qty=((l_sfa.sfa06+l_sfa.sfa065-l_sfa.sfa063+l_sfa.sfa062)/l_sfa.sfa05)*l_sfb08   #FUN-C30166 
      # ---------------------------
      # 已發 - 報費 / 實計單位用量
      # --------------------------- 
