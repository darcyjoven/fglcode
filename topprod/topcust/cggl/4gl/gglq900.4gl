...
# Modify.........: No:MOD-E30008 14/03/03 By fengmy 總賬金額多出N倍
# Modify.........: No:MOD-E80079 14/08/13 By qiull 子系統期末余額計算錯誤，應該是期末=期初+當期發生
...
DEFINE lc_qbe_sn         LIKE gbm_file.gbm01
   ...
   #LET tm.choice = '1'   #No.FUN-D70072   Add#mark muping160222 1 在画面上删掉了
   LET tm.choice = '2'  #add muping160222
   LET tm.n = '1'   #No.FUN-D70072   Add
   #LET tm.a = '1' #mark muping16022
   LET tm.a = '3' #add muping160222
   CALL cl_set_act_visible("related_document,aging_update,anomalies,ap_closing,ap_monthly_statement,ar_closing,ar_monthly_statement,check_closing,closing,monthly_statement,monthly_statement_return",FALSE)#add muping160222
   LET tm.b = '1'   
   LET tm.e ='N'    
   LET g_bgjob = 'N'
  ...
  #mark muping160222 str
  # LET comb_value = '1,2,3,4'   #modify by renkl160122
   ...
   FOREACH gglq900_alz_cs1 INTO l_alz01,l_alz14
      ...
      IF tm.b = '1' THEN
         LET l_sql = "SELECT SUM(alz13_bf - alz13_af),SUM(alz13_b - alz13_a),SUM(alz15), ",
                  ...
                  #  "           AND aag01 = alz14 AND aag06 = '1') ",    #mark by renkl160121
                     "           AND aag01 = alz14 AND aag06 = '1' AND (aag07 = '2' OR aag07 = '3')) ",    #add by renkl160121
                     " UNION ",
                     ...
                     "           AND alz14 = '",l_alz14,"'",
                     "           AND aag00 = '",g_aza.aza81,"'",   #TQC-D80007  add
                    #"           AND aag01 = alz14 AND aag06 = '2' ) "   #mark by renkl160121
                     "           AND aag01 = alz14 AND aag06 = '2' AND (aag07 = '2' OR aag07 = '3')) "   #mark by renkl160121
      ELSE
         LET l_sql = "SELECT  SUM(alz13_af - alz13_bf),SUM(alz13_a - alz13_b),SUM(alz15), ",
                    ...
                    #"           AND aag01 = alz14 AND aag06 = '1') ",    #mark by renkl160121
                     ...
                     "           AND aag00 = '",g_aza.aza81,"'",   #TQC-D80007  add
                   # "           AND aag01 = alz14 AND aag06 = '2') "  #mark by renkl160121
                     "           AND aag01 = alz14 AND aag06 = '2' AND (aag07 = '2' OR aag07 = '3')) "   #add by renkl160121
      END IF
      #TQC-D80007--add--end--
      ...
      IF tm.b = '1' THEN    #TQC-D80007 add
        IF tm.a = '4' THEN    #add by renkl160122
         SELECT pmc03 INTO l_occ02 FROM pmc_file WHERE pmc01 = l_alz01  #add by renkl160122
        ELSE                                         #add by renkl160122
         SELECT occ02 INTO l_occ02 FROM occ_file WHERE occ01 = l_alz01  
        END IF     #add by renkl160122
      #TQC-D80007--add--str--
      ELSE
...
FUNCTION gglq900_ar_ap2()
  ...
  #獲取科目/廠商
   ...
   LET l_sql = "SELECT UNIQUE aed02,aag01 FROM aag_file,aed_file ",
             ...
             # "   AND aed011 = '1'"
               "   AND aed011 = '1' AND (aag07 = '2' OR aag07 = '3')"   #modify by renkl160121
   ...
   LET l_sql = l_sql," UNION ",
             ...
             # "    AND abb11 IS NOT NULL"
               "    AND abb11 IS NOT NULL AND (aag07 = '2' OR aag07 = '3')"  #modify by renkl160121
  ...
  #子系統---期間發生額
   LET l_sql ="SELECT SUM(npr06f),SUM(npr07f),SUM(npr06),SUM(npr07) ",
               "  FROM npr_file ",
               " WHERE npr00 LIKE ? AND npr01 = ? ",
              #"   AND npr04 = ",tm.yy,"'",  #fengmy131225 mark
               "   AND npr04 = '",tm.yy,"'", #fengmy131225
               "   AND npr05 = '",tm.mm,"' ",
   ...
   FOREACH gglq900_ap2_c1 INTO l_alz01,l_alz14
     ...
     #子系統金額
      ...
      IF l_aag06 = '1' THEN
        ...
        #LET l_alz09f = (l_npr06f - l_npr07f) - (l_npr06f_1 - l_npr07f_1)   #MOD-E80079 mark
        #LET l_alz09  = (l_npr06  - l_npr07 ) - (l_npr06_1  - l_npr07_1 )   #MOD-E80079 mark
         LET l_alz09f = (l_npr06f - l_npr07f) + (l_npr06f_1 - l_npr07f_1)   #MOD-E80079 add
         LET l_alz09  = (l_npr06  - l_npr07 ) + (l_npr06_1  - l_npr07_1 )   #MOD-E80079 add
      ELSE
         LET l_alz13f = l_npr07f_1 - l_npr06f_1
         LET l_alz13  = l_npr07_1  - l_npr06_1
        #LET l_alz09f = (l_npr07f - l_npr06f) - (l_npr07f_1 - l_npr06f_1)   #MOD-E80079 mark
        #LET l_alz09  = (l_npr07  - l_npr06 ) - (l_npr07_1  - l_npr06_1 )   #MOD-E80079 mark
         LET l_alz09f = (l_npr07f - l_npr06f) + (l_npr07f_1 - l_npr06f_1)   #MOD-E80079 add
         LET l_alz09  = (l_npr07  - l_npr06 ) + (l_npr07_1  - l_npr06_1 )   #MOD-E80079 add
      END IF
...
FUNCTION gglq900_ar_ap2_1()
  ...
  #獲取科目/廠商
   ...
   LET l_sql = "SELECT UNIQUE ted02,aag01,ted09 FROM aag_file,ted_file ",
              ...
              #"   AND ted011 = '1'"
               "   AND ted011 = '1' AND (aag07 = '2' OR aag07 = '3')"   #modify by renkl160121
...
FUNCTION gglq900_nm22()
   ...
   LET l_sql = " SELECT aag01 FROM aag_file",
              ...
              #"    AND aag02 LIKE '",l_aag02_d,"' "         #科目
               "    AND aag02 LIKE '",l_aag02_d,"' AND (aag07 = '2' OR aag07 = '3')"   #modify by renkl160121
...
FUNCTION gglq900_gl()
   ...
   LET l_sql = "SELECT DISTINCT aag01",
                  ...
                  " WHERE aag00 = '",g_aza.aza81,"'",
                  "   AND aag01 = abb03",
                  "   AND (aag07 = '2' OR aag07 = '3')",   #add by renkl160121
                  "   AND ",tm.wc2 CLIPPED
...
FUNCTION gglq900_b_fill()
  ...
  #IF tm.a = '3' THEN
   IF tm.a = '3' OR tm.a = '4' THEN   #modify by renkl160122
      IF tm.e = 'N' THEN 
       # LET g_sql = "SELECT alz01,occ02,alz14,aag02,'','','',alz13f,alz13,cf,c,df_cf,df_c,",  #No.FUN-D70072   Add '',''   
         LET g_sql = "SELECT alz01,'',alz14,aag02,'','','',alz13f,alz13,cf,c,df_cf,df_c,",  #No.FUN-D70072   Add '',''     #modify by renkl160122
      ...
      ELSE 
       # LET g_sql = "SELECT alz01,occ02,alz14,aag02,'','',alz10,alz13f,alz13,cf,c,df_cf,df_c,",     #No.FUN-D70072   Add '',''  
         LET g_sql = "SELECT alz01,'',alz14,aag02,'','',alz10,alz13f,alz13,cf,c,df_cf,df_c,",     #No.FUN-D70072   Add '',''  #modify by renkl160122
                     "       alz09f,alz09,df,d,df_tf,df_t",
                     " FROM gglq900_tmp",
   ...
   FOREACH aed_curs INTO g_alz[g_cnt].*
      IF SQLCA.sqlcode THEN
         ...
         EXIT FOREACH
      END IF
#add by renkl160121 start      
   IF tm.b = '1' AND tm.a = '4'  THEN   
       SELECT pmc03 INTO g_alz[g_cnt].occ02 FROM pmc_file 
          WHERE pmc01 = g_alz[g_cnt].alz01     
         DISPLAY BY NAME g_alz[g_cnt].occ02     
     END IF      
   IF tm.b = '1' AND tm.a = '3'  THEN  
       SELECT occ02 INTO g_alz[g_cnt].occ02 FROM occ_file 
          WHERE occ01 = g_alz[g_cnt].alz01     
         DISPLAY BY NAME g_alz[g_cnt].occ02
   END IF         
#add by renkl160121
   
   #add muping160222 str
   IF cl_null(g_alz[g_cnt].occ02) THEN
      SELECT gen02 INTO g_alz[g_cnt].occ02  FROM gen_file WHERE gen01 = g_alz[g_cnt].alz01 
       DISPLAY BY NAME g_alz[g_cnt].occ02
   END IF 
   IF cl_null(g_alz[g_cnt].occ02) THEN
      SELECT pmc03 INTO g_alz[g_cnt].occ02 FROM pmc_file 
...
FUNCTION gglq900_t()
  ...
  #No.FUN-D70072 ---Add--- End
   ...
   #   CALL cl_set_act_visible("inquiry_subsystem,ledger_enquiry,monthly_statement,aging_update,closing",TRUE)#mark muping160222
      CALL cl_set_act_visible("inquiry_subsystem,ledger_enquiry",TRUE) #add muping160222
   END IF  
   
   IF tm.b = '3' THEN 
   #   CALL cl_set_act_visible("inquiry_subsystem,ledger_enquiry,monthly_statement,check_closing,closing",TRUE)#mark muping16022
       CALL cl_set_act_visible("inquiry_subsystem,ledger_enquiry",TRUE) #add muping160222
   ...
   IF tm.b = '4' THEN 
      ...
      CALL cl_set_comp_visible("alz01,occ02",FALSE)
      CALL cl_set_comp_visible("alz13,c,df_c,alz09,d,df_t",TRUE)
      #CALL cl_set_act_visible("monthly_statement,monthly_statement_return,closing",TRUE)#mark muping160222
   END IF 
  ...
  #LET comb_value = '1,2,3'
   ...
   ELSE
     IF tm.b = '1' THEN
       # CALL cl_set_act_visible("ap_closing,ar_closing,ap_monthly_statement,ar_monthly_statement",TRUE)  #mark muping160222
        CALL cl_set_act_visible("closing,closing,monthly_statement,monthly_statement",FALSE) 
     ELSE
        CALL cl_set_act_visible("ap_closing,ar_closing,ap_monthly_statement,ar_monthly_statement",FALSE)
        #CALL cl_set_act_visible("closing,closing,monthly_statement,monthly_statement",TRUE) #mark muping160222
     END IF
   END IF
  #No.FUN-D70072 ---Add--- End
END FUNCTION 
...
FUNCTION gglq900_t_1()
   ...
   IF tm.b = '2' THEN 
     # CALL cl_set_act_visible("inquiry_subsystem,ledger_enquiry,monthly_statement,check_closing,closing",TRUE)#mark muping160222
       CALL cl_set_act_visible("inquiry_subsystem,ledger_enquiry",TRUE) #add muping160222
...
FUNCTION q900_inquiry_subsystem()
   ...
   IF tm.b = '1' THEN 
      ...
      END IF 
    # IF tm.a = '3' THEN 
      IF tm.a = '3'  OR tm.a = '4' THEN   #modify by renkl160121
   ...
   END IF
  #No.FUN-D70072 ---Add--- End
   #直接取gglq910add muping160223 str
   LET l_wc = 'npq21 = "',g_alz[l_ac].alz01,'"  AND npq03 = "',g_alz[l_ac].alz14,'"'
   LET l_str = "gglq910 '' '' '",g_lang,"' 'Y' '' '' '",l_wc CLIPPED,"' '",l_bdate,"' '",l_edate,"' '",g_aza.aza81,"' 'N' '' 'N' '1' 'N' 'N' 'N' '' '' '' ''" 
   #add mupping160223 end
