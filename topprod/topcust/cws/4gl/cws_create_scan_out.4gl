...
FUNCTION cws_create_scan_out_process()
    ...
    FOR l_i = 1 TO l_cnt1 
     ...
     #  END IF 
       ...
       #tianry add 170221
        #  扫出数量总和
       SELECT SUM(tc_shc12) INTO l_tc_shc12 FROM tc_shc_file WHERE tc_shc01='2' AND tc_shc03=g_tc_shc.tc_shc03
       AND tc_shc08=g_tc_shc.tc_shc08 AND tc_shc06=g_tc_shc.tc_shc06
       IF cl_null(l_tc_shc12) THEN LET l_tc_shc12=0 END IF
       #  完工数量综合
       SELECT SUM(tc_shb12) INTO l_tc_shb12 FROM tc_shb_file WHERE tc_shb01='2' AND tc_shb03=g_tc_shc.tc_shc03
       AND tc_shb08=g_tc_shc.tc_shc08 AND tc_shb06=g_tc_shc.tc_shc06
       IF cl_null(l_tc_shb12) THEN LET l_tc_shb12=0 END IF 
       IF l_tc_shc12-l_tc_shb12>0 THEN   #扫出数量大于完工数量
          LET g_status.code = SQLCA.SQLCODE
          LET g_status.sqlcode = SQLCA.SQLCODE,g_tc_shc.tc_shc03
          LET l_return.code="-1"
          LET g_success='N' 
          LET l_return.msg = "扫出数量大于完工数量请重新扫描"
          LET l_return.msg1 = "第'",l_a,"'笔"
          DELETE FROM tc_shc_file WHERE tc_shc02=g_tc_shc.tc_shc02  
          EXIT FOR
       END IF 
       #tianry add  end 
      ...
      IF cl_null(l_sfbud11) THEN  #属于精简报工的工单 
         ...
         FOREACH sel_tc_shc_cc_cur  INTO l_sgm03,l_sgm04,l_ta_sgm06,l_ecd07
              ...
              IF l_cnt=0 THEN
                 IF l_ta_ecd04='N' OR cl_null(l_ta_ecd04) THEN  #下一站不存在开工完工的 情况
                    ...
                    IF STATUS OR SQLCA.SQLERRD[3]=0 THEN 
                       ...
                       LET l_str="'",g_prog,"' '",STATUS,"'  '",TIME,"' '",l_tc_shc.tc_shc01,"'  "
                       CALL writeStringToFile(l_str,l_logfile)
                       LET g_status.code = '-1'
                       LET g_status.description = 'INS tc_shc err 1'
                       LET g_success = 'N'  
                    ...
                    IF STATUS OR SQLCA.SQLERRD[3]=0 THEN
                       ...
                       LET l_str="'",g_prog,"' '",STATUS,"'  '",TIME,"' '",l_tc_shc1.tc_shc01,"'  "
                       CALL writeStringToFile(l_str,l_logfile)
                       LET g_status.code = '-1'
                       LET g_status.description = 'INS tc_shc err 2'
                       LET g_success = 'N'
                 ...
                 IF cl_null(l_tc_shb.tc_shb121) THEN LET l_tc_shb.tc_shb121=0 END IF  #add ly180103
                 IF cl_null(l_tc_shb.tc_shb122) THEN LET l_tc_shb.tc_shb122=0 END IF  #add ly180103
                 INSERT INTO tc_shb_file VALUES (l_tc_shb.*)
                 IF STATUS OR SQLCA.SQLERRD[3]=0 THEN
                    LET l_str="'",g_prog,"' '",STATUS,"'  '",TIME,"' '",l_tc_shb.tc_shb01,"'  "
                    CALL writeStringToFile(l_str,l_logfile)
                    LET g_status.code = '-1'
                    LET g_status.description = 'INS tc_shb err 2'
                    LET g_success = 'N'
                 ...
                 IF STATUS OR SQLCA.SQLERRD[3]=0 THEN 
                    LET l_str="'",g_prog,"' '",STATUS,"'  '",TIME,"' '",l_tc_shb1.tc_shb01,"'  "
                    CALL writeStringToFile(l_str,l_logfile)
                    LET g_status.code = '-1'
                    LET g_status.description = 'INS tc_shb err 2'
                    LET g_success = 'N'
           ...
           END IF  
           #下一站报工资料产生
           SELECT tc_shb02 INTO g_tc_shb02 FROM tc_shb_file WHERE tc_shb01='2' AND tc_shb03=g_tc_shc.tc_shc03
           AND tc_shb06=l_sgm03  AND rownum=1
           LET g_tc_shb03=g_tc_shc.tc_shc03
           LET g_tc_shb08=l_sgm04
          # LET g_tc_shb02= g_tc_shc.tc_shc12   # l_tc_shb1.tc_shb02     #g_argv3
           LET g_tc_shb12=g_tc_shc.tc_shc12
           CALL p740_try_1()
         END FOREACH 
     END IF
     CALL p003_try_1()
...
DEFINE p_row,p_col   LIKE type_file.num5          #No.FUN-680136 SMALLINT
   ...
   #      FOREACH p730_curs2 INTO l_tc_shb.*
            CALL p730_shb_try_1(l_tc_shb.tc_shb03,l_tc_shb.tc_shb06,l_tc_shb.tc_shb11,l_tc_shb.tc_shb12,l_tc_shb.tc_shb13,l_tc_shb.tc_shb14) 
         ...
         #   END IF 
            ...
            CLOSE ss_ee_cur4
            IF cl_null(l_str) THEN LET l_str='MRK'  END IF  
...
FUNCTION p730_shb_try_1(p_tc_shb03,p_tc_shb06,p_tc_shb11,p_tc_shb12,p_tc_shb13,p_tc_shb14) 
...
CALL p002_create_temp_try_1()
    


   CALL p002_b_fill_try_1()
   CALL p002_b_auto_try_1()
...
#            CALL cl_err('foreach:',SQLCA.sqlcode,1)
        ...
        # AND tc_shb01='2' AND  tc_shb12=l_shb111 AND tc_shb17 IS  NULL
         ...
         CALL t730sub_y_chk(l_shb01,TRUE)
             ...
             ELSE
                IF p002_accept_qty_1('c',l_shb01) THEN
                   LET g_success = 'N'
...
FUNCTION p002_create_temp_try_1()
DROP TABLE shb1_temp;
...
FUNCTION p002_accept_qty_1(p_cmd,l_shb01)
