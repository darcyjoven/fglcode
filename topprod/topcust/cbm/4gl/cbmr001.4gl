...
FUNCTION cbmr001_tm(p_row,p_col)
   ...
   OPEN WINDOW cbmr001_w AT p_row,p_col WITH FORM "cbm/42f/cbmr001"
...
#            LET tm.wc = cl_replace_str(tm.wc, "'", "\"")
            LET l_cmd = l_cmd CLIPPED,       
                        ...
                        " '",g_template CLIPPED,"'",           
                         " '",g_rpt_name CLIPPED,"'"           
            CALL cl_cmdat('cbmr001',g_time,l_cmd)
         END IF
...
FUNCTION cbmr001()
  ...
  #公司全名zo02、公司地址zo041、公司電話zo05、公司傳真zo09
   ...
   SELECT zz05 INTO g_zz05 FROM zz_file WHERE zz01 = 'cbmr001'  
...
#str----add by huanglf160922
   ...
   CALL cl_prt_cs3('cbmr001','cbmr001',l_sql,l_str)
