...
TYPE t_oea          RECORD                                            #记录集\
       ...
       ,oebud08       LIKE oeb_file.oebud08   #add by guanyao160614
       ,oebud09       LIKE oeb_file.oebud09   #add by guanyao160614
       ,oebud04       LIKE oeb_file.oebud04   #add by guanyao160801
       ,oebud11       LIKE oeb_file.oebud11   #add by guanyao160801
       ,oea10         LIKE oea_file.oea10     #tianry add 
                         END RECORD
DEFINE g_oea               DYNAMIC ARRAY OF t_oea                     #单身全局
DEFINE g_oea_t             t_oea                                      #单身旧值
...
DEFINE g_oea01_t           LIKE oea_file.oea01                        #定义KEY值旧值
...
DEFINE p_row,p_col         LIKE type_file.num5
       ...
       IF (NOT cl_setup("CXM")) THEN                                  #预设模组参数(g_aza.*,...)权限参数,判断使用者执行权限
          EXIT PROGRAM                                                #退出程序
       END IF
       ...
       OPEN WINDOW q001_w AT p_row,p_col WITH FORM "cxm/42f/cxmq001"
...
FUNCTION q001_cs()
       ...
       CLEAR FORM
       CALL g_oea.clear()                                             #数组变量清空
       LET tm.wc2 = NULL
       
           CONSTRUCT tm.wc2 ON oea01,oeb03,oea03,occ02,oeb04,oeb06,ima021,oeb12,oeb24,oebud07,oebud08,oebud09  #add by guanyao160614
                               ,oebud04,oebud11,oea10    #add by guanyao160801 
           FROM
                   s_oea[1].oea01,s_oea[1].oeb03,s_oea[1].oea03,s_oea[1].occ02,
                   s_oea[1].oeb04,s_oea[1].oeb06,s_oea[1].ima021,s_oea[1].oeb12,
                   s_oea[1].oeb24,s_oea[1].oebud07
                   ,s_oea[1].oebud08,s_oea[1].oebud09  #add by guanyao160614
                   ,s_oea[1].oebud04,s_oea[1].oebud11,s_oea[1].oea10   #add by guanyao160614
               ...
               ON ACTION controlp 
                 CASE 
                   WHEN INFIELD(oea01)  #                        #按Ctrl+P触发(一般用于ButtonEdit)
                       ...
                       NEXT FIELD oea01
                   WHEN INFIELD(oea03)  #                         #按Ctrl+P触发(一般用于ButtonEdit)
                       CALL cl_init_qry_var() 
                       LET g_qryparam.state= "c"
                       ...
                       NEXT FIELD oea03
                   WHEN INFIELD(oeb04)  #                        #按Ctrl+P触发(一般用于ButtonEdit)
...
DEFINE p_ud                LIKE type_file.chr1
       ...
       DISPLAY ARRAY g_oea TO s_oea.* ATTRIBUTE(COUNT=oea_cnt,UNBUFFERED)
...
FUNCTION q001_b_fill()
   ...
   IF cl_null(tm.wc2) THEN 
      LET tm.wc2=" 1=1" 
   END IF
   LET g_sql =" SELECT oea01,oeb03,oea03,occ02,oeb04,oeb06,ima021,oeb12,oeb24,oebud07,oebud08,oebud09",  #add by guanyao160614
              "        ,oebud04,oebud11,oea10 ",   #add by guanyao160801
              "   FROM oea_file LEFT JOIN occ_file ON occ01 = oea03,",
   ...
   PREPARE cxmq001_pb FROM g_sql
   DECLARE oea_curs  CURSOR FOR cxmq001_pb        #CURSOR
