...
MAIN
   ...
   LET  l_table = cl_prt_temptable('cxmr001',g_sql) CLIPPED
...
FUNCTION cxmr001_tm(p_row,p_col)
...
DEFINE p_row,p_col    LIKE type_file.num5,        
   ...
   OPEN WINDOW cxmr001_w AT p_row,p_col WITH FORM "cxm/42f/cxmr001"
...
WHILE TRUE
  ...
  END CONSTRUCT
   ...
   IF INT_FLAG THEN
      LET INT_FLAG = 0 CLOSE WINDOW cxmr001_w 
  ...
  #UI
   ...
   IF g_bgjob = 'Y' THEN
      ...
      ELSE
         ...
         CALL cl_cmdat('cxmr001',g_time,l_cmd)    # Execute cmd at later time
      END IF
      CLOSE WINDOW cxmr001_w
      CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690126
      EXIT PROGRAM
   END IF
   CALL cl_wait()
...
#       l_time          LIKE type_file.chr8        #No.FUN-6A0094
          ...
          sr        RECORD
                    ...
                    pmc081   LIKE pmc_file.pmc081,#送货客户名称
   ...
   LOCATE l_img_blob IN MEMORY             
     ...
     SELECT zz05 INTO g_zz05 FROM zz_file WHERE zz01='cxmr001' 
...
LET l_sql="select '','','','','',oga01,'','','',ogb04,'',sum(ogb12),'','','','','','','',ogbud02",
     ...
     PREPARE cxmr001_prepare1 FROM l_sql
     IF STATUS THEN CALL cl_err('prepare:',STATUS,1) 
        CALL cl_used(g_prog,g_time,2) RETURNING g_time #No.FUN-690126
        EXIT PROGRAM 
     END IF 
     LET l_ogb03 = 1
     DECLARE cxmr001_curs1 CURSOR FOR cxmr001_prepare1
     FOREACH cxmr001_curs1 INTO sr.* 
     IF STATUS THEN CALL cl_err('foreach:',STATUS,1) EXIT FOREACH END IF
     LET sr.ogb03 = l_ogb03
     SELECT oga04,ogb11,ogb05,ogb31,ogbud01,ogaud03,ogaud04,ogaud05,oga02,ogbud02 
     INTO sr.oga04,sr.ogb11,sr.ogb05,sr.ogb31,sr.ogbud01,sr.ogaud03,sr.ogaud04,sr.ogaud05,sr.oga02,sr.ogbud02
     ...
     SELECT pmc081 INTO sr.pmc081 FROM pmc_file WHERE pmc01=sr.oga04
    ...
    LET l_ogb03 = l_ogb03 + 1
     ...
     CALL cl_prt_cs3('cxmr001','cxmr001',g_sql,g_str)
