# Prog. Version..: '5.25.04-11.10.17(00008)'     #
#
...
# Modify..........: No:FUN-C90123 12/10/12 By wujie 年度/期别的抓取改为从会计期间资料，而非自然年月
# Modify..........: No:130808     13/08/08 By tangyh 不应该删除aglt0021的资料
...
#   LET g_month= MONTH(g_aaa07)
   LET g_year = s_get_aznn(g_plant,g_aaw01,g_aaa07,1)
   LET g_month= s_get_aznn(g_plant,g_aaw01,g_aaa07,3)
#No.FUN-C90123 --end
  WHILE TRUE
...
#  CALL s_dsmark(g_bookno)    #FUN-BB80135
   ...
   OPEN WINDOW cglp007 AT p_row,p_col WITH FORM "cgl/42f/cglp007" 
       ATTRIBUTE (STYLE = g_win_style CLIPPED)
    
   CALL cl_ui_init()

#   CALL s_shwact(0,0,g_bookno)  #FUN-B80135
   CALL cl_opmsg('q')
   WHILE TRUE 
      CLEAR FORM 
...
DEFINE l_num         LIKE type_file.num5
   ...
   #CALL p007_del()    #TQC-B70069   Add   #130808 mark by tangyh
...
DEFINE l_aag04 LIKE aag_file.aag04
DEFINE l_axz08 LIKE axz_file.axz08    #FUN-B80195

   SELECT axz08 INTO l_axz08 FROM axz_file WHERE axz01 = g_axf.axf09 #FUN-B80195
 ...
 # LET g_axj.axj05= g_axf.axf09    #FUN-B60134 ADD   #FUN-B80195
   LET g_axj.axj05= l_axz08        #FUN-B80195
